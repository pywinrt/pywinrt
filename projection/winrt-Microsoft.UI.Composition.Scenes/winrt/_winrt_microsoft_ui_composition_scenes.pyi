...
class SceneComponentCollection(winrt.system.Object, winrt._winrt.MutableSequence[SceneComponent]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[SceneComponent]: ...
...
class SceneMeshMaterialAttributeMap(winrt.system.Object, winrt._winrt.MutableMapping[str, SceneAttributeSemantic]):
    ...
    def get_view(self) -> windows_foundation_collections.IMapView[str, SceneAttributeSemantic]: ...
...
class SceneNodeCollection(winrt.system.Object, winrt._winrt.MutableSequence[SceneNode]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[SceneNode]: ...
...
class SceneVisual(winrt.system.Object, metaclass=SceneVisual_Static):
    ...
    @_property
    def children(self) -> microsoft_ui_composition.VisualCollection: ...
    @_property
    ...
    @_property
    def clip(self) -> microsoft_ui_composition.CompositionClip: ...
    @clip.setter
    def clip(self, value: microsoft_ui_composition.CompositionClip) -> None: ...
    @_property
    ...
    @_property
    def parent(self) -> microsoft_ui_composition.ContainerVisual: ...
    @_property
    ...
    @_property
    def parent_for_transform(self) -> microsoft_ui_composition.Visual: ...
    @parent_for_transform.setter
    def parent_for_transform(self, value: microsoft_ui_composition.Visual) -> None: ...
    @_property
