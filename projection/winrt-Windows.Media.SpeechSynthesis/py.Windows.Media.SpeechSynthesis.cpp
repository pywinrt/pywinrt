...
PyMODINIT_FUNC PyInit__winrt_windows_media_speechsynthesis(void) noexcept
{
    ...
    py::pyobj_handle SpeechSynthesisStream_type{py::register_python_type(module.get(), &type_spec_SpeechSynthesisStream, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle SpeechSynthesizer_type{py::register_python_type(module.get(), &type_spec_SpeechSynthesizer, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_SpeechSynthesizer_Static.get()))};
    if (!SpeechSynthesizer_type)
    {
        return nullptr;
    }

    py::pyobj_handle SpeechSynthesizerOptions_type{py::register_python_type(module.get(), &type_spec_SpeechSynthesizerOptions, object_bases.get(), nullptr)};
    if (!SpeechSynthesizerOptions_type)
    {
        return nullptr;
    }

    py::pyobj_handle VoiceInformation_type{py::register_python_type(module.get(), &type_spec_VoiceInformation, object_bases.get(), nullptr)};
