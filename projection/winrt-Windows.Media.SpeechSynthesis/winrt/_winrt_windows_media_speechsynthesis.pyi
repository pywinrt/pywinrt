...
@typing.final
class SpeechSynthesisStream(winrt.system.Object, windows_media_core.ImplementsITimedMetadataTrackProvider, windows_storage_streams.ImplementsIRandomAccessStreamWithContentType, windows_storage_streams.ImplementsIContentTypeProvider, windows_storage_streams.ImplementsIRandomAccessStream, windows_storage_streams.ImplementsIOutputStream, windows_storage_streams.ImplementsIInputStream, windows_foundation.ImplementsIClosable):
...
@typing.final
class SpeechSynthesizer(winrt.system.Object, windows_foundation.ImplementsIClosable, metaclass=SpeechSynthesizer_Static):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]], exc_value: typing.Optional[BaseException], traceback: typing.Optional[types.TracebackType]) -> None: ...
