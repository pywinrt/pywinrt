...
class SpeechSynthesisStream(winrt.system.Object):
    ...
    @_property
    def timed_metadata_tracks(self) -> windows_foundation_collections.IVectorView[windows_media_core.TimedMetadataTrack]: ...
    @_property
    def markers(self) -> windows_foundation_collections.IVectorView[windows_media.IMediaMarker]: ...
    @_property
...
class SpeechSynthesizer_Static(type):
    ...
    @_property
    def all_voices(cls) -> windows_foundation_collections.IVectorView[VoiceInformation]: ...
    @_property
