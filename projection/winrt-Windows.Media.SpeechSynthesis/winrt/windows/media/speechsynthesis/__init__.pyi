...
class SpeechSynthesizer(winrt.system.Object):
    ...
    @staticmethod
    def try_set_default_voice_async(voice: typing.Optional[VoiceInformation], /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...

class SpeechSynthesizerOptions(winrt.system.Object):
    include_word_boundary_metadata: winrt.system.Boolean
    include_sentence_boundary_metadata: winrt.system.Boolean
