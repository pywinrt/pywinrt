...
class MiracastReceiver(winrt.system.Object):
    ...
    def create_session(self, view: typing.Optional[windows_applicationmodel_core.CoreApplicationView], /) -> typing.Optional[MiracastReceiverSession]: ...
    def create_session_async(self, view: typing.Optional[windows_applicationmodel_core.CoreApplicationView], /) -> windows_foundation.IAsyncOperation[MiracastReceiverSession]: ...
    ...
    def disconnect_all_and_apply_settings_async(self, settings: typing.Optional[MiracastReceiverSettings], /) -> windows_foundation.IAsyncOperation[MiracastReceiverApplySettingsResult]: ...
...
class MiracastReceiverCursorImageChannel(winrt.system.Object):
    ...
    def remove_image_stream_changed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    @_property
    def image_stream(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamWithContentType]: ...
    @_property
...
class MiracastReceiverCursorImageChannelSettings(winrt.system.Object):
    ...
    def max_image_size(self, value: windows_graphics.SizeInt32) -> None: ...
    @_property
    def is_enabled(self) -> bool: ...
    @is_enabled.setter
...
class MiracastReceiverSession(winrt.system.Object):
    ...
    def remove_connection_created(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_media_source_created(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
...
class MiracastReceiverStatus(winrt.system.Object):
    ...
    @_property
    def known_transmitters(self) -> typing.Optional[windows_foundation_collections.IVectorView[MiracastTransmitter]]: ...
    @_property
...
class MiracastReceiverStreamControl(winrt.system.Object):
    ...
    def suggest_video_stream_settings_async(self, settings: typing.Optional[MiracastReceiverVideoStreamSettings], /) -> windows_foundation.IAsyncAction: ...
    @_property
...
class MiracastReceiverVideoStreamSettings(winrt.system.Object):
    ...
    @size.setter
    def size(self, value: windows_graphics.SizeInt32) -> None: ...
    @_property
...
class MiracastTransmitter(winrt.system.Object):
    ...
    def get_connections(self) -> typing.Optional[windows_foundation_collections.IVectorView[MiracastReceiverConnection]]: ...
    @_property
    def name(self) -> str: ...
    @name.setter
