...
@typing.final
class MiracastReceiverConnection(winrt.system.Object, windows_foundation.ImplementsIClosable):
...
@typing.final
class MiracastReceiverSession(winrt.system.Object, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
