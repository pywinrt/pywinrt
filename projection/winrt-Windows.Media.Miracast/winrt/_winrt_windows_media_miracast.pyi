...
class MiracastReceiverStatus(winrt.system.Object):
    ...
    @_property
    def known_transmitters(self) -> windows_foundation_collections.IVectorView[MiracastTransmitter]: ...
    @_property
...
class MiracastTransmitter(winrt.system.Object):
    ...
    def get_connections(self) -> windows_foundation_collections.IVectorView[MiracastReceiverConnection]: ...
    @_property
    def name(self) -> str: ...
    @name.setter
