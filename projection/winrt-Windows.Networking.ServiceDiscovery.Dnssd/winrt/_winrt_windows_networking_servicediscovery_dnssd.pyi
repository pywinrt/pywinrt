...
class DnssdServiceInstance(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[DnssdServiceInstance], dnssd_service_instance_name: str, host_name: windows_networking.HostName, port: winrt.system.UInt16) -> DnssdServiceInstance: ...
    ...
    @_property
    def text_attributes(self) -> windows_foundation_collections.IMap[str, str]: ...
