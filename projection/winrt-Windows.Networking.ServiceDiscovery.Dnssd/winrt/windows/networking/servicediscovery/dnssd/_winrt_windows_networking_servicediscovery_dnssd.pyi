...
class DnssdRegistrationResult(winrt.system.Object):
    has_instance_name_changed: winrt.system.Boolean
...
class DnssdServiceInstanceCollection(winrt.system.Object, typing.Sequence[DnssdServiceInstance]):
    ...
    def index_of(self, value: typing.Optional[DnssdServiceInstance], /) -> typing.Tuple[winrt.system.Boolean, winrt.system.UInt32]: ...
