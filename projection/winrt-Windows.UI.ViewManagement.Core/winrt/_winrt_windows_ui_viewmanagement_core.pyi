...
class CoreFrameworkInputView_Static(type):
    ...
    def get_for_u_i_context(cls, context: windows_ui.UIContext, /) -> CoreFrameworkInputView: ...
...
class CoreFrameworkInputViewAnimationStartingEventArgs(winrt.system.Object):
    ...
    @_property
    def occlusions(self) -> windows_foundation_collections.IVectorView[CoreInputViewOcclusion]: ...
...
class CoreInputView_Static(type):
    ...
    def get_for_u_i_context(cls, context: windows_ui.UIContext, /) -> CoreInputView: ...

@typing.final
class CoreInputView(winrt.system.Object, metaclass=CoreInputView_Static):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> CoreInputView: ...
    def get_core_input_view_occlusions(self) -> windows_foundation_collections.IVectorView[CoreInputViewOcclusion]: ...
