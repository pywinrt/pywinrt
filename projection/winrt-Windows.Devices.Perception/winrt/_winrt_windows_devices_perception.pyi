...
class PerceptionColorFrameSource(winrt.system.Object, metaclass=PerceptionColorFrameSource_Static):
    ...
    @_property
    def available_video_profiles(self) -> windows_foundation_collections.IVectorView[PerceptionVideoProfile]: ...
    @_property
    ...
    @_property
    def supported_video_profiles(self) -> windows_foundation_collections.IVectorView[PerceptionVideoProfile]: ...
    @_property
