...
class PerceptionColorFrameReader(winrt.system.Object):
    is_paused: winrt.system.Boolean
...
class PerceptionColorFrameSource(winrt.system.Object):
    ...
    display_name: str
    id: str
    is_controlled: winrt.system.Boolean
    ...
    def can_control_independently_from(self, target_id: str, /) -> winrt.system.Boolean: ...
    @staticmethod
    ...
    def is_correlated_with(self, target_id: str, /) -> winrt.system.Boolean: ...
    ...
    def try_get_transform_to(self, target_id: str, /) -> typing.Tuple[winrt.system.Boolean, winrt.windows.foundation.numerics.Matrix4x4]: ...
...
class PerceptionVideoProfile(winrt.system.Object):
    ...
    def is_equal(self, other: typing.Optional[PerceptionVideoProfile], /) -> winrt.system.Boolean: ...
