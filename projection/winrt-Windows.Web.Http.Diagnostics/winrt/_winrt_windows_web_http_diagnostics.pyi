...
class HttpDiagnosticProvider_Static(type):
    def create_from_process_diagnostic_info(cls, process_diagnostic_info: typing.Optional[windows_system_diagnostics.ProcessDiagnosticInfo], /) -> typing.Optional[HttpDiagnosticProvider]: ...
...
class HttpDiagnosticProviderRequestResponseCompletedEventArgs(winrt.system.Object):
    ...
    @_property
    def source_locations(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpDiagnosticSourceLocation]]: ...
    @_property
...
class HttpDiagnosticProviderRequestSentEventArgs(winrt.system.Object):
    ...
    def initiator(self) -> HttpDiagnosticRequestInitiator: ...
    @_property
    def message(self) -> typing.Optional[windows_web_http.HttpRequestMessage]: ...
    @_property
    def process_id(self) -> winrt.system.UInt32: ...
    @_property
    def source_locations(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpDiagnosticSourceLocation]]: ...
...
class HttpDiagnosticProviderResponseReceivedEventArgs(winrt.system.Object):
    ...
    def activity_id(self) -> _uuid.UUID: ...
    @_property
    def message(self) -> typing.Optional[windows_web_http.HttpResponseMessage]: ...
    @_property
    def timestamp(self) -> datetime.datetime: ...
