...
PyMODINIT_FUNC PyInit__winrt_windows_graphics(void) noexcept
{
    ...
    py::pyobj_handle IGeometrySource2D_type{py::register_python_type(module.get(), &type_spec_IGeometrySource2D, object_bases.get(), nullptr)};
    if (!IGeometrySource2D_type)
    {
        return nullptr;
    }

    py::pyobj_handle DisplayAdapterId_type{py::register_python_type(module.get(), &type_spec_DisplayAdapterId, nullptr, nullptr)};
    ...
    py::pyobj_handle PointInt32_type{py::register_python_type(module.get(), &type_spec_PointInt32, nullptr, nullptr)};
    if (!PointInt32_type)
    {
        return nullptr;
    }

    py::pyobj_handle RectInt32_type{py::register_python_type(module.get(), &type_spec_RectInt32, nullptr, nullptr)};
    if (!RectInt32_type)
    {
        return nullptr;
    }

    py::pyobj_handle SizeInt32_type{py::register_python_type(module.get(), &type_spec_SizeInt32, nullptr, nullptr)};
    if (!SizeInt32_type)
    {
        return nullptr;
    }
