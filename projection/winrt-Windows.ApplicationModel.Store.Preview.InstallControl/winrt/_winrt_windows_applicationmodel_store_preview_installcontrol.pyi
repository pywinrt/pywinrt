...
class AppInstallManager(winrt.system.Object):
    ...
    def search_for_all_updates_with_telemetry_async(self, correlation_vector: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppInstallItem]]: ...
    def search_for_all_updates_with_update_options_async(self, correlation_vector: str, client_id: str, update_options: typing.Optional[AppUpdateOptions], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppInstallItem]]: ...
    def search_for_all_updates_with_update_options_for_user_async(self, user: typing.Optional[windows_system.User], correlation_vector: str, client_id: str, update_options: typing.Optional[AppUpdateOptions], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppInstallItem]]: ...
    ...
    def search_for_updates_with_update_options_async(self, product_id: str, sku_id: str, correlation_vector: str, client_id: str, update_options: typing.Optional[AppUpdateOptions], /) -> windows_foundation.IAsyncOperation[AppInstallItem]: ...
    def search_for_updates_with_update_options_for_user_async(self, user: typing.Optional[windows_system.User], product_id: str, sku_id: str, correlation_vector: str, client_id: str, update_options: typing.Optional[AppUpdateOptions], /) -> windows_foundation.IAsyncOperation[AppInstallItem]: ...
    ...
    def start_product_install_with_options_async(self, product_id: str, flight_id: str, client_id: str, correlation_vector: str, install_options: typing.Optional[AppInstallOptions], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppInstallItem]]: ...
    def start_product_install_with_options_for_user_async(self, user: typing.Optional[windows_system.User], product_id: str, flight_id: str, client_id: str, correlation_vector: str, install_options: typing.Optional[AppInstallOptions], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppInstallItem]]: ...
