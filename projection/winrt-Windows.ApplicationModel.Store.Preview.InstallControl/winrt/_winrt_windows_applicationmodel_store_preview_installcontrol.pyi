...
class AppInstallItem(winrt.system.Object):
    ...
    @_property
    def children(self) -> windows_foundation_collections.IVectorView[AppInstallItem]: ...
    @_property
...
class AppInstallManager(winrt.system.Object):
    ...
    def search_for_all_updates_for_user_async(self, user: windows_system.User, correlation_vector: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppInstallItem]]: ...
    ...
    def search_for_all_updates_with_update_options_async(self, correlation_vector: str, client_id: str, update_options: AppUpdateOptions, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppInstallItem]]: ...
    def search_for_all_updates_with_update_options_for_user_async(self, user: windows_system.User, correlation_vector: str, client_id: str, update_options: AppUpdateOptions, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppInstallItem]]: ...
    ...
    def start_product_install_with_options_async(self, product_id: str, flight_id: str, client_id: str, correlation_vector: str, install_options: AppInstallOptions, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppInstallItem]]: ...
    def start_product_install_with_options_for_user_async(self, user: windows_system.User, product_id: str, flight_id: str, client_id: str, correlation_vector: str, install_options: AppInstallOptions, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppInstallItem]]: ...
    ...
    @_property
    def app_install_items(self) -> windows_foundation_collections.IVectorView[AppInstallItem]: ...
    @_property
    def app_install_items_with_group_support(self) -> windows_foundation_collections.IVectorView[AppInstallItem]: ...
    @_property
