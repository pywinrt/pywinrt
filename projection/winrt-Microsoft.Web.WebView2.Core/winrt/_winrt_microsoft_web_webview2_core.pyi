...
class CoreWebView2BrowserExtension(winrt.system.Object):
    ...
    def enable_async(self, is_enabled: bool, /) -> winrt.windows.foundation.IAsyncAction: ...
    def remove_async(self) -> winrt.windows.foundation.IAsyncAction: ...
    @_property
    def id(self) -> str: ...
    @_property
...
class CoreWebView2CustomSchemeRegistration(winrt.system.Object):
    ...
    @_property
    def allowed_origins(self) -> typing.Optional[winrt.windows.foundation.collections.IVector[str]]: ...
    @_property
...
class CoreWebView2Environment(winrt.system.Object, metaclass=CoreWebView2Environment_Static):
    ...
    def get_process_extended_infos_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.windows.foundation.collections.IVectorView[CoreWebView2ProcessExtendedInfo]]: ...
...
class CoreWebView2EnvironmentOptions(winrt.system.Object):
    ...
    @_property
    def custom_scheme_registrations(self) -> typing.Optional[winrt.windows.foundation.collections.IVector[CoreWebView2CustomSchemeRegistration]]: ...
    @custom_scheme_registrations.setter
    def custom_scheme_registrations(self, value: typing.Optional[winrt.windows.foundation.collections.IVector[CoreWebView2CustomSchemeRegistration]]) -> None: ...
    @_property
...
class CoreWebView2ProcessExtendedInfo(winrt.system.Object):
    ...
    @_property
    def associated_frame_infos(self) -> typing.Optional[winrt.windows.foundation.collections.IVectorView[CoreWebView2FrameInfo]]: ...
    @_property
...
class CoreWebView2Profile(winrt.system.Object):
    ...
    def add_browser_extension_async(self, extension_folder_path: str, /) -> winrt.windows.foundation.IAsyncOperation[CoreWebView2BrowserExtension]: ...
    @typing.overload
    ...
    def add_deleted(self, handler: winrt.windows.foundation.TypedEventHandler[CoreWebView2Profile, winrt.system.Object], /) -> winrt.windows.foundation.EventRegistrationToken: ...
    def remove_deleted(self, token: winrt.windows.foundation.EventRegistrationToken, /) -> None: ...
    @_property
