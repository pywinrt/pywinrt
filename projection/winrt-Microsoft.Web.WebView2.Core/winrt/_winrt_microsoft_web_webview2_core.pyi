...
class CoreWebView2(winrt.system.Object):
    ...
    def capture_preview_async(self, image_format: CoreWebView2CapturePreviewImageFormat, image_stream: windows_storage_streams.ImplementsIRandomAccessStream, /) -> windows_foundation.IAsyncAction: ...
...
class CoreWebView2Environment(winrt.system.Object, metaclass=CoreWebView2Environment_Static):
    ...
    def create_context_menu_item(self, label: str, icon_stream: windows_storage_streams.ImplementsIRandomAccessStream, kind: CoreWebView2ContextMenuItemKind, /) -> CoreWebView2ContextMenuItem: ...
    @typing.overload
    ...
    def create_web_resource_request(self, uri: str, method: str, post_data: windows_storage_streams.ImplementsIRandomAccessStream, headers: str, /) -> CoreWebView2WebResourceRequest: ...
    def create_web_resource_response(self, content: windows_storage_streams.ImplementsIRandomAccessStream, status_code: winrt.system.Int32, reason_phrase: str, headers: str, /) -> CoreWebView2WebResourceResponse: ...
...
@typing.final
class CoreWebView2HttpHeadersCollectionIterator(winrt.system.Object, windows_foundation_collections.ImplementsIIterator[windows_foundation_collections.IKeyValuePair[str, str]]):
...
class CoreWebView2Settings(winrt.system.Object):
    ...
    def host_object_dispatch_adapter(self, value: ImplementsICoreWebView2DispatchAdapter) -> None: ...
    @_property
...
@typing.final
class CoreWebView2SharedBuffer(winrt.system.Object, windows_foundation.ImplementsIClosable):
...
class CoreWebView2WebResourceRequest(winrt.system.Object):
    ...
    @content.setter
    def content(self, value: windows_storage_streams.ImplementsIRandomAccessStream) -> None: ...
    @_property
