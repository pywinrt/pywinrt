...
class CoreWebView2(winrt.system.Object):
    ...
    def capture_preview_async(self, image_format: CoreWebView2CapturePreviewImageFormat, image_stream: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> windows_foundation.IAsyncAction: ...
    ...
    @typing.overload
    def post_web_message_as_json(self, web_message_as_json: str, additional_objects: windows_foundation_collections.IVectorView[winrt.system.Object], /) -> None: ...
    def post_web_message_as_string(self, web_message_as_string: str, /) -> None: ...
    def print_async(self, print_settings: typing.Optional[CoreWebView2PrintSettings], /) -> windows_foundation.IAsyncOperation[CoreWebView2PrintStatus]: ...
    def print_to_pdf_async(self, result_file_path: str, print_settings: typing.Optional[CoreWebView2PrintSettings], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def print_to_pdf_stream_async(self, print_settings: typing.Optional[CoreWebView2PrintSettings], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IRandomAccessStream]: ...
    ...
    def show_save_as_u_i_async(self) -> windows_foundation.IAsyncOperation[CoreWebView2SaveAsUIResult]: ...
    def stop(self) -> None: ...
    ...
    def add_d_o_m_content_loaded(self, handler: windows_foundation.TypedEventHandler[CoreWebView2, CoreWebView2DOMContentLoadedEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    ...
    def add_save_as_u_i_showing(self, handler: windows_foundation.TypedEventHandler[CoreWebView2, CoreWebView2SaveAsUIShowingEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_save_as_u_i_showing(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
...
class CoreWebView2BrowserExtension(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> CoreWebView2BrowserExtension: ...
...
class CoreWebView2Certificate(winrt.system.Object):
    ...
    def to_certificate(self) -> typing.Optional[windows_security_cryptography_certificates.Certificate]: ...
    ...
    def issuer(self) -> str: ...
    @_property
    def pem_encoded_issuer_certificate_chain(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
...
class CoreWebView2ClientCertificateRequestedEventArgs(winrt.system.Object):
    ...
    def cancel(self, value: bool) -> None: ...
    @_property
    def allowed_certificate_authorities(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
    def host(self) -> str: ...
    @_property
    def is_proxy(self) -> bool: ...
    @_property
    def mutually_trusted_certificates(self) -> typing.Optional[windows_foundation_collections.IVectorView[CoreWebView2ClientCertificate]]: ...
    @_property
...
class CoreWebView2CompositionController(winrt.system.Object):
    ...
    def close(self) -> None: ...
    def drag_enter(self, drag_info: typing.Optional[windows_applicationmodel_datatransfer_dragdrop_core.CoreDragInfo], drag_u_i_override: typing.Optional[windows_applicationmodel_datatransfer_dragdrop_core.CoreDragUIOverride], /) -> windows_applicationmodel_datatransfer.DataPackageOperation: ...
    def drag_leave(self) -> None: ...
    def drag_over(self, drag_info: typing.Optional[windows_applicationmodel_datatransfer_dragdrop_core.CoreDragInfo], drag_u_i_override: typing.Optional[windows_applicationmodel_datatransfer_dragdrop_core.CoreDragUIOverride], /) -> windows_applicationmodel_datatransfer.DataPackageOperation: ...
    def drop(self, drag_info: typing.Optional[windows_applicationmodel_datatransfer_dragdrop_core.CoreDragInfo], /) -> windows_applicationmodel_datatransfer.DataPackageOperation: ...
    ...
    def query_non_client_region(self, kind: CoreWebView2NonClientRegionKind, /) -> typing.Optional[windows_foundation_collections.IVectorView[windows_foundation.Rect]]: ...
    ...
    @_property
    def cursor(self) -> typing.Optional[windows_ui_core.CoreCursor]: ...
    @_property
...
class CoreWebView2ContextMenuItem(winrt.system.Object):
    ...
    @_property
    def children(self) -> typing.Optional[windows_foundation_collections.IVector[CoreWebView2ContextMenuItem]]: ...
    @_property
    def command_id(self) -> winrt.system.Int32: ...
    @_property
    def icon(self) -> typing.Optional[windows_storage_streams.IRandomAccessStream]: ...
    @_property
...
class CoreWebView2ContextMenuRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def menu_items(self) -> typing.Optional[windows_foundation_collections.IVector[CoreWebView2ContextMenuItem]]: ...
...
class CoreWebView2ControllerWindowReference_Static(type):
    def create_from_core_window(cls, core_window: typing.Optional[windows_ui_core.CoreWindow], /) -> typing.Optional[CoreWebView2ControllerWindowReference]: ...
...
class CoreWebView2CookieManager(winrt.system.Object):
    ...
    def get_cookies_async(self, uri: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[CoreWebView2Cookie]]: ...
...
class CoreWebView2CustomSchemeRegistration(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[CoreWebView2CustomSchemeRegistration], scheme_name: str) -> CoreWebView2CustomSchemeRegistration: ...
    @_property
    ...
    @_property
    def allowed_origins(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
...
class CoreWebView2Environment_Static(type):
    ...
    @typing.overload
    def get_available_browser_version_string(cls, browser_executable_folder: str, options: typing.Optional[CoreWebView2EnvironmentOptions], /) -> str: ...
...
class CoreWebView2Environment(winrt.system.Object, metaclass=CoreWebView2Environment_Static):
    ...
    def create_context_menu_item(self, label: str, icon_stream: typing.Optional[windows_storage_streams.IRandomAccessStream], kind: CoreWebView2ContextMenuItemKind, /) -> typing.Optional[CoreWebView2ContextMenuItem]: ...
    @typing.overload
    def create_core_web_view2_composition_controller_async(self, parent_window: typing.Optional[CoreWebView2ControllerWindowReference], /) -> windows_foundation.IAsyncOperation[CoreWebView2CompositionController]: ...
    @typing.overload
    def create_core_web_view2_composition_controller_async(self, parent_window: typing.Optional[CoreWebView2ControllerWindowReference], options: typing.Optional[CoreWebView2ControllerOptions], /) -> windows_foundation.IAsyncOperation[CoreWebView2CompositionController]: ...
    @typing.overload
    def create_core_web_view2_controller_async(self, parent_window: typing.Optional[CoreWebView2ControllerWindowReference], /) -> windows_foundation.IAsyncOperation[CoreWebView2Controller]: ...
    @typing.overload
    def create_core_web_view2_controller_async(self, parent_window: typing.Optional[CoreWebView2ControllerWindowReference], options: typing.Optional[CoreWebView2ControllerOptions], /) -> windows_foundation.IAsyncOperation[CoreWebView2Controller]: ...
    ...
    def create_web_file_system_directory_handle(self, path: str, permission: CoreWebView2FileSystemHandlePermission, /) -> typing.Optional[CoreWebView2FileSystemHandle]: ...
    def create_web_file_system_file_handle(self, path: str, permission: CoreWebView2FileSystemHandlePermission, /) -> typing.Optional[CoreWebView2FileSystemHandle]: ...
    def create_web_resource_request(self, uri: str, method: str, post_data: typing.Optional[windows_storage_streams.IRandomAccessStream], headers: str, /) -> typing.Optional[CoreWebView2WebResourceRequest]: ...
    def create_web_resource_response(self, content: typing.Optional[windows_storage_streams.IRandomAccessStream], status_code: winrt.system.Int32, reason_phrase: str, headers: str, /) -> typing.Optional[CoreWebView2WebResourceResponse]: ...
    def get_process_extended_infos_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[CoreWebView2ProcessExtendedInfo]]: ...
    def get_process_infos(self) -> typing.Optional[windows_foundation_collections.IVectorView[CoreWebView2ProcessInfo]]: ...
...
class CoreWebView2EnvironmentOptions(winrt.system.Object):
    ...
    @_property
    def custom_scheme_registrations(self) -> typing.Optional[windows_foundation_collections.IVector[CoreWebView2CustomSchemeRegistration]]: ...
    @custom_scheme_registrations.setter
    def custom_scheme_registrations(self, value: typing.Optional[windows_foundation_collections.IVector[CoreWebView2CustomSchemeRegistration]]) -> None: ...
    @_property
...
class CoreWebView2ExecuteScriptResult(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> CoreWebView2ExecuteScriptResult: ...
    def try_get_result_as_string(self) -> typing.Tuple[winrt.system.Int32, str]: ...
    @_property
    def exception(self) -> typing.Optional[CoreWebView2ScriptException]: ...
    @_property
...
class CoreWebView2FileSystemHandle(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> CoreWebView2FileSystemHandle: ...
    @_property
...
class CoreWebView2Frame(winrt.system.Object):
    ...
    def remove_content_loading(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_d_o_m_content_loaded(self, handler: windows_foundation.TypedEventHandler[CoreWebView2Frame, CoreWebView2DOMContentLoadedEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_d_o_m_content_loaded(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
...
class CoreWebView2FrameInfo(winrt.system.Object):
    ...
    @_property
    def parent_frame_info(self) -> typing.Optional[CoreWebView2FrameInfo]: ...
...
class CoreWebView2HttpHeadersCollectionIterator(winrt.system.Object):
    ...
    def get_many(self, items: winrt.system.Array[windows_foundation_collections.IKeyValuePair[str, str]], /) -> winrt.system.UInt32: ...
    def move_next(self) -> bool: ...
    @_property
    def current(self) -> typing.Optional[windows_foundation_collections.IKeyValuePair[str, str]]: ...
    @_property
    def has_current(self) -> bool: ...

@typing.final
class CoreWebView2HttpRequestHeaders(winrt.system.Object):
    def __iter__(self) -> windows_foundation_collections.IIterator[windows_foundation_collections.IKeyValuePair[str, str]]: ...
    @staticmethod
...
class CoreWebView2NewWindowRequestedEventArgs(winrt.system.Object):
    ...
    def name(self) -> str: ...
    @_property
    def original_source_frame_info(self) -> typing.Optional[CoreWebView2FrameInfo]: ...

@typing.final
class CoreWebView2NonClientRegionChangedEventArgs(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> CoreWebView2NonClientRegionChangedEventArgs: ...
    @_property
...
class CoreWebView2Notification(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> CoreWebView2Notification: ...
    ...
    def title(self) -> str: ...
    @_property
    def vibration_pattern(self) -> typing.Optional[windows_foundation_collections.IVectorView[winrt.system.UInt64]]: ...

@typing.final
class CoreWebView2NotificationReceivedEventArgs(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> CoreWebView2NotificationReceivedEventArgs: ...
    def get_deferral(self) -> typing.Optional[windows_foundation.Deferral]: ...
    @_property
    def handled(self) -> bool: ...
    @handled.setter
    def handled(self, value: bool) -> None: ...
    @_property
    def notification(self) -> typing.Optional[CoreWebView2Notification]: ...
    @_property
...
class CoreWebView2ProcessExtendedInfo(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> CoreWebView2ProcessExtendedInfo: ...
    @_property
    def associated_frame_infos(self) -> typing.Optional[windows_foundation_collections.IVectorView[CoreWebView2FrameInfo]]: ...
    @_property
    def process_info(self) -> typing.Optional[CoreWebView2ProcessInfo]: ...
...
class CoreWebView2ProcessFailedEventArgs(winrt.system.Object):
    ...
    @_property
    def frame_infos_for_failed_process(self) -> typing.Optional[windows_foundation_collections.IVectorView[CoreWebView2FrameInfo]]: ...
    @_property
...
class CoreWebView2Profile(winrt.system.Object):
    ...
    def get_browser_extensions_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[CoreWebView2BrowserExtension]]: ...
    def get_non_default_permission_settings_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[CoreWebView2PermissionSetting]]: ...
...
class CoreWebView2SaveAsUIShowingEventArgs(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> CoreWebView2SaveAsUIShowingEventArgs: ...
    def get_deferral(self) -> typing.Optional[windows_foundation.Deferral]: ...
    @_property
...
class CoreWebView2ScriptException(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> CoreWebView2ScriptException: ...
    @_property
...
class CoreWebView2SharedBuffer(winrt.system.Object):
    ...
    def close(self) -> None: ...
    def open_stream(self) -> typing.Optional[windows_storage_streams.IRandomAccessStream]: ...
    @_property
    def size(self) -> winrt.system.UInt64: ...
    @_property
    def buffer(self) -> typing.Optional[windows_foundation.IMemoryBufferReference]: ...
...
class CoreWebView2WebMessageReceivedEventArgs(winrt.system.Object):
    ...
    @_property
    def additional_objects(self) -> typing.Optional[windows_foundation_collections.IVectorView[winrt.system.Object]]: ...
...
class CoreWebView2WebResourceRequest(winrt.system.Object):
    ...
    @_property
    def content(self) -> typing.Optional[windows_storage_streams.IRandomAccessStream]: ...
    @content.setter
    def content(self, value: typing.Optional[windows_storage_streams.IRandomAccessStream]) -> None: ...
    @_property
