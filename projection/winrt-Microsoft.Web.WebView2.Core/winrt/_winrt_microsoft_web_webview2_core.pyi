...
class CoreWebView2Certificate(winrt.system.Object):
    ...
    def issuer(self) -> str: ...
    @_property
    def pem_encoded_issuer_certificate_chain(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
...
class CoreWebView2ClientCertificateRequestedEventArgs(winrt.system.Object):
    ...
    def cancel(self, value: bool) -> None: ...
    @_property
    def allowed_certificate_authorities(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def host(self) -> str: ...
    @_property
    def is_proxy(self) -> bool: ...
    @_property
    def mutually_trusted_certificates(self) -> windows_foundation_collections.IVectorView[CoreWebView2ClientCertificate]: ...
    @_property
...
class CoreWebView2CompositionController(winrt.system.Object):
    ...
    def close(self) -> None: ...
    def drag_enter(self, drag_info: windows_applicationmodel_datatransfer_dragdrop_core.CoreDragInfo, drag_u_i_override: windows_applicationmodel_datatransfer_dragdrop_core.CoreDragUIOverride, /) -> windows_applicationmodel_datatransfer.DataPackageOperation: ...
    def drag_leave(self) -> None: ...
    def drag_over(self, drag_info: windows_applicationmodel_datatransfer_dragdrop_core.CoreDragInfo, drag_u_i_override: windows_applicationmodel_datatransfer_dragdrop_core.CoreDragUIOverride, /) -> windows_applicationmodel_datatransfer.DataPackageOperation: ...
    ...
    def query_non_client_region(self, kind: CoreWebView2NonClientRegionKind, /) -> windows_foundation_collections.IVectorView[windows_foundation.Rect]: ...
    ...
    @_property
    def core_web_view2(self) -> CoreWebView2: ...
    @_property
...
class CoreWebView2ContextMenuItem(winrt.system.Object):
    ...
    @_property
    def children(self) -> windows_foundation_collections.IVector[CoreWebView2ContextMenuItem]: ...
    @_property
...
class CoreWebView2ContextMenuRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def menu_items(self) -> windows_foundation_collections.IVector[CoreWebView2ContextMenuItem]: ...
...
class CoreWebView2CustomSchemeRegistration(winrt.system.Object):
    ...
    @_property
    def allowed_origins(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
...
class CoreWebView2Environment_Static(type):
    ...
    def create_with_options_async(cls, browser_executable_folder: str, user_data_folder: str, options: CoreWebView2EnvironmentOptions, /) -> windows_foundation.IAsyncOperation[CoreWebView2Environment]: ...
...
class CoreWebView2Environment(winrt.system.Object, metaclass=CoreWebView2Environment_Static):
    ...
    @typing.overload
    def create_core_web_view2_composition_controller_async(self, parent_window: CoreWebView2ControllerWindowReference, /) -> windows_foundation.IAsyncOperation[CoreWebView2CompositionController]: ...
    @typing.overload
    def create_core_web_view2_composition_controller_async(self, parent_window: CoreWebView2ControllerWindowReference, options: CoreWebView2ControllerOptions, /) -> windows_foundation.IAsyncOperation[CoreWebView2CompositionController]: ...
    @typing.overload
    def create_core_web_view2_controller_async(self, parent_window: CoreWebView2ControllerWindowReference, /) -> windows_foundation.IAsyncOperation[CoreWebView2Controller]: ...
    @typing.overload
    def create_core_web_view2_controller_async(self, parent_window: CoreWebView2ControllerWindowReference, options: CoreWebView2ControllerOptions, /) -> windows_foundation.IAsyncOperation[CoreWebView2Controller]: ...
    def create_core_web_view2_controller_options(self) -> CoreWebView2ControllerOptions: ...
    def create_core_web_view2_pointer_info(self) -> CoreWebView2PointerInfo: ...
    ...
    def get_process_infos(self) -> windows_foundation_collections.IVectorView[CoreWebView2ProcessInfo]: ...
...
class CoreWebView2EnvironmentOptions(winrt.system.Object):
    ...
    @_property
    def custom_scheme_registrations(self) -> windows_foundation_collections.IVector[CoreWebView2CustomSchemeRegistration]: ...
    @custom_scheme_registrations.setter
    def custom_scheme_registrations(self, value: windows_foundation_collections.IVector[CoreWebView2CustomSchemeRegistration]) -> None: ...
    @_property
...
class CoreWebView2Notification(winrt.system.Object):
    ...
    def title(self) -> str: ...
    @_property
    def vibration_pattern(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt64]: ...
...
class CoreWebView2ProcessExtendedInfo(winrt.system.Object):
    ...
    @_property
    def associated_frame_infos(self) -> windows_foundation_collections.IVectorView[CoreWebView2FrameInfo]: ...
    @_property
...
class CoreWebView2ProcessFailedEventArgs(winrt.system.Object):
    ...
    @_property
    def frame_infos_for_failed_process(self) -> windows_foundation_collections.IVectorView[CoreWebView2FrameInfo]: ...
    @_property
...
class CoreWebView2WebMessageReceivedEventArgs(winrt.system.Object):
    ...
    @_property
    def additional_objects(self) -> windows_foundation_collections.IVectorView[winrt.system.Object]: ...
