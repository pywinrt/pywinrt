...
class GameList_Static(type):
    ...
    def merge_entries_async(cls, left: typing.Optional[GameListEntry], right: typing.Optional[GameListEntry], /) -> windows_foundation.IAsyncOperation[GameListEntry]: ...
    def unmerge_entry_async(cls, merged_entry: typing.Optional[GameListEntry], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[GameListEntry]]: ...
    def add_game_added(cls, handler: typing.Optional[GameListChangedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_game_added(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_game_removed(cls, handler: typing.Optional[GameListRemovedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_game_removed(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_game_updated(cls, handler: typing.Optional[GameListChangedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
...
class GameListEntry(winrt.system.Object):
    ...
    def set_launcher_executable_file_async(self, executable_file: typing.Optional[windows_storage.IStorageFile], /) -> windows_foundation.IAsyncAction: ...
    def set_launcher_executable_file_with_params_async(self, executable_file: typing.Optional[windows_storage.IStorageFile], launch_params: str, /) -> windows_foundation.IAsyncAction: ...
    ...
    @_property
    def launcher_executable(self) -> typing.Optional[windows_storage.IStorageFile]: ...
    @_property
...
class GameModeConfiguration(winrt.system.Object):
    ...
    @_property
    def related_process_names(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class GameModeUserConfiguration(winrt.system.Object, metaclass=GameModeUserConfiguration_Static):
    ...
    def save_async(self) -> windows_foundation.IAsyncAction: ...
    @_property
    def gaming_related_process_names(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
