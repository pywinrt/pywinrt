...
class GameList_Static(type):
    ...
    @typing.overload
    def find_all_async(cls, package_family_name: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[GameListEntry]]: ...
...
class GameListEntry(winrt.system.Object):
    ...
    @typing.overload
    def set_launcher_executable_file_async(self, executable_file: typing.Optional[windows_storage.IStorageFile], launch_params: str, /) -> windows_foundation.IAsyncAction: ...
