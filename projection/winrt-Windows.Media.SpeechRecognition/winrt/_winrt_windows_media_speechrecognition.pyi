...
class SpeechRecognitionGrammarFileConstraint(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SpeechRecognitionGrammarFileConstraint], file: typing.Optional[windows_storage.StorageFile]) -> SpeechRecognitionGrammarFileConstraint: ...
    @typing.overload
    def __new__(cls: typing.Type[SpeechRecognitionGrammarFileConstraint], file: typing.Optional[windows_storage.StorageFile], tag: str) -> SpeechRecognitionGrammarFileConstraint: ...
    @_property
    def tag(self) -> str: ...
    @tag.setter
    ...
    @_property
    def grammar_file(self) -> typing.Optional[windows_storage.StorageFile]: ...
...
class SpeechRecognitionListConstraint(winrt.system.Object):
    ...
    def type(self) -> SpeechRecognitionConstraintType: ...
    @_property
    def commands(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class SpeechRecognitionResult(winrt.system.Object):
    ...
    def get_alternates(self, max_alternates: winrt.system.UInt32, /) -> typing.Optional[windows_foundation_collections.IVectorView[SpeechRecognitionResult]]: ...
    @_property
    ...
    @_property
    def rule_path(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
...
class SpeechRecognizer_Static(type):
    def try_set_system_speech_language_async(cls, speech_language: typing.Optional[windows_globalization.Language], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @_property
    def supported_grammar_languages(cls) -> typing.Optional[windows_foundation_collections.IVectorView[windows_globalization.Language]]: ...
    @_property
    def supported_topic_languages(cls) -> typing.Optional[windows_foundation_collections.IVectorView[windows_globalization.Language]]: ...
    @_property
    def system_speech_language(cls) -> typing.Optional[windows_globalization.Language]: ...
...
class SpeechRecognizer(winrt.system.Object, metaclass=SpeechRecognizer_Static):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SpeechRecognizer], language: typing.Optional[windows_globalization.Language]) -> SpeechRecognizer: ...
    @typing.overload
    ...
    def recognize_with_u_i_async(self) -> windows_foundation.IAsyncOperation[SpeechRecognitionResult]: ...
    ...
    @_property
    def constraints(self) -> typing.Optional[windows_foundation_collections.IVector[ISpeechRecognitionConstraint]]: ...
    @_property
    def current_language(self) -> typing.Optional[windows_globalization.Language]: ...
    @_property
...
class VoiceCommandManager_Static(type):
    def install_command_sets_from_storage_file_async(cls, file: typing.Optional[windows_storage.StorageFile], /) -> windows_foundation.IAsyncAction: ...
    @_property
    def installed_command_sets(cls) -> typing.Optional[windows_foundation_collections.IMapView[str, VoiceCommandSet]]: ...
