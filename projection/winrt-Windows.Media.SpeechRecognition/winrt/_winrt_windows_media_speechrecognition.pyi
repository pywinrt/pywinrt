...
class SpeechRecognitionGrammarFileConstraint(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SpeechRecognitionGrammarFileConstraint], file: windows_storage.StorageFile) -> SpeechRecognitionGrammarFileConstraint: ...
    @typing.overload
    def __new__(cls: typing.Type[SpeechRecognitionGrammarFileConstraint], file: windows_storage.StorageFile, tag: str) -> SpeechRecognitionGrammarFileConstraint: ...
    @_property
    def tag(self) -> str: ...
    @tag.setter
...
class SpeechRecognitionListConstraint(winrt.system.Object):
    ...
    def type(self) -> SpeechRecognitionConstraintType: ...
    @_property
    def commands(self) -> windows_foundation_collections.IVector[str]: ...
...
class SpeechRecognitionResult(winrt.system.Object):
    ...
    def get_alternates(self, max_alternates: winrt.system.UInt32, /) -> windows_foundation_collections.IVectorView[SpeechRecognitionResult]: ...
    @_property
    ...
    @_property
    def rule_path(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
...
class SpeechRecognitionSemanticInterpretation(winrt.system.Object):
    ...
    @_property
    def properties(self) -> windows_foundation_collections.IMapView[str, windows_foundation_collections.IVectorView[str]]: ...
...
class SpeechRecognizer_Static(type):
    ...
    @_property
    def supported_grammar_languages(cls) -> windows_foundation_collections.IVectorView[windows_globalization.Language]: ...
    @_property
    def supported_topic_languages(cls) -> windows_foundation_collections.IVectorView[windows_globalization.Language]: ...
    @_property
...
class SpeechRecognizer(winrt.system.Object, metaclass=SpeechRecognizer_Static):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SpeechRecognizer], language: windows_globalization.Language) -> SpeechRecognizer: ...
    @typing.overload
    ...
    @_property
    def constraints(self) -> windows_foundation_collections.IVector[ISpeechRecognitionConstraint]: ...
    @_property
    def current_language(self) -> windows_globalization.Language: ...
    @_property
    def timeouts(self) -> SpeechRecognizerTimeouts: ...
    @_property
    def u_i_options(self) -> SpeechRecognizerUIOptions: ...
    @_property
...
class VoiceCommandManager_Static(type):
    ...
    @_property
    def installed_command_sets(cls) -> windows_foundation_collections.IMapView[str, VoiceCommandSet]: ...
