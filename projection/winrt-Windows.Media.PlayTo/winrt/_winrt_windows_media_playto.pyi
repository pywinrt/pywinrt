...
class PlayToConnection(winrt.system.Object):
    ...
    def remove_error(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_transferred(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
...
class PlayToManager(winrt.system.Object, metaclass=PlayToManager_Static):
    ...
    def remove_source_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_source_selected(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
...
class PlayToReceiver(winrt.system.Object):
    ...
    def remove_current_time_change_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_mute_change_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_pause_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_play_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_source_change_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_stop_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_time_update_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_volume_change_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
...
class SourceChangeRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def stream(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamWithContentType]: ...
    @_property
