...
class VoiceCommandDefinitionManager_Static(type):
    ...
    @_property
    def installed_command_definitions(cls) -> windows_foundation_collections.IMapView[str, VoiceCommandDefinition]: ...
...
class VoiceCommandResponse(winrt.system.Object, metaclass=VoiceCommandResponse_Static):
    ...
    def app_launch_argument(self, value: str) -> None: ...
    @_property
    def voice_command_content_tiles(self) -> windows_foundation_collections.IVector[VoiceCommandContentTile]: ...
