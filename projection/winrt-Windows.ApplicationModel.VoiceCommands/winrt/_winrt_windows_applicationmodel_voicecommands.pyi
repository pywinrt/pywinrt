...
class VoiceCommandResponse_Static(type):
    ...
    def create_response_for_prompt_with_tiles(cls, message: typing.Optional[VoiceCommandUserMessage], repeat_message: typing.Optional[VoiceCommandUserMessage], content_tiles: typing.Iterable[VoiceCommandContentTile], /) -> typing.Optional[VoiceCommandResponse]: ...
    def create_response_with_tiles(cls, message: typing.Optional[VoiceCommandUserMessage], content_tiles: typing.Iterable[VoiceCommandContentTile], /) -> typing.Optional[VoiceCommandResponse]: ...
    @_property
