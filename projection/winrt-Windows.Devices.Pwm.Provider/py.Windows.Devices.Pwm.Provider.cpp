...
PyMODINIT_FUNC PyInit__winrt_windows_devices_pwm_provider(void) noexcept
{
    ...
    py::pyobj_handle IPwmControllerProvider_type{py::register_python_type(module.get(), &type_spec_IPwmControllerProvider, object_bases.get(), nullptr)};
    if (!IPwmControllerProvider_type)
    {
        return nullptr;
    }

    py::pyobj_handle IPwmProvider_type{py::register_python_type(module.get(), &type_spec_IPwmProvider, object_bases.get(), nullptr)};
