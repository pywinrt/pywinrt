...
class ResourceLoader_Static(type):
    ...
    def get_for_current_view_with_name(cls, name: str, /) -> typing.Optional[ResourceLoader]: ...
    def get_for_u_i_context(cls, context: typing.Optional[windows_ui.UIContext], /) -> typing.Optional[ResourceLoader]: ...
    def get_for_view_independent_use(cls) -> typing.Optional[ResourceLoader]: ...
    def get_for_view_independent_use_with_name(cls, name: str, /) -> typing.Optional[ResourceLoader]: ...
    def get_string_for_reference(cls, uri: typing.Optional[windows_foundation.Uri], /) -> str: ...
...
class ResourceLoader(winrt.system.Object, metaclass=ResourceLoader_Static):
    ...
    def get_string_for_uri(self, uri: typing.Optional[windows_foundation.Uri], /) -> str: ...
