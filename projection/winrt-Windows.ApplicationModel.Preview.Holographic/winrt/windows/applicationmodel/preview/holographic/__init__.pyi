...
class HolographicApplicationPreview(winrt.system.Object):
    ...
    @staticmethod
    def is_current_view_presented_on_holographic_display() -> winrt.system.Boolean: ...
    @staticmethod
    def is_holographic_activation(activated_event_args: typing.Optional[winrt.windows.applicationmodel.activation.IActivatedEventArgs], /) -> winrt.system.Boolean: ...
