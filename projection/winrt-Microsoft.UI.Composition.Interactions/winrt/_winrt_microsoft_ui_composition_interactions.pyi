...
class CompositionConditionalValue(winrt.system.Object, metaclass=CompositionConditionalValue_Static):
    ...
    def start_animation(self, property_name: str, animation: microsoft_ui_composition.CompositionAnimation, /) -> None: ...
    def start_animation_group(self, value: microsoft_ui_composition.ICompositionAnimationBase, /) -> None: ...
    def start_animation_with_controller(self, property_name: str, animation: microsoft_ui_composition.CompositionAnimation, animation_controller: microsoft_ui_composition.AnimationController, /) -> None: ...
    def stop_animation(self, property_name: str, /) -> None: ...
    def stop_animation_group(self, value: microsoft_ui_composition.ICompositionAnimationBase, /) -> None: ...
    def try_get_animation_controller(self, property_name: str, /) -> microsoft_ui_composition.AnimationController: ...
    @_property
    ...
    @_property
    def properties(self) -> microsoft_ui_composition.CompositionPropertySet: ...
    @_property
    def implicit_animations(self) -> microsoft_ui_composition.ImplicitAnimationCollection: ...
    @implicit_animations.setter
    def implicit_animations(self, value: microsoft_ui_composition.ImplicitAnimationCollection) -> None: ...
    @_property
