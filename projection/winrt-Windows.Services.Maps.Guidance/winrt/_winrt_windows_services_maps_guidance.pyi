...
class GuidanceNavigator(winrt.system.Object, metaclass=GuidanceNavigator_Static):
    ...
    @typing.overload
    def update_user_location(self, user_location: typing.Optional[windows_devices_geolocation.Geocoordinate], position_override: windows_devices_geolocation.BasicGeoposition, /) -> None: ...
