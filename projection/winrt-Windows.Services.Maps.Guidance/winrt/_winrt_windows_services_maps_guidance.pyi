...
class GuidanceAudioNotificationRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def audio_file_paths(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
...
class GuidanceNavigator(winrt.system.Object, metaclass=GuidanceNavigator_Static):
    ...
    def update_user_location_with_position_override(self, user_location: windows_devices_geolocation.Geocoordinate, position_override: windows_devices_geolocation.BasicGeoposition, /) -> None: ...
...
class GuidanceRoadSignpost(winrt.system.Object):
    ...
    def exit(self) -> str: ...
    @_property
    def exit_directions(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
...
class GuidanceRoute_Static(type):
    ...
    def try_create_from_map_route(cls, map_route: windows_services_maps.MapRoute, /) -> GuidanceRoute: ...
...
class GuidanceRoute(winrt.system.Object, metaclass=GuidanceRoute_Static):
    ...
    @_property
    def maneuvers(self) -> windows_foundation_collections.IVectorView[GuidanceManeuver]: ...
    @_property
    def path(self) -> windows_devices_geolocation.Geopath: ...
    @_property
    def road_segments(self) -> windows_foundation_collections.IVectorView[GuidanceRoadSegment]: ...
...
class GuidanceUpdatedEventArgs(winrt.system.Object):
    ...
    @_property
    def lane_info(self) -> windows_foundation_collections.IVectorView[GuidanceLaneInfo]: ...
    @_property
