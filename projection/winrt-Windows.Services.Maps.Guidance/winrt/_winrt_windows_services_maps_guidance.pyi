...
class GuidanceAudioNotificationRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def audio_file_paths(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
...
class GuidanceManeuver(winrt.system.Object):
    ...
    @_property
    def start_location(self) -> typing.Optional[windows_devices_geolocation.Geopoint]: ...
...
class GuidanceNavigator(winrt.system.Object, metaclass=GuidanceNavigator_Static):
    ...
    def stop(self) -> None: ...
    def update_user_location(self, user_location: typing.Optional[windows_devices_geolocation.Geocoordinate], /) -> None: ...
    def update_user_location_with_position_override(self, user_location: typing.Optional[windows_devices_geolocation.Geocoordinate], position_override: windows_devices_geolocation.BasicGeoposition, /) -> None: ...
    ...
    def remove_destination_reached(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_guidance_updated(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_reroute_failed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_rerouted(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_rerouting(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_user_location_lost(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_user_location_restored(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_audio_notification_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
...
class GuidanceRoadSignpost(winrt.system.Object):
    ...
    def exit(self) -> str: ...
    @_property
    def exit_directions(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
...
class GuidanceRoute_Static(type):
    def can_create_from_map_route(cls, map_route: typing.Optional[windows_services_maps.MapRoute], /) -> bool: ...
    def try_create_from_map_route(cls, map_route: typing.Optional[windows_services_maps.MapRoute], /) -> typing.Optional[GuidanceRoute]: ...

@typing.final
class GuidanceRoute(winrt.system.Object, metaclass=GuidanceRoute_Static):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> GuidanceRoute: ...
    def convert_to_map_route(self) -> typing.Optional[windows_services_maps.MapRoute]: ...
    @_property
    def bounding_box(self) -> typing.Optional[windows_devices_geolocation.GeoboundingBox]: ...
    @_property
    def distance(self) -> winrt.system.Int32: ...
    @_property
    def duration(self) -> datetime.timedelta: ...
    @_property
    def maneuvers(self) -> typing.Optional[windows_foundation_collections.IVectorView[GuidanceManeuver]]: ...
    @_property
    def path(self) -> typing.Optional[windows_devices_geolocation.Geopath]: ...
    @_property
    def road_segments(self) -> typing.Optional[windows_foundation_collections.IVectorView[GuidanceRoadSegment]]: ...
...
class GuidanceUpdatedEventArgs(winrt.system.Object):
    ...
    @_property
    def lane_info(self) -> typing.Optional[windows_foundation_collections.IVectorView[GuidanceLaneInfo]]: ...
    @_property
