...
namespace py::cpp::Microsoft::UI::Xaml::Navigation
{
    ...
    using BasePyWinrtFrameNavigationOptions = winrt::Microsoft::UI::Xaml::Navigation::FrameNavigationOptionsT<PyWinrtFrameNavigationOptions, py::IPywinrtObject>;
    ...
    static PyObject* FrameNavigationOptions_get_TransitionInfoOverride(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, void* /*unused*/) noexcept
    {
        try
        {
            return py::convert([&]()
            {
                ...
                return py::require<winrt::Microsoft::UI::Xaml::Navigation::IFrameNavigationOptions>(self->obj, py::member_kind::property, "Microsoft.UI.Xaml.Navigation.FrameNavigationOptions", "TransitionInfoOverride", "Microsoft.UI.Xaml.Navigation.IFrameNavigationOptions").TransitionInfoOverride();
            }());
        }
        catch (...)
        {
    ...
    static int FrameNavigationOptions_put_TransitionInfoOverride(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* arg, void* /*unused*/) noexcept
    {
        ...
        try
        {
            ...
            {
                auto _gil = release_gil();
                py::require<winrt::Microsoft::UI::Xaml::Navigation::IFrameNavigationOptions>(self->obj, py::member_kind::property, "Microsoft.UI.Xaml.Navigation.FrameNavigationOptions", "TransitionInfoOverride", "Microsoft.UI.Xaml.Navigation.IFrameNavigationOptions").TransitionInfoOverride(param0);
            }
    ...
    static PyObject* FrameNavigationOptions_get_IsNavigationStackEnabled(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Microsoft::UI::Xaml::Navigation::IFrameNavigationOptions>(self->obj, py::member_kind::property, "Microsoft.UI.Xaml.Navigation.FrameNavigationOptions", "IsNavigationStackEnabled", "Microsoft.UI.Xaml.Navigation.IFrameNavigationOptions").IsNavigationStackEnabled();
            }());
        }
        catch (...)
        {
    ...
    static int FrameNavigationOptions_put_IsNavigationStackEnabled(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* arg, void* /*unused*/) noexcept
    {
        ...
        try
        {
            ...
            {
                auto _gil = release_gil();
                py::require<winrt::Microsoft::UI::Xaml::Navigation::IFrameNavigationOptions>(self->obj, py::member_kind::property, "Microsoft.UI.Xaml.Navigation.FrameNavigationOptions", "IsNavigationStackEnabled", "Microsoft.UI.Xaml.Navigation.IFrameNavigationOptions").IsNavigationStackEnabled(param0);
            }
    ...
    static PyType_Spec type_spec_FrameNavigationOptions = {
        "winui3._winui3_microsoft_ui_xaml_navigation.FrameNavigationOptions",
    ...
    static PyType_Spec type_spec_FrameNavigationOptions_Static = {
        "winui3._winui3_microsoft_ui_xaml_navigation.FrameNavigationOptions_Static",
    ...
    static PyType_Spec type_spec_NavigatingCancelEventArgs = {
        "winui3._winui3_microsoft_ui_xaml_navigation.NavigatingCancelEventArgs",
    ...
    static PyType_Spec type_spec_NavigationEventArgs = {
        "winui3._winui3_microsoft_ui_xaml_navigation.NavigationEventArgs",
    ...
    static PyType_Spec type_spec_NavigationFailedEventArgs = {
        "winui3._winui3_microsoft_ui_xaml_navigation.NavigationFailedEventArgs",
    ...
    static PyObject* PageStackEntry_get_SourcePageTypeProperty(PyObject* /*unused*/, void* /*unused*/) noexcept
    {
        ...
        try
        {
            ...
            {
                auto _gil = release_gil();
                return winrt::Microsoft::UI::Xaml::Navigation::PageStackEntry::SourcePageTypeProperty();
            }());
        }
        catch (...)
        {
    ...
    static PyType_Spec type_spec_PageStackEntry = {
        "winui3._winui3_microsoft_ui_xaml_navigation.PageStackEntry",
    ...
    static PyType_Spec type_spec_PageStackEntry_Static = {
        "winui3._winui3_microsoft_ui_xaml_navigation.PageStackEntry_Static",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
    ...
    static PyModuleDef module_def = {
        ...
        "_winui3_microsoft_ui_xaml_navigation",
        module_doc,
        0,
        nullptr,
        nullptr,
...
PyMODINIT_FUNC PyInit__winui3_microsoft_ui_xaml_navigation(void) noexcept
{
