...
class PrintDocument(microsoft_ui_xaml.DependencyObject, metaclass=PrintDocument_Static):
    ...
    def remove_add_pages(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_get_preview_page(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_paginate(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
AddPagesEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, AddPagesEventArgs], None]
GetPreviewPageEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, GetPreviewPageEventArgs], None]
PaginateEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, PaginateEventArgs], None]
