...
class WidgetResourceRequest(winrt.system.Object):
    ...
    @_property
    def headers(self) -> _cabc.MutableMapping[str, str]: ...
...
class WidgetUpdateRequestOptions(winrt.system.Object, metaclass=WidgetUpdateRequestOptions_Static):
    ...
    @_property
    def is_placeholder_content(self) -> bool | None: ...
    ...
    @rank.setter
    def rank(self, value: winrt.system.Int32 | None) -> None: ...
