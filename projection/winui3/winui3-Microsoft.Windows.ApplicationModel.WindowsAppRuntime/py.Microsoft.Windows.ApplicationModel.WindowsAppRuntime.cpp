...
namespace py::cpp::Microsoft::Windows::ApplicationModel::WindowsAppRuntime
{
    ...
    static PyObject* DeploymentManager_GetStatus(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.ApplicationModel.WindowsAppRuntime.DeploymentManager", "GetStatus", nullptr, py::site_is_static};
    ...
    static PyObject* DeploymentManager_Initialize(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.ApplicationModel.WindowsAppRuntime.DeploymentManager", "Initialize", nullptr, py::site_is_static};
        ...
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Microsoft.Windows.ApplicationModel.WindowsAppRuntime.DeploymentManager", "Initialize", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Microsoft.Windows.ApplicationModel.WindowsAppRuntime.ReleaseInfo", "AsString", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Microsoft.Windows.ApplicationModel.WindowsAppRuntime.ReleaseInfo", "Major", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Microsoft.Windows.ApplicationModel.WindowsAppRuntime.ReleaseInfo", "Minor", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Microsoft.Windows.ApplicationModel.WindowsAppRuntime.ReleaseInfo", "Patch", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Microsoft.Windows.ApplicationModel.WindowsAppRuntime.ReleaseInfo", "VersionTag", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Microsoft.Windows.ApplicationModel.WindowsAppRuntime.RuntimeInfo", "AsString", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Microsoft.Windows.ApplicationModel.WindowsAppRuntime.RuntimeInfo", "Version", nullptr, py::site_is_static};
