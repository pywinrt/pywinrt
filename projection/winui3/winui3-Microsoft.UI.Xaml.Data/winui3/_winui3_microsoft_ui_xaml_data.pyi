...
class ICollectionView(windows_foundation_collections.IObservableVector[winrt.system.Object], windows_foundation_collections.IVector[winrt.system.Object], windows_foundation_collections.IIterable[winrt.system.Object], winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def remove_current_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @abstractmethod
    def remove_current_changing(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ICustomPropertyProvider(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def get_indexed_property(self, name: str, type: windows_ui_xaml_interop.TypeName | tuple[str, windows_ui_xaml_interop.TypeKind], /) -> ICustomProperty: ...
...
class INotifyDataErrorInfo(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def remove_errors_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ISelectionInfo(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def get_selected_ranges(self) -> _cabc.Sequence[ItemIndexRange]: ...
