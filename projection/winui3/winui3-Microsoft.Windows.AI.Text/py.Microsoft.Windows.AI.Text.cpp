...
namespace py::cpp::Microsoft::Windows::AI::Text
{
            ...
            {
                {
                    ...
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Microsoft.Windows.AI.Text.LanguageModel", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
    ...
    static PyObject* LanguageModel_CreateAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Text.LanguageModel", "CreateAsync", nullptr, py::site_is_static};
    ...
    static PyObject* LanguageModel_EnsureReadyAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Text.LanguageModel", "EnsureReadyAsync", nullptr, py::site_is_static};
    ...
    static PyObject* LanguageModel_GetReadyState(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Text.LanguageModel", "GetReadyState", nullptr, py::site_is_static};
    ...
    static PyObject* LanguageModelContext_Close(py::wrapper::Microsoft::Windows::AI::Text::LanguageModelContext* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Microsoft.Windows.AI.Text.LanguageModelContext", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
