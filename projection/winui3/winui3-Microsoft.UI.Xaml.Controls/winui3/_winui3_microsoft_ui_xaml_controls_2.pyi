...
class DatePickerFlyout(microsoft_ui_xaml_controls_primitives.PickerFlyoutBase, metaclass=DatePickerFlyout_Static):
    ...
    def show_at_async(self, target: microsoft_ui_xaml.FrameworkElement, /) -> windows_foundation.IAsyncOperation[datetime.datetime | None]: ...
...
class ListPickerFlyout(microsoft_ui_xaml_controls_primitives.PickerFlyoutBase, metaclass=ListPickerFlyout_Static):
    ...
    def show_at_async(self, target: microsoft_ui_xaml.FrameworkElement, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[winrt.system.Object]]: ...
...
class ListViewBase(microsoft_ui_xaml_controls_primitives.Selector, ISemanticZoomInformation, metaclass=ListViewBase_Static):
    ...
    @_property
    @typing.final
    def selected_ranges(self) -> _cabc.Sequence[microsoft_ui_xaml_data.ItemIndexRange]: ...
...
class MenuFlyout(microsoft_ui_xaml_controls_primitives.FlyoutBase, metaclass=MenuFlyout_Static):
    ...
    def show_at(self, target_element: microsoft_ui_xaml.UIElement, point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...  # type: ignore[misc,override]
...
class TimePickerFlyout(microsoft_ui_xaml_controls_primitives.PickerFlyoutBase, metaclass=TimePickerFlyout_Static):
    ...
    def show_at_async(self, target: microsoft_ui_xaml.FrameworkElement, /) -> windows_foundation.IAsyncOperation[datetime.timedelta | None]: ...
