...
class PushNotificationCreateChannelStatus:
    ...
    def __new__(cls, status: PushNotificationChannelStatus = ..., extended_error: windows_foundation.HResult = ..., retry_count: winrt.system.UInt32 = 0) -> PushNotificationCreateChannelStatus: ...
    def __replace__(self, /, **changes: typing.Any) -> PushNotificationCreateChannelStatus: ...
    def unpack(self) -> tuple[PushNotificationChannelStatus, tuple[winrt.system.Int32], winrt.system.UInt32]: ...
...
class PushNotificationManager(winrt.system.Object, metaclass=PushNotificationManager_Static):
    ...
    def remove_push_received(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
