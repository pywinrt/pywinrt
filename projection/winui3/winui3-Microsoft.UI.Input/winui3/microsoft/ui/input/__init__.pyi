...
class ManipulationDelta:
    ...
    def __new__(cls, translation: windows_foundation.Point = ..., scale: winrt.system.Single = 0, rotation: winrt.system.Single = 0, expansion: winrt.system.Single = 0) -> ManipulationDelta: ...
    def __replace__(self, /, **changes: typing.Any) -> ManipulationDelta: ...
    def unpack(self) -> tuple[tuple[winrt.system.Single, winrt.system.Single], winrt.system.Single, winrt.system.Single, winrt.system.Single]: ...
...
class ManipulationVelocities:
    ...
    @_property
    def expansion(self) -> winrt.system.Single: ...
    def __new__(cls, linear: windows_foundation.Point = ..., angular: winrt.system.Single = 0, expansion: winrt.system.Single = 0) -> ManipulationVelocities: ...
...
class PhysicalKeyStatus:
    ...
    def unpack(self) -> tuple[winrt.system.UInt32, winrt.system.UInt32, bool, bool, bool, bool]: ...
...
class EnteringMoveSizeEventArgs(winrt.system.Object):
    ...
    def move_size_window_id(self, value: microsoft_ui.WindowId | tuple[winrt.system.UInt64]) -> None: ...
...
class FocusNavigationRequest_Static(winrt._winrt.IInspectable_Static):
    ...
    def create(cls, reason: FocusNavigationReason, hint_rect: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> FocusNavigationRequest: ...
    @typing.overload
...
class FocusNavigationRequest(winrt.system.Object, metaclass=FocusNavigationRequest_Static):
    ...
    @_property
    def hint_rect(self) -> windows_foundation.Rect | None: ...
...
class GestureRecognizer(winrt.system.Object):
    ...
    def process_move_events(self, value: _cabc.MutableSequence[PointerPoint], /) -> None: ...
    ...
    def remove_cross_sliding(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_dragging(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @pivot_center.setter
    def pivot_center(self, value: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
    ...
    def cross_slide_thresholds(self, value: CrossSlideThresholds | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single]) -> None: ...
...
class InputActivationListener_Static(InputObject_Static):
    ...
    def get_for_window_id(cls, window_id: microsoft_ui.WindowId | tuple[winrt.system.UInt64], /) -> InputActivationListener: ...
...
class InputActivationListener(InputObject, metaclass=InputActivationListener_Static):
    ...
    def remove_input_activation_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class InputFocusController(InputObject, metaclass=InputFocusController_Static):
    ...
    def remove_navigate_focus_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class InputFocusNavigationHost(InputObject, metaclass=InputFocusNavigationHost_Static):
    ...
    def remove_depart_focus_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class InputKeyboardSource(InputObject, metaclass=InputKeyboardSource_Static):
    ...
    def remove_context_menu_key(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_system_key_down(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_system_key_up(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class InputLightDismissAction_Static(InputObject_Static):
    ...
    def get_for_window_id(cls, window_id: microsoft_ui.WindowId | tuple[winrt.system.UInt64], /) -> InputLightDismissAction: ...
...
class InputLightDismissAction(InputObject, metaclass=InputLightDismissAction_Static):
    ...
    def remove_dismissed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class InputNonClientPointerSource(winrt.system.Object, metaclass=InputNonClientPointerSource_Static):
    ...
    def set_region_rects(self, region: NonClientRegionKind, rects: winrt.system.Array[windows_graphics.RectInt32] | winrt.system.ReadableBuffer, /) -> None: ...
    ...
    def remove_caption_tapped(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_regions_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_entered_move_size(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_entering_move_size(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_exited_move_size(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_window_rect_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_window_rect_changing(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class InputPointerSource(InputObject, metaclass=InputPointerSource_Static):
    ...
    def remove_pointer_routed_away(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_pointer_routed_released(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_pointer_routed_to(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MouseWheelParameters(winrt.system.Object):
    ...
    def page_translation(self, value: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
    ...
    def char_translation(self, value: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
...
class PointerEventArgs(winrt.system.Object):
    ...
    def get_intermediate_transformed_points(self, transform: IPointerPointTransform, /) -> _cabc.MutableSequence[PointerPoint]: ...
...
class WindowRectChangingEventArgs(winrt.system.Object):
    ...
    def new_window_rect(self, value: windows_graphics.RectInt32 | tuple[winrt.system.Int32, winrt.system.Int32, winrt.system.Int32, winrt.system.Int32]) -> None: ...
...
class IPointerPointTransform(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def try_transform_bounds(self, in_rect: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> tuple[bool, windows_foundation.Rect]: ...
