...
class AppNotificationActivatedEventArgs(winrt.system.Object):
    ...
    @_property
    def user_input(self) -> _cabc.MutableMapping[str, str]: ...
...
class AppNotificationManager(winrt.system.Object, metaclass=AppNotificationManager_Static):
    ...
    def update_async(self, data: AppNotificationProgressData, tag: str, /) -> windows_foundation.IAsyncOperation[AppNotificationProgressResult]: ...
    @typing.overload
    ...
    def remove_notification_invoked(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
