...
namespace py::cpp::Microsoft::UI::Xaml::Printing
{
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Microsoft.UI.Xaml.Printing.PrintDocument", "DocumentSourceProperty", nullptr, py::site_is_static};
