...
namespace py::cpp::Microsoft::Graphics::Display
{
    ...
    static PyObject* DisplayInformation_CreateForDisplayId(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Microsoft.Graphics.Display.DisplayInformation", "CreateForDisplayId", nullptr, py::site_is_static};
    ...
    static PyObject* DisplayInformation_CreateForWindowId(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Microsoft.Graphics.Display.DisplayInformation", "CreateForWindowId", nullptr, py::site_is_static};
