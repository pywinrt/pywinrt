...
setup(
    ...
    ext_modules=[
        Extension(
            "winui3._winui3_microsoft_windows_applicationmodel_background_universalbgtask",
            sources=["py.Microsoft.Windows.ApplicationModel.Background.UniversalBGTask.cpp"],
