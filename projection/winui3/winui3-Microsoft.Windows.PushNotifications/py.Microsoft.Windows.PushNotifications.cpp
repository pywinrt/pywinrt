...
namespace py::cpp::Microsoft::Windows::PushNotifications
{
    ...
    static PyObject* PushNotificationManager_IsSupported(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.PushNotifications.PushNotificationManager", "IsSupported", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Microsoft.Windows.PushNotifications.PushNotificationManager", "Default", nullptr, py::site_is_static};
