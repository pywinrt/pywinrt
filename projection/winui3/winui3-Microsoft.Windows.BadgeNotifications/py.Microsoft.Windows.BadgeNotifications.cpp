...
namespace py::cpp::Microsoft::Windows::BadgeNotifications
{
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Microsoft.Windows.BadgeNotifications.BadgeNotificationManager", "Current", nullptr, py::site_is_static};
