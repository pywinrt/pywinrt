...
class AppWindow_Static(winrt._winrt.IInspectable_Static):
    ...
    def create(cls, app_window_presenter: AppWindowPresenter, owner_window_id: typing.Union[microsoft_ui.WindowId, typing.Tuple[winrt.system.UInt64]], /) -> AppWindow: ...
    @typing.overload
    ...
    def create(cls, app_window_presenter: AppWindowPresenter, owner_window_id: typing.Union[microsoft_ui.WindowId, typing.Tuple[winrt.system.UInt64]], dispatcher_queue: microsoft_ui_dispatching.DispatcherQueue, /) -> AppWindow: ...
...
class AppWindow(winrt.system.Object, metaclass=AppWindow_Static):
    ...
    def move_and_resize(self, rect: typing.Union[windows_graphics.RectInt32, typing.Tuple[winrt.system.Int32, winrt.system.Int32, winrt.system.Int32, winrt.system.Int32]], displayarea: DisplayArea, /) -> None: ...
