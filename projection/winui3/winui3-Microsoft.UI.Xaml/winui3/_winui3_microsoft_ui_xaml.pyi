...
import winui3.microsoft.ui.windowing as microsoft_ui_windowing
...
import winui3.microsoft.windows.applicationmodel.resources as microsoft_windows_applicationmodel_resources
...
class Application_Static(winrt._winrt.IInspectable_Static):
    ...
    def load_component(cls, component: winrt.system.Object, resource_locator: windows_foundation.Uri, component_resource_location: microsoft_ui_xaml_controls_primitives.ComponentResourceLocation, /) -> None: ...
...
class Application(winrt.system.Object, metaclass=Application_Static):
    ...
    def remove_resource_manager_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class DebugSettings(winrt.system.Object):
    ...
    def remove_xaml_resource_reference_failed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class DragUI(winrt.system.Object):
    ...
    def set_content_from_bitmap_image(self, bitmap_image: microsoft_ui_xaml_media_imaging.BitmapImage, anchor_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
    ...
    def set_content_from_bitmap_image_with_anchor_point(self, bitmap_image: microsoft_ui_xaml_media_imaging.BitmapImage, anchor_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
...
class UIElement(DependencyObject, microsoft_ui_composition.IVisualElement2, microsoft_ui_composition.IVisualElement, microsoft_ui_composition.IAnimationObject, metaclass=UIElement_Static):
    ...
    @_property
    @typing.final
    def keyboard_accelerators(self) -> _cabc.MutableSequence[microsoft_ui_xaml_input.KeyboardAccelerator]: ...
    # Windows.Foundation.Collections.IVector`1<Microsoft.UI.Xaml.Media.XamlLight> Microsoft.UI.Xaml.UIElement::get_Lights()
    @_property
    @typing.final
    def lights(self) -> _cabc.MutableSequence[microsoft_ui_xaml_media.XamlLight]: ...
    ...
    @_property
    @typing.final
    def pointer_captures(self) -> _cabc.Sequence[microsoft_ui_xaml_input.Pointer]: ...
...
class IXamlServiceProvider(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def get_service(self, type: windows_ui_xaml_interop.TypeName | tuple[str, windows_ui_xaml_interop.TypeKind], /) -> winrt.system.Object: ...
