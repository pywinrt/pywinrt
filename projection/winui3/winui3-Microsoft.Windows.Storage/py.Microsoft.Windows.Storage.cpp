...
namespace py::cpp::Microsoft::Windows::Storage
{
    ...
    static PyObject* ApplicationData_Close(py::wrapper::Microsoft::Windows::Storage::ApplicationData* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Microsoft.Windows.Storage.ApplicationData", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
    ...
    static PyObject* ApplicationData_GetDefault(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.Storage.ApplicationData", "GetDefault", nullptr, py::site_is_static};
    ...
    static PyObject* ApplicationData_GetForPackageFamily(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Microsoft.Windows.Storage.ApplicationData", "GetForPackageFamily", nullptr, py::site_is_static};
    ...
    static PyObject* ApplicationData_GetForUser(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Microsoft.Windows.Storage.ApplicationData", "GetForUser", nullptr, py::site_is_static};
    ...
    static PyObject* ApplicationDataContainer_Close(py::wrapper::Microsoft::Windows::Storage::ApplicationDataContainer* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Microsoft.Windows.Storage.ApplicationDataContainer", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
