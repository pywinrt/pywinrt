...
namespace py::cpp::Microsoft::Windows::System
{
    ...
    static PyObject* EnvironmentManager_get_AreChangesTracked(py::wrapper::Microsoft::Windows::System::EnvironmentManager* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Microsoft::Windows::System::IEnvironmentManager2>(self->obj, py::member_kind::property, "Microsoft.Windows.System.EnvironmentManager", "AreChangesTracked", "Microsoft.Windows.System.IEnvironmentManager2").AreChangesTracked();
            }());
        }
        catch (...)
        {
