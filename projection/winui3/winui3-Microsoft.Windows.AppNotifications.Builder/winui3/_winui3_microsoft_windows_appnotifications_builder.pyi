...
class AppNotificationBuilder(winrt.system.Object, metaclass=AppNotificationBuilder_Static):
    ...
    def set_app_logo_override(self, image_uri: windows_foundation.Uri, image_crop: AppNotificationImageCrop, /) -> AppNotificationBuilder: ...
    @typing.overload
    ...
    def set_inline_image(self, image_uri: windows_foundation.Uri, image_crop: AppNotificationImageCrop, /) -> AppNotificationBuilder: ...
    @typing.overload
...
class AppNotificationButton(winrt.system.Object, metaclass=AppNotificationButton_Static):
    @typing.overload
    def __new__(cls: type[Self], content: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
    ...
    @arguments.setter
    def arguments(self, value: _cabc.MutableMapping[str, str]) -> None: ...
...
class AppNotificationComboBox(winrt.system.Object):
    ...
    @_property
    def items(self) -> _cabc.MutableMapping[str, str]: ...
    ...
    @items.setter
    def items(self, value: _cabc.MutableMapping[str, str]) -> None: ...
