...
namespace py::cpp::Microsoft::Windows::Widgets
{
    ...
    static PyModuleDef module_def = {
        ...
        "_winui3_microsoft_windows_widgets",
        module_doc,
        0,
        nullptr,
        nullptr,
...
PyMODINIT_FUNC PyInit__winui3_microsoft_windows_widgets(void) noexcept
{
    using namespace py::cpp::Microsoft::Windows::Widgets;
