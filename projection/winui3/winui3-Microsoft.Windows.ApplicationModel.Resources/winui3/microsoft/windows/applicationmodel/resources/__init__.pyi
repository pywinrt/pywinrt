...
class ResourceCandidate(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], kind: ResourceCandidateKind, data: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], data: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> Self: ...
    ...
    @_property
    def qualifier_values(self) -> _cabc.Mapping[str, str]: ...
...
class ResourceLoader(winrt.system.Object, metaclass=ResourceLoader_Static):
    @typing.overload
    def __new__(cls: type[Self], file_name: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], file_name: str, resource_map: str) -> Self: ...
    @typing.overload
...
class ResourceManager(winrt.system.Object, IResourceManager):
    ...
    def remove_resource_not_found(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ResourceMap(winrt.system.Object):
    ...
    def try_get_value(self, resource: str, /) -> ResourceCandidate | None: ...
    @typing.overload
