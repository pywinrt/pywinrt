...
class ResourceCandidate(winrt.system.Object):
    @typing.overload
    def __new__(cls, kind: ResourceCandidateKind, data: str) -> typing.Self: ...
    @typing.overload
    def __new__(cls, data: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> typing.Self: ...
...
class ResourceLoader(winrt.system.Object, metaclass=ResourceLoader_Static):
    ...
    @typing.overload
    def __new__(cls, file_name: str, resource_map: str) -> typing.Self: ...
    @typing.overload
