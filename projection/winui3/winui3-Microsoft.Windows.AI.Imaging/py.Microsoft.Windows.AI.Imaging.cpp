...
namespace py::cpp::Microsoft::Windows::AI::Imaging
{
            ...
            {
                {
                    ...
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Microsoft.Windows.AI.Imaging.ImageDescriptionGenerator", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
    ...
    static PyObject* ImageDescriptionGenerator_CreateAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Imaging.ImageDescriptionGenerator", "CreateAsync", nullptr, py::site_is_static};
    ...
    static PyObject* ImageDescriptionGenerator_EnsureReadyAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Imaging.ImageDescriptionGenerator", "EnsureReadyAsync", nullptr, py::site_is_static};
    ...
    static PyObject* ImageDescriptionGenerator_GetReadyState(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Imaging.ImageDescriptionGenerator", "GetReadyState", nullptr, py::site_is_static};
    ...
    static PyObject* ImageObjectExtractor_Close(py::wrapper::Microsoft::Windows::AI::Imaging::ImageObjectExtractor* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Microsoft.Windows.AI.Imaging.ImageObjectExtractor", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
    ...
    static PyObject* ImageObjectExtractor_CreateWithImageBufferAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Microsoft.Windows.AI.Imaging.ImageObjectExtractor", "CreateWithImageBufferAsync", nullptr, py::site_is_static};
    ...
    static PyObject* ImageObjectExtractor_CreateWithSoftwareBitmapAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Microsoft.Windows.AI.Imaging.ImageObjectExtractor", "CreateWithSoftwareBitmapAsync", nullptr, py::site_is_static};
    ...
    static PyObject* ImageObjectExtractor_EnsureReadyAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Imaging.ImageObjectExtractor", "EnsureReadyAsync", nullptr, py::site_is_static};
    ...
    static PyObject* ImageObjectExtractor_GetReadyState(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Imaging.ImageObjectExtractor", "GetReadyState", nullptr, py::site_is_static};
    ...
    static PyObject* ImageScaler_Close(py::wrapper::Microsoft::Windows::AI::Imaging::ImageScaler* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Microsoft.Windows.AI.Imaging.ImageScaler", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
    ...
    static PyObject* ImageScaler_CreateAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Imaging.ImageScaler", "CreateAsync", nullptr, py::site_is_static};
    ...
    static PyObject* ImageScaler_EnsureReadyAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Imaging.ImageScaler", "EnsureReadyAsync", nullptr, py::site_is_static};
    ...
    static PyObject* ImageScaler_GetReadyState(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Imaging.ImageScaler", "GetReadyState", nullptr, py::site_is_static};
    ...
    static PyObject* TextRecognizer_Close(py::wrapper::Microsoft::Windows::AI::Imaging::TextRecognizer* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Microsoft.Windows.AI.Imaging.TextRecognizer", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
    ...
    static PyObject* TextRecognizer_CreateAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Imaging.TextRecognizer", "CreateAsync", nullptr, py::site_is_static};
    ...
    static PyObject* TextRecognizer_EnsureReadyAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Imaging.TextRecognizer", "EnsureReadyAsync", nullptr, py::site_is_static};
    ...
    static PyObject* TextRecognizer_GetReadyState(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Microsoft.Windows.AI.Imaging.TextRecognizer", "GetReadyState", nullptr, py::site_is_static};
