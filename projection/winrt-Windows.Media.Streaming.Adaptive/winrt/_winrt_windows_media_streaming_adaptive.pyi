...
class AdaptiveMediaSource_Static(type):
    ...
    def create_from_stream_with_downloader_async(cls, stream: typing.Optional[windows_storage_streams.IInputStream], uri: typing.Optional[windows_foundation.Uri], content_type: str, http_client: typing.Optional[windows_web_http.HttpClient], /) -> windows_foundation.IAsyncOperation[AdaptiveMediaSourceCreationResult]: ...
    ...
    def create_from_uri_with_downloader_async(cls, uri: typing.Optional[windows_foundation.Uri], http_client: typing.Optional[windows_web_http.HttpClient], /) -> windows_foundation.IAsyncOperation[AdaptiveMediaSourceCreationResult]: ...
