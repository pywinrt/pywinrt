...
class AgentProvisioningProgressReport(winrt.system.Object):
    ...
    @_property
    def batches(self) -> windows_foundation_collections.IVector[DeploymentWorkloadBatch]: ...
...
class DeploymentWorkloadBatch(winrt.system.Object):
    ...
    @_property
    def batch_workloads(self) -> windows_foundation_collections.IVector[DeploymentWorkload]: ...
    @_property
