...
class BluetoothDevice(winrt.system.Object, metaclass=BluetoothDevice_Static):
    ...
    def get_rfcomm_services_for_id_with_cache_mode_async(self, service_id: typing.Optional[windows_devices_bluetooth_rfcomm.RfcommServiceId], cache_mode: BluetoothCacheMode, /) -> windows_foundation.IAsyncOperation[windows_devices_bluetooth_rfcomm.RfcommDeviceServicesResult]: ...
