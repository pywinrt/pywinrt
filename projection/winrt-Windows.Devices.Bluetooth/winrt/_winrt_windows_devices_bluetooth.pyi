...
class BluetoothDevice(winrt.system.Object, metaclass=BluetoothDevice_Static):
    ...
    def name(self) -> str: ...
    @_property
    def rfcomm_services(self) -> windows_foundation_collections.IVectorView[windows_devices_bluetooth_rfcomm.RfcommDeviceService]: ...
    @_property
    def sdp_records(self) -> windows_foundation_collections.IVectorView[windows_storage_streams.IBuffer]: ...
    @_property
...
class BluetoothLEDevice(winrt.system.Object, metaclass=BluetoothLEDevice_Static):
    ...
    def device_id(self) -> str: ...
    @_property
    def gatt_services(self) -> windows_foundation_collections.IVectorView[windows_devices_bluetooth_genericattributeprofile.GattDeviceService]: ...
    @_property
    def name(self) -> str: ...
    @_property
...
class BluetoothSignalStrengthFilter(winrt.system.Object):
    ...
    @_property
    def out_of_range_threshold_in_d_bm(self) -> typing.Optional[winrt.system.Int16]: ...
    @out_of_range_threshold_in_d_bm.setter
    def out_of_range_threshold_in_d_bm(self, value: typing.Optional[winrt.system.Int16]) -> None: ...
    @_property
    def in_range_threshold_in_d_bm(self) -> typing.Optional[winrt.system.Int16]: ...
    @in_range_threshold_in_d_bm.setter
    def in_range_threshold_in_d_bm(self, value: typing.Optional[winrt.system.Int16]) -> None: ...
