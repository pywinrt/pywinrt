...
class VpnChannel(winrt.system.Object, metaclass=VpnChannel_Static):
    ...
    def activate_foreground(self, package_relative_app_id: str, shared_context: typing.Optional[windows_foundation_collections.ValueSet], /) -> typing.Optional[windows_foundation_collections.ValueSet]: ...
    ...
    def get_slot_type_for_transport_context(self, context: typing.Optional[winrt.system.Object], /) -> windows_networking_sockets.ControlChannelTriggerStatus: ...
    ...
    def request_credentials(self, cred_type: VpnCredentialType, is_retry: bool, is_single_sign_on_credential: bool, certificate: typing.Optional[windows_security_cryptography_certificates.Certificate], /) -> typing.Optional[VpnPickedCredential]: ...
    def request_credentials_simple_async(self, cred_type: VpnCredentialType, /) -> windows_foundation.IAsyncOperation[VpnCredential]: ...
    def request_credentials_with_certificate_async(self, cred_type: VpnCredentialType, cred_options: winrt.system.UInt32, certificate: typing.Optional[windows_security_cryptography_certificates.Certificate], /) -> windows_foundation.IAsyncOperation[VpnCredential]: ...
    ...
    def request_custom_prompt(self, custom_prompt: windows_foundation_collections.IVectorView[IVpnCustomPrompt], /) -> None: ...
    def request_custom_prompt_async(self, custom_prompt_element: windows_foundation_collections.IVectorView[IVpnCustomPromptElement], /) -> windows_foundation.IAsyncAction: ...
    ...
    def start(self, assigned_client_i_pv4list: windows_foundation_collections.IVectorView[windows_networking.HostName], assigned_client_i_pv6list: windows_foundation_collections.IVectorView[windows_networking.HostName], vpn_interface_id: typing.Optional[VpnInterfaceId], route_scope: typing.Optional[VpnRouteAssignment], namespace_scope: typing.Optional[VpnNamespaceAssignment], mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, optimize_for_low_cost_network: bool, main_outer_tunnel_transport: typing.Optional[winrt.system.Object], optional_outer_tunnel_transport: typing.Optional[winrt.system.Object], /) -> None: ...
    def start_existing_transports(self, assigned_client_i_pv4list: windows_foundation_collections.IVectorView[windows_networking.HostName], assigned_client_i_pv6list: windows_foundation_collections.IVectorView[windows_networking.HostName], vpn_interface_id: typing.Optional[VpnInterfaceId], assigned_routes: typing.Optional[VpnRouteAssignment], assigned_domain_name: typing.Optional[VpnDomainNameAssignment], mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, reserved: bool, /) -> None: ...
    ...
    def start_with_main_transport(self, assigned_client_i_pv4list: windows_foundation_collections.IVectorView[windows_networking.HostName], assigned_client_i_pv6list: windows_foundation_collections.IVectorView[windows_networking.HostName], vpn_interface_id: typing.Optional[VpnInterfaceId], assigned_routes: typing.Optional[VpnRouteAssignment], assigned_domain_name: typing.Optional[VpnDomainNameAssignment], mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, reserved: bool, main_outer_tunnel_transport: typing.Optional[winrt.system.Object], /) -> None: ...
    def start_with_multiple_transports(self, assigned_client_ipv4_addresses: typing.Iterable[windows_networking.HostName], assigned_client_ipv6_addresses: typing.Iterable[windows_networking.HostName], vpninterface_id: typing.Optional[VpnInterfaceId], assigned_routes: typing.Optional[VpnRouteAssignment], assigned_namespace: typing.Optional[VpnDomainNameAssignment], mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, reserved: bool, transports: typing.Iterable[winrt.system.Object], assigned_traffic_filters: typing.Optional[VpnTrafficFilterAssignment], /) -> None: ...
    def start_with_traffic_filter(self, assigned_client_ipv4_list: windows_foundation_collections.IVectorView[windows_networking.HostName], assigned_client_ipv6_list: windows_foundation_collections.IVectorView[windows_networking.HostName], vpn_interface_id: typing.Optional[VpnInterfaceId], assigned_routes: typing.Optional[VpnRouteAssignment], assigned_namespace: typing.Optional[VpnDomainNameAssignment], mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, reserved: bool, main_outer_tunnel_transport: typing.Optional[winrt.system.Object], optional_outer_tunnel_transport: typing.Optional[winrt.system.Object], assigned_traffic_filters: typing.Optional[VpnTrafficFilterAssignment], /) -> None: ...
    def stop(self) -> None: ...
...
class VpnChannelConfiguration(winrt.system.Object):
    ...
    @_property
    def server_host_name_list(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_networking.HostName]]: ...
    @_property
    def server_service_name(self) -> str: ...
    @_property
    def server_uris(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_foundation.Uri]]: ...
...
class VpnCredential(winrt.system.Object):
    ...
    @_property
    def certificate_credential(self) -> typing.Optional[windows_security_cryptography_certificates.Certificate]: ...
    @_property
    def old_password_credential(self) -> typing.Optional[windows_security_credentials.PasswordCredential]: ...
    @_property
    def passkey_credential(self) -> typing.Optional[windows_security_credentials.PasswordCredential]: ...
...
class VpnCustomComboBox(winrt.system.Object):
    ...
    @_property
    def options_text(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @options_text.setter
    def options_text(self, value: typing.Optional[windows_foundation_collections.IVectorView[str]]) -> None: ...
    @_property
...
class VpnCustomPromptOptionSelector(winrt.system.Object):
    ...
    def compulsory(self, value: bool) -> None: ...
    @_property
    def options(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
...
class VpnDomainNameAssignment(winrt.system.Object):
    ...
    @_property
    def proxy_auto_configuration_uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @proxy_auto_configuration_uri.setter
    def proxy_auto_configuration_uri(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    def domain_name_list(self) -> typing.Optional[windows_foundation_collections.IVector[VpnDomainNameInfo]]: ...
...
class VpnDomainNameInfo(winrt.system.Object):
    ...
    @_property
    def domain_name(self) -> typing.Optional[windows_networking.HostName]: ...
    @domain_name.setter
    def domain_name(self, value: typing.Optional[windows_networking.HostName]) -> None: ...
    @_property
    def dns_servers(self) -> typing.Optional[windows_foundation_collections.IVector[windows_networking.HostName]]: ...
    @_property
    def web_proxy_servers(self) -> typing.Optional[windows_foundation_collections.IVector[windows_networking.HostName]]: ...
    @_property
    def web_proxy_uris(self) -> typing.Optional[windows_foundation_collections.IVector[windows_foundation.Uri]]: ...
...
class VpnForegroundActivatedEventArgs(winrt.system.Object):
    ...
    @_property
    def shared_context(self) -> typing.Optional[windows_foundation_collections.ValueSet]: ...
...
class VpnForegroundActivationOperation(winrt.system.Object):
    ...
    def complete(self, result: typing.Optional[windows_foundation_collections.ValueSet], /) -> None: ...
...
class VpnManagementAgent(winrt.system.Object):
    ...
    def add_profile_from_object_async(self, profile: typing.Optional[IVpnProfile], /) -> windows_foundation.IAsyncOperation[VpnManagementErrorStatus]: ...
    def add_profile_from_xml_async(self, xml: str, /) -> windows_foundation.IAsyncOperation[VpnManagementErrorStatus]: ...
    def connect_profile_async(self, profile: typing.Optional[IVpnProfile], /) -> windows_foundation.IAsyncOperation[VpnManagementErrorStatus]: ...
    def connect_profile_with_password_credential_async(self, profile: typing.Optional[IVpnProfile], password_credential: typing.Optional[windows_security_credentials.PasswordCredential], /) -> windows_foundation.IAsyncOperation[VpnManagementErrorStatus]: ...
    def delete_profile_async(self, profile: typing.Optional[IVpnProfile], /) -> windows_foundation.IAsyncOperation[VpnManagementErrorStatus]: ...
    def disconnect_profile_async(self, profile: typing.Optional[IVpnProfile], /) -> windows_foundation.IAsyncOperation[VpnManagementErrorStatus]: ...
    def get_profiles_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[IVpnProfile]]: ...
    def update_profile_from_object_async(self, profile: typing.Optional[IVpnProfile], /) -> windows_foundation.IAsyncOperation[VpnManagementErrorStatus]: ...
...
class VpnNamespaceAssignment(winrt.system.Object):
    ...
    @_property
    def proxy_auto_config_uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @proxy_auto_config_uri.setter
    def proxy_auto_config_uri(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    def namespace_list(self) -> typing.Optional[windows_foundation_collections.IVector[VpnNamespaceInfo]]: ...
    @namespace_list.setter
    def namespace_list(self, value: typing.Optional[windows_foundation_collections.IVector[VpnNamespaceInfo]]) -> None: ...

@typing.final
class VpnNamespaceInfo(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> VpnNamespaceInfo: ...
    def __new__(cls: typing.Type[VpnNamespaceInfo], name: str, dns_server_list: windows_foundation_collections.IVector[windows_networking.HostName], proxy_server_list: windows_foundation_collections.IVector[windows_networking.HostName]) -> VpnNamespaceInfo: ...
    @_property
    def web_proxy_servers(self) -> typing.Optional[windows_foundation_collections.IVector[windows_networking.HostName]]: ...
    @web_proxy_servers.setter
    def web_proxy_servers(self, value: typing.Optional[windows_foundation_collections.IVector[windows_networking.HostName]]) -> None: ...
    @_property
    ...
    def dns_servers(self) -> typing.Optional[windows_foundation_collections.IVector[windows_networking.HostName]]: ...
    @dns_servers.setter
    def dns_servers(self, value: typing.Optional[windows_foundation_collections.IVector[windows_networking.HostName]]) -> None: ...
...
class VpnNativeProfile(winrt.system.Object):
    ...
    @_property
    def servers(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    ...
    @_property
    def routes(self) -> typing.Optional[windows_foundation_collections.IVector[VpnRoute]]: ...
    @_property
    def app_triggers(self) -> typing.Optional[windows_foundation_collections.IVector[VpnAppId]]: ...
    @_property
    def traffic_filters(self) -> typing.Optional[windows_foundation_collections.IVector[VpnTrafficFilter]]: ...
    @_property
    def domain_name_info_list(self) -> typing.Optional[windows_foundation_collections.IVector[VpnDomainNameInfo]]: ...
...
class VpnPacketBuffer(winrt.system.Object):
    ...
    @_property
    def buffer(self) -> typing.Optional[windows_storage_streams.Buffer]: ...
    @_property
...
class VpnPacketBufferList(winrt.system.Object):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[VpnPacketBuffer]]: ...
...
class VpnPlugInProfile(winrt.system.Object):
    ...
    @_property
    def server_uris(self) -> typing.Optional[windows_foundation_collections.IVector[windows_foundation.Uri]]: ...
    @_property
    def require_vpn_client_app_u_i(self) -> bool: ...
    @require_vpn_client_app_u_i.setter
    def require_vpn_client_app_u_i(self, value: bool) -> None: ...
...
class VpnRoute(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[VpnRoute], address: typing.Optional[windows_networking.HostName], prefix_size: winrt.system.UInt8) -> VpnRoute: ...
    @_property
    def prefix_size(self) -> winrt.system.UInt8: ...
    @prefix_size.setter
    def prefix_size(self, value: winrt.system.UInt8) -> None: ...
    @_property
    def address(self) -> typing.Optional[windows_networking.HostName]: ...
    @address.setter
    def address(self, value: typing.Optional[windows_networking.HostName]) -> None: ...
...
class VpnRouteAssignment(winrt.system.Object):
    ...
    @_property
    def ipv6_inclusion_routes(self) -> typing.Optional[windows_foundation_collections.IVector[VpnRoute]]: ...
    @ipv6_inclusion_routes.setter
    def ipv6_inclusion_routes(self, value: typing.Optional[windows_foundation_collections.IVector[VpnRoute]]) -> None: ...
    @_property
    def ipv6_exclusion_routes(self) -> typing.Optional[windows_foundation_collections.IVector[VpnRoute]]: ...
    @ipv6_exclusion_routes.setter
    def ipv6_exclusion_routes(self, value: typing.Optional[windows_foundation_collections.IVector[VpnRoute]]) -> None: ...
    @_property
    def ipv4_inclusion_routes(self) -> typing.Optional[windows_foundation_collections.IVector[VpnRoute]]: ...
    @ipv4_inclusion_routes.setter
    def ipv4_inclusion_routes(self, value: typing.Optional[windows_foundation_collections.IVector[VpnRoute]]) -> None: ...
    @_property
    def ipv4_exclusion_routes(self) -> typing.Optional[windows_foundation_collections.IVector[VpnRoute]]: ...
    @ipv4_exclusion_routes.setter
    def ipv4_exclusion_routes(self, value: typing.Optional[windows_foundation_collections.IVector[VpnRoute]]) -> None: ...
    @_property
...
class VpnSystemHealth(winrt.system.Object):
    ...
    @_property
    def statement_of_health(self) -> typing.Optional[windows_storage_streams.Buffer]: ...
...
class VpnTrafficFilter(winrt.system.Object):
    ...
    @_property
    def app_claims(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def local_address_ranges(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def local_port_ranges(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def remote_address_ranges(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def remote_port_ranges(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class VpnTrafficFilterAssignment(winrt.system.Object):
    ...
    @_property
    def traffic_filter_list(self) -> typing.Optional[windows_foundation_collections.IVector[VpnTrafficFilter]]: ...
...
class IVpnDomainNameInfoFactory(winrt.system.Object):
    ...
    def create_vpn_domain_name_info(self, name: str, name_type: VpnDomainNameType, dns_server_list: typing.Iterable[windows_networking.HostName], proxy_server_list: typing.Iterable[windows_networking.HostName], /) -> typing.Optional[VpnDomainNameInfo]: ...

@typing.final
class IVpnInterfaceIdFactory(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> IVpnInterfaceIdFactory: ...
    def create_vpn_interface_id(self, address: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> typing.Optional[VpnInterfaceId]: ...

@typing.final
class IVpnNamespaceInfoFactory(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> IVpnNamespaceInfoFactory: ...
    def create_vpn_namespace_info(self, name: str, dns_server_list: windows_foundation_collections.IVector[windows_networking.HostName], proxy_server_list: windows_foundation_collections.IVector[windows_networking.HostName], /) -> typing.Optional[VpnNamespaceInfo]: ...
...
class IVpnPlugInReconnectTransport(winrt.system.Object):
    ...
    def reconnect_transport(self, channel: typing.Optional[VpnChannel], context: typing.Optional[winrt.system.Object], /) -> None: ...
...
class IVpnRouteFactory(winrt.system.Object):
    ...
    def create_vpn_route(self, address: typing.Optional[windows_networking.HostName], prefix_size: winrt.system.UInt8, /) -> typing.Optional[VpnRoute]: ...
