...
class VpnChannel(winrt.system.Object, metaclass=VpnChannel_Static):
    ...
    def start(self, assigned_client_i_pv4list: windows_foundation_collections.IVectorView[windows_networking.HostName], assigned_client_i_pv6list: windows_foundation_collections.IVectorView[windows_networking.HostName], vpn_interface_id: VpnInterfaceId, route_scope: VpnRouteAssignment, namespace_scope: VpnNamespaceAssignment, mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, optimize_for_low_cost_network: bool, main_outer_tunnel_transport: winrt.system.Object, optional_outer_tunnel_transport: winrt.system.Object, /) -> None: ...
    def start_existing_transports(self, assigned_client_i_pv4list: windows_foundation_collections.IVectorView[windows_networking.HostName], assigned_client_i_pv6list: windows_foundation_collections.IVectorView[windows_networking.HostName], vpn_interface_id: VpnInterfaceId, assigned_routes: VpnRouteAssignment, assigned_domain_name: VpnDomainNameAssignment, mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, reserved: bool, /) -> None: ...
    ...
    def start_with_traffic_filter(self, assigned_client_ipv4_list: windows_foundation_collections.IVectorView[windows_networking.HostName], assigned_client_ipv6_list: windows_foundation_collections.IVectorView[windows_networking.HostName], vpn_interface_id: VpnInterfaceId, assigned_routes: VpnRouteAssignment, assigned_namespace: VpnDomainNameAssignment, mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, reserved: bool, main_outer_tunnel_transport: winrt.system.Object, optional_outer_tunnel_transport: winrt.system.Object, assigned_traffic_filters: VpnTrafficFilterAssignment, /) -> None: ...
    def stop(self) -> None: ...
...
class VpnChannelConfiguration(winrt.system.Object):
    ...
    @_property
    def server_host_name_list(self) -> windows_foundation_collections.IVectorView[windows_networking.HostName]: ...
    @_property
    def server_service_name(self) -> str: ...
    @_property
    def server_uris(self) -> windows_foundation_collections.IVectorView[windows_foundation.Uri]: ...
...
class VpnCustomComboBox(winrt.system.Object):
    ...
    @_property
    def options_text(self) -> windows_foundation_collections.IVectorView[str]: ...
    @options_text.setter
    def options_text(self, value: windows_foundation_collections.IVectorView[str]) -> None: ...
    @_property
...
class VpnCustomPromptOptionSelector(winrt.system.Object):
    ...
    def compulsory(self, value: bool) -> None: ...
    @_property
    def options(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
...
class VpnDomainNameAssignment(winrt.system.Object):
    ...
    @_property
    def domain_name_list(self) -> windows_foundation_collections.IVector[VpnDomainNameInfo]: ...
...
class VpnDomainNameInfo(winrt.system.Object):
    ...
    @_property
    def dns_servers(self) -> windows_foundation_collections.IVector[windows_networking.HostName]: ...
    @_property
    def web_proxy_servers(self) -> windows_foundation_collections.IVector[windows_networking.HostName]: ...
    @_property
    def web_proxy_uris(self) -> windows_foundation_collections.IVector[windows_foundation.Uri]: ...
...
class VpnNamespaceAssignment(winrt.system.Object):
    ...
    @_property
    def namespace_list(self) -> windows_foundation_collections.IVector[VpnNamespaceInfo]: ...
    @namespace_list.setter
    def namespace_list(self, value: windows_foundation_collections.IVector[VpnNamespaceInfo]) -> None: ...
...
class VpnNamespaceInfo(winrt.system.Object):
    ...
    def web_proxy_servers(self, value: windows_foundation_collections.IVector[windows_networking.HostName]) -> None: ...
    @_property
    ...
    def dns_servers(self) -> windows_foundation_collections.IVector[windows_networking.HostName]: ...
    @dns_servers.setter
    def dns_servers(self, value: windows_foundation_collections.IVector[windows_networking.HostName]) -> None: ...
...
class VpnNativeProfile(winrt.system.Object):
    ...
    @_property
    def servers(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    ...
    @_property
    def routes(self) -> windows_foundation_collections.IVector[VpnRoute]: ...
    @_property
    def app_triggers(self) -> windows_foundation_collections.IVector[VpnAppId]: ...
    @_property
    def traffic_filters(self) -> windows_foundation_collections.IVector[VpnTrafficFilter]: ...
    @_property
    def domain_name_info_list(self) -> windows_foundation_collections.IVector[VpnDomainNameInfo]: ...
...
class VpnPlugInProfile(winrt.system.Object):
    ...
    @_property
    def server_uris(self) -> windows_foundation_collections.IVector[windows_foundation.Uri]: ...
    @_property
    def require_vpn_client_app_u_i(self) -> bool: ...
    @require_vpn_client_app_u_i.setter
    def require_vpn_client_app_u_i(self, value: bool) -> None: ...
...
class VpnRouteAssignment(winrt.system.Object):
    ...
    @_property
    def ipv6_inclusion_routes(self) -> windows_foundation_collections.IVector[VpnRoute]: ...
    @ipv6_inclusion_routes.setter
    def ipv6_inclusion_routes(self, value: windows_foundation_collections.IVector[VpnRoute]) -> None: ...
    @_property
    def ipv6_exclusion_routes(self) -> windows_foundation_collections.IVector[VpnRoute]: ...
    @ipv6_exclusion_routes.setter
    def ipv6_exclusion_routes(self, value: windows_foundation_collections.IVector[VpnRoute]) -> None: ...
    @_property
    def ipv4_inclusion_routes(self) -> windows_foundation_collections.IVector[VpnRoute]: ...
    @ipv4_inclusion_routes.setter
    def ipv4_inclusion_routes(self, value: windows_foundation_collections.IVector[VpnRoute]) -> None: ...
    @_property
    def ipv4_exclusion_routes(self) -> windows_foundation_collections.IVector[VpnRoute]: ...
    @ipv4_exclusion_routes.setter
    def ipv4_exclusion_routes(self, value: windows_foundation_collections.IVector[VpnRoute]) -> None: ...
    @_property
...
class VpnTrafficFilter(winrt.system.Object):
    ...
    @_property
    def app_claims(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def local_address_ranges(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def local_port_ranges(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def remote_address_ranges(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def remote_port_ranges(self) -> windows_foundation_collections.IVector[str]: ...
...
class VpnTrafficFilterAssignment(winrt.system.Object):
    ...
    @_property
    def traffic_filter_list(self) -> windows_foundation_collections.IVector[VpnTrafficFilter]: ...
...
class IVpnNamespaceInfoFactory(winrt.system.Object):
    ...
    def create_vpn_namespace_info(self, name: str, dns_server_list: windows_foundation_collections.IVector[windows_networking.HostName], proxy_server_list: windows_foundation_collections.IVector[windows_networking.HostName], /) -> VpnNamespaceInfo: ...
