...
PyObject* py::converter<winrt::Windows::UI::Xaml::Media::Matrix>::convert(winrt::Windows::UI::Xaml::Media::Matrix instance) noexcept
{
    auto type = py::get_python_type<winrt::Windows::UI::Xaml::Media::Matrix>();
    if (!type)
    {
        return nullptr;
    }
...
winrt::Windows::UI::Xaml::Media::Matrix py::converter<winrt::Windows::UI::Xaml::Media::Matrix>::convert_to(PyObject* obj)
{
    ...
    if (Py_TYPE(obj) == type)
    {
        return reinterpret_cast<py::winrt_struct_wrapper<winrt::Windows::UI::Xaml::Media::Matrix>*>(obj)->obj;
    }

    PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Xaml::Media::Matrix");
    throw python_exception();
}
...
namespace py::cpp::Windows::UI::Xaml::Media
{
    struct module_state
    {
        PyObject* type_AcrylicBackgroundSource;
        PyObject* type_AlignmentX;
        PyObject* type_AlignmentY;
        PyObject* type_AudioCategory;
        PyObject* type_AudioDeviceType;
        PyObject* type_BrushMappingMode;
        PyObject* type_ColorInterpolationMode;
        PyObject* type_ElementCompositeMode;
        PyObject* type_FastPlayFallbackBehaviour;
        PyObject* type_FillRule;
        PyObject* type_GradientSpreadMethod;
        PyObject* type_LoadedImageSourceLoadStatus;
        PyObject* type_MediaCanPlayResponse;
        PyObject* type_MediaElementState;
        PyObject* type_PenLineCap;
        PyObject* type_PenLineJoin;
        PyObject* type_RevealBrushState;
        PyObject* type_Stereo3DVideoPackingMode;
        PyObject* type_Stereo3DVideoRenderMode;
        PyObject* type_Stretch;
        PyObject* type_StyleSimulations;
        PyObject* type_SweepDirection;
    ...
    static PyObject* register_AcrylicBackgroundSource(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AcrylicBackgroundSource)
        {
        ...
        state->type_AcrylicBackgroundSource = type;
        Py_INCREF(state->type_AcrylicBackgroundSource);


        Py_RETURN_NONE;
    }

    static PyObject* register_AlignmentX(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AlignmentX)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AlignmentX = type;
        Py_INCREF(state->type_AlignmentX);


        Py_RETURN_NONE;
    }

    static PyObject* register_AlignmentY(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AlignmentY)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AlignmentY = type;
        Py_INCREF(state->type_AlignmentY);


        Py_RETURN_NONE;
    }

    static PyObject* register_AudioCategory(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AudioCategory)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AudioCategory = type;
        Py_INCREF(state->type_AudioCategory);


        Py_RETURN_NONE;
    }

    static PyObject* register_AudioDeviceType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AudioDeviceType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AudioDeviceType = type;
        Py_INCREF(state->type_AudioDeviceType);


        Py_RETURN_NONE;
    }

    static PyObject* register_BrushMappingMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_BrushMappingMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_BrushMappingMode = type;
        Py_INCREF(state->type_BrushMappingMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_ColorInterpolationMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_ColorInterpolationMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_ColorInterpolationMode = type;
        Py_INCREF(state->type_ColorInterpolationMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_ElementCompositeMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_ElementCompositeMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_ElementCompositeMode = type;
        Py_INCREF(state->type_ElementCompositeMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_FastPlayFallbackBehaviour(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_FastPlayFallbackBehaviour)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_FastPlayFallbackBehaviour = type;
        Py_INCREF(state->type_FastPlayFallbackBehaviour);


        Py_RETURN_NONE;
    }

    static PyObject* register_FillRule(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_FillRule)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_FillRule = type;
        Py_INCREF(state->type_FillRule);


        Py_RETURN_NONE;
    }

    static PyObject* register_GradientSpreadMethod(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_GradientSpreadMethod)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_GradientSpreadMethod = type;
        Py_INCREF(state->type_GradientSpreadMethod);


        Py_RETURN_NONE;
    }

    static PyObject* register_LoadedImageSourceLoadStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_LoadedImageSourceLoadStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_LoadedImageSourceLoadStatus = type;
        Py_INCREF(state->type_LoadedImageSourceLoadStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_MediaCanPlayResponse(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MediaCanPlayResponse)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MediaCanPlayResponse = type;
        Py_INCREF(state->type_MediaCanPlayResponse);


        Py_RETURN_NONE;
    }

    static PyObject* register_MediaElementState(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MediaElementState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MediaElementState = type;
        Py_INCREF(state->type_MediaElementState);


        Py_RETURN_NONE;
    }

    static PyObject* register_PenLineCap(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PenLineCap)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PenLineCap = type;
        Py_INCREF(state->type_PenLineCap);


        Py_RETURN_NONE;
    }

    static PyObject* register_PenLineJoin(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PenLineJoin)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PenLineJoin = type;
        Py_INCREF(state->type_PenLineJoin);


        Py_RETURN_NONE;
    }

    static PyObject* register_RevealBrushState(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_RevealBrushState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_RevealBrushState = type;
        Py_INCREF(state->type_RevealBrushState);


        Py_RETURN_NONE;
    }

    static PyObject* register_Stereo3DVideoPackingMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_Stereo3DVideoPackingMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_Stereo3DVideoPackingMode = type;
        Py_INCREF(state->type_Stereo3DVideoPackingMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_Stereo3DVideoRenderMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_Stereo3DVideoRenderMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_Stereo3DVideoRenderMode = type;
        Py_INCREF(state->type_Stereo3DVideoRenderMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_Stretch(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_Stretch)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_Stretch = type;
        Py_INCREF(state->type_Stretch);


        Py_RETURN_NONE;
    }

    static PyObject* register_StyleSimulations(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_StyleSimulations)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_StyleSimulations = type;
        Py_INCREF(state->type_StyleSimulations);


        Py_RETURN_NONE;
    }

    static PyObject* register_SweepDirection(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SweepDirection)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SweepDirection = type;
        Py_INCREF(state->type_SweepDirection);
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.AcrylicBrush", L"TintTransitionDuration"))
        {
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.AcrylicBrush", L"TintOpacity"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.AcrylicBrush", L"TintColor"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.AcrylicBrush", L"BackgroundSource"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
        ...
        try
        {
            return py::convert(self->obj.BackgroundSource());
        }
        catch (...)
        {
            py::to_PyErr();
    ...
    static int AcrylicBrush_put_BackgroundSource(py::wrapper::Windows::UI::Xaml::Media::AcrylicBrush* self, PyObject* arg, void* /*unused*/) noexcept
    {
        ...
        try
        {
            ...
            self->obj.BackgroundSource(param0);
            return 0;
        }
        catch (...)
        {
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.AcrylicBrush", L"AlwaysUseFallback"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.AcrylicBrush", L"TintLuminosityOpacity"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.AcrylicBrush", L"AlwaysUseFallbackProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.AcrylicBrush", L"BackgroundSourceProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.AcrylicBrush", L"TintColorProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.AcrylicBrush", L"TintOpacityProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.AcrylicBrush", L"TintTransitionDurationProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.AcrylicBrush", L"TintLuminosityOpacityProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_AcrylicBrush_Meta[] = {
    ...
    static PyType_Slot type_slots_AcrylicBrush_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_AcrylicBrush_Meta) },
        { }
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ArcSegment", L"SweepDirection"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ArcSegment", L"Size"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ArcSegment", L"RotationAngle"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ArcSegment", L"Point"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ArcSegment", L"IsLargeArc"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ArcSegment", L"IsLargeArcProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ArcSegment", L"PointProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ArcSegment", L"RotationAngleProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ArcSegment", L"SizeProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ArcSegment", L"SweepDirectionProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_ArcSegment_Meta[] = {
    ...
    static PyType_Slot type_slots_ArcSegment_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_ArcSegment_Meta) },
        { }
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.BezierSegment", L"Point3"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.BezierSegment", L"Point2"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.BezierSegment", L"Point1"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.BezierSegment", L"Point1Property"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.BezierSegment", L"Point2Property"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.BezierSegment", L"Point3Property"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_BezierSegment_Meta[] = {
    ...
    static PyType_Slot type_slots_BezierSegment_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_BezierSegment_Meta) },
        { }
    };
    ...
    static PyObject* Brush_PopulatePropertyInfo(py::wrapper::Windows::UI::Xaml::Media::Brush* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.Brush", L"PopulatePropertyInfo", 2))
            {
    ...
    static PyObject* Brush_PopulatePropertyInfoOverride(py::wrapper::Windows::UI::Xaml::Media::Brush* self, PyObject* args) noexcept
    {
        auto arg_count = PyTuple_Size(args);

        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.Brush", L"PopulatePropertyInfoOverride", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Brush", L"Transform"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Brush", L"RelativeTransform"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Brush", L"Opacity"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Brush", L"OpacityProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Brush", L"RelativeTransformProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Brush", L"TransformProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_Brush_Meta[] = {
    ...
    static PyType_Slot type_slots_Brush_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_Brush_Meta) },
        { }
    };
    ...
    static PyObject* BrushCollection_Append(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"Append", 1))
            {
    ...
    static PyObject* BrushCollection_Clear(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"Clear", 0))
            {
    ...
    static PyObject* BrushCollection_First(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"First", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* BrushCollection_GetAt(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"GetAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* BrushCollection_GetMany(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"GetMany", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* BrushCollection_GetView(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"GetView", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* BrushCollection_IndexOf(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"IndexOf", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* BrushCollection_InsertAt(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"InsertAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* BrushCollection_RemoveAt(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"RemoveAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* BrushCollection_RemoveAtEnd(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"RemoveAtEnd", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* BrushCollection_ReplaceAll(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"ReplaceAll", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* BrushCollection_SetAt(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"SetAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.BrushCollection", L"Size"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static int _seq_assign_BrushCollection(py::wrapper::Windows::UI::Xaml::Media::BrushCollection* self, Py_ssize_t i, PyObject* value) noexcept
    {
        try
        {
            ...
            else { self->obj.SetAt(static_cast<uint32_t>(i), py::convert_to<winrt::Windows::UI::Xaml::Media::Brush>(value)); }
            return 0;
        }
        catch (...)
        {
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"TranslateY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"TranslateX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"SkewY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"SkewX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"ScaleY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"ScaleX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"Rotation"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"CenterY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"CenterX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"CenterXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"CenterYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"RotationProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"ScaleXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"ScaleYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"SkewXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"SkewYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"TranslateXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.CompositeTransform", L"TranslateYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_CompositeTransform_Meta[] = {
    ...
    static PyType_Slot type_slots_CompositeTransform_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_CompositeTransform_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_CompositeTransform_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_CompositeTransform_Meta
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsEventPresent(L"Windows.UI.Xaml.Media.CompositionTarget", L"Rendered"))
        {
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsEventPresent(L"Windows.UI.Xaml.Media.CompositionTarget", L"Rendering"))
        {
            PyErr_SetString(PyExc_AttributeError, "event is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsEventPresent(L"Windows.UI.Xaml.Media.CompositionTarget", L"SurfaceContentsLost"))
        {
            PyErr_SetString(PyExc_AttributeError, "event is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyObject* DoubleCollection_Append(py::wrapper::Windows::UI::Xaml::Media::DoubleCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"Append", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* DoubleCollection_Clear(py::wrapper::Windows::UI::Xaml::Media::DoubleCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"Clear", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* DoubleCollection_First(py::wrapper::Windows::UI::Xaml::Media::DoubleCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"First", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* DoubleCollection_GetAt(py::wrapper::Windows::UI::Xaml::Media::DoubleCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"GetAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* DoubleCollection_GetMany(py::wrapper::Windows::UI::Xaml::Media::DoubleCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"GetMany", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* DoubleCollection_GetView(py::wrapper::Windows::UI::Xaml::Media::DoubleCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"GetView", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* DoubleCollection_IndexOf(py::wrapper::Windows::UI::Xaml::Media::DoubleCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"IndexOf", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* DoubleCollection_InsertAt(py::wrapper::Windows::UI::Xaml::Media::DoubleCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"InsertAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* DoubleCollection_RemoveAt(py::wrapper::Windows::UI::Xaml::Media::DoubleCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"RemoveAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* DoubleCollection_RemoveAtEnd(py::wrapper::Windows::UI::Xaml::Media::DoubleCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"RemoveAtEnd", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* DoubleCollection_ReplaceAll(py::wrapper::Windows::UI::Xaml::Media::DoubleCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"ReplaceAll", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* DoubleCollection_SetAt(py::wrapper::Windows::UI::Xaml::Media::DoubleCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"SetAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.DoubleCollection", L"Size"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.EllipseGeometry", L"RadiusY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.EllipseGeometry", L"RadiusX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.EllipseGeometry", L"Center"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.EllipseGeometry", L"CenterProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.EllipseGeometry", L"RadiusXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.EllipseGeometry", L"RadiusYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_EllipseGeometry_Meta[] = {
    ...
    static PyType_Slot type_slots_EllipseGeometry_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_EllipseGeometry_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_EllipseGeometry_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_EllipseGeometry_Meta
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.FontFamily", L"Source"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.FontFamily", L"XamlAutoFontFamily"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_FontFamily_Meta[] = {
        { "xaml_auto_font_family", reinterpret_cast<getter>(FontFamily_get_XamlAutoFontFamily), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_FontFamily_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_FontFamily_Meta) },
        { }
    };
    ...
    static PyObject* GeneralTransform_TransformBounds(py::wrapper::Windows::UI::Xaml::Media::GeneralTransform* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeneralTransform", L"TransformBounds", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GeneralTransform_TransformBoundsCore(py::wrapper::Windows::UI::Xaml::Media::GeneralTransform* self, PyObject* args) noexcept
    {
        auto arg_count = PyTuple_Size(args);

        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeneralTransform", L"TransformBoundsCore", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GeneralTransform_TransformPoint(py::wrapper::Windows::UI::Xaml::Media::GeneralTransform* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeneralTransform", L"TransformPoint", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GeneralTransform_TryTransform(py::wrapper::Windows::UI::Xaml::Media::GeneralTransform* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeneralTransform", L"TryTransform", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GeneralTransform_TryTransformCore(py::wrapper::Windows::UI::Xaml::Media::GeneralTransform* self, PyObject* args) noexcept
    {
        auto arg_count = PyTuple_Size(args);

        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeneralTransform", L"TryTransformCore", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GeneralTransform", L"Inverse"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyObject* GeneralTransform_get_InverseCore(py::wrapper::Windows::UI::Xaml::Media::GeneralTransform* self, void* /*unused*/) noexcept
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GeneralTransform", L"InverseCore"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Geometry", L"Transform"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Geometry", L"Bounds"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Geometry", L"Empty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Geometry", L"StandardFlatteningTolerance"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Geometry", L"TransformProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_Geometry_Meta[] = {
    ...
    static PyType_Slot type_slots_Geometry_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_Geometry_Meta) },
        { }
    };
    ...
    static PyObject* GeometryCollection_Append(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"Append", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GeometryCollection_Clear(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"Clear", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* GeometryCollection_First(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"First", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* GeometryCollection_GetAt(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"GetAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GeometryCollection_GetMany(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"GetMany", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GeometryCollection_GetView(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"GetView", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* GeometryCollection_IndexOf(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"IndexOf", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GeometryCollection_InsertAt(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"InsertAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* GeometryCollection_RemoveAt(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"RemoveAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GeometryCollection_RemoveAtEnd(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"RemoveAtEnd", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* GeometryCollection_ReplaceAll(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"ReplaceAll", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GeometryCollection_SetAt(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"SetAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GeometryCollection", L"Size"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static int _seq_assign_GeometryCollection(py::wrapper::Windows::UI::Xaml::Media::GeometryCollection* self, Py_ssize_t i, PyObject* value) noexcept
    {
        ...
        {
            if (value == nullptr) { self->obj.RemoveAt(static_cast<uint32_t>(i)); }
            else { self->obj.SetAt(static_cast<uint32_t>(i), py::convert_to<winrt::Windows::UI::Xaml::Media::Geometry>(value)); }
            return 0;
        }
        catch (...)
        {
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GeometryGroup", L"FillRule"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GeometryGroup", L"Children"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GeometryGroup", L"ChildrenProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GeometryGroup", L"FillRuleProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_GeometryGroup_Meta[] = {
    ...
    static PyType_Slot type_slots_GeometryGroup_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_GeometryGroup_Meta) },
        { }
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientBrush", L"SpreadMethod"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientBrush", L"MappingMode"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientBrush", L"GradientStops"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientBrush", L"ColorInterpolationMode"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientBrush", L"ColorInterpolationModeProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientBrush", L"GradientStopsProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientBrush", L"MappingModeProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientBrush", L"SpreadMethodProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_GradientBrush_Meta[] = {
    ...
    static PyType_Slot type_slots_GradientBrush_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_GradientBrush_Meta) },
        { }
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientStop", L"Offset"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientStop", L"Color"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientStop", L"ColorProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientStop", L"OffsetProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_GradientStop_Meta[] = {
    ...
    static PyType_Slot type_slots_GradientStop_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_GradientStop_Meta) },
        { }
    };
    ...
    static PyObject* GradientStopCollection_Append(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"Append", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GradientStopCollection_Clear(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"Clear", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* GradientStopCollection_First(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"First", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* GradientStopCollection_GetAt(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"GetAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GradientStopCollection_GetMany(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"GetMany", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GradientStopCollection_GetView(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"GetView", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* GradientStopCollection_IndexOf(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"IndexOf", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GradientStopCollection_InsertAt(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"InsertAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* GradientStopCollection_RemoveAt(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"RemoveAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GradientStopCollection_RemoveAtEnd(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"RemoveAtEnd", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* GradientStopCollection_ReplaceAll(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"ReplaceAll", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* GradientStopCollection_SetAt(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"SetAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.GradientStopCollection", L"Size"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static int _seq_assign_GradientStopCollection(py::wrapper::Windows::UI::Xaml::Media::GradientStopCollection* self, Py_ssize_t i, PyObject* value) noexcept
    {
        ...
        {
            if (value == nullptr) { self->obj.RemoveAt(static_cast<uint32_t>(i)); }
            else { self->obj.SetAt(static_cast<uint32_t>(i), py::convert_to<winrt::Windows::UI::Xaml::Media::GradientStop>(value)); }
            return 0;
        }
        catch (...)
        {
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ImageBrush", L"ImageSource"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ImageBrush", L"ImageSourceProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsEventPresent(L"Windows.UI.Xaml.Media.ImageBrush", L"ImageFailed"))
        {
            PyErr_SetString(PyExc_AttributeError, "event is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsEventPresent(L"Windows.UI.Xaml.Media.ImageBrush", L"ImageOpened"))
        {
            PyErr_SetString(PyExc_AttributeError, "event is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_ImageBrush_Meta[] = {
        { "image_source_property", reinterpret_cast<getter>(ImageBrush_get_ImageSourceProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_ImageBrush_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_ImageBrush_Meta) },
        { }
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LineGeometry", L"StartPoint"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LineGeometry", L"EndPoint"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LineGeometry", L"EndPointProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LineGeometry", L"StartPointProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_LineGeometry_Meta[] = {
    ...
    static PyType_Slot type_slots_LineGeometry_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_LineGeometry_Meta) },
        { }
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LineSegment", L"Point"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LineSegment", L"PointProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_LineSegment_Meta[] = {
        { "point_property", reinterpret_cast<getter>(LineSegment_get_PointProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_LineSegment_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_LineSegment_Meta) },
        { }
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LinearGradientBrush", L"StartPoint"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LinearGradientBrush", L"EndPoint"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LinearGradientBrush", L"EndPointProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LinearGradientBrush", L"StartPointProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_LinearGradientBrush_Meta[] = {
    ...
    static PyType_Slot type_slots_LinearGradientBrush_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_LinearGradientBrush_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_LinearGradientBrush_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_LinearGradientBrush_Meta
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LoadedImageSourceLoadCompletedEventArgs", L"Status"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyObject* LoadedImageSurface_Close(py::wrapper::Windows::UI::Xaml::Media::LoadedImageSurface* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.LoadedImageSurface", L"Close", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* LoadedImageSurface_StartLoadFromStream(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.LoadedImageSurface", L"StartLoadFromStream", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
        ...
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.LoadedImageSurface", L"StartLoadFromStream", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* LoadedImageSurface_StartLoadFromUri(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.LoadedImageSurface", L"StartLoadFromUri", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
        ...
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.LoadedImageSurface", L"StartLoadFromUri", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LoadedImageSurface", L"DecodedPhysicalSize"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LoadedImageSurface", L"DecodedSize"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.LoadedImageSurface", L"NaturalSize"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsEventPresent(L"Windows.UI.Xaml.Media.LoadedImageSurface", L"LoadCompleted"))
        {
            PyErr_SetString(PyExc_AttributeError, "event is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyMethodDef _methods_LoadedImageSurface[] = {
        ...
        { "start_load_from_stream", reinterpret_cast<PyCFunction>(LoadedImageSurface_StartLoadFromStream), METH_VARARGS | METH_STATIC, nullptr },
        { "start_load_from_uri", reinterpret_cast<PyCFunction>(LoadedImageSurface_StartLoadFromUri), METH_VARARGS | METH_STATIC, nullptr },
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Matrix3DProjection", L"ProjectionMatrix"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.Matrix3DProjection", L"ProjectionMatrixProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_Matrix3DProjection_Meta[] = {
    ...
    static PyType_Slot type_slots_Matrix3DProjection_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_Matrix3DProjection_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_Matrix3DProjection_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_Matrix3DProjection_Meta
    };
    ...
    static PyObject* MatrixHelper_FromElements(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 6)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.MatrixHelper", L"FromElements", 6))
            {
    ...
    static PyObject* MatrixHelper_GetIsIdentity(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.MatrixHelper", L"GetIsIdentity", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* MatrixHelper_Transform(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.MatrixHelper", L"Transform", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.MatrixHelper", L"Identity"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyMethodDef _methods_MatrixHelper[] = {
        { "from_elements", reinterpret_cast<PyCFunction>(MatrixHelper_FromElements), METH_VARARGS | METH_STATIC, nullptr },
        { "get_is_identity", reinterpret_cast<PyCFunction>(MatrixHelper_GetIsIdentity), METH_VARARGS | METH_STATIC, nullptr },
        { "transform", reinterpret_cast<PyCFunction>(MatrixHelper_Transform), METH_VARARGS | METH_STATIC, nullptr },
    ...
    static PyGetSetDef getset_MatrixHelper_Meta[] = {
        { "identity", reinterpret_cast<getter>(MatrixHelper_get_Identity), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_MatrixHelper_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_MatrixHelper_Meta) },
        { }
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.MatrixTransform", L"Matrix"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.MatrixTransform", L"MatrixProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_MatrixTransform_Meta[] = {
        { "matrix_property", reinterpret_cast<getter>(MatrixTransform_get_MatrixProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_MatrixTransform_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_MatrixTransform_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_MatrixTransform_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_MatrixTransform_Meta
    };
    ...
    static PyObject* MediaTransportControlsThumbnailRequestedEventArgs_GetDeferral(py::wrapper::Windows::UI::Xaml::Media::MediaTransportControlsThumbnailRequestedEventArgs* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.MediaTransportControlsThumbnailRequestedEventArgs", L"GetDeferral", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* MediaTransportControlsThumbnailRequestedEventArgs_SetThumbnailImage(py::wrapper::Windows::UI::Xaml::Media::MediaTransportControlsThumbnailRequestedEventArgs* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.MediaTransportControlsThumbnailRequestedEventArgs", L"SetThumbnailImage", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PartialMediaFailureDetectedEventArgs", L"StreamKind"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PartialMediaFailureDetectedEventArgs", L"ExtendedError"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathFigure", L"StartPoint"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathFigure", L"Segments"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathFigure", L"IsFilled"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathFigure", L"IsClosed"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathFigure", L"IsClosedProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathFigure", L"IsFilledProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathFigure", L"SegmentsProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathFigure", L"StartPointProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_PathFigure_Meta[] = {
    ...
    static PyType_Slot type_slots_PathFigure_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_PathFigure_Meta) },
        { }
    };
    ...
    static PyObject* PathFigureCollection_Append(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"Append", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PathFigureCollection_Clear(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"Clear", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* PathFigureCollection_First(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"First", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* PathFigureCollection_GetAt(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"GetAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PathFigureCollection_GetMany(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"GetMany", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PathFigureCollection_GetView(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"GetView", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* PathFigureCollection_IndexOf(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"IndexOf", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PathFigureCollection_InsertAt(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"InsertAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* PathFigureCollection_RemoveAt(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"RemoveAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PathFigureCollection_RemoveAtEnd(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"RemoveAtEnd", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* PathFigureCollection_ReplaceAll(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"ReplaceAll", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PathFigureCollection_SetAt(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"SetAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathFigureCollection", L"Size"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static int _seq_assign_PathFigureCollection(py::wrapper::Windows::UI::Xaml::Media::PathFigureCollection* self, Py_ssize_t i, PyObject* value) noexcept
    {
        ...
        {
            if (value == nullptr) { self->obj.RemoveAt(static_cast<uint32_t>(i)); }
            else { self->obj.SetAt(static_cast<uint32_t>(i), py::convert_to<winrt::Windows::UI::Xaml::Media::PathFigure>(value)); }
            return 0;
        }
        catch (...)
        {
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathGeometry", L"FillRule"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathGeometry", L"Figures"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathGeometry", L"FiguresProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathGeometry", L"FillRuleProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_PathGeometry_Meta[] = {
    ...
    static PyType_Slot type_slots_PathGeometry_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_PathGeometry_Meta) },
        { }
    };
    ...
    static PyObject* PathSegmentCollection_Append(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"Append", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PathSegmentCollection_Clear(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"Clear", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* PathSegmentCollection_First(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"First", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* PathSegmentCollection_GetAt(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"GetAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PathSegmentCollection_GetMany(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"GetMany", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PathSegmentCollection_GetView(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"GetView", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* PathSegmentCollection_IndexOf(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"IndexOf", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PathSegmentCollection_InsertAt(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"InsertAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* PathSegmentCollection_RemoveAt(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"RemoveAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PathSegmentCollection_RemoveAtEnd(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"RemoveAtEnd", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* PathSegmentCollection_ReplaceAll(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"ReplaceAll", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PathSegmentCollection_SetAt(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"SetAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PathSegmentCollection", L"Size"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static int _seq_assign_PathSegmentCollection(py::wrapper::Windows::UI::Xaml::Media::PathSegmentCollection* self, Py_ssize_t i, PyObject* value) noexcept
    {
        ...
        {
            if (value == nullptr) { self->obj.RemoveAt(static_cast<uint32_t>(i)); }
            else { self->obj.SetAt(static_cast<uint32_t>(i), py::convert_to<winrt::Windows::UI::Xaml::Media::PathSegment>(value)); }
            return 0;
        }
        catch (...)
        {
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"RotationZ"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"RotationY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"RotationX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"LocalOffsetZ"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"LocalOffsetY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"LocalOffsetX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"GlobalOffsetZ"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"GlobalOffsetY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"GlobalOffsetX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"CenterOfRotationZ"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"CenterOfRotationY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"CenterOfRotationX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"ProjectionMatrix"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"CenterOfRotationXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"CenterOfRotationYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"CenterOfRotationZProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"GlobalOffsetXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"GlobalOffsetYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"GlobalOffsetZProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"LocalOffsetXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"LocalOffsetYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"LocalOffsetZProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"ProjectionMatrixProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"RotationXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"RotationYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PlaneProjection", L"RotationZProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_PlaneProjection_Meta[] = {
    ...
    static PyType_Slot type_slots_PlaneProjection_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_PlaneProjection_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_PlaneProjection_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_PlaneProjection_Meta
    };
    ...
    static PyObject* PointCollection_Append(py::wrapper::Windows::UI::Xaml::Media::PointCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PointCollection", L"Append", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PointCollection_Clear(py::wrapper::Windows::UI::Xaml::Media::PointCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PointCollection", L"Clear", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* PointCollection_First(py::wrapper::Windows::UI::Xaml::Media::PointCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PointCollection", L"First", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* PointCollection_GetAt(py::wrapper::Windows::UI::Xaml::Media::PointCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PointCollection", L"GetAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PointCollection_GetMany(py::wrapper::Windows::UI::Xaml::Media::PointCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PointCollection", L"GetMany", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PointCollection_GetView(py::wrapper::Windows::UI::Xaml::Media::PointCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PointCollection", L"GetView", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* PointCollection_IndexOf(py::wrapper::Windows::UI::Xaml::Media::PointCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PointCollection", L"IndexOf", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PointCollection_InsertAt(py::wrapper::Windows::UI::Xaml::Media::PointCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PointCollection", L"InsertAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* PointCollection_RemoveAt(py::wrapper::Windows::UI::Xaml::Media::PointCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PointCollection", L"RemoveAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PointCollection_RemoveAtEnd(py::wrapper::Windows::UI::Xaml::Media::PointCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PointCollection", L"RemoveAtEnd", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* PointCollection_ReplaceAll(py::wrapper::Windows::UI::Xaml::Media::PointCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PointCollection", L"ReplaceAll", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* PointCollection_SetAt(py::wrapper::Windows::UI::Xaml::Media::PointCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.PointCollection", L"SetAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PointCollection", L"Size"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PolyBezierSegment", L"Points"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PolyBezierSegment", L"PointsProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_PolyBezierSegment_Meta[] = {
        { "points_property", reinterpret_cast<getter>(PolyBezierSegment_get_PointsProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_PolyBezierSegment_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_PolyBezierSegment_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_PolyBezierSegment_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_PolyBezierSegment_Meta
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PolyLineSegment", L"Points"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PolyLineSegment", L"PointsProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_PolyLineSegment_Meta[] = {
        { "points_property", reinterpret_cast<getter>(PolyLineSegment_get_PointsProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_PolyLineSegment_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_PolyLineSegment_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_PolyLineSegment_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_PolyLineSegment_Meta
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PolyQuadraticBezierSegment", L"Points"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.PolyQuadraticBezierSegment", L"PointsProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_PolyQuadraticBezierSegment_Meta[] = {
        { "points_property", reinterpret_cast<getter>(PolyQuadraticBezierSegment_get_PointsProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_PolyQuadraticBezierSegment_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_PolyQuadraticBezierSegment_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_PolyQuadraticBezierSegment_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_PolyQuadraticBezierSegment_Meta
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.QuadraticBezierSegment", L"Point2"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.QuadraticBezierSegment", L"Point1"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.QuadraticBezierSegment", L"Point1Property"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.QuadraticBezierSegment", L"Point2Property"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_QuadraticBezierSegment_Meta[] = {
    ...
    static PyType_Slot type_slots_QuadraticBezierSegment_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_QuadraticBezierSegment_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_QuadraticBezierSegment_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_QuadraticBezierSegment_Meta
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RectangleGeometry", L"Rect"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RectangleGeometry", L"RectProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_RectangleGeometry_Meta[] = {
        { "rect_property", reinterpret_cast<getter>(RectangleGeometry_get_RectProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_RectangleGeometry_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_RectangleGeometry_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_RectangleGeometry_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_RectangleGeometry_Meta
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RenderedEventArgs", L"FrameDuration"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RenderingEventArgs", L"RenderingTime"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyObject* RevealBrush_GetState(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.RevealBrush", L"GetState", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* RevealBrush_SetState(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.RevealBrush", L"SetState", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RevealBrush", L"TargetTheme"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
        ...
        try
        {
            return py::convert(self->obj.TargetTheme());
        }
        catch (...)
        {
            py::to_PyErr();
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RevealBrush", L"Color"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RevealBrush", L"AlwaysUseFallback"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RevealBrush", L"AlwaysUseFallbackProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RevealBrush", L"ColorProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RevealBrush", L"StateProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RevealBrush", L"TargetThemeProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyMethodDef _methods_RevealBrush[] = {
        { "get_state", reinterpret_cast<PyCFunction>(RevealBrush_GetState), METH_VARARGS | METH_STATIC, nullptr },
        { "set_state", reinterpret_cast<PyCFunction>(RevealBrush_SetState), METH_VARARGS | METH_STATIC, nullptr },
    ...
    static PyGetSetDef getset_RevealBrush_Meta[] = {
    ...
    static PyType_Slot type_slots_RevealBrush_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_RevealBrush_Meta) },
        { }
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RotateTransform", L"CenterY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RotateTransform", L"CenterX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RotateTransform", L"Angle"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RotateTransform", L"AngleProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RotateTransform", L"CenterXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.RotateTransform", L"CenterYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_RotateTransform_Meta[] = {
    ...
    static PyType_Slot type_slots_RotateTransform_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_RotateTransform_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_RotateTransform_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_RotateTransform_Meta
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ScaleTransform", L"ScaleY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ScaleTransform", L"ScaleX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ScaleTransform", L"CenterY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ScaleTransform", L"CenterX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ScaleTransform", L"CenterXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ScaleTransform", L"CenterYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ScaleTransform", L"ScaleXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ScaleTransform", L"ScaleYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_ScaleTransform_Meta[] = {
    ...
    static PyType_Slot type_slots_ScaleTransform_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_ScaleTransform_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_ScaleTransform_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_ScaleTransform_Meta
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.SkewTransform", L"CenterY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.SkewTransform", L"CenterX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.SkewTransform", L"AngleY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.SkewTransform", L"AngleX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.SkewTransform", L"AngleXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.SkewTransform", L"AngleYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.SkewTransform", L"CenterXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.SkewTransform", L"CenterYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_SkewTransform_Meta[] = {
    ...
    static PyType_Slot type_slots_SkewTransform_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_SkewTransform_Meta) },
        { }
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.SolidColorBrush", L"Color"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.SolidColorBrush", L"ColorProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_SolidColorBrush_Meta[] = {
        { "color_property", reinterpret_cast<getter>(SolidColorBrush_get_ColorProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_SolidColorBrush_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_SolidColorBrush_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_SolidColorBrush_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_SolidColorBrush_Meta
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.ThemeShadow", L"Receivers"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TileBrush", L"Stretch"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TileBrush", L"AlignmentY"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TileBrush", L"AlignmentX"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TileBrush", L"AlignmentXProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TileBrush", L"AlignmentYProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TileBrush", L"StretchProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_TileBrush_Meta[] = {
    ...
    static PyType_Slot type_slots_TileBrush_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_TileBrush_Meta) },
        { }
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TimelineMarker", L"Type"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TimelineMarker", L"Time"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TimelineMarker", L"Text"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TimelineMarker", L"TextProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TimelineMarker", L"TimeProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TimelineMarker", L"TypeProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_TimelineMarker_Meta[] = {
    ...
    static PyType_Slot type_slots_TimelineMarker_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_TimelineMarker_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_TimelineMarker_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_TimelineMarker_Meta
    };
    ...
    static PyObject* TimelineMarkerCollection_Append(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"Append", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* TimelineMarkerCollection_Clear(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"Clear", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* TimelineMarkerCollection_First(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"First", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* TimelineMarkerCollection_GetAt(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"GetAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* TimelineMarkerCollection_GetMany(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"GetMany", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* TimelineMarkerCollection_GetView(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"GetView", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* TimelineMarkerCollection_IndexOf(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"IndexOf", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* TimelineMarkerCollection_InsertAt(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"InsertAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* TimelineMarkerCollection_RemoveAt(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"RemoveAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* TimelineMarkerCollection_RemoveAtEnd(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"RemoveAtEnd", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* TimelineMarkerCollection_ReplaceAll(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"ReplaceAll", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* TimelineMarkerCollection_SetAt(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"SetAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TimelineMarkerCollection", L"Size"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static int _seq_assign_TimelineMarkerCollection(py::wrapper::Windows::UI::Xaml::Media::TimelineMarkerCollection* self, Py_ssize_t i, PyObject* value) noexcept
    {
        ...
        {
            if (value == nullptr) { self->obj.RemoveAt(static_cast<uint32_t>(i)); }
            else { self->obj.SetAt(static_cast<uint32_t>(i), py::convert_to<winrt::Windows::UI::Xaml::Media::TimelineMarker>(value)); }
            return 0;
        }
        catch (...)
        {
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TimelineMarkerRoutedEventArgs", L"Marker"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyObject* TransformCollection_Append(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"Append", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* TransformCollection_Clear(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"Clear", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* TransformCollection_First(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"First", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* TransformCollection_GetAt(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"GetAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* TransformCollection_GetMany(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"GetMany", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* TransformCollection_GetView(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"GetView", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* TransformCollection_IndexOf(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"IndexOf", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* TransformCollection_InsertAt(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"InsertAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* TransformCollection_RemoveAt(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"RemoveAt", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* TransformCollection_RemoveAtEnd(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"RemoveAtEnd", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* TransformCollection_ReplaceAll(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"ReplaceAll", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* TransformCollection_SetAt(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"SetAt", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TransformCollection", L"Size"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static int _seq_assign_TransformCollection(py::wrapper::Windows::UI::Xaml::Media::TransformCollection* self, Py_ssize_t i, PyObject* value) noexcept
    {
        ...
        {
            if (value == nullptr) { self->obj.RemoveAt(static_cast<uint32_t>(i)); }
            else { self->obj.SetAt(static_cast<uint32_t>(i), py::convert_to<winrt::Windows::UI::Xaml::Media::Transform>(value)); }
            return 0;
        }
        catch (...)
        {
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TransformGroup", L"Children"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TransformGroup", L"Value"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TransformGroup", L"ChildrenProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_TransformGroup_Meta[] = {
        { "children_property", reinterpret_cast<getter>(TransformGroup_get_ChildrenProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_TransformGroup_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_TransformGroup_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_TransformGroup_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_TransformGroup_Meta
    };
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TranslateTransform", L"Y"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TranslateTransform", L"X"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TranslateTransform", L"XProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.TranslateTransform", L"YProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_TranslateTransform_Meta[] = {
    ...
    static PyType_Slot type_slots_TranslateTransform_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_TranslateTransform_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_TranslateTransform_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_TranslateTransform_Meta
    };
    ...
    static PyObject* VisualTreeHelper_DisconnectChildrenRecursive(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.VisualTreeHelper", L"DisconnectChildrenRecursive", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* VisualTreeHelper_FindElementsInHostCoordinates(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.VisualTreeHelper", L"FindElementsInHostCoordinates", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
        ...
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.VisualTreeHelper", L"FindElementsInHostCoordinates", 3))
            {
    ...
    static PyObject* VisualTreeHelper_GetChild(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.VisualTreeHelper", L"GetChild", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* VisualTreeHelper_GetChildrenCount(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.VisualTreeHelper", L"GetChildrenCount", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* VisualTreeHelper_GetOpenPopups(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.VisualTreeHelper", L"GetOpenPopups", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* VisualTreeHelper_GetOpenPopupsForXamlRoot(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.VisualTreeHelper", L"GetOpenPopupsForXamlRoot", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* VisualTreeHelper_GetParent(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.VisualTreeHelper", L"GetParent", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyMethodDef _methods_VisualTreeHelper[] = {
        { "disconnect_children_recursive", reinterpret_cast<PyCFunction>(VisualTreeHelper_DisconnectChildrenRecursive), METH_VARARGS | METH_STATIC, nullptr },
        { "find_elements_in_host_coordinates", reinterpret_cast<PyCFunction>(VisualTreeHelper_FindElementsInHostCoordinates), METH_VARARGS | METH_STATIC, nullptr },
        { "get_child", reinterpret_cast<PyCFunction>(VisualTreeHelper_GetChild), METH_VARARGS | METH_STATIC, nullptr },
        { "get_children_count", reinterpret_cast<PyCFunction>(VisualTreeHelper_GetChildrenCount), METH_VARARGS | METH_STATIC, nullptr },
        { "get_open_popups", reinterpret_cast<PyCFunction>(VisualTreeHelper_GetOpenPopups), METH_VARARGS | METH_STATIC, nullptr },
        { "get_open_popups_for_xaml_root", reinterpret_cast<PyCFunction>(VisualTreeHelper_GetOpenPopupsForXamlRoot), METH_VARARGS | METH_STATIC, nullptr },
        { "get_parent", reinterpret_cast<PyCFunction>(VisualTreeHelper_GetParent), METH_VARARGS | METH_STATIC, nullptr },
    ...
    static PyObject* XamlCompositionBrushBase_OnConnected(py::wrapper::Windows::UI::Xaml::Media::XamlCompositionBrushBase* self, PyObject* args) noexcept
    {
        auto arg_count = PyTuple_Size(args);

        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.XamlCompositionBrushBase", L"OnConnected", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* XamlCompositionBrushBase_OnDisconnected(py::wrapper::Windows::UI::Xaml::Media::XamlCompositionBrushBase* self, PyObject* args) noexcept
    {
        auto arg_count = PyTuple_Size(args);

        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.XamlCompositionBrushBase", L"OnDisconnected", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.XamlCompositionBrushBase", L"FallbackColor"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyObject* XamlCompositionBrushBase_get_CompositionBrush(py::wrapper::Windows::UI::Xaml::Media::XamlCompositionBrushBase* self, void* /*unused*/) noexcept
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.XamlCompositionBrushBase", L"CompositionBrush"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static int XamlCompositionBrushBase_put_CompositionBrush(py::wrapper::Windows::UI::Xaml::Media::XamlCompositionBrushBase* self, PyObject* arg, void* /*unused*/) noexcept
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.XamlCompositionBrushBase", L"CompositionBrush"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
    ...
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.XamlCompositionBrushBase", L"FallbackColorProperty"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static PyGetSetDef getset_XamlCompositionBrushBase_Meta[] = {
    ...
    static PyType_Slot type_slots_XamlCompositionBrushBase_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_XamlCompositionBrushBase_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_XamlCompositionBrushBase_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_XamlCompositionBrushBase_Meta
    };
    ...
    static PyObject* XamlLight_AddTargetBrush(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.XamlLight", L"AddTargetBrush", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* XamlLight_AddTargetElement(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.XamlLight", L"AddTargetElement", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* XamlLight_GetId(py::wrapper::Windows::UI::Xaml::Media::XamlLight* self, PyObject* args) noexcept
    {
        auto arg_count = PyTuple_Size(args);

        if (arg_count == 0)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.XamlLight", L"GetId", 0))
            {
                py::set_arg_count_version_error(0);
                return nullptr;
            }
    ...
    static PyObject* XamlLight_OnConnected(py::wrapper::Windows::UI::Xaml::Media::XamlLight* self, PyObject* args) noexcept
    {
        auto arg_count = PyTuple_Size(args);

        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.XamlLight", L"OnConnected", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* XamlLight_OnDisconnected(py::wrapper::Windows::UI::Xaml::Media::XamlLight* self, PyObject* args) noexcept
    {
        auto arg_count = PyTuple_Size(args);

        if (arg_count == 1)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.XamlLight", L"OnDisconnected", 1))
            {
                py::set_arg_count_version_error(1);
                return nullptr;
            }
    ...
    static PyObject* XamlLight_RemoveTargetBrush(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.XamlLight", L"RemoveTargetBrush", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* XamlLight_RemoveTargetElement(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Xaml.Media.XamlLight", L"RemoveTargetElement", 2))
            {
                py::set_arg_count_version_error(2);
                return nullptr;
            }
    ...
    static PyObject* XamlLight_get_CompositionLight(py::wrapper::Windows::UI::Xaml::Media::XamlLight* self, void* /*unused*/) noexcept
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.XamlLight", L"CompositionLight"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
            return nullptr;
        }
    ...
    static int XamlLight_put_CompositionLight(py::wrapper::Windows::UI::Xaml::Media::XamlLight* self, PyObject* arg, void* /*unused*/) noexcept
    {
        if (!winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Xaml.Media.XamlLight", L"CompositionLight"))
        {
            PyErr_SetString(PyExc_AttributeError, "property is not available in this version of Windows");
    ...
    static PyMethodDef _methods_XamlLight[] = {
        { "add_target_brush", reinterpret_cast<PyCFunction>(XamlLight_AddTargetBrush), METH_VARARGS | METH_STATIC, nullptr },
        { "add_target_element", reinterpret_cast<PyCFunction>(XamlLight_AddTargetElement), METH_VARARGS | METH_STATIC, nullptr },
        ...
        { "remove_target_brush", reinterpret_cast<PyCFunction>(XamlLight_RemoveTargetBrush), METH_VARARGS | METH_STATIC, nullptr },
        { "remove_target_element", reinterpret_cast<PyCFunction>(XamlLight_RemoveTargetElement), METH_VARARGS | METH_STATIC, nullptr },
    ...
    static PyMethodDef module_methods[] = {
        {"_register_AcrylicBackgroundSource", register_AcrylicBackgroundSource, METH_O, "registers type"},
        {"_register_AlignmentX", register_AlignmentX, METH_O, "registers type"},
        {"_register_AlignmentY", register_AlignmentY, METH_O, "registers type"},
        {"_register_AudioCategory", register_AudioCategory, METH_O, "registers type"},
        {"_register_AudioDeviceType", register_AudioDeviceType, METH_O, "registers type"},
        {"_register_BrushMappingMode", register_BrushMappingMode, METH_O, "registers type"},
        {"_register_ColorInterpolationMode", register_ColorInterpolationMode, METH_O, "registers type"},
        {"_register_ElementCompositeMode", register_ElementCompositeMode, METH_O, "registers type"},
        {"_register_FastPlayFallbackBehaviour", register_FastPlayFallbackBehaviour, METH_O, "registers type"},
        {"_register_FillRule", register_FillRule, METH_O, "registers type"},
        {"_register_GradientSpreadMethod", register_GradientSpreadMethod, METH_O, "registers type"},
        {"_register_LoadedImageSourceLoadStatus", register_LoadedImageSourceLoadStatus, METH_O, "registers type"},
        {"_register_MediaCanPlayResponse", register_MediaCanPlayResponse, METH_O, "registers type"},
        {"_register_MediaElementState", register_MediaElementState, METH_O, "registers type"},
        {"_register_PenLineCap", register_PenLineCap, METH_O, "registers type"},
        {"_register_PenLineJoin", register_PenLineJoin, METH_O, "registers type"},
        {"_register_RevealBrushState", register_RevealBrushState, METH_O, "registers type"},
        {"_register_Stereo3DVideoPackingMode", register_Stereo3DVideoPackingMode, METH_O, "registers type"},
        {"_register_Stereo3DVideoRenderMode", register_Stereo3DVideoRenderMode, METH_O, "registers type"},
        {"_register_Stretch", register_Stretch, METH_O, "registers type"},
        {"_register_StyleSimulations", register_StyleSimulations, METH_O, "registers type"},
        {"_register_SweepDirection", register_SweepDirection, METH_O, "registers type"},
        {}};
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_AcrylicBackgroundSource);
        Py_VISIT(state->type_AlignmentX);
        Py_VISIT(state->type_AlignmentY);
        Py_VISIT(state->type_AudioCategory);
        Py_VISIT(state->type_AudioDeviceType);
        Py_VISIT(state->type_BrushMappingMode);
        Py_VISIT(state->type_ColorInterpolationMode);
        Py_VISIT(state->type_ElementCompositeMode);
        Py_VISIT(state->type_FastPlayFallbackBehaviour);
        Py_VISIT(state->type_FillRule);
        Py_VISIT(state->type_GradientSpreadMethod);
        Py_VISIT(state->type_LoadedImageSourceLoadStatus);
        Py_VISIT(state->type_MediaCanPlayResponse);
        Py_VISIT(state->type_MediaElementState);
        Py_VISIT(state->type_PenLineCap);
        Py_VISIT(state->type_PenLineJoin);
        Py_VISIT(state->type_RevealBrushState);
        Py_VISIT(state->type_Stereo3DVideoPackingMode);
        Py_VISIT(state->type_Stereo3DVideoRenderMode);
        Py_VISIT(state->type_Stretch);
        Py_VISIT(state->type_StyleSimulations);
        Py_VISIT(state->type_SweepDirection);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_AcrylicBackgroundSource);
        Py_CLEAR(state->type_AlignmentX);
        Py_CLEAR(state->type_AlignmentY);
        Py_CLEAR(state->type_AudioCategory);
        Py_CLEAR(state->type_AudioDeviceType);
        Py_CLEAR(state->type_BrushMappingMode);
        Py_CLEAR(state->type_ColorInterpolationMode);
        Py_CLEAR(state->type_ElementCompositeMode);
        Py_CLEAR(state->type_FastPlayFallbackBehaviour);
        Py_CLEAR(state->type_FillRule);
        Py_CLEAR(state->type_GradientSpreadMethod);
        Py_CLEAR(state->type_LoadedImageSourceLoadStatus);
        Py_CLEAR(state->type_MediaCanPlayResponse);
        Py_CLEAR(state->type_MediaElementState);
        Py_CLEAR(state->type_PenLineCap);
        Py_CLEAR(state->type_PenLineJoin);
        Py_CLEAR(state->type_RevealBrushState);
        Py_CLEAR(state->type_Stereo3DVideoPackingMode);
        Py_CLEAR(state->type_Stereo3DVideoRenderMode);
        Py_CLEAR(state->type_Stretch);
        Py_CLEAR(state->type_StyleSimulations);
        Py_CLEAR(state->type_SweepDirection);
...
PyMODINIT_FUNC PyInit__winrt_Windows_UI_Xaml_Media(void) noexcept
{
    ...
    py::pyobj_handle type_ArcSegment_Meta{PyType_FromSpec(&type_spec_ArcSegment_Meta)};
    if (!type_ArcSegment_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_BezierSegment_Meta{PyType_FromSpec(&type_spec_BezierSegment_Meta)};
    if (!type_BezierSegment_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_Brush_Meta{PyType_FromSpec(&type_spec_Brush_Meta)};
    if (!type_Brush_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_CompositeTransform_Meta{PyType_FromSpec(&type_spec_CompositeTransform_Meta)};
    if (!type_CompositeTransform_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_EllipseGeometry_Meta{PyType_FromSpec(&type_spec_EllipseGeometry_Meta)};
    if (!type_EllipseGeometry_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_FontFamily_Meta{PyType_FromSpec(&type_spec_FontFamily_Meta)};
    if (!type_FontFamily_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_Geometry_Meta{PyType_FromSpec(&type_spec_Geometry_Meta)};
    if (!type_Geometry_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_GeometryGroup_Meta{PyType_FromSpec(&type_spec_GeometryGroup_Meta)};
    if (!type_GeometryGroup_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_GradientBrush_Meta{PyType_FromSpec(&type_spec_GradientBrush_Meta)};
    if (!type_GradientBrush_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_GradientStop_Meta{PyType_FromSpec(&type_spec_GradientStop_Meta)};
    if (!type_GradientStop_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_ImageBrush_Meta{PyType_FromSpec(&type_spec_ImageBrush_Meta)};
    if (!type_ImageBrush_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_LineGeometry_Meta{PyType_FromSpec(&type_spec_LineGeometry_Meta)};
    if (!type_LineGeometry_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_LineSegment_Meta{PyType_FromSpec(&type_spec_LineSegment_Meta)};
    if (!type_LineSegment_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_LinearGradientBrush_Meta{PyType_FromSpec(&type_spec_LinearGradientBrush_Meta)};
    if (!type_LinearGradientBrush_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_Matrix3DProjection_Meta{PyType_FromSpec(&type_spec_Matrix3DProjection_Meta)};
    if (!type_Matrix3DProjection_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_MatrixHelper_Meta{PyType_FromSpec(&type_spec_MatrixHelper_Meta)};
    if (!type_MatrixHelper_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_MatrixTransform_Meta{PyType_FromSpec(&type_spec_MatrixTransform_Meta)};
    if (!type_MatrixTransform_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_PathFigure_Meta{PyType_FromSpec(&type_spec_PathFigure_Meta)};
    if (!type_PathFigure_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_PathGeometry_Meta{PyType_FromSpec(&type_spec_PathGeometry_Meta)};
    if (!type_PathGeometry_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_PlaneProjection_Meta{PyType_FromSpec(&type_spec_PlaneProjection_Meta)};
    if (!type_PlaneProjection_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_PolyBezierSegment_Meta{PyType_FromSpec(&type_spec_PolyBezierSegment_Meta)};
    if (!type_PolyBezierSegment_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_PolyLineSegment_Meta{PyType_FromSpec(&type_spec_PolyLineSegment_Meta)};
    if (!type_PolyLineSegment_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_PolyQuadraticBezierSegment_Meta{PyType_FromSpec(&type_spec_PolyQuadraticBezierSegment_Meta)};
    if (!type_PolyQuadraticBezierSegment_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_QuadraticBezierSegment_Meta{PyType_FromSpec(&type_spec_QuadraticBezierSegment_Meta)};
    if (!type_QuadraticBezierSegment_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_RectangleGeometry_Meta{PyType_FromSpec(&type_spec_RectangleGeometry_Meta)};
    if (!type_RectangleGeometry_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_RevealBrush_Meta{PyType_FromSpec(&type_spec_RevealBrush_Meta)};
    if (!type_RevealBrush_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_RotateTransform_Meta{PyType_FromSpec(&type_spec_RotateTransform_Meta)};
    if (!type_RotateTransform_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_ScaleTransform_Meta{PyType_FromSpec(&type_spec_ScaleTransform_Meta)};
    if (!type_ScaleTransform_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_SkewTransform_Meta{PyType_FromSpec(&type_spec_SkewTransform_Meta)};
    if (!type_SkewTransform_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_SolidColorBrush_Meta{PyType_FromSpec(&type_spec_SolidColorBrush_Meta)};
    if (!type_SolidColorBrush_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_TileBrush_Meta{PyType_FromSpec(&type_spec_TileBrush_Meta)};
    if (!type_TileBrush_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_TimelineMarker_Meta{PyType_FromSpec(&type_spec_TimelineMarker_Meta)};
    if (!type_TimelineMarker_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_TransformGroup_Meta{PyType_FromSpec(&type_spec_TransformGroup_Meta)};
    if (!type_TransformGroup_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_TranslateTransform_Meta{PyType_FromSpec(&type_spec_TranslateTransform_Meta)};
    if (!type_TranslateTransform_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_XamlCompositionBrushBase_Meta{PyType_FromSpec(&type_spec_XamlCompositionBrushBase_Meta)};
    if (!type_XamlCompositionBrushBase_Meta)
    {
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::AcrylicBackgroundSource>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_AcrylicBackgroundSource;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::AcrylicBackgroundSource is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::AlignmentX>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_AlignmentX;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::AlignmentX is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::AlignmentY>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_AlignmentY;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::AlignmentY is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::AudioCategory>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_AudioCategory;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::AudioCategory is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::AudioDeviceType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_AudioDeviceType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::AudioDeviceType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::BrushMappingMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_BrushMappingMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::BrushMappingMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::ColorInterpolationMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_ColorInterpolationMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::ColorInterpolationMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::ElementCompositeMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_ElementCompositeMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::ElementCompositeMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::FastPlayFallbackBehaviour>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_FastPlayFallbackBehaviour;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::FastPlayFallbackBehaviour is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::FillRule>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_FillRule;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::FillRule is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::GradientSpreadMethod>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_GradientSpreadMethod;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::GradientSpreadMethod is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::LoadedImageSourceLoadStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_LoadedImageSourceLoadStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::LoadedImageSourceLoadStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::MediaCanPlayResponse>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_MediaCanPlayResponse;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::MediaCanPlayResponse is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::MediaElementState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_MediaElementState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::MediaElementState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::PenLineCap>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_PenLineCap;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::PenLineCap is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::PenLineJoin>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_PenLineJoin;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::PenLineJoin is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::RevealBrushState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_RevealBrushState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::RevealBrushState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::Stereo3DVideoPackingMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_Stereo3DVideoPackingMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::Stereo3DVideoPackingMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::Stereo3DVideoRenderMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_Stereo3DVideoRenderMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::Stereo3DVideoRenderMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::Stretch>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_Stretch;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::Stretch is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::StyleSimulations>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_StyleSimulations;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::StyleSimulations is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Media::SweepDirection>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Media;
    ...
    auto python_type = state->type_SweepDirection;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Media::SweepDirection is not registered");
        return nullptr;
    }
