...
class Brush(windows_ui_xaml.DependencyObject, windows_ui_composition.ImplementsIAnimationObject, metaclass=Brush_Static):
    @staticmethod
...
@typing.final
class LoadedImageSurface(winrt.system.Object, windows_ui_composition.ImplementsICompositionSurface, windows_foundation.ImplementsIClosable, metaclass=LoadedImageSurface_Static):
...
class VisualTreeHelper_Static(type):
    ...
    def find_all_elements_in_host_coordinates_point(cls, intersecting_point: windows_foundation.Point, subtree: windows_ui_xaml.UIElement, include_all_elements: bool, /) -> typing.Iterable[windows_ui_xaml.UIElement]: ...
    def find_all_elements_in_host_coordinates_rect(cls, intersecting_rect: windows_foundation.Rect, subtree: windows_ui_xaml.UIElement, include_all_elements: bool, /) -> typing.Iterable[windows_ui_xaml.UIElement]: ...
    def find_elements_in_host_coordinates_point(cls, intersecting_point: windows_foundation.Point, subtree: windows_ui_xaml.UIElement, /) -> typing.Iterable[windows_ui_xaml.UIElement]: ...
    def find_elements_in_host_coordinates_rect(cls, intersecting_rect: windows_foundation.Rect, subtree: windows_ui_xaml.UIElement, /) -> typing.Iterable[windows_ui_xaml.UIElement]: ...
