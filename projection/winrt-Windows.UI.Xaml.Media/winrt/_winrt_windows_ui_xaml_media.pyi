...
class VisualTreeHelper_Static(type):
    ...
    @typing.overload
    def find_elements_in_host_coordinates(cls, intersecting_point: windows_foundation.Point, subtree: typing.Optional[windows_ui_xaml.UIElement], /) -> typing.Optional[windows_foundation_collections.IIterable[windows_ui_xaml.UIElement]]: ...
    @typing.overload
    def find_elements_in_host_coordinates(cls, intersecting_point: windows_foundation.Point, subtree: typing.Optional[windows_ui_xaml.UIElement], include_all_elements: bool, /) -> typing.Optional[windows_foundation_collections.IIterable[windows_ui_xaml.UIElement]]: ...
