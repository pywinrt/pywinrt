...
class TimelineMarkerCollection(winrt.system.Object, winrt._winrt.MutableSequence[TimelineMarker]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[TimelineMarker]: ...
...
class VisualTreeHelper_Static(type):
    ...
    def find_all_elements_in_host_coordinates_point(cls, intersecting_point: windows_foundation.Point, subtree: windows_ui_xaml.UIElement, include_all_elements: bool, /) -> windows_foundation_collections.IIterable[windows_ui_xaml.UIElement]: ...
    def find_all_elements_in_host_coordinates_rect(cls, intersecting_rect: windows_foundation.Rect, subtree: windows_ui_xaml.UIElement, include_all_elements: bool, /) -> windows_foundation_collections.IIterable[windows_ui_xaml.UIElement]: ...
    def find_elements_in_host_coordinates_point(cls, intersecting_point: windows_foundation.Point, subtree: windows_ui_xaml.UIElement, /) -> windows_foundation_collections.IIterable[windows_ui_xaml.UIElement]: ...
    def find_elements_in_host_coordinates_rect(cls, intersecting_rect: windows_foundation.Rect, subtree: windows_ui_xaml.UIElement, /) -> windows_foundation_collections.IIterable[windows_ui_xaml.UIElement]: ...
    ...
    def get_open_popups(cls, window: windows_ui_xaml.Window, /) -> windows_foundation_collections.IVectorView[windows_ui_xaml_controls_primitives.Popup]: ...
    def get_open_popups_for_xaml_root(cls, xaml_root: windows_ui_xaml.XamlRoot, /) -> windows_foundation_collections.IVectorView[windows_ui_xaml_controls_primitives.Popup]: ...
