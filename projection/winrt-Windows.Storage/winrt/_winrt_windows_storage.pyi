...
class DownloadsFolder_Static(type):
    ...
    def create_file_for_user_with_collision_option_async(cls, user: typing.Optional[windows_system.User], desired_name: str, option: CreationCollisionOption, /) -> windows_foundation.IAsyncOperation[StorageFile]: ...
    ...
    def create_folder_for_user_with_collision_option_async(cls, user: typing.Optional[windows_system.User], desired_name: str, option: CreationCollisionOption, /) -> windows_foundation.IAsyncOperation[StorageFolder]: ...
...
class FileIO_Static(type):
    ...
    def append_lines_with_encoding_async(cls, file: typing.Optional[IStorageFile], lines: typing.Iterable[str], encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncAction: ...
    def append_text_async(cls, file: typing.Optional[IStorageFile], contents: str, /) -> windows_foundation.IAsyncAction: ...
    def append_text_with_encoding_async(cls, file: typing.Optional[IStorageFile], contents: str, encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncAction: ...
    ...
    def read_lines_with_encoding_async(cls, file: typing.Optional[IStorageFile], encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVector[str]]: ...
    def read_text_async(cls, file: typing.Optional[IStorageFile], /) -> windows_foundation.IAsyncOperation[str]: ...
    def read_text_with_encoding_async(cls, file: typing.Optional[IStorageFile], encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncOperation[str]: ...
    ...
    def write_bytes_async(cls, file: typing.Optional[IStorageFile], buffer: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> windows_foundation.IAsyncAction: ...
    def write_lines_async(cls, file: typing.Optional[IStorageFile], lines: typing.Iterable[str], /) -> windows_foundation.IAsyncAction: ...
    def write_lines_with_encoding_async(cls, file: typing.Optional[IStorageFile], lines: typing.Iterable[str], encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncAction: ...
    def write_text_async(cls, file: typing.Optional[IStorageFile], contents: str, /) -> windows_foundation.IAsyncAction: ...
    def write_text_with_encoding_async(cls, file: typing.Optional[IStorageFile], contents: str, encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncAction: ...
...
class PathIO_Static(type):
    ...
    def read_lines_with_encoding_async(cls, absolute_path: str, encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVector[str]]: ...
...
class StorageFile(winrt.system.Object, metaclass=StorageFile_Static):
    ...
    def copy_overload(self, destination_folder: typing.Optional[IStorageFolder], desired_new_name: str, option: NameCollisionOption, /) -> windows_foundation.IAsyncOperation[StorageFile]: ...
    def copy_overload_default_name_and_options(self, destination_folder: typing.Optional[IStorageFolder], /) -> windows_foundation.IAsyncOperation[StorageFile]: ...
    def copy_overload_default_options(self, destination_folder: typing.Optional[IStorageFolder], desired_new_name: str, /) -> windows_foundation.IAsyncOperation[StorageFile]: ...
    ...
    def move_overload(self, destination_folder: typing.Optional[IStorageFolder], desired_new_name: str, option: NameCollisionOption, /) -> windows_foundation.IAsyncAction: ...
    def move_overload_default_name_and_options(self, destination_folder: typing.Optional[IStorageFolder], /) -> windows_foundation.IAsyncAction: ...
    def move_overload_default_options(self, destination_folder: typing.Optional[IStorageFolder], desired_new_name: str, /) -> windows_foundation.IAsyncAction: ...
...
class StorageFolder(winrt.system.Object, metaclass=StorageFolder_Static):
    ...
    def get_files_async_overload_default_options_start_and_count(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[StorageFile]]: ...
    def get_files_async_overload_default_start_and_count(self, query: windows_storage_search.CommonFileQuery, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[StorageFile]]: ...
    ...
    def get_folders_async_overload_default_options_start_and_count(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[StorageFolder]]: ...
    def get_folders_async_overload_default_start_and_count(self, query: windows_storage_search.CommonFolderQuery, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[StorageFolder]]: ...
    ...
    def get_items_async_overload_default_start_and_count(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[IStorageItem]]: ...
    def get_parent_async(self) -> windows_foundation.IAsyncOperation[StorageFolder]: ...
    def get_scaled_image_as_thumbnail_async(self, mode: windows_storage_fileproperties.ThumbnailMode, requested_size: winrt.system.UInt32, options: windows_storage_fileproperties.ThumbnailOptions, /) -> windows_foundation.IAsyncOperation[windows_storage_fileproperties.StorageItemThumbnail]: ...
    def get_scaled_image_as_thumbnail_async_overload_default_options(self, mode: windows_storage_fileproperties.ThumbnailMode, requested_size: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_storage_fileproperties.StorageItemThumbnail]: ...
    def get_scaled_image_as_thumbnail_async_overload_default_size_default_options(self, mode: windows_storage_fileproperties.ThumbnailMode, /) -> windows_foundation.IAsyncOperation[windows_storage_fileproperties.StorageItemThumbnail]: ...
...
class StorageLibraryChangeTracker(winrt.system.Object):
    ...
    def enable_with_options(self, options: typing.Optional[StorageLibraryChangeTrackerOptions], /) -> None: ...
