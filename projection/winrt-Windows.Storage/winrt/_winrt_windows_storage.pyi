...
class ApplicationDataContainer(winrt.system.Object):
    ...
    @_property
    def containers(self) -> windows_foundation_collections.IMapView[str, ApplicationDataContainer]: ...
    @_property
...
class FileIO_Static(type):
    ...
    def read_lines_async(cls, file: IStorageFile, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVector[str]]: ...
    def read_lines_with_encoding_async(cls, file: IStorageFile, encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVector[str]]: ...
