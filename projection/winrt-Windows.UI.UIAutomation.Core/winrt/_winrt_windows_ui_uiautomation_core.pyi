...
class CoreAutomationRemoteOperation(winrt.system.Object):
    ...
    def execute(self, bytecode_buffer: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> typing.Optional[AutomationRemoteOperationResult]: ...
    def import_connection_bound_object(self, operand_id: AutomationRemoteOperationOperandId, connection_bound_object: typing.Optional[windows_ui_uiautomation.AutomationConnectionBoundObject], /) -> None: ...
    def import_element(self, operand_id: AutomationRemoteOperationOperandId, element: typing.Optional[windows_ui_uiautomation.AutomationElement], /) -> None: ...
    def import_text_range(self, operand_id: AutomationRemoteOperationOperandId, text_range: typing.Optional[windows_ui_uiautomation.AutomationTextRange], /) -> None: ...
...
class CoreAutomationRemoteOperationContext(winrt.system.Object):
    ...
    def set_operand2(self, id: AutomationRemoteOperationOperandId, operand: typing.Optional[winrt.system.Object], operand_interface_id: _uuid.UUID, /) -> None: ...
...
class RemoteAutomationClientSession(winrt.system.Object):
    ...
    def create_window_async(self, remote_window_id: winrt.system.UInt64, remote_process_id: winrt.system.UInt32, parent_automation_element: typing.Optional[winrt.system.Object], /) -> windows_foundation.IAsyncOperation[RemoteAutomationWindow]: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
...
class ICoreAutomationRemoteOperationExtensionProvider(winrt.system.Object):
    ...
    def call_extension(self, extension_id: _uuid.UUID, context: typing.Optional[CoreAutomationRemoteOperationContext], operand_ids: typing.Union[winrt.system.Array[AutomationRemoteOperationOperandId], winrt.system.ReadableBuffer], /) -> None: ...
