...
class CoreAutomationRegistrar(winrt.system.Object):
    ...
    @staticmethod
    def register_annotation_type(guid: winrt.system.Guid, /) -> AutomationAnnotationTypeRegistration: ...
    @staticmethod
...
class CoreAutomationRemoteOperationContext(winrt.system.Object):
    ...
    @typing.overload
    def set_operand(self, id: AutomationRemoteOperationOperandId, operand: typing.Optional[winrt.system.Object], operand_interface_id: winrt.system.Guid, /) -> None: ...
...
class RemoteAutomationClientSession(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[RemoteAutomationClientSession], name: str, session_id: winrt.system.Guid) -> RemoteAutomationClientSession:...
...
class RemoteAutomationServer(winrt.system.Object):
    ...
    @staticmethod
    def report_session(session_id: winrt.system.Guid, /) -> None: ...
...
class ICoreAutomationRemoteOperationExtensionProvider(winrt.system.Object):
    ...
    def call_extension(self, extension_id: winrt.system.Guid, context: typing.Optional[CoreAutomationRemoteOperationContext], operand_ids: winrt.system.Array[AutomationRemoteOperationOperandId], /) -> None: ...
    def is_extension_supported(self, extension_id: winrt.system.Guid, /) -> winrt.system.Boolean: ...
