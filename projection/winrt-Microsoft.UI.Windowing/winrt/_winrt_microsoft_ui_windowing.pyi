...
class AppWindow_Static(type):
    ...
    @typing.overload
    def create(cls, app_window_presenter: typing.Optional[AppWindowPresenter], owner_window_id: microsoft_ui.WindowId, /) -> typing.Optional[AppWindow]: ...
    @typing.overload
    def create(cls, app_window_presenter: typing.Optional[AppWindowPresenter], owner_window_id: microsoft_ui.WindowId, dispatcher_queue: typing.Optional[microsoft_ui_dispatching.DispatcherQueue], /) -> typing.Optional[AppWindow]: ...
...
class AppWindow(winrt.system.Object, metaclass=AppWindow_Static):
    ...
    @typing.overload
    def move_and_resize(self, rect: windows_graphics.RectInt32, displayarea: typing.Optional[DisplayArea], /) -> None: ...
...
class AppWindowTitleBar(winrt.system.Object, metaclass=AppWindowTitleBar_Static):
    ...
    def set_drag_rectangles(self, value: winrt.system.Array[windows_graphics.RectInt32], /) -> None: ...
    @_property
