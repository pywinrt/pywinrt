...
class AppWindow_Static(type):
    ...
    def create_with_dispatcher_queue(cls, app_window_presenter: typing.Optional[AppWindowPresenter], owner_window_id: microsoft_ui.WindowId, dispatcher_queue: typing.Optional[microsoft_ui_dispatching.DispatcherQueue], /) -> typing.Optional[AppWindow]: ...
    def create_with_presenter(cls, app_window_presenter: typing.Optional[AppWindowPresenter], /) -> typing.Optional[AppWindow]: ...
    def create_with_presenter_and_owner(cls, app_window_presenter: typing.Optional[AppWindowPresenter], owner_window_id: microsoft_ui.WindowId, /) -> typing.Optional[AppWindow]: ...
    def get_from_window_id(cls, window_id: microsoft_ui.WindowId, /) -> typing.Optional[AppWindow]: ...

@typing.final
class AppWindow(winrt.system.Object, metaclass=AppWindow_Static):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> AppWindow: ...
    def associate_with_dispatcher_queue(self, dispatcher_queue: typing.Optional[microsoft_ui_dispatching.DispatcherQueue], /) -> None: ...
    def destroy(self) -> None: ...
    def hide(self) -> None: ...
    def move(self, position: windows_graphics.PointInt32, /) -> None: ...
    def move_and_resize(self, rect: windows_graphics.RectInt32, /) -> None: ...
    def move_and_resize_relative_to_display_area(self, rect: windows_graphics.RectInt32, displayarea: typing.Optional[DisplayArea], /) -> None: ...
...
class DisplayArea_Static(type):
    ...
    def find_all(cls) -> typing.Optional[windows_foundation_collections.IVectorView[DisplayArea]]: ...
    def get_from_display_id(cls, display_id: microsoft_ui.DisplayId, /) -> typing.Optional[DisplayArea]: ...
    def get_from_point(cls, point: windows_graphics.PointInt32, display_area_fallback: DisplayAreaFallback, /) -> typing.Optional[DisplayArea]: ...
    def get_from_rect(cls, rect: windows_graphics.RectInt32, display_area_fallback: DisplayAreaFallback, /) -> typing.Optional[DisplayArea]: ...
    def get_from_window_id(cls, window_id: microsoft_ui.WindowId, display_area_fallback: DisplayAreaFallback, /) -> typing.Optional[DisplayArea]: ...
    @_property
