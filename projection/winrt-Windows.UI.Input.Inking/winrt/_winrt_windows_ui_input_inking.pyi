...
class InkManager(winrt.system.Object):
    ...
    def get_recognition_results(self) -> windows_foundation_collections.IVectorView[InkRecognitionResult]: ...
    def get_recognizers(self) -> windows_foundation_collections.IVectorView[InkRecognizer]: ...
    def get_strokes(self) -> windows_foundation_collections.IVectorView[InkStroke]: ...
    ...
    def recognize_async(self, stroke_collection: InkStrokeContainer, recognition_target: InkRecognitionTarget, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[InkRecognitionResult]]: ...
...
class InkPresenterProtractor(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[InkPresenterProtractor], ink_presenter: InkPresenter) -> InkPresenterProtractor: ...
    @_property
...
class InkPresenterRuler(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[InkPresenterRuler], ink_presenter: InkPresenter) -> InkPresenterRuler: ...
    @_property
...
class InkRecognitionResult(winrt.system.Object):
    ...
    def get_strokes(self) -> windows_foundation_collections.IVectorView[InkStroke]: ...
    def get_text_candidates(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def bounding_rect(self) -> windows_foundation.Rect: ...
...
class InkStroke(winrt.system.Object):
    ...
    def get_ink_points(self) -> windows_foundation_collections.IVectorView[InkPoint]: ...
    def get_rendering_segments(self) -> windows_foundation_collections.IVectorView[InkStrokeRenderingSegment]: ...
    @_property
...
class InkStrokesCollectedEventArgs(winrt.system.Object):
    ...
    @_property
    def strokes(self) -> windows_foundation_collections.IVectorView[InkStroke]: ...
...
class InkSynchronizer(winrt.system.Object):
    ...
    def begin_dry(self) -> windows_foundation_collections.IVectorView[InkStroke]: ...
