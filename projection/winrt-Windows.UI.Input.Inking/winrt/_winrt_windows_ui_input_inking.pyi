...
class InkManager(winrt.system.Object):
    ...
    def recognize_async2(self, recognition_target: InkRecognitionTarget, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[InkRecognitionResult]]: ...
...
class InkStrokeContainer(winrt.system.Object):
    ...
    def paste_from_clipboard(self, position: windows_foundation.Point, /) -> windows_foundation.Rect: ...
    def save_async(self, output_stream: typing.Optional[windows_storage_streams.IOutputStream], /) -> windows_foundation.IAsyncOperationWithProgress[winrt.system.UInt32, winrt.system.UInt32]: ...
    def save_with_format_async(self, output_stream: typing.Optional[windows_storage_streams.IOutputStream], ink_persistence_format: InkPersistenceFormat, /) -> windows_foundation.IAsyncOperationWithProgress[winrt.system.UInt32, winrt.system.UInt32]: ...
    def select_with_line(self, from_: windows_foundation.Point, to: windows_foundation.Point, /) -> windows_foundation.Rect: ...
    def select_with_poly_line(self, polyline: typing.Iterable[windows_foundation.Point], /) -> windows_foundation.Rect: ...
    def update_recognition_results(self, recognition_results: windows_foundation_collections.IVectorView[InkRecognitionResult], /) -> None: ...
    @_property
