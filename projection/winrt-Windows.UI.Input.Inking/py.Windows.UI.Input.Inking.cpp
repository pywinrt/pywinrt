...
namespace py::cpp::Windows::UI::Input::Inking
{
    struct module_state
    {
        PyObject* type_HandwritingLineHeight;
        PyObject* type_InkDrawingAttributesKind;
        PyObject* type_InkHighContrastAdjustment;
        PyObject* type_InkInputProcessingMode;
        PyObject* type_InkInputRightDragAction;
        PyObject* type_InkManipulationMode;
        PyObject* type_InkPersistenceFormat;
        PyObject* type_InkPresenterPredefinedConfiguration;
        PyObject* type_InkPresenterStencilKind;
        PyObject* type_InkRecognitionTarget;
        PyObject* type_PenHandedness;
        PyObject* type_PenTipShape;
    ...
    static PyObject* register_HandwritingLineHeight(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_HandwritingLineHeight)
        {
        ...
        state->type_HandwritingLineHeight = type;
        Py_INCREF(state->type_HandwritingLineHeight);


        Py_RETURN_NONE;
    }

    static PyObject* register_InkDrawingAttributesKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_InkDrawingAttributesKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_InkDrawingAttributesKind = type;
        Py_INCREF(state->type_InkDrawingAttributesKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_InkHighContrastAdjustment(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_InkHighContrastAdjustment)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_InkHighContrastAdjustment = type;
        Py_INCREF(state->type_InkHighContrastAdjustment);


        Py_RETURN_NONE;
    }

    static PyObject* register_InkInputProcessingMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_InkInputProcessingMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_InkInputProcessingMode = type;
        Py_INCREF(state->type_InkInputProcessingMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_InkInputRightDragAction(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_InkInputRightDragAction)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_InkInputRightDragAction = type;
        Py_INCREF(state->type_InkInputRightDragAction);


        Py_RETURN_NONE;
    }

    static PyObject* register_InkManipulationMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_InkManipulationMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_InkManipulationMode = type;
        Py_INCREF(state->type_InkManipulationMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_InkPersistenceFormat(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_InkPersistenceFormat)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_InkPersistenceFormat = type;
        Py_INCREF(state->type_InkPersistenceFormat);


        Py_RETURN_NONE;
    }

    static PyObject* register_InkPresenterPredefinedConfiguration(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_InkPresenterPredefinedConfiguration)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_InkPresenterPredefinedConfiguration = type;
        Py_INCREF(state->type_InkPresenterPredefinedConfiguration);


        Py_RETURN_NONE;
    }

    static PyObject* register_InkPresenterStencilKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_InkPresenterStencilKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_InkPresenterStencilKind = type;
        Py_INCREF(state->type_InkPresenterStencilKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_InkRecognitionTarget(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_InkRecognitionTarget)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_InkRecognitionTarget = type;
        Py_INCREF(state->type_InkRecognitionTarget);


        Py_RETURN_NONE;
    }

    static PyObject* register_PenHandedness(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PenHandedness)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PenHandedness = type;
        Py_INCREF(state->type_PenHandedness);


        Py_RETURN_NONE;
    }

    static PyObject* register_PenTipShape(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PenTipShape)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PenTipShape = type;
        Py_INCREF(state->type_PenTipShape);
    ...
    static PyMethodDef module_methods[] = {
        {"_register_HandwritingLineHeight", register_HandwritingLineHeight, METH_O, "registers type"},
        {"_register_InkDrawingAttributesKind", register_InkDrawingAttributesKind, METH_O, "registers type"},
        {"_register_InkHighContrastAdjustment", register_InkHighContrastAdjustment, METH_O, "registers type"},
        {"_register_InkInputProcessingMode", register_InkInputProcessingMode, METH_O, "registers type"},
        {"_register_InkInputRightDragAction", register_InkInputRightDragAction, METH_O, "registers type"},
        {"_register_InkManipulationMode", register_InkManipulationMode, METH_O, "registers type"},
        {"_register_InkPersistenceFormat", register_InkPersistenceFormat, METH_O, "registers type"},
        {"_register_InkPresenterPredefinedConfiguration", register_InkPresenterPredefinedConfiguration, METH_O, "registers type"},
        {"_register_InkPresenterStencilKind", register_InkPresenterStencilKind, METH_O, "registers type"},
        {"_register_InkRecognitionTarget", register_InkRecognitionTarget, METH_O, "registers type"},
        {"_register_PenHandedness", register_PenHandedness, METH_O, "registers type"},
        {"_register_PenTipShape", register_PenTipShape, METH_O, "registers type"},
        {}};
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_HandwritingLineHeight);
        Py_VISIT(state->type_InkDrawingAttributesKind);
        Py_VISIT(state->type_InkHighContrastAdjustment);
        Py_VISIT(state->type_InkInputProcessingMode);
        Py_VISIT(state->type_InkInputRightDragAction);
        Py_VISIT(state->type_InkManipulationMode);
        Py_VISIT(state->type_InkPersistenceFormat);
        Py_VISIT(state->type_InkPresenterPredefinedConfiguration);
        Py_VISIT(state->type_InkPresenterStencilKind);
        Py_VISIT(state->type_InkRecognitionTarget);
        Py_VISIT(state->type_PenHandedness);
        Py_VISIT(state->type_PenTipShape);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_HandwritingLineHeight);
        Py_CLEAR(state->type_InkDrawingAttributesKind);
        Py_CLEAR(state->type_InkHighContrastAdjustment);
        Py_CLEAR(state->type_InkInputProcessingMode);
        Py_CLEAR(state->type_InkInputRightDragAction);
        Py_CLEAR(state->type_InkManipulationMode);
        Py_CLEAR(state->type_InkPersistenceFormat);
        Py_CLEAR(state->type_InkPresenterPredefinedConfiguration);
        Py_CLEAR(state->type_InkPresenterStencilKind);
        Py_CLEAR(state->type_InkRecognitionTarget);
        Py_CLEAR(state->type_PenHandedness);
        Py_CLEAR(state->type_PenTipShape);
...
PyObject* py::py_type<winrt::Windows::UI::Input::Inking::HandwritingLineHeight>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input::Inking;
    ...
    auto python_type = state->type_HandwritingLineHeight;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::Inking::HandwritingLineHeight is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::Inking::InkDrawingAttributesKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input::Inking;
    ...
    auto python_type = state->type_InkDrawingAttributesKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::Inking::InkDrawingAttributesKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::Inking::InkHighContrastAdjustment>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input::Inking;
    ...
    auto python_type = state->type_InkHighContrastAdjustment;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::Inking::InkHighContrastAdjustment is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::Inking::InkInputProcessingMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input::Inking;
    ...
    auto python_type = state->type_InkInputProcessingMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::Inking::InkInputProcessingMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::Inking::InkInputRightDragAction>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input::Inking;
    ...
    auto python_type = state->type_InkInputRightDragAction;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::Inking::InkInputRightDragAction is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::Inking::InkManipulationMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input::Inking;
    ...
    auto python_type = state->type_InkManipulationMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::Inking::InkManipulationMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::Inking::InkPersistenceFormat>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input::Inking;
    ...
    auto python_type = state->type_InkPersistenceFormat;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::Inking::InkPersistenceFormat is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::Inking::InkPresenterPredefinedConfiguration>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input::Inking;
    ...
    auto python_type = state->type_InkPresenterPredefinedConfiguration;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::Inking::InkPresenterPredefinedConfiguration is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::Inking::InkPresenterStencilKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input::Inking;
    ...
    auto python_type = state->type_InkPresenterStencilKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::Inking::InkPresenterStencilKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::Inking::InkRecognitionTarget>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input::Inking;
    ...
    auto python_type = state->type_InkRecognitionTarget;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::Inking::InkRecognitionTarget is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::Inking::PenHandedness>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input::Inking;
    ...
    auto python_type = state->type_PenHandedness;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::Inking::PenHandedness is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Input::Inking::PenTipShape>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Input::Inking;
    ...
    auto python_type = state->type_PenTipShape;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Input::Inking::PenTipShape is not registered");
        return nullptr;
    }
