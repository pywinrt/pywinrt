...
class UsbDevice(winrt.system.Object):
    ...
    @typing.overload
    @staticmethod
    def get_device_selector(win_usb_interface_class: winrt.system.Guid, /) -> str: ...
    @typing.overload
    @staticmethod
    def get_device_selector(vendor_id: winrt.system.UInt32, product_id: winrt.system.UInt32, /) -> str: ...
    @typing.overload
    @staticmethod
    def get_device_selector(vendor_id: winrt.system.UInt32, product_id: winrt.system.UInt32, win_usb_interface_class: winrt.system.Guid, /) -> str: ...
    @typing.overload
