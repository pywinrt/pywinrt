...
class UsbConfiguration(winrt.system.Object):
    ...
    @_property
    def descriptors(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbDescriptor]]: ...
    @_property
    def usb_interfaces(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbInterface]]: ...
...
class UsbDescriptor(winrt.system.Object):
    ...
    def read_descriptor_buffer(self, buffer: typing.Optional[windows_storage_streams.IBuffer], /) -> None: ...
    @_property
...
class UsbDevice(winrt.system.Object, metaclass=UsbDevice_Static):
    ...
    def close(self) -> None: ...
    def send_control_in_transfer_async(self, setup_packet: typing.Optional[UsbSetupPacket], buffer: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IBuffer]: ...
    def send_control_in_transfer_async_no_buffer(self, setup_packet: typing.Optional[UsbSetupPacket], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IBuffer]: ...
    def send_control_out_transfer_async(self, setup_packet: typing.Optional[UsbSetupPacket], buffer: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncOperation[winrt.system.UInt32]: ...
    def send_control_out_transfer_async_no_buffer(self, setup_packet: typing.Optional[UsbSetupPacket], /) -> windows_foundation.IAsyncOperation[winrt.system.UInt32]: ...
    @_property
...
class UsbInterface(winrt.system.Object):
    ...
    @_property
    def bulk_in_pipes(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbBulkInPipe]]: ...
    @_property
    def bulk_out_pipes(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbBulkOutPipe]]: ...
    @_property
    def descriptors(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbDescriptor]]: ...
    @_property
    def interface_number(self) -> winrt.system.UInt8: ...
    @_property
    def interface_settings(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbInterfaceSetting]]: ...
    @_property
    def interrupt_in_pipes(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbInterruptInPipe]]: ...
    @_property
    def interrupt_out_pipes(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbInterruptOutPipe]]: ...
...
class UsbInterfaceSetting(winrt.system.Object):
    ...
    @_property
    def bulk_in_endpoints(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbBulkInEndpointDescriptor]]: ...
    @_property
    def bulk_out_endpoints(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbBulkOutEndpointDescriptor]]: ...
    @_property
    def descriptors(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbDescriptor]]: ...
    @_property
    def interface_descriptor(self) -> typing.Optional[UsbInterfaceDescriptor]: ...
    @_property
    def interrupt_in_endpoints(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbInterruptInEndpointDescriptor]]: ...
    @_property
    def interrupt_out_endpoints(self) -> typing.Optional[windows_foundation_collections.IVectorView[UsbInterruptOutEndpointDescriptor]]: ...
    @_property
...
class UsbInterruptInEventArgs(winrt.system.Object):
    ...
    @_property
    def interrupt_data(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
...
class UsbSetupPacket(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[UsbSetupPacket], eight_byte_buffer: typing.Optional[windows_storage_streams.IBuffer]) -> UsbSetupPacket: ...
    @typing.overload
