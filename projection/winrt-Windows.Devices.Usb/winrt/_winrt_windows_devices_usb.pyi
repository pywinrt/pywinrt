...
class UsbDevice(winrt.system.Object, metaclass=UsbDevice_Static):
    ...
    def close(self) -> None: ...
    @typing.overload
    def send_control_in_transfer_async(self, setup_packet: typing.Optional[UsbSetupPacket], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IBuffer]: ...
    @typing.overload
    ...
    @typing.overload
    def send_control_out_transfer_async(self, setup_packet: typing.Optional[UsbSetupPacket], /) -> windows_foundation.IAsyncOperation[winrt.system.UInt32]: ...
    @typing.overload
