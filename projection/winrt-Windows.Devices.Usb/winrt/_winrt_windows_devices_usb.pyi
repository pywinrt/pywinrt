...
class UsbConfiguration(winrt.system.Object):
    ...
    @_property
    def descriptors(self) -> windows_foundation_collections.IVectorView[UsbDescriptor]: ...
    @_property
    def usb_interfaces(self) -> windows_foundation_collections.IVectorView[UsbInterface]: ...
...
class UsbInterface(winrt.system.Object):
    ...
    @_property
    def bulk_in_pipes(self) -> windows_foundation_collections.IVectorView[UsbBulkInPipe]: ...
    @_property
    def bulk_out_pipes(self) -> windows_foundation_collections.IVectorView[UsbBulkOutPipe]: ...
    @_property
    def descriptors(self) -> windows_foundation_collections.IVectorView[UsbDescriptor]: ...
    @_property
    def interface_number(self) -> winrt.system.UInt8: ...
    @_property
    def interface_settings(self) -> windows_foundation_collections.IVectorView[UsbInterfaceSetting]: ...
    @_property
    def interrupt_in_pipes(self) -> windows_foundation_collections.IVectorView[UsbInterruptInPipe]: ...
    @_property
    def interrupt_out_pipes(self) -> windows_foundation_collections.IVectorView[UsbInterruptOutPipe]: ...
...
class UsbInterfaceSetting(winrt.system.Object):
    ...
    @_property
    def bulk_in_endpoints(self) -> windows_foundation_collections.IVectorView[UsbBulkInEndpointDescriptor]: ...
    @_property
    def bulk_out_endpoints(self) -> windows_foundation_collections.IVectorView[UsbBulkOutEndpointDescriptor]: ...
    @_property
    def descriptors(self) -> windows_foundation_collections.IVectorView[UsbDescriptor]: ...
    @_property
    def interface_descriptor(self) -> UsbInterfaceDescriptor: ...
    @_property
    def interrupt_in_endpoints(self) -> windows_foundation_collections.IVectorView[UsbInterruptInEndpointDescriptor]: ...
    @_property
    def interrupt_out_endpoints(self) -> windows_foundation_collections.IVectorView[UsbInterruptOutEndpointDescriptor]: ...
    @_property
...
class UsbSetupPacket(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[UsbSetupPacket], eight_byte_buffer: windows_storage_streams.IBuffer) -> UsbSetupPacket: ...
    @typing.overload
