...
class EnhancedWaypoint(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[EnhancedWaypoint], point: typing.Optional[windows_devices_geolocation.Geopoint], kind: WaypointKind) -> EnhancedWaypoint: ...
    @_property
...
class MapLocationFinder_Static(type):
    def find_locations_async(cls, search_text: str, reference_point: typing.Optional[windows_devices_geolocation.Geopoint], /) -> windows_foundation.IAsyncOperation[MapLocationFinderResult]: ...
    def find_locations_at_async(cls, query_point: typing.Optional[windows_devices_geolocation.Geopoint], /) -> windows_foundation.IAsyncOperation[MapLocationFinderResult]: ...
    def find_locations_at_with_accuracy_async(cls, query_point: typing.Optional[windows_devices_geolocation.Geopoint], accuracy: MapLocationDesiredAccuracy, /) -> windows_foundation.IAsyncOperation[MapLocationFinderResult]: ...
    def find_locations_with_max_count_async(cls, search_text: str, reference_point: typing.Optional[windows_devices_geolocation.Geopoint], max_count: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[MapLocationFinderResult]: ...
...
class MapLocationFinderResult(winrt.system.Object):
    ...
    @_property
    def locations(self) -> typing.Optional[windows_foundation_collections.IVectorView[MapLocation]]: ...
    @_property
...
class MapRoute(winrt.system.Object):
    ...
    @_property
    def legs(self) -> typing.Optional[windows_foundation_collections.IVectorView[MapRouteLeg]]: ...
    @_property
...
class MapRouteFinder_Static(type):
    def get_driving_route_async(cls, start_point: typing.Optional[windows_devices_geolocation.Geopoint], end_point: typing.Optional[windows_devices_geolocation.Geopoint], /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    ...
    def get_driving_route_from_enhanced_waypoints_with_options_async(cls, waypoints: typing.Iterable[EnhancedWaypoint], options: typing.Optional[MapRouteDrivingOptions], /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    ...
    def get_driving_route_with_optimization_and_restrictions_async(cls, start_point: typing.Optional[windows_devices_geolocation.Geopoint], end_point: typing.Optional[windows_devices_geolocation.Geopoint], optimization: MapRouteOptimization, restrictions: MapRouteRestrictions, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    def get_driving_route_with_optimization_async(cls, start_point: typing.Optional[windows_devices_geolocation.Geopoint], end_point: typing.Optional[windows_devices_geolocation.Geopoint], optimization: MapRouteOptimization, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    def get_driving_route_with_optimization_restrictions_and_heading_async(cls, start_point: typing.Optional[windows_devices_geolocation.Geopoint], end_point: typing.Optional[windows_devices_geolocation.Geopoint], optimization: MapRouteOptimization, restrictions: MapRouteRestrictions, heading_in_degrees: winrt.system.Double, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    def get_driving_route_with_options_async(cls, start_point: typing.Optional[windows_devices_geolocation.Geopoint], end_point: typing.Optional[windows_devices_geolocation.Geopoint], options: typing.Optional[MapRouteDrivingOptions], /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    def get_walking_route_async(cls, start_point: typing.Optional[windows_devices_geolocation.Geopoint], end_point: typing.Optional[windows_devices_geolocation.Geopoint], /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
...
class MapRouteFinderResult(winrt.system.Object):
    ...
    @_property
    def alternate_routes(self) -> typing.Optional[windows_foundation_collections.IVectorView[MapRoute]]: ...
...
class MapRouteLeg(winrt.system.Object):
    ...
    def length_in_meters(self) -> winrt.system.Double: ...
    @_property
    def maneuvers(self) -> typing.Optional[windows_foundation_collections.IVectorView[MapRouteManeuver]]: ...
    @_property
    def path(self) -> typing.Optional[windows_devices_geolocation.Geopath]: ...
    @_property
    def duration_without_traffic(self) -> datetime.timedelta: ...
...
class MapRouteManeuver(winrt.system.Object):
    ...
    @_property
    def starting_point(self) -> typing.Optional[windows_devices_geolocation.Geopoint]: ...
    @_property
    ...
    @_property
    def warnings(self) -> typing.Optional[windows_foundation_collections.IVectorView[ManeuverWarning]]: ...
...
class PlaceInfo_Static(type):
    def create(cls, reference_point: typing.Optional[windows_devices_geolocation.Geopoint], /) -> typing.Optional[PlaceInfo]: ...
    def create_from_address(cls, display_address: str, /) -> typing.Optional[PlaceInfo]: ...
    def create_from_address_with_name(cls, display_address: str, display_name: str, /) -> typing.Optional[PlaceInfo]: ...
    def create_from_identifier(cls, identifier: str, /) -> typing.Optional[PlaceInfo]: ...
    def create_from_identifier_with_options(cls, identifier: str, default_point: typing.Optional[windows_devices_geolocation.Geopoint], options: typing.Optional[PlaceInfoCreateOptions], /) -> typing.Optional[PlaceInfo]: ...
    def create_from_map_location(cls, location: typing.Optional[MapLocation], /) -> typing.Optional[PlaceInfo]: ...
    def create_with_geopoint_and_options(cls, reference_point: typing.Optional[windows_devices_geolocation.Geopoint], options: typing.Optional[PlaceInfoCreateOptions], /) -> typing.Optional[PlaceInfo]: ...
    @_property
