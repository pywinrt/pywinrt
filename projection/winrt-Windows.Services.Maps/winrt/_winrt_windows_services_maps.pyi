...
class MapLocationFinder_Static(type):
    ...
    @typing.overload
    def find_locations_async(cls, search_text: str, reference_point: typing.Optional[windows_devices_geolocation.Geopoint], max_count: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[MapLocationFinderResult]: ...
    @typing.overload
    ...
    @typing.overload
    def find_locations_at_async(cls, query_point: typing.Optional[windows_devices_geolocation.Geopoint], accuracy: MapLocationDesiredAccuracy, /) -> windows_foundation.IAsyncOperation[MapLocationFinderResult]: ...
...
class MapRouteFinder_Static(type):
    ...
    @typing.overload
    def get_driving_route_async(cls, start_point: typing.Optional[windows_devices_geolocation.Geopoint], end_point: typing.Optional[windows_devices_geolocation.Geopoint], options: typing.Optional[MapRouteDrivingOptions], /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    def get_driving_route_async(cls, start_point: typing.Optional[windows_devices_geolocation.Geopoint], end_point: typing.Optional[windows_devices_geolocation.Geopoint], optimization: MapRouteOptimization, restrictions: MapRouteRestrictions, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    def get_driving_route_async(cls, start_point: typing.Optional[windows_devices_geolocation.Geopoint], end_point: typing.Optional[windows_devices_geolocation.Geopoint], optimization: MapRouteOptimization, restrictions: MapRouteRestrictions, heading_in_degrees: winrt.system.Double, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    ...
    @typing.overload
    def get_driving_route_from_enhanced_waypoints_async(cls, waypoints: typing.Iterable[EnhancedWaypoint], options: typing.Optional[MapRouteDrivingOptions], /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
...
class PlaceInfo_Static(type):
    ...
    @typing.overload
    def create(cls, reference_point: typing.Optional[windows_devices_geolocation.Geopoint], options: typing.Optional[PlaceInfoCreateOptions], /) -> typing.Optional[PlaceInfo]: ...
    @typing.overload
    ...
    @typing.overload
    def create_from_identifier(cls, identifier: str, default_point: typing.Optional[windows_devices_geolocation.Geopoint], options: typing.Optional[PlaceInfoCreateOptions], /) -> typing.Optional[PlaceInfo]: ...
