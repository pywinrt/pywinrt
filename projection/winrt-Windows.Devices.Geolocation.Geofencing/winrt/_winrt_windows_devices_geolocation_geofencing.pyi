...
class Geofence(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[Geofence], id: str, geoshape: windows_devices_geolocation.IGeoshape) -> Geofence: ...
    @typing.overload
    def __new__(cls: typing.Type[Geofence], id: str, geoshape: windows_devices_geolocation.IGeoshape, monitored_states: MonitoredGeofenceStates, single_use: bool) -> Geofence: ...
    @typing.overload
    def __new__(cls: typing.Type[Geofence], id: str, geoshape: windows_devices_geolocation.IGeoshape, monitored_states: MonitoredGeofenceStates, single_use: bool, dwell_time: datetime.timedelta) -> Geofence: ...
    @typing.overload
    def __new__(cls: typing.Type[Geofence], id: str, geoshape: windows_devices_geolocation.IGeoshape, monitored_states: MonitoredGeofenceStates, single_use: bool, dwell_time: datetime.timedelta, start_time: datetime.datetime, duration: datetime.timedelta) -> Geofence: ...
    @_property
...
class GeofenceMonitor(winrt.system.Object, metaclass=GeofenceMonitor_Static):
    ...
    def read_reports(self) -> windows_foundation_collections.IVectorView[GeofenceStateChangeReport]: ...
    ...
    @_property
    def geofences(self) -> windows_foundation_collections.IVector[Geofence]: ...
    @_property
