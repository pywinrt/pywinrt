...
class Geofence(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[Geofence], id: str, geoshape: windows_devices_geolocation.ImplementsIGeoshape) -> Geofence: ...
    @typing.overload
    def __new__(cls: typing.Type[Geofence], id: str, geoshape: windows_devices_geolocation.ImplementsIGeoshape, monitored_states: MonitoredGeofenceStates, single_use: bool) -> Geofence: ...
    @typing.overload
    def __new__(cls: typing.Type[Geofence], id: str, geoshape: windows_devices_geolocation.ImplementsIGeoshape, monitored_states: MonitoredGeofenceStates, single_use: bool, dwell_time: datetime.timedelta) -> Geofence: ...
    @typing.overload
    def __new__(cls: typing.Type[Geofence], id: str, geoshape: windows_devices_geolocation.ImplementsIGeoshape, monitored_states: MonitoredGeofenceStates, single_use: bool, dwell_time: datetime.timedelta, start_time: datetime.datetime, duration: datetime.timedelta) -> Geofence: ...
    @_property
