...
class Geofence(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[Geofence], id: str, geoshape: typing.Optional[windows_devices_geolocation.IGeoshape]) -> Geofence: ...
    @typing.overload
    def __new__(cls: typing.Type[Geofence], id: str, geoshape: typing.Optional[windows_devices_geolocation.IGeoshape], monitored_states: MonitoredGeofenceStates, single_use: bool) -> Geofence: ...
    @typing.overload
    def __new__(cls: typing.Type[Geofence], id: str, geoshape: typing.Optional[windows_devices_geolocation.IGeoshape], monitored_states: MonitoredGeofenceStates, single_use: bool, dwell_time: datetime.timedelta) -> Geofence: ...
    @typing.overload
    def __new__(cls: typing.Type[Geofence], id: str, geoshape: typing.Optional[windows_devices_geolocation.IGeoshape], monitored_states: MonitoredGeofenceStates, single_use: bool, dwell_time: datetime.timedelta, start_time: datetime.datetime, duration: datetime.timedelta) -> Geofence: ...
    @_property
    def duration(self) -> datetime.timedelta: ...
    @_property
    def dwell_time(self) -> datetime.timedelta: ...
    @_property
    def geoshape(self) -> typing.Optional[windows_devices_geolocation.IGeoshape]: ...
    @_property
    def id(self) -> str: ...
    @_property
...
class GeofenceMonitor(winrt.system.Object, metaclass=GeofenceMonitor_Static):
    ...
    def read_reports(self) -> typing.Optional[windows_foundation_collections.IVectorView[GeofenceStateChangeReport]]: ...
    ...
    @_property
    def geofences(self) -> typing.Optional[windows_foundation_collections.IVector[Geofence]]: ...
    @_property
    def last_known_geoposition(self) -> typing.Optional[windows_devices_geolocation.Geoposition]: ...
    @_property
...
class GeofenceStateChangeReport(winrt.system.Object):
    ...
    @_property
    def geoposition(self) -> typing.Optional[windows_devices_geolocation.Geoposition]: ...
    @_property
