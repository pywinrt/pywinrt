...
PyMODINIT_FUNC PyInit__winrt_windows_media_appbroadcasting(void) noexcept
{
    ...
    py::pyobj_handle AppBroadcastingMonitor_type{py::register_python_type(module.get(), &type_spec_AppBroadcastingMonitor, object_bases.get(), nullptr)};
    if (!AppBroadcastingMonitor_type)
    {
        return nullptr;
    }

    py::pyobj_handle AppBroadcastingStatus_type{py::register_python_type(module.get(), &type_spec_AppBroadcastingStatus, object_bases.get(), nullptr)};
    if (!AppBroadcastingStatus_type)
    {
        return nullptr;
    }

    py::pyobj_handle AppBroadcastingStatusDetails_type{py::register_python_type(module.get(), &type_spec_AppBroadcastingStatusDetails, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle AppBroadcastingUI_type{py::register_python_type(module.get(), &type_spec_AppBroadcastingUI, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_AppBroadcastingUI_Static.get()))};
