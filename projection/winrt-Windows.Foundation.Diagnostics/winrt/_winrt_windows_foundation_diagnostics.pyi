...
class FileLoggingSession(winrt.system.Object):
    ...
    def add_logging_channel_with_level(self, logging_channel: typing.Optional[ILoggingChannel], max_level: LoggingLevel, /) -> None: ...
    def close(self) -> None: ...
...
class LoggingActivity(winrt.system.Object):
    ...
    def log_event_with_fields(self, event_name: str, fields: typing.Optional[LoggingFields], /) -> None: ...
    def log_event_with_fields_and_level(self, event_name: str, fields: typing.Optional[LoggingFields], level: LoggingLevel, /) -> None: ...
    def log_event_with_fields_and_options(self, event_name: str, fields: typing.Optional[LoggingFields], level: LoggingLevel, options: typing.Optional[LoggingOptions], /) -> None: ...
    def start_activity(self, start_event_name: str, /) -> typing.Optional[LoggingActivity]: ...
    def start_activity_with_fields(self, start_event_name: str, fields: typing.Optional[LoggingFields], /) -> typing.Optional[LoggingActivity]: ...
    def start_activity_with_fields_and_level(self, start_event_name: str, fields: typing.Optional[LoggingFields], level: LoggingLevel, /) -> typing.Optional[LoggingActivity]: ...
    def start_activity_with_fields_and_options(self, start_event_name: str, fields: typing.Optional[LoggingFields], level: LoggingLevel, options: typing.Optional[LoggingOptions], /) -> typing.Optional[LoggingActivity]: ...
    def stop_activity(self, stop_event_name: str, /) -> None: ...
    def stop_activity_with_fields(self, stop_event_name: str, fields: typing.Optional[LoggingFields], /) -> None: ...
    def stop_activity_with_fields_and_options(self, stop_event_name: str, fields: typing.Optional[LoggingFields], options: typing.Optional[LoggingOptions], /) -> None: ...
    @_property
