...
class LoggingActivity(ILoggingTarget, windows_foundation.IClosable, winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[LoggingActivity], activity_name: str, logging_channel: ILoggingChannel) -> LoggingActivity: ...
    @typing.overload
    def __new__(cls: typing.Type[LoggingActivity], activity_name: str, logging_channel: ILoggingChannel, level: LoggingLevel) -> LoggingActivity: ...
    def close(self) -> None: ...
