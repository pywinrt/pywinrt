...
class LoggingActivity(winrt.system.Object, ImplementsILoggingTarget, windows_foundation.ImplementsIClosable):
    ...
    @typing.overload
    def __new__(cls: typing.Type[LoggingActivity], activity_name: str, logging_channel: ImplementsILoggingChannel) -> LoggingActivity: ...
    @typing.overload
    def __new__(cls: typing.Type[LoggingActivity], activity_name: str, logging_channel: ImplementsILoggingChannel, level: LoggingLevel) -> LoggingActivity: ...
    def close(self) -> None: ...
...
class LoggingChannel(winrt.system.Object, ImplementsILoggingTarget, ImplementsILoggingChannel, windows_foundation.ImplementsIClosable):
    ...
    @typing.overload
    def __new__(cls: typing.Type[LoggingChannel], name: str, options: LoggingChannelOptions) -> LoggingChannel: ...
    @typing.overload
    def __new__(cls: typing.Type[LoggingChannel], name: str, options: LoggingChannelOptions, id: _uuid.UUID) -> LoggingChannel: ...
    @typing.overload
