...
PyObject* py::converter<winrt::Windows::UI::Xaml::Controls::Primitives::GeneratorPosition>::convert(winrt::Windows::UI::Xaml::Controls::Primitives::GeneratorPosition instance) noexcept
{
    auto type = py::get_python_type<winrt::Windows::UI::Xaml::Controls::Primitives::GeneratorPosition>();
    if (!type)
    {
        return nullptr;
    }
...
winrt::Windows::UI::Xaml::Controls::Primitives::GeneratorPosition py::converter<winrt::Windows::UI::Xaml::Controls::Primitives::GeneratorPosition>::convert_to(PyObject* obj)
{
    ...
    if (Py_TYPE(obj) == type)
    {
        return reinterpret_cast<py::winrt_struct_wrapper<winrt::Windows::UI::Xaml::Controls::Primitives::GeneratorPosition>*>(obj)->obj;
    }

    PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Xaml::Controls::Primitives::GeneratorPosition");
    throw python_exception();
}
...
namespace py::cpp::Windows::UI::Xaml::Controls::Primitives
{
    struct module_state
    {
        PyObject* type_AnimationDirection;
        PyObject* type_ComponentResourceLocation;
        PyObject* type_EdgeTransitionLocation;
        PyObject* type_FlyoutPlacementMode;
        PyObject* type_FlyoutShowMode;
        PyObject* type_GeneratorDirection;
        PyObject* type_GroupHeaderPlacement;
        PyObject* type_ListViewItemPresenterCheckMode;
        PyObject* type_ListViewItemPresenterSelectionIndicatorMode;
        PyObject* type_PlacementMode;
        PyObject* type_PopupPlacementMode;
        PyObject* type_ScrollEventType;
        PyObject* type_ScrollingIndicatorMode;
        PyObject* type_SliderSnapsTo;
        PyObject* type_SnapPointsAlignment;
        PyObject* type_TickPlacement;
    ...
    static PyObject* register_AnimationDirection(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AnimationDirection)
        {
        ...
        state->type_AnimationDirection = type;
        Py_INCREF(state->type_AnimationDirection);


        Py_RETURN_NONE;
    }

    static PyObject* register_ComponentResourceLocation(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_ComponentResourceLocation)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_ComponentResourceLocation = type;
        Py_INCREF(state->type_ComponentResourceLocation);


        Py_RETURN_NONE;
    }

    static PyObject* register_EdgeTransitionLocation(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EdgeTransitionLocation)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EdgeTransitionLocation = type;
        Py_INCREF(state->type_EdgeTransitionLocation);


        Py_RETURN_NONE;
    }

    static PyObject* register_FlyoutPlacementMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_FlyoutPlacementMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_FlyoutPlacementMode = type;
        Py_INCREF(state->type_FlyoutPlacementMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_FlyoutShowMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_FlyoutShowMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_FlyoutShowMode = type;
        Py_INCREF(state->type_FlyoutShowMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_GeneratorDirection(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_GeneratorDirection)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_GeneratorDirection = type;
        Py_INCREF(state->type_GeneratorDirection);


        Py_RETURN_NONE;
    }

    static PyObject* register_GroupHeaderPlacement(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_GroupHeaderPlacement)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_GroupHeaderPlacement = type;
        Py_INCREF(state->type_GroupHeaderPlacement);


        Py_RETURN_NONE;
    }

    static PyObject* register_ListViewItemPresenterCheckMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_ListViewItemPresenterCheckMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_ListViewItemPresenterCheckMode = type;
        Py_INCREF(state->type_ListViewItemPresenterCheckMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_ListViewItemPresenterSelectionIndicatorMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_ListViewItemPresenterSelectionIndicatorMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_ListViewItemPresenterSelectionIndicatorMode = type;
        Py_INCREF(state->type_ListViewItemPresenterSelectionIndicatorMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_PlacementMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PlacementMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PlacementMode = type;
        Py_INCREF(state->type_PlacementMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_PopupPlacementMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PopupPlacementMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PopupPlacementMode = type;
        Py_INCREF(state->type_PopupPlacementMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_ScrollEventType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_ScrollEventType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_ScrollEventType = type;
        Py_INCREF(state->type_ScrollEventType);


        Py_RETURN_NONE;
    }

    static PyObject* register_ScrollingIndicatorMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_ScrollingIndicatorMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_ScrollingIndicatorMode = type;
        Py_INCREF(state->type_ScrollingIndicatorMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_SliderSnapsTo(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SliderSnapsTo)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SliderSnapsTo = type;
        Py_INCREF(state->type_SliderSnapsTo);


        Py_RETURN_NONE;
    }

    static PyObject* register_SnapPointsAlignment(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SnapPointsAlignment)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SnapPointsAlignment = type;
        Py_INCREF(state->type_SnapPointsAlignment);


        Py_RETURN_NONE;
    }

    static PyObject* register_TickPlacement(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_TickPlacement)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_TickPlacement = type;
        Py_INCREF(state->type_TickPlacement);
    ...
    {
        py::set_invalid_activation_error(type_name_AppBarButtonTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_AppBarTemplateSettings = "AppBarTemplateSettings";

    static PyObject* _new_AppBarTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_AppBarTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_AppBarToggleButtonTemplateSettings = "AppBarToggleButtonTemplateSettings";

    static PyObject* _new_AppBarToggleButtonTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_AppBarToggleButtonTemplateSettings);
        return nullptr;
    }
    ...
    // ----- ButtonBase class --------------------
    static constexpr const char* const type_name_ButtonBase = "ButtonBase";

    static PyObject* _new_ButtonBase(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_ButtonBase);
        return nullptr;
    }
    ...
    static PyGetSetDef getset_ButtonBase_Meta[] = {
    ...
    static PyType_Slot type_slots_ButtonBase_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_ButtonBase_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_ButtonBase_Meta =
    {
        ...
        Py_TPFLAGS_DEFAULT,
        type_slots_ButtonBase_Meta
    };

    // ----- CalendarPanel class --------------------
    static constexpr const char* const type_name_CalendarPanel = "CalendarPanel";
    ...
    static constexpr const char* const type_name_CalendarViewTemplateSettings = "CalendarViewTemplateSettings";

    static PyObject* _new_CalendarViewTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_CalendarViewTemplateSettings);
        return nullptr;
    }
    ...
    // ----- CarouselPanel class --------------------
    static constexpr const char* const type_name_CarouselPanel = "CarouselPanel";
    ...
    static constexpr const char* const type_name_ColorPickerSlider = "ColorPickerSlider";
    ...
    static PyGetSetDef getset_ColorPickerSlider_Meta[] = {
        { "color_channel_property", reinterpret_cast<getter>(ColorPickerSlider_get_ColorChannelProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_ColorPickerSlider_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_ColorPickerSlider_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_ColorPickerSlider_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_ColorPickerSlider_Meta
    };

    // ----- ColorSpectrum class --------------------
    static constexpr const char* const type_name_ColorSpectrum = "ColorSpectrum";
    ...
    static PyGetSetDef getset_ColorSpectrum_Meta[] = {
    ...
    static PyType_Slot type_slots_ColorSpectrum_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_ColorSpectrum_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_ColorSpectrum_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_ColorSpectrum_Meta
    };

    // ----- ComboBoxTemplateSettings class --------------------
    static constexpr const char* const type_name_ComboBoxTemplateSettings = "ComboBoxTemplateSettings";

    static PyObject* _new_ComboBoxTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_ComboBoxTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_CommandBarFlyoutCommandBar = "CommandBarFlyoutCommandBar";
    ...
    static constexpr const char* const type_name_CommandBarFlyoutCommandBarTemplateSettings = "CommandBarFlyoutCommandBarTemplateSettings";

    static PyObject* _new_CommandBarFlyoutCommandBarTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_CommandBarFlyoutCommandBarTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_CommandBarTemplateSettings = "CommandBarTemplateSettings";

    static PyObject* _new_CommandBarTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_CommandBarTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_DragCompletedEventArgs = "DragCompletedEventArgs";
    ...
    static constexpr const char* const type_name_DragDeltaEventArgs = "DragDeltaEventArgs";
    ...
    static constexpr const char* const type_name_DragStartedEventArgs = "DragStartedEventArgs";
    ...
    // ----- FlyoutBase class --------------------
    static constexpr const char* const type_name_FlyoutBase = "FlyoutBase";

    static PyObject* _new_FlyoutBase(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_FlyoutBase);
        return nullptr;
    }
    ...
    static PyMethodDef _methods_FlyoutBase[] = {
        ...
        { "get_attached_flyout", reinterpret_cast<PyCFunction>(FlyoutBase_GetAttachedFlyout), METH_VARARGS | METH_STATIC, nullptr },
        ...
        { "set_attached_flyout", reinterpret_cast<PyCFunction>(FlyoutBase_SetAttachedFlyout), METH_VARARGS | METH_STATIC, nullptr },
        { "show_at", reinterpret_cast<PyCFunction>(FlyoutBase_ShowAt), METH_VARARGS, nullptr },
        { "show_attached_flyout", reinterpret_cast<PyCFunction>(FlyoutBase_ShowAttachedFlyout), METH_VARARGS | METH_STATIC, nullptr },
    ...
    static PyGetSetDef getset_FlyoutBase_Meta[] = {
    ...
    static PyType_Slot type_slots_FlyoutBase_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_FlyoutBase_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_FlyoutBase_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_FlyoutBase_Meta
    };

    // ----- FlyoutBaseClosingEventArgs class --------------------
    static constexpr const char* const type_name_FlyoutBaseClosingEventArgs = "FlyoutBaseClosingEventArgs";

    static PyObject* _new_FlyoutBaseClosingEventArgs(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_FlyoutBaseClosingEventArgs);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_FlyoutShowOptions = "FlyoutShowOptions";
    ...
    static constexpr const char* const type_name_GeneratorPositionHelper = "GeneratorPositionHelper";

    static PyObject* _new_GeneratorPositionHelper(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_GeneratorPositionHelper);
        return nullptr;
    }
    ...
    static PyMethodDef _methods_GeneratorPositionHelper[] = {
        { "from_index_and_offset", reinterpret_cast<PyCFunction>(GeneratorPositionHelper_FromIndexAndOffset), METH_VARARGS | METH_STATIC, nullptr },
    ...
    static constexpr const char* const type_name_GridViewItemPresenter = "GridViewItemPresenter";
    ...
    static PyGetSetDef getset_GridViewItemPresenter_Meta[] = {
    ...
    static PyType_Slot type_slots_GridViewItemPresenter_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_GridViewItemPresenter_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_GridViewItemPresenter_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_GridViewItemPresenter_Meta
    };

    // ----- GridViewItemTemplateSettings class --------------------
    static constexpr const char* const type_name_GridViewItemTemplateSettings = "GridViewItemTemplateSettings";

    static PyObject* _new_GridViewItemTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_GridViewItemTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_ItemsChangedEventArgs = "ItemsChangedEventArgs";

    static PyObject* _new_ItemsChangedEventArgs(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_ItemsChangedEventArgs);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_JumpListItemBackgroundConverter = "JumpListItemBackgroundConverter";
    ...
    static PyGetSetDef getset_JumpListItemBackgroundConverter_Meta[] = {
    ...
    static PyType_Slot type_slots_JumpListItemBackgroundConverter_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_JumpListItemBackgroundConverter_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_JumpListItemBackgroundConverter_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_JumpListItemBackgroundConverter_Meta
    };

    // ----- JumpListItemForegroundConverter class --------------------
    static constexpr const char* const type_name_JumpListItemForegroundConverter = "JumpListItemForegroundConverter";
    ...
    static PyGetSetDef getset_JumpListItemForegroundConverter_Meta[] = {
    ...
    static PyType_Slot type_slots_JumpListItemForegroundConverter_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_JumpListItemForegroundConverter_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_JumpListItemForegroundConverter_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_JumpListItemForegroundConverter_Meta
    };

    // ----- LayoutInformation class --------------------
    static constexpr const char* const type_name_LayoutInformation = "LayoutInformation";

    static PyObject* _new_LayoutInformation(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_LayoutInformation);
        return nullptr;
    }
    ...
    static PyMethodDef _methods_LayoutInformation[] = {
        { "get_available_size", reinterpret_cast<PyCFunction>(LayoutInformation_GetAvailableSize), METH_VARARGS | METH_STATIC, nullptr },
        { "get_layout_exception_element", reinterpret_cast<PyCFunction>(LayoutInformation_GetLayoutExceptionElement), METH_VARARGS | METH_STATIC, nullptr },
        { "get_layout_slot", reinterpret_cast<PyCFunction>(LayoutInformation_GetLayoutSlot), METH_VARARGS | METH_STATIC, nullptr },
    ...
    static constexpr const char* const type_name_ListViewItemPresenter = "ListViewItemPresenter";
    ...
    static PyGetSetDef getset_ListViewItemPresenter_Meta[] = {
    ...
    static PyType_Slot type_slots_ListViewItemPresenter_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_ListViewItemPresenter_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_ListViewItemPresenter_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_ListViewItemPresenter_Meta
    };

    // ----- ListViewItemTemplateSettings class --------------------
    static constexpr const char* const type_name_ListViewItemTemplateSettings = "ListViewItemTemplateSettings";

    static PyObject* _new_ListViewItemTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_ListViewItemTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_LoopingSelector = "LoopingSelector";

    static PyObject* _new_LoopingSelector(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_LoopingSelector);
        return nullptr;
    }
    ...
    static PyGetSetDef getset_LoopingSelector_Meta[] = {
    ...
    static PyType_Slot type_slots_LoopingSelector_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_LoopingSelector_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_LoopingSelector_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_LoopingSelector_Meta
    };

    // ----- LoopingSelectorItem class --------------------
    static constexpr const char* const type_name_LoopingSelectorItem = "LoopingSelectorItem";

    static PyObject* _new_LoopingSelectorItem(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_LoopingSelectorItem);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_LoopingSelectorPanel = "LoopingSelectorPanel";

    static PyObject* _new_LoopingSelectorPanel(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_LoopingSelectorPanel);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_MenuFlyoutItemTemplateSettings = "MenuFlyoutItemTemplateSettings";

    static PyObject* _new_MenuFlyoutItemTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_MenuFlyoutItemTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_MenuFlyoutPresenterTemplateSettings = "MenuFlyoutPresenterTemplateSettings";

    static PyObject* _new_MenuFlyoutPresenterTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_MenuFlyoutPresenterTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_NavigationViewItemPresenter = "NavigationViewItemPresenter";
    ...
    static PyGetSetDef getset_NavigationViewItemPresenter_Meta[] = {
        { "icon_property", reinterpret_cast<getter>(NavigationViewItemPresenter_get_IconProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_NavigationViewItemPresenter_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_NavigationViewItemPresenter_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_NavigationViewItemPresenter_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_NavigationViewItemPresenter_Meta
    };

    // ----- OrientedVirtualizingPanel class --------------------
    static constexpr const char* const type_name_OrientedVirtualizingPanel = "OrientedVirtualizingPanel";

    static PyObject* _new_OrientedVirtualizingPanel(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_OrientedVirtualizingPanel);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_PickerFlyoutBase = "PickerFlyoutBase";

    static PyObject* _new_PickerFlyoutBase(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_PickerFlyoutBase);
        return nullptr;
    }
    ...
    static PyMethodDef _methods_PickerFlyoutBase[] = {
        { "get_title", reinterpret_cast<PyCFunction>(PickerFlyoutBase_GetTitle), METH_VARARGS | METH_STATIC, nullptr },
        { "on_confirmed", reinterpret_cast<PyCFunction>(PickerFlyoutBase_OnConfirmed), METH_VARARGS, nullptr },
        { "set_title", reinterpret_cast<PyCFunction>(PickerFlyoutBase_SetTitle), METH_VARARGS | METH_STATIC, nullptr },
    ...
    static PyGetSetDef getset_PickerFlyoutBase_Meta[] = {
        { "title_property", reinterpret_cast<getter>(PickerFlyoutBase_get_TitleProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_PickerFlyoutBase_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_PickerFlyoutBase_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_PickerFlyoutBase_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_PickerFlyoutBase_Meta
    };

    // ----- PivotHeaderItem class --------------------
    static constexpr const char* const type_name_PivotHeaderItem = "PivotHeaderItem";
    ...
    static constexpr const char* const type_name_PivotHeaderPanel = "PivotHeaderPanel";
    ...
    // ----- PivotPanel class --------------------
    static constexpr const char* const type_name_PivotPanel = "PivotPanel";
    ...
    // ----- Popup class --------------------
    static constexpr const char* const type_name_Popup = "Popup";
    ...
    static PyGetSetDef getset_Popup_Meta[] = {
    ...
    static PyType_Slot type_slots_Popup_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_Popup_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_Popup_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_Popup_Meta
    };

    // ----- ProgressBarTemplateSettings class --------------------
    static constexpr const char* const type_name_ProgressBarTemplateSettings = "ProgressBarTemplateSettings";

    static PyObject* _new_ProgressBarTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_ProgressBarTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_ProgressRingTemplateSettings = "ProgressRingTemplateSettings";

    static PyObject* _new_ProgressRingTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_ProgressRingTemplateSettings);
        return nullptr;
    }
    ...
    // ----- RangeBase class --------------------
    static constexpr const char* const type_name_RangeBase = "RangeBase";

    static PyObject* _new_RangeBase(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_RangeBase);
        return nullptr;
    }
    ...
    static PyGetSetDef getset_RangeBase_Meta[] = {
    ...
    static PyType_Slot type_slots_RangeBase_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_RangeBase_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_RangeBase_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_RangeBase_Meta
    };

    // ----- RangeBaseValueChangedEventArgs class --------------------
    static constexpr const char* const type_name_RangeBaseValueChangedEventArgs = "RangeBaseValueChangedEventArgs";

    static PyObject* _new_RangeBaseValueChangedEventArgs(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_RangeBaseValueChangedEventArgs);
        return nullptr;
    }
    ...
    // ----- RepeatButton class --------------------
    static constexpr const char* const type_name_RepeatButton = "RepeatButton";
    ...
    static PyGetSetDef getset_RepeatButton_Meta[] = {
    ...
    static PyType_Slot type_slots_RepeatButton_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_RepeatButton_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_RepeatButton_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_RepeatButton_Meta
    };

    // ----- ScrollBar class --------------------
    static constexpr const char* const type_name_ScrollBar = "ScrollBar";
    ...
    static PyGetSetDef getset_ScrollBar_Meta[] = {
    ...
    static PyType_Slot type_slots_ScrollBar_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_ScrollBar_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_ScrollBar_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_ScrollBar_Meta
    };

    // ----- ScrollEventArgs class --------------------
    static constexpr const char* const type_name_ScrollEventArgs = "ScrollEventArgs";
    ...
    // ----- Selector class --------------------
    static constexpr const char* const type_name_Selector = "Selector";

    static PyObject* _new_Selector(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_Selector);
        return nullptr;
    }
    ...
    static PyMethodDef _methods_Selector[] = {
        { "get_is_selection_active", reinterpret_cast<PyCFunction>(Selector_GetIsSelectionActive), METH_VARARGS | METH_STATIC, nullptr },
    ...
    static PyGetSetDef getset_Selector_Meta[] = {
    ...
    static PyType_Slot type_slots_Selector_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_Selector_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_Selector_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_Selector_Meta
    };

    // ----- SelectorItem class --------------------
    static constexpr const char* const type_name_SelectorItem = "SelectorItem";

    static PyObject* _new_SelectorItem(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_SelectorItem);
        return nullptr;
    }
    ...
    static PyGetSetDef getset_SelectorItem_Meta[] = {
        { "is_selected_property", reinterpret_cast<getter>(SelectorItem_get_IsSelectedProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_SelectorItem_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_SelectorItem_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_SelectorItem_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_SelectorItem_Meta
    };

    // ----- SettingsFlyoutTemplateSettings class --------------------
    static constexpr const char* const type_name_SettingsFlyoutTemplateSettings = "SettingsFlyoutTemplateSettings";

    static PyObject* _new_SettingsFlyoutTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_SettingsFlyoutTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_SplitViewTemplateSettings = "SplitViewTemplateSettings";

    static PyObject* _new_SplitViewTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_SplitViewTemplateSettings);
        return nullptr;
    }
    ...
    // ----- Thumb class --------------------
    static constexpr const char* const type_name_Thumb = "Thumb";
    ...
    static PyGetSetDef getset_Thumb_Meta[] = {
        { "is_dragging_property", reinterpret_cast<getter>(Thumb_get_IsDraggingProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_Thumb_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_Thumb_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_Thumb_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_Thumb_Meta
    };

    // ----- TickBar class --------------------
    static constexpr const char* const type_name_TickBar = "TickBar";
    ...
    static PyGetSetDef getset_TickBar_Meta[] = {
        { "fill_property", reinterpret_cast<getter>(TickBar_get_FillProperty), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_TickBar_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_TickBar_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_TickBar_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_TickBar_Meta
    };

    // ----- ToggleButton class --------------------
    static constexpr const char* const type_name_ToggleButton = "ToggleButton";
    ...
    static PyGetSetDef getset_ToggleButton_Meta[] = {
    ...
    static PyType_Slot type_slots_ToggleButton_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_ToggleButton_Meta) },
        { }
    };
    ...
    static PyType_Spec type_spec_ToggleButton_Meta =
    {
        ...
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_ToggleButton_Meta
    };

    // ----- ToggleSwitchTemplateSettings class --------------------
    static constexpr const char* const type_name_ToggleSwitchTemplateSettings = "ToggleSwitchTemplateSettings";

    static PyObject* _new_ToggleSwitchTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_ToggleSwitchTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_ToolTipTemplateSettings = "ToolTipTemplateSettings";

    static PyObject* _new_ToolTipTemplateSettings(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_ToolTipTemplateSettings);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_IScrollSnapPointsInfo = "IScrollSnapPointsInfo";

    static PyObject* _new_IScrollSnapPointsInfo(PyTypeObject* /* unused */, PyObject* /* unused */, PyObject* /* unused */) noexcept
    {
        py::set_invalid_activation_error(type_name_IScrollSnapPointsInfo);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_GeneratorPosition = "GeneratorPosition";
    ...
    static PyMethodDef module_methods[] = {
        {"_register_AnimationDirection", register_AnimationDirection, METH_O, "registers type"},
        {"_register_ComponentResourceLocation", register_ComponentResourceLocation, METH_O, "registers type"},
        {"_register_EdgeTransitionLocation", register_EdgeTransitionLocation, METH_O, "registers type"},
        {"_register_FlyoutPlacementMode", register_FlyoutPlacementMode, METH_O, "registers type"},
        {"_register_FlyoutShowMode", register_FlyoutShowMode, METH_O, "registers type"},
        {"_register_GeneratorDirection", register_GeneratorDirection, METH_O, "registers type"},
        {"_register_GroupHeaderPlacement", register_GroupHeaderPlacement, METH_O, "registers type"},
        {"_register_ListViewItemPresenterCheckMode", register_ListViewItemPresenterCheckMode, METH_O, "registers type"},
        {"_register_ListViewItemPresenterSelectionIndicatorMode", register_ListViewItemPresenterSelectionIndicatorMode, METH_O, "registers type"},
        {"_register_PlacementMode", register_PlacementMode, METH_O, "registers type"},
        {"_register_PopupPlacementMode", register_PopupPlacementMode, METH_O, "registers type"},
        {"_register_ScrollEventType", register_ScrollEventType, METH_O, "registers type"},
        {"_register_ScrollingIndicatorMode", register_ScrollingIndicatorMode, METH_O, "registers type"},
        {"_register_SliderSnapsTo", register_SliderSnapsTo, METH_O, "registers type"},
        {"_register_SnapPointsAlignment", register_SnapPointsAlignment, METH_O, "registers type"},
        {"_register_TickPlacement", register_TickPlacement, METH_O, "registers type"},
        {}};
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_AnimationDirection);
        Py_VISIT(state->type_ComponentResourceLocation);
        Py_VISIT(state->type_EdgeTransitionLocation);
        Py_VISIT(state->type_FlyoutPlacementMode);
        Py_VISIT(state->type_FlyoutShowMode);
        Py_VISIT(state->type_GeneratorDirection);
        Py_VISIT(state->type_GroupHeaderPlacement);
        Py_VISIT(state->type_ListViewItemPresenterCheckMode);
        Py_VISIT(state->type_ListViewItemPresenterSelectionIndicatorMode);
        Py_VISIT(state->type_PlacementMode);
        Py_VISIT(state->type_PopupPlacementMode);
        Py_VISIT(state->type_ScrollEventType);
        Py_VISIT(state->type_ScrollingIndicatorMode);
        Py_VISIT(state->type_SliderSnapsTo);
        Py_VISIT(state->type_SnapPointsAlignment);
        Py_VISIT(state->type_TickPlacement);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_AnimationDirection);
        Py_CLEAR(state->type_ComponentResourceLocation);
        Py_CLEAR(state->type_EdgeTransitionLocation);
        Py_CLEAR(state->type_FlyoutPlacementMode);
        Py_CLEAR(state->type_FlyoutShowMode);
        Py_CLEAR(state->type_GeneratorDirection);
        Py_CLEAR(state->type_GroupHeaderPlacement);
        Py_CLEAR(state->type_ListViewItemPresenterCheckMode);
        Py_CLEAR(state->type_ListViewItemPresenterSelectionIndicatorMode);
        Py_CLEAR(state->type_PlacementMode);
        Py_CLEAR(state->type_PopupPlacementMode);
        Py_CLEAR(state->type_ScrollEventType);
        Py_CLEAR(state->type_ScrollingIndicatorMode);
        Py_CLEAR(state->type_SliderSnapsTo);
        Py_CLEAR(state->type_SnapPointsAlignment);
        Py_CLEAR(state->type_TickPlacement);
...
PyMODINIT_FUNC PyInit__winrt_Windows_UI_Xaml_Controls_Primitives(void) noexcept
{
    ...
    py::pyobj_handle type_ButtonBase_Meta{PyType_FromSpec(&type_spec_ButtonBase_Meta)};
    if (!type_ButtonBase_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_ColorPickerSlider_Meta{PyType_FromSpec(&type_spec_ColorPickerSlider_Meta)};
    if (!type_ColorPickerSlider_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_ColorSpectrum_Meta{PyType_FromSpec(&type_spec_ColorSpectrum_Meta)};
    if (!type_ColorSpectrum_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_FlyoutBase_Meta{PyType_FromSpec(&type_spec_FlyoutBase_Meta)};
    if (!type_FlyoutBase_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_GridViewItemPresenter_Meta{PyType_FromSpec(&type_spec_GridViewItemPresenter_Meta)};
    if (!type_GridViewItemPresenter_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_JumpListItemBackgroundConverter_Meta{PyType_FromSpec(&type_spec_JumpListItemBackgroundConverter_Meta)};
    if (!type_JumpListItemBackgroundConverter_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_JumpListItemForegroundConverter_Meta{PyType_FromSpec(&type_spec_JumpListItemForegroundConverter_Meta)};
    if (!type_JumpListItemForegroundConverter_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_ListViewItemPresenter_Meta{PyType_FromSpec(&type_spec_ListViewItemPresenter_Meta)};
    if (!type_ListViewItemPresenter_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_LoopingSelector_Meta{PyType_FromSpec(&type_spec_LoopingSelector_Meta)};
    if (!type_LoopingSelector_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_NavigationViewItemPresenter_Meta{PyType_FromSpec(&type_spec_NavigationViewItemPresenter_Meta)};
    if (!type_NavigationViewItemPresenter_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_PickerFlyoutBase_Meta{PyType_FromSpec(&type_spec_PickerFlyoutBase_Meta)};
    if (!type_PickerFlyoutBase_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_Popup_Meta{PyType_FromSpec(&type_spec_Popup_Meta)};
    if (!type_Popup_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_RangeBase_Meta{PyType_FromSpec(&type_spec_RangeBase_Meta)};
    if (!type_RangeBase_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_RepeatButton_Meta{PyType_FromSpec(&type_spec_RepeatButton_Meta)};
    if (!type_RepeatButton_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_ScrollBar_Meta{PyType_FromSpec(&type_spec_ScrollBar_Meta)};
    if (!type_ScrollBar_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_Selector_Meta{PyType_FromSpec(&type_spec_Selector_Meta)};
    if (!type_Selector_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_SelectorItem_Meta{PyType_FromSpec(&type_spec_SelectorItem_Meta)};
    if (!type_SelectorItem_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_Thumb_Meta{PyType_FromSpec(&type_spec_Thumb_Meta)};
    if (!type_Thumb_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_TickBar_Meta{PyType_FromSpec(&type_spec_TickBar_Meta)};
    if (!type_TickBar_Meta)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle type_ToggleButton_Meta{PyType_FromSpec(&type_spec_ToggleButton_Meta)};
    if (!type_ToggleButton_Meta)
    {
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::AnimationDirection>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_AnimationDirection;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::AnimationDirection is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::ComponentResourceLocation>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_ComponentResourceLocation;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::ComponentResourceLocation is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::EdgeTransitionLocation>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_EdgeTransitionLocation;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::EdgeTransitionLocation is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::FlyoutPlacementMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_FlyoutPlacementMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::FlyoutPlacementMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::FlyoutShowMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_FlyoutShowMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::FlyoutShowMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::GeneratorDirection>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_GeneratorDirection;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::GeneratorDirection is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::GroupHeaderPlacement>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_GroupHeaderPlacement;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::GroupHeaderPlacement is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::ListViewItemPresenterCheckMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_ListViewItemPresenterCheckMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::ListViewItemPresenterCheckMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::ListViewItemPresenterSelectionIndicatorMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_ListViewItemPresenterSelectionIndicatorMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::ListViewItemPresenterSelectionIndicatorMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::PlacementMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_PlacementMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::PlacementMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::PopupPlacementMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_PopupPlacementMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::PopupPlacementMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::ScrollEventType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_ScrollEventType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::ScrollEventType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::ScrollingIndicatorMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_ScrollingIndicatorMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::ScrollingIndicatorMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::SliderSnapsTo>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_SliderSnapsTo;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::SliderSnapsTo is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::SnapPointsAlignment>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_SnapPointsAlignment;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::SnapPointsAlignment is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Primitives::TickPlacement>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Primitives;
    ...
    auto python_type = state->type_TickPlacement;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Primitives::TickPlacement is not registered");
        return nullptr;
    }
