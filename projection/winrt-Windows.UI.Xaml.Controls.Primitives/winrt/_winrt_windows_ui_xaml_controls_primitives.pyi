...
class ButtonBase_Static(type):
    @_property
    def click_mode_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    ...
    @_property
    def is_pointer_over_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def is_pressed_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class ButtonBase(winrt.system.Object, metaclass=ButtonBase_Static):
    ...
    @_property
    def content_template_selector(self) -> typing.Optional[windows_ui_xaml_controls.DataTemplateSelector]: ...
    @content_template_selector.setter
    def content_template_selector(self, value: typing.Optional[windows_ui_xaml_controls.DataTemplateSelector]) -> None: ...
    @_property
...
class CalendarPanel(winrt.system.Object):
    ...
    def background(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def children(self) -> typing.Optional[windows_ui_xaml_controls.UIElementCollection]: ...
    @_property
...
class CarouselPanel(winrt.system.Object):
    ...
    def get_animation_base_value(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], /) -> typing.Optional[winrt.system.Object]: ...
    def get_binding_expression(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], /) -> typing.Optional[windows_ui_xaml_data.BindingExpression]: ...
    def get_irregular_snap_points(self, orientation: windows_ui_xaml_controls.Orientation, alignment: SnapPointsAlignment, /) -> typing.Optional[windows_foundation_collections.IVectorView[winrt.system.Single]]: ...
    ...
    @_property
    def item_container_generator(self) -> typing.Optional[windows_ui_xaml_controls.ItemContainerGenerator]: ...
    @_property
    def children_transitions(self) -> typing.Optional[windows_ui_xaml_media_animation.TransitionCollection]: ...
    @children_transitions.setter
    def children_transitions(self, value: typing.Optional[windows_ui_xaml_media_animation.TransitionCollection]) -> None: ...
...
class ColorSpectrum_Static(type):
    ...
    @_property
    def components_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def hsv_color_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    ...
    @_property
    def shape_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class CommandBarFlyoutCommandBar(winrt.system.Object):
    ...
    @_property
    def primary_commands(self) -> typing.Optional[windows_foundation_collections.IObservableVector[windows_ui_xaml_controls.ICommandBarElement]]: ...
    @_property
    def secondary_commands(self) -> typing.Optional[windows_foundation_collections.IObservableVector[windows_ui_xaml_controls.ICommandBarElement]]: ...
    @_property
    ...
    @_property
    def overflow_button_visibility(self) -> windows_ui_xaml_controls.CommandBarOverflowButtonVisibility: ...
    @overflow_button_visibility.setter
    def overflow_button_visibility(self, value: windows_ui_xaml_controls.CommandBarOverflowButtonVisibility) -> None: ...
    @_property
    ...
    @_property
    def default_label_position(self) -> windows_ui_xaml_controls.CommandBarDefaultLabelPosition: ...
    @default_label_position.setter
    def default_label_position(self, value: windows_ui_xaml_controls.CommandBarDefaultLabelPosition) -> None: ...
    @_property
    ...
    @_property
    def closed_display_mode(self) -> windows_ui_xaml_controls.AppBarClosedDisplayMode: ...
    @closed_display_mode.setter
    def closed_display_mode(self, value: windows_ui_xaml_controls.AppBarClosedDisplayMode) -> None: ...
    @_property
...
class FlyoutBase_Static(type):
    def get_attached_flyout(cls, element: typing.Optional[windows_ui_xaml.FrameworkElement], /) -> typing.Optional[FlyoutBase]: ...
    def set_attached_flyout(cls, element: typing.Optional[windows_ui_xaml.FrameworkElement], value: typing.Optional[FlyoutBase], /) -> None: ...
    def show_attached_flyout(cls, flyout_owner: typing.Optional[windows_ui_xaml.FrameworkElement], /) -> None: ...
    @_property
    def attached_flyout_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    ...
    @_property
    def allow_focus_when_disabled_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    ...
    @_property
    def overlay_input_pass_through_element_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def are_open_close_animations_enabled_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def input_device_prefers_primary_commands_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def is_open_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def show_mode_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def target_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def should_constrain_to_root_bounds_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class FlyoutBase(winrt.system.Object, metaclass=FlyoutBase_Static):
    ...
    def set_value(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], value: typing.Optional[winrt.system.Object], /) -> None: ...
    @typing.overload
    def show_at(self, placement_target: typing.Optional[windows_ui_xaml.FrameworkElement], /) -> None: ...
    @typing.overload
    def show_at(self, placement_target: typing.Optional[windows_ui_xaml.DependencyObject], show_options: typing.Optional[FlyoutShowOptions], /) -> None: ...
    def try_invoke_keyboard_accelerator(self, args: typing.Optional[windows_ui_xaml_input.ProcessKeyboardAcceleratorEventArgs], /) -> None: ...
    def unregister_property_changed_callback(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], token: winrt.system.Int64, /) -> None: ...
    ...
    def allow_focus_on_interaction(self, value: bool) -> None: ...
    @_property
    def target(self) -> typing.Optional[windows_ui_xaml.FrameworkElement]: ...
    @_property
    def overlay_input_pass_through_element(self) -> typing.Optional[windows_ui_xaml.DependencyObject]: ...
    @overlay_input_pass_through_element.setter
    def overlay_input_pass_through_element(self, value: typing.Optional[windows_ui_xaml.DependencyObject]) -> None: ...
    @_property
...
class GridViewItemPresenter_Static(type):
    @_property
    def check_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_hint_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_selecting_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def content_margin_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def disabled_opacity_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def drag_background_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def drag_foreground_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def drag_opacity_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def focus_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def grid_view_item_presenter_horizontal_content_alignment_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def grid_view_item_presenter_padding_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def grid_view_item_presenter_vertical_content_alignment_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def placeholder_background_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def pointer_over_background_margin_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def pointer_over_background_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def reorder_hint_offset_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_background_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_border_thickness_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_foreground_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_pointer_over_background_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_pointer_over_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selection_check_mark_visual_enabled_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class GridViewItemPresenter(winrt.system.Object, metaclass=GridViewItemPresenter_Static):
    ...
    @_property
    def selected_pointer_over_border_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @selected_pointer_over_border_brush.setter
    def selected_pointer_over_border_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def selected_pointer_over_background(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @selected_pointer_over_background.setter
    def selected_pointer_over_background(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def selected_background(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @selected_background.setter
    def selected_background(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def pointer_over_background(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @pointer_over_background.setter
    def pointer_over_background(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def placeholder_background(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @placeholder_background.setter
    def placeholder_background(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def drag_foreground(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @drag_foreground.setter
    def drag_foreground(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def drag_background(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @drag_background.setter
    def drag_background(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def check_selecting_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_selecting_brush.setter
    def check_selecting_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_hint_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_hint_brush.setter
    def check_hint_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_brush.setter
    def check_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def foreground(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @foreground.setter
    def foreground(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
...
class JumpListItemBackgroundConverter_Static(type):
    @_property
    def disabled_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def enabled_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class JumpListItemBackgroundConverter(winrt.system.Object, metaclass=JumpListItemBackgroundConverter_Static):
    ...
    def unregister_property_changed_callback(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], token: winrt.system.Int64, /) -> None: ...
    @_property
    def enabled(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @enabled.setter
    def enabled(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def disabled(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @disabled.setter
    def disabled(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def dispatcher(self) -> typing.Optional[windows_ui_core.CoreDispatcher]: ...
...
class LayoutInformation_Static(type):
    def get_available_size(cls, element: typing.Optional[windows_ui_xaml.UIElement], /) -> windows_foundation.Size: ...
    def get_layout_exception_element(cls, dispatcher: typing.Optional[winrt.system.Object], /) -> typing.Optional[windows_ui_xaml.UIElement]: ...
    def get_layout_slot(cls, element: typing.Optional[windows_ui_xaml.FrameworkElement], /) -> windows_foundation.Rect: ...
...
class ListViewItemPresenter_Static(type):
    ...
    def placeholder_background_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def list_view_item_presenter_vertical_content_alignment_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def list_view_item_presenter_padding_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def list_view_item_presenter_horizontal_content_alignment_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def focus_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def drag_opacity_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    ...
    def selection_check_mark_visual_enabled_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def pressed_background_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_pressed_background_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def pointer_over_foreground_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def focus_secondary_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_mode_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def reveal_background_shows_above_content_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def reveal_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def reveal_border_thickness_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def reveal_background_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selection_indicator_pressed_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selection_indicator_pointer_over_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selection_indicator_mode_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selection_indicator_corner_radius_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selection_indicator_disabled_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selection_indicator_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_pressed_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_inner_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_disabled_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_disabled_background_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def pointer_over_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_pressed_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_disabled_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_selected_pressed_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_selected_pointer_over_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_selected_disabled_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_selected_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_pressed_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_pressed_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_pointer_over_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_pointer_over_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_disabled_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_disabled_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_corner_radius_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def check_box_border_brush_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selection_indicator_visual_enabled_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class ListViewItemPresenter(winrt.system.Object, metaclass=ListViewItemPresenter_Static):
    ...
    def pointer_over_background_margin(self, value: windows_ui_xaml.Thickness) -> None: ...
    @_property
    def selected_pressed_background(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @selected_pressed_background.setter
    def selected_pressed_background(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def pressed_background(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @pressed_background.setter
    def pressed_background(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def pointer_over_foreground(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @pointer_over_foreground.setter
    def pointer_over_foreground(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def focus_secondary_border_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @focus_secondary_border_brush.setter
    def focus_secondary_border_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_mode(self) -> ListViewItemPresenterCheckMode: ...
    @check_mode.setter
    def check_mode(self, value: ListViewItemPresenterCheckMode) -> None: ...
    @_property
    def check_box_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_box_brush.setter
    def check_box_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def reveal_background(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @reveal_background.setter
    def reveal_background(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def reveal_border_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @reveal_border_brush.setter
    def reveal_border_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_disabled_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_disabled_brush.setter
    def check_disabled_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def selection_indicator_pressed_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @selection_indicator_pressed_brush.setter
    def selection_indicator_pressed_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def selection_indicator_pointer_over_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @selection_indicator_pointer_over_brush.setter
    def selection_indicator_pointer_over_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def selection_indicator_disabled_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @selection_indicator_disabled_brush.setter
    def selection_indicator_disabled_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def selection_indicator_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @selection_indicator_brush.setter
    def selection_indicator_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def selected_inner_border_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @selected_inner_border_brush.setter
    def selected_inner_border_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def selected_disabled_background(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @selected_disabled_background.setter
    def selected_disabled_background(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def pointer_over_border_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @pointer_over_border_brush.setter
    def pointer_over_border_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_pressed_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_pressed_brush.setter
    def check_pressed_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def check_box_selected_pressed_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_box_selected_pressed_brush.setter
    def check_box_selected_pressed_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_box_selected_pointer_over_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_box_selected_pointer_over_brush.setter
    def check_box_selected_pointer_over_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_box_selected_disabled_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_box_selected_disabled_brush.setter
    def check_box_selected_disabled_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_box_selected_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_box_selected_brush.setter
    def check_box_selected_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_box_pressed_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_box_pressed_brush.setter
    def check_box_pressed_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_box_pressed_border_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_box_pressed_border_brush.setter
    def check_box_pressed_border_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_box_pointer_over_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_box_pointer_over_brush.setter
    def check_box_pointer_over_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_box_pointer_over_border_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_box_pointer_over_border_brush.setter
    def check_box_pointer_over_border_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_box_disabled_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_box_disabled_brush.setter
    def check_box_disabled_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def check_box_disabled_border_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_box_disabled_border_brush.setter
    def check_box_disabled_border_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def check_box_border_brush(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @check_box_border_brush.setter
    def check_box_border_brush(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
    @_property
    def foreground(self) -> typing.Optional[windows_ui_xaml_media.Brush]: ...
    @foreground.setter
    def foreground(self, value: typing.Optional[windows_ui_xaml_media.Brush]) -> None: ...
...
class LoopingSelector_Static(type):
    ...
    @_property
    def should_loop_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class LoopingSelector(winrt.system.Object, metaclass=LoopingSelector_Static):
    ...
    def unregister_property_changed_callback(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], token: winrt.system.Int64, /) -> None: ...
    def update_layout(self) -> None: ...
    def add_selection_changed(self, handler: typing.Optional[windows_ui_xaml_controls.SelectionChangedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
...
class NavigationViewItemPresenter(winrt.system.Object, metaclass=NavigationViewItemPresenter_Static):
    ...
    def update_layout(self) -> None: ...
    @_property
    def icon(self) -> typing.Optional[windows_ui_xaml_controls.IconElement]: ...
    @icon.setter
    def icon(self, value: typing.Optional[windows_ui_xaml_controls.IconElement]) -> None: ...
    @_property
    def content_transitions(self) -> typing.Optional[windows_ui_xaml_media_animation.TransitionCollection]: ...
    @content_transitions.setter
    def content_transitions(self, value: typing.Optional[windows_ui_xaml_media_animation.TransitionCollection]) -> None: ...
...
class PickerFlyoutBase_Static(type):
    def get_title(cls, element: typing.Optional[windows_ui_xaml.DependencyObject], /) -> str: ...
    def set_title(cls, element: typing.Optional[windows_ui_xaml.DependencyObject], value: str, /) -> None: ...
    @_property
...
class Popup_Static(type):
    ...
    @_property
    def is_light_dismiss_enabled_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def is_open_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    ...
    def should_constrain_to_root_bounds_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def desired_placement_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
...
class Popup(winrt.system.Object, metaclass=Popup_Static):
    ...
    def is_constrained_to_root_bounds(self) -> bool: ...
    @_property
    def placement_target(self) -> typing.Optional[windows_ui_xaml.FrameworkElement]: ...
    @placement_target.setter
    def placement_target(self, value: typing.Optional[windows_ui_xaml.FrameworkElement]) -> None: ...
    @_property
...
class RangeBase_Static(type):
    @_property
    def large_change_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def maximum_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def minimum_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def small_change_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
...
class RepeatButton_Static(type):
    @_property
    def delay_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def interval_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class ScrollBar_Static(type):
    @_property
    def indicator_mode_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def orientation_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def viewport_size_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class Selector_Static(type):
    def get_is_selection_active(cls, element: typing.Optional[windows_ui_xaml.DependencyObject], /) -> bool: ...
    @_property
    def is_synchronized_with_current_item_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_index_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def selected_item_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class Selector(winrt.system.Object, metaclass=Selector_Static):
    ...
    @_property
    def items_panel(self) -> typing.Optional[windows_ui_xaml_controls.ItemsPanelTemplate]: ...
    @items_panel.setter
    def items_panel(self, value: typing.Optional[windows_ui_xaml_controls.ItemsPanelTemplate]) -> None: ...
    @_property
    def item_template_selector(self) -> typing.Optional[windows_ui_xaml_controls.DataTemplateSelector]: ...
    @item_template_selector.setter
    def item_template_selector(self, value: typing.Optional[windows_ui_xaml_controls.DataTemplateSelector]) -> None: ...
    @_property
    def item_template(self) -> typing.Optional[windows_ui_xaml.DataTemplate]: ...
    @item_template.setter
    def item_template(self, value: typing.Optional[windows_ui_xaml.DataTemplate]) -> None: ...
    ...
    @_property
    def item_container_style_selector(self) -> typing.Optional[windows_ui_xaml_controls.StyleSelector]: ...
    @item_container_style_selector.setter
    def item_container_style_selector(self, value: typing.Optional[windows_ui_xaml_controls.StyleSelector]) -> None: ...
    @_property
    ...
    @_property
    def group_style_selector(self) -> typing.Optional[windows_ui_xaml_controls.GroupStyleSelector]: ...
    @group_style_selector.setter
    def group_style_selector(self, value: typing.Optional[windows_ui_xaml_controls.GroupStyleSelector]) -> None: ...
    @_property
    def display_member_path(self) -> str: ...
    @display_member_path.setter
    def display_member_path(self, value: str) -> None: ...
    @_property
    def group_style(self) -> typing.Optional[windows_foundation_collections.IObservableVector[windows_ui_xaml_controls.GroupStyle]]: ...
    @_property
    def is_grouping(self) -> bool: ...
    @_property
    def item_container_generator(self) -> typing.Optional[windows_ui_xaml_controls.ItemContainerGenerator]: ...
    @_property
    def items(self) -> typing.Optional[windows_ui_xaml_controls.ItemCollection]: ...
    @_property
    def items_panel_root(self) -> typing.Optional[windows_ui_xaml_controls.Panel]: ...
    @_property
    def padding(self) -> windows_ui_xaml.Thickness: ...
    @padding.setter
    def padding(self, value: windows_ui_xaml.Thickness) -> None: ...
...
class SelectorItem_Static(type):
    @_property
    def is_selected_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class Thumb_Static(type):
    @_property
    def is_dragging_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class ToggleButton_Static(type):
    ...
    @_property
    def is_three_state_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class ToggleButton(winrt.system.Object, metaclass=ToggleButton_Static):
    ...
    def unregister_property_changed_callback(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], token: winrt.system.Int64, /) -> None: ...
    def update_layout(self) -> None: ...
    def add_checked(self, handler: typing.Optional[windows_ui_xaml.RoutedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_checked(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_indeterminate(self, handler: typing.Optional[windows_ui_xaml.RoutedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_indeterminate(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_unchecked(self, handler: typing.Optional[windows_ui_xaml.RoutedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
