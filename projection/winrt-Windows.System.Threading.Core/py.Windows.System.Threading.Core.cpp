...
PyMODINIT_FUNC PyInit__winrt_windows_system_threading_core(void) noexcept
{
    ...
    if (py::register_python_type(module.get(), &type_spec_PreallocatedWorkItem, nullptr, object_bases.get(), nullptr) == -1)
    #else
    ...
    #if PY_VERSION_HEX < 0x03090000
    if (py::register_python_type(module.get(), &type_spec_SignalNotifier, nullptr, object_bases.get(), nullptr) == -1)
    #else
