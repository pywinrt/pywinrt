...
class SignalNotifier_Static(type):
    ...
    def attach_to_event_with_timeout(cls, name: str, handler: typing.Optional[SignalHandler], timeout: datetime.timedelta, /) -> typing.Optional[SignalNotifier]: ...
    def attach_to_semaphore(cls, name: str, handler: typing.Optional[SignalHandler], /) -> typing.Optional[SignalNotifier]: ...
    def attach_to_semaphore_with_timeout(cls, name: str, handler: typing.Optional[SignalHandler], timeout: datetime.timedelta, /) -> typing.Optional[SignalNotifier]: ...
