...
@typing.final
class HttpBufferContent(windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable, winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[HttpBufferContent], content: windows_storage_streams.IBuffer) -> HttpBufferContent: ...
    @typing.overload
    def __new__(cls: typing.Type[HttpBufferContent], content: windows_storage_streams.IBuffer, offset: winrt.system.UInt32, count: winrt.system.UInt32) -> HttpBufferContent: ...
...
@typing.final
class HttpClient(windows_foundation.IStringable, windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    def __str__(self) -> str: ...
    @staticmethod
    ...
    @typing.overload
    def __new__(cls: typing.Type[HttpClient], filter: windows_web_http_filters.IHttpFilter) -> HttpClient: ...
    @typing.overload
...
@typing.final
class HttpCookie(windows_foundation.IStringable, winrt.system.Object):
    def __str__(self) -> str: ...
    @staticmethod
...
@typing.final
class HttpFormUrlEncodedContent(windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    def __str__(self) -> str: ...
    @staticmethod
...
@typing.final
class HttpMethod(windows_foundation.IStringable, winrt.system.Object, metaclass=HttpMethod_Static):
    def __str__(self) -> str: ...
    @staticmethod
...
@typing.final
class HttpMultipartContent(windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    def __str__(self) -> str: ...
...
@typing.final
class HttpMultipartFormDataContent(windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    def __str__(self) -> str: ...
    def __iter__(self) -> windows_foundation_collections.IIterator[IHttpContent]: ...
...
@typing.final
class HttpRequestMessage(windows_foundation.IStringable, windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    def __str__(self) -> str: ...
    @staticmethod
...
@typing.final
class HttpResponseMessage(windows_foundation.IStringable, windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    def __str__(self) -> str: ...
    @staticmethod
...
@typing.final
class HttpStreamContent(windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    def __str__(self) -> str: ...
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> HttpStreamContent: ...
    def __new__(cls: typing.Type[HttpStreamContent], content: windows_storage_streams.IInputStream) -> HttpStreamContent: ...
    def buffer_all_async(self) -> windows_foundation.IAsyncOperationWithProgress[winrt.system.UInt64, winrt.system.UInt64]: ...
    def close(self) -> None: ...
    def read_as_buffer_async(self) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IBuffer, winrt.system.UInt64]: ...
    def read_as_input_stream_async(self) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IInputStream, winrt.system.UInt64]: ...
...
@typing.final
class HttpStringContent(windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    def __str__(self) -> str: ...
    @staticmethod
...
class IHttpContent(windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
