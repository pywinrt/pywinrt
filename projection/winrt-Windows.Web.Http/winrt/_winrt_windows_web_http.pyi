...
class HttpBufferContent(winrt.system.Object, windows_foundation.ImplementsIStringable, ImplementsIHttpContent, windows_foundation.ImplementsIClosable):
    ...
    @typing.overload
    def __new__(cls: typing.Type[Self], content: windows_storage_streams.ImplementsIBuffer) -> Self: ...
    @typing.overload
    def __new__(cls: typing.Type[Self], content: windows_storage_streams.ImplementsIBuffer, offset: winrt.system.UInt32, count: winrt.system.UInt32) -> Self: ...
...
class HttpClient(winrt.system.Object, windows_foundation.ImplementsIStringable, windows_foundation.ImplementsIClosable):
    ...
    def __str__(self) -> str: ...
    @typing.overload
    def __new__(cls: typing.Type[Self], filter: windows_web_http_filters.ImplementsIHttpFilter) -> Self: ...
    @typing.overload
...
class HttpFormUrlEncodedContent(winrt.system.Object, windows_foundation.ImplementsIStringable, ImplementsIHttpContent, windows_foundation.ImplementsIClosable):
    ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]], exc_value: typing.Optional[BaseException], traceback: typing.Optional[types.TracebackType]) -> None: ...
    def __str__(self) -> str: ...
    def __new__(cls: typing.Type[Self], content: typing.Iterable[windows_foundation_collections.ImplementsIKeyValuePair[str, str]]) -> Self: ...
...
class HttpStreamContent(winrt.system.Object, windows_foundation.ImplementsIStringable, ImplementsIHttpContent, windows_foundation.ImplementsIClosable):
    ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]], exc_value: typing.Optional[BaseException], traceback: typing.Optional[types.TracebackType]) -> None: ...
    def __str__(self) -> str: ...
    def __new__(cls: typing.Type[Self], content: windows_storage_streams.ImplementsIInputStream) -> Self: ...
...
class ImplementsIHttpContent(windows_foundation.ImplementsIClosable):
