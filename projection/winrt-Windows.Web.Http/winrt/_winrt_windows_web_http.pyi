...
class HttpBufferContent(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[HttpBufferContent], content: typing.Optional[windows_storage_streams.IBuffer]) -> HttpBufferContent: ...
    @typing.overload
    def __new__(cls: typing.Type[HttpBufferContent], content: typing.Optional[windows_storage_streams.IBuffer], offset: winrt.system.UInt32, count: winrt.system.UInt32) -> HttpBufferContent: ...
    ...
    def write_to_stream_async(self, output_stream: typing.Optional[windows_storage_streams.IOutputStream], /) -> windows_foundation.IAsyncOperationWithProgress[winrt.system.UInt64, winrt.system.UInt64]: ...
    @_property
    def headers(self) -> typing.Optional[windows_web_http_headers.HttpContentHeaderCollection]: ...
...
class HttpClient(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[HttpClient], filter: typing.Optional[windows_web_http_filters.IHttpFilter]) -> HttpClient: ...
    @typing.overload
    def __new__(cls: typing.Type[HttpClient]) -> HttpClient: ...
    def close(self) -> None: ...
    def delete_async(self, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]: ...
    def get_async(self, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]: ...
    def get_buffer_async(self, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IBuffer, HttpProgress]: ...
    def get_input_stream_async(self, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IInputStream, HttpProgress]: ...
    def get_string_async(self, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[str, HttpProgress]: ...
    def get_with_option_async(self, uri: typing.Optional[windows_foundation.Uri], completion_option: HttpCompletionOption, /) -> windows_foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]: ...
    def post_async(self, uri: typing.Optional[windows_foundation.Uri], content: typing.Optional[IHttpContent], /) -> windows_foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]: ...
    def put_async(self, uri: typing.Optional[windows_foundation.Uri], content: typing.Optional[IHttpContent], /) -> windows_foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]: ...
    def send_request_async(self, request: typing.Optional[HttpRequestMessage], /) -> windows_foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]: ...
    def send_request_with_option_async(self, request: typing.Optional[HttpRequestMessage], completion_option: HttpCompletionOption, /) -> windows_foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]: ...
    def to_string(self) -> str: ...
    def try_delete_async(self, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]: ...
    def try_get_async(self, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]: ...
    def try_get_async2(self, uri: typing.Optional[windows_foundation.Uri], completion_option: HttpCompletionOption, /) -> windows_foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]: ...
    def try_get_buffer_async(self, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[HttpGetBufferResult, HttpProgress]: ...
    def try_get_input_stream_async(self, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[HttpGetInputStreamResult, HttpProgress]: ...
    def try_get_string_async(self, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[HttpGetStringResult, HttpProgress]: ...
    def try_post_async(self, uri: typing.Optional[windows_foundation.Uri], content: typing.Optional[IHttpContent], /) -> windows_foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]: ...
    def try_put_async(self, uri: typing.Optional[windows_foundation.Uri], content: typing.Optional[IHttpContent], /) -> windows_foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]: ...
    def try_send_request_async(self, request: typing.Optional[HttpRequestMessage], /) -> windows_foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]: ...
    def try_send_request_async2(self, request: typing.Optional[HttpRequestMessage], completion_option: HttpCompletionOption, /) -> windows_foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]: ...
    @_property
    def default_request_headers(self) -> typing.Optional[windows_web_http_headers.HttpRequestHeaderCollection]: ...
    @_property
...
class HttpCookieCollection(winrt.system.Object, winrt._winrt.Sequence[HttpCookie]):
    ...
    def __iter__(self) -> windows_foundation_collections.IIterator[HttpCookie]: ...
    @typing.overload
    ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[HttpCookie]]: ...
...
class HttpCookieManager(winrt.system.Object):
    ...
    def get_cookies(self, uri: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[HttpCookieCollection]: ...
    def set_cookie(self, cookie: typing.Optional[HttpCookie], /) -> bool: ...
    def set_cookie_with_third_party(self, cookie: typing.Optional[HttpCookie], third_party: bool, /) -> bool: ...
...
class HttpFormUrlEncodedContent(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[HttpFormUrlEncodedContent], content: typing.Iterable[windows_foundation_collections.IKeyValuePair[str, str]]) -> HttpFormUrlEncodedContent: ...
    def buffer_all_async(self) -> windows_foundation.IAsyncOperationWithProgress[winrt.system.UInt64, winrt.system.UInt64]: ...
    def close(self) -> None: ...
    def read_as_buffer_async(self) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IBuffer, winrt.system.UInt64]: ...
    def read_as_input_stream_async(self) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IInputStream, winrt.system.UInt64]: ...
...
class HttpGetInputStreamResult(winrt.system.Object):
    ...
    def succeeded(self) -> bool: ...
    @_property
    def value(self) -> typing.Optional[windows_storage_streams.IInputStream]: ...
...
class HttpMultipartContent(winrt.system.Object):
    ...
    def __exit__(self, *args) -> None: ...
    def __str__(self) -> str: ...
    def __iter__(self) -> windows_foundation_collections.IIterator[IHttpContent]: ...
    @staticmethod
    ...
    def buffer_all_async(self) -> windows_foundation.IAsyncOperationWithProgress[winrt.system.UInt64, winrt.system.UInt64]: ...
    def close(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[IHttpContent]]: ...
    def read_as_buffer_async(self) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IBuffer, winrt.system.UInt64]: ...
    def read_as_input_stream_async(self) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IInputStream, winrt.system.UInt64]: ...
    def read_as_string_async(self) -> windows_foundation.IAsyncOperationWithProgress[str, winrt.system.UInt64]: ...
    def to_string(self) -> str: ...
...
class HttpMultipartFormDataContent(winrt.system.Object):
    ...
    def add(self, content: typing.Optional[IHttpContent], /) -> None: ...
    def add_with_name(self, content: typing.Optional[IHttpContent], name: str, /) -> None: ...
    def add_with_name_and_file_name(self, content: typing.Optional[IHttpContent], name: str, file_name: str, /) -> None: ...
    def buffer_all_async(self) -> windows_foundation.IAsyncOperationWithProgress[winrt.system.UInt64, winrt.system.UInt64]: ...
    def close(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[IHttpContent]]: ...
    def read_as_buffer_async(self) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IBuffer, winrt.system.UInt64]: ...
...
class HttpRequestMessage(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[HttpRequestMessage], method: typing.Optional[HttpMethod], uri: typing.Optional[windows_foundation.Uri]) -> HttpRequestMessage: ...
    @typing.overload
    def __new__(cls: typing.Type[HttpRequestMessage]) -> HttpRequestMessage: ...
    def close(self) -> None: ...
    def to_string(self) -> str: ...
    @_property
    def request_uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @request_uri.setter
    def request_uri(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    ...
    @_property
    def headers(self) -> typing.Optional[windows_web_http_headers.HttpRequestHeaderCollection]: ...
    @_property
...
class HttpResponseMessage(winrt.system.Object):
    ...
    def content(self, value: typing.Optional[IHttpContent]) -> None: ...
    @_property
    def headers(self) -> typing.Optional[windows_web_http_headers.HttpResponseHeaderCollection]: ...
    @_property
...
class HttpStreamContent(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[HttpStreamContent], content: typing.Optional[windows_storage_streams.IInputStream]) -> HttpStreamContent: ...
    def buffer_all_async(self) -> windows_foundation.IAsyncOperationWithProgress[winrt.system.UInt64, winrt.system.UInt64]: ...
    def close(self) -> None: ...
    def read_as_buffer_async(self) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IBuffer, winrt.system.UInt64]: ...
    def read_as_input_stream_async(self) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IInputStream, winrt.system.UInt64]: ...
...
class HttpStringContent(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[HttpStringContent], content: str, encoding: windows_storage_streams.UnicodeEncoding) -> HttpStringContent: ...
    @typing.overload
    def __new__(cls: typing.Type[HttpStringContent], content: str, encoding: windows_storage_streams.UnicodeEncoding, media_type: str) -> HttpStringContent: ...
    def buffer_all_async(self) -> windows_foundation.IAsyncOperationWithProgress[winrt.system.UInt64, winrt.system.UInt64]: ...
    def close(self) -> None: ...
    def read_as_buffer_async(self) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IBuffer, winrt.system.UInt64]: ...
    def read_as_input_stream_async(self) -> windows_foundation.IAsyncOperationWithProgress[windows_storage_streams.IInputStream, winrt.system.UInt64]: ...
