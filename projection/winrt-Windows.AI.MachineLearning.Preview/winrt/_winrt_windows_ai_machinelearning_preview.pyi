...
class LearningModelBindingPreview(winrt.system.Object, winrt._winrt.Mapping[str, winrt.system.Object]):
    ...
    def bind_with_properties(self, name: str, value: typing.Optional[winrt.system.Object], metadata: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
    def clear(self) -> None: ...
