...
class LearningModelBindingPreview(winrt.system.Object, winrt._winrt.Mapping[str, winrt.system.Object]):
    ...
    def __new__(cls: typing.Type[LearningModelBindingPreview], model: LearningModelPreview) -> LearningModelBindingPreview: ...
    ...
    def split(self) -> typing.Tuple[windows_foundation_collections.IMapView[str, winrt.system.Object], windows_foundation_collections.IMapView[str, winrt.system.Object]]: ...
    @_property
...
class LearningModelDescriptionPreview(winrt.system.Object):
    ...
    def domain(self) -> str: ...
    @_property
    def input_features(self) -> windows_foundation_collections.IIterable[ILearningModelVariableDescriptorPreview]: ...
    @_property
    def metadata(self) -> windows_foundation_collections.IMapView[str, str]: ...
    @_property
    def name(self) -> str: ...
    @_property
    def output_features(self) -> windows_foundation_collections.IIterable[ILearningModelVariableDescriptorPreview]: ...
    @_property
...
class LearningModelEvaluationResultPreview(winrt.system.Object):
    ...
    @_property
    def outputs(self) -> windows_foundation_collections.IMapView[str, winrt.system.Object]: ...
...
class MapVariableDescriptorPreview(winrt.system.Object):
    ...
    @_property
    def valid_integer_keys(self) -> windows_foundation_collections.IIterable[winrt.system.Int64]: ...
    @_property
    def valid_string_keys(self) -> windows_foundation_collections.IIterable[str]: ...
...
class TensorVariableDescriptorPreview(winrt.system.Object):
    ...
    @_property
    def shape(self) -> windows_foundation_collections.IIterable[winrt.system.Int64]: ...
