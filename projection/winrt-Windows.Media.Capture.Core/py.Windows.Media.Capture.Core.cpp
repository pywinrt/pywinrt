...
PyMODINIT_FUNC PyInit__winrt_Windows_Media_Capture_Core(void) noexcept
{
    ...
    state->type_VariablePhotoCapturedEventArgs = py::register_python_type(module.get(), type_name_VariablePhotoCapturedEventArgs, &type_spec_VariablePhotoCapturedEventArgs, object_bases.get(), nullptr);
    if (!state->type_VariablePhotoCapturedEventArgs)
    {
        return nullptr;
    }

    state->type_VariablePhotoSequenceCapture = py::register_python_type(module.get(), type_name_VariablePhotoSequenceCapture, &type_spec_VariablePhotoSequenceCapture, object_bases.get(), nullptr);
