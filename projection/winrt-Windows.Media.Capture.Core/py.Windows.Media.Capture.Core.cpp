...
PyMODINIT_FUNC PyInit__winrt_windows_media_capture_core(void) noexcept
{
    ...
    py::pyobj_handle VariablePhotoCapturedEventArgs_type{py::register_python_type(module.get(), &type_spec_VariablePhotoCapturedEventArgs, object_bases.get(), nullptr)};
    if (!VariablePhotoCapturedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle VariablePhotoSequenceCapture_type{py::register_python_type(module.get(), &type_spec_VariablePhotoSequenceCapture, object_bases.get(), nullptr)};
