...
PyMODINIT_FUNC PyInit__winrt_microsoft_windows_applifecycle(void) noexcept
{
    ...
    py::pyobj_handle ActivationRegistrationManager_type{py::register_python_type(module.get(), &type_spec_ActivationRegistrationManager, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_ActivationRegistrationManager_Static.get()))};
    if (!ActivationRegistrationManager_type)
    {
        return nullptr;
    }

    py::pyobj_handle AppActivationArguments_type{py::register_python_type(module.get(), &type_spec_AppActivationArguments, object_bases.get(), nullptr)};
