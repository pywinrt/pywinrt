...
PyMODINIT_FUNC PyInit__winrt_windows_media_contentrestrictions(void) noexcept
{
    ...
    py::pyobj_handle ContentRestrictionsBrowsePolicy_type{py::register_python_type(module.get(), &type_spec_ContentRestrictionsBrowsePolicy, object_bases.get(), nullptr)};
    if (!ContentRestrictionsBrowsePolicy_type)
    {
        return nullptr;
    }

    py::pyobj_handle RatedContentDescription_type{py::register_python_type(module.get(), &type_spec_RatedContentDescription, object_bases.get(), nullptr)};
    if (!RatedContentDescription_type)
    {
        return nullptr;
    }

    py::pyobj_handle RatedContentRestrictions_type{py::register_python_type(module.get(), &type_spec_RatedContentRestrictions, object_bases.get(), nullptr)};
