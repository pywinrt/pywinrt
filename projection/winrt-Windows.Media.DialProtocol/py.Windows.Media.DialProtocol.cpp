...
PyMODINIT_FUNC PyInit__winrt_windows_media_dialprotocol(void) noexcept
{
    ...
    py::pyobj_handle DialApp_type{py::register_python_type(module.get(), &type_spec_DialApp, object_bases.get(), nullptr)};
    if (!DialApp_type)
    {
        return nullptr;
    }

    py::pyobj_handle DialAppStateDetails_type{py::register_python_type(module.get(), &type_spec_DialAppStateDetails, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle DialDevice_type{py::register_python_type(module.get(), &type_spec_DialDevice, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_DialDevice_Static.get()))};
    if (!DialDevice_type)
    {
        return nullptr;
    }

    py::pyobj_handle DialDevicePicker_type{py::register_python_type(module.get(), &type_spec_DialDevicePicker, object_bases.get(), nullptr)};
    if (!DialDevicePicker_type)
    {
        return nullptr;
    }

    py::pyobj_handle DialDevicePickerFilter_type{py::register_python_type(module.get(), &type_spec_DialDevicePickerFilter, object_bases.get(), nullptr)};
    if (!DialDevicePickerFilter_type)
    {
        return nullptr;
    }

    py::pyobj_handle DialDeviceSelectedEventArgs_type{py::register_python_type(module.get(), &type_spec_DialDeviceSelectedEventArgs, object_bases.get(), nullptr)};
    if (!DialDeviceSelectedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle DialDisconnectButtonClickedEventArgs_type{py::register_python_type(module.get(), &type_spec_DialDisconnectButtonClickedEventArgs, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle DialReceiverApp_type{py::register_python_type(module.get(), &type_spec_DialReceiverApp, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_DialReceiverApp_Static.get()))};
