...
PyMODINIT_FUNC PyInit__winrt_windows_phone_startscreen(void) noexcept
{
    ...
    py::pyobj_handle DualSimTile_type{py::register_python_type(module.get(), &type_spec_DualSimTile, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_DualSimTile_Static.get()))};
    if (!DualSimTile_type)
    {
        return nullptr;
    }

    py::pyobj_handle IToastNotificationManagerStatics3_type{py::register_python_type(module.get(), &type_spec_IToastNotificationManagerStatics3, object_bases.get(), nullptr)};
