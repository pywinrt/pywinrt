...
class WindowsXamlManager(winrt.system.Object, metaclass=WindowsXamlManager_Static):
    ...
    def close(self) -> None: ...
    def add_xaml_shutdown_completed_on_thread(self, handler: winrt.windows.foundation.TypedEventHandler[WindowsXamlManager, XamlShutdownCompletedOnThreadEventArgs], /) -> winrt.windows.foundation.EventRegistrationToken: ...
    def remove_xaml_shutdown_completed_on_thread(self, token: winrt.windows.foundation.EventRegistrationToken, /) -> None: ...
...
class XamlShutdownCompletedOnThreadEventArgs(winrt.system.Object):
    ...
    def get_dispatcher_queue_deferral(self) -> typing.Optional[winrt.windows.foundation.Deferral]: ...
