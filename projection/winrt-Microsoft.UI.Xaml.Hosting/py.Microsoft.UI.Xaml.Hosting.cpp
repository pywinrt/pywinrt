...
namespace py::cpp::Microsoft::UI::Xaml::Hosting
{
    ...
    struct PyWinrtDesktopWindowXamlSource : winrt::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSourceT<PyWinrtDesktopWindowXamlSource>
    {
        PyWinrtDesktopWindowXamlSource() : winrt::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSourceT<PyWinrtDesktopWindowXamlSource>() {}
    };
        ...
        if (arg_count == 0)
        {
            try
            {
                if (type != self_type)
                {
                    ...
                    auto self = reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource*>(type->tp_alloc(type, 0));
                    if (!self)
                    {
                        return nullptr;
                    }
    ...
    static PyObject* DesktopWindowXamlSource_NavigateFocus(py::wrapper::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            try
            {
                ...
                return py::convert(self->obj.try_as<winrt::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource>().NavigateFocus(param0));
            }
            catch (...)
            {
                py::to_PyErr();
    ...
    static PyObject* DesktopWindowXamlSource_get_SystemBackdrop(py::wrapper::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            return py::convert(self->obj.try_as<winrt::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource>().SystemBackdrop());
        }
        catch (...)
        {
            py::to_PyErr();
    ...
    static PyObject* DesktopWindowXamlSource_get_Content(py::wrapper::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            return py::convert(self->obj.try_as<winrt::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource>().Content());
        }
        catch (...)
        {
            py::to_PyErr();
    ...
    static PyObject* DesktopWindowXamlSource_get_HasFocus(py::wrapper::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            return py::convert(self->obj.try_as<winrt::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource>().HasFocus());
        }
        catch (...)
        {
            py::to_PyErr();
    ...
    static PyObject* DesktopWindowXamlSource_get_SiteBridge(py::wrapper::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            return py::convert(self->obj.try_as<winrt::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource>().SiteBridge());
        }
        catch (...)
        {
            py::to_PyErr();
    ...
    static PyObject* DesktopWindowXamlSource_get_ShouldConstrainPopupsToWorkArea(py::wrapper::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            return py::convert(self->obj.try_as<winrt::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource>().ShouldConstrainPopupsToWorkArea());
        }
        catch (...)
        {
            py::to_PyErr();
    ...
    static PyObject* DesktopWindowXamlSource_add_GotFocus(py::wrapper::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            return py::convert(self->obj.try_as<winrt::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource>().GotFocus(param0));
        }
        catch (...)
        {
            py::to_PyErr();
    ...
    static PyObject* DesktopWindowXamlSource_add_TakeFocusRequested(py::wrapper::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            return py::convert(self->obj.try_as<winrt::Microsoft::UI::Xaml::Hosting::DesktopWindowXamlSource>().TakeFocusRequested(param0));
        }
        catch (...)
        {
            py::to_PyErr();
...
PyMODINIT_FUNC PyInit__winrt_microsoft_ui_xaml_hosting(void) noexcept
{
    ...
    py::pytype_handle XamlShutdownCompletedOnThreadEventArgs_type{py::register_python_type(module.get(), &type_spec_XamlShutdownCompletedOnThreadEventArgs, object_bases.get(), nullptr)};
