...
PyMODINIT_FUNC PyInit__winrt_windows_system_remotedesktop(void) noexcept
{
    ...
    py::pyobj_handle InteractiveSession_type{py::register_python_type(module.get(), &type_spec_InteractiveSession, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_InteractiveSession_Static.get()))};
