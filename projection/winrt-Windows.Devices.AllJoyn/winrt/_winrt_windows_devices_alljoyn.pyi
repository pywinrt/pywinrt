...
class AllJoynAboutData(winrt.system.Object):
    ...
    @_property
    def support_url(self) -> typing.Optional[windows_foundation.Uri]: ...
    @support_url.setter
    def support_url(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    ...
    @_property
    def app_names(self) -> typing.Optional[windows_foundation_collections.IMap[str, str]]: ...
    @_property
    def manufacturers(self) -> typing.Optional[windows_foundation_collections.IMap[str, str]]: ...
    @_property
    def descriptions(self) -> typing.Optional[windows_foundation_collections.IMap[str, str]]: ...

@typing.final
class AllJoynAboutDataView_Static(type):
    @typing.overload
    def get_data_by_session_port_async(cls, unique_name: str, bus_attachment: typing.Optional[AllJoynBusAttachment], session_port: winrt.system.UInt16, /) -> windows_foundation.IAsyncOperation[AllJoynAboutDataView]: ...
    @typing.overload
    def get_data_by_session_port_async(cls, unique_name: str, bus_attachment: typing.Optional[AllJoynBusAttachment], session_port: winrt.system.UInt16, language: typing.Optional[windows_globalization.Language], /) -> windows_foundation.IAsyncOperation[AllJoynAboutDataView]: ...
...
class AllJoynAboutDataView(winrt.system.Object, metaclass=AllJoynAboutDataView_Static):
    ...
    def date_of_manufacture(self) -> typing.Optional[typing.Optional[datetime.datetime]]: ...
    @_property
    def default_language(self) -> typing.Optional[windows_globalization.Language]: ...
    @_property
    ...
    def support_url(self) -> typing.Optional[windows_foundation.Uri]: ...
    @_property
    def supported_languages(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_globalization.Language]]: ...
...
class AllJoynBusAttachment_Static(type):
    ...
    def get_watcher(cls, required_interfaces: typing.Iterable[str], /) -> typing.Optional[windows_devices_enumeration.DeviceWatcher]: ...
...
class AllJoynBusAttachment(winrt.system.Object, metaclass=AllJoynBusAttachment_Static):
    ...
    @typing.overload
    def get_about_data_async(self, service_info: typing.Optional[AllJoynServiceInfo], /) -> windows_foundation.IAsyncOperation[AllJoynAboutDataView]: ...
    @typing.overload
    def get_about_data_async(self, service_info: typing.Optional[AllJoynServiceInfo], language: typing.Optional[windows_globalization.Language], /) -> windows_foundation.IAsyncOperation[AllJoynAboutDataView]: ...
    def ping_async(self, unique_name: str, /) -> windows_foundation.IAsyncOperation[winrt.system.Int32]: ...
    def add_authentication_complete(self, handler: windows_foundation.TypedEventHandler[AllJoynBusAttachment, AllJoynAuthenticationCompleteEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_authentication_complete(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_credentials_requested(self, handler: windows_foundation.TypedEventHandler[AllJoynBusAttachment, AllJoynCredentialsRequestedEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_credentials_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_credentials_verification_requested(self, handler: windows_foundation.TypedEventHandler[AllJoynBusAttachment, AllJoynCredentialsVerificationRequestedEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_credentials_verification_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_state_changed(self, handler: windows_foundation.TypedEventHandler[AllJoynBusAttachment, AllJoynBusAttachmentStateChangedEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_state_changed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_accept_session_joiner_requested(self, handler: windows_foundation.TypedEventHandler[AllJoynBusAttachment, AllJoynAcceptSessionJoinerEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_accept_session_joiner_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_session_joined(self, handler: windows_foundation.TypedEventHandler[AllJoynBusAttachment, AllJoynSessionJoinedEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_session_joined(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
    def about_data(self) -> typing.Optional[AllJoynAboutData]: ...
    @_property
    def authentication_mechanisms(self) -> typing.Optional[windows_foundation_collections.IVector[AllJoynAuthenticationMechanism]]: ...
    @_property
...
class AllJoynBusObject(winrt.system.Object):
    ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
    def add_stopped(self, handler: windows_foundation.TypedEventHandler[AllJoynBusObject, AllJoynBusObjectStoppedEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
...
class AllJoynCredentials(winrt.system.Object):
    ...
    @_property
    def password_credential(self) -> typing.Optional[windows_security_credentials.PasswordCredential]: ...
    @password_credential.setter
    def password_credential(self, value: typing.Optional[windows_security_credentials.PasswordCredential]) -> None: ...
    @_property
    def certificate(self) -> typing.Optional[windows_security_cryptography_certificates.Certificate]: ...
    @certificate.setter
    def certificate(self, value: typing.Optional[windows_security_cryptography_certificates.Certificate]) -> None: ...
    @_property
    def authentication_mechanism(self) -> AllJoynAuthenticationMechanism: ...
...
class AllJoynCredentialsVerificationRequestedEventArgs(winrt.system.Object):
    ...
    def authentication_mechanism(self) -> AllJoynAuthenticationMechanism: ...
    @_property
    def peer_certificate(self) -> typing.Optional[windows_security_cryptography_certificates.Certificate]: ...
    @_property
    def peer_certificate_error_severity(self) -> windows_networking_sockets.SocketSslErrorSeverity: ...
    @_property
    def peer_certificate_errors(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_security_cryptography_certificates.ChainValidationResult]]: ...
    @_property
    def peer_intermediate_certificates(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_security_cryptography_certificates.Certificate]]: ...
    @_property
    def peer_unique_name(self) -> str: ...
...
class AllJoynServiceInfo_Static(type):
    def from_id_async(cls, device_id: str, /) -> windows_foundation.IAsyncOperation[AllJoynServiceInfo]: ...
...
class AllJoynSession_Static(type):
    @typing.overload
    def get_from_service_info_async(cls, service_info: typing.Optional[AllJoynServiceInfo], /) -> windows_foundation.IAsyncOperation[AllJoynSession]: ...
    @typing.overload
    def get_from_service_info_async(cls, service_info: typing.Optional[AllJoynServiceInfo], bus_attachment: typing.Optional[AllJoynBusAttachment], /) -> windows_foundation.IAsyncOperation[AllJoynSession]: ...

@typing.final
class AllJoynSession(winrt.system.Object, metaclass=AllJoynSession_Static):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> AllJoynSession: ...
    def remove_member_async(self, unique_name: str, /) -> windows_foundation.IAsyncOperation[winrt.system.Int32]: ...
    def add_lost(self, handler: windows_foundation.TypedEventHandler[AllJoynSession, AllJoynSessionLostEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_lost(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_member_added(self, handler: windows_foundation.TypedEventHandler[AllJoynSession, AllJoynSessionMemberAddedEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_member_added(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_member_removed(self, handler: windows_foundation.TypedEventHandler[AllJoynSession, AllJoynSessionMemberRemovedEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_member_removed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
