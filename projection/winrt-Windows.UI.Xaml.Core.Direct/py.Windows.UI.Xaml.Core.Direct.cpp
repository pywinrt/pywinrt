...
PyMODINIT_FUNC PyInit__winrt_windows_ui_xaml_core_direct(void) noexcept
{
    ...
    py::pyobj_handle XamlDirect_type{py::register_python_type(module.get(), &type_spec_XamlDirect, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_XamlDirect_Static.get()))};
    if (!XamlDirect_type)
    {
        return nullptr;
    }

    py::pyobj_handle IXamlDirectObject_type{py::register_python_type(module.get(), &type_spec_IXamlDirectObject, object_bases.get(), nullptr)};
