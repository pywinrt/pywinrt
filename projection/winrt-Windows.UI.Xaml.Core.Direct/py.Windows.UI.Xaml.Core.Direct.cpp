...
namespace py::cpp::Windows::UI::Xaml::Core::Direct
{
    ...
    {
        py::set_invalid_activation_error(type_name_XamlDirect);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_IXamlDirectObject = "IXamlDirectObject";

    static PyObject* _new_IXamlDirectObject(PyTypeObject* /* unused */, PyObject* /* unused */, PyObject* /* unused */) noexcept
    {
        py::set_invalid_activation_error(type_name_IXamlDirectObject);
        return nullptr;
    }
...
PyMODINIT_FUNC PyInit__winrt_Windows_UI_Xaml_Core_Direct(void) noexcept
{
    ...
    state->type_XamlDirect = py::register_python_type(module.get(), type_name_XamlDirect, &type_spec_XamlDirect, object_bases.get(), nullptr);
    if (!state->type_XamlDirect)
    {
        return nullptr;
    }

    state->type_IXamlDirectObject = py::register_python_type(module.get(), type_name_IXamlDirectObject, &type_spec_IXamlDirectObject, object_bases.get(), nullptr);
    if (!state->type_IXamlDirectObject)
    {
        return nullptr;
    }
...
PyTypeObject* py::winrt_type<winrt::Windows::UI::Xaml::Core::Direct::XamlDirect>::get_python_type() noexcept {
    ...
    auto python_type = state->type_XamlDirect;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Core::Direct::XamlDirect is not registered");
        return nullptr;
    }
...
PyTypeObject* py::winrt_type<winrt::Windows::UI::Xaml::Core::Direct::IXamlDirectObject>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Core::Direct;
    ...
    auto python_type = state->type_IXamlDirectObject;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Core::Direct::IXamlDirectObject is not registered");
        return nullptr;
    }
