...
class UserDataTaskBatch(winrt.system.Object):
    ...
    @_property
    def tasks(self) -> typing.Optional[windows_foundation_collections.IVectorView[UserDataTask]]: ...
...
class UserDataTaskList(winrt.system.Object):
    ...
    def get_task_reader_with_options(self, options: typing.Optional[UserDataTaskQueryOptions], /) -> typing.Optional[UserDataTaskReader]: ...
    def register_sync_manager_async(self) -> windows_foundation.IAsyncAction: ...
    def save_async(self) -> windows_foundation.IAsyncAction: ...
    def save_task_async(self, user_data_task: typing.Optional[UserDataTask], /) -> windows_foundation.IAsyncAction: ...
    @_property
...
class UserDataTaskListLimitedWriteOperations(winrt.system.Object):
    ...
    def try_create_or_update_task_async(self, user_data_task: typing.Optional[UserDataTask], /) -> windows_foundation.IAsyncOperation[bool]: ...
...
class UserDataTaskManager_Static(type):
    ...
    def get_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[UserDataTaskManager]: ...
...
class UserDataTaskStore(winrt.system.Object):
    ...
    def find_lists_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[UserDataTaskList]]: ...
