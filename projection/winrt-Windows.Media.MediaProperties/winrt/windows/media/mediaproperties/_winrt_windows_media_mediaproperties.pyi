...
from . import AudioEncodingQuality, MediaMirroringOptions, MediaPixelFormat, MediaRotation, MediaThumbnailFormat, SphericalVideoFrameFormat, StereoscopicVideoPackingMode, VideoEncodingQuality

Self = typing.TypeVar('Self')

class AudioEncodingProperties(winrt.system.Object):
    sample_rate: winrt.system.UInt32
    channel_count: winrt.system.UInt32
    bits_per_sample: winrt.system.UInt32
    bitrate: winrt.system.UInt32
    is_spatial: winrt.system.Boolean
    subtype: str
...
class MediaPropertySet(winrt.system.Object, typing.MutableMapping[winrt.system.Guid, winrt.system.Object]):
