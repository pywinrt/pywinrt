...
class MediaEncodingProfile_Static(type):
    ...
    def create_from_file_async(cls, file: typing.Optional[windows_storage.IStorageFile], /) -> windows_foundation.IAsyncOperation[MediaEncodingProfile]: ...
    def create_from_stream_async(cls, stream: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> windows_foundation.IAsyncOperation[MediaEncodingProfile]: ...
...
class MediaEncodingProfile(winrt.system.Object, metaclass=MediaEncodingProfile_Static):
    ...
    def get_audio_tracks(self) -> typing.Optional[windows_foundation_collections.IVector[windows_media_core.AudioStreamDescriptor]]: ...
    def get_timed_metadata_tracks(self) -> typing.Optional[windows_foundation_collections.IVector[windows_media_core.TimedMetadataStreamDescriptor]]: ...
    def get_video_tracks(self) -> typing.Optional[windows_foundation_collections.IVector[windows_media_core.VideoStreamDescriptor]]: ...
...
class TimedMetadataEncodingProperties_Static(type):
    ...
    def create_ssa(cls, format_user_data: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> typing.Optional[TimedMetadataEncodingProperties]: ...
    def create_vob_sub(cls, format_user_data: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> typing.Optional[TimedMetadataEncodingProperties]: ...
