...
PyMODINIT_FUNC PyInit__winrt_windows_devices_pointofservice_provider(void) noexcept
{
    ...
    py::pyobj_handle BarcodeScannerDisableScannerRequest_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerDisableScannerRequest, object_bases.get(), nullptr)};
    if (!BarcodeScannerDisableScannerRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerDisableScannerRequestEventArgs_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerDisableScannerRequestEventArgs, object_bases.get(), nullptr)};
    if (!BarcodeScannerDisableScannerRequestEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerEnableScannerRequest_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerEnableScannerRequest, object_bases.get(), nullptr)};
    if (!BarcodeScannerEnableScannerRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerEnableScannerRequestEventArgs_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerEnableScannerRequestEventArgs, object_bases.get(), nullptr)};
    if (!BarcodeScannerEnableScannerRequestEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerFrameReader_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerFrameReader, object_bases.get(), nullptr)};
    if (!BarcodeScannerFrameReader_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerFrameReaderFrameArrivedEventArgs_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerFrameReaderFrameArrivedEventArgs, object_bases.get(), nullptr)};
    if (!BarcodeScannerFrameReaderFrameArrivedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerGetSymbologyAttributesRequest_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerGetSymbologyAttributesRequest, object_bases.get(), nullptr)};
    if (!BarcodeScannerGetSymbologyAttributesRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerGetSymbologyAttributesRequestEventArgs_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerGetSymbologyAttributesRequestEventArgs, object_bases.get(), nullptr)};
    if (!BarcodeScannerGetSymbologyAttributesRequestEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerHideVideoPreviewRequest_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerHideVideoPreviewRequest, object_bases.get(), nullptr)};
    if (!BarcodeScannerHideVideoPreviewRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerHideVideoPreviewRequestEventArgs_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerHideVideoPreviewRequestEventArgs, object_bases.get(), nullptr)};
    if (!BarcodeScannerHideVideoPreviewRequestEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerProviderConnection_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerProviderConnection, object_bases.get(), nullptr)};
    if (!BarcodeScannerProviderConnection_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerProviderTriggerDetails_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerProviderTriggerDetails, object_bases.get(), nullptr)};
    if (!BarcodeScannerProviderTriggerDetails_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerSetActiveSymbologiesRequest_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerSetActiveSymbologiesRequest, object_bases.get(), nullptr)};
    if (!BarcodeScannerSetActiveSymbologiesRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerSetActiveSymbologiesRequestEventArgs_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerSetActiveSymbologiesRequestEventArgs, object_bases.get(), nullptr)};
    if (!BarcodeScannerSetActiveSymbologiesRequestEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerSetSymbologyAttributesRequest_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerSetSymbologyAttributesRequest, object_bases.get(), nullptr)};
    if (!BarcodeScannerSetSymbologyAttributesRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerSetSymbologyAttributesRequestEventArgs_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerSetSymbologyAttributesRequestEventArgs, object_bases.get(), nullptr)};
    if (!BarcodeScannerSetSymbologyAttributesRequestEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerStartSoftwareTriggerRequest_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerStartSoftwareTriggerRequest, object_bases.get(), nullptr)};
    if (!BarcodeScannerStartSoftwareTriggerRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerStartSoftwareTriggerRequestEventArgs_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerStartSoftwareTriggerRequestEventArgs, object_bases.get(), nullptr)};
    if (!BarcodeScannerStartSoftwareTriggerRequestEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerStopSoftwareTriggerRequest_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerStopSoftwareTriggerRequest, object_bases.get(), nullptr)};
    if (!BarcodeScannerStopSoftwareTriggerRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerStopSoftwareTriggerRequestEventArgs_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerStopSoftwareTriggerRequestEventArgs, object_bases.get(), nullptr)};
    if (!BarcodeScannerStopSoftwareTriggerRequestEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeScannerVideoFrame_type{py::register_python_type(module.get(), &type_spec_BarcodeScannerVideoFrame, object_bases.get(), nullptr)};
    if (!BarcodeScannerVideoFrame_type)
    {
        return nullptr;
    }

    py::pyobj_handle BarcodeSymbologyAttributesBuilder_type{py::register_python_type(module.get(), &type_spec_BarcodeSymbologyAttributesBuilder, object_bases.get(), nullptr)};
