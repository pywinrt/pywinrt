...
class BarcodeScannerGetSymbologyAttributesRequest(winrt.system.Object):
    ...
    def report_completed_async(self, attributes: typing.Optional[windows_devices_pointofservice.BarcodeSymbologyAttributes], /) -> windows_foundation.IAsyncAction: ...
    def report_failed_async(self) -> windows_foundation.IAsyncAction: ...
    def report_failed_with_failed_reason_and_description_async(self, reason: winrt.system.Int32, failed_reason_description: str, /) -> windows_foundation.IAsyncAction: ...
    def report_failed_with_failed_reason_async(self, reason: winrt.system.Int32, /) -> windows_foundation.IAsyncAction: ...
    @_property
...
class BarcodeScannerProviderConnection(winrt.system.Object):
    ...
    def create_frame_reader_with_format_and_size_async(self, preferred_format: windows_graphics_imaging.BitmapPixelFormat, preferred_size: windows_graphics_imaging.BitmapSize, /) -> windows_foundation.IAsyncOperation[BarcodeScannerFrameReader]: ...
    ...
    def report_error_async(self, error_data: typing.Optional[windows_devices_pointofservice.UnifiedPosErrorData], /) -> windows_foundation.IAsyncAction: ...
    def report_error_async_with_scan_report(self, error_data: typing.Optional[windows_devices_pointofservice.UnifiedPosErrorData], is_retriable: bool, scan_report: typing.Optional[windows_devices_pointofservice.BarcodeScannerReport], /) -> windows_foundation.IAsyncAction: ...
    def report_scanned_data_async(self, report: typing.Optional[windows_devices_pointofservice.BarcodeScannerReport], /) -> windows_foundation.IAsyncAction: ...
    ...
    def remove_disable_scanner_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_enable_scanner_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_get_barcode_symbology_attributes_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_hide_video_preview_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_set_active_symbologies_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_set_barcode_symbology_attributes_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_start_software_trigger_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_stop_software_trigger_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
    ...
    def id(self) -> str: ...
    @_property
    def supported_symbologies(self) -> typing.Optional[windows_foundation_collections.IVector[winrt.system.UInt32]]: ...
    @_property
...
class BarcodeScannerSetActiveSymbologiesRequest(winrt.system.Object):
    ...
    def report_failed_with_failed_reason_async(self, reason: winrt.system.Int32, /) -> windows_foundation.IAsyncAction: ...
    @_property
    def symbologies(self) -> typing.Optional[windows_foundation_collections.IVectorView[winrt.system.UInt32]]: ...
...
class BarcodeScannerSetSymbologyAttributesRequest(winrt.system.Object):
    ...
    def report_failed_with_failed_reason_async(self, reason: winrt.system.Int32, /) -> windows_foundation.IAsyncAction: ...
    @_property
    def attributes(self) -> typing.Optional[windows_devices_pointofservice.BarcodeSymbologyAttributes]: ...
    @_property
    def symbology(self) -> winrt.system.UInt32: ...
...
class BarcodeScannerVideoFrame(winrt.system.Object):
    ...
    @_property
    def pixel_data(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
...
class BarcodeSymbologyAttributesBuilder(winrt.system.Object):
    ...
    def create_attributes(self) -> typing.Optional[windows_devices_pointofservice.BarcodeSymbologyAttributes]: ...
    @_property
