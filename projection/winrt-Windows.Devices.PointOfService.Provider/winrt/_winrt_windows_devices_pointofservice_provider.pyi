...
class BarcodeScannerProviderConnection(winrt.system.Object):
    ...
    @typing.overload
    def create_frame_reader_async(self, preferred_format: windows_graphics_imaging.BitmapPixelFormat, preferred_size: windows_graphics_imaging.BitmapSize, /) -> windows_foundation.IAsyncOperation[BarcodeScannerFrameReader]: ...
    @typing.overload
    ...
    @typing.overload
    def report_error_async(self, error_data: typing.Optional[windows_devices_pointofservice.UnifiedPosErrorData], is_retriable: bool, scan_report: typing.Optional[windows_devices_pointofservice.BarcodeScannerReport], /) -> windows_foundation.IAsyncAction: ...
