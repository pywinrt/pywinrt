...
class BarcodeScannerProviderConnection(winrt.system.Object):
    ...
    def id(self) -> str: ...
    @_property
    def supported_symbologies(self) -> windows_foundation_collections.IVector[winrt.system.UInt32]: ...
    @_property
...
class BarcodeScannerSetActiveSymbologiesRequest(winrt.system.Object):
    ...
    def report_failed_with_failed_reason_async(self, reason: winrt.system.Int32, /) -> windows_foundation.IAsyncAction: ...
    @_property
    def symbologies(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
