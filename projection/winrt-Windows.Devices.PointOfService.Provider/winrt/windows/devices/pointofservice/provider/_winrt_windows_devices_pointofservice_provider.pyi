...
class BarcodeScannerProviderConnection(winrt.system.Object):
    ...
    @typing.overload
    def report_error_async(self, error_data: typing.Optional[winrt.windows.devices.pointofservice.UnifiedPosErrorData], is_retriable: winrt.system.Boolean, scan_report: typing.Optional[winrt.windows.devices.pointofservice.BarcodeScannerReport], /) -> winrt.windows.foundation.IAsyncAction: ...
