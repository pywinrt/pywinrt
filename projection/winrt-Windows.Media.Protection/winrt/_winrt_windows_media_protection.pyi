...
class ComponentRenewal_Static(type):
    def renew_system_components_async(cls, information: typing.Optional[RevocationAndRenewalInformation], /) -> windows_foundation.IAsyncOperationWithProgress[RenewalStatus, winrt.system.UInt32]: ...
...
class HdcpSession(winrt.system.Object):
    ...
    def remove_protection_changed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
...
class MediaProtectionManager(winrt.system.Object):
    ...
    def add_component_load_failed(self, handler: typing.Optional[ComponentLoadFailedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_component_load_failed(self, cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_reboot_needed(self, handler: typing.Optional[RebootNeededEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_reboot_needed(self, cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_service_requested(self, handler: typing.Optional[ServiceRequestedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_service_requested(self, cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
...
class MediaProtectionPMPServer(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[MediaProtectionPMPServer], p_properties: typing.Optional[windows_foundation_collections.IPropertySet]) -> MediaProtectionPMPServer: ...
    @_property
    def properties(self) -> typing.Optional[windows_foundation_collections.IPropertySet]: ...
...
class RevocationAndRenewalInformation(winrt.system.Object):
    ...
    @_property
    def items(self) -> typing.Optional[windows_foundation_collections.IVector[RevocationAndRenewalItem]]: ...
...
class ServiceRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def media_playback_item(self) -> typing.Optional[windows_media_playback.MediaPlaybackItem]: ...
