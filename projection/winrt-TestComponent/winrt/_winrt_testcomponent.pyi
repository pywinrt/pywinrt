...
class OverloadClass(winrt.system.Object, metaclass=OverloadClass_Static):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> OverloadClass: ...
    def __new__(cls: typing.Type[Self]) -> Self: ...
    @typing.final
...
class Override(winrt.system.Object, metaclass=Override_Static):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> Override: ...
    def __new__(cls: typing.Type[Self]) -> Self: ...
    @typing.final
    ...
    @typing.final
    def remove_overridable_called(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @typing.final
