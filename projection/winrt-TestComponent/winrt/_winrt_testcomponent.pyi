...
class TestRunner_Static(type):
    def create_int32_vector(cls) -> typing.Optional[windows_foundation_collections.IVector[winrt.system.Int32]]: ...
    def create_string_vector(cls) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    def create_stringable_vector(cls) -> typing.Optional[windows_foundation_collections.IVector[windows_foundation.IStringable]]: ...
...
class ITests(winrt.system.Object):
    ...
    def array1(self, a: winrt.system.Array[bool], b: winrt.system.Array[bool], /) -> typing.Tuple[winrt.system.Array[bool], winrt.system.Array[bool]]: ...
    def array10(self, a: winrt.system.Array[winrt.system.Double], b: winrt.system.Array[winrt.system.Double], /) -> typing.Tuple[winrt.system.Array[winrt.system.Double], winrt.system.Array[winrt.system.Double]]: ...
    def array10_call(self, handler: typing.Optional[Array10Handler], /) -> None: ...
    def array11(self, a: winrt.system.Array[winrt.system.Char16], b: winrt.system.Array[winrt.system.Char16], /) -> typing.Tuple[winrt.system.Array[winrt.system.Char16], winrt.system.Array[winrt.system.Char16]]: ...
    def array11_call(self, handler: typing.Optional[Array11Handler], /) -> None: ...
    def array12(self, a: winrt.system.Array[str], b: winrt.system.Array[str], /) -> typing.Tuple[winrt.system.Array[str], winrt.system.Array[str]]: ...
    def array12_call(self, handler: typing.Optional[Array12Handler], /) -> None: ...
    def array13(self, a: winrt.system.Array[Blittable], b: winrt.system.Array[Blittable], /) -> typing.Tuple[winrt.system.Array[Blittable], winrt.system.Array[Blittable]]: ...
    def array13_call(self, handler: typing.Optional[Array13Handler], /) -> None: ...
    def array14(self, a: winrt.system.Array[NonBlittable], b: winrt.system.Array[NonBlittable], /) -> typing.Tuple[winrt.system.Array[NonBlittable], winrt.system.Array[NonBlittable]]: ...
    def array14_call(self, handler: typing.Optional[Array14Handler], /) -> None: ...
    def array15(self, a: winrt.system.Array[Nested], b: winrt.system.Array[Nested], /) -> typing.Tuple[winrt.system.Array[Nested], winrt.system.Array[Nested]]: ...
    ...
    def array2(self, a: winrt.system.Array[winrt.system.UInt8], b: winrt.system.Array[winrt.system.UInt8], /) -> typing.Tuple[winrt.system.Array[winrt.system.UInt8], winrt.system.Array[winrt.system.UInt8]]: ...
    def array2_call(self, handler: typing.Optional[Array2Handler], /) -> None: ...
    def array3(self, a: winrt.system.Array[winrt.system.UInt16], b: winrt.system.Array[winrt.system.UInt16], /) -> typing.Tuple[winrt.system.Array[winrt.system.UInt16], winrt.system.Array[winrt.system.UInt16]]: ...
    def array3_call(self, handler: typing.Optional[Array3Handler], /) -> None: ...
    def array4(self, a: winrt.system.Array[winrt.system.UInt32], b: winrt.system.Array[winrt.system.UInt32], /) -> typing.Tuple[winrt.system.Array[winrt.system.UInt32], winrt.system.Array[winrt.system.UInt32]]: ...
    def array4_call(self, handler: typing.Optional[Array4Handler], /) -> None: ...
    def array5(self, a: winrt.system.Array[winrt.system.UInt64], b: winrt.system.Array[winrt.system.UInt64], /) -> typing.Tuple[winrt.system.Array[winrt.system.UInt64], winrt.system.Array[winrt.system.UInt64]]: ...
    def array5_call(self, handler: typing.Optional[Array5Handler], /) -> None: ...
    def array6(self, a: winrt.system.Array[winrt.system.Int16], b: winrt.system.Array[winrt.system.Int16], /) -> typing.Tuple[winrt.system.Array[winrt.system.Int16], winrt.system.Array[winrt.system.Int16]]: ...
    def array6_call(self, handler: typing.Optional[Array6Handler], /) -> None: ...
    def array7(self, a: winrt.system.Array[winrt.system.Int32], b: winrt.system.Array[winrt.system.Int32], /) -> typing.Tuple[winrt.system.Array[winrt.system.Int32], winrt.system.Array[winrt.system.Int32]]: ...
    def array7_call(self, handler: typing.Optional[Array7Handler], /) -> None: ...
    def array8(self, a: winrt.system.Array[winrt.system.Int64], b: winrt.system.Array[winrt.system.Int64], /) -> typing.Tuple[winrt.system.Array[winrt.system.Int64], winrt.system.Array[winrt.system.Int64]]: ...
    def array8_call(self, handler: typing.Optional[Array8Handler], /) -> None: ...
    def array9(self, a: winrt.system.Array[winrt.system.Single], b: winrt.system.Array[winrt.system.Single], /) -> typing.Tuple[winrt.system.Array[winrt.system.Single], winrt.system.Array[winrt.system.Single]]: ...
    ...
    def collection1(self, a: typing.Iterable[str], /) -> typing.Tuple[typing.Optional[windows_foundation_collections.IIterable[str]], typing.Optional[windows_foundation_collections.IIterable[str]]]: ...
    def collection1_call(self, handler: typing.Optional[Collection1Handler], /) -> None: ...
    def collection2(self, a: typing.Iterable[windows_foundation_collections.IKeyValuePair[str, str]], /) -> typing.Tuple[typing.Optional[windows_foundation_collections.IIterable[windows_foundation_collections.IKeyValuePair[str, str]]], typing.Optional[windows_foundation_collections.IIterable[windows_foundation_collections.IKeyValuePair[str, str]]]]: ...
    def collection2_call(self, handler: typing.Optional[Collection2Handler], /) -> None: ...
    def collection3(self, a: windows_foundation_collections.IMap[str, str], /) -> typing.Tuple[typing.Optional[windows_foundation_collections.IMap[str, str]], typing.Optional[windows_foundation_collections.IMap[str, str]]]: ...
    def collection3_call(self, handler: typing.Optional[Collection3Handler], /) -> None: ...
    def collection4(self, a: windows_foundation_collections.IMapView[str, str], /) -> typing.Tuple[typing.Optional[windows_foundation_collections.IMapView[str, str]], typing.Optional[windows_foundation_collections.IMapView[str, str]]]: ...
    def collection4_call(self, handler: typing.Optional[Collection4Handler], /) -> None: ...
    def collection5(self, a: windows_foundation_collections.IVector[str], /) -> typing.Tuple[typing.Optional[windows_foundation_collections.IVector[str]], typing.Optional[windows_foundation_collections.IVector[str]]]: ...
    def collection5_call(self, handler: typing.Optional[Collection5Handler], /) -> None: ...
    def collection6(self, a: windows_foundation_collections.IVectorView[str], /) -> typing.Tuple[typing.Optional[windows_foundation_collections.IVectorView[str]], typing.Optional[windows_foundation_collections.IVectorView[str]]]: ...
