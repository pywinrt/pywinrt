...
@typing.final
class Class(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> Class: ...
    def __new__(cls: typing.Type[Class]) -> Class: ...
...
@typing.final
class Composable(winrt.system.Object, metaclass=Composable_Static):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> Composable: ...
    @typing.overload
    def __new__(cls: typing.Type[Composable]) -> Composable: ...
    @typing.overload
    def __new__(cls: typing.Type[Composable], init: winrt.system.Int32) -> Composable: ...
...
class TestRunner_Static(type):
    ...
    def create_int32_vector(cls) -> windows_foundation_collections.IVector[winrt.system.Int32]: ...
    def create_string_vector(cls) -> windows_foundation_collections.IVector[str]: ...
    def create_stringable_vector(cls) -> windows_foundation_collections.IVector[windows_foundation.IStringable]: ...
...
@typing.final
class IRequiredFour(winrt.system.Object):
    @staticmethod
...
@typing.final
class IRequiredThree(winrt.system.Object):
    @staticmethod
...
@typing.final
class IRequiredTwo(winrt.system.Object):
    @staticmethod
...
class ITests(winrt.system.Object):
    ...
    def collection1(self, a: typing.Iterable[str], /) -> typing.Tuple[windows_foundation_collections.IIterable[str], windows_foundation_collections.IIterable[str]]: ...
    def collection1_call(self, handler: Collection1Handler, /) -> None: ...
    def collection2(self, a: typing.Iterable[windows_foundation_collections.IKeyValuePair[str, str]], /) -> typing.Tuple[windows_foundation_collections.IIterable[windows_foundation_collections.IKeyValuePair[str, str]], windows_foundation_collections.IIterable[windows_foundation_collections.IKeyValuePair[str, str]]]: ...
    def collection2_call(self, handler: Collection2Handler, /) -> None: ...
    def collection3(self, a: windows_foundation_collections.IMap[str, str], /) -> typing.Tuple[windows_foundation_collections.IMap[str, str], windows_foundation_collections.IMap[str, str]]: ...
    def collection3_call(self, handler: Collection3Handler, /) -> None: ...
    def collection4(self, a: windows_foundation_collections.IMapView[str, str], /) -> typing.Tuple[windows_foundation_collections.IMapView[str, str], windows_foundation_collections.IMapView[str, str]]: ...
    def collection4_call(self, handler: Collection4Handler, /) -> None: ...
    def collection5(self, a: windows_foundation_collections.IVector[str], /) -> typing.Tuple[windows_foundation_collections.IVector[str], windows_foundation_collections.IVector[str]]: ...
    def collection5_call(self, handler: Collection5Handler, /) -> None: ...
    def collection6(self, a: windows_foundation_collections.IVectorView[str], /) -> typing.Tuple[windows_foundation_collections.IVectorView[str], windows_foundation_collections.IVectorView[str]]: ...
    ...
    def get_blittable_vector_subset(self, blittable_vector: windows_foundation_collections.IVectorView[Blittable], start_index: winrt.system.Int32, /) -> windows_foundation_collections.IVectorView[Blittable]: ...
    def get_boolean_vector_subset(self, boolean_vector: windows_foundation_collections.IVectorView[bool], start_index: winrt.system.Int32, /) -> windows_foundation_collections.IVectorView[bool]: ...
    def get_class_vector_subset(self, class_vector: windows_foundation_collections.IVectorView[Class], start_index: winrt.system.Int32, /) -> windows_foundation_collections.IVectorView[Class]: ...
    def get_composable_class_vector_subset(self, class_vector: windows_foundation_collections.IVectorView[Composable], start_index: winrt.system.Int32, /) -> windows_foundation_collections.IVectorView[Composable]: ...
    def get_interface_vector_subset(self, interface_vector: windows_foundation_collections.IVectorView[IRequiredOne], start_index: winrt.system.Int32, /) -> windows_foundation_collections.IVectorView[IRequiredOne]: ...
    def get_non_blittable_vector_subset(self, non_blittable_vector: windows_foundation_collections.IVectorView[NonBlittable], start_index: winrt.system.Int32, /) -> windows_foundation_collections.IVectorView[NonBlittable]: ...
    def get_object_vector_subset(self, object_vector: windows_foundation_collections.IVectorView[winrt.system.Object], start_index: winrt.system.Int32, /) -> windows_foundation_collections.IVectorView[winrt.system.Object]: ...
    def get_string_vector_subset(self, string_vector: windows_foundation_collections.IVectorView[str], start_index: winrt.system.Int32, /) -> windows_foundation_collections.IVectorView[str]: ...
