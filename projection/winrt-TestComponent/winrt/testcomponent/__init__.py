...
Collection2Handler = typing.Callable[[typing.Iterable["windows_foundation_collections.ImplementsIKeyValuePair[str, str]"]], typing.Tuple[typing.Iterable["windows_foundation_collections.IKeyValuePair[str, str]"], typing.Iterable["windows_foundation_collections.IKeyValuePair[str, str]"]]]
