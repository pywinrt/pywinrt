...
WINRT_EXPORT namespace winrt::TestComponent
{
    ...
    template <typename O, typename M> Array10Handler::Array10Handler(weak_ref<O>&& object, M method) :
        Array10Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array11Handler::Array11Handler(weak_ref<O>&& object, M method) :
        Array11Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array12Handler::Array12Handler(weak_ref<O>&& object, M method) :
        Array12Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array13Handler::Array13Handler(weak_ref<O>&& object, M method) :
        Array13Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array14Handler::Array14Handler(weak_ref<O>&& object, M method) :
        Array14Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array15Handler::Array15Handler(weak_ref<O>&& object, M method) :
        Array15Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array1Handler::Array1Handler(weak_ref<O>&& object, M method) :
        Array1Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array2Handler::Array2Handler(weak_ref<O>&& object, M method) :
        Array2Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array3Handler::Array3Handler(weak_ref<O>&& object, M method) :
        Array3Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array4Handler::Array4Handler(weak_ref<O>&& object, M method) :
        Array4Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array5Handler::Array5Handler(weak_ref<O>&& object, M method) :
        Array5Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array6Handler::Array6Handler(weak_ref<O>&& object, M method) :
        Array6Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array7Handler::Array7Handler(weak_ref<O>&& object, M method) :
        Array7Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array8Handler::Array8Handler(weak_ref<O>&& object, M method) :
        Array8Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Array9Handler::Array9Handler(weak_ref<O>&& object, M method) :
        Array9Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Async1Handler::Async1Handler(weak_ref<O>&& object, M method) :
        Async1Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Async2Handler::Async2Handler(weak_ref<O>&& object, M method) :
        Async2Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Async3Handler::Async3Handler(weak_ref<O>&& object, M method) :
        Async3Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Async4Handler::Async4Handler(weak_ref<O>&& object, M method) :
        Async4Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Collection1Handler::Collection1Handler(weak_ref<O>&& object, M method) :
        Collection1Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Collection2Handler::Collection2Handler(weak_ref<O>&& object, M method) :
        Collection2Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Collection3Handler::Collection3Handler(weak_ref<O>&& object, M method) :
        Collection3Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Collection4Handler::Collection4Handler(weak_ref<O>&& object, M method) :
        Collection4Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Collection5Handler::Collection5Handler(weak_ref<O>&& object, M method) :
        Collection5Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Collection6Handler::Collection6Handler(weak_ref<O>&& object, M method) :
        Collection6Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param10Handler::Param10Handler(weak_ref<O>&& object, M method) :
        Param10Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param11Handler::Param11Handler(weak_ref<O>&& object, M method) :
        Param11Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param12Handler::Param12Handler(weak_ref<O>&& object, M method) :
        Param12Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param13Handler::Param13Handler(weak_ref<O>&& object, M method) :
        Param13Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param14Handler::Param14Handler(weak_ref<O>&& object, M method) :
        Param14Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param15Handler::Param15Handler(weak_ref<O>&& object, M method) :
        Param15Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param1Handler::Param1Handler(weak_ref<O>&& object, M method) :
        Param1Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param2Handler::Param2Handler(weak_ref<O>&& object, M method) :
        Param2Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param3Handler::Param3Handler(weak_ref<O>&& object, M method) :
        Param3Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param4Handler::Param4Handler(weak_ref<O>&& object, M method) :
        Param4Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param5Handler::Param5Handler(weak_ref<O>&& object, M method) :
        Param5Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param6Handler::Param6Handler(weak_ref<O>&& object, M method) :
        Param6Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param7Handler::Param7Handler(weak_ref<O>&& object, M method) :
        Param7Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param8Handler::Param8Handler(weak_ref<O>&& object, M method) :
        Param8Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> Param9Handler::Param9Handler(weak_ref<O>&& object, M method) :
        Param9Handler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
    ...
    template <typename O, typename M> TestHandler::TestHandler(weak_ref<O>&& object, M method) :
        TestHandler([o = std::move(object), method](auto&&... args) { if (auto s = o.get()) { ((*s).*(method))(args...); } })
    {
    }
