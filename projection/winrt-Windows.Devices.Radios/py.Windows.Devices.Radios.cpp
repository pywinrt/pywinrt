...
PyMODINIT_FUNC PyInit__winrt_Windows_Devices_Radios(void) noexcept
{
    ...
    if (py::register_python_type(module.get(), type_name_Radio, &type_spec_Radio, nullptr, object_bases.get(), nullptr) == -1)
    #else
    if (py::register_python_type(module.get(), type_name_Radio, &type_spec_Radio, object_bases.get(), nullptr) == -1)
    #endif
    {
        return nullptr;
    }
