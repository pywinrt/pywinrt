...
class XboxLiveDeviceAddress_Static(type):
    ...
    def create_from_snapshot_buffer(cls, buffer: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[XboxLiveDeviceAddress]: ...
    def create_from_snapshot_bytes(cls, buffer: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> typing.Optional[XboxLiveDeviceAddress]: ...
...
class XboxLiveDeviceAddress(winrt.system.Object, metaclass=XboxLiveDeviceAddress_Static):
    ...
    def get_snapshot_as_buffer(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
...
class XboxLiveEndpointPair_Static(type):
    def find_endpoint_pair_by_host_names_and_ports(cls, local_host_name: typing.Optional[windows_networking.HostName], local_port: str, remote_host_name: typing.Optional[windows_networking.HostName], remote_port: str, /) -> typing.Optional[XboxLiveEndpointPair]: ...
    def find_endpoint_pair_by_socket_address_bytes(cls, local_socket_address: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], remote_socket_address: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> typing.Optional[XboxLiveEndpointPair]: ...
...
class XboxLiveEndpointPair(winrt.system.Object, metaclass=XboxLiveEndpointPair_Static):
    ...
    @_property
    def local_host_name(self) -> typing.Optional[windows_networking.HostName]: ...
    @_property
...
class XboxLiveEndpointPairTemplate_Static(type):
    ...
    @_property
    def templates(cls) -> typing.Optional[windows_foundation_collections.IVectorView[XboxLiveEndpointPairTemplate]]: ...
...
class XboxLiveEndpointPairTemplate(winrt.system.Object, metaclass=XboxLiveEndpointPairTemplate_Static):
    ...
    def create_endpoint_pair_default_async(self, device_address: typing.Optional[XboxLiveDeviceAddress], /) -> windows_foundation.IAsyncOperation[XboxLiveEndpointPairCreationResult]: ...
    def create_endpoint_pair_for_ports_default_async(self, device_address: typing.Optional[XboxLiveDeviceAddress], initiator_port: str, acceptor_port: str, /) -> windows_foundation.IAsyncOperation[XboxLiveEndpointPairCreationResult]: ...
    def create_endpoint_pair_for_ports_with_behaviors_async(self, device_address: typing.Optional[XboxLiveDeviceAddress], initiator_port: str, acceptor_port: str, behaviors: XboxLiveEndpointPairCreationBehaviors, /) -> windows_foundation.IAsyncOperation[XboxLiveEndpointPairCreationResult]: ...
    def create_endpoint_pair_with_behaviors_async(self, device_address: typing.Optional[XboxLiveDeviceAddress], behaviors: XboxLiveEndpointPairCreationBehaviors, /) -> windows_foundation.IAsyncOperation[XboxLiveEndpointPairCreationResult]: ...
    ...
    @_property
    def endpoint_pairs(self) -> typing.Optional[windows_foundation_collections.IVectorView[XboxLiveEndpointPair]]: ...
    @_property
...
class XboxLiveQualityOfServiceMeasurement_Static(type):
    ...
    @_property
    def published_private_payload(cls) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @published_private_payload.setter
    def published_private_payload(cls, value: typing.Optional[windows_storage_streams.IBuffer]) -> None: ...
    @_property
...
class XboxLiveQualityOfServiceMeasurement(winrt.system.Object, metaclass=XboxLiveQualityOfServiceMeasurement_Static):
    ...
    def get_metric_results_for_device(self, device_address: typing.Optional[XboxLiveDeviceAddress], /) -> typing.Optional[windows_foundation_collections.IVectorView[XboxLiveQualityOfServiceMetricResult]]: ...
    def get_metric_results_for_metric(self, metric: XboxLiveQualityOfServiceMetric, /) -> typing.Optional[windows_foundation_collections.IVectorView[XboxLiveQualityOfServiceMetricResult]]: ...
    ...
    @_property
    def device_addresses(self) -> typing.Optional[windows_foundation_collections.IVector[XboxLiveDeviceAddress]]: ...
    @_property
    def metric_results(self) -> typing.Optional[windows_foundation_collections.IVectorView[XboxLiveQualityOfServiceMetricResult]]: ...
    @_property
    def metrics(self) -> typing.Optional[windows_foundation_collections.IVector[XboxLiveQualityOfServiceMetric]]: ...
    @_property
    def number_of_results_pending(self) -> winrt.system.UInt32: ...
    @_property
    def private_payload_results(self) -> typing.Optional[windows_foundation_collections.IVectorView[XboxLiveQualityOfServicePrivatePayloadResult]]: ...
