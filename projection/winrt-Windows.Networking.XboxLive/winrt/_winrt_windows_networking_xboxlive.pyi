...
class XboxLiveEndpointPairTemplate_Static(type):
    ...
    @_property
    def templates(cls) -> windows_foundation_collections.IVectorView[XboxLiveEndpointPairTemplate]: ...
...
class XboxLiveEndpointPairTemplate(winrt.system.Object, metaclass=XboxLiveEndpointPairTemplate_Static):
    ...
    @_property
    def endpoint_pairs(self) -> windows_foundation_collections.IVectorView[XboxLiveEndpointPair]: ...
    @_property
...
class XboxLiveQualityOfServiceMeasurement(winrt.system.Object, metaclass=XboxLiveQualityOfServiceMeasurement_Static):
    ...
    def get_metric_results_for_device(self, device_address: XboxLiveDeviceAddress, /) -> windows_foundation_collections.IVectorView[XboxLiveQualityOfServiceMetricResult]: ...
    def get_metric_results_for_metric(self, metric: XboxLiveQualityOfServiceMetric, /) -> windows_foundation_collections.IVectorView[XboxLiveQualityOfServiceMetricResult]: ...
    ...
    @_property
    def device_addresses(self) -> windows_foundation_collections.IVector[XboxLiveDeviceAddress]: ...
    @_property
    def metric_results(self) -> windows_foundation_collections.IVectorView[XboxLiveQualityOfServiceMetricResult]: ...
    @_property
    def metrics(self) -> windows_foundation_collections.IVector[XboxLiveQualityOfServiceMetric]: ...
    @_property
    def number_of_results_pending(self) -> winrt.system.UInt32: ...
    @_property
    def private_payload_results(self) -> windows_foundation_collections.IVectorView[XboxLiveQualityOfServicePrivatePayloadResult]: ...
