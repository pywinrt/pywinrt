...
PyMODINIT_FUNC PyInit__winrt_windows_system_preview(void) noexcept
{
    ...
    py::pyobj_handle TwoPanelHingedDevicePosturePreview_type{py::register_python_type(module.get(), &type_spec_TwoPanelHingedDevicePosturePreview, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_TwoPanelHingedDevicePosturePreview_Static.get()))};
    if (!TwoPanelHingedDevicePosturePreview_type)
    {
        return nullptr;
    }

    py::pyobj_handle TwoPanelHingedDevicePosturePreviewReading_type{py::register_python_type(module.get(), &type_spec_TwoPanelHingedDevicePosturePreviewReading, object_bases.get(), nullptr)};
    if (!TwoPanelHingedDevicePosturePreviewReading_type)
    {
        return nullptr;
    }

    py::pyobj_handle TwoPanelHingedDevicePosturePreviewReadingChangedEventArgs_type{py::register_python_type(module.get(), &type_spec_TwoPanelHingedDevicePosturePreviewReadingChangedEventArgs, object_bases.get(), nullptr)};
