...
namespace py::cpp::Windows::Devices::Power
{
    ...
    static PyGetSetDef getset_Battery_Meta[] = {
        { "aggregate_battery", reinterpret_cast<getter>(Battery_get_AggregateBattery), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_Battery_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_Battery_Meta) },
        { }
    };
...
PyMODINIT_FUNC PyInit__winrt_Windows_Devices_Power(void) noexcept
{
    ...
    py::pyobj_handle type_Battery_Meta{PyType_FromSpec(&type_spec_Battery_Meta)};
    if (!type_Battery_Meta)
    {
        return nullptr;
    }

    state->type_Battery = py::register_python_type(module.get(), type_name_Battery, &type_spec_Battery, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_Battery_Meta.get()));
    if (!state->type_Battery)
    {
        return nullptr;
    }

    state->type_BatteryReport = py::register_python_type(module.get(), type_name_BatteryReport, &type_spec_BatteryReport, object_bases.get(), nullptr);
