...
PyMODINIT_FUNC PyInit__winrt_windows_system_power_diagnostics(void) noexcept
{
    ...
    py::pyobj_handle BackgroundEnergyDiagnostics_type{py::register_python_type(module.get(), &type_spec_BackgroundEnergyDiagnostics, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_BackgroundEnergyDiagnostics_Static.get()))};
    ...
    py::pyobj_handle ForegroundEnergyDiagnostics_type{py::register_python_type(module.get(), &type_spec_ForegroundEnergyDiagnostics, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_ForegroundEnergyDiagnostics_Static.get()))};
