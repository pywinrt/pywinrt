...
namespace winrt::impl
{
    ...
    template <> inline constexpr auto& name_v<winrt::Windows::UI::Core::Preview::Communications::PreviewCommunicationsContract> = L"Windows.UI.Core.Preview.Communications.PreviewCommunicationsContract";
