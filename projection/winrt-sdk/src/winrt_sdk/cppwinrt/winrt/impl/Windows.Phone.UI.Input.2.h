...
{
    struct WINRT_IMPL_EMPTY_BASES BackPressedEventArgs : winrt::Windows::Phone::UI::Input::IBackPressedEventArgs
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES CameraEventArgs : winrt::Windows::Phone::UI::Input::ICameraEventArgs
    {
