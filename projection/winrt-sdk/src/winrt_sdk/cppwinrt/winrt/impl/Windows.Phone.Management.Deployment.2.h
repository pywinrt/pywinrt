...
{
    struct WINRT_IMPL_EMPTY_BASES Enterprise : winrt::Windows::Phone::Management::Deployment::IEnterprise
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES EnterpriseEnrollmentResult : winrt::Windows::Phone::Management::Deployment::IEnterpriseEnrollmentResult
    {
    ...
    struct WINRT_IMPL_EMPTY_BASES PackageInstallResult : winrt::Windows::Phone::Management::Deployment::IPackageInstallResult,
