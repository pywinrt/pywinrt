...
class SpatialHoldStartedEventArgs(winrt.system.Object):
    ...
    def try_get_pointer_pose(self, coordinate_system: windows_perception_spatial.SpatialCoordinateSystem, /) -> SpatialPointerPose: ...
    @_property
    def interaction_source_kind(self) -> SpatialInteractionSourceKind: ...
...
class SpatialInteractionController(winrt.system.Object):
    ...
    def try_get_battery_report(self) -> windows_devices_power.BatteryReport: ...
...
class SpatialInteractionManager(winrt.system.Object, metaclass=SpatialInteractionManager_Static):
    ...
    def get_detected_sources_at_timestamp(self, time_stamp: windows_perception.PerceptionTimestamp, /) -> windows_foundation_collections.IVectorView[SpatialInteractionSourceState]: ...
...
class SpatialInteractionSource(winrt.system.Object):
    ...
    def try_create_hand_mesh_observer(self) -> windows_perception_people.HandMeshObserver: ...
    ...
    def try_get_state_at_timestamp(self, timestamp: windows_perception.PerceptionTimestamp, /) -> SpatialInteractionSourceState: ...
    @_property
...
class SpatialInteractionSourceProperties(winrt.system.Object):
    ...
    def try_get_location(self, coordinate_system: windows_perception_spatial.SpatialCoordinateSystem, /) -> SpatialInteractionSourceLocation: ...
...
class SpatialInteractionSourceState(winrt.system.Object):
    ...
    def try_get_hand_pose(self) -> windows_perception_people.HandPose: ...
    def try_get_pointer_pose(self, coordinate_system: windows_perception_spatial.SpatialCoordinateSystem, /) -> SpatialPointerPose: ...
    @_property
...
class SpatialManipulationCompletedEventArgs(winrt.system.Object):
    ...
    def try_get_cumulative_delta(self, coordinate_system: windows_perception_spatial.SpatialCoordinateSystem, /) -> SpatialManipulationDelta: ...
    @_property
    def interaction_source_kind(self) -> SpatialInteractionSourceKind: ...
...
class SpatialPointerPose_Static(type):
    def try_get_at_timestamp(cls, coordinate_system: windows_perception_spatial.SpatialCoordinateSystem, timestamp: windows_perception.PerceptionTimestamp, /) -> SpatialPointerPose: ...
