...
namespace py::cpp::Windows::Media::Protection::PlayReady
{
    struct module_state
    {
        PyObject* type_NDCertificateFeature;
        PyObject* type_NDCertificatePlatformID;
        PyObject* type_NDCertificateType;
        PyObject* type_NDClosedCaptionFormat;
        PyObject* type_NDContentIDType;
        PyObject* type_NDMediaStreamType;
        PyObject* type_NDProximityDetectionType;
        PyObject* type_NDStartAsyncOptions;
        PyObject* type_PlayReadyDecryptorSetup;
        PyObject* type_PlayReadyEncryptionAlgorithm;
        PyObject* type_PlayReadyHardwareDRMFeatures;
        PyObject* type_PlayReadyITADataFormat;
    ...
    static PyObject* register_NDCertificateFeature(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_NDCertificateFeature)
        {
        ...
        state->type_NDCertificateFeature = type;
        Py_INCREF(state->type_NDCertificateFeature);


        Py_RETURN_NONE;
    }

    static PyObject* register_NDCertificatePlatformID(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_NDCertificatePlatformID)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_NDCertificatePlatformID = type;
        Py_INCREF(state->type_NDCertificatePlatformID);


        Py_RETURN_NONE;
    }

    static PyObject* register_NDCertificateType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_NDCertificateType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_NDCertificateType = type;
        Py_INCREF(state->type_NDCertificateType);


        Py_RETURN_NONE;
    }

    static PyObject* register_NDClosedCaptionFormat(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_NDClosedCaptionFormat)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_NDClosedCaptionFormat = type;
        Py_INCREF(state->type_NDClosedCaptionFormat);


        Py_RETURN_NONE;
    }

    static PyObject* register_NDContentIDType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_NDContentIDType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_NDContentIDType = type;
        Py_INCREF(state->type_NDContentIDType);


        Py_RETURN_NONE;
    }

    static PyObject* register_NDMediaStreamType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_NDMediaStreamType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_NDMediaStreamType = type;
        Py_INCREF(state->type_NDMediaStreamType);


        Py_RETURN_NONE;
    }

    static PyObject* register_NDProximityDetectionType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_NDProximityDetectionType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_NDProximityDetectionType = type;
        Py_INCREF(state->type_NDProximityDetectionType);


        Py_RETURN_NONE;
    }

    static PyObject* register_NDStartAsyncOptions(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_NDStartAsyncOptions)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_NDStartAsyncOptions = type;
        Py_INCREF(state->type_NDStartAsyncOptions);


        Py_RETURN_NONE;
    }

    static PyObject* register_PlayReadyDecryptorSetup(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PlayReadyDecryptorSetup)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PlayReadyDecryptorSetup = type;
        Py_INCREF(state->type_PlayReadyDecryptorSetup);


        Py_RETURN_NONE;
    }

    static PyObject* register_PlayReadyEncryptionAlgorithm(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PlayReadyEncryptionAlgorithm)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PlayReadyEncryptionAlgorithm = type;
        Py_INCREF(state->type_PlayReadyEncryptionAlgorithm);


        Py_RETURN_NONE;
    }

    static PyObject* register_PlayReadyHardwareDRMFeatures(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PlayReadyHardwareDRMFeatures)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PlayReadyHardwareDRMFeatures = type;
        Py_INCREF(state->type_PlayReadyHardwareDRMFeatures);


        Py_RETURN_NONE;
    }

    static PyObject* register_PlayReadyITADataFormat(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PlayReadyITADataFormat)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PlayReadyITADataFormat = type;
        Py_INCREF(state->type_PlayReadyITADataFormat);
    ...
    {
        "_winrt_Windows_Media_Protection_PlayReady.PlayReadyStatics_Meta",
    ...
    static PyMethodDef module_methods[] = {
        {"_register_NDCertificateFeature", register_NDCertificateFeature, METH_O, "registers type"},
        {"_register_NDCertificatePlatformID", register_NDCertificatePlatformID, METH_O, "registers type"},
        {"_register_NDCertificateType", register_NDCertificateType, METH_O, "registers type"},
        {"_register_NDClosedCaptionFormat", register_NDClosedCaptionFormat, METH_O, "registers type"},
        {"_register_NDContentIDType", register_NDContentIDType, METH_O, "registers type"},
        {"_register_NDMediaStreamType", register_NDMediaStreamType, METH_O, "registers type"},
        {"_register_NDProximityDetectionType", register_NDProximityDetectionType, METH_O, "registers type"},
        {"_register_NDStartAsyncOptions", register_NDStartAsyncOptions, METH_O, "registers type"},
        {"_register_PlayReadyDecryptorSetup", register_PlayReadyDecryptorSetup, METH_O, "registers type"},
        {"_register_PlayReadyEncryptionAlgorithm", register_PlayReadyEncryptionAlgorithm, METH_O, "registers type"},
        {"_register_PlayReadyHardwareDRMFeatures", register_PlayReadyHardwareDRMFeatures, METH_O, "registers type"},
        {"_register_PlayReadyITADataFormat", register_PlayReadyITADataFormat, METH_O, "registers type"},
        {}};
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_NDCertificateFeature);
        Py_VISIT(state->type_NDCertificatePlatformID);
        Py_VISIT(state->type_NDCertificateType);
        Py_VISIT(state->type_NDClosedCaptionFormat);
        Py_VISIT(state->type_NDContentIDType);
        Py_VISIT(state->type_NDMediaStreamType);
        Py_VISIT(state->type_NDProximityDetectionType);
        Py_VISIT(state->type_NDStartAsyncOptions);
        Py_VISIT(state->type_PlayReadyDecryptorSetup);
        Py_VISIT(state->type_PlayReadyEncryptionAlgorithm);
        Py_VISIT(state->type_PlayReadyHardwareDRMFeatures);
        Py_VISIT(state->type_PlayReadyITADataFormat);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_NDCertificateFeature);
        Py_CLEAR(state->type_NDCertificatePlatformID);
        Py_CLEAR(state->type_NDCertificateType);
        Py_CLEAR(state->type_NDClosedCaptionFormat);
        Py_CLEAR(state->type_NDContentIDType);
        Py_CLEAR(state->type_NDMediaStreamType);
        Py_CLEAR(state->type_NDProximityDetectionType);
        Py_CLEAR(state->type_NDStartAsyncOptions);
        Py_CLEAR(state->type_PlayReadyDecryptorSetup);
        Py_CLEAR(state->type_PlayReadyEncryptionAlgorithm);
        Py_CLEAR(state->type_PlayReadyHardwareDRMFeatures);
        Py_CLEAR(state->type_PlayReadyITADataFormat);
...
PyObject* py::py_type<winrt::Windows::Media::Protection::PlayReady::NDCertificateFeature>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Protection::PlayReady;
    ...
    auto python_type = state->type_NDCertificateFeature;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Protection::PlayReady::NDCertificateFeature is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Protection::PlayReady::NDCertificatePlatformID>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Protection::PlayReady;
    ...
    auto python_type = state->type_NDCertificatePlatformID;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Protection::PlayReady::NDCertificatePlatformID is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Protection::PlayReady::NDCertificateType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Protection::PlayReady;
    ...
    auto python_type = state->type_NDCertificateType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Protection::PlayReady::NDCertificateType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Protection::PlayReady::NDClosedCaptionFormat>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Protection::PlayReady;
    ...
    auto python_type = state->type_NDClosedCaptionFormat;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Protection::PlayReady::NDClosedCaptionFormat is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Protection::PlayReady::NDContentIDType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Protection::PlayReady;
    ...
    auto python_type = state->type_NDContentIDType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Protection::PlayReady::NDContentIDType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Protection::PlayReady::NDMediaStreamType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Protection::PlayReady;
    ...
    auto python_type = state->type_NDMediaStreamType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Protection::PlayReady::NDMediaStreamType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Protection::PlayReady::NDProximityDetectionType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Protection::PlayReady;
    ...
    auto python_type = state->type_NDProximityDetectionType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Protection::PlayReady::NDProximityDetectionType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Protection::PlayReady::NDStartAsyncOptions>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Protection::PlayReady;
    ...
    auto python_type = state->type_NDStartAsyncOptions;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Protection::PlayReady::NDStartAsyncOptions is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Protection::PlayReady::PlayReadyDecryptorSetup>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Protection::PlayReady;
    ...
    auto python_type = state->type_PlayReadyDecryptorSetup;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Protection::PlayReady::PlayReadyDecryptorSetup is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Protection::PlayReady::PlayReadyEncryptionAlgorithm>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Protection::PlayReady;
    ...
    auto python_type = state->type_PlayReadyEncryptionAlgorithm;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Protection::PlayReady::PlayReadyEncryptionAlgorithm is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Protection::PlayReady::PlayReadyHardwareDRMFeatures>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Protection::PlayReady;
    ...
    auto python_type = state->type_PlayReadyHardwareDRMFeatures;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Protection::PlayReady::PlayReadyHardwareDRMFeatures is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Protection::PlayReady::PlayReadyITADataFormat>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Protection::PlayReady;
    ...
    auto python_type = state->type_PlayReadyITADataFormat;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Protection::PlayReady::PlayReadyITADataFormat is not registered");
        return nullptr;
    }
