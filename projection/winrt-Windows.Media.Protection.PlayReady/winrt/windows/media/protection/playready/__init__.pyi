...
class NDStreamParserNotifier(winrt.system.Object):
    ...
    def on_begin_setup_decryptor(self, descriptor: typing.Optional[winrt.windows.media.core.IMediaStreamDescriptor], key_i_d: winrt.system.Guid, pro_bytes: winrt.system.Array[winrt.system.UInt8], /) -> None: ...
    def on_content_i_d_received(self, license_fetch_descriptor: typing.Optional[INDLicenseFetchDescriptor], /) -> None: ...
...
class PlayReadyContentHeader(winrt.system.Object):
    ...
    key_id_strings: str
    key_ids: winrt.system.Guid
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> PlayReadyContentHeader: ...
    @typing.overload
    def __new__(cls: typing.Type[PlayReadyContentHeader], dw_flags: winrt.system.UInt32, content_key_ids: winrt.system.Array[winrt.system.Guid], content_key_id_strings: winrt.system.Array[str], content_encryption_algorithm: PlayReadyEncryptionAlgorithm, license_acquisition_url: typing.Optional[winrt.windows.foundation.Uri], license_acquisition_user_interface_url: typing.Optional[winrt.windows.foundation.Uri], custom_attributes: str, domain_service_id: winrt.system.Guid) -> PlayReadyContentHeader:...
    @typing.overload
    ...
    @typing.overload
    def __new__(cls: typing.Type[PlayReadyContentHeader], content_key_id: winrt.system.Guid, content_key_id_string: str, content_encryption_algorithm: PlayReadyEncryptionAlgorithm, license_acquisition_url: typing.Optional[winrt.windows.foundation.Uri], license_acquisition_user_interface_url: typing.Optional[winrt.windows.foundation.Uri], custom_attributes: str, domain_service_id: winrt.system.Guid) -> PlayReadyContentHeader:...
    @typing.overload
...
class PlayReadyDomainIterable(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[PlayReadyDomainIterable], domain_account_id: winrt.system.Guid) -> PlayReadyDomainIterable:...
...
class PlayReadyDomainJoinServiceRequest(winrt.system.Object):
    ...
    domain_account_id: winrt.system.Guid
...
class PlayReadyITADataGenerator(winrt.system.Object):
    ...
    def generate_data(self, guid_c_p_system_id: winrt.system.Guid, count_of_streams: winrt.system.UInt32, configuration: typing.Optional[winrt.windows.foundation.collections.IPropertySet], format: PlayReadyITADataFormat, /) -> winrt.system.UInt8: ...
...
class PlayReadyLicense(winrt.system.Object):
    ...
    domain_account_i_d: winrt.system.Guid
    expiration_date: typing.Optional[typing.Optional[datetime.datetime]]
    expire_after_first_play: winrt.system.UInt32
    fully_evaluated: winrt.system.Boolean
    usable_for_play: winrt.system.Boolean
    expires_in_real_time: winrt.system.Boolean
    in_memory_only: winrt.system.Boolean
    secure_stop_id: winrt.system.Guid
    security_level: winrt.system.UInt32
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> PlayReadyLicense: ...
    def get_k_i_d_at_chain_depth(self, chain_depth: winrt.system.UInt32, /) -> winrt.system.Guid: ...
...
class PlayReadyLicenseAcquisitionServiceRequest(winrt.system.Object):
    ...
    def begin_service_request(self) -> winrt.windows.foundation.IAsyncAction: ...
    def create_license_iterable(self, content_header: typing.Optional[PlayReadyContentHeader], fully_evaluated: winrt.system.Boolean, /) -> typing.Optional[PlayReadyLicenseIterable]: ...
    def generate_manual_enabling_challenge(self) -> typing.Optional[PlayReadySoapMessage]: ...
    def next_service_request(self) -> typing.Optional[IPlayReadyServiceRequest]: ...
    def process_manual_enabling_response(self, response_bytes: winrt.system.Array[winrt.system.UInt8], /) -> winrt.windows.foundation.HResult: ...
...
class PlayReadyLicenseIterable(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[PlayReadyLicenseIterable], content_header: typing.Optional[PlayReadyContentHeader], fully_evaluated: winrt.system.Boolean) -> PlayReadyLicenseIterable:...
...
class PlayReadySecureStopServiceRequest(winrt.system.Object):
    ...
    session_i_d: winrt.system.Guid
    start_time: datetime.datetime
    stopped: winrt.system.Boolean
    ...
    @typing.overload
    def __new__(cls: typing.Type[PlayReadySecureStopServiceRequest], session_i_d: winrt.system.Guid, publisher_cert_bytes: winrt.system.Array[winrt.system.UInt8]) -> PlayReadySecureStopServiceRequest:...
    def begin_service_request(self) -> winrt.windows.foundation.IAsyncAction: ...
    def generate_manual_enabling_challenge(self) -> typing.Optional[PlayReadySoapMessage]: ...
    def next_service_request(self) -> typing.Optional[IPlayReadyServiceRequest]: ...
    def process_manual_enabling_response(self, response_bytes: winrt.system.Array[winrt.system.UInt8], /) -> winrt.windows.foundation.HResult: ...
...
class PlayReadyStatics(winrt.system.Object):
    domain_join_service_request_type: typing.ClassVar[winrt.system.Guid]
    domain_leave_service_request_type: typing.ClassVar[winrt.system.Guid]
    individualization_service_request_type: typing.ClassVar[winrt.system.Guid]
    license_acquirer_service_request_type: typing.ClassVar[winrt.system.Guid]
    media_protection_system_id: typing.ClassVar[winrt.system.Guid]
    metering_report_service_request_type: typing.ClassVar[winrt.system.Guid]
    play_ready_security_version: typing.ClassVar[winrt.system.UInt32]
    revocation_service_request_type: typing.ClassVar[winrt.system.Guid]
    play_ready_certificate_security_level: typing.ClassVar[winrt.system.UInt32]
    secure_stop_service_request_type: typing.ClassVar[winrt.system.Guid]
    protection_system_id: typing.ClassVar[winrt.system.Guid]
    ...
    @staticmethod
    def check_supported_hardware(hwdrm_feature: PlayReadyHardwareDRMFeatures, /) -> winrt.system.Boolean: ...
    @staticmethod
...
class INDRegistrationCompletedEventArgs(winrt.system.Object):
    response_custom_data: typing.Optional[INDCustomData]
    transmitter_certificate_accepted: winrt.system.Boolean
