...
class NDClient(winrt.system.Object):
    ...
    def close(self) -> None: ...
    def license_fetch_async(self, license_fetch_descriptor: typing.Optional[INDLicenseFetchDescriptor], /) -> windows_foundation.IAsyncOperation[INDLicenseFetchResult]: ...
    def re_registration_async(self, registration_custom_data: typing.Optional[INDCustomData], /) -> windows_foundation.IAsyncAction: ...
    def start_async(self, content_url: typing.Optional[windows_foundation.Uri], start_async_options: winrt.system.UInt32, registration_custom_data: typing.Optional[INDCustomData], license_fetch_descriptor: typing.Optional[INDLicenseFetchDescriptor], /) -> windows_foundation.IAsyncOperation[INDStartResult]: ...
...
class NDCustomData(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[NDCustomData], custom_data_type_i_d_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], custom_data_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer]) -> NDCustomData: ...
    @_property
...
class NDLicenseFetchDescriptor(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[NDLicenseFetchDescriptor], content_i_d_type: NDContentIDType, content_i_d_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], license_fetch_challenge_custom_data: typing.Optional[INDCustomData]) -> NDLicenseFetchDescriptor: ...
    @_property
...
class NDStorageFileHelper(winrt.system.Object):
    ...
    def get_file_u_r_ls(self, file: typing.Optional[windows_storage.IStorageFile], /) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class NDStreamParserNotifier(winrt.system.Object):
    ...
    def on_begin_setup_decryptor(self, descriptor: typing.Optional[windows_media_core.IMediaStreamDescriptor], key_i_d: _uuid.UUID, pro_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> None: ...
    def on_content_i_d_received(self, license_fetch_descriptor: typing.Optional[INDLicenseFetchDescriptor], /) -> None: ...
    def on_media_stream_descriptor_created(self, audio_stream_descriptors: windows_foundation_collections.IVector[windows_media_core.AudioStreamDescriptor], video_stream_descriptors: windows_foundation_collections.IVector[windows_media_core.VideoStreamDescriptor], /) -> None: ...
    def on_sample_parsed(self, stream_i_d: winrt.system.UInt32, stream_type: NDMediaStreamType, stream_sample: typing.Optional[windows_media_core.MediaStreamSample], pts: winrt.system.Int64, cc_format: NDClosedCaptionFormat, cc_data_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> None: ...
...
class NDTCPMessenger(winrt.system.Object):
    ...
    def send_license_fetch_request_async(self, session_i_d_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], challenge_data_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> windows_foundation.IAsyncOperation[INDSendResult]: ...
    def send_proximity_detection_response_async(self, pd_type: NDProximityDetectionType, transmitter_channel_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], session_i_d_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], response_data_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> windows_foundation.IAsyncOperation[INDSendResult]: ...
    ...
    def send_registration_request_async(self, session_i_d_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], challenge_data_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> windows_foundation.IAsyncOperation[INDSendResult]: ...
...
class PlayReadyContentHeader(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[PlayReadyContentHeader], dw_flags: winrt.system.UInt32, content_key_ids: typing.Union[winrt.system.Array[_uuid.UUID], winrt.system.ReadableBuffer], content_key_id_strings: typing.Union[winrt.system.Array[str], winrt.system.ReadableBuffer], content_encryption_algorithm: PlayReadyEncryptionAlgorithm, license_acquisition_url: typing.Optional[windows_foundation.Uri], license_acquisition_user_interface_url: typing.Optional[windows_foundation.Uri], custom_attributes: str, domain_service_id: _uuid.UUID) -> PlayReadyContentHeader: ...
    @typing.overload
    def __new__(cls: typing.Type[PlayReadyContentHeader], header_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], license_acquisition_url: typing.Optional[windows_foundation.Uri], license_acquisition_user_interface_url: typing.Optional[windows_foundation.Uri], custom_attributes: str, domain_service_id: _uuid.UUID) -> PlayReadyContentHeader: ...
    @typing.overload
    def __new__(cls: typing.Type[PlayReadyContentHeader], content_key_id: _uuid.UUID, content_key_id_string: str, content_encryption_algorithm: PlayReadyEncryptionAlgorithm, license_acquisition_url: typing.Optional[windows_foundation.Uri], license_acquisition_user_interface_url: typing.Optional[windows_foundation.Uri], custom_attributes: str, domain_service_id: _uuid.UUID) -> PlayReadyContentHeader: ...
    @typing.overload
    ...
    @_property
    def license_acquisition_url(self) -> typing.Optional[windows_foundation.Uri]: ...
    @_property
    def license_acquisition_user_interface_url(self) -> typing.Optional[windows_foundation.Uri]: ...
    @_property
...
class PlayReadyDomain(winrt.system.Object):
    ...
    @_property
    def domain_join_url(self) -> typing.Optional[windows_foundation.Uri]: ...
    @_property
...
class PlayReadyDomainIterable(winrt.system.Object):
    ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[IPlayReadyDomain]]: ...
...
class PlayReadyITADataGenerator(winrt.system.Object):
    ...
    def generate_data(self, guid_c_p_system_id: _uuid.UUID, count_of_streams: winrt.system.UInt32, configuration: typing.Optional[windows_foundation_collections.IPropertySet], format: PlayReadyITADataFormat, /) -> winrt.system.Array[winrt.system.UInt8]: ...
...
class PlayReadyLicenseIterable(winrt.system.Object):
    ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[IPlayReadyLicense]]: ...
...
class PlayReadyLicenseManagement_Static(type):
    def delete_licenses(cls, content_header: typing.Optional[PlayReadyContentHeader], /) -> windows_foundation.IAsyncAction: ...
...
class PlayReadyLicenseSession(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[PlayReadyLicenseSession], configuration: typing.Optional[windows_foundation_collections.IPropertySet]) -> PlayReadyLicenseSession: ...
    def configure_media_protection_manager(self, mpm: typing.Optional[windows_media_protection.MediaProtectionManager], /) -> None: ...
...
class PlayReadySecureStopIterable(winrt.system.Object):
    ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[IPlayReadySecureStopServiceRequest]]: ...
...
class PlayReadySecureStopServiceRequest(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[PlayReadySecureStopServiceRequest], session_i_d: _uuid.UUID, publisher_cert_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer]) -> PlayReadySecureStopServiceRequest: ...
    def begin_service_request(self) -> windows_foundation.IAsyncAction: ...
    def generate_manual_enabling_challenge(self) -> typing.Optional[PlayReadySoapMessage]: ...
    def next_service_request(self) -> typing.Optional[IPlayReadyServiceRequest]: ...
    def process_manual_enabling_response(self, response_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> windows_foundation.HResult: ...
...
class PlayReadySoapMessage(winrt.system.Object):
    ...
    @_property
    def message_headers(self) -> typing.Optional[windows_foundation_collections.IPropertySet]: ...
    @_property
    def uri(self) -> typing.Optional[windows_foundation.Uri]: ...
...
class INDDownloadEngine(winrt.system.Object):
    ...
    def close(self) -> None: ...
    def open(self, uri: typing.Optional[windows_foundation.Uri], session_i_d_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> None: ...
    def pause(self) -> None: ...
...
class INDStartResult(winrt.system.Object):
    ...
    @_property
    def media_stream_source(self) -> typing.Optional[windows_media_core.MediaStreamSource]: ...
...
class INDStreamParser(winrt.system.Object):
    ...
    def get_stream_information(self, descriptor: typing.Optional[windows_media_core.IMediaStreamDescriptor], /) -> typing.Tuple[winrt.system.UInt32, NDMediaStreamType]: ...
