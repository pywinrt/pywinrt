...
class PlayReadyITADataGenerator(winrt.system.Object):
    ...
    def generate_data(self, guid_c_p_system_id: _uuid.UUID, count_of_streams: winrt.system.UInt32, configuration: typing.Optional[windows_foundation_collections.IPropertySet], format: PlayReadyITADataFormat, /) -> winrt.system.UInt8: ...
