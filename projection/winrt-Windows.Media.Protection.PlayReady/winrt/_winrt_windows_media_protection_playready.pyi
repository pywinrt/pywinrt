...
class NDLicenseFetchDescriptor(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[NDLicenseFetchDescriptor], content_i_d_type: NDContentIDType, content_i_d_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], license_fetch_challenge_custom_data: INDCustomData) -> NDLicenseFetchDescriptor: ...
    @_property
...
class NDStorageFileHelper(winrt.system.Object):
    ...
    def get_file_u_r_ls(self, file: windows_storage.IStorageFile, /) -> windows_foundation_collections.IVector[str]: ...
...
class NDStreamParserNotifier(winrt.system.Object):
    ...
    def on_begin_setup_decryptor(self, descriptor: windows_media_core.IMediaStreamDescriptor, key_i_d: _uuid.UUID, pro_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> None: ...
    def on_content_i_d_received(self, license_fetch_descriptor: INDLicenseFetchDescriptor, /) -> None: ...
    ...
    def on_sample_parsed(self, stream_i_d: winrt.system.UInt32, stream_type: NDMediaStreamType, stream_sample: windows_media_core.MediaStreamSample, pts: winrt.system.Int64, cc_format: NDClosedCaptionFormat, cc_data_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> None: ...
...
class PlayReadyStatics_Static(type):
    ...
    @_property
    def hardware_d_r_m_disabled_until_time(cls) -> typing.Optional[datetime.datetime]: ...
    @_property
    def hardware_d_r_m_disabled_at_time(cls) -> typing.Optional[datetime.datetime]: ...
...
class INDDownloadEngine(winrt.system.Object):
    ...
    def close(self) -> None: ...
    def open(self, uri: windows_foundation.Uri, session_i_d_bytes: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> None: ...
    def pause(self) -> None: ...
