...
namespace py::cpp::Windows::Phone::ApplicationModel
{
    ...
    static PyObject* ApplicationProfile_get_Modes(PyObject* /*unused*/, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                is_property_present = winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.Phone.ApplicationModel.ApplicationProfile", L"Modes");
            }
...
PyMODINIT_FUNC PyInit__winrt_windows_phone_applicationmodel(void) noexcept
{
    ...
    py::pyobj_handle ApplicationProfile_Static_bases{PyTuple_Pack(1, reinterpret_cast<PyObject*>(inspectable_meta_type))};
    if (!ApplicationProfile_Static_bases)
    {
        return nullptr;
    }

    py::pyobj_handle type_ApplicationProfile_Static{PyType_FromSpecWithBases(&type_spec_ApplicationProfile_Static, ApplicationProfile_Static_bases.get())};
    if (!type_ApplicationProfile_Static)
    {
        return nullptr;
    }

    py::pytype_handle ApplicationProfile_type{py::register_python_type(module.get(), &type_spec_ApplicationProfile, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_ApplicationProfile_Static.get()))};
