...
class DatagramSocket_Static(type):
    def get_endpoint_pairs_async(cls, remote_host_name: windows_networking.HostName, remote_service_name: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_networking.EndpointPair]]: ...
    def get_endpoint_pairs_with_sort_options_async(cls, remote_host_name: windows_networking.HostName, remote_service_name: str, sort_options: windows_networking.HostNameSortOptions, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_networking.EndpointPair]]: ...
...
class MessageWebSocketControl(winrt.system.Object):
    ...
    @_property
    def supported_protocols(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
...
class SocketActivityContext(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[SocketActivityContext], data: windows_storage_streams.IBuffer) -> SocketActivityContext: ...
    @_property
