...
class DatagramSocket_Static(type):
    ...
    def get_endpoint_pairs_with_sort_options_async(cls, remote_host_name: typing.Optional[windows_networking.HostName], remote_service_name: str, sort_options: windows_networking.HostNameSortOptions, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_networking.EndpointPair]]: ...
...
class DatagramSocket(winrt.system.Object, metaclass=DatagramSocket_Static):
    ...
    def bind_service_name_and_adapter_async(self, local_service_name: str, adapter: typing.Optional[windows_networking_connectivity.NetworkAdapter], /) -> windows_foundation.IAsyncAction: ...
    ...
    def connect_with_endpoint_pair_async(self, endpoint_pair: typing.Optional[windows_networking.EndpointPair], /) -> windows_foundation.IAsyncAction: ...
    ...
    def get_output_stream_with_endpoint_pair_async(self, endpoint_pair: typing.Optional[windows_networking.EndpointPair], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IOutputStream]: ...
    ...
    def transfer_ownership_with_context(self, socket_id: str, data: typing.Optional[SocketActivityContext], /) -> None: ...
    def transfer_ownership_with_context_and_keep_alive_time(self, socket_id: str, data: typing.Optional[SocketActivityContext], keep_alive_time: datetime.timedelta, /) -> None: ...
...
class StreamSocket(winrt.system.Object, metaclass=StreamSocket_Static):
    ...
    def close(self) -> None: ...
    def connect_async(self, remote_host_name: typing.Optional[windows_networking.HostName], remote_service_name: str, /) -> windows_foundation.IAsyncAction: ...
    def connect_with_endpoint_pair_and_protection_level_async(self, endpoint_pair: typing.Optional[windows_networking.EndpointPair], protection_level: SocketProtectionLevel, /) -> windows_foundation.IAsyncAction: ...
    def connect_with_endpoint_pair_async(self, endpoint_pair: typing.Optional[windows_networking.EndpointPair], /) -> windows_foundation.IAsyncAction: ...
    def connect_with_protection_level_and_adapter_async(self, remote_host_name: typing.Optional[windows_networking.HostName], remote_service_name: str, protection_level: SocketProtectionLevel, adapter: typing.Optional[windows_networking_connectivity.NetworkAdapter], /) -> windows_foundation.IAsyncAction: ...
    def connect_with_protection_level_async(self, remote_host_name: typing.Optional[windows_networking.HostName], remote_service_name: str, protection_level: SocketProtectionLevel, /) -> windows_foundation.IAsyncAction: ...
    def enable_transfer_ownership(self, task_id: _uuid.UUID, /) -> None: ...
    def enable_transfer_ownership_with_connected_standby_action(self, task_id: _uuid.UUID, connected_standby_action: SocketActivityConnectedStandbyAction, /) -> None: ...
    def transfer_ownership(self, socket_id: str, /) -> None: ...
    def transfer_ownership_with_context(self, socket_id: str, data: typing.Optional[SocketActivityContext], /) -> None: ...
...
class StreamSocketListener(winrt.system.Object):
    ...
    def bind_endpoint_async(self, local_host_name: typing.Optional[windows_networking.HostName], local_service_name: str, /) -> windows_foundation.IAsyncAction: ...
    def bind_service_name_async(self, local_service_name: str, /) -> windows_foundation.IAsyncAction: ...
    def bind_service_name_with_protection_level_and_adapter_async(self, local_service_name: str, protection_level: SocketProtectionLevel, adapter: typing.Optional[windows_networking_connectivity.NetworkAdapter], /) -> windows_foundation.IAsyncAction: ...
