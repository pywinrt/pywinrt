...
class HttpCacheDirectiveHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[HttpNameValueHeaderValue]):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[HttpNameValueHeaderValue]]: ...
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpNameValueHeaderValue]]: ...
...
class HttpChallengeHeaderValue(winrt.system.Object, metaclass=HttpChallengeHeaderValue_Static):
    ...
    def to_string(self) -> str: ...
    @_property
    def parameters(self) -> typing.Optional[windows_foundation_collections.IVector[HttpNameValueHeaderValue]]: ...
    @_property
    def scheme(self) -> str: ...
    @_property
    def token(self) -> str: ...
...
class HttpChallengeHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[HttpChallengeHeaderValue]):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[HttpChallengeHeaderValue]]: ...
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpChallengeHeaderValue]]: ...
...
class HttpConnectionOptionHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[HttpConnectionOptionHeaderValue]):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[HttpConnectionOptionHeaderValue]]: ...
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpConnectionOptionHeaderValue]]: ...
...
class HttpContentCodingHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[HttpContentCodingHeaderValue]):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[HttpContentCodingHeaderValue]]: ...
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpContentCodingHeaderValue]]: ...
...
class HttpContentCodingWithQualityHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[HttpContentCodingWithQualityHeaderValue]):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[HttpContentCodingWithQualityHeaderValue]]: ...
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpContentCodingWithQualityHeaderValue]]: ...
...
class HttpContentHeaderCollection(winrt.system.Object, winrt._winrt.MutableMapping[str, str]):
    ...
    @_property
    def content_m_d5(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @content_m_d5.setter
    def content_m_d5(self, value: typing.Optional[windows_storage_streams.IBuffer]) -> None: ...
    @_property
    def content_location(self) -> typing.Optional[windows_foundation.Uri]: ...
    @content_location.setter
    def content_location(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
...
class HttpCookiePairHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[HttpCookiePairHeaderValue]):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[HttpCookiePairHeaderValue]]: ...
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpCookiePairHeaderValue]]: ...
...
class HttpExpectationHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[HttpExpectationHeaderValue]):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[HttpExpectationHeaderValue]]: ...
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpExpectationHeaderValue]]: ...
...
@typing.final
class HttpLanguageHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[windows_globalization.Language]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
    ...
    def append(self, value: typing.Optional[windows_globalization.Language], /) -> None: ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[windows_globalization.Language]]: ...
    def get_at(self, index: winrt.system.UInt32, /) -> typing.Optional[windows_globalization.Language]: ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[windows_globalization.Language], /) -> winrt.system.UInt32: ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_globalization.Language]]: ...
    def index_of(self, value: typing.Optional[windows_globalization.Language], /) -> typing.Tuple[bool, winrt.system.UInt32]: ...
    def insert_at(self, index: winrt.system.UInt32, value: typing.Optional[windows_globalization.Language], /) -> None: ...
    def parse_add(self, input: str, /) -> None: ...
    def remove_at(self, index: winrt.system.UInt32, /) -> None: ...
    def remove_at_end(self) -> None: ...
    def replace_all(self, items: winrt.system.Array[windows_globalization.Language], /) -> None: ...
    def set_at(self, index: winrt.system.UInt32, value: typing.Optional[windows_globalization.Language], /) -> None: ...
    def to_string(self) -> str: ...
    def try_parse_add(self, input: str, /) -> bool: ...
    @_property
    def size(self) -> winrt.system.UInt32: ...
...
class HttpLanguageRangeWithQualityHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[HttpLanguageRangeWithQualityHeaderValue]):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[HttpLanguageRangeWithQualityHeaderValue]]: ...
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpLanguageRangeWithQualityHeaderValue]]: ...
...
class HttpMediaTypeWithQualityHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[HttpMediaTypeWithQualityHeaderValue]):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[HttpMediaTypeWithQualityHeaderValue]]: ...
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpMediaTypeWithQualityHeaderValue]]: ...
...
@typing.final
class HttpMethodHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[windows_web_http.HttpMethod]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
    ...
    def append(self, value: typing.Optional[windows_web_http.HttpMethod], /) -> None: ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[windows_web_http.HttpMethod]]: ...
    def get_at(self, index: winrt.system.UInt32, /) -> typing.Optional[windows_web_http.HttpMethod]: ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[windows_web_http.HttpMethod], /) -> winrt.system.UInt32: ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_web_http.HttpMethod]]: ...
    def index_of(self, value: typing.Optional[windows_web_http.HttpMethod], /) -> typing.Tuple[bool, winrt.system.UInt32]: ...
    def insert_at(self, index: winrt.system.UInt32, value: typing.Optional[windows_web_http.HttpMethod], /) -> None: ...
    def parse_add(self, input: str, /) -> None: ...
    def remove_at(self, index: winrt.system.UInt32, /) -> None: ...
    def remove_at_end(self) -> None: ...
    def replace_all(self, items: winrt.system.Array[windows_web_http.HttpMethod], /) -> None: ...
    def set_at(self, index: winrt.system.UInt32, value: typing.Optional[windows_web_http.HttpMethod], /) -> None: ...
    def to_string(self) -> str: ...
    def try_parse_add(self, input: str, /) -> bool: ...
    @_property
    def size(self) -> winrt.system.UInt32: ...
...
class HttpProductInfoHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[HttpProductInfoHeaderValue]):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[HttpProductInfoHeaderValue]]: ...
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpProductInfoHeaderValue]]: ...
...
class HttpRequestHeaderCollection(winrt.system.Object, winrt._winrt.MutableMapping[str, str]):
    ...
    def size(self) -> winrt.system.UInt32: ...
    @_property
    def referer(self) -> typing.Optional[windows_foundation.Uri]: ...
    @referer.setter
    def referer(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    ...
    @_property
    def host(self) -> typing.Optional[windows_networking.HostName]: ...
    @host.setter
    def host(self, value: typing.Optional[windows_networking.HostName]) -> None: ...
    @_property
    def from_(self) -> str: ...
    @from_.setter
...
class HttpResponseHeaderCollection(winrt.system.Object, winrt._winrt.MutableMapping[str, str]):
    ...
    @_property
    def location(self) -> typing.Optional[windows_foundation.Uri]: ...
    @location.setter
    def location(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    def date(self) -> typing.Optional[typing.Optional[datetime.datetime]]: ...
    @date.setter
    def date(self, value: typing.Optional[typing.Optional[datetime.datetime]]) -> None: ...
...
class HttpTransferCodingHeaderValueCollection(winrt.system.Object, winrt._winrt.MutableSequence[HttpTransferCodingHeaderValue]):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[HttpTransferCodingHeaderValue]]: ...
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[HttpTransferCodingHeaderValue]]: ...
