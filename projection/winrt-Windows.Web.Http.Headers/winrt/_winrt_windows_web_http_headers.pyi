...
@typing.final
class HttpCacheDirectiveHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[HttpNameValueHeaderValue]):
...
@typing.final
class HttpChallengeHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[HttpChallengeHeaderValue]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
...
@typing.final
class HttpConnectionOptionHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[HttpConnectionOptionHeaderValue]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
...
@typing.final
class HttpContentCodingHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[HttpContentCodingHeaderValue]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
...
@typing.final
class HttpContentCodingWithQualityHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[HttpContentCodingWithQualityHeaderValue]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
...
@typing.final
class HttpContentHeaderCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableMapping[str, str]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
    ...
    @_property
    def content_m_d5(self) -> windows_storage_streams.IBuffer: ...
    @content_m_d5.setter
    def content_m_d5(self, value: windows_storage_streams.IBuffer) -> None: ...
    @_property
...
@typing.final
class HttpCookiePairHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[HttpCookiePairHeaderValue]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
...
@typing.final
class HttpExpectationHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[HttpExpectationHeaderValue]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
...
@typing.final
class HttpLanguageHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[windows_globalization.Language]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
...
@typing.final
class HttpLanguageRangeWithQualityHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[HttpLanguageRangeWithQualityHeaderValue]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
...
@typing.final
class HttpMediaTypeWithQualityHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[HttpMediaTypeWithQualityHeaderValue]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
...
@typing.final
class HttpMethodHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[windows_web_http.HttpMethod]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
...
@typing.final
class HttpProductInfoHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[HttpProductInfoHeaderValue]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
...
@typing.final
class HttpRequestHeaderCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableMapping[str, str]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[str]: ...
    def __contains__(self, key: object) -> bool: ...
...
@typing.final
class HttpResponseHeaderCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableMapping[str, str]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[str]: ...
    def __contains__(self, key: object) -> bool: ...
...
@typing.final
class HttpTransferCodingHeaderValueCollection(windows_foundation.IStringable, winrt.system.Object, winrt._winrt.MutableSequence[HttpTransferCodingHeaderValue]):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
