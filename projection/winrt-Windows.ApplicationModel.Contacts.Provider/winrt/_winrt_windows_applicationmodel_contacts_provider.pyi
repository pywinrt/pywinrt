...
class ContactPickerUI(winrt.system.Object):
    ...
    @_property
    def desired_fields(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def selection_mode(self) -> windows_applicationmodel_contacts.ContactSelectionMode: ...
    @_property
    def desired_fields_with_contact_field_type(self) -> windows_foundation_collections.IVector[windows_applicationmodel_contacts.ContactFieldType]: ...
