...
class Contact(winrt.system.Object):
    ...
    def source_display_picture(self, value: windows_storage_streams.ImplementsIRandomAccessStreamReference) -> None: ...
    @_property
...
@typing.final
class ContactCardDelayedDataLoader(winrt.system.Object, windows_foundation.ImplementsIClosable):
...
@typing.final
class ContactField(winrt.system.Object, ImplementsIContactField):
    @staticmethod
...
@typing.final
class ContactFieldFactory(winrt.system.Object, ImplementsIContactInstantMessageFieldFactory, ImplementsIContactLocationFieldFactory, ImplementsIContactFieldFactory):
    @staticmethod
...
@typing.final
class ContactInstantMessageField(winrt.system.Object, ImplementsIContactField):
    @staticmethod
...
@typing.final
class ContactLocationField(winrt.system.Object, ImplementsIContactField):
    @staticmethod
...
class ContactManager_Static(type):
    ...
    def convert_v_card_to_contact_async(cls, v_card: windows_storage_streams.ImplementsIRandomAccessStreamReference, /) -> windows_foundation.IAsyncOperation[Contact]: ...
...
class ContactManagerForUser(winrt.system.Object):
    ...
    def convert_v_card_to_contact_async(self, v_card: windows_storage_streams.ImplementsIRandomAccessStreamReference, /) -> windows_foundation.IAsyncOperation[Contact]: ...
