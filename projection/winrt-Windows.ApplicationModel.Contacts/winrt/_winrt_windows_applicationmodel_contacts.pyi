...
class AggregateContactManager(winrt.system.Object):
    ...
    def find_raw_contacts_async(self, contact: typing.Optional[Contact], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Contact]]: ...
    ...
    def try_link_contacts_async(self, primary_contact: typing.Optional[Contact], secondary_contact: typing.Optional[Contact], /) -> windows_foundation.IAsyncOperation[Contact]: ...
    def try_set_preferred_source_for_picture_async(self, aggregate_contact: typing.Optional[Contact], raw_contact: typing.Optional[Contact], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def unlink_raw_contact_async(self, contact: typing.Optional[Contact], /) -> windows_foundation.IAsyncAction: ...
...
class Contact(winrt.system.Object):
    ...
    @thumbnail.setter
    def thumbnail(self, value: typing.Optional[windows_storage_streams.IRandomAccessStreamReference]) -> None: ...
    @_property
    def name(self) -> str: ...
    @name.setter
    def name(self, value: str) -> None: ...
    @_property
    def fields(self) -> typing.Optional[windows_foundation_collections.IVector[IContactField]]: ...
    @_property
    def id(self) -> str: ...
    @id.setter
    ...
    @_property
    def connected_service_accounts(self) -> typing.Optional[windows_foundation_collections.IVector[ContactConnectedServiceAccount]]: ...
    @_property
    def emails(self) -> typing.Optional[windows_foundation_collections.IVector[ContactEmail]]: ...
    @_property
    def addresses(self) -> typing.Optional[windows_foundation_collections.IVector[ContactAddress]]: ...
    @_property
    def important_dates(self) -> typing.Optional[windows_foundation_collections.IVector[ContactDate]]: ...
    @_property
    def job_info(self) -> typing.Optional[windows_foundation_collections.IVector[ContactJobInfo]]: ...
    @_property
    def data_suppliers(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def phones(self) -> typing.Optional[windows_foundation_collections.IVector[ContactPhone]]: ...
    @_property
    def provider_properties(self) -> typing.Optional[windows_foundation_collections.IPropertySet]: ...
    @_property
    def significant_others(self) -> typing.Optional[windows_foundation_collections.IVector[ContactSignificantOther]]: ...
    @_property
    def websites(self) -> typing.Optional[windows_foundation_collections.IVector[ContactWebsite]]: ...
    @_property
    def source_display_picture(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
    @source_display_picture.setter
    def source_display_picture(self, value: typing.Optional[windows_storage_streams.IRandomAccessStreamReference]) -> None: ...
    @_property
    ...
    @_property
    def large_display_picture(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
    @_property
    def small_display_picture(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
    @_property
...
class ContactAnnotation(winrt.system.Object):
    ...
    @_property
    def provider_properties(self) -> typing.Optional[windows_foundation_collections.ValueSet]: ...
    @_property
    def contact_list_id(self) -> str: ...
...
class ContactAnnotationList(winrt.system.Object):
    ...
    def delete_annotation_async(self, annotation: typing.Optional[ContactAnnotation], /) -> windows_foundation.IAsyncAction: ...
    def delete_async(self) -> windows_foundation.IAsyncAction: ...
    def find_annotations_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ContactAnnotation]]: ...
    def find_annotations_by_remote_id_async(self, remote_id: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ContactAnnotation]]: ...
    def get_annotation_async(self, annotation_id: str, /) -> windows_foundation.IAsyncOperation[ContactAnnotation]: ...
    def try_save_annotation_async(self, annotation: typing.Optional[ContactAnnotation], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @_property
    def id(self) -> str: ...
    @_property
...
class ContactAnnotationStore(winrt.system.Object):
    ...
    def disable_annotation_async(self, annotation: typing.Optional[ContactAnnotation], /) -> windows_foundation.IAsyncAction: ...
    def find_annotation_lists_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ContactAnnotationList]]: ...
    def find_annotations_for_contact_async(self, contact: typing.Optional[Contact], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ContactAnnotation]]: ...
    def find_annotations_for_contact_list_async(self, contact_list_id: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ContactAnnotation]]: ...
    def find_contact_ids_by_email_async(self, email_address: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[str]]: ...
    def find_contact_ids_by_phone_number_async(self, phone_number: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[str]]: ...
...
class ContactBatch(winrt.system.Object):
    ...
    @_property
    def contacts(self) -> typing.Optional[windows_foundation_collections.IVectorView[Contact]]: ...
    @_property
...
class ContactCardOptions(winrt.system.Object):
    ...
    @_property
    def server_search_contact_list_ids(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class ContactChangeReader(winrt.system.Object):
    ...
    def read_batch_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ContactChange]]: ...
...
class ContactFieldFactory(winrt.system.Object):
    ...
    def create_field_category(self, value: str, type: ContactFieldType, category: ContactFieldCategory, /) -> typing.Optional[ContactField]: ...
    def create_field_custom(self, name: str, value: str, type: ContactFieldType, category: ContactFieldCategory, /) -> typing.Optional[ContactField]: ...
    def create_field_default(self, value: str, type: ContactFieldType, /) -> typing.Optional[ContactField]: ...
    def create_instant_message_all(self, user_name: str, category: ContactFieldCategory, service: str, display_text: str, verb: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[ContactInstantMessageField]: ...
    def create_instant_message_category(self, user_name: str, category: ContactFieldCategory, /) -> typing.Optional[ContactInstantMessageField]: ...
    def create_instant_message_default(self, user_name: str, /) -> typing.Optional[ContactInstantMessageField]: ...
    def create_location_all(self, unstructured_address: str, category: ContactFieldCategory, street: str, city: str, region: str, country: str, postal_code: str, /) -> typing.Optional[ContactLocationField]: ...
    def create_location_category(self, unstructured_address: str, category: ContactFieldCategory, /) -> typing.Optional[ContactLocationField]: ...
    def create_location_default(self, unstructured_address: str, /) -> typing.Optional[ContactLocationField]: ...
...
class ContactInformation(winrt.system.Object):
    ...
    def query_custom_fields(self, custom_name: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[ContactField]]: ...
    @_property
    def custom_fields(self) -> typing.Optional[windows_foundation_collections.IVectorView[ContactField]]: ...
    @_property
    def emails(self) -> typing.Optional[windows_foundation_collections.IVectorView[ContactField]]: ...
    @_property
    def instant_messages(self) -> typing.Optional[windows_foundation_collections.IVectorView[ContactInstantMessageField]]: ...
    @_property
    def locations(self) -> typing.Optional[windows_foundation_collections.IVectorView[ContactLocationField]]: ...
    @_property
    def name(self) -> str: ...
    @_property
    def phone_numbers(self) -> typing.Optional[windows_foundation_collections.IVectorView[ContactField]]: ...
...
class ContactInstantMessageField(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[ContactInstantMessageField], user_name: str, category: ContactFieldCategory, service: str, display_text: str, verb: typing.Optional[windows_foundation.Uri]) -> ContactInstantMessageField: ...
    @_property
    def category(self) -> ContactFieldCategory: ...
    @_property
    def name(self) -> str: ...
    ...
    @_property
    def launch_uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @_property
...
class ContactList(winrt.system.Object):
    ...
    def delete_async(self) -> windows_foundation.IAsyncAction: ...
    def delete_contact_async(self, contact: typing.Optional[Contact], /) -> windows_foundation.IAsyncAction: ...
    ...
    def get_contact_reader_with_options(self, options: typing.Optional[ContactQueryOptions], /) -> typing.Optional[ContactReader]: ...
    ...
    def save_contact_async(self, contact: typing.Optional[Contact], /) -> windows_foundation.IAsyncAction: ...
...
class ContactListLimitedWriteOperations(winrt.system.Object):
    ...
    def try_create_or_update_contact_async(self, contact: typing.Optional[Contact], /) -> windows_foundation.IAsyncOperation[bool]: ...
...
class ContactManager_Static(type):
    def convert_contact_to_v_card_async(cls, contact: typing.Optional[Contact], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.RandomAccessStreamReference]: ...
    def convert_contact_to_v_card_async_with_max_bytes(cls, contact: typing.Optional[Contact], max_bytes: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_storage_streams.RandomAccessStreamReference]: ...
    def convert_v_card_to_contact_async(cls, v_card: typing.Optional[windows_storage_streams.IRandomAccessStreamReference], /) -> windows_foundation.IAsyncOperation[Contact]: ...
    def get_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[ContactManagerForUser]: ...
    ...
    def show_contact_card(cls, contact: typing.Optional[Contact], selection: windows_foundation.Rect, /) -> None: ...
    def show_contact_card_with_options(cls, contact: typing.Optional[Contact], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, contact_card_options: typing.Optional[ContactCardOptions], /) -> None: ...
    def show_contact_card_with_placement(cls, contact: typing.Optional[Contact], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> None: ...
    def show_delay_loaded_contact_card(cls, contact: typing.Optional[Contact], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> typing.Optional[ContactCardDelayedDataLoader]: ...
    def show_delay_loaded_contact_card_with_options(cls, contact: typing.Optional[Contact], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, contact_card_options: typing.Optional[ContactCardOptions], /) -> typing.Optional[ContactCardDelayedDataLoader]: ...
...
class ContactManagerForUser(winrt.system.Object):
    ...
    def convert_contact_to_v_card_async(self, contact: typing.Optional[Contact], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.RandomAccessStreamReference]: ...
    def convert_contact_to_v_card_async_with_max_bytes(self, contact: typing.Optional[Contact], max_bytes: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_storage_streams.RandomAccessStreamReference]: ...
    def convert_v_card_to_contact_async(self, v_card: typing.Optional[windows_storage_streams.IRandomAccessStreamReference], /) -> windows_foundation.IAsyncOperation[Contact]: ...
...
class ContactMatchReason(winrt.system.Object):
    ...
    @_property
    def segments(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_data_text.TextSegment]]: ...
    @_property
    def text(self) -> str: ...
...
class ContactPanel(winrt.system.Object):
    ...
    @_property
    def header_color(self) -> typing.Optional[typing.Optional[windows_ui.Color]]: ...
    @header_color.setter
    def header_color(self, value: typing.Optional[typing.Optional[windows_ui.Color]]) -> None: ...
...
class ContactPicker_Static(type):
    def create_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[ContactPicker]: ...
...
class ContactPicker(winrt.system.Object, metaclass=ContactPicker_Static):
    ...
    def pick_contacts_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVector[Contact]]: ...
    def pick_multiple_contacts_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ContactInformation]]: ...
    ...
    @_property
    def desired_fields(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def desired_fields_with_contact_field_type(self) -> typing.Optional[windows_foundation_collections.IVector[ContactFieldType]]: ...
    @_property
    def user(self) -> typing.Optional[windows_system.User]: ...
...
class ContactQueryOptions(winrt.system.Object):
    ...
    @_property
    def annotation_list_ids(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def contact_list_ids(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
...
class ContactReader(winrt.system.Object):
    ...
    def get_matching_properties_with_match_reason(self, contact: typing.Optional[Contact], /) -> typing.Optional[windows_foundation_collections.IVectorView[ContactMatchReason]]: ...
...
class ContactStore(winrt.system.Object):
    ...
    def find_contact_lists_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ContactList]]: ...
    def find_contacts_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Contact]]: ...
    def find_contacts_with_search_text_async(self, search_text: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Contact]]: ...
    def get_change_tracker(self, identity: str, /) -> typing.Optional[ContactChangeTracker]: ...
    def get_contact_async(self, contact_id: str, /) -> windows_foundation.IAsyncOperation[Contact]: ...
...
class PinnedContactIdsQueryResult(winrt.system.Object):
    ...
    @_property
    def contact_ids(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...

@typing.final
class PinnedContactManager_Static(type):
    def get_default(cls) -> typing.Optional[PinnedContactManager]: ...
    def get_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[PinnedContactManager]: ...
...
class PinnedContactManager(winrt.system.Object, metaclass=PinnedContactManager_Static):
    ...
    def request_pin_contact_async(self, contact: typing.Optional[Contact], surface: PinnedContactSurface, /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def request_unpin_contact_async(self, contact: typing.Optional[Contact], surface: PinnedContactSurface, /) -> windows_foundation.IAsyncOperation[bool]: ...
