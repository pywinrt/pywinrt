...
class ContactFieldFactory(winrt.system.Object):
    ...
    @typing.overload
    def create_instant_message(self, user_name: str, category: ContactFieldCategory, service: str, display_text: str, verb: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[ContactInstantMessageField]: ...
    @typing.overload
...
class ContactManager_Static(type):
    ...
    @typing.overload
    def convert_contact_to_v_card_async(cls, contact: typing.Optional[Contact], max_bytes: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_storage_streams.RandomAccessStreamReference]: ...
    ...
    @typing.overload
    def show_contact_card(cls, contact: typing.Optional[Contact], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> None: ...
    @typing.overload
    def show_contact_card(cls, contact: typing.Optional[Contact], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, contact_card_options: typing.Optional[ContactCardOptions], /) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def show_delay_loaded_contact_card(cls, contact: typing.Optional[Contact], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, contact_card_options: typing.Optional[ContactCardOptions], /) -> typing.Optional[ContactCardDelayedDataLoader]: ...
...
class ContactManagerForUser(winrt.system.Object):
    ...
    @typing.overload
    def convert_contact_to_v_card_async(self, contact: typing.Optional[Contact], max_bytes: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_storage_streams.RandomAccessStreamReference]: ...
...
class ContactStore(winrt.system.Object):
    ...
    @typing.overload
    def find_contacts_async(self, search_text: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Contact]]: ...
    def get_change_tracker(self, identity: str, /) -> typing.Optional[ContactChangeTracker]: ...
    def get_contact_async(self, contact_id: str, /) -> windows_foundation.IAsyncOperation[Contact]: ...
