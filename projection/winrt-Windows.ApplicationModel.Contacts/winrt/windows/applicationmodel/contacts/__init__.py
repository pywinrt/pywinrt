...
_ns_module._register_ContactAddressKind(ContactAddressKind)
_ns_module._register_ContactAnnotationOperations(ContactAnnotationOperations)
_ns_module._register_ContactAnnotationStoreAccessType(ContactAnnotationStoreAccessType)
_ns_module._register_ContactBatchStatus(ContactBatchStatus)
_ns_module._register_ContactCardHeaderKind(ContactCardHeaderKind)
_ns_module._register_ContactCardTabKind(ContactCardTabKind)
_ns_module._register_ContactChangeType(ContactChangeType)
_ns_module._register_ContactDateKind(ContactDateKind)
_ns_module._register_ContactEmailKind(ContactEmailKind)
_ns_module._register_ContactFieldCategory(ContactFieldCategory)
_ns_module._register_ContactFieldType(ContactFieldType)
_ns_module._register_ContactListOtherAppReadAccess(ContactListOtherAppReadAccess)
_ns_module._register_ContactListOtherAppWriteAccess(ContactListOtherAppWriteAccess)
_ns_module._register_ContactListSyncStatus(ContactListSyncStatus)
_ns_module._register_ContactMatchReasonKind(ContactMatchReasonKind)
_ns_module._register_ContactNameOrder(ContactNameOrder)
_ns_module._register_ContactPhoneKind(ContactPhoneKind)
_ns_module._register_ContactQueryDesiredFields(ContactQueryDesiredFields)
_ns_module._register_ContactQuerySearchFields(ContactQuerySearchFields)
_ns_module._register_ContactQuerySearchScope(ContactQuerySearchScope)
_ns_module._register_ContactRelationship(ContactRelationship)
_ns_module._register_ContactSelectionMode(ContactSelectionMode)
_ns_module._register_ContactStoreAccessType(ContactStoreAccessType)
_ns_module._register_PinnedContactSurface(PinnedContactSurface)
