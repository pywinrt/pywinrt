...
PyMODINIT_FUNC PyInit__winrt_microsoft_windows_applicationmodel_resources(void) noexcept
{
    ...
    py::pyobj_handle KnownResourceQualifierName_type{py::register_python_type(module.get(), &type_spec_KnownResourceQualifierName, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_KnownResourceQualifierName_Static.get()))};
    ...
    py::pyobj_handle ResourceContext_type{py::register_python_type(module.get(), &type_spec_ResourceContext, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle ResourceManager_type{py::register_python_type(module.get(), &type_spec_ResourceManager, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle ResourceNotFoundEventArgs_type{py::register_python_type(module.get(), &type_spec_ResourceNotFoundEventArgs, object_bases.get(), nullptr)};
    if (!ResourceNotFoundEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle IResourceContext_type{py::register_python_type(module.get(), &type_spec_IResourceContext, object_bases.get(), nullptr)};
    if (!IResourceContext_type)
    {
        return nullptr;
    }

    py::pyobj_handle IResourceManager_type{py::register_python_type(module.get(), &type_spec_IResourceManager, object_bases.get(), nullptr)};
