...
class ResourceMap(winrt.system.Object):
    ...
    @typing.overload
    def get_value_by_index(self, index: winrt.system.UInt32, context: typing.Optional[ResourceContext], /) -> typing.Optional[windows_foundation_collections.IKeyValuePair[str, ResourceCandidate]]: ...
