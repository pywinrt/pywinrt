...
class ResourceCandidate(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[ResourceCandidate], data: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer]) -> ResourceCandidate: ...
    @_property
    def kind(self) -> ResourceCandidateKind: ...
    @_property
    def qualifier_values(self) -> typing.Optional[windows_foundation_collections.IMapView[str, str]]: ...
    @_property
...
class ResourceContext(winrt.system.Object):
    ...
    @_property
    def qualifier_values(self) -> typing.Optional[windows_foundation_collections.IMap[str, str]]: ...
...
class ResourceLoader(winrt.system.Object, metaclass=ResourceLoader_Static):
    ...
    def get_string_for_uri(self, resource_uri: typing.Optional[windows_foundation.Uri], /) -> str: ...
...
class ResourceMap(winrt.system.Object):
    ...
    def get_value_by_index(self, index: winrt.system.UInt32, /) -> typing.Optional[windows_foundation_collections.IKeyValuePair[str, ResourceCandidate]]: ...
    def get_value_by_index_with_context(self, index: winrt.system.UInt32, context: typing.Optional[ResourceContext], /) -> typing.Optional[windows_foundation_collections.IKeyValuePair[str, ResourceCandidate]]: ...
    def get_value_with_context(self, resource: str, context: typing.Optional[ResourceContext], /) -> typing.Optional[ResourceCandidate]: ...
    ...
    def try_get_value_with_context(self, resource: str, context: typing.Optional[ResourceContext], /) -> typing.Optional[ResourceCandidate]: ...
    @_property
