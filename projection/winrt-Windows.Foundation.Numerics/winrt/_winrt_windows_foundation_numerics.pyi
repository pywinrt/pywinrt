...
class Matrix3x2(metaclass=Matrix3x2_Static):
    ...
    def __init__(self, m11: winrt.system.Single = 0, m12: winrt.system.Single = 0, m21: winrt.system.Single = 0, m22: winrt.system.Single = 0, m31: winrt.system.Single = 0, m32: winrt.system.Single = 0) -> None: ...
...
class Plane(metaclass=Plane_Static):
    ...
    def __init__(self, normal: Vector3 = Vector3(), d: winrt.system.Single = 0) -> None: ...
...
class Quaternion(metaclass=Quaternion_Static):
    ...
    def __init__(self, x: winrt.system.Single = 0, y: winrt.system.Single = 0, z: winrt.system.Single = 0, w: winrt.system.Single = 0) -> None: ...
...
class Rational:
    ...
    def __init__(self, numerator: winrt.system.UInt32 = 0, denominator: winrt.system.UInt32 = 0) -> None: ...
...
class Vector3(metaclass=Vector3_Static):
    ...
    y: winrt.system.Single
    z: winrt.system.Single
    def __init__(self, x: winrt.system.Single = 0, y: winrt.system.Single = 0, z: winrt.system.Single = 0) -> None: ...
