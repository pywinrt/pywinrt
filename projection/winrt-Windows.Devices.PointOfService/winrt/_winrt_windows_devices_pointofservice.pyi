...
class BarcodeScanner(winrt.system.Object, metaclass=BarcodeScanner_Static):
    ...
    def close(self) -> None: ...
    def get_supported_profiles(self) -> windows_foundation_collections.IVectorView[str]: ...
...
class BarcodeScannerReport(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[BarcodeScannerReport], scan_data_type: winrt.system.UInt32, scan_data: windows_storage_streams.IBuffer, scan_data_label: windows_storage_streams.IBuffer) -> BarcodeScannerReport: ...
    @_property
...
class ClaimedLineDisplay(winrt.system.Object, metaclass=ClaimedLineDisplay_Static):
    ...
    @_property
    def supported_character_sets(self) -> windows_foundation_collections.IVectorView[winrt.system.Int32]: ...
    @_property
    def supported_screen_sizes_in_characters(self) -> windows_foundation_collections.IVectorView[windows_foundation.Size]: ...
...
class JournalPrinterCapabilities(winrt.system.Object):
    ...
    @_property
    def supported_characters_per_line(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
...
class LineDisplayCustomGlyphs(winrt.system.Object):
    ...
    @_property
    def supported_glyph_codes(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
...
class MagneticStripeReaderReport(winrt.system.Object):
    ...
    @_property
    def properties(self) -> windows_foundation_collections.IMapView[str, str]: ...
    @_property
...
class PosPrinter(winrt.system.Object, metaclass=PosPrinter_Static):
    ...
    @_property
    def supported_character_sets(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
    def supported_type_faces(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def supported_barcode_symbologies(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
...
class PosPrinterFontProperty(winrt.system.Object):
    ...
    @_property
    def character_sizes(self) -> windows_foundation_collections.IVectorView[SizeUInt32]: ...
    @_property
...
class ReceiptPrinterCapabilities(winrt.system.Object):
    ...
    @_property
    def supported_barcode_rotations(self) -> windows_foundation_collections.IVectorView[PosPrinterRotation]: ...
    @_property
    def supported_bitmap_rotations(self) -> windows_foundation_collections.IVectorView[PosPrinterRotation]: ...
    @_property
