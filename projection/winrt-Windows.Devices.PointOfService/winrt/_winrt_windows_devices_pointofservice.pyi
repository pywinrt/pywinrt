...
class ClaimedLineDisplay(winrt.system.Object, metaclass=ClaimedLineDisplay_Static):
    ...
    def try_store_storage_file_bitmap_with_alignment_and_width_async(self, bitmap: typing.Optional[windows_storage.StorageFile], horizontal_alignment: LineDisplayHorizontalAlignment, vertical_alignment: LineDisplayVerticalAlignment, width_in_pixels: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[LineDisplayStoredBitmap]: ...
    def try_store_storage_file_bitmap_with_alignment_async(self, bitmap: typing.Optional[windows_storage.StorageFile], horizontal_alignment: LineDisplayHorizontalAlignment, vertical_alignment: LineDisplayVerticalAlignment, /) -> windows_foundation.IAsyncOperation[LineDisplayStoredBitmap]: ...
...
class LineDisplayWindow(winrt.system.Object):
    ...
    def try_display_storage_file_bitmap_at_cursor_with_alignment_and_width_async(self, bitmap: typing.Optional[windows_storage.StorageFile], horizontal_alignment: LineDisplayHorizontalAlignment, vertical_alignment: LineDisplayVerticalAlignment, width_in_pixels: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_display_storage_file_bitmap_at_cursor_with_alignment_async(self, bitmap: typing.Optional[windows_storage.StorageFile], horizontal_alignment: LineDisplayHorizontalAlignment, vertical_alignment: LineDisplayVerticalAlignment, /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def try_display_storage_file_bitmap_at_point_with_width_async(self, bitmap: typing.Optional[windows_storage.StorageFile], offset_in_pixels: windows_foundation.Point, width_in_pixels: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[bool]: ...
...
class ReceiptPrintJob(winrt.system.Object):
    ...
    def print_bitmap_custom_width_custom_align(self, bitmap: typing.Optional[windows_graphics_imaging.BitmapFrame], alignment_distance: winrt.system.UInt32, width: winrt.system.UInt32, /) -> None: ...
    def print_bitmap_custom_width_standard_align(self, bitmap: typing.Optional[windows_graphics_imaging.BitmapFrame], alignment: PosPrinterAlignment, width: winrt.system.UInt32, /) -> None: ...
    ...
    def set_bitmap_custom_width_custom_align(self, bitmap_number: winrt.system.UInt32, bitmap: typing.Optional[windows_graphics_imaging.BitmapFrame], alignment_distance: winrt.system.UInt32, width: winrt.system.UInt32, /) -> None: ...
    def set_bitmap_custom_width_standard_align(self, bitmap_number: winrt.system.UInt32, bitmap: typing.Optional[windows_graphics_imaging.BitmapFrame], alignment: PosPrinterAlignment, width: winrt.system.UInt32, /) -> None: ...
