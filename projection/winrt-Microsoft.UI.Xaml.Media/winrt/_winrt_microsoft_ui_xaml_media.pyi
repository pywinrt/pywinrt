...
class BrushCollection(winrt.system.Object, winrt._winrt.MutableSequence[Brush]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[Brush]: ...
...
class DoubleCollection(winrt.system.Object, winrt._winrt.MutableSequence[winrt.system.Double]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[winrt.system.Double]: ...
...
class GeometryCollection(winrt.system.Object, winrt._winrt.MutableSequence[Geometry]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[Geometry]: ...
...
class GradientStopCollection(winrt.system.Object, winrt._winrt.MutableSequence[GradientStop]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[GradientStop]: ...
...
class LinearGradientBrush(winrt.system.Object, metaclass=LinearGradientBrush_Static):
    ...
    @typing.overload
    def __new__(cls: typing.Type[LinearGradientBrush], gradient_stop_collection: GradientStopCollection, angle: winrt.system.Double) -> LinearGradientBrush: ...
    @typing.overload
...
class LoadedImageSurface_Static(type):
    ...
    def start_load_from_stream_with_size(cls, stream: windows_storage_streams.IRandomAccessStream, desired_max_size: windows_foundation.Size, /) -> LoadedImageSurface: ...
...
class PathFigureCollection(winrt.system.Object, winrt._winrt.MutableSequence[PathFigure]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[PathFigure]: ...
...
class PathSegmentCollection(winrt.system.Object, winrt._winrt.MutableSequence[PathSegment]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[PathSegment]: ...
...
class PointCollection(winrt.system.Object, winrt._winrt.MutableSequence[windows_foundation.Point]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[windows_foundation.Point]: ...
...
class TransformCollection(winrt.system.Object, winrt._winrt.MutableSequence[Transform]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[Transform]: ...
...
class VisualTreeHelper_Static(type):
    ...
    def find_all_elements_in_host_coordinates_point(cls, intersecting_point: windows_foundation.Point, subtree: microsoft_ui_xaml.UIElement, include_all_elements: bool, /) -> windows_foundation_collections.IIterable[microsoft_ui_xaml.UIElement]: ...
    def find_all_elements_in_host_coordinates_rect(cls, intersecting_rect: windows_foundation.Rect, subtree: microsoft_ui_xaml.UIElement, include_all_elements: bool, /) -> windows_foundation_collections.IIterable[microsoft_ui_xaml.UIElement]: ...
    def find_elements_in_host_coordinates_point(cls, intersecting_point: windows_foundation.Point, subtree: microsoft_ui_xaml.UIElement, /) -> windows_foundation_collections.IIterable[microsoft_ui_xaml.UIElement]: ...
    def find_elements_in_host_coordinates_rect(cls, intersecting_rect: windows_foundation.Rect, subtree: microsoft_ui_xaml.UIElement, /) -> windows_foundation_collections.IIterable[microsoft_ui_xaml.UIElement]: ...
    ...
    def get_open_popups(cls, window: microsoft_ui_xaml.Window, /) -> windows_foundation_collections.IVectorView[microsoft_ui_xaml_controls_primitives.Popup]: ...
    def get_open_popups_for_xaml_root(cls, xaml_root: microsoft_ui_xaml.XamlRoot, /) -> windows_foundation_collections.IVectorView[microsoft_ui_xaml_controls_primitives.Popup]: ...
