...
class LoadedImageSurface_Static(type):
    ...
    def start_load_from_stream_with_size(cls, stream: typing.Optional[windows_storage_streams.IRandomAccessStream], desired_max_size: windows_foundation.Size, /) -> typing.Optional[LoadedImageSurface]: ...
    def start_load_from_uri(cls, uri: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[LoadedImageSurface]: ...
    def start_load_from_uri_with_size(cls, uri: typing.Optional[windows_foundation.Uri], desired_max_size: windows_foundation.Size, /) -> typing.Optional[LoadedImageSurface]: ...
...
class VisualTreeHelper_Static(type):
    ...
    def find_all_elements_in_host_coordinates_point(cls, intersecting_point: windows_foundation.Point, subtree: typing.Optional[microsoft_ui_xaml.UIElement], include_all_elements: bool, /) -> typing.Optional[windows_foundation_collections.IIterable[microsoft_ui_xaml.UIElement]]: ...
    def find_all_elements_in_host_coordinates_rect(cls, intersecting_rect: windows_foundation.Rect, subtree: typing.Optional[microsoft_ui_xaml.UIElement], include_all_elements: bool, /) -> typing.Optional[windows_foundation_collections.IIterable[microsoft_ui_xaml.UIElement]]: ...
    def find_elements_in_host_coordinates_point(cls, intersecting_point: windows_foundation.Point, subtree: typing.Optional[microsoft_ui_xaml.UIElement], /) -> typing.Optional[windows_foundation_collections.IIterable[microsoft_ui_xaml.UIElement]]: ...
    def find_elements_in_host_coordinates_rect(cls, intersecting_rect: windows_foundation.Rect, subtree: typing.Optional[microsoft_ui_xaml.UIElement], /) -> typing.Optional[windows_foundation_collections.IIterable[microsoft_ui_xaml.UIElement]]: ...
