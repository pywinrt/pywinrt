...
class WiFiDirectService_Static(type):
    ...
    def get_selector_with_filter(cls, service_name: str, service_info_filter: windows_storage_streams.IBuffer, /) -> str: ...
...
class WiFiDirectService(winrt.system.Object, metaclass=WiFiDirectService_Static):
    ...
    @session_info.setter
    def session_info(self, value: windows_storage_streams.IBuffer) -> None: ...
    @_property
    ...
    @_property
    def supported_configuration_methods(self) -> windows_foundation_collections.IVectorView[WiFiDirectServiceConfigurationMethod]: ...
...
class WiFiDirectServiceAdvertiser(winrt.system.Object):
    ...
    @service_info.setter
    def service_info(self, value: windows_storage_streams.IBuffer) -> None: ...
    @_property
    def prefer_group_owner_mode(self) -> bool: ...
    @prefer_group_owner_mode.setter
    def prefer_group_owner_mode(self, value: bool) -> None: ...
    ...
    def deferred_session_info(self, value: windows_storage_streams.IBuffer) -> None: ...
    @_property
    ...
    def service_error(self) -> WiFiDirectServiceError: ...
    @_property
    def preferred_configuration_methods(self) -> windows_foundation_collections.IVector[WiFiDirectServiceConfigurationMethod]: ...
    @_property
    def service_name(self) -> str: ...
    @_property
    def service_name_prefixes(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
...
class WiFiDirectServiceRemotePortAddedEventArgs(winrt.system.Object):
    ...
    @_property
    def endpoint_pairs(self) -> windows_foundation_collections.IVectorView[windows_networking.EndpointPair]: ...
    @_property
...
class WiFiDirectServiceSession(winrt.system.Object):
    ...
    def close(self) -> None: ...
    def get_connection_endpoint_pairs(self) -> windows_foundation_collections.IVectorView[windows_networking.EndpointPair]: ...
