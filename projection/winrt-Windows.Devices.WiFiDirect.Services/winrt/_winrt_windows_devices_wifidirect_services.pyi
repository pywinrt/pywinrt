...
class WiFiDirectService_Static(type):
    ...
    def get_selector_with_filter(cls, service_name: str, service_info_filter: typing.Optional[windows_storage_streams.IBuffer], /) -> str: ...
...
class WiFiDirectServiceAdvertiser(winrt.system.Object):
    ...
    def connect_async_with_pin(self, device_info: typing.Optional[windows_devices_enumeration.DeviceInformation], pin: str, /) -> windows_foundation.IAsyncOperation[WiFiDirectServiceSession]: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
