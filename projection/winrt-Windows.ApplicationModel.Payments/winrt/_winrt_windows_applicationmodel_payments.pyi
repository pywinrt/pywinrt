...
class PaymentAddress(winrt.system.Object):
    ...
    @_property
    def address_lines(self) -> windows_foundation_collections.IVectorView[str]: ...
    @address_lines.setter
    def address_lines(self, value: windows_foundation_collections.IVectorView[str]) -> None: ...
    @_property
...
class PaymentDetails(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentDetails], total: PaymentItem) -> PaymentDetails: ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentDetails], total: PaymentItem, display_items: typing.Iterable[PaymentItem]) -> PaymentDetails: ...
    @typing.overload
    ...
    @_property
    def shipping_options(self) -> windows_foundation_collections.IVectorView[PaymentShippingOption]: ...
    @shipping_options.setter
    def shipping_options(self, value: windows_foundation_collections.IVectorView[PaymentShippingOption]) -> None: ...
    @_property
    def modifiers(self) -> windows_foundation_collections.IVectorView[PaymentDetailsModifier]: ...
    @modifiers.setter
    def modifiers(self, value: windows_foundation_collections.IVectorView[PaymentDetailsModifier]) -> None: ...
    @_property
    def display_items(self) -> windows_foundation_collections.IVectorView[PaymentItem]: ...
    @display_items.setter
    def display_items(self, value: windows_foundation_collections.IVectorView[PaymentItem]) -> None: ...
...
class PaymentDetailsModifier(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentDetailsModifier], supported_method_ids: typing.Iterable[str], total: PaymentItem) -> PaymentDetailsModifier: ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentDetailsModifier], supported_method_ids: typing.Iterable[str], total: PaymentItem, additional_display_items: typing.Iterable[PaymentItem]) -> PaymentDetailsModifier: ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentDetailsModifier], supported_method_ids: typing.Iterable[str], total: PaymentItem, additional_display_items: typing.Iterable[PaymentItem], json_data: str) -> PaymentDetailsModifier: ...
    @_property
    def additional_display_items(self) -> windows_foundation_collections.IVectorView[PaymentItem]: ...
    @_property
    def json_data(self) -> str: ...
    @_property
    def supported_method_ids(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def total(self) -> PaymentItem: ...
...
class PaymentItem(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[PaymentItem], label: str, amount: PaymentCurrencyAmount) -> PaymentItem: ...
    @_property
...
class PaymentMerchantInfo(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentMerchantInfo], uri: windows_foundation.Uri) -> PaymentMerchantInfo: ...
    @typing.overload
...
class PaymentRequest(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentRequest], details: PaymentDetails, method_data: typing.Iterable[PaymentMethodData], merchant_info: PaymentMerchantInfo, options: PaymentOptions, id: str) -> PaymentRequest: ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentRequest], details: PaymentDetails, method_data: typing.Iterable[PaymentMethodData]) -> PaymentRequest: ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentRequest], details: PaymentDetails, method_data: typing.Iterable[PaymentMethodData], merchant_info: PaymentMerchantInfo) -> PaymentRequest: ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentRequest], details: PaymentDetails, method_data: typing.Iterable[PaymentMethodData], merchant_info: PaymentMerchantInfo, options: PaymentOptions) -> PaymentRequest: ...
    @_property
    def details(self) -> PaymentDetails: ...
    @_property
    def merchant_info(self) -> PaymentMerchantInfo: ...
    @_property
    def method_data(self) -> windows_foundation_collections.IVectorView[PaymentMethodData]: ...
    @_property
...
class PaymentRequestChangedResult(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentRequestChangedResult], change_accepted_by_merchant: bool, updated_payment_details: PaymentDetails) -> PaymentRequestChangedResult: ...
    @_property
...
class PaymentShippingOption(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentShippingOption], label: str, amount: PaymentCurrencyAmount) -> PaymentShippingOption: ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentShippingOption], label: str, amount: PaymentCurrencyAmount, selected: bool) -> PaymentShippingOption: ...
    @typing.overload
    def __new__(cls: typing.Type[PaymentShippingOption], label: str, amount: PaymentCurrencyAmount, selected: bool, tag: str) -> PaymentShippingOption: ...
    @_property
    def tag(self) -> str: ...
    @tag.setter
