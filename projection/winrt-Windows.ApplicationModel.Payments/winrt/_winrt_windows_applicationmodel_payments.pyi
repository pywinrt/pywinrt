...
class PaymentMediator(winrt.system.Object):
    ...
    def submit_payment_request_with_change_handler_async(self, payment_request: typing.Optional[PaymentRequest], change_handler: typing.Optional[PaymentRequestChangedHandler], /) -> windows_foundation.IAsyncOperation[PaymentRequestSubmitResult]: ...
