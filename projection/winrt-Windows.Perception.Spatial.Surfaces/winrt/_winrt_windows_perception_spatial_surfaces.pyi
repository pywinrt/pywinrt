...
class SpatialSurfaceInfo(winrt.system.Object):
    ...
    def try_compute_latest_mesh_with_options_async(self, max_triangles_per_cubic_meter: winrt.system.Double, options: SpatialSurfaceMeshOptions, /) -> windows_foundation.IAsyncOperation[SpatialSurfaceMesh]: ...
...
class SpatialSurfaceMeshOptions_Static(type):
    @_property
    def supported_triangle_index_formats(cls) -> windows_foundation_collections.IVectorView[windows_graphics_directx.DirectXPixelFormat]: ...
    @_property
    def supported_vertex_normal_formats(cls) -> windows_foundation_collections.IVectorView[windows_graphics_directx.DirectXPixelFormat]: ...
    @_property
    def supported_vertex_position_formats(cls) -> windows_foundation_collections.IVectorView[windows_graphics_directx.DirectXPixelFormat]: ...
...
class SpatialSurfaceObserver(winrt.system.Object, metaclass=SpatialSurfaceObserver_Static):
    ...
    def get_observed_surfaces(self) -> windows_foundation_collections.IMapView[_uuid.UUID, SpatialSurfaceInfo]: ...
