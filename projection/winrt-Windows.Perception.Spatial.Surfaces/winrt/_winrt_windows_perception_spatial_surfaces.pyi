...
class SpatialSurfaceInfo(winrt.system.Object):
    ...
    def try_compute_latest_mesh_with_options_async(self, max_triangles_per_cubic_meter: winrt.system.Double, options: typing.Optional[SpatialSurfaceMeshOptions], /) -> windows_foundation.IAsyncOperation[SpatialSurfaceMesh]: ...
