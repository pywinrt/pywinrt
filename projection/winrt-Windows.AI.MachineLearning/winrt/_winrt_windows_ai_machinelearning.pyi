...
class LearningModel(winrt.system.Object, metaclass=LearningModel_Static):
    ...
    def domain(self) -> str: ...
    @_property
    def input_features(self) -> windows_foundation_collections.IVectorView[ILearningModelFeatureDescriptor]: ...
    @_property
    def metadata(self) -> windows_foundation_collections.IMapView[str, str]: ...
    @_property
    def name(self) -> str: ...
    @_property
    def output_features(self) -> windows_foundation_collections.IVectorView[ILearningModelFeatureDescriptor]: ...
    @_property
...
class LearningModelSession(winrt.system.Object):
    ...
    def evaluate_features(self, features: windows_foundation_collections.IMap[str, winrt.system.Object], correlation_id: str, /) -> LearningModelEvaluationResult: ...
...
class TensorBoolean(winrt.system.Object, metaclass=TensorBoolean_Static):
    ...
    def get_as_vector_view(self) -> windows_foundation_collections.IVectorView[bool]: ...
    @_property
    def kind(self) -> LearningModelFeatureKind: ...
    @_property
    def shape(self) -> windows_foundation_collections.IVectorView[winrt.system.Int64]: ...
    @_property
...
class TensorDouble(winrt.system.Object, metaclass=TensorDouble_Static):
    ...
    def close(self) -> None: ...
    def create_reference(self) -> windows_foundation.IMemoryBufferReference: ...
    def get_as_vector_view(self) -> windows_foundation_collections.IVectorView[winrt.system.Double]: ...
    @_property
    def kind(self) -> LearningModelFeatureKind: ...
    @_property
    def shape(self) -> windows_foundation_collections.IVectorView[winrt.system.Int64]: ...
...
class TensorFloat(winrt.system.Object, metaclass=TensorFloat_Static):
    ...
    def close(self) -> None: ...
    def create_reference(self) -> windows_foundation.IMemoryBufferReference: ...
    def get_as_vector_view(self) -> windows_foundation_collections.IVectorView[winrt.system.Single]: ...
    @_property
    def kind(self) -> LearningModelFeatureKind: ...
    @_property
    def shape(self) -> windows_foundation_collections.IVectorView[winrt.system.Int64]: ...
...
class TensorInt16Bit(winrt.system.Object, metaclass=TensorInt16Bit_Static):
    ...
    def close(self) -> None: ...
    def create_reference(self) -> windows_foundation.IMemoryBufferReference: ...
    def get_as_vector_view(self) -> windows_foundation_collections.IVectorView[winrt.system.Int16]: ...
    @_property
    def kind(self) -> LearningModelFeatureKind: ...
    @_property
    def shape(self) -> windows_foundation_collections.IVectorView[winrt.system.Int64]: ...
...
class TensorInt32Bit(winrt.system.Object, metaclass=TensorInt32Bit_Static):
    ...
    def close(self) -> None: ...
    def create_reference(self) -> windows_foundation.IMemoryBufferReference: ...
    def get_as_vector_view(self) -> windows_foundation_collections.IVectorView[winrt.system.Int32]: ...
    @_property
    def kind(self) -> LearningModelFeatureKind: ...
    @_property
    def shape(self) -> windows_foundation_collections.IVectorView[winrt.system.Int64]: ...
...
class TensorInt64Bit(winrt.system.Object, metaclass=TensorInt64Bit_Static):
    ...
    def close(self) -> None: ...
    def create_reference(self) -> windows_foundation.IMemoryBufferReference: ...
    def get_as_vector_view(self) -> windows_foundation_collections.IVectorView[winrt.system.Int64]: ...
    @_property
    def kind(self) -> LearningModelFeatureKind: ...
    @_property
    def shape(self) -> windows_foundation_collections.IVectorView[winrt.system.Int64]: ...
...
class TensorInt8Bit(winrt.system.Object, metaclass=TensorInt8Bit_Static):
    ...
    def close(self) -> None: ...
    def create_reference(self) -> windows_foundation.IMemoryBufferReference: ...
    def get_as_vector_view(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt8]: ...
    @_property
    def kind(self) -> LearningModelFeatureKind: ...
    @_property
    def shape(self) -> windows_foundation_collections.IVectorView[winrt.system.Int64]: ...
...
class TensorString(winrt.system.Object, metaclass=TensorString_Static):
    ...
    def close(self) -> None: ...
    def create_reference(self) -> windows_foundation.IMemoryBufferReference: ...
    def get_as_vector_view(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def kind(self) -> LearningModelFeatureKind: ...
    @_property
    def shape(self) -> windows_foundation_collections.IVectorView[winrt.system.Int64]: ...
...
class TensorUInt16Bit(winrt.system.Object, metaclass=TensorUInt16Bit_Static):
    ...
    def close(self) -> None: ...
    def create_reference(self) -> windows_foundation.IMemoryBufferReference: ...
    def get_as_vector_view(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt16]: ...
    @_property
    def kind(self) -> LearningModelFeatureKind: ...
    @_property
    def shape(self) -> windows_foundation_collections.IVectorView[winrt.system.Int64]: ...
...
class TensorUInt32Bit(winrt.system.Object, metaclass=TensorUInt32Bit_Static):
    ...
    def close(self) -> None: ...
    def create_reference(self) -> windows_foundation.IMemoryBufferReference: ...
    def get_as_vector_view(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
    def kind(self) -> LearningModelFeatureKind: ...
    @_property
    def shape(self) -> windows_foundation_collections.IVectorView[winrt.system.Int64]: ...
...
class TensorUInt64Bit(winrt.system.Object, metaclass=TensorUInt64Bit_Static):
    ...
    def close(self) -> None: ...
    def create_reference(self) -> windows_foundation.IMemoryBufferReference: ...
    def get_as_vector_view(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt64]: ...
    @_property
    def kind(self) -> LearningModelFeatureKind: ...
    @_property
    def shape(self) -> windows_foundation_collections.IVectorView[winrt.system.Int64]: ...
