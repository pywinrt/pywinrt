...
class AmbientLight(winrt.system.Object):
    ...
    def start_animation_with_controller(self, property_name: str, animation: typing.Optional[CompositionAnimation], animation_controller: typing.Optional[AnimationController], /) -> None: ...
...
class BooleanKeyFrameAnimation(winrt.system.Object):
    ...
    def insert_expression_key_frame_with_easing_function(self, normalized_progress_key: winrt.system.Single, value: str, easing_function: typing.Optional[CompositionEasingFunction], /) -> None: ...
...
class ColorKeyFrameAnimation(winrt.system.Object):
    ...
    def insert_key_frame_with_easing_function(self, normalized_progress_key: winrt.system.Single, value: windows_ui.Color, easing_function: typing.Optional[CompositionEasingFunction], /) -> None: ...
    def populate_property_info(self, property_name: str, property_info: typing.Optional[AnimationPropertyInfo], /) -> None: ...
    def set_boolean_parameter(self, key: str, value: bool, /) -> None: ...
    def set_color_parameter(self, key: str, value: windows_ui.Color, /) -> None: ...
    def set_expression_reference_parameter(self, parameter_name: str, source: typing.Optional[IAnimationObject], /) -> None: ...
...
class CompositionEasingFunction_Static(type):
    ...
    def create_step_easing_function_with_step_count(cls, owner: typing.Optional[Compositor], step_count: winrt.system.Int32, /) -> typing.Optional[StepEasingFunction]: ...
...
class CompositionGraphicsDevice(winrt.system.Object):
    ...
    def capture_async(self, capture_visual: typing.Optional[Visual], size: windows_graphics.SizeInt32, pixel_format: microsoft_graphics_directx.DirectXPixelFormat, alpha_mode: microsoft_graphics_directx.DirectXAlphaMode, sdr_boost: winrt.system.Single, /) -> windows_foundation.IAsyncOperation[ICompositionSurface]: ...
    def close(self) -> None: ...
    def create_drawing_surface(self, size_pixels: windows_foundation.Size, pixel_format: microsoft_graphics_directx.DirectXPixelFormat, alpha_mode: microsoft_graphics_directx.DirectXAlphaMode, /) -> typing.Optional[CompositionDrawingSurface]: ...
    def create_drawing_surface2(self, size_pixels: windows_graphics.SizeInt32, pixel_format: microsoft_graphics_directx.DirectXPixelFormat, alpha_mode: microsoft_graphics_directx.DirectXAlphaMode, /) -> typing.Optional[CompositionDrawingSurface]: ...
    def create_mipmap_surface(self, size_pixels: windows_graphics.SizeInt32, pixel_format: microsoft_graphics_directx.DirectXPixelFormat, alpha_mode: microsoft_graphics_directx.DirectXAlphaMode, /) -> typing.Optional[CompositionMipmapSurface]: ...
    def create_virtual_drawing_surface(self, size_pixels: windows_graphics.SizeInt32, pixel_format: microsoft_graphics_directx.DirectXPixelFormat, alpha_mode: microsoft_graphics_directx.DirectXAlphaMode, /) -> typing.Optional[CompositionVirtualDrawingSurface]: ...
    def populate_property_info(self, property_name: str, property_info: typing.Optional[AnimationPropertyInfo], /) -> None: ...
    def start_animation(self, property_name: str, animation: typing.Optional[CompositionAnimation], /) -> None: ...
    def start_animation_group(self, value: typing.Optional[ICompositionAnimationBase], /) -> None: ...
    def start_animation_with_controller(self, property_name: str, animation: typing.Optional[CompositionAnimation], animation_controller: typing.Optional[AnimationController], /) -> None: ...
...
class Compositor(winrt.system.Object, metaclass=Compositor_Static):
    ...
    def create_color_brush_with_color(self, color: windows_ui.Color, /) -> typing.Optional[CompositionColorBrush]: ...
    def create_color_gradient_stop(self) -> typing.Optional[CompositionColorGradientStop]: ...
    def create_color_gradient_stop_with_offset_and_color(self, offset: winrt.system.Single, color: windows_ui.Color, /) -> typing.Optional[CompositionColorGradientStop]: ...
    ...
    def create_effect_factory_with_properties(self, graphics_effect: typing.Optional[windows_graphics_effects.IGraphicsEffect], animatable_properties: typing.Iterable[str], /) -> typing.Optional[CompositionEffectFactory]: ...
    ...
    def create_expression_animation_with_expression(self, expression: str, /) -> typing.Optional[ExpressionAnimation]: ...
    def create_geometric_clip(self) -> typing.Optional[CompositionGeometricClip]: ...
    def create_geometric_clip_with_geometry(self, geometry: typing.Optional[CompositionGeometry], /) -> typing.Optional[CompositionGeometricClip]: ...
    ...
    def create_inset_clip_with_insets(self, left_inset: winrt.system.Single, top_inset: winrt.system.Single, right_inset: winrt.system.Single, bottom_inset: winrt.system.Single, /) -> typing.Optional[InsetClip]: ...
    ...
    def create_path_geometry_with_path(self, path: typing.Optional[CompositionPath], /) -> typing.Optional[CompositionPathGeometry]: ...
    ...
    def create_rectangle_clip_with_sides(self, left: winrt.system.Single, top: winrt.system.Single, right: winrt.system.Single, bottom: winrt.system.Single, /) -> typing.Optional[RectangleClip]: ...
    ...
    def create_redirect_visual_with_source_visual(self, source: typing.Optional[Visual], /) -> typing.Optional[RedirectVisual]: ...
    ...
    def create_sprite_shape_with_geometry(self, geometry: typing.Optional[CompositionGeometry], /) -> typing.Optional[CompositionSpriteShape]: ...
    ...
    def create_step_easing_function_with_step_count(self, step_count: winrt.system.Int32, /) -> typing.Optional[StepEasingFunction]: ...
    def create_surface_brush(self) -> typing.Optional[CompositionSurfaceBrush]: ...
    def create_surface_brush_with_surface(self, surface: typing.Optional[ICompositionSurface], /) -> typing.Optional[CompositionSurfaceBrush]: ...
...
class PathKeyFrameAnimation(winrt.system.Object):
    ...
    def insert_key_frame_with_easing_function(self, normalized_progress_key: winrt.system.Single, path: typing.Optional[CompositionPath], easing_function: typing.Optional[CompositionEasingFunction], /) -> None: ...
    def populate_property_info(self, property_name: str, property_info: typing.Optional[AnimationPropertyInfo], /) -> None: ...
    def set_boolean_parameter(self, key: str, value: bool, /) -> None: ...
    def set_color_parameter(self, key: str, value: windows_ui.Color, /) -> None: ...
    def set_expression_reference_parameter(self, parameter_name: str, source: typing.Optional[IAnimationObject], /) -> None: ...
...
class QuaternionKeyFrameAnimation(winrt.system.Object):
    ...
    def insert_key_frame_with_easing_function(self, normalized_progress_key: winrt.system.Single, value: windows_foundation_numerics.Quaternion, easing_function: typing.Optional[CompositionEasingFunction], /) -> None: ...
    def populate_property_info(self, property_name: str, property_info: typing.Optional[AnimationPropertyInfo], /) -> None: ...
    def set_boolean_parameter(self, key: str, value: bool, /) -> None: ...
    def set_color_parameter(self, key: str, value: windows_ui.Color, /) -> None: ...
    def set_expression_reference_parameter(self, parameter_name: str, source: typing.Optional[IAnimationObject], /) -> None: ...
...
class ScalarKeyFrameAnimation(winrt.system.Object):
    ...
    def insert_key_frame_with_easing_function(self, normalized_progress_key: winrt.system.Single, value: winrt.system.Single, easing_function: typing.Optional[CompositionEasingFunction], /) -> None: ...
    def populate_property_info(self, property_name: str, property_info: typing.Optional[AnimationPropertyInfo], /) -> None: ...
    def set_boolean_parameter(self, key: str, value: bool, /) -> None: ...
    def set_color_parameter(self, key: str, value: windows_ui.Color, /) -> None: ...
    def set_expression_reference_parameter(self, parameter_name: str, source: typing.Optional[IAnimationObject], /) -> None: ...
...
class Vector2KeyFrameAnimation(winrt.system.Object):
    ...
    def insert_key_frame_with_easing_function(self, normalized_progress_key: winrt.system.Single, value: windows_foundation_numerics.Vector2, easing_function: typing.Optional[CompositionEasingFunction], /) -> None: ...
    def populate_property_info(self, property_name: str, property_info: typing.Optional[AnimationPropertyInfo], /) -> None: ...
    def set_boolean_parameter(self, key: str, value: bool, /) -> None: ...
    def set_color_parameter(self, key: str, value: windows_ui.Color, /) -> None: ...
    def set_expression_reference_parameter(self, parameter_name: str, source: typing.Optional[IAnimationObject], /) -> None: ...
...
class Vector3KeyFrameAnimation(winrt.system.Object):
    ...
    def insert_key_frame_with_easing_function(self, normalized_progress_key: winrt.system.Single, value: windows_foundation_numerics.Vector3, easing_function: typing.Optional[CompositionEasingFunction], /) -> None: ...
    def populate_property_info(self, property_name: str, property_info: typing.Optional[AnimationPropertyInfo], /) -> None: ...
    def set_boolean_parameter(self, key: str, value: bool, /) -> None: ...
    def set_color_parameter(self, key: str, value: windows_ui.Color, /) -> None: ...
    def set_expression_reference_parameter(self, parameter_name: str, source: typing.Optional[IAnimationObject], /) -> None: ...
...
class Vector4KeyFrameAnimation(winrt.system.Object):
    ...
    def insert_key_frame_with_easing_function(self, normalized_progress_key: winrt.system.Single, value: windows_foundation_numerics.Vector4, easing_function: typing.Optional[CompositionEasingFunction], /) -> None: ...
    def populate_property_info(self, property_name: str, property_info: typing.Optional[AnimationPropertyInfo], /) -> None: ...
    def set_boolean_parameter(self, key: str, value: bool, /) -> None: ...
    def set_color_parameter(self, key: str, value: windows_ui.Color, /) -> None: ...
    def set_expression_reference_parameter(self, parameter_name: str, source: typing.Optional[IAnimationObject], /) -> None: ...
