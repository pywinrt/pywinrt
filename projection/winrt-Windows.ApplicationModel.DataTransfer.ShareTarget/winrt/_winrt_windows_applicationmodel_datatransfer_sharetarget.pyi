...
class QuickLink(winrt.system.Object):
    ...
    @_property
    def supported_data_formats(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def supported_file_types(self) -> windows_foundation_collections.IVector[str]: ...
...
class ShareOperation(winrt.system.Object):
    ...
    @_property
    def contacts(self) -> windows_foundation_collections.IVectorView[windows_applicationmodel_contacts.Contact]: ...
