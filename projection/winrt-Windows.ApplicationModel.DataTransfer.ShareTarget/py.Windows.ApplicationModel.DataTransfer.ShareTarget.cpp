...
PyMODINIT_FUNC PyInit__winrt_windows_applicationmodel_datatransfer_sharetarget(void) noexcept
{
    ...
    py::pytype_handle QuickLink_type{py::register_python_type(module.get(), &type_spec_QuickLink, object_bases.get(), nullptr)};
    if (!QuickLink_type)
    {
        return nullptr;
    }

    py::pytype_handle ShareOperation_type{py::register_python_type(module.get(), &type_spec_ShareOperation, object_bases.get(), nullptr)};
