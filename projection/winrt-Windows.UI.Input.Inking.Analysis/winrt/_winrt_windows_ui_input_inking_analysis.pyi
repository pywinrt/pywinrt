...
class InkAnalysisInkBullet(winrt.system.Object):
    ...
    def get_stroke_ids(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
    def recognized_text(self) -> str: ...
    @_property
    def bounding_rect(self) -> windows_foundation.Rect: ...
    @_property
    def children(self) -> windows_foundation_collections.IVectorView[IInkAnalysisNode]: ...
    @_property
    ...
    @_property
    def rotated_bounding_rect(self) -> windows_foundation_collections.IVectorView[windows_foundation.Point]: ...
...
class InkAnalysisInkDrawing(winrt.system.Object):
    ...
    @_property
    def points(self) -> windows_foundation_collections.IVectorView[windows_foundation.Point]: ...
    @_property
    def bounding_rect(self) -> windows_foundation.Rect: ...
    @_property
    def children(self) -> windows_foundation_collections.IVectorView[IInkAnalysisNode]: ...
...
class InkAnalysisInkWord(winrt.system.Object):
    ...
    def recognized_text(self) -> str: ...
    @_property
    def text_alternates(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def bounding_rect(self) -> windows_foundation.Rect: ...
    @_property
    def children(self) -> windows_foundation_collections.IVectorView[IInkAnalysisNode]: ...
...
class InkAnalysisRoot(winrt.system.Object):
    ...
    def find_nodes(self, node_kind: InkAnalysisNodeKind, /) -> windows_foundation_collections.IVectorView[IInkAnalysisNode]: ...
    def get_stroke_ids(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
    def bounding_rect(self) -> windows_foundation.Rect: ...
    @_property
