...
class XmlDocument_Static(type):
    ...
    @typing.overload
    def load_from_file_async(cls, file: typing.Optional[windows_storage.IStorageFile], load_settings: typing.Optional[XmlLoadSettings], /) -> windows_foundation.IAsyncOperation[XmlDocument]: ...
    @typing.overload
    def load_from_uri_async(cls, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperation[XmlDocument]: ...
    @typing.overload
    def load_from_uri_async(cls, uri: typing.Optional[windows_foundation.Uri], load_settings: typing.Optional[XmlLoadSettings], /) -> windows_foundation.IAsyncOperation[XmlDocument]: ...
...
class XmlDocument(winrt.system.Object, metaclass=XmlDocument_Static):
    ...
    @typing.overload
    def load_xml_from_buffer(self, buffer: typing.Optional[windows_storage_streams.IBuffer], load_settings: typing.Optional[XmlLoadSettings], /) -> None: ...
    def normalize(self) -> None: ...
    def remove_child(self, child_node: typing.Optional[IXmlNode], /) -> typing.Optional[IXmlNode]: ...
    def replace_child(self, new_child: typing.Optional[IXmlNode], reference_child: typing.Optional[IXmlNode], /) -> typing.Optional[IXmlNode]: ...
