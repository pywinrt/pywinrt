...
class XmlDocument_Static(type):
    def load_from_file_async(cls, file: typing.Optional[windows_storage.IStorageFile], /) -> windows_foundation.IAsyncOperation[XmlDocument]: ...
    def load_from_file_with_settings_async(cls, file: typing.Optional[windows_storage.IStorageFile], load_settings: typing.Optional[XmlLoadSettings], /) -> windows_foundation.IAsyncOperation[XmlDocument]: ...
    def load_from_uri_async(cls, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperation[XmlDocument]: ...
    def load_from_uri_with_settings_async(cls, uri: typing.Optional[windows_foundation.Uri], load_settings: typing.Optional[XmlLoadSettings], /) -> windows_foundation.IAsyncOperation[XmlDocument]: ...
...
class XmlDocument(winrt.system.Object, metaclass=XmlDocument_Static):
    ...
    def load_xml_from_buffer(self, buffer: typing.Optional[windows_storage_streams.IBuffer], /) -> None: ...
    def load_xml_from_buffer_with_settings(self, buffer: typing.Optional[windows_storage_streams.IBuffer], load_settings: typing.Optional[XmlLoadSettings], /) -> None: ...
    def load_xml_with_settings(self, xml: str, load_settings: typing.Optional[XmlLoadSettings], /) -> None: ...
    def normalize(self) -> None: ...
    def remove_child(self, child_node: typing.Optional[IXmlNode], /) -> typing.Optional[IXmlNode]: ...
    def replace_child(self, new_child: typing.Optional[IXmlNode], reference_child: typing.Optional[IXmlNode], /) -> typing.Optional[IXmlNode]: ...
    def save_to_file_async(self, file: typing.Optional[windows_storage.IStorageFile], /) -> windows_foundation.IAsyncAction: ...
    def select_nodes(self, xpath: str, /) -> typing.Optional[XmlNodeList]: ...
    def select_nodes_n_s(self, xpath: str, namespaces: typing.Optional[winrt.system.Object], /) -> typing.Optional[XmlNodeList]: ...
    def select_single_node(self, xpath: str, /) -> typing.Optional[IXmlNode]: ...
    def select_single_node_n_s(self, xpath: str, namespaces: typing.Optional[winrt.system.Object], /) -> typing.Optional[IXmlNode]: ...
...
class XmlNamedNodeMap(winrt.system.Object, winrt._winrt.Sequence[IXmlNode]):
    ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[IXmlNode]]: ...
