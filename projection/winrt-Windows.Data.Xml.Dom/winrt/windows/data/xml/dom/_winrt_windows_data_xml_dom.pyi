...
class DtdEntity(winrt.system.Object):
    ...
    def clone_node(self, deep: winrt.system.Boolean, /) -> typing.Optional[IXmlNode]: ...
    def get_xml(self) -> str: ...
    def has_child_nodes(self) -> winrt.system.Boolean: ...
...
class XmlAttribute(winrt.system.Object):
    value: str
    specified: winrt.system.Boolean
    name: str
    prefix: typing.Optional[winrt.system.Object]
    node_value: typing.Optional[winrt.system.Object]
    first_child: typing.Optional[IXmlNode]
...
class XmlDocument(winrt.system.Object):
    ...
    def get_xml(self) -> str: ...
    def has_child_nodes(self) -> winrt.system.Boolean: ...
    def import_node(self, node: typing.Optional[IXmlNode], deep: winrt.system.Boolean, /) -> typing.Optional[IXmlNode]: ...
    def insert_before(self, new_child: typing.Optional[IXmlNode], reference_child: typing.Optional[IXmlNode], /) -> typing.Optional[IXmlNode]: ...
    @typing.overload
    @staticmethod
...
class XmlDomImplementation(winrt.system.Object):
    ...
    def has_feature(self, feature: str, version: typing.Optional[winrt.system.Object], /) -> winrt.system.Boolean: ...
...
class XmlLoadSettings(winrt.system.Object):
    validate_on_parse: winrt.system.Boolean
    resolve_externals: winrt.system.Boolean
    prohibit_dtd: winrt.system.Boolean
    max_element_depth: winrt.system.UInt32
    element_content_white_space: winrt.system.Boolean
    @staticmethod
...
class XmlNamedNodeMap(winrt.system.Object, typing.Sequence[IXmlNode]):
    ...
    def index_of(self, value: typing.Optional[IXmlNode], /) -> typing.Tuple[winrt.system.Boolean, winrt.system.UInt32]: ...
