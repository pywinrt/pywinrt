...
class ColorPaletteResources(winrt.system.Object):
    ...
    def get_animation_base_value(self, dp: DependencyProperty, /) -> winrt.system.Object: ...
    def get_value(self, dp: DependencyProperty, /) -> winrt.system.Object: ...
    def get_view(self) -> windows_foundation_collections.IMapView[winrt.system.Object, winrt.system.Object]: ...
    ...
    @_property
    def merged_dictionaries(self) -> windows_foundation_collections.IVector[ResourceDictionary]: ...
    @_property
    def theme_dictionaries(self) -> windows_foundation_collections.IMap[winrt.system.Object, winrt.system.Object]: ...
    @_property
...
class DependencyObjectCollection(winrt.system.Object, winrt._winrt.MutableSequence[DependencyObject]):
    ...
    def get_value(self, dp: DependencyProperty, /) -> winrt.system.Object: ...
    def get_view(self) -> windows_foundation_collections.IVectorView[DependencyObject]: ...
...
class DragEventArgs(winrt.system.Object):
    ...
    @_property
    def drag_u_i_override(self) -> DragUIOverride: ...
    @_property
...
class LaunchActivatedEventArgs(winrt.system.Object):
    ...
    @_property
    def u_w_p_launch_activated_event_args(self) -> windows_applicationmodel_activation.LaunchActivatedEventArgs: ...
...
class SetterBaseCollection(winrt.system.Object, winrt._winrt.MutableSequence[SetterBase]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[SetterBase]: ...
...
class TriggerActionCollection(winrt.system.Object, winrt._winrt.MutableSequence[TriggerAction]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[TriggerAction]: ...
...
class TriggerCollection(winrt.system.Object, winrt._winrt.MutableSequence[TriggerBase]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[TriggerBase]: ...
...
class UIElement_Static(type):
    ...
    @_property
    def transform3_d_property(cls) -> DependencyProperty: ...
    @_property
...
class UIElementWeakCollection(winrt.system.Object, winrt._winrt.MutableSequence[UIElement]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[UIElement]: ...
...
class VisualState(winrt.system.Object):
    ...
    def setters(self) -> SetterBaseCollection: ...
    @_property
    def state_triggers(self) -> windows_foundation_collections.IVector[StateTriggerBase]: ...
    @_property
    def dispatcher(self) -> windows_ui_core.CoreDispatcher: ...
    @_property
    def dispatcher_queue(self) -> microsoft_ui_dispatching.DispatcherQueue: ...
...
class VisualStateGroup(winrt.system.Object):
    ...
    def name(self) -> str: ...
    @_property
    def states(self) -> windows_foundation_collections.IVector[VisualState]: ...
    @_property
    def transitions(self) -> windows_foundation_collections.IVector[VisualTransition]: ...
    @_property
    def dispatcher(self) -> windows_ui_core.CoreDispatcher: ...
    @_property
    def dispatcher_queue(self) -> microsoft_ui_dispatching.DispatcherQueue: ...
...
class VisualStateManager_Static(type):
    ...
    def get_visual_state_groups(cls, obj: FrameworkElement, /) -> windows_foundation_collections.IVector[VisualStateGroup]: ...
