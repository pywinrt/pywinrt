...
class Application_Static(type):
    ...
    def load_component_with_resource_location(cls, component: typing.Optional[winrt.system.Object], resource_locator: typing.Optional[windows_foundation.Uri], component_resource_location: microsoft_ui_xaml_controls_primitives.ComponentResourceLocation, /) -> None: ...
...
class DragUI(winrt.system.Object):
    ...
    def set_content_from_bitmap_image_with_anchor_point(self, bitmap_image: typing.Optional[microsoft_ui_xaml_media_imaging.BitmapImage], anchor_point: windows_foundation.Point, /) -> None: ...
...
class FrameworkElement(winrt.system.Object, metaclass=FrameworkElement_Static):
    ...
    def start_bring_into_view_with_options(self, options: typing.Optional[BringIntoViewOptions], /) -> None: ...
...
class PropertyMetadata_Static(type):
    def create_with_default_value(cls, default_value: typing.Optional[winrt.system.Object], /) -> typing.Optional[PropertyMetadata]: ...
    def create_with_default_value_and_callback(cls, default_value: typing.Optional[winrt.system.Object], property_changed_callback: typing.Optional[PropertyChangedCallback], /) -> typing.Optional[PropertyMetadata]: ...
    def create_with_factory(cls, create_default_value_callback: typing.Optional[CreateDefaultValueCallback], /) -> typing.Optional[PropertyMetadata]: ...
    def create_with_factory_and_callback(cls, create_default_value_callback: typing.Optional[CreateDefaultValueCallback], property_changed_callback: typing.Optional[PropertyChangedCallback], /) -> typing.Optional[PropertyMetadata]: ...
