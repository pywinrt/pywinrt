...
class WebAccountClientView(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[WebAccountClientView], view_type: WebAccountClientViewType, application_callback_uri: windows_foundation.Uri) -> WebAccountClientView: ...
    @typing.overload
    def __new__(cls: typing.Type[WebAccountClientView], view_type: WebAccountClientViewType, application_callback_uri: windows_foundation.Uri, account_pairwise_id: str) -> WebAccountClientView: ...
    @_property
...
class WebAccountManager_Static(type):
    ...
    def add_web_account_for_user_async(cls, user: windows_system.User, web_account_id: str, web_account_user_name: str, props: windows_foundation_collections.IMapView[str, str], /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccount]: ...
    ...
    def add_web_account_with_scope_and_map_for_user_async(cls, user: windows_system.User, web_account_id: str, web_account_user_name: str, props: windows_foundation_collections.IMapView[str, str], scope: WebAccountScope, per_user_web_account_id: str, /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccount]: ...
    ...
    def add_web_account_with_scope_for_user_async(cls, user: windows_system.User, web_account_id: str, web_account_user_name: str, props: windows_foundation_collections.IMapView[str, str], scope: WebAccountScope, /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccount]: ...
    ...
    def find_all_provider_web_accounts_for_user_async(cls, user: windows_system.User, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_security_credentials.WebAccount]]: ...
    ...
    def get_views_async(cls, web_account: windows_security_credentials.WebAccount, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[WebAccountClientView]]: ...
    ...
    def push_cookies_async(cls, uri: windows_foundation.Uri, cookies: windows_foundation_collections.IVectorView[windows_web_http.HttpCookie], /) -> windows_foundation.IAsyncAction: ...
    ...
    def update_web_account_properties_async(cls, web_account: windows_security_credentials.WebAccount, web_account_user_name: str, additional_properties: windows_foundation_collections.IMapView[str, str], /) -> windows_foundation.IAsyncAction: ...
...
class WebAccountProviderGetTokenSilentOperation(winrt.system.Object):
    ...
    @_property
    def provider_responses(self) -> windows_foundation_collections.IVector[WebProviderTokenResponse]: ...
...
class WebAccountProviderRetrieveCookiesOperation(winrt.system.Object):
    ...
    @_property
    def cookies(self) -> windows_foundation_collections.IVector[windows_web_http.HttpCookie]: ...
...
class WebProviderTokenRequest(winrt.system.Object):
    ...
    @_property
    def web_accounts(self) -> windows_foundation_collections.IVectorView[windows_security_credentials.WebAccount]: ...
    @_property
...
class WebProviderTokenResponse(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[WebProviderTokenResponse], web_token_response: windows_security_authentication_web_core.WebTokenResponse) -> WebProviderTokenResponse: ...
    @_property
