...
class ContentCoordinateConverter(winrt.system.Object, metaclass=ContentCoordinateConverter_Static):
    ...
    @typing.overload
    def convert_local_to_screen(self, local_points: winrt.system.Array[windows_foundation.Point], rounding_mode: ContentCoordinateRoundingMode, /) -> windows_graphics.PointInt32: ...
...
class ContentIsland_Static(type):
    ...
    def find_all_for_compositor(cls, compositor: typing.Optional[microsoft_ui_composition.Compositor], /) -> typing.Optional[ContentIsland]: ...
