...
class QueryOptions(winrt.system.Object):
    ...
    @_property
    def sort_order(self) -> windows_foundation_collections.IVector[SortEntry]: ...
    @_property
    def storage_provider_id_filter(self) -> windows_foundation_collections.IVector[str]: ...
...
class SortEntryVector(winrt.system.Object, winrt._winrt.MutableSequence[SortEntry]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[SortEntry]: ...
...
class StorageFileQueryResult(winrt.system.Object):
    ...
    def get_matching_properties_with_ranges(self, file: windows_storage.StorageFile, /) -> windows_foundation_collections.IMap[str, windows_foundation_collections.IVectorView[windows_data_text.TextSegment]]: ...
