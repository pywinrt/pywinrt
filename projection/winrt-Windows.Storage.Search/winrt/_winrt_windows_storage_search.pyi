...
class ContentIndexer_Static(type):
    ...
    def get_indexer_with_name(cls, index_name: str, /) -> typing.Optional[ContentIndexer]: ...
...
class ContentIndexer(winrt.system.Object, metaclass=ContentIndexer_Static):
    ...
    def create_query_with_sort_order(self, search_filter: str, properties_to_retrieve: typing.Iterable[str], sort_order: typing.Iterable[SortEntry], /) -> typing.Optional[ContentIndexerQuery]: ...
    def create_query_with_sort_order_and_language(self, search_filter: str, properties_to_retrieve: typing.Iterable[str], sort_order: typing.Iterable[SortEntry], search_filter_language: str, /) -> typing.Optional[ContentIndexerQuery]: ...
...
class ContentIndexerQuery(winrt.system.Object):
    ...
    def get_properties_range_async(self, start_index: winrt.system.UInt32, max_items: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_foundation_collections.IMapView[str, winrt.system.Object]]]: ...
    def get_range_async(self, start_index: winrt.system.UInt32, max_items: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[IIndexableContent]]: ...
    @_property
...
class StorageFileQueryResult(winrt.system.Object):
    ...
    def get_files_async_default_start_and_count(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_storage.StorageFile]]: ...
...
class StorageFolderQueryResult(winrt.system.Object):
    ...
    def get_folders_async_default_start_and_count(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_storage.StorageFolder]]: ...
    def get_item_count_async(self) -> windows_foundation.IAsyncOperation[winrt.system.UInt32]: ...
    def add_contents_changed(self, handler: windows_foundation.TypedEventHandler[IStorageQueryResultBase, winrt.system.Object], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_contents_changed(self, event_cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_options_changed(self, changed_handler: windows_foundation.TypedEventHandler[IStorageQueryResultBase, winrt.system.Object], /) -> windows_foundation.EventRegistrationToken: ...
...
class StorageItemQueryResult(winrt.system.Object):
    ...
    def get_items_async_default_start_and_count(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_storage.IStorageItem]]: ...
    def add_contents_changed(self, handler: windows_foundation.TypedEventHandler[IStorageQueryResultBase, winrt.system.Object], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_contents_changed(self, event_cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_options_changed(self, changed_handler: windows_foundation.TypedEventHandler[IStorageQueryResultBase, winrt.system.Object], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_options_changed(self, event_cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
...
class IStorageFolderQueryOperations(winrt.system.Object):
    ...
    def create_file_query_overload_default(self) -> typing.Optional[StorageFileQueryResult]: ...
    ...
    def create_folder_query_overload_default(self) -> typing.Optional[StorageFolderQueryResult]: ...
    ...
    def get_files_async_overload_default_start_and_count(self, query: CommonFileQuery, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_storage.StorageFile]]: ...
    ...
    def get_folders_async_overload_default_start_and_count(self, query: CommonFolderQuery, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_storage.StorageFolder]]: ...
