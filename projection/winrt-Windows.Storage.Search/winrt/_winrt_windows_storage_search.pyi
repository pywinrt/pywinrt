...
class ContentIndexerQuery(winrt.system.Object):
    ...
    def get_properties_async(self) -> windows_foundation.IAsyncOperation[typing.Sequence[windows_foundation_collections.IMapView[str, winrt.system.Object]]]: ...
    def get_properties_range_async(self, start_index: winrt.system.UInt32, max_items: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[typing.Sequence[windows_foundation_collections.IMapView[str, winrt.system.Object]]]: ...
...
class StorageFileQueryResult(winrt.system.Object):
    ...
    def get_matching_properties_with_ranges(self, file: windows_storage.StorageFile, /) -> windows_foundation_collections.IMap[str, typing.Sequence[windows_data_text.TextSegment]]: ...
