...
class ContentIndexer(winrt.system.Object, metaclass=ContentIndexer_Static):
    ...
    def add_async(self, indexable_content: ImplementsIIndexableContent, /) -> windows_foundation.IAsyncAction: ...
    ...
    def update_async(self, indexable_content: ImplementsIIndexableContent, /) -> windows_foundation.IAsyncAction: ...
    @_property
...
@typing.final
class IndexableContent(winrt.system.Object, ImplementsIIndexableContent):
    @staticmethod
...
@typing.final
class StorageFileQueryResult(winrt.system.Object, ImplementsIStorageQueryResultBase):
    @staticmethod
...
@typing.final
class StorageFolderQueryResult(winrt.system.Object, ImplementsIStorageQueryResultBase):
    @staticmethod
...
@typing.final
class StorageItemQueryResult(winrt.system.Object, ImplementsIStorageQueryResultBase):
    @staticmethod
