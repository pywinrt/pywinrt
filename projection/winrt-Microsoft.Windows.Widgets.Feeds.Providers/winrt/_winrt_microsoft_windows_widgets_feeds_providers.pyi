...
class FeedResourceResponse(winrt.system.Object):
    ...
    @_property
    def headers(self) -> windows_foundation_collections.IIterable[windows_foundation_collections.IKeyValuePair[str, str]]: ...
    @headers.setter
    def headers(self, value: windows_foundation_collections.IIterable[windows_foundation_collections.IKeyValuePair[str, str]]) -> None: ...
    @_property
    def content(self) -> windows_storage_streams.IRandomAccessStreamReference: ...
    @_property
