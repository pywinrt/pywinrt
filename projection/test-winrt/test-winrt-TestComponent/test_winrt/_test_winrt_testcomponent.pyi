...
class TestRunner_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_async_action_with_progress(cls, milliseconds: winrt.system.UInt32, items: typing.Sequence[winrt.system.Int32], /) -> windows_foundation.IAsyncActionWithProgress[winrt.system.Int32]: ...
    ...
    def create_async_action_with_progress_with_error(cls, milliseconds: winrt.system.UInt32, items: typing.Sequence[winrt.system.Int32], error: winrt.system.Int32, /) -> windows_foundation.IAsyncActionWithProgress[winrt.system.Int32]: ...
    ...
    def create_async_operation_with_progress(cls, milliseconds: winrt.system.UInt32, items: typing.Sequence[winrt.system.Int32], result: winrt.system.Int32, /) -> windows_foundation.IAsyncOperationWithProgress[winrt.system.Int32, winrt.system.Int32]: ...
    ...
    def create_async_operation_with_progress_with_error(cls, milliseconds: winrt.system.UInt32, items: typing.Sequence[winrt.system.Int32], result: winrt.system.Int32, error: winrt.system.Int32, /) -> windows_foundation.IAsyncOperationWithProgress[winrt.system.Int32, winrt.system.Int32]: ...
...
class ITests(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def collection2(self, a: typing.Union[typing.Mapping[str, str], typing.Iterable[windows_foundation_collections.IKeyValuePair[str, str]]], /) -> typing.Tuple[typing.Iterable[windows_foundation_collections.IKeyValuePair[str, str]], typing.Iterable[windows_foundation_collections.IKeyValuePair[str, str]]]: ...
