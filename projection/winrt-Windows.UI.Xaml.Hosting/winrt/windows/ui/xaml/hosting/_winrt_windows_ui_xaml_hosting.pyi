...
from . import DesignerAppViewState, XamlSourceFocusNavigationReason
...
class DesignerAppManager(winrt.system.Object):
    ...
    def load_object_into_app_async(self, dll_name: str, class_id: uuid.UUID, initialization_data: str, /) -> winrt.windows.foundation.IAsyncAction: ...
...
class ElementCompositionPreview(winrt.system.Object):
    ...
    @staticmethod
    def set_is_translation_enabled(element: typing.Optional[winrt.windows.ui.xaml.UIElement], value: bool, /) -> None: ...
...
class XamlSourceFocusNavigationRequest(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[XamlSourceFocusNavigationRequest], reason: XamlSourceFocusNavigationReason, hint_rect: winrt.windows.foundation.Rect, correlation_id: uuid.UUID) -> XamlSourceFocusNavigationRequest:...

class XamlSourceFocusNavigationResult(winrt.system.Object):
    was_focus_moved: bool
    @staticmethod
...
class XamlUIPresenter(winrt.system.Object):
    ...
    complete_timelines_automatically: typing.ClassVar[bool]
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> XamlUIPresenter: ...
    @staticmethod
    def get_flyout_placement(placement_target_bounds: winrt.windows.foundation.Rect, control_size: winrt.windows.foundation.Size, min_control_size: winrt.windows.foundation.Size, container_rect: winrt.windows.foundation.Rect, target_preferred_placement: winrt.windows.ui.xaml.controls.primitives.FlyoutPlacementMode, allow_fallbacks: bool, /) -> typing.Tuple[winrt.windows.foundation.Rect, winrt.windows.ui.xaml.controls.primitives.FlyoutPlacementMode]: ...
    @staticmethod
    def get_flyout_placement_target_info(placement_target: typing.Optional[winrt.windows.ui.xaml.FrameworkElement], preferred_placement: winrt.windows.ui.xaml.controls.primitives.FlyoutPlacementMode, /) -> typing.Tuple[winrt.windows.foundation.Rect, winrt.windows.ui.xaml.controls.primitives.FlyoutPlacementMode, bool]: ...
    @staticmethod
