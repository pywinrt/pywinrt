...
class ElementCompositionPreview_Static(type):
    def get_app_window_content(cls, app_window: typing.Optional[windows_ui_windowmanagement.AppWindow], /) -> typing.Optional[windows_ui_xaml.UIElement]: ...
    def get_element_child_visual(cls, element: typing.Optional[windows_ui_xaml.UIElement], /) -> typing.Optional[windows_ui_composition.Visual]: ...
    def get_element_visual(cls, element: typing.Optional[windows_ui_xaml.UIElement], /) -> typing.Optional[windows_ui_composition.Visual]: ...
    def get_pointer_position_property_set(cls, target_element: typing.Optional[windows_ui_xaml.UIElement], /) -> typing.Optional[windows_ui_composition.CompositionPropertySet]: ...
    def get_scroll_viewer_manipulation_property_set(cls, scroll_viewer: typing.Optional[windows_ui_xaml_controls.ScrollViewer], /) -> typing.Optional[windows_ui_composition.CompositionPropertySet]: ...
    def set_app_window_content(cls, app_window: typing.Optional[windows_ui_windowmanagement.AppWindow], xaml_content: typing.Optional[windows_ui_xaml.UIElement], /) -> None: ...
    def set_element_child_visual(cls, element: typing.Optional[windows_ui_xaml.UIElement], visual: typing.Optional[windows_ui_composition.Visual], /) -> None: ...
    def set_implicit_hide_animation(cls, element: typing.Optional[windows_ui_xaml.UIElement], animation: typing.Optional[windows_ui_composition.ICompositionAnimationBase], /) -> None: ...
    def set_implicit_show_animation(cls, element: typing.Optional[windows_ui_xaml.UIElement], animation: typing.Optional[windows_ui_composition.ICompositionAnimationBase], /) -> None: ...
    def set_is_translation_enabled(cls, element: typing.Optional[windows_ui_xaml.UIElement], value: bool, /) -> None: ...
...
class XamlUIPresenter_Static(type):
    ...
    def get_flyout_placement_target_info(cls, placement_target: typing.Optional[windows_ui_xaml.FrameworkElement], preferred_placement: windows_ui_xaml_controls_primitives.FlyoutPlacementMode, /) -> typing.Tuple[windows_foundation.Rect, windows_ui_xaml_controls_primitives.FlyoutPlacementMode, bool]: ...
...
class XamlUIPresenter(winrt.system.Object, metaclass=XamlUIPresenter_Static):
    ...
    @_property
    def root_element(self) -> typing.Optional[windows_ui_xaml.UIElement]: ...
    @root_element.setter
    def root_element(self, value: typing.Optional[windows_ui_xaml.UIElement]) -> None: ...
...
class IXamlUIPresenterHost3(winrt.system.Object):
    ...
    def resolve_dictionary_resource(self, dictionary: typing.Optional[windows_ui_xaml.ResourceDictionary], dictionary_key: typing.Optional[winrt.system.Object], suggested_value: typing.Optional[winrt.system.Object], /) -> typing.Optional[winrt.system.Object]: ...
