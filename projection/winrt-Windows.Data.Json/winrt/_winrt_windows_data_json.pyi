...
class JsonArray(winrt.system.Object, winrt._winrt.MutableSequence[IJsonValue], metaclass=JsonArray_Static):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[IJsonValue]]: ...
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[IJsonValue]]: ...
...
class JsonObject(winrt.system.Object, winrt._winrt.MutableMapping[str, IJsonValue], metaclass=JsonObject_Static):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[windows_foundation_collections.IKeyValuePair[str, IJsonValue]]]: ...
    def get_array(self) -> typing.Optional[JsonArray]: ...
    def get_boolean(self) -> bool: ...
    def get_named_array(self, name: str, /) -> typing.Optional[JsonArray]: ...
    def get_named_array_or_default(self, name: str, default_value: typing.Optional[JsonArray], /) -> typing.Optional[JsonArray]: ...
    ...
    def get_named_object_or_default(self, name: str, default_value: typing.Optional[JsonObject], /) -> typing.Optional[JsonObject]: ...
    ...
    def get_named_value_or_default(self, name: str, default_value: typing.Optional[JsonValue], /) -> typing.Optional[JsonValue]: ...
    def get_number(self) -> winrt.system.Double: ...
    def get_object(self) -> typing.Optional[JsonObject]: ...
    def get_string(self) -> str: ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IMapView[str, IJsonValue]]: ...
