...
@typing.final
class JsonArray(windows_foundation.IStringable, IJsonValue, winrt.system.Object, winrt._winrt.MutableSequence[IJsonValue], metaclass=JsonArray_Static):
...
@typing.final
class JsonObject(windows_foundation.IStringable, IJsonValue, winrt.system.Object, winrt._winrt.MutableMapping[str, IJsonValue], metaclass=JsonObject_Static):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
