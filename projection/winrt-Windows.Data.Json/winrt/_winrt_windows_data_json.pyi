...
class JsonArray(winrt.system.Object, typing.MutableSequence[IJsonValue], metaclass=JsonArray_Static):
...
class JsonObject(winrt.system.Object, typing.MutableMapping[str, IJsonValue], metaclass=JsonObject_Static):
    def __str__(self) -> str: ...
    def __len__(self) -> int: ...
