...
namespace py::cpp::Microsoft::UI::Xaml::Resources
{
    ...
    struct PyWinrtCustomXamlResourceLoader : py::py_obj_ref, winrt::Microsoft::UI::Xaml::Resources::CustomXamlResourceLoaderT<PyWinrtCustomXamlResourceLoader>
    {
        PyWinrtCustomXamlResourceLoader(PyObject* py_obj) : py::py_obj_ref(py_obj), winrt::Microsoft::UI::Xaml::Resources::CustomXamlResourceLoaderT<PyWinrtCustomXamlResourceLoader>() {}
        ...
        if (arg_count == 0)
        {
            try
            {
                if (type != self_type)
                {
                    ...
                    std::construct_at(&reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Resources::CustomXamlResourceLoader*>(self.get())->obj, nullptr);
                    reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Resources::CustomXamlResourceLoader*>(self.get())->obj = winrt::make<PyWinrtCustomXamlResourceLoader>(self.get());
