...
class LampArrayBitmapEffect(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[LampArrayBitmapEffect], lamp_array: typing.Optional[windows_devices_lights.LampArray], lamp_indexes: typing.Union[winrt.system.Array[winrt.system.Int32], winrt.system.ReadableBuffer]) -> LampArrayBitmapEffect: ...
...
class LampArrayBlinkEffect(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[LampArrayBlinkEffect], lamp_array: typing.Optional[windows_devices_lights.LampArray], lamp_indexes: typing.Union[winrt.system.Array[winrt.system.Int32], winrt.system.ReadableBuffer]) -> LampArrayBlinkEffect: ...
    @_property
...
class LampArrayColorRampEffect(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[LampArrayColorRampEffect], lamp_array: typing.Optional[windows_devices_lights.LampArray], lamp_indexes: typing.Union[winrt.system.Array[winrt.system.Int32], winrt.system.ReadableBuffer]) -> LampArrayColorRampEffect: ...
    @_property
    def start_delay(self) -> datetime.timedelta: ...
    @start_delay.setter
    def start_delay(self, value: datetime.timedelta) -> None: ...
...
class LampArrayCustomEffect(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[LampArrayCustomEffect], lamp_array: typing.Optional[windows_devices_lights.LampArray], lamp_indexes: typing.Union[winrt.system.Array[winrt.system.Int32], winrt.system.ReadableBuffer]) -> LampArrayCustomEffect: ...
...
class LampArraySolidEffect(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[LampArraySolidEffect], lamp_array: typing.Optional[windows_devices_lights.LampArray], lamp_indexes: typing.Union[winrt.system.Array[winrt.system.Int32], winrt.system.ReadableBuffer]) -> LampArraySolidEffect: ...
    @_property
    def z_index(self) -> winrt.system.Int32: ...
    @z_index.setter
    def z_index(self, value: winrt.system.Int32) -> None: ...
