...
class LampArrayBitmapEffect(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[LampArrayBitmapEffect], lamp_array: typing.Optional[windows_devices_lights.LampArray], lamp_indexes: winrt.system.Array[winrt.system.Int32]) -> LampArrayBitmapEffect: ...
...
class LampArrayBitmapRequestedEventArgs(winrt.system.Object):
    ...
    def update_bitmap(self, bitmap: typing.Optional[windows_graphics_imaging.SoftwareBitmap], /) -> None: ...
    @_property
...
class LampArrayBlinkEffect(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[LampArrayBlinkEffect], lamp_array: typing.Optional[windows_devices_lights.LampArray], lamp_indexes: winrt.system.Array[winrt.system.Int32]) -> LampArrayBlinkEffect: ...
    @_property
...
class LampArrayColorRampEffect(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[LampArrayColorRampEffect], lamp_array: typing.Optional[windows_devices_lights.LampArray], lamp_indexes: winrt.system.Array[winrt.system.Int32]) -> LampArrayColorRampEffect: ...
    @_property
    def start_delay(self) -> datetime.timedelta: ...
    @start_delay.setter
    def start_delay(self, value: datetime.timedelta) -> None: ...
...
class LampArrayCustomEffect(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[LampArrayCustomEffect], lamp_array: typing.Optional[windows_devices_lights.LampArray], lamp_indexes: winrt.system.Array[winrt.system.Int32]) -> LampArrayCustomEffect: ...
...
class LampArrayEffectPlaylist(winrt.system.Object, winrt._winrt.Sequence[ILampArrayEffect], metaclass=LampArrayEffectPlaylist_Static):
    ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[ILampArrayEffect]]: ...
...
class LampArraySolidEffect(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[LampArraySolidEffect], lamp_array: typing.Optional[windows_devices_lights.LampArray], lamp_indexes: winrt.system.Array[winrt.system.Int32]) -> LampArraySolidEffect: ...
    @_property
    def z_index(self) -> winrt.system.Int32: ...
    @z_index.setter
    def z_index(self, value: winrt.system.Int32) -> None: ...
...
class LampArrayUpdateRequestedEventArgs(winrt.system.Object):
    ...
    def set_colors_for_indices(self, desired_colors: winrt.system.Array[windows_ui.Color], lamp_indexes: winrt.system.Array[winrt.system.Int32], /) -> None: ...
    def set_single_color_for_indices(self, desired_color: windows_ui.Color, lamp_indexes: winrt.system.Array[winrt.system.Int32], /) -> None: ...
    @_property
    def since_started(self) -> datetime.timedelta: ...
