...
@typing.final
class CornerRadiusFilterConverter(microsoft_ui_xaml_data.IValueConverter, winrt.system.Object, metaclass=CornerRadiusFilterConverter_Static):
    @staticmethod
...
@typing.final
class CornerRadiusToThicknessConverter(microsoft_ui_xaml_data.IValueConverter, winrt.system.Object, metaclass=CornerRadiusToThicknessConverter_Static):
    @staticmethod
...
@typing.final
class JumpListItemBackgroundConverter(microsoft_ui_xaml_data.IValueConverter, winrt.system.Object, metaclass=JumpListItemBackgroundConverter_Static):
    @staticmethod
...
@typing.final
class JumpListItemForegroundConverter(microsoft_ui_xaml_data.IValueConverter, winrt.system.Object, metaclass=JumpListItemForegroundConverter_Static):
    @staticmethod
...
@typing.final
class LoopingSelectorPanel(IScrollSnapPointsInfo, winrt.system.Object):
    @staticmethod
...
@typing.final
class PivotPanel(IScrollSnapPointsInfo, winrt.system.Object):
    @staticmethod
...
class ScrollControllerPanRequestedEventArgs(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[ScrollControllerPanRequestedEventArgs], pointer_point: microsoft_ui_input.PointerPoint) -> ScrollControllerPanRequestedEventArgs: ...
    @_property
...
class ScrollControllerScrollByRequestedEventArgs(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[ScrollControllerScrollByRequestedEventArgs], offset_delta: winrt.system.Double, options: microsoft_ui_xaml_controls.ScrollingScrollOptions) -> ScrollControllerScrollByRequestedEventArgs: ...
    @_property
    def correlation_id(self) -> winrt.system.Int32: ...
    @correlation_id.setter
    def correlation_id(self, value: winrt.system.Int32) -> None: ...
...
class ScrollControllerScrollToRequestedEventArgs(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[ScrollControllerScrollToRequestedEventArgs], offset: winrt.system.Double, options: microsoft_ui_xaml_controls.ScrollingScrollOptions) -> ScrollControllerScrollToRequestedEventArgs: ...
    @_property
    def correlation_id(self) -> winrt.system.Int32: ...
    @correlation_id.setter
    def correlation_id(self, value: winrt.system.Int32) -> None: ...
...
class ScrollPresenter(microsoft_ui_xaml_controls.IScrollAnchorProvider, winrt.system.Object, metaclass=ScrollPresenter_Static):
    @staticmethod
