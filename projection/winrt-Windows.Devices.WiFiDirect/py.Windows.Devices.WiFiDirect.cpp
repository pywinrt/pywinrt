...
PyMODINIT_FUNC PyInit__winrt_windows_devices_wifidirect(void) noexcept
{
    ...
    py::pyobj_handle WiFiDirectAdvertisement_type{py::register_python_type(module.get(), &type_spec_WiFiDirectAdvertisement, object_bases.get(), nullptr)};
    if (!WiFiDirectAdvertisement_type)
    {
        return nullptr;
    }

    py::pyobj_handle WiFiDirectAdvertisementPublisher_type{py::register_python_type(module.get(), &type_spec_WiFiDirectAdvertisementPublisher, object_bases.get(), nullptr)};
    if (!WiFiDirectAdvertisementPublisher_type)
    {
        return nullptr;
    }

    py::pyobj_handle WiFiDirectAdvertisementPublisherStatusChangedEventArgs_type{py::register_python_type(module.get(), &type_spec_WiFiDirectAdvertisementPublisherStatusChangedEventArgs, object_bases.get(), nullptr)};
    if (!WiFiDirectAdvertisementPublisherStatusChangedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle WiFiDirectConnectionListener_type{py::register_python_type(module.get(), &type_spec_WiFiDirectConnectionListener, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle WiFiDirectConnectionParameters_type{py::register_python_type(module.get(), &type_spec_WiFiDirectConnectionParameters, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_WiFiDirectConnectionParameters_Static.get()))};
    if (!WiFiDirectConnectionParameters_type)
    {
        return nullptr;
    }

    py::pyobj_handle WiFiDirectConnectionRequest_type{py::register_python_type(module.get(), &type_spec_WiFiDirectConnectionRequest, object_bases.get(), nullptr)};
    if (!WiFiDirectConnectionRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle WiFiDirectConnectionRequestedEventArgs_type{py::register_python_type(module.get(), &type_spec_WiFiDirectConnectionRequestedEventArgs, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle WiFiDirectDevice_type{py::register_python_type(module.get(), &type_spec_WiFiDirectDevice, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_WiFiDirectDevice_Static.get()))};
    ...
    py::pyobj_handle WiFiDirectInformationElement_type{py::register_python_type(module.get(), &type_spec_WiFiDirectInformationElement, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_WiFiDirectInformationElement_Static.get()))};
    if (!WiFiDirectInformationElement_type)
    {
        return nullptr;
    }

    py::pyobj_handle WiFiDirectLegacySettings_type{py::register_python_type(module.get(), &type_spec_WiFiDirectLegacySettings, object_bases.get(), nullptr)};
