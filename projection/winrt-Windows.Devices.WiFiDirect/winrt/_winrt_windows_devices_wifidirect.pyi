...
class WiFiDirectAdvertisement(winrt.system.Object):
    ...
    @_property
    def information_elements(self) -> windows_foundation_collections.IVector[WiFiDirectInformationElement]: ...
    @information_elements.setter
    def information_elements(self, value: windows_foundation_collections.IVector[WiFiDirectInformationElement]) -> None: ...
    @_property
    def legacy_settings(self) -> WiFiDirectLegacySettings: ...
    @_property
    def supported_configuration_methods(self) -> windows_foundation_collections.IVector[WiFiDirectConfigurationMethod]: ...
...
class WiFiDirectConnectionParameters(winrt.system.Object, metaclass=WiFiDirectConnectionParameters_Static):
    ...
    @_property
    def preference_ordered_configuration_methods(self) -> windows_foundation_collections.IVector[WiFiDirectConfigurationMethod]: ...
...
class WiFiDirectInformationElement_Static(type):
    def create_from_buffer(cls, buffer: windows_storage_streams.IBuffer, /) -> windows_foundation_collections.IVector[WiFiDirectInformationElement]: ...
    def create_from_device_information(cls, device_information: windows_devices_enumeration.DeviceInformation, /) -> windows_foundation_collections.IVector[WiFiDirectInformationElement]: ...
...
class WiFiDirectInformationElement(winrt.system.Object, metaclass=WiFiDirectInformationElement_Static):
    ...
    @value.setter
    def value(self, value: windows_storage_streams.IBuffer) -> None: ...
    @_property
    def oui_type(self) -> winrt.system.UInt8: ...
    @oui_type.setter
    def oui_type(self, value: winrt.system.UInt8) -> None: ...
    @_property
    def oui(self) -> windows_storage_streams.IBuffer: ...
    @oui.setter
    def oui(self, value: windows_storage_streams.IBuffer) -> None: ...
