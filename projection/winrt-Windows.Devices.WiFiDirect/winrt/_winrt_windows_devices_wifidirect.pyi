...
@typing.final
class WiFiDirectConnectionParameters(winrt.system.Object, windows_devices_enumeration.ImplementsIDevicePairingSettings, metaclass=WiFiDirectConnectionParameters_Static):
    def __new__(cls: typing.Type[Self]) -> Self: ...
    @_property
...
@typing.final
class WiFiDirectConnectionRequest(winrt.system.Object, windows_foundation.ImplementsIClosable):
...
@typing.final
class WiFiDirectDevice(winrt.system.Object, windows_foundation.ImplementsIClosable, metaclass=WiFiDirectDevice_Static):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    def close(self) -> None: ...
...
class WiFiDirectInformationElement_Static(type):
    def create_from_buffer(cls, buffer: windows_storage_streams.ImplementsIBuffer, /) -> typing.MutableSequence[WiFiDirectInformationElement]: ...
...
class WiFiDirectInformationElement(winrt.system.Object, metaclass=WiFiDirectInformationElement_Static):
    ...
    @value.setter
    def value(self, value: windows_storage_streams.ImplementsIBuffer) -> None: ...
    @_property
    ...
    @oui.setter
    def oui(self, value: windows_storage_streams.ImplementsIBuffer) -> None: ...
