...
namespace py::cpp::Windows::UI::Xaml::Navigation
{
    ...
    struct PyWinrtFrameNavigationOptions : py::py_obj_ref, winrt::Windows::UI::Xaml::Navigation::FrameNavigationOptionsT<PyWinrtFrameNavigationOptions>
    {
        PyWinrtFrameNavigationOptions(PyObject* py_obj) : py::py_obj_ref(py_obj), winrt::Windows::UI::Xaml::Navigation::FrameNavigationOptionsT<PyWinrtFrameNavigationOptions>() {}
        ...
        if (arg_count == 0)
        {
            try
            {
                if (type != self_type)
                {
                    ...
                    std::construct_at(&reinterpret_cast<py::wrapper::Windows::UI::Xaml::Navigation::FrameNavigationOptions*>(self.get())->obj, nullptr);
                    reinterpret_cast<py::wrapper::Windows::UI::Xaml::Navigation::FrameNavigationOptions*>(self.get())->obj = winrt::make<PyWinrtFrameNavigationOptions>(self.get());
