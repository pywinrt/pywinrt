...
class FrameNavigationOptions(winrt.system.Object):
    ...
    @_property
    def transition_info_override(self) -> typing.Optional[winrt.windows.ui.xaml.media.animation.NavigationTransitionInfo]: ...
    @transition_info_override.setter
    def transition_info_override(self, value: typing.Optional[winrt.windows.ui.xaml.media.animation.NavigationTransitionInfo]) -> None: ...
    @_property
...
class NavigatingCancelEventArgs(winrt.system.Object):
    ...
    @_property
    def navigation_transition_info(self) -> typing.Optional[winrt.windows.ui.xaml.media.animation.NavigationTransitionInfo]: ...
    @_property
