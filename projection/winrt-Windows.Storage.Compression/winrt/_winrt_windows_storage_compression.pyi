...
class Compressor(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[Compressor], underlying_stream: windows_storage_streams.IOutputStream) -> Compressor: ...
    @typing.overload
    def __new__(cls: typing.Type[Compressor], underlying_stream: windows_storage_streams.IOutputStream, algorithm: CompressAlgorithm, block_size: winrt.system.UInt32) -> Compressor: ...
    def close(self) -> None: ...
...
class Decompressor(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[Decompressor], underlying_stream: windows_storage_streams.IInputStream) -> Decompressor: ...
    def close(self) -> None: ...
