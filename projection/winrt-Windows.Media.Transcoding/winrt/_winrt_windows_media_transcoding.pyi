...
class MediaTranscoder(winrt.system.Object):
    ...
    def add_audio_effect_with_settings(self, activatable_class_id: str, effect_required: bool, configuration: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
    def add_video_effect(self, activatable_class_id: str, /) -> None: ...
    def add_video_effect_with_settings(self, activatable_class_id: str, effect_required: bool, configuration: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
