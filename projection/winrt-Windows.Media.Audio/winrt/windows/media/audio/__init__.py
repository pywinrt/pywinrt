...
_ns_module._register_AudioDeviceNodeCreationStatus(AudioDeviceNodeCreationStatus)
_ns_module._register_AudioFileNodeCreationStatus(AudioFileNodeCreationStatus)
_ns_module._register_AudioGraphCreationStatus(AudioGraphCreationStatus)
_ns_module._register_AudioGraphUnrecoverableError(AudioGraphUnrecoverableError)
_ns_module._register_AudioNodeEmitterDecayKind(AudioNodeEmitterDecayKind)
_ns_module._register_AudioNodeEmitterSettings(AudioNodeEmitterSettings)
_ns_module._register_AudioNodeEmitterShapeKind(AudioNodeEmitterShapeKind)
_ns_module._register_AudioPlaybackConnectionOpenResultStatus(AudioPlaybackConnectionOpenResultStatus)
_ns_module._register_AudioPlaybackConnectionState(AudioPlaybackConnectionState)
_ns_module._register_MediaSourceAudioInputNodeCreationStatus(MediaSourceAudioInputNodeCreationStatus)
_ns_module._register_MixedRealitySpatialAudioFormatPolicy(MixedRealitySpatialAudioFormatPolicy)
_ns_module._register_QuantumSizeSelectionMode(QuantumSizeSelectionMode)
_ns_module._register_SetDefaultSpatialAudioFormatStatus(SetDefaultSpatialAudioFormatStatus)
_ns_module._register_SpatialAudioModel(SpatialAudioModel)
