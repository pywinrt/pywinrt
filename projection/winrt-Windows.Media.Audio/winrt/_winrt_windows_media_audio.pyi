...
class AudioDeviceInputNode(winrt.system.Object):
    ...
    @_property
    def outgoing_connections(self) -> windows_foundation_collections.IVectorView[AudioGraphConnection]: ...
    @_property
    ...
    @_property
    def effect_definitions(self) -> windows_foundation_collections.IVector[windows_media_effects.IAudioEffectDefinition]: ...
    @_property
...
class AudioNodeEmitter(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[AudioNodeEmitter], shape: AudioNodeEmitterShape, decay_model: AudioNodeEmitterDecayModel, settings: AudioNodeEmitterSettings) -> AudioNodeEmitter: ...
    @typing.overload
...
class AudioPlaybackConnection_Static(type):
    ...
    def try_create_from_id(cls, id: str, /) -> AudioPlaybackConnection: ...
...
class EchoEffectDefinition(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[EchoEffectDefinition], audio_graph: AudioGraph) -> EchoEffectDefinition: ...
    @_property
...
class EqualizerEffectDefinition(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[EqualizerEffectDefinition], audio_graph: AudioGraph) -> EqualizerEffectDefinition: ...
    @_property
    def bands(self) -> windows_foundation_collections.IVectorView[EqualizerBand]: ...
    @_property
    def activatable_class_id(self) -> str: ...
    @_property
    def properties(self) -> windows_foundation_collections.IPropertySet: ...
...
class LimiterEffectDefinition(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[LimiterEffectDefinition], audio_graph: AudioGraph) -> LimiterEffectDefinition: ...
    @_property
...
class ReverbEffectDefinition(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[ReverbEffectDefinition], audio_graph: AudioGraph) -> ReverbEffectDefinition: ...
    @_property
