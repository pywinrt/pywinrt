...
class AudioDeviceInputNode(winrt.system.Object):
    ...
    def add_outgoing_connection_with_gain(self, destination: typing.Optional[IAudioNode], gain: winrt.system.Double, /) -> None: ...
    def close(self) -> None: ...
...
class AudioGraph(winrt.system.Object, metaclass=AudioGraph_Static):
    ...
    def create_device_input_node_with_format_async(self, category: windows_media_capture.MediaCategory, encoding_properties: typing.Optional[windows_media_mediaproperties.AudioEncodingProperties], /) -> windows_foundation.IAsyncOperation[CreateAudioDeviceInputNodeResult]: ...
    ...
    def create_file_input_node_with_emitter_async(self, file: typing.Optional[windows_storage.IStorageFile], emitter: typing.Optional[AudioNodeEmitter], /) -> windows_foundation.IAsyncOperation[CreateAudioFileInputNodeResult]: ...
    ...
    def create_file_output_node_with_file_profile_async(self, file: typing.Optional[windows_storage.IStorageFile], file_encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], /) -> windows_foundation.IAsyncOperation[CreateAudioFileOutputNodeResult]: ...
    def create_frame_input_node(self) -> typing.Optional[AudioFrameInputNode]: ...
    def create_frame_input_node_with_format(self, encoding_properties: typing.Optional[windows_media_mediaproperties.AudioEncodingProperties], /) -> typing.Optional[AudioFrameInputNode]: ...
    def create_frame_input_node_with_format_and_emitter(self, encoding_properties: typing.Optional[windows_media_mediaproperties.AudioEncodingProperties], emitter: typing.Optional[AudioNodeEmitter], /) -> typing.Optional[AudioFrameInputNode]: ...
    def create_frame_output_node(self) -> typing.Optional[AudioFrameOutputNode]: ...
    def create_frame_output_node_with_format(self, encoding_properties: typing.Optional[windows_media_mediaproperties.AudioEncodingProperties], /) -> typing.Optional[AudioFrameOutputNode]: ...
    ...
    def create_media_source_audio_input_node_with_emitter_async(self, media_source: typing.Optional[windows_media_core.MediaSource], emitter: typing.Optional[AudioNodeEmitter], /) -> windows_foundation.IAsyncOperation[CreateMediaSourceAudioInputNodeResult]: ...
    def create_submix_node(self) -> typing.Optional[AudioSubmixNode]: ...
    def create_submix_node_with_format(self, encoding_properties: typing.Optional[windows_media_mediaproperties.AudioEncodingProperties], /) -> typing.Optional[AudioSubmixNode]: ...
    def create_submix_node_with_format_and_emitter(self, encoding_properties: typing.Optional[windows_media_mediaproperties.AudioEncodingProperties], emitter: typing.Optional[AudioNodeEmitter], /) -> typing.Optional[AudioSubmixNode]: ...
...
class AudioStateMonitor_Static(type):
    ...
    def create_for_capture_monitoring_with_category(cls, category: windows_media_capture.MediaCategory, /) -> typing.Optional[AudioStateMonitor]: ...
    ...
    def create_for_capture_monitoring_with_category_and_device_role(cls, category: windows_media_capture.MediaCategory, role: windows_media_devices.AudioDeviceRole, /) -> typing.Optional[AudioStateMonitor]: ...
    def create_for_render_monitoring(cls) -> typing.Optional[AudioStateMonitor]: ...
    def create_for_render_monitoring_with_category(cls, category: windows_media_render.AudioRenderCategory, /) -> typing.Optional[AudioStateMonitor]: ...
    ...
    def create_for_render_monitoring_with_category_and_device_role(cls, category: windows_media_render.AudioRenderCategory, role: windows_media_devices.AudioDeviceRole, /) -> typing.Optional[AudioStateMonitor]: ...
