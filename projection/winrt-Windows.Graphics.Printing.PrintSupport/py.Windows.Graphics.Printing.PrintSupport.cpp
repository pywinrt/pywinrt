...
PyMODINIT_FUNC PyInit__winrt_windows_graphics_printing_printsupport(void) noexcept
{
    ...
    py::pyobj_handle PrintSupportExtensionSession_type{py::register_python_type(module.get(), &type_spec_PrintSupportExtensionSession, object_bases.get(), nullptr)};
    if (!PrintSupportExtensionSession_type)
    {
        return nullptr;
    }

    py::pyobj_handle PrintSupportExtensionTriggerDetails_type{py::register_python_type(module.get(), &type_spec_PrintSupportExtensionTriggerDetails, object_bases.get(), nullptr)};
    if (!PrintSupportExtensionTriggerDetails_type)
    {
        return nullptr;
    }

    py::pyobj_handle PrintSupportPrintDeviceCapabilitiesChangedEventArgs_type{py::register_python_type(module.get(), &type_spec_PrintSupportPrintDeviceCapabilitiesChangedEventArgs, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle PrintSupportPrintDeviceCapabilitiesUpdatePolicy_type{py::register_python_type(module.get(), &type_spec_PrintSupportPrintDeviceCapabilitiesUpdatePolicy, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_PrintSupportPrintDeviceCapabilitiesUpdatePolicy_Static.get()))};
    if (!PrintSupportPrintDeviceCapabilitiesUpdatePolicy_type)
    {
        return nullptr;
    }

    py::pyobj_handle PrintSupportPrintTicketElement_type{py::register_python_type(module.get(), &type_spec_PrintSupportPrintTicketElement, object_bases.get(), nullptr)};
    if (!PrintSupportPrintTicketElement_type)
    {
        return nullptr;
    }

    py::pyobj_handle PrintSupportPrintTicketValidationRequestedEventArgs_type{py::register_python_type(module.get(), &type_spec_PrintSupportPrintTicketValidationRequestedEventArgs, object_bases.get(), nullptr)};
    if (!PrintSupportPrintTicketValidationRequestedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle PrintSupportPrinterSelectedEventArgs_type{py::register_python_type(module.get(), &type_spec_PrintSupportPrinterSelectedEventArgs, object_bases.get(), nullptr)};
    if (!PrintSupportPrinterSelectedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle PrintSupportSessionInfo_type{py::register_python_type(module.get(), &type_spec_PrintSupportSessionInfo, object_bases.get(), nullptr)};
    if (!PrintSupportSessionInfo_type)
    {
        return nullptr;
    }

    py::pyobj_handle PrintSupportSettingsActivatedEventArgs_type{py::register_python_type(module.get(), &type_spec_PrintSupportSettingsActivatedEventArgs, object_bases.get(), nullptr)};
    if (!PrintSupportSettingsActivatedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle PrintSupportSettingsUISession_type{py::register_python_type(module.get(), &type_spec_PrintSupportSettingsUISession, object_bases.get(), nullptr)};
