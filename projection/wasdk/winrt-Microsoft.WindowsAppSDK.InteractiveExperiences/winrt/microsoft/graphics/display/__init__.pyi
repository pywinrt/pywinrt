...
class DisplayInformation_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_for_window_id(cls, window_id: microsoft_ui.WindowId | tuple[winrt.system.UInt64], /) -> DisplayInformation: ...
...
class DisplayInformation(winrt.system.Object, windows_foundation.IClosable, metaclass=DisplayInformation_Static):
    ...
    def remove_is_stereo_enabled_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
