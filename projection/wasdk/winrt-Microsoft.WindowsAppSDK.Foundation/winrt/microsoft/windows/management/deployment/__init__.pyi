...
class PackageDeploymentProgress:
    ...
    def __new__(cls, status: PackageDeploymentProgressStatus = ..., progress: winrt.system.Double = 0) -> PackageDeploymentProgress: ...
    def __replace__(self, /, **changes: typing.Any) -> PackageDeploymentProgress: ...
    def unpack(self) -> tuple[PackageDeploymentProgressStatus, winrt.system.Double]: ...
...
class AddPackageOptions(winrt.system.Object):
    ...
    @_property
    def dependency_package_uris(self) -> _cabc.MutableSequence[windows_foundation.Uri]: ...
    ...
    @_property
    def optional_package_family_names(self) -> _cabc.MutableSequence[str]: ...
    ...
    @_property
    def optional_package_uris(self) -> _cabc.MutableSequence[windows_foundation.Uri]: ...
...
class PackageSet(winrt.system.Object):
    ...
    @_property
    def items(self) -> _cabc.MutableSequence[PackageSetItem]: ...
...
class PackageSetItem(winrt.system.Object):
    ...
    @min_version.setter
    def min_version(self, value: windows_applicationmodel.PackageVersion | tuple[winrt.system.UInt16, winrt.system.UInt16, winrt.system.UInt16, winrt.system.UInt16]) -> None: ...
...
class ProvisionPackageOptions(winrt.system.Object):
    ...
    @_property
    def projection_order_package_family_names(self) -> _cabc.MutableSequence[str]: ...
...
class RegisterPackageOptions(winrt.system.Object):
    ...
    @_property
    def dependency_package_family_names(self) -> _cabc.MutableSequence[str]: ...
