...
class CarouselPanel(microsoft_ui_xaml_controls.VirtualizingPanel, IScrollSnapPointsInfo, metaclass=CarouselPanel_Static):
    ...
    def get_regular_snap_points(self, orientation: microsoft_ui_xaml_controls.Orientation, alignment: SnapPointsAlignment, /) -> tuple[winrt.system.Single, winrt.system.Single]: ...
    @typing.final
    ...
    def make_visible(self, visual: microsoft_ui_xaml.UIElement, rectangle: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Rect: ...
    @typing.final
...
class ColorSpectrum(microsoft_ui_xaml_controls.Control, metaclass=ColorSpectrum_Static):
    ...
    @hsv_color.setter
    @typing.final
    def hsv_color(self, value: windows_foundation_numerics.Vector4 | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single]) -> None: ...
...
class DragCompletedEventArgs(microsoft_ui_xaml.RoutedEventArgs, metaclass=DragCompletedEventArgs_Static):
    def __new__(cls, horizontal_change: winrt.system.Double, vertical_change: winrt.system.Double, canceled: bool) -> typing.Self: ...
...
class DragDeltaEventArgs(microsoft_ui_xaml.RoutedEventArgs, metaclass=DragDeltaEventArgs_Static):
    def __new__(cls, horizontal_change: winrt.system.Double, vertical_change: winrt.system.Double) -> typing.Self: ...
...
class DragStartedEventArgs(microsoft_ui_xaml.RoutedEventArgs, metaclass=DragStartedEventArgs_Static):
    def __new__(cls, horizontal_offset: winrt.system.Double, vertical_offset: winrt.system.Double) -> typing.Self: ...
...
class FlyoutShowOptions(winrt.system.Object, metaclass=FlyoutShowOptions_Static):
    ...
    @_property
    def position(self) -> windows_foundation.Point | None: ...
    ...
    @position.setter
    @typing.final
    def position(self, value: windows_foundation.Point | None) -> None: ...
    ...
    @_property
    def exclusion_rect(self) -> windows_foundation.Rect | None: ...
...
class GridViewItemPresenter(microsoft_ui_xaml_controls.ContentPresenter, metaclass=GridViewItemPresenter_Static):
    ...
    @typing.final
    def selected_border_thickness(self, value: microsoft_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
    ...
    @typing.final
    def pointer_over_background_margin(self, value: microsoft_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
    ...
    @typing.final
    def content_margin(self, value: microsoft_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
...
class InfoBarPanel_Static(microsoft_ui_xaml_controls.Panel_Static):
    ...
    def set_horizontal_orientation_margin(cls, object: microsoft_ui_xaml.DependencyObject, value: microsoft_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double], /) -> None: ...
    ...
    def set_vertical_orientation_margin(cls, object: microsoft_ui_xaml.DependencyObject, value: microsoft_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double], /) -> None: ...
...
class InfoBarPanel(microsoft_ui_xaml_controls.Panel, metaclass=InfoBarPanel_Static):
    ...
    @typing.final
    def vertical_orientation_padding(self, value: microsoft_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
    ...
    @typing.final
    def horizontal_orientation_padding(self, value: microsoft_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
...
class ListViewItemPresenter(microsoft_ui_xaml_controls.ContentPresenter, metaclass=ListViewItemPresenter_Static):
    ...
    @typing.final
    def check_box_corner_radius(self, value: microsoft_ui_xaml.CornerRadius | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
    ...
    @typing.final
    def selection_indicator_corner_radius(self, value: microsoft_ui_xaml.CornerRadius | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
    ...
    @typing.final
    def reveal_border_thickness(self, value: microsoft_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
...
class LoopingSelector(microsoft_ui_xaml_controls.Control, metaclass=LoopingSelector_Static):
    ...
    @items.setter
    def items(self, value: _cabc.MutableSequence[winrt.system.Object]) -> None: ...
...
class MonochromaticOverlayPresenter(microsoft_ui_xaml_controls.Grid, metaclass=MonochromaticOverlayPresenter_Static):
    ...
    @typing.final
    def replacement_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
...
class Popup(microsoft_ui_xaml.FrameworkElement, metaclass=Popup_Static):
    ...
    def remove_actual_placement_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class RepeatedScrollSnapPoint(ScrollSnapPointBase, metaclass=RepeatedScrollSnapPoint_Static):
    def __new__(cls, offset: winrt.system.Double, interval: winrt.system.Double, start: winrt.system.Double, end: winrt.system.Double, alignment: ScrollSnapPointsAlignment) -> typing.Self: ...
...
class RepeatedZoomSnapPoint(ZoomSnapPointBase, metaclass=RepeatedZoomSnapPoint_Static):
    def __new__(cls, offset: winrt.system.Double, interval: winrt.system.Double, start: winrt.system.Double, end: winrt.system.Double) -> typing.Self: ...
...
class ScrollBar(RangeBase, metaclass=ScrollBar_Static):
    ...
    def remove_scroll(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ScrollControllerAddScrollVelocityRequestedEventArgs(winrt.system.Object):
    def __new__(cls, offset_velocity: winrt.system.Single, inertia_decay_rate: winrt.system.Single | None) -> typing.Self: ...
    ...
    @_property
    def inertia_decay_rate(self) -> winrt.system.Single | None: ...
...
class ScrollControllerPanRequestedEventArgs(winrt.system.Object):
    def __new__(cls, pointer_point: microsoft_ui_input.PointerPoint) -> typing.Self: ...
...
class ScrollControllerScrollByRequestedEventArgs(winrt.system.Object):
    def __new__(cls, offset_delta: winrt.system.Double, options: microsoft_ui_xaml_controls.ScrollingScrollOptions) -> typing.Self: ...
...
class ScrollControllerScrollToRequestedEventArgs(winrt.system.Object):
    def __new__(cls, offset: winrt.system.Double, options: microsoft_ui_xaml_controls.ScrollingScrollOptions) -> typing.Self: ...
...
class ScrollPresenter(microsoft_ui_xaml.FrameworkElement, microsoft_ui_xaml_controls.IScrollAnchorProvider, metaclass=ScrollPresenter_Static):
    ...
    def add_scroll_velocity(self, offsets_velocity: windows_foundation_numerics.Vector2 | tuple[winrt.system.Single, winrt.system.Single], inertia_decay_rate: windows_foundation_numerics.Vector2 | None, /) -> winrt.system.Int32: ...
    @typing.final
    ...
    def add_zoom_velocity(self, zoom_factor_velocity: winrt.system.Single, center_point: windows_foundation_numerics.Vector2 | None, inertia_decay_rate: winrt.system.Single | None, /) -> winrt.system.Int32: ...
    ...
    def zoom_by(self, zoom_factor_delta: winrt.system.Single, center_point: windows_foundation_numerics.Vector2 | None, /) -> winrt.system.Int32: ...
    @typing.overload
    ...
    def zoom_by(self, zoom_factor_delta: winrt.system.Single, center_point: windows_foundation_numerics.Vector2 | None, options: microsoft_ui_xaml_controls.ScrollingZoomOptions, /) -> winrt.system.Int32: ...
    @typing.final
    # Deprecated alias of zoom_by() for pywinrt v3.x compatibility.
    # System.Int32 Microsoft.UI.Xaml.Controls.Primitives.ScrollPresenter::ZoomBy(System.Single,Windows.Foundation.IReference`1<Windows.Foundation.Numerics.Vector2>,Microsoft.UI.Xaml.Controls.ScrollingZoomOptions)
    @deprecated("Use zoom_by() instead.")
    def zoom_by_with_options(self, zoom_factor_delta: winrt.system.Single, center_point: windows_foundation_numerics.Vector2 | None, options: microsoft_ui_xaml_controls.ScrollingZoomOptions, /) -> winrt.system.Int32: ...
    @typing.overload
    @typing.final
    ...
    def zoom_to(self, zoom_factor: winrt.system.Single, center_point: windows_foundation_numerics.Vector2 | None, /) -> winrt.system.Int32: ...
    @typing.overload
    ...
    def zoom_to(self, zoom_factor: winrt.system.Single, center_point: windows_foundation_numerics.Vector2 | None, options: microsoft_ui_xaml_controls.ScrollingZoomOptions, /) -> winrt.system.Int32: ...
    @typing.final
    # Deprecated alias of zoom_to() for pywinrt v3.x compatibility.
    # System.Int32 Microsoft.UI.Xaml.Controls.Primitives.ScrollPresenter::ZoomTo(System.Single,Windows.Foundation.IReference`1<Windows.Foundation.Numerics.Vector2>,Microsoft.UI.Xaml.Controls.ScrollingZoomOptions)
    @deprecated("Use zoom_to() instead.")
    def zoom_to_with_options(self, zoom_factor: winrt.system.Single, center_point: windows_foundation_numerics.Vector2 | None, options: microsoft_ui_xaml_controls.ScrollingZoomOptions, /) -> winrt.system.Int32: ...
    @typing.final
    ...
    def remove_bringing_into_view(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_extent_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_scroll_animation_starting(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_scroll_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_zoom_animation_starting(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_zoom_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    @typing.final
    def horizontal_snap_points(self) -> _cabc.MutableSequence[ScrollSnapPointBase]: ...
    ...
    @_property
    @typing.final
    def vertical_snap_points(self) -> _cabc.MutableSequence[ScrollSnapPointBase]: ...
    ...
    @_property
    @typing.final
    def zoom_snap_points(self) -> _cabc.MutableSequence[ZoomSnapPointBase]: ...
...
class ScrollSnapPoint(ScrollSnapPointBase, metaclass=ScrollSnapPoint_Static):
    def __new__(cls, snap_point_value: winrt.system.Double, alignment: ScrollSnapPointsAlignment) -> typing.Self: ...
...
class Selector(microsoft_ui_xaml_controls.ItemsControl, metaclass=Selector_Static):
    ...
    @_property
    def is_synchronized_with_current_item(self) -> bool | None: ...
    ...
    @typing.final
    def is_synchronized_with_current_item(self, value: bool | None) -> None: ...
...
class Thumb(microsoft_ui_xaml_controls.Control, metaclass=Thumb_Static):
    ...
    def remove_drag_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_drag_delta(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_drag_started(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ToggleButton(ButtonBase, metaclass=ToggleButton_Static):
    ...
    def remove_checked(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_indeterminate(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_unchecked(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @is_checked.setter
    @typing.final
    def is_checked(self, value: bool | None) -> None: ...
...
class ZoomSnapPoint(ZoomSnapPointBase, metaclass=ZoomSnapPoint_Static):
    def __new__(cls, snap_point_value: winrt.system.Double) -> typing.Self: ...
...
class IScrollController(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def remove_add_scroll_velocity_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @abstractmethod
    def remove_can_scroll_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @abstractmethod
    def remove_is_scrolling_with_mouse_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @abstractmethod
    def remove_scroll_by_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @abstractmethod
    def remove_scroll_to_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class IScrollControllerPanningInfo(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def remove_pan_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
