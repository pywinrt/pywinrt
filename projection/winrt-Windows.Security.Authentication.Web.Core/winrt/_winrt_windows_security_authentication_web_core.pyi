...
class FindAllAccountsResult(winrt.system.Object):
    ...
    @_property
    def accounts(self) -> windows_foundation_collections.IVectorView[windows_security_credentials.WebAccount]: ...
    @_property
...
class WebAuthenticationAddAccountResponse(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[WebAuthenticationAddAccountResponse], web_account: windows_security_credentials.WebAccount) -> WebAuthenticationAddAccountResponse: ...
    @_property
    def properties(self) -> windows_foundation_collections.IMap[str, str]: ...
    @_property
...
class WebAuthenticationTransferTokenRequest(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[WebAuthenticationTransferTokenRequest], provider: windows_security_credentials.WebAccountProvider, transfer_token: str) -> WebAuthenticationTransferTokenRequest: ...
    @typing.overload
    def __new__(cls: typing.Type[WebAuthenticationTransferTokenRequest], provider: windows_security_credentials.WebAccountProvider, transfer_token: str, correlation_id: str) -> WebAuthenticationTransferTokenRequest: ...
    @_property
...
class WebTokenRequest(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[WebTokenRequest], provider: windows_security_credentials.WebAccountProvider, scope: str, client_id: str) -> WebTokenRequest: ...
    @typing.overload
    def __new__(cls: typing.Type[WebTokenRequest], provider: windows_security_credentials.WebAccountProvider, scope: str, client_id: str, prompt_type: WebTokenRequestPromptType) -> WebTokenRequest: ...
    @typing.overload
    def __new__(cls: typing.Type[WebTokenRequest], provider: windows_security_credentials.WebAccountProvider) -> WebTokenRequest: ...
    @typing.overload
    def __new__(cls: typing.Type[WebTokenRequest], provider: windows_security_credentials.WebAccountProvider, scope: str) -> WebTokenRequest: ...
    @_property
    ...
    def web_account_provider(self) -> windows_security_credentials.WebAccountProvider: ...
    @_property
    def app_properties(self) -> windows_foundation_collections.IMap[str, str]: ...
    @_property
    def correlation_id(self) -> str: ...
    @correlation_id.setter
    def correlation_id(self, value: str) -> None: ...
...
class WebTokenRequestResult(winrt.system.Object):
    ...
    @_property
    def response_data(self) -> windows_foundation_collections.IVectorView[WebTokenResponse]: ...
    @_property
    def response_error(self) -> WebProviderError: ...
    @_property
...
class WebTokenResponse(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[WebTokenResponse], token: str, web_account: windows_security_credentials.WebAccount) -> WebTokenResponse: ...
    @typing.overload
    def __new__(cls: typing.Type[WebTokenResponse], token: str, web_account: windows_security_credentials.WebAccount, error: WebProviderError) -> WebTokenResponse: ...
    @typing.overload
