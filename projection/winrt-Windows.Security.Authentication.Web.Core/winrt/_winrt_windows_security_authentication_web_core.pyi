...
class WebAuthenticationAddAccountResponse(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[WebAuthenticationAddAccountResponse], web_account: typing.Optional[windows_security_credentials.WebAccount]) -> WebAuthenticationAddAccountResponse: ...
    @_property
...
class WebAuthenticationAddAccountResult(winrt.system.Object):
    ...
    @_property
    def response_data(self) -> typing.Optional[WebAuthenticationAddAccountResponse]: ...
    @_property
...
class WebAuthenticationCoreManager_Static(type):
    def add_account_with_transfer_token_async(cls, request: typing.Optional[WebAuthenticationTransferTokenRequest], /) -> windows_foundation.IAsyncOperation[WebAuthenticationAddAccountResult]: ...
    ...
    def find_account_provider_with_authority_for_user_async(cls, web_account_provider_id: str, authority: str, user: typing.Optional[windows_system.User], /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccountProvider]: ...
    ...
    def find_all_accounts_with_client_id_async(cls, provider: typing.Optional[windows_security_credentials.WebAccountProvider], client_id: str, /) -> windows_foundation.IAsyncOperation[FindAllAccountsResult]: ...
    ...
    def find_system_account_provider_with_authority_for_user_async(cls, web_account_provider_id: str, authority: str, user: typing.Optional[windows_system.User], /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccountProvider]: ...
    ...
    def get_token_silently_with_web_account_async(cls, request: typing.Optional[WebTokenRequest], web_account: typing.Optional[windows_security_credentials.WebAccount], /) -> windows_foundation.IAsyncOperation[WebTokenRequestResult]: ...
    ...
    def request_token_with_web_account_async(cls, request: typing.Optional[WebTokenRequest], web_account: typing.Optional[windows_security_credentials.WebAccount], /) -> windows_foundation.IAsyncOperation[WebTokenRequestResult]: ...
...
class WebAuthenticationTransferTokenRequest(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[WebAuthenticationTransferTokenRequest], provider: typing.Optional[windows_security_credentials.WebAccountProvider], transfer_token: str) -> WebAuthenticationTransferTokenRequest: ...
    @typing.overload
    def __new__(cls: typing.Type[WebAuthenticationTransferTokenRequest], provider: typing.Optional[windows_security_credentials.WebAccountProvider], transfer_token: str, correlation_id: str) -> WebAuthenticationTransferTokenRequest: ...
    @_property
