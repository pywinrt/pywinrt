...
PyMODINIT_FUNC PyInit__winrt_windows_ui_composition_effects(void) noexcept
{
    ...
    if (py::register_python_type(module.get(), type_name_SceneLightingEffect, &type_spec_SceneLightingEffect, nullptr, object_bases.get(), nullptr) == -1)
    #else
    if (py::register_python_type(module.get(), type_name_SceneLightingEffect, &type_spec_SceneLightingEffect, object_bases.get(), nullptr) == -1)
    #endif
    {
        return nullptr;
    }
