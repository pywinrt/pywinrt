...
class DeviceAccountConfiguration(winrt.system.Object):
    ...
    @_property
    def cal_dav_server_url(self) -> typing.Optional[windows_foundation.Uri]: ...
    @cal_dav_server_url.setter
    def cal_dav_server_url(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    ...
    @_property
    def incoming_server_credential(self) -> typing.Optional[windows_security_credentials.PasswordCredential]: ...
    @incoming_server_credential.setter
    def incoming_server_credential(self, value: typing.Optional[windows_security_credentials.PasswordCredential]) -> None: ...
    @_property
    ...
    @_property
    def card_dav_server_url(self) -> typing.Optional[windows_foundation.Uri]: ...
    @card_dav_server_url.setter
    def card_dav_server_url(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    ...
    @_property
    def outgoing_server_credential(self) -> typing.Optional[windows_security_credentials.PasswordCredential]: ...
    @outgoing_server_credential.setter
    def outgoing_server_credential(self, value: typing.Optional[windows_security_credentials.PasswordCredential]) -> None: ...
    @_property
...
class UserDataAccountSystemAccessManager_Static(type):
    def add_and_show_device_accounts_async(cls, accounts: typing.Iterable[DeviceAccountConfiguration], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[str]]: ...
    def create_device_account_async(cls, account: typing.Optional[DeviceAccountConfiguration], /) -> windows_foundation.IAsyncOperation[str]: ...
