...
class CortanaActionableInsights(winrt.system.Object, metaclass=CortanaActionableInsights_Static):
    ...
    def show_insights_for_image_with_options_async(self, image_stream: typing.Optional[windows_storage_streams.IRandomAccessStreamReference], options: typing.Optional[CortanaActionableInsightsOptions], /) -> windows_foundation.IAsyncAction: ...
    def show_insights_for_text_async(self, text: str, /) -> windows_foundation.IAsyncAction: ...
    def show_insights_for_text_with_options_async(self, text: str, options: typing.Optional[CortanaActionableInsightsOptions], /) -> windows_foundation.IAsyncAction: ...
    def show_insights_with_options_async(self, datapackage: typing.Optional[windows_applicationmodel_datatransfer.DataPackage], options: typing.Optional[CortanaActionableInsightsOptions], /) -> windows_foundation.IAsyncAction: ...
    @_property
