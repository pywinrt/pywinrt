...
class CortanaActionableInsights(winrt.system.Object):
    ...
    def is_available_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    @typing.overload
...
class CortanaPermissionsManager(winrt.system.Object):
    ...
    def are_permissions_granted_async(self, permissions: typing.Iterable[CortanaPermission], /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    @staticmethod
...
class CortanaSettings(winrt.system.Object):
    is_voice_activation_enabled: winrt.system.Boolean
    has_user_consent_to_voice_activation: winrt.system.Boolean
    @staticmethod
