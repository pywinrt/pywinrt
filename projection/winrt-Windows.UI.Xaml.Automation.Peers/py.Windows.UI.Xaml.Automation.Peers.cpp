...
namespace py::cpp::Windows::UI::Xaml::Automation::Peers
{
    struct module_state
    {
        PyObject* type_AccessibilityView;
        PyObject* type_AutomationControlType;
        PyObject* type_AutomationEvents;
        PyObject* type_AutomationHeadingLevel;
        PyObject* type_AutomationLandmarkType;
        PyObject* type_AutomationLiveSetting;
        PyObject* type_AutomationNavigationDirection;
        PyObject* type_AutomationNotificationKind;
        PyObject* type_AutomationNotificationProcessing;
        PyObject* type_AutomationOrientation;
        PyObject* type_AutomationStructureChangeType;
        PyObject* type_PatternInterface;
    ...
    static PyObject* register_AccessibilityView(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AccessibilityView)
        {
        ...
        state->type_AccessibilityView = type;
        Py_INCREF(state->type_AccessibilityView);


        Py_RETURN_NONE;
    }

    static PyObject* register_AutomationControlType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AutomationControlType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AutomationControlType = type;
        Py_INCREF(state->type_AutomationControlType);


        Py_RETURN_NONE;
    }

    static PyObject* register_AutomationEvents(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AutomationEvents)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AutomationEvents = type;
        Py_INCREF(state->type_AutomationEvents);


        Py_RETURN_NONE;
    }

    static PyObject* register_AutomationHeadingLevel(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AutomationHeadingLevel)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AutomationHeadingLevel = type;
        Py_INCREF(state->type_AutomationHeadingLevel);


        Py_RETURN_NONE;
    }

    static PyObject* register_AutomationLandmarkType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AutomationLandmarkType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AutomationLandmarkType = type;
        Py_INCREF(state->type_AutomationLandmarkType);


        Py_RETURN_NONE;
    }

    static PyObject* register_AutomationLiveSetting(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AutomationLiveSetting)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AutomationLiveSetting = type;
        Py_INCREF(state->type_AutomationLiveSetting);


        Py_RETURN_NONE;
    }

    static PyObject* register_AutomationNavigationDirection(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AutomationNavigationDirection)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AutomationNavigationDirection = type;
        Py_INCREF(state->type_AutomationNavigationDirection);


        Py_RETURN_NONE;
    }

    static PyObject* register_AutomationNotificationKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AutomationNotificationKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AutomationNotificationKind = type;
        Py_INCREF(state->type_AutomationNotificationKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_AutomationNotificationProcessing(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AutomationNotificationProcessing)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AutomationNotificationProcessing = type;
        Py_INCREF(state->type_AutomationNotificationProcessing);


        Py_RETURN_NONE;
    }

    static PyObject* register_AutomationOrientation(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AutomationOrientation)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AutomationOrientation = type;
        Py_INCREF(state->type_AutomationOrientation);


        Py_RETURN_NONE;
    }

    static PyObject* register_AutomationStructureChangeType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AutomationStructureChangeType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AutomationStructureChangeType = type;
        Py_INCREF(state->type_AutomationStructureChangeType);


        Py_RETURN_NONE;
    }

    static PyObject* register_PatternInterface(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PatternInterface)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PatternInterface = type;
        Py_INCREF(state->type_PatternInterface);
    ...
    static PyMethodDef module_methods[] = {
        {"_register_AccessibilityView", register_AccessibilityView, METH_O, "registers type"},
        {"_register_AutomationControlType", register_AutomationControlType, METH_O, "registers type"},
        {"_register_AutomationEvents", register_AutomationEvents, METH_O, "registers type"},
        {"_register_AutomationHeadingLevel", register_AutomationHeadingLevel, METH_O, "registers type"},
        {"_register_AutomationLandmarkType", register_AutomationLandmarkType, METH_O, "registers type"},
        {"_register_AutomationLiveSetting", register_AutomationLiveSetting, METH_O, "registers type"},
        {"_register_AutomationNavigationDirection", register_AutomationNavigationDirection, METH_O, "registers type"},
        {"_register_AutomationNotificationKind", register_AutomationNotificationKind, METH_O, "registers type"},
        {"_register_AutomationNotificationProcessing", register_AutomationNotificationProcessing, METH_O, "registers type"},
        {"_register_AutomationOrientation", register_AutomationOrientation, METH_O, "registers type"},
        {"_register_AutomationStructureChangeType", register_AutomationStructureChangeType, METH_O, "registers type"},
        {"_register_PatternInterface", register_PatternInterface, METH_O, "registers type"},
        {}};
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_AccessibilityView);
        Py_VISIT(state->type_AutomationControlType);
        Py_VISIT(state->type_AutomationEvents);
        Py_VISIT(state->type_AutomationHeadingLevel);
        Py_VISIT(state->type_AutomationLandmarkType);
        Py_VISIT(state->type_AutomationLiveSetting);
        Py_VISIT(state->type_AutomationNavigationDirection);
        Py_VISIT(state->type_AutomationNotificationKind);
        Py_VISIT(state->type_AutomationNotificationProcessing);
        Py_VISIT(state->type_AutomationOrientation);
        Py_VISIT(state->type_AutomationStructureChangeType);
        Py_VISIT(state->type_PatternInterface);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_AccessibilityView);
        Py_CLEAR(state->type_AutomationControlType);
        Py_CLEAR(state->type_AutomationEvents);
        Py_CLEAR(state->type_AutomationHeadingLevel);
        Py_CLEAR(state->type_AutomationLandmarkType);
        Py_CLEAR(state->type_AutomationLiveSetting);
        Py_CLEAR(state->type_AutomationNavigationDirection);
        Py_CLEAR(state->type_AutomationNotificationKind);
        Py_CLEAR(state->type_AutomationNotificationProcessing);
        Py_CLEAR(state->type_AutomationOrientation);
        Py_CLEAR(state->type_AutomationStructureChangeType);
        Py_CLEAR(state->type_PatternInterface);
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Automation::Peers::AccessibilityView>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Automation::Peers;
    ...
    auto python_type = state->type_AccessibilityView;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Automation::Peers::AccessibilityView is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Automation::Peers::AutomationControlType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Automation::Peers;
    ...
    auto python_type = state->type_AutomationControlType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Automation::Peers::AutomationControlType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Automation::Peers::AutomationEvents>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Automation::Peers;
    ...
    auto python_type = state->type_AutomationEvents;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Automation::Peers::AutomationEvents is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Automation::Peers::AutomationHeadingLevel>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Automation::Peers;
    ...
    auto python_type = state->type_AutomationHeadingLevel;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Automation::Peers::AutomationHeadingLevel is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Automation::Peers::AutomationLandmarkType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Automation::Peers;
    ...
    auto python_type = state->type_AutomationLandmarkType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Automation::Peers::AutomationLandmarkType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Automation::Peers::AutomationLiveSetting>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Automation::Peers;
    ...
    auto python_type = state->type_AutomationLiveSetting;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Automation::Peers::AutomationLiveSetting is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Automation::Peers::AutomationNavigationDirection>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Automation::Peers;
    ...
    auto python_type = state->type_AutomationNavigationDirection;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Automation::Peers::AutomationNavigationDirection is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Automation::Peers::AutomationNotificationKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Automation::Peers;
    ...
    auto python_type = state->type_AutomationNotificationKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Automation::Peers::AutomationNotificationKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Automation::Peers::AutomationNotificationProcessing>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Automation::Peers;
    ...
    auto python_type = state->type_AutomationNotificationProcessing;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Automation::Peers::AutomationNotificationProcessing is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Automation::Peers::AutomationOrientation>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Automation::Peers;
    ...
    auto python_type = state->type_AutomationOrientation;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Automation::Peers::AutomationOrientation is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Automation::Peers::AutomationStructureChangeType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Automation::Peers;
    ...
    auto python_type = state->type_AutomationStructureChangeType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Automation::Peers::AutomationStructureChangeType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Automation::Peers::PatternInterface>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Automation::Peers;
    ...
    auto python_type = state->type_PatternInterface;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Automation::Peers::PatternInterface is not registered");
        return nullptr;
    }
