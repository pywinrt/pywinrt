...
class RichEditTextDocument(winrt.system.Object):
    ...
    def get_range_from_point(self, point: windows_foundation.Point, options: PointOptions, /) -> typing.Optional[ITextRange]: ...
    def get_text(self, options: TextGetOptions, /) -> str: ...
    def load_from_stream(self, options: TextSetOptions, value: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> None: ...
    def redo(self) -> None: ...
    def save_to_stream(self, options: TextGetOptions, value: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> None: ...
...
class RichEditTextRange(winrt.system.Object):
    ...
    def get_text(self, options: TextGetOptions, /) -> str: ...
    def get_text_via_stream(self, options: TextGetOptions, value: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> None: ...
    def in_range(self, range: typing.Optional[ITextRange], /) -> bool: ...
    def in_story(self, range: typing.Optional[ITextRange], /) -> bool: ...
    def insert_image(self, width: winrt.system.Int32, height: winrt.system.Int32, ascent: winrt.system.Int32, vertical_align: VerticalCharacterAlignment, alternate_text: str, value: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> None: ...
    ...
    def set_text(self, options: TextSetOptions, value: str, /) -> None: ...
    def set_text_via_stream(self, options: TextSetOptions, value: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> None: ...
    def start_of(self, unit: TextRangeUnit, extend: bool, /) -> winrt.system.Int32: ...
    @_property
    def content_link_info(self) -> typing.Optional[ContentLinkInfo]: ...
    @content_link_info.setter
    def content_link_info(self, value: typing.Optional[ContentLinkInfo]) -> None: ...
    @_property
    def text(self) -> str: ...
    @text.setter
