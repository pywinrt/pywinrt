...
{
    auto type = py::get_python_type<winrt::Windows::UI::Text::FontWeight>();
    if (!type)
    {
        return nullptr;
    }
...
winrt::Windows::UI::Text::FontWeight py::converter<winrt::Windows::UI::Text::FontWeight>::convert_to(PyObject* obj)
{
    ...
    PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::UI::Text::FontWeight");
    throw python_exception();
}
...
namespace py::cpp::Windows::UI::Text
{
    struct module_state
    {
        PyObject* type_CaretType;
        PyObject* type_FindOptions;
        PyObject* type_FontStretch;
        PyObject* type_FontStyle;
        PyObject* type_FormatEffect;
        PyObject* type_HorizontalCharacterAlignment;
        PyObject* type_LetterCase;
        PyObject* type_LineSpacingRule;
        PyObject* type_LinkType;
        PyObject* type_MarkerAlignment;
        PyObject* type_MarkerStyle;
        PyObject* type_MarkerType;
        PyObject* type_ParagraphAlignment;
        PyObject* type_ParagraphStyle;
        PyObject* type_PointOptions;
        PyObject* type_RangeGravity;
        PyObject* type_RichEditMathMode;
        PyObject* type_SelectionOptions;
        PyObject* type_SelectionType;
        PyObject* type_TabAlignment;
        PyObject* type_TabLeader;
        PyObject* type_TextDecorations;
        PyObject* type_TextGetOptions;
        PyObject* type_TextRangeUnit;
        PyObject* type_TextScript;
        PyObject* type_TextSetOptions;
        PyObject* type_UnderlineType;
        PyObject* type_VerticalCharacterAlignment;
    ...
    static PyObject* register_CaretType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_CaretType)
        {
        ...
        state->type_CaretType = type;
        Py_INCREF(state->type_CaretType);


        Py_RETURN_NONE;
    }

    static PyObject* register_FindOptions(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_FindOptions)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_FindOptions = type;
        Py_INCREF(state->type_FindOptions);


        Py_RETURN_NONE;
    }

    static PyObject* register_FontStretch(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_FontStretch)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_FontStretch = type;
        Py_INCREF(state->type_FontStretch);


        Py_RETURN_NONE;
    }

    static PyObject* register_FontStyle(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_FontStyle)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_FontStyle = type;
        Py_INCREF(state->type_FontStyle);


        Py_RETURN_NONE;
    }

    static PyObject* register_FormatEffect(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_FormatEffect)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_FormatEffect = type;
        Py_INCREF(state->type_FormatEffect);


        Py_RETURN_NONE;
    }

    static PyObject* register_HorizontalCharacterAlignment(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_HorizontalCharacterAlignment)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_HorizontalCharacterAlignment = type;
        Py_INCREF(state->type_HorizontalCharacterAlignment);


        Py_RETURN_NONE;
    }

    static PyObject* register_LetterCase(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_LetterCase)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_LetterCase = type;
        Py_INCREF(state->type_LetterCase);


        Py_RETURN_NONE;
    }

    static PyObject* register_LineSpacingRule(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_LineSpacingRule)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_LineSpacingRule = type;
        Py_INCREF(state->type_LineSpacingRule);


        Py_RETURN_NONE;
    }

    static PyObject* register_LinkType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_LinkType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_LinkType = type;
        Py_INCREF(state->type_LinkType);


        Py_RETURN_NONE;
    }

    static PyObject* register_MarkerAlignment(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MarkerAlignment)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MarkerAlignment = type;
        Py_INCREF(state->type_MarkerAlignment);


        Py_RETURN_NONE;
    }

    static PyObject* register_MarkerStyle(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MarkerStyle)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MarkerStyle = type;
        Py_INCREF(state->type_MarkerStyle);


        Py_RETURN_NONE;
    }

    static PyObject* register_MarkerType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MarkerType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MarkerType = type;
        Py_INCREF(state->type_MarkerType);


        Py_RETURN_NONE;
    }

    static PyObject* register_ParagraphAlignment(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_ParagraphAlignment)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_ParagraphAlignment = type;
        Py_INCREF(state->type_ParagraphAlignment);


        Py_RETURN_NONE;
    }

    static PyObject* register_ParagraphStyle(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_ParagraphStyle)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_ParagraphStyle = type;
        Py_INCREF(state->type_ParagraphStyle);


        Py_RETURN_NONE;
    }

    static PyObject* register_PointOptions(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PointOptions)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PointOptions = type;
        Py_INCREF(state->type_PointOptions);


        Py_RETURN_NONE;
    }

    static PyObject* register_RangeGravity(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_RangeGravity)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_RangeGravity = type;
        Py_INCREF(state->type_RangeGravity);


        Py_RETURN_NONE;
    }

    static PyObject* register_RichEditMathMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_RichEditMathMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_RichEditMathMode = type;
        Py_INCREF(state->type_RichEditMathMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_SelectionOptions(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SelectionOptions)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SelectionOptions = type;
        Py_INCREF(state->type_SelectionOptions);


        Py_RETURN_NONE;
    }

    static PyObject* register_SelectionType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SelectionType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SelectionType = type;
        Py_INCREF(state->type_SelectionType);


        Py_RETURN_NONE;
    }

    static PyObject* register_TabAlignment(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_TabAlignment)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_TabAlignment = type;
        Py_INCREF(state->type_TabAlignment);


        Py_RETURN_NONE;
    }

    static PyObject* register_TabLeader(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_TabLeader)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_TabLeader = type;
        Py_INCREF(state->type_TabLeader);


        Py_RETURN_NONE;
    }

    static PyObject* register_TextDecorations(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_TextDecorations)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_TextDecorations = type;
        Py_INCREF(state->type_TextDecorations);


        Py_RETURN_NONE;
    }

    static PyObject* register_TextGetOptions(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_TextGetOptions)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_TextGetOptions = type;
        Py_INCREF(state->type_TextGetOptions);


        Py_RETURN_NONE;
    }

    static PyObject* register_TextRangeUnit(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_TextRangeUnit)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_TextRangeUnit = type;
        Py_INCREF(state->type_TextRangeUnit);


        Py_RETURN_NONE;
    }

    static PyObject* register_TextScript(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_TextScript)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_TextScript = type;
        Py_INCREF(state->type_TextScript);


        Py_RETURN_NONE;
    }

    static PyObject* register_TextSetOptions(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_TextSetOptions)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_TextSetOptions = type;
        Py_INCREF(state->type_TextSetOptions);


        Py_RETURN_NONE;
    }

    static PyObject* register_UnderlineType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_UnderlineType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_UnderlineType = type;
        Py_INCREF(state->type_UnderlineType);


        Py_RETURN_NONE;
    }

    static PyObject* register_VerticalCharacterAlignment(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_VerticalCharacterAlignment)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_VerticalCharacterAlignment = type;
        Py_INCREF(state->type_VerticalCharacterAlignment);
    ...
    static PyMethodDef module_methods[] = {
        {"_register_CaretType", register_CaretType, METH_O, "registers type"},
        {"_register_FindOptions", register_FindOptions, METH_O, "registers type"},
        {"_register_FontStretch", register_FontStretch, METH_O, "registers type"},
        {"_register_FontStyle", register_FontStyle, METH_O, "registers type"},
        {"_register_FormatEffect", register_FormatEffect, METH_O, "registers type"},
        {"_register_HorizontalCharacterAlignment", register_HorizontalCharacterAlignment, METH_O, "registers type"},
        {"_register_LetterCase", register_LetterCase, METH_O, "registers type"},
        {"_register_LineSpacingRule", register_LineSpacingRule, METH_O, "registers type"},
        {"_register_LinkType", register_LinkType, METH_O, "registers type"},
        {"_register_MarkerAlignment", register_MarkerAlignment, METH_O, "registers type"},
        {"_register_MarkerStyle", register_MarkerStyle, METH_O, "registers type"},
        {"_register_MarkerType", register_MarkerType, METH_O, "registers type"},
        {"_register_ParagraphAlignment", register_ParagraphAlignment, METH_O, "registers type"},
        {"_register_ParagraphStyle", register_ParagraphStyle, METH_O, "registers type"},
        {"_register_PointOptions", register_PointOptions, METH_O, "registers type"},
        {"_register_RangeGravity", register_RangeGravity, METH_O, "registers type"},
        {"_register_RichEditMathMode", register_RichEditMathMode, METH_O, "registers type"},
        {"_register_SelectionOptions", register_SelectionOptions, METH_O, "registers type"},
        {"_register_SelectionType", register_SelectionType, METH_O, "registers type"},
        {"_register_TabAlignment", register_TabAlignment, METH_O, "registers type"},
        {"_register_TabLeader", register_TabLeader, METH_O, "registers type"},
        {"_register_TextDecorations", register_TextDecorations, METH_O, "registers type"},
        {"_register_TextGetOptions", register_TextGetOptions, METH_O, "registers type"},
        {"_register_TextRangeUnit", register_TextRangeUnit, METH_O, "registers type"},
        {"_register_TextScript", register_TextScript, METH_O, "registers type"},
        {"_register_TextSetOptions", register_TextSetOptions, METH_O, "registers type"},
        {"_register_UnderlineType", register_UnderlineType, METH_O, "registers type"},
        {"_register_VerticalCharacterAlignment", register_VerticalCharacterAlignment, METH_O, "registers type"},
        {}};
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_CaretType);
        Py_VISIT(state->type_FindOptions);
        Py_VISIT(state->type_FontStretch);
        Py_VISIT(state->type_FontStyle);
        Py_VISIT(state->type_FormatEffect);
        Py_VISIT(state->type_HorizontalCharacterAlignment);
        Py_VISIT(state->type_LetterCase);
        Py_VISIT(state->type_LineSpacingRule);
        Py_VISIT(state->type_LinkType);
        Py_VISIT(state->type_MarkerAlignment);
        Py_VISIT(state->type_MarkerStyle);
        Py_VISIT(state->type_MarkerType);
        Py_VISIT(state->type_ParagraphAlignment);
        Py_VISIT(state->type_ParagraphStyle);
        Py_VISIT(state->type_PointOptions);
        Py_VISIT(state->type_RangeGravity);
        Py_VISIT(state->type_RichEditMathMode);
        Py_VISIT(state->type_SelectionOptions);
        Py_VISIT(state->type_SelectionType);
        Py_VISIT(state->type_TabAlignment);
        Py_VISIT(state->type_TabLeader);
        Py_VISIT(state->type_TextDecorations);
        Py_VISIT(state->type_TextGetOptions);
        Py_VISIT(state->type_TextRangeUnit);
        Py_VISIT(state->type_TextScript);
        Py_VISIT(state->type_TextSetOptions);
        Py_VISIT(state->type_UnderlineType);
        Py_VISIT(state->type_VerticalCharacterAlignment);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_CaretType);
        Py_CLEAR(state->type_FindOptions);
        Py_CLEAR(state->type_FontStretch);
        Py_CLEAR(state->type_FontStyle);
        Py_CLEAR(state->type_FormatEffect);
        Py_CLEAR(state->type_HorizontalCharacterAlignment);
        Py_CLEAR(state->type_LetterCase);
        Py_CLEAR(state->type_LineSpacingRule);
        Py_CLEAR(state->type_LinkType);
        Py_CLEAR(state->type_MarkerAlignment);
        Py_CLEAR(state->type_MarkerStyle);
        Py_CLEAR(state->type_MarkerType);
        Py_CLEAR(state->type_ParagraphAlignment);
        Py_CLEAR(state->type_ParagraphStyle);
        Py_CLEAR(state->type_PointOptions);
        Py_CLEAR(state->type_RangeGravity);
        Py_CLEAR(state->type_RichEditMathMode);
        Py_CLEAR(state->type_SelectionOptions);
        Py_CLEAR(state->type_SelectionType);
        Py_CLEAR(state->type_TabAlignment);
        Py_CLEAR(state->type_TabLeader);
        Py_CLEAR(state->type_TextDecorations);
        Py_CLEAR(state->type_TextGetOptions);
        Py_CLEAR(state->type_TextRangeUnit);
        Py_CLEAR(state->type_TextScript);
        Py_CLEAR(state->type_TextSetOptions);
        Py_CLEAR(state->type_UnderlineType);
        Py_CLEAR(state->type_VerticalCharacterAlignment);
...
PyObject* py::py_type<winrt::Windows::UI::Text::CaretType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_CaretType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::CaretType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::FindOptions>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_FindOptions;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::FindOptions is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::FontStretch>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_FontStretch;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::FontStretch is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::FontStyle>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_FontStyle;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::FontStyle is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::FormatEffect>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_FormatEffect;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::FormatEffect is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::HorizontalCharacterAlignment>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_HorizontalCharacterAlignment;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::HorizontalCharacterAlignment is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::LetterCase>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_LetterCase;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::LetterCase is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::LineSpacingRule>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_LineSpacingRule;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::LineSpacingRule is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::LinkType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_LinkType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::LinkType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::MarkerAlignment>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_MarkerAlignment;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::MarkerAlignment is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::MarkerStyle>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_MarkerStyle;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::MarkerStyle is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::MarkerType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_MarkerType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::MarkerType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::ParagraphAlignment>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_ParagraphAlignment;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::ParagraphAlignment is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::ParagraphStyle>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_ParagraphStyle;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::ParagraphStyle is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::PointOptions>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_PointOptions;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::PointOptions is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::RangeGravity>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_RangeGravity;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::RangeGravity is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::RichEditMathMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_RichEditMathMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::RichEditMathMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::SelectionOptions>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_SelectionOptions;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::SelectionOptions is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::SelectionType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_SelectionType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::SelectionType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::TabAlignment>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_TabAlignment;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::TabAlignment is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::TabLeader>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_TabLeader;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::TabLeader is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::TextDecorations>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_TextDecorations;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::TextDecorations is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::TextGetOptions>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_TextGetOptions;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::TextGetOptions is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::TextRangeUnit>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_TextRangeUnit;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::TextRangeUnit is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::TextScript>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_TextScript;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::TextScript is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::TextSetOptions>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_TextSetOptions;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::TextSetOptions is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::UnderlineType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_UnderlineType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::UnderlineType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Text::VerticalCharacterAlignment>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Text;
    ...
    auto python_type = state->type_VerticalCharacterAlignment;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Text::VerticalCharacterAlignment is not registered");
        return nullptr;
    }
