...
class ESim(winrt.system.Object):
    ...
    def discover_with_server_address_and_matching_id(self, server_address: str, matching_id: str, /) -> typing.Optional[ESimDiscoverResult]: ...
...
class MobileBroadbandDeviceServiceCommandEventArgs(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> MobileBroadbandDeviceServiceCommandEventArgs: ...
    @_property
    def device_id(self) -> str: ...
    @_property
    def device_service_id(self) -> _uuid.UUID: ...
...
class NetworkOperatorTetheringManager_Static(type):
    ...
    def create_from_connection_profile_with_target_adapter(cls, profile: typing.Optional[windows_networking_connectivity.ConnectionProfile], adapter: typing.Optional[windows_networking_connectivity.NetworkAdapter], /) -> typing.Optional[NetworkOperatorTetheringManager]: ...
...
class NetworkOperatorTetheringManager(winrt.system.Object, metaclass=NetworkOperatorTetheringManager_Static):
    ...
    @typing.overload
    def start_tethering_async(self, configuration: typing.Optional[NetworkOperatorTetheringSessionAccessPointConfiguration], /) -> windows_foundation.IAsyncOperation[NetworkOperatorTetheringOperationResult]: ...
...
class NetworkOperatorTetheringSessionAccessPointConfiguration(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> NetworkOperatorTetheringSessionAccessPointConfiguration: ...
    def __new__(cls: typing.Type[NetworkOperatorTetheringSessionAccessPointConfiguration]) -> NetworkOperatorTetheringSessionAccessPointConfiguration: ...
    def is_authentication_kind_supported(self, authentication_kind: TetheringWiFiAuthenticationKind, /) -> bool: ...
    def is_authentication_kind_supported_async(self, authentication_kind: TetheringWiFiAuthenticationKind, /) -> windows_foundation.IAsyncOperation[bool]: ...
    def is_band_supported(self, band: TetheringWiFiBand, /) -> bool: ...
    def is_band_supported_async(self, band: TetheringWiFiBand, /) -> windows_foundation.IAsyncOperation[bool]: ...
