...
class FdnAccessManager(winrt.system.Object):
    ...
    @staticmethod
    def request_unlock_async(contact_list_id: str, /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
...
class HotspotAuthenticationContext(winrt.system.Object):
    ...
    @staticmethod
    def try_get_authentication_context(even_token: str, /) -> typing.Tuple[bool, typing.Optional[HotspotAuthenticationContext]]: ...
    @_property
