...
class ESim(winrt.system.Object):
    ...
    def get_profiles(self) -> windows_foundation_collections.IVectorView[ESimProfile]: ...
...
class ESimDiscoverResult(winrt.system.Object):
    ...
    @_property
    def events(self) -> windows_foundation_collections.IVectorView[ESimDiscoverEvent]: ...
    @_property
...
class ESimManager_Static(type):
    def try_create_e_sim_watcher(cls) -> ESimWatcher: ...
...
class KnownCSimFilePaths_Static(type):
    @_property
    def e_f_spn(cls) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
    def gid1(cls) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
    def gid2(cls) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
...
class KnownSimFilePaths_Static(type):
    @_property
    def e_f_ons(cls) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
    def e_f_spn(cls) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
    def gid1(cls) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
...
class KnownUSimFilePaths_Static(type):
    @_property
    def e_f_opl(cls) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
    def e_f_pnn(cls) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
    def e_f_spn(cls) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
    def gid1(cls) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
...
class MobileBroadbandAccount_Static(type):
    ...
    @_property
    def available_network_account_ids(cls) -> windows_foundation_collections.IVectorView[str]: ...
...
class MobileBroadbandAccount(winrt.system.Object, metaclass=MobileBroadbandAccount_Static):
    ...
    def get_connection_profiles(self) -> windows_foundation_collections.IVectorView[windows_networking_connectivity.ConnectionProfile]: ...
    @_property
...
class MobileBroadbandCellCdma(winrt.system.Object):
    ...
    @_property
    def pilot_signal_strength_in_d_b(self) -> typing.Optional[winrt.system.Double]: ...
    @_property
...
class MobileBroadbandCellGsm(winrt.system.Object):
    ...
    def provider_id(self) -> str: ...
    @_property
    def received_signal_strength_in_d_bm(self) -> typing.Optional[winrt.system.Double]: ...
    @_property
...
class MobileBroadbandCellLte(winrt.system.Object):
    ...
    def provider_id(self) -> str: ...
    @_property
    def reference_signal_received_power_in_d_bm(self) -> typing.Optional[winrt.system.Double]: ...
    @_property
    def reference_signal_received_quality_in_d_bm(self) -> typing.Optional[winrt.system.Double]: ...
    @_property
    def timing_advance_in_bit_periods(self) -> typing.Optional[winrt.system.Int32]: ...
    @_property
...
class MobileBroadbandCellNR(winrt.system.Object):
    ...
    def reference_signal_received_quality_in_d_bm(self) -> typing.Optional[winrt.system.Double]: ...
    @_property
    def signal_to_noise_ratio_in_d_b(self) -> typing.Optional[winrt.system.Double]: ...
    @_property
...
class MobileBroadbandCellTdscdma(winrt.system.Object):
    ...
    def location_area_code(self) -> typing.Optional[winrt.system.Int32]: ...
    @_property
    def path_loss_in_d_b(self) -> typing.Optional[winrt.system.Double]: ...
    @_property
    def provider_id(self) -> str: ...
    @_property
    def received_signal_code_power_in_d_bm(self) -> typing.Optional[winrt.system.Double]: ...
    @_property
    def timing_advance_in_bit_periods(self) -> typing.Optional[winrt.system.Int32]: ...
...
class MobileBroadbandCellsInfo(winrt.system.Object):
    ...
    @_property
    def neighboring_cells_cdma(self) -> windows_foundation_collections.IVectorView[MobileBroadbandCellCdma]: ...
    @_property
    def neighboring_cells_gsm(self) -> windows_foundation_collections.IVectorView[MobileBroadbandCellGsm]: ...
    @_property
    def neighboring_cells_lte(self) -> windows_foundation_collections.IVectorView[MobileBroadbandCellLte]: ...
    @_property
    def neighboring_cells_tdscdma(self) -> windows_foundation_collections.IVectorView[MobileBroadbandCellTdscdma]: ...
    @_property
    def neighboring_cells_umts(self) -> windows_foundation_collections.IVectorView[MobileBroadbandCellUmts]: ...
    @_property
    def serving_cells_cdma(self) -> windows_foundation_collections.IVectorView[MobileBroadbandCellCdma]: ...
    @_property
    def serving_cells_gsm(self) -> windows_foundation_collections.IVectorView[MobileBroadbandCellGsm]: ...
    @_property
    def serving_cells_lte(self) -> windows_foundation_collections.IVectorView[MobileBroadbandCellLte]: ...
    @_property
    def serving_cells_tdscdma(self) -> windows_foundation_collections.IVectorView[MobileBroadbandCellTdscdma]: ...
    @_property
    def serving_cells_umts(self) -> windows_foundation_collections.IVectorView[MobileBroadbandCellUmts]: ...
    @_property
    def neighboring_cells_n_r(self) -> windows_foundation_collections.IVectorView[MobileBroadbandCellNR]: ...
    @_property
    def serving_cells_n_r(self) -> windows_foundation_collections.IVectorView[MobileBroadbandCellNR]: ...
...
class MobileBroadbandDeviceInformation(winrt.system.Object):
    ...
    @_property
    def telephone_numbers(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
...
class MobileBroadbandDeviceService(winrt.system.Object):
    ...
    @_property
    def supported_commands(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
...
class MobileBroadbandModem(winrt.system.Object, metaclass=MobileBroadbandModem_Static):
    ...
    @_property
    def device_services(self) -> windows_foundation_collections.IVectorView[MobileBroadbandDeviceServiceInformation]: ...
    @_property
...
class MobileBroadbandNetwork(winrt.system.Object):
    ...
    @_property
    def registration_uicc_apps(self) -> windows_foundation_collections.IVectorView[MobileBroadbandUiccApp]: ...
...
class MobileBroadbandNetworkRegistrationStateChangeTriggerDetails(winrt.system.Object):
    ...
    @_property
    def network_registration_state_changes(self) -> windows_foundation_collections.IVectorView[MobileBroadbandNetworkRegistrationStateChange]: ...
...
class MobileBroadbandPinLockStateChangeTriggerDetails(winrt.system.Object):
    ...
    @_property
    def pin_lock_state_changes(self) -> windows_foundation_collections.IVectorView[MobileBroadbandPinLockStateChange]: ...
...
class MobileBroadbandPinManager(winrt.system.Object):
    ...
    @_property
    def supported_pins(self) -> windows_foundation_collections.IVectorView[MobileBroadbandPinType]: ...
...
class MobileBroadbandRadioStateChangeTriggerDetails(winrt.system.Object):
    ...
    @_property
    def radio_state_changes(self) -> windows_foundation_collections.IVectorView[MobileBroadbandRadioStateChange]: ...
...
class MobileBroadbandSarManager(winrt.system.Object):
    ...
    @_property
    def antennas(self) -> windows_foundation_collections.IVectorView[MobileBroadbandAntennaSar]: ...
    @_property
...
class MobileBroadbandSlotManager(winrt.system.Object):
    ...
    def current_slot_index(self) -> winrt.system.Int32: ...
    @_property
    def slot_infos(self) -> windows_foundation_collections.IVectorView[MobileBroadbandSlotInfo]: ...
...
class MobileBroadbandUiccAppsResult(winrt.system.Object):
    ...
    def status(self) -> MobileBroadbandUiccAppOperationStatus: ...
    @_property
    def uicc_apps(self) -> windows_foundation_collections.IVectorView[MobileBroadbandUiccApp]: ...
...
class NetworkOperatorTetheringClient(winrt.system.Object):
    ...
    @_property
    def host_names(self) -> windows_foundation_collections.IVectorView[windows_networking.HostName]: ...
    @_property
...
class NetworkOperatorTetheringManager(winrt.system.Object, metaclass=NetworkOperatorTetheringManager_Static):
    ...
    def get_tethering_clients(self) -> windows_foundation_collections.IVectorView[NetworkOperatorTetheringClient]: ...
    @typing.overload
