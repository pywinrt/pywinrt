...
class PhoneNumberFormatter(winrt.system.Object, metaclass=PhoneNumberFormatter_Static):
    ...
    def format_with_output_format(self, number: typing.Optional[PhoneNumberInfo], number_format: PhoneNumberFormat, /) -> str: ...
...
class PhoneNumberInfo_Static(type):
    ...
    def try_parse_with_region(cls, input: str, region_code: str, /) -> typing.Tuple[PhoneNumberParseResult, typing.Optional[PhoneNumberInfo]]: ...
