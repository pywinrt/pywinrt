...
PyMODINIT_FUNC PyInit__winrt_windows_globalization_phonenumberformatting(void) noexcept
{
    ...
    py::pyobj_handle PhoneNumberFormatter_type{py::register_python_type(module.get(), &type_spec_PhoneNumberFormatter, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_PhoneNumberFormatter_Static.get()))};
    ...
    py::pyobj_handle PhoneNumberInfo_type{py::register_python_type(module.get(), &type_spec_PhoneNumberInfo, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_PhoneNumberInfo_Static.get()))};
