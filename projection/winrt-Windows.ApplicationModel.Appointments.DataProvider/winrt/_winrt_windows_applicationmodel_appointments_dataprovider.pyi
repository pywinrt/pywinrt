...
class AppointmentCalendarCreateOrUpdateAppointmentRequest(winrt.system.Object):
    ...
    def appointment_calendar_local_id(self) -> str: ...
    @_property
    def changed_properties(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def notify_invitees(self) -> bool: ...
...
class AppointmentCalendarForwardMeetingRequest(winrt.system.Object):
    ...
    @_property
    def invitees(self) -> windows_foundation_collections.IVectorView[windows_applicationmodel_appointments.AppointmentInvitee]: ...
    @_property
    def subject(self) -> str: ...
