...
@typing.final
class MediaPlaybackAudioTrackList(winrt.system.Object, windows_media_core.ImplementsISingleSelectMediaTrackList, winrt._winrt.Sequence[windows_media_core.AudioTrack]):
...
@typing.final
class MediaPlaybackItem(winrt.system.Object, ImplementsIMediaPlaybackSource, metaclass=MediaPlaybackItem_Static):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> MediaPlaybackItem: ...
    @typing.overload
    def __new__(cls: typing.Type[MediaPlaybackItem], source: windows_media_core.MediaSource, start_time: datetime.timedelta) -> MediaPlaybackItem: ...
    @typing.overload
    def __new__(cls: typing.Type[MediaPlaybackItem], source: windows_media_core.MediaSource, start_time: datetime.timedelta, duration_limit: datetime.timedelta) -> MediaPlaybackItem: ...
    @typing.overload
    def __new__(cls: typing.Type[MediaPlaybackItem], source: windows_media_core.MediaSource) -> MediaPlaybackItem: ...
...
@typing.final
class MediaPlaybackList(winrt.system.Object, ImplementsIMediaPlaybackSource):
    @staticmethod
...
@typing.final
class MediaPlaybackVideoTrackList(winrt.system.Object, windows_media_core.ImplementsISingleSelectMediaTrackList, winrt._winrt.Sequence[windows_media_core.VideoTrack]):
    def __len__(self) -> int: ...
...
@typing.final
class MediaPlayer(winrt.system.Object, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> MediaPlayer: ...
    def __new__(cls: typing.Type[MediaPlayer]) -> MediaPlayer: ...
    def add_audio_effect(self, activatable_class_id: str, effect_optional: bool, configuration: windows_foundation_collections.ImplementsIPropertySet, /) -> None: ...
    def add_video_effect(self, activatable_class_id: str, effect_optional: bool, effect_configuration: windows_foundation_collections.ImplementsIPropertySet, /) -> None: ...
    def close(self) -> None: ...
    def copy_frame_to_stereoscopic_video_surfaces(self, destination_left_eye: windows_graphics_directx_direct3d11.ImplementsIDirect3DSurface, destination_right_eye: windows_graphics_directx_direct3d11.ImplementsIDirect3DSurface, /) -> None: ...
    def copy_frame_to_video_surface(self, destination: windows_graphics_directx_direct3d11.ImplementsIDirect3DSurface, /) -> None: ...
    def copy_frame_to_video_surface_with_target_rectangle(self, destination: windows_graphics_directx_direct3d11.ImplementsIDirect3DSurface, target_rectangle: windows_foundation.Rect, /) -> None: ...
    ...
    def render_subtitles_to_surface(self, destination: windows_graphics_directx_direct3d11.ImplementsIDirect3DSurface, /) -> bool: ...
    def render_subtitles_to_surface_with_target_rectangle(self, destination: windows_graphics_directx_direct3d11.ImplementsIDirect3DSurface, target_rectangle: windows_foundation.Rect, /) -> bool: ...
    # @deprecated("Use Source instead of SetFileSource.  For more info, see MSDN.")
    def set_file_source(self, file: windows_storage.ImplementsIStorageFile, /) -> None: ...
    # @deprecated("Use Source instead of SetMediaSource.  For more info, see MSDN.")
    def set_media_source(self, source: windows_media_core.ImplementsIMediaSource, /) -> None: ...
    # @deprecated("Use Source instead of SetStreamSource.  For more info, see MSDN.")
    def set_stream_source(self, stream: windows_storage_streams.ImplementsIRandomAccessStream, /) -> None: ...
    ...
    @source.setter
    def source(self, value: ImplementsIMediaPlaybackSource) -> None: ...
...
@typing.final
class MediaPlayerSurface(winrt.system.Object, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
