...
class MediaBreakSchedule(winrt.system.Object):
    ...
    @_property
    def midroll_breaks(self) -> windows_foundation_collections.IVectorView[MediaBreak]: ...
    @_property
...
class MediaBreakSeekedOverEventArgs(winrt.system.Object):
    ...
    @_property
    def seeked_over_breaks(self) -> windows_foundation_collections.IVectorView[MediaBreak]: ...
...
class MediaPlaybackList(winrt.system.Object):
    ...
    @_property
    def shuffled_items(self) -> windows_foundation_collections.IVectorView[MediaPlaybackItem]: ...
    @_property
...
class MediaPlaybackSession(winrt.system.Object):
    ...
    def get_buffered_ranges(self) -> windows_foundation_collections.IVectorView[windows_media.MediaTimeRange]: ...
    def get_output_degradation_policy_state(self) -> MediaPlaybackSessionOutputDegradationPolicyState: ...
    def get_played_ranges(self) -> windows_foundation_collections.IVectorView[windows_media.MediaTimeRange]: ...
    def get_seekable_ranges(self) -> windows_foundation_collections.IVectorView[windows_media.MediaTimeRange]: ...
