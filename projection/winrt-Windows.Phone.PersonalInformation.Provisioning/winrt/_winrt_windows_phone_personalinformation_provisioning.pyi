...
class MessagePartnerProvisioningManager_Static(type):
    def import_mms_to_system_async(cls, incoming: bool, read: bool, subject: str, sender: str, recipients: typing.Sequence[str], delivery_time: datetime.datetime, attachments: typing.Sequence[windows_foundation_collections.IMapView[str, winrt.system.Object]], /) -> windows_foundation.IAsyncAction: ...
