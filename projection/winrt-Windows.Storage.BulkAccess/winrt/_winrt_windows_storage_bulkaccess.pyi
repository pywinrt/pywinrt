...
class FileInformation(winrt.system.Object):
    ...
    def copy_overload(self, destination_folder: typing.Optional[windows_storage.IStorageFolder], desired_new_name: str, option: windows_storage.NameCollisionOption, /) -> windows_foundation.IAsyncOperation[windows_storage.StorageFile]: ...
    def copy_overload_default_name_and_options(self, destination_folder: typing.Optional[windows_storage.IStorageFolder], /) -> windows_foundation.IAsyncOperation[windows_storage.StorageFile]: ...
    def copy_overload_default_options(self, destination_folder: typing.Optional[windows_storage.IStorageFolder], desired_new_name: str, /) -> windows_foundation.IAsyncOperation[windows_storage.StorageFile]: ...
    ...
    def move_overload(self, destination_folder: typing.Optional[windows_storage.IStorageFolder], desired_new_name: str, option: windows_storage.NameCollisionOption, /) -> windows_foundation.IAsyncAction: ...
    def move_overload_default_name_and_options(self, destination_folder: typing.Optional[windows_storage.IStorageFolder], /) -> windows_foundation.IAsyncAction: ...
    def move_overload_default_options(self, destination_folder: typing.Optional[windows_storage.IStorageFolder], desired_new_name: str, /) -> windows_foundation.IAsyncAction: ...
...
class FileInformationFactory(winrt.system.Object):
    ...
    def get_files_async_default_start_and_count(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[FileInformation]]: ...
    ...
    def get_folders_async_default_start_and_count(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[FolderInformation]]: ...
    ...
    def get_items_async_default_start_and_count(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[IStorageItemInformation]]: ...
...
class FolderInformation(winrt.system.Object):
    ...
    def create_file_query_overload_default(self) -> typing.Optional[windows_storage_search.StorageFileQueryResult]: ...
    ...
    def create_folder_query_overload_default(self) -> typing.Optional[windows_storage_search.StorageFolderQueryResult]: ...
    ...
    def get_files_async_overload_default_options_start_and_count(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_storage.StorageFile]]: ...
    def get_files_async_overload_default_start_and_count(self, query: windows_storage_search.CommonFileQuery, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_storage.StorageFile]]: ...
    ...
    def get_folders_async_overload_default_options_start_and_count(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_storage.StorageFolder]]: ...
    def get_folders_async_overload_default_start_and_count(self, query: windows_storage_search.CommonFolderQuery, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_storage.StorageFolder]]: ...
    ...
    def get_items_async_overload_default_start_and_count(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_storage.IStorageItem]]: ...
    def get_parent_async(self) -> windows_foundation.IAsyncOperation[windows_storage.StorageFolder]: ...
    def get_thumbnail_async(self, mode: windows_storage_fileproperties.ThumbnailMode, requested_size: winrt.system.UInt32, options: windows_storage_fileproperties.ThumbnailOptions, /) -> windows_foundation.IAsyncOperation[windows_storage_fileproperties.StorageItemThumbnail]: ...
    def get_thumbnail_async_overload_default_options(self, mode: windows_storage_fileproperties.ThumbnailMode, requested_size: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_storage_fileproperties.StorageItemThumbnail]: ...
    def get_thumbnail_async_overload_default_size_default_options(self, mode: windows_storage_fileproperties.ThumbnailMode, /) -> windows_foundation.IAsyncOperation[windows_storage_fileproperties.StorageItemThumbnail]: ...
