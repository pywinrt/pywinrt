...
class FileInformationFactory(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[FileInformationFactory], query_result: windows_storage_search.IStorageQueryResultBase, mode: windows_storage_fileproperties.ThumbnailMode) -> FileInformationFactory: ...
    @typing.overload
    def __new__(cls: typing.Type[FileInformationFactory], query_result: windows_storage_search.IStorageQueryResultBase, mode: windows_storage_fileproperties.ThumbnailMode, requested_thumbnail_size: winrt.system.UInt32) -> FileInformationFactory: ...
    @typing.overload
    def __new__(cls: typing.Type[FileInformationFactory], query_result: windows_storage_search.IStorageQueryResultBase, mode: windows_storage_fileproperties.ThumbnailMode, requested_thumbnail_size: winrt.system.UInt32, thumbnail_options: windows_storage_fileproperties.ThumbnailOptions) -> FileInformationFactory: ...
    @typing.overload
    def __new__(cls: typing.Type[FileInformationFactory], query_result: windows_storage_search.IStorageQueryResultBase, mode: windows_storage_fileproperties.ThumbnailMode, requested_thumbnail_size: winrt.system.UInt32, thumbnail_options: windows_storage_fileproperties.ThumbnailOptions, delay_load: bool) -> FileInformationFactory: ...
