...
PyMODINIT_FUNC PyInit__winrt_microsoft_windows_widgets_providers(void) noexcept
{
    ...
    py::pyobj_handle WidgetActionInvokedArgs_type{py::register_python_type(module.get(), &type_spec_WidgetActionInvokedArgs, object_bases.get(), nullptr)};
    if (!WidgetActionInvokedArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle WidgetAnalyticsInfoReportedArgs_type{py::register_python_type(module.get(), &type_spec_WidgetAnalyticsInfoReportedArgs, object_bases.get(), nullptr)};
    if (!WidgetAnalyticsInfoReportedArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle WidgetContext_type{py::register_python_type(module.get(), &type_spec_WidgetContext, object_bases.get(), nullptr)};
    if (!WidgetContext_type)
    {
        return nullptr;
    }

    py::pyobj_handle WidgetContextChangedArgs_type{py::register_python_type(module.get(), &type_spec_WidgetContextChangedArgs, object_bases.get(), nullptr)};
    if (!WidgetContextChangedArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle WidgetCustomizationRequestedArgs_type{py::register_python_type(module.get(), &type_spec_WidgetCustomizationRequestedArgs, object_bases.get(), nullptr)};
    if (!WidgetCustomizationRequestedArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle WidgetErrorInfoReportedArgs_type{py::register_python_type(module.get(), &type_spec_WidgetErrorInfoReportedArgs, object_bases.get(), nullptr)};
    if (!WidgetErrorInfoReportedArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle WidgetInfo_type{py::register_python_type(module.get(), &type_spec_WidgetInfo, object_bases.get(), nullptr)};
    if (!WidgetInfo_type)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle WidgetManager_type{py::register_python_type(module.get(), &type_spec_WidgetManager, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_WidgetManager_Static.get()))};
    ...
    py::pyobj_handle WidgetUpdateRequestOptions_type{py::register_python_type(module.get(), &type_spec_WidgetUpdateRequestOptions, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_WidgetUpdateRequestOptions_Static.get()))};
    if (!WidgetUpdateRequestOptions_type)
    {
        return nullptr;
    }

    py::pyobj_handle IWidgetManager_type{py::register_python_type(module.get(), &type_spec_IWidgetManager, object_bases.get(), nullptr)};
    if (!IWidgetManager_type)
    {
        return nullptr;
    }

    py::pyobj_handle IWidgetProvider_type{py::register_python_type(module.get(), &type_spec_IWidgetProvider, object_bases.get(), nullptr)};
    if (!IWidgetProvider_type)
    {
        return nullptr;
    }

    py::pyobj_handle IWidgetProvider2_type{py::register_python_type(module.get(), &type_spec_IWidgetProvider2, object_bases.get(), nullptr)};
    if (!IWidgetProvider2_type)
    {
        return nullptr;
    }

    py::pyobj_handle IWidgetProviderAnalytics_type{py::register_python_type(module.get(), &type_spec_IWidgetProviderAnalytics, object_bases.get(), nullptr)};
    if (!IWidgetProviderAnalytics_type)
    {
        return nullptr;
    }

    py::pyobj_handle IWidgetProviderErrors_type{py::register_python_type(module.get(), &type_spec_IWidgetProviderErrors, object_bases.get(), nullptr)};
