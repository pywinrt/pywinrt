...
PyMODINIT_FUNC PyInit__winrt_windows_applicationmodel_contacts_dataprovider(void) noexcept
{
    ...
    py::pyobj_handle ContactDataProviderConnection_type{py::register_python_type(module.get(), &type_spec_ContactDataProviderConnection, object_bases.get(), nullptr)};
    if (!ContactDataProviderConnection_type)
    {
        return nullptr;
    }

    py::pyobj_handle ContactDataProviderTriggerDetails_type{py::register_python_type(module.get(), &type_spec_ContactDataProviderTriggerDetails, object_bases.get(), nullptr)};
    if (!ContactDataProviderTriggerDetails_type)
    {
        return nullptr;
    }

    py::pyobj_handle ContactListCreateOrUpdateContactRequest_type{py::register_python_type(module.get(), &type_spec_ContactListCreateOrUpdateContactRequest, object_bases.get(), nullptr)};
    if (!ContactListCreateOrUpdateContactRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle ContactListCreateOrUpdateContactRequestEventArgs_type{py::register_python_type(module.get(), &type_spec_ContactListCreateOrUpdateContactRequestEventArgs, object_bases.get(), nullptr)};
    if (!ContactListCreateOrUpdateContactRequestEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle ContactListDeleteContactRequest_type{py::register_python_type(module.get(), &type_spec_ContactListDeleteContactRequest, object_bases.get(), nullptr)};
    if (!ContactListDeleteContactRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle ContactListDeleteContactRequestEventArgs_type{py::register_python_type(module.get(), &type_spec_ContactListDeleteContactRequestEventArgs, object_bases.get(), nullptr)};
    if (!ContactListDeleteContactRequestEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle ContactListServerSearchReadBatchRequest_type{py::register_python_type(module.get(), &type_spec_ContactListServerSearchReadBatchRequest, object_bases.get(), nullptr)};
    if (!ContactListServerSearchReadBatchRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle ContactListServerSearchReadBatchRequestEventArgs_type{py::register_python_type(module.get(), &type_spec_ContactListServerSearchReadBatchRequestEventArgs, object_bases.get(), nullptr)};
    if (!ContactListServerSearchReadBatchRequestEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle ContactListSyncManagerSyncRequest_type{py::register_python_type(module.get(), &type_spec_ContactListSyncManagerSyncRequest, object_bases.get(), nullptr)};
    if (!ContactListSyncManagerSyncRequest_type)
    {
        return nullptr;
    }

    py::pyobj_handle ContactListSyncManagerSyncRequestEventArgs_type{py::register_python_type(module.get(), &type_spec_ContactListSyncManagerSyncRequestEventArgs, object_bases.get(), nullptr)};
