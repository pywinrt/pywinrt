...
class ICustomNavigationProvider(winrt.system.Object):
    ...
    def navigate_custom(self, direction: windows_ui_xaml_automation_peers.AutomationNavigationDirection, /) -> typing.Optional[winrt.system.Object]: ...
...
class IItemContainerProvider(winrt.system.Object):
    ...
    def find_item_by_property(self, start_after: typing.Optional[IRawElementProviderSimple], automation_property: typing.Optional[windows_ui_xaml_automation.AutomationProperty], value: typing.Optional[winrt.system.Object], /) -> typing.Optional[IRawElementProviderSimple]: ...
...
class ISpreadsheetItemProvider(winrt.system.Object):
    ...
    def get_annotation_types(self) -> windows_ui_xaml_automation.AnnotationType: ...
    @_property
...
class ITextRangeProvider(winrt.system.Object):
    ...
    def compare_endpoints(self, endpoint: windows_ui_xaml_automation_text.TextPatternRangeEndpoint, text_range_provider: typing.Optional[ITextRangeProvider], target_endpoint: windows_ui_xaml_automation_text.TextPatternRangeEndpoint, /) -> winrt.system.Int32: ...
    ...
    def move_endpoint_by_range(self, endpoint: windows_ui_xaml_automation_text.TextPatternRangeEndpoint, text_range_provider: typing.Optional[ITextRangeProvider], target_endpoint: windows_ui_xaml_automation_text.TextPatternRangeEndpoint, /) -> None: ...
