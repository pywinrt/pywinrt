...
class PushNotificationChannelManagerForUser(winrt.system.Object):
    ...
    def create_raw_push_notification_channel_with_alternate_key_for_application_async_with_id(self, app_server_key: typing.Optional[windows_storage_streams.IBuffer], channel_id: str, app_id: str, /) -> windows_foundation.IAsyncOperation[PushNotificationChannel]: ...
    @_property
