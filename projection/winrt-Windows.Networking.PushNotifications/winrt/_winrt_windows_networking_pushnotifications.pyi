...
class PushNotificationChannelManagerForUser(winrt.system.Object):
    ...
    def create_raw_push_notification_channel_with_alternate_key_for_application_async(self, app_server_key: windows_storage_streams.ImplementsIBuffer, channel_id: str, /) -> windows_foundation.IAsyncOperation[PushNotificationChannel]: ...
    ...
    def create_raw_push_notification_channel_with_alternate_key_for_application_async_with_id(self, app_server_key: windows_storage_streams.ImplementsIBuffer, channel_id: str, app_id: str, /) -> windows_foundation.IAsyncOperation[PushNotificationChannel]: ...
