...
namespace py::cpp::Windows::UI::Xaml::Markup
{
    ...
    struct PyWinrtMarkupExtension : winrt::Windows::UI::Xaml::Markup::MarkupExtensionT<PyWinrtMarkupExtension>
    {
        PyWinrtMarkupExtension() : winrt::Windows::UI::Xaml::Markup::MarkupExtensionT<PyWinrtMarkupExtension>() {}
    };
        ...
        if (arg_count == 0)
        {
            try
            {
                if (type != self_type)
                {
                    ...
                    auto self = reinterpret_cast<py::wrapper::Windows::UI::Xaml::Markup::MarkupExtension*>(type->tp_alloc(type, 0));
                    if (!self)
                    {
                        return nullptr;
                    }
