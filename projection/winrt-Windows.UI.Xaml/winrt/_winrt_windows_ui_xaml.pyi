...
class DurationHelper(winrt.system.Object):
    ...
    @staticmethod
    def equals(target: Duration, value: Duration, /) -> bool: ...
    @staticmethod
    def from_time_span(time_span: datetime.timedelta, /) -> Duration: ...
    @staticmethod
    def get_has_time_span(target: Duration, /) -> bool: ...
    @staticmethod
...
class FrameworkElement(winrt.system.Object):
    ...
    @_property
    def focus_visual_secondary_brush(self) -> typing.Optional[winrt.windows.ui.xaml.media.Brush]: ...
    @focus_visual_secondary_brush.setter
    def focus_visual_secondary_brush(self, value: typing.Optional[winrt.windows.ui.xaml.media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def focus_visual_primary_brush(self) -> typing.Optional[winrt.windows.ui.xaml.media.Brush]: ...
    @focus_visual_primary_brush.setter
    def focus_visual_primary_brush(self, value: typing.Optional[winrt.windows.ui.xaml.media.Brush]) -> None: ...
    @_property
...
class GridLengthHelper(winrt.system.Object):
    ...
    @staticmethod
    def equals(target: GridLength, value: GridLength, /) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def get_is_absolute(target: GridLength, /) -> bool: ...
    @staticmethod
    def get_is_auto(target: GridLength, /) -> bool: ...
    @staticmethod
    def get_is_star(target: GridLength, /) -> bool: ...
...
class RectHelper(winrt.system.Object):
    ...
    @staticmethod
    def contains(target: winrt.windows.foundation.Rect, point: winrt.windows.foundation.Point, /) -> bool: ...
    @staticmethod
    def equals(target: winrt.windows.foundation.Rect, value: winrt.windows.foundation.Rect, /) -> bool: ...
    @staticmethod
    ...
    @staticmethod
    def get_is_empty(target: winrt.windows.foundation.Rect, /) -> bool: ...
    @staticmethod
...
class SizeHelper(winrt.system.Object):
    ...
    @staticmethod
    def equals(target: winrt.windows.foundation.Size, value: winrt.windows.foundation.Size, /) -> bool: ...
    @staticmethod
    def from_dimensions(width: winrt.system.Single, height: winrt.system.Single, /) -> winrt.windows.foundation.Size: ...
    @staticmethod
    def get_is_empty(target: winrt.windows.foundation.Size, /) -> bool: ...
...
class UIElement(winrt.system.Object):
    ...
    def capture_pointer(self, value: typing.Optional[winrt.windows.ui.xaml.input.Pointer], /) -> bool: ...
    ...
    @staticmethod
    def try_start_direct_manipulation(value: typing.Optional[winrt.windows.ui.xaml.input.Pointer], /) -> bool: ...
    ...
    @_property
    def transitions(self) -> typing.Optional[winrt.windows.ui.xaml.media.animation.TransitionCollection]: ...
    @transitions.setter
    def transitions(self, value: typing.Optional[winrt.windows.ui.xaml.media.animation.TransitionCollection]) -> None: ...
    @_property
    def projection(self) -> typing.Optional[winrt.windows.ui.xaml.media.Projection]: ...
    @projection.setter
    def projection(self, value: typing.Optional[winrt.windows.ui.xaml.media.Projection]) -> None: ...
    @_property
    ...
    @_property
    def manipulation_mode(self) -> winrt.windows.ui.xaml.input.ManipulationModes: ...
    @manipulation_mode.setter
    def manipulation_mode(self, value: winrt.windows.ui.xaml.input.ManipulationModes) -> None: ...
    @_property
    ...
    @_property
    def clip(self) -> typing.Optional[winrt.windows.ui.xaml.media.RectangleGeometry]: ...
    @clip.setter
    def clip(self, value: typing.Optional[winrt.windows.ui.xaml.media.RectangleGeometry]) -> None: ...
    @_property
    def cache_mode(self) -> typing.Optional[winrt.windows.ui.xaml.media.CacheMode]: ...
    @cache_mode.setter
    def cache_mode(self, value: typing.Optional[winrt.windows.ui.xaml.media.CacheMode]) -> None: ...
    @_property
    def use_layout_rounding(self) -> bool: ...
    @use_layout_rounding.setter
    def use_layout_rounding(self, value: bool) -> None: ...
    @_property
    def render_transform(self) -> typing.Optional[winrt.windows.ui.xaml.media.Transform]: ...
    @render_transform.setter
    def render_transform(self, value: typing.Optional[winrt.windows.ui.xaml.media.Transform]) -> None: ...
    @_property
    ...
    @_property
    def pointer_captures(self) -> typing.Optional[winrt.windows.foundation.collections.IVectorView[winrt.windows.ui.xaml.input.Pointer]]: ...
    @_property
    ...
    @_property
    def shadow(self) -> typing.Optional[winrt.windows.ui.xaml.media.Shadow]: ...
    @shadow.setter
    def shadow(self, value: typing.Optional[winrt.windows.ui.xaml.media.Shadow]) -> None: ...
    @_property
    ...
    @_property
    def composite_mode(self) -> winrt.windows.ui.xaml.media.ElementCompositeMode: ...
    @composite_mode.setter
    def composite_mode(self, value: winrt.windows.ui.xaml.media.ElementCompositeMode) -> None: ...
    @_property
    def transform3_d(self) -> typing.Optional[winrt.windows.ui.xaml.media.media3d.Transform3D]: ...
    @transform3_d.setter
    def transform3_d(self, value: typing.Optional[winrt.windows.ui.xaml.media.media3d.Transform3D]) -> None: ...
    @_property
    ...
    @_property
    def context_flyout(self) -> typing.Optional[winrt.windows.ui.xaml.controls.primitives.FlyoutBase]: ...
    @context_flyout.setter
    def context_flyout(self, value: typing.Optional[winrt.windows.ui.xaml.controls.primitives.FlyoutBase]) -> None: ...
    @_property
    ...
    @_property
    def x_y_focus_keyboard_navigation(self) -> winrt.windows.ui.xaml.input.XYFocusKeyboardNavigationMode: ...
    @x_y_focus_keyboard_navigation.setter
    def x_y_focus_keyboard_navigation(self, value: winrt.windows.ui.xaml.input.XYFocusKeyboardNavigationMode) -> None: ...
    @_property
    ...
    @_property
    def tab_focus_navigation(self) -> winrt.windows.ui.xaml.input.KeyboardNavigationMode: ...
    @tab_focus_navigation.setter
    def tab_focus_navigation(self, value: winrt.windows.ui.xaml.input.KeyboardNavigationMode) -> None: ...
    @_property
    ...
    @_property
    def lights(self) -> typing.Optional[winrt.windows.foundation.collections.IVector[winrt.windows.ui.xaml.media.XamlLight]]: ...
    @_property
    def keyboard_accelerators(self) -> typing.Optional[winrt.windows.foundation.collections.IVector[winrt.windows.ui.xaml.input.KeyboardAccelerator]]: ...
    @_property
    ...
    @_property
    def keyboard_accelerator_placement_mode(self) -> winrt.windows.ui.xaml.input.KeyboardAcceleratorPlacementMode: ...
    @keyboard_accelerator_placement_mode.setter
    def keyboard_accelerator_placement_mode(self, value: winrt.windows.ui.xaml.input.KeyboardAcceleratorPlacementMode) -> None: ...
    @_property
...
class VisualState(winrt.system.Object):
    ...
    @_property
    def storyboard(self) -> typing.Optional[winrt.windows.ui.xaml.media.animation.Storyboard]: ...
    @storyboard.setter
    def storyboard(self, value: typing.Optional[winrt.windows.ui.xaml.media.animation.Storyboard]) -> None: ...
    @_property
    def name(self) -> str: ...
    @_property
    def setters(self) -> typing.Optional[SetterBaseCollection]: ...
...
class VisualStateChangedEventArgs(winrt.system.Object):
    ...
    @_property
    def control(self) -> typing.Optional[winrt.windows.ui.xaml.controls.Control]: ...
    @control.setter
    def control(self, value: typing.Optional[winrt.windows.ui.xaml.controls.Control]) -> None: ...
...
class VisualStateManager(winrt.system.Object):
    ...
    @staticmethod
    def go_to_state(control: typing.Optional[winrt.windows.ui.xaml.controls.Control], state_name: str, use_transitions: bool, /) -> bool: ...
    def go_to_state_core(self, control: typing.Optional[winrt.windows.ui.xaml.controls.Control], template_root: typing.Optional[FrameworkElement], state_name: str, group: typing.Optional[VisualStateGroup], state: typing.Optional[VisualState], use_transitions: bool, /) -> bool: ...
...
class VisualTransition(winrt.system.Object):
    ...
    def storyboard(self, value: typing.Optional[winrt.windows.ui.xaml.media.animation.Storyboard]) -> None: ...
    @_property
    def generated_easing_function(self) -> typing.Optional[winrt.windows.ui.xaml.media.animation.EasingFunctionBase]: ...
    @generated_easing_function.setter
    def generated_easing_function(self, value: typing.Optional[winrt.windows.ui.xaml.media.animation.EasingFunctionBase]) -> None: ...
    @_property
