...
class Application_Static(type):
    ...
    @typing.overload
    def load_component(cls, component: typing.Optional[winrt.system.Object], resource_locator: typing.Optional[windows_foundation.Uri], component_resource_location: windows_ui_xaml_controls_primitives.ComponentResourceLocation, /) -> None: ...
...
class DragUI(winrt.system.Object):
    ...
    @typing.overload
    def set_content_from_bitmap_image(self, bitmap_image: typing.Optional[windows_ui_xaml_media_imaging.BitmapImage], anchor_point: windows_foundation.Point, /) -> None: ...
