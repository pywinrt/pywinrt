...
class Application_Static(type):
    ...
    @typing.overload
    def load_component(cls, component: typing.Optional[winrt.system.Object], resource_locator: typing.Optional[winrt.windows.foundation.Uri], component_resource_location: winrt.windows.ui.xaml.controls.primitives.ComponentResourceLocation, /) -> None: ...
...
class UIElement_Static(type):
    ...
    def try_start_direct_manipulation(cls, value: typing.Optional[winrt.windows.ui.xaml.input.Pointer], /) -> bool: ...
    @_property
...
class VisualStateManager_Static(type):
    ...
    def go_to_state(cls, control: typing.Optional[winrt.windows.ui.xaml.controls.Control], state_name: str, use_transitions: bool, /) -> bool: ...
