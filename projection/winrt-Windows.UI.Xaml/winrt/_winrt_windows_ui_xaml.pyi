...
class Application_Static(type):
    ...
    def load_component_with_resource_location(cls, component: typing.Optional[winrt.system.Object], resource_locator: typing.Optional[windows_foundation.Uri], component_resource_location: windows_ui_xaml_controls_primitives.ComponentResourceLocation, /) -> None: ...
...
class Application(winrt.system.Object, metaclass=Application_Static):
    ...
    def add_suspending(self, handler: typing.Optional[SuspendingEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    ...
    def add_entered_background(self, handler: typing.Optional[EnteredBackgroundEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_entered_background(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_leaving_background(self, handler: typing.Optional[LeavingBackgroundEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
...
class DragUI(winrt.system.Object):
    ...
    def set_content_from_bitmap_image(self, bitmap_image: typing.Optional[windows_ui_xaml_media_imaging.BitmapImage], /) -> None: ...
    def set_content_from_bitmap_image_with_anchor_point(self, bitmap_image: typing.Optional[windows_ui_xaml_media_imaging.BitmapImage], anchor_point: windows_foundation.Point, /) -> None: ...
...
class FrameworkElement(winrt.system.Object, metaclass=FrameworkElement_Static):
    ...
    def get_animation_base_value(self, dp: typing.Optional[DependencyProperty], /) -> typing.Optional[winrt.system.Object]: ...
    def get_binding_expression(self, dp: typing.Optional[DependencyProperty], /) -> typing.Optional[windows_ui_xaml_data.BindingExpression]: ...
    def get_value(self, dp: typing.Optional[DependencyProperty], /) -> typing.Optional[winrt.system.Object]: ...
    ...
    def set_binding(self, dp: typing.Optional[DependencyProperty], binding: typing.Optional[windows_ui_xaml_data.BindingBase], /) -> None: ...
    def set_value(self, dp: typing.Optional[DependencyProperty], value: typing.Optional[winrt.system.Object], /) -> None: ...
    ...
    def transform_to_visual(self, visual: typing.Optional[UIElement], /) -> typing.Optional[windows_ui_xaml_media.GeneralTransform]: ...
...
class UIElement_Static(type):
    ...
    def try_start_direct_manipulation(cls, value: typing.Optional[windows_ui_xaml_input.Pointer], /) -> bool: ...
    @_property
...
class VisualState(winrt.system.Object):
    ...
    def unregister_property_changed_callback(self, dp: typing.Optional[DependencyProperty], token: winrt.system.Int64, /) -> None: ...
    @_property
    def storyboard(self) -> typing.Optional[windows_ui_xaml_media_animation.Storyboard]: ...
    @storyboard.setter
    def storyboard(self, value: typing.Optional[windows_ui_xaml_media_animation.Storyboard]) -> None: ...
    @_property
    def name(self) -> str: ...
    @_property
    def setters(self) -> typing.Optional[SetterBaseCollection]: ...
...
class VisualStateChangedEventArgs(winrt.system.Object):
    ...
    @_property
    def control(self) -> typing.Optional[windows_ui_xaml_controls.Control]: ...
    @control.setter
    def control(self, value: typing.Optional[windows_ui_xaml_controls.Control]) -> None: ...
...
class VisualStateManager_Static(type):
    ...
    def go_to_state(cls, control: typing.Optional[windows_ui_xaml_controls.Control], state_name: str, use_transitions: bool, /) -> bool: ...
...
class VisualTransition(winrt.system.Object):
    ...
    def storyboard(self, value: typing.Optional[windows_ui_xaml_media_animation.Storyboard]) -> None: ...
    @_property
    def generated_easing_function(self) -> typing.Optional[windows_ui_xaml_media_animation.EasingFunctionBase]: ...
    @generated_easing_function.setter
    def generated_easing_function(self, value: typing.Optional[windows_ui_xaml_media_animation.EasingFunctionBase]) -> None: ...
    @_property
...
class Window(winrt.system.Object, metaclass=Window_Static):
    ...
    def add_activated(self, handler: typing.Optional[WindowActivatedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_activated(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_closed(self, handler: typing.Optional[WindowClosedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_closed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_size_changed(self, handler: typing.Optional[WindowSizeChangedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_size_changed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_visibility_changed(self, handler: typing.Optional[WindowVisibilityChangedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
...
class IDataTemplateExtension(winrt.system.Object):
    ...
    def process_bindings(self, arg: typing.Optional[windows_ui_xaml_controls.ContainerContentChangingEventArgs], /) -> winrt.system.Int32: ...
