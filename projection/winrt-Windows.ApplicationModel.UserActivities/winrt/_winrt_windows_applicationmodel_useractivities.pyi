...
class UserActivity(winrt.system.Object, metaclass=UserActivity_Static):
    ...
    @content_info.setter
    def content_info(self, value: ImplementsIUserActivityContentInfo) -> None: ...
    @_property
...
class UserActivityAttribution(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[UserActivityAttribution], icon_uri: windows_foundation.Uri) -> UserActivityAttribution: ...
    @typing.overload
...
class UserActivityChannel_Static(type):
    ...
    def try_get_for_web_account(cls, account: windows_security_credentials.WebAccount, /) -> UserActivityChannel: ...
...
class UserActivityVisualElements(winrt.system.Object):
    ...
    @content.setter
    def content(self, value: windows_ui_shell.ImplementsIAdaptiveCard) -> None: ...
    @_property
