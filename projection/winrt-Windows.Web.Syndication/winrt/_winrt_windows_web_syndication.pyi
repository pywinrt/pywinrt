...
class SyndicationCategory(winrt.system.Object):
    ...
    @_property
    def attribute_extensions(self) -> windows_foundation_collections.IVector[SyndicationAttribute]: ...
    @_property
    def element_extensions(self) -> windows_foundation_collections.IVector[ISyndicationNode]: ...
...
class SyndicationClient(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SyndicationClient], server_credential: windows_security_credentials.PasswordCredential) -> SyndicationClient: ...
    @typing.overload
...
class SyndicationContent(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SyndicationContent], source_uri: windows_foundation.Uri) -> SyndicationContent: ...
    @typing.overload
...
class SyndicationFeed(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SyndicationFeed], title: str, subtitle: str, uri: windows_foundation.Uri) -> SyndicationFeed: ...
    @typing.overload
    ...
    @_property
    def items(self) -> windows_foundation_collections.IVector[SyndicationItem]: ...
    @_property
    def last_uri(self) -> windows_foundation.Uri: ...
    @_property
    def links(self) -> windows_foundation_collections.IVector[SyndicationLink]: ...
    @_property
    def next_uri(self) -> windows_foundation.Uri: ...
    @_property
    def previous_uri(self) -> windows_foundation.Uri: ...
    @_property
    def categories(self) -> windows_foundation_collections.IVector[SyndicationCategory]: ...
    @_property
    def source_format(self) -> SyndicationFormat: ...
    @_property
    def contributors(self) -> windows_foundation_collections.IVector[SyndicationPerson]: ...
    @_property
    def authors(self) -> windows_foundation_collections.IVector[SyndicationPerson]: ...
    @_property
    def node_value(self) -> str: ...
    @node_value.setter
    def node_value(self, value: str) -> None: ...
...
class SyndicationItem(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SyndicationItem], title: str, content: SyndicationContent, uri: windows_foundation.Uri) -> SyndicationItem: ...
    @typing.overload
...
class SyndicationLink(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SyndicationLink], uri: windows_foundation.Uri) -> SyndicationLink: ...
    @typing.overload
    def __new__(cls: typing.Type[SyndicationLink], uri: windows_foundation.Uri, relationship: str, title: str, media_type: str, length: winrt.system.UInt32) -> SyndicationLink: ...
    @typing.overload
...
class SyndicationPerson(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SyndicationPerson], name: str, email: str, uri: windows_foundation.Uri) -> SyndicationPerson: ...
    @typing.overload
