...
setup(
    ...
    ext_modules=[
        Extension(
            "winui2._winui2_microsoft_ui_xaml_automation_peers",
            sources=["py.Microsoft.UI.Xaml.Automation.Peers.cpp"],
            include_dirs=[get_include()] + get_include_dirs() + get_winui2_include_dirs(),
