...
class InfoBarPanel_Static(windows_ui_xaml_controls.Panel_Static):
    ...
    def set_horizontal_orientation_margin(cls, object: windows_ui_xaml.DependencyObject, value: windows_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double], /) -> None: ...
    ...
    def set_vertical_orientation_margin(cls, object: windows_ui_xaml.DependencyObject, value: windows_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double], /) -> None: ...
...
class InfoBarPanel(windows_ui_xaml_controls.Panel, metaclass=InfoBarPanel_Static):
    ...
    @typing.final
    def vertical_orientation_padding(self, value: windows_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
    ...
    @typing.final
    def horizontal_orientation_padding(self, value: windows_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
