...
class AcrylicBrush(windows_ui_xaml_media.XamlCompositionBrushBase, metaclass=AcrylicBrush_Static):
    ...
    @tint_color.setter
    @typing.final
    def tint_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
    ...
    @_property
    def tint_luminosity_opacity(self) -> winrt.system.Double | None: ...
    ...
    @typing.final
    def tint_luminosity_opacity(self, value: winrt.system.Double | None) -> None: ...
...
class RadialGradientBrush(windows_ui_xaml_media.XamlCompositionBrushBase, metaclass=RadialGradientBrush_Static):
    ...
    @typing.final
    def gradient_origin(self, value: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
