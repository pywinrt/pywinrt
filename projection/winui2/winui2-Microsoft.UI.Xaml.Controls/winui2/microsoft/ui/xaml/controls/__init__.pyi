...
class BreadcrumbBar(windows_ui_xaml_controls.Control, metaclass=BreadcrumbBar_Static):
    ...
    def remove_item_clicked(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class InfoBadgeTemplateSettings(windows_ui_xaml.DependencyObject, metaclass=InfoBadgeTemplateSettings_Static):
    ...
    @typing.final
    def info_badge_corner_radius(self, value: windows_ui_xaml.CornerRadius | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
...
class ItemsRepeater(windows_ui_xaml.FrameworkElement, metaclass=ItemsRepeater_Static):
    ...
    def remove_element_clearing(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_element_index_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_element_prepared(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ItemsSourceView(winrt.system.Object, windows_ui_xaml_interop.INotifyCollectionChanged, metaclass=ItemsSourceView_Static):
    def __new__(cls: type[Self], source: winrt.system.Object) -> Self: ...
    @typing.final
...
class Layout(windows_ui_xaml.DependencyObject, metaclass=Layout_Static):
    ...
    def measure(self, context: LayoutContext, available_size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Size: ...
    @typing.final
    ...
    def remove_arrange_invalidated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_measure_invalidated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MenuBarItem(windows_ui_xaml_controls.Control, metaclass=MenuBarItem_Static):
    ...
    @_property
    @typing.final
    def items(self) -> _cabc.MutableSequence[windows_ui_xaml_controls.MenuFlyoutItemBase]: ...
...
class NavigationView(windows_ui_xaml_controls.ContentControl, metaclass=NavigationView_Static):
    ...
    @_property
    @typing.final
    def footer_menu_items(self) -> _cabc.MutableSequence[winrt.system.Object]: ...
...
class NonVirtualizingLayout(Layout, metaclass=NonVirtualizingLayout_Static):
    ...
    def _arrange_override(self, context: NonVirtualizingLayoutContext, final_size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Size: ...
    ...
    def _measure_override(self, context: NonVirtualizingLayoutContext, available_size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Size: ...
...
class TabView(windows_ui_xaml_controls.Control, metaclass=TabView_Static):
    ...
    def remove_add_tab_button_click(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_tab_drag_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_tab_drag_starting(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_tab_dropped_outside(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_tab_items_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_tab_strip_drag_over(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_tab_strip_drop(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    @typing.final
    def tab_items(self) -> _cabc.MutableSequence[winrt.system.Object]: ...
...
class TeachingTip(windows_ui_xaml_controls.ContentControl, metaclass=TeachingTip_Static):
    ...
    def remove_action_button_click(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    @typing.final
    def placement_margin(self, value: windows_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
...
class TeachingTipTemplateSettings(windows_ui_xaml.DependencyObject, metaclass=TeachingTipTemplateSettings_Static):
    ...
    @typing.final
    def top_right_highlight_margin(self, value: windows_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
    ...
    @typing.final
    def top_left_highlight_margin(self, value: windows_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
...
class VirtualizingLayout(Layout, metaclass=VirtualizingLayout_Static):
    ...
    def _arrange_override(self, context: VirtualizingLayoutContext, final_size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Size: ...
    ...
    def _measure_override(self, context: VirtualizingLayoutContext, available_size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Size: ...
...
class VirtualizingLayoutContext(LayoutContext, metaclass=VirtualizingLayoutContext_Static):
    ...
    @typing.final
    def layout_origin(self, value: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
...
class WebView2(windows_ui_xaml_controls.Control, metaclass=WebView2_Static):
    ...
    def remove_core_process_failed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_core_webview2_initialized(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
...
class IDynamicAnimatedVisualSource(IAnimatedVisualSource, winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def remove_animated_visual_invalidated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
