...
class CameraIntrinsics(winrt.system.Object):
    ...
    def distort_points(self, inputs: winrt.system.Array[windows_foundation.Point], results: winrt.system.Array[windows_foundation.Point], /) -> None: ...
    def project_many_onto_frame(self, coordinates: winrt.system.Array[windows_foundation_numerics.Vector3], results: winrt.system.Array[windows_foundation.Point], /) -> None: ...
    ...
    def undistort_points(self, inputs: winrt.system.Array[windows_foundation.Point], results: winrt.system.Array[windows_foundation.Point], /) -> None: ...
    def unproject_at_unit_depth(self, pixel_coordinate: windows_foundation.Point, /) -> windows_foundation_numerics.Vector2: ...
    def unproject_pixels_at_unit_depth(self, pixel_coordinates: winrt.system.Array[windows_foundation.Point], results: winrt.system.Array[windows_foundation_numerics.Vector2], /) -> None: ...
    @_property
...
class DepthCorrelatedCoordinateMapper(winrt.system.Object):
    ...
    def map_points(self, source_points: winrt.system.Array[windows_foundation.Point], target_coordinate_system: typing.Optional[windows_perception_spatial.SpatialCoordinateSystem], target_camera_intrinsics: typing.Optional[CameraIntrinsics], results: winrt.system.Array[windows_foundation.Point], /) -> None: ...
    ...
    def unproject_points(self, source_points: winrt.system.Array[windows_foundation.Point], target_coordinate_system: typing.Optional[windows_perception_spatial.SpatialCoordinateSystem], results: winrt.system.Array[windows_foundation_numerics.Vector3], /) -> None: ...
