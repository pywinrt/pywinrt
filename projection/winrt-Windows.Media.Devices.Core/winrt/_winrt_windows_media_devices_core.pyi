...
class CameraIntrinsics(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[CameraIntrinsics], focal_length: windows_foundation_numerics.Vector2, principal_point: windows_foundation_numerics.Vector2, radial_distortion: windows_foundation_numerics.Vector3, tangential_distortion: windows_foundation_numerics.Vector2, image_width: winrt.system.UInt32, image_height: winrt.system.UInt32) -> CameraIntrinsics: ...
...
class DepthCorrelatedCoordinateMapper(winrt.system.Object):
    ...
    def close(self) -> None: ...
    def map_point(self, source_point: windows_foundation.Point, target_coordinate_system: typing.Optional[windows_perception_spatial.SpatialCoordinateSystem], target_camera_intrinsics: typing.Optional[CameraIntrinsics], /) -> windows_foundation.Point: ...
    def map_points(self, source_points: typing.Union[winrt.system.Array[windows_foundation.Point], winrt.system.ReadableBuffer], target_coordinate_system: typing.Optional[windows_perception_spatial.SpatialCoordinateSystem], target_camera_intrinsics: typing.Optional[CameraIntrinsics], results: typing.Union[winrt.system.Array[windows_foundation.Point], winrt.system.WriteableBuffer], /) -> None: ...
    def unproject_point(self, source_point: windows_foundation.Point, target_coordinate_system: typing.Optional[windows_perception_spatial.SpatialCoordinateSystem], /) -> windows_foundation_numerics.Vector3: ...
    def unproject_points(self, source_points: typing.Union[winrt.system.Array[windows_foundation.Point], winrt.system.ReadableBuffer], target_coordinate_system: typing.Optional[windows_perception_spatial.SpatialCoordinateSystem], results: typing.Union[winrt.system.Array[windows_foundation_numerics.Vector3], winrt.system.WriteableBuffer], /) -> None: ...
...
class VariablePhotoSequenceController(winrt.system.Object):
    ...
    @_property
    def desired_frame_controllers(self) -> typing.Optional[windows_foundation_collections.IVector[FrameController]]: ...
    @_property
