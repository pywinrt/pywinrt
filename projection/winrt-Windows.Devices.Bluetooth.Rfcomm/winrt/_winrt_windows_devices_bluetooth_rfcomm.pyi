...
class RfcommDeviceServicesResult(winrt.system.Object):
    ...
    @_property
    def services(self) -> windows_foundation_collections.IVectorView[RfcommDeviceService]: ...
...
class RfcommServiceProvider(winrt.system.Object, metaclass=RfcommServiceProvider_Static):
    ...
    @_property
    def sdp_raw_attributes(self) -> windows_foundation_collections.IMap[winrt.system.UInt32, windows_storage_streams.IBuffer]: ...
    @_property
    def service_id(self) -> RfcommServiceId: ...
