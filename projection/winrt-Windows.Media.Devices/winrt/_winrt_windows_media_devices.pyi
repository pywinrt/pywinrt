...
class AdvancedPhotoControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> typing.Optional[windows_foundation_collections.IVectorView[AdvancedPhotoMode]]: ...

@typing.final
class AudioDeviceController(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> AudioDeviceController: ...
    def get_available_media_stream_properties(self, media_stream_type: windows_media_capture.MediaStreamType, /) -> typing.Optional[windows_foundation_collections.IVectorView[windows_media_mediaproperties.IMediaEncodingProperties]]: ...
    def get_media_stream_properties(self, media_stream_type: windows_media_capture.MediaStreamType, /) -> typing.Optional[windows_media_mediaproperties.IMediaEncodingProperties]: ...
    def set_media_stream_properties_async(self, media_stream_type: windows_media_capture.MediaStreamType, media_encoding_properties: typing.Optional[windows_media_mediaproperties.IMediaEncodingProperties], /) -> windows_foundation.IAsyncAction: ...
    @_property
...
class AudioDeviceModule(winrt.system.Object):
    ...
    def send_command_async(self, command: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncOperation[ModuleCommandResult]: ...
    @_property
...
class AudioDeviceModuleNotificationEventArgs(winrt.system.Object):
    ...
    @_property
    def notification_data(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
...
class AudioDeviceModulesManager(winrt.system.Object):
    ...
    def find_all(self) -> typing.Optional[windows_foundation_collections.IVectorView[AudioDeviceModule]]: ...
    def find_all_by_id(self, module_id: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[AudioDeviceModule]]: ...
...
class CallControl(winrt.system.Object, metaclass=CallControl_Static):
    ...
    def add_answer_requested(self, handler: typing.Optional[CallControlEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_answer_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_audio_transfer_requested(self, handler: typing.Optional[CallControlEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_audio_transfer_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_dial_requested(self, handler: typing.Optional[DialRequestedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_dial_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_hang_up_requested(self, handler: typing.Optional[CallControlEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_hang_up_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_keypad_pressed(self, handler: typing.Optional[KeypadPressedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_keypad_pressed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_redial_requested(self, handler: typing.Optional[RedialRequestedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
...
class DigitalWindowControl(winrt.system.Object):
    ...
    def configure_with_bounds(self, digital_window_mode: DigitalWindowMode, digital_window_bounds: typing.Optional[DigitalWindowBounds], /) -> None: ...
    ...
    @_property
    def supported_capabilities(self) -> typing.Optional[windows_foundation_collections.IVectorView[DigitalWindowCapability]]: ...
    @_property
...
class FocusControl(winrt.system.Object):
    ...
    def supported(self) -> bool: ...
    @_property
    def supported_presets(self) -> typing.Optional[windows_foundation_collections.IVectorView[FocusPreset]]: ...
    @_property
    ...
    @_property
    def supported_focus_distances(self) -> typing.Optional[windows_foundation_collections.IVectorView[ManualFocusDistance]]: ...
    @_property
    def supported_focus_modes(self) -> typing.Optional[windows_foundation_collections.IVectorView[FocusMode]]: ...
    @_property
    def supported_focus_ranges(self) -> typing.Optional[windows_foundation_collections.IVectorView[AutoFocusRange]]: ...
    @_property
...
class HdrVideoControl(winrt.system.Object):
    ...
    def supported(self) -> bool: ...
    @_property
    def supported_modes(self) -> typing.Optional[windows_foundation_collections.IVectorView[HdrVideoMode]]: ...
...
class InfraredTorchControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> typing.Optional[windows_foundation_collections.IVectorView[InfraredTorchMode]]: ...
...
class IsoSpeedControl(winrt.system.Object):
    ...
    def supported(self) -> bool: ...
    @_property
    def supported_presets(self) -> typing.Optional[windows_foundation_collections.IVectorView[IsoSpeedPreset]]: ...
    @_property
    def auto(self) -> bool: ...
    @_property
    def max(self) -> winrt.system.UInt32: ...
...
class LowLagPhotoControl(winrt.system.Object):
    ...
    def get_current_frame_rate(self) -> typing.Optional[windows_media_mediaproperties.MediaRatio]: ...
    def get_highest_concurrent_frame_rate(self, capture_properties: typing.Optional[windows_media_mediaproperties.IMediaEncodingProperties], /) -> typing.Optional[windows_media_mediaproperties.MediaRatio]: ...
    @_property
...
class ModuleCommandResult(winrt.system.Object):
    ...
    @_property
    def result(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
...
class OpticalImageStabilizationControl(winrt.system.Object):
    ...
    def supported(self) -> bool: ...
    @_property
    def supported_modes(self) -> typing.Optional[windows_foundation_collections.IVectorView[OpticalImageStabilizationMode]]: ...
...
class SceneModeControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> typing.Optional[windows_foundation_collections.IVectorView[CaptureSceneMode]]: ...
    @_property
...
class VideoDeviceController(winrt.system.Object):
    ...
    def get_device_property_by_extended_id(self, extended_property_id: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], max_property_value_size: typing.Optional[winrt.system.UInt32], /) -> typing.Optional[VideoDeviceControllerGetDevicePropertyResult]: ...
    ...
    @_property
    def variable_photo_sequence_controller(self) -> typing.Optional[windows_media_devices_core.VariablePhotoSequenceController]: ...
    @_property
...
class VideoTemporalDenoisingControl(winrt.system.Object):
    ...
    def supported(self) -> bool: ...
    @_property
    def supported_modes(self) -> typing.Optional[windows_foundation_collections.IVectorView[VideoTemporalDenoisingMode]]: ...
...
class ZoomControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> typing.Optional[windows_foundation_collections.IVectorView[ZoomTransitionMode]]: ...
