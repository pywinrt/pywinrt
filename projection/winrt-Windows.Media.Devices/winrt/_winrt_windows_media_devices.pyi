...
class AdvancedPhotoControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> windows_foundation_collections.IVectorView[AdvancedPhotoMode]: ...

@typing.final
class AudioDeviceController(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> AudioDeviceController: ...
    def get_available_media_stream_properties(self, media_stream_type: windows_media_capture.MediaStreamType, /) -> windows_foundation_collections.IVectorView[windows_media_mediaproperties.IMediaEncodingProperties]: ...
...
class AudioDeviceModulesManager(winrt.system.Object):
    ...
    def find_all(self) -> windows_foundation_collections.IVectorView[AudioDeviceModule]: ...
    def find_all_by_id(self, module_id: str, /) -> windows_foundation_collections.IVectorView[AudioDeviceModule]: ...
...
class DigitalWindowControl(winrt.system.Object):
    ...
    @_property
    def supported_capabilities(self) -> windows_foundation_collections.IVectorView[DigitalWindowCapability]: ...
    @_property
...
class FocusControl(winrt.system.Object):
    ...
    def supported(self) -> bool: ...
    @_property
    def supported_presets(self) -> windows_foundation_collections.IVectorView[FocusPreset]: ...
    @_property
    ...
    @_property
    def supported_focus_distances(self) -> windows_foundation_collections.IVectorView[ManualFocusDistance]: ...
    @_property
    def supported_focus_modes(self) -> windows_foundation_collections.IVectorView[FocusMode]: ...
    @_property
    def supported_focus_ranges(self) -> windows_foundation_collections.IVectorView[AutoFocusRange]: ...
    @_property
...
class HdrVideoControl(winrt.system.Object):
    ...
    def supported(self) -> bool: ...
    @_property
    def supported_modes(self) -> windows_foundation_collections.IVectorView[HdrVideoMode]: ...
...
class InfraredTorchControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> windows_foundation_collections.IVectorView[InfraredTorchMode]: ...
...
class IsoSpeedControl(winrt.system.Object):
    ...
    def supported(self) -> bool: ...
    @_property
    def supported_presets(self) -> windows_foundation_collections.IVectorView[IsoSpeedPreset]: ...
    @_property
    def auto(self) -> bool: ...
    @_property
    def max(self) -> winrt.system.UInt32: ...
...
class OpticalImageStabilizationControl(winrt.system.Object):
    ...
    def supported(self) -> bool: ...
    @_property
    def supported_modes(self) -> windows_foundation_collections.IVectorView[OpticalImageStabilizationMode]: ...
...
class SceneModeControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> windows_foundation_collections.IVectorView[CaptureSceneMode]: ...
    @_property
...
class VideoTemporalDenoisingControl(winrt.system.Object):
    ...
    def supported(self) -> bool: ...
    @_property
    def supported_modes(self) -> windows_foundation_collections.IVectorView[VideoTemporalDenoisingMode]: ...
...
class ZoomControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> windows_foundation_collections.IVectorView[ZoomTransitionMode]: ...
