...
@typing.final
class AudioDeviceController(winrt.system.Object, ImplementsIMediaDeviceController):
...
class AudioDeviceModule(winrt.system.Object):
    ...
    def send_command_async(self, command: windows_storage_streams.ImplementsIBuffer, /) -> windows_foundation.IAsyncOperation[ModuleCommandResult]: ...
...
@typing.final
class DefaultAudioCaptureDeviceChangedEventArgs(winrt.system.Object, ImplementsIDefaultAudioDeviceChangedEventArgs):
...
@typing.final
class DefaultAudioRenderDeviceChangedEventArgs(winrt.system.Object, ImplementsIDefaultAudioDeviceChangedEventArgs):
...
@typing.final
class VideoDeviceController(winrt.system.Object, ImplementsIMediaDeviceController):
