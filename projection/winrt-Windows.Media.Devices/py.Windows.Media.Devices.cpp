...
namespace py::cpp::Windows::Media::Devices
{
    struct module_state
    {
        PyObject* type_AdvancedPhotoMode;
        PyObject* type_AudioDeviceRole;
        PyObject* type_AutoFocusRange;
        PyObject* type_CameraOcclusionKind;
        PyObject* type_CameraStreamState;
        PyObject* type_CaptureSceneMode;
        PyObject* type_CaptureUse;
        PyObject* type_ColorTemperaturePreset;
        PyObject* type_DigitalWindowMode;
        PyObject* type_FocusMode;
        PyObject* type_FocusPreset;
        PyObject* type_HdrVideoMode;
        PyObject* type_InfraredTorchMode;
        PyObject* type_IsoSpeedPreset;
        PyObject* type_ManualFocusDistance;
        PyObject* type_MediaCaptureFocusState;
        PyObject* type_MediaCaptureOptimization;
        PyObject* type_MediaCapturePauseBehavior;
        ...
        PyObject* type_ZoomTransitionMode;
    ...
    static PyObject* register_AdvancedPhotoMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AdvancedPhotoMode)
        {
        ...
        state->type_AdvancedPhotoMode = type;
        Py_INCREF(state->type_AdvancedPhotoMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_AudioDeviceRole(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AudioDeviceRole)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AudioDeviceRole = type;
        Py_INCREF(state->type_AudioDeviceRole);


        Py_RETURN_NONE;
    }

    static PyObject* register_AutoFocusRange(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AutoFocusRange)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_AutoFocusRange = type;
        Py_INCREF(state->type_AutoFocusRange);


        Py_RETURN_NONE;
    }

    static PyObject* register_CameraOcclusionKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_CameraOcclusionKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_CameraOcclusionKind = type;
        Py_INCREF(state->type_CameraOcclusionKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_CameraStreamState(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_CameraStreamState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_CameraStreamState = type;
        Py_INCREF(state->type_CameraStreamState);


        Py_RETURN_NONE;
    }

    static PyObject* register_CaptureSceneMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_CaptureSceneMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_CaptureSceneMode = type;
        Py_INCREF(state->type_CaptureSceneMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_CaptureUse(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_CaptureUse)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_CaptureUse = type;
        Py_INCREF(state->type_CaptureUse);


        Py_RETURN_NONE;
    }

    static PyObject* register_ColorTemperaturePreset(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_ColorTemperaturePreset)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_ColorTemperaturePreset = type;
        Py_INCREF(state->type_ColorTemperaturePreset);


        Py_RETURN_NONE;
    }

    static PyObject* register_DigitalWindowMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_DigitalWindowMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_DigitalWindowMode = type;
        Py_INCREF(state->type_DigitalWindowMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_FocusMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_FocusMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_FocusMode = type;
        Py_INCREF(state->type_FocusMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_FocusPreset(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_FocusPreset)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_FocusPreset = type;
        Py_INCREF(state->type_FocusPreset);


        Py_RETURN_NONE;
    }

    static PyObject* register_HdrVideoMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_HdrVideoMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_HdrVideoMode = type;
        Py_INCREF(state->type_HdrVideoMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_InfraredTorchMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_InfraredTorchMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_InfraredTorchMode = type;
        Py_INCREF(state->type_InfraredTorchMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_IsoSpeedPreset(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_IsoSpeedPreset)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_IsoSpeedPreset = type;
        Py_INCREF(state->type_IsoSpeedPreset);


        Py_RETURN_NONE;
    }

    static PyObject* register_ManualFocusDistance(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_ManualFocusDistance)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_ManualFocusDistance = type;
        Py_INCREF(state->type_ManualFocusDistance);


        Py_RETURN_NONE;
    }

    static PyObject* register_MediaCaptureFocusState(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MediaCaptureFocusState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MediaCaptureFocusState = type;
        Py_INCREF(state->type_MediaCaptureFocusState);


        Py_RETURN_NONE;
    }

    static PyObject* register_MediaCaptureOptimization(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MediaCaptureOptimization)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MediaCaptureOptimization = type;
        Py_INCREF(state->type_MediaCaptureOptimization);


        Py_RETURN_NONE;
    }

    static PyObject* register_MediaCapturePauseBehavior(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MediaCapturePauseBehavior)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MediaCapturePauseBehavior = type;
        Py_INCREF(state->type_MediaCapturePauseBehavior);


        Py_RETURN_NONE;
    }

    static PyObject* register_OpticalImageStabilizationMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_OpticalImageStabilizationMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_OpticalImageStabilizationMode = type;
        Py_INCREF(state->type_OpticalImageStabilizationMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_RegionOfInterestType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_RegionOfInterestType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_RegionOfInterestType = type;
        Py_INCREF(state->type_RegionOfInterestType);


        Py_RETURN_NONE;
    }

    static PyObject* register_SendCommandStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SendCommandStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
    ...
    static PyObject* register_TelephonyKey(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);
    ...
    static PyObject* register_VideoDeviceControllerGetDevicePropertyStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_VideoDeviceControllerGetDevicePropertyStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_VideoDeviceControllerGetDevicePropertyStatus = type;
        Py_INCREF(state->type_VideoDeviceControllerGetDevicePropertyStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_VideoDeviceControllerSetDevicePropertyStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_VideoDeviceControllerSetDevicePropertyStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_VideoDeviceControllerSetDevicePropertyStatus = type;
        Py_INCREF(state->type_VideoDeviceControllerSetDevicePropertyStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_VideoTemporalDenoisingMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_VideoTemporalDenoisingMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_VideoTemporalDenoisingMode = type;
        Py_INCREF(state->type_VideoTemporalDenoisingMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_ZoomTransitionMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_ZoomTransitionMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_ZoomTransitionMode = type;
        Py_INCREF(state->type_ZoomTransitionMode);
    ...
    static PyMethodDef module_methods[] = {
        {"_register_AdvancedPhotoMode", register_AdvancedPhotoMode, METH_O, "registers type"},
        {"_register_AudioDeviceRole", register_AudioDeviceRole, METH_O, "registers type"},
        {"_register_AutoFocusRange", register_AutoFocusRange, METH_O, "registers type"},
        {"_register_CameraOcclusionKind", register_CameraOcclusionKind, METH_O, "registers type"},
        {"_register_CameraStreamState", register_CameraStreamState, METH_O, "registers type"},
        {"_register_CaptureSceneMode", register_CaptureSceneMode, METH_O, "registers type"},
        {"_register_CaptureUse", register_CaptureUse, METH_O, "registers type"},
        {"_register_ColorTemperaturePreset", register_ColorTemperaturePreset, METH_O, "registers type"},
        {"_register_DigitalWindowMode", register_DigitalWindowMode, METH_O, "registers type"},
        {"_register_FocusMode", register_FocusMode, METH_O, "registers type"},
        {"_register_FocusPreset", register_FocusPreset, METH_O, "registers type"},
        {"_register_HdrVideoMode", register_HdrVideoMode, METH_O, "registers type"},
        {"_register_InfraredTorchMode", register_InfraredTorchMode, METH_O, "registers type"},
        {"_register_IsoSpeedPreset", register_IsoSpeedPreset, METH_O, "registers type"},
        {"_register_ManualFocusDistance", register_ManualFocusDistance, METH_O, "registers type"},
        {"_register_MediaCaptureFocusState", register_MediaCaptureFocusState, METH_O, "registers type"},
        {"_register_MediaCaptureOptimization", register_MediaCaptureOptimization, METH_O, "registers type"},
        {"_register_MediaCapturePauseBehavior", register_MediaCapturePauseBehavior, METH_O, "registers type"},
        ...
        {"_register_ZoomTransitionMode", register_ZoomTransitionMode, METH_O, "registers type"},
        {}};
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_AdvancedPhotoMode);
        Py_VISIT(state->type_AudioDeviceRole);
        Py_VISIT(state->type_AutoFocusRange);
        Py_VISIT(state->type_CameraOcclusionKind);
        Py_VISIT(state->type_CameraStreamState);
        Py_VISIT(state->type_CaptureSceneMode);
        Py_VISIT(state->type_CaptureUse);
        Py_VISIT(state->type_ColorTemperaturePreset);
        Py_VISIT(state->type_DigitalWindowMode);
        Py_VISIT(state->type_FocusMode);
        Py_VISIT(state->type_FocusPreset);
        Py_VISIT(state->type_HdrVideoMode);
        Py_VISIT(state->type_InfraredTorchMode);
        Py_VISIT(state->type_IsoSpeedPreset);
        Py_VISIT(state->type_ManualFocusDistance);
        Py_VISIT(state->type_MediaCaptureFocusState);
        Py_VISIT(state->type_MediaCaptureOptimization);
        Py_VISIT(state->type_MediaCapturePauseBehavior);
        ...
        Py_VISIT(state->type_ZoomTransitionMode);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_AdvancedPhotoMode);
        Py_CLEAR(state->type_AudioDeviceRole);
        Py_CLEAR(state->type_AutoFocusRange);
        Py_CLEAR(state->type_CameraOcclusionKind);
        Py_CLEAR(state->type_CameraStreamState);
        Py_CLEAR(state->type_CaptureSceneMode);
        Py_CLEAR(state->type_CaptureUse);
        Py_CLEAR(state->type_ColorTemperaturePreset);
        Py_CLEAR(state->type_DigitalWindowMode);
        Py_CLEAR(state->type_FocusMode);
        Py_CLEAR(state->type_FocusPreset);
        Py_CLEAR(state->type_HdrVideoMode);
        Py_CLEAR(state->type_InfraredTorchMode);
        Py_CLEAR(state->type_IsoSpeedPreset);
        Py_CLEAR(state->type_ManualFocusDistance);
        Py_CLEAR(state->type_MediaCaptureFocusState);
        Py_CLEAR(state->type_MediaCaptureOptimization);
        Py_CLEAR(state->type_MediaCapturePauseBehavior);
        ...
        Py_CLEAR(state->type_ZoomTransitionMode);
...
PyObject* py::py_type<winrt::Windows::Media::Devices::AdvancedPhotoMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_AdvancedPhotoMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::AdvancedPhotoMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::AudioDeviceRole>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_AudioDeviceRole;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::AudioDeviceRole is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::AutoFocusRange>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_AutoFocusRange;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::AutoFocusRange is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::CameraOcclusionKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_CameraOcclusionKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::CameraOcclusionKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::CameraStreamState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_CameraStreamState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::CameraStreamState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::CaptureSceneMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_CaptureSceneMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::CaptureSceneMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::CaptureUse>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_CaptureUse;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::CaptureUse is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::ColorTemperaturePreset>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_ColorTemperaturePreset;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::ColorTemperaturePreset is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::DigitalWindowMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_DigitalWindowMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::DigitalWindowMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::FocusMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_FocusMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::FocusMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::FocusPreset>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_FocusPreset;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::FocusPreset is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::HdrVideoMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_HdrVideoMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::HdrVideoMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::InfraredTorchMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_InfraredTorchMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::InfraredTorchMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::IsoSpeedPreset>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_IsoSpeedPreset;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::IsoSpeedPreset is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::ManualFocusDistance>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_ManualFocusDistance;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::ManualFocusDistance is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::MediaCaptureFocusState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_MediaCaptureFocusState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::MediaCaptureFocusState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::MediaCaptureOptimization>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_MediaCaptureOptimization;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::MediaCaptureOptimization is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::MediaCapturePauseBehavior>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_MediaCapturePauseBehavior;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::MediaCapturePauseBehavior is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::OpticalImageStabilizationMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_OpticalImageStabilizationMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::OpticalImageStabilizationMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::RegionOfInterestType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_RegionOfInterestType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::RegionOfInterestType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::SendCommandStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_SendCommandStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::SendCommandStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::VideoDeviceControllerGetDevicePropertyStatus>::get_python_type() noexcept {
    ...
    auto python_type = state->type_VideoDeviceControllerGetDevicePropertyStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::VideoDeviceControllerGetDevicePropertyStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::VideoDeviceControllerSetDevicePropertyStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_VideoDeviceControllerSetDevicePropertyStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::VideoDeviceControllerSetDevicePropertyStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::VideoTemporalDenoisingMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_VideoTemporalDenoisingMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::VideoTemporalDenoisingMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Media::Devices::ZoomTransitionMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Media::Devices;
    ...
    auto python_type = state->type_ZoomTransitionMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Media::Devices::ZoomTransitionMode is not registered");
        return nullptr;
    }
