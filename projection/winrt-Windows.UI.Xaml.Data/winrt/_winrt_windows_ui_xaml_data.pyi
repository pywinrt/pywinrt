...
class Binding(winrt.system.Object):
    ...
    @_property
    def path(self) -> typing.Optional[windows_ui_xaml.PropertyPath]: ...
    @path.setter
    def path(self, value: typing.Optional[windows_ui_xaml.PropertyPath]) -> None: ...
    @_property
...
class BindingOperations_Static(type):
    def set_binding(cls, target: typing.Optional[windows_ui_xaml.DependencyObject], dp: typing.Optional[windows_ui_xaml.DependencyProperty], binding: typing.Optional[BindingBase], /) -> None: ...
...
class CollectionViewSource_Static(type):
    @_property
    def is_source_grouped_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def items_path_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def source_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def view_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class CollectionViewSource(winrt.system.Object, metaclass=CollectionViewSource_Static):
    ...
    def source(self, value: typing.Optional[winrt.system.Object]) -> None: ...
    @_property
    def items_path(self) -> typing.Optional[windows_ui_xaml.PropertyPath]: ...
    @items_path.setter
    def items_path(self, value: typing.Optional[windows_ui_xaml.PropertyPath]) -> None: ...
    @_property
