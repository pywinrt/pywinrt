...
class Binding(winrt.system.Object):
    ...
    @_property
    def path(self) -> typing.Optional[winrt.windows.ui.xaml.PropertyPath]: ...
    @path.setter
    def path(self, value: typing.Optional[winrt.windows.ui.xaml.PropertyPath]) -> None: ...
    @_property
...
class CollectionViewSource(winrt.system.Object, metaclass=CollectionViewSource_Static):
    ...
    def source(self, value: typing.Optional[winrt.system.Object]) -> None: ...
    @_property
    def items_path(self) -> typing.Optional[winrt.windows.ui.xaml.PropertyPath]: ...
    @items_path.setter
    def items_path(self, value: typing.Optional[winrt.windows.ui.xaml.PropertyPath]) -> None: ...
    @_property
