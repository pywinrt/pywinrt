...
class Appointment(winrt.system.Object):
    ...
    @_property
    def invitees(self) -> windows_foundation_collections.IVector[AppointmentInvitee]: ...
    @_property
...
class AppointmentCalendar(winrt.system.Object):
    ...
    def find_all_instances_async_with_options(self, master_local_id: str, range_start: datetime.datetime, range_length: datetime.timedelta, p_options: FindAppointmentsOptions, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    ...
    def find_appointments_async_with_options(self, range_start: datetime.datetime, range_length: datetime.timedelta, options: FindAppointmentsOptions, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    ...
    def find_unexpanded_appointments_async_with_options(self, options: FindAppointmentsOptions, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
...
class AppointmentException(winrt.system.Object):
    ...
    @_property
    def exception_properties(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
...
class AppointmentProperties_Static(type):
    ...
    @_property
    def default_properties(cls) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def details(cls) -> str: ...
    @_property
...
class FindAppointmentsOptions(winrt.system.Object):
    ...
    @_property
    def calendar_ids(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def fetch_properties(self) -> windows_foundation_collections.IVector[str]: ...
