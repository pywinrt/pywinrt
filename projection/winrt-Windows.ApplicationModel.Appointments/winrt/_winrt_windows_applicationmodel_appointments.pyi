...
class Appointment(winrt.system.Object):
    ...
    @_property
    def invitees(self) -> typing.Optional[windows_foundation_collections.IVector[AppointmentInvitee]]: ...
    @_property
...
class AppointmentCalendar(winrt.system.Object):
    ...
    @typing.overload
    def find_all_instances_async(self, master_local_id: str, range_start: datetime.datetime, range_length: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    @typing.overload
    def find_all_instances_async(self, master_local_id: str, range_start: datetime.datetime, range_length: datetime.timedelta, p_options: typing.Optional[FindAppointmentsOptions], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    @typing.overload
    def find_appointments_async(self, range_start: datetime.datetime, range_length: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    @typing.overload
    def find_appointments_async(self, range_start: datetime.datetime, range_length: datetime.timedelta, options: typing.Optional[FindAppointmentsOptions], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    def find_exceptions_from_master_async(self, master_local_id: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppointmentException]]: ...
    @typing.overload
    def find_unexpanded_appointments_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    @typing.overload
    def find_unexpanded_appointments_async(self, options: typing.Optional[FindAppointmentsOptions], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    ...
    def save_appointment_async(self, p_appointment: typing.Optional[Appointment], /) -> windows_foundation.IAsyncAction: ...
    def save_async(self) -> windows_foundation.IAsyncAction: ...
    def try_cancel_meeting_async(self, meeting: typing.Optional[Appointment], subject: str, comment: str, notify_invitees: bool, /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_create_or_update_appointment_async(self, appointment: typing.Optional[Appointment], notify_invitees: bool, /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_forward_meeting_async(self, meeting: typing.Optional[Appointment], invitees: typing.Iterable[AppointmentInvitee], subject: str, forward_header: str, comment: str, /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_propose_new_time_for_meeting_async(self, meeting: typing.Optional[Appointment], new_start_time: datetime.datetime, new_duration: datetime.timedelta, subject: str, comment: str, /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_update_meeting_response_async(self, meeting: typing.Optional[Appointment], response: AppointmentParticipantResponse, subject: str, comment: str, send_update: bool, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @_property
...
class AppointmentException(winrt.system.Object):
    ...
    @_property
    def exception_properties(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
...
class AppointmentManager_Static(type):
    def get_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[AppointmentManagerForUser]: ...
    def request_store_async(cls, options: AppointmentStoreAccessType, /) -> windows_foundation.IAsyncOperation[AppointmentStore]: ...
    @typing.overload
    def show_add_appointment_async(cls, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    def show_add_appointment_async(cls, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    def show_edit_new_appointment_async(cls, appointment: typing.Optional[Appointment], /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    @typing.overload
    def show_remove_appointment_async(cls, appointment_id: str, selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    def show_remove_appointment_async(cls, appointment_id: str, selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    def show_replace_appointment_async(cls, appointment_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    def show_replace_appointment_async(cls, appointment_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    def show_replace_appointment_async(cls, appointment_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[str]: ...
...
class AppointmentManagerForUser(winrt.system.Object):
    ...
    @typing.overload
    def show_add_appointment_async(self, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    def show_add_appointment_async(self, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    def show_edit_new_appointment_async(self, appointment: typing.Optional[Appointment], /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    @typing.overload
    def show_remove_appointment_async(self, appointment_id: str, selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    def show_remove_appointment_async(self, appointment_id: str, selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    def show_replace_appointment_async(self, appointment_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    def show_replace_appointment_async(self, appointment_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    def show_replace_appointment_async(self, appointment_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[str]: ...
...
class AppointmentProperties_Static(type):
    ...
    @_property
    def default_properties(cls) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def details(cls) -> str: ...
    @_property
...
class AppointmentStore(winrt.system.Object):
    ...
    @typing.overload
    def find_appointment_calendars_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppointmentCalendar]]: ...
    @typing.overload
    def find_appointment_calendars_async(self, options: FindAppointmentCalendarsOptions, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppointmentCalendar]]: ...
    @typing.overload
    def find_appointments_async(self, range_start: datetime.datetime, range_length: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    @typing.overload
    def find_appointments_async(self, range_start: datetime.datetime, range_length: datetime.timedelta, options: typing.Optional[FindAppointmentsOptions], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    @typing.overload
    def find_conflict_async(self, appointment: typing.Optional[Appointment], /) -> windows_foundation.IAsyncOperation[AppointmentConflictResult]: ...
    @typing.overload
    def find_conflict_async(self, appointment: typing.Optional[Appointment], instance_start_time: datetime.datetime, /) -> windows_foundation.IAsyncOperation[AppointmentConflictResult]: ...
    def find_local_ids_from_roaming_id_async(self, roaming_id: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[str]]: ...
    def get_appointment_async(self, local_id: str, /) -> windows_foundation.IAsyncOperation[Appointment]: ...
    ...
    def move_appointment_async(self, appointment: typing.Optional[Appointment], destination_calendar: typing.Optional[AppointmentCalendar], /) -> windows_foundation.IAsyncAction: ...
    def show_add_appointment_async(self, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    @typing.overload
    def show_remove_appointment_async(self, local_id: str, selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    def show_replace_appointment_async(self, local_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    def show_replace_appointment_async(self, local_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[str]: ...
...
class AppointmentStoreChangeReader(winrt.system.Object):
    ...
    def read_batch_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppointmentStoreChange]]: ...
...
class FindAppointmentsOptions(winrt.system.Object):
    ...
    @_property
    def calendar_ids(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def fetch_properties(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
