...
class AppointmentCalendar(winrt.system.Object):
    ...
    def find_all_instances_async_with_options(self, master_local_id: str, range_start: datetime.datetime, range_length: datetime.timedelta, p_options: typing.Optional[FindAppointmentsOptions], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    ...
    def find_appointments_async_with_options(self, range_start: datetime.datetime, range_length: datetime.timedelta, options: typing.Optional[FindAppointmentsOptions], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    ...
    def find_unexpanded_appointments_async_with_options(self, options: typing.Optional[FindAppointmentsOptions], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
...
class AppointmentManager_Static(type):
    ...
    def show_add_appointment_with_placement_async(cls, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
    ...
    def show_replace_appointment_with_placement_and_date_async(cls, appointment_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[str]: ...
    def show_replace_appointment_with_placement_async(cls, appointment_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
...
class AppointmentManagerForUser(winrt.system.Object):
    ...
    def show_add_appointment_with_placement_async(self, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
    ...
    def show_replace_appointment_with_placement_and_date_async(self, appointment_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[str]: ...
    def show_replace_appointment_with_placement_async(self, appointment_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
...
class AppointmentStore(winrt.system.Object):
    ...
    def find_appointment_calendars_async_with_options(self, options: FindAppointmentCalendarsOptions, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AppointmentCalendar]]: ...
    def find_appointments_async(self, range_start: datetime.datetime, range_length: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    def find_appointments_async_with_options(self, range_start: datetime.datetime, range_length: datetime.timedelta, options: typing.Optional[FindAppointmentsOptions], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Appointment]]: ...
    ...
    def find_conflict_async_with_instance_start(self, appointment: typing.Optional[Appointment], instance_start_time: datetime.datetime, /) -> windows_foundation.IAsyncOperation[AppointmentConflictResult]: ...
    ...
    def show_replace_appointment_with_placement_and_date_async(self, local_id: str, appointment: typing.Optional[Appointment], selection: windows_foundation.Rect, preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[str]: ...
