...
class PrintTicketCapabilities(winrt.system.Object):
    ...
    @_property
    def xml_node(self) -> typing.Optional[windows_data_xml_dom.IXmlNode]: ...
...
class PrintTicketFeature(winrt.system.Object):
    ...
    def name(self) -> str: ...
    @_property
    def options(self) -> typing.Optional[windows_foundation_collections.IVectorView[PrintTicketOption]]: ...
    @_property
...
class PrintTicketOption(winrt.system.Object):
    ...
    def get_property_node(self, name: str, xml_namespace: str, /) -> typing.Optional[windows_data_xml_dom.IXmlNode]: ...
    def get_property_value(self, name: str, xml_namespace: str, /) -> typing.Optional[PrintTicketValue]: ...
    def get_scored_property_node(self, name: str, xml_namespace: str, /) -> typing.Optional[windows_data_xml_dom.IXmlNode]: ...
