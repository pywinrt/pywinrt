...
class FileProtectionManager_Static(type):
    ...
    def load_file_from_container_with_target_and_name_collision_option_async(cls, container_file: typing.Optional[windows_storage.IStorageFile], target: typing.Optional[windows_storage.IStorageItem], collision_option: windows_storage.NameCollisionOption, /) -> windows_foundation.IAsyncOperation[ProtectedContainerImportResult]: ...
    def load_file_from_container_with_target_async(cls, container_file: typing.Optional[windows_storage.IStorageFile], target: typing.Optional[windows_storage.IStorageItem], /) -> windows_foundation.IAsyncOperation[ProtectedContainerImportResult]: ...
    ...
    def save_file_as_container_with_sharing_async(cls, protected_file: typing.Optional[windows_storage.IStorageFile], shared_with_identities: typing.Iterable[str], /) -> windows_foundation.IAsyncOperation[ProtectedContainerExportResult]: ...
    ...
    def unprotect_with_options_async(cls, target: typing.Optional[windows_storage.IStorageItem], options: typing.Optional[FileUnprotectOptions], /) -> windows_foundation.IAsyncOperation[FileProtectionInfo]: ...
...
class ProtectionPolicyManager_Static(type):
    ...
    def request_access_for_app_with_auditing_info_async(cls, source_identity: str, app_package_family_name: str, audit_info: typing.Optional[ProtectionPolicyAuditInfo], /) -> windows_foundation.IAsyncOperation[ProtectionPolicyEvaluationResult]: ...
    def request_access_for_app_with_behavior_async(cls, source_identity: str, app_package_family_name: str, audit_info: typing.Optional[ProtectionPolicyAuditInfo], message_from_app: str, behavior: ProtectionPolicyRequestAccessBehavior, /) -> windows_foundation.IAsyncOperation[ProtectionPolicyEvaluationResult]: ...
    def request_access_for_app_with_message_async(cls, source_identity: str, app_package_family_name: str, audit_info: typing.Optional[ProtectionPolicyAuditInfo], message_from_app: str, /) -> windows_foundation.IAsyncOperation[ProtectionPolicyEvaluationResult]: ...
    ...
    def request_access_with_auditing_info_async(cls, source_identity: str, target_identity: str, audit_info: typing.Optional[ProtectionPolicyAuditInfo], /) -> windows_foundation.IAsyncOperation[ProtectionPolicyEvaluationResult]: ...
    def request_access_with_behavior_async(cls, source_identity: str, target_identity: str, audit_info: typing.Optional[ProtectionPolicyAuditInfo], message_from_app: str, behavior: ProtectionPolicyRequestAccessBehavior, /) -> windows_foundation.IAsyncOperation[ProtectionPolicyEvaluationResult]: ...
    def request_access_with_message_async(cls, source_identity: str, target_identity: str, audit_info: typing.Optional[ProtectionPolicyAuditInfo], message_from_app: str, /) -> windows_foundation.IAsyncOperation[ProtectionPolicyEvaluationResult]: ...
