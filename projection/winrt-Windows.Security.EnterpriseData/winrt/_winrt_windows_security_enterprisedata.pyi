...
class DataProtectionManager_Static(type):
    ...
    def protect_async(cls, data: windows_storage_streams.IBuffer, identity: str, /) -> windows_foundation.IAsyncOperation[BufferProtectUnprotectResult]: ...
    ...
    def unprotect_async(cls, data: windows_storage_streams.IBuffer, /) -> windows_foundation.IAsyncOperation[BufferProtectUnprotectResult]: ...
