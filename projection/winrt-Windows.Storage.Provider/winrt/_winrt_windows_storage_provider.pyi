...
class StorageProviderKnownFolderSyncInfo(winrt.system.Object):
    ...
    @_property
    def known_folder_entries(self) -> windows_foundation_collections.IVector[StorageProviderKnownFolderEntry]: ...
...
class StorageProviderKnownFolderSyncRequestArgs(winrt.system.Object):
    ...
    @_property
    def known_folders(self) -> windows_foundation_collections.IVectorView[_uuid.UUID]: ...
    @_property
...
class StorageProviderStatusUI(winrt.system.Object):
    ...
    @_property
    def quota_u_i(self) -> StorageProviderQuotaUI: ...
    @quota_u_i.setter
    def quota_u_i(self, value: StorageProviderQuotaUI) -> None: ...
    @_property
    ...
    @_property
    def provider_secondary_commands(self) -> windows_foundation_collections.IVector[IStorageProviderUICommand]: ...
    @provider_secondary_commands.setter
    def provider_secondary_commands(self, value: windows_foundation_collections.IVector[IStorageProviderUICommand]) -> None: ...
    @_property
    ...
    @_property
    def more_info_u_i(self) -> StorageProviderMoreInfoUI: ...
    @more_info_u_i.setter
    def more_info_u_i(self, value: StorageProviderMoreInfoUI) -> None: ...
...
class StorageProviderSyncRootInfo(winrt.system.Object):
    ...
    @_property
    def storage_provider_item_property_definitions(self) -> windows_foundation_collections.IVector[StorageProviderItemPropertyDefinition]: ...
    @_property
    def provider_id(self) -> _uuid.UUID: ...
    @provider_id.setter
    def provider_id(self, value: _uuid.UUID) -> None: ...
    @_property
    def fallback_file_type_info(self) -> windows_foundation_collections.IVector[StorageProviderFileTypeInfo]: ...

@typing.final
class StorageProviderSyncRootManager_Static(type):
    def get_current_sync_roots(cls) -> windows_foundation_collections.IVectorView[StorageProviderSyncRootInfo]: ...
...
class IStorageProviderItemPropertySource(winrt.system.Object):
    ...
    def get_item_properties(self, item_path: str, /) -> windows_foundation_collections.IIterable[StorageProviderItemProperty]: ...
...
class IStorageProviderStatusUISource(winrt.system.Object):
    ...
    def get_status_u_i(self) -> StorageProviderStatusUI: ...
...
class IStorageProviderStatusUISourceFactory(winrt.system.Object):
    ...
    def get_status_u_i_source(self, sync_root_id: str, /) -> IStorageProviderStatusUISource: ...
