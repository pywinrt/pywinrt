...
class CachedFileUpdater_Static(type):
    def set_update_information(cls, file: typing.Optional[windows_storage.IStorageFile], content_id: str, read_mode: ReadActivationMode, write_mode: WriteActivationMode, options: CachedFileOptions, /) -> None: ...
...
class CachedFileUpdaterUI(winrt.system.Object):
    ...
    def add_u_i_requested(self, handler: windows_foundation.TypedEventHandler[CachedFileUpdaterUI, winrt.system.Object], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_u_i_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
    def title(self) -> str: ...
    @title.setter
...
class FileUpdateRequest(winrt.system.Object):
    ...
    def get_deferral(self) -> typing.Optional[FileUpdateRequestDeferral]: ...
    def update_local_file(self, value: typing.Optional[windows_storage.IStorageFile], /) -> None: ...
    @_property
...
class StorageProviderItemProperties_Static(type):
    def set_async(cls, item: typing.Optional[windows_storage.IStorageItem], item_properties: typing.Iterable[StorageProviderItemProperty], /) -> windows_foundation.IAsyncAction: ...
...
class StorageProviderKnownFolderSyncInfo(winrt.system.Object):
    ...
    @_property
    def known_folder_entries(self) -> typing.Optional[windows_foundation_collections.IVector[StorageProviderKnownFolderEntry]]: ...
...
class StorageProviderKnownFolderSyncRequestArgs(winrt.system.Object):
    ...
    @_property
    def known_folders(self) -> typing.Optional[windows_foundation_collections.IVectorView[_uuid.UUID]]: ...
    @_property
    def source(self) -> typing.Optional[windows_storage.StorageFolder]: ...
...
class StorageProviderQuotaUI(winrt.system.Object):
    ...
    @_property
    def quota_used_color(self) -> typing.Optional[typing.Optional[windows_ui.Color]]: ...
    @quota_used_color.setter
    def quota_used_color(self, value: typing.Optional[typing.Optional[windows_ui.Color]]) -> None: ...
    @_property
...
class StorageProviderStatusUI(winrt.system.Object):
    ...
    @_property
    def provider_state_icon(self) -> typing.Optional[windows_foundation.Uri]: ...
    @provider_state_icon.setter
    def provider_state_icon(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    def provider_state(self) -> StorageProviderState: ...
    @provider_state.setter
    def provider_state(self, value: StorageProviderState) -> None: ...
    @_property
    def provider_secondary_commands(self) -> typing.Optional[windows_foundation_collections.IVector[IStorageProviderUICommand]]: ...
    @provider_secondary_commands.setter
    def provider_secondary_commands(self, value: typing.Optional[windows_foundation_collections.IVector[IStorageProviderUICommand]]) -> None: ...
    @_property
...
class StorageProviderSyncRootInfo(winrt.system.Object):
    ...
    @_property
    def recycle_bin_uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @recycle_bin_uri.setter
    def recycle_bin_uri(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    ...
    @_property
    def path(self) -> typing.Optional[windows_storage.IStorageFolder]: ...
    @path.setter
    def path(self, value: typing.Optional[windows_storage.IStorageFolder]) -> None: ...
    @_property
    ...
    def display_name_resource(self, value: str) -> None: ...
    @_property
    def context(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @context.setter
    def context(self, value: typing.Optional[windows_storage_streams.IBuffer]) -> None: ...
    @_property
    def allow_pinning(self) -> bool: ...
    @allow_pinning.setter
    def allow_pinning(self, value: bool) -> None: ...
    @_property
    def storage_provider_item_property_definitions(self) -> typing.Optional[windows_foundation_collections.IVector[StorageProviderItemPropertyDefinition]]: ...
    @_property
    def provider_id(self) -> _uuid.UUID: ...
    @provider_id.setter
    def provider_id(self, value: _uuid.UUID) -> None: ...
    @_property
    def fallback_file_type_info(self) -> typing.Optional[windows_foundation_collections.IVector[StorageProviderFileTypeInfo]]: ...

@typing.final
class StorageProviderSyncRootManager_Static(type):
    def get_current_sync_roots(cls) -> typing.Optional[windows_foundation_collections.IVectorView[StorageProviderSyncRootInfo]]: ...
    def get_sync_root_information_for_folder(cls, folder: typing.Optional[windows_storage.IStorageFolder], /) -> typing.Optional[StorageProviderSyncRootInfo]: ...
...
class IStorageProviderItemPropertySource(winrt.system.Object):
    ...
    def get_item_properties(self, item_path: str, /) -> typing.Optional[windows_foundation_collections.IIterable[StorageProviderItemProperty]]: ...
...
class IStorageProviderStatusUISource(winrt.system.Object):
    ...
    def add_status_u_i_changed(self, handler: windows_foundation.TypedEventHandler[IStorageProviderStatusUISource, winrt.system.Object], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_status_u_i_changed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
