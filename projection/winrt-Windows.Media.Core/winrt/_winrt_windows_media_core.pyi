...
class MediaStreamSource(winrt.system.Object, ImplementsIMediaSource):
    @typing.overload
    def __new__(cls: typing.Type[Self], descriptor: ImplementsIMediaStreamDescriptor) -> Self: ...
    @typing.overload
    def __new__(cls: typing.Type[Self], descriptor: ImplementsIMediaStreamDescriptor, descriptor2: ImplementsIMediaStreamDescriptor) -> Self: ...
