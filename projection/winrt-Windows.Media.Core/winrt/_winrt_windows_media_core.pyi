...
@typing.final
class AudioStreamDescriptor(winrt.system.Object, ImplementsIMediaStreamDescriptor2, ImplementsIMediaStreamDescriptor):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> AudioStreamDescriptor: ...
    def __new__(cls: typing.Type[AudioStreamDescriptor], encoding_properties: windows_media_mediaproperties.AudioEncodingProperties) -> AudioStreamDescriptor: ...
...
@typing.final
class AudioTrack(winrt.system.Object, ImplementsIMediaTrack):
    @staticmethod
...
@typing.final
class ChapterCue(winrt.system.Object, ImplementsIMediaCue):
    @staticmethod
...
@typing.final
class DataCue(winrt.system.Object, ImplementsIMediaCue):
    @staticmethod
...
@typing.final
class FaceDetectionEffect(winrt.system.Object, windows_media.ImplementsIMediaExtension):
    @staticmethod
...
@typing.final
class FaceDetectionEffectDefinition(winrt.system.Object, windows_media_effects.ImplementsIVideoEffectDefinition):
    @staticmethod
...
@typing.final
class FaceDetectionEffectFrame(winrt.system.Object, windows_media.ImplementsIMediaFrame, windows_foundation.ImplementsIClosable):
...
@typing.final
class ImageCue(winrt.system.Object, ImplementsIMediaCue):
    @staticmethod
...
@typing.final
class LowLightFusionResult(winrt.system.Object, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
...
class MediaBindingEventArgs(winrt.system.Object):
    ...
    def set_storage_file(self, file: windows_storage.ImplementsIStorageFile, /) -> None: ...
    def set_stream(self, stream: windows_storage_streams.ImplementsIRandomAccessStream, content_type: str, /) -> None: ...
    def set_stream_reference(self, stream: windows_storage_streams.ImplementsIRandomAccessStreamReference, content_type: str, /) -> None: ...
...
class MediaSource_Static(type):
    ...
    def create_from_imedia_source(cls, media_source: ImplementsIMediaSource, /) -> MediaSource: ...
    ...
    def create_from_storage_file(cls, file: windows_storage.ImplementsIStorageFile, /) -> MediaSource: ...
    def create_from_stream(cls, stream: windows_storage_streams.ImplementsIRandomAccessStream, content_type: str, /) -> MediaSource: ...
    def create_from_stream_reference(cls, stream: windows_storage_streams.ImplementsIRandomAccessStreamReference, content_type: str, /) -> MediaSource: ...
    def create_from_uri(cls, uri: windows_foundation.Uri, /) -> MediaSource: ...

@typing.final
class MediaSource(winrt.system.Object, windows_foundation.ImplementsIClosable, windows_media_playback.ImplementsIMediaPlaybackSource, metaclass=MediaSource_Static):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
...
class MediaSourceAppServiceConnection(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[MediaSourceAppServiceConnection], app_service_connection: windows_applicationmodel_appservice.AppServiceConnection) -> MediaSourceAppServiceConnection: ...
    def start(self) -> None: ...
...
class MediaStreamSample_Static(type):
    def create_from_buffer(cls, buffer: windows_storage_streams.ImplementsIBuffer, timestamp: datetime.timedelta, /) -> MediaStreamSample: ...
    def create_from_direct3d11_surface(cls, surface: windows_graphics_directx_direct3d11.ImplementsIDirect3DSurface, timestamp: datetime.timedelta, /) -> MediaStreamSample: ...
    def create_from_stream_async(cls, stream: windows_storage_streams.ImplementsIInputStream, count: winrt.system.UInt32, timestamp: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[MediaStreamSample]: ...
...
@typing.final
class MediaStreamSource(winrt.system.Object, ImplementsIMediaSource):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> MediaStreamSource: ...
    @typing.overload
    def __new__(cls: typing.Type[MediaStreamSource], descriptor: ImplementsIMediaStreamDescriptor) -> MediaStreamSource: ...
    @typing.overload
    def __new__(cls: typing.Type[MediaStreamSource], descriptor: ImplementsIMediaStreamDescriptor, descriptor2: ImplementsIMediaStreamDescriptor) -> MediaStreamSource: ...
    def add_protection_key(self, stream_descriptor: ImplementsIMediaStreamDescriptor, key_identifier: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], license_data: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> None: ...
    def add_stream_descriptor(self, descriptor: ImplementsIMediaStreamDescriptor, /) -> None: ...
...
class MseSourceBuffer(winrt.system.Object):
    ...
    def abort(self) -> None: ...
    def append_buffer(self, buffer: windows_storage_streams.ImplementsIBuffer, /) -> None: ...
    def append_stream(self, stream: windows_storage_streams.ImplementsIInputStream, /) -> None: ...
    def append_stream_max_size(self, stream: windows_storage_streams.ImplementsIInputStream, max_size: winrt.system.UInt64, /) -> None: ...
...
@typing.final
class MseStreamSource(winrt.system.Object, ImplementsIMediaSource, metaclass=MseStreamSource_Static):
    @staticmethod
...
@typing.final
class SceneAnalysisEffect(winrt.system.Object, windows_media.ImplementsIMediaExtension):
    @staticmethod
...
@typing.final
class SceneAnalysisEffectDefinition(winrt.system.Object, windows_media_effects.ImplementsIVideoEffectDefinition):
    @staticmethod
...
@typing.final
class SceneAnalysisEffectFrame(winrt.system.Object, windows_media.ImplementsIMediaFrame, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
...
@typing.final
class SpeechCue(winrt.system.Object, ImplementsIMediaCue):
    @staticmethod
...
@typing.final
class TimedMetadataStreamDescriptor(winrt.system.Object, ImplementsIMediaStreamDescriptor2, ImplementsIMediaStreamDescriptor):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> TimedMetadataStreamDescriptor: ...
    def __new__(cls: typing.Type[TimedMetadataStreamDescriptor], encoding_properties: windows_media_mediaproperties.TimedMetadataEncodingProperties) -> TimedMetadataStreamDescriptor: ...
...
@typing.final
class TimedMetadataTrack(winrt.system.Object, ImplementsIMediaTrack):
    @staticmethod
    ...
    def add_cue(self, cue: ImplementsIMediaCue, /) -> None: ...
    def remove_cue(self, cue: ImplementsIMediaCue, /) -> None: ...
...
@typing.final
class TimedTextCue(winrt.system.Object, ImplementsIMediaCue):
    @staticmethod
...
class TimedTextSource_Static(type):
    def create_from_stream(cls, stream: windows_storage_streams.ImplementsIRandomAccessStream, /) -> TimedTextSource: ...
    def create_from_stream_with_index(cls, stream: windows_storage_streams.ImplementsIRandomAccessStream, index_stream: windows_storage_streams.ImplementsIRandomAccessStream, /) -> TimedTextSource: ...
    def create_from_stream_with_index_and_language(cls, stream: windows_storage_streams.ImplementsIRandomAccessStream, index_stream: windows_storage_streams.ImplementsIRandomAccessStream, default_language: str, /) -> TimedTextSource: ...
    def create_from_stream_with_language(cls, stream: windows_storage_streams.ImplementsIRandomAccessStream, default_language: str, /) -> TimedTextSource: ...
...
@typing.final
class VideoStabilizationEffect(winrt.system.Object, windows_media.ImplementsIMediaExtension):
    @staticmethod
...
@typing.final
class VideoStabilizationEffectDefinition(winrt.system.Object, windows_media_effects.ImplementsIVideoEffectDefinition):
    @staticmethod
...
@typing.final
class VideoStreamDescriptor(winrt.system.Object, ImplementsIMediaStreamDescriptor2, ImplementsIMediaStreamDescriptor):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> VideoStreamDescriptor: ...
    def __new__(cls: typing.Type[VideoStreamDescriptor], encoding_properties: windows_media_mediaproperties.VideoEncodingProperties) -> VideoStreamDescriptor: ...
...
@typing.final
class VideoTrack(winrt.system.Object, ImplementsIMediaTrack):
    @staticmethod
