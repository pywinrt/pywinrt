...
class CodecInfo(winrt.system.Object):
    ...
    @_property
    def subtypes(self) -> windows_foundation_collections.IVectorView[str]: ...
...
class FaceDetectionEffectFrame(winrt.system.Object):
    ...
    def close(self) -> None: ...
    @_property
    def detected_faces(self) -> windows_foundation_collections.IVectorView[windows_media_faceanalysis.DetectedFace]: ...
    @_property
...
class HighDynamicRangeOutput(winrt.system.Object):
    ...
    @_property
    def frame_controllers(self) -> windows_foundation_collections.IVectorView[windows_media_devices_core.FrameController]: ...
...
class LowLightFusion_Static(type):
    ...
    @_property
    def supported_bitmap_pixel_formats(cls) -> windows_foundation_collections.IVectorView[windows_graphics_imaging.BitmapPixelFormat]: ...
...
class MediaSource_Static(type):
    ...
    def create_from_i_media_source(cls, media_source: IMediaSource, /) -> MediaSource: ...
...
class MediaStreamSample_Static(type):
    ...
    def create_from_direct3_d11_surface(cls, surface: windows_graphics_directx_direct3d11.IDirect3DSurface, timestamp: datetime.timedelta, /) -> MediaStreamSample: ...
...
class MediaStreamSample(winrt.system.Object, metaclass=MediaStreamSample_Static):
    ...
    @_property
    def direct3_d11_surface(self) -> windows_graphics_directx_direct3d11.IDirect3DSurface: ...
...
class MediaStreamSamplePropertySet(winrt.system.Object, winrt._winrt.MutableMapping[_uuid.UUID, winrt.system.Object]):
    ...
    def get_view(self) -> windows_foundation_collections.IMapView[_uuid.UUID, winrt.system.Object]: ...
...
class MediaStreamSource(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[MediaStreamSource], descriptor: IMediaStreamDescriptor) -> MediaStreamSource: ...
    @typing.overload
    def __new__(cls: typing.Type[MediaStreamSource], descriptor: IMediaStreamDescriptor, descriptor2: IMediaStreamDescriptor) -> MediaStreamSource: ...
...
class MseSourceBuffer(winrt.system.Object):
    ...
    @_property
    def buffered(self) -> windows_foundation_collections.IVectorView[MseTimeRange]: ...
    @_property
...
class MseSourceBufferList(winrt.system.Object):
    ...
    @_property
    def buffers(self) -> windows_foundation_collections.IVectorView[MseSourceBuffer]: ...
...
class TimedMetadataTrack(winrt.system.Object):
    ...
    def track_kind(self) -> MediaTrackKind: ...
    @_property
    def active_cues(self) -> windows_foundation_collections.IVectorView[IMediaCue]: ...
    @_property
    def cues(self) -> windows_foundation_collections.IVectorView[IMediaCue]: ...
    @_property
...
class TimedTextCue(winrt.system.Object):
    ...
    @_property
    def lines(self) -> windows_foundation_collections.IVector[TimedTextLine]: ...
...
class TimedTextLine(winrt.system.Object):
    ...
    def text(self, value: str) -> None: ...
    @_property
    def subformats(self) -> windows_foundation_collections.IVector[TimedTextSubformat]: ...
...
class TimedTextSourceResolveResultEventArgs(winrt.system.Object):
    ...
    def error(self) -> TimedMetadataTrackError: ...
    @_property
    def tracks(self) -> windows_foundation_collections.IVectorView[TimedMetadataTrack]: ...
...
class ITimedMetadataTrackProvider(winrt.system.Object):
    ...
    @_property
    def timed_metadata_tracks(self) -> windows_foundation_collections.IVectorView[TimedMetadataTrack]: ...
