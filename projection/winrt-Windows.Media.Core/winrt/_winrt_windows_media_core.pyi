...
class AudioStreamDescriptor(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[AudioStreamDescriptor], encoding_properties: typing.Optional[windows_media_mediaproperties.AudioEncodingProperties]) -> AudioStreamDescriptor: ...
...
class AudioTrack(winrt.system.Object):
    ...
    def get_encoding_properties(self) -> typing.Optional[windows_media_mediaproperties.AudioEncodingProperties]: ...
    ...
    def name(self) -> str: ...
    @_property
    def playback_item(self) -> typing.Optional[windows_media_playback.MediaPlaybackItem]: ...
    @_property
...
class CodecInfo(winrt.system.Object):
    ...
    @_property
    def subtypes(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
...
class CodecQuery(winrt.system.Object):
    ...
    def find_all_async(self, kind: CodecKind, category: CodecCategory, sub_type: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[CodecInfo]]: ...
...
class DataCue(winrt.system.Object):
    ...
    @_property
    def properties(self) -> typing.Optional[windows_foundation_collections.PropertySet]: ...
    @_property
    def start_time(self) -> datetime.timedelta: ...
    @start_time.setter
    def start_time(self, value: datetime.timedelta) -> None: ...
...
class FaceDetectionEffectFrame(winrt.system.Object):
    ...
    def close(self) -> None: ...
    @_property
    def detected_faces(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_media_faceanalysis.DetectedFace]]: ...
    @_property
...
class HighDynamicRangeOutput(winrt.system.Object):
    ...
    @_property
    def frame_controllers(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_media_devices_core.FrameController]]: ...
...
class ImageCue(winrt.system.Object):
    ...
    def software_bitmap(self, value: typing.Optional[windows_graphics_imaging.SoftwareBitmap]) -> None: ...
    @_property
...
class InitializeMediaStreamSourceRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def random_access_stream(self) -> typing.Optional[windows_storage_streams.IRandomAccessStream]: ...
    @_property
...
class LowLightFusion_Static(type):
    ...
    @_property
    def supported_bitmap_pixel_formats(cls) -> typing.Optional[windows_foundation_collections.IVectorView[windows_graphics_imaging.BitmapPixelFormat]]: ...
...
class LowLightFusionResult(winrt.system.Object):
    ...
    def close(self) -> None: ...
    @_property
    def frame(self) -> typing.Optional[windows_graphics_imaging.SoftwareBitmap]: ...
...
class MediaBindingEventArgs(winrt.system.Object):
    ...
    def get_deferral(self) -> typing.Optional[windows_foundation.Deferral]: ...
    def set_adaptive_media_source(self, media_source: typing.Optional[windows_media_streaming_adaptive.AdaptiveMediaSource], /) -> None: ...
    def set_download_operation(self, download_operation: typing.Optional[windows_networking_backgroundtransfer.DownloadOperation], /) -> None: ...
    def set_storage_file(self, file: typing.Optional[windows_storage.IStorageFile], /) -> None: ...
    def set_stream(self, stream: typing.Optional[windows_storage_streams.IRandomAccessStream], content_type: str, /) -> None: ...
    def set_stream_reference(self, stream: typing.Optional[windows_storage_streams.IRandomAccessStreamReference], content_type: str, /) -> None: ...
    def set_uri(self, uri: typing.Optional[windows_foundation.Uri], /) -> None: ...
...
class MediaSource_Static(type):
    def create_from_adaptive_media_source(cls, media_source: typing.Optional[windows_media_streaming_adaptive.AdaptiveMediaSource], /) -> typing.Optional[MediaSource]: ...
    def create_from_download_operation(cls, download_operation: typing.Optional[windows_networking_backgroundtransfer.DownloadOperation], /) -> typing.Optional[MediaSource]: ...
    ...
    def create_from_media_frame_source(cls, frame_source: typing.Optional[windows_media_capture_frames.MediaFrameSource], /) -> typing.Optional[MediaSource]: ...
    ...
    def create_from_storage_file(cls, file: typing.Optional[windows_storage.IStorageFile], /) -> typing.Optional[MediaSource]: ...
    def create_from_stream(cls, stream: typing.Optional[windows_storage_streams.IRandomAccessStream], content_type: str, /) -> typing.Optional[MediaSource]: ...
    def create_from_stream_reference(cls, stream: typing.Optional[windows_storage_streams.IRandomAccessStreamReference], content_type: str, /) -> typing.Optional[MediaSource]: ...
    def create_from_uri(cls, uri: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[MediaSource]: ...
...
class MediaSource(winrt.system.Object, metaclass=MediaSource_Static):
    ...
    def duration(self) -> typing.Optional[typing.Optional[datetime.timedelta]]: ...
    @_property
    def external_timed_metadata_tracks(self) -> typing.Optional[windows_foundation_collections.IObservableVector[TimedMetadataTrack]]: ...
    @_property
    def external_timed_text_sources(self) -> typing.Optional[windows_foundation_collections.IObservableVector[TimedTextSource]]: ...
    @_property
    def is_open(self) -> bool: ...
    @_property
    def state(self) -> MediaSourceState: ...
    @_property
    def adaptive_media_source(self) -> typing.Optional[windows_media_streaming_adaptive.AdaptiveMediaSource]: ...
    @_property
    ...
    @_property
    def download_operation(self) -> typing.Optional[windows_networking_backgroundtransfer.DownloadOperation]: ...
...
class MediaSourceAppServiceConnection(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[MediaSourceAppServiceConnection], app_service_connection: typing.Optional[windows_applicationmodel_appservice.AppServiceConnection]) -> MediaSourceAppServiceConnection: ...
    def start(self) -> None: ...
...
class MediaStreamSample_Static(type):
    def create_from_buffer(cls, buffer: typing.Optional[windows_storage_streams.IBuffer], timestamp: datetime.timedelta, /) -> typing.Optional[MediaStreamSample]: ...
    def create_from_direct3_d11_surface(cls, surface: typing.Optional[windows_graphics_directx_direct3d11.IDirect3DSurface], timestamp: datetime.timedelta, /) -> typing.Optional[MediaStreamSample]: ...
    def create_from_stream_async(cls, stream: typing.Optional[windows_storage_streams.IInputStream], count: winrt.system.UInt32, timestamp: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[MediaStreamSample]: ...
...
class MediaStreamSample(winrt.system.Object, metaclass=MediaStreamSample_Static):
    ...
    @_property
    def direct3_d11_surface(self) -> typing.Optional[windows_graphics_directx_direct3d11.IDirect3DSurface]: ...
...
class MediaStreamSamplePropertySet(winrt.system.Object, winrt._winrt.MutableMapping[_uuid.UUID, winrt.system.Object]):
    ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[windows_foundation_collections.IKeyValuePair[_uuid.UUID, winrt.system.Object]]]: ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IMapView[_uuid.UUID, winrt.system.Object]]: ...
...
class MediaStreamSource(winrt.system.Object):
    ...
    def add_protection_key(self, stream_descriptor: typing.Optional[IMediaStreamDescriptor], key_identifier: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], license_data: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> None: ...
    ...
    @_property
    def media_protection_manager(self) -> typing.Optional[windows_media_protection.MediaProtectionManager]: ...
    @media_protection_manager.setter
    def media_protection_manager(self, value: typing.Optional[windows_media_protection.MediaProtectionManager]) -> None: ...
    @_property
    def duration(self) -> datetime.timedelta: ...
    @duration.setter
    def duration(self, value: datetime.timedelta) -> None: ...
...
class MseSourceBuffer(winrt.system.Object):
    ...
    def abort(self) -> None: ...
    def append_buffer(self, buffer: typing.Optional[windows_storage_streams.IBuffer], /) -> None: ...
    def append_stream(self, stream: typing.Optional[windows_storage_streams.IInputStream], /) -> None: ...
    def append_stream_max_size(self, stream: typing.Optional[windows_storage_streams.IInputStream], max_size: winrt.system.UInt64, /) -> None: ...
    ...
    @_property
    def buffered(self) -> typing.Optional[windows_foundation_collections.IVectorView[MseTimeRange]]: ...
    @_property
...
class MseSourceBufferList(winrt.system.Object):
    ...
    @_property
    def buffers(self) -> typing.Optional[windows_foundation_collections.IVectorView[MseSourceBuffer]]: ...
...
class SceneAnalysisEffectFrame(winrt.system.Object):
    ...
    def close(self) -> None: ...
    @_property
    def frame_control_values(self) -> typing.Optional[windows_media_capture.CapturedFrameControlValues]: ...
    @_property
...
class TimedMetadataStreamDescriptor(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[TimedMetadataStreamDescriptor], encoding_properties: typing.Optional[windows_media_mediaproperties.TimedMetadataEncodingProperties]) -> TimedMetadataStreamDescriptor: ...
    ...
    def label(self, value: str) -> None: ...
    @_property
    def encoding_properties(self) -> typing.Optional[windows_media_mediaproperties.TimedMetadataEncodingProperties]: ...
...
class TimedMetadataTrack(winrt.system.Object):
    ...
    def track_kind(self) -> MediaTrackKind: ...
    @_property
    def active_cues(self) -> typing.Optional[windows_foundation_collections.IVectorView[IMediaCue]]: ...
    @_property
    def cues(self) -> typing.Optional[windows_foundation_collections.IVectorView[IMediaCue]]: ...
    @_property
...
class TimedTextCue(winrt.system.Object):
    ...
    @_property
    def lines(self) -> typing.Optional[windows_foundation_collections.IVector[TimedTextLine]]: ...
...
class TimedTextLine(winrt.system.Object):
    ...
    def text(self, value: str) -> None: ...
    @_property
    def subformats(self) -> typing.Optional[windows_foundation_collections.IVector[TimedTextSubformat]]: ...
...
class TimedTextSource_Static(type):
    def create_from_stream(cls, stream: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> typing.Optional[TimedTextSource]: ...
    def create_from_stream_with_index(cls, stream: typing.Optional[windows_storage_streams.IRandomAccessStream], index_stream: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> typing.Optional[TimedTextSource]: ...
    def create_from_stream_with_index_and_language(cls, stream: typing.Optional[windows_storage_streams.IRandomAccessStream], index_stream: typing.Optional[windows_storage_streams.IRandomAccessStream], default_language: str, /) -> typing.Optional[TimedTextSource]: ...
    def create_from_stream_with_language(cls, stream: typing.Optional[windows_storage_streams.IRandomAccessStream], default_language: str, /) -> typing.Optional[TimedTextSource]: ...
    def create_from_uri(cls, uri: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[TimedTextSource]: ...
    def create_from_uri_with_index(cls, uri: typing.Optional[windows_foundation.Uri], index_uri: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[TimedTextSource]: ...
    def create_from_uri_with_index_and_language(cls, uri: typing.Optional[windows_foundation.Uri], index_uri: typing.Optional[windows_foundation.Uri], default_language: str, /) -> typing.Optional[TimedTextSource]: ...
    def create_from_uri_with_language(cls, uri: typing.Optional[windows_foundation.Uri], default_language: str, /) -> typing.Optional[TimedTextSource]: ...
...
class TimedTextSourceResolveResultEventArgs(winrt.system.Object):
    ...
    def error(self) -> typing.Optional[TimedMetadataTrackError]: ...
    @_property
    def tracks(self) -> typing.Optional[windows_foundation_collections.IVectorView[TimedMetadataTrack]]: ...
...
class VideoStabilizationEffect(winrt.system.Object):
    ...
    def get_recommended_stream_configuration(self, controller: typing.Optional[windows_media_devices.VideoDeviceController], desired_properties: typing.Optional[windows_media_mediaproperties.VideoEncodingProperties], /) -> typing.Optional[windows_media_capture.VideoStreamConfiguration]: ...
    def set_properties(self, configuration: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
...
class VideoStreamDescriptor(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[VideoStreamDescriptor], encoding_properties: typing.Optional[windows_media_mediaproperties.VideoEncodingProperties]) -> VideoStreamDescriptor: ...
    ...
    def label(self, value: str) -> None: ...
    @_property
    def encoding_properties(self) -> typing.Optional[windows_media_mediaproperties.VideoEncodingProperties]: ...

@typing.final
class VideoTrack(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> VideoTrack: ...
    def get_encoding_properties(self) -> typing.Optional[windows_media_mediaproperties.VideoEncodingProperties]: ...
...
class ITimedMetadataTrackProvider(winrt.system.Object):
    ...
    @_property
    def timed_metadata_tracks(self) -> typing.Optional[windows_foundation_collections.IVectorView[TimedMetadataTrack]]: ...
