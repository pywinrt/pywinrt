...
PyMODINIT_FUNC PyInit__winrt_windows_services_maps_offlinemaps(void) noexcept
{
    ...
    py::pyobj_handle OfflineMapPackage_type{py::register_python_type(module.get(), &type_spec_OfflineMapPackage, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_OfflineMapPackage_Static.get()))};
    if (!OfflineMapPackage_type)
    {
        return nullptr;
    }

    py::pyobj_handle OfflineMapPackageQueryResult_type{py::register_python_type(module.get(), &type_spec_OfflineMapPackageQueryResult, object_bases.get(), nullptr)};
    if (!OfflineMapPackageQueryResult_type)
    {
        return nullptr;
    }

    py::pyobj_handle OfflineMapPackageStartDownloadResult_type{py::register_python_type(module.get(), &type_spec_OfflineMapPackageStartDownloadResult, object_bases.get(), nullptr)};
