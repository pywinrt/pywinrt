...
class ActivitySensor_Static(type):
    ...
    @typing.overload
    def get_system_history_async(cls, from_time: datetime.datetime, duration: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ActivitySensorReading]]: ...
...
class Pedometer_Static(type):
    ...
    @typing.overload
    def get_system_history_async(cls, from_time: datetime.datetime, duration: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[PedometerReading]]: ...
