...
class ActivitySensor(winrt.system.Object, metaclass=ActivitySensor_Static):
    ...
    @_property
    def subscribed_activities(self) -> windows_foundation_collections.IVector[ActivityType]: ...
    @_property
    def supported_activities(self) -> windows_foundation_collections.IVectorView[ActivityType]: ...
...
class ActivitySensorTriggerDetails(winrt.system.Object):
    ...
    def read_reports(self) -> windows_foundation_collections.IVectorView[ActivitySensorReadingChangeReport]: ...
...
class HumanPresenceFeatures(winrt.system.Object):
    ...
    @_property
    def supported_wake_or_lock_distances_in_millimeters(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
...
class HumanPresenceSensorReading(winrt.system.Object):
    ...
    def properties(self) -> windows_foundation_collections.IMapView[str, winrt.system.Object]: ...
    @_property
    def detected_persons(self) -> windows_foundation_collections.IVectorView[DetectedPerson]: ...
    @_property
...
class HumanPresenceSettings_Static(type):
    ...
    def get_supported_lock_on_leave_timeouts(cls) -> windows_foundation_collections.IVectorView[datetime.timedelta]: ...
...
class Pedometer_Static(type):
    ...
    def get_device_selector(cls) -> str: ...
    def get_readings_from_trigger_details(cls, trigger_details: SensorDataThresholdTriggerDetails, /) -> windows_foundation_collections.IVectorView[PedometerReading]: ...
...
class Pedometer(winrt.system.Object, metaclass=Pedometer_Static):
    ...
    def get_current_readings(self) -> windows_foundation_collections.IMapView[PedometerStepKind, PedometerReading]: ...
...
class ProximitySensor_Static(type):
    ...
    def get_device_selector(cls) -> str: ...
    def get_readings_from_trigger_details(cls, trigger_details: SensorDataThresholdTriggerDetails, /) -> windows_foundation_collections.IVectorView[ProximitySensorReading]: ...
