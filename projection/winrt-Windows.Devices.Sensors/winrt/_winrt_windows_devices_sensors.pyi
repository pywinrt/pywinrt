...
class Accelerometer_Static(type):
    ...
    def get_default_with_accelerometer_reading_type(cls, reading_type: AccelerometerReadingType, /) -> typing.Optional[Accelerometer]: ...
...
class Accelerometer(winrt.system.Object, metaclass=Accelerometer_Static):
    ...
    def remove_shaken(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
...
class ActivitySensor_Static(type):
    ...
    def get_system_history_async(cls, from_time: datetime.datetime, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ActivitySensorReading]]: ...
    def get_system_history_with_duration_async(cls, from_time: datetime.datetime, duration: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ActivitySensorReading]]: ...
...
class ActivitySensor(winrt.system.Object, metaclass=ActivitySensor_Static):
    ...
    @_property
    def subscribed_activities(self) -> typing.Optional[windows_foundation_collections.IVector[ActivityType]]: ...
    @_property
    def supported_activities(self) -> typing.Optional[windows_foundation_collections.IVectorView[ActivityType]]: ...
...
class ActivitySensorTriggerDetails(winrt.system.Object):
    ...
    def read_reports(self) -> typing.Optional[windows_foundation_collections.IVectorView[ActivitySensorReadingChangeReport]]: ...
...
class DetectedPerson(winrt.system.Object):
    ...
    @_property
    def head_orientation(self) -> typing.Optional[HeadOrientation]: ...
    @_property
    def head_position(self) -> typing.Optional[HeadPosition]: ...
    @_property
    def person_id(self) -> typing.Optional[typing.Optional[winrt.system.Int32]]: ...
...
class HeadOrientation(winrt.system.Object):
    ...
    @_property
    def pitch_in_degrees(self) -> typing.Optional[typing.Optional[winrt.system.Double]]: ...
    @_property
    def roll_in_degrees(self) -> typing.Optional[typing.Optional[winrt.system.Double]]: ...
    @_property
    def yaw_in_degrees(self) -> typing.Optional[typing.Optional[winrt.system.Double]]: ...
...
class HeadPosition(winrt.system.Object):
    ...
    @_property
    def altitude_in_degrees(self) -> typing.Optional[typing.Optional[winrt.system.Double]]: ...
    @_property
    def azimuth_in_degrees(self) -> typing.Optional[typing.Optional[winrt.system.Double]]: ...
...
class HumanPresenceFeatures(winrt.system.Object):
    ...
    @_property
    def supported_wake_or_lock_distances_in_millimeters(self) -> typing.Optional[windows_foundation_collections.IVectorView[winrt.system.UInt32]]: ...
    @_property
...
class HumanPresenceSensor(winrt.system.Object, metaclass=HumanPresenceSensor_Static):
    ...
    @_property
    def max_detectable_altitude_in_degrees(self) -> typing.Optional[typing.Optional[winrt.system.Double]]: ...
    @_property
    def max_detectable_azimuth_in_degrees(self) -> typing.Optional[typing.Optional[winrt.system.Double]]: ...
    @_property
    def max_detectable_persons(self) -> winrt.system.Int32: ...
    @_property
    def min_detectable_altitude_in_degrees(self) -> typing.Optional[typing.Optional[winrt.system.Double]]: ...
    @_property
    def min_detectable_azimuth_in_degrees(self) -> typing.Optional[typing.Optional[winrt.system.Double]]: ...
...
class HumanPresenceSensorReading(winrt.system.Object):
    ...
    def properties(self) -> typing.Optional[windows_foundation_collections.IMapView[str, winrt.system.Object]]: ...
    @_property
    def detected_persons(self) -> typing.Optional[windows_foundation_collections.IVectorView[DetectedPerson]]: ...
    @_property
...
class HumanPresenceSettings_Static(type):
    ...
    def get_supported_lock_on_leave_timeouts(cls) -> typing.Optional[windows_foundation_collections.IVectorView[datetime.timedelta]]: ...
    def update_settings(cls, settings: typing.Optional[HumanPresenceSettings], /) -> None: ...
    def update_settings_async(cls, settings: typing.Optional[HumanPresenceSettings], /) -> windows_foundation.IAsyncAction: ...
    ...
    def remove_settings_changed(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
...
class Inclinometer_Static(type):
    ...
    def get_default_with_sensor_reading_type(cls, sensor_readingtype: SensorReadingType, /) -> typing.Optional[Inclinometer]: ...
...
class OrientationSensor_Static(type):
    ...
    def get_default_with_sensor_reading_type(cls, sensor_readingtype: SensorReadingType, /) -> typing.Optional[OrientationSensor]: ...
    def get_default_with_sensor_reading_type_and_sensor_optimization_goal(cls, sensor_reading_type: SensorReadingType, optimization_goal: SensorOptimizationGoal, /) -> typing.Optional[OrientationSensor]: ...
    def get_device_selector(cls, reading_type: SensorReadingType, /) -> str: ...
...
class Pedometer_Static(type):
    ...
    def get_device_selector(cls) -> str: ...
    def get_readings_from_trigger_details(cls, trigger_details: typing.Optional[SensorDataThresholdTriggerDetails], /) -> typing.Optional[windows_foundation_collections.IVectorView[PedometerReading]]: ...
    def get_system_history_async(cls, from_time: datetime.datetime, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[PedometerReading]]: ...
    def get_system_history_with_duration_async(cls, from_time: datetime.datetime, duration: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[PedometerReading]]: ...

@typing.final
class Pedometer(winrt.system.Object, metaclass=Pedometer_Static):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> Pedometer: ...
    def get_current_readings(self) -> typing.Optional[windows_foundation_collections.IMapView[PedometerStepKind, PedometerReading]]: ...
...
class ProximitySensor_Static(type):
    ...
    def get_device_selector(cls) -> str: ...
    def get_readings_from_trigger_details(cls, trigger_details: typing.Optional[SensorDataThresholdTriggerDetails], /) -> typing.Optional[windows_foundation_collections.IVectorView[ProximitySensorReading]]: ...
