...
class StorePreviewProductInfo(winrt.system.Object):
    ...
    @_property
    def sku_info_list(self) -> windows_foundation_collections.IVectorView[StorePreviewSkuInfo]: ...
    @_property
    def title(self) -> str: ...
...
class WebAuthenticationCoreManagerHelper_Static(type):
    def request_token_with_u_i_element_hosting_and_web_account_async(cls, request: windows_security_authentication_web_core.WebTokenRequest, web_account: windows_security_credentials.WebAccount, ui_element: windows_ui_xaml.UIElement, /) -> windows_foundation.IAsyncOperation[windows_security_authentication_web_core.WebTokenRequestResult]: ...
    def request_token_with_u_i_element_hosting_async(cls, request: windows_security_authentication_web_core.WebTokenRequest, ui_element: windows_ui_xaml.UIElement, /) -> windows_foundation.IAsyncOperation[windows_security_authentication_web_core.WebTokenRequestResult]: ...
