...
class HttpMapTileDataSource(winrt.system.Object):
    ...
    @_property
    def additional_request_headers(self) -> windows_foundation_collections.IMap[str, str]: ...
    @_property
    def dispatcher(self) -> windows_ui_core.CoreDispatcher: ...
...
class MapBillboard(winrt.system.Object, metaclass=MapBillboard_Static):
    ...
    def __new__(cls: typing.Type[MapBillboard], camera: MapCamera) -> MapBillboard: ...
    def clear_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> None: ...
    def get_animation_base_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
    def get_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
    def read_local_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
...
class MapCamera(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[MapCamera], location: windows_devices_geolocation.Geopoint) -> MapCamera: ...
    @typing.overload
    def __new__(cls: typing.Type[MapCamera], location: windows_devices_geolocation.Geopoint, heading_in_degrees: winrt.system.Double) -> MapCamera: ...
    @typing.overload
    def __new__(cls: typing.Type[MapCamera], location: windows_devices_geolocation.Geopoint, heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double) -> MapCamera: ...
    @typing.overload
    def __new__(cls: typing.Type[MapCamera], location: windows_devices_geolocation.Geopoint, heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double, roll_in_degrees: winrt.system.Double, field_of_view_in_degrees: winrt.system.Double) -> MapCamera: ...
    def clear_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> None: ...
    def get_animation_base_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
    def get_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
    def read_local_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
...
class MapContextRequestedEventArgs(winrt.system.Object):
    ...
    def location(self) -> windows_devices_geolocation.Geopoint: ...
    @_property
    def map_elements(self) -> windows_foundation_collections.IVectorView[MapElement]: ...
    @_property
...
class MapControl_Static(type):
    ...
    @_property
    def is3_d_supported_property(cls) -> windows_ui_xaml.DependencyProperty: ...
    @_property
...
class MapControl(winrt.system.Object, metaclass=MapControl_Static):
    ...
    def clear_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> None: ...
    def find_map_elements_at_offset(self, offset: windows_foundation.Point, /) -> windows_foundation_collections.IVectorView[MapElement]: ...
    def find_map_elements_at_offset_with_radius(self, offset: windows_foundation.Point, radius: winrt.system.Double, /) -> windows_foundation_collections.IVectorView[MapElement]: ...
    ...
    @_property
    def children(self) -> windows_foundation_collections.IVector[windows_ui_xaml.DependencyObject]: ...
    @_property
    def loading_status(self) -> MapLoadingStatus: ...
    @_property
    def map_elements(self) -> windows_foundation_collections.IVector[MapElement]: ...
    @_property
    ...
    def pitch(self) -> winrt.system.Double: ...
    @_property
    def routes(self) -> windows_foundation_collections.IVector[MapRouteView]: ...
    @_property
    def tile_sources(self) -> windows_foundation_collections.IVector[MapTileSource]: ...
    @_property
    ...
    @_property
    def layers(self) -> windows_foundation_collections.IVector[MapLayer]: ...
    @layers.setter
    def layers(self, value: windows_foundation_collections.IVector[MapLayer]) -> None: ...
    @_property
    def region(self) -> str: ...
    @region.setter
    ...
    @_property
    def template(self) -> windows_ui_xaml_controls.ControlTemplate: ...
    @template.setter
    def template(self, value: windows_ui_xaml_controls.ControlTemplate) -> None: ...
    @_property
...
class MapControlBusinessLandmarkClickEventArgs(winrt.system.Object):
    ...
    @_property
    def local_locations(self) -> windows_foundation_collections.IVectorView[windows_services_maps_localsearch.LocalLocation]: ...
...
class MapControlDataHelper(winrt.system.Object, metaclass=MapControlDataHelper_Static):
    ...
    def __new__(cls: typing.Type[MapControlDataHelper], map: MapControl) -> MapControlDataHelper: ...
    def clear_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> None: ...
    def get_animation_base_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
    def get_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
    def read_local_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
...
class MapControlTransitFeatureClickEventArgs(winrt.system.Object):
    ...
    def location(self) -> windows_devices_geolocation.Geopoint: ...
    @_property
    def transit_properties(self) -> windows_foundation_collections.IMapView[str, winrt.system.Object]: ...
...
class MapElementsLayer(winrt.system.Object, metaclass=MapElementsLayer_Static):
    ...
    def map_elements(self) -> windows_foundation_collections.IVector[MapElement]: ...
    @map_elements.setter
    def map_elements(self, value: windows_foundation_collections.IVector[MapElement]) -> None: ...
    @_property
    def z_index(self) -> winrt.system.Int32: ...
    @z_index.setter
    def z_index(self, value: winrt.system.Int32) -> None: ...
...
class MapItemsControl(winrt.system.Object, metaclass=MapItemsControl_Static):
    ...
    @_property
    def items(self) -> windows_foundation_collections.IVector[windows_ui_xaml.DependencyObject]: ...
    @_property
    def dispatcher(self) -> windows_ui_core.CoreDispatcher: ...
...
class MapModel3D_Static(type):
    def create_from3_m_f_async(cls, source: windows_storage_streams.IRandomAccessStreamReference, /) -> windows_foundation.IAsyncOperation[MapModel3D]: ...
    def create_from3_m_f_with_shading_option_async(cls, source: windows_storage_streams.IRandomAccessStreamReference, shading_option: MapModel3DShadingOption, /) -> windows_foundation.IAsyncOperation[MapModel3D]: ...
...
class MapPolygon(winrt.system.Object, metaclass=MapPolygon_Static):
    ...
    @_property
    def paths(self) -> windows_foundation_collections.IVector[windows_devices_geolocation.Geopath]: ...
    @_property
    def z_index(self) -> winrt.system.Int32: ...
    @z_index.setter
    def z_index(self, value: winrt.system.Int32) -> None: ...
...
class MapTileSource(winrt.system.Object, metaclass=MapTileSource_Static):
    ...
    @typing.overload
    def __new__(cls: typing.Type[MapTileSource], data_source: MapTileDataSource) -> MapTileSource: ...
    @typing.overload
    def __new__(cls: typing.Type[MapTileSource], data_source: MapTileDataSource, zoom_level_range: MapZoomLevelRange) -> MapTileSource: ...
    @typing.overload
    def __new__(cls: typing.Type[MapTileSource], data_source: MapTileDataSource, zoom_level_range: MapZoomLevelRange, bounds: windows_devices_geolocation.GeoboundingBox) -> MapTileSource: ...
    @typing.overload
    def __new__(cls: typing.Type[MapTileSource], data_source: MapTileDataSource, zoom_level_range: MapZoomLevelRange, bounds: windows_devices_geolocation.GeoboundingBox, tile_size_in_pixels: winrt.system.Int32) -> MapTileSource: ...
    def clear_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> None: ...
    def get_animation_base_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
    def get_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
    def pause(self) -> None: ...
...
class StreetsideExperience(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[StreetsideExperience], panorama: StreetsidePanorama) -> StreetsideExperience: ...
    @typing.overload
    def __new__(cls: typing.Type[StreetsideExperience], panorama: StreetsidePanorama, heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double, field_of_view_in_degrees: winrt.system.Double) -> StreetsideExperience: ...
    def clear_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> None: ...
    def get_animation_base_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
    def get_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
    def read_local_value(self, dp: windows_ui_xaml.DependencyProperty, /) -> winrt.system.Object: ...
