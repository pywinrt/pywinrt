...
class MapControl(winrt.system.Object, metaclass=MapControl_Static):
    ...
    def find_map_elements_at_offset_with_radius(self, offset: windows_foundation.Point, radius: winrt.system.Double, /) -> typing.Optional[windows_foundation_collections.IVectorView[MapElement]]: ...
    ...
    def get_location_from_offset_with_reference_system(self, offset: windows_foundation.Point, desired_reference_system: windows_devices_geolocation.AltitudeReferenceSystem, /) -> typing.Optional[windows_devices_geolocation.Geopoint]: ...
    ...
    def try_get_location_from_offset_with_reference_system(self, offset: windows_foundation.Point, desired_reference_system: windows_devices_geolocation.AltitudeReferenceSystem, /) -> typing.Tuple[bool, typing.Optional[windows_devices_geolocation.Geopoint]]: ...
    ...
    def try_set_scene_with_animation_async(self, scene: typing.Optional[MapScene], animation_kind: MapAnimationKind, /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def try_set_view_with_center_and_zoom_async(self, center: typing.Optional[windows_devices_geolocation.Geopoint], zoom_level: typing.Optional[winrt.system.Double], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_set_view_with_center_async(self, center: typing.Optional[windows_devices_geolocation.Geopoint], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_set_view_with_center_zoom_heading_and_pitch_async(self, center: typing.Optional[windows_devices_geolocation.Geopoint], zoom_level: typing.Optional[winrt.system.Double], heading: typing.Optional[winrt.system.Double], desired_pitch: typing.Optional[winrt.system.Double], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_set_view_with_center_zoom_heading_pitch_and_animation_async(self, center: typing.Optional[windows_devices_geolocation.Geopoint], zoom_level: typing.Optional[winrt.system.Double], heading: typing.Optional[winrt.system.Double], desired_pitch: typing.Optional[winrt.system.Double], animation: MapAnimationKind, /) -> windows_foundation.IAsyncOperation[bool]: ...
...
class MapModel3D_Static(type):
    ...
    def create_from3_m_f_with_shading_option_async(cls, source: typing.Optional[windows_storage_streams.IRandomAccessStreamReference], shading_option: MapModel3DShadingOption, /) -> windows_foundation.IAsyncOperation[MapModel3D]: ...
...
class MapScene_Static(type):
    ...
    def create_from_bounding_box_with_heading_and_pitch(cls, bounds: typing.Optional[windows_devices_geolocation.GeoboundingBox], heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double, /) -> typing.Optional[MapScene]: ...
    ...
    def create_from_location_and_radius_with_heading_and_pitch(cls, location: typing.Optional[windows_devices_geolocation.Geopoint], radius_in_meters: winrt.system.Double, heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double, /) -> typing.Optional[MapScene]: ...
    def create_from_location_with_heading_and_pitch(cls, location: typing.Optional[windows_devices_geolocation.Geopoint], heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double, /) -> typing.Optional[MapScene]: ...
    def create_from_locations(cls, locations: typing.Iterable[windows_devices_geolocation.Geopoint], /) -> typing.Optional[MapScene]: ...
    def create_from_locations_with_heading_and_pitch(cls, locations: typing.Iterable[windows_devices_geolocation.Geopoint], heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double, /) -> typing.Optional[MapScene]: ...
...
class StreetsidePanorama_Static(type):
    def find_nearby_with_location_and_radius_async(cls, location: typing.Optional[windows_devices_geolocation.Geopoint], radius_in_meters: winrt.system.Double, /) -> windows_foundation.IAsyncOperation[StreetsidePanorama]: ...
    def find_nearby_with_location_async(cls, location: typing.Optional[windows_devices_geolocation.Geopoint], /) -> windows_foundation.IAsyncOperation[StreetsidePanorama]: ...
