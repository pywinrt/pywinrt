...
namespace py::cpp::Windows::UI::Xaml::Controls::Maps
{
    struct module_state
    {
        PyObject* type_MapAnimationKind;
        PyObject* type_MapCameraChangeReason;
        PyObject* type_MapColorScheme;
        PyObject* type_MapElementCollisionBehavior;
        PyObject* type_MapInteractionMode;
        PyObject* type_MapLoadingStatus;
        PyObject* type_MapModel3DShadingOption;
        PyObject* type_MapPanInteractionMode;
        PyObject* type_MapProjection;
        PyObject* type_MapStyle;
        PyObject* type_MapTileAnimationState;
        PyObject* type_MapTileLayer;
        PyObject* type_MapVisibleRegionKind;
        PyObject* type_MapWatermarkMode;
    ...
    static PyObject* register_MapAnimationKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapAnimationKind)
        {
        ...
        state->type_MapAnimationKind = type;
        Py_INCREF(state->type_MapAnimationKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapCameraChangeReason(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapCameraChangeReason)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapCameraChangeReason = type;
        Py_INCREF(state->type_MapCameraChangeReason);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapColorScheme(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapColorScheme)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapColorScheme = type;
        Py_INCREF(state->type_MapColorScheme);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapElementCollisionBehavior(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapElementCollisionBehavior)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapElementCollisionBehavior = type;
        Py_INCREF(state->type_MapElementCollisionBehavior);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapInteractionMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapInteractionMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapInteractionMode = type;
        Py_INCREF(state->type_MapInteractionMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapLoadingStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapLoadingStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapLoadingStatus = type;
        Py_INCREF(state->type_MapLoadingStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapModel3DShadingOption(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapModel3DShadingOption)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapModel3DShadingOption = type;
        Py_INCREF(state->type_MapModel3DShadingOption);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapPanInteractionMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapPanInteractionMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapPanInteractionMode = type;
        Py_INCREF(state->type_MapPanInteractionMode);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapProjection(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapProjection)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapProjection = type;
        Py_INCREF(state->type_MapProjection);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapStyle(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapStyle)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapStyle = type;
        Py_INCREF(state->type_MapStyle);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapTileAnimationState(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapTileAnimationState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapTileAnimationState = type;
        Py_INCREF(state->type_MapTileAnimationState);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapTileLayer(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapTileLayer)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapTileLayer = type;
        Py_INCREF(state->type_MapTileLayer);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapVisibleRegionKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapVisibleRegionKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapVisibleRegionKind = type;
        Py_INCREF(state->type_MapVisibleRegionKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_MapWatermarkMode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_MapWatermarkMode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_MapWatermarkMode = type;
        Py_INCREF(state->type_MapWatermarkMode);
    ...
    PyObject* _new_MapZoomLevelRange(PyTypeObject* type, PyObject* args, PyObject* kwds)
    {
        ...
        if ((tuple_size == 0) && (kwds == nullptr))
        {
            try
            {
                winrt::Windows::UI::Xaml::Controls::Maps::MapZoomLevelRange return_value{};
        ...
        try
        {
            winrt::Windows::UI::Xaml::Controls::Maps::MapZoomLevelRange return_value{ _Min, _Max };
            return py::convert(return_value);
        }
        catch (...)
        {
    ...
    static PyMethodDef module_methods[] = {
        {"_register_MapAnimationKind", register_MapAnimationKind, METH_O, "registers type"},
        {"_register_MapCameraChangeReason", register_MapCameraChangeReason, METH_O, "registers type"},
        {"_register_MapColorScheme", register_MapColorScheme, METH_O, "registers type"},
        {"_register_MapElementCollisionBehavior", register_MapElementCollisionBehavior, METH_O, "registers type"},
        {"_register_MapInteractionMode", register_MapInteractionMode, METH_O, "registers type"},
        {"_register_MapLoadingStatus", register_MapLoadingStatus, METH_O, "registers type"},
        {"_register_MapModel3DShadingOption", register_MapModel3DShadingOption, METH_O, "registers type"},
        {"_register_MapPanInteractionMode", register_MapPanInteractionMode, METH_O, "registers type"},
        {"_register_MapProjection", register_MapProjection, METH_O, "registers type"},
        {"_register_MapStyle", register_MapStyle, METH_O, "registers type"},
        {"_register_MapTileAnimationState", register_MapTileAnimationState, METH_O, "registers type"},
        {"_register_MapTileLayer", register_MapTileLayer, METH_O, "registers type"},
        {"_register_MapVisibleRegionKind", register_MapVisibleRegionKind, METH_O, "registers type"},
        {"_register_MapWatermarkMode", register_MapWatermarkMode, METH_O, "registers type"},
        {}};
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_MapAnimationKind);
        Py_VISIT(state->type_MapCameraChangeReason);
        Py_VISIT(state->type_MapColorScheme);
        Py_VISIT(state->type_MapElementCollisionBehavior);
        Py_VISIT(state->type_MapInteractionMode);
        Py_VISIT(state->type_MapLoadingStatus);
        Py_VISIT(state->type_MapModel3DShadingOption);
        Py_VISIT(state->type_MapPanInteractionMode);
        Py_VISIT(state->type_MapProjection);
        Py_VISIT(state->type_MapStyle);
        Py_VISIT(state->type_MapTileAnimationState);
        Py_VISIT(state->type_MapTileLayer);
        Py_VISIT(state->type_MapVisibleRegionKind);
        Py_VISIT(state->type_MapWatermarkMode);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_MapAnimationKind);
        Py_CLEAR(state->type_MapCameraChangeReason);
        Py_CLEAR(state->type_MapColorScheme);
        Py_CLEAR(state->type_MapElementCollisionBehavior);
        Py_CLEAR(state->type_MapInteractionMode);
        Py_CLEAR(state->type_MapLoadingStatus);
        Py_CLEAR(state->type_MapModel3DShadingOption);
        Py_CLEAR(state->type_MapPanInteractionMode);
        Py_CLEAR(state->type_MapProjection);
        Py_CLEAR(state->type_MapStyle);
        Py_CLEAR(state->type_MapTileAnimationState);
        Py_CLEAR(state->type_MapTileLayer);
        Py_CLEAR(state->type_MapVisibleRegionKind);
        Py_CLEAR(state->type_MapWatermarkMode);
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapAnimationKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapAnimationKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapAnimationKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapCameraChangeReason>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapCameraChangeReason;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapCameraChangeReason is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapColorScheme>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapColorScheme;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapColorScheme is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapElementCollisionBehavior>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapElementCollisionBehavior;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapElementCollisionBehavior is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapInteractionMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapInteractionMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapInteractionMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapLoadingStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapLoadingStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapLoadingStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapModel3DShadingOption>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapModel3DShadingOption;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapModel3DShadingOption is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapPanInteractionMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapPanInteractionMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapPanInteractionMode is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapProjection>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapProjection;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapProjection is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapStyle>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapStyle;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapStyle is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapTileAnimationState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapTileAnimationState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapTileAnimationState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapTileLayer>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapTileLayer;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapTileLayer is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapVisibleRegionKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapVisibleRegionKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapVisibleRegionKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::UI::Xaml::Controls::Maps::MapWatermarkMode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::UI::Xaml::Controls::Maps;
    ...
    auto python_type = state->type_MapWatermarkMode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::UI::Xaml::Controls::Maps::MapWatermarkMode is not registered");
        return nullptr;
    }
