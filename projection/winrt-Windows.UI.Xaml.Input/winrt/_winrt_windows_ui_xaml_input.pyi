...
class FocusManager_Static(type):
    ...
    def find_next_element_with_options(cls, focus_navigation_direction: FocusNavigationDirection, focus_navigation_options: typing.Optional[FindNextElementOptions], /) -> typing.Optional[windows_ui_xaml.DependencyObject]: ...
    ...
    def find_next_focusable_element_with_hint(cls, focus_navigation_direction: FocusNavigationDirection, hint_rect: windows_foundation.Rect, /) -> typing.Optional[windows_ui_xaml.UIElement]: ...
    @typing.overload
