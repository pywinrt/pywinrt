...
class FindNextElementOptions(winrt.system.Object):
    ...
    @_property
    def search_root(self) -> typing.Optional[winrt.windows.ui.xaml.DependencyObject]: ...
    @search_root.setter
    def search_root(self, value: typing.Optional[winrt.windows.ui.xaml.DependencyObject]) -> None: ...
    @_property
...
class FocusManager_Static(type):
    ...
    @typing.overload
    def find_next_element(cls, focus_navigation_direction: FocusNavigationDirection, /) -> typing.Optional[winrt.windows.ui.xaml.DependencyObject]: ...
    @typing.overload
    def find_next_element(cls, focus_navigation_direction: FocusNavigationDirection, focus_navigation_options: typing.Optional[FindNextElementOptions], /) -> typing.Optional[winrt.windows.ui.xaml.DependencyObject]: ...
    @typing.overload
    def find_next_focusable_element(cls, focus_navigation_direction: FocusNavigationDirection, /) -> typing.Optional[winrt.windows.ui.xaml.UIElement]: ...
    @typing.overload
    def find_next_focusable_element(cls, focus_navigation_direction: FocusNavigationDirection, hint_rect: winrt.windows.foundation.Rect, /) -> typing.Optional[winrt.windows.ui.xaml.UIElement]: ...
    @typing.overload
    def get_focused_element(cls) -> typing.Optional[winrt.system.Object]: ...
    @typing.overload
    def get_focused_element(cls, xaml_root: typing.Optional[winrt.windows.ui.xaml.XamlRoot], /) -> typing.Optional[winrt.system.Object]: ...
    def try_focus_async(cls, element: typing.Optional[winrt.windows.ui.xaml.DependencyObject], value: winrt.windows.ui.xaml.FocusState, /) -> winrt.windows.foundation.IAsyncOperation[FocusMovementResult]: ...
    @typing.overload
...
class GettingFocusEventArgs(winrt.system.Object):
    ...
    def new_focused_element(self, value: typing.Optional[winrt.windows.ui.xaml.DependencyObject]) -> None: ...
    @_property
    def handled(self) -> bool: ...
    @handled.setter
    def handled(self, value: bool) -> None: ...
...
class HoldingRoutedEventArgs(winrt.system.Object):
    ...
    def handled(self, value: bool) -> None: ...
    @_property
    def holding_state(self) -> winrt.windows.ui.input.HoldingState: ...
    @_property
    def pointer_device_type(self) -> winrt.windows.devices.input.PointerDeviceType: ...
...
class KeyboardAccelerator_Static(type):
    ...
    @_property
    def key_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
    def modifiers_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
...
class KeyboardAccelerator(winrt.system.Object, metaclass=KeyboardAccelerator_Static):
    ...
    @_property
    def scope_owner(self) -> typing.Optional[winrt.windows.ui.xaml.DependencyObject]: ...
    @scope_owner.setter
    def scope_owner(self, value: typing.Optional[winrt.windows.ui.xaml.DependencyObject]) -> None: ...
    @_property
...
class KeyboardAcceleratorInvokedEventArgs(winrt.system.Object):
    ...
    def handled(self, value: bool) -> None: ...
    @_property
    def element(self) -> typing.Optional[winrt.windows.ui.xaml.DependencyObject]: ...
    @_property
...
class ManipulationCompletedRoutedEventArgs(winrt.system.Object):
    ...
    def handled(self, value: bool) -> None: ...
    @_property
    def container(self) -> typing.Optional[winrt.windows.ui.xaml.UIElement]: ...
    @_property
    def cumulative(self) -> winrt.windows.ui.input.ManipulationDelta: ...
    @_property
...
class ManipulationDeltaRoutedEventArgs(winrt.system.Object):
    ...
    def cumulative(self) -> winrt.windows.ui.input.ManipulationDelta: ...
    @_property
    def delta(self) -> winrt.windows.ui.input.ManipulationDelta: ...
    @_property
    def is_inertial(self) -> bool: ...
    @_property
    def pointer_device_type(self) -> winrt.windows.devices.input.PointerDeviceType: ...
...
class XamlUICommand_Static(type):
    ...
    @_property
    def keyboard_accelerators_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
...
class XamlUICommand(winrt.system.Object, metaclass=XamlUICommand_Static):
    ...
    @_property
    def icon_source(self) -> typing.Optional[winrt.windows.ui.xaml.controls.IconSource]: ...
    @icon_source.setter
    def icon_source(self, value: typing.Optional[winrt.windows.ui.xaml.controls.IconSource]) -> None: ...
    @_property
