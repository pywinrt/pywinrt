...
class OcrEngine_Static(type):
    ...
    @_property
    def available_recognizer_languages(cls) -> windows_foundation_collections.IVectorView[windows_globalization.Language]: ...
    @_property
...
class OcrLine(winrt.system.Object):
    ...
    def text(self) -> str: ...
    @_property
    def words(self) -> windows_foundation_collections.IVectorView[OcrWord]: ...
...
class OcrResult(winrt.system.Object):
    ...
    @_property
    def lines(self) -> windows_foundation_collections.IVectorView[OcrLine]: ...
    @_property
    def text(self) -> str: ...
    @_property
