...
class Launcher(winrt.system.Object):
    ...
    @typing.overload
    @staticmethod
    def launch_file_async(file: typing.Optional[winrt.windows.storage.IStorageFile], /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @typing.overload
    @staticmethod
    def launch_file_async(file: typing.Optional[winrt.windows.storage.IStorageFile], options: typing.Optional[LauncherOptions], /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @typing.overload
    @staticmethod
    def launch_folder_async(folder: typing.Optional[winrt.windows.storage.IStorageFolder], /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @typing.overload
    @staticmethod
    def launch_folder_async(folder: typing.Optional[winrt.windows.storage.IStorageFolder], options: typing.Optional[FolderLauncherOptions], /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @typing.overload
    @staticmethod
    def launch_folder_path_async(path: str, /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @typing.overload
    @staticmethod
    def launch_folder_path_async(path: str, options: typing.Optional[FolderLauncherOptions], /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @typing.overload
    @staticmethod
    def launch_folder_path_for_user_async(user: typing.Optional[User], path: str, /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @typing.overload
    @staticmethod
    def launch_folder_path_for_user_async(user: typing.Optional[User], path: str, options: typing.Optional[FolderLauncherOptions], /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @typing.overload
    @staticmethod
    def launch_uri_async(uri: typing.Optional[winrt.windows.foundation.Uri], /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @typing.overload
    @staticmethod
    def launch_uri_async(uri: typing.Optional[winrt.windows.foundation.Uri], options: typing.Optional[LauncherOptions], /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @typing.overload
    @staticmethod
    def launch_uri_async(uri: typing.Optional[winrt.windows.foundation.Uri], options: typing.Optional[LauncherOptions], input_data: typing.Optional[winrt.windows.foundation.collections.ValueSet], /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @typing.overload
    @staticmethod
...
class MemoryManager(winrt.system.Object):
    ...
    @staticmethod
    def try_set_app_memory_usage_limit(value: winrt.system.UInt64, /) -> bool: ...
    @staticmethod
...
class TimeZoneSettings(winrt.system.Object):
    can_change_time_zone: typing.ClassVar[bool]
