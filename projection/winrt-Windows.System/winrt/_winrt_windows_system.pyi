...
class AppDiagnosticInfo_Static(type):
    ...
    def request_info_for_app_user_model_id(cls, app_user_model_id: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVector[AppDiagnosticInfo]]: ...
...
class DispatcherQueue(winrt.system.Object, metaclass=DispatcherQueue_Static):
    ...
    def try_enqueue_with_priority(self, priority: DispatcherQueuePriority, callback: typing.Optional[DispatcherQueueHandler], /) -> bool: ...
...
class Launcher_Static(type):
    ...
    def find_uri_scheme_handlers_with_launch_uri_type_async(cls, scheme: str, launch_query_support_type: LaunchQuerySupportType, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_applicationmodel.AppInfo]]: ...
    def launch_file_async(cls, file: typing.Optional[windows_storage.IStorageFile], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def launch_file_with_options_async(cls, file: typing.Optional[windows_storage.IStorageFile], options: typing.Optional[LauncherOptions], /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def launch_folder_path_with_options_async(cls, path: str, options: typing.Optional[FolderLauncherOptions], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def launch_folder_path_with_options_for_user_async(cls, user: typing.Optional[User], path: str, options: typing.Optional[FolderLauncherOptions], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def launch_folder_with_options_async(cls, folder: typing.Optional[windows_storage.IStorageFolder], options: typing.Optional[FolderLauncherOptions], /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def launch_uri_for_results_with_data_async(cls, uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[LauncherOptions], input_data: typing.Optional[windows_foundation_collections.ValueSet], /) -> windows_foundation.IAsyncOperation[LaunchUriResult]: ...
    def launch_uri_for_results_with_data_for_user_async(cls, user: typing.Optional[User], uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[LauncherOptions], input_data: typing.Optional[windows_foundation_collections.ValueSet], /) -> windows_foundation.IAsyncOperation[LaunchUriResult]: ...
    ...
    def launch_uri_with_data_async(cls, uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[LauncherOptions], input_data: typing.Optional[windows_foundation_collections.ValueSet], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def launch_uri_with_data_for_user_async(cls, user: typing.Optional[User], uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[LauncherOptions], input_data: typing.Optional[windows_foundation_collections.ValueSet], /) -> windows_foundation.IAsyncOperation[LaunchUriStatus]: ...
    def launch_uri_with_options_async(cls, uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[LauncherOptions], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def launch_uri_with_options_for_user_async(cls, user: typing.Optional[User], uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[LauncherOptions], /) -> windows_foundation.IAsyncOperation[LaunchUriStatus]: ...
    ...
    def query_app_uri_support_with_package_family_name_async(cls, uri: typing.Optional[windows_foundation.Uri], package_family_name: str, /) -> windows_foundation.IAsyncOperation[LaunchQuerySupportStatus]: ...
    ...
    def query_file_support_with_package_family_name_async(cls, file: typing.Optional[windows_storage.StorageFile], package_family_name: str, /) -> windows_foundation.IAsyncOperation[LaunchQuerySupportStatus]: ...
    ...
    def query_uri_support_with_package_family_name_async(cls, uri: typing.Optional[windows_foundation.Uri], launch_query_support_type: LaunchQuerySupportType, package_family_name: str, /) -> windows_foundation.IAsyncOperation[LaunchQuerySupportStatus]: ...
...
class ProcessLauncher_Static(type):
    ...
    def run_to_completion_async_with_options(cls, file_name: str, args: str, options: typing.Optional[ProcessLauncherOptions], /) -> windows_foundation.IAsyncOperation[ProcessLauncherResult]: ...
...
class RemoteLauncher_Static(type):
    ...
    def launch_uri_with_data_async(cls, remote_system_connection_request: typing.Optional[windows_system_remotesystems.RemoteSystemConnectionRequest], uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[RemoteLauncherOptions], input_data: typing.Optional[windows_foundation_collections.ValueSet], /) -> windows_foundation.IAsyncOperation[RemoteLaunchUriStatus]: ...
    def launch_uri_with_options_async(cls, remote_system_connection_request: typing.Optional[windows_system_remotesystems.RemoteSystemConnectionRequest], uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[RemoteLauncherOptions], /) -> windows_foundation.IAsyncOperation[RemoteLaunchUriStatus]: ...
...
class User_Static(type):
    ...
    def find_all_async_by_type(cls, type: UserType, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[User]]: ...
    def find_all_async_by_type_and_status(cls, type: UserType, status: UserAuthenticationStatus, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[User]]: ...
