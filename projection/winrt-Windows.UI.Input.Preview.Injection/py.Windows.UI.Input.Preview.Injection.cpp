...
PyMODINIT_FUNC PyInit__winrt_windows_ui_input_preview_injection(void) noexcept
{
    ...
    py::pyobj_handle InjectedInputGamepadInfo_type{py::register_python_type(module.get(), &type_spec_InjectedInputGamepadInfo, object_bases.get(), nullptr)};
    if (!InjectedInputGamepadInfo_type)
    {
        return nullptr;
    }

    py::pyobj_handle InjectedInputKeyboardInfo_type{py::register_python_type(module.get(), &type_spec_InjectedInputKeyboardInfo, object_bases.get(), nullptr)};
    if (!InjectedInputKeyboardInfo_type)
    {
        return nullptr;
    }

    py::pyobj_handle InjectedInputMouseInfo_type{py::register_python_type(module.get(), &type_spec_InjectedInputMouseInfo, object_bases.get(), nullptr)};
    if (!InjectedInputMouseInfo_type)
    {
        return nullptr;
    }

    py::pyobj_handle InjectedInputPenInfo_type{py::register_python_type(module.get(), &type_spec_InjectedInputPenInfo, object_bases.get(), nullptr)};
    if (!InjectedInputPenInfo_type)
    {
        return nullptr;
    }

    py::pyobj_handle InjectedInputTouchInfo_type{py::register_python_type(module.get(), &type_spec_InjectedInputTouchInfo, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle InputInjector_type{py::register_python_type(module.get(), &type_spec_InputInjector, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_InputInjector_Static.get()))};
    if (!InputInjector_type)
    {
        return nullptr;
    }

    py::pyobj_handle InjectedInputPoint_type{py::register_python_type(module.get(), &type_spec_InjectedInputPoint, nullptr, nullptr)};
    if (!InjectedInputPoint_type)
    {
        return nullptr;
    }

    py::pyobj_handle InjectedInputPointerInfo_type{py::register_python_type(module.get(), &type_spec_InjectedInputPointerInfo, nullptr, nullptr)};
    if (!InjectedInputPointerInfo_type)
    {
        return nullptr;
    }

    py::pyobj_handle InjectedInputRectangle_type{py::register_python_type(module.get(), &type_spec_InjectedInputRectangle, nullptr, nullptr)};
