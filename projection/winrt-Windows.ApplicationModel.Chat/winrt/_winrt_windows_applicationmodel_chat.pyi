...
class ChatConversation(winrt.system.Object):
    ...
    @_property
    def participants(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
...
class ChatConversationReader(winrt.system.Object):
    ...
    def read_batch_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ChatConversation]]: ...
    def read_batch_with_count_async(self, count: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ChatConversation]]: ...
...
class ChatMessage(winrt.system.Object):
    ...
    @_property
    def recipient_send_statuses(self) -> typing.Optional[windows_foundation_collections.IMapView[str, ChatMessageStatus]]: ...
    @_property
    def recipients(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def transport_friendly_name(self) -> str: ...
    @_property
    def attachments(self) -> typing.Optional[windows_foundation_collections.IVector[ChatMessageAttachment]]: ...
    @_property
    def id(self) -> str: ...
    @_property
    ...
    @_property
    def recipients_delivery_infos(self) -> typing.Optional[windows_foundation_collections.IVector[ChatRecipientDeliveryInfo]]: ...
    @_property
...
class ChatMessageAttachment(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[ChatMessageAttachment], mime_type: str, data_stream_reference: typing.Optional[windows_storage_streams.IRandomAccessStreamReference]) -> ChatMessageAttachment: ...
    @_property
    def text(self) -> str: ...
    @text.setter
    ...
    @_property
    def data_stream_reference(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
    @data_stream_reference.setter
    def data_stream_reference(self, value: typing.Optional[windows_storage_streams.IRandomAccessStreamReference]) -> None: ...
    @_property
...
class ChatMessageChangeReader(winrt.system.Object):
    ...
    def read_batch_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ChatMessageChange]]: ...
...
class ChatMessageManager_Static(type):
    ...
    def get_transports_async(cls) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ChatMessageTransport]]: ...
    ...
    def show_compose_sms_message_async(cls, message: typing.Optional[ChatMessage], /) -> windows_foundation.IAsyncAction: ...
...
class ChatMessageReader(winrt.system.Object):
    ...
    def read_batch_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ChatMessage]]: ...
    def read_batch_with_count_async(self, count: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ChatMessage]]: ...
...
class ChatMessageStore(winrt.system.Object):
    ...
    def get_conversation_for_transports_reader(self, transport_ids: typing.Iterable[str], /) -> typing.Optional[ChatConversationReader]: ...
    def get_conversation_from_threading_info_async(self, threading_info: typing.Optional[ChatConversationThreadingInfo], /) -> windows_foundation.IAsyncOperation[ChatConversation]: ...
    ...
    def get_message_reader1(self) -> typing.Optional[ChatMessageReader]: ...
    def get_message_reader2(self, recent_time_limit: datetime.timedelta, /) -> typing.Optional[ChatMessageReader]: ...
    ...
    def save_message_async(self, chat_message: typing.Optional[ChatMessage], /) -> windows_foundation.IAsyncAction: ...
    def send_message_async(self, chat_message: typing.Optional[ChatMessage], /) -> windows_foundation.IAsyncAction: ...
...
class ChatMessageTransportConfiguration(winrt.system.Object):
    ...
    @_property
    def supported_video_format(self) -> typing.Optional[windows_media_mediaproperties.MediaEncodingProfile]: ...
...
class ChatSearchReader(winrt.system.Object):
    ...
    def read_batch_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[IChatItem]]: ...
    def read_batch_with_count_async(self, count: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[IChatItem]]: ...
...
class ChatSyncManager(winrt.system.Object):
    ...
    def associate_account_async(self, web_account: typing.Optional[windows_security_credentials.WebAccount], /) -> windows_foundation.IAsyncAction: ...
    def is_account_associated(self, web_account: typing.Optional[windows_security_credentials.WebAccount], /) -> bool: ...
    def set_configuration_async(self, configuration: typing.Optional[ChatSyncConfiguration], /) -> windows_foundation.IAsyncAction: ...
...
class RcsEndUserMessage(winrt.system.Object):
    ...
    def send_response_async(self, action: typing.Optional[RcsEndUserMessageAction], /) -> windows_foundation.IAsyncAction: ...
    def send_response_with_pin_async(self, action: typing.Optional[RcsEndUserMessageAction], pin: str, /) -> windows_foundation.IAsyncAction: ...
    @_property
    def actions(self) -> typing.Optional[windows_foundation_collections.IVectorView[RcsEndUserMessageAction]]: ...
    @_property
...
class RcsManager_Static(type):
    ...
    def get_transports_async(cls) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[RcsTransport]]: ...
    def leave_conversation_async(cls, conversation: typing.Optional[ChatConversation], /) -> windows_foundation.IAsyncAction: ...
