...
@typing.final
class DragOperation(windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
    ...
    def close(self) -> None: ...
    def set_drag_u_i_content_from_software_bitmap(self, bitmap: windows_graphics_imaging.SoftwareBitmap, /) -> None: ...
    def set_drag_u_i_content_from_software_bitmap2(self, bitmap: windows_graphics_imaging.SoftwareBitmap, anchor_point: windows_foundation.Point, /) -> None: ...
...
class IDropOperationTarget(winrt.system.Object):
    ...
    def enter_async(self, drag_info: DragInfo, drag_u_i_override: DragUIOverride, /) -> windows_foundation.IAsyncOperation[windows_applicationmodel_datatransfer.DataPackageOperation]: ...
    def leave_async(self, drag_info: DragInfo, /) -> windows_foundation.IAsyncAction: ...
    def over_async(self, drag_info: DragInfo, drag_u_i_override: DragUIOverride, /) -> windows_foundation.IAsyncOperation[windows_applicationmodel_datatransfer.DataPackageOperation]: ...
