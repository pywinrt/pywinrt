...
class LanguageFontGroup(winrt.system.Object):
    ...
    @_property
    def u_i_caption_font(self) -> LanguageFont: ...
    @_property
    def u_i_heading_font(self) -> LanguageFont: ...
    @_property
    def u_i_notification_heading_font(self) -> LanguageFont: ...
    @_property
    def u_i_text_font(self) -> LanguageFont: ...
    @_property
    def u_i_title_font(self) -> LanguageFont: ...
