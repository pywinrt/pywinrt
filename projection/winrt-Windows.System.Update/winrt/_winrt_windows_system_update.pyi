...
class SystemUpdateManager_Static(type):
    ...
    def get_automatic_reboot_block_ids(cls) -> windows_foundation_collections.IVectorView[str]: ...
    def get_flight_ring(cls) -> str: ...
    def get_update_items(cls) -> windows_foundation_collections.IVectorView[SystemUpdateItem]: ...
