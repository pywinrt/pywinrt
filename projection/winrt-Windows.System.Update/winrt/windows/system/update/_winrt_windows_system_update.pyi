...
class SystemUpdateLastErrorInfo(winrt.system.Object):
    extended_error: winrt.windows.foundation.HResult
    is_interactive: winrt.system.Boolean
...
class SystemUpdateManager(winrt.system.Object):
    ...
    @staticmethod
    def block_automatic_reboot_async(lock_id: str, /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    @staticmethod
    ...
    @staticmethod
    def set_flight_ring(flight_ring: str, /) -> winrt.system.Boolean: ...
    @staticmethod
    def start_cancel_updates() -> None: ...
    @staticmethod
    def start_install(action: SystemUpdateStartInstallAction, /) -> None: ...
    @staticmethod
    def try_set_user_active_hours(start: datetime.timedelta, end: datetime.timedelta, /) -> winrt.system.Boolean: ...
    @staticmethod
    def unblock_automatic_reboot_async(lock_id: str, /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    @staticmethod
