...
class LegacyGipGameControllerProvider(winrt.system.Object, metaclass=LegacyGipGameControllerProvider_Static):
    ...
    def get_standard_controller_button_remapping(self, user: windows_system.User, previous: bool, /) -> windows_foundation_collections.IMapView[RemappingButtonCategory, winrt.system.Object]: ...
    ...
    def set_standard_controller_button_remapping(self, user: windows_system.User, previous: bool, remapping: windows_foundation_collections.IMapView[RemappingButtonCategory, winrt.system.Object], /) -> None: ...
    @_property
    ...
    @_property
    def preferred_types(self) -> windows_foundation_collections.IVectorView[str]: ...
