...
class GameControllerProviderInfo_Static(type):
    ...
    def get_parent_provider_id(cls, provider: windows_gaming_input_custom.ImplementsIGameControllerProvider, /) -> str: ...
    ...
    def get_provider_id(cls, provider: windows_gaming_input_custom.ImplementsIGameControllerProvider, /) -> str: ...
...
class LegacyGipGameControllerProvider_Static(type):
    ...
    def from_game_controller(cls, controller: windows_gaming_input.ImplementsIGameController, /) -> LegacyGipGameControllerProvider: ...
    ...
    def from_game_controller_provider(cls, provider: windows_gaming_input_custom.ImplementsIGameControllerProvider, /) -> LegacyGipGameControllerProvider: ...
