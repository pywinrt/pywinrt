...
PyMODINIT_FUNC PyInit__winrt_Windows_Gaming_Input_Preview(void) noexcept
{
    ...
    if (py::register_python_type(module.get(), type_name_GameControllerProviderInfo, &type_spec_GameControllerProviderInfo, nullptr, object_bases.get(), nullptr) == -1)
    #else
    if (py::register_python_type(module.get(), type_name_GameControllerProviderInfo, &type_spec_GameControllerProviderInfo, object_bases.get(), nullptr) == -1)
    #endif
    {
        return nullptr;
    }
