...
class DisplayPresentationRate:
    ...
    def __init__(self, vertical_sync_rate: windows_foundation_numerics.Rational, vertical_syncs_per_presentation: winrt.system.Int32) -> None: ...

@typing.final
class DisplayAdapter_Static(type):
    def from_id(cls, id: windows_graphics.DisplayAdapterId, /) -> typing.Optional[DisplayAdapter]: ...
...
class DisplayAdapter(winrt.system.Object, metaclass=DisplayAdapter_Static):
    ...
    @_property
    def preferred_render_adapter(self) -> typing.Optional[DisplayAdapter]: ...
...
class DisplayDevice(winrt.system.Object):
    ...
    def create_simple_scanout_with_dirty_rects_and_options(self, source: typing.Optional[DisplaySource], surface: typing.Optional[DisplaySurface], subresource_index: winrt.system.UInt32, sync_interval: winrt.system.UInt32, dirty_rects: typing.Iterable[windows_graphics.RectInt32], options: DisplayScanoutOptions, /) -> typing.Optional[DisplayScanout]: ...
...
class DisplayManager(winrt.system.Object, metaclass=DisplayManager_Static):
    ...
    def create_display_device_for_indirect_adapter(self, indirect_adapter: typing.Optional[DisplayAdapter], render_adapter: typing.Optional[DisplayAdapter], /) -> typing.Optional[DisplayDevice]: ...
    def get_current_adapters(self) -> typing.Optional[windows_foundation_collections.IVectorView[DisplayAdapter]]: ...
    def get_current_targets(self) -> typing.Optional[windows_foundation_collections.IVectorView[DisplayTarget]]: ...
    ...
    def try_read_current_state_for_mode_query(self) -> typing.Optional[DisplayManagerResultWithState]: ...
...
@typing.final
class DisplayMuxDevice(winrt.system.Object, metaclass=DisplayMuxDevice_Static):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> DisplayMuxDevice: ...
    def close(self) -> None: ...
    def get_available_mux_targets(self) -> typing.Optional[windows_foundation_collections.IVectorView[DisplayTarget]]: ...
    def set_automatic_target_switching(self) -> windows_foundation.IAsyncAction: ...
    def set_preferred_target(self, target: typing.Optional[DisplayTarget], /) -> windows_foundation.IAsyncAction: ...
    ...
    def remove_changed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
    def current_target(self) -> typing.Optional[DisplayTarget]: ...
    @_property
    def id(self) -> str: ...
    @_property
    ...
    @_property
    def preferred_target(self) -> typing.Optional[DisplayTarget]: ...
...
class DisplayPath(winrt.system.Object):
    ...
    def find_modes(self, flags: DisplayModeQueryOptions, /) -> typing.Optional[windows_foundation_collections.IVectorView[DisplayModeInfo]]: ...
    @_property
    def wire_format(self) -> typing.Optional[DisplayWireFormat]: ...
    @wire_format.setter
    def wire_format(self, value: typing.Optional[DisplayWireFormat]) -> None: ...
    @_property
    def target_resolution(self) -> typing.Optional[typing.Optional[windows_graphics.SizeInt32]]: ...
    @target_resolution.setter
    def target_resolution(self, value: typing.Optional[typing.Optional[windows_graphics.SizeInt32]]) -> None: ...
    @_property
    def source_resolution(self) -> typing.Optional[typing.Optional[windows_graphics.SizeInt32]]: ...
    @source_resolution.setter
    def source_resolution(self, value: typing.Optional[typing.Optional[windows_graphics.SizeInt32]]) -> None: ...
    @_property
    def source_pixel_format(self) -> windows_graphics_directx.DirectXPixelFormat: ...
    ...
    @_property
    def properties(self) -> typing.Optional[windows_foundation_collections.IMap[_uuid.UUID, winrt.system.Object]]: ...
    @_property
...
class DisplaySource(winrt.system.Object):
    ...
    def get_metadata(self, key: _uuid.UUID, /) -> typing.Optional[windows_storage_streams.IBuffer]: ...
...
class DisplayState(winrt.system.Object):
    ...
    def connect_target_to_view(self, target: typing.Optional[DisplayTarget], view: typing.Optional[DisplayView], /) -> typing.Optional[DisplayPath]: ...
    ...
    def properties(self) -> typing.Optional[windows_foundation_collections.IMap[_uuid.UUID, winrt.system.Object]]: ...
    @_property
    def targets(self) -> typing.Optional[windows_foundation_collections.IVectorView[DisplayTarget]]: ...
    @_property
    def views(self) -> typing.Optional[windows_foundation_collections.IVectorView[DisplayView]]: ...
...
class DisplayView(winrt.system.Object):
    ...
    @_property
    def content_resolution(self) -> typing.Optional[typing.Optional[windows_graphics.SizeInt32]]: ...
    @content_resolution.setter
    def content_resolution(self, value: typing.Optional[typing.Optional[windows_graphics.SizeInt32]]) -> None: ...
    @_property
    def paths(self) -> typing.Optional[windows_foundation_collections.IVectorView[DisplayPath]]: ...
    @_property
    def properties(self) -> typing.Optional[windows_foundation_collections.IMap[_uuid.UUID, winrt.system.Object]]: ...
