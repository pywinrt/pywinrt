...
class DisplayManager(winrt.system.Object, metaclass=DisplayManager_Static):
    ...
    def get_current_adapters(self) -> windows_foundation_collections.IVectorView[DisplayAdapter]: ...
    def get_current_targets(self) -> windows_foundation_collections.IVectorView[DisplayTarget]: ...
...
class DisplayMuxDevice(winrt.system.Object, metaclass=DisplayMuxDevice_Static):
    ...
    def close(self) -> None: ...
    def get_available_mux_targets(self) -> windows_foundation_collections.IVectorView[DisplayTarget]: ...
...
class DisplayPath(winrt.system.Object):
    ...
    def find_modes(self, flags: DisplayModeQueryOptions, /) -> windows_foundation_collections.IVectorView[DisplayModeInfo]: ...
    @_property
    ...
    @_property
    def properties(self) -> windows_foundation_collections.IMap[_uuid.UUID, winrt.system.Object]: ...
    @_property
...
class DisplayState(winrt.system.Object):
    ...
    def properties(self) -> windows_foundation_collections.IMap[_uuid.UUID, winrt.system.Object]: ...
    @_property
    def targets(self) -> windows_foundation_collections.IVectorView[DisplayTarget]: ...
    @_property
    def views(self) -> windows_foundation_collections.IVectorView[DisplayView]: ...
...
class DisplayTarget(winrt.system.Object):
    ...
    def try_get_monitor(self) -> windows_devices_display.DisplayMonitor: ...
    @_property
...
class DisplayView(winrt.system.Object):
    ...
    @_property
    def paths(self) -> windows_foundation_collections.IVectorView[DisplayPath]: ...
    @_property
    def properties(self) -> windows_foundation_collections.IMap[_uuid.UUID, winrt.system.Object]: ...
