...
class DisplayPath(winrt.system.Object):
    ...
    properties: typing.Optional[winrt.windows.foundation.collections.IMap[_uuid.UUID, winrt.system.Object]]
...
class DisplayPrimaryDescription(winrt.system.Object):
    ...
    @staticmethod
    def create_with_properties(extra_properties: typing.Iterable[winrt.windows.foundation.collections.IKeyValuePair[_uuid.UUID, winrt.system.Object]], width: winrt.system.UInt32, height: winrt.system.UInt32, pixel_format: winrt.windows.graphics.directx.DirectXPixelFormat, color_space: winrt.windows.graphics.directx.DirectXColorSpace, is_stereo: bool, multisample_description: winrt.windows.graphics.directx.direct3d11.Direct3DMultisampleDescription, /) -> typing.Optional[DisplayPrimaryDescription]: ...
...
class DisplayWireFormat(winrt.system.Object):
    ...
    @staticmethod
    def create_with_properties(extra_properties: typing.Iterable[winrt.windows.foundation.collections.IKeyValuePair[_uuid.UUID, winrt.system.Object]], pixel_encoding: DisplayWireFormatPixelEncoding, bits_per_channel: winrt.system.Int32, color_space: DisplayWireFormatColorSpace, eotf: DisplayWireFormatEotf, hdr_metadata: DisplayWireFormatHdrMetadata, /) -> typing.Optional[DisplayWireFormat]: ...
