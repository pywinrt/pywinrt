...
class LocalContentSuggestionSettings(winrt.system.Object):
    ...
    @_property
    def locations(self) -> windows_foundation_collections.IVector[windows_storage.StorageFolder]: ...
    @_property
    def properties_to_match(self) -> windows_foundation_collections.IVector[str]: ...
...
class SearchPaneQueryLinguisticDetails(winrt.system.Object):
    ...
    @_property
    def query_text_alternatives(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
