...
class SimpleHapticsController(winrt.system.Object):
    ...
    def send_haptic_feedback_with_intensity(self, feedback: typing.Optional[SimpleHapticsControllerFeedback], intensity: winrt.system.Double, /) -> None: ...
    ...
    @_property
    def supported_feedback(self) -> typing.Optional[windows_foundation_collections.IVectorView[SimpleHapticsControllerFeedback]]: ...
...
class VibrationDevice_Static(type):
    def find_all_async(cls) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[VibrationDevice]]: ...
