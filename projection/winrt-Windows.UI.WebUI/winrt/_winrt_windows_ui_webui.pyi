...
class WebUIFileActivatedEventArgs(winrt.system.Object):
    ...
    def currently_shown_application_view_id(self) -> winrt.system.Int32: ...
    @_property
    def files(self) -> windows_foundation_collections.IVectorView[windows_storage.IStorageItem]: ...
    @_property
    def verb(self) -> str: ...
    @_property
...
class WebUIFileOpenPickerContinuationEventArgs(winrt.system.Object):
    ...
    @_property
    def files(self) -> windows_foundation_collections.IVectorView[windows_storage.StorageFile]: ...
    @_property
    def activated_operation(self) -> ActivatedOperation: ...
...
class WebUIView(winrt.system.Object, metaclass=WebUIView_Static):
    ...
    @_property
    def deferred_permission_requests(self) -> windows_foundation_collections.IVectorView[windows_web_ui.WebViewControlDeferredPermissionRequest]: ...
    @_property
