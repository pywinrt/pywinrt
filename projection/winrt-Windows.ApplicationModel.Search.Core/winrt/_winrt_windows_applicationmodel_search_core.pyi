...
class SearchSuggestionManager(winrt.system.Object):
    ...
    def set_query_with_search_query_linguistic_details(self, query_text: str, language: str, linguistic_details: typing.Optional[windows_applicationmodel_search.SearchQueryLinguisticDetails], /) -> None: ...
