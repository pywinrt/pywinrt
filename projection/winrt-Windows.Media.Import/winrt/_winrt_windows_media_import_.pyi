...
class PhotoImportDeleteImportedItemsFromSourceResult(winrt.system.Object):
    ...
    @_property
    def deleted_items(self) -> typing.Optional[windows_foundation_collections.IVectorView[PhotoImportItem]]: ...
    @_property
...
class PhotoImportFindItemsResult(winrt.system.Object):
    ...
    @_property
    def found_items(self) -> typing.Optional[windows_foundation_collections.IVectorView[PhotoImportItem]]: ...
    @_property
    def has_succeeded(self) -> bool: ...
    @_property
...
class PhotoImportImportItemsResult(winrt.system.Object):
    ...
    def has_succeeded(self) -> bool: ...
    @_property
    def imported_items(self) -> typing.Optional[windows_foundation_collections.IVectorView[PhotoImportItem]]: ...
    @_property
    def photos_count(self) -> winrt.system.UInt32: ...
    @_property
    def photos_size_in_bytes(self) -> winrt.system.UInt64: ...
...
class PhotoImportItem(winrt.system.Object):
    ...
    @_property
    def deleted_file_names(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
    def imported_file_names(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
    ...
    @_property
    def sidecars(self) -> typing.Optional[windows_foundation_collections.IVectorView[PhotoImportSidecar]]: ...
    @_property
    ...
    @_property
    def video_segments(self) -> typing.Optional[windows_foundation_collections.IVectorView[PhotoImportVideoSegment]]: ...
    @_property
    def path(self) -> str: ...
...
class PhotoImportManager_Static(type):
    def find_all_sources_async(cls) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[PhotoImportSource]]: ...
    def get_pending_operations(cls) -> typing.Optional[windows_foundation_collections.IVectorView[PhotoImportOperation]]: ...
...
class PhotoImportSession(winrt.system.Object):
    ...
    @_property
    def destination_folder(self) -> typing.Optional[windows_storage.IStorageFolder]: ...
    @destination_folder.setter
    def destination_folder(self, value: typing.Optional[windows_storage.IStorageFolder]) -> None: ...
    @_property
...
class PhotoImportSource_Static(type):
    def from_folder_async(cls, source_root_folder: typing.Optional[windows_storage.IStorageFolder], /) -> windows_foundation.IAsyncOperation[PhotoImportSource]: ...
...
class PhotoImportSource(winrt.system.Object, metaclass=PhotoImportSource_Static):
    ...
    @_property
    def storage_media(self) -> typing.Optional[windows_foundation_collections.IVectorView[PhotoImportStorageMedium]]: ...
    @_property
    def thumbnail(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
    @_property
