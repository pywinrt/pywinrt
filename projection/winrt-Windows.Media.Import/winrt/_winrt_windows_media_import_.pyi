...
class PhotoImportSession(winrt.system.Object, windows_foundation.ImplementsIClosable):
    ...
    def destination_folder(self, value: windows_storage.ImplementsIStorageFolder) -> None: ...
    @_property
...
class PhotoImportSource_Static(type):
    def from_folder_async(cls, source_root_folder: windows_storage.ImplementsIStorageFolder, /) -> windows_foundation.IAsyncOperation[PhotoImportSource]: ...
