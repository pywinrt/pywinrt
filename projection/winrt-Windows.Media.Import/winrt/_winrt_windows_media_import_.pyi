...
class PhotoImportDeleteImportedItemsFromSourceResult(winrt.system.Object):
    ...
    @_property
    def deleted_items(self) -> windows_foundation_collections.IVectorView[PhotoImportItem]: ...
    @_property
...
class PhotoImportFindItemsResult(winrt.system.Object):
    ...
    @_property
    def found_items(self) -> windows_foundation_collections.IVectorView[PhotoImportItem]: ...
    @_property
    def has_succeeded(self) -> bool: ...
    @_property
...
class PhotoImportImportItemsResult(winrt.system.Object):
    ...
    def has_succeeded(self) -> bool: ...
    @_property
    def imported_items(self) -> windows_foundation_collections.IVectorView[PhotoImportItem]: ...
    @_property
    def photos_count(self) -> winrt.system.UInt32: ...
    @_property
    def photos_size_in_bytes(self) -> winrt.system.UInt64: ...
...
class PhotoImportItem(winrt.system.Object):
    ...
    @_property
    def deleted_file_names(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def imported_file_names(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    ...
    @_property
    def sidecars(self) -> windows_foundation_collections.IVectorView[PhotoImportSidecar]: ...
    @_property
    def size_in_bytes(self) -> winrt.system.UInt64: ...
    @_property
    def thumbnail(self) -> windows_storage_streams.IRandomAccessStreamReference: ...
    @_property
    def video_segments(self) -> windows_foundation_collections.IVectorView[PhotoImportVideoSegment]: ...
    @_property
    def path(self) -> str: ...
...
class PhotoImportManager_Static(type):
    ...
    def get_pending_operations(cls) -> windows_foundation_collections.IVectorView[PhotoImportOperation]: ...
...
class PhotoImportSource(winrt.system.Object, metaclass=PhotoImportSource_Static):
    ...
    @_property
    def storage_media(self) -> windows_foundation_collections.IVectorView[PhotoImportStorageMedium]: ...
    @_property
    def thumbnail(self) -> windows_storage_streams.IRandomAccessStreamReference: ...
    @_property
