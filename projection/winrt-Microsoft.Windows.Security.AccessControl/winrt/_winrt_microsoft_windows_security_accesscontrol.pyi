...
class SecurityDescriptorHelpers_Static(type):
    ...
    def get_security_descriptor_bytes_from_app_container_names(cls, access_requests: winrt.system.Array[AppContainerNameAndAccess], principal_string_sid: str, principal_access_mask: winrt.system.UInt32, /) -> winrt.system.Array[winrt.system.UInt8]: ...
