...
class Deferral(IClosable, winrt.system.Object):
    ...
    def __new__(cls: typing.Type[Deferral], handler: DeferralCompletedHandler) -> Deferral: ...
    def close(self) -> None: ...
...
class IAsyncActionWithProgress(IAsyncInfo, winrt.system.Object, typing.Generic[TProgress]):
...
class IAsyncOperationWithProgress(IAsyncInfo, winrt.system.Object, typing.Generic[TResult, TProgress]):
    def __class_getitem__(cls, key: typing.Any) -> types.GenericAlias: ...
...
class IAsyncOperation(IAsyncInfo, winrt.system.Object, typing.Generic[TResult]):
    def __class_getitem__(cls, key: typing.Any) -> types.GenericAlias: ...
    def __await__(self) -> typing.Generator[typing.Any, None, TResult]: ...
    def cancel(self) -> None: ...
    def close(self) -> None: ...
...
class IReferenceArray(IPropertyValue, winrt.system.Object, typing.Generic[T]):
    def __class_getitem__(cls, key: typing.Any) -> types.GenericAlias: ...
    def get_boolean(self) -> bool: ...
    def get_boolean_array(self) -> winrt.system.Array[bool]: ...
    def get_char16(self) -> winrt.system.Char16: ...
...
class IReference(IPropertyValue, winrt.system.Object, typing.Generic[T]):
    def __class_getitem__(cls, key: typing.Any) -> types.GenericAlias: ...
    def get_boolean(self) -> bool: ...
    def get_boolean_array(self) -> winrt.system.Array[bool]: ...
    def get_char16(self) -> winrt.system.Char16: ...
