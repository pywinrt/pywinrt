...
class ApplicationTrigger(winrt.system.Object):
    ...
    def request_async_with_arguments(self, arguments: typing.Optional[windows_foundation_collections.ValueSet], /) -> windows_foundation.IAsyncOperation[ApplicationTriggerResult]: ...
...
class BackgroundTaskBuilder(winrt.system.Object, metaclass=BackgroundTaskBuilder_Static):
    ...
    @typing.overload
    def register(self, task_name: str, /) -> typing.Optional[BackgroundTaskRegistration]: ...
...
class MediaProcessingTrigger(winrt.system.Object):
    ...
    def request_async_with_arguments(self, arguments: typing.Optional[windows_foundation_collections.ValueSet], /) -> windows_foundation.IAsyncOperation[MediaProcessingTriggerResult]: ...
