...
class ActivitySensorTrigger(winrt.system.Object):
    ...
    @_property
    def subscribed_activities(self) -> windows_foundation_collections.IVector[windows_devices_sensors.ActivityType]: ...
    @_property
    def supported_activities(self) -> windows_foundation_collections.IVectorView[windows_devices_sensors.ActivityType]: ...
...
class BackgroundTaskRegistration_Static(type):
    ...
    @_property
    def all_tasks(cls) -> windows_foundation_collections.IMapView[_uuid.UUID, IBackgroundTaskRegistration]: ...
    @_property
    def all_task_groups(cls) -> windows_foundation_collections.IMapView[str, BackgroundTaskRegistrationGroup]: ...
...
class BackgroundTaskRegistrationGroup(winrt.system.Object):
    ...
    @_property
    def all_tasks(self) -> windows_foundation_collections.IMapView[_uuid.UUID, BackgroundTaskRegistration]: ...
    @_property
    def id(self) -> str: ...
    @_property
    def name(self) -> str: ...
...
class BluetoothLEAdvertisementPublisherTrigger(winrt.system.Object):
    ...
    @_property
    def preferred_transmit_power_level_in_d_bm(self) -> typing.Optional[winrt.system.Int16]: ...
    @preferred_transmit_power_level_in_d_bm.setter
    def preferred_transmit_power_level_in_d_bm(self, value: typing.Optional[winrt.system.Int16]) -> None: ...
    @_property
...
class GattCharacteristicNotificationTrigger(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[GattCharacteristicNotificationTrigger], characteristic: windows_devices_bluetooth_genericattributeprofile.GattCharacteristic, event_triggering_mode: windows_devices_bluetooth_background.BluetoothEventTriggeringMode) -> GattCharacteristicNotificationTrigger: ...
    @typing.overload
    def __new__(cls: typing.Type[GattCharacteristicNotificationTrigger], characteristic: windows_devices_bluetooth_genericattributeprofile.GattCharacteristic) -> GattCharacteristicNotificationTrigger: ...
    @_property
...
class SensorDataThresholdTrigger(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[SensorDataThresholdTrigger], threshold: windows_devices_sensors.ISensorDataThreshold) -> SensorDataThresholdTrigger: ...
...
class SmsMessageReceivedTrigger(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[SmsMessageReceivedTrigger], filter_rules: windows_devices_sms.SmsFilterRules) -> SmsMessageReceivedTrigger: ...
...
class StorageLibraryChangeTrackerTrigger(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[StorageLibraryChangeTrackerTrigger], tracker: windows_storage.StorageLibraryChangeTracker) -> StorageLibraryChangeTrackerTrigger: ...
