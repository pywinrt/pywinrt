...
class BackgroundExecutionManager(winrt.system.Object):
    ...
    @staticmethod
    def request_access_kind_async(requested_access: BackgroundAccessRequestKind, reason: str, /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    @staticmethod
    def request_access_kind_for_modern_standby_async(requested_access: BackgroundAccessRequestKind, reason: str, /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...

class BackgroundTaskBuilder(winrt.system.Object):
    task_entry_point: str
    name: str
    cancel_on_condition_loss: winrt.system.Boolean
    is_network_requested: winrt.system.Boolean
    ...
    def set_task_entry_point_clsid(self, task_entry_point: winrt.system.Guid, /) -> None: ...
...
class BackgroundTaskRegistration(winrt.system.Object):
    ...
    task_group: typing.Optional[BackgroundTaskRegistrationGroup]
    all_tasks: typing.ClassVar[typing.Optional[winrt.windows.foundation.collections.IMapView[winrt.system.Guid, IBackgroundTaskRegistration]]]
    ...
    def unregister(self, cancel_task: winrt.system.Boolean, /) -> None: ...
...
class BackgroundTaskRegistrationGroup(winrt.system.Object):
    all_tasks: typing.Optional[winrt.windows.foundation.collections.IMapView[winrt.system.Guid, BackgroundTaskRegistration]]
    id: str
    name: str
    @staticmethod
...
class BluetoothLEAdvertisementPublisherTrigger(winrt.system.Object):
    ...
    use_extended_format: winrt.system.Boolean
...
class CachedFileUpdaterTriggerDetails(winrt.system.Object):
    can_request_user_input: winrt.system.Boolean
...
class DeviceManufacturerNotificationTrigger(winrt.system.Object):
    one_shot: winrt.system.Boolean
    trigger_qualifier: str
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> DeviceManufacturerNotificationTrigger: ...
    def __new__(cls: typing.Type[DeviceManufacturerNotificationTrigger], trigger_qualifier: str, one_shot: winrt.system.Boolean) -> DeviceManufacturerNotificationTrigger:...
...
class GattServiceProviderTrigger(winrt.system.Object):
    ...
    @staticmethod
    def create_async(trigger_id: str, service_uuid: winrt.system.Guid, /) -> winrt.windows.foundation.IAsyncOperation[GattServiceProviderTriggerResult]: ...
...
class MaintenanceTrigger(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[MaintenanceTrigger], freshness_time: winrt.system.UInt32, one_shot: winrt.system.Boolean) -> MaintenanceTrigger:...
...
class PhoneTrigger(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[PhoneTrigger], type: winrt.windows.applicationmodel.calls.background.PhoneTriggerType, one_shot: winrt.system.Boolean) -> PhoneTrigger:...
...
class RfcommConnectionTrigger(winrt.system.Object):
    ...
    allow_multiple_connections: winrt.system.Boolean
...
class SystemTrigger(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[SystemTrigger], trigger_type: SystemTriggerType, one_shot: winrt.system.Boolean) -> SystemTrigger:...
...
class TimeTrigger(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[TimeTrigger], freshness_time: winrt.system.UInt32, one_shot: winrt.system.Boolean) -> TimeTrigger:...
