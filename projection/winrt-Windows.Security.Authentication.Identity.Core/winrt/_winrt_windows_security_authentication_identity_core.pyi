...
class MicrosoftAccountMultiFactorGetSessionsResult(winrt.system.Object):
    ...
    @_property
    def sessions(self) -> windows_foundation_collections.IVectorView[MicrosoftAccountMultiFactorSessionInfo]: ...
...
class MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo(winrt.system.Object):
    ...
    def sessions(self) -> windows_foundation_collections.IVectorView[MicrosoftAccountMultiFactorSessionInfo]: ...
    @_property
    def unregistered_accounts(self) -> windows_foundation_collections.IVectorView[str]: ...
