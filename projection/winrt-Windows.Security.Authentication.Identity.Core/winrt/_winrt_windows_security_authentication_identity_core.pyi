...
class MicrosoftAccountMultiFactorAuthenticationManager(winrt.system.Object, metaclass=MicrosoftAccountMultiFactorAuthenticationManager_Static):
    ...
    def approve_session_using_auth_session_info_async(self, session_authentiction_status: MicrosoftAccountMultiFactorSessionAuthenticationStatus, authentication_session_info: typing.Optional[MicrosoftAccountMultiFactorSessionInfo], /) -> windows_foundation.IAsyncOperation[MicrosoftAccountMultiFactorServiceResponse]: ...
    ...
    def deny_session_using_auth_session_info_async(self, authentication_session_info: typing.Optional[MicrosoftAccountMultiFactorSessionInfo], /) -> windows_foundation.IAsyncOperation[MicrosoftAccountMultiFactorServiceResponse]: ...
...
class MicrosoftAccountMultiFactorGetSessionsResult(winrt.system.Object):
    ...
    @_property
    def sessions(self) -> typing.Optional[windows_foundation_collections.IVectorView[MicrosoftAccountMultiFactorSessionInfo]]: ...
...
class MicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo(winrt.system.Object):
    ...
    def sessions(self) -> typing.Optional[windows_foundation_collections.IVectorView[MicrosoftAccountMultiFactorSessionInfo]]: ...
    @_property
    def unregistered_accounts(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
