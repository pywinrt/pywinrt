...
PyMODINIT_FUNC PyInit__winrt_windows_applicationmodel_preview_inkworkspace(void) noexcept
{
    ...
    if (py::register_python_type(module.get(), type_name_InkWorkspaceHostedAppManager, &type_spec_InkWorkspaceHostedAppManager, nullptr, object_bases.get(), nullptr) == -1)
    #else
    if (py::register_python_type(module.get(), type_name_InkWorkspaceHostedAppManager, &type_spec_InkWorkspaceHostedAppManager, object_bases.get(), nullptr) == -1)
    #endif
    {
        return nullptr;
    }
