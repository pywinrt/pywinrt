...
PyMODINIT_FUNC PyInit__winrt_windows_applicationmodel_preview_inkworkspace(void) noexcept
{
    ...
    py::pyobj_handle InkWorkspaceHostedAppManager_type{py::register_python_type(module.get(), &type_spec_InkWorkspaceHostedAppManager, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_InkWorkspaceHostedAppManager_Static.get()))};
