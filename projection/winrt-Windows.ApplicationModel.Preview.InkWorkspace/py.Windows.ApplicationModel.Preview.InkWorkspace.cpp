...
PyMODINIT_FUNC PyInit__winrt_Windows_ApplicationModel_Preview_InkWorkspace(void) noexcept
{
    ...
    state->type_InkWorkspaceHostedAppManager = py::register_python_type(module.get(), type_name_InkWorkspaceHostedAppManager, &type_spec_InkWorkspaceHostedAppManager, object_bases.get(), nullptr);
