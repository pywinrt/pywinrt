...
class AppCapability_Static(type):
    ...
    def request_access_for_capabilities_for_user_async(cls, user: windows_system.User, capability_names: typing.Iterable[str], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IMapView[str, AppCapabilityAccessStatus]]: ...
