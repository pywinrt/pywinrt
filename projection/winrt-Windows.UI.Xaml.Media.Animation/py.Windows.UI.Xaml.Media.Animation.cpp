...
namespace py::cpp::Windows::UI::Xaml::Media::Animation
{
        ...
        if (arg_count == 0)
        {
            try
            {
                if (type != self_type)
                {
                    ...
                    std::construct_at(&reinterpret_cast<py::wrapper::Windows::UI::Xaml::Media::Animation::BasicConnectedAnimationConfiguration*>(self.get())->obj, nullptr);
                    reinterpret_cast<py::wrapper::Windows::UI::Xaml::Media::Animation::BasicConnectedAnimationConfiguration*>(self.get())->obj = winrt::make<PyWinrtBasicConnectedAnimationConfiguration>(self.get());
        ...
        if (arg_count == 0)
        {
            try
            {
                if (type != self_type)
                {
                    ...
                    std::construct_at(&reinterpret_cast<py::wrapper::Windows::UI::Xaml::Media::Animation::DirectConnectedAnimationConfiguration*>(self.get())->obj, nullptr);
                    reinterpret_cast<py::wrapper::Windows::UI::Xaml::Media::Animation::DirectConnectedAnimationConfiguration*>(self.get())->obj = winrt::make<PyWinrtDirectConnectedAnimationConfiguration>(self.get());
        ...
        if (arg_count == 0)
        {
            try
            {
                if (type != self_type)
                {
                    ...
                    std::construct_at(&reinterpret_cast<py::wrapper::Windows::UI::Xaml::Media::Animation::GravityConnectedAnimationConfiguration*>(self.get())->obj, nullptr);
                    reinterpret_cast<py::wrapper::Windows::UI::Xaml::Media::Animation::GravityConnectedAnimationConfiguration*>(self.get())->obj = winrt::make<PyWinrtGravityConnectedAnimationConfiguration>(self.get());
    ...
    static PyObject* _richcompare_KeyTime(py::wrapper::Windows::UI::Xaml::Media::Animation::KeyTime* self, PyObject* other, int op) noexcept
    {
        try
        {
            auto _other = py::convert_to<winrt::Windows::UI::Xaml::Media::Animation::KeyTime>(other);
    ...
    static PyObject* _richcompare_RepeatBehavior(py::wrapper::Windows::UI::Xaml::Media::Animation::RepeatBehavior* self, PyObject* other, int op) noexcept
    {
        try
        {
            auto _other = py::convert_to<winrt::Windows::UI::Xaml::Media::Animation::RepeatBehavior>(other);
