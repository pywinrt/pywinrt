...
class GameControllerFactoryManager(winrt.system.Object):
    ...
    @staticmethod
    def register_custom_factory_for_gip_interface(factory: typing.Optional[ICustomGameControllerFactory], interface_id: _uuid.UUID, /) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def try_get_factory_controller_from_game_controller(factory: typing.Optional[ICustomGameControllerFactory], game_controller: typing.Optional[winrt.windows.gaming.input.IGameController], /) -> typing.Optional[winrt.windows.gaming.input.IGameController]: ...
