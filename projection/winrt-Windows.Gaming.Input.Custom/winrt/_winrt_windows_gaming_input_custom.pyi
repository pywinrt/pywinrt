...
class GameControllerFactoryManager_Static(type):
    ...
    def try_get_factory_controller_from_game_controller(cls, factory: ICustomGameControllerFactory, game_controller: windows_gaming_input.IGameController, /) -> windows_gaming_input.IGameController: ...
