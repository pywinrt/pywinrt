...
from . import GipFirmwareUpdateStatus, GipMessageClass, XusbDeviceSubtype, XusbDeviceType
...
class GipFirmwareUpdateResult(winrt.system.Object):
    extended_error_code: winrt.system.UInt32
    final_component_id: winrt.system.UInt32
