...
class CryptographicBuffer_Static(type):
    ...
    def compare(cls, object1: windows_storage_streams.ImplementsIBuffer, object2: windows_storage_streams.ImplementsIBuffer, /) -> bool: ...
    ...
    def convert_binary_to_string(cls, encoding: BinaryStringEncoding, buffer: windows_storage_streams.ImplementsIBuffer, /) -> str: ...
    ...
    def copy_to_byte_array(cls, buffer: windows_storage_streams.ImplementsIBuffer, /) -> winrt.system.Array[winrt.system.UInt8]: ...
    ...
    def encode_to_base64_string(cls, buffer: windows_storage_streams.ImplementsIBuffer, /) -> str: ...
    # System.String Windows.Security.Cryptography.CryptographicBuffer::EncodeToHexString(Windows.Storage.Streams.IBuffer)
    def encode_to_hex_string(cls, buffer: windows_storage_streams.ImplementsIBuffer, /) -> str: ...
