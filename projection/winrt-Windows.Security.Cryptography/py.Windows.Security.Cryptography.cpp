...
PyMODINIT_FUNC PyInit__winrt_windows_security_cryptography(void) noexcept
{
    ...
    py::pyobj_handle CryptographicBuffer_type{py::register_python_type(module.get(), &type_spec_CryptographicBuffer, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_CryptographicBuffer_Static.get()))};
