...
PyMODINIT_FUNC PyInit__winrt_Windows_Security_Cryptography(void) noexcept
{
    ...
    if (py::register_python_type(module.get(), type_name_CryptographicBuffer, &type_spec_CryptographicBuffer, nullptr, object_bases.get(), nullptr) == -1)
    #else
    if (py::register_python_type(module.get(), type_name_CryptographicBuffer, &type_spec_CryptographicBuffer, object_bases.get(), nullptr) == -1)
    #endif
    {
        return nullptr;
    }
