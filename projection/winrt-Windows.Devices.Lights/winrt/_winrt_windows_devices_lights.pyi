...
@typing.final
class Lamp(winrt.system.Object, windows_foundation.ImplementsIClosable, metaclass=Lamp_Static):
...
class LampArray(winrt.system.Object, metaclass=LampArray_Static):
    ...
    def send_message_async(self, message_id: winrt.system.Int32, message: windows_storage_streams.ImplementsIBuffer, /) -> windows_foundation.IAsyncAction: ...
