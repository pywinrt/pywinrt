...
class LampArray(winrt.system.Object, metaclass=LampArray_Static):
    ...
    def get_indices_for_key(self, key: windows_system.VirtualKey, /) -> winrt.system.Int32: ...
    ...
    def send_message_async(self, message_id: winrt.system.Int32, message: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncAction: ...
    ...
    def set_colors_for_keys(self, desired_colors: winrt.system.Array[windows_ui.Color], keys: winrt.system.Array[windows_system.VirtualKey], /) -> None: ...
...
class LampInfo(winrt.system.Object):
    ...
    @_property
    def fixed_color(self) -> typing.Optional[typing.Optional[windows_ui.Color]]: ...
    @_property
