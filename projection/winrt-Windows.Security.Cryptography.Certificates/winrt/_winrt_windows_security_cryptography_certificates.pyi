...
class Certificate(winrt.system.Object):
    def __new__(cls: typing.Type[Self], cert_blob: windows_storage_streams.ImplementsIBuffer) -> Self: ...
...
class CmsAttachedSignature(winrt.system.Object, metaclass=CmsAttachedSignature_Static):
    def __new__(cls: typing.Type[Self], input_blob: windows_storage_streams.ImplementsIBuffer) -> Self: ...
