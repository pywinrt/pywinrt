...
class Certificate(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[Certificate], cert_blob: typing.Optional[windows_storage_streams.IBuffer]) -> Certificate: ...
    def build_chain_async(self, certificates: typing.Iterable[Certificate], /) -> windows_foundation.IAsyncOperation[CertificateChain]: ...
    def build_chain_with_parameters_async(self, certificates: typing.Iterable[Certificate], parameters: typing.Optional[ChainBuildingParameters], /) -> windows_foundation.IAsyncOperation[CertificateChain]: ...
    def get_certificate_blob(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    ...
    @_property
    def enhanced_key_usages(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
...
class CertificateChain(winrt.system.Object):
    ...
    def get_certificates(self, include_root: bool, /) -> typing.Optional[windows_foundation_collections.IVectorView[Certificate]]: ...
    def validate(self) -> ChainValidationResult: ...
    def validate_with_parameters(self, parameter: typing.Optional[ChainValidationParameters], /) -> ChainValidationResult: ...

@typing.final
class CertificateEnrollmentManager_Static(type):
    def create_request_async(cls, request: typing.Optional[CertificateRequestProperties], /) -> windows_foundation.IAsyncOperation[str]: ...
    ...
    def import_pfx_data_to_ksp_with_parameters_async(cls, pfx_data: str, password: str, pfx_import_parameters: typing.Optional[PfxImportParameters], /) -> windows_foundation.IAsyncAction: ...
...
class CertificateQuery(winrt.system.Object):
    ...
    def friendly_name(self, value: str) -> None: ...
    @_property
    def enhanced_key_usages(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def store_name(self) -> str: ...
    @store_name.setter
...
class CertificateRequestProperties(winrt.system.Object):
    ...
    @_property
    def extensions(self) -> typing.Optional[windows_foundation_collections.IVector[CertificateExtension]]: ...
    @_property
    def subject_alternative_name(self) -> typing.Optional[SubjectAlternativeNameInfo]: ...
    @_property
    def suppressed_defaults(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class CertificateStores_Static(type):
    def find_all_async(cls) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Certificate]]: ...
    def find_all_with_query_async(cls, query: typing.Optional[CertificateQuery], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Certificate]]: ...
...
class ChainBuildingParameters(winrt.system.Object):
    ...
    def enhanced_key_usages(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def exclusive_trust_roots(self) -> typing.Optional[windows_foundation_collections.IVector[Certificate]]: ...
...
class ChainValidationParameters(winrt.system.Object):
    ...
    @_property
    def server_dns_name(self) -> typing.Optional[windows_networking.HostName]: ...
    @server_dns_name.setter
    def server_dns_name(self, value: typing.Optional[windows_networking.HostName]) -> None: ...
    @_property
...
class CmsAttachedSignature_Static(type):
    def generate_signature_async(cls, data: typing.Optional[windows_storage_streams.IBuffer], signers: typing.Iterable[CmsSignerInfo], certificates: typing.Iterable[Certificate], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IBuffer]: ...
...
class CmsAttachedSignature(winrt.system.Object, metaclass=CmsAttachedSignature_Static):
    ...
    def __new__(cls: typing.Type[CmsAttachedSignature], input_blob: typing.Optional[windows_storage_streams.IBuffer]) -> CmsAttachedSignature: ...
    def verify_signature(self) -> SignatureValidationResult: ...
    @_property
    def certificates(self) -> typing.Optional[windows_foundation_collections.IVectorView[Certificate]]: ...
    @_property
    def content(self) -> winrt.system.UInt8: ...
    @_property
    def signers(self) -> typing.Optional[windows_foundation_collections.IVectorView[CmsSignerInfo]]: ...

@typing.final
class CmsDetachedSignature_Static(type):
    def generate_signature_async(cls, data: typing.Optional[windows_storage_streams.IInputStream], signers: typing.Iterable[CmsSignerInfo], certificates: typing.Iterable[Certificate], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IBuffer]: ...
...
class CmsDetachedSignature(winrt.system.Object, metaclass=CmsDetachedSignature_Static):
    ...
    def __new__(cls: typing.Type[CmsDetachedSignature], input_blob: typing.Optional[windows_storage_streams.IBuffer]) -> CmsDetachedSignature: ...
    def verify_signature_async(self, data: typing.Optional[windows_storage_streams.IInputStream], /) -> windows_foundation.IAsyncOperation[SignatureValidationResult]: ...
    @_property
    def certificates(self) -> typing.Optional[windows_foundation_collections.IVectorView[Certificate]]: ...
    @_property
    def signers(self) -> typing.Optional[windows_foundation_collections.IVectorView[CmsSignerInfo]]: ...
...
class SubjectAlternativeNameInfo(winrt.system.Object):
    ...
    @_property
    def distinguished_name(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
    def dns_name(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
    def email_name(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
    def ip_address(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
    def principal_name(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
    def url(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
    def distinguished_names(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def dns_names(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def email_names(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def extension(self) -> typing.Optional[CertificateExtension]: ...
    @_property
    def ip_addresses(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def principal_names(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def urls(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class UserCertificateEnrollmentManager(winrt.system.Object):
    ...
    def create_request_async(self, request: typing.Optional[CertificateRequestProperties], /) -> windows_foundation.IAsyncOperation[str]: ...
    ...
    def import_pfx_data_to_ksp_with_parameters_async(self, pfx_data: str, password: str, pfx_import_parameters: typing.Optional[PfxImportParameters], /) -> windows_foundation.IAsyncAction: ...
...
class UserCertificateStore(winrt.system.Object):
    ...
    def request_add_async(self, certificate: typing.Optional[Certificate], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def request_delete_async(self, certificate: typing.Optional[Certificate], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @_property
    def name(self) -> str: ...
