...
class Certificate(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[Certificate], cert_blob: windows_storage_streams.ImplementsIBuffer) -> Certificate: ...
...
class CmsAttachedSignature_Static(type):
    def generate_signature_async(cls, data: windows_storage_streams.ImplementsIBuffer, signers: typing.Iterable[CmsSignerInfo], certificates: typing.Iterable[Certificate], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IBuffer]: ...
...
class CmsAttachedSignature(winrt.system.Object, metaclass=CmsAttachedSignature_Static):
    ...
    def __new__(cls: typing.Type[CmsAttachedSignature], input_blob: windows_storage_streams.ImplementsIBuffer) -> CmsAttachedSignature: ...
...
class CmsDetachedSignature_Static(type):
    def generate_signature_async(cls, data: windows_storage_streams.ImplementsIInputStream, signers: typing.Iterable[CmsSignerInfo], certificates: typing.Iterable[Certificate], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IBuffer]: ...
...
class CmsDetachedSignature(winrt.system.Object, metaclass=CmsDetachedSignature_Static):
    ...
    def __new__(cls: typing.Type[CmsDetachedSignature], input_blob: windows_storage_streams.ImplementsIBuffer) -> CmsDetachedSignature: ...
    def verify_signature_async(self, data: windows_storage_streams.ImplementsIInputStream, /) -> windows_foundation.IAsyncOperation[SignatureValidationResult]: ...
    @_property
    def certificates(self) -> typing.Sequence[Certificate]: ...
    @_property
    def signers(self) -> typing.Sequence[CmsSignerInfo]: ...
