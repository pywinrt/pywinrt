...
class Certificate(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[Certificate], cert_blob: windows_storage_streams.IBuffer) -> Certificate: ...
    ...
    @_property
    def enhanced_key_usages(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
...
class CertificateChain(winrt.system.Object):
    ...
    def get_certificates(self, include_root: bool, /) -> windows_foundation_collections.IVectorView[Certificate]: ...
...
class CertificateQuery(winrt.system.Object):
    ...
    def friendly_name(self, value: str) -> None: ...
    @_property
    def enhanced_key_usages(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def store_name(self) -> str: ...
    @store_name.setter
...
class CertificateRequestProperties(winrt.system.Object):
    ...
    @_property
    def extensions(self) -> windows_foundation_collections.IVector[CertificateExtension]: ...
    @_property
    def subject_alternative_name(self) -> SubjectAlternativeNameInfo: ...
    @_property
    def suppressed_defaults(self) -> windows_foundation_collections.IVector[str]: ...
...
class CertificateStores_Static(type):
    ...
    def find_all_with_query_async(cls, query: CertificateQuery, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Certificate]]: ...
...
class ChainBuildingParameters(winrt.system.Object):
    ...
    def enhanced_key_usages(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def exclusive_trust_roots(self) -> windows_foundation_collections.IVector[Certificate]: ...
...
class CmsAttachedSignature(winrt.system.Object, metaclass=CmsAttachedSignature_Static):
    ...
    def __new__(cls: typing.Type[CmsAttachedSignature], input_blob: windows_storage_streams.IBuffer) -> CmsAttachedSignature: ...
    def verify_signature(self) -> SignatureValidationResult: ...
    @_property
    def certificates(self) -> windows_foundation_collections.IVectorView[Certificate]: ...
    @_property
    def content(self) -> winrt.system.UInt8: ...
    @_property
    def signers(self) -> windows_foundation_collections.IVectorView[CmsSignerInfo]: ...
...
class CmsDetachedSignature(winrt.system.Object, metaclass=CmsDetachedSignature_Static):
    ...
    def __new__(cls: typing.Type[CmsDetachedSignature], input_blob: windows_storage_streams.IBuffer) -> CmsDetachedSignature: ...
...
class SubjectAlternativeNameInfo(winrt.system.Object):
    ...
    @_property
    def distinguished_name(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def dns_name(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def email_name(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def ip_address(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def principal_name(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def url(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def distinguished_names(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def dns_names(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def email_names(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def extension(self) -> CertificateExtension: ...
    @_property
    def ip_addresses(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def principal_names(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def urls(self) -> windows_foundation_collections.IVector[str]: ...
