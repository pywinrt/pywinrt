...
PyMODINIT_FUNC PyInit__winrt_Windows_ApplicationModel_ExtendedExecution_Foreground(void) noexcept
{
    ...
    state->type_ExtendedExecutionForegroundRevokedEventArgs = py::register_python_type(module.get(), type_name_ExtendedExecutionForegroundRevokedEventArgs, &type_spec_ExtendedExecutionForegroundRevokedEventArgs, object_bases.get(), nullptr);
    if (!state->type_ExtendedExecutionForegroundRevokedEventArgs)
    {
        return nullptr;
    }

    state->type_ExtendedExecutionForegroundSession = py::register_python_type(module.get(), type_name_ExtendedExecutionForegroundSession, &type_spec_ExtendedExecutionForegroundSession, object_bases.get(), nullptr);
