...
class RemoteSystem_Static(type):
    ...
    def create_watcher_with_filters(cls, filters: typing.Iterable[IRemoteSystemFilter], /) -> typing.Optional[RemoteSystemWatcher]: ...
    def create_watcher_with_filters_for_user(cls, user: typing.Optional[windows_system.User], filters: typing.Iterable[IRemoteSystemFilter], /) -> typing.Optional[RemoteSystemWatcher]: ...
