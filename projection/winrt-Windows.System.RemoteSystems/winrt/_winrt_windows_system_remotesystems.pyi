...
class RemoteSystem(winrt.system.Object, metaclass=RemoteSystem_Static):
    ...
    @_property
    def apps(self) -> windows_foundation_collections.IVectorView[RemoteSystemApp]: ...
    @_property
...
class RemoteSystemApp(winrt.system.Object):
    ...
    @_property
    def attributes(self) -> windows_foundation_collections.IMapView[str, str]: ...
    @_property
    def display_name(self) -> str: ...
    @_property
    def id(self) -> str: ...
...
class RemoteSystemAppRegistration(winrt.system.Object, metaclass=RemoteSystemAppRegistration_Static):
    ...
    @_property
    def attributes(self) -> windows_foundation_collections.IMap[str, str]: ...
    @_property
    def user(self) -> windows_system.User: ...
...
class RemoteSystemConnectionRequest(winrt.system.Object, metaclass=RemoteSystemConnectionRequest_Static):
    ...
    def __new__(cls: typing.Type[RemoteSystemConnectionRequest], remote_system: RemoteSystem) -> RemoteSystemConnectionRequest: ...
    @_property
    def remote_system(self) -> RemoteSystem: ...
    @_property
...
class RemoteSystemKindFilter(winrt.system.Object):
    ...
    @_property
    def remote_system_kinds(self) -> windows_foundation_collections.IVectorView[str]: ...
...
class RemoteSystemSessionController(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[RemoteSystemSessionController], display_name: str, options: RemoteSystemSessionOptions) -> RemoteSystemSessionController: ...
...
class RemoteSystemSessionMessageChannel(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[RemoteSystemSessionMessageChannel], session: RemoteSystemSession, channel_name: str) -> RemoteSystemSessionMessageChannel: ...
    @typing.overload
    def __new__(cls: typing.Type[RemoteSystemSessionMessageChannel], session: RemoteSystemSession, channel_name: str, reliability: RemoteSystemSessionMessageChannelReliability) -> RemoteSystemSessionMessageChannel: ...
...
class RemoteSystemSessionParticipant(winrt.system.Object):
    ...
    def get_host_names(self) -> windows_foundation_collections.IVectorView[windows_networking.HostName]: ...
    @_property
    def remote_system(self) -> RemoteSystem: ...
...
class RemoteSystemWebAccountFilter(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[RemoteSystemWebAccountFilter], account: windows_security_credentials.WebAccount) -> RemoteSystemWebAccountFilter: ...
    @_property
