...
class AppBroadcastPreviewStreamReader(winrt.system.Object):
    ...
    def try_get_next_video_frame(self) -> AppBroadcastPreviewStreamVideoFrame: ...
...
class AppBroadcastStreamReader(winrt.system.Object):
    ...
    def try_get_next_audio_frame(self) -> AppBroadcastStreamAudioFrame: ...
    # Windows.Media.Capture.AppBroadcastStreamVideoFrame Windows.Media.Capture.AppBroadcastStreamReader::TryGetNextVideoFrame()
    def try_get_next_video_frame(self) -> AppBroadcastStreamVideoFrame: ...
...
@typing.final
class AppCaptureMetadataWriter(winrt.system.Object, windows_foundation.ImplementsIClosable):
...
@typing.final
class MediaCapture(winrt.system.Object, windows_foundation.ImplementsIClosable, metaclass=MediaCapture_Static):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]], exc_value: typing.Optional[BaseException], traceback: typing.Optional[types.TracebackType]) -> None: ...
    def __new__(cls: typing.Type[Self]) -> Self: ...
    ...
    def add_audio_effect_async(self, definition: windows_media_effects.ImplementsIAudioEffectDefinition, /) -> windows_foundation.IAsyncOperation[windows_media.IMediaExtension]: ...
    ...
    def add_effect_async(self, media_stream_type: MediaStreamType, effect_activation_id: str, effect_settings: windows_foundation_collections.ImplementsIPropertySet, /) -> windows_foundation.IAsyncAction: ...
    ...
    def add_video_effect_async(self, definition: windows_media_effects.ImplementsIVideoEffectDefinition, media_stream_type: MediaStreamType, /) -> windows_foundation.IAsyncOperation[windows_media.IMediaExtension]: ...
    ...
    def capture_photo_to_storage_file_async(self, type: windows_media_mediaproperties.ImageEncodingProperties, file: windows_storage.ImplementsIStorageFile, /) -> windows_foundation.IAsyncAction: ...
    ...
    def capture_photo_to_stream_async(self, type: windows_media_mediaproperties.ImageEncodingProperties, stream: windows_storage_streams.ImplementsIRandomAccessStream, /) -> windows_foundation.IAsyncAction: ...
    ...
    def prepare_low_lag_record_to_custom_sink_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, custom_media_sink: windows_media.ImplementsIMediaExtension, /) -> windows_foundation.IAsyncOperation[LowLagMediaRecording]: ...
    ...
    def prepare_low_lag_record_to_custom_sink_id_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, custom_sink_activation_id: str, custom_sink_settings: windows_foundation_collections.ImplementsIPropertySet, /) -> windows_foundation.IAsyncOperation[LowLagMediaRecording]: ...
    ...
    def prepare_low_lag_record_to_storage_file_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, file: windows_storage.ImplementsIStorageFile, /) -> windows_foundation.IAsyncOperation[LowLagMediaRecording]: ...
    ...
    def prepare_low_lag_record_to_stream_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, stream: windows_storage_streams.ImplementsIRandomAccessStream, /) -> windows_foundation.IAsyncOperation[LowLagMediaRecording]: ...
    ...
    def remove_effect_async(self, effect: windows_media.ImplementsIMediaExtension, /) -> windows_foundation.IAsyncAction: ...
    ...
    def set_encoding_properties_async(self, media_stream_type: MediaStreamType, media_encoding_properties: windows_media_mediaproperties.ImplementsIMediaEncodingProperties, encoder_properties: windows_media_mediaproperties.MediaPropertySet, /) -> windows_foundation.IAsyncAction: ...
    ...
    def start_preview_to_custom_sink_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, custom_media_sink: windows_media.ImplementsIMediaExtension, /) -> windows_foundation.IAsyncAction: ...
    ...
    def start_preview_to_custom_sink_id_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, custom_sink_activation_id: str, custom_sink_settings: windows_foundation_collections.ImplementsIPropertySet, /) -> windows_foundation.IAsyncAction: ...
    ...
    def start_record_to_custom_sink_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, custom_media_sink: windows_media.ImplementsIMediaExtension, /) -> windows_foundation.IAsyncAction: ...
    ...
    def start_record_to_custom_sink_id_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, custom_sink_activation_id: str, custom_sink_settings: windows_foundation_collections.ImplementsIPropertySet, /) -> windows_foundation.IAsyncAction: ...
    ...
    def start_record_to_storage_file_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, file: windows_storage.ImplementsIStorageFile, /) -> windows_foundation.IAsyncAction: ...
    ...
    def start_record_to_stream_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, stream: windows_storage_streams.ImplementsIRandomAccessStream, /) -> windows_foundation.IAsyncAction: ...
...
class MediaCaptureInitializationSettings(winrt.system.Object):
    ...
    @video_source.setter
    def video_source(self, value: windows_media_core.ImplementsIMediaSource) -> None: ...
    ...
    @audio_source.setter
    def audio_source(self, value: windows_media_core.ImplementsIMediaSource) -> None: ...
...
@typing.final
class MediaCapturePauseResult(winrt.system.Object, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]], exc_value: typing.Optional[BaseException], traceback: typing.Optional[types.TracebackType]) -> None: ...
...
@typing.final
class MediaCaptureRelativePanelWatcher(winrt.system.Object, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]], exc_value: typing.Optional[BaseException], traceback: typing.Optional[types.TracebackType]) -> None: ...
...
@typing.final
class MediaCaptureStopResult(winrt.system.Object, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]], exc_value: typing.Optional[BaseException], traceback: typing.Optional[types.TracebackType]) -> None: ...
