...
class AppBroadcastPlugInManager(winrt.system.Object, metaclass=AppBroadcastPlugInManager_Static):
    ...
    @_property
    def plug_in_list(self) -> windows_foundation_collections.IVectorView[AppBroadcastPlugIn]: ...
...
class MediaCapture_Static(type):
    def find_all_video_profiles(cls, video_device_id: str, /) -> windows_foundation_collections.IVectorView[MediaCaptureVideoProfile]: ...
    def find_concurrent_profiles(cls, video_device_id: str, /) -> windows_foundation_collections.IVectorView[MediaCaptureVideoProfile]: ...
    def find_known_video_profiles(cls, video_device_id: str, name: KnownVideoProfile, /) -> windows_foundation_collections.IVectorView[MediaCaptureVideoProfile]: ...
...
class MediaCapture(winrt.system.Object, metaclass=MediaCapture_Static):
    ...
    def add_effect_async(self, media_stream_type: MediaStreamType, effect_activation_i_d: str, effect_settings: windows_foundation_collections.IPropertySet, /) -> windows_foundation.IAsyncAction: ...
    ...
    @_property
    def frame_sources(self) -> windows_foundation_collections.IMapView[str, windows_media_capture_frames.MediaFrameSource]: ...
...
class MediaCaptureVideoProfile(winrt.system.Object):
    ...
    def get_concurrency(self) -> windows_foundation_collections.IVectorView[MediaCaptureVideoProfile]: ...
    @_property
    def id(self) -> str: ...
    @_property
    def supported_photo_media_description(self) -> windows_foundation_collections.IVectorView[MediaCaptureVideoProfileMediaDescription]: ...
    @_property
    def supported_preview_media_description(self) -> windows_foundation_collections.IVectorView[MediaCaptureVideoProfileMediaDescription]: ...
    @_property
    def supported_record_media_description(self) -> windows_foundation_collections.IVectorView[MediaCaptureVideoProfileMediaDescription]: ...
    @_property
    def video_device_id(self) -> str: ...
    @_property
    def frame_source_infos(self) -> windows_foundation_collections.IVectorView[windows_media_capture_frames.MediaFrameSourceInfo]: ...
    @_property
    def properties(self) -> windows_foundation_collections.IMapView[_uuid.UUID, winrt.system.Object]: ...
