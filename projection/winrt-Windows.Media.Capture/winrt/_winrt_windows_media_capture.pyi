...
class AdvancedPhotoCapture(winrt.system.Object):
    ...
    @typing.overload
    def capture_async(self, context: typing.Optional[winrt.system.Object], /) -> windows_foundation.IAsyncOperation[AdvancedCapturedPhoto]: ...
...
class MediaCapture(winrt.system.Object, metaclass=MediaCapture_Static):
    ...
    @typing.overload
    def create_frame_reader_async(self, input_source: typing.Optional[windows_media_capture_frames.MediaFrameSource], output_subtype: str, /) -> windows_foundation.IAsyncOperation[windows_media_capture_frames.MediaFrameReader]: ...
    @typing.overload
    def create_frame_reader_async(self, input_source: typing.Optional[windows_media_capture_frames.MediaFrameSource], output_subtype: str, output_size: windows_graphics_imaging.BitmapSize, /) -> windows_foundation.IAsyncOperation[windows_media_capture_frames.MediaFrameReader]: ...
    ...
    @typing.overload
    def get_preview_frame_async(self, destination: typing.Optional[windows_media.VideoFrame], /) -> windows_foundation.IAsyncOperation[windows_media.VideoFrame]: ...
    ...
    @typing.overload
    def initialize_async(self, media_capture_initialization_settings: typing.Optional[MediaCaptureInitializationSettings], /) -> windows_foundation.IAsyncAction: ...
    ...
    @typing.overload
    def start_preview_to_custom_sink_async(self, encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], custom_sink_activation_id: str, custom_sink_settings: typing.Optional[windows_foundation_collections.IPropertySet], /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    ...
    @typing.overload
    def start_record_to_custom_sink_async(self, encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], custom_sink_activation_id: str, custom_sink_settings: typing.Optional[windows_foundation_collections.IPropertySet], /) -> windows_foundation.IAsyncAction: ...
