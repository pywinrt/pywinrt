...
class AdvancedCapturedPhoto(winrt.system.Object):
    ...
    @_property
    def frame_bounds_relative_to_reference_photo(self) -> typing.Optional[typing.Optional[windows_foundation.Rect]]: ...
...
class AdvancedPhotoCapture(winrt.system.Object):
    ...
    def capture_with_context_async(self, context: typing.Optional[winrt.system.Object], /) -> windows_foundation.IAsyncOperation[AdvancedCapturedPhoto]: ...
...
class AppBroadcastBackgroundServiceSignInInfo(winrt.system.Object):
    ...
    @_property
    def o_auth_request_uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @o_auth_request_uri.setter
    def o_auth_request_uri(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    def o_auth_callback_uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @o_auth_callback_uri.setter
    def o_auth_callback_uri(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    def authentication_result(self) -> typing.Optional[windows_security_authentication_web.WebAuthenticationResult]: ...
    @_property
...
class AppBroadcastPlugIn(winrt.system.Object):
    ...
    @_property
    def logo(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
    @_property
...
class AppBroadcastPlugInManager_Static(type):
    ...
    def get_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[AppBroadcastPlugInManager]: ...
...
class AppBroadcastPlugInManager(winrt.system.Object, metaclass=AppBroadcastPlugInManager_Static):
    ...
    @_property
    def plug_in_list(self) -> typing.Optional[windows_foundation_collections.IVectorView[AppBroadcastPlugIn]]: ...
...
class AppBroadcastPreviewStreamVideoFrame(winrt.system.Object):
    ...
    @_property
    def video_buffer(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
...
class AppBroadcastServices(winrt.system.Object):
    ...
    def enter_broadcast_mode_async(self, plug_in: typing.Optional[AppBroadcastPlugIn], /) -> windows_foundation.IAsyncOperation[winrt.system.UInt32]: ...
    ...
    def start_preview(self, desired_size: windows_foundation.Size, /) -> typing.Optional[AppBroadcastPreview]: ...
    @_property
...
class AppBroadcastState(winrt.system.Object):
    ...
    def authentication_result(self, value: typing.Optional[windows_security_authentication_web.WebAuthenticationResult]) -> None: ...
    @_property
...
class AppBroadcastStreamAudioFrame(winrt.system.Object):
    ...
    @_property
    def audio_buffer(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
...
class AppBroadcastStreamReader(winrt.system.Object):
    ...
    def remove_video_frame_arrived(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
    def audio_aac_sequence(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
...
class AppCaptureSettings(winrt.system.Object):
    ...
    @_property
    def app_capture_destination_folder(self) -> typing.Optional[windows_storage.StorageFolder]: ...
    @app_capture_destination_folder.setter
    def app_capture_destination_folder(self, value: typing.Optional[windows_storage.StorageFolder]) -> None: ...
    @_property
    ...
    @_property
    def screenshot_destination_folder(self) -> typing.Optional[windows_storage.StorageFolder]: ...
    @screenshot_destination_folder.setter
    def screenshot_destination_folder(self, value: typing.Optional[windows_storage.StorageFolder]) -> None: ...
    @_property
...
class CapturedFrame(winrt.system.Object):
    ...
    @_property
    def bitmap_properties(self) -> typing.Optional[windows_graphics_imaging.BitmapPropertySet]: ...
    @_property
...
class CapturedFrameControlValues(winrt.system.Object):
    ...
    @_property
    def scene_mode(self) -> typing.Optional[typing.Optional[windows_media_devices.CaptureSceneMode]]: ...
    @_property
    ...
    @_property
    def focus_state(self) -> typing.Optional[typing.Optional[windows_media_devices.MediaCaptureFocusState]]: ...
    @_property
    ...
    @_property
    def sensor_frame_rate(self) -> typing.Optional[windows_media_mediaproperties.MediaRatio]: ...
    @_property
...
class MediaCapture_Static(type):
    def find_all_video_profiles(cls, video_device_id: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[MediaCaptureVideoProfile]]: ...
    def find_concurrent_profiles(cls, video_device_id: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[MediaCaptureVideoProfile]]: ...
    def find_known_video_profiles(cls, video_device_id: str, name: KnownVideoProfile, /) -> typing.Optional[windows_foundation_collections.IVectorView[MediaCaptureVideoProfile]]: ...
...
class MediaCapture(winrt.system.Object, metaclass=MediaCapture_Static):
    ...
    def add_audio_effect_async(self, definition: typing.Optional[windows_media_effects.IAudioEffectDefinition], /) -> windows_foundation.IAsyncOperation[windows_media.IMediaExtension]: ...
    def add_effect_async(self, media_stream_type: MediaStreamType, effect_activation_i_d: str, effect_settings: typing.Optional[windows_foundation_collections.IPropertySet], /) -> windows_foundation.IAsyncAction: ...
    def add_video_effect_async(self, definition: typing.Optional[windows_media_effects.IVideoEffectDefinition], media_stream_type: MediaStreamType, /) -> windows_foundation.IAsyncOperation[windows_media.IMediaExtension]: ...
    def capture_photo_to_storage_file_async(self, type: typing.Optional[windows_media_mediaproperties.ImageEncodingProperties], file: typing.Optional[windows_storage.IStorageFile], /) -> windows_foundation.IAsyncAction: ...
    def capture_photo_to_stream_async(self, type: typing.Optional[windows_media_mediaproperties.ImageEncodingProperties], stream: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> windows_foundation.IAsyncAction: ...
    def clear_effects_async(self, media_stream_type: MediaStreamType, /) -> windows_foundation.IAsyncAction: ...
    def close(self) -> None: ...
    def create_frame_reader_async(self, input_source: typing.Optional[windows_media_capture_frames.MediaFrameSource], /) -> windows_foundation.IAsyncOperation[windows_media_capture_frames.MediaFrameReader]: ...
    def create_frame_reader_with_subtype_and_size_async(self, input_source: typing.Optional[windows_media_capture_frames.MediaFrameSource], output_subtype: str, output_size: windows_graphics_imaging.BitmapSize, /) -> windows_foundation.IAsyncOperation[windows_media_capture_frames.MediaFrameReader]: ...
    def create_frame_reader_with_subtype_async(self, input_source: typing.Optional[windows_media_capture_frames.MediaFrameSource], output_subtype: str, /) -> windows_foundation.IAsyncOperation[windows_media_capture_frames.MediaFrameReader]: ...
    ...
    def create_relative_panel_watcher(self, capture_mode: StreamingCaptureMode, display_region: typing.Optional[windows_ui_windowmanagement.DisplayRegion], /) -> typing.Optional[MediaCaptureRelativePanelWatcher]: ...
    ...
    def get_preview_frame_copy_async(self, destination: typing.Optional[windows_media.VideoFrame], /) -> windows_foundation.IAsyncOperation[windows_media.VideoFrame]: ...
    ...
    def initialize_with_settings_async(self, media_capture_initialization_settings: typing.Optional[MediaCaptureInitializationSettings], /) -> windows_foundation.IAsyncAction: ...
    ...
    def prepare_advanced_photo_capture_async(self, encoding_properties: typing.Optional[windows_media_mediaproperties.ImageEncodingProperties], /) -> windows_foundation.IAsyncOperation[AdvancedPhotoCapture]: ...
    def prepare_low_lag_photo_capture_async(self, type: typing.Optional[windows_media_mediaproperties.ImageEncodingProperties], /) -> windows_foundation.IAsyncOperation[LowLagPhotoCapture]: ...
    def prepare_low_lag_photo_sequence_capture_async(self, type: typing.Optional[windows_media_mediaproperties.ImageEncodingProperties], /) -> windows_foundation.IAsyncOperation[LowLagPhotoSequenceCapture]: ...
    def prepare_low_lag_record_to_custom_sink_async(self, encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], custom_media_sink: typing.Optional[windows_media.IMediaExtension], /) -> windows_foundation.IAsyncOperation[LowLagMediaRecording]: ...
    def prepare_low_lag_record_to_custom_sink_id_async(self, encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], custom_sink_activation_id: str, custom_sink_settings: typing.Optional[windows_foundation_collections.IPropertySet], /) -> windows_foundation.IAsyncOperation[LowLagMediaRecording]: ...
    def prepare_low_lag_record_to_storage_file_async(self, encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], file: typing.Optional[windows_storage.IStorageFile], /) -> windows_foundation.IAsyncOperation[LowLagMediaRecording]: ...
    def prepare_low_lag_record_to_stream_async(self, encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], stream: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> windows_foundation.IAsyncOperation[LowLagMediaRecording]: ...
    def prepare_variable_photo_sequence_capture_async(self, type: typing.Optional[windows_media_mediaproperties.ImageEncodingProperties], /) -> windows_foundation.IAsyncOperation[windows_media_capture_core.VariablePhotoSequenceCapture]: ...
    def remove_effect_async(self, effect: typing.Optional[windows_media.IMediaExtension], /) -> windows_foundation.IAsyncAction: ...
    ...
    def set_encoding_properties_async(self, media_stream_type: MediaStreamType, media_encoding_properties: typing.Optional[windows_media_mediaproperties.IMediaEncodingProperties], encoder_properties: typing.Optional[windows_media_mediaproperties.MediaPropertySet], /) -> windows_foundation.IAsyncAction: ...
    ...
    def start_preview_to_custom_sink_async(self, encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], custom_media_sink: typing.Optional[windows_media.IMediaExtension], /) -> windows_foundation.IAsyncAction: ...
    def start_preview_to_custom_sink_id_async(self, encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], custom_sink_activation_id: str, custom_sink_settings: typing.Optional[windows_foundation_collections.IPropertySet], /) -> windows_foundation.IAsyncAction: ...
    def start_record_to_custom_sink_async(self, encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], custom_media_sink: typing.Optional[windows_media.IMediaExtension], /) -> windows_foundation.IAsyncAction: ...
    def start_record_to_custom_sink_id_async(self, encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], custom_sink_activation_id: str, custom_sink_settings: typing.Optional[windows_foundation_collections.IPropertySet], /) -> windows_foundation.IAsyncAction: ...
    def start_record_to_storage_file_async(self, encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], file: typing.Optional[windows_storage.IStorageFile], /) -> windows_foundation.IAsyncAction: ...
    def start_record_to_stream_async(self, encoding_profile: typing.Optional[windows_media_mediaproperties.MediaEncodingProfile], stream: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> windows_foundation.IAsyncAction: ...
    ...
    def add_failed(self, error_event_handler: typing.Optional[MediaCaptureFailedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_failed(self, event_cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_record_limitation_exceeded(self, record_limitation_exceeded_event_handler: typing.Optional[RecordLimitationExceededEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    ...
    @_property
    def audio_device_controller(self) -> typing.Optional[windows_media_devices.AudioDeviceController]: ...
    @_property
    def media_capture_settings(self) -> typing.Optional[MediaCaptureSettings]: ...
    @_property
    def video_device_controller(self) -> typing.Optional[windows_media_devices.VideoDeviceController]: ...
    @_property
    def camera_stream_state(self) -> windows_media_devices.CameraStreamState: ...
    @_property
    def thermal_status(self) -> MediaCaptureThermalStatus: ...
    @_property
    def frame_sources(self) -> typing.Optional[windows_foundation_collections.IMapView[str, windows_media_capture_frames.MediaFrameSource]]: ...
...
class MediaCaptureInitializationSettings(winrt.system.Object):
    ...
    @_property
    def video_source(self) -> typing.Optional[windows_media_core.IMediaSource]: ...
    @video_source.setter
    def video_source(self, value: typing.Optional[windows_media_core.IMediaSource]) -> None: ...
    @_property
    def audio_source(self) -> typing.Optional[windows_media_core.IMediaSource]: ...
    @audio_source.setter
    def audio_source(self, value: typing.Optional[windows_media_core.IMediaSource]) -> None: ...
    @_property
    ...
    @_property
    def source_group(self) -> typing.Optional[windows_media_capture_frames.MediaFrameSourceGroup]: ...
    @source_group.setter
    def source_group(self, value: typing.Optional[windows_media_capture_frames.MediaFrameSourceGroup]) -> None: ...
    @_property
    ...
    @_property
    def device_uri_password_credential(self) -> typing.Optional[windows_security_credentials.PasswordCredential]: ...
    @device_uri_password_credential.setter
    def device_uri_password_credential(self, value: typing.Optional[windows_security_credentials.PasswordCredential]) -> None: ...
    @_property
    def device_uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @device_uri.setter
    def device_uri(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
...
class MediaCapturePauseResult(winrt.system.Object):
    ...
    def close(self) -> None: ...
    @_property
    def last_frame(self) -> typing.Optional[windows_media.VideoFrame]: ...
    @_property
...
class MediaCaptureVideoProfile(winrt.system.Object):
    ...
    def get_concurrency(self) -> typing.Optional[windows_foundation_collections.IVectorView[MediaCaptureVideoProfile]]: ...
    @_property
    def id(self) -> str: ...
    @_property
    def supported_photo_media_description(self) -> typing.Optional[windows_foundation_collections.IVectorView[MediaCaptureVideoProfileMediaDescription]]: ...
    @_property
    def supported_preview_media_description(self) -> typing.Optional[windows_foundation_collections.IVectorView[MediaCaptureVideoProfileMediaDescription]]: ...
    @_property
    def supported_record_media_description(self) -> typing.Optional[windows_foundation_collections.IVectorView[MediaCaptureVideoProfileMediaDescription]]: ...
    @_property
    def video_device_id(self) -> str: ...
    @_property
    def frame_source_infos(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_media_capture_frames.MediaFrameSourceInfo]]: ...
    @_property
    def properties(self) -> typing.Optional[windows_foundation_collections.IMapView[_uuid.UUID, winrt.system.Object]]: ...
...
class VideoStreamConfiguration(winrt.system.Object):
    ...
    @_property
    def input_properties(self) -> typing.Optional[windows_media_mediaproperties.VideoEncodingProperties]: ...
    @_property
    def output_properties(self) -> typing.Optional[windows_media_mediaproperties.VideoEncodingProperties]: ...
