...
class ContactInformation_Static(type):
    def parse_vcard_async(cls, vcard: typing.Optional[windows_storage_streams.IInputStream], /) -> windows_foundation.IAsyncOperation[ContactInformation]: ...
...
class ContactInformation(winrt.system.Object, metaclass=ContactInformation_Static):
    ...
    def get_properties_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IMap[str, winrt.system.Object]]: ...
    def set_display_picture_async(self, stream: typing.Optional[windows_storage_streams.IInputStream], /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    def to_vcard_async(self) -> windows_foundation.IAsyncOperation[windows_storage_streams.IRandomAccessStream]: ...
    @typing.overload
    def to_vcard_async(self, format: VCardFormat, /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IRandomAccessStream]: ...
    @_property
    ...
    @_property
    def display_picture(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
...
class ContactQueryResult(winrt.system.Object):
    ...
    @typing.overload
    def get_contacts_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[StoredContact]]: ...
    @typing.overload
    def get_contacts_async(self, start_index: winrt.system.UInt32, max_number_of_items: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[StoredContact]]: ...
...
class ContactStore_Static(type):
    ...
    @typing.overload
    def create_or_open_async(cls, access: ContactStoreSystemAccessMode, sharing: ContactStoreApplicationAccessMode, /) -> windows_foundation.IAsyncOperation[ContactStore]: ...
...
class ContactStore(winrt.system.Object, metaclass=ContactStore_Static):
    ...
    def get_changes_async(self, base_revision_number: winrt.system.UInt64, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ContactChangeRecord]]: ...
    def load_extended_properties_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IMap[str, winrt.system.Object]]: ...
    def save_extended_properties_async(self, data: windows_foundation_collections.IMapView[str, winrt.system.Object], /) -> windows_foundation.IAsyncAction: ...
    @_property
    def revision_number(self) -> winrt.system.UInt64: ...
...
class StoredContact(winrt.system.Object):
    ...
    def get_display_picture_async(self) -> windows_foundation.IAsyncOperation[windows_storage_streams.IRandomAccessStream]: ...
    def get_extended_properties_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IMap[str, winrt.system.Object]]: ...
    def get_properties_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IMap[str, winrt.system.Object]]: ...
