...
class ContactInformation_Static(type):
    def parse_vcard_async(cls, vcard: windows_storage_streams.ImplementsIInputStream, /) -> windows_foundation.IAsyncOperation[ContactInformation]: ...

@typing.final
class ContactInformation(winrt.system.Object, ImplementsIContactInformation, metaclass=ContactInformation_Static):
    @staticmethod
...
@typing.final
class StoredContact(winrt.system.Object, ImplementsIContactInformation2, ImplementsIContactInformation):
    @staticmethod
