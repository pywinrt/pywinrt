...
class ContactQueryResult(winrt.system.Object):
    ...
    def get_contacts_async_in_range(self, start_index: winrt.system.UInt32, max_number_of_items: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[StoredContact]]: ...
...
class ContactStore(winrt.system.Object, metaclass=ContactStore_Static):
    ...
    def create_contact_query_default(self) -> typing.Optional[ContactQueryResult]: ...
    def create_contact_query_with_options(self, options: typing.Optional[ContactQueryOptions], /) -> typing.Optional[ContactQueryResult]: ...
