...
class StoredContact(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[StoredContact], store: ContactStore) -> StoredContact: ...
    @typing.overload
    def __new__(cls: typing.Type[StoredContact], store: ContactStore, contact: ContactInformation) -> StoredContact: ...
    def get_display_picture_async(self) -> windows_foundation.IAsyncOperation[windows_storage_streams.IRandomAccessStream]: ...
