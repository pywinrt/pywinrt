...
class EnterpriseEnrollmentManager_Static(type):
    ...
    @_property
    def enrolled_enterprises(cls) -> windows_foundation_collections.IVectorView[Enterprise]: ...
...
class InstallationManager_Static(type):
    ...
    def find_packages(cls) -> windows_foundation_collections.IIterable[windows_applicationmodel.Package]: ...
    def find_packages_by_name_publisher(cls, package_name: str, package_publisher: str, /) -> windows_foundation_collections.IIterable[windows_applicationmodel.Package]: ...
    def find_packages_for_current_publisher(cls) -> windows_foundation_collections.IIterable[windows_applicationmodel.Package]: ...
    def get_pending_package_installs(cls) -> windows_foundation_collections.IIterable[windows_foundation.IAsyncOperationWithProgress[PackageInstallResult, winrt.system.UInt32]]: ...
