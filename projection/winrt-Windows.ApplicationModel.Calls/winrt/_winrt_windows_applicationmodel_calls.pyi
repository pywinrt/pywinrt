...
class PhoneCallHistoryStore(winrt.system.Object):
    ...
    def get_entry_reader_with_options(self, query_options: typing.Optional[PhoneCallHistoryEntryQueryOptions], /) -> typing.Optional[PhoneCallHistoryEntryReader]: ...
