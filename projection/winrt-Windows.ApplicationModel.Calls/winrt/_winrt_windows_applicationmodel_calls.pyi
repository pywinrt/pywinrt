...
class AcceptedVoipPhoneCallOptions(winrt.system.Object):
    ...
    @_property
    def associated_device_ids(self) -> windows_foundation_collections.IVector[str]: ...
...
class PhoneCallHistoryEntryQueryOptions(winrt.system.Object):
    ...
    @_property
    def source_ids(self) -> windows_foundation_collections.IVector[str]: ...
...
class PhoneCallsResult(winrt.system.Object):
    ...
    @_property
    def all_active_phone_calls(self) -> windows_foundation_collections.IVectorView[PhoneCall]: ...
    @_property
...
class VoipPhoneCall(winrt.system.Object):
    ...
    def get_associated_call_control_devices(self) -> windows_foundation_collections.IVectorView[str]: ...
