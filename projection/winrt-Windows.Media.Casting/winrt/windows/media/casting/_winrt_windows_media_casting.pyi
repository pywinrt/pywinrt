...
class CastingDevice(winrt.system.Object):
    ...
    @staticmethod
    def device_info_supports_casting_async(device: typing.Optional[winrt.windows.devices.enumeration.DeviceInformation], /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @staticmethod
