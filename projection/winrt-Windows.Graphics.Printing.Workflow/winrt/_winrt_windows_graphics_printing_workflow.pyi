...
class PrintWorkflowPrinterJob(winrt.system.Object):
    ...
    def convert_print_ticket_to_job_attributes(self, print_ticket: typing.Optional[windows_graphics_printing_printticket.WorkflowPrintTicket], target_pdl_format: str, /) -> typing.Optional[windows_foundation_collections.IMap[str, windows_devices_printers.IppAttributeValue]]: ...
...
class PrintWorkflowVirtualPrinterTriggerDetails(winrt.system.Object):
    ...
    @_property
    def virtual_printer_session(self) -> typing.Optional[PrintWorkflowVirtualPrinterSession]: ...
