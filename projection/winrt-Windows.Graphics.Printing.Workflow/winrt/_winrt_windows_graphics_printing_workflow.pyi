...
class PrintWorkflowJobIssueDetectedEventArgs(winrt.system.Object):
    ...
    @_property
    def u_i_launcher(self) -> PrintWorkflowUILauncher: ...
...
class PrintWorkflowJobStartingEventArgs(winrt.system.Object):
    ...
    @_property
    def skip_system_fax_u_i(self) -> bool: ...
    @skip_system_fax_u_i.setter
    def skip_system_fax_u_i(self, value: bool) -> None: ...
    @_property
...
class PrintWorkflowJobUISession(winrt.system.Object):
    ...
    def add_virtual_printer_u_i_data_available(self, handler: windows_foundation.TypedEventHandler[PrintWorkflowJobUISession, PrintWorkflowVirtualPrinterUIEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_virtual_printer_u_i_data_available(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
    def status(self) -> PrintWorkflowSessionStatus: ...
...
class PrintWorkflowObjectModelSourceFileContent(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[PrintWorkflowObjectModelSourceFileContent], xps_stream: windows_storage_streams.IInputStream) -> PrintWorkflowObjectModelSourceFileContent: ...
...
class PrintWorkflowPrinterJob(winrt.system.Object):
    ...
    def convert_print_ticket_to_job_attributes(self, print_ticket: windows_graphics_printing_printticket.WorkflowPrintTicket, target_pdl_format: str, /) -> windows_foundation_collections.IMap[str, windows_devices_printers.IppAttributeValue]: ...
    def get_job_attributes(self, attribute_names: typing.Iterable[str], /) -> windows_foundation_collections.IMap[str, windows_devices_printers.IppAttributeValue]: ...
