...
class PerceptionControlGroup(winrt.system.Object):
    ...
    @_property
    def frame_provider_ids(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
...
class PerceptionCorrelationGroup(winrt.system.Object):
    ...
    @_property
    def relative_locations(self) -> typing.Optional[windows_foundation_collections.IVectorView[PerceptionCorrelation]]: ...
...
class PerceptionFrame(winrt.system.Object):
    ...
    @_property
    def frame_data(self) -> typing.Optional[windows_foundation.IMemoryBuffer]: ...
    @_property
...
class PerceptionVideoFrameAllocator(winrt.system.Object):
    ...
    def close(self) -> None: ...
    def copy_from_video_frame(self, frame: typing.Optional[windows_media.VideoFrame], /) -> typing.Optional[PerceptionFrame]: ...
