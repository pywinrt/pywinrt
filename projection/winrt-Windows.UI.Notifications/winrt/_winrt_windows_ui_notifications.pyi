...
class NotificationData(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[NotificationData], initial_values: typing.Iterable[windows_foundation_collections.ImplementsIKeyValuePair[str, str]], sequence_number: winrt.system.UInt32) -> NotificationData: ...
    @typing.overload
    def __new__(cls: typing.Type[NotificationData], initial_values: typing.Iterable[windows_foundation_collections.ImplementsIKeyValuePair[str, str]]) -> NotificationData: ...
    @typing.overload
