...
class AdaptiveNotificationText(winrt.system.Object):
    ...
    @_property
    def hints(self) -> typing.Optional[windows_foundation_collections.IMap[str, str]]: ...
    @_property
...
class BadgeNotification(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[BadgeNotification], content: typing.Optional[windows_data_xml_dom.XmlDocument]) -> BadgeNotification: ...
    @_property
    ...
    @_property
    def content(self) -> typing.Optional[windows_data_xml_dom.XmlDocument]: ...

@typing.final
class BadgeUpdateManager_Static(type):
    def create_badge_updater_for_application(cls) -> typing.Optional[BadgeUpdater]: ...
    def create_badge_updater_for_application_with_id(cls, application_id: str, /) -> typing.Optional[BadgeUpdater]: ...
    def create_badge_updater_for_secondary_tile(cls, tile_id: str, /) -> typing.Optional[BadgeUpdater]: ...
    def get_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[BadgeUpdateManagerForUser]: ...
    def get_template_content(cls, type: BadgeTemplateType, /) -> typing.Optional[windows_data_xml_dom.XmlDocument]: ...
...
class BadgeUpdateManagerForUser(winrt.system.Object):
    ...
    def create_badge_updater_for_application_with_id(self, application_id: str, /) -> typing.Optional[BadgeUpdater]: ...
...
class BadgeUpdater(winrt.system.Object):
    ...
    def clear(self) -> None: ...
    def start_periodic_update(self, badge_content: typing.Optional[windows_foundation.Uri], requested_interval: PeriodicUpdateRecurrence, /) -> None: ...
    def start_periodic_update_at_time(self, badge_content: typing.Optional[windows_foundation.Uri], start_time: datetime.datetime, requested_interval: PeriodicUpdateRecurrence, /) -> None: ...
...
class NotificationBinding(winrt.system.Object):
    ...
    def get_text_elements(self) -> typing.Optional[windows_foundation_collections.IVectorView[AdaptiveNotificationText]]: ...
    @_property
...
class NotificationData(winrt.system.Object):
    ...
    @_property
    def values(self) -> typing.Optional[windows_foundation_collections.IMap[str, str]]: ...
...
class NotificationVisual(winrt.system.Object):
    ...
    def language(self, value: str) -> None: ...
    @_property
    def bindings(self) -> typing.Optional[windows_foundation_collections.IVector[NotificationBinding]]: ...

@typing.final
class ScheduledTileNotification(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> ScheduledTileNotification: ...
    def __new__(cls: typing.Type[ScheduledTileNotification], content: typing.Optional[windows_data_xml_dom.XmlDocument], delivery_time: datetime.datetime) -> ScheduledTileNotification: ...
    @_property
    def tag(self) -> str: ...
    @tag.setter
...
class ScheduledToastNotification(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[ScheduledToastNotification], content: typing.Optional[windows_data_xml_dom.XmlDocument], delivery_time: datetime.datetime) -> ScheduledToastNotification: ...
    @typing.overload
    def __new__(cls: typing.Type[ScheduledToastNotification], content: typing.Optional[windows_data_xml_dom.XmlDocument], delivery_time: datetime.datetime, snooze_interval: datetime.timedelta, maximum_snooze_count: winrt.system.UInt32) -> ScheduledToastNotification: ...
    @_property
    def id(self) -> str: ...
    @id.setter
    def id(self, value: str) -> None: ...
...
class TileFlyoutNotification(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[TileFlyoutNotification], content: typing.Optional[windows_data_xml_dom.XmlDocument]) -> TileFlyoutNotification: ...
    @_property
    def expiration_time(self) -> typing.Optional[typing.Optional[datetime.datetime]]: ...
    @expiration_time.setter
    def expiration_time(self, value: typing.Optional[typing.Optional[datetime.datetime]]) -> None: ...
...
class TileFlyoutUpdateManager_Static(type):
    ...
    def create_tile_flyout_updater_for_application_with_id(cls, application_id: str, /) -> typing.Optional[TileFlyoutUpdater]: ...
    def create_tile_flyout_updater_for_secondary_tile(cls, tile_id: str, /) -> typing.Optional[TileFlyoutUpdater]: ...
    def get_template_content(cls, type: TileFlyoutTemplateType, /) -> typing.Optional[windows_data_xml_dom.XmlDocument]: ...
...
class TileFlyoutUpdater(winrt.system.Object):
    ...
    def clear(self) -> None: ...
    def start_periodic_update(self, tile_flyout_content: typing.Optional[windows_foundation.Uri], requested_interval: PeriodicUpdateRecurrence, /) -> None: ...
    def start_periodic_update_at_time(self, tile_flyout_content: typing.Optional[windows_foundation.Uri], start_time: datetime.datetime, requested_interval: PeriodicUpdateRecurrence, /) -> None: ...
    def stop_periodic_update(self) -> None: ...
...
class TileNotification(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[TileNotification], content: typing.Optional[windows_data_xml_dom.XmlDocument]) -> TileNotification: ...
    @_property
    def tag(self) -> str: ...
    @tag.setter
    def tag(self, value: str) -> None: ...
...
class TileUpdateManager_Static(type):
    ...
    def create_tile_updater_for_application_with_id(cls, application_id: str, /) -> typing.Optional[TileUpdater]: ...
    def create_tile_updater_for_secondary_tile(cls, tile_id: str, /) -> typing.Optional[TileUpdater]: ...
    def get_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[TileUpdateManagerForUser]: ...
    def get_template_content(cls, type: TileTemplateType, /) -> typing.Optional[windows_data_xml_dom.XmlDocument]: ...
...
class TileUpdateManagerForUser(winrt.system.Object):
    ...
    def create_tile_updater_for_application(self) -> typing.Optional[TileUpdater]: ...
    def create_tile_updater_for_application_with_id(self, application_id: str, /) -> typing.Optional[TileUpdater]: ...
...
class TileUpdater(winrt.system.Object):
    ...
    def get_scheduled_tile_notifications(self) -> typing.Optional[windows_foundation_collections.IVectorView[ScheduledTileNotification]]: ...
    def remove_from_schedule(self, scheduled_tile: typing.Optional[ScheduledTileNotification], /) -> None: ...
    def start_periodic_update(self, tile_content: typing.Optional[windows_foundation.Uri], requested_interval: PeriodicUpdateRecurrence, /) -> None: ...
    def start_periodic_update_at_time(self, tile_content: typing.Optional[windows_foundation.Uri], start_time: datetime.datetime, requested_interval: PeriodicUpdateRecurrence, /) -> None: ...
...
class ToastCollection(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[ToastCollection], collection_id: str, display_name: str, launch_args: str, icon_uri: typing.Optional[windows_foundation.Uri]) -> ToastCollection: ...
    @_property
    def launch_args(self) -> str: ...
    @launch_args.setter
    def launch_args(self, value: str) -> None: ...
    @_property
    def icon(self) -> typing.Optional[windows_foundation.Uri]: ...
    @icon.setter
    def icon(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
...
class ToastCollectionManager(winrt.system.Object):
    ...
    def save_toast_collection_async(self, collection: typing.Optional[ToastCollection], /) -> windows_foundation.IAsyncAction: ...
    @_property
    def app_id(self) -> str: ...
    @_property
    def user(self) -> typing.Optional[windows_system.User]: ...
...
class ToastNotification(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[ToastNotification], content: typing.Optional[windows_data_xml_dom.XmlDocument]) -> ToastNotification: ...
...
class ToastNotificationHistory(winrt.system.Object):
    ...
    def get_history(self) -> typing.Optional[windows_foundation_collections.IVectorView[ToastNotification]]: ...
    def get_history_with_id(self, application_id: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[ToastNotification]]: ...
...
class ToastNotificationManager_Static(type):
    ...
    def create_toast_notifier_with_id(cls, application_id: str, /) -> typing.Optional[ToastNotifier]: ...
    def get_default(cls) -> typing.Optional[ToastNotificationManagerForUser]: ...
    def get_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[ToastNotificationManagerForUser]: ...
    def get_template_content(cls, type: ToastTemplateType, /) -> typing.Optional[windows_data_xml_dom.XmlDocument]: ...
    @_property
...
class ToastNotificationManagerForUser(winrt.system.Object):
    ...
    def create_toast_notifier_with_id(self, application_id: str, /) -> typing.Optional[ToastNotifier]: ...
    ...
    def get_toast_collection_manager_with_app_id(self, app_id: str, /) -> typing.Optional[ToastCollectionManager]: ...
...
class ToastNotifier(winrt.system.Object):
    ...
    def get_scheduled_toast_notifications(self) -> typing.Optional[windows_foundation_collections.IVectorView[ScheduledToastNotification]]: ...
    ...
    def update_with_tag(self, data: typing.Optional[NotificationData], tag: str, /) -> NotificationUpdateResult: ...
    def update_with_tag_and_group(self, data: typing.Optional[NotificationData], tag: str, group: str, /) -> NotificationUpdateResult: ...
