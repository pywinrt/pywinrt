...
class WalletBarcode(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[WalletBarcode], stream_to_barcode_image: windows_storage_streams.IRandomAccessStreamReference) -> WalletBarcode: ...
...
class WalletItem(winrt.system.Object):
    ...
    @_property
    def display_properties(self) -> windows_foundation_collections.IMap[str, WalletItemCustomProperty]: ...
    @_property
    def id(self) -> str: ...
    @_property
    def relevant_locations(self) -> windows_foundation_collections.IMap[str, WalletRelevantLocation]: ...
    @_property
    def transaction_history(self) -> windows_foundation_collections.IMap[str, WalletTransaction]: ...
    @_property
    def verbs(self) -> windows_foundation_collections.IMap[str, WalletVerb]: ...
...
class WalletItemStore(winrt.system.Object):
    ...
    def get_items_with_kind_async(self, kind: WalletItemKind, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[WalletItem]]: ...
