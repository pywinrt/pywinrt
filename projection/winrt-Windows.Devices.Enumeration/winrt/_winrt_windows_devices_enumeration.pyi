...
class DeviceInformation_Static(type):
    ...
    def create_from_id_async_with_additional_properties_kind_and_settings(cls, device_id: str, additional_properties: typing.Iterable[str], kind: DeviceInformationKind, settings: typing.Optional[IDeviceEnumerationSettings], /) -> windows_foundation.IAsyncOperation[DeviceInformation]: ...
    ...
    def create_watcher_aqs_filter(cls, aqs_filter: str, /) -> typing.Optional[DeviceWatcher]: ...
    def create_watcher_aqs_filter_and_additional_properties(cls, aqs_filter: str, additional_properties: typing.Iterable[str], /) -> typing.Optional[DeviceWatcher]: ...
    def create_watcher_device_class(cls, device_class: DeviceClass, /) -> typing.Optional[DeviceWatcher]: ...
    def create_watcher_with_aqs_filter_additional_properties_kind_and_settings(cls, aqs_filter: str, additional_properties: typing.Iterable[str], kind: DeviceInformationKind, settings: typing.Optional[IDeviceEnumerationSettings], /) -> typing.Optional[DeviceWatcher]: ...
    def create_watcher_with_kind_aqs_filter_and_additional_properties(cls, aqs_filter: str, additional_properties: typing.Iterable[str], kind: DeviceInformationKind, /) -> typing.Optional[DeviceWatcher]: ...
    ...
    def find_all_async_with_aqs_filter_additional_properties_kind_and_settings(cls, aqs_filter: str, additional_properties: typing.Iterable[str], kind: DeviceInformationKind, settings: typing.Optional[IDeviceEnumerationSettings], /) -> windows_foundation.IAsyncOperation[DeviceInformationCollection]: ...
...
class DeviceInformationCustomPairing(winrt.system.Object):
    ...
    def add_pairing_set_member(self, device: typing.Optional[DeviceInformation], /) -> None: ...
    def pair_async(self, pairing_kinds_supported: DevicePairingKinds, /) -> windows_foundation.IAsyncOperation[DevicePairingResult]: ...
    def pair_with_protection_level_and_settings_async(self, pairing_kinds_supported: DevicePairingKinds, min_protection_level: DevicePairingProtectionLevel, device_pairing_settings: typing.Optional[IDevicePairingSettings], /) -> windows_foundation.IAsyncOperation[DevicePairingResult]: ...
...
class DeviceInformationPairing(winrt.system.Object, metaclass=DeviceInformationPairing_Static):
    ...
    def pair_with_protection_level_and_settings_async(self, min_protection_level: DevicePairingProtectionLevel, device_pairing_settings: typing.Optional[IDevicePairingSettings], /) -> windows_foundation.IAsyncOperation[DevicePairingResult]: ...
...
class DevicePairingSetMembersRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def pairing_set_members(self) -> typing.Optional[windows_foundation_collections.IVectorView[DeviceInformation]]: ...
    @_property
    def parent_device_information(self) -> typing.Optional[DeviceInformation]: ...
    @_property
