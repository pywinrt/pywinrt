...
class DevicePairingSetMembersRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def pairing_set_members(self) -> windows_foundation_collections.IVectorView[DeviceInformation]: ...
    @_property
...
class DevicePicker(winrt.system.Object):
    ...
    @_property
    def requested_properties(self) -> windows_foundation_collections.IVector[str]: ...
...
class DevicePickerFilter(winrt.system.Object):
    ...
    @_property
    def supported_device_classes(self) -> windows_foundation_collections.IVector[DeviceClass]: ...
    @_property
    def supported_device_selectors(self) -> windows_foundation_collections.IVector[str]: ...
...
class DeviceWatcherTriggerDetails(winrt.system.Object):
    ...
    @_property
    def device_watcher_events(self) -> windows_foundation_collections.IVectorView[DeviceWatcherEvent]: ...
