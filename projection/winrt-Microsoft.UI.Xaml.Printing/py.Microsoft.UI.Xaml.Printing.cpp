...
namespace py::cpp::Microsoft::UI::Xaml::Printing
{
    ...
    struct PyWinrtPrintDocument : py::py_obj_ref, winrt::Microsoft::UI::Xaml::Printing::PrintDocumentT<PyWinrtPrintDocument>
    {
        PyWinrtPrintDocument(PyObject* py_obj) : py::py_obj_ref(py_obj), winrt::Microsoft::UI::Xaml::Printing::PrintDocumentT<PyWinrtPrintDocument>() {}
        ...
        if (arg_count == 0)
        {
            try
            {
                if (type != self_type)
                {
                    ...
                    std::construct_at(&reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Printing::PrintDocument*>(self.get())->obj, nullptr);
                    reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Printing::PrintDocument*>(self.get())->obj = winrt::make<PyWinrtPrintDocument>(self.get());
    ...
    static PyObject* PrintDocument_get_DocumentSource(py::wrapper::Microsoft::UI::Xaml::Printing::PrintDocument* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            return py::convert(self->obj.try_as<winrt::Microsoft::UI::Xaml::Printing::PrintDocument>().DocumentSource());
        }
        catch (...)
        {
            py::to_PyErr();
    ...
    static PyObject* PrintDocument_add_AddPages(py::wrapper::Microsoft::UI::Xaml::Printing::PrintDocument* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            return py::convert(self->obj.try_as<winrt::Microsoft::UI::Xaml::Printing::PrintDocument>().AddPages(param0));
        }
        catch (...)
        {
            py::to_PyErr();
    ...
    static PyObject* PrintDocument_add_GetPreviewPage(py::wrapper::Microsoft::UI::Xaml::Printing::PrintDocument* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            return py::convert(self->obj.try_as<winrt::Microsoft::UI::Xaml::Printing::PrintDocument>().GetPreviewPage(param0));
        }
        catch (...)
        {
            py::to_PyErr();
    ...
    static PyObject* PrintDocument_add_Paginate(py::wrapper::Microsoft::UI::Xaml::Printing::PrintDocument* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            return py::convert(self->obj.try_as<winrt::Microsoft::UI::Xaml::Printing::PrintDocument>().Paginate(param0));
        }
        catch (...)
        {
            py::to_PyErr();
