...
class GlobalizationPreferences_Static(type):
    ...
    @_property
    def calendars(cls) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def clocks(cls) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def currencies(cls) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
...
class GlobalizationPreferencesForUser(winrt.system.Object):
    ...
    @_property
    def calendars(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def clocks(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def currencies(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
