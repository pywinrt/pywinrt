...
@typing.final
class Direct3D11CaptureFrame(winrt.system.Object, windows_foundation.ImplementsIClosable):
...
class Direct3D11CaptureFramePool_Static(type):
    ...
    def create(cls, device: windows_graphics_directx_direct3d11.ImplementsIDirect3DDevice, pixel_format: windows_graphics_directx.DirectXPixelFormat, number_of_buffers: winrt.system.Int32, size: windows_graphics.SizeInt32, /) -> Direct3D11CaptureFramePool: ...
    ...
    def create_free_threaded(cls, device: windows_graphics_directx_direct3d11.ImplementsIDirect3DDevice, pixel_format: windows_graphics_directx.DirectXPixelFormat, number_of_buffers: winrt.system.Int32, size: windows_graphics.SizeInt32, /) -> Direct3D11CaptureFramePool: ...

@typing.final
class Direct3D11CaptureFramePool(winrt.system.Object, windows_foundation.ImplementsIClosable, metaclass=Direct3D11CaptureFramePool_Static):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]], exc_value: typing.Optional[BaseException], traceback: typing.Optional[types.TracebackType]) -> None: ...
    ...
    def recreate(self, device: windows_graphics_directx_direct3d11.ImplementsIDirect3DDevice, pixel_format: windows_graphics_directx.DirectXPixelFormat, number_of_buffers: winrt.system.Int32, size: windows_graphics.SizeInt32, /) -> None: ...
...
class GraphicsCaptureItem_Static(type):
    ...
    def try_create_from_display_id(cls, display_id: windows_graphics.DisplayId, /) -> GraphicsCaptureItem: ...
    ...
    def try_create_from_window_id(cls, window_id: windows_ui.WindowId, /) -> GraphicsCaptureItem: ...
...
@typing.final
class GraphicsCaptureSession(winrt.system.Object, windows_foundation.ImplementsIClosable, metaclass=GraphicsCaptureSession_Static):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]], exc_value: typing.Optional[BaseException], traceback: typing.Optional[types.TracebackType]) -> None: ...
