...
class MediaExtensionManager(winrt.system.Object):
    ...
    def register_audio_decoder_with_settings(self, activatable_class_id: str, input_subtype: _uuid.UUID, output_subtype: _uuid.UUID, configuration: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
    def register_audio_encoder(self, activatable_class_id: str, input_subtype: _uuid.UUID, output_subtype: _uuid.UUID, /) -> None: ...
    def register_audio_encoder_with_settings(self, activatable_class_id: str, input_subtype: _uuid.UUID, output_subtype: _uuid.UUID, configuration: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
    def register_byte_stream_handler(self, activatable_class_id: str, file_extension: str, mime_type: str, /) -> None: ...
    def register_byte_stream_handler_with_settings(self, activatable_class_id: str, file_extension: str, mime_type: str, configuration: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
    ...
    def register_scheme_handler_with_settings(self, activatable_class_id: str, scheme: str, configuration: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
    def register_video_decoder(self, activatable_class_id: str, input_subtype: _uuid.UUID, output_subtype: _uuid.UUID, /) -> None: ...
    def register_video_decoder_with_settings(self, activatable_class_id: str, input_subtype: _uuid.UUID, output_subtype: _uuid.UUID, configuration: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
    def register_video_encoder(self, activatable_class_id: str, input_subtype: _uuid.UUID, output_subtype: _uuid.UUID, /) -> None: ...
    def register_video_encoder_with_settings(self, activatable_class_id: str, input_subtype: _uuid.UUID, output_subtype: _uuid.UUID, configuration: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
...
class VideoFrame_Static(type):
    ...
    def create_as_direct3_d11_surface_backed_with_device(cls, format: windows_graphics_directx.DirectXPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32, device: typing.Optional[windows_graphics_directx_direct3d11.IDirect3DDevice], /) -> typing.Optional[VideoFrame]: ...
...
class VideoFrame(winrt.system.Object, metaclass=VideoFrame_Static):
    ...
    def copy_to_with_bounds_async(self, frame: typing.Optional[VideoFrame], source_bounds: typing.Optional[windows_graphics_imaging.BitmapBounds], destination_bounds: typing.Optional[windows_graphics_imaging.BitmapBounds], /) -> windows_foundation.IAsyncAction: ...
    @_property
    def system_relative_time(self) -> typing.Optional[typing.Optional[datetime.timedelta]]: ...
    @system_relative_time.setter
    def system_relative_time(self, value: typing.Optional[typing.Optional[datetime.timedelta]]) -> None: ...
