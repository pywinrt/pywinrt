...
class MusicDisplayProperties(winrt.system.Object):
    ...
    @_property
    def genres(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
...
class VideoFrame_Static(type):
    def create_as_direct3_d11_surface_backed(cls, format: windows_graphics_directx.DirectXPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32, /) -> VideoFrame: ...
    def create_as_direct3_d11_surface_backed_with_device(cls, format: windows_graphics_directx.DirectXPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32, device: windows_graphics_directx_direct3d11.IDirect3DDevice, /) -> VideoFrame: ...
    def create_with_direct3_d11_surface(cls, surface: windows_graphics_directx_direct3d11.IDirect3DSurface, /) -> VideoFrame: ...
...
class VideoFrame(winrt.system.Object, metaclass=VideoFrame_Static):
    ...
    def type(self) -> str: ...
    @_property
    def direct3_d_surface(self) -> windows_graphics_directx_direct3d11.IDirect3DSurface: ...
    @_property
...
class IMediaMarkers(winrt.system.Object):
    ...
    @_property
    def markers(self) -> windows_foundation_collections.IVectorView[IMediaMarker]: ...
