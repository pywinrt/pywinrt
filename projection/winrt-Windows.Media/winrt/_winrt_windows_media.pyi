...
@typing.final
class AudioBuffer(winrt.system.Object, windows_foundation.ImplementsIMemoryBuffer, windows_foundation.ImplementsIClosable):
...
@typing.final
class AudioFrame(winrt.system.Object, ImplementsIMediaFrame, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]], exc_value: typing.Optional[BaseException], traceback: typing.Optional[types.TracebackType]) -> None: ...
...
class MediaExtensionManager(winrt.system.Object):
    ...
    def register_audio_decoder_with_settings(self, activatable_class_id: str, input_subtype: _uuid.UUID, output_subtype: _uuid.UUID, configuration: windows_foundation_collections.ImplementsIPropertySet, /) -> None: ...
    ...
    def register_audio_encoder_with_settings(self, activatable_class_id: str, input_subtype: _uuid.UUID, output_subtype: _uuid.UUID, configuration: windows_foundation_collections.ImplementsIPropertySet, /) -> None: ...
    ...
    def register_byte_stream_handler_with_settings(self, activatable_class_id: str, file_extension: str, mime_type: str, configuration: windows_foundation_collections.ImplementsIPropertySet, /) -> None: ...
    ...
    def register_media_extension_for_app_service(self, extension: ImplementsIMediaExtension, connection: windows_applicationmodel_appservice.AppServiceConnection, /) -> None: ...
    ...
    def register_scheme_handler_with_settings(self, activatable_class_id: str, scheme: str, configuration: windows_foundation_collections.ImplementsIPropertySet, /) -> None: ...
    ...
    def register_video_decoder_with_settings(self, activatable_class_id: str, input_subtype: _uuid.UUID, output_subtype: _uuid.UUID, configuration: windows_foundation_collections.ImplementsIPropertySet, /) -> None: ...
    ...
    def register_video_encoder_with_settings(self, activatable_class_id: str, input_subtype: _uuid.UUID, output_subtype: _uuid.UUID, configuration: windows_foundation_collections.ImplementsIPropertySet, /) -> None: ...
...
class VideoFrame_Static(type):
    ...
    def create_as_direct3d11_surface_backed_with_device(cls, format: windows_graphics_directx.DirectXPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32, device: windows_graphics_directx_direct3d11.ImplementsIDirect3DDevice, /) -> VideoFrame: ...
    ...
    def create_with_direct3d11_surface(cls, surface: windows_graphics_directx_direct3d11.ImplementsIDirect3DSurface, /) -> VideoFrame: ...
...
@typing.final
class VideoFrame(winrt.system.Object, ImplementsIMediaFrame, windows_foundation.ImplementsIClosable, metaclass=VideoFrame_Static):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]], exc_value: typing.Optional[BaseException], traceback: typing.Optional[types.TracebackType]) -> None: ...
    @typing.overload
