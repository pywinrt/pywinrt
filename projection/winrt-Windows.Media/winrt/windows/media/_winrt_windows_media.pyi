...
from . import AudioBufferAccessMode, AudioProcessing, MediaPlaybackAutoRepeatMode, MediaPlaybackStatus, MediaPlaybackType, MediaTimelineControllerState, SoundLevel, SystemMediaTransportControlsButton, SystemMediaTransportControlsProperty
...
class MediaExtensionManager(winrt.system.Object):
    ...
    @typing.overload
    def register_audio_decoder(self, activatable_class_id: str, input_subtype: uuid.UUID, output_subtype: uuid.UUID, configuration: typing.Optional[winrt.windows.foundation.collections.IPropertySet], /) -> None: ...
    @typing.overload
    def register_audio_encoder(self, activatable_class_id: str, input_subtype: uuid.UUID, output_subtype: uuid.UUID, /) -> None: ...
    @typing.overload
    def register_audio_encoder(self, activatable_class_id: str, input_subtype: uuid.UUID, output_subtype: uuid.UUID, configuration: typing.Optional[winrt.windows.foundation.collections.IPropertySet], /) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def register_video_decoder(self, activatable_class_id: str, input_subtype: uuid.UUID, output_subtype: uuid.UUID, configuration: typing.Optional[winrt.windows.foundation.collections.IPropertySet], /) -> None: ...
    @typing.overload
    def register_video_encoder(self, activatable_class_id: str, input_subtype: uuid.UUID, output_subtype: uuid.UUID, /) -> None: ...
    @typing.overload
    def register_video_encoder(self, activatable_class_id: str, input_subtype: uuid.UUID, output_subtype: uuid.UUID, configuration: typing.Optional[winrt.windows.foundation.collections.IPropertySet], /) -> None: ...
