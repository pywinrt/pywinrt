...
PyMODINIT_FUNC PyInit__winrt_windows_ui_xaml_media_imaging(void) noexcept
{
    ...
    py::pyobj_handle BitmapImage_type{py::register_python_type(module.get(), &type_spec_BitmapImage, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_BitmapImage_Static.get()))};
    if (!BitmapImage_type)
    {
        return nullptr;
    }
    ...
    py::pyobj_handle DownloadProgressEventArgs_type{py::register_python_type(module.get(), &type_spec_DownloadProgressEventArgs, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle RenderTargetBitmap_type{py::register_python_type(module.get(), &type_spec_RenderTargetBitmap, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_RenderTargetBitmap_Static.get()))};
    if (!RenderTargetBitmap_type)
    {
        return nullptr;
    }

    py::pyobj_handle SoftwareBitmapSource_type{py::register_python_type(module.get(), &type_spec_SoftwareBitmapSource, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle SvgImageSource_type{py::register_python_type(module.get(), &type_spec_SvgImageSource, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_SvgImageSource_Static.get()))};
    if (!SvgImageSource_type)
    {
        return nullptr;
    }

    py::pyobj_handle SvgImageSourceFailedEventArgs_type{py::register_python_type(module.get(), &type_spec_SvgImageSourceFailedEventArgs, object_bases.get(), nullptr)};
    if (!SvgImageSourceFailedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle SvgImageSourceOpenedEventArgs_type{py::register_python_type(module.get(), &type_spec_SvgImageSourceOpenedEventArgs, object_bases.get(), nullptr)};
    if (!SvgImageSourceOpenedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle VirtualSurfaceImageSource_type{py::register_python_type(module.get(), &type_spec_VirtualSurfaceImageSource, object_bases.get(), nullptr)};
    if (!VirtualSurfaceImageSource_type)
    {
        return nullptr;
    }

    py::pyobj_handle WriteableBitmap_type{py::register_python_type(module.get(), &type_spec_WriteableBitmap, object_bases.get(), nullptr)};
