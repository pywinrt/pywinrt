...
class BitmapImage_Static(type):
    @_property
    def create_options_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def decode_pixel_height_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def decode_pixel_width_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def uri_source_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def decode_pixel_type_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def auto_play_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def is_animated_bitmap_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def is_playing_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class BitmapSource_Static(type):
    @_property
    def pixel_height_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def pixel_width_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class RenderTargetBitmap(winrt.system.Object, metaclass=RenderTargetBitmap_Static):
    ...
    def read_local_value(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], /) -> typing.Optional[winrt.system.Object]: ...
    def register_property_changed_callback(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], callback: typing.Optional[windows_ui_xaml.DependencyPropertyChangedCallback], /) -> winrt.system.Int64: ...
    def render_async(self, element: typing.Optional[windows_ui_xaml.UIElement], /) -> windows_foundation.IAsyncAction: ...
    def render_to_size_async(self, element: typing.Optional[windows_ui_xaml.UIElement], scaled_width: winrt.system.Int32, scaled_height: winrt.system.Int32, /) -> windows_foundation.IAsyncAction: ...
    def set_value(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], value: typing.Optional[winrt.system.Object], /) -> None: ...
    def unregister_property_changed_callback(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], token: winrt.system.Int64, /) -> None: ...
    @_property
    def pixel_height(self) -> winrt.system.Int32: ...
...
class SvgImageSource_Static(type):
    @_property
    def rasterize_pixel_height_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def rasterize_pixel_width_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def uri_source_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
