...
class RenderTargetBitmap(winrt.system.Object, metaclass=RenderTargetBitmap_Static):
    ...
    @typing.overload
    def render_async(self, element: typing.Optional[windows_ui_xaml.UIElement], scaled_width: winrt.system.Int32, scaled_height: winrt.system.Int32, /) -> windows_foundation.IAsyncAction: ...
    def set_value(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], value: typing.Optional[winrt.system.Object], /) -> None: ...
    def unregister_property_changed_callback(self, dp: typing.Optional[windows_ui_xaml.DependencyProperty], token: winrt.system.Int64, /) -> None: ...
    @_property
    def pixel_height(self) -> winrt.system.Int32: ...
