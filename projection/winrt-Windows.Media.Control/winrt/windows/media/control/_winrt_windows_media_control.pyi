...
class GlobalSystemMediaTransportControlsSession(winrt.system.Object):
    ...
    def try_change_auto_repeat_mode_async(self, requested_auto_repeat_mode: winrt.windows.media.MediaPlaybackAutoRepeatMode, /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_change_channel_down_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_change_channel_up_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_change_playback_position_async(self, requested_playback_position: winrt.system.Int64, /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_change_playback_rate_async(self, requested_playback_rate: winrt.system.Double, /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_change_shuffle_active_async(self, requested_shuffle_state: winrt.system.Boolean, /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_fast_forward_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    ...
    def try_pause_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_play_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_record_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_rewind_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_skip_next_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_skip_previous_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_stop_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_toggle_play_pause_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
...
class GlobalSystemMediaTransportControlsSessionPlaybackControls(winrt.system.Object):
    ...
    is_play_pause_toggle_enabled: winrt.system.Boolean
    is_playback_position_enabled: winrt.system.Boolean
    ...
    is_shuffle_enabled: winrt.system.Boolean
...
class GlobalSystemMediaTransportControlsSessionPlaybackInfo(winrt.system.Object):
    ...
    is_shuffle_active: typing.Optional[typing.Optional[winrt.system.Boolean]]
