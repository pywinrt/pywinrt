...
namespace py::cpp::Windows::UI::Xaml::Shapes
{
    ...
    struct PyWinrtPath : winrt::Windows::UI::Xaml::Shapes::PathT<PyWinrtPath>
    {
        PyWinrtPath() : winrt::Windows::UI::Xaml::Shapes::PathT<PyWinrtPath>() {}
    };
        ...
        if (arg_count == 0)
        {
            try
            {
                if (type != self_type)
                {
                    ...
                    auto self = reinterpret_cast<py::wrapper::Windows::UI::Xaml::Shapes::Path*>(type->tp_alloc(type, 0));
                    if (!self)
                    {
                        return nullptr;
                    }
    ...
    struct PyWinrtShape : winrt::Windows::UI::Xaml::Shapes::ShapeT<PyWinrtShape>
    {
    };
