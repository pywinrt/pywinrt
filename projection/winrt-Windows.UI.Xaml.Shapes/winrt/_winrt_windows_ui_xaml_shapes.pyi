...
class Line_Static(type):
    ...
    @_property
    def x2_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
    def y1_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
...
class Polygon(winrt.system.Object, metaclass=Polygon_Static):
    ...
    @_property
    def points(self) -> typing.Optional[winrt.windows.ui.xaml.media.PointCollection]: ...
    @points.setter
    def points(self, value: typing.Optional[winrt.windows.ui.xaml.media.PointCollection]) -> None: ...
    @_property
    def fill_rule(self) -> winrt.windows.ui.xaml.media.FillRule: ...
    @fill_rule.setter
...
class Shape_Static(type):
    ...
    @_property
    def stroke_dash_array_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
    def stroke_dash_cap_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
    def stroke_dash_offset_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
    def stroke_end_line_cap_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
    def stroke_line_join_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
    def stroke_miter_limit_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
    def stroke_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
    def stroke_start_line_cap_property(cls) -> typing.Optional[winrt.windows.ui.xaml.DependencyProperty]: ...
    @_property
...
class Shape(winrt.system.Object, metaclass=Shape_Static):
    ...
    @_property
    def stroke_start_line_cap(self) -> winrt.windows.ui.xaml.media.PenLineCap: ...
    @stroke_start_line_cap.setter
    def stroke_start_line_cap(self, value: winrt.windows.ui.xaml.media.PenLineCap) -> None: ...
    @_property
    ...
    @_property
    def stroke_line_join(self) -> winrt.windows.ui.xaml.media.PenLineJoin: ...
    @stroke_line_join.setter
    def stroke_line_join(self, value: winrt.windows.ui.xaml.media.PenLineJoin) -> None: ...
    @_property
    def stroke_end_line_cap(self) -> winrt.windows.ui.xaml.media.PenLineCap: ...
    @stroke_end_line_cap.setter
    def stroke_end_line_cap(self, value: winrt.windows.ui.xaml.media.PenLineCap) -> None: ...
    @_property
    ...
    @_property
    def stroke_dash_cap(self) -> winrt.windows.ui.xaml.media.PenLineCap: ...
    @stroke_dash_cap.setter
    def stroke_dash_cap(self, value: winrt.windows.ui.xaml.media.PenLineCap) -> None: ...
    @_property
    def stroke_dash_array(self) -> typing.Optional[winrt.windows.ui.xaml.media.DoubleCollection]: ...
    @stroke_dash_array.setter
    def stroke_dash_array(self, value: typing.Optional[winrt.windows.ui.xaml.media.DoubleCollection]) -> None: ...
    @_property
    def stroke(self) -> typing.Optional[winrt.windows.ui.xaml.media.Brush]: ...
    @stroke.setter
    def stroke(self, value: typing.Optional[winrt.windows.ui.xaml.media.Brush]) -> None: ...
    @_property
    ...
    @_property
    def geometry_transform(self) -> typing.Optional[winrt.windows.ui.xaml.media.Transform]: ...
