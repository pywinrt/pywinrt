...
class AtomPubClient(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[AtomPubClient], server_credential: windows_security_credentials.PasswordCredential) -> AtomPubClient: ...
    @typing.overload
...
class ResourceCollection(winrt.system.Object):
    ...
    @_property
    def accepts(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def categories(self) -> windows_foundation_collections.IVectorView[windows_web_syndication.SyndicationCategory]: ...
    @_property
    ...
    @_property
    def attribute_extensions(self) -> windows_foundation_collections.IVector[windows_web_syndication.SyndicationAttribute]: ...
    @_property
    def element_extensions(self) -> windows_foundation_collections.IVector[windows_web_syndication.ISyndicationNode]: ...
...
class ServiceDocument(winrt.system.Object):
    ...
    def get_xml_document(self, format: windows_web_syndication.SyndicationFormat, /) -> windows_data_xml_dom.XmlDocument: ...
    @_property
    def workspaces(self) -> windows_foundation_collections.IVectorView[Workspace]: ...
    @_property
    def node_value(self) -> str: ...
    @node_value.setter
    def node_value(self, value: str) -> None: ...
...
class Workspace(winrt.system.Object):
    ...
    def get_xml_document(self, format: windows_web_syndication.SyndicationFormat, /) -> windows_data_xml_dom.XmlDocument: ...
    @_property
    def collections(self) -> windows_foundation_collections.IVectorView[ResourceCollection]: ...
    @_property
    def title(self) -> windows_web_syndication.ISyndicationText: ...
    @_property
    def node_value(self) -> str: ...
