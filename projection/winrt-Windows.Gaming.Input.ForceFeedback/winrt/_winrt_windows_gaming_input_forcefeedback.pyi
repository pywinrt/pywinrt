...
class ForceFeedbackMotor(winrt.system.Object):
    ...
    def load_effect_async(self, effect: typing.Optional[IForceFeedbackEffect], /) -> windows_foundation.IAsyncOperation[ForceFeedbackLoadEffectResult]: ...
    ...
    def try_unload_effect_async(self, effect: typing.Optional[IForceFeedbackEffect], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @_property
