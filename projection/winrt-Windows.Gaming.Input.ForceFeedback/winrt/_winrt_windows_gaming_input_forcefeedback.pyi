...
@typing.final
class ConditionForceEffect(winrt.system.Object, ImplementsIForceFeedbackEffect):
    @staticmethod
    ...
    def set_parameters(self, direction: windows_foundation_numerics.Vector3, positive_coefficient: winrt.system.Single, negative_coefficient: winrt.system.Single, max_positive_magnitude: winrt.system.Single, max_negative_magnitude: winrt.system.Single, dead_zone: winrt.system.Single, bias: winrt.system.Single, /) -> None: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
    @_property
...
class ForceFeedbackMotor(winrt.system.Object):
    ...
    def load_effect_async(self, effect: ImplementsIForceFeedbackEffect, /) -> windows_foundation.IAsyncOperation[ForceFeedbackLoadEffectResult]: ...
    ...
    def try_unload_effect_async(self, effect: ImplementsIForceFeedbackEffect, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @_property
...
@typing.final
class PeriodicForceEffect(winrt.system.Object, ImplementsIForceFeedbackEffect):
    @staticmethod
    ...
    def set_parameters(self, vector: windows_foundation_numerics.Vector3, frequency: winrt.system.Single, phase: winrt.system.Single, bias: winrt.system.Single, duration: datetime.timedelta, /) -> None: ...
    def set_parameters_with_envelope(self, vector: windows_foundation_numerics.Vector3, frequency: winrt.system.Single, phase: winrt.system.Single, bias: winrt.system.Single, attack_gain: winrt.system.Single, sustain_gain: winrt.system.Single, release_gain: winrt.system.Single, start_delay: datetime.timedelta, attack_duration: datetime.timedelta, sustain_duration: datetime.timedelta, release_duration: datetime.timedelta, repeat_count: winrt.system.UInt32, /) -> None: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
    @_property
    def gain(self) -> winrt.system.Double: ...
...
@typing.final
class RampForceEffect(winrt.system.Object, ImplementsIForceFeedbackEffect):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> RampForceEffect: ...
    def __new__(cls: typing.Type[Self]) -> Self: ...
    def set_parameters(self, start_vector: windows_foundation_numerics.Vector3, end_vector: windows_foundation_numerics.Vector3, duration: datetime.timedelta, /) -> None: ...
    def set_parameters_with_envelope(self, start_vector: windows_foundation_numerics.Vector3, end_vector: windows_foundation_numerics.Vector3, attack_gain: winrt.system.Single, sustain_gain: winrt.system.Single, release_gain: winrt.system.Single, start_delay: datetime.timedelta, attack_duration: datetime.timedelta, sustain_duration: datetime.timedelta, release_duration: datetime.timedelta, repeat_count: winrt.system.UInt32, /) -> None: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
    @_property
    def gain(self) -> winrt.system.Double: ...
