...
PyMODINIT_FUNC PyInit__winrt_windows_ui_accessibility(void) noexcept
{
    ...
    py::pyobj_handle ScreenReaderPositionChangedEventArgs_type{py::register_python_type(module.get(), &type_spec_ScreenReaderPositionChangedEventArgs, object_bases.get(), nullptr)};
    if (!ScreenReaderPositionChangedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle ScreenReaderService_type{py::register_python_type(module.get(), &type_spec_ScreenReaderService, object_bases.get(), nullptr)};
