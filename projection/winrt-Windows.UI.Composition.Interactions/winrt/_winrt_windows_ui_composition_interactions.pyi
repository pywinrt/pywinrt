...
class CompositionConditionalValue(winrt.system.Object, metaclass=CompositionConditionalValue_Static):
    ...
    def start_animation_with_controller(self, property_name: str, animation: typing.Optional[windows_ui_composition.CompositionAnimation], animation_controller: typing.Optional[windows_ui_composition.AnimationController], /) -> None: ...
