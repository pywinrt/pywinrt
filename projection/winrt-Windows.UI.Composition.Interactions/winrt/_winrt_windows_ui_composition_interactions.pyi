...
class CompositionConditionalValue_Static(type):
    def create(cls, compositor: typing.Optional[windows_ui_composition.Compositor], /) -> typing.Optional[CompositionConditionalValue]: ...
...
class CompositionConditionalValue(winrt.system.Object, metaclass=CompositionConditionalValue_Static):
    ...
    @_property
    def value(self) -> typing.Optional[windows_ui_composition.ExpressionAnimation]: ...
    @value.setter
    def value(self, value: typing.Optional[windows_ui_composition.ExpressionAnimation]) -> None: ...
    @_property
    def condition(self) -> typing.Optional[windows_ui_composition.ExpressionAnimation]: ...
    @condition.setter
    def condition(self, value: typing.Optional[windows_ui_composition.ExpressionAnimation]) -> None: ...
    @_property
...
class InteractionTracker_Static(type):
    def create(cls, compositor: typing.Optional[windows_ui_composition.Compositor], /) -> typing.Optional[InteractionTracker]: ...
    def create_with_owner(cls, compositor: typing.Optional[windows_ui_composition.Compositor], owner: typing.Optional[IInteractionTrackerOwner], /) -> typing.Optional[InteractionTracker]: ...
...
class InteractionTracker(winrt.system.Object, metaclass=InteractionTracker_Static):
    ...
    def try_update_position_with_animation(self, animation: typing.Optional[windows_ui_composition.CompositionAnimation], /) -> winrt.system.Int32: ...
    ...
    def try_update_scale_with_animation(self, animation: typing.Optional[windows_ui_composition.CompositionAnimation], center_point: windows_foundation_numerics.Vector3, /) -> winrt.system.Int32: ...
    @_property
...
class InteractionTrackerInertiaMotion_Static(type):
    def create(cls, compositor: typing.Optional[windows_ui_composition.Compositor], /) -> typing.Optional[InteractionTrackerInertiaMotion]: ...
...
class InteractionTrackerInertiaMotion(winrt.system.Object, metaclass=InteractionTrackerInertiaMotion_Static):
    ...
    def try_get_animation_controller(self, property_name: str, /) -> typing.Optional[windows_ui_composition.AnimationController]: ...
    @_property
    def motion(self) -> typing.Optional[windows_ui_composition.ExpressionAnimation]: ...
    @motion.setter
    def motion(self, value: typing.Optional[windows_ui_composition.ExpressionAnimation]) -> None: ...
    @_property
    def condition(self) -> typing.Optional[windows_ui_composition.ExpressionAnimation]: ...
    @condition.setter
    def condition(self, value: typing.Optional[windows_ui_composition.ExpressionAnimation]) -> None: ...
...
class InteractionTrackerInertiaNaturalMotion_Static(type):
    def create(cls, compositor: typing.Optional[windows_ui_composition.Compositor], /) -> typing.Optional[InteractionTrackerInertiaNaturalMotion]: ...
...
class InteractionTrackerInertiaNaturalMotion(winrt.system.Object, metaclass=InteractionTrackerInertiaNaturalMotion_Static):
    ...
    def try_get_animation_controller(self, property_name: str, /) -> typing.Optional[windows_ui_composition.AnimationController]: ...
    @_property
    def natural_motion(self) -> typing.Optional[windows_ui_composition.ScalarNaturalMotionAnimation]: ...
    @natural_motion.setter
    def natural_motion(self, value: typing.Optional[windows_ui_composition.ScalarNaturalMotionAnimation]) -> None: ...
    @_property
    def condition(self) -> typing.Optional[windows_ui_composition.ExpressionAnimation]: ...
    @condition.setter
    def condition(self, value: typing.Optional[windows_ui_composition.ExpressionAnimation]) -> None: ...
...
class InteractionTrackerInertiaRestingValue_Static(type):
    def create(cls, compositor: typing.Optional[windows_ui_composition.Compositor], /) -> typing.Optional[InteractionTrackerInertiaRestingValue]: ...
...
class InteractionTrackerInertiaRestingValue(winrt.system.Object, metaclass=InteractionTrackerInertiaRestingValue_Static):
    ...
    def try_get_animation_controller(self, property_name: str, /) -> typing.Optional[windows_ui_composition.AnimationController]: ...
    @_property
    def resting_value(self) -> typing.Optional[windows_ui_composition.ExpressionAnimation]: ...
    @resting_value.setter
    def resting_value(self, value: typing.Optional[windows_ui_composition.ExpressionAnimation]) -> None: ...
    @_property
    def condition(self) -> typing.Optional[windows_ui_composition.ExpressionAnimation]: ...
    @condition.setter
    def condition(self, value: typing.Optional[windows_ui_composition.ExpressionAnimation]) -> None: ...
...
class InteractionTrackerVector2InertiaNaturalMotion_Static(type):
    def create(cls, compositor: typing.Optional[windows_ui_composition.Compositor], /) -> typing.Optional[InteractionTrackerVector2InertiaNaturalMotion]: ...
...
class InteractionTrackerVector2InertiaNaturalMotion(winrt.system.Object, metaclass=InteractionTrackerVector2InertiaNaturalMotion_Static):
    ...
    def try_get_animation_controller(self, property_name: str, /) -> typing.Optional[windows_ui_composition.AnimationController]: ...
    @_property
    def natural_motion(self) -> typing.Optional[windows_ui_composition.Vector2NaturalMotionAnimation]: ...
    @natural_motion.setter
    def natural_motion(self, value: typing.Optional[windows_ui_composition.Vector2NaturalMotionAnimation]) -> None: ...
    @_property
    def condition(self) -> typing.Optional[windows_ui_composition.ExpressionAnimation]: ...
    @condition.setter
    def condition(self, value: typing.Optional[windows_ui_composition.ExpressionAnimation]) -> None: ...
...
class VisualInteractionSource_Static(type):
    def create(cls, source: typing.Optional[windows_ui_composition.Visual], /) -> typing.Optional[VisualInteractionSource]: ...
    def create_from_i_visual_element(cls, source: typing.Optional[windows_ui_composition.IVisualElement], /) -> typing.Optional[VisualInteractionSource]: ...
...
class VisualInteractionSource(winrt.system.Object, metaclass=VisualInteractionSource_Static):
    ...
    def stop_animation_group(self, value: typing.Optional[windows_ui_composition.ICompositionAnimationBase], /) -> None: ...
    def try_get_animation_controller(self, property_name: str, /) -> typing.Optional[windows_ui_composition.AnimationController]: ...
    def try_redirect_for_manipulation(self, pointer_point: typing.Optional[windows_ui_input.PointerPoint], /) -> None: ...
    @_property
    ...
    @_property
    def source(self) -> typing.Optional[windows_ui_composition.Visual]: ...
    @_property
