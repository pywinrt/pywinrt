...
_ns_module = winrt.system._import_ns_module("Windows.Security.Authentication.Identity.Provider")
...
_ns_module._register_SecondaryAuthenticationFactorAuthenticationMessage(SecondaryAuthenticationFactorAuthenticationMessage)
_ns_module._register_SecondaryAuthenticationFactorAuthenticationScenario(SecondaryAuthenticationFactorAuthenticationScenario)
_ns_module._register_SecondaryAuthenticationFactorAuthenticationStage(SecondaryAuthenticationFactorAuthenticationStage)
_ns_module._register_SecondaryAuthenticationFactorAuthenticationStatus(SecondaryAuthenticationFactorAuthenticationStatus)
_ns_module._register_SecondaryAuthenticationFactorDeviceCapabilities(SecondaryAuthenticationFactorDeviceCapabilities)
_ns_module._register_SecondaryAuthenticationFactorDeviceFindScope(SecondaryAuthenticationFactorDeviceFindScope)
_ns_module._register_SecondaryAuthenticationFactorDevicePresence(SecondaryAuthenticationFactorDevicePresence)
_ns_module._register_SecondaryAuthenticationFactorDevicePresenceMonitoringMode(SecondaryAuthenticationFactorDevicePresenceMonitoringMode)
_ns_module._register_SecondaryAuthenticationFactorDevicePresenceMonitoringRegistrationStatus(SecondaryAuthenticationFactorDevicePresenceMonitoringRegistrationStatus)
_ns_module._register_SecondaryAuthenticationFactorFinishAuthenticationStatus(SecondaryAuthenticationFactorFinishAuthenticationStatus)
_ns_module._register_SecondaryAuthenticationFactorRegistrationStatus(SecondaryAuthenticationFactorRegistrationStatus)
