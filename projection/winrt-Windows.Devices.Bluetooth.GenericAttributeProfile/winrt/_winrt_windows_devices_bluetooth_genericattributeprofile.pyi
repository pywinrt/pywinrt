...
class GattCharacteristic(winrt.system.Object, metaclass=GattCharacteristic_Static):
    ...
    def write_value_with_option_async(self, value: typing.Optional[windows_storage_streams.IBuffer], write_option: GattWriteOption, /) -> windows_foundation.IAsyncOperation[GattCommunicationStatus]: ...
    def write_value_with_result_and_option_async(self, value: typing.Optional[windows_storage_streams.IBuffer], write_option: GattWriteOption, /) -> windows_foundation.IAsyncOperation[GattWriteResult]: ...
...
class GattDeviceService_Static(type):
    ...
    def get_device_selector_for_bluetooth_device_id_and_uuid_with_cache_mode(cls, bluetooth_device_id: typing.Optional[windows_devices_bluetooth.BluetoothDeviceId], service_uuid: _uuid.UUID, cache_mode: windows_devices_bluetooth.BluetoothCacheMode, /) -> str: ...
    def get_device_selector_for_bluetooth_device_id_with_cache_mode(cls, bluetooth_device_id: typing.Optional[windows_devices_bluetooth.BluetoothDeviceId], cache_mode: windows_devices_bluetooth.BluetoothCacheMode, /) -> str: ...
...
class GattLocalCharacteristic(winrt.system.Object):
    ...
    def notify_value_for_subscribed_client_async(self, value: typing.Optional[windows_storage_streams.IBuffer], subscribed_client: typing.Optional[GattSubscribedClient], /) -> windows_foundation.IAsyncOperation[GattClientNotificationResult]: ...
...
class GattServiceProvider(winrt.system.Object, metaclass=GattServiceProvider_Static):
    ...
    def start_advertising_with_parameters(self, parameters: typing.Optional[GattServiceProviderAdvertisingParameters], /) -> None: ...
