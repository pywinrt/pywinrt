...
class GattCharacteristic(winrt.system.Object, metaclass=GattCharacteristic_Static):
    ...
    def get_all_descriptors(self) -> windows_foundation_collections.IVectorView[GattDescriptor]: ...
    def get_descriptors(self, descriptor_uuid: _uuid.UUID, /) -> windows_foundation_collections.IVectorView[GattDescriptor]: ...
    ...
    @_property
    def presentation_formats(self) -> windows_foundation_collections.IVectorView[GattPresentationFormat]: ...
    @_property
...
class GattCharacteristicsResult(winrt.system.Object):
    ...
    @_property
    def characteristics(self) -> windows_foundation_collections.IVectorView[GattCharacteristic]: ...
    @_property
...
class GattDescriptorsResult(winrt.system.Object):
    ...
    @_property
    def descriptors(self) -> windows_foundation_collections.IVectorView[GattDescriptor]: ...
    @_property
    def protocol_error(self) -> typing.Optional[winrt.system.UInt8]: ...
    @_property
    def status(self) -> GattCommunicationStatus: ...
...
class GattDeviceService(winrt.system.Object, metaclass=GattDeviceService_Static):
    ...
    def close(self) -> None: ...
    def get_all_characteristics(self) -> windows_foundation_collections.IVectorView[GattCharacteristic]: ...
    def get_all_included_services(self) -> windows_foundation_collections.IVectorView[GattDeviceService]: ...
    def get_characteristics(self, characteristic_uuid: _uuid.UUID, /) -> windows_foundation_collections.IVectorView[GattCharacteristic]: ...
    ...
    def get_included_services(self, service_uuid: _uuid.UUID, /) -> windows_foundation_collections.IVectorView[GattDeviceService]: ...
    ...
    @_property
    def parent_services(self) -> windows_foundation_collections.IVectorView[GattDeviceService]: ...
    @_property
...
class GattDeviceServicesResult(winrt.system.Object):
    ...
    def protocol_error(self) -> typing.Optional[winrt.system.UInt8]: ...
    @_property
    def services(self) -> windows_foundation_collections.IVectorView[GattDeviceService]: ...
    @_property
    def status(self) -> GattCommunicationStatus: ...
...
class GattLocalCharacteristic(winrt.system.Object):
    ...
    def notify_value_async(self, value: windows_storage_streams.IBuffer, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[GattClientNotificationResult]]: ...
    ...
    def characteristic_properties(self) -> GattCharacteristicProperties: ...
    @_property
    def descriptors(self) -> windows_foundation_collections.IVectorView[GattLocalDescriptor]: ...
    @_property
    def presentation_formats(self) -> windows_foundation_collections.IVectorView[GattPresentationFormat]: ...
    @_property
    ...
    @_property
    def subscribed_clients(self) -> windows_foundation_collections.IVectorView[GattSubscribedClient]: ...
    @_property
    def user_description(self) -> str: ...
    @_property
    def uuid(self) -> _uuid.UUID: ...
...
class GattLocalCharacteristicParameters(winrt.system.Object):
    ...
    @_property
    def presentation_formats(self) -> windows_foundation_collections.IVector[GattPresentationFormat]: ...
...
class GattLocalService(winrt.system.Object):
    ...
    @_property
    def characteristics(self) -> windows_foundation_collections.IVectorView[GattLocalCharacteristic]: ...
    @_property
    def uuid(self) -> _uuid.UUID: ...
