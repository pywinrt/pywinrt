...
class StoreContext(winrt.system.Object):
    ...
    def report_consumable_fulfillment_async(self, product_store_id: str, quantity: winrt.system.UInt32, tracking_id: winrt.system.Guid, /) -> winrt.windows.foundation.IAsyncOperation[StoreConsumableResult]: ...
