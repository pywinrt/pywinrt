...
class StoreAvailability(winrt.system.Object):
    ...
    @typing.overload
    def request_purchase_async(self, store_purchase_properties: typing.Optional[StorePurchaseProperties], /) -> windows_foundation.IAsyncOperation[StorePurchaseResult]: ...
    @_property
...
class StoreContext(winrt.system.Object, metaclass=StoreContext_Static):
    ...
    @typing.overload
    def get_store_products_async(self, product_kinds: typing.Iterable[str], store_ids: typing.Iterable[str], store_product_options: typing.Optional[StoreProductOptions], /) -> windows_foundation.IAsyncOperation[StoreProductQueryResult]: ...
    ...
    @typing.overload
    def request_download_and_install_store_packages_async(self, store_ids: typing.Iterable[str], store_package_install_options: typing.Optional[StorePackageInstallOptions], /) -> windows_foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]: ...
    ...
    @typing.overload
    def request_purchase_async(self, store_id: str, store_purchase_properties: typing.Optional[StorePurchaseProperties], /) -> windows_foundation.IAsyncOperation[StorePurchaseResult]: ...
