...
class StoreAppLicense(winrt.system.Object):
    ...
    @_property
    def add_on_licenses(self) -> typing.Optional[windows_foundation_collections.IMapView[str, StoreLicense]]: ...
    @_property
...
class StoreAvailability(winrt.system.Object):
    ...
    def request_purchase_with_purchase_properties_async(self, store_purchase_properties: typing.Optional[StorePurchaseProperties], /) -> windows_foundation.IAsyncOperation[StorePurchaseResult]: ...
    @_property
...
class StoreContext_Static(type):
    ...
    def get_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[StoreContext]: ...

@typing.final
class StoreContext(winrt.system.Object, metaclass=StoreContext_Static):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> StoreContext: ...
    def acquire_store_license_for_optional_package_async(self, optional_package: typing.Optional[windows_applicationmodel.Package], /) -> windows_foundation.IAsyncOperation[StoreAcquireLicenseResult]: ...
    ...
    def can_acquire_store_license_for_optional_package_async(self, optional_package: typing.Optional[windows_applicationmodel.Package], /) -> windows_foundation.IAsyncOperation[StoreCanAcquireLicenseResult]: ...
    ...
    def find_store_product_for_package_async(self, product_kinds: typing.Iterable[str], package: typing.Optional[windows_applicationmodel.Package], /) -> windows_foundation.IAsyncOperation[StoreProductResult]: ...
    def get_app_and_optional_store_package_updates_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[StorePackageUpdate]]: ...
    ...
    def get_associated_store_queue_items_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[StoreQueueItem]]: ...
    ...
    def get_store_products_with_options_async(self, product_kinds: typing.Iterable[str], store_ids: typing.Iterable[str], store_product_options: typing.Optional[StoreProductOptions], /) -> windows_foundation.IAsyncOperation[StoreProductQueryResult]: ...
    def get_store_queue_items_async(self, store_ids: typing.Iterable[str], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[StoreQueueItem]]: ...
    ...
    def request_download_and_install_store_packages_with_install_options_async(self, store_ids: typing.Iterable[str], store_package_install_options: typing.Optional[StorePackageInstallOptions], /) -> windows_foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]: ...
    ...
    def request_purchase_with_purchase_properties_async(self, store_id: str, store_purchase_properties: typing.Optional[StorePurchaseProperties], /) -> windows_foundation.IAsyncOperation[StorePurchaseResult]: ...
    def request_rate_and_review_app_async(self) -> windows_foundation.IAsyncOperation[StoreRateAndReviewResult]: ...
    def request_uninstall_store_package_async(self, package: typing.Optional[windows_applicationmodel.Package], /) -> windows_foundation.IAsyncOperation[StoreUninstallStorePackageResult]: ...
    ...
    def set_install_order_for_associated_store_queue_items_async(self, items: typing.Iterable[StoreQueueItem], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[StoreQueueItem]]: ...
    ...
    def uninstall_store_package_async(self, package: typing.Optional[windows_applicationmodel.Package], /) -> windows_foundation.IAsyncOperation[StoreUninstallStorePackageResult]: ...
...
class StorePackageUpdateResult(winrt.system.Object):
    ...
    @_property
    def store_package_update_statuses(self) -> typing.Optional[windows_foundation_collections.IVectorView[StorePackageUpdateStatus]]: ...
    @_property
    def store_queue_items(self) -> typing.Optional[windows_foundation_collections.IVectorView[StoreQueueItem]]: ...
...
class StoreProduct(winrt.system.Object):
    ...
    @_property
    def images(self) -> typing.Optional[windows_foundation_collections.IVectorView[StoreImage]]: ...
    @_property
    def in_app_offer_token(self) -> str: ...
    @_property
    def is_in_user_collection(self) -> bool: ...
    @_property
    def keywords(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
    def language(self) -> str: ...
    @_property
    def link_uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @_property
    def price(self) -> typing.Optional[StorePrice]: ...
    @_property
    def product_kind(self) -> str: ...
    @_property
    def skus(self) -> typing.Optional[windows_foundation_collections.IVectorView[StoreSku]]: ...
    @_property
    def store_id(self) -> str: ...
    @_property
    def title(self) -> str: ...
    @_property
    def videos(self) -> typing.Optional[windows_foundation_collections.IVectorView[StoreVideo]]: ...
...
class StoreProductOptions(winrt.system.Object):
    ...
    @_property
    def action_filters(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class StoreProductPagedQueryResult(winrt.system.Object):
    ...
    @_property
    def products(self) -> typing.Optional[windows_foundation_collections.IMapView[str, StoreProduct]]: ...
...
class StoreRequestHelper_Static(type):
    def send_request_async(cls, context: typing.Optional[StoreContext], request_kind: winrt.system.UInt32, parameters_as_json: str, /) -> windows_foundation.IAsyncOperation[StoreSendRequestResult]: ...
...
class StoreSku(winrt.system.Object):
    ...
    def request_purchase_with_purchase_properties_async(self, store_purchase_properties: typing.Optional[StorePurchaseProperties], /) -> windows_foundation.IAsyncOperation[StorePurchaseResult]: ...
    @_property
    def availabilities(self) -> typing.Optional[windows_foundation_collections.IVectorView[StoreAvailability]]: ...
    @_property
    def bundled_skus(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
