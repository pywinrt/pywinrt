...
class ActivationSignalDetector(winrt.system.Object):
    ...
    def get_available_model_ids_for_signal_id(self, signal_id: str, /) -> windows_foundation_collections.IVector[str]: ...
    ...
    def get_configurations(self) -> windows_foundation_collections.IVectorView[ActivationSignalDetectionConfiguration]: ...
    ...
    def get_supported_model_ids_for_signal_id(self, signal_id: str, /) -> windows_foundation_collections.IVectorView[str]: ...
    ...
    @_property
    def supported_model_data_types(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def supported_power_states(self) -> windows_foundation_collections.IVectorView[ActivationSignalDetectorPowerState]: ...
    @_property
    def supported_training_data_formats(self) -> windows_foundation_collections.IVectorView[ActivationSignalDetectionTrainingDataFormat]: ...
    @_property
...
class ConversationalAgentDetectorManager(winrt.system.Object, metaclass=ConversationalAgentDetectorManager_Static):
    ...
    def get_activation_signal_detectors(self, kind: ActivationSignalDetectorKind, /) -> windows_foundation_collections.IVectorView[ActivationSignalDetector]: ...
    ...
    def get_all_activation_signal_detectors(self) -> windows_foundation_collections.IVectorView[ActivationSignalDetector]: ...
...
class ConversationalAgentSession(winrt.system.Object, metaclass=ConversationalAgentSession_Static):
    ...
    def get_missing_prerequisites(self) -> windows_foundation_collections.IVectorView[ConversationalAgentVoiceActivationPrerequisiteKind]: ...
    ...
    def get_supported_signal_model_ids(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
...
class DetectionConfigurationAvailabilityInfo(winrt.system.Object):
    ...
    @_property
    def unavailable_system_resources(self) -> windows_foundation_collections.IVectorView[SignalDetectorResourceKind]: ...
