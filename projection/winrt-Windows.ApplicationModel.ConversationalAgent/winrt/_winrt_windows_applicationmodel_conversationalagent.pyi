...
@typing.final
class ActivationSignalDetectionConfiguration(winrt.system.Object, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    def apply_training_data(self, training_data_format: ActivationSignalDetectionTrainingDataFormat, training_data: windows_storage_streams.ImplementsIInputStream, /) -> DetectionConfigurationTrainingStatus: ...
    def apply_training_data_async(self, training_data_format: ActivationSignalDetectionTrainingDataFormat, training_data: windows_storage_streams.ImplementsIInputStream, /) -> windows_foundation.IAsyncOperation[DetectionConfigurationTrainingStatus]: ...
    ...
    def set_model_data(self, data_type: str, data: windows_storage_streams.ImplementsIInputStream, /) -> None: ...
    def set_model_data_async(self, data_type: str, data: windows_storage_streams.ImplementsIInputStream, /) -> windows_foundation.IAsyncAction: ...
    def set_model_data_with_result(self, data_type: str, data: windows_storage_streams.ImplementsIInputStream, /) -> ActivationSignalDetectionConfigurationSetModelDataResult: ...
    def set_model_data_with_result_async(self, data_type: str, data: windows_storage_streams.ImplementsIInputStream, /) -> windows_foundation.IAsyncOperation[ActivationSignalDetectionConfigurationSetModelDataResult]: ...
...
@typing.final
class ConversationalAgentSession(winrt.system.Object, windows_foundation.ImplementsIClosable, metaclass=ConversationalAgentSession_Static):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    def close(self) -> None: ...
