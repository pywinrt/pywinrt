...
PyMODINIT_FUNC PyInit__winrt_windows_system_diagnostics_deviceportal(void) noexcept
{
    ...
    py::pyobj_handle DevicePortalConnection_type{py::register_python_type(module.get(), &type_spec_DevicePortalConnection, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_DevicePortalConnection_Static.get()))};
    if (!DevicePortalConnection_type)
    {
        return nullptr;
    }

    py::pyobj_handle DevicePortalConnectionClosedEventArgs_type{py::register_python_type(module.get(), &type_spec_DevicePortalConnectionClosedEventArgs, object_bases.get(), nullptr)};
    if (!DevicePortalConnectionClosedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle DevicePortalConnectionRequestReceivedEventArgs_type{py::register_python_type(module.get(), &type_spec_DevicePortalConnectionRequestReceivedEventArgs, object_bases.get(), nullptr)};
