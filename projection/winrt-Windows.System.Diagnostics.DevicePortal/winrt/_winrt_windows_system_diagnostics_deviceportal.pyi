...
class DevicePortalConnection(winrt.system.Object, metaclass=DevicePortalConnection_Static):
    ...
    def get_server_message_web_socket_for_request2(self, request: typing.Optional[windows_web_http.HttpRequestMessage], message_type: windows_networking_sockets.SocketMessageType, protocol: str, /) -> typing.Optional[windows_networking_sockets.ServerMessageWebSocket]: ...
    def get_server_message_web_socket_for_request3(self, request: typing.Optional[windows_web_http.HttpRequestMessage], message_type: windows_networking_sockets.SocketMessageType, protocol: str, outbound_buffer_size_in_bytes: winrt.system.UInt32, max_message_size: winrt.system.UInt32, receive_mode: windows_networking_sockets.MessageWebSocketReceiveMode, /) -> typing.Optional[windows_networking_sockets.ServerMessageWebSocket]: ...
    ...
    def get_server_stream_web_socket_for_request2(self, request: typing.Optional[windows_web_http.HttpRequestMessage], protocol: str, outbound_buffer_size_in_bytes: winrt.system.UInt32, no_delay: bool, /) -> typing.Optional[windows_networking_sockets.ServerStreamWebSocket]: ...
