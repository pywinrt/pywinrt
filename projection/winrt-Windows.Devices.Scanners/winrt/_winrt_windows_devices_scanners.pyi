...
class ImageScanner(winrt.system.Object, metaclass=ImageScanner_Static):
    ...
    def scan_preview_to_stream_async(self, scan_source: ImageScannerScanSource, target_stream: windows_storage_streams.ImplementsIRandomAccessStream, /) -> windows_foundation.IAsyncOperation[ImageScannerPreviewResult]: ...
    @_property
...
@typing.final
class ImageScannerAutoConfiguration(winrt.system.Object, ImplementsIImageScannerFormatConfiguration):
    @staticmethod
...
@typing.final
class ImageScannerFeederConfiguration(winrt.system.Object, ImplementsIImageScannerSourceConfiguration, ImplementsIImageScannerFormatConfiguration):
    @staticmethod
...
@typing.final
class ImageScannerFlatbedConfiguration(winrt.system.Object, ImplementsIImageScannerSourceConfiguration, ImplementsIImageScannerFormatConfiguration):
    @staticmethod
