...
class CoreDragOperation(winrt.system.Object):
    ...
    def set_drag_u_i_content_from_software_bitmap(self, software_bitmap: windows_graphics_imaging.SoftwareBitmap, /) -> None: ...
    def set_drag_u_i_content_from_software_bitmap_with_anchor_point(self, software_bitmap: windows_graphics_imaging.SoftwareBitmap, anchor_point: windows_foundation.Point, /) -> None: ...
...
class ICoreDropOperationTarget(winrt.system.Object):
    ...
    def enter_async(self, drag_info: CoreDragInfo, drag_u_i_override: CoreDragUIOverride, /) -> windows_foundation.IAsyncOperation[windows_applicationmodel_datatransfer.DataPackageOperation]: ...
    def leave_async(self, drag_info: CoreDragInfo, /) -> windows_foundation.IAsyncAction: ...
    def over_async(self, drag_info: CoreDragInfo, drag_u_i_override: CoreDragUIOverride, /) -> windows_foundation.IAsyncOperation[windows_applicationmodel_datatransfer.DataPackageOperation]: ...
