...
class CoreDragOperation(winrt.system.Object):
    ...
    def set_drag_u_i_content_from_software_bitmap_with_anchor_point(self, software_bitmap: typing.Optional[windows_graphics_imaging.SoftwareBitmap], anchor_point: windows_foundation.Point, /) -> None: ...
...
class CoreDragUIOverride(winrt.system.Object):
    ...
    def set_content_from_software_bitmap_with_anchor_point(self, software_bitmap: typing.Optional[windows_graphics_imaging.SoftwareBitmap], anchor_point: windows_foundation.Point, /) -> None: ...
    @_property
