...
namespace py::cpp::Windows::Management::Deployment
{
    struct module_state
    {
        PyObject* type_AddPackageByAppInstallerOptions;
        PyObject* type_DeploymentOptions;
        PyObject* type_DeploymentProgressState;
        PyObject* type_PackageInstallState;
        PyObject* type_PackageState;
        PyObject* type_PackageStatus;
    ...
    static PyObject* register_AddPackageByAppInstallerOptions(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_AddPackageByAppInstallerOptions)
        {
        ...
        state->type_AddPackageByAppInstallerOptions = type;
        Py_INCREF(state->type_AddPackageByAppInstallerOptions);


        Py_RETURN_NONE;
    }

    static PyObject* register_DeploymentOptions(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_DeploymentOptions)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_DeploymentOptions = type;
        Py_INCREF(state->type_DeploymentOptions);


        Py_RETURN_NONE;
    }

    static PyObject* register_DeploymentProgressState(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_DeploymentProgressState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_DeploymentProgressState = type;
        Py_INCREF(state->type_DeploymentProgressState);


        Py_RETURN_NONE;
    }

    static PyObject* register_PackageInstallState(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PackageInstallState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PackageInstallState = type;
        Py_INCREF(state->type_PackageInstallState);


        Py_RETURN_NONE;
    }

    static PyObject* register_PackageState(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PackageState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PackageState = type;
        Py_INCREF(state->type_PackageState);


        Py_RETURN_NONE;
    }

    static PyObject* register_PackageStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);
        ...
        state->type_PackageStatus = type;
        Py_INCREF(state->type_PackageStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_PackageStubPreference(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PackageStubPreference)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PackageStubPreference = type;
        Py_INCREF(state->type_PackageStubPreference);


        Py_RETURN_NONE;
    }

    static PyObject* register_PackageTypes(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_PackageTypes)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_PackageTypes = type;
        Py_INCREF(state->type_PackageTypes);


        Py_RETURN_NONE;
    }

    static PyObject* register_RemovalOptions(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_RemovalOptions)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
    ...
    static PyObject* register_SharedPackageContainerCreationCollisionOptions(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);
    ...
    static PyObject* register_SharedPackageContainerOperationStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);
    ...
    static PyObject* register_StubPackageOption(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_StubPackageOption)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_StubPackageOption = type;
        Py_INCREF(state->type_StubPackageOption);
    ...
    static PyMethodDef module_methods[] = {
        {"_register_AddPackageByAppInstallerOptions", register_AddPackageByAppInstallerOptions, METH_O, "registers type"},
        {"_register_DeploymentOptions", register_DeploymentOptions, METH_O, "registers type"},
        {"_register_DeploymentProgressState", register_DeploymentProgressState, METH_O, "registers type"},
        {"_register_PackageInstallState", register_PackageInstallState, METH_O, "registers type"},
        {"_register_PackageState", register_PackageState, METH_O, "registers type"},
        {"_register_PackageStatus", register_PackageStatus, METH_O, "registers type"},
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_AddPackageByAppInstallerOptions);
        Py_VISIT(state->type_DeploymentOptions);
        Py_VISIT(state->type_DeploymentProgressState);
        Py_VISIT(state->type_PackageInstallState);
        Py_VISIT(state->type_PackageState);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_AddPackageByAppInstallerOptions);
        Py_CLEAR(state->type_DeploymentOptions);
        Py_CLEAR(state->type_DeploymentProgressState);
        Py_CLEAR(state->type_PackageInstallState);
        Py_CLEAR(state->type_PackageState);
...
PyObject* py::py_type<winrt::Windows::Management::Deployment::AddPackageByAppInstallerOptions>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Management::Deployment;
    ...
    auto python_type = state->type_AddPackageByAppInstallerOptions;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Management::Deployment::AddPackageByAppInstallerOptions is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Management::Deployment::DeploymentOptions>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Management::Deployment;
    ...
    auto python_type = state->type_DeploymentOptions;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Management::Deployment::DeploymentOptions is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Management::Deployment::DeploymentProgressState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Management::Deployment;
    ...
    auto python_type = state->type_DeploymentProgressState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Management::Deployment::DeploymentProgressState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Management::Deployment::PackageInstallState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Management::Deployment;
    ...
    auto python_type = state->type_PackageInstallState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Management::Deployment::PackageInstallState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Management::Deployment::PackageState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Management::Deployment;
    ...
    auto python_type = state->type_PackageState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Management::Deployment::PackageState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Management::Deployment::PackageStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Management::Deployment;
    ...
    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Management::Deployment::PackageStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Management::Deployment::PackageStubPreference>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Management::Deployment;
    ...
    auto python_type = state->type_PackageStubPreference;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Management::Deployment::PackageStubPreference is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Management::Deployment::PackageTypes>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Management::Deployment;
    ...
    auto python_type = state->type_PackageTypes;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Management::Deployment::PackageTypes is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Management::Deployment::RemovalOptions>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Management::Deployment;
    ...
    auto python_type = state->type_RemovalOptions;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Management::Deployment::RemovalOptions is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Management::Deployment::StubPackageOption>::get_python_type() noexcept {
    ...
    auto python_type = state->type_StubPackageOption;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Management::Deployment::StubPackageOption is not registered");
        return nullptr;
    }
