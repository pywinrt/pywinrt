...
PyMODINIT_FUNC PyInit__winrt_windows_management_deployment(void) noexcept
{
    ...
    py::pyobj_handle AppInstallerManager_type{py::register_python_type(module.get(), &type_spec_AppInstallerManager, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_AppInstallerManager_Static.get()))};
    ...
    py::pyobj_handle AutoUpdateSettingsOptions_type{py::register_python_type(module.get(), &type_spec_AutoUpdateSettingsOptions, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_AutoUpdateSettingsOptions_Static.get()))};
    if (!AutoUpdateSettingsOptions_type)
    {
        return nullptr;
    }

    py::pyobj_handle CreateSharedPackageContainerOptions_type{py::register_python_type(module.get(), &type_spec_CreateSharedPackageContainerOptions, object_bases.get(), nullptr)};
    if (!CreateSharedPackageContainerOptions_type)
    {
        return nullptr;
    }

    py::pyobj_handle CreateSharedPackageContainerResult_type{py::register_python_type(module.get(), &type_spec_CreateSharedPackageContainerResult, object_bases.get(), nullptr)};
    if (!CreateSharedPackageContainerResult_type)
    {
        return nullptr;
    }

    py::pyobj_handle DeleteSharedPackageContainerOptions_type{py::register_python_type(module.get(), &type_spec_DeleteSharedPackageContainerOptions, object_bases.get(), nullptr)};
    if (!DeleteSharedPackageContainerOptions_type)
    {
        return nullptr;
    }

    py::pyobj_handle DeleteSharedPackageContainerResult_type{py::register_python_type(module.get(), &type_spec_DeleteSharedPackageContainerResult, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle FindSharedPackageContainerOptions_type{py::register_python_type(module.get(), &type_spec_FindSharedPackageContainerOptions, object_bases.get(), nullptr)};
    if (!FindSharedPackageContainerOptions_type)
    {
        return nullptr;
    }

    py::pyobj_handle PackageAllUserProvisioningOptions_type{py::register_python_type(module.get(), &type_spec_PackageAllUserProvisioningOptions, object_bases.get(), nullptr)};
    if (!PackageAllUserProvisioningOptions_type)
    {
        return nullptr;
    }

    py::pyobj_handle PackageManager_type{py::register_python_type(module.get(), &type_spec_PackageManager, object_bases.get(), nullptr)};
    if (!PackageManager_type)
    {
        return nullptr;
    }

    py::pyobj_handle PackageManagerDebugSettings_type{py::register_python_type(module.get(), &type_spec_PackageManagerDebugSettings, object_bases.get(), nullptr)};
    if (!PackageManagerDebugSettings_type)
    {
        return nullptr;
    }

    py::pyobj_handle PackageUserInformation_type{py::register_python_type(module.get(), &type_spec_PackageUserInformation, object_bases.get(), nullptr)};
    if (!PackageUserInformation_type)
    {
        return nullptr;
    }

    py::pyobj_handle PackageVolume_type{py::register_python_type(module.get(), &type_spec_PackageVolume, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle SharedPackageContainer_type{py::register_python_type(module.get(), &type_spec_SharedPackageContainer, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle SharedPackageContainerManager_type{py::register_python_type(module.get(), &type_spec_SharedPackageContainerManager, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_SharedPackageContainerManager_Static.get()))};
    if (!SharedPackageContainerManager_type)
    {
        return nullptr;
    }

    py::pyobj_handle SharedPackageContainerMember_type{py::register_python_type(module.get(), &type_spec_SharedPackageContainerMember, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle UpdateSharedPackageContainerOptions_type{py::register_python_type(module.get(), &type_spec_UpdateSharedPackageContainerOptions, object_bases.get(), nullptr)};
    if (!UpdateSharedPackageContainerOptions_type)
    {
        return nullptr;
    }

    py::pyobj_handle UpdateSharedPackageContainerResult_type{py::register_python_type(module.get(), &type_spec_UpdateSharedPackageContainerResult, object_bases.get(), nullptr)};
    if (!UpdateSharedPackageContainerResult_type)
    {
        return nullptr;
    }

    py::pyobj_handle DeploymentProgress_type{py::register_python_type(module.get(), &type_spec_DeploymentProgress, nullptr, nullptr)};
