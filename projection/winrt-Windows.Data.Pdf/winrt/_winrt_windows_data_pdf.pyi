...
class PdfDocument_Static(type):
    ...
    def load_from_file_with_password_async(cls, file: typing.Optional[windows_storage.IStorageFile], password: str, /) -> windows_foundation.IAsyncOperation[PdfDocument]: ...
    ...
    def load_from_stream_with_password_async(cls, input_stream: typing.Optional[windows_storage_streams.IRandomAccessStream], password: str, /) -> windows_foundation.IAsyncOperation[PdfDocument]: ...
...
class PdfPage(winrt.system.Object):
    ...
    def render_with_options_to_stream_async(self, output_stream: typing.Optional[windows_storage_streams.IRandomAccessStream], options: typing.Optional[PdfPageRenderOptions], /) -> windows_foundation.IAsyncAction: ...
    @_property
