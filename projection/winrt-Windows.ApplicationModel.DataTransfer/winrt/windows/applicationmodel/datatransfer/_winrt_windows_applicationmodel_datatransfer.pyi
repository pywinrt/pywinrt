...
class Clipboard(winrt.system.Object):
    ...
    def clear() -> None: ...
    @staticmethod
    def clear_history() -> winrt.system.Boolean: ...
    @staticmethod
    def delete_item_from_history(item: typing.Optional[ClipboardHistoryItem], /) -> winrt.system.Boolean: ...
    @staticmethod
    def flush() -> None: ...
    @staticmethod
    ...
    @staticmethod
    def is_history_enabled() -> winrt.system.Boolean: ...
    @staticmethod
    def is_roaming_enabled() -> winrt.system.Boolean: ...
    @staticmethod
    def set_content(content: typing.Optional[DataPackage], /) -> None: ...
    @staticmethod
    def set_content_with_options(content: typing.Optional[DataPackage], options: typing.Optional[ClipboardContentOptions], /) -> winrt.system.Boolean: ...
    @staticmethod
...
class ClipboardContentOptions(winrt.system.Object):
    ...
    is_allowed_in_history: winrt.system.Boolean
...
class DataPackage(winrt.system.Object):
    ...
    @typing.overload
    def set_storage_items(self, value: typing.Iterable[winrt.windows.storage.IStorageItem], read_only: winrt.system.Boolean, /) -> None: ...
...
class DataPackagePropertySetView(winrt.system.Object, typing.Mapping[str, winrt.system.Object]):
    ...
    enterprise_id: str
    content_source_user_activity_json: str
    is_from_roaming_clipboard: winrt.system.Boolean
    size: winrt.system.UInt32
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[str]: ...
    def __contains__(self, key: object) -> bool:...
...
class DataPackageView(winrt.system.Object):
    ...
    def contains(self, format_id: str, /) -> winrt.system.Boolean: ...
