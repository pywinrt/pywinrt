...
class ClipboardContentOptions(winrt.system.Object):
    ...
    @_property
    def history_formats(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def roaming_formats(self) -> windows_foundation_collections.IVector[str]: ...
...
class ClipboardHistoryItemsResult(winrt.system.Object):
    ...
    @_property
    def items(self) -> windows_foundation_collections.IVectorView[ClipboardHistoryItem]: ...
    @_property
...
class DataPackage(winrt.system.Object):
    ...
    @_property
    def resource_map(self) -> windows_foundation_collections.IMap[str, windows_storage_streams.RandomAccessStreamReference]: ...
...
class DataPackagePropertySet(winrt.system.Object, winrt._winrt.MutableMapping[str, winrt.system.Object]):
    ...
    def get_view(self) -> windows_foundation_collections.IMapView[str, winrt.system.Object]: ...
    ...
    @_property
    def file_types(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
...
class DataPackagePropertySetView(winrt.system.Object, winrt._winrt.Mapping[str, winrt.system.Object]):
    ...
    def description(self) -> str: ...
    @_property
    def file_types(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
...
class DataPackageView(winrt.system.Object):
    ...
    @_property
    def available_formats(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
...
class DataTransferManager_Static(type):
    ...
    def show_share_u_i_with_options(cls, options: ShareUIOptions, /) -> None: ...
...
class ShareProvider(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[ShareProvider], title: str, display_icon: windows_storage_streams.RandomAccessStreamReference, background_color: windows_ui.Color, handler: ShareProviderHandler) -> ShareProvider: ...
    @_property
...
class ShareProvidersRequestedEventArgs(winrt.system.Object):
    ...
    def data(self) -> DataPackageView: ...
    @_property
    def providers(self) -> windows_foundation_collections.IVector[ShareProvider]: ...
