...
class ShareProvider(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[Self], title: str, display_icon: windows_storage_streams.RandomAccessStreamReference, background_color: windows_ui.Color, handler: ShareProviderHandler) -> Self: ...
    @_property
