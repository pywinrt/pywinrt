...
class Clipboard_Static(type):
    ...
    def remove_history_changed(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_history_enabled_changed(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_roaming_enabled_changed(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_content_changed(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
...
class ClipboardContentOptions(winrt.system.Object):
    ...
    @_property
    def history_formats(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def roaming_formats(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class ClipboardHistoryItemsResult(winrt.system.Object):
    ...
    @_property
    def items(self) -> typing.Optional[windows_foundation_collections.IVectorView[ClipboardHistoryItem]]: ...
    @_property
...
class DataPackage(winrt.system.Object):
    ...
    def set_application_link(self, value: typing.Optional[windows_foundation.Uri], /) -> None: ...
    def set_bitmap(self, value: typing.Optional[windows_storage_streams.RandomAccessStreamReference], /) -> None: ...
    ...
    def set_uri(self, value: typing.Optional[windows_foundation.Uri], /) -> None: ...
    def set_web_link(self, value: typing.Optional[windows_foundation.Uri], /) -> None: ...
    ...
    def remove_operation_completed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_share_completed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_share_canceled(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
    ...
    @_property
    def resource_map(self) -> typing.Optional[windows_foundation_collections.IMap[str, windows_storage_streams.RandomAccessStreamReference]]: ...
...
class DataPackagePropertySet(winrt.system.Object, winrt._winrt.MutableMapping[str, winrt.system.Object]):
    ...
    @_property
    def application_listing_uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @application_listing_uri.setter
    def application_listing_uri(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    def file_types(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def square30x30_logo(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
    @square30x30_logo.setter
    def square30x30_logo(self, value: typing.Optional[windows_storage_streams.IRandomAccessStreamReference]) -> None: ...
    @_property
    ...
    def logo_background_color(self, value: windows_ui.Color) -> None: ...
    @_property
    ...
    @_property
    def content_source_application_link(self) -> typing.Optional[windows_foundation.Uri]: ...
    @content_source_application_link.setter
    def content_source_application_link(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
...
class DataPackagePropertySetView(winrt.system.Object, winrt._winrt.Mapping[str, winrt.system.Object]):
    ...
    def description(self) -> str: ...
    @_property
    def file_types(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
...
class DataPackageView(winrt.system.Object):
    ...
    def get_resource_map_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IMapView[str, windows_storage_streams.RandomAccessStreamReference]]: ...
    def get_rtf_async(self) -> windows_foundation.IAsyncOperation[str]: ...
    def get_storage_items_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_storage.IStorageItem]]: ...
    ...
    @_property
    def available_formats(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
...
class DataTransferManager_Static(type):
    ...
    def show_share_u_i_with_options(cls, options: typing.Optional[ShareUIOptions], /) -> None: ...
...
class DataTransferManager(winrt.system.Object, metaclass=DataTransferManager_Static):
    ...
    def remove_data_requested(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_target_application_chosen(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
...
class ShareProvider(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[ShareProvider], title: str, display_icon: typing.Optional[windows_storage_streams.RandomAccessStreamReference], background_color: windows_ui.Color, handler: typing.Optional[ShareProviderHandler]) -> ShareProvider: ...
    @_property
    ...
    @_property
    def display_icon(self) -> typing.Optional[windows_storage_streams.RandomAccessStreamReference]: ...
    @_property
    def title(self) -> str: ...
...
class ShareProvidersRequestedEventArgs(winrt.system.Object):
    ...
    def data(self) -> typing.Optional[DataPackageView]: ...
    @_property
    def providers(self) -> typing.Optional[windows_foundation_collections.IVector[ShareProvider]]: ...
...
class SharedStorageAccessManager_Static(type):
    def add_file(cls, file: typing.Optional[windows_storage.IStorageFile], /) -> str: ...
