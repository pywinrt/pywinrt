...
class DataPackage(winrt.system.Object):
    ...
    def set_storage_items(self, value: typing.Iterable[windows_storage.ImplementsIStorageItem], read_only: bool, /) -> None: ...
    def set_storage_items_read_only(self, value: typing.Iterable[windows_storage.ImplementsIStorageItem], /) -> None: ...
...
class DataPackagePropertySet(winrt.system.Object, winrt._winrt.MutableMapping[str, winrt.system.Object]):
    ...
    def square30x30_logo(self, value: windows_storage_streams.ImplementsIRandomAccessStreamReference) -> None: ...
    @_property
...
class SharedStorageAccessManager_Static(type):
    def add_file(cls, file: windows_storage.ImplementsIStorageFile, /) -> str: ...
