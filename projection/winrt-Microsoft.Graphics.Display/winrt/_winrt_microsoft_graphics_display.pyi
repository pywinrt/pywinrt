...
class DisplayInformation_Static(type):
    def create_for_display_id(cls, display_id: microsoft_ui.DisplayId, /) -> typing.Optional[DisplayInformation]: ...
    def create_for_window_id(cls, window_id: microsoft_ui.WindowId, /) -> typing.Optional[DisplayInformation]: ...
...
class DisplayInformation(winrt.system.Object, metaclass=DisplayInformation_Static):
    ...
    def get_color_profile(self) -> typing.Optional[windows_storage_streams.IRandomAccessStream]: ...
