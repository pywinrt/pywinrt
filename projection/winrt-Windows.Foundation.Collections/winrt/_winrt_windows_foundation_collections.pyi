...
@typing.final
class PropertySet(IPropertySet, IObservableMap[str, winrt.system.Object], winrt.system.Object, winrt._winrt.MutableMapping[str, winrt.system.Object]):
...
@typing.final
class StringMap(IObservableMap[str, str], winrt.system.Object, winrt._winrt.MutableMapping[str, str]):
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[str]: ...
    def __contains__(self, key: object) -> bool: ...
...
@typing.final
class ValueSet(IPropertySet, IObservableMap[str, winrt.system.Object], winrt.system.Object, winrt._winrt.MutableMapping[str, winrt.system.Object]):
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[str]: ...
    def __contains__(self, key: object) -> bool: ...
    def __getitem__(self, key: str) -> winrt.system.Object: ...
...
class IMapView(winrt.system.Object, winrt._winrt.Mapping[K, V]):
    def __class_getitem__(cls, key: typing.Any) -> types.GenericAlias: ...
    def __len__(self) -> int: ...
...
class IMap(winrt.system.Object, winrt._winrt.MutableMapping[K, V]):
    def __class_getitem__(cls, key: typing.Any) -> types.GenericAlias: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[K]: ...
    def __contains__(self, key: object) -> bool: ...
...
class IObservableMap(winrt.system.Object, winrt._winrt.MutableMapping[K, V]):
    def __class_getitem__(cls, key: typing.Any) -> types.GenericAlias: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[K]: ...
    def __contains__(self, key: object) -> bool: ...
...
class IObservableVector(winrt.system.Object, winrt._winrt.MutableSequence[T]):
    def __class_getitem__(cls, key: typing.Any) -> types.GenericAlias: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> IIterator[T]: ...
    @typing.overload
...
class IPropertySet(IObservableMap[str, winrt.system.Object], winrt.system.Object, winrt._winrt.MutableMapping[str, winrt.system.Object]):
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[str]: ...
    def __contains__(self, key: object) -> bool: ...
    def __getitem__(self, key: str) -> winrt.system.Object: ...
...
class IVectorView(winrt.system.Object, winrt._winrt.Sequence[T]):
    def __class_getitem__(cls, key: typing.Any) -> types.GenericAlias: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> IIterator[T]: ...
    @typing.overload
...
class IVector(winrt.system.Object, winrt._winrt.MutableSequence[T]):
    def __class_getitem__(cls, key: typing.Any) -> types.GenericAlias: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> IIterator[T]: ...
    @typing.overload
