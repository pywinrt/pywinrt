...
class Printing3D3MFPackage(winrt.system.Object, metaclass=Printing3D3MFPackage_Static):
    ...
    @_property
    def textures(self) -> windows_foundation_collections.IVector[Printing3DTextureResource]: ...
    @_property
...
class Printing3DBaseMaterialGroup(winrt.system.Object):
    ...
    @_property
    def bases(self) -> windows_foundation_collections.IVector[Printing3DBaseMaterial]: ...
    @_property
...
class Printing3DColorMaterialGroup(winrt.system.Object):
    ...
    @_property
    def colors(self) -> windows_foundation_collections.IVector[Printing3DColorMaterial]: ...
    @_property
    def material_group_id(self) -> winrt.system.UInt32: ...
...
class Printing3DComponent(winrt.system.Object):
    ...
    @_property
    def components(self) -> windows_foundation_collections.IVector[Printing3DComponentWithMatrix]: ...
...
class Printing3DCompositeMaterial(winrt.system.Object):
    ...
    @_property
    def values(self) -> windows_foundation_collections.IVector[winrt.system.Double]: ...
...
class Printing3DCompositeMaterialGroup(winrt.system.Object):
    ...
    @_property
    def composites(self) -> windows_foundation_collections.IVector[Printing3DCompositeMaterial]: ...
    @_property
    def material_group_id(self) -> winrt.system.UInt32: ...
    @_property
    def material_indices(self) -> windows_foundation_collections.IVector[winrt.system.UInt32]: ...
    @_property
...
class Printing3DMaterial(winrt.system.Object):
    ...
    @_property
    def base_groups(self) -> windows_foundation_collections.IVector[Printing3DBaseMaterialGroup]: ...
    @_property
    def color_groups(self) -> windows_foundation_collections.IVector[Printing3DColorMaterialGroup]: ...
    @_property
    def composite_groups(self) -> windows_foundation_collections.IVector[Printing3DCompositeMaterialGroup]: ...
    @_property
    def multiple_property_groups(self) -> windows_foundation_collections.IVector[Printing3DMultiplePropertyMaterialGroup]: ...
    @_property
    def texture2_coord_groups(self) -> windows_foundation_collections.IVector[Printing3DTexture2CoordMaterialGroup]: ...
...
class Printing3DMeshVerificationResult(winrt.system.Object):
    ...
    @_property
    def nonmanifold_triangles(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
    @_property
    def reversed_normal_triangles(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt32]: ...
...
class Printing3DModel(winrt.system.Object):
    ...
    @_property
    def components(self) -> windows_foundation_collections.IVector[Printing3DComponent]: ...
    @_property
    def meshes(self) -> windows_foundation_collections.IVector[Printing3DMesh]: ...
    @_property
    def metadata(self) -> windows_foundation_collections.IMap[str, str]: ...
    @_property
    def required_extensions(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def textures(self) -> windows_foundation_collections.IVector[Printing3DModelTexture]: ...
...
class Printing3DMultiplePropertyMaterialGroup(winrt.system.Object):
    ...
    def material_group_id(self) -> winrt.system.UInt32: ...
    @_property
    def material_group_indices(self) -> windows_foundation_collections.IVector[winrt.system.UInt32]: ...
    @_property
    def multiple_properties(self) -> windows_foundation_collections.IVector[Printing3DMultiplePropertyMaterial]: ...
...
class Printing3DTexture2CoordMaterialGroup(winrt.system.Object):
    ...
    def material_group_id(self) -> winrt.system.UInt32: ...
    @_property
    def texture2_coords(self) -> windows_foundation_collections.IVector[Printing3DTexture2CoordMaterial]: ...
    @_property
    def texture(self) -> Printing3DModelTexture: ...
    @texture.setter
    def texture(self, value: Printing3DModelTexture) -> None: ...
