...
class Printing3DModel(winrt.system.Object):
    ...
    def try_reduce_faces_with_options_and_time_async(self, printing3_d_face_reduction_options: typing.Optional[Printing3DFaceReductionOptions], max_wait: datetime.timedelta, /) -> windows_foundation.IAsyncOperationWithProgress[bool, winrt.system.Double]: ...
    def try_reduce_faces_with_options_async(self, printing3_d_face_reduction_options: typing.Optional[Printing3DFaceReductionOptions], /) -> windows_foundation.IAsyncOperationWithProgress[bool, winrt.system.Double]: ...
    @_property
