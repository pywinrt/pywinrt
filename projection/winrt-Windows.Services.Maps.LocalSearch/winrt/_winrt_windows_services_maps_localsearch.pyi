...
class LocalLocation(winrt.system.Object):
    ...
    @_property
    def address(self) -> typing.Optional[windows_services_maps.MapAddress]: ...
    @_property
    ...
    @_property
    def point(self) -> typing.Optional[windows_devices_geolocation.Geopoint]: ...
    @_property
    def category(self) -> str: ...
    @_property
    def hours_of_operation(self) -> typing.Optional[windows_foundation_collections.IVectorView[LocalLocationHoursOfOperationItem]]: ...
    @_property
    def rating_info(self) -> typing.Optional[LocalLocationRatingInfo]: ...

@typing.final
class LocalLocationFinder_Static(type):
    def find_local_locations_async(cls, search_term: str, search_area: typing.Optional[windows_devices_geolocation.Geocircle], local_category: str, max_results: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[LocalLocationFinderResult]: ...
...
class LocalLocationFinderResult(winrt.system.Object):
    ...
    @_property
    def local_locations(self) -> typing.Optional[windows_foundation_collections.IVectorView[LocalLocation]]: ...
    @_property
...
class PlaceInfoHelper_Static(type):
    def create_from_local_location(cls, location: typing.Optional[LocalLocation], /) -> typing.Optional[windows_services_maps.PlaceInfo]: ...
