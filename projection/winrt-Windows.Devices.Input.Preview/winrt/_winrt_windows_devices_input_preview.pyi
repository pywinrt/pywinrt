...
class GazeDevicePreview(winrt.system.Object):
    ...
    def get_boolean_control_descriptions(self, usage_page: winrt.system.UInt16, usage_id: winrt.system.UInt16, /) -> windows_foundation_collections.IVectorView[windows_devices_humaninterfacedevice.HidBooleanControlDescription]: ...
    def get_numeric_control_descriptions(self, usage_page: winrt.system.UInt16, usage_id: winrt.system.UInt16, /) -> windows_foundation_collections.IVectorView[windows_devices_humaninterfacedevice.HidNumericControlDescription]: ...
...
class GazeMovedPreviewEventArgs(winrt.system.Object):
    ...
    def get_intermediate_points(self) -> windows_foundation_collections.IVector[GazePointPreview]: ...
    @_property
    def handled(self) -> bool: ...
    @handled.setter
    def handled(self, value: bool) -> None: ...
