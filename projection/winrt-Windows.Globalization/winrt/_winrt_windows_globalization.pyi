...
class ApplicationLanguages_Static(type):
    def get_languages_for_user(cls, user: windows_system.User, /) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def primary_language_override(cls) -> str: ...
    @primary_language_override.setter
    def primary_language_override(cls, value: str) -> None: ...
    @_property
    def languages(cls) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def manifest_languages(cls) -> windows_foundation_collections.IVectorView[str]: ...
...
class Calendar(winrt.system.Object):
    ...
    @_property
    def languages(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
...
class GeographicRegion(winrt.system.Object, metaclass=GeographicRegion_Static):
    ...
    @_property
    def currencies_in_use(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
...
class JapanesePhoneticAnalyzer_Static(type):
    def get_words(cls, input: str, /) -> windows_foundation_collections.IVectorView[JapanesePhoneme]: ...
    def get_words_with_mono_ruby_option(cls, input: str, mono_ruby: bool, /) -> windows_foundation_collections.IVectorView[JapanesePhoneme]: ...
...
class Language_Static(type):
    def get_mui_compatible_language_list_from_language_tags(cls, language_tags: typing.Iterable[str], /) -> windows_foundation_collections.IVector[str]: ...
...
class Language(winrt.system.Object, metaclass=Language_Static):
    ...
    def get_extension_subtags(self, singleton: str, /) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def display_name(self) -> str: ...
    @_property
