...
class ApplicationLanguages_Static(type):
    def get_languages_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
...
class GeographicRegion(winrt.system.Object, metaclass=GeographicRegion_Static):
    ...
    @_property
    def currencies_in_use(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
...
class JapanesePhoneticAnalyzer_Static(type):
    def get_words(cls, input: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[JapanesePhoneme]]: ...
    def get_words_with_mono_ruby_option(cls, input: str, mono_ruby: bool, /) -> typing.Optional[windows_foundation_collections.IVectorView[JapanesePhoneme]]: ...
...
class Language_Static(type):
    def get_mui_compatible_language_list_from_language_tags(cls, language_tags: typing.Iterable[str], /) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class Language(winrt.system.Object, metaclass=Language_Static):
    ...
    def get_extension_subtags(self, singleton: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
    def display_name(self) -> str: ...
    @_property
