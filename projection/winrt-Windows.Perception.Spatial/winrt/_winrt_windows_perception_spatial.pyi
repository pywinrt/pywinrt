...
class SpatialAnchor_Static(type):
    ...
    def try_create_with_position_and_orientation_relative_to(cls, coordinate_system: typing.Optional[SpatialCoordinateSystem], position: windows_foundation_numerics.Vector3, orientation: windows_foundation_numerics.Quaternion, /) -> typing.Optional[SpatialAnchor]: ...
    def try_create_with_position_relative_to(cls, coordinate_system: typing.Optional[SpatialCoordinateSystem], position: windows_foundation_numerics.Vector3, /) -> typing.Optional[SpatialAnchor]: ...
...
class SpatialEntityStore_Static(type):
    def try_get_for_remote_system_session(cls, session: typing.Optional[windows_system_remotesystems.RemoteSystemSession], /) -> typing.Optional[SpatialEntityStore]: ...
    @_property
...
class SpatialLocator(winrt.system.Object, metaclass=SpatialLocator_Static):
    ...
    def create_attached_frame_of_reference_at_current_heading_with_position(self, relative_position: windows_foundation_numerics.Vector3, /) -> typing.Optional[SpatialLocatorAttachedFrameOfReference]: ...
    def create_attached_frame_of_reference_at_current_heading_with_position_and_orientation(self, relative_position: windows_foundation_numerics.Vector3, relative_orientation: windows_foundation_numerics.Quaternion, /) -> typing.Optional[SpatialLocatorAttachedFrameOfReference]: ...
    def create_attached_frame_of_reference_at_current_heading_with_position_and_orientation_and_relative_heading(self, relative_position: windows_foundation_numerics.Vector3, relative_orientation: windows_foundation_numerics.Quaternion, relative_heading_in_radians: winrt.system.Double, /) -> typing.Optional[SpatialLocatorAttachedFrameOfReference]: ...
    def create_stationary_frame_of_reference_at_current_location(self) -> typing.Optional[SpatialStationaryFrameOfReference]: ...
    def create_stationary_frame_of_reference_at_current_location_with_position(self, relative_position: windows_foundation_numerics.Vector3, /) -> typing.Optional[SpatialStationaryFrameOfReference]: ...
    def create_stationary_frame_of_reference_at_current_location_with_position_and_orientation(self, relative_position: windows_foundation_numerics.Vector3, relative_orientation: windows_foundation_numerics.Quaternion, /) -> typing.Optional[SpatialStationaryFrameOfReference]: ...
    def create_stationary_frame_of_reference_at_current_location_with_position_and_orientation_and_relative_heading(self, relative_position: windows_foundation_numerics.Vector3, relative_orientation: windows_foundation_numerics.Quaternion, relative_heading_in_radians: winrt.system.Double, /) -> typing.Optional[SpatialStationaryFrameOfReference]: ...
