...
class SpatialAnchor_Static(type):
    def try_create_relative_to(cls, coordinate_system: SpatialCoordinateSystem, /) -> SpatialAnchor: ...
    def try_create_with_position_and_orientation_relative_to(cls, coordinate_system: SpatialCoordinateSystem, position: windows_foundation_numerics.Vector3, orientation: windows_foundation_numerics.Quaternion, /) -> SpatialAnchor: ...
    def try_create_with_position_relative_to(cls, coordinate_system: SpatialCoordinateSystem, position: windows_foundation_numerics.Vector3, /) -> SpatialAnchor: ...
...
class SpatialAnchorStore(winrt.system.Object):
    ...
    def clear(self) -> None: ...
    def get_all_saved_anchors(self) -> windows_foundation_collections.IMapView[str, SpatialAnchor]: ...
...
class SpatialAnchorTransferManager_Static(type):
    ...
    def try_import_anchors_async(cls, stream: windows_storage_streams.IInputStream, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IMapView[str, SpatialAnchor]]: ...
...
class SpatialEntity(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SpatialEntity], spatial_anchor: SpatialAnchor) -> SpatialEntity: ...
    @typing.overload
    def __new__(cls: typing.Type[SpatialEntity], spatial_anchor: SpatialAnchor, property_set: windows_foundation_collections.ValueSet) -> SpatialEntity: ...
    @_property
...
class SpatialEntityStore_Static(type):
    def try_get_for_remote_system_session(cls, session: windows_system_remotesystems.RemoteSystemSession, /) -> SpatialEntityStore: ...
    @_property
...
class SpatialLocator(winrt.system.Object, metaclass=SpatialLocator_Static):
    ...
    def try_locate_at_timestamp(self, timestamp: windows_perception.PerceptionTimestamp, coordinate_system: SpatialCoordinateSystem, /) -> SpatialLocation: ...
