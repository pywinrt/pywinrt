...
from . import SpatialAnchorExportPurpose, SpatialEntityWatcherStatus, SpatialLocatability, SpatialLookDirectionRange, SpatialMovementRange, SpatialPerceptionAccessStatus
...
class SpatialAnchorTransferManager(winrt.system.Object):
    ...
    def request_access_async() -> winrt.windows.foundation.IAsyncOperation[SpatialPerceptionAccessStatus]: ...
    @staticmethod
    def try_export_anchors_async(anchors: typing.Iterable[winrt.windows.foundation.collections.IKeyValuePair[str, SpatialAnchor]], stream: typing.Optional[winrt.windows.storage.streams.IOutputStream], /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
    @staticmethod
