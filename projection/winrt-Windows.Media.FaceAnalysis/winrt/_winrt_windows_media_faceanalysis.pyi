...
class FaceDetector_Static(type):
    ...
    def get_supported_bitmap_pixel_formats(cls) -> windows_foundation_collections.IVectorView[windows_graphics_imaging.BitmapPixelFormat]: ...
...
class FaceDetector(winrt.system.Object, metaclass=FaceDetector_Static):
    ...
    def detect_faces_async(self, image: windows_graphics_imaging.SoftwareBitmap, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVector[DetectedFace]]: ...
    def detect_faces_with_search_area_async(self, image: windows_graphics_imaging.SoftwareBitmap, search_area: windows_graphics_imaging.BitmapBounds, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVector[DetectedFace]]: ...
    @_property
...
class FaceTracker(winrt.system.Object, metaclass=FaceTracker_Static):
    ...
    def process_next_frame_async(self, video_frame: windows_media.VideoFrame, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVector[DetectedFace]]: ...
    @_property
    def min_detectable_face_size(self) -> windows_graphics_imaging.BitmapSize: ...
    @min_detectable_face_size.setter
    def min_detectable_face_size(self, value: windows_graphics_imaging.BitmapSize) -> None: ...
