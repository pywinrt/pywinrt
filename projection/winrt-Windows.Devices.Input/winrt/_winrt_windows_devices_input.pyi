...
class PointerDevice_Static(type):
    ...
    def get_pointer_devices(cls) -> typing.Optional[windows_foundation_collections.IVectorView[PointerDevice]]: ...
...
class PointerDevice(winrt.system.Object, metaclass=PointerDevice_Static):
    ...
    @_property
    def supported_usages(self) -> typing.Optional[windows_foundation_collections.IVectorView[PointerDeviceUsage]]: ...
    @_property
