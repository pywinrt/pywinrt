...
class BluetoothLEAdvertisement(winrt.system.Object):
    ...
    def get_manufacturer_data_by_company_id(self, company_id: winrt.system.UInt16, /) -> windows_foundation_collections.IVectorView[BluetoothLEManufacturerData]: ...
    def get_sections_by_type(self, type: winrt.system.UInt8, /) -> windows_foundation_collections.IVectorView[BluetoothLEAdvertisementDataSection]: ...
    @_property
    ...
    @_property
    def data_sections(self) -> windows_foundation_collections.IVector[BluetoothLEAdvertisementDataSection]: ...
    @_property
    def manufacturer_data(self) -> windows_foundation_collections.IVector[BluetoothLEManufacturerData]: ...
    @_property
    def service_uuids(self) -> windows_foundation_collections.IVector[_uuid.UUID]: ...
...
class BluetoothLEAdvertisementBytePattern(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEAdvertisementBytePattern], data_type: winrt.system.UInt8, offset: winrt.system.Int16, data: windows_storage_streams.IBuffer) -> BluetoothLEAdvertisementBytePattern: ...
    @_property
...
class BluetoothLEAdvertisementDataSection(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEAdvertisementDataSection], data_type: winrt.system.UInt8, data: windows_storage_streams.IBuffer) -> BluetoothLEAdvertisementDataSection: ...
    @_property
    def data_type(self) -> winrt.system.UInt8: ...
    @data_type.setter
    def data_type(self, value: winrt.system.UInt8) -> None: ...
...
class BluetoothLEAdvertisementFilter(winrt.system.Object):
    ...
    @_property
    def byte_patterns(self) -> windows_foundation_collections.IVector[BluetoothLEAdvertisementBytePattern]: ...
...
class BluetoothLEAdvertisementPublisher(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEAdvertisementPublisher], advertisement: BluetoothLEAdvertisement) -> BluetoothLEAdvertisementPublisher: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
...
class BluetoothLEAdvertisementReceivedEventArgs(winrt.system.Object):
    ...
    @_property
    def transmit_power_level_in_d_bm(self) -> typing.Optional[winrt.system.Int16]: ...
...
class BluetoothLEAdvertisementWatcher(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEAdvertisementWatcher], advertisement_filter: BluetoothLEAdvertisementFilter) -> BluetoothLEAdvertisementWatcher: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
...
class BluetoothLEManufacturerData(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEManufacturerData], company_id: winrt.system.UInt16, data: windows_storage_streams.IBuffer) -> BluetoothLEManufacturerData: ...
    @_property
    def data(self) -> windows_storage_streams.IBuffer: ...
    @data.setter
    def data(self, value: windows_storage_streams.IBuffer) -> None: ...
