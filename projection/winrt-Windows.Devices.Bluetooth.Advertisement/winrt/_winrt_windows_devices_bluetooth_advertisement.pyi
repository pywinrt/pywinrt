...
class BluetoothLEAdvertisementBytePattern(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEAdvertisementBytePattern], data_type: winrt.system.UInt8, offset: winrt.system.Int16, data: windows_storage_streams.ImplementsIBuffer) -> BluetoothLEAdvertisementBytePattern: ...
    @_property
...
class BluetoothLEAdvertisementDataSection(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEAdvertisementDataSection], data_type: winrt.system.UInt8, data: windows_storage_streams.ImplementsIBuffer) -> BluetoothLEAdvertisementDataSection: ...
    @_property
    def data_type(self) -> winrt.system.UInt8: ...
    @data_type.setter
    def data_type(self, value: winrt.system.UInt8) -> None: ...
...
class BluetoothLEManufacturerData(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BluetoothLEManufacturerData], company_id: winrt.system.UInt16, data: windows_storage_streams.ImplementsIBuffer) -> BluetoothLEManufacturerData: ...
    @_property
    def data(self) -> windows_storage_streams.IBuffer: ...
    @data.setter
    def data(self, value: windows_storage_streams.IBuffer) -> None: ...
