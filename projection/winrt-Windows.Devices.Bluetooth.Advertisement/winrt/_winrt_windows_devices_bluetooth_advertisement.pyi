...
class BluetoothLEAdvertisementBytePattern(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: typing.Type[Self], data_type: winrt.system.UInt8, offset: winrt.system.Int16, data: windows_storage_streams.ImplementsIBuffer) -> Self: ...
    @_property
...
class BluetoothLEAdvertisementDataSection(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: typing.Type[Self], data_type: winrt.system.UInt8, data: windows_storage_streams.ImplementsIBuffer) -> Self: ...
    @_property
    def data_type(self) -> winrt.system.UInt8: ...
    @data_type.setter
    def data_type(self, value: winrt.system.UInt8) -> None: ...
...
class BluetoothLEManufacturerData(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: typing.Type[Self], company_id: winrt.system.UInt16, data: windows_storage_streams.ImplementsIBuffer) -> Self: ...
    @_property
    def data(self) -> windows_storage_streams.IBuffer: ...
    @data.setter
    def data(self, value: windows_storage_streams.ImplementsIBuffer) -> None: ...
