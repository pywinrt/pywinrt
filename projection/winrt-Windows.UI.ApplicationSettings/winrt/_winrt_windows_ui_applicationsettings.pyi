...
class AccountsSettingsPaneCommandsRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def commands(self) -> windows_foundation_collections.IVector[SettingsCommand]: ...
    @_property
    def credential_commands(self) -> windows_foundation_collections.IVector[CredentialCommand]: ...
    @_property
    def web_account_commands(self) -> windows_foundation_collections.IVector[WebAccountCommand]: ...
    @_property
    def web_account_provider_commands(self) -> windows_foundation_collections.IVector[WebAccountProviderCommand]: ...
    @_property
...
class SettingsPaneCommandsRequest(winrt.system.Object):
    ...
    @_property
    def application_commands(self) -> windows_foundation_collections.IVector[SettingsCommand]: ...
