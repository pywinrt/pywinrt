...
PyMODINIT_FUNC PyInit__winrt_windows_ui_shell(void) noexcept
{
    ...
    py::pyobj_handle AdaptiveCardBuilder_type{py::register_python_type(module.get(), &type_spec_AdaptiveCardBuilder, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_AdaptiveCardBuilder_Static.get()))};
    if (!AdaptiveCardBuilder_type)
    {
        return nullptr;
    }

    py::pyobj_handle FocusSession_type{py::register_python_type(module.get(), &type_spec_FocusSession, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle FocusSessionManager_type{py::register_python_type(module.get(), &type_spec_FocusSessionManager, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_FocusSessionManager_Static.get()))};
    if (!FocusSessionManager_type)
    {
        return nullptr;
    }

    py::pyobj_handle SecurityAppManager_type{py::register_python_type(module.get(), &type_spec_SecurityAppManager, object_bases.get(), nullptr)};
    if (!SecurityAppManager_type)
    {
        return nullptr;
    }

    py::pyobj_handle ShareWindowCommandEventArgs_type{py::register_python_type(module.get(), &type_spec_ShareWindowCommandEventArgs, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle ShareWindowCommandSource_type{py::register_python_type(module.get(), &type_spec_ShareWindowCommandSource, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_ShareWindowCommandSource_Static.get()))};
    ...
    py::pyobj_handle TaskbarManager_type{py::register_python_type(module.get(), &type_spec_TaskbarManager, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_TaskbarManager_Static.get()))};
    if (!TaskbarManager_type)
    {
        return nullptr;
    }

    py::pyobj_handle WindowTab_type{py::register_python_type(module.get(), &type_spec_WindowTab, object_bases.get(), nullptr)};
    if (!WindowTab_type)
    {
        return nullptr;
    }

    py::pyobj_handle WindowTabCloseRequestedEventArgs_type{py::register_python_type(module.get(), &type_spec_WindowTabCloseRequestedEventArgs, object_bases.get(), nullptr)};
    if (!WindowTabCloseRequestedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle WindowTabCollection_type{py::register_python_type(module.get(), &type_spec_WindowTabCollection, object_bases.get(), nullptr)};
    if (!WindowTabCollection_type)
    {
        return nullptr;
    }

    py::pyobj_handle WindowTabGroup_type{py::register_python_type(module.get(), &type_spec_WindowTabGroup, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle WindowTabIcon_type{py::register_python_type(module.get(), &type_spec_WindowTabIcon, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_WindowTabIcon_Static.get()))};
    ...
    py::pyobj_handle WindowTabManager_type{py::register_python_type(module.get(), &type_spec_WindowTabManager, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_WindowTabManager_Static.get()))};
    if (!WindowTabManager_type)
    {
        return nullptr;
    }

    py::pyobj_handle WindowTabSwitchRequestedEventArgs_type{py::register_python_type(module.get(), &type_spec_WindowTabSwitchRequestedEventArgs, object_bases.get(), nullptr)};
    if (!WindowTabSwitchRequestedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle WindowTabTearOutRequestedEventArgs_type{py::register_python_type(module.get(), &type_spec_WindowTabTearOutRequestedEventArgs, object_bases.get(), nullptr)};
    if (!WindowTabTearOutRequestedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle WindowTabThumbnailRequestedEventArgs_type{py::register_python_type(module.get(), &type_spec_WindowTabThumbnailRequestedEventArgs, object_bases.get(), nullptr)};
    if (!WindowTabThumbnailRequestedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle IAdaptiveCard_type{py::register_python_type(module.get(), &type_spec_IAdaptiveCard, object_bases.get(), nullptr)};
    if (!IAdaptiveCard_type)
    {
        return nullptr;
    }

    py::pyobj_handle IAdaptiveCardBuilderStatics_type{py::register_python_type(module.get(), &type_spec_IAdaptiveCardBuilderStatics, object_bases.get(), nullptr)};
