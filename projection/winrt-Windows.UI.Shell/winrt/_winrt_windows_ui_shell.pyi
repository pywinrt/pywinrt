...
class FocusSessionManager(winrt.system.Object, metaclass=FocusSessionManager_Static):
    ...
    def try_start_focus_session(self) -> FocusSession: ...
    def try_start_focus_session2(self, end_time: datetime.datetime, /) -> FocusSession: ...
...
class WindowTabCollection(winrt.system.Object, winrt._winrt.MutableSequence[WindowTab]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[WindowTab]: ...
