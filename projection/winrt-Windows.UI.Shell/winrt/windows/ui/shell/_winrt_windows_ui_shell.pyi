...
class SecurityAppManager(winrt.system.Object):
    ...
    def register(self, kind: SecurityAppKind, display_name: str, details_uri: typing.Optional[winrt.windows.foundation.Uri], register_per_user: winrt.system.Boolean, /) -> uuid.UUID: ...
