...
class FocusSessionManager(winrt.system.Object):
    is_focus_active: winrt.system.Boolean
...
class SecurityAppManager(winrt.system.Object):
    ...
    def register(self, kind: SecurityAppKind, display_name: str, details_uri: typing.Optional[winrt.windows.foundation.Uri], register_per_user: winrt.system.Boolean, /) -> winrt.system.Guid: ...
    def unregister(self, kind: SecurityAppKind, guid_registration: winrt.system.Guid, /) -> None: ...
    def update_state(self, kind: SecurityAppKind, guid_registration: winrt.system.Guid, state: SecurityAppState, substatus: SecurityAppSubstatus, details_uri: typing.Optional[winrt.windows.foundation.Uri], /) -> None: ...
...
class TaskbarManager(winrt.system.Object):
    is_pinning_allowed: winrt.system.Boolean
    ...
    def is_app_list_entry_pinned_async(self, app_list_entry: typing.Optional[winrt.windows.applicationmodel.core.AppListEntry], /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def is_current_app_pinned_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def is_secondary_tile_pinned_async(self, tile_id: str, /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def request_pin_app_list_entry_async(self, app_list_entry: typing.Optional[winrt.windows.applicationmodel.core.AppListEntry], /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def request_pin_current_app_async(self) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def request_pin_secondary_tile_async(self, secondary_tile: typing.Optional[winrt.windows.ui.startscreen.SecondaryTile], /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
    def try_unpin_secondary_tile_async(self, tile_id: str, /) -> winrt.windows.foundation.IAsyncOperation[winrt.system.Boolean]: ...
...
class WindowTabCollection(winrt.system.Object, typing.MutableSequence[WindowTab]):
    ...
    def index_of(self, value: typing.Optional[WindowTab], /) -> typing.Tuple[winrt.system.Boolean, winrt.system.UInt32]: ...
...
class WindowTabManager(winrt.system.Object):
    ...
    @staticmethod
    def is_tab_tear_out_supported() -> winrt.system.Boolean: ...
...
class WindowTabThumbnailRequestedEventArgs(winrt.system.Object):
    ...
    is_composited_on_window: winrt.system.Boolean
