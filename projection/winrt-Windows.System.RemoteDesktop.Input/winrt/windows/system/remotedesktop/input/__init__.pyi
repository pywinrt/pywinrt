...
class RemoteTextConnection(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[RemoteTextConnection], connection_id: winrt.system.Guid, pdu_forwarder: typing.Optional[RemoteTextConnectionDataHandler]) -> RemoteTextConnection:...
    def close(self) -> None: ...
