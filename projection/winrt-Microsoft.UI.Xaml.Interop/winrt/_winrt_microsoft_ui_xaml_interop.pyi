...
class IBindableObservableVector(winrt.system.Object):
    ...
    def add_vector_changed(self, handler: typing.Optional[BindableVectorChangedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
...
class INotifyCollectionChanged(winrt.system.Object):
    ...
    def add_collection_changed(self, handler: typing.Optional[NotifyCollectionChangedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
