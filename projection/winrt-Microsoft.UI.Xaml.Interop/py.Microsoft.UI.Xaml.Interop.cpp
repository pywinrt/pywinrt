...
namespace py::cpp::Microsoft::UI::Xaml::Interop
{
    ...
    struct PyWinrtNotifyCollectionChangedEventArgs : py::py_obj_ref, winrt::Microsoft::UI::Xaml::Interop::NotifyCollectionChangedEventArgsT<PyWinrtNotifyCollectionChangedEventArgs>
    {
        PyWinrtNotifyCollectionChangedEventArgs(PyObject* py_obj, winrt::Microsoft::UI::Xaml::Interop::NotifyCollectionChangedAction action, winrt::Microsoft::UI::Xaml::Interop::IBindableVector newItems, winrt::Microsoft::UI::Xaml::Interop::IBindableVector oldItems, int32_t newIndex, int32_t oldIndex) : py::py_obj_ref(py_obj), winrt::Microsoft::UI::Xaml::Interop::NotifyCollectionChangedEventArgsT<PyWinrtNotifyCollectionChangedEventArgs>(action, newItems, oldItems, newIndex, oldIndex) {}
