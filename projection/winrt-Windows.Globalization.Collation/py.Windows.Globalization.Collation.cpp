...
PyMODINIT_FUNC PyInit__winrt_windows_globalization_collation(void) noexcept
{
    ...
    py::pyobj_handle CharacterGrouping_type{py::register_python_type(module.get(), &type_spec_CharacterGrouping, object_bases.get(), nullptr)};
    if (!CharacterGrouping_type)
    {
        return nullptr;
    }

    py::pyobj_handle CharacterGroupings_type{py::register_python_type(module.get(), &type_spec_CharacterGroupings, object_bases.get(), nullptr)};
