...
PyMODINIT_FUNC PyInit__winrt_Windows_Globalization_Collation(void) noexcept
{
    ...
    state->type_CharacterGrouping = py::register_python_type(module.get(), type_name_CharacterGrouping, &type_spec_CharacterGrouping, object_bases.get(), nullptr);
    if (!state->type_CharacterGrouping)
    {
        return nullptr;
    }

    state->type_CharacterGroupings = py::register_python_type(module.get(), type_name_CharacterGroupings, &type_spec_CharacterGroupings, object_bases.get(), nullptr);
