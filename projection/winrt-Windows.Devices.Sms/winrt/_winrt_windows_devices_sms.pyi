...
class GetSmsDeviceOperation(winrt.system.Object):
    ...
    def status(self) -> windows_foundation.AsyncStatus: ...
    @_property
    def completed(self) -> typing.Optional[windows_foundation.AsyncOperationCompletedHandler[SmsDevice]]: ...
    @completed.setter
    def completed(self, value: typing.Optional[windows_foundation.AsyncOperationCompletedHandler[SmsDevice]]) -> None: ...
...
class GetSmsMessageOperation(winrt.system.Object):
    ...
    def status(self) -> windows_foundation.AsyncStatus: ...
    @_property
    def completed(self) -> typing.Optional[windows_foundation.AsyncOperationCompletedHandler[ISmsMessage]]: ...
    @completed.setter
    def completed(self, value: typing.Optional[windows_foundation.AsyncOperationCompletedHandler[ISmsMessage]]) -> None: ...

@typing.final
class GetSmsMessagesOperation(winrt.system.Object):
    def __await__(self) -> typing.Generator[typing.Any, None, typing.Optional[windows_foundation_collections.IVectorView[ISmsMessage]]]: ...
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> GetSmsMessagesOperation: ...
    def cancel(self) -> None: ...
    def close(self) -> None: ...
    def get_results(self) -> typing.Optional[windows_foundation_collections.IVectorView[ISmsMessage]]: ...
    @_property
    def error_code(self) -> windows_foundation.HResult: ...
    @_property
    def id(self) -> winrt.system.UInt32: ...
    ...
    def status(self) -> windows_foundation.AsyncStatus: ...
    @_property
    def progress(self) -> typing.Optional[windows_foundation.AsyncOperationProgressHandler[windows_foundation_collections.IVectorView[ISmsMessage], winrt.system.Int32]]: ...
    @progress.setter
    def progress(self, value: typing.Optional[windows_foundation.AsyncOperationProgressHandler[windows_foundation_collections.IVectorView[ISmsMessage], winrt.system.Int32]]) -> None: ...
    @_property
    def completed(self) -> typing.Optional[windows_foundation.AsyncOperationWithProgressCompletedHandler[windows_foundation_collections.IVectorView[ISmsMessage], winrt.system.Int32]]: ...
    @completed.setter
    def completed(self, value: typing.Optional[windows_foundation.AsyncOperationWithProgressCompletedHandler[windows_foundation_collections.IVectorView[ISmsMessage], winrt.system.Int32]]) -> None: ...
...
class SmsAppMessage(winrt.system.Object):
    ...
    @_property
    def binary_body(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @binary_body.setter
    def binary_body(self, value: typing.Optional[windows_storage_streams.IBuffer]) -> None: ...
    @_property
    def to(self) -> str: ...
    @to.setter
...
class SmsDevice(winrt.system.Object, metaclass=SmsDevice_Static):
    ...
    def add_sms_device_status_changed(self, event_handler: typing.Optional[SmsDeviceStatusChangedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_sms_device_status_changed(self, event_cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_sms_message_received(self, event_handler: typing.Optional[SmsMessageReceivedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
...
class SmsDevice2(winrt.system.Object, metaclass=SmsDevice2_Static):
    ...
    def send_message_and_get_result_async(self, message: typing.Optional[ISmsMessageBase], /) -> windows_foundation.IAsyncOperation[SmsSendMessageResult]: ...
...
class SmsDeviceMessageStore(winrt.system.Object):
    ...
    def get_messages_async(self, message_filter: SmsMessageFilter, /) -> windows_foundation.IAsyncOperationWithProgress[windows_foundation_collections.IVectorView[ISmsMessage], winrt.system.Int32]: ...
    @_property
...
class SmsFilterRule(winrt.system.Object):
    ...
    @_property
    def broadcast_channels(self) -> typing.Optional[windows_foundation_collections.IVector[winrt.system.Int32]]: ...
    @_property
    def broadcast_types(self) -> typing.Optional[windows_foundation_collections.IVector[SmsBroadcastType]]: ...
    @_property
    def device_ids(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def imsi_prefixes(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def message_type(self) -> SmsMessageType: ...
    @_property
    def port_numbers(self) -> typing.Optional[windows_foundation_collections.IVector[winrt.system.Int32]]: ...
    @_property
    def protocol_ids(self) -> typing.Optional[windows_foundation_collections.IVector[winrt.system.Int32]]: ...
    @_property
    def sender_numbers(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def teleservice_ids(self) -> typing.Optional[windows_foundation_collections.IVector[winrt.system.Int32]]: ...
    @_property
    def text_message_prefixes(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def wap_application_ids(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def wap_content_types(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class SmsFilterRules(winrt.system.Object):
    ...
    @_property
    def rules(self) -> typing.Optional[windows_foundation_collections.IVector[SmsFilterRule]]: ...
...
class SmsMessageRegistration_Static(type):
    ...
    @_property
    def all_registrations(cls) -> typing.Optional[windows_foundation_collections.IVectorView[SmsMessageRegistration]]: ...
...
class SmsSendMessageResult(winrt.system.Object):
    ...
    @_property
    def message_reference_numbers(self) -> typing.Optional[windows_foundation_collections.IVectorView[winrt.system.Int32]]: ...
    @_property
...
class SmsTextMessage_Static(type):
    def from_binary_data(cls, format: SmsDataFormat, value: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> typing.Optional[SmsTextMessage]: ...
...
class SmsTextMessage(winrt.system.Object, metaclass=SmsTextMessage_Static):
    ...
    def to_binary_messages(self, format: SmsDataFormat, /) -> typing.Optional[windows_foundation_collections.IVectorView[ISmsBinaryMessage]]: ...
    @_property
    def id(self) -> winrt.system.UInt32: ...
    @_property
    def message_class(self) -> SmsMessageClass: ...
...
class SmsWapMessage(winrt.system.Object):
    ...
    def from_(self) -> str: ...
    @_property
    def headers(self) -> typing.Optional[windows_foundation_collections.IMap[str, str]]: ...
    @_property
    def to(self) -> str: ...
