...
class GetSmsMessagesOperation(winrt.system.Object):
    def __await__(self) -> typing.Generator[typing.Any, None, windows_foundation_collections.IVectorView[ISmsMessage]]: ...
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> GetSmsMessagesOperation: ...
    def cancel(self) -> None: ...
    def close(self) -> None: ...
    def get_results(self) -> windows_foundation_collections.IVectorView[ISmsMessage]: ...
    @_property
    def error_code(self) -> windows_foundation.HResult: ...
    @_property
    def id(self) -> winrt.system.UInt32: ...
    ...
    def status(self) -> windows_foundation.AsyncStatus: ...
    @_property
    def progress(self) -> windows_foundation.AsyncOperationProgressHandler[windows_foundation_collections.IVectorView[ISmsMessage], winrt.system.Int32]: ...
    @progress.setter
    def progress(self, value: windows_foundation.AsyncOperationProgressHandler[windows_foundation_collections.IVectorView[ISmsMessage], winrt.system.Int32]) -> None: ...
    @_property
    def completed(self) -> windows_foundation.AsyncOperationWithProgressCompletedHandler[windows_foundation_collections.IVectorView[ISmsMessage], winrt.system.Int32]: ...
    @completed.setter
    def completed(self, value: windows_foundation.AsyncOperationWithProgressCompletedHandler[windows_foundation_collections.IVectorView[ISmsMessage], winrt.system.Int32]) -> None: ...
...
class SmsFilterRule(winrt.system.Object):
    ...
    @_property
    def broadcast_channels(self) -> windows_foundation_collections.IVector[winrt.system.Int32]: ...
    @_property
    def broadcast_types(self) -> windows_foundation_collections.IVector[SmsBroadcastType]: ...
    @_property
    def device_ids(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def imsi_prefixes(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def message_type(self) -> SmsMessageType: ...
    @_property
    def port_numbers(self) -> windows_foundation_collections.IVector[winrt.system.Int32]: ...
    @_property
    def protocol_ids(self) -> windows_foundation_collections.IVector[winrt.system.Int32]: ...
    @_property
    def sender_numbers(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def teleservice_ids(self) -> windows_foundation_collections.IVector[winrt.system.Int32]: ...
    @_property
    def text_message_prefixes(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def wap_application_ids(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def wap_content_types(self) -> windows_foundation_collections.IVector[str]: ...
...
class SmsFilterRules(winrt.system.Object):
    ...
    @_property
    def rules(self) -> windows_foundation_collections.IVector[SmsFilterRule]: ...
...
class SmsMessageRegistration_Static(type):
    ...
    @_property
    def all_registrations(cls) -> windows_foundation_collections.IVectorView[SmsMessageRegistration]: ...
...
class SmsSendMessageResult(winrt.system.Object):
    ...
    @_property
    def message_reference_numbers(self) -> windows_foundation_collections.IVectorView[winrt.system.Int32]: ...
    @_property
...
class SmsTextMessage(winrt.system.Object, metaclass=SmsTextMessage_Static):
    ...
    def to_binary_messages(self, format: SmsDataFormat, /) -> windows_foundation_collections.IVectorView[ISmsBinaryMessage]: ...
    @_property
    def id(self) -> winrt.system.UInt32: ...
    @_property
    def message_class(self) -> SmsMessageClass: ...
...
class SmsWapMessage(winrt.system.Object):
    ...
    def from_(self) -> str: ...
    @_property
    def headers(self) -> windows_foundation_collections.IMap[str, str]: ...
    @_property
    def to(self) -> str: ...
