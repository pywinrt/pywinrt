...
{
    auto type = py::get_python_type<winrt::Windows::Devices::Sms::SmsEncodedLength>();
    if (!type)
    {
        return nullptr;
    }
...
winrt::Windows::Devices::Sms::SmsEncodedLength py::converter<winrt::Windows::Devices::Sms::SmsEncodedLength>::convert_to(PyObject* obj)
{
    ...
    PyErr_SetString(PyExc_TypeError, "expecting winrt::Windows::Devices::Sms::SmsEncodedLength");
    throw python_exception();
}
...
namespace py::cpp::Windows::Devices::Sms
{
    struct module_state
    {
        PyObject* type_CellularClass;
        PyObject* type_SmsBroadcastType;
        PyObject* type_SmsDataFormat;
        PyObject* type_SmsDeviceStatus;
        PyObject* type_SmsEncoding;
    ...
    static PyObject* register_CellularClass(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_CellularClass)
        {
        ...
        state->type_CellularClass = type;
        Py_INCREF(state->type_CellularClass);


        Py_RETURN_NONE;
    }

    static PyObject* register_SmsBroadcastType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SmsBroadcastType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SmsBroadcastType = type;
        Py_INCREF(state->type_SmsBroadcastType);


        Py_RETURN_NONE;
    }

    static PyObject* register_SmsDataFormat(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SmsDataFormat)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SmsDataFormat = type;
        Py_INCREF(state->type_SmsDataFormat);


        Py_RETURN_NONE;
    }

    static PyObject* register_SmsDeviceStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SmsDeviceStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SmsDeviceStatus = type;
        Py_INCREF(state->type_SmsDeviceStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_SmsEncoding(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SmsEncoding)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SmsEncoding = type;
        Py_INCREF(state->type_SmsEncoding);


        Py_RETURN_NONE;
    }

    static PyObject* register_SmsFilterActionType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SmsFilterActionType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SmsFilterActionType = type;
        Py_INCREF(state->type_SmsFilterActionType);


        Py_RETURN_NONE;
    }

    static PyObject* register_SmsGeographicalScope(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SmsGeographicalScope)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SmsGeographicalScope = type;
        Py_INCREF(state->type_SmsGeographicalScope);


        Py_RETURN_NONE;
    }

    static PyObject* register_SmsMessageClass(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SmsMessageClass)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SmsMessageClass = type;
        Py_INCREF(state->type_SmsMessageClass);


        Py_RETURN_NONE;
    }

    static PyObject* register_SmsMessageFilter(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);
    ...
    static PyObject* register_SmsMessageType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SmsMessageType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SmsMessageType = type;
        Py_INCREF(state->type_SmsMessageType);


        Py_RETURN_NONE;
    }

    static PyObject* register_SmsModemErrorCode(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_SmsModemErrorCode)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_SmsModemErrorCode = type;
        Py_INCREF(state->type_SmsModemErrorCode);
    ...
    {
        "_winrt_Windows_Devices_Sms.DeleteSmsMessageOperation",
    ...
    {
        "_winrt_Windows_Devices_Sms.DeleteSmsMessagesOperation",
    ...
    {
        "_winrt_Windows_Devices_Sms.GetSmsDeviceOperation",
    ...
    {
        "_winrt_Windows_Devices_Sms.GetSmsMessageOperation",
    ...
    {
        "_winrt_Windows_Devices_Sms.GetSmsMessagesOperation",
    ...
    {
        "_winrt_Windows_Devices_Sms.SendSmsMessageOperation",
    ...
    {
        "_winrt_Windows_Devices_Sms.SmsBinaryMessage",
    ...
    {
        "_winrt_Windows_Devices_Sms.SmsDevice",
    ...
    {
        "_winrt_Windows_Devices_Sms.SmsDeviceMessageStore",
    ...
    {
        "_winrt_Windows_Devices_Sms.SmsMessageReceivedEventArgs",
    ...
    static PyGetSetDef getset_SmsMessageRegistration_Meta[] = {
        { "all_registrations", reinterpret_cast<getter>(SmsMessageRegistration_get_AllRegistrations), nullptr, nullptr, nullptr },
        { }
    };

    static PyType_Slot type_slots_SmsMessageRegistration_Meta[] = 
    {
        { Py_tp_base, reinterpret_cast<void*>(&PyType_Type) },
        { Py_tp_getset, reinterpret_cast<void*>(getset_SmsMessageRegistration_Meta) },
        { }
    };

    static PyType_Spec type_spec_SmsMessageRegistration_Meta =
    {
        "_winrt_Windows_Devices_Sms.SmsMessageRegistration_Meta",
        static_cast<int>(PyType_Type.tp_basicsize),
        static_cast<int>(PyType_Type.tp_itemsize),
        Py_TPFLAGS_DEFAULT,
        type_slots_SmsMessageRegistration_Meta
    };
    ...
    {
        "_winrt_Windows_Devices_Sms.SmsReceivedEventDetails",
    ...
    {
        "_winrt_Windows_Devices_Sms.SmsTextMessage",
    ...
    {
        "_winrt_Windows_Devices_Sms.ISmsBinaryMessage",
    ...
    {
        "_winrt_Windows_Devices_Sms.ISmsDevice",
    ...
    {
        "_winrt_Windows_Devices_Sms.ISmsMessage",
    ...
    {
        "_winrt_Windows_Devices_Sms.ISmsTextMessage",
    ...
    static PyMethodDef module_methods[] = {
        {"_register_CellularClass", register_CellularClass, METH_O, "registers type"},
        {"_register_SmsBroadcastType", register_SmsBroadcastType, METH_O, "registers type"},
        {"_register_SmsDataFormat", register_SmsDataFormat, METH_O, "registers type"},
        {"_register_SmsDeviceStatus", register_SmsDeviceStatus, METH_O, "registers type"},
        {"_register_SmsEncoding", register_SmsEncoding, METH_O, "registers type"},
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_CellularClass);
        Py_VISIT(state->type_SmsBroadcastType);
        Py_VISIT(state->type_SmsDataFormat);
        Py_VISIT(state->type_SmsDeviceStatus);
        Py_VISIT(state->type_SmsEncoding);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_CellularClass);
        Py_CLEAR(state->type_SmsBroadcastType);
        Py_CLEAR(state->type_SmsDataFormat);
        Py_CLEAR(state->type_SmsDeviceStatus);
        Py_CLEAR(state->type_SmsEncoding);
...
PyMODINIT_FUNC PyInit__winrt_Windows_Devices_Sms(void) noexcept
{
    ...
    py::pyobj_handle type_SmsMessageRegistration_Meta{PyType_FromSpec(&type_spec_SmsMessageRegistration_Meta)};
    if (!type_SmsMessageRegistration_Meta)
    {
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Devices::Sms::CellularClass>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Devices::Sms;
    ...
    auto python_type = state->type_CellularClass;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::Sms::CellularClass is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Devices::Sms::SmsBroadcastType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Devices::Sms;
    ...
    auto python_type = state->type_SmsBroadcastType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::Sms::SmsBroadcastType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Devices::Sms::SmsDataFormat>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Devices::Sms;
    ...
    auto python_type = state->type_SmsDataFormat;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::Sms::SmsDataFormat is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Devices::Sms::SmsDeviceStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Devices::Sms;
    ...
    auto python_type = state->type_SmsDeviceStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::Sms::SmsDeviceStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Devices::Sms::SmsEncoding>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Devices::Sms;
    ...
    auto python_type = state->type_SmsEncoding;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::Sms::SmsEncoding is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Devices::Sms::SmsFilterActionType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Devices::Sms;
    ...
    auto python_type = state->type_SmsFilterActionType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::Sms::SmsFilterActionType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Devices::Sms::SmsGeographicalScope>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Devices::Sms;
    ...
    auto python_type = state->type_SmsGeographicalScope;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::Sms::SmsGeographicalScope is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Devices::Sms::SmsMessageClass>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Devices::Sms;
    ...
    auto python_type = state->type_SmsMessageClass;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::Sms::SmsMessageClass is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Devices::Sms::SmsMessageType>::get_python_type() noexcept {
    ...
    auto python_type = state->type_SmsMessageType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::Sms::SmsMessageType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::Devices::Sms::SmsModemErrorCode>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Devices::Sms;
    ...
    auto python_type = state->type_SmsModemErrorCode;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::Sms::SmsModemErrorCode is not registered");
        return nullptr;
    }
