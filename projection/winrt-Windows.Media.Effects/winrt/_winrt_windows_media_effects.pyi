...
class AudioCaptureEffectsManager(winrt.system.Object):
    ...
    def get_audio_capture_effects(self) -> typing.Optional[windows_foundation_collections.IVectorView[AudioEffect]]: ...
...
class AudioEffectDefinition(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[AudioEffectDefinition], activatable_class_id: str, props: typing.Optional[windows_foundation_collections.IPropertySet]) -> AudioEffectDefinition: ...
    @_property
...
class AudioEffectsManager_Static(type):
    def create_audio_capture_effects_manager(cls, device_id: str, category: windows_media_capture.MediaCategory, /) -> typing.Optional[AudioCaptureEffectsManager]: ...
    def create_audio_capture_effects_manager_with_mode(cls, device_id: str, category: windows_media_capture.MediaCategory, mode: windows_media.AudioProcessing, /) -> typing.Optional[AudioCaptureEffectsManager]: ...
    def create_audio_render_effects_manager(cls, device_id: str, category: windows_media_render.AudioRenderCategory, /) -> typing.Optional[AudioRenderEffectsManager]: ...
    def create_audio_render_effects_manager_with_mode(cls, device_id: str, category: windows_media_render.AudioRenderCategory, mode: windows_media.AudioProcessing, /) -> typing.Optional[AudioRenderEffectsManager]: ...
...
class AudioRenderEffectsManager(winrt.system.Object):
    ...
    def get_audio_render_effects(self) -> typing.Optional[windows_foundation_collections.IVectorView[AudioEffect]]: ...
    ...
    @_property
    def effects_provider_thumbnail(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamWithContentType]: ...

@typing.final
class CompositeVideoFrameContext(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> CompositeVideoFrameContext: ...
    def get_overlay_for_surface(self, surface_to_overlay: typing.Optional[windows_graphics_directx_direct3d11.IDirect3DSurface], /) -> typing.Optional[windows_media_editing.MediaOverlay]: ...
    @_property
    def background_frame(self) -> typing.Optional[windows_media.VideoFrame]: ...
    @_property
    def output_frame(self) -> typing.Optional[windows_media.VideoFrame]: ...
    @_property
    def surfaces_to_overlay(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_graphics_directx_direct3d11.IDirect3DSurface]]: ...
...
class ProcessAudioFrameContext(winrt.system.Object):
    ...
    @_property
    def input_frame(self) -> typing.Optional[windows_media.AudioFrame]: ...
    @_property
    def output_frame(self) -> typing.Optional[windows_media.AudioFrame]: ...
...
class ProcessVideoFrameContext(winrt.system.Object):
    ...
    @_property
    def input_frame(self) -> typing.Optional[windows_media.VideoFrame]: ...
    @_property
    def output_frame(self) -> typing.Optional[windows_media.VideoFrame]: ...
...
class VideoCompositorDefinition(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[VideoCompositorDefinition], activatable_class_id: str, props: typing.Optional[windows_foundation_collections.IPropertySet]) -> VideoCompositorDefinition: ...
    @_property
    def activatable_class_id(self) -> str: ...
    @_property
    def properties(self) -> typing.Optional[windows_foundation_collections.IPropertySet]: ...
...
class VideoEffectDefinition(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[VideoEffectDefinition], activatable_class_id: str, props: typing.Optional[windows_foundation_collections.IPropertySet]) -> VideoEffectDefinition: ...
    @_property
    def activatable_class_id(self) -> str: ...
    @_property
    def properties(self) -> typing.Optional[windows_foundation_collections.IPropertySet]: ...
...
class IBasicAudioEffect(winrt.system.Object):
    ...
    def set_encoding_properties(self, encoding_properties: typing.Optional[windows_media_mediaproperties.AudioEncodingProperties], /) -> None: ...
    def set_properties(self, configuration: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
    @_property
    def supported_encoding_properties(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_media_mediaproperties.AudioEncodingProperties]]: ...
    @_property
...
class IBasicVideoEffect(winrt.system.Object):
    ...
    def set_encoding_properties(self, encoding_properties: typing.Optional[windows_media_mediaproperties.VideoEncodingProperties], device: typing.Optional[windows_graphics_directx_direct3d11.IDirect3DDevice], /) -> None: ...
    def set_properties(self, configuration: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
    @_property
    def is_read_only(self) -> bool: ...
    @_property
    def supported_encoding_properties(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_media_mediaproperties.VideoEncodingProperties]]: ...
    @_property
...
class IVideoCompositor(winrt.system.Object):
    ...
    def discard_queued_frames(self) -> None: ...
    def set_encoding_properties(self, background_properties: typing.Optional[windows_media_mediaproperties.VideoEncodingProperties], device: typing.Optional[windows_graphics_directx_direct3d11.IDirect3DDevice], /) -> None: ...
    def set_properties(self, configuration: typing.Optional[windows_foundation_collections.IPropertySet], /) -> None: ...
    @_property
    def time_independent(self) -> bool: ...
