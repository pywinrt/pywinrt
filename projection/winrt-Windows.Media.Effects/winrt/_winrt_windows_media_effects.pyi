...
class AudioCaptureEffectsManager(winrt.system.Object):
    ...
    def get_audio_capture_effects(self) -> windows_foundation_collections.IVectorView[AudioEffect]: ...
...
class AudioEffectDefinition(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[AudioEffectDefinition], activatable_class_id: str, props: windows_foundation_collections.IPropertySet) -> AudioEffectDefinition: ...
    @_property
...
class AudioRenderEffectsManager(winrt.system.Object):
    ...
    def get_audio_render_effects(self) -> windows_foundation_collections.IVectorView[AudioEffect]: ...
...
class CompositeVideoFrameContext(winrt.system.Object):
    ...
    @_property
    def surfaces_to_overlay(self) -> windows_foundation_collections.IVectorView[windows_graphics_directx_direct3d11.IDirect3DSurface]: ...
...
class VideoCompositorDefinition(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[VideoCompositorDefinition], activatable_class_id: str, props: windows_foundation_collections.IPropertySet) -> VideoCompositorDefinition: ...
    @_property
    def activatable_class_id(self) -> str: ...
    @_property
    def properties(self) -> windows_foundation_collections.IPropertySet: ...
...
class VideoEffectDefinition(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[VideoEffectDefinition], activatable_class_id: str, props: windows_foundation_collections.IPropertySet) -> VideoEffectDefinition: ...
    @_property
    def activatable_class_id(self) -> str: ...
    @_property
    def properties(self) -> windows_foundation_collections.IPropertySet: ...
...
class IBasicAudioEffect(winrt.system.Object):
    ...
    @_property
    def supported_encoding_properties(self) -> windows_foundation_collections.IVectorView[windows_media_mediaproperties.AudioEncodingProperties]: ...
    @_property
...
class IBasicVideoEffect(winrt.system.Object):
    ...
    @_property
    def supported_encoding_properties(self) -> windows_foundation_collections.IVectorView[windows_media_mediaproperties.VideoEncodingProperties]: ...
    @_property
