...
class BluetoothLEAdvertisementPublisherTriggerDetails(winrt.system.Object):
    ...
    @_property
    def selected_transmit_power_level_in_d_bm(self) -> typing.Optional[winrt.system.Int16]: ...
...
class BluetoothLEAdvertisementWatcherTriggerDetails(winrt.system.Object):
    ...
    @_property
    def advertisements(self) -> windows_foundation_collections.IVectorView[windows_devices_bluetooth_advertisement.BluetoothLEAdvertisementReceivedEventArgs]: ...
    @_property
    def error(self) -> windows_devices_bluetooth.BluetoothError: ...
    @_property
...
class GattCharacteristicNotificationTriggerDetails(winrt.system.Object):
    ...
    @_property
    def value_changed_events(self) -> windows_foundation_collections.IVectorView[windows_devices_bluetooth_genericattributeprofile.GattValueChangedEventArgs]: ...
...
class RfcommInboundConnectionInformation(winrt.system.Object):
    ...
    @sdp_record.setter
    def sdp_record(self, value: windows_storage_streams.IBuffer) -> None: ...
    @_property
