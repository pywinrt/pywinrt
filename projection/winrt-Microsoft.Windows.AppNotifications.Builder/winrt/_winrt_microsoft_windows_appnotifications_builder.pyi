...
class AppNotificationBuilder(winrt.system.Object, metaclass=AppNotificationBuilder_Static):
    ...
    @typing.overload
    def set_app_logo_override(self, image_uri: typing.Optional[windows_foundation.Uri], image_crop: AppNotificationImageCrop, /) -> typing.Optional[AppNotificationBuilder]: ...
    @typing.overload
    def set_app_logo_override(self, image_uri: typing.Optional[windows_foundation.Uri], image_crop: AppNotificationImageCrop, alternate_text: str, /) -> typing.Optional[AppNotificationBuilder]: ...
    @typing.overload
    ...
    @typing.overload
    def set_audio_uri(self, audio_uri: typing.Optional[windows_foundation.Uri], loop: AppNotificationAudioLooping, /) -> typing.Optional[AppNotificationBuilder]: ...
    ...
    @typing.overload
    def set_hero_image(self, image_uri: typing.Optional[windows_foundation.Uri], alternate_text: str, /) -> typing.Optional[AppNotificationBuilder]: ...
    @typing.overload
    def set_inline_image(self, image_uri: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[AppNotificationBuilder]: ...
    @typing.overload
    def set_inline_image(self, image_uri: typing.Optional[windows_foundation.Uri], image_crop: AppNotificationImageCrop, /) -> typing.Optional[AppNotificationBuilder]: ...
    @typing.overload
    def set_inline_image(self, image_uri: typing.Optional[windows_foundation.Uri], imagecrop: AppNotificationImageCrop, alternate_text: str, /) -> typing.Optional[AppNotificationBuilder]: ...
...
class AppNotificationButton(winrt.system.Object, metaclass=AppNotificationButton_Static):
    ...
    @typing.overload
    def set_invoke_uri(self, protocol_uri: typing.Optional[windows_foundation.Uri], target_app_id: str, /) -> typing.Optional[AppNotificationButton]: ...
