...
import winrt._winrt
import winrt.system
import winrt.microsoft.windows.appnotifications as microsoft_windows_appnotifications
...
class AppNotificationBuilder(winrt.system.Object, metaclass=AppNotificationBuilder_Static):
    ...
    def add_text2(self, text: str, properties: typing.Optional[AppNotificationTextProperties], /) -> typing.Optional[AppNotificationBuilder]: ...
    def add_text_box(self, id: str, /) -> typing.Optional[AppNotificationBuilder]: ...
    def add_text_box2(self, id: str, place_holder_text: str, title: str, /) -> typing.Optional[AppNotificationBuilder]: ...
    def build_notification(self) -> typing.Optional[microsoft_windows_appnotifications.AppNotification]: ...
    def mute_audio(self) -> typing.Optional[AppNotificationBuilder]: ...
    def set_app_logo_override(self, image_uri: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[AppNotificationBuilder]: ...
    def set_app_logo_override2(self, image_uri: typing.Optional[windows_foundation.Uri], image_crop: AppNotificationImageCrop, /) -> typing.Optional[AppNotificationBuilder]: ...
    def set_app_logo_override3(self, image_uri: typing.Optional[windows_foundation.Uri], image_crop: AppNotificationImageCrop, alternate_text: str, /) -> typing.Optional[AppNotificationBuilder]: ...
    def set_attribution_text(self, text: str, /) -> typing.Optional[AppNotificationBuilder]: ...
    def set_attribution_text2(self, text: str, language: str, /) -> typing.Optional[AppNotificationBuilder]: ...
    def set_audio_event(self, app_notification_sound_event: AppNotificationSoundEvent, /) -> typing.Optional[AppNotificationBuilder]: ...
    def set_audio_event2(self, app_notification_sound_event: AppNotificationSoundEvent, loop: AppNotificationAudioLooping, /) -> typing.Optional[AppNotificationBuilder]: ...
    def set_audio_uri(self, audio_uri: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[AppNotificationBuilder]: ...
    def set_audio_uri2(self, audio_uri: typing.Optional[windows_foundation.Uri], loop: AppNotificationAudioLooping, /) -> typing.Optional[AppNotificationBuilder]: ...
    ...
    def set_hero_image(self, image_uri: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[AppNotificationBuilder]: ...
    def set_hero_image2(self, image_uri: typing.Optional[windows_foundation.Uri], alternate_text: str, /) -> typing.Optional[AppNotificationBuilder]: ...
    def set_inline_image(self, image_uri: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[AppNotificationBuilder]: ...
    def set_inline_image2(self, image_uri: typing.Optional[windows_foundation.Uri], image_crop: AppNotificationImageCrop, /) -> typing.Optional[AppNotificationBuilder]: ...
    def set_inline_image3(self, image_uri: typing.Optional[windows_foundation.Uri], imagecrop: AppNotificationImageCrop, alternate_text: str, /) -> typing.Optional[AppNotificationBuilder]: ...
...
class AppNotificationButton(winrt.system.Object, metaclass=AppNotificationButton_Static):
    ...
    def set_icon(self, value: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[AppNotificationButton]: ...
    def set_input_id(self, value: str, /) -> typing.Optional[AppNotificationButton]: ...
    def set_invoke_uri(self, protocol_uri: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[AppNotificationButton]: ...
    def set_invoke_uri2(self, protocol_uri: typing.Optional[windows_foundation.Uri], target_app_id: str, /) -> typing.Optional[AppNotificationButton]: ...
    ...
    @_property
    def invoke_uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @invoke_uri.setter
    def invoke_uri(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    ...
    @_property
    def arguments(self) -> typing.Optional[windows_foundation_collections.IMap[str, str]]: ...
    @arguments.setter
    def arguments(self, value: typing.Optional[windows_foundation_collections.IMap[str, str]]) -> None: ...
...
class AppNotificationComboBox(winrt.system.Object):
    ...
    @_property
    def items(self) -> typing.Optional[windows_foundation_collections.IMap[str, str]]: ...
    @items.setter
    def items(self, value: typing.Optional[windows_foundation_collections.IMap[str, str]]) -> None: ...
