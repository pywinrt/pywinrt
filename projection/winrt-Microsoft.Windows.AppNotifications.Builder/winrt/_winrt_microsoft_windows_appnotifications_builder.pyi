...
class AppNotificationButton(winrt.system.Object, metaclass=AppNotificationButton_Static):
    ...
    @_property
    def arguments(self) -> windows_foundation_collections.IMap[str, str]: ...
    @arguments.setter
    def arguments(self, value: windows_foundation_collections.IMap[str, str]) -> None: ...
...
class AppNotificationComboBox(winrt.system.Object):
    ...
    @_property
    def items(self) -> windows_foundation_collections.IMap[str, str]: ...
    @items.setter
    def items(self, value: windows_foundation_collections.IMap[str, str]) -> None: ...
