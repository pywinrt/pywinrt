...
class CredentialPicker_Static(type):
    ...
    def pick_with_options_async(cls, options: typing.Optional[CredentialPickerOptions], /) -> windows_foundation.IAsyncOperation[CredentialPickerResults]: ...
...
class CredentialPickerOptions(winrt.system.Object):
    ...
    @_property
    def previous_credential(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @previous_credential.setter
    def previous_credential(self, value: typing.Optional[windows_storage_streams.IBuffer]) -> None: ...
    @_property
...
class CredentialPickerResults(winrt.system.Object):
    ...
    @_property
    def credential(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
