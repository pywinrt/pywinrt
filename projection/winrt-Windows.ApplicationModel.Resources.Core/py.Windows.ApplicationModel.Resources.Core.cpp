...
PyMODINIT_FUNC PyInit__winrt_windows_applicationmodel_resources_core(void) noexcept
{
    ...
    py::pyobj_handle NamedResource_type{py::register_python_type(module.get(), &type_spec_NamedResource, object_bases.get(), nullptr)};
    if (!NamedResource_type)
    {
        return nullptr;
    }

    py::pyobj_handle ResourceCandidate_type{py::register_python_type(module.get(), &type_spec_ResourceCandidate, object_bases.get(), nullptr)};
    if (!ResourceCandidate_type)
    {
        return nullptr;
    }

    py::pyobj_handle ResourceCandidateVectorView_type{py::register_python_type(module.get(), &type_spec_ResourceCandidateVectorView, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle ResourceContext_type{py::register_python_type(module.get(), &type_spec_ResourceContext, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_ResourceContext_Static.get()))};
    if (!ResourceContext_type)
    {
        return nullptr;
    }

    py::pyobj_handle ResourceContextLanguagesVectorView_type{py::register_python_type(module.get(), &type_spec_ResourceContextLanguagesVectorView, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle ResourceManager_type{py::register_python_type(module.get(), &type_spec_ResourceManager, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_ResourceManager_Static.get()))};
    if (!ResourceManager_type)
    {
        return nullptr;
    }

    py::pyobj_handle ResourceMap_type{py::register_python_type(module.get(), &type_spec_ResourceMap, object_bases.get(), nullptr)};
    if (!ResourceMap_type)
    {
        return nullptr;
    }

    py::pyobj_handle ResourceMapIterator_type{py::register_python_type(module.get(), &type_spec_ResourceMapIterator, object_bases.get(), nullptr)};
    if (!ResourceMapIterator_type)
    {
        return nullptr;
    }

    py::pyobj_handle ResourceMapMapView_type{py::register_python_type(module.get(), &type_spec_ResourceMapMapView, object_bases.get(), nullptr)};
    if (!ResourceMapMapView_type)
    {
        return nullptr;
    }

    py::pyobj_handle ResourceMapMapViewIterator_type{py::register_python_type(module.get(), &type_spec_ResourceMapMapViewIterator, object_bases.get(), nullptr)};
    if (!ResourceMapMapViewIterator_type)
    {
        return nullptr;
    }

    py::pyobj_handle ResourceQualifier_type{py::register_python_type(module.get(), &type_spec_ResourceQualifier, object_bases.get(), nullptr)};
    if (!ResourceQualifier_type)
    {
        return nullptr;
    }

    py::pyobj_handle ResourceQualifierMapView_type{py::register_python_type(module.get(), &type_spec_ResourceQualifierMapView, object_bases.get(), nullptr)};
    if (!ResourceQualifierMapView_type)
    {
        return nullptr;
    }

    py::pyobj_handle ResourceQualifierObservableMap_type{py::register_python_type(module.get(), &type_spec_ResourceQualifierObservableMap, object_bases.get(), nullptr)};
    if (!ResourceQualifierObservableMap_type)
    {
        return nullptr;
    }

    py::pyobj_handle ResourceQualifierVectorView_type{py::register_python_type(module.get(), &type_spec_ResourceQualifierVectorView, object_bases.get(), nullptr)};
    if (!ResourceQualifierVectorView_type)
    {
        return nullptr;
    }

    py::pyobj_handle ResourceLayoutInfo_type{py::register_python_type(module.get(), &type_spec_ResourceLayoutInfo, nullptr, nullptr)};
