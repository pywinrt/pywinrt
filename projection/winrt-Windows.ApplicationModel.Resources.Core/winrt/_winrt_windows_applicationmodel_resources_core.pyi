...
class NamedResource(winrt.system.Object):
    ...
    def resolve_all(self) -> windows_foundation_collections.IVectorView[ResourceCandidate]: ...
    def resolve_all_for_context(self, resource_context: ResourceContext, /) -> windows_foundation_collections.IVectorView[ResourceCandidate]: ...
    def resolve_for_context(self, resource_context: ResourceContext, /) -> ResourceCandidate: ...
    @_property
    def candidates(self) -> windows_foundation_collections.IVectorView[ResourceCandidate]: ...
    @_property
...
class ResourceCandidate(winrt.system.Object):
    ...
    @_property
    def qualifiers(self) -> windows_foundation_collections.IVectorView[ResourceQualifier]: ...
    @_property
...
class ResourceContext_Static(type):
    ...
    def get_for_u_i_context(cls, context: windows_ui.UIContext, /) -> ResourceContext: ...
...
class ResourceContext(winrt.system.Object, metaclass=ResourceContext_Static):
    ...
    @languages.setter
    def languages(self, value: windows_foundation_collections.IVectorView[str]) -> None: ...
    @_property
...
class ResourceManager(winrt.system.Object, metaclass=ResourceManager_Static):
    ...
    def get_all_named_resources_for_package(self, package_name: str, resource_layout_info: ResourceLayoutInfo, /) -> windows_foundation_collections.IVectorView[NamedResource]: ...
    def get_all_subtrees_for_package(self, package_name: str, resource_layout_info: ResourceLayoutInfo, /) -> windows_foundation_collections.IVectorView[ResourceMap]: ...
    ...
    @_property
    def all_resource_maps(self) -> windows_foundation_collections.IMapView[str, ResourceMap]: ...
    @_property
...
class ResourceMap(winrt.system.Object, winrt._winrt.Mapping[str, NamedResource]):
    ...
    def split(self) -> typing.Tuple[windows_foundation_collections.IMapView[str, NamedResource], windows_foundation_collections.IMapView[str, NamedResource]]: ...
    @_property
    def uri(self) -> windows_foundation.Uri: ...
    @_property
    def size(self) -> winrt.system.UInt32: ...
...
class ResourceMapMapView(winrt.system.Object, winrt._winrt.Mapping[str, ResourceMap]):
    ...
    def split(self) -> typing.Tuple[windows_foundation_collections.IMapView[str, ResourceMap], windows_foundation_collections.IMapView[str, ResourceMap]]: ...
    @_property
    def size(self) -> winrt.system.UInt32: ...
...
class ResourceQualifierMapView(winrt.system.Object, winrt._winrt.Mapping[str, str]):
    ...
    def split(self) -> typing.Tuple[windows_foundation_collections.IMapView[str, str], windows_foundation_collections.IMapView[str, str]]: ...
    @_property
    def size(self) -> winrt.system.UInt32: ...
