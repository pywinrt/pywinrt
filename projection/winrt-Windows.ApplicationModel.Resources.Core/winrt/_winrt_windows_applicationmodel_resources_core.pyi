...
class NamedResource(winrt.system.Object):
    ...
    @typing.overload
    def resolve_all(self) -> typing.Optional[windows_foundation_collections.IVectorView[ResourceCandidate]]: ...
    @typing.overload
    def resolve_all(self, resource_context: typing.Optional[ResourceContext], /) -> typing.Optional[windows_foundation_collections.IVectorView[ResourceCandidate]]: ...
    @_property
    def candidates(self) -> typing.Optional[windows_foundation_collections.IVectorView[ResourceCandidate]]: ...
    @_property
...
class ResourceCandidate(winrt.system.Object):
    ...
    @_property
    def qualifiers(self) -> typing.Optional[windows_foundation_collections.IVectorView[ResourceQualifier]]: ...
    @_property
...
class ResourceCandidateVectorView(winrt.system.Object, winrt._winrt.Sequence[ResourceCandidate]):
    ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[ResourceCandidate]]: ...
...
class ResourceContext_Static(type):
    ...
    def get_for_u_i_context(cls, context: typing.Optional[windows_ui.UIContext], /) -> typing.Optional[ResourceContext]: ...
...
class ResourceContext(winrt.system.Object, metaclass=ResourceContext_Static):
    ...
    @languages.setter
    def languages(self, value: typing.Optional[windows_foundation_collections.IVectorView[str]]) -> None: ...
    @_property
    def qualifier_values(self) -> typing.Optional[windows_foundation_collections.IObservableMap[str, str]]: ...
...
class ResourceContextLanguagesVectorView(winrt.system.Object, winrt._winrt.Sequence[str]):
    ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[str]]: ...
...
class ResourceManager(winrt.system.Object, metaclass=ResourceManager_Static):
    ...
    def get_all_named_resources_for_package(self, package_name: str, resource_layout_info: ResourceLayoutInfo, /) -> typing.Optional[windows_foundation_collections.IVectorView[NamedResource]]: ...
    def get_all_subtrees_for_package(self, package_name: str, resource_layout_info: ResourceLayoutInfo, /) -> typing.Optional[windows_foundation_collections.IVectorView[ResourceMap]]: ...
    ...
    @_property
    def all_resource_maps(self) -> typing.Optional[windows_foundation_collections.IMapView[str, ResourceMap]]: ...
    @_property
...
class ResourceMap(winrt.system.Object, winrt._winrt.Mapping[str, NamedResource]):
    ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[windows_foundation_collections.IKeyValuePair[str, NamedResource]]]: ...
    ...
    def split(self) -> typing.Tuple[typing.Optional[windows_foundation_collections.IMapView[str, NamedResource]], typing.Optional[windows_foundation_collections.IMapView[str, NamedResource]]]: ...
    @_property
    def uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @_property
    def size(self) -> winrt.system.UInt32: ...
...
class ResourceMapIterator(winrt.system.Object):
    ...
    def get_many(self, items: winrt.system.Array[windows_foundation_collections.IKeyValuePair[str, NamedResource]], /) -> winrt.system.UInt32: ...
    def move_next(self) -> bool: ...
    @_property
    def current(self) -> typing.Optional[windows_foundation_collections.IKeyValuePair[str, NamedResource]]: ...
    @_property
...
class ResourceMapMapView(winrt.system.Object, winrt._winrt.Mapping[str, ResourceMap]):
    ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[windows_foundation_collections.IKeyValuePair[str, ResourceMap]]]: ...
    def has_key(self, key: str, /) -> bool: ...
    def lookup(self, key: str, /) -> typing.Optional[ResourceMap]: ...
    def split(self) -> typing.Tuple[typing.Optional[windows_foundation_collections.IMapView[str, ResourceMap]], typing.Optional[windows_foundation_collections.IMapView[str, ResourceMap]]]: ...
    @_property
    def size(self) -> winrt.system.UInt32: ...
...
class ResourceMapMapViewIterator(winrt.system.Object):
    ...
    def get_many(self, items: winrt.system.Array[windows_foundation_collections.IKeyValuePair[str, ResourceMap]], /) -> winrt.system.UInt32: ...
    def move_next(self) -> bool: ...
    @_property
    def current(self) -> typing.Optional[windows_foundation_collections.IKeyValuePair[str, ResourceMap]]: ...
    @_property
    def has_current(self) -> bool: ...
...
class ResourceQualifierMapView(winrt.system.Object, winrt._winrt.Mapping[str, str]):
    ...
    def split(self) -> typing.Tuple[typing.Optional[windows_foundation_collections.IMapView[str, str]], typing.Optional[windows_foundation_collections.IMapView[str, str]]]: ...
    @_property
    def size(self) -> winrt.system.UInt32: ...
...
class ResourceQualifierVectorView(winrt.system.Object, winrt._winrt.Sequence[ResourceQualifier]):
    ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[ResourceQualifier]]: ...
