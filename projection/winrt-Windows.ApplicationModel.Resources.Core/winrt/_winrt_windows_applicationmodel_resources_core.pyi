...
class NamedResource(winrt.system.Object):
    ...
    def resolve_all_for_context(self, resource_context: typing.Optional[ResourceContext], /) -> typing.Optional[windows_foundation_collections.IVectorView[ResourceCandidate]]: ...
    def resolve_for_context(self, resource_context: typing.Optional[ResourceContext], /) -> typing.Optional[ResourceCandidate]: ...
    @_property
...
class ResourceMap(winrt.system.Object, winrt._winrt.Mapping[str, NamedResource]):
    ...
    def get_value_for_context(self, resource: str, context: typing.Optional[ResourceContext], /) -> typing.Optional[ResourceCandidate]: ...
