...
namespace winrt::impl
{
    template <typename D> auto consume_Microsoft_Windows_System_Power_IPowerManagerStatics<D>::EnergySaverStatus() const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::System::Power::IPowerManagerStatics>)
        {
            ...
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::System::Power::IPowerManagerStatics, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
    ...
    template <typename D> auto consume_Microsoft_Windows_System_Power_IPowerManagerStatics2<D>::EffectivePowerMode2() const
    {
        ...
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::System::Power::IPowerManagerStatics2, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
