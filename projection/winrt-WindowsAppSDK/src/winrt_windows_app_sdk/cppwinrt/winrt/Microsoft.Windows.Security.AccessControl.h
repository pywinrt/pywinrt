...
namespace winrt::impl
{
    ...
    {
        void* result{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Security::AccessControl::ISecurityDescriptorHelpersStatics>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::Security::AccessControl::ISecurityDescriptorHelpersStatics, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Security::AccessControl::ISecurityDescriptorHelpersStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetSddlForAppContainerNames(accessRequests.size(), get_abi(accessRequests), *(void**)(&principalStringSid), principalAccessMask, &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Security::AccessControl::ISecurityDescriptorHelpersStatics>**)this;
            check_hresult(_winrt_abi_type->GetSddlForAppContainerNames(accessRequests.size(), get_abi(accessRequests), *(void**)(&principalStringSid), principalAccessMask, &result));
        }
    ...
    template <typename D> auto consume_Microsoft_Windows_Security_AccessControl_ISecurityDescriptorHelpersStatics<D>::GetSecurityDescriptorBytesFromAppContainerNames(array_view<winrt::Microsoft::Windows::Security::AccessControl::AppContainerNameAndAccess const> accessRequests, param::hstring const& principalStringSid, uint32_t principalAccessMask) const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::Security::AccessControl::ISecurityDescriptorHelpersStatics>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Security::AccessControl::ISecurityDescriptorHelpersStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetSecurityDescriptorBytesFromAppContainerNames(accessRequests.size(), get_abi(accessRequests), *(void**)(&principalStringSid), principalAccessMask, &result_impl_size, &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::Security::AccessControl::ISecurityDescriptorHelpersStatics>**)this;
