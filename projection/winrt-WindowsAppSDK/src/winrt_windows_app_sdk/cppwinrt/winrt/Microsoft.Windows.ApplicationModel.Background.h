...
namespace winrt::impl
{
    ...
    {
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::ApplicationModel::Background::IBackgroundTaskBuilder>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::ApplicationModel::Background::IBackgroundTaskBuilder, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::ApplicationModel::Background::IBackgroundTaskBuilder>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->SetTrigger(*(void**)(&trigger)));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::ApplicationModel::Background::IBackgroundTaskBuilder>**)this;
            check_hresult(_winrt_abi_type->SetTrigger(*(void**)(&trigger)));
        }
    }
    template <typename D> auto consume_Microsoft_Windows_ApplicationModel_Background_IBackgroundTaskBuilder<D>::SetTaskEntryPointClsid(winrt::guid const& clsId) const
    {
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::ApplicationModel::Background::IBackgroundTaskBuilder>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::ApplicationModel::Background::IBackgroundTaskBuilder>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->SetTaskEntryPointClsid(impl::bind_in(clsId)));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::ApplicationModel::Background::IBackgroundTaskBuilder>**)this;
