...
class InputScope(winrt.system.Object):
    ...
    @_property
    def names(self) -> windows_foundation_collections.IVector[InputScopeName]: ...
    @_property
...
class PointerRoutedEventArgs(winrt.system.Object):
    ...
    def get_intermediate_points(self, relative_to: microsoft_ui_xaml.UIElement, /) -> windows_foundation_collections.IVector[microsoft_ui_input.PointerPoint]: ...
    @_property
    def handled(self) -> bool: ...
    @handled.setter
    def handled(self, value: bool) -> None: ...
...
class StandardUICommand(winrt.system.Object, metaclass=StandardUICommand_Static):
    ...
    @_property
    def keyboard_accelerators(self) -> windows_foundation_collections.IVector[KeyboardAccelerator]: ...
    @_property
    def dispatcher(self) -> windows_ui_core.CoreDispatcher: ...
    @_property
    def dispatcher_queue(self) -> microsoft_ui_dispatching.DispatcherQueue: ...
