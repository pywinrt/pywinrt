...
class AccessKeyManager_Static(type):
    def enter_display_mode_for_xaml_root(cls, xaml_root: typing.Optional[microsoft_ui_xaml.XamlRoot], /) -> None: ...
...
class FocusManager_Static(type):
    ...
    def find_next_element_with_options(cls, focus_navigation_direction: FocusNavigationDirection, focus_navigation_options: typing.Optional[FindNextElementOptions], /) -> typing.Optional[microsoft_ui_xaml.DependencyObject]: ...
    ...
    def find_next_focusable_element_with_hint(cls, focus_navigation_direction: FocusNavigationDirection, hint_rect: windows_foundation.Rect, /) -> typing.Optional[microsoft_ui_xaml.UIElement]: ...
    def get_focused_element(cls) -> typing.Optional[winrt.system.Object]: ...
    def get_focused_element_with_root(cls, xaml_root: typing.Optional[microsoft_ui_xaml.XamlRoot], /) -> typing.Optional[winrt.system.Object]: ...
    ...
    def try_move_focus_with_options(cls, focus_navigation_direction: FocusNavigationDirection, focus_navigation_options: typing.Optional[FindNextElementOptions], /) -> bool: ...
    def try_move_focus_with_options_async(cls, focus_navigation_direction: FocusNavigationDirection, focus_navigation_options: typing.Optional[FindNextElementOptions], /) -> windows_foundation.IAsyncOperation[FocusMovementResult]: ...
