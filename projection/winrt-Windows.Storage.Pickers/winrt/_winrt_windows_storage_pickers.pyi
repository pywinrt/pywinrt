...
class FileExtensionVector(winrt.system.Object, winrt._winrt.MutableSequence[str]):
    ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
...
class FileOpenPicker_Static(type):
    def create_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[FileOpenPicker]: ...
...
class FileOpenPicker(winrt.system.Object, metaclass=FileOpenPicker_Static):
    ...
    def pick_multiple_files_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[windows_storage.StorageFile]]: ...
...
@typing.final
class FilePickerFileTypesOrderedMap(winrt.system.Object, winrt._winrt.MutableMapping[str, windows_foundation_collections.IVector[str]]):
    def __len__(self) -> int: ...
    def __iter__(self) -> typing.Iterator[str]: ...
    def __contains__(self, key: object) -> bool: ...
    def __getitem__(self, key: str) -> windows_foundation_collections.IVector[str]: ...
    def __setitem__(self, key: str, value: windows_foundation_collections.IVector[str]) -> None: ...
    def __delitem__(self, key: str) -> None: ...
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> FilePickerFileTypesOrderedMap: ...
    def clear(self) -> None: ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[windows_foundation_collections.IKeyValuePair[str, windows_foundation_collections.IVector[str]]]]: ...
    def get_view(self) -> typing.Optional[windows_foundation_collections.IMapView[str, windows_foundation_collections.IVector[str]]]: ...
    def has_key(self, key: str, /) -> bool: ...
    def insert(self, key: str, value: windows_foundation_collections.IVector[str], /) -> bool: ...
    def lookup(self, key: str, /) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class FilePickerSelectedFilesArray(winrt.system.Object, winrt._winrt.Sequence[windows_storage.StorageFile]):
    ...
    def first(self) -> typing.Optional[windows_foundation_collections.IIterator[windows_storage.StorageFile]]: ...
    def get_at(self, index: winrt.system.UInt32, /) -> typing.Optional[windows_storage.StorageFile]: ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[windows_storage.StorageFile], /) -> winrt.system.UInt32: ...
    def index_of(self, value: typing.Optional[windows_storage.StorageFile], /) -> typing.Tuple[bool, winrt.system.UInt32]: ...
    @_property
    def size(self) -> winrt.system.UInt32: ...

@typing.final
class FileSavePicker_Static(type):
    def create_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[FileSavePicker]: ...
...
class FileSavePicker(winrt.system.Object, metaclass=FileSavePicker_Static):
    ...
    def suggested_start_location(self, value: PickerLocationId) -> None: ...
    @_property
    def suggested_save_file(self) -> typing.Optional[windows_storage.StorageFile]: ...
    @suggested_save_file.setter
    def suggested_save_file(self, value: typing.Optional[windows_storage.StorageFile]) -> None: ...
    @_property
    ...
    def commit_button_text(self, value: str) -> None: ...
    @_property
    def file_type_choices(self) -> typing.Optional[windows_foundation_collections.IMap[str, windows_foundation_collections.IVector[str]]]: ...
    @_property
    def continuation_data(self) -> typing.Optional[windows_foundation_collections.ValueSet]: ...
    @_property
...
class FolderPicker_Static(type):
    def create_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[FolderPicker]: ...
