...
class FileExtensionVector(winrt.system.Object, winrt._winrt.MutableSequence[str]):
    ...
    def get_view(self) -> windows_foundation_collections.IVectorView[str]: ...
...
class FileOpenPicker(winrt.system.Object, metaclass=FileOpenPicker_Static):
    ...
    @_property
    def file_type_filter(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
...
class FilePickerFileTypesOrderedMap(winrt.system.Object, winrt._winrt.MutableMapping[str, windows_foundation_collections.IVector[str]]):
    ...
    def clear(self) -> None: ...
    def first(self) -> windows_foundation_collections.IIterator[windows_foundation_collections.IKeyValuePair[str, windows_foundation_collections.IVector[str]]]: ...
    def get_view(self) -> windows_foundation_collections.IMapView[str, windows_foundation_collections.IVector[str]]: ...
    def has_key(self, key: str, /) -> bool: ...
    def insert(self, key: str, value: windows_foundation_collections.IVector[str], /) -> bool: ...
    def lookup(self, key: str, /) -> windows_foundation_collections.IVector[str]: ...
...
class FileSavePicker(winrt.system.Object, metaclass=FileSavePicker_Static):
    ...
    def commit_button_text(self, value: str) -> None: ...
    @_property
    def file_type_choices(self) -> windows_foundation_collections.IMap[str, windows_foundation_collections.IVector[str]]: ...
    @_property
    def continuation_data(self) -> windows_foundation_collections.ValueSet: ...
    @_property
