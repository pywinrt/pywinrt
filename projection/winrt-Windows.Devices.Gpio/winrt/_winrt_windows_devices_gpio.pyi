...
class GpioChangeReader(winrt.system.Object):
    ...
    def clear(self) -> None: ...
    def close(self) -> None: ...
    def get_all_items(self) -> windows_foundation_collections.IVector[GpioChangeRecord]: ...
...
class GpioController_Static(type):
    def get_controllers_async(cls, provider: windows_devices_gpio_provider.IGpioProvider, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[GpioController]]: ...
