...
@typing.final
class GpioChangeCounter(winrt.system.Object, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> GpioChangeCounter: ...
    def __new__(cls: typing.Type[GpioChangeCounter], pin: GpioPin) -> GpioChangeCounter: ...
    def close(self) -> None: ...
...
@typing.final
class GpioChangeReader(winrt.system.Object, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> GpioChangeReader: ...
    @typing.overload
    def __new__(cls: typing.Type[GpioChangeReader], pin: GpioPin) -> GpioChangeReader: ...
    @typing.overload
    def __new__(cls: typing.Type[GpioChangeReader], pin: GpioPin, min_capacity: winrt.system.Int32) -> GpioChangeReader: ...
    def clear(self) -> None: ...
    def close(self) -> None: ...
...
class GpioController_Static(type):
    def get_controllers_async(cls, provider: windows_devices_gpio_provider.ImplementsIGpioProvider, /) -> windows_foundation.IAsyncOperation[typing.Sequence[GpioController]]: ...
...
@typing.final
class GpioPin(winrt.system.Object, windows_foundation.ImplementsIClosable):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
