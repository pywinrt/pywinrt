...
PyMODINIT_FUNC PyInit__winrt_windows_data_html(void) noexcept
{
    ...
    py::pyobj_handle HtmlUtilities_type{py::register_python_type(module.get(), &type_spec_HtmlUtilities, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_HtmlUtilities_Static.get()))};
