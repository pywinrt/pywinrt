...
class MidiOutPort(winrt.system.Object, metaclass=MidiOutPort_Static):
    ...
    def close(self) -> None: ...
    def send_buffer(self, midi_data: typing.Optional[windows_storage_streams.IBuffer], /) -> None: ...
...
class MidiSynthesizer_Static(type):
    ...
    def create_from_audio_device_async(cls, audio_device: typing.Optional[windows_devices_enumeration.DeviceInformation], /) -> windows_foundation.IAsyncOperation[MidiSynthesizer]: ...
    def is_synthesizer(cls, midi_device: typing.Optional[windows_devices_enumeration.DeviceInformation], /) -> bool: ...
...
class MidiSystemExclusiveMessage(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[MidiSystemExclusiveMessage], raw_data: typing.Optional[windows_storage_streams.IBuffer]) -> MidiSystemExclusiveMessage: ...
    @_property
    def raw_data(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
    def timestamp(self) -> datetime.timedelta: ...
