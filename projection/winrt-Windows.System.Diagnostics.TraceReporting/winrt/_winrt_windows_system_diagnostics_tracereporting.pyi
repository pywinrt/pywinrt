...
class PlatformDiagnosticActions_Static(type):
    ...
    def get_active_scenario_list(cls) -> windows_foundation_collections.IVectorView[_uuid.UUID]: ...
    def get_active_trace_runtime(cls, slot_type: PlatformDiagnosticTraceSlotType, /) -> PlatformDiagnosticTraceRuntimeInfo: ...
    def get_known_trace_list(cls, slot_type: PlatformDiagnosticTraceSlotType, /) -> windows_foundation_collections.IVectorView[PlatformDiagnosticTraceInfo]: ...
