...
class PlatformDiagnosticActions_Static(type):
    ...
    def get_active_scenario_list(cls) -> typing.Optional[winrt.windows.foundation.collections.IVectorView[_uuid.UUID]]: ...
    ...
    def get_known_trace_list(cls, slot_type: PlatformDiagnosticTraceSlotType, /) -> typing.Optional[winrt.windows.foundation.collections.IVectorView[PlatformDiagnosticTraceInfo]]: ...
