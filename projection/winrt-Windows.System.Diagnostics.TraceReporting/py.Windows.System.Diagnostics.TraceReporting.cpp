...
PyMODINIT_FUNC PyInit__winrt_windows_system_diagnostics_tracereporting(void) noexcept
{
    ...
    py::pyobj_handle PlatformDiagnosticActions_type{py::register_python_type(module.get(), &type_spec_PlatformDiagnosticActions, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_PlatformDiagnosticActions_Static.get()))};
    if (!PlatformDiagnosticActions_type)
    {
        return nullptr;
    }

    py::pyobj_handle PlatformDiagnosticTraceInfo_type{py::register_python_type(module.get(), &type_spec_PlatformDiagnosticTraceInfo, object_bases.get(), nullptr)};
    if (!PlatformDiagnosticTraceInfo_type)
    {
        return nullptr;
    }

    py::pyobj_handle PlatformDiagnosticTraceRuntimeInfo_type{py::register_python_type(module.get(), &type_spec_PlatformDiagnosticTraceRuntimeInfo, object_bases.get(), nullptr)};
