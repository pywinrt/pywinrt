...
class PackageSet(winrt.system.Object):
    ...
    @_property
    def items(self) -> windows_foundation_collections.IVector[PackageSetItem]: ...
...
class PackageSetRuntimeDisposition(winrt.system.Object):
    ...
    @_property
    def package_set_item_runtime_dispositions(self) -> windows_foundation_collections.IVector[PackageSetItemRuntimeDisposition]: ...
...
class PackageVolume_Static(type):
    ...
    def find_package_volumes(cls) -> windows_foundation_collections.IVector[PackageVolume]: ...
...
class RegisterPackageOptions(winrt.system.Object):
    ...
    def allow_unsigned(self, value: bool) -> None: ...
    @_property
    def dependency_package_family_names(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def dependency_package_uris(self) -> windows_foundation_collections.IVector[windows_foundation.Uri]: ...
    @_property
    def expected_digests(self) -> windows_foundation_collections.IMap[windows_foundation.Uri, str]: ...
