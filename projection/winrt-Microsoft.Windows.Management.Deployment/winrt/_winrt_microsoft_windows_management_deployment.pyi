...
class PackageDeploymentManager(winrt.system.Object, metaclass=PackageDeploymentManager_Static):
    ...
    def add_package_async(self, package: str, options: typing.Optional[AddPackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def add_package_by_uri_async(self, package_uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[AddPackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def add_package_set_async(self, package_set: typing.Optional[PackageSet], options: typing.Optional[AddPackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    ...
    def deprovision_package_by_uri_async(self, package_uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def deprovision_package_set_async(self, package_set: typing.Optional[PackageSet], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def ensure_package_ready_async(self, package: str, options: typing.Optional[EnsureReadyOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def ensure_package_ready_by_uri_async(self, package_uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[EnsureReadyOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def ensure_package_set_ready_async(self, package_set: typing.Optional[PackageSet], options: typing.Optional[EnsureReadyOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def is_package_provisioned(self, package: str, /) -> bool: ...
    def is_package_provisioned_by_uri(self, package_uri: typing.Optional[windows_foundation.Uri], /) -> bool: ...
    def is_package_ready(self, package: str, /) -> bool: ...
    def is_package_ready_by_uri(self, package_uri: typing.Optional[windows_foundation.Uri], /) -> bool: ...
    def is_package_ready_or_newer_available(self, package: str, /) -> PackageReadyOrNewerAvailableStatus: ...
    def is_package_ready_or_newer_available_by_uri(self, package_uri: typing.Optional[windows_foundation.Uri], /) -> PackageReadyOrNewerAvailableStatus: ...
    ...
    def is_package_set_provisioned(self, package_set: typing.Optional[PackageSet], /) -> bool: ...
    def is_package_set_ready(self, package_set: typing.Optional[PackageSet], /) -> bool: ...
    def is_package_set_ready_or_newer_available(self, package_set: typing.Optional[PackageSet], /) -> PackageReadyOrNewerAvailableStatus: ...
    def provision_package_async(self, package: str, options: typing.Optional[ProvisionPackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def provision_package_by_uri_async(self, package_uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[ProvisionPackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def provision_package_set_async(self, package_set: typing.Optional[PackageSet], options: typing.Optional[ProvisionPackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def register_package_async(self, package: str, options: typing.Optional[RegisterPackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def register_package_by_uri_async(self, package_uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[RegisterPackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def register_package_set_async(self, package_set: typing.Optional[PackageSet], options: typing.Optional[RegisterPackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def remove_package_async(self, package: str, options: typing.Optional[RemovePackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def remove_package_by_family_name_async(self, package_family_name: str, options: typing.Optional[RemovePackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def remove_package_by_full_name_async(self, package_full_name: str, options: typing.Optional[RemovePackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def remove_package_by_uri_async(self, package_uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[RemovePackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def remove_package_set_async(self, package_set: typing.Optional[PackageSet], options: typing.Optional[RemovePackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    ...
    def repair_package_by_uri_async(self, package_uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def repair_package_set_async(self, package_set: typing.Optional[PackageSet], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    ...
    def reset_package_by_uri_async(self, package_uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def reset_package_set_async(self, package_set: typing.Optional[PackageSet], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def stage_package_async(self, package: str, options: typing.Optional[StagePackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def stage_package_by_uri_async(self, package_uri: typing.Optional[windows_foundation.Uri], options: typing.Optional[StagePackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
    def stage_package_set_async(self, package_set: typing.Optional[PackageSet], options: typing.Optional[StagePackageOptions], /) -> windows_foundation.IAsyncOperationWithProgress[PackageDeploymentResult, PackageDeploymentProgress]: ...
...
class PackageRuntimeManager(winrt.system.Object, metaclass=PackageRuntimeManager_Static):
    ...
    def add_package_set_with_options(self, package_set: typing.Optional[PackageSet], create_options: typing.Optional[microsoft_windows_applicationmodel_dynamicdependency.CreatePackageDependencyOptions], add_options: typing.Optional[microsoft_windows_applicationmodel_dynamicdependency.AddPackageDependencyOptions], /) -> typing.Optional[PackageSetRuntimeDisposition]: ...
...
class PackageSet(winrt.system.Object):
    ...
    @_property
    def package_uri(self) -> typing.Optional[windows_foundation.Uri]: ...
    @package_uri.setter
    def package_uri(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    def id(self) -> str: ...
    @id.setter
    def id(self, value: str) -> None: ...
    @_property
    def items(self) -> typing.Optional[windows_foundation_collections.IVector[PackageSetItem]]: ...
...
class PackageSetRuntimeDisposition(winrt.system.Object):
    ...
    @_property
    def package_set_item_runtime_dispositions(self) -> typing.Optional[windows_foundation_collections.IVector[PackageSetItemRuntimeDisposition]]: ...
...
class PackageVolume_Static(type):
    ...
    def find_package_volumes(cls) -> typing.Optional[windows_foundation_collections.IVector[PackageVolume]]: ...
...
class RegisterPackageOptions(winrt.system.Object):
    ...
    def allow_unsigned(self, value: bool) -> None: ...
    @_property
    def dependency_package_family_names(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def dependency_package_uris(self) -> typing.Optional[windows_foundation_collections.IVector[windows_foundation.Uri]]: ...
    @_property
    def expected_digests(self) -> typing.Optional[windows_foundation_collections.IMap[windows_foundation.Uri, str]]: ...
