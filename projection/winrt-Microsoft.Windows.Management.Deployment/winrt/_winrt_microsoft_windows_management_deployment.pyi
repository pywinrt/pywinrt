...
class PackageRuntimeManager(winrt.system.Object, metaclass=PackageRuntimeManager_Static):
    ...
    @typing.overload
    def add_package_set(self, package_set: typing.Optional[PackageSet], create_options: typing.Optional[microsoft_windows_applicationmodel_dynamicdependency.CreatePackageDependencyOptions], add_options: typing.Optional[microsoft_windows_applicationmodel_dynamicdependency.AddPackageDependencyOptions], /) -> typing.Optional[PackageSetRuntimeDisposition]: ...
