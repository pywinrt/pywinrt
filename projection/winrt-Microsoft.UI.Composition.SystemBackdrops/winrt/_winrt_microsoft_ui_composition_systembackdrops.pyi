...
@typing.final
class DesktopAcrylicController(microsoft_ui.IClosableNotifier, ISystemBackdropControllerWithTargets, ISystemBackdropController, windows_foundation.IClosable, winrt.system.Object, metaclass=DesktopAcrylicController_Static):
...
@typing.final
class MicaController(microsoft_ui.IClosableNotifier, ISystemBackdropControllerWithTargets, ISystemBackdropController, windows_foundation.IClosable, winrt.system.Object, metaclass=MicaController_Static):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
...
class ISystemBackdropController(windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
...
class ISystemBackdropControllerWithTargets(ISystemBackdropController, windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
