...
class DesktopAcrylicController(winrt.system.Object, metaclass=DesktopAcrylicController_Static):
    ...
    def set_target_with_core_window(self, core_window: typing.Optional[windows_ui_core.CoreWindow], composition_target: typing.Optional[windows_ui_composition.CompositionTarget], /) -> bool: ...
    def set_target_with_window_id(self, window_id: microsoft_ui.WindowId, desktop_window_target: typing.Optional[windows_ui_composition.CompositionTarget], /) -> bool: ...
