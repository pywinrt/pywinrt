...
PyMODINIT_FUNC PyInit__winrt_windows_security_isolation(void) noexcept
{
    ...
    py::pyobj_handle IsolatedWindowsEnvironment_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironment, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_IsolatedWindowsEnvironment_Static.get()))};
    if (!IsolatedWindowsEnvironment_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentCreateResult_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentCreateResult, object_bases.get(), nullptr)};
    if (!IsolatedWindowsEnvironmentCreateResult_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentFile_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentFile, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle IsolatedWindowsEnvironmentHost_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentHost, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_IsolatedWindowsEnvironmentHost_Static.get()))};
    if (!IsolatedWindowsEnvironmentHost_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentLaunchFileResult_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentLaunchFileResult, object_bases.get(), nullptr)};
    if (!IsolatedWindowsEnvironmentLaunchFileResult_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentOptions_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentOptions, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle IsolatedWindowsEnvironmentOwnerRegistration_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentOwnerRegistration, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_IsolatedWindowsEnvironmentOwnerRegistration_Static.get()))};
    if (!IsolatedWindowsEnvironmentOwnerRegistration_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentOwnerRegistrationData_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentOwnerRegistrationData, object_bases.get(), nullptr)};
    if (!IsolatedWindowsEnvironmentOwnerRegistrationData_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentOwnerRegistrationResult_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentOwnerRegistrationResult, object_bases.get(), nullptr)};
    if (!IsolatedWindowsEnvironmentOwnerRegistrationResult_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentPostMessageResult_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentPostMessageResult, object_bases.get(), nullptr)};
    if (!IsolatedWindowsEnvironmentPostMessageResult_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentProcess_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentProcess, object_bases.get(), nullptr)};
    if (!IsolatedWindowsEnvironmentProcess_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentShareFileRequestOptions_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentShareFileRequestOptions, object_bases.get(), nullptr)};
    if (!IsolatedWindowsEnvironmentShareFileRequestOptions_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentShareFileResult_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentShareFileResult, object_bases.get(), nullptr)};
    if (!IsolatedWindowsEnvironmentShareFileResult_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentShareFolderRequestOptions_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentShareFolderRequestOptions, object_bases.get(), nullptr)};
    if (!IsolatedWindowsEnvironmentShareFolderRequestOptions_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentShareFolderResult_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentShareFolderResult, object_bases.get(), nullptr)};
    if (!IsolatedWindowsEnvironmentShareFolderResult_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentStartProcessResult_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentStartProcessResult, object_bases.get(), nullptr)};
    if (!IsolatedWindowsEnvironmentStartProcessResult_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentTelemetryParameters_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentTelemetryParameters, object_bases.get(), nullptr)};
    if (!IsolatedWindowsEnvironmentTelemetryParameters_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentUserInfo_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentUserInfo, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle IsolatedWindowsHostMessenger_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsHostMessenger, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_IsolatedWindowsHostMessenger_Static.get()))};
    if (!IsolatedWindowsHostMessenger_type)
    {
        return nullptr;
    }

    py::pyobj_handle IsolatedWindowsEnvironmentCreateProgress_type{py::register_python_type(module.get(), &type_spec_IsolatedWindowsEnvironmentCreateProgress, nullptr, nullptr)};
