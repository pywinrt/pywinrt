...
class IsolatedWindowsEnvironment_Static(type):
    ...
    def find_by_owner_id(cls, environment_owner_id: str, /) -> windows_foundation_collections.IVectorView[IsolatedWindowsEnvironment]: ...
...
class IsolatedWindowsEnvironment(winrt.system.Object, metaclass=IsolatedWindowsEnvironment_Static):
    ...
    def launch_file_with_u_i_and_telemetry_async(self, app_exe_path: str, arguments_template: str, file_path: str, telemetry_parameters: IsolatedWindowsEnvironmentTelemetryParameters, /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentLaunchFileResult]: ...
...
class IsolatedWindowsEnvironmentHost_Static(type):
    @_property
    def host_errors(cls) -> windows_foundation_collections.IVectorView[IsolatedWindowsEnvironmentHostError]: ...
    @_property
...
class IsolatedWindowsEnvironmentOwnerRegistrationData(winrt.system.Object):
    ...
    @_property
    def activation_file_extensions(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def processes_runnable_as_system(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def processes_runnable_as_user(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
    def shareable_folders(self) -> windows_foundation_collections.IVector[str]: ...
