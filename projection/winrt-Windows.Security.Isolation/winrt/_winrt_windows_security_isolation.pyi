...
class IsolatedWindowsEnvironment_Static(type):
    @typing.overload
    def create_async(cls, options: typing.Optional[IsolatedWindowsEnvironmentOptions], /) -> windows_foundation.IAsyncOperationWithProgress[IsolatedWindowsEnvironmentCreateResult, IsolatedWindowsEnvironmentCreateProgress]: ...
    @typing.overload
    def create_async(cls, options: typing.Optional[IsolatedWindowsEnvironmentOptions], telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncOperationWithProgress[IsolatedWindowsEnvironmentCreateResult, IsolatedWindowsEnvironmentCreateProgress]: ...
    def find_by_owner_id(cls, environment_owner_id: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[IsolatedWindowsEnvironment]]: ...
...
class IsolatedWindowsEnvironment(winrt.system.Object, metaclass=IsolatedWindowsEnvironment_Static):
    ...
    @typing.overload
    def launch_file_with_u_i_async(self, app_exe_path: str, arguments_template: str, file_path: str, /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentLaunchFileResult]: ...
    @typing.overload
    def launch_file_with_u_i_async(self, app_exe_path: str, arguments_template: str, file_path: str, telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentLaunchFileResult]: ...
    @typing.overload
    ...
    @typing.overload
    def post_message_to_receiver_async(self, receiver_id: _uuid.UUID, message: typing.Iterable[winrt.system.Object], telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentPostMessageResult]: ...
    ...
    @typing.overload
    def share_file_async(self, file_path: str, options: typing.Optional[IsolatedWindowsEnvironmentShareFileRequestOptions], /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentShareFileResult]: ...
    @typing.overload
    def share_file_async(self, file_path: str, options: typing.Optional[IsolatedWindowsEnvironmentShareFileRequestOptions], telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentShareFileResult]: ...
    @typing.overload
    def share_folder_async(self, host_folder: str, request_options: typing.Optional[IsolatedWindowsEnvironmentShareFolderRequestOptions], /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentShareFolderResult]: ...
    @typing.overload
    def share_folder_async(self, host_folder: str, request_options: typing.Optional[IsolatedWindowsEnvironmentShareFolderRequestOptions], telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentShareFolderResult]: ...
    @typing.overload
    ...
    @typing.overload
    def start_process_silently_async(self, host_exe_path: str, arguments: str, activator: IsolatedWindowsEnvironmentActivator, telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentStartProcessResult]: ...
    @typing.overload
    def terminate_async(self) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    def terminate_async(self, telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncAction: ...
...
class IsolatedWindowsEnvironmentHost_Static(type):
    @_property
    def host_errors(cls) -> typing.Optional[windows_foundation_collections.IVectorView[IsolatedWindowsEnvironmentHostError]]: ...
    @_property
...
class IsolatedWindowsEnvironmentOwnerRegistrationData(winrt.system.Object):
    ...
    @_property
    def activation_file_extensions(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def processes_runnable_as_system(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def processes_runnable_as_user(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
    def shareable_folders(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
...
class IsolatedWindowsHostMessenger_Static(type):
    ...
    def post_message_to_receiver(cls, receiver_id: _uuid.UUID, message: windows_foundation_collections.IVectorView[winrt.system.Object], /) -> None: ...
