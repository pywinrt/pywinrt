...
class IsolatedWindowsHostMessenger(winrt.system.Object):
    ...
    @staticmethod
    def get_file_id(file_path: str, /) -> _uuid.UUID: ...
    @staticmethod
    def post_message_to_receiver(receiver_id: _uuid.UUID, message: winrt.windows.foundation.collections.IVectorView[winrt.system.Object], /) -> None: ...
    @staticmethod
    def register_host_message_receiver(receiver_id: _uuid.UUID, host_message_received_callback: typing.Optional[HostMessageReceivedCallback], /) -> None: ...
    @staticmethod
    def unregister_host_message_receiver(receiver_id: _uuid.UUID, /) -> None: ...
