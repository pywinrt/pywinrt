...
class IsolatedWindowsEnvironment_Static(type):
    ...
    def create_with_telemetry_async(cls, options: typing.Optional[IsolatedWindowsEnvironmentOptions], telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncOperationWithProgress[IsolatedWindowsEnvironmentCreateResult, IsolatedWindowsEnvironmentCreateProgress]: ...
...
class IsolatedWindowsEnvironment(winrt.system.Object, metaclass=IsolatedWindowsEnvironment_Static):
    ...
    def launch_file_with_u_i_and_telemetry_async(self, app_exe_path: str, arguments_template: str, file_path: str, telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentLaunchFileResult]: ...
    ...
    def post_message_to_receiver_with_telemetry_async(self, receiver_id: _uuid.UUID, message: typing.Iterable[winrt.system.Object], telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentPostMessageResult]: ...
    ...
    def share_file_with_telemetry_async(self, file_path: str, options: typing.Optional[IsolatedWindowsEnvironmentShareFileRequestOptions], telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentShareFileResult]: ...
    ...
    def start_process_silently_with_telemetry_async(self, host_exe_path: str, arguments: str, activator: IsolatedWindowsEnvironmentActivator, telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncOperation[IsolatedWindowsEnvironmentStartProcessResult]: ...
    def terminate_async(self) -> windows_foundation.IAsyncAction: ...
    def terminate_with_telemetry_async(self, telemetry_parameters: typing.Optional[IsolatedWindowsEnvironmentTelemetryParameters], /) -> windows_foundation.IAsyncAction: ...
