...
class CoreIndependentInputSourceController_Static(type):
    def create_for_i_visual_element(cls, visual_element: windows_ui_composition.IVisualElement, /) -> CoreIndependentInputSourceController: ...
...
class CoreWindowDialog(winrt.system.Object):
    ...
    @_property
    def commands(self) -> windows_foundation_collections.IVector[windows_ui_popups.IUICommand]: ...
    @_property
...
class PointerEventArgs(winrt.system.Object):
    ...
    def get_intermediate_points(self) -> windows_foundation_collections.IVector[windows_ui_input.PointerPoint]: ...
    @_property
    def handled(self) -> bool: ...
    @handled.setter
    def handled(self, value: bool) -> None: ...
