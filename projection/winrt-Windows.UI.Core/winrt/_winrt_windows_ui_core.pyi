...
@typing.final
class AcceleratorKeyEventArgs(winrt.system.Object, ImplementsICoreWindowEventArgs):
    @staticmethod
...
@typing.final
class AutomationProviderRequestedEventArgs(winrt.system.Object, ImplementsICoreWindowEventArgs):
    @staticmethod
...
@typing.final
class CharacterReceivedEventArgs(winrt.system.Object, ImplementsICoreWindowEventArgs):
    @staticmethod
...
class ClosestInteractiveBoundsRequestedEventArgs(winrt.system.Object):
    ...
    def closest_interactive_bounds(self, value: windows_foundation.Rect) -> None: ...
    @_property
...
@typing.final
class CoreAcceleratorKeys(winrt.system.Object, ImplementsICoreAcceleratorKeys):
    @staticmethod
...
@typing.final
class CoreComponentInputSource(winrt.system.Object, ImplementsICorePointerInputSource2, ImplementsICorePointerInputSource, ImplementsICoreInputSourceBase):
    @staticmethod
    ...
    def remove_got_focus(self, cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_lost_focus(self, cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_closest_interactive_bounds_requested(self, cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
...
@typing.final
class CoreDispatcher(winrt.system.Object, ImplementsICoreAcceleratorKeys):
    @staticmethod
...
@typing.final
class CoreIndependentInputSource(winrt.system.Object, ImplementsICorePointerRedirector, ImplementsICorePointerInputSource2, ImplementsICorePointerInputSource, ImplementsICoreInputSourceBase):
    @staticmethod
...
class CoreIndependentInputSourceController_Static(type):
    def create_for_ivisual_element(cls, visual_element: windows_ui_composition.ImplementsIVisualElement, /) -> CoreIndependentInputSourceController: ...
    def create_for_visual(cls, visual: windows_ui_composition.Visual, /) -> CoreIndependentInputSourceController: ...

@typing.final
class CoreIndependentInputSourceController(winrt.system.Object, windows_foundation.ImplementsIClosable, metaclass=CoreIndependentInputSourceController_Static):
...
@typing.final
class CoreWindow(winrt.system.Object, ImplementsICorePointerRedirector, ImplementsICoreWindow, metaclass=CoreWindow_Static):
    @staticmethod
    ...
    def remove_resize_completed(self, cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_resize_started(self, cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
    def pointer_position(self) -> windows_foundation.Point: ...
    @pointer_position.setter
    def pointer_position(self, value: windows_foundation.Point) -> None: ...
    @_property
    def pointer_cursor(self) -> CoreCursor: ...
    @pointer_cursor.setter
    def pointer_cursor(self, value: CoreCursor) -> None: ...
...
class CoreWindowDialog(winrt.system.Object):
    ...
    def remove_showing(self, cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
    def title(self) -> str: ...
    @title.setter
...
@typing.final
class CoreWindowEventArgs(winrt.system.Object, ImplementsICoreWindowEventArgs):
    @staticmethod
...
class CoreWindowFlyout(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[CoreWindowFlyout], position: windows_foundation.Point) -> CoreWindowFlyout: ...
    @typing.overload
    def __new__(cls: typing.Type[CoreWindowFlyout], position: windows_foundation.Point, title: str) -> CoreWindowFlyout: ...
    def show_async(self) -> windows_foundation.IAsyncOperation[windows_ui_popups.IUICommand]: ...
    def add_showing(self, handler: windows_foundation.TypedEventHandler[CoreWindow, CoreWindowPopupShowingEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_showing(self, cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
...
@typing.final
class InputEnabledEventArgs(winrt.system.Object, ImplementsICoreWindowEventArgs):
    @staticmethod
...
@typing.final
class KeyEventArgs(winrt.system.Object, ImplementsICoreWindowEventArgs):
    @staticmethod
...
@typing.final
class PointerEventArgs(winrt.system.Object, ImplementsICoreWindowEventArgs):
    @staticmethod
...
@typing.final
class TouchHitTestingEventArgs(winrt.system.Object, ImplementsICoreWindowEventArgs):
    @staticmethod
    ...
    def evaluate_proximity_to_rect(self, control_bounding_box: windows_foundation.Rect, /) -> CoreProximityEvaluation: ...
    @_property
    def handled(self) -> bool: ...
    @handled.setter
    def handled(self, value: bool) -> None: ...
...
@typing.final
class VisibilityChangedEventArgs(winrt.system.Object, ImplementsICoreWindowEventArgs):
    @staticmethod
...
@typing.final
class WindowActivatedEventArgs(winrt.system.Object, ImplementsICoreWindowEventArgs):
    @staticmethod
...
@typing.final
class WindowSizeChangedEventArgs(winrt.system.Object, ImplementsICoreWindowEventArgs):
    @staticmethod
