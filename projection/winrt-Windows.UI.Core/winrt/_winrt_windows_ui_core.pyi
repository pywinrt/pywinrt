...
class CoreProximityEvaluation:
    ...
    def __init__(self, score: winrt.system.Int32, adjusted_point: windows_foundation.Point) -> None: ...
...
class CoreDispatcher(winrt.system.Object):
    ...
    def run_async(self, priority: CoreDispatcherPriority, agile_callback: typing.Optional[DispatchedHandler], /) -> windows_foundation.IAsyncAction: ...
    def run_idle_async(self, agile_callback: typing.Optional[IdleDispatchedHandler], /) -> windows_foundation.IAsyncAction: ...
    def should_yield(self) -> bool: ...
    def should_yield_to_priority(self, priority: CoreDispatcherPriority, /) -> bool: ...
    def stop_process_events(self) -> None: ...
    def try_run_async(self, priority: CoreDispatcherPriority, agile_callback: typing.Optional[DispatchedHandler], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_run_idle_async(self, agile_callback: typing.Optional[IdleDispatchedHandler], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def add_accelerator_key_activated(self, handler: windows_foundation.TypedEventHandler[CoreDispatcher, AcceleratorKeyEventArgs], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_accelerator_key_activated(self, cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
...
class CoreIndependentInputSourceController_Static(type):
    def create_for_i_visual_element(cls, visual_element: typing.Optional[windows_ui_composition.IVisualElement], /) -> typing.Optional[CoreIndependentInputSourceController]: ...
    def create_for_visual(cls, visual: typing.Optional[windows_ui_composition.Visual], /) -> typing.Optional[CoreIndependentInputSourceController]: ...
...
class CoreWindowDialog(winrt.system.Object):
    ...
    @_property
    def back_button_command(self) -> typing.Optional[windows_ui_popups.UICommandInvokedHandler]: ...
    @back_button_command.setter
    def back_button_command(self, value: typing.Optional[windows_ui_popups.UICommandInvokedHandler]) -> None: ...
    @_property
    def commands(self) -> typing.Optional[windows_foundation_collections.IVector[windows_ui_popups.IUICommand]]: ...
    @_property
...
class PointerEventArgs(winrt.system.Object):
    ...
    def get_intermediate_points(self) -> typing.Optional[windows_foundation_collections.IVector[windows_ui_input.PointerPoint]]: ...
    @_property
    def handled(self) -> bool: ...
    @handled.setter
    def handled(self, value: bool) -> None: ...
    @_property
    def current_point(self) -> typing.Optional[windows_ui_input.PointerPoint]: ...
    @_property
