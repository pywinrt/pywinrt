...
class AttributedNetworkUsage(winrt.system.Object):
    ...
    @_property
    def attribution_thumbnail(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
    @_property
...
class ConnectionProfile(winrt.system.Object):
    ...
    def get_attributed_network_usage_async(self, start_time: datetime.datetime, end_time: datetime.datetime, states: NetworkUsageStates, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AttributedNetworkUsage]]: ...
    def get_connection_cost(self) -> typing.Optional[ConnectionCost]: ...
    def get_connectivity_intervals_async(self, start_time: datetime.datetime, end_time: datetime.datetime, states: NetworkUsageStates, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ConnectivityInterval]]: ...
    ...
    def get_local_usage_per_roaming_states(self, start_time: datetime.datetime, end_time: datetime.datetime, states: RoamingStates, /) -> typing.Optional[DataUsage]: ...
    def get_network_connectivity_level(self) -> NetworkConnectivityLevel: ...
    def get_network_names(self) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    def get_network_usage_async(self, start_time: datetime.datetime, end_time: datetime.datetime, granularity: DataUsageGranularity, states: NetworkUsageStates, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[NetworkUsage]]: ...
    def get_provider_network_usage_async(self, start_time: datetime.datetime, end_time: datetime.datetime, states: NetworkUsageStates, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ProviderNetworkUsage]]: ...
...
class ConnectionProfileFilter(winrt.system.Object):
    ...
    @_property
    def raw_data(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
...
class ConnectivityManager_Static(type):
    def acquire_connection_async(cls, cellular_apn_context: typing.Optional[CellularApnContext], /) -> windows_foundation.IAsyncOperation[ConnectionSession]: ...
...
class LanIdentifierData(winrt.system.Object):
    ...
    @_property
    def value(self) -> typing.Optional[windows_foundation_collections.IVectorView[winrt.system.UInt8]]: ...
...
class NetworkInformation_Static(type):
    def find_connection_profiles_async(cls, p_profile_filter: typing.Optional[ConnectionProfileFilter], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ConnectionProfile]]: ...
    def get_connection_profiles(cls) -> typing.Optional[windows_foundation_collections.IVectorView[ConnectionProfile]]: ...
    def get_host_names(cls) -> typing.Optional[windows_foundation_collections.IVectorView[windows_networking.HostName]]: ...
    def get_internet_connection_profile(cls) -> typing.Optional[ConnectionProfile]: ...
    def get_lan_identifiers(cls) -> typing.Optional[windows_foundation_collections.IVectorView[LanIdentifier]]: ...
    def get_proxy_configuration_async(cls, uri: typing.Optional[windows_foundation.Uri], /) -> windows_foundation.IAsyncOperation[ProxyConfiguration]: ...
    def get_sorted_endpoint_pairs(cls, destination_list: typing.Iterable[windows_networking.EndpointPair], sort_options: windows_networking.HostNameSortOptions, /) -> typing.Optional[windows_foundation_collections.IVectorView[windows_networking.EndpointPair]]: ...
    def add_network_status_changed(cls, network_status_handler: typing.Optional[NetworkStatusChangedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
...
class ProxyConfiguration(winrt.system.Object):
    ...
    @_property
    def proxy_uris(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_foundation.Uri]]: ...

@typing.final
class RoutePolicy(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> RoutePolicy: ...
    def __new__(cls: typing.Type[RoutePolicy], connection_profile: typing.Optional[ConnectionProfile], host_name: typing.Optional[windows_networking.HostName], type: windows_networking.DomainNameType) -> RoutePolicy: ...
    @_property
    def connection_profile(self) -> typing.Optional[ConnectionProfile]: ...
    @_property
...
class WwanConnectionProfileDetails(winrt.system.Object):
    ...
    @_property
    def purpose_guids(self) -> typing.Optional[windows_foundation_collections.IVectorView[_uuid.UUID]]: ...
