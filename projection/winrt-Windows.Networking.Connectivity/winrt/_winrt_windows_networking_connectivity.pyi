...
class ConnectionProfile(winrt.system.Object):
    ...
    def get_network_names(self) -> windows_foundation_collections.IVectorView[str]: ...
...
class LanIdentifierData(winrt.system.Object):
    ...
    @_property
    def value(self) -> windows_foundation_collections.IVectorView[winrt.system.UInt8]: ...
...
class NetworkInformation_Static(type):
    def find_connection_profiles_async(cls, p_profile_filter: ConnectionProfileFilter, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[ConnectionProfile]]: ...
    def get_connection_profiles(cls) -> windows_foundation_collections.IVectorView[ConnectionProfile]: ...
    def get_host_names(cls) -> windows_foundation_collections.IVectorView[windows_networking.HostName]: ...
    def get_internet_connection_profile(cls) -> ConnectionProfile: ...
    def get_lan_identifiers(cls) -> windows_foundation_collections.IVectorView[LanIdentifier]: ...
    def get_proxy_configuration_async(cls, uri: windows_foundation.Uri, /) -> windows_foundation.IAsyncOperation[ProxyConfiguration]: ...
    def get_sorted_endpoint_pairs(cls, destination_list: typing.Iterable[windows_networking.EndpointPair], sort_options: windows_networking.HostNameSortOptions, /) -> windows_foundation_collections.IVectorView[windows_networking.EndpointPair]: ...
...
class ProxyConfiguration(winrt.system.Object):
    ...
    @_property
    def proxy_uris(self) -> windows_foundation_collections.IVectorView[windows_foundation.Uri]: ...

@typing.final
class RoutePolicy(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> RoutePolicy: ...
    def __new__(cls: typing.Type[RoutePolicy], connection_profile: ConnectionProfile, host_name: windows_networking.HostName, type: windows_networking.DomainNameType) -> RoutePolicy: ...
    @_property
    def connection_profile(self) -> ConnectionProfile: ...
    @_property
...
class WwanConnectionProfileDetails(winrt.system.Object):
    ...
    @_property
    def purpose_guids(self) -> windows_foundation_collections.IVectorView[_uuid.UUID]: ...
