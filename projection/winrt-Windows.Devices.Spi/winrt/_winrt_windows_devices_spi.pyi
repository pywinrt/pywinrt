...
class SpiBusInfo(winrt.system.Object):
    ...
    @_property
    def supported_data_bit_lengths(self) -> typing.Optional[windows_foundation_collections.IVectorView[winrt.system.Int32]]: ...
...
class SpiController_Static(type):
    def get_controllers_async(cls, provider: typing.Optional[windows_devices_spi_provider.ISpiProvider], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[SpiController]]: ...
...
class SpiDevice_Static(type):
    def from_id_async(cls, bus_id: str, settings: typing.Optional[SpiConnectionSettings], /) -> windows_foundation.IAsyncOperation[SpiDevice]: ...
...
class ISpiDeviceStatics(winrt.system.Object):
    ...
    def from_id_async(self, bus_id: str, settings: typing.Optional[SpiConnectionSettings], /) -> windows_foundation.IAsyncOperation[SpiDevice]: ...
