...
class SpiBusInfo(winrt.system.Object):
    ...
    @_property
    def supported_data_bit_lengths(self) -> windows_foundation_collections.IVectorView[winrt.system.Int32]: ...
...
class SpiController_Static(type):
    def get_controllers_async(cls, provider: windows_devices_spi_provider.ISpiProvider, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[SpiController]]: ...
