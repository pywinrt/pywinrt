...
class AsymmetricKeyAlgorithmProvider(winrt.system.Object, metaclass=AsymmetricKeyAlgorithmProvider_Static):
    ...
    def create_key_pair_with_curve_parameters(self, parameters: typing.Union[winrt.system.Array[winrt.system.UInt8], winrt.system.ReadableBuffer], /) -> typing.Optional[CryptographicKey]: ...
    def import_default_private_key_blob(self, key_blob: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[CryptographicKey]: ...
    def import_default_public_key_blob(self, key_blob: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[CryptographicKey]: ...
    def import_key_pair_with_blob_type(self, key_blob: typing.Optional[windows_storage_streams.IBuffer], blob_type: CryptographicPrivateKeyBlobType, /) -> typing.Optional[CryptographicKey]: ...
    def import_public_key_with_blob_type(self, key_blob: typing.Optional[windows_storage_streams.IBuffer], blob_type: CryptographicPublicKeyBlobType, /) -> typing.Optional[CryptographicKey]: ...
    @_property
    def algorithm_name(self) -> str: ...

@typing.final
class CryptographicEngine_Static(type):
    def decrypt(cls, key: typing.Optional[CryptographicKey], data: typing.Optional[windows_storage_streams.IBuffer], iv: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    def decrypt_and_authenticate(cls, key: typing.Optional[CryptographicKey], data: typing.Optional[windows_storage_streams.IBuffer], nonce: typing.Optional[windows_storage_streams.IBuffer], authentication_tag: typing.Optional[windows_storage_streams.IBuffer], authenticated_data: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    def decrypt_async(cls, key: typing.Optional[CryptographicKey], data: typing.Optional[windows_storage_streams.IBuffer], iv: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IBuffer]: ...
    def derive_key_material(cls, key: typing.Optional[CryptographicKey], parameters: typing.Optional[KeyDerivationParameters], desired_key_size: winrt.system.UInt32, /) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    def encrypt(cls, key: typing.Optional[CryptographicKey], data: typing.Optional[windows_storage_streams.IBuffer], iv: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    def encrypt_and_authenticate(cls, key: typing.Optional[CryptographicKey], data: typing.Optional[windows_storage_streams.IBuffer], nonce: typing.Optional[windows_storage_streams.IBuffer], authenticated_data: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[EncryptedAndAuthenticatedData]: ...
    def sign(cls, key: typing.Optional[CryptographicKey], data: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    def sign_async(cls, key: typing.Optional[CryptographicKey], data: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IBuffer]: ...
    def sign_hashed_data(cls, key: typing.Optional[CryptographicKey], data: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    def sign_hashed_data_async(cls, key: typing.Optional[CryptographicKey], data: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IBuffer]: ...
    def verify_signature(cls, key: typing.Optional[CryptographicKey], data: typing.Optional[windows_storage_streams.IBuffer], signature: typing.Optional[windows_storage_streams.IBuffer], /) -> bool: ...
    def verify_signature_with_hash_input(cls, key: typing.Optional[CryptographicKey], data: typing.Optional[windows_storage_streams.IBuffer], signature: typing.Optional[windows_storage_streams.IBuffer], /) -> bool: ...
...
class CryptographicHash(winrt.system.Object):
    ...
    def append(self, data: typing.Optional[windows_storage_streams.IBuffer], /) -> None: ...
    def get_value_and_reset(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...

@typing.final
class CryptographicKey(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> CryptographicKey: ...
    def export_default_private_key_blob_type(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    def export_default_public_key_blob_type(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    def export_private_key_with_blob_type(self, blob_type: CryptographicPrivateKeyBlobType, /) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    def export_public_key_with_blob_type(self, blob_type: CryptographicPublicKeyBlobType, /) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
...
class EccCurveNames_Static(type):
    @_property
    def all_ecc_curve_names(cls) -> typing.Optional[windows_foundation_collections.IVectorView[str]]: ...
    @_property
...
class EncryptedAndAuthenticatedData(winrt.system.Object):
    ...
    @_property
    def authentication_tag(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
...
class HashAlgorithmProvider(winrt.system.Object, metaclass=HashAlgorithmProvider_Static):
    ...
    def hash_data(self, data: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
    def algorithm_name(self) -> str: ...
    @_property
...
class KeyDerivationAlgorithmProvider(winrt.system.Object, metaclass=KeyDerivationAlgorithmProvider_Static):
    ...
    def create_key(self, key_material: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[CryptographicKey]: ...
    @_property
    def algorithm_name(self) -> str: ...
...
class KeyDerivationParameters_Static(type):
    ...
    def build_for_pbkdf2(cls, pbkdf2_salt: typing.Optional[windows_storage_streams.IBuffer], iteration_count: winrt.system.UInt32, /) -> typing.Optional[KeyDerivationParameters]: ...
    def build_for_s_p800108(cls, label: typing.Optional[windows_storage_streams.IBuffer], context: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[KeyDerivationParameters]: ...
    def build_for_s_p80056a(cls, algorithm_id: typing.Optional[windows_storage_streams.IBuffer], party_u_info: typing.Optional[windows_storage_streams.IBuffer], party_v_info: typing.Optional[windows_storage_streams.IBuffer], supp_pub_info: typing.Optional[windows_storage_streams.IBuffer], supp_priv_info: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[KeyDerivationParameters]: ...
...
class KeyDerivationParameters(winrt.system.Object, metaclass=KeyDerivationParameters_Static):
    ...
    @_property
    def kdf_generic_binary(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @kdf_generic_binary.setter
    def kdf_generic_binary(self, value: typing.Optional[windows_storage_streams.IBuffer]) -> None: ...
    @_property
...
class MacAlgorithmProvider(winrt.system.Object, metaclass=MacAlgorithmProvider_Static):
    ...
    def create_hash(self, key_material: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[CryptographicHash]: ...
    def create_key(self, key_material: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[CryptographicKey]: ...
    @_property
    def algorithm_name(self) -> str: ...
    @_property
...
class PersistedKeyProvider_Static(type):
    def open_key_pair_from_certificate_async(cls, certificate: typing.Optional[windows_security_cryptography_certificates.Certificate], hash_algorithm_name: str, padding: CryptographicPadding, /) -> windows_foundation.IAsyncOperation[CryptographicKey]: ...
    def open_public_key_from_certificate(cls, certificate: typing.Optional[windows_security_cryptography_certificates.Certificate], hash_algorithm_name: str, padding: CryptographicPadding, /) -> typing.Optional[CryptographicKey]: ...
...
class SymmetricKeyAlgorithmProvider(winrt.system.Object, metaclass=SymmetricKeyAlgorithmProvider_Static):
    ...
    def create_symmetric_key(self, key_material: typing.Optional[windows_storage_streams.IBuffer], /) -> typing.Optional[CryptographicKey]: ...
    @_property
    def algorithm_name(self) -> str: ...
    @_property
