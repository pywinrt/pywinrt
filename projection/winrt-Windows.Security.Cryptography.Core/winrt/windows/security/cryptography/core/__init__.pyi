...
class CryptographicEngine(winrt.system.Object):
    ...
    @staticmethod
    def verify_signature(key: typing.Optional[CryptographicKey], data: typing.Optional[winrt.windows.storage.streams.IBuffer], signature: typing.Optional[winrt.windows.storage.streams.IBuffer], /) -> winrt.system.Boolean: ...
    @staticmethod
    def verify_signature_with_hash_input(key: typing.Optional[CryptographicKey], data: typing.Optional[winrt.windows.storage.streams.IBuffer], signature: typing.Optional[winrt.windows.storage.streams.IBuffer], /) -> winrt.system.Boolean: ...
