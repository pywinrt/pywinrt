...
class DepthMediaFrame(winrt.system.Object):
    ...
    def try_create_coordinate_mapper(self, camera_intrinsics: windows_media_devices_core.CameraIntrinsics, coordinate_system: windows_perception_spatial.SpatialCoordinateSystem, /) -> windows_media_devices_core.DepthCorrelatedCoordinateMapper: ...
    @_property
...
class MediaFrameSource(winrt.system.Object):
    ...
    def try_get_camera_intrinsics(self, format: MediaFrameFormat, /) -> windows_media_devices_core.CameraIntrinsics: ...
    ...
    @_property
    def supported_formats(self) -> windows_foundation_collections.IVectorView[MediaFrameFormat]: ...
...
class MediaFrameSourceGroup(winrt.system.Object, metaclass=MediaFrameSourceGroup_Static):
    ...
    def id(self) -> str: ...
    @_property
    def source_infos(self) -> windows_foundation_collections.IVectorView[MediaFrameSourceInfo]: ...
...
class MediaFrameSourceInfo(winrt.system.Object):
    ...
    @_property
    def video_profile_media_description(self) -> windows_foundation_collections.IVectorView[windows_media_capture.MediaCaptureVideoProfileMediaDescription]: ...
    @_property
