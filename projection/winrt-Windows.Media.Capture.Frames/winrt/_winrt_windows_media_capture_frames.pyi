...
class AudioMediaFrame(winrt.system.Object):
    ...
    def get_audio_frame(self) -> typing.Optional[windows_media.AudioFrame]: ...
    @_property
    def audio_encoding_properties(self) -> typing.Optional[windows_media_mediaproperties.AudioEncodingProperties]: ...
    @_property
...
class DepthMediaFrame(winrt.system.Object):
    ...
    def try_create_coordinate_mapper(self, camera_intrinsics: typing.Optional[windows_media_devices_core.CameraIntrinsics], coordinate_system: typing.Optional[windows_perception_spatial.SpatialCoordinateSystem], /) -> typing.Optional[windows_media_devices_core.DepthCorrelatedCoordinateMapper]: ...
    @_property
...
class MediaFrameFormat(winrt.system.Object):
    ...
    @_property
    def frame_rate(self) -> typing.Optional[windows_media_mediaproperties.MediaRatio]: ...
    @_property
...
class MediaFrameSource(winrt.system.Object):
    ...
    def set_format_async(self, format: typing.Optional[MediaFrameFormat], /) -> windows_foundation.IAsyncAction: ...
    def try_get_camera_intrinsics(self, format: typing.Optional[MediaFrameFormat], /) -> typing.Optional[windows_media_devices_core.CameraIntrinsics]: ...
    ...
    def remove_format_changed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
    ...
    @_property
    def supported_formats(self) -> typing.Optional[windows_foundation_collections.IVectorView[MediaFrameFormat]]: ...
...
class MediaFrameSourceController(winrt.system.Object):
    ...
    def get_property_by_extended_id_async(self, extended_property_id: winrt.system.Array[winrt.system.UInt8], max_property_value_size: typing.Optional[winrt.system.UInt32], /) -> windows_foundation.IAsyncOperation[MediaFrameSourceGetPropertyResult]: ...
    def set_property_async(self, property_id: str, property_value: typing.Optional[winrt.system.Object], /) -> windows_foundation.IAsyncOperation[MediaFrameSourceSetPropertyStatus]: ...
    def set_property_by_extended_id_async(self, extended_property_id: winrt.system.Array[winrt.system.UInt8], property_value: winrt.system.Array[winrt.system.UInt8], /) -> windows_foundation.IAsyncOperation[MediaFrameSourceSetPropertyStatus]: ...
    @_property
...
class MediaFrameSourceGroup_Static(type):
    def find_all_async(cls) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[MediaFrameSourceGroup]]: ...
...
class MediaFrameSourceGroup(winrt.system.Object, metaclass=MediaFrameSourceGroup_Static):
    ...
    def id(self) -> str: ...
    @_property
    def source_infos(self) -> typing.Optional[windows_foundation_collections.IVectorView[MediaFrameSourceInfo]]: ...

@typing.final
class MediaFrameSourceInfo(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> MediaFrameSourceInfo: ...
    def get_relative_panel(self, display_region: typing.Optional[windows_ui_windowmanagement.DisplayRegion], /) -> windows_devices_enumeration.Panel: ...
    @_property
    def coordinate_system(self) -> typing.Optional[windows_perception_spatial.SpatialCoordinateSystem]: ...
    @_property
    ...
    @_property
    def video_profile_media_description(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_media_capture.MediaCaptureVideoProfileMediaDescription]]: ...
    @_property
...
class VideoMediaFrame(winrt.system.Object):
    ...
    def get_video_frame(self) -> typing.Optional[windows_media.VideoFrame]: ...
    @_property
