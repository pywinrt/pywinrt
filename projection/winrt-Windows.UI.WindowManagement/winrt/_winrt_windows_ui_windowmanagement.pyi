...
class AppWindow(winrt.system.Object, metaclass=AppWindow_Static):
    ...
    def get_display_regions(self) -> windows_foundation_collections.IVectorView[DisplayRegion]: ...
...
class AppWindowFrame(winrt.system.Object):
    ...
    @_property
    def drag_region_visuals(self) -> windows_foundation_collections.IVector[windows_ui_composition.IVisualElement]: ...
...
class AppWindowTitleBar(winrt.system.Object):
    ...
    def get_title_bar_occlusions(self) -> windows_foundation_collections.IVectorView[AppWindowTitleBarOcclusion]: ...
...
class WindowServices_Static(type):
    def find_all_top_level_window_ids(cls) -> windows_foundation_collections.IVectorView[windows_ui.WindowId]: ...
...
class WindowingEnvironment_Static(type):
    def find_all(cls) -> windows_foundation_collections.IVectorView[WindowingEnvironment]: ...
    def find_all_with_kind(cls, kind: WindowingEnvironmentKind, /) -> windows_foundation_collections.IVectorView[WindowingEnvironment]: ...
