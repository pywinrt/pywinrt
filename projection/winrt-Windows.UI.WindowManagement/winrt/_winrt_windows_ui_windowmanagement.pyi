...
class AppWindowPresenter(winrt.system.Object):
    ...
    def request_presentation(self, configuration: typing.Optional[AppWindowPresentationConfiguration], /) -> bool: ...
...
class WindowingEnvironment_Static(type):
    ...
    def find_all_with_kind(cls, kind: WindowingEnvironmentKind, /) -> typing.Optional[windows_foundation_collections.IVectorView[WindowingEnvironment]]: ...
