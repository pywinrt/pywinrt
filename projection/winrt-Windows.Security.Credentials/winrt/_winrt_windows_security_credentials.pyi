...
class KeyCredential(winrt.system.Object):
    ...
    def request_sign_async(self, data: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncOperation[KeyCredentialOperationResult]: ...
    def retrieve_public_key_with_blob_type(self, blob_type: windows_security_cryptography_core.CryptographicPublicKeyBlobType, /) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    def retrieve_public_key_with_default_blob_type(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
    def name(self) -> str: ...
...
class KeyCredentialAttestationResult(winrt.system.Object):
    ...
    @_property
    def attestation_buffer(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
    def certificate_chain_buffer(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
...
class PasswordVault(winrt.system.Object):
    ...
    def find_all_by_resource(self, resource: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[PasswordCredential]]: ...
    def find_all_by_user_name(self, user_name: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[PasswordCredential]]: ...
    ...
    def retrieve_all(self) -> typing.Optional[windows_foundation_collections.IVectorView[PasswordCredential]]: ...
...
class WebAccountProvider(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[WebAccountProvider], id: str, display_name: str, icon_uri: typing.Optional[windows_foundation.Uri]) -> WebAccountProvider: ...
    @_property
