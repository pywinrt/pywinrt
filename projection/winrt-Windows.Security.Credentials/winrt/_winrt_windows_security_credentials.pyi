...
class KeyCredential(winrt.system.Object):
    ...
    @typing.overload
    def retrieve_public_key(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @typing.overload
    def retrieve_public_key(self, blob_type: windows_security_cryptography_core.CryptographicPublicKeyBlobType, /) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
    def name(self) -> str: ...
