...
class PasswordVault(winrt.system.Object):
    ...
    def find_all_by_resource(self, resource: str, /) -> windows_foundation_collections.IVectorView[PasswordCredential]: ...
    def find_all_by_user_name(self, user_name: str, /) -> windows_foundation_collections.IVectorView[PasswordCredential]: ...
    def remove(self, credential: PasswordCredential, /) -> None: ...
    def retrieve(self, resource: str, user_name: str, /) -> PasswordCredential: ...
    def retrieve_all(self) -> windows_foundation_collections.IVectorView[PasswordCredential]: ...

@typing.final
class WebAccount(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> WebAccount: ...
    def __new__(cls: typing.Type[WebAccount], web_account_provider: WebAccountProvider, user_name: str, state: WebAccountState) -> WebAccount: ...
...
class WebAccountProvider(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[WebAccountProvider], id: str, display_name: str, icon_uri: windows_foundation.Uri) -> WebAccountProvider: ...
    @_property
