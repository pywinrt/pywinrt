...
class KnownSmartCardAppletIds_Static(type):
    @_property
    def payment_system_environment(cls) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
    def proximity_payment_system_environment(cls) -> typing.Optional[windows_storage_streams.IBuffer]: ...
...
class SmartCardAppletIdGroup(winrt.system.Object, metaclass=SmartCardAppletIdGroup_Static):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SmartCardAppletIdGroup], display_name: str, applet_ids: windows_foundation_collections.IVector[windows_storage_streams.IBuffer], emulation_category: SmartCardEmulationCategory, emulation_type: SmartCardEmulationType) -> SmartCardAppletIdGroup: ...
    @typing.overload
    ...
    @_property
    def applet_ids(self) -> typing.Optional[windows_foundation_collections.IVector[windows_storage_streams.IBuffer]]: ...
    @_property
    ...
    @logo.setter
    def logo(self, value: typing.Optional[windows_storage_streams.IRandomAccessStreamReference]) -> None: ...
    @_property
...
class SmartCardAppletIdGroupRegistration(winrt.system.Object):
    ...
    def set_properties_async(self, props: typing.Optional[windows_foundation_collections.ValueSet], /) -> windows_foundation.IAsyncAction: ...
    @_property
...
class SmartCardAutomaticResponseApdu(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[SmartCardAutomaticResponseApdu], command_apdu: typing.Optional[windows_storage_streams.IBuffer], response_apdu: typing.Optional[windows_storage_streams.IBuffer]) -> SmartCardAutomaticResponseApdu: ...
    @_property
    def should_match_length(self) -> bool: ...
    @should_match_length.setter
    def should_match_length(self, value: bool) -> None: ...
    @_property
    def response_apdu(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @response_apdu.setter
    def response_apdu(self, value: typing.Optional[windows_storage_streams.IBuffer]) -> None: ...
    @_property
    def command_apdu_bit_mask(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @command_apdu_bit_mask.setter
    def command_apdu_bit_mask(self, value: typing.Optional[windows_storage_streams.IBuffer]) -> None: ...
    @_property
    def command_apdu(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @command_apdu.setter
    def command_apdu(self, value: typing.Optional[windows_storage_streams.IBuffer]) -> None: ...
    @_property
    def applet_id(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @applet_id.setter
    def applet_id(self, value: typing.Optional[windows_storage_streams.IBuffer]) -> None: ...
    @_property
...
class SmartCardChallengeContext(winrt.system.Object):
    ...
    def change_administrative_key_async(self, response: typing.Optional[windows_storage_streams.IBuffer], new_administrative_key: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncAction: ...
    def close(self) -> None: ...
    def provision_async(self, response: typing.Optional[windows_storage_streams.IBuffer], format_card: bool, /) -> windows_foundation.IAsyncAction: ...
    def provision_async_with_new_card_id(self, response: typing.Optional[windows_storage_streams.IBuffer], format_card: bool, new_card_id: _uuid.UUID, /) -> windows_foundation.IAsyncAction: ...
    def verify_response_async(self, response: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @_property
    def challenge(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
...
class SmartCardConnection(winrt.system.Object):
    ...
    def close(self) -> None: ...
    def transmit_async(self, command: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IBuffer]: ...
...
class SmartCardCryptogramGenerator(winrt.system.Object, metaclass=SmartCardCryptogramGenerator_Static):
    ...
    def import_cryptogram_material_package_async(self, format: SmartCardCryptogramMaterialPackageFormat, storage_key_name: str, material_package_name: str, cryptogram_material_package: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]: ...
    ...
    def try_prove_possession_of_cryptogram_material_package_async(self, prompting_behavior: SmartCardUnlockPromptingBehavior, response_format: SmartCardCryptogramMaterialPackageConfirmationResponseFormat, material_package_name: str, material_name: str, challenge: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramMaterialPossessionProof]: ...
    def validate_request_apdu_async(self, prompting_behavior: SmartCardUnlockPromptingBehavior, apdu_to_validate: typing.Optional[windows_storage_streams.IBuffer], cryptogram_placement_steps: typing.Iterable[SmartCardCryptogramPlacementStep], /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]: ...
    @_property
    def supported_cryptogram_algorithms(self) -> typing.Optional[windows_foundation_collections.IVectorView[SmartCardCryptogramAlgorithm]]: ...
    @_property
    def supported_cryptogram_material_package_confirmation_response_formats(self) -> typing.Optional[windows_foundation_collections.IVectorView[SmartCardCryptogramMaterialPackageConfirmationResponseFormat]]: ...
    @_property
    def supported_cryptogram_material_package_formats(self) -> typing.Optional[windows_foundation_collections.IVectorView[SmartCardCryptogramMaterialPackageFormat]]: ...
    @_property
    def supported_cryptogram_material_types(self) -> typing.Optional[windows_foundation_collections.IVectorView[SmartCardCryptogramMaterialType]]: ...
    @_property
    def supported_smart_card_cryptogram_storage_key_capabilities(self) -> typing.Optional[windows_foundation_collections.IVectorView[SmartCardCryptogramStorageKeyCapabilities]]: ...
...
class SmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult(winrt.system.Object):
    ...
    @_property
    def characteristics(self) -> typing.Optional[windows_foundation_collections.IVectorView[SmartCardCryptogramMaterialCharacteristics]]: ...
    @_property
...
class SmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult(winrt.system.Object):
    ...
    @_property
    def characteristics(self) -> typing.Optional[windows_foundation_collections.IVectorView[SmartCardCryptogramMaterialPackageCharacteristics]]: ...
    @_property
    def operation_status(self) -> SmartCardCryptogramGeneratorOperationStatus: ...
...
class SmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult(winrt.system.Object):
    ...
    @_property
    def characteristics(self) -> typing.Optional[windows_foundation_collections.IVectorView[SmartCardCryptogramStorageKeyCharacteristics]]: ...
    @_property
    def operation_status(self) -> SmartCardCryptogramGeneratorOperationStatus: ...
...
class SmartCardCryptogramMaterialCharacteristics(winrt.system.Object):
    ...
    @_property
    def allowed_algorithms(self) -> typing.Optional[windows_foundation_collections.IVectorView[SmartCardCryptogramAlgorithm]]: ...
    @_property
    def allowed_proof_of_possession_algorithms(self) -> typing.Optional[windows_foundation_collections.IVectorView[SmartCardCryptogramMaterialPackageConfirmationResponseFormat]]: ...
    @_property
    def allowed_validations(self) -> typing.Optional[windows_foundation_collections.IVectorView[SmartCardCryptogramAlgorithm]]: ...
    @_property
...
class SmartCardCryptogramMaterialPossessionProof(winrt.system.Object):
    ...
    def operation_status(self) -> SmartCardCryptogramGeneratorOperationStatus: ...
    @_property
    def proof(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
...
class SmartCardCryptogramPlacementStep(winrt.system.Object):
    ...
    @_property
    def source_data(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @source_data.setter
    def source_data(self, value: typing.Optional[windows_storage_streams.IBuffer]) -> None: ...
    @_property
...
class SmartCardCryptogramStorageKeyInfo(winrt.system.Object):
    ...
    @_property
    def attestation(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
    def attestation_certificate_chain(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
    ...
    def operation_status(self) -> SmartCardCryptogramGeneratorOperationStatus: ...
    @_property
    def public_key(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
...
class SmartCardEmulator_Static(type):
    def get_applet_id_group_registrations_async(cls) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[SmartCardAppletIdGroupRegistration]]: ...
    def get_default_async(cls) -> windows_foundation.IAsyncOperation[SmartCardEmulator]: ...
    def is_supported(cls) -> bool: ...
    def register_applet_id_group_async(cls, applet_id_group: typing.Optional[SmartCardAppletIdGroup], /) -> windows_foundation.IAsyncOperation[SmartCardAppletIdGroupRegistration]: ...
    def unregister_applet_id_group_async(cls, registration: typing.Optional[SmartCardAppletIdGroupRegistration], /) -> windows_foundation.IAsyncAction: ...
    @_property
...
class SmartCardEmulatorApduReceivedEventArgs(winrt.system.Object):
    ...
    def try_respond_async(self, response_apdu: typing.Optional[windows_storage_streams.IBuffer], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_respond_with_cryptograms_and_state_async(self, response_template: typing.Optional[windows_storage_streams.IBuffer], cryptogram_placement_steps: typing.Iterable[SmartCardCryptogramPlacementStep], next_state: typing.Optional[winrt.system.UInt32], /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]: ...
    def try_respond_with_cryptograms_async(self, response_template: typing.Optional[windows_storage_streams.IBuffer], cryptogram_placement_steps: typing.Iterable[SmartCardCryptogramPlacementStep], /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]: ...
    def try_respond_with_state_async(self, response_apdu: typing.Optional[windows_storage_streams.IBuffer], next_state: typing.Optional[winrt.system.UInt32], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @_property
...
class SmartCardPinResetRequest(winrt.system.Object):
    ...
    def set_response(self, response: typing.Optional[windows_storage_streams.IBuffer], /) -> None: ...
    @_property
    def challenge(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
...
class SmartCardProvisioning_Static(type):
    def from_smart_card_async(cls, card: typing.Optional[SmartCard], /) -> windows_foundation.IAsyncOperation[SmartCardProvisioning]: ...
    def request_attested_virtual_smart_card_creation_async(cls, friendly_name: str, administrative_key: typing.Optional[windows_storage_streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy], /) -> windows_foundation.IAsyncOperation[SmartCardProvisioning]: ...
    def request_attested_virtual_smart_card_creation_async_with_card_id(cls, friendly_name: str, administrative_key: typing.Optional[windows_storage_streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy], card_id: _uuid.UUID, /) -> windows_foundation.IAsyncOperation[SmartCardProvisioning]: ...
    def request_virtual_smart_card_creation_async(cls, friendly_name: str, administrative_key: typing.Optional[windows_storage_streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy], /) -> windows_foundation.IAsyncOperation[SmartCardProvisioning]: ...
    def request_virtual_smart_card_creation_async_with_card_id(cls, friendly_name: str, administrative_key: typing.Optional[windows_storage_streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy], card_id: _uuid.UUID, /) -> windows_foundation.IAsyncOperation[SmartCardProvisioning]: ...
    def request_virtual_smart_card_deletion_async(cls, card: typing.Optional[SmartCard], /) -> windows_foundation.IAsyncOperation[bool]: ...
...
class SmartCardProvisioning(winrt.system.Object, metaclass=SmartCardProvisioning_Static):
    ...
    def request_pin_reset_async(self, handler: typing.Optional[SmartCardPinResetHandler], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @_property
    def smart_card(self) -> typing.Optional[SmartCard]: ...
...
class SmartCardReader(winrt.system.Object, metaclass=SmartCardReader_Static):
    ...
    def find_all_cards_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[SmartCard]]: ...
...
class SmartCardTriggerDetails(winrt.system.Object):
    ...
    @_property
    def source_applet_id(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
    def trigger_data(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
