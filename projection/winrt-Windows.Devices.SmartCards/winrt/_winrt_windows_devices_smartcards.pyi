...
class SmartCardAppletIdGroup(winrt.system.Object, metaclass=SmartCardAppletIdGroup_Static):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SmartCardAppletIdGroup], display_name: str, applet_ids: typing.MutableSequence[windows_storage_streams.ImplementsIBuffer], emulation_category: SmartCardEmulationCategory, emulation_type: SmartCardEmulationType) -> SmartCardAppletIdGroup: ...
    @typing.overload
...
class SmartCardAutomaticResponseApdu(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[SmartCardAutomaticResponseApdu], command_apdu: windows_storage_streams.ImplementsIBuffer, response_apdu: windows_storage_streams.ImplementsIBuffer) -> SmartCardAutomaticResponseApdu: ...
    @_property
