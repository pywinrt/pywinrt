...
class SmartCardAppletIdGroup(winrt.system.Object, metaclass=SmartCardAppletIdGroup_Static):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SmartCardAppletIdGroup], display_name: str, applet_ids: typing.MutableSequence[windows_storage_streams.IBuffer], emulation_category: SmartCardEmulationCategory, emulation_type: SmartCardEmulationType) -> SmartCardAppletIdGroup: ...
    @typing.overload
