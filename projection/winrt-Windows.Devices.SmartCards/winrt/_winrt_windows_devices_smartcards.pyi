...
class SmartCardChallengeContext(winrt.system.Object):
    ...
    @typing.overload
    def provision_async(self, response: typing.Optional[windows_storage_streams.IBuffer], format_card: bool, new_card_id: _uuid.UUID, /) -> windows_foundation.IAsyncAction: ...
...
class SmartCardEmulatorApduReceivedEventArgs(winrt.system.Object):
    ...
    @typing.overload
    def try_respond_async(self, response_apdu: typing.Optional[windows_storage_streams.IBuffer], next_state: typing.Optional[winrt.system.UInt32], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
...
class SmartCardProvisioning_Static(type):
    ...
    @typing.overload
    def request_attested_virtual_smart_card_creation_async(cls, friendly_name: str, administrative_key: typing.Optional[windows_storage_streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy], card_id: _uuid.UUID, /) -> windows_foundation.IAsyncOperation[SmartCardProvisioning]: ...
    @typing.overload
    ...
    @typing.overload
    def request_virtual_smart_card_creation_async(cls, friendly_name: str, administrative_key: typing.Optional[windows_storage_streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy], card_id: _uuid.UUID, /) -> windows_foundation.IAsyncOperation[SmartCardProvisioning]: ...
