...
class SmartCardAppletIdGroup(winrt.system.Object, metaclass=SmartCardAppletIdGroup_Static):
    ...
    @_property
    def applet_ids(self) -> windows_foundation_collections.IVector[windows_storage_streams.IBuffer]: ...
    @_property
...
class SmartCardAutomaticResponseApdu(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[SmartCardAutomaticResponseApdu], command_apdu: windows_storage_streams.IBuffer, response_apdu: windows_storage_streams.IBuffer) -> SmartCardAutomaticResponseApdu: ...
    @_property
    ...
    def response_apdu(self, value: windows_storage_streams.IBuffer) -> None: ...
    @_property
    def command_apdu_bit_mask(self) -> windows_storage_streams.IBuffer: ...
    @command_apdu_bit_mask.setter
    def command_apdu_bit_mask(self, value: windows_storage_streams.IBuffer) -> None: ...
    @_property
    def command_apdu(self) -> windows_storage_streams.IBuffer: ...
    @command_apdu.setter
    def command_apdu(self, value: windows_storage_streams.IBuffer) -> None: ...
    @_property
    def applet_id(self) -> windows_storage_streams.IBuffer: ...
    @applet_id.setter
    def applet_id(self, value: windows_storage_streams.IBuffer) -> None: ...
    @_property
...
class SmartCardChallengeContext(winrt.system.Object):
    ...
    def change_administrative_key_async(self, response: windows_storage_streams.IBuffer, new_administrative_key: windows_storage_streams.IBuffer, /) -> windows_foundation.IAsyncAction: ...
    def close(self) -> None: ...
    def provision_async(self, response: windows_storage_streams.IBuffer, format_card: bool, /) -> windows_foundation.IAsyncAction: ...
    def provision_async_with_new_card_id(self, response: windows_storage_streams.IBuffer, format_card: bool, new_card_id: _uuid.UUID, /) -> windows_foundation.IAsyncAction: ...
    def verify_response_async(self, response: windows_storage_streams.IBuffer, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @_property
...
class SmartCardCryptogramGenerator(winrt.system.Object, metaclass=SmartCardCryptogramGenerator_Static):
    ...
    def import_cryptogram_material_package_async(self, format: SmartCardCryptogramMaterialPackageFormat, storage_key_name: str, material_package_name: str, cryptogram_material_package: windows_storage_streams.IBuffer, /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]: ...
    ...
    def try_prove_possession_of_cryptogram_material_package_async(self, prompting_behavior: SmartCardUnlockPromptingBehavior, response_format: SmartCardCryptogramMaterialPackageConfirmationResponseFormat, material_package_name: str, material_name: str, challenge: windows_storage_streams.IBuffer, /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramMaterialPossessionProof]: ...
    def validate_request_apdu_async(self, prompting_behavior: SmartCardUnlockPromptingBehavior, apdu_to_validate: windows_storage_streams.IBuffer, cryptogram_placement_steps: typing.Iterable[SmartCardCryptogramPlacementStep], /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]: ...
    @_property
    def supported_cryptogram_algorithms(self) -> windows_foundation_collections.IVectorView[SmartCardCryptogramAlgorithm]: ...
    @_property
    def supported_cryptogram_material_package_confirmation_response_formats(self) -> windows_foundation_collections.IVectorView[SmartCardCryptogramMaterialPackageConfirmationResponseFormat]: ...
    @_property
    def supported_cryptogram_material_package_formats(self) -> windows_foundation_collections.IVectorView[SmartCardCryptogramMaterialPackageFormat]: ...
    @_property
    def supported_cryptogram_material_types(self) -> windows_foundation_collections.IVectorView[SmartCardCryptogramMaterialType]: ...
    @_property
    def supported_smart_card_cryptogram_storage_key_capabilities(self) -> windows_foundation_collections.IVectorView[SmartCardCryptogramStorageKeyCapabilities]: ...
...
class SmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult(winrt.system.Object):
    ...
    @_property
    def characteristics(self) -> windows_foundation_collections.IVectorView[SmartCardCryptogramMaterialCharacteristics]: ...
    @_property
...
class SmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult(winrt.system.Object):
    ...
    @_property
    def characteristics(self) -> windows_foundation_collections.IVectorView[SmartCardCryptogramMaterialPackageCharacteristics]: ...
    @_property
    def operation_status(self) -> SmartCardCryptogramGeneratorOperationStatus: ...
...
class SmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult(winrt.system.Object):
    ...
    @_property
    def characteristics(self) -> windows_foundation_collections.IVectorView[SmartCardCryptogramStorageKeyCharacteristics]: ...
    @_property
    def operation_status(self) -> SmartCardCryptogramGeneratorOperationStatus: ...
...
class SmartCardCryptogramMaterialCharacteristics(winrt.system.Object):
    ...
    @_property
    def allowed_algorithms(self) -> windows_foundation_collections.IVectorView[SmartCardCryptogramAlgorithm]: ...
    @_property
    def allowed_proof_of_possession_algorithms(self) -> windows_foundation_collections.IVectorView[SmartCardCryptogramMaterialPackageConfirmationResponseFormat]: ...
    @_property
    def allowed_validations(self) -> windows_foundation_collections.IVectorView[SmartCardCryptogramAlgorithm]: ...
    @_property
...
class SmartCardCryptogramPlacementStep(winrt.system.Object):
    ...
    @source_data.setter
    def source_data(self, value: windows_storage_streams.IBuffer) -> None: ...
    @_property
...
class SmartCardEmulatorApduReceivedEventArgs(winrt.system.Object):
    ...
    def try_respond_async(self, response_apdu: windows_storage_streams.IBuffer, /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_respond_with_cryptograms_and_state_async(self, response_template: windows_storage_streams.IBuffer, cryptogram_placement_steps: typing.Iterable[SmartCardCryptogramPlacementStep], next_state: typing.Optional[winrt.system.UInt32], /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]: ...
    def try_respond_with_cryptograms_async(self, response_template: windows_storage_streams.IBuffer, cryptogram_placement_steps: typing.Iterable[SmartCardCryptogramPlacementStep], /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]: ...
    def try_respond_with_state_async(self, response_apdu: windows_storage_streams.IBuffer, next_state: typing.Optional[winrt.system.UInt32], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @_property
...
class SmartCardPinResetRequest(winrt.system.Object):
    ...
    def set_response(self, response: windows_storage_streams.IBuffer, /) -> None: ...
    @_property
    def challenge(self) -> windows_storage_streams.IBuffer: ...
    @_property
...
class SmartCardProvisioning_Static(type):
    ...
    def request_attested_virtual_smart_card_creation_async(cls, friendly_name: str, administrative_key: windows_storage_streams.IBuffer, pin_policy: SmartCardPinPolicy, /) -> windows_foundation.IAsyncOperation[SmartCardProvisioning]: ...
    def request_attested_virtual_smart_card_creation_async_with_card_id(cls, friendly_name: str, administrative_key: windows_storage_streams.IBuffer, pin_policy: SmartCardPinPolicy, card_id: _uuid.UUID, /) -> windows_foundation.IAsyncOperation[SmartCardProvisioning]: ...
    def request_virtual_smart_card_creation_async(cls, friendly_name: str, administrative_key: windows_storage_streams.IBuffer, pin_policy: SmartCardPinPolicy, /) -> windows_foundation.IAsyncOperation[SmartCardProvisioning]: ...
    def request_virtual_smart_card_creation_async_with_card_id(cls, friendly_name: str, administrative_key: windows_storage_streams.IBuffer, pin_policy: SmartCardPinPolicy, card_id: _uuid.UUID, /) -> windows_foundation.IAsyncOperation[SmartCardProvisioning]: ...
