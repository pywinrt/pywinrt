...
class SmartCardProvisioning(winrt.system.Object):
    ...
    @typing.overload
    @staticmethod
    def request_attested_virtual_smart_card_creation_async(friendly_name: str, administrative_key: typing.Optional[winrt.windows.storage.streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy], card_id: _uuid.UUID, /) -> winrt.windows.foundation.IAsyncOperation[SmartCardProvisioning]: ...
    ...
    @typing.overload
    @staticmethod
    def request_virtual_smart_card_creation_async(friendly_name: str, administrative_key: typing.Optional[winrt.windows.storage.streams.IBuffer], pin_policy: typing.Optional[SmartCardPinPolicy], card_id: _uuid.UUID, /) -> winrt.windows.foundation.IAsyncOperation[SmartCardProvisioning]: ...
    @staticmethod
    def request_virtual_smart_card_deletion_async(card: typing.Optional[SmartCard], /) -> winrt.windows.foundation.IAsyncOperation[bool]: ...
