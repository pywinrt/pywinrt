...
class SmartCardChallengeContext(winrt.system.Object):
    ...
    @typing.overload
    def provision_async(self, response: typing.Optional[winrt.windows.storage.streams.IBuffer], format_card: bool, new_card_id: uuid.UUID, /) -> winrt.windows.foundation.IAsyncAction: ...
