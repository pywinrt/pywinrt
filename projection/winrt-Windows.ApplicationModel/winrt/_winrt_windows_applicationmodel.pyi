...
class AppInstallerInfo(winrt.system.Object):
    ...
    @_property
    def dependency_package_uris(self) -> windows_foundation_collections.IVectorView[windows_foundation.Uri]: ...
    @_property
    ...
    @_property
    def optional_package_uris(self) -> windows_foundation_collections.IVectorView[windows_foundation.Uri]: ...
    @_property
    def paused_until(self) -> typing.Optional[datetime.datetime]: ...
    @_property
    def policy_source(self) -> AppInstallerPolicySource: ...
    @_property
    def repair_uris(self) -> windows_foundation_collections.IVectorView[windows_foundation.Uri]: ...
    @_property
    def show_prompt(self) -> bool: ...
    @_property
    def update_blocks_activation(self) -> bool: ...
    @_property
    def update_uris(self) -> windows_foundation_collections.IVectorView[windows_foundation.Uri]: ...
    @_property
...
class Package(winrt.system.Object, metaclass=Package_Static):
    ...
    def find_related_packages(self, options: FindRelatedPackagesOptions, /) -> windows_foundation_collections.IVector[Package]: ...
    def get_app_installer_info(self) -> AppInstallerInfo: ...
    def get_app_list_entries(self) -> windows_foundation_collections.IVectorView[windows_applicationmodel_core.AppListEntry]: ...
    ...
    def stage_content_groups_with_priority_async(self, names: typing.Iterable[str], move_to_head_of_queue: bool, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVector[PackageContentGroup]]: ...
    def verify_content_integrity_async(self) -> windows_foundation.IAsyncOperation[bool]: ...
    @_property
    def dependencies(self) -> windows_foundation_collections.IVectorView[Package]: ...
    @_property
...
class PackageCatalogRemoveOptionalPackagesResult(winrt.system.Object):
    ...
    def extended_error(self) -> windows_foundation.HResult: ...
    @_property
    def packages_removed(self) -> windows_foundation_collections.IVectorView[Package]: ...
