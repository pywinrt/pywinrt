...
class SelectableWordsSegmenter(winrt.system.Object):
    ...
    def get_tokens(self, text: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[SelectableWordSegment]]: ...
...
class SemanticTextQuery(winrt.system.Object):
    ...
    def find(self, content: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[TextSegment]]: ...
    def find_in_property(self, property_content: str, property_name: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[TextSegment]]: ...
...
class TextConversionGenerator(winrt.system.Object):
    ...
    def get_candidates_async(self, input: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[str]]: ...
    def get_candidates_with_max_count_async(self, input: str, max_candidates: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[str]]: ...
    @_property
...
class TextPredictionGenerator(winrt.system.Object):
    ...
    def get_candidates_async(self, input: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[str]]: ...
    def get_candidates_with_max_count_async(self, input: str, max_candidates: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[str]]: ...
    def get_candidates_with_parameters_async(self, input: str, max_candidates: winrt.system.UInt32, prediction_options: TextPredictionOptions, previous_strings: typing.Iterable[str], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[str]]: ...
    def get_next_word_candidates_async(self, max_candidates: winrt.system.UInt32, previous_strings: typing.Iterable[str], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[str]]: ...
    @_property
    def language_available_but_not_installed(self) -> bool: ...
    @_property
    def resolved_language(self) -> str: ...
...
class TextReverseConversionGenerator(winrt.system.Object):
    ...
    def get_phonemes_async(self, input: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[TextPhoneme]]: ...
    @_property
    def language_available_but_not_installed(self) -> bool: ...
    @_property
    def resolved_language(self) -> str: ...
...
class WordSegment(winrt.system.Object):
    ...
    @_property
    def alternate_forms(self) -> typing.Optional[windows_foundation_collections.IVectorView[AlternateWordForm]]: ...
    @_property
    def source_text_segment(self) -> TextSegment: ...
    @_property
    def text(self) -> str: ...
...
class WordsSegmenter(winrt.system.Object):
    ...
    def get_tokens(self, text: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[WordSegment]]: ...
