...
class SelectableWordsSegmenter(winrt.system.Object):
    ...
    def get_tokens(self, text: str, /) -> windows_foundation_collections.IVectorView[SelectableWordSegment]: ...
...
class SemanticTextQuery(winrt.system.Object):
    ...
    def find(self, content: str, /) -> windows_foundation_collections.IVectorView[TextSegment]: ...
    def find_in_property(self, property_content: str, property_name: str, /) -> windows_foundation_collections.IVectorView[TextSegment]: ...
...
class WordSegment(winrt.system.Object):
    ...
    @_property
    def alternate_forms(self) -> windows_foundation_collections.IVectorView[AlternateWordForm]: ...
    @_property
    def source_text_segment(self) -> TextSegment: ...
    @_property
    def text(self) -> str: ...
...
class WordsSegmenter(winrt.system.Object):
    ...
    def get_tokens(self, text: str, /) -> windows_foundation_collections.IVectorView[WordSegment]: ...
