...
class SpatialGraphInteropPreview_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_create_frame_of_reference_with_position(cls, coordinate_system: windows_perception_spatial.SpatialCoordinateSystem, relative_position: windows_foundation_numerics.Vector3, /) -> typing.Optional[SpatialGraphInteropFrameOfReferencePreview]: ...
    ...
    def try_create_frame_of_reference_with_position_and_orientation(cls, coordinate_system: windows_perception_spatial.SpatialCoordinateSystem, relative_position: windows_foundation_numerics.Vector3, relative_orientation: windows_foundation_numerics.Quaternion, /) -> typing.Optional[SpatialGraphInteropFrameOfReferencePreview]: ...
