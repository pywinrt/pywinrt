...
namespace py::cpp::Microsoft::UI::Xaml::Media::Imaging
{
    ...
    struct PyWinrtBitmapSource : winrt::Microsoft::UI::Xaml::Media::Imaging::BitmapSourceT<PyWinrtBitmapSource>
    {
    };
    ...
    struct PyWinrtSurfaceImageSource : winrt::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSourceT<PyWinrtSurfaceImageSource>
    {
        PyWinrtSurfaceImageSource(int32_t pixelWidth, int32_t pixelHeight) : winrt::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSourceT<PyWinrtSurfaceImageSource>(pixelWidth, pixelHeight) {}
        PyWinrtSurfaceImageSource(int32_t pixelWidth, int32_t pixelHeight, bool isOpaque) : winrt::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSourceT<PyWinrtSurfaceImageSource>(pixelWidth, pixelHeight, isOpaque) {}
    };
        ...
        if (arg_count == 2)
        {
            try
            {
                ...
                if (type != self_type)
                {
                    ...
                    auto self = reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSource*>(type->tp_alloc(type, 0));
                    if (!self)
                    {
                        return nullptr;
                    }
    ...
    struct PyWinrtSvgImageSource : winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSourceT<PyWinrtSvgImageSource>
    {
        PyWinrtSvgImageSource() : winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSourceT<PyWinrtSvgImageSource>() {}
        PyWinrtSvgImageSource(winrt::Windows::Foundation::Uri uriSource) : winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSourceT<PyWinrtSvgImageSource>(uriSource) {}
    };
        ...
        if (arg_count == 0)
        {
            try
            {
                if (type != self_type)
                {
                    ...
                    auto self = reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Media::Imaging::SvgImageSource*>(type->tp_alloc(type, 0));
                    if (!self)
                    {
                        return nullptr;
                    }
    ...
    struct PyWinrtXamlRenderingBackgroundTask : winrt::Microsoft::UI::Xaml::Media::Imaging::XamlRenderingBackgroundTaskT<PyWinrtXamlRenderingBackgroundTask>
    {
    };
