...
namespace py::cpp::Microsoft::UI::Xaml::Media::Imaging
{
    ...
    struct PyWinrtBitmapSource : py::py_obj_ref, winrt::Microsoft::UI::Xaml::Media::Imaging::BitmapSourceT<PyWinrtBitmapSource>
    {
    ...
    struct PyWinrtSurfaceImageSource : py::py_obj_ref, winrt::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSourceT<PyWinrtSurfaceImageSource>
    {
        PyWinrtSurfaceImageSource(PyObject* py_obj, int32_t pixelWidth, int32_t pixelHeight) : py::py_obj_ref(py_obj), winrt::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSourceT<PyWinrtSurfaceImageSource>(pixelWidth, pixelHeight) {}
        PyWinrtSurfaceImageSource(PyObject* py_obj, int32_t pixelWidth, int32_t pixelHeight, bool isOpaque) : py::py_obj_ref(py_obj), winrt::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSourceT<PyWinrtSurfaceImageSource>(pixelWidth, pixelHeight, isOpaque) {}
        ...
        if (arg_count == 2)
        {
            try
            {
                ...
                if (type != self_type)
                {
                    ...
                    std::construct_at(&reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSource*>(self.get())->obj, nullptr);
                    reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSource*>(self.get())->obj = winrt::make<PyWinrtSurfaceImageSource>(self.get(), param0, param1);
        ...
        else if (arg_count == 3)
        {
            try
            {
                ...
                if (type != self_type)
                {
                    ...
                    std::construct_at(&reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSource*>(self.get())->obj, nullptr);
                    reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Media::Imaging::SurfaceImageSource*>(self.get())->obj = winrt::make<PyWinrtSurfaceImageSource>(self.get(), param0, param1, param2);
    ...
    struct PyWinrtSvgImageSource : py::py_obj_ref, winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSourceT<PyWinrtSvgImageSource>
    {
        PyWinrtSvgImageSource(PyObject* py_obj) : py::py_obj_ref(py_obj), winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSourceT<PyWinrtSvgImageSource>() {}
        PyWinrtSvgImageSource(PyObject* py_obj, winrt::Windows::Foundation::Uri uriSource) : py::py_obj_ref(py_obj), winrt::Microsoft::UI::Xaml::Media::Imaging::SvgImageSourceT<PyWinrtSvgImageSource>(uriSource) {}
        ...
        if (arg_count == 0)
        {
            try
            {
                if (type != self_type)
                {
                    ...
                    std::construct_at(&reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Media::Imaging::SvgImageSource*>(self.get())->obj, nullptr);
                    reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Media::Imaging::SvgImageSource*>(self.get())->obj = winrt::make<PyWinrtSvgImageSource>(self.get());
        ...
        else if (arg_count == 1)
        {
            try
            {
                ...
                if (type != self_type)
                {
                    ...
                    std::construct_at(&reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Media::Imaging::SvgImageSource*>(self.get())->obj, nullptr);
                    reinterpret_cast<py::wrapper::Microsoft::UI::Xaml::Media::Imaging::SvgImageSource*>(self.get())->obj = winrt::make<PyWinrtSvgImageSource>(self.get(), param0);
    ...
    struct PyWinrtXamlRenderingBackgroundTask : py::py_obj_ref, winrt::Microsoft::UI::Xaml::Media::Imaging::XamlRenderingBackgroundTaskT<PyWinrtXamlRenderingBackgroundTask>
    {
...
PyMODINIT_FUNC PyInit__winrt_microsoft_ui_xaml_media_imaging(void) noexcept
{
    ...
    py::pyobj_handle microsoft_ui_xaml_media_module{PyImport_ImportModule("winrt._winrt_microsoft_ui_xaml_media")};
