...
class BackgroundDownloader_Static(type):
    ...
    def get_current_downloads_for_group_async(cls, group: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[DownloadOperation]]: ...
...
class BackgroundDownloader(winrt.system.Object, metaclass=BackgroundDownloader_Static):
    ...
    def create_download_from_file(self, uri: typing.Optional[windows_foundation.Uri], result_file: typing.Optional[windows_storage.IStorageFile], request_body_file: typing.Optional[windows_storage.IStorageFile], /) -> typing.Optional[DownloadOperation]: ...
...
class BackgroundUploader_Static(type):
    ...
    def get_current_uploads_for_group_async(cls, group: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[UploadOperation]]: ...
...
class BackgroundUploader(winrt.system.Object, metaclass=BackgroundUploader_Static):
    ...
    def create_upload_with_form_data_and_auto_boundary_async(self, uri: typing.Optional[windows_foundation.Uri], parts: typing.Iterable[BackgroundTransferContentPart], /) -> windows_foundation.IAsyncOperation[UploadOperation]: ...
    def create_upload_with_sub_type_and_boundary_async(self, uri: typing.Optional[windows_foundation.Uri], parts: typing.Iterable[BackgroundTransferContentPart], sub_type: str, boundary: str, /) -> windows_foundation.IAsyncOperation[UploadOperation]: ...
    def create_upload_with_sub_type_async(self, uri: typing.Optional[windows_foundation.Uri], parts: typing.Iterable[BackgroundTransferContentPart], sub_type: str, /) -> windows_foundation.IAsyncOperation[UploadOperation]: ...
    def set_request_header(self, header_name: str, header_value: str, /) -> None: ...
    @_property
    def server_credential(self) -> typing.Optional[windows_security_credentials.PasswordCredential]: ...
    @server_credential.setter
