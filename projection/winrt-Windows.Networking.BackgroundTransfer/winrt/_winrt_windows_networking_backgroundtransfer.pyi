...
class BackgroundDownloader_Static(type):
    ...
    def get_current_downloads_for_transfer_group_async(cls, group: BackgroundTransferGroup, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[DownloadOperation]]: ...
...
class BackgroundDownloader(winrt.system.Object, metaclass=BackgroundDownloader_Static):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BackgroundDownloader], completion_group: BackgroundTransferCompletionGroup) -> BackgroundDownloader: ...
    @typing.overload
...
class BackgroundTransferCompletionGroupTriggerDetails(winrt.system.Object):
    ...
    @_property
    def downloads(self) -> windows_foundation_collections.IVectorView[DownloadOperation]: ...
    @_property
    def uploads(self) -> windows_foundation_collections.IVectorView[UploadOperation]: ...
...
class BackgroundTransferRangesDownloadedEventArgs(winrt.system.Object):
    ...
    @_property
    def added_ranges(self) -> windows_foundation_collections.IVector[BackgroundTransferFileRange]: ...
    @_property
...
class BackgroundUploader_Static(type):
    ...
    def get_current_uploads_for_transfer_group_async(cls, group: BackgroundTransferGroup, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[UploadOperation]]: ...
...
class BackgroundUploader(winrt.system.Object, metaclass=BackgroundUploader_Static):
    ...
    @typing.overload
    def __new__(cls: typing.Type[BackgroundUploader], completion_group: BackgroundTransferCompletionGroup) -> BackgroundUploader: ...
    @typing.overload
...
class ContentPrefetcher_Static(type):
    ...
    @_property
    def content_uris(cls) -> windows_foundation_collections.IVector[windows_foundation.Uri]: ...
    @_property
...
class DownloadOperation(winrt.system.Object):
    ...
    def get_downloaded_ranges(self) -> windows_foundation_collections.IVector[BackgroundTransferFileRange]: ...
    ...
    @_property
    def recoverable_web_error_statuses(self) -> windows_foundation_collections.IVector[windows_web.WebErrorStatus]: ...
...
class ResponseInformation(winrt.system.Object):
    ...
    @_property
    def headers(self) -> windows_foundation_collections.IMapView[str, str]: ...
    @_property
