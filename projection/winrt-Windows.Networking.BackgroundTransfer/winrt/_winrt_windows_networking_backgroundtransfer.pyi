...
@typing.final
class BackgroundDownloader(winrt.system.Object, ImplementsIBackgroundTransferBase, metaclass=BackgroundDownloader_Static):
    @staticmethod
    ...
    def create_download(self, uri: windows_foundation.Uri, result_file: windows_storage.ImplementsIStorageFile, /) -> DownloadOperation: ...
    def create_download_async(self, uri: windows_foundation.Uri, result_file: windows_storage.ImplementsIStorageFile, request_body_stream: windows_storage_streams.ImplementsIInputStream, /) -> windows_foundation.IAsyncOperation[DownloadOperation]: ...
    def create_download_from_file(self, uri: windows_foundation.Uri, result_file: windows_storage.ImplementsIStorageFile, request_body_file: windows_storage.ImplementsIStorageFile, /) -> DownloadOperation: ...
...
class BackgroundTransferContentPart(winrt.system.Object):
    ...
    def set_file(self, value: windows_storage.ImplementsIStorageFile, /) -> None: ...
...
@typing.final
class BackgroundUploader(winrt.system.Object, ImplementsIBackgroundTransferBase, metaclass=BackgroundUploader_Static):
    @staticmethod
    ...
    def create_upload(self, uri: windows_foundation.Uri, source_file: windows_storage.ImplementsIStorageFile, /) -> UploadOperation: ...
    def create_upload_from_stream_async(self, uri: windows_foundation.Uri, source_stream: windows_storage_streams.ImplementsIInputStream, /) -> windows_foundation.IAsyncOperation[UploadOperation]: ...
...
@typing.final
class DownloadOperation(winrt.system.Object, ImplementsIBackgroundTransferOperationPriority, ImplementsIBackgroundTransferOperation):
    @staticmethod
...
@typing.final
class UploadOperation(winrt.system.Object, ImplementsIBackgroundTransferOperationPriority, ImplementsIBackgroundTransferOperation):
    @staticmethod
