...
class AccessoryManager_Static(type):
    ...
    def get_all_email_accounts(cls) -> windows_foundation_collections.IVectorView[EmailAccountInfo]: ...
    def get_app_icon(cls, app_id: str, /) -> windows_storage_streams.IRandomAccessStreamReference: ...
    def get_apps(cls) -> windows_foundation_collections.IMapView[str, AppNotificationInfo]: ...
    def get_enabled_accessory_notification_types(cls) -> winrt.system.Int32: ...
    def get_folders(cls, email_account: str, /) -> windows_foundation_collections.IVectorView[EmailFolderInfo]: ...
    ...
    @_property
    def phone_line_details(cls) -> windows_foundation_collections.IVectorView[PhoneLineDetails]: ...
    @_property
    def is_phone_pin_locked(cls) -> bool: ...
    @_property
    def speed_dial_list(cls) -> windows_foundation_collections.IVectorView[SpeedDialEntry]: ...
    @_property
...
class PhoneCallDetails(winrt.system.Object):
    ...
    @_property
    def preset_text_responses(self) -> windows_foundation_collections.IVectorView[TextResponse]: ...
    @_property
