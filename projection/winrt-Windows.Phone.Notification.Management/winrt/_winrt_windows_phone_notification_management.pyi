...
class AccessoryManager_Static(type):
    ...
    def enable_email_notification_folder_filter(cls, email_account: str, folders: windows_foundation_collections.IVectorView[str], /) -> None: ...
    ...
    def get_all_email_accounts(cls) -> typing.Optional[windows_foundation_collections.IVectorView[EmailAccountInfo]]: ...
    def get_app_icon(cls, app_id: str, /) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
    def get_apps(cls) -> typing.Optional[windows_foundation_collections.IMapView[str, AppNotificationInfo]]: ...
    def get_enabled_accessory_notification_types(cls) -> winrt.system.Int32: ...
    def get_folders(cls, email_account: str, /) -> typing.Optional[windows_foundation_collections.IVectorView[EmailFolderInfo]]: ...
    ...
    def reject_phone_call_with_text(cls, phone_call_id: winrt.system.UInt32, text_response_i_d: winrt.system.UInt32, /) -> None: ...
    ...
    @_property
    def phone_line_details(cls) -> typing.Optional[windows_foundation_collections.IVectorView[PhoneLineDetails]]: ...
    @_property
    def is_phone_pin_locked(cls) -> bool: ...
    @_property
    def speed_dial_list(cls) -> typing.Optional[windows_foundation_collections.IVectorView[SpeedDialEntry]]: ...
    @_property
...
class EmailNotificationTriggerDetails(winrt.system.Object):
    ...
    @_property
    def email_message(self) -> typing.Optional[windows_applicationmodel_email.EmailMessage]: ...
    @_property
...
class PhoneCallDetails(winrt.system.Object):
    ...
    @_property
    def preset_text_responses(self) -> typing.Optional[windows_foundation_collections.IVectorView[TextResponse]]: ...
    @_property
