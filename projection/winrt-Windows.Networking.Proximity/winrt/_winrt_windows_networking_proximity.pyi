...
class PeerFinder_Static(type):
    def connect_async(cls, peer_information: typing.Optional[PeerInformation], /) -> windows_foundation.IAsyncOperation[windows_networking_sockets.StreamSocket]: ...
    def create_watcher(cls) -> typing.Optional[PeerWatcher]: ...
    def find_all_peers_async(cls) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[PeerInformation]]: ...
    def start(cls) -> None: ...
    ...
    @_property
    def alternate_identities(cls) -> typing.Optional[windows_foundation_collections.IMap[str, str]]: ...
    @_property
    ...
    @_property
    def discovery_data(cls) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @discovery_data.setter
    def discovery_data(cls, value: typing.Optional[windows_storage_streams.IBuffer]) -> None: ...
...
class PeerInformation(winrt.system.Object):
    ...
    @_property
    def discovery_data(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
    def id(self) -> str: ...
    @_property
...
class ProximityDevice(winrt.system.Object, metaclass=ProximityDevice_Static):
    ...
    def publish_binary_message(self, message_type: str, message: typing.Optional[windows_storage_streams.IBuffer], /) -> winrt.system.Int64: ...
    def publish_binary_message_with_callback(self, message_type: str, message: typing.Optional[windows_storage_streams.IBuffer], message_transmitted_handler: typing.Optional[MessageTransmittedHandler], /) -> winrt.system.Int64: ...
    def publish_message(self, message_type: str, message: str, /) -> winrt.system.Int64: ...
    def publish_message_with_callback(self, message_type: str, message: str, message_transmitted_handler: typing.Optional[MessageTransmittedHandler], /) -> winrt.system.Int64: ...
    def publish_uri_message(self, message: typing.Optional[windows_foundation.Uri], /) -> winrt.system.Int64: ...
    def publish_uri_message_with_callback(self, message: typing.Optional[windows_foundation.Uri], message_transmitted_handler: typing.Optional[MessageTransmittedHandler], /) -> winrt.system.Int64: ...
    ...
    def add_device_arrived(self, arrived_handler: typing.Optional[DeviceArrivedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_device_arrived(self, cookie: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_device_departed(self, departed_handler: typing.Optional[DeviceDepartedEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
