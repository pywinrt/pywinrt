...
class ProximityDevice(winrt.system.Object, metaclass=ProximityDevice_Static):
    ...
    @typing.overload
    def publish_binary_message(self, message_type: str, message: typing.Optional[windows_storage_streams.IBuffer], message_transmitted_handler: typing.Optional[MessageTransmittedHandler], /) -> winrt.system.Int64: ...
    @typing.overload
    ...
    @typing.overload
    def publish_uri_message(self, message: typing.Optional[windows_foundation.Uri], message_transmitted_handler: typing.Optional[MessageTransmittedHandler], /) -> winrt.system.Int64: ...
