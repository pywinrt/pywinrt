...
class I2cController_Static(type):
    def get_controllers_async(cls, provider: windows_devices_i2c_provider.II2cProvider, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[I2cController]]: ...
