...
PyMODINIT_FUNC PyInit__winrt_windows_system_diagnostics_telemetry(void) noexcept
{
    ...
    if (py::register_python_type(module.get(), &type_spec_PlatformTelemetryClient, nullptr, object_bases.get(), nullptr) == -1)
    #else
    ...
    #if PY_VERSION_HEX < 0x03090000
    if (py::register_python_type(module.get(), &type_spec_PlatformTelemetryRegistrationResult, nullptr, object_bases.get(), nullptr) == -1)
    #else
    ...
    #if PY_VERSION_HEX < 0x03090000
    if (py::register_python_type(module.get(), &type_spec_PlatformTelemetryRegistrationSettings, nullptr, object_bases.get(), nullptr) == -1)
    #else
