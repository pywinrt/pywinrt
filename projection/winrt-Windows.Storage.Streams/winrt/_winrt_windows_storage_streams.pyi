...
class DataWriter(winrt.system.Object):
    ...
    def write_buffer_range(self, buffer: typing.Optional[IBuffer], start: winrt.system.UInt32, count: winrt.system.UInt32, /) -> None: ...
...
class FileRandomAccessStream_Static(type):
    ...
    def open_for_user_with_options_async(cls, user: typing.Optional[windows_system.User], file_path: str, access_mode: windows_storage.FileAccessMode, sharing_options: windows_storage.StorageOpenOptions, open_disposition: FileOpenDisposition, /) -> windows_foundation.IAsyncOperation[IRandomAccessStream]: ...
    ...
    def open_transacted_write_for_user_with_options_async(cls, user: typing.Optional[windows_system.User], file_path: str, open_options: windows_storage.StorageOpenOptions, open_disposition: FileOpenDisposition, /) -> windows_foundation.IAsyncOperation[windows_storage.StorageStreamTransaction]: ...
...
class RandomAccessStream_Static(type):
    ...
    def copy_size_async(cls, source: typing.Optional[IInputStream], destination: typing.Optional[IOutputStream], bytes_to_copy: winrt.system.UInt64, /) -> windows_foundation.IAsyncOperationWithProgress[winrt.system.UInt64, winrt.system.UInt64]: ...
