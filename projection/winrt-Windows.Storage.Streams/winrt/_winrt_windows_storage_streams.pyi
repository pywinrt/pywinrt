...
class Buffer_Static(type):
    ...
    def create_memory_buffer_over_i_buffer(cls, input: IBuffer, /) -> windows_foundation.MemoryBuffer: ...
...
class DataReader(windows_foundation.IClosable, IDataReader, winrt.system.Object, metaclass=DataReader_Static):
    ...
    def __new__(cls: typing.Type[DataReader], input_stream: IInputStream) -> DataReader: ...
    def close(self) -> None: ...
...
class DataWriter(windows_foundation.IClosable, IDataWriter, winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[DataWriter], output_stream: IOutputStream) -> DataWriter: ...
    @typing.overload
...
class IRandomAccessStreamWithContentType(IContentTypeProvider, IRandomAccessStream, IOutputStream, IInputStream, windows_foundation.IClosable, winrt.system.Object):
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
