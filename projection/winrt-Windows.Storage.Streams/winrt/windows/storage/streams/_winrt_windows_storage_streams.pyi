...
from . import ByteOrder, FileOpenDisposition, InputStreamOptions, UnicodeEncoding

Self = typing.TypeVar('Self')

class Buffer(winrt.system.Object):
    ...
    @staticmethod
    def create_copy_from_memory_buffer(input: typing.Optional[winrt.windows.foundation.IMemoryBuffer], /) -> typing.Optional[Buffer]: ...
    @staticmethod
    def create_memory_buffer_over_i_buffer(input: typing.Optional[IBuffer], /) -> typing.Optional[winrt.windows.foundation.MemoryBuffer]: ...

class DataReader(winrt.system.Object):
    unicode_encoding: UnicodeEncoding
    input_stream_options: InputStreamOptions
    byte_order: ByteOrder
    unconsumed_buffer_length: winrt.system.UInt32
    ...
    def read_boolean(self) -> winrt.system.Boolean: ...
    ...
    def read_guid(self) -> winrt.system.Guid: ...
...
class DataReaderLoadOperation(winrt.system.Object):
    ...
    completed: typing.Optional[winrt.windows.foundation.AsyncOperationCompletedHandler[winrt.system.UInt32]]
...
class DataWriter(winrt.system.Object):
    unicode_encoding: UnicodeEncoding
    byte_order: ByteOrder
    unstored_buffer_length: winrt.system.UInt32
    def __enter__(self: Self) -> Self: ...
    def __exit__(self, *args) -> None: ...
    @staticmethod
    ...
    def write_boolean(self, value: winrt.system.Boolean, /) -> None: ...
    @typing.overload
    ...
    def write_guid(self, value: winrt.system.Guid, /) -> None: ...
...
class FileRandomAccessStream(winrt.system.Object):
    ...
    @typing.overload
    @staticmethod
    def open_for_user_async(user: typing.Optional[winrt.windows.system.User], file_path: str, access_mode: winrt.windows.storage.FileAccessMode, /) -> winrt.windows.foundation.IAsyncOperation[IRandomAccessStream]: ...
    @typing.overload
    @staticmethod
    def open_for_user_async(user: typing.Optional[winrt.windows.system.User], file_path: str, access_mode: winrt.windows.storage.FileAccessMode, sharing_options: winrt.windows.storage.StorageOpenOptions, open_disposition: FileOpenDisposition, /) -> winrt.windows.foundation.IAsyncOperation[IRandomAccessStream]: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def open_transacted_write_for_user_async(user: typing.Optional[winrt.windows.system.User], file_path: str, /) -> winrt.windows.foundation.IAsyncOperation[winrt.windows.storage.StorageStreamTransaction]: ...
    @typing.overload
    @staticmethod
    def open_transacted_write_for_user_async(user: typing.Optional[winrt.windows.system.User], file_path: str, open_options: winrt.windows.storage.StorageOpenOptions, open_disposition: FileOpenDisposition, /) -> winrt.windows.foundation.IAsyncOperation[winrt.windows.storage.StorageStreamTransaction]: ...
    def read_async(self, buffer: typing.Optional[IBuffer], count: winrt.system.UInt32, options: InputStreamOptions, /) -> winrt.windows.foundation.IAsyncOperationWithProgress[IBuffer, winrt.system.UInt32]: ...
...
class RandomAccessStream(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> RandomAccessStream: ...
    @staticmethod
    def copy_and_close_async(source: typing.Optional[IInputStream], destination: typing.Optional[IOutputStream], /) -> winrt.windows.foundation.IAsyncOperationWithProgress[winrt.system.UInt64, winrt.system.UInt64]: ...
    @typing.overload
    @staticmethod
    def copy_async(source: typing.Optional[IInputStream], destination: typing.Optional[IOutputStream], /) -> winrt.windows.foundation.IAsyncOperationWithProgress[winrt.system.UInt64, winrt.system.UInt64]: ...
    @typing.overload
    @staticmethod
    def copy_async(source: typing.Optional[IInputStream], destination: typing.Optional[IOutputStream], bytes_to_copy: winrt.system.UInt64, /) -> winrt.windows.foundation.IAsyncOperationWithProgress[winrt.system.UInt64, winrt.system.UInt64]: ...
...
class RandomAccessStreamReference(winrt.system.Object):
    @staticmethod
    def _from(obj: winrt.system.Object, /) -> RandomAccessStreamReference: ...
    @staticmethod
    def create_from_file(file: typing.Optional[winrt.windows.storage.IStorageFile], /) -> typing.Optional[RandomAccessStreamReference]: ...
    @staticmethod
    def create_from_stream(stream: typing.Optional[IRandomAccessStream], /) -> typing.Optional[RandomAccessStreamReference]: ...
    @staticmethod
    def create_from_uri(uri: typing.Optional[winrt.windows.foundation.Uri], /) -> typing.Optional[RandomAccessStreamReference]: ...
