...
class HidBooleanControlDescription(winrt.system.Object):
    ...
    def id(self) -> winrt.system.UInt32: ...
    @_property
    def parent_collections(self) -> windows_foundation_collections.IVectorView[HidCollection]: ...
    @_property
...
class HidDevice(winrt.system.Object, metaclass=HidDevice_Static):
    ...
    def get_boolean_control_descriptions(self, report_type: HidReportType, usage_page: winrt.system.UInt16, usage_id: winrt.system.UInt16, /) -> windows_foundation_collections.IVectorView[HidBooleanControlDescription]: ...
    ...
    def get_numeric_control_descriptions(self, report_type: HidReportType, usage_page: winrt.system.UInt16, usage_id: winrt.system.UInt16, /) -> windows_foundation_collections.IVectorView[HidNumericControlDescription]: ...
...
class HidInputReport(winrt.system.Object):
    ...
    def get_numeric_control_by_description(self, control_description: HidNumericControlDescription, /) -> HidNumericControl: ...
    @_property
    def activated_boolean_controls(self) -> windows_foundation_collections.IVectorView[HidBooleanControl]: ...
    @_property
    def data(self) -> windows_storage_streams.IBuffer: ...
    @_property
    def id(self) -> winrt.system.UInt16: ...
    @_property
    def transitioned_boolean_controls(self) -> windows_foundation_collections.IVectorView[HidBooleanControl]: ...
