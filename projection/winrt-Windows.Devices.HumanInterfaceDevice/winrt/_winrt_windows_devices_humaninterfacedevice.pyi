...
class HidBooleanControlDescription(winrt.system.Object):
    ...
    def id(self) -> winrt.system.UInt32: ...
    @_property
    def parent_collections(self) -> typing.Optional[windows_foundation_collections.IVectorView[HidCollection]]: ...
    @_property
...
class HidDevice(winrt.system.Object, metaclass=HidDevice_Static):
    ...
    def create_feature_report_by_id(self, report_id: winrt.system.UInt16, /) -> typing.Optional[HidFeatureReport]: ...
    def create_output_report(self) -> typing.Optional[HidOutputReport]: ...
    def create_output_report_by_id(self, report_id: winrt.system.UInt16, /) -> typing.Optional[HidOutputReport]: ...
    def get_boolean_control_descriptions(self, report_type: HidReportType, usage_page: winrt.system.UInt16, usage_id: winrt.system.UInt16, /) -> typing.Optional[windows_foundation_collections.IVectorView[HidBooleanControlDescription]]: ...
    ...
    def get_numeric_control_descriptions(self, report_type: HidReportType, usage_page: winrt.system.UInt16, usage_id: winrt.system.UInt16, /) -> typing.Optional[windows_foundation_collections.IVectorView[HidNumericControlDescription]]: ...
    def send_feature_report_async(self, feature_report: typing.Optional[HidFeatureReport], /) -> windows_foundation.IAsyncOperation[winrt.system.UInt32]: ...
    def send_output_report_async(self, output_report: typing.Optional[HidOutputReport], /) -> windows_foundation.IAsyncOperation[winrt.system.UInt32]: ...
...
class HidInputReport(winrt.system.Object):
    ...
    def get_numeric_control_by_description(self, control_description: typing.Optional[HidNumericControlDescription], /) -> typing.Optional[HidNumericControl]: ...
    @_property
    def activated_boolean_controls(self) -> typing.Optional[windows_foundation_collections.IVectorView[HidBooleanControl]]: ...
    @_property
    def data(self) -> typing.Optional[windows_storage_streams.IBuffer]: ...
    @_property
    def id(self) -> winrt.system.UInt16: ...
    @_property
    def transitioned_boolean_controls(self) -> typing.Optional[windows_foundation_collections.IVectorView[HidBooleanControl]]: ...
