...
class ProcessDiagnosticInfo_Static(type):
    ...
    def get_for_processes(cls) -> windows_foundation_collections.IVectorView[ProcessDiagnosticInfo]: ...
    def try_get_for_process_id(cls, process_id: winrt.system.UInt32, /) -> ProcessDiagnosticInfo: ...
...
class ProcessDiagnosticInfo(winrt.system.Object, metaclass=ProcessDiagnosticInfo_Static):
    ...
    def get_app_diagnostic_infos(self) -> windows_foundation_collections.IVector[windows_system.AppDiagnosticInfo]: ...
    @_property
