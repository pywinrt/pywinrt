...
class AppRecordingManager(winrt.system.Object, metaclass=AppRecordingManager_Static):
    ...
    @_property
    def supported_screenshot_media_encoding_subtypes(self) -> windows_foundation_collections.IVectorView[str]: ...
...
class AppRecordingSaveScreenshotResult(winrt.system.Object):
    ...
    def extended_error(self) -> windows_foundation.HResult: ...
    @_property
    def saved_screenshot_infos(self) -> windows_foundation_collections.IVectorView[AppRecordingSavedScreenshotInfo]: ...
    @_property
    def succeeded(self) -> bool: ...
