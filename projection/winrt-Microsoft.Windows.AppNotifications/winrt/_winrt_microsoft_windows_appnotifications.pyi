...
class AppNotificationActivatedEventArgs(winrt.system.Object):
    ...
    @_property
    def user_input(self) -> typing.Optional[windows_foundation_collections.IMap[str, str]]: ...
    @_property
...
class AppNotificationManager(winrt.system.Object, metaclass=AppNotificationManager_Static):
    ...
    def get_all_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVector[AppNotification]]: ...
    @typing.overload
    def register(self) -> None: ...
    @typing.overload
    def register(self, display_name: str, icon_uri: typing.Optional[windows_foundation.Uri], /) -> None: ...
    ...
    def update_async(self, data: typing.Optional[AppNotificationProgressData], tag: str, group: str, /) -> windows_foundation.IAsyncOperation[AppNotificationProgressResult]: ...
    def update_async2(self, data: typing.Optional[AppNotificationProgressData], tag: str, /) -> windows_foundation.IAsyncOperation[AppNotificationProgressResult]: ...
