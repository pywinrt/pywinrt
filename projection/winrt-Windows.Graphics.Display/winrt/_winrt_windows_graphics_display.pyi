...
class BrightnessOverride_Static(type):
    ...
    def save_for_system_async(cls, value: typing.Optional[BrightnessOverride], /) -> windows_foundation.IAsyncOperation[bool]: ...
...
class DisplayEnhancementOverrideCapabilities(winrt.system.Object):
    ...
    def get_supported_nit_ranges(self) -> typing.Optional[windows_foundation_collections.IVectorView[NitRange]]: ...
    @_property
...
class DisplayProperties_Static(type):
    ...
    def add_color_profile_changed(cls, handler: typing.Optional[DisplayPropertiesEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_color_profile_changed(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_display_contents_invalidated(cls, handler: typing.Optional[DisplayPropertiesEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_display_contents_invalidated(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_logical_dpi_changed(cls, handler: typing.Optional[DisplayPropertiesEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_logical_dpi_changed(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_orientation_changed(cls, handler: typing.Optional[DisplayPropertiesEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
    def remove_orientation_changed(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    def add_stereo_enabled_changed(cls, handler: typing.Optional[DisplayPropertiesEventHandler], /) -> windows_foundation.EventRegistrationToken: ...
