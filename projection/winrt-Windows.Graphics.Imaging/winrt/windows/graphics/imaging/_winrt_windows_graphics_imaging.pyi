...
class BitmapBounds:
    ...
    def __new__(cls: typing.Type[BitmapBounds], x: winrt.system.UInt32, y: winrt.system.UInt32, width: winrt.system.UInt32, height: winrt.system.UInt32) -> BitmapBounds: ...
...
class BitmapPlaneDescription:
    ...
    def __new__(cls: typing.Type[BitmapPlaneDescription], start_index: winrt.system.Int32, width: winrt.system.Int32, height: winrt.system.Int32, stride: winrt.system.Int32) -> BitmapPlaneDescription: ...

class BitmapSize:
    width: winrt.system.UInt32
    height: winrt.system.UInt32
    def __new__(cls: typing.Type[BitmapSize], width: winrt.system.UInt32, height: winrt.system.UInt32) -> BitmapSize: ...
...
class BitmapEncoder(winrt.system.Object):
    is_thumbnail_generated: winrt.system.Boolean
...
class BitmapPropertySet(winrt.system.Object, typing.MutableMapping[str, BitmapTypedValue]):
    ...
    def insert(self, key: str, value: typing.Optional[BitmapTypedValue], /) -> winrt.system.Boolean: ...
