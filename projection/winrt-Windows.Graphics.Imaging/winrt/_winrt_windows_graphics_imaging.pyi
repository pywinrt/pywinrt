...
class BitmapDecoder(winrt.system.Object):
    ...
    @typing.overload
    @staticmethod
    def create_async(decoder_id: _uuid.UUID, stream: typing.Optional[winrt.windows.storage.streams.IRandomAccessStream], /) -> winrt.windows.foundation.IAsyncOperation[BitmapDecoder]: ...
    @staticmethod
    ...
    bmp_decoder_id: typing.ClassVar[_uuid.UUID]
    gif_decoder_id: typing.ClassVar[_uuid.UUID]
    ico_decoder_id: typing.ClassVar[_uuid.UUID]
    jpeg_decoder_id: typing.ClassVar[_uuid.UUID]
    jpeg_x_r_decoder_id: typing.ClassVar[_uuid.UUID]
    png_decoder_id: typing.ClassVar[_uuid.UUID]
    tiff_decoder_id: typing.ClassVar[_uuid.UUID]
    heif_decoder_id: typing.ClassVar[_uuid.UUID]
    webp_decoder_id: typing.ClassVar[_uuid.UUID]
...
class BitmapEncoder(winrt.system.Object):
    ...
    @typing.overload
    @staticmethod
    def create_async(encoder_id: _uuid.UUID, stream: typing.Optional[winrt.windows.storage.streams.IRandomAccessStream], /) -> winrt.windows.foundation.IAsyncOperation[BitmapEncoder]: ...
    @typing.overload
    @staticmethod
    def create_async(encoder_id: _uuid.UUID, stream: typing.Optional[winrt.windows.storage.streams.IRandomAccessStream], encoding_options: typing.Iterable[winrt.windows.foundation.collections.IKeyValuePair[str, BitmapTypedValue]], /) -> winrt.windows.foundation.IAsyncOperation[BitmapEncoder]: ...
    @staticmethod
    ...
    bmp_encoder_id: typing.ClassVar[_uuid.UUID]
    gif_encoder_id: typing.ClassVar[_uuid.UUID]
    jpeg_encoder_id: typing.ClassVar[_uuid.UUID]
    jpeg_x_r_encoder_id: typing.ClassVar[_uuid.UUID]
    png_encoder_id: typing.ClassVar[_uuid.UUID]
    tiff_encoder_id: typing.ClassVar[_uuid.UUID]
    heif_encoder_id: typing.ClassVar[_uuid.UUID]
