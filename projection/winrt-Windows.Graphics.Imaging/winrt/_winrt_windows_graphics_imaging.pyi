...
class BitmapDecoder_Static(type):
    ...
    def create_with_id_async(cls, decoder_id: _uuid.UUID, stream: typing.Optional[windows_storage_streams.IRandomAccessStream], /) -> windows_foundation.IAsyncOperation[BitmapDecoder]: ...
...
class BitmapDecoder(winrt.system.Object, metaclass=BitmapDecoder_Static):
    ...
    def get_pixel_data_transformed_async(self, pixel_format: BitmapPixelFormat, alpha_mode: BitmapAlphaMode, transform: typing.Optional[BitmapTransform], exif_orientation_mode: ExifOrientationMode, color_management_mode: ColorManagementMode, /) -> windows_foundation.IAsyncOperation[PixelDataProvider]: ...
    ...
    def get_software_bitmap_transformed_async(self, pixel_format: BitmapPixelFormat, alpha_mode: BitmapAlphaMode, transform: typing.Optional[BitmapTransform], exif_orientation_mode: ExifOrientationMode, color_management_mode: ColorManagementMode, /) -> windows_foundation.IAsyncOperation[SoftwareBitmap]: ...
...
class BitmapEncoder_Static(type):
    ...
    def create_with_encoding_options_async(cls, encoder_id: _uuid.UUID, stream: typing.Optional[windows_storage_streams.IRandomAccessStream], encoding_options: typing.Iterable[windows_foundation_collections.IKeyValuePair[str, BitmapTypedValue]], /) -> windows_foundation.IAsyncOperation[BitmapEncoder]: ...
...
class SoftwareBitmap_Static(type):
    ...
    def convert_with_alpha(cls, source: typing.Optional[SoftwareBitmap], format: BitmapPixelFormat, alpha: BitmapAlphaMode, /) -> typing.Optional[SoftwareBitmap]: ...
    ...
    def create_copy_with_alpha_from_buffer(cls, source: typing.Optional[windows_storage_streams.IBuffer], format: BitmapPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32, alpha: BitmapAlphaMode, /) -> typing.Optional[SoftwareBitmap]: ...
    def create_copy_with_alpha_from_surface_async(cls, surface: typing.Optional[windows_graphics_directx_direct3d11.IDirect3DSurface], alpha: BitmapAlphaMode, /) -> windows_foundation.IAsyncOperation[SoftwareBitmap]: ...
