...
class BitmapCodecInformation(winrt.system.Object):
    ...
    @_property
    def file_extensions(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def friendly_name(self) -> str: ...
    @_property
    def mime_types(self) -> windows_foundation_collections.IVectorView[str]: ...
...
class BitmapDecoder_Static(type):
    ...
    def get_decoder_information_enumerator(cls) -> windows_foundation_collections.IVectorView[BitmapCodecInformation]: ...
    @_property
...
class BitmapEncoder_Static(type):
    ...
    def get_encoder_information_enumerator(cls) -> windows_foundation_collections.IVectorView[BitmapCodecInformation]: ...
    @_property
...
class BitmapPropertySet(winrt.system.Object, winrt._winrt.MutableMapping[str, BitmapTypedValue]):
    ...
    def get_view(self) -> windows_foundation_collections.IMapView[str, BitmapTypedValue]: ...
