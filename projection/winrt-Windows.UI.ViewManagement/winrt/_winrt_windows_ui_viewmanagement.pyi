...
class ApplicationView(winrt.system.Object, metaclass=ApplicationView_Static):
    ...
    def try_enter_view_mode_with_preferences_async(self, view_mode: ApplicationViewMode, view_mode_preferences: typing.Optional[ViewModePreferences], /) -> windows_foundation.IAsyncOperation[bool]: ...
...
class ApplicationViewSwitcher_Static(type):
    ...
    def try_show_as_view_mode_with_preferences_async(cls, view_id: winrt.system.Int32, view_mode: ApplicationViewMode, view_mode_preferences: typing.Optional[ViewModePreferences], /) -> windows_foundation.IAsyncOperation[bool]: ...
...
class ProjectionManager_Static(type):
    ...
    def start_projecting_with_device_info_async(cls, projection_view_id: winrt.system.Int32, anchor_view_id: winrt.system.Int32, display_device_info: typing.Optional[windows_devices_enumeration.DeviceInformation], /) -> windows_foundation.IAsyncAction: ...
