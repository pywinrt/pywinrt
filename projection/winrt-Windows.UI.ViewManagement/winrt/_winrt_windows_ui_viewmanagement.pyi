...
class ApplicationView(winrt.system.Object, metaclass=ApplicationView_Static):
    ...
    def get_display_regions(self) -> windows_foundation_collections.IVectorView[windows_ui_windowmanagement.DisplayRegion]: ...
...
class InputPane_Static(type):
    ...
    def get_for_u_i_context(cls, context: windows_ui.UIContext, /) -> InputPane: ...
