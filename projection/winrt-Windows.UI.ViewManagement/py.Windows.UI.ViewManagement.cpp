...
PyMODINIT_FUNC PyInit__winrt_windows_ui_viewmanagement(void) noexcept
{
    ...
    py::pyobj_handle AccessibilitySettings_type{py::register_python_type(module.get(), &type_spec_AccessibilitySettings, object_bases.get(), nullptr)};
    if (!AccessibilitySettings_type)
    {
        return nullptr;
    }

    py::pyobj_handle ActivationViewSwitcher_type{py::register_python_type(module.get(), &type_spec_ActivationViewSwitcher, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle ApplicationView_type{py::register_python_type(module.get(), &type_spec_ApplicationView, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_ApplicationView_Static.get()))};
    if (!ApplicationView_type)
    {
        return nullptr;
    }

    py::pyobj_handle ApplicationViewConsolidatedEventArgs_type{py::register_python_type(module.get(), &type_spec_ApplicationViewConsolidatedEventArgs, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle ApplicationViewScaling_type{py::register_python_type(module.get(), &type_spec_ApplicationViewScaling, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_ApplicationViewScaling_Static.get()))};
    ...
    py::pyobj_handle ApplicationViewSwitcher_type{py::register_python_type(module.get(), &type_spec_ApplicationViewSwitcher, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_ApplicationViewSwitcher_Static.get()))};
    if (!ApplicationViewSwitcher_type)
    {
        return nullptr;
    }

    py::pyobj_handle ApplicationViewTitleBar_type{py::register_python_type(module.get(), &type_spec_ApplicationViewTitleBar, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle ApplicationViewTransferContext_type{py::register_python_type(module.get(), &type_spec_ApplicationViewTransferContext, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_ApplicationViewTransferContext_Static.get()))};
    ...
    py::pyobj_handle InputPane_type{py::register_python_type(module.get(), &type_spec_InputPane, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_InputPane_Static.get()))};
    if (!InputPane_type)
    {
        return nullptr;
    }

    py::pyobj_handle InputPaneVisibilityEventArgs_type{py::register_python_type(module.get(), &type_spec_InputPaneVisibilityEventArgs, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle ProjectionManager_type{py::register_python_type(module.get(), &type_spec_ProjectionManager, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_ProjectionManager_Static.get()))};
    ...
    py::pyobj_handle StatusBar_type{py::register_python_type(module.get(), &type_spec_StatusBar, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_StatusBar_Static.get()))};
    if (!StatusBar_type)
    {
        return nullptr;
    }

    py::pyobj_handle StatusBarProgressIndicator_type{py::register_python_type(module.get(), &type_spec_StatusBarProgressIndicator, object_bases.get(), nullptr)};
    if (!StatusBarProgressIndicator_type)
    {
        return nullptr;
    }

    py::pyobj_handle UISettings_type{py::register_python_type(module.get(), &type_spec_UISettings, object_bases.get(), nullptr)};
    if (!UISettings_type)
    {
        return nullptr;
    }

    py::pyobj_handle UISettingsAnimationsEnabledChangedEventArgs_type{py::register_python_type(module.get(), &type_spec_UISettingsAnimationsEnabledChangedEventArgs, object_bases.get(), nullptr)};
    if (!UISettingsAnimationsEnabledChangedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle UISettingsAutoHideScrollBarsChangedEventArgs_type{py::register_python_type(module.get(), &type_spec_UISettingsAutoHideScrollBarsChangedEventArgs, object_bases.get(), nullptr)};
    if (!UISettingsAutoHideScrollBarsChangedEventArgs_type)
    {
        return nullptr;
    }

    py::pyobj_handle UISettingsMessageDurationChangedEventArgs_type{py::register_python_type(module.get(), &type_spec_UISettingsMessageDurationChangedEventArgs, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle UIViewSettings_type{py::register_python_type(module.get(), &type_spec_UIViewSettings, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_UIViewSettings_Static.get()))};
    ...
    py::pyobj_handle ViewModePreferences_type{py::register_python_type(module.get(), &type_spec_ViewModePreferences, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_ViewModePreferences_Static.get()))};
