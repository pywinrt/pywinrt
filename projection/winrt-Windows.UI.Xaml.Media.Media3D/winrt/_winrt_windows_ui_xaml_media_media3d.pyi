...
class CompositeTransform3D_Static(type):
    ...
    @_property
    def center_z_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    ...
    @_property
    def scale_z_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    ...
    @_property
    def translate_z_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class PerspectiveTransform3D_Static(type):
    ...
    @_property
    def offset_x_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
    @_property
    def offset_y_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
