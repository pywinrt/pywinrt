...
class PackageDependency_Static(type):
    def create(cls, package_family_name: str, min_version: windows_applicationmodel.PackageVersion, /) -> typing.Optional[PackageDependency]: ...
    def create2(cls, package_family_name: str, min_version: windows_applicationmodel.PackageVersion, options: typing.Optional[CreatePackageDependencyOptions], /) -> typing.Optional[PackageDependency]: ...
    def create_for_system(cls, package_family_name: str, min_version: windows_applicationmodel.PackageVersion, options: typing.Optional[CreatePackageDependencyOptions], /) -> typing.Optional[PackageDependency]: ...
...
class PackageDependency(winrt.system.Object, metaclass=PackageDependency_Static):
    ...
    def add2(self, options: typing.Optional[AddPackageDependencyOptions], /) -> typing.Optional[PackageDependencyContext]: ...
