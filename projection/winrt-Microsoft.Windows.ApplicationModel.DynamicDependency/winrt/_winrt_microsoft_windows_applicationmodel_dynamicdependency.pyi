...
class PackageDependency_Static(type):
    ...
    @typing.overload
    def create(cls, package_family_name: str, min_version: windows_applicationmodel.PackageVersion, options: typing.Optional[CreatePackageDependencyOptions], /) -> typing.Optional[PackageDependency]: ...
