...
class IppAttributeValue(winrt.system.Object):
    ...
    @staticmethod
    def create_boolean(value: bool, /) -> typing.Optional[IppAttributeValue]: ...
    @staticmethod
    def create_boolean_array(values: typing.Iterable[bool], /) -> typing.Optional[IppAttributeValue]: ...
    @staticmethod
...
class IppPrintDevice(winrt.system.Object):
    ...
    @staticmethod
    def is_ipp_printer(printer_name: str, /) -> bool: ...
