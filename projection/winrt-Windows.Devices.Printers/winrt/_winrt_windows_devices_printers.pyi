...
class IppAttributeError(winrt.system.Object):
    ...
    def get_unsupported_values(self) -> windows_foundation_collections.IVectorView[IppAttributeValue]: ...
    @_property
...
class IppAttributeValue_Static(type):
    ...
    def create_collection(cls, member_attributes: typing.Iterable[windows_foundation_collections.IKeyValuePair[str, IppAttributeValue]], /) -> IppAttributeValue: ...
    def create_collection_array(cls, member_attributes_array: typing.Iterable[windows_foundation_collections.IIterable[windows_foundation_collections.IKeyValuePair[str, IppAttributeValue]]], /) -> IppAttributeValue: ...
    ...
    def create_octet_string(cls, value: windows_storage_streams.IBuffer, /) -> IppAttributeValue: ...
    def create_octet_string_array(cls, values: typing.Iterable[windows_storage_streams.IBuffer], /) -> IppAttributeValue: ...
...
class IppAttributeValue(winrt.system.Object, metaclass=IppAttributeValue_Static):
    ...
    def get_boolean_array(self) -> windows_foundation_collections.IVector[bool]: ...
    def get_charset_array(self) -> windows_foundation_collections.IVector[str]: ...
    def get_collection_array(self) -> windows_foundation_collections.IVector[windows_foundation_collections.IMapView[str, IppAttributeValue]]: ...
    def get_date_time_array(self) -> windows_foundation_collections.IVector[datetime.datetime]: ...
    def get_enum_array(self) -> windows_foundation_collections.IVector[winrt.system.Int32]: ...
    def get_integer_array(self) -> windows_foundation_collections.IVector[winrt.system.Int32]: ...
    def get_keyword_array(self) -> windows_foundation_collections.IVector[str]: ...
    def get_mime_media_type_array(self) -> windows_foundation_collections.IVector[str]: ...
    def get_name_with_language_array(self) -> windows_foundation_collections.IVector[IppTextWithLanguage]: ...
    def get_name_without_language_array(self) -> windows_foundation_collections.IVector[str]: ...
    def get_natural_language_array(self) -> windows_foundation_collections.IVector[str]: ...
    def get_octet_string_array(self) -> windows_foundation_collections.IVector[windows_storage_streams.IBuffer]: ...
    def get_range_of_integer_array(self) -> windows_foundation_collections.IVector[IppIntegerRange]: ...
    def get_resolution_array(self) -> windows_foundation_collections.IVector[IppResolution]: ...
    def get_text_with_language_array(self) -> windows_foundation_collections.IVector[IppTextWithLanguage]: ...
    def get_text_without_language_array(self) -> windows_foundation_collections.IVector[str]: ...
    def get_uri_array(self) -> windows_foundation_collections.IVector[windows_foundation.Uri]: ...
    def get_uri_schema_array(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
...
class IppPrintDevice(winrt.system.Object, metaclass=IppPrintDevice_Static):
    ...
    def get_printer_attributes(self, attribute_names: typing.Iterable[str], /) -> windows_foundation_collections.IMap[str, IppAttributeValue]: ...
    ...
    def set_printer_attributes(self, printer_attributes: typing.Iterable[windows_foundation_collections.IKeyValuePair[str, IppAttributeValue]], /) -> IppSetAttributesResult: ...
    def set_printer_attributes_from_buffer(self, printer_attributes_buffer: windows_storage_streams.IBuffer, /) -> IppSetAttributesResult: ...
    @_property
...
class IppSetAttributesResult(winrt.system.Object):
    ...
    @_property
    def attribute_errors(self) -> windows_foundation_collections.IMapView[str, IppAttributeError]: ...
    @_property
...
class PdlPassthroughProvider(winrt.system.Object):
    ...
    @_property
    def supported_pdl_content_types(self) -> windows_foundation_collections.IVectorView[str]: ...
