...
PyMODINIT_FUNC PyInit__winrt_Windows_Phone_Media_Devices(void) noexcept
{
    ...
    state->type_AudioRoutingManager = py::register_python_type(module.get(), type_name_AudioRoutingManager, &type_spec_AudioRoutingManager, object_bases.get(), nullptr);
