...
namespace py::cpp::Windows::Phone::Media::Devices
{
    ...
    static PyObject* AudioRoutingManager_GetAudioEndpoint(py::wrapper::Windows::Phone::Media::Devices::AudioRoutingManager* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                ...
                {
                    is_overload_present = winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Phone.Media.Devices.AudioRoutingManager", L"GetAudioEndpoint", 0);
                }
    ...
    static PyObject* AudioRoutingManager_GetDefault(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                ...
                if (!is_overload_present.has_value())
                {
                    is_overload_present = winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Phone.Media.Devices.AudioRoutingManager", L"GetDefault", 0);
                }
    ...
    static PyObject* AudioRoutingManager_SetAudioEndpoint(py::wrapper::Windows::Phone::Media::Devices::AudioRoutingManager* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            try
            {
                ...
                if (!is_overload_present.has_value())
                {
                    is_overload_present = winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.Phone.Media.Devices.AudioRoutingManager", L"SetAudioEndpoint", 1);
                }
    ...
    static PyObject* AudioRoutingManager_get_AvailableAudioEndpoints(py::wrapper::Windows::Phone::Media::Devices::AudioRoutingManager* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                is_property_present = winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.Phone.Media.Devices.AudioRoutingManager", L"AvailableAudioEndpoints");
            }
    ...
    static PyObject* AudioRoutingManager_add_AudioEndpointChanged(py::wrapper::Windows::Phone::Media::Devices::AudioRoutingManager* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            {
                is_event_present = winrt::Windows::Foundation::Metadata::ApiInformation::IsEventPresent(L"Windows.Phone.Media.Devices.AudioRoutingManager", L"AudioEndpointChanged");
            }
...
PyMODINIT_FUNC PyInit__winrt_windows_phone_media_devices(void) noexcept
{
    ...
    py::pyobj_handle AudioRoutingManager_Static_bases{PyTuple_Pack(1, reinterpret_cast<PyObject*>(inspectable_meta_type))};
    if (!AudioRoutingManager_Static_bases)
    {
        return nullptr;
    }

    py::pyobj_handle type_AudioRoutingManager_Static{PyType_FromSpecWithBases(&type_spec_AudioRoutingManager_Static, AudioRoutingManager_Static_bases.get())};
