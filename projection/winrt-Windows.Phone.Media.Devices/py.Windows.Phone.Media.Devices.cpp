...
PyMODINIT_FUNC PyInit__winrt_windows_phone_media_devices(void) noexcept
{
    ...
    py::pyobj_handle AudioRoutingManager_type{py::register_python_type(module.get(), &type_spec_AudioRoutingManager, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_AudioRoutingManager_Static.get()))};
