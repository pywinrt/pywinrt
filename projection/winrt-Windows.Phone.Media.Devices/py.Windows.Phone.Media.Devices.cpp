...
PyMODINIT_FUNC PyInit__winrt_windows_phone_media_devices(void) noexcept
{
    ...
    if (py::register_python_type(module.get(), &type_spec_AudioRoutingManager, nullptr, object_bases.get(), nullptr) == -1)
    #else
    if (py::register_python_type(module.get(), &type_spec_AudioRoutingManager, object_bases.get(), nullptr) == -1)
    #endif
    {
        return nullptr;
    }
