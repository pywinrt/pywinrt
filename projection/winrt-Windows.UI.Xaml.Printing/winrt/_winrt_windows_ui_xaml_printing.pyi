...
class PrintDocument_Static(type):
    @_property
    def document_source_property(cls) -> typing.Optional[windows_ui_xaml.DependencyProperty]: ...
...
class PrintDocument(winrt.system.Object, metaclass=PrintDocument_Static):
    ...
    def add_page(self, page_visual: typing.Optional[windows_ui_xaml.UIElement], /) -> None: ...
    ...
    def set_preview_page(self, page_number: winrt.system.Int32, page_visual: typing.Optional[windows_ui_xaml.UIElement], /) -> None: ...
