...
class TargetedContentCollection(winrt.system.Object):
    ...
    @_property
    def collections(self) -> windows_foundation_collections.IVectorView[TargetedContentCollection]: ...
    @_property
    def id(self) -> str: ...
    @_property
    def items(self) -> windows_foundation_collections.IVectorView[TargetedContentItem]: ...
    @_property
    def path(self) -> str: ...
    @_property
...
class TargetedContentSubscriptionOptions(winrt.system.Object):
    ...
    @_property
    def local_filters(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
...
class TargetedContentValue(winrt.system.Object):
    ...
    @_property
    def actions(self) -> windows_foundation_collections.IVectorView[TargetedContentAction]: ...
    @_property
    def boolean(self) -> bool: ...
    @_property
    def booleans(self) -> windows_foundation_collections.IVectorView[bool]: ...
    @_property
    def file(self) -> TargetedContentFile: ...
    @_property
    def files(self) -> windows_foundation_collections.IVectorView[TargetedContentFile]: ...
    @_property
    def image_file(self) -> TargetedContentImage: ...
    @_property
    def image_files(self) -> windows_foundation_collections.IVectorView[TargetedContentImage]: ...
    @_property
    def number(self) -> winrt.system.Double: ...
    @_property
    def numbers(self) -> windows_foundation_collections.IVectorView[winrt.system.Double]: ...
    @_property
    def path(self) -> str: ...
    @_property
    def string(self) -> str: ...
    @_property
    def strings(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
    def uri(self) -> windows_foundation.Uri: ...
    @_property
    def uris(self) -> windows_foundation_collections.IVectorView[windows_foundation.Uri]: ...
    @_property
