...
class FocusNavigationRequest_Static(type):
    ...
    def create_with_hint_rect(cls, reason: FocusNavigationReason, hint_rect: windows_foundation.Rect, /) -> typing.Optional[FocusNavigationRequest]: ...
    def create_with_hint_rect_and_id(cls, reason: FocusNavigationReason, hint_rect: windows_foundation.Rect, correlation_id: _uuid.UUID, /) -> typing.Optional[FocusNavigationRequest]: ...
