...
class FocusNavigationRequest_Static(type):
    ...
    def create_with_hint_rect(cls, reason: FocusNavigationReason, hint_rect: windows_foundation.Rect, /) -> FocusNavigationRequest: ...
    def create_with_hint_rect_and_id(cls, reason: FocusNavigationReason, hint_rect: windows_foundation.Rect, correlation_id: _uuid.UUID, /) -> FocusNavigationRequest: ...
...
class PointerEventArgs(winrt.system.Object):
    ...
    def get_intermediate_points(self) -> windows_foundation_collections.IVector[PointerPoint]: ...
    def get_intermediate_transformed_points(self, transform: IPointerPointTransform, /) -> windows_foundation_collections.IVector[PointerPoint]: ...
    @_property
    def handled(self) -> bool: ...
    @handled.setter
    def handled(self, value: bool) -> None: ...
