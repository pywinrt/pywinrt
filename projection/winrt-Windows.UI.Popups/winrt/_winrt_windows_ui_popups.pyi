...
class MessageDialog(winrt.system.Object):
    ...
    @_property
    def commands(self) -> windows_foundation_collections.IVector[IUICommand]: ...
...
class UICommand(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[UICommand], label: str, action: UICommandInvokedHandler) -> UICommand: ...
    @typing.overload
    def __new__(cls: typing.Type[UICommand], label: str, action: UICommandInvokedHandler, command_id: winrt.system.Object) -> UICommand: ...
    @typing.overload
