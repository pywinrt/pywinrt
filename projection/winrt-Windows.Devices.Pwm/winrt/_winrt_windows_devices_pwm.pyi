...
class PwmController_Static(type):
    ...
    def get_controllers_async(cls, provider: windows_devices_pwm_provider.IPwmProvider, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[PwmController]]: ...
