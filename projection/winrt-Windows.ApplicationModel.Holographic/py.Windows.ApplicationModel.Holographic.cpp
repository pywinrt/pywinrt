...
PyMODINIT_FUNC PyInit__winrt_windows_applicationmodel_holographic(void) noexcept
{
    ...
    py::pyobj_handle HolographicKeyboard_type{py::register_python_type(module.get(), &type_spec_HolographicKeyboard, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_HolographicKeyboard_Static.get()))};
