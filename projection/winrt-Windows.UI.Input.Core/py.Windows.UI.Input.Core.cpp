...
PyMODINIT_FUNC PyInit__winrt_windows_ui_input_core(void) noexcept
{
    ...
    py::pyobj_handle RadialControllerIndependentInputSource_type{py::register_python_type(module.get(), &type_spec_RadialControllerIndependentInputSource, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_RadialControllerIndependentInputSource_Static.get()))};
