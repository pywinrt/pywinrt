...
class AdcController_Static(type):
    def get_controllers_async(cls, provider: windows_devices_adc_provider.IAdcProvider, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[AdcController]]: ...
