...
class Geopath(winrt.system.Object):
    ...
    @_property
    def positions(self) -> windows_foundation_collections.IVectorView[BasicGeoposition]: ...
    @_property
    def altitude_reference_system(self) -> AltitudeReferenceSystem: ...
    @_property
    def geoshape_type(self) -> GeoshapeType: ...
...
class GeovisitTriggerDetails(winrt.system.Object):
    ...
    def read_reports(self) -> windows_foundation_collections.IVectorView[Geovisit]: ...
