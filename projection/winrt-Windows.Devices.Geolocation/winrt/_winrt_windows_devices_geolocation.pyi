...
class GeoboundingBox_Static(type):
    ...
    def try_compute_with_altitude_reference(cls, positions: typing.Iterable[BasicGeoposition], altitude_ref_system: AltitudeReferenceSystem, /) -> typing.Optional[GeoboundingBox]: ...
    def try_compute_with_altitude_reference_and_spatial_reference(cls, positions: typing.Iterable[BasicGeoposition], altitude_ref_system: AltitudeReferenceSystem, spatial_reference_id: winrt.system.UInt32, /) -> typing.Optional[GeoboundingBox]: ...
...
class Geolocator_Static(type):
    def get_geoposition_history_async(cls, start_time: datetime.datetime, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Geoposition]]: ...
    def get_geoposition_history_with_duration_async(cls, start_time: datetime.datetime, duration: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[Geoposition]]: ...
...
class Geopath(winrt.system.Object):
    ...
    @_property
    def positions(self) -> typing.Optional[windows_foundation_collections.IVectorView[BasicGeoposition]]: ...
    @_property
    def altitude_reference_system(self) -> AltitudeReferenceSystem: ...
    @_property
    def geoshape_type(self) -> GeoshapeType: ...
...
class GeovisitTriggerDetails(winrt.system.Object):
    ...
    def read_reports(self) -> typing.Optional[windows_foundation_collections.IVectorView[Geovisit]]: ...
