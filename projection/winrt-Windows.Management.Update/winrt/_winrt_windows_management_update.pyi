...
class WindowsUpdate(winrt.system.Object):
    ...
    @_property
    def more_info_url(self) -> typing.Optional[windows_foundation.Uri]: ...
    @_property
...
class WindowsUpdateAdministrator(winrt.system.Object, metaclass=WindowsUpdateAdministrator_Static):
    ...
    def get_updates(self) -> typing.Optional[windows_foundation_collections.IVectorView[WindowsUpdate]]: ...
...
class WindowsUpdateManager(winrt.system.Object):
    ...
    def get_applicable_updates(self) -> typing.Optional[windows_foundation_collections.IVectorView[WindowsUpdate]]: ...
    def get_most_recent_completed_updates(self, count: winrt.system.Int32, /) -> typing.Optional[windows_foundation_collections.IVectorView[WindowsUpdateItem]]: ...
    def get_most_recent_completed_updates_async(self, count: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[WindowsUpdateItem]]: ...
    ...
    def remove_action_completed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_attention_required_reason_changed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_progress_changed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_scan_completed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_scanning_state_changed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_working_state_changed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
...
class WindowsUpdateRestartRequestOptions(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[WindowsUpdateRestartRequestOptions], title: str, description: str, more_info_url: typing.Optional[windows_foundation.Uri], compliance_deadline_in_days: winrt.system.Int32, compliance_grace_period_in_days: winrt.system.Int32) -> WindowsUpdateRestartRequestOptions: ...
    @typing.overload
    ...
    def more_info_url(self, value: typing.Optional[windows_foundation.Uri]) -> None: ...
    @_property
    def description(self) -> str: ...
    @description.setter
...
class WindowsUpdateScanCompletedEventArgs(winrt.system.Object):
    ...
    def succeeded(self) -> bool: ...
    @_property
    def updates(self) -> typing.Optional[windows_foundation_collections.IVectorView[WindowsUpdate]]: ...
