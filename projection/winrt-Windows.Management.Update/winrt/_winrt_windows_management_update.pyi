...
class WindowsUpdateAdministrator(winrt.system.Object, metaclass=WindowsUpdateAdministrator_Static):
    ...
    def get_updates(self) -> windows_foundation_collections.IVectorView[WindowsUpdate]: ...
...
class WindowsUpdateManager(winrt.system.Object):
    ...
    def get_applicable_updates(self) -> windows_foundation_collections.IVectorView[WindowsUpdate]: ...
    def get_most_recent_completed_updates(self, count: winrt.system.Int32, /) -> windows_foundation_collections.IVectorView[WindowsUpdateItem]: ...
...
class WindowsUpdateRestartRequestOptions(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[WindowsUpdateRestartRequestOptions], title: str, description: str, more_info_url: windows_foundation.Uri, compliance_deadline_in_days: winrt.system.Int32, compliance_grace_period_in_days: winrt.system.Int32) -> WindowsUpdateRestartRequestOptions: ...
    @typing.overload
...
class WindowsUpdateScanCompletedEventArgs(winrt.system.Object):
    ...
    def succeeded(self) -> bool: ...
    @_property
    def updates(self) -> windows_foundation_collections.IVectorView[WindowsUpdate]: ...
