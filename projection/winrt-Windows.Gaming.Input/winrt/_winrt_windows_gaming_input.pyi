...
class ArcadeStick_Static(type):
    ...
    @_property
    def arcade_sticks(cls) -> typing.Optional[windows_foundation_collections.IVectorView[ArcadeStick]]: ...
...
class FlightStick_Static(type):
    ...
    @_property
    def flight_sticks(cls) -> typing.Optional[windows_foundation_collections.IVectorView[FlightStick]]: ...
...
class Gamepad_Static(type):
    ...
    @_property
    def gamepads(cls) -> typing.Optional[windows_foundation_collections.IVectorView[Gamepad]]: ...
...
class RacingWheel_Static(type):
    ...
    @_property
    def racing_wheels(cls) -> typing.Optional[windows_foundation_collections.IVectorView[RacingWheel]]: ...
...
class RacingWheel(winrt.system.Object, metaclass=RacingWheel_Static):
    ...
    @_property
    def wheel_motor(self) -> typing.Optional[windows_gaming_input_forcefeedback.ForceFeedbackMotor]: ...
...
class RawGameController_Static(type):
    ...
    @_property
    def raw_game_controllers(cls) -> typing.Optional[windows_foundation_collections.IVectorView[RawGameController]]: ...
...
class RawGameController(winrt.system.Object, metaclass=RawGameController_Static):
    ...
    @_property
    def force_feedback_motors(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_gaming_input_forcefeedback.ForceFeedbackMotor]]: ...
    @_property
    ...
    @_property
    def simple_haptics_controllers(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_devices_haptics.SimpleHapticsController]]: ...
...
class UINavigationController_Static(type):
    ...
    @_property
    def u_i_navigation_controllers(cls) -> typing.Optional[windows_foundation_collections.IVectorView[UINavigationController]]: ...
