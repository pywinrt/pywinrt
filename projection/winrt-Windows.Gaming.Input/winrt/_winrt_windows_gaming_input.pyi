...
class UINavigationController_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_ui_navigation_controller_added(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    ...
    def remove_ui_navigation_controller_removed(cls, token: windows_foundation.EventRegistrationToken, /) -> None: ...
