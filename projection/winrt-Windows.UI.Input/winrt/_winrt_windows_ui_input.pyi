...
class PointerPoint_Static(type):
    ...
    def get_intermediate_points(cls, pointer_id: winrt.system.UInt32, /) -> windows_foundation_collections.IVector[PointerPoint]: ...
    def get_intermediate_points_transformed(cls, pointer_id: winrt.system.UInt32, transform: IPointerPointTransform, /) -> windows_foundation_collections.IVector[PointerPoint]: ...
...
class RadialControllerMenu(winrt.system.Object):
    ...
    @_property
    def items(self) -> windows_foundation_collections.IVector[RadialControllerMenuItem]: ...
