...
class PhysicalGestureRecognizer(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[PhysicalGestureRecognizer]) -> PhysicalGestureRecognizer: ...
    def complete_gesture(self) -> None: ...
    def process_down_event(self, value: typing.Optional[PointerPoint], /) -> None: ...
    def process_move_events(self, value: windows_foundation_collections.IVector[PointerPoint], /) -> None: ...
    def process_up_event(self, value: typing.Optional[PointerPoint], /) -> None: ...
...
class PointerPoint_Static(type):
    ...
    def get_current_point_transformed(cls, pointer_id: winrt.system.UInt32, transform: typing.Optional[IPointerPointTransform], /) -> typing.Optional[PointerPoint]: ...
    ...
    def get_intermediate_points_transformed(cls, pointer_id: winrt.system.UInt32, transform: typing.Optional[IPointerPointTransform], /) -> typing.Optional[windows_foundation_collections.IVector[PointerPoint]]: ...
...
class RadialControllerMenuItem_Static(type):
    ...
    def create_from_font_glyph_with_uri(cls, display_text: str, glyph: str, font_family: str, font_uri: typing.Optional[windows_foundation.Uri], /) -> typing.Optional[RadialControllerMenuItem]: ...
...
class TouchpadGesturesController_Static(type):
    def create_for_process(cls) -> typing.Optional[TouchpadGesturesController]: ...
    def is_supported(cls) -> bool: ...
...
class TouchpadGesturesController(winrt.system.Object, metaclass=TouchpadGesturesController_Static):
    ...
    def remove_touchpad_global_action_performed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
    @_property
