...
namespace py::cpp::Windows::ApplicationModel::Email
{
    struct module_state
    {
        PyObject* type_EmailAttachmentDownloadState;
        PyObject* type_EmailBatchStatus;
        PyObject* type_EmailCertificateValidationStatus;
        PyObject* type_EmailFlagState;
        PyObject* type_EmailImportance;
        PyObject* type_EmailMailboxActionKind;
        PyObject* type_EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation;
        PyObject* type_EmailMailboxAutoReplyMessageResponseKind;
        PyObject* type_EmailMailboxChangeType;
        PyObject* type_EmailMailboxCreateFolderStatus;
        PyObject* type_EmailMailboxDeleteFolderStatus;
        PyObject* type_EmailMailboxEmptyFolderStatus;
        PyObject* type_EmailMailboxOtherAppReadAccess;
        PyObject* type_EmailMailboxOtherAppWriteAccess;
        PyObject* type_EmailMailboxSmimeEncryptionAlgorithm;
        PyObject* type_EmailMailboxSmimeSigningAlgorithm;
        PyObject* type_EmailMailboxSyncStatus;
        PyObject* type_EmailMeetingResponseType;
        PyObject* type_EmailMessageBodyKind;
        PyObject* type_EmailMessageDownloadState;
        PyObject* type_EmailMessageResponseKind;
        PyObject* type_EmailMessageSmimeKind;
        PyObject* type_EmailQueryKind;
        PyObject* type_EmailQuerySearchFields;
        PyObject* type_EmailQuerySearchScope;
        PyObject* type_EmailQuerySortDirection;
        PyObject* type_EmailQuerySortProperty;
        PyObject* type_EmailRecipientResolutionStatus;
        PyObject* type_EmailSpecialFolderKind;
        PyObject* type_EmailStoreAccessType;
    ...
    static PyObject* register_EmailAttachmentDownloadState(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailAttachmentDownloadState)
        {
        ...
        state->type_EmailAttachmentDownloadState = type;
        Py_INCREF(state->type_EmailAttachmentDownloadState);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailBatchStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailBatchStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailBatchStatus = type;
        Py_INCREF(state->type_EmailBatchStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailCertificateValidationStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailCertificateValidationStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailCertificateValidationStatus = type;
        Py_INCREF(state->type_EmailCertificateValidationStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailFlagState(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailFlagState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailFlagState = type;
        Py_INCREF(state->type_EmailFlagState);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailImportance(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailImportance)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailImportance = type;
        Py_INCREF(state->type_EmailImportance);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMailboxActionKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMailboxActionKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMailboxActionKind = type;
        Py_INCREF(state->type_EmailMailboxActionKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation = type;
        Py_INCREF(state->type_EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMailboxAutoReplyMessageResponseKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMailboxAutoReplyMessageResponseKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMailboxAutoReplyMessageResponseKind = type;
        Py_INCREF(state->type_EmailMailboxAutoReplyMessageResponseKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMailboxChangeType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMailboxChangeType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMailboxChangeType = type;
        Py_INCREF(state->type_EmailMailboxChangeType);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMailboxCreateFolderStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMailboxCreateFolderStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMailboxCreateFolderStatus = type;
        Py_INCREF(state->type_EmailMailboxCreateFolderStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMailboxDeleteFolderStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMailboxDeleteFolderStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMailboxDeleteFolderStatus = type;
        Py_INCREF(state->type_EmailMailboxDeleteFolderStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMailboxEmptyFolderStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMailboxEmptyFolderStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMailboxEmptyFolderStatus = type;
        Py_INCREF(state->type_EmailMailboxEmptyFolderStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMailboxOtherAppReadAccess(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMailboxOtherAppReadAccess)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMailboxOtherAppReadAccess = type;
        Py_INCREF(state->type_EmailMailboxOtherAppReadAccess);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMailboxOtherAppWriteAccess(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMailboxOtherAppWriteAccess)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMailboxOtherAppWriteAccess = type;
        Py_INCREF(state->type_EmailMailboxOtherAppWriteAccess);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMailboxSmimeEncryptionAlgorithm(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMailboxSmimeEncryptionAlgorithm)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMailboxSmimeEncryptionAlgorithm = type;
        Py_INCREF(state->type_EmailMailboxSmimeEncryptionAlgorithm);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMailboxSmimeSigningAlgorithm(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMailboxSmimeSigningAlgorithm)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMailboxSmimeSigningAlgorithm = type;
        Py_INCREF(state->type_EmailMailboxSmimeSigningAlgorithm);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMailboxSyncStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMailboxSyncStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMailboxSyncStatus = type;
        Py_INCREF(state->type_EmailMailboxSyncStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMeetingResponseType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMeetingResponseType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMeetingResponseType = type;
        Py_INCREF(state->type_EmailMeetingResponseType);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMessageBodyKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMessageBodyKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMessageBodyKind = type;
        Py_INCREF(state->type_EmailMessageBodyKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMessageDownloadState(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMessageDownloadState)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMessageDownloadState = type;
        Py_INCREF(state->type_EmailMessageDownloadState);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMessageResponseKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMessageResponseKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMessageResponseKind = type;
        Py_INCREF(state->type_EmailMessageResponseKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailMessageSmimeKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailMessageSmimeKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailMessageSmimeKind = type;
        Py_INCREF(state->type_EmailMessageSmimeKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailQueryKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailQueryKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailQueryKind = type;
        Py_INCREF(state->type_EmailQueryKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailQuerySearchFields(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailQuerySearchFields)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailQuerySearchFields = type;
        Py_INCREF(state->type_EmailQuerySearchFields);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailQuerySearchScope(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailQuerySearchScope)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailQuerySearchScope = type;
        Py_INCREF(state->type_EmailQuerySearchScope);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailQuerySortDirection(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailQuerySortDirection)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailQuerySortDirection = type;
        Py_INCREF(state->type_EmailQuerySortDirection);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailQuerySortProperty(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailQuerySortProperty)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailQuerySortProperty = type;
        Py_INCREF(state->type_EmailQuerySortProperty);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailRecipientResolutionStatus(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailRecipientResolutionStatus)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailRecipientResolutionStatus = type;
        Py_INCREF(state->type_EmailRecipientResolutionStatus);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailSpecialFolderKind(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailSpecialFolderKind)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailSpecialFolderKind = type;
        Py_INCREF(state->type_EmailSpecialFolderKind);


        Py_RETURN_NONE;
    }

    static PyObject* register_EmailStoreAccessType(PyObject* module, PyObject* type) noexcept
    {
        auto state = reinterpret_cast<module_state*>(PyModule_GetState(module));
        WINRT_ASSERT(state);

        if (state->type_EmailStoreAccessType)
        {
            PyErr_SetString(PyExc_RuntimeError, "type has already been registered");
            return nullptr;
        }
        ...
        state->type_EmailStoreAccessType = type;
        Py_INCREF(state->type_EmailStoreAccessType);
    ...
    static constexpr const char* const type_name_EmailConversation = "EmailConversation";

    static PyObject* _new_EmailConversation(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailConversation);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailConversationBatch = "EmailConversationBatch";

    static PyObject* _new_EmailConversationBatch(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailConversationBatch);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailConversationReader = "EmailConversationReader";

    static PyObject* _new_EmailConversationReader(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailConversationReader);
        return nullptr;
    }
    ...
    // ----- EmailFolder class --------------------
    static constexpr const char* const type_name_EmailFolder = "EmailFolder";

    static PyObject* _new_EmailFolder(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailFolder);
        return nullptr;
    }
    ...
    // ----- EmailIrmInfo class --------------------
    static constexpr const char* const type_name_EmailIrmInfo = "EmailIrmInfo";
    ...
    static constexpr const char* const type_name_EmailIrmTemplate = "EmailIrmTemplate";
    ...
    static constexpr const char* const type_name_EmailItemCounts = "EmailItemCounts";

    static PyObject* _new_EmailItemCounts(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailItemCounts);
        return nullptr;
    }
    ...
    // ----- EmailMailbox class --------------------
    static constexpr const char* const type_name_EmailMailbox = "EmailMailbox";

    static PyObject* _new_EmailMailbox(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMailbox);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMailboxAction = "EmailMailboxAction";

    static PyObject* _new_EmailMailboxAction(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMailboxAction);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMailboxAutoReply = "EmailMailboxAutoReply";

    static PyObject* _new_EmailMailboxAutoReply(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMailboxAutoReply);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMailboxAutoReplySettings = "EmailMailboxAutoReplySettings";
    ...
    static constexpr const char* const type_name_EmailMailboxCapabilities = "EmailMailboxCapabilities";

    static PyObject* _new_EmailMailboxCapabilities(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMailboxCapabilities);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMailboxChange = "EmailMailboxChange";

    static PyObject* _new_EmailMailboxChange(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMailboxChange);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMailboxChangeReader = "EmailMailboxChangeReader";

    static PyObject* _new_EmailMailboxChangeReader(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMailboxChangeReader);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMailboxChangeTracker = "EmailMailboxChangeTracker";

    static PyObject* _new_EmailMailboxChangeTracker(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMailboxChangeTracker);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMailboxChangedDeferral = "EmailMailboxChangedDeferral";

    static PyObject* _new_EmailMailboxChangedDeferral(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMailboxChangedDeferral);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMailboxChangedEventArgs = "EmailMailboxChangedEventArgs";

    static PyObject* _new_EmailMailboxChangedEventArgs(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMailboxChangedEventArgs);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMailboxCreateFolderResult = "EmailMailboxCreateFolderResult";

    static PyObject* _new_EmailMailboxCreateFolderResult(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMailboxCreateFolderResult);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMailboxPolicies = "EmailMailboxPolicies";

    static PyObject* _new_EmailMailboxPolicies(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMailboxPolicies);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMailboxSyncManager = "EmailMailboxSyncManager";

    static PyObject* _new_EmailMailboxSyncManager(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMailboxSyncManager);
        return nullptr;
    }
    ...
    // ----- EmailManager class --------------------
    static constexpr const char* const type_name_EmailManager = "EmailManager";

    static PyObject* _new_EmailManager(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailManager);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailManagerForUser = "EmailManagerForUser";

    static PyObject* _new_EmailManagerForUser(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailManagerForUser);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMeetingInfo = "EmailMeetingInfo";
    ...
    // ----- EmailMessage class --------------------
    static constexpr const char* const type_name_EmailMessage = "EmailMessage";
    ...
    static constexpr const char* const type_name_EmailMessageBatch = "EmailMessageBatch";

    static PyObject* _new_EmailMessageBatch(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMessageBatch);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailMessageReader = "EmailMessageReader";

    static PyObject* _new_EmailMessageReader(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailMessageReader);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailQueryOptions = "EmailQueryOptions";
    ...
    static constexpr const char* const type_name_EmailQueryTextSearch = "EmailQueryTextSearch";

    static PyObject* _new_EmailQueryTextSearch(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailQueryTextSearch);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailRecipient = "EmailRecipient";
    ...
    static constexpr const char* const type_name_EmailRecipientResolutionResult = "EmailRecipientResolutionResult";
    ...
    // ----- EmailStore class --------------------
    static constexpr const char* const type_name_EmailStore = "EmailStore";

    static PyObject* _new_EmailStore(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailStore);
        return nullptr;
    }
    ...
    static constexpr const char* const type_name_EmailStoreNotificationTriggerDetails = "EmailStoreNotificationTriggerDetails";

    static PyObject* _new_EmailStoreNotificationTriggerDetails(PyTypeObject* type, PyObject* args, PyObject* kwds) noexcept
    {
        py::set_invalid_activation_error(type_name_EmailStoreNotificationTriggerDetails);
        return nullptr;
    }
    ...
    static PyMethodDef module_methods[] = {
        {"_register_EmailAttachmentDownloadState", register_EmailAttachmentDownloadState, METH_O, "registers type"},
        {"_register_EmailBatchStatus", register_EmailBatchStatus, METH_O, "registers type"},
        {"_register_EmailCertificateValidationStatus", register_EmailCertificateValidationStatus, METH_O, "registers type"},
        {"_register_EmailFlagState", register_EmailFlagState, METH_O, "registers type"},
        {"_register_EmailImportance", register_EmailImportance, METH_O, "registers type"},
        {"_register_EmailMailboxActionKind", register_EmailMailboxActionKind, METH_O, "registers type"},
        {"_register_EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation", register_EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation, METH_O, "registers type"},
        {"_register_EmailMailboxAutoReplyMessageResponseKind", register_EmailMailboxAutoReplyMessageResponseKind, METH_O, "registers type"},
        {"_register_EmailMailboxChangeType", register_EmailMailboxChangeType, METH_O, "registers type"},
        {"_register_EmailMailboxCreateFolderStatus", register_EmailMailboxCreateFolderStatus, METH_O, "registers type"},
        {"_register_EmailMailboxDeleteFolderStatus", register_EmailMailboxDeleteFolderStatus, METH_O, "registers type"},
        {"_register_EmailMailboxEmptyFolderStatus", register_EmailMailboxEmptyFolderStatus, METH_O, "registers type"},
        {"_register_EmailMailboxOtherAppReadAccess", register_EmailMailboxOtherAppReadAccess, METH_O, "registers type"},
        {"_register_EmailMailboxOtherAppWriteAccess", register_EmailMailboxOtherAppWriteAccess, METH_O, "registers type"},
        {"_register_EmailMailboxSmimeEncryptionAlgorithm", register_EmailMailboxSmimeEncryptionAlgorithm, METH_O, "registers type"},
        {"_register_EmailMailboxSmimeSigningAlgorithm", register_EmailMailboxSmimeSigningAlgorithm, METH_O, "registers type"},
        {"_register_EmailMailboxSyncStatus", register_EmailMailboxSyncStatus, METH_O, "registers type"},
        {"_register_EmailMeetingResponseType", register_EmailMeetingResponseType, METH_O, "registers type"},
        {"_register_EmailMessageBodyKind", register_EmailMessageBodyKind, METH_O, "registers type"},
        {"_register_EmailMessageDownloadState", register_EmailMessageDownloadState, METH_O, "registers type"},
        {"_register_EmailMessageResponseKind", register_EmailMessageResponseKind, METH_O, "registers type"},
        {"_register_EmailMessageSmimeKind", register_EmailMessageSmimeKind, METH_O, "registers type"},
        {"_register_EmailQueryKind", register_EmailQueryKind, METH_O, "registers type"},
        {"_register_EmailQuerySearchFields", register_EmailQuerySearchFields, METH_O, "registers type"},
        {"_register_EmailQuerySearchScope", register_EmailQuerySearchScope, METH_O, "registers type"},
        {"_register_EmailQuerySortDirection", register_EmailQuerySortDirection, METH_O, "registers type"},
        {"_register_EmailQuerySortProperty", register_EmailQuerySortProperty, METH_O, "registers type"},
        {"_register_EmailRecipientResolutionStatus", register_EmailRecipientResolutionStatus, METH_O, "registers type"},
        {"_register_EmailSpecialFolderKind", register_EmailSpecialFolderKind, METH_O, "registers type"},
        {"_register_EmailStoreAccessType", register_EmailStoreAccessType, METH_O, "registers type"},
        {}};
    ...
    static int module_traverse(PyObject* module, visitproc visit, void* arg) noexcept
    {
        ...
        Py_VISIT(state->type_EmailAttachmentDownloadState);
        Py_VISIT(state->type_EmailBatchStatus);
        Py_VISIT(state->type_EmailCertificateValidationStatus);
        Py_VISIT(state->type_EmailFlagState);
        Py_VISIT(state->type_EmailImportance);
        Py_VISIT(state->type_EmailMailboxActionKind);
        Py_VISIT(state->type_EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation);
        Py_VISIT(state->type_EmailMailboxAutoReplyMessageResponseKind);
        Py_VISIT(state->type_EmailMailboxChangeType);
        Py_VISIT(state->type_EmailMailboxCreateFolderStatus);
        Py_VISIT(state->type_EmailMailboxDeleteFolderStatus);
        Py_VISIT(state->type_EmailMailboxEmptyFolderStatus);
        Py_VISIT(state->type_EmailMailboxOtherAppReadAccess);
        Py_VISIT(state->type_EmailMailboxOtherAppWriteAccess);
        Py_VISIT(state->type_EmailMailboxSmimeEncryptionAlgorithm);
        Py_VISIT(state->type_EmailMailboxSmimeSigningAlgorithm);
        Py_VISIT(state->type_EmailMailboxSyncStatus);
        Py_VISIT(state->type_EmailMeetingResponseType);
        Py_VISIT(state->type_EmailMessageBodyKind);
        Py_VISIT(state->type_EmailMessageDownloadState);
        Py_VISIT(state->type_EmailMessageResponseKind);
        Py_VISIT(state->type_EmailMessageSmimeKind);
        Py_VISIT(state->type_EmailQueryKind);
        Py_VISIT(state->type_EmailQuerySearchFields);
        Py_VISIT(state->type_EmailQuerySearchScope);
        Py_VISIT(state->type_EmailQuerySortDirection);
        Py_VISIT(state->type_EmailQuerySortProperty);
        Py_VISIT(state->type_EmailRecipientResolutionStatus);
        Py_VISIT(state->type_EmailSpecialFolderKind);
        Py_VISIT(state->type_EmailStoreAccessType);
    ...
    static int module_clear(PyObject* module) noexcept
    {
        ...
        Py_CLEAR(state->type_EmailAttachmentDownloadState);
        Py_CLEAR(state->type_EmailBatchStatus);
        Py_CLEAR(state->type_EmailCertificateValidationStatus);
        Py_CLEAR(state->type_EmailFlagState);
        Py_CLEAR(state->type_EmailImportance);
        Py_CLEAR(state->type_EmailMailboxActionKind);
        Py_CLEAR(state->type_EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation);
        Py_CLEAR(state->type_EmailMailboxAutoReplyMessageResponseKind);
        Py_CLEAR(state->type_EmailMailboxChangeType);
        Py_CLEAR(state->type_EmailMailboxCreateFolderStatus);
        Py_CLEAR(state->type_EmailMailboxDeleteFolderStatus);
        Py_CLEAR(state->type_EmailMailboxEmptyFolderStatus);
        Py_CLEAR(state->type_EmailMailboxOtherAppReadAccess);
        Py_CLEAR(state->type_EmailMailboxOtherAppWriteAccess);
        Py_CLEAR(state->type_EmailMailboxSmimeEncryptionAlgorithm);
        Py_CLEAR(state->type_EmailMailboxSmimeSigningAlgorithm);
        Py_CLEAR(state->type_EmailMailboxSyncStatus);
        Py_CLEAR(state->type_EmailMeetingResponseType);
        Py_CLEAR(state->type_EmailMessageBodyKind);
        Py_CLEAR(state->type_EmailMessageDownloadState);
        Py_CLEAR(state->type_EmailMessageResponseKind);
        Py_CLEAR(state->type_EmailMessageSmimeKind);
        Py_CLEAR(state->type_EmailQueryKind);
        Py_CLEAR(state->type_EmailQuerySearchFields);
        Py_CLEAR(state->type_EmailQuerySearchScope);
        Py_CLEAR(state->type_EmailQuerySortDirection);
        Py_CLEAR(state->type_EmailQuerySortProperty);
        Py_CLEAR(state->type_EmailRecipientResolutionStatus);
        Py_CLEAR(state->type_EmailSpecialFolderKind);
        Py_CLEAR(state->type_EmailStoreAccessType);
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailAttachmentDownloadState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailAttachmentDownloadState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailAttachmentDownloadState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailBatchStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailBatchStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailBatchStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailCertificateValidationStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailCertificateValidationStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailCertificateValidationStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailFlagState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailFlagState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailFlagState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailImportance>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailImportance;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailImportance is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMailboxActionKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMailboxActionKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMailboxActionKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMailboxAllowedSmimeEncryptionAlgorithmNegotiation is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMailboxAutoReplyMessageResponseKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMailboxAutoReplyMessageResponseKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMailboxAutoReplyMessageResponseKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMailboxChangeType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMailboxChangeType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMailboxChangeType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMailboxCreateFolderStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMailboxCreateFolderStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMailboxCreateFolderStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMailboxDeleteFolderStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMailboxDeleteFolderStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMailboxDeleteFolderStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMailboxEmptyFolderStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMailboxEmptyFolderStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMailboxEmptyFolderStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMailboxOtherAppReadAccess>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMailboxOtherAppReadAccess;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMailboxOtherAppReadAccess is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMailboxOtherAppWriteAccess>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMailboxOtherAppWriteAccess;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMailboxOtherAppWriteAccess is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMailboxSmimeEncryptionAlgorithm>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMailboxSmimeEncryptionAlgorithm;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMailboxSmimeEncryptionAlgorithm is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMailboxSmimeSigningAlgorithm>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMailboxSmimeSigningAlgorithm;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMailboxSmimeSigningAlgorithm is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMailboxSyncStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMailboxSyncStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMailboxSyncStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMeetingResponseType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMeetingResponseType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMeetingResponseType is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMessageBodyKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMessageBodyKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMessageBodyKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMessageDownloadState>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMessageDownloadState;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMessageDownloadState is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMessageResponseKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMessageResponseKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMessageResponseKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailMessageSmimeKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailMessageSmimeKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailMessageSmimeKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailQueryKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailQueryKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailQueryKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailQuerySearchFields>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailQuerySearchFields;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailQuerySearchFields is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailQuerySearchScope>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailQuerySearchScope;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailQuerySearchScope is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailQuerySortDirection>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailQuerySortDirection;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailQuerySortDirection is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailQuerySortProperty>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailQuerySortProperty;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailQuerySortProperty is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailRecipientResolutionStatus>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailRecipientResolutionStatus;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailRecipientResolutionStatus is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailSpecialFolderKind>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailSpecialFolderKind;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailSpecialFolderKind is not registered");
        return nullptr;
    }
...
PyObject* py::py_type<winrt::Windows::ApplicationModel::Email::EmailStoreAccessType>::get_python_type() noexcept {
    using namespace py::cpp::Windows::ApplicationModel::Email;
    ...
    auto python_type = state->type_EmailStoreAccessType;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::ApplicationModel::Email::EmailStoreAccessType is not registered");
        return nullptr;
    }
