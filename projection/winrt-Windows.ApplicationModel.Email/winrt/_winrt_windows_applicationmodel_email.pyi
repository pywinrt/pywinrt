...
class EmailConversation(winrt.system.Object):
    ...
    @typing.overload
    def find_messages_async(self, count: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[EmailMessage]]: ...
    @_property
...
class EmailFolder(winrt.system.Object):
    ...
    @typing.overload
    def try_move_async(self, new_parent_folder: typing.Optional[EmailFolder], new_folder_name: str, /) -> windows_foundation.IAsyncOperation[bool]: ...
...
class EmailMailbox(winrt.system.Object):
    ...
    @typing.overload
    def send_message_async(self, message: typing.Optional[EmailMessage], smart_send: bool, /) -> windows_foundation.IAsyncAction: ...
