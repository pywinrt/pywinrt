...
class EmailAttachment(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[EmailAttachment], file_name: str, data: windows_storage_streams.ImplementsIRandomAccessStreamReference, mime_type: str) -> EmailAttachment: ...
    @typing.overload
    def __new__(cls: typing.Type[EmailAttachment], file_name: str, data: windows_storage_streams.ImplementsIRandomAccessStreamReference) -> EmailAttachment: ...
    @typing.overload
    ...
    @data.setter
    def data(self, value: windows_storage_streams.ImplementsIRandomAccessStreamReference) -> None: ...
    @_property
...
class EmailMessage(winrt.system.Object):
    ...
    @smime_data.setter
    def smime_data(self, value: windows_storage_streams.ImplementsIRandomAccessStreamReference) -> None: ...
    @_property
