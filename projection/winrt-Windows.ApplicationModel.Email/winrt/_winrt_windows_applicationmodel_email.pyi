...
class EmailAttachment(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[EmailAttachment], file_name: str, data: typing.Optional[windows_storage_streams.IRandomAccessStreamReference], mime_type: str) -> EmailAttachment: ...
    @typing.overload
    def __new__(cls: typing.Type[EmailAttachment], file_name: str, data: typing.Optional[windows_storage_streams.IRandomAccessStreamReference]) -> EmailAttachment: ...
    @typing.overload
    ...
    @_property
    def data(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
    @data.setter
    def data(self, value: typing.Optional[windows_storage_streams.IRandomAccessStreamReference]) -> None: ...
    @_property
...
class EmailConversation(winrt.system.Object):
    ...
    def find_messages_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[EmailMessage]]: ...
    def find_messages_with_count_async(self, count: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[EmailMessage]]: ...
    @_property
...
class EmailConversationBatch(winrt.system.Object):
    ...
    @_property
    def conversations(self) -> typing.Optional[windows_foundation_collections.IVectorView[EmailConversation]]: ...
    @_property
...
class EmailFolder(winrt.system.Object):
    ...
    def find_child_folders_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[EmailFolder]]: ...
    def get_conversation_reader(self) -> typing.Optional[EmailConversationReader]: ...
    def get_conversation_reader_with_options(self, options: typing.Optional[EmailQueryOptions], /) -> typing.Optional[EmailConversationReader]: ...
    ...
    def get_message_reader_with_options(self, options: typing.Optional[EmailQueryOptions], /) -> typing.Optional[EmailMessageReader]: ...
    def save_message_async(self, message: typing.Optional[EmailMessage], /) -> windows_foundation.IAsyncAction: ...
    def try_move_async(self, new_parent_folder: typing.Optional[EmailFolder], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_move_with_new_name_async(self, new_parent_folder: typing.Optional[EmailFolder], new_folder_name: str, /) -> windows_foundation.IAsyncOperation[bool]: ...
...
class EmailMailbox(winrt.system.Object):
    ...
    def resolve_recipients_async(self, recipients: typing.Iterable[str], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[EmailRecipientResolutionResult]]: ...
    def save_async(self) -> windows_foundation.IAsyncAction: ...
    def save_draft_async(self, message: typing.Optional[EmailMessage], /) -> windows_foundation.IAsyncAction: ...
    def send_message_async(self, message: typing.Optional[EmailMessage], /) -> windows_foundation.IAsyncAction: ...
    def smart_send_message_async(self, message: typing.Optional[EmailMessage], smart_send: bool, /) -> windows_foundation.IAsyncAction: ...
    ...
    def try_forward_meeting_async(self, meeting: typing.Optional[EmailMessage], recipients: typing.Iterable[EmailRecipient], subject: str, forward_header_type: EmailMessageBodyKind, forward_header: str, comment: str, /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def try_propose_new_time_for_meeting_async(self, meeting: typing.Optional[EmailMessage], new_start_time: datetime.datetime, new_duration: datetime.timedelta, subject: str, comment: str, /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_set_auto_reply_settings_async(self, auto_reply_settings: typing.Optional[EmailMailboxAutoReplySettings], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def try_update_meeting_response_async(self, meeting: typing.Optional[EmailMessage], response: EmailMeetingResponseType, subject: str, comment: str, send_update: bool, /) -> windows_foundation.IAsyncOperation[bool]: ...
    def validate_certificates_async(self, certificates: typing.Iterable[windows_security_cryptography_certificates.Certificate], /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[EmailCertificateValidationStatus]]: ...
    ...
    @_property
    def mail_address_aliases(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
...
class EmailMailboxChange(winrt.system.Object):
    ...
    @_property
    def mailbox_actions(self) -> typing.Optional[windows_foundation_collections.IVector[EmailMailboxAction]]: ...
    @_property
...
class EmailMailboxChangeReader(winrt.system.Object):
    ...
    def read_batch_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[EmailMailboxChange]]: ...
...
class EmailManager_Static(type):
    def get_for_user(cls, user: typing.Optional[windows_system.User], /) -> typing.Optional[EmailManagerForUser]: ...
    def request_store_async(cls, access_type: EmailStoreAccessType, /) -> windows_foundation.IAsyncOperation[EmailStore]: ...
    def show_compose_new_email_async(cls, message: typing.Optional[EmailMessage], /) -> windows_foundation.IAsyncAction: ...
...
class EmailManagerForUser(winrt.system.Object):
    ...
    def show_compose_new_email_async(self, message: typing.Optional[EmailMessage], /) -> windows_foundation.IAsyncAction: ...
    @_property
...
class EmailMeetingInfo(winrt.system.Object):
    ...
    @_property
    def recurrence(self) -> typing.Optional[windows_applicationmodel_appointments.AppointmentRecurrence]: ...
    @recurrence.setter
    def recurrence(self, value: typing.Optional[windows_applicationmodel_appointments.AppointmentRecurrence]) -> None: ...
    @_property
...
class EmailMessage(winrt.system.Object):
    ...
    def get_body_stream(self, type: EmailMessageBodyKind, /) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
    def set_body_stream(self, type: EmailMessageBodyKind, stream: typing.Optional[windows_storage_streams.IRandomAccessStreamReference], /) -> None: ...
    @_property
    def subject(self) -> str: ...
    @subject.setter
    ...
    @_property
    def bcc(self) -> typing.Optional[windows_foundation_collections.IVector[EmailRecipient]]: ...
    @_property
    def c_c(self) -> typing.Optional[windows_foundation_collections.IVector[EmailRecipient]]: ...
    @_property
    def attachments(self) -> typing.Optional[windows_foundation_collections.IVector[EmailAttachment]]: ...
    @_property
    def to(self) -> typing.Optional[windows_foundation_collections.IVector[EmailRecipient]]: ...
    @_property
    ...
    @_property
    def smime_data(self) -> typing.Optional[windows_storage_streams.IRandomAccessStreamReference]: ...
    @smime_data.setter
    def smime_data(self, value: typing.Optional[windows_storage_streams.IRandomAccessStreamReference]) -> None: ...
    @_property
    ...
    @_property
    def reply_to(self) -> typing.Optional[windows_foundation_collections.IVector[EmailRecipient]]: ...
...
class EmailMessageBatch(winrt.system.Object):
    ...
    @_property
    def messages(self) -> typing.Optional[windows_foundation_collections.IVectorView[EmailMessage]]: ...
    @_property
    def status(self) -> EmailBatchStatus: ...
...
class EmailQueryOptions(winrt.system.Object):
    ...
    @_property
    def folder_ids(self) -> typing.Optional[windows_foundation_collections.IVector[str]]: ...
    @_property
...
class EmailRecipientResolutionResult(winrt.system.Object):
    ...
    @_property
    def public_keys(self) -> typing.Optional[windows_foundation_collections.IVectorView[windows_security_cryptography_certificates.Certificate]]: ...
...
class EmailStore(winrt.system.Object):
    ...
    def find_mailboxes_async(self) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[EmailMailbox]]: ...
    def get_conversation_async(self, id: str, /) -> windows_foundation.IAsyncOperation[EmailConversation]: ...
    def get_conversation_reader(self) -> typing.Optional[EmailConversationReader]: ...
    def get_conversation_reader_with_options(self, options: typing.Optional[EmailQueryOptions], /) -> typing.Optional[EmailConversationReader]: ...
    def get_folder_async(self, id: str, /) -> windows_foundation.IAsyncOperation[EmailFolder]: ...
