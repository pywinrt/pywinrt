...
class EmailAttachment(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[EmailAttachment], file_name: str, data: windows_storage_streams.IRandomAccessStreamReference, mime_type: str) -> EmailAttachment: ...
    @typing.overload
    def __new__(cls: typing.Type[EmailAttachment], file_name: str, data: windows_storage_streams.IRandomAccessStreamReference) -> EmailAttachment: ...
    @typing.overload
...
class EmailConversationBatch(winrt.system.Object):
    ...
    @_property
    def conversations(self) -> windows_foundation_collections.IVectorView[EmailConversation]: ...
    @_property
...
class EmailIrmInfo(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: typing.Type[EmailIrmInfo], expiration: datetime.datetime, irm_template: EmailIrmTemplate) -> EmailIrmInfo: ...
    @typing.overload
...
class EmailMailbox(winrt.system.Object):
    ...
    @_property
    def mail_address_aliases(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
...
class EmailMailboxChange(winrt.system.Object):
    ...
    @_property
    def mailbox_actions(self) -> windows_foundation_collections.IVector[EmailMailboxAction]: ...
    @_property
...
class EmailMessage(winrt.system.Object):
    ...
    @_property
    def bcc(self) -> windows_foundation_collections.IVector[EmailRecipient]: ...
    @_property
    def c_c(self) -> windows_foundation_collections.IVector[EmailRecipient]: ...
    @_property
    def attachments(self) -> windows_foundation_collections.IVector[EmailAttachment]: ...
    @_property
    def to(self) -> windows_foundation_collections.IVector[EmailRecipient]: ...
    @_property
    ...
    @_property
    def reply_to(self) -> windows_foundation_collections.IVector[EmailRecipient]: ...
...
class EmailMessageBatch(winrt.system.Object):
    ...
    @_property
    def messages(self) -> windows_foundation_collections.IVectorView[EmailMessage]: ...
    @_property
    def status(self) -> EmailBatchStatus: ...
...
class EmailQueryOptions(winrt.system.Object):
    ...
    @_property
    def folder_ids(self) -> windows_foundation_collections.IVector[str]: ...
    @_property
...
class EmailRecipientResolutionResult(winrt.system.Object):
    ...
    @_property
    def public_keys(self) -> windows_foundation_collections.IVectorView[windows_security_cryptography_certificates.Certificate]: ...
