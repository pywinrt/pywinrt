...
PyMODINIT_FUNC PyInit__winrt_windows_devices_serialcommunication(void) noexcept
{
    ...
    if (py::register_python_type(module.get(), type_name_ErrorReceivedEventArgs, &type_spec_ErrorReceivedEventArgs, nullptr, object_bases.get(), nullptr) == -1)
    #else
    if (py::register_python_type(module.get(), type_name_ErrorReceivedEventArgs, &type_spec_ErrorReceivedEventArgs, object_bases.get(), nullptr) == -1)
    #endif
    {
        return nullptr;
    }
    ...
    #if PY_VERSION_HEX < 0x03090000
    if (py::register_python_type(module.get(), type_name_PinChangedEventArgs, &type_spec_PinChangedEventArgs, nullptr, object_bases.get(), nullptr) == -1)
    #else
    if (py::register_python_type(module.get(), type_name_PinChangedEventArgs, &type_spec_PinChangedEventArgs, object_bases.get(), nullptr) == -1)
    #endif
    {
        return nullptr;
    }
    ...
    #if PY_VERSION_HEX < 0x03090000
    if (py::register_python_type(module.get(), type_name_SerialDevice, &type_spec_SerialDevice, nullptr, object_bases.get(), nullptr) == -1)
    #else
    if (py::register_python_type(module.get(), type_name_SerialDevice, &type_spec_SerialDevice, object_bases.get(), nullptr) == -1)
    #endif
    {
        return nullptr;
    }
