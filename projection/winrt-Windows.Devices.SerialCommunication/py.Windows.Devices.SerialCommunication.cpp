...
PyMODINIT_FUNC PyInit__winrt_Windows_Devices_SerialCommunication(void) noexcept
{
    ...
    state->type_ErrorReceivedEventArgs = py::register_python_type(module.get(), type_name_ErrorReceivedEventArgs, &type_spec_ErrorReceivedEventArgs, object_bases.get(), nullptr);
    if (!state->type_ErrorReceivedEventArgs)
    {
        return nullptr;
    }

    state->type_PinChangedEventArgs = py::register_python_type(module.get(), type_name_PinChangedEventArgs, &type_spec_PinChangedEventArgs, object_bases.get(), nullptr);
    if (!state->type_PinChangedEventArgs)
    {
        return nullptr;
    }

    state->type_SerialDevice = py::register_python_type(module.get(), type_name_SerialDevice, &type_spec_SerialDevice, object_bases.get(), nullptr);
    if (!state->type_SerialDevice)
    {
        return nullptr;
    }
...
PyTypeObject* py::winrt_type<winrt::Windows::Devices::SerialCommunication::ErrorReceivedEventArgs>::get_python_type() noexcept {
    ...
    auto python_type = state->type_ErrorReceivedEventArgs;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::SerialCommunication::ErrorReceivedEventArgs is not registered");
        return nullptr;
    }
...
PyTypeObject* py::winrt_type<winrt::Windows::Devices::SerialCommunication::PinChangedEventArgs>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Devices::SerialCommunication;
    ...
    auto python_type = state->type_PinChangedEventArgs;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::SerialCommunication::PinChangedEventArgs is not registered");
        return nullptr;
    }
...
PyTypeObject* py::winrt_type<winrt::Windows::Devices::SerialCommunication::SerialDevice>::get_python_type() noexcept {
    using namespace py::cpp::Windows::Devices::SerialCommunication;
    ...
    auto python_type = state->type_SerialDevice;

    if (!python_type) {
        PyErr_SetString(PyExc_RuntimeError, "type winrt::Windows::Devices::SerialCommunication::SerialDevice is not registered");
        return nullptr;
    }
