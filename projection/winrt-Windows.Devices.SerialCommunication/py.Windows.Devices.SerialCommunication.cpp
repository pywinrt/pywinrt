...
PyMODINIT_FUNC PyInit__winrt_windows_devices_serialcommunication(void) noexcept
{
    ...
    if (py::register_python_type(module.get(), &type_spec_ErrorReceivedEventArgs, nullptr, object_bases.get(), nullptr) == -1)
    #else
    ...
    #if PY_VERSION_HEX < 0x03090000
    if (py::register_python_type(module.get(), &type_spec_PinChangedEventArgs, nullptr, object_bases.get(), nullptr) == -1)
    #else
    ...
    #if PY_VERSION_HEX < 0x03090000
    if (py::register_python_type(module.get(), &type_spec_SerialDevice, nullptr, object_bases.get(), nullptr) == -1)
    #else
