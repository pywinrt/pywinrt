...
class JumpList(winrt.system.Object, metaclass=JumpList_Static):
    ...
    @_property
    def items(self) -> windows_foundation_collections.IVector[JumpListItem]: ...
...
class SecondaryTile_Static(type):
    ...
    def find_all_for_application_async(cls, application_id: str, /) -> windows_foundation.IAsyncOperation[windows_foundation_collections.IVectorView[SecondaryTile]]: ...
...
class SecondaryTile(winrt.system.Object, metaclass=SecondaryTile_Static):
    ...
    @typing.overload
    def __new__(cls: typing.Type[SecondaryTile], tile_id: str, display_name: str, arguments: str, square150x150_logo: windows_foundation.Uri, desired_size: TileSize) -> SecondaryTile: ...
    @typing.overload
    def __new__(cls: typing.Type[SecondaryTile], tile_id: str, short_name: str, display_name: str, arguments: str, tile_options: TileOptions, logo_reference: windows_foundation.Uri) -> SecondaryTile: ...
    @typing.overload
    def __new__(cls: typing.Type[SecondaryTile], tile_id: str, short_name: str, display_name: str, arguments: str, tile_options: TileOptions, logo_reference: windows_foundation.Uri, wide_logo_reference: windows_foundation.Uri) -> SecondaryTile: ...
    @typing.overload
...
class VisualElementsRequest(winrt.system.Object):
    ...
    @_property
    def alternate_visual_elements(self) -> windows_foundation_collections.IVectorView[SecondaryTileVisualElements]: ...
    @_property
