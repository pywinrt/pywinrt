...
class ConnectedAnimation(winrt.system.Object):
    ...
    def try_start_with_coordinated_elements(self, destination: typing.Optional[microsoft_ui_xaml.UIElement], coordinated_elements: typing.Iterable[microsoft_ui_xaml.UIElement], /) -> bool: ...
