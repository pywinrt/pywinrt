...
class SceneMesh(winrt.system.Object):
    ...
    @_property
    def primitive_topology(self) -> winrt.windows.graphics.directx.DirectXPrimitiveTopology: ...
    @primitive_topology.setter
    def primitive_topology(self, value: winrt.windows.graphics.directx.DirectXPrimitiveTopology) -> None: ...
    @_property
...
class SceneSurfaceMaterialInput(winrt.system.Object):
    ...
    @_property
    def surface(self) -> typing.Optional[winrt.windows.ui.composition.ICompositionSurface]: ...
    @surface.setter
    def surface(self, value: typing.Optional[winrt.windows.ui.composition.ICompositionSurface]) -> None: ...
    @_property
    def bitmap_interpolation_mode(self) -> winrt.windows.ui.composition.CompositionBitmapInterpolationMode: ...
