...
class SceneVisual(winrt.system.Object, metaclass=SceneVisual_Static):
    ...
    @_property
    def children(self) -> windows_ui_composition.VisualCollection: ...
    @_property
    ...
    @_property
    def clip(self) -> windows_ui_composition.CompositionClip: ...
    @clip.setter
    def clip(self, value: windows_ui_composition.CompositionClip) -> None: ...
    @_property
    ...
    @_property
    def parent(self) -> windows_ui_composition.ContainerVisual: ...
    @_property
    ...
    @_property
    def parent_for_transform(self) -> windows_ui_composition.Visual: ...
    @parent_for_transform.setter
    def parent_for_transform(self, value: windows_ui_composition.Visual) -> None: ...
    @_property
