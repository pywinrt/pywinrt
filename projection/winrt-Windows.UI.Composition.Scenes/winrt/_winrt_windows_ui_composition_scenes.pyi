...
class SceneMesh_Static(type):
    def create(cls, compositor: typing.Optional[windows_ui_composition.Compositor], /) -> typing.Optional[SceneMesh]: ...
...
class SceneMesh(winrt.system.Object, metaclass=SceneMesh_Static):
    ...
    def close(self) -> None: ...
    def fill_mesh_attribute(self, semantic: SceneAttributeSemantic, format: windows_graphics_directx.DirectXPixelFormat, memory: typing.Optional[windows_foundation.MemoryBuffer], /) -> None: ...
    def populate_property_info(self, property_name: str, property_info: typing.Optional[windows_ui_composition.AnimationPropertyInfo], /) -> None: ...
    @typing.overload
    def start_animation(self, property_name: str, animation: typing.Optional[windows_ui_composition.CompositionAnimation], /) -> None: ...
    @typing.overload
...
class SceneMeshRendererComponent_Static(type):
    def create(cls, compositor: typing.Optional[windows_ui_composition.Compositor], /) -> typing.Optional[SceneMeshRendererComponent]: ...
...
class SceneMetallicRoughnessMaterial_Static(type):
    def create(cls, compositor: typing.Optional[windows_ui_composition.Compositor], /) -> typing.Optional[SceneMetallicRoughnessMaterial]: ...
...
class SceneNode_Static(type):
    def create(cls, compositor: typing.Optional[windows_ui_composition.Compositor], /) -> typing.Optional[SceneNode]: ...
...
class SceneSurfaceMaterialInput_Static(type):
    def create(cls, compositor: typing.Optional[windows_ui_composition.Compositor], /) -> typing.Optional[SceneSurfaceMaterialInput]: ...
...
class SceneSurfaceMaterialInput(winrt.system.Object, metaclass=SceneSurfaceMaterialInput_Static):
    ...
    @_property
    def surface(self) -> typing.Optional[windows_ui_composition.ICompositionSurface]: ...
    @surface.setter
    def surface(self, value: typing.Optional[windows_ui_composition.ICompositionSurface]) -> None: ...
    @_property
...
class SceneVisual_Static(type):
    def create(cls, compositor: typing.Optional[windows_ui_composition.Compositor], /) -> typing.Optional[SceneVisual]: ...
...
class SceneVisual(winrt.system.Object, metaclass=SceneVisual_Static):
    ...
    @_property
    def children(self) -> typing.Optional[windows_ui_composition.VisualCollection]: ...
    @_property
    ...
    @_property
    def composite_mode(self) -> windows_ui_composition.CompositionCompositeMode: ...
    @composite_mode.setter
    def composite_mode(self, value: windows_ui_composition.CompositionCompositeMode) -> None: ...
    @_property
    def clip(self) -> typing.Optional[windows_ui_composition.CompositionClip]: ...
    @clip.setter
    def clip(self, value: typing.Optional[windows_ui_composition.CompositionClip]) -> None: ...
    @_property
    ...
    @_property
    def border_mode(self) -> windows_ui_composition.CompositionBorderMode: ...
    @border_mode.setter
    def border_mode(self, value: windows_ui_composition.CompositionBorderMode) -> None: ...
    @_property
    def backface_visibility(self) -> windows_ui_composition.CompositionBackfaceVisibility: ...
    @backface_visibility.setter
    def backface_visibility(self, value: windows_ui_composition.CompositionBackfaceVisibility) -> None: ...
    @_property
    ...
    @_property
    def parent(self) -> typing.Optional[windows_ui_composition.ContainerVisual]: ...
    @_property
    ...
    @_property
    def parent_for_transform(self) -> typing.Optional[windows_ui_composition.Visual]: ...
    @parent_for_transform.setter
    def parent_for_transform(self, value: typing.Optional[windows_ui_composition.Visual]) -> None: ...
    @_property
