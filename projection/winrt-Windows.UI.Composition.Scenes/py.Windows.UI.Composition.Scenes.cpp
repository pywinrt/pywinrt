...
PyMODINIT_FUNC PyInit__winrt_windows_ui_composition_scenes(void) noexcept
{
    ...
    py::pyobj_handle SceneComponent_type{py::register_python_type(module.get(), &type_spec_SceneComponent, object_bases.get(), nullptr)};
    if (!SceneComponent_type)
    {
        return nullptr;
    }

    py::pyobj_handle SceneMaterial_type{py::register_python_type(module.get(), &type_spec_SceneMaterial, object_bases.get(), nullptr)};
    if (!SceneMaterial_type)
    {
        return nullptr;
    }

    py::pyobj_handle SceneMaterialInput_type{py::register_python_type(module.get(), &type_spec_SceneMaterialInput, object_bases.get(), nullptr)};
    if (!SceneMaterialInput_type)
    {
        return nullptr;
    }

    py::pyobj_handle SceneObject_type{py::register_python_type(module.get(), &type_spec_SceneObject, object_bases.get(), nullptr)};
    if (!SceneObject_type)
    {
        return nullptr;
    }

    py::pyobj_handle ScenePbrMaterial_type{py::register_python_type(module.get(), &type_spec_ScenePbrMaterial, object_bases.get(), nullptr)};
    if (!ScenePbrMaterial_type)
    {
        return nullptr;
    }

    py::pyobj_handle SceneRendererComponent_type{py::register_python_type(module.get(), &type_spec_SceneRendererComponent, object_bases.get(), nullptr)};
    if (!SceneRendererComponent_type)
    {
        return nullptr;
    }

    py::pyobj_handle SceneBoundingBox_type{py::register_python_type(module.get(), &type_spec_SceneBoundingBox, object_bases.get(), nullptr)};
    if (!SceneBoundingBox_type)
    {
        return nullptr;
    }

    py::pyobj_handle SceneComponentCollection_type{py::register_python_type(module.get(), &type_spec_SceneComponentCollection, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle SceneMesh_type{py::register_python_type(module.get(), &type_spec_SceneMesh, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_SceneMesh_Static.get()))};
    if (!SceneMesh_type)
    {
        return nullptr;
    }

    py::pyobj_handle SceneMeshMaterialAttributeMap_type{py::register_python_type(module.get(), &type_spec_SceneMeshMaterialAttributeMap, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle SceneMeshRendererComponent_type{py::register_python_type(module.get(), &type_spec_SceneMeshRendererComponent, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_SceneMeshRendererComponent_Static.get()))};
    ...
    py::pyobj_handle SceneMetallicRoughnessMaterial_type{py::register_python_type(module.get(), &type_spec_SceneMetallicRoughnessMaterial, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_SceneMetallicRoughnessMaterial_Static.get()))};
    if (!SceneMetallicRoughnessMaterial_type)
    {
        return nullptr;
    }

    py::pyobj_handle SceneModelTransform_type{py::register_python_type(module.get(), &type_spec_SceneModelTransform, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle SceneNode_type{py::register_python_type(module.get(), &type_spec_SceneNode, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_SceneNode_Static.get()))};
    if (!SceneNode_type)
    {
        return nullptr;
    }

    py::pyobj_handle SceneNodeCollection_type{py::register_python_type(module.get(), &type_spec_SceneNodeCollection, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle SceneSurfaceMaterialInput_type{py::register_python_type(module.get(), &type_spec_SceneSurfaceMaterialInput, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_SceneSurfaceMaterialInput_Static.get()))};
    ...
    py::pyobj_handle SceneVisual_type{py::register_python_type(module.get(), &type_spec_SceneVisual, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_SceneVisual_Static.get()))};
    if (!SceneVisual_type)
    {
        return nullptr;
    }
