...
class LicenseInformation(winrt.system.Object):
    ...
    @_property
    def product_licenses(self) -> windows_foundation_collections.IMapView[str, ProductLicense]: ...
...
class ListingInformation(winrt.system.Object):
    ...
    def name(self) -> str: ...
    @_property
    def product_listings(self) -> windows_foundation_collections.IMapView[str, ProductListing]: ...
    @_property
...
class ProductListing(winrt.system.Object):
    ...
    @_property
    def keywords(self) -> windows_foundation_collections.IIterable[str]: ...
    @_property
    def tag(self) -> str: ...
    @_property
