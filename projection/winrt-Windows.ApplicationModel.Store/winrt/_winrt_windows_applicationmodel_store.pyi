...
class CurrentApp_Static(type):
    ...
    def request_product_purchase_with_display_properties_async(cls, product_id: str, offer_id: str, display_properties: typing.Optional[ProductPurchaseDisplayProperties], /) -> windows_foundation.IAsyncOperation[PurchaseResults]: ...
