...
PyMODINIT_FUNC PyInit__winrt_windows_applicationmodel_appointments_appointmentsprovider(void) noexcept
{
    ...
    py::pyobj_handle AddAppointmentOperation_type{py::register_python_type(module.get(), &type_spec_AddAppointmentOperation, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle AppointmentsProviderLaunchActionVerbs_type{py::register_python_type(module.get(), &type_spec_AppointmentsProviderLaunchActionVerbs, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_AppointmentsProviderLaunchActionVerbs_Static.get()))};
    if (!AppointmentsProviderLaunchActionVerbs_type)
    {
        return nullptr;
    }

    py::pyobj_handle RemoveAppointmentOperation_type{py::register_python_type(module.get(), &type_spec_RemoveAppointmentOperation, object_bases.get(), nullptr)};
    if (!RemoveAppointmentOperation_type)
    {
        return nullptr;
    }

    py::pyobj_handle ReplaceAppointmentOperation_type{py::register_python_type(module.get(), &type_spec_ReplaceAppointmentOperation, object_bases.get(), nullptr)};
