...
class CoreApplication_Static(type):
    ...
    def create_new_view_from_main_view(cls) -> typing.Optional[CoreApplicationView]: ...
    def create_new_view_with_view_source(cls, view_source: typing.Optional[IFrameworkViewSource], /) -> typing.Optional[CoreApplicationView]: ...
