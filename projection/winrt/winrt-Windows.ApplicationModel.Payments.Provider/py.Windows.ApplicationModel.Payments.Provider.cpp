...
namespace py::cpp::Windows::ApplicationModel::Payments::Provider
{
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.ApplicationModel.Payments.Provider.PaymentAppManager", "Current", nullptr, py::site_is_static};
    ...
    static PyObject* PaymentTransaction_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.Payments.Provider.PaymentTransaction", "FromIdAsync", nullptr, py::site_is_static};
