...
namespace py::cpp::Windows::ApplicationModel::AppService
{
    ...
    static PyObject* AppServiceCatalog_FindAppServiceProvidersAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.AppService.AppServiceCatalog", "FindAppServiceProvidersAsync", nullptr, py::site_is_static};
    ...
    static PyObject* AppServiceConnection_SendStatelessMessageAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 3)
        {
            static constexpr py::member_site site{py::member_kind::method, 3, "Windows.ApplicationModel.AppService.AppServiceConnection", "SendStatelessMessageAsync", nullptr, py::site_is_static};
