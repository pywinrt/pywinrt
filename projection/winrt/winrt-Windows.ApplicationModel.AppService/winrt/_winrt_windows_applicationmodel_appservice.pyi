...
class AppServiceConnection(winrt.system.Object, windows_foundation.IClosable, metaclass=AppServiceConnection_Static):
    ...
    def remove_request_received(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_service_closed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
