...
class AppWindow_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_create_async(cls) -> windows_foundation.IAsyncOperation[AppWindow | None]: ...
...
class AppWindow(winrt.system.Object, metaclass=AppWindow_Static):
    ...
    def request_move_relative_to_current_view_content(self, content_offset: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
    ...
    def request_move_relative_to_display_region(self, display_region: DisplayRegion, display_region_offset: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
    ...
    def request_move_relative_to_window_content(self, anchor_window: AppWindow, content_offset: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
    ...
    def request_size(self, frame_size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
...
class AppWindowFrame(winrt.system.Object):
    ...
    @_property
    def drag_region_visuals(self) -> _cabc.MutableSequence[windows_ui_composition.IVisualElement]: ...
...
class AppWindowTitleBar(winrt.system.Object):
    ...
    def get_title_bar_occlusions(self) -> _cabc.Sequence[AppWindowTitleBarOcclusion]: ...
...
class WindowingEnvironment_Static(winrt._winrt.IInspectable_Static):
    ...
    def find_all(cls, kind: WindowingEnvironmentKind, /) -> _cabc.Sequence[WindowingEnvironment]: ...
    # Deprecated alias of find_all() for pywinrt v3.x compatibility.
    # Windows.Foundation.Collections.IVectorView`1<Windows.UI.WindowManagement.WindowingEnvironment> Windows.UI.WindowManagement.WindowingEnvironment::FindAll(Windows.UI.WindowManagement.WindowingEnvironmentKind)
    @deprecated("Use find_all() instead.")
    def find_all_with_kind(cls, kind: WindowingEnvironmentKind, /) -> _cabc.Sequence[WindowingEnvironment]: ...
