...
namespace py::cpp::Windows::ApplicationModel::LockScreen
{
    ...
    static PyObject* LockApplicationHost_GetForCurrentView(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.ApplicationModel.LockScreen.LockApplicationHost", "GetForCurrentView", nullptr, py::site_is_static};
