...
class ActionEntityFactory(winrt.system.Object, windows_foundation.IClosable, metaclass=ActionEntityFactory_Static):
    ...
    def create_table_entity(self, data: winrt.system.Array[str] | winrt.system.ReadableBuffer, column_count: winrt.system.UInt32, /) -> TableActionEntity: ...
    @typing.overload
    @typing.final
...
class ActionInvocationContext(winrt.system.Object, windows_foundation.IClosable):
    ...
    def extended_error(self, value: windows_foundation.HResult | tuple[winrt.system.Int32]) -> None: ...
...
class ActionRuntime(winrt.system.Object, windows_foundation.IClosable, metaclass=ActionRuntime_Static):
    ...
    def create_invocation_context_with_window_id(self, action_id: str, invoker_window_id: windows_ui.WindowId | tuple[winrt.system.UInt64], /) -> ActionInvocationContext: ...
    @typing.final
