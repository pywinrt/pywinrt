...
class ActionEntityFactory(winrt.system.Object, windows_foundation.IClosable, metaclass=ActionEntityFactory_Static):
    ...
    def close(self) -> None: ...
    @typing.final
    # Windows.AI.Actions.AppointmentActionEntity Windows.AI.Actions.ActionEntityFactory::CreateAppointmentEntity(System.String,Windows.ApplicationModel.Appointments.Appointment,Windows.AI.Actions.ContactActionEntity[])
    def create_appointment_entity(self, source_id: str, appointment: windows_applicationmodel_appointments.Appointment, attendees: winrt.system.Array[ContactActionEntity] | winrt.system.ReadableBuffer, /) -> AppointmentActionEntity: ...
    @typing.final
    # Windows.AI.Actions.ArrayActionEntity Windows.AI.Actions.ActionEntityFactory::CreateArrayEntity(Windows.AI.Actions.ActionEntityKind,Windows.AI.Actions.ActionEntity[])
    def create_array_entity(self, kind: ActionEntityKind, entities: winrt.system.Array[ActionEntity] | winrt.system.ReadableBuffer, /) -> ArrayActionEntity: ...
    @typing.final
    # Windows.AI.Actions.ArrayActionEntity Windows.AI.Actions.ActionEntityFactory::CreateArrayEntityWithCustomKind(Windows.AI.Actions.ActionEntityKind,System.String,Windows.AI.Actions.ActionEntity[])
    def create_array_entity_with_custom_kind(self, element_kind: ActionEntityKind, custom_kind: str, entities: winrt.system.Array[ActionEntity] | winrt.system.ReadableBuffer, /) -> ArrayActionEntity: ...
    @typing.final
    ...
    @typing.final
    # Windows.AI.Actions.CustomTextActionEntity Windows.AI.Actions.ActionEntityFactory::CreateCustomTextEntity(System.String,System.String,Windows.Foundation.Collections.IMapView`2<System.String,System.Object>)
    def create_custom_text_entity(self, kind: str, key_phrase: str, props: _cabc.Mapping[str, winrt.system.Object], /) -> CustomTextActionEntity: ...
    @typing.final
    # Windows.AI.Actions.DateTimeActionEntity Windows.AI.Actions.ActionEntityFactory::CreateDateTimeEntity(Windows.Foundation.DateTime)
    def create_date_time_entity(self, date_time: datetime.datetime, /) -> DateTimeActionEntity: ...
    @typing.final
    ...
    @typing.final
    # Windows.AI.Actions.UriActionEntity Windows.AI.Actions.ActionEntityFactory::CreateUriEntity(Windows.Foundation.Uri)
    def create_uri_entity(self, uri: windows_foundation.Uri, /) -> UriActionEntity: ...
...
class ActionInvocationHelpDetails(winrt.system.Object, windows_foundation.IClosable):
    ...
    def add_changed(self, handler: windows_foundation.TypedEventHandler[ActionInvocationHelpDetails, winrt.system.Object], /) -> windows_foundation.EventRegistrationToken: ...
    # System.Void Windows.AI.Actions.ActionInvocationHelpDetails::remove_Changed(Windows.Foundation.EventRegistrationToken)
...
class ActionRuntime(winrt.system.Object, windows_foundation.IClosable, metaclass=ActionRuntime_Static):
    ...
    @typing.final
    # Windows.AI.Actions.ActionInvocationContext Windows.AI.Actions.ActionRuntime::GetActionInvocationContextFromToken(System.String)
    def get_action_invocation_context_from_token(self, token: str, /) -> ActionInvocationContext: ...
    @typing.final
    ...
    # Windows.AI.Actions.CustomActionEntityStore Windows.AI.Actions.ActionRuntime::get_CustomEntityStore()
    @_property
    @typing.final
    def custom_entity_store(self) -> CustomActionEntityStore: ...
...
class AppointmentActionEntity(ActionEntity):
    ...
    def get_presented_files(self) -> winrt.system.Array[RemoteFileActionEntity]: ...
    # Windows.AI.Actions.RemoteFileActionEntity[] Windows.AI.Actions.AppointmentActionEntity::GetSharedFiles()
    def get_shared_files(self) -> winrt.system.Array[RemoteFileActionEntity]: ...
    # System.Void Windows.AI.Actions.AppointmentActionEntity::SetPresentedFiles(Windows.AI.Actions.RemoteFileActionEntity[])
    def set_presented_files(self, files: winrt.system.Array[RemoteFileActionEntity] | winrt.system.ReadableBuffer, /) -> None: ...
    # System.Void Windows.AI.Actions.AppointmentActionEntity::SetSharedFiles(Windows.AI.Actions.RemoteFileActionEntity[])
    def set_shared_files(self, files: winrt.system.Array[RemoteFileActionEntity] | winrt.system.ReadableBuffer, /) -> None: ...
    # Windows.ApplicationModel.Appointments.Appointment Windows.AI.Actions.AppointmentActionEntity::get_Appointment()
    @_property
    def appointment(self) -> windows_applicationmodel_appointments.Appointment: ...
    # System.String Windows.AI.Actions.AppointmentActionEntity::get_SourceId()
    @_property
...
class ArrayActionEntity(ActionEntity):
    ...
    @_property
    def element_kind(self) -> ActionEntityKind: ...
    # System.String Windows.AI.Actions.ArrayActionEntity::get_CustomElementKind()
    @_property
    def custom_element_kind(self) -> str: ...
...
class CustomActionEntityStore(winrt.system.Object, windows_foundation.IClosable, metaclass=CustomActionEntityStore_Static):
    ...
    def close(self) -> None: ...
    @typing.final
    # System.Void Windows.AI.Actions.CustomActionEntityStore::Delete(System.String)
    def delete(self, kind: str, /) -> None: ...
    @typing.final
    # Windows.Foundation.DateTime Windows.AI.Actions.CustomActionEntityStore::GetLastModifiedTime(System.String)
    def get_last_modified_time(self, kind: str, /) -> datetime.datetime: ...
    @typing.final
    # System.Void Windows.AI.Actions.CustomActionEntityStore::Insert(Windows.AI.Actions.CustomTextActionEntity)
    def insert(self, entity: CustomTextActionEntity, /) -> None: ...
    @typing.final
    # System.Void Windows.AI.Actions.CustomActionEntityStore::InsertMany(Windows.AI.Actions.CustomTextActionEntity[])
    def insert_many(self, entities: winrt.system.Array[CustomTextActionEntity] | winrt.system.ReadableBuffer, /) -> None: ...
...
class CustomTextActionEntity(ActionEntity):
    ...
    # System.String Windows.AI.Actions.CustomTextActionEntity::get_KeyPhrase()
    @_property
    def key_phrase(self) -> str: ...
    # Windows.Foundation.Collections.IMapView`2<System.String,System.Object> Windows.AI.Actions.CustomTextActionEntity::get_Properties()
    @_property
...
class RemoteFileActionEntity(ActionEntity):
    ...
    def set_contributors(self, contributors: winrt.system.Array[ContactActionEntity] | winrt.system.ReadableBuffer, /) -> None: ...
    ...
    # Windows.Foundation.IReference`1<Windows.Foundation.DateTime> Windows.AI.Actions.RemoteFileActionEntity::get_LastUpdatedTime()
    @_property
    def last_updated_time(self) -> datetime.datetime | None: ...
    # System.Void Windows.AI.Actions.RemoteFileActionEntity::put_LastUpdatedTime(Windows.Foundation.IReference`1<Windows.Foundation.DateTime>)
    @last_updated_time.setter
    def last_updated_time(self, value: datetime.datetime | None) -> None: ...
    # System.String Windows.AI.Actions.RemoteFileActionEntity::get_Filename()
    @_property
    def filename(self) -> str: ...
    # System.Void Windows.AI.Actions.RemoteFileActionEntity::put_Filename(System.String)
    @filename.setter
    def filename(self, value: str) -> None: ...
    # Windows.AI.Actions.ContactActionEntity Windows.AI.Actions.RemoteFileActionEntity::get_Creator()
    @_property
    def creator(self) -> ContactActionEntity: ...
    # System.Void Windows.AI.Actions.RemoteFileActionEntity::put_Creator(Windows.AI.Actions.ContactActionEntity)
    @creator.setter
    def creator(self, value: ContactActionEntity) -> None: ...
