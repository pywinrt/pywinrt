...
class GipFirmwareUpdateProgress:
    ...
    def unpack(self) -> tuple[winrt.system.Double, winrt.system.UInt32]: ...
...
class GameControllerFactoryManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_get_factory_controller_from_game_controller(cls, factory: ICustomGameControllerFactory, game_controller: windows_gaming_input.IGameController, /) -> windows_gaming_input.IGameController | None: ...
...
class GipGameControllerProvider(winrt.system.Object, IGameControllerProvider):
    ...
    def send_receive_message(self, message_class: GipMessageClass, message_id: winrt.system.UInt8, request_message_buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, response_message_buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.WriteableBuffer, /) -> None: ...
...
class HidGameControllerProvider(winrt.system.Object, IGameControllerProvider):
    ...
    def send_feature_report(self, report_id: winrt.system.UInt8, report_buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> None: ...
    # System.Void Windows.Gaming.Input.Custom.HidGameControllerProvider::SendOutputReport(System.Byte,System.Byte[])
    def send_output_report(self, report_id: winrt.system.UInt8, report_buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> None: ...
...
class IGipGameControllerInputSink(IGameControllerInputSink, winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def on_message_received(self, timestamp: winrt.system.UInt64, message_class: GipMessageClass, message_id: winrt.system.UInt8, sequence_id: winrt.system.UInt8, message_buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> None: ...
