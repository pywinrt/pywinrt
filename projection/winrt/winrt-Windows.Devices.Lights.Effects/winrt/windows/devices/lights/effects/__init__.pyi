...
class LampArrayBitmapEffect(winrt.system.Object, ILampArrayEffect):
    def __new__(cls: type[Self], lamp_array: windows_devices_lights.LampArray, lamp_indexes: winrt.system.Array[winrt.system.Int32] | winrt.system.ReadableBuffer) -> Self: ...
...
class LampArrayCustomEffect(winrt.system.Object, ILampArrayEffect):
    ...
    def remove_update_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class LampArrayEffectPlaylist_Static(winrt._winrt.IInspectable_Static):
    ...
    def start_all(cls, value: _cabc.Iterable[LampArrayEffectPlaylist], /) -> None: ...
...
class LampArrayEffectPlaylist(winrt.system.Object, winrt._winrt.Sequence[ILampArrayEffect], metaclass=LampArrayEffectPlaylist_Static):
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[ILampArrayEffect] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def index_of(self, value: ILampArrayEffect, /) -> tuple[bool, winrt.system.UInt32]: ...
...
class LampArrayUpdateRequestedEventArgs(winrt.system.Object):
    ...
    def set_color_for_index(self, lamp_index: winrt.system.Int32, desired_color: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8], /) -> None: ...
    ...
    def set_colors_for_indices(self, desired_colors: winrt.system.Array[windows_ui.Color] | winrt.system.ReadableBuffer, lamp_indexes: winrt.system.Array[winrt.system.Int32] | winrt.system.ReadableBuffer, /) -> None: ...
    ...
    def set_single_color_for_indices(self, desired_color: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8], lamp_indexes: winrt.system.Array[winrt.system.Int32] | winrt.system.ReadableBuffer, /) -> None: ...
