...
namespace py::cpp::Windows::ApplicationModel::Wallet::System
{
    ...
    static PyObject* WalletItemSystemStore_add_ItemsChanged(py::wrapper::Windows::ApplicationModel::Wallet::System::WalletItemSystemStore* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore2>(self->obj, py::member_kind::event, "Windows.ApplicationModel.Wallet.System.WalletItemSystemStore", "ItemsChanged", "Windows.ApplicationModel.Wallet.System.IWalletItemSystemStore2").ItemsChanged(param0);
            }());
        }
        catch (...)
        {
    ...
    static PyObject* WalletItemSystemStore_remove_ItemsChanged(py::wrapper::Windows::ApplicationModel::Wallet::System::WalletItemSystemStore* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                py::require<winrt::Windows::ApplicationModel::Wallet::System::IWalletItemSystemStore2>(self->obj, py::member_kind::event, "Windows.ApplicationModel.Wallet.System.WalletItemSystemStore", "ItemsChanged", "Windows.ApplicationModel.Wallet.System.IWalletItemSystemStore2").ItemsChanged(param0);
            }
