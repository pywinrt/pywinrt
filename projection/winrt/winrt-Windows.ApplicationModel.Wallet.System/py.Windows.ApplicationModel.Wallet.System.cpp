...
namespace py::cpp::Windows::ApplicationModel::Wallet::System
{
    ...
    static PyObject* WalletManagerSystem_RequestStoreAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.ApplicationModel.Wallet.System.WalletManagerSystem", "RequestStoreAsync", nullptr, py::site_is_static};
