...
class PerceptionColorFrameReader(winrt.system.Object, windows_foundation.IClosable):
    ...
    def try_read_latest_frame(self) -> PerceptionColorFrame | None: ...
...
class PerceptionColorFrameSource_Static(winrt._winrt.IInspectable_Static):
    ...
    def find_all_async(cls) -> windows_foundation.IAsyncOperation[_cabc.Sequence[PerceptionColorFrameSource]]: ...
...
class PerceptionColorFrameSource(winrt.system.Object, metaclass=PerceptionColorFrameSource_Static):
    ...
    # @deprecated("PerceptionColorFrameSource may be unavailable after Windows Creator Update.  Use Windows.Media.Capture.Frames.MediaFrameSource instead.")
    def try_get_depth_correlated_camera_intrinsics_async(self, correlated_depth_frame_source: PerceptionDepthFrameSource, /) -> windows_foundation.IAsyncOperation[PerceptionDepthCorrelatedCameraIntrinsics | None]: ...
    ...
    # @deprecated("PerceptionColorFrameSource may be unavailable after Windows Creator Update.  Use Windows.Media.Capture.Frames.MediaFrameSource instead.")
    def try_get_depth_correlated_coordinate_mapper_async(self, target_source_id: str, correlated_depth_frame_source: PerceptionDepthFrameSource, /) -> windows_foundation.IAsyncOperation[PerceptionDepthCorrelatedCoordinateMapper | None]: ...
    ...
    # @deprecated("PerceptionColorFrameSource may be unavailable after Windows Creator Update.  Use Windows.Media.Capture.Frames.MediaFrameSource instead.")
    def try_get_transform_to(self, target_id: str, /) -> tuple[bool, windows_foundation_numerics.Matrix4x4]: ...
    ...
    # @deprecated("PerceptionColorFrameSource may be unavailable after Windows Creator Update.  Use Windows.Media.Capture.Frames.MediaFrameSource instead.")
    def remove_active_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    # @deprecated("PerceptionColorFrameSource may be unavailable after Windows Creator Update.  Use Windows.Media.Capture.Frames.MediaFrameSource instead.")
    def remove_available_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    # @deprecated("PerceptionColorFrameSource may be unavailable after Windows Creator Update.  Use Windows.Media.Capture.Frames.MediaFrameSource instead.")
    def remove_camera_intrinsics_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    # @deprecated("PerceptionColorFrameSource may be unavailable after Windows Creator Update.  Use Windows.Media.Capture.Frames.MediaFrameSource instead.")
    def remove_properties_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    # @deprecated("PerceptionColorFrameSource may be unavailable after Windows Creator Update.  Use Windows.Media.Capture.Frames.MediaFrameSource instead.")
    def remove_video_profile_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def available_video_profiles(self) -> _cabc.Sequence[PerceptionVideoProfile]: ...
    ...
    @_property
    def supported_video_profiles(self) -> _cabc.Sequence[PerceptionVideoProfile]: ...
...
class PerceptionColorFrameSourceWatcher(winrt.system.Object):
    ...
    # @deprecated("PerceptionColorFrameSourceWatcher may be unavailable after Windows Creator Update.  Use Windows.Devices.Enumeration.DeviceWatcher instead.")
    def remove_source_added(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    # @deprecated("PerceptionColorFrameSourceWatcher may be unavailable after Windows Creator Update.  Use Windows.Devices.Enumeration.DeviceWatcher instead.")
    def remove_source_removed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PerceptionControlSession(winrt.system.Object, windows_foundation.IClosable):
    ...
    # @deprecated("PerceptionControlSession may be unavailable after Windows Creator Update.  Please refer to Windows.Media.Capture.Frames APIs on MSDN.")
    def remove_control_lost(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PerceptionDepthCorrelatedCameraIntrinsics(winrt.system.Object):
    ...
    # @deprecated("PerceptionDepthCorrelatedCameraIntrinsics may be unavailable after Windows Creator Update.  Use Windows.Media.Devices.Core.DepthCorrelatedCoordinateMapper instead.")
    def unproject_pixel_at_correlated_depth(self, pixel_coordinate: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], depth_frame: PerceptionDepthFrame, /) -> windows_foundation_numerics.Vector3: ...
    ...
    # @deprecated("PerceptionDepthCorrelatedCameraIntrinsics may be unavailable after Windows Creator Update.  Use Windows.Media.Devices.Core.DepthCorrelatedCoordinateMapper instead.")
    def unproject_pixels_at_correlated_depth(self, source_coordinates: winrt.system.Array[windows_foundation.Point] | winrt.system.ReadableBuffer, depth_frame: PerceptionDepthFrame, results: winrt.system.Array[windows_foundation_numerics.Vector3] | winrt.system.WriteableBuffer, /) -> None: ...
    ...
    # @deprecated("PerceptionDepthCorrelatedCameraIntrinsics may be unavailable after Windows Creator Update.  Use Windows.Media.Devices.Core.DepthCorrelatedCoordinateMapper instead.")
    def unproject_region_pixels_at_correlated_depth_async(self, region: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], depth_frame: PerceptionDepthFrame, results: winrt.system.Array[windows_foundation_numerics.Vector3] | winrt.system.WriteableBuffer, /) -> windows_foundation.IAsyncAction: ...
...
class PerceptionDepthCorrelatedCoordinateMapper(winrt.system.Object):
    ...
    # @deprecated("PerceptionDepthCorrelatedCoordinateMapper may be unavailable after Windows Creator Update.  Use Windows.Media.Devices.Core.DepthCorrelatedCoordinateMapper instead.")
    def map_pixel_to_target(self, source_pixel_coordinate: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], depth_frame: PerceptionDepthFrame, /) -> windows_foundation.Point: ...
    ...
    # @deprecated("PerceptionDepthCorrelatedCoordinateMapper may be unavailable after Windows Creator Update.  Use Windows.Media.Devices.Core.DepthCorrelatedCoordinateMapper instead.")
    def map_pixels_to_target(self, source_coordinates: winrt.system.Array[windows_foundation.Point] | winrt.system.ReadableBuffer, depth_frame: PerceptionDepthFrame, results: winrt.system.Array[windows_foundation.Point] | winrt.system.WriteableBuffer, /) -> None: ...
    ...
    # @deprecated("PerceptionDepthCorrelatedCoordinateMapper may be unavailable after Windows Creator Update.  Use Windows.Media.Devices.Core.DepthCorrelatedCoordinateMapper instead.")
    def map_region_of_pixels_to_target_async(self, region: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], depth_frame: PerceptionDepthFrame, target_coordinates: winrt.system.Array[windows_foundation.Point] | winrt.system.WriteableBuffer, /) -> windows_foundation.IAsyncAction: ...
...
class PerceptionDepthFrameReader(winrt.system.Object, windows_foundation.IClosable):
    ...
    def try_read_latest_frame(self) -> PerceptionDepthFrame | None: ...
...
class PerceptionDepthFrameSource_Static(winrt._winrt.IInspectable_Static):
    ...
    def find_all_async(cls) -> windows_foundation.IAsyncOperation[_cabc.Sequence[PerceptionDepthFrameSource]]: ...
...
class PerceptionDepthFrameSource(winrt.system.Object, metaclass=PerceptionDepthFrameSource_Static):
    ...
    # @deprecated("PerceptionDepthFrameSource may be unavailable after Windows Creator Update.  Use Windows.Media.Capture.Frames.MediaFrameSource instead.")
    def try_get_depth_correlated_camera_intrinsics_async(self, target: PerceptionDepthFrameSource, /) -> windows_foundation.IAsyncOperation[PerceptionDepthCorrelatedCameraIntrinsics | None]: ...
    ...
    # @deprecated("PerceptionDepthFrameSource may be unavailable after Windows Creator Update.  Use Windows.Media.Capture.Frames.MediaFrameSource instead.")
    def try_get_depth_correlated_coordinate_mapper_async(self, target_id: str, depth_frame_source_to_map_with: PerceptionDepthFrameSource, /) -> windows_foundation.IAsyncOperation[PerceptionDepthCorrelatedCoordinateMapper | None]: ...
...
class PerceptionInfraredFrameReader(winrt.system.Object, windows_foundation.IClosable):
    ...
    def try_read_latest_frame(self) -> PerceptionInfraredFrame | None: ...
...
class PerceptionInfraredFrameSource_Static(winrt._winrt.IInspectable_Static):
    ...
    def find_all_async(cls) -> windows_foundation.IAsyncOperation[_cabc.Sequence[PerceptionInfraredFrameSource]]: ...
