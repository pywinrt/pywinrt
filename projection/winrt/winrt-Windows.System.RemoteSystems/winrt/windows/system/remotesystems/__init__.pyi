...
class RemoteSystem_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_watcher(cls, filters: _cabc.Iterable[IRemoteSystemFilter], /) -> RemoteSystemWatcher: ...
    # Deprecated alias of create_watcher() for pywinrt v3.x compatibility.
    # Windows.System.RemoteSystems.RemoteSystemWatcher Windows.System.RemoteSystems.RemoteSystem::CreateWatcher(Windows.Foundation.Collections.IIterable`1<Windows.System.RemoteSystems.IRemoteSystemFilter>)
    @deprecated("Use create_watcher() instead.")
    def create_watcher_with_filters(cls, filters: _cabc.Iterable[IRemoteSystemFilter], /) -> RemoteSystemWatcher: ...
    @typing.overload
    ...
    def create_watcher_for_user(cls, user: windows_system.User, filters: _cabc.Iterable[IRemoteSystemFilter], /) -> RemoteSystemWatcher: ...
    # Deprecated alias of create_watcher_for_user() for pywinrt v3.x compatibility.
    # Windows.System.RemoteSystems.RemoteSystemWatcher Windows.System.RemoteSystems.RemoteSystem::CreateWatcherForUser(Windows.System.User,Windows.Foundation.Collections.IIterable`1<Windows.System.RemoteSystems.IRemoteSystemFilter>)
    @deprecated("Use create_watcher_for_user() instead.")
    def create_watcher_with_filters_for_user(cls, user: windows_system.User, filters: _cabc.Iterable[IRemoteSystemFilter], /) -> RemoteSystemWatcher: ...
...
class RemoteSystem(winrt.system.Object, metaclass=RemoteSystem_Static):
    ...
    @_property
    def apps(self) -> _cabc.Sequence[RemoteSystemApp]: ...
...
class RemoteSystemAppRegistration(winrt.system.Object, metaclass=RemoteSystemAppRegistration_Static):
    ...
    @_property
    def attributes(self) -> _cabc.MutableMapping[str, str]: ...
...
class RemoteSystemAuthorizationKindFilter(winrt.system.Object, IRemoteSystemFilter):
    def __new__(cls: type[Self], remote_system_authorization_kind: RemoteSystemAuthorizationKind) -> Self: ...
...
class RemoteSystemConnectionInfo_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_create_from_app_service_connection(cls, connection: windows_applicationmodel_appservice.AppServiceConnection, /) -> RemoteSystemConnectionInfo | None: ...
...
class RemoteSystemConnectionRequest(winrt.system.Object, metaclass=RemoteSystemConnectionRequest_Static):
    def __new__(cls: type[Self], remote_system: RemoteSystem) -> Self: ...
...
class RemoteSystemDiscoveryTypeFilter(winrt.system.Object, IRemoteSystemFilter):
    def __new__(cls: type[Self], discovery_type: RemoteSystemDiscoveryType) -> Self: ...
...
class RemoteSystemKindFilter(winrt.system.Object, IRemoteSystemFilter):
    def __new__(cls: type[Self], remote_system_kinds: _cabc.Iterable[str]) -> Self: ...
    ...
    @_property
    def remote_system_kinds(self) -> _cabc.Sequence[str]: ...
...
class RemoteSystemSession(winrt.system.Object, windows_foundation.IClosable, metaclass=RemoteSystemSession_Static):
    ...
    def remove_disconnected(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class RemoteSystemSessionController(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], display_name: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], display_name: str, options: RemoteSystemSessionOptions) -> Self: ...
    ...
    def remove_join_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class RemoteSystemSessionInvitationListener(winrt.system.Object):
    ...
    def remove_invitation_received(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class RemoteSystemSessionMessageChannel(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], session: RemoteSystemSession, channel_name: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], session: RemoteSystemSession, channel_name: str, reliability: RemoteSystemSessionMessageChannelReliability) -> Self: ...
    ...
    def send_value_set_to_participants_async(self, message_data: windows_foundation_collections.ValueSet, participants: _cabc.Iterable[RemoteSystemSessionParticipant], /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def remove_value_set_received(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class RemoteSystemStatusTypeFilter(winrt.system.Object, IRemoteSystemFilter):
    def __new__(cls: type[Self], remote_system_status_type: RemoteSystemStatusType) -> Self: ...
...
class RemoteSystemWatcher(winrt.system.Object):
    ...
    def remove_remote_system_added(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_remote_system_removed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_remote_system_updated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_error_occurred(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class RemoteSystemWebAccountFilter(winrt.system.Object, IRemoteSystemFilter):
    def __new__(cls: type[Self], account: windows_security_credentials.WebAccount) -> Self: ...
