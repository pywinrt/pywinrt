...
class RemoteSystemConnectionRequest(winrt.system.Object, metaclass=RemoteSystemConnectionRequest_Static):
    def __new__(cls, remote_system: RemoteSystem) -> typing.Self: ...
...
class RemoteSystemSessionController(winrt.system.Object):
    @typing.overload
    def __new__(cls, display_name: str) -> typing.Self: ...
    @typing.overload
    def __new__(cls, display_name: str, options: RemoteSystemSessionOptions) -> typing.Self: ...
...
class RemoteSystemSessionMessageChannel(winrt.system.Object):
    @typing.overload
    def __new__(cls, session: RemoteSystemSession, channel_name: str) -> typing.Self: ...
    @typing.overload
    def __new__(cls, session: RemoteSystemSession, channel_name: str, reliability: RemoteSystemSessionMessageChannelReliability) -> typing.Self: ...
