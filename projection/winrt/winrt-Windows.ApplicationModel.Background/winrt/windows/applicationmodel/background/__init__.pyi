...
class BackgroundTaskRegistrationGroup(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls, id: str, name: str) -> typing.Self: ...
...
class GattCharacteristicNotificationTrigger(winrt.system.Object, IBackgroundTrigger):
    ...
    @typing.overload
    def __new__(cls, characteristic: windows_devices_bluetooth_genericattributeprofile.GattCharacteristic) -> typing.Self: ...
