...
class ActivitySensorTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], report_interval_in_milliseconds: winrt.system.UInt32) -> Self: ...
    ...
    @_property
    def subscribed_activities(self) -> _cabc.MutableSequence[windows_devices_sensors.ActivityType]: ...
...
class AppBroadcastTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], provider_key: str) -> Self: ...
...
class BackgroundTaskRegistration_Static(winrt._winrt.IInspectable_Static):
    ...
    @_property
    def all_tasks(cls) -> _cabc.Mapping[_uuid.UUID, IBackgroundTaskRegistration]: ...
...
class BackgroundTaskRegistration(winrt.system.Object, IBackgroundTaskRegistration3, IBackgroundTaskRegistration2, IBackgroundTaskRegistration, metaclass=BackgroundTaskRegistration_Static):
    ...
    def remove_completed(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_progress(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class BackgroundTaskRegistrationGroup(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: type[Self], id: str, name: str) -> Self: ...
    ...
    def remove_background_activated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def all_tasks(self) -> _cabc.Mapping[_uuid.UUID, BackgroundTaskRegistration]: ...
...
class BluetoothLEAdvertisementPublisherTrigger(winrt.system.Object, IBackgroundTrigger):
    ...
    @_property
    def preferred_transmit_power_level_in_dbm(self) -> winrt.system.Int16 | None: ...
    ...
    def preferred_transmit_power_level_in_dbm(self, value: winrt.system.Int16 | None) -> None: ...
...
class ContentPrefetchTrigger(winrt.system.Object, IBackgroundTrigger):
    @typing.overload
    def __new__(cls: type[Self], wait_interval: datetime.timedelta) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
class CustomSystemEventTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], trigger_id: str, recurrence: CustomSystemEventTriggerRecurrence) -> Self: ...
...
class DeviceManufacturerNotificationTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], trigger_qualifier: str, one_shot: bool) -> Self: ...
...
class GattCharacteristicNotificationTrigger(winrt.system.Object, IBackgroundTrigger):
    @typing.overload
    def __new__(cls: type[Self], characteristic: windows_devices_bluetooth_genericattributeprofile.GattCharacteristic, event_triggering_mode: windows_devices_bluetooth_background.BluetoothEventTriggeringMode) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], characteristic: windows_devices_bluetooth_genericattributeprofile.GattCharacteristic) -> Self: ...
...
class LocationTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], trigger_type: LocationTriggerType) -> Self: ...
...
class MaintenanceTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], freshness_time: winrt.system.UInt32, one_shot: bool) -> Self: ...
...
class NetworkOperatorNotificationTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], network_account_id: str) -> Self: ...
...
class PhoneTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], type: windows_applicationmodel_calls_background.PhoneTriggerType, one_shot: bool) -> Self: ...
...
class PushNotificationTrigger(winrt.system.Object, IBackgroundTrigger):
    @typing.overload
    def __new__(cls: type[Self], application_id: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
class SensorDataThresholdTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], threshold: windows_devices_sensors.ISensorDataThreshold) -> Self: ...

@typing.final
class SmartCardTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], trigger_type: windows_devices_smartcards.SmartCardTriggerType) -> Self: ...
...
class SmsMessageReceivedTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], filter_rules: windows_devices_sms.SmsFilterRules) -> Self: ...
...
class StorageLibraryChangeTrackerTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], tracker: windows_storage.StorageLibraryChangeTracker) -> Self: ...
...
class SystemCondition(winrt.system.Object, IBackgroundCondition):
    def __new__(cls: type[Self], condition_type: SystemConditionType) -> Self: ...
...
class SystemTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], trigger_type: SystemTriggerType, one_shot: bool) -> Self: ...
...
class UserNotificationChangedTrigger(winrt.system.Object, IBackgroundTrigger):
    def __new__(cls: type[Self], notification_kinds: windows_ui_notifications.NotificationKinds) -> Self: ...
