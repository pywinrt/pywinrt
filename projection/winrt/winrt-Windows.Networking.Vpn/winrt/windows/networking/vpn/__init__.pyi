...
class VpnAppId(winrt.system.Object):
    def __new__(cls, type: VpnAppIdType, value: str) -> typing.Self: ...
...
class VpnDomainNameInfo(winrt.system.Object):
    def __new__(cls, name: str, name_type: VpnDomainNameType, dns_server_list: _cabc.Iterable[windows_networking.HostName], proxy_server_list: _cabc.Iterable[windows_networking.HostName]) -> typing.Self: ...
...
class VpnInterfaceId(winrt.system.Object):
    def __new__(cls, address: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> typing.Self: ...
...
class VpnNamespaceInfo(winrt.system.Object):
    def __new__(cls, name: str, dns_server_list: _cabc.MutableSequence[windows_networking.HostName], proxy_server_list: _cabc.MutableSequence[windows_networking.HostName]) -> typing.Self: ...
...
class VpnPacketBuffer(winrt.system.Object):
    def __new__(cls, parent_buffer: VpnPacketBuffer, offset: winrt.system.UInt32, length: winrt.system.UInt32) -> typing.Self: ...
...
class VpnRoute(winrt.system.Object):
    def __new__(cls, address: windows_networking.HostName, prefix_size: winrt.system.UInt8) -> typing.Self: ...
...
class VpnTrafficFilter(winrt.system.Object):
    def __new__(cls, app_id: VpnAppId) -> typing.Self: ...
