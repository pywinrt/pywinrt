...
class VpnAppId(winrt.system.Object):
    def __new__(cls: type[Self], type: VpnAppIdType, value: str) -> Self: ...
...
class VpnChannel(winrt.system.Object, metaclass=VpnChannel_Static):
    ...
    def request_credentials_async(self, cred_type: VpnCredentialType, /) -> windows_foundation.IAsyncOperation[VpnCredential]: ...
    @typing.overload
    ...
    def request_credentials_async(self, cred_type: VpnCredentialType, cred_options: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[VpnCredential]: ...
    @typing.overload
    ...
    def request_credentials_async(self, cred_type: VpnCredentialType, cred_options: winrt.system.UInt32, certificate: windows_security_cryptography_certificates.Certificate, /) -> windows_foundation.IAsyncOperation[VpnCredential]: ...
    # Deprecated alias of request_credentials_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Networking.Vpn.VpnCredential> Windows.Networking.Vpn.VpnChannel::RequestCredentialsAsync(Windows.Networking.Vpn.VpnCredentialType)
    @deprecated("Use request_credentials_async() instead.")
    ...
    def request_custom_prompt(self, custom_prompt: _cabc.Sequence[IVpnCustomPrompt], /) -> None: ...
    ...
    def request_custom_prompt_async(self, custom_prompt_element: _cabc.Sequence[IVpnCustomPromptElement], /) -> windows_foundation.IAsyncAction: ...
    ...
    def start(self, assigned_client_ipv4list: _cabc.Sequence[windows_networking.HostName], assigned_client_ipv6list: _cabc.Sequence[windows_networking.HostName], vpn_interface_id: VpnInterfaceId, route_scope: VpnRouteAssignment, namespace_scope: VpnNamespaceAssignment, mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, optimize_for_low_cost_network: bool, main_outer_tunnel_transport: winrt.system.Object, optional_outer_tunnel_transport: winrt.system.Object, /) -> None: ...
    ...
    def start_existing_transports(self, assigned_client_ipv4list: _cabc.Sequence[windows_networking.HostName], assigned_client_ipv6list: _cabc.Sequence[windows_networking.HostName], vpn_interface_id: VpnInterfaceId, assigned_routes: VpnRouteAssignment, assigned_domain_name: VpnDomainNameAssignment, mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, reserved: bool, /) -> None: ...
    ...
    def start_with_traffic_filter(self, assigned_client_ipv4_addresses: _cabc.Iterable[windows_networking.HostName], assigned_client_ipv6_addresses: _cabc.Iterable[windows_networking.HostName], vpninterface_id: VpnInterfaceId, assigned_routes: VpnRouteAssignment, assigned_namespace: VpnDomainNameAssignment, mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, reserved: bool, transports: _cabc.Iterable[winrt.system.Object], assigned_traffic_filters: VpnTrafficFilterAssignment, /) -> None: ...
    @typing.overload
    ...
    def start_with_traffic_filter(self, assigned_client_ipv4_list: _cabc.Sequence[windows_networking.HostName], assigned_client_ipv6_list: _cabc.Sequence[windows_networking.HostName], vpn_interface_id: VpnInterfaceId, assigned_routes: VpnRouteAssignment, assigned_namespace: VpnDomainNameAssignment, mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, reserved: bool, main_outer_tunnel_transport: winrt.system.Object, optional_outer_tunnel_transport: winrt.system.Object, assigned_traffic_filters: VpnTrafficFilterAssignment, /) -> None: ...
    # Deprecated alias of start_with_traffic_filter() for pywinrt v3.x compatibility.
    # System.Void Windows.Networking.Vpn.VpnChannel::StartWithTrafficFilter(Windows.Foundation.Collections.IIterable`1<Windows.Networking.HostName>,Windows.Foundation.Collections.IIterable`1<Windows.Networking.HostName>,Windows.Networking.Vpn.VpnInterfaceId,Windows.Networking.Vpn.VpnRouteAssignment,Windows.Networking.Vpn.VpnDomainNameAssignment,System.UInt32,System.UInt32,System.Boolean,Windows.Foundation.Collections.IIterable`1<System.Object>,Windows.Networking.Vpn.VpnTrafficFilterAssignment)
    @deprecated("Use start_with_traffic_filter() instead.")
    def start_with_multiple_transports(self, assigned_client_ipv4_addresses: _cabc.Iterable[windows_networking.HostName], assigned_client_ipv6_addresses: _cabc.Iterable[windows_networking.HostName], vpninterface_id: VpnInterfaceId, assigned_routes: VpnRouteAssignment, assigned_namespace: VpnDomainNameAssignment, mtu_size: winrt.system.UInt32, max_frame_size: winrt.system.UInt32, reserved: bool, transports: _cabc.Iterable[winrt.system.Object], assigned_traffic_filters: VpnTrafficFilterAssignment, /) -> None: ...
    ...
    def remove_activity_change(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_activity_state_change(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class VpnChannelConfiguration(winrt.system.Object):
    ...
    @_property
    def server_host_name_list(self) -> _cabc.Sequence[windows_networking.HostName]: ...
...
class VpnCustomComboBox(winrt.system.Object, IVpnCustomPrompt):
    ...
    @_property
    def options_text(self) -> _cabc.Sequence[str]: ...
    ...
    @options_text.setter
    def options_text(self, value: _cabc.Sequence[str]) -> None: ...
...
class VpnCustomPromptOptionSelector(winrt.system.Object, IVpnCustomPromptElement):
    ...
    @_property
    def options(self) -> _cabc.MutableSequence[str]: ...
...
class VpnDomainNameAssignment(winrt.system.Object):
    ...
    @_property
    def domain_name_list(self) -> _cabc.MutableSequence[VpnDomainNameInfo]: ...

@typing.final
class VpnDomainNameInfo(winrt.system.Object):
    def __new__(cls: type[Self], name: str, name_type: VpnDomainNameType, dns_server_list: _cabc.Iterable[windows_networking.HostName], proxy_server_list: _cabc.Iterable[windows_networking.HostName]) -> Self: ...
    ...
    @_property
    def dns_servers(self) -> _cabc.MutableSequence[windows_networking.HostName]: ...
    ...
    @_property
    def web_proxy_servers(self) -> _cabc.MutableSequence[windows_networking.HostName]: ...
...
class VpnInterfaceId(winrt.system.Object):
    def __new__(cls: type[Self], address: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> Self: ...
...
class VpnManagementAgent(winrt.system.Object):
    ...
    def get_profiles_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[IVpnProfile]]: ...
...
class VpnNamespaceAssignment(winrt.system.Object):
    ...
    @_property
    def namespace_list(self) -> _cabc.MutableSequence[VpnNamespaceInfo]: ...
    ...
    def namespace_list(self, value: _cabc.MutableSequence[VpnNamespaceInfo]) -> None: ...

@typing.final
class VpnNamespaceInfo(winrt.system.Object):
    def __new__(cls: type[Self], name: str, dns_server_list: _cabc.MutableSequence[windows_networking.HostName], proxy_server_list: _cabc.MutableSequence[windows_networking.HostName]) -> Self: ...
    ...
    def web_proxy_servers(self, value: _cabc.MutableSequence[windows_networking.HostName]) -> None: ...
...
class VpnNativeProfile(winrt.system.Object, IVpnProfile):
    ...
    @_property
    def servers(self) -> _cabc.MutableSequence[str]: ...
    ...
    @_property
    def routes(self) -> _cabc.MutableSequence[VpnRoute]: ...
    ...
    @_property
    def app_triggers(self) -> _cabc.MutableSequence[VpnAppId]: ...
    ...
    @_property
    def traffic_filters(self) -> _cabc.MutableSequence[VpnTrafficFilter]: ...
    ...
    @_property
    def domain_name_info_list(self) -> _cabc.MutableSequence[VpnDomainNameInfo]: ...

@typing.final
class VpnPacketBuffer(winrt.system.Object):
    def __new__(cls: type[Self], parent_buffer: VpnPacketBuffer, offset: winrt.system.UInt32, length: winrt.system.UInt32) -> Self: ...
...
class VpnPlugInProfile(winrt.system.Object, IVpnProfile):
    ...
    @_property
    def server_uris(self) -> _cabc.MutableSequence[windows_foundation.Uri]: ...
...
class VpnRoute(winrt.system.Object):
    def __new__(cls: type[Self], address: windows_networking.HostName, prefix_size: winrt.system.UInt8) -> Self: ...
...
class VpnRouteAssignment(winrt.system.Object):
    ...
    @_property
    def ipv6_inclusion_routes(self) -> _cabc.MutableSequence[VpnRoute]: ...
    ...
    def ipv6_inclusion_routes(self, value: _cabc.MutableSequence[VpnRoute]) -> None: ...
    ...
    @_property
    def ipv6_exclusion_routes(self) -> _cabc.MutableSequence[VpnRoute]: ...
    ...
    def ipv6_exclusion_routes(self, value: _cabc.MutableSequence[VpnRoute]) -> None: ...
    ...
    @_property
    def ipv4_inclusion_routes(self) -> _cabc.MutableSequence[VpnRoute]: ...
    ...
    def ipv4_inclusion_routes(self, value: _cabc.MutableSequence[VpnRoute]) -> None: ...
    ...
    @_property
    def ipv4_exclusion_routes(self) -> _cabc.MutableSequence[VpnRoute]: ...
    ...
    def ipv4_exclusion_routes(self, value: _cabc.MutableSequence[VpnRoute]) -> None: ...
...
class VpnTrafficFilter(winrt.system.Object):
    def __new__(cls: type[Self], app_id: VpnAppId) -> Self: ...
...
class VpnTrafficFilterAssignment(winrt.system.Object):
    ...
    @_property
    def traffic_filter_list(self) -> _cabc.MutableSequence[VpnTrafficFilter]: ...
