...
class VoiceCommandDefinitionManager_Static(winrt._winrt.IInspectable_Static):
    ...
    @_property
    def installed_command_definitions(cls) -> _cabc.Mapping[str, VoiceCommandDefinition]: ...
...
class VoiceCommandResponse_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_response(cls, message: VoiceCommandUserMessage, content_tiles: _cabc.Iterable[VoiceCommandContentTile], /) -> VoiceCommandResponse: ...
    # Deprecated alias of create_response() for pywinrt v3.x compatibility.
    # Windows.ApplicationModel.VoiceCommands.VoiceCommandResponse Windows.ApplicationModel.VoiceCommands.VoiceCommandResponse::CreateResponse(Windows.ApplicationModel.VoiceCommands.VoiceCommandUserMessage,Windows.Foundation.Collections.IIterable`1<Windows.ApplicationModel.VoiceCommands.VoiceCommandContentTile>)
    @deprecated("Use create_response() instead.")
    def create_response_with_tiles(cls, message: VoiceCommandUserMessage, content_tiles: _cabc.Iterable[VoiceCommandContentTile], /) -> VoiceCommandResponse: ...
    @typing.overload
    ...
    def create_response_for_prompt(cls, message: VoiceCommandUserMessage, repeat_message: VoiceCommandUserMessage, content_tiles: _cabc.Iterable[VoiceCommandContentTile], /) -> VoiceCommandResponse: ...
    ...
    def create_response_for_prompt_with_tiles(cls, message: VoiceCommandUserMessage, repeat_message: VoiceCommandUserMessage, content_tiles: _cabc.Iterable[VoiceCommandContentTile], /) -> VoiceCommandResponse: ...
...
class VoiceCommandResponse(winrt.system.Object, metaclass=VoiceCommandResponse_Static):
    ...
    @_property
    def voice_command_content_tiles(self) -> _cabc.MutableSequence[VoiceCommandContentTile]: ...
...
class VoiceCommandServiceConnection(winrt.system.Object, metaclass=VoiceCommandServiceConnection_Static):
    ...
    def remove_voice_command_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
