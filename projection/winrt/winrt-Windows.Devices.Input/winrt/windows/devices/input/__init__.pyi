...
class PointerDeviceUsage:
    ...
    def unpack(self) -> tuple[winrt.system.UInt32, winrt.system.UInt32, winrt.system.Int32, winrt.system.Int32, winrt.system.Int32, winrt.system.Int32, winrt.system.UInt32, winrt.system.Single]: ...
...
class MouseDevice(winrt.system.Object, metaclass=MouseDevice_Static):
    ...
    def remove_mouse_moved(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PenButtonListener(winrt.system.Object, metaclass=PenButtonListener_Static):
    ...
    def remove_tail_button_clicked(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_tail_button_double_clicked(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_tail_button_long_pressed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PenDockListener(winrt.system.Object, metaclass=PenDockListener_Static):
    ...
    def remove_docked(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_undocked(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PointerDevice_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_pointer_devices(cls) -> _cabc.Sequence[PointerDevice]: ...
...
class PointerDevice(winrt.system.Object, metaclass=PointerDevice_Static):
    ...
    @_property
    def supported_usages(self) -> _cabc.Sequence[PointerDeviceUsage]: ...
