...
namespace py::cpp::Windows::Devices::Input
{
    ...
    static PyObject* MouseDevice_GetForCurrentView(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Input.MouseDevice", "GetForCurrentView", nullptr, py::site_is_static};
    ...
    static PyObject* PenButtonListener_GetDefault(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Input.PenButtonListener", "GetDefault", nullptr, py::site_is_static};
    ...
    static PyObject* PenDevice_GetFromPointerId(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Input.PenDevice", "GetFromPointerId", nullptr, py::site_is_static};
    ...
    static PyObject* PenDevice_get_SimpleHapticsController(py::wrapper::Windows::Devices::Input::PenDevice* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::Devices::Input::IPenDevice2>(self->obj, py::member_kind::property, "Windows.Devices.Input.PenDevice", "SimpleHapticsController", "Windows.Devices.Input.IPenDevice2").SimpleHapticsController();
            }());
        }
        catch (...)
        {
    ...
    static PyObject* PenDockListener_GetDefault(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Input.PenDockListener", "GetDefault", nullptr, py::site_is_static};
    ...
    static PyObject* PointerDevice_GetPointerDevice(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Input.PointerDevice", "GetPointerDevice", nullptr, py::site_is_static};
    ...
    static PyObject* PointerDevice_GetPointerDevices(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Input.PointerDevice", "GetPointerDevices", nullptr, py::site_is_static};
    ...
    static PyObject* PointerDevice_get_MaxPointersWithZDistance(py::wrapper::Windows::Devices::Input::PointerDevice* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::Devices::Input::IPointerDevice2>(self->obj, py::member_kind::property, "Windows.Devices.Input.PointerDevice", "MaxPointersWithZDistance", "Windows.Devices.Input.IPointerDevice2").MaxPointersWithZDistance();
            }());
        }
        catch (...)
        {
