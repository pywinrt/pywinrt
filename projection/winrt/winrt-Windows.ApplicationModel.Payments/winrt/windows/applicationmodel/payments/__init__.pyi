...
class PaymentCanMakePaymentResult(winrt.system.Object):
    def __new__(cls, value: PaymentCanMakePaymentResultStatus) -> typing.Self: ...
...
class PaymentCurrencyAmount(winrt.system.Object):
    @typing.overload
    def __new__(cls, value: str, currency: str) -> typing.Self: ...
    @typing.overload
    def __new__(cls, value: str, currency: str, currency_system: str) -> typing.Self: ...
...
class PaymentDetails(winrt.system.Object):
    @typing.overload
    def __new__(cls, total: PaymentItem) -> typing.Self: ...
    @typing.overload
    def __new__(cls, total: PaymentItem, display_items: _cabc.Iterable[PaymentItem]) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
...
class PaymentDetailsModifier(winrt.system.Object):
    @typing.overload
    def __new__(cls, supported_method_ids: _cabc.Iterable[str], total: PaymentItem) -> typing.Self: ...
    @typing.overload
    def __new__(cls, supported_method_ids: _cabc.Iterable[str], total: PaymentItem, additional_display_items: _cabc.Iterable[PaymentItem]) -> typing.Self: ...
    @typing.overload
    def __new__(cls, supported_method_ids: _cabc.Iterable[str], total: PaymentItem, additional_display_items: _cabc.Iterable[PaymentItem], json_data: str) -> typing.Self: ...
...
class PaymentItem(winrt.system.Object):
    def __new__(cls, label: str, amount: PaymentCurrencyAmount) -> typing.Self: ...
...
class PaymentMethodData(winrt.system.Object):
    @typing.overload
    def __new__(cls, supported_method_ids: _cabc.Iterable[str]) -> typing.Self: ...
    @typing.overload
    def __new__(cls, supported_method_ids: _cabc.Iterable[str], json_data: str) -> typing.Self: ...
...
class PaymentRequest(winrt.system.Object):
    @typing.overload
    def __new__(cls, details: PaymentDetails, method_data: _cabc.Iterable[PaymentMethodData], merchant_info: PaymentMerchantInfo, options: PaymentOptions, id: str) -> typing.Self: ...
    @typing.overload
    def __new__(cls, details: PaymentDetails, method_data: _cabc.Iterable[PaymentMethodData]) -> typing.Self: ...
    @typing.overload
    def __new__(cls, details: PaymentDetails, method_data: _cabc.Iterable[PaymentMethodData], merchant_info: PaymentMerchantInfo) -> typing.Self: ...
    @typing.overload
    def __new__(cls, details: PaymentDetails, method_data: _cabc.Iterable[PaymentMethodData], merchant_info: PaymentMerchantInfo, options: PaymentOptions) -> typing.Self: ...
...
class PaymentRequestChangedResult(winrt.system.Object):
    @typing.overload
    def __new__(cls, change_accepted_by_merchant: bool) -> typing.Self: ...
    @typing.overload
    def __new__(cls, change_accepted_by_merchant: bool, updated_payment_details: PaymentDetails) -> typing.Self: ...
...
class PaymentShippingOption(winrt.system.Object):
    ...
    def __new__(cls, label: str, amount: PaymentCurrencyAmount) -> typing.Self: ...
    @typing.overload
    def __new__(cls, label: str, amount: PaymentCurrencyAmount, selected: bool) -> typing.Self: ...
    @typing.overload
    def __new__(cls, label: str, amount: PaymentCurrencyAmount, selected: bool, tag: str) -> typing.Self: ...
...
class PaymentToken(winrt.system.Object):
    @typing.overload
    def __new__(cls, payment_method_id: str) -> typing.Self: ...
    @typing.overload
    def __new__(cls, payment_method_id: str, json_details: str) -> typing.Self: ...
