...
namespace py::cpp::Windows::Media::DialProtocol
{
    ...
    static PyObject* DialDevice_DeviceInfoSupportsDialAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Media.DialProtocol.DialDevice", "DeviceInfoSupportsDialAsync", nullptr, py::site_is_static};
    ...
    static PyObject* DialDevice_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Media.DialProtocol.DialDevice", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* DialDevice_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Media.DialProtocol.DialDevice", "GetDeviceSelector", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.Media.DialProtocol.DialReceiverApp", "Current", nullptr, py::site_is_static};
