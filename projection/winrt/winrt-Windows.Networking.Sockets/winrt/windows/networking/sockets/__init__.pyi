...
class BandwidthStatistics:
    ...
    def unpack(self) -> tuple[winrt.system.UInt64, winrt.system.UInt64, winrt.system.UInt64, winrt.system.UInt64, bool, bool]: ...
...
class ControlChannelTrigger(winrt.system.Object, windows_foundation.IClosable):
    ...
    @typing.overload
    def __new__(cls: type[Self], channel_id: str, server_keep_alive_interval_in_minutes: winrt.system.UInt32) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], channel_id: str, server_keep_alive_interval_in_minutes: winrt.system.UInt32, resource_request_type: ControlChannelTriggerResourceType) -> Self: ...
...
class DatagramSocket_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_endpoint_pairs_async(cls, remote_host_name: windows_networking.HostName, remote_service_name: str, sort_options: windows_networking.HostNameSortOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_networking.EndpointPair]]: ...
    # Deprecated alias of get_endpoint_pairs_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Networking.EndpointPair>> Windows.Networking.Sockets.DatagramSocket::GetEndpointPairsAsync(Windows.Networking.HostName,System.String,Windows.Networking.HostNameSortOptions)
    @deprecated("Use get_endpoint_pairs_async() instead.")
...
class DatagramSocket(winrt.system.Object, windows_foundation.IClosable, metaclass=DatagramSocket_Static):
    ...
    def bind_service_name_async(self, local_service_name: str, adapter: windows_networking_connectivity.NetworkAdapter, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of bind_service_name_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Networking.Sockets.DatagramSocket::BindServiceNameAsync(System.String,Windows.Networking.Connectivity.NetworkAdapter)
    @deprecated("Use bind_service_name_async() instead.")
    ...
    def connect_async(self, endpoint_pair: windows_networking.EndpointPair, /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    ...
    # Deprecated alias of enable_transfer_ownership() for pywinrt v3.x compatibility.
    # System.Void Windows.Networking.Sockets.DatagramSocket::EnableTransferOwnership(System.Guid,Windows.Networking.Sockets.SocketActivityConnectedStandbyAction)
    @deprecated("Use enable_transfer_ownership() instead.")
    ...
    def get_output_stream_async(self, endpoint_pair: windows_networking.EndpointPair, /) -> windows_foundation.IAsyncOperation[windows_storage_streams.IOutputStream]: ...
    @typing.overload
    ...
    # Deprecated alias of get_output_stream_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Storage.Streams.IOutputStream> Windows.Networking.Sockets.DatagramSocket::GetOutputStreamAsync(Windows.Networking.EndpointPair)
    @deprecated("Use get_output_stream_async() instead.")
    ...
    def transfer_ownership(self, socket_id: str, data: SocketActivityContext, /) -> None: ...
    @typing.overload
    ...
    def transfer_ownership(self, socket_id: str, data: SocketActivityContext, keep_alive_time: datetime.timedelta, /) -> None: ...
    # Deprecated alias of transfer_ownership() for pywinrt v3.x compatibility.
    # System.Void Windows.Networking.Sockets.DatagramSocket::TransferOwnership(System.String,Windows.Networking.Sockets.SocketActivityContext)
    @deprecated("Use transfer_ownership() instead.")
    ...
    def remove_message_received(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MessageWebSocket(winrt.system.Object, IWebSocket, windows_foundation.IClosable):
    ...
    # Deprecated alias of close() for pywinrt v3.x compatibility.
    # System.Void Windows.Networking.Sockets.MessageWebSocket::Close(System.UInt16,System.String)
    ...
    def remove_closed(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_server_custom_validation_requested(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MessageWebSocketControl(winrt.system.Object, IWebSocketControl2, IWebSocketControl):
    ...
    @_property
    def supported_protocols(self) -> _cabc.MutableSequence[str]: ...
...
class ServerMessageWebSocket(winrt.system.Object, windows_foundation.IClosable):
    ...
    def remove_message_received(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class SocketActivityContext(winrt.system.Object):
    def __new__(cls: type[Self], data: winrt.system.Buffer) -> Self: ...
...
class StreamSocket(winrt.system.Object, windows_foundation.IClosable, metaclass=StreamSocket_Static):
    ...
    def connect_async(self, remote_host_name: windows_networking.HostName, remote_service_name: str, protection_level: SocketProtectionLevel, /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    ...
    def connect_async(self, remote_host_name: windows_networking.HostName, remote_service_name: str, protection_level: SocketProtectionLevel, adapter: windows_networking_connectivity.NetworkAdapter, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of connect_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Networking.Sockets.StreamSocket::ConnectAsync(Windows.Networking.EndpointPair)
    @deprecated("Use connect_async() instead.")
    def connect_with_endpoint_pair_async(self, endpoint_pair: windows_networking.EndpointPair, /) -> windows_foundation.IAsyncAction: ...
...
class StreamSocketListener(winrt.system.Object, windows_foundation.IClosable):
    ...
    def bind_service_name_async(self, local_service_name: str, protection_level: SocketProtectionLevel, adapter: windows_networking_connectivity.NetworkAdapter, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of bind_service_name_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Networking.Sockets.StreamSocketListener::BindServiceNameAsync(System.String,Windows.Networking.Sockets.SocketProtectionLevel,Windows.Networking.Connectivity.NetworkAdapter)
    @deprecated("Use bind_service_name_async() instead.")
    ...
    def remove_connection_received(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
