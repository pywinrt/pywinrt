...
class ControlChannelTrigger(winrt.system.Object, windows_foundation.IClosable):
    ...
    @typing.overload
    def __new__(cls, channel_id: str, server_keep_alive_interval_in_minutes: winrt.system.UInt32) -> typing.Self: ...
    @typing.overload
    def __new__(cls, channel_id: str, server_keep_alive_interval_in_minutes: winrt.system.UInt32, resource_request_type: ControlChannelTriggerResourceType) -> typing.Self: ...
...
class SocketActivityContext(winrt.system.Object):
    def __new__(cls, data: winrt.system.Buffer) -> typing.Self: ...
