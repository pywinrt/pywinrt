...
class DatagramSocket_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_endpoint_pairs_async(cls, remote_host_name: windows_networking.HostName, remote_service_name: str, sort_options: windows_networking.HostNameSortOptions, /) -> windows_foundation.IAsyncOperation[typing.Sequence[windows_networking.EndpointPair]]: ...
