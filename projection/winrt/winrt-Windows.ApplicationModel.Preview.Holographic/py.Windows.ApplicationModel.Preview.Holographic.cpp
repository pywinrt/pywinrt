...
namespace py::cpp::Windows::ApplicationModel::Preview::Holographic
{
    ...
    static PyObject* HolographicApplicationPreview_IsCurrentViewPresentedOnHolographicDisplay(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.ApplicationModel.Preview.Holographic.HolographicApplicationPreview", "IsCurrentViewPresentedOnHolographicDisplay", nullptr, py::site_is_static};
    ...
    static PyObject* HolographicApplicationPreview_IsHolographicActivation(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.Preview.Holographic.HolographicApplicationPreview", "IsHolographicActivation", nullptr, py::site_is_static};
    ...
    static PyObject* HolographicKeyboardPlacementOverridePreview_GetForCurrentView(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.ApplicationModel.Preview.Holographic.HolographicKeyboardPlacementOverridePreview", "GetForCurrentView", nullptr, py::site_is_static};
