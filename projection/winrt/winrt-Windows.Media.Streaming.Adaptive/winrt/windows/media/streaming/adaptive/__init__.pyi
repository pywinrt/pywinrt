...
class AdaptiveMediaSource(winrt.system.Object, windows_foundation.IClosable, windows_media_core.IMediaSource, metaclass=AdaptiveMediaSource_Static):
    ...
    def remove_download_bitrate_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_download_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_download_failed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_download_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_playback_bitrate_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def desired_max_bitrate(self) -> winrt.system.UInt32 | None: ...
    ...
    def desired_max_bitrate(self, value: winrt.system.UInt32 | None) -> None: ...
    ...
    @_property
    def desired_min_bitrate(self) -> winrt.system.UInt32 | None: ...
    ...
    def desired_min_bitrate(self, value: winrt.system.UInt32 | None) -> None: ...
    ...
    @_property
    def available_bitrates(self) -> _cabc.Sequence[winrt.system.UInt32]: ...
    ...
    @_property
    def desired_seekable_window_size(self) -> datetime.timedelta | None: ...
    ...
    def desired_seekable_window_size(self, value: datetime.timedelta | None) -> None: ...
    ...
    @_property
    def max_seekable_window_size(self) -> datetime.timedelta | None: ...
    ...
    @_property
    def min_live_offset(self) -> datetime.timedelta | None: ...
...
class AdaptiveMediaSourceAdvancedSettings(winrt.system.Object):
    ...
    def desired_bitrate_headroom_ratio(self, value: winrt.system.Double | None) -> None: ...
    ...
    @_property
    def bitrate_downgrade_trigger_ratio(self) -> winrt.system.Double | None: ...
    ...
    def bitrate_downgrade_trigger_ratio(self, value: winrt.system.Double | None) -> None: ...
...
class AdaptiveMediaSourceCorrelatedTimes(winrt.system.Object):
    ...
    @_property
    def presentation_time_stamp(self) -> datetime.timedelta | None: ...
    ...
    @_property
    def program_date_time(self) -> datetime.datetime | None: ...
...
class AdaptiveMediaSourceDiagnosticAvailableEventArgs(winrt.system.Object):
    ...
    @_property
    def request_id(self) -> winrt.system.Int32 | None: ...
    ...
    @_property
    def resource_byte_range_length(self) -> winrt.system.UInt64 | None: ...
    ...
    @_property
    def resource_byte_range_offset(self) -> winrt.system.UInt64 | None: ...
    ...
    @_property
    def resource_type(self) -> AdaptiveMediaSourceResourceType | None: ...
    ...
    @_property
    def segment_id(self) -> winrt.system.UInt64 | None: ...
    ...
    @_property
    def resource_duration(self) -> datetime.timedelta | None: ...
...
class AdaptiveMediaSourceDiagnostics(winrt.system.Object):
    ...
    def remove_diagnostic_available(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AdaptiveMediaSourceDownloadResult(winrt.system.Object):
    ...
    def resource_byte_range_offset(self, value: winrt.system.UInt64 | None) -> None: ...
    ...
    def resource_byte_range_length(self, value: winrt.system.UInt64 | None) -> None: ...
...
class AdaptiveMediaSourceDownloadStatistics(winrt.system.Object):
    ...
    @_property
    def time_to_first_byte_received(self) -> datetime.timedelta | None: ...
    ...
    @_property
    def time_to_headers_received(self) -> datetime.timedelta | None: ...
    ...
    @_property
    def time_to_last_byte_received(self) -> datetime.timedelta | None: ...
