...
class RemoteTextConnection(winrt.system.Object, windows_foundation.IClosable):
    ...
    @typing.overload
    def __new__(cls, connection_id: _uuid.UUID, pdu_forwarder: RemoteTextConnectionDataHandler, options: RemoteTextConnectionOptions) -> typing.Self: ...
    @typing.overload
    def __new__(cls, connection_id: _uuid.UUID, pdu_forwarder: RemoteTextConnectionDataHandler) -> typing.Self: ...
