...
class AccessListEntryView(winrt.system.Object, winrt._winrt.Sequence[AccessListEntry]):
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[AccessListEntry] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def index_of(self, value: AccessListEntry | tuple[str, str], /) -> tuple[bool, winrt.system.UInt32]: ...
...
class StorageItemMostRecentlyUsedList(winrt.system.Object, IStorageItemAccessList):
    ...
    def remove_item_removed(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
