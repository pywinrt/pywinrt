        ...
        auto Add(winrt::Windows::Storage::IStorageItem const& param0)
        {
            try
            {
                ...
                if (!method)
                {
                    ...
                    PyErr_Clear();
                    method.attach(PyObject_GetAttrString(self.get(), "add"));
                    if (!method)
                    {
                        throw python_exception();
                    }
        ...
        auto AddOrReplace(winrt::hstring const& param0, winrt::Windows::Storage::IStorageItem const& param1)
        {
            try
            {
                ...
                if (!method)
                {
                    ...
                    PyErr_Clear();
                    method.attach(PyObject_GetAttrString(self.get(), "add_or_replace"));
                    if (!method)
                    {
                        throw python_exception();
                    }
        ...
        auto GetFileAsync(winrt::hstring const& param0, winrt::Windows::Storage::AccessCache::AccessCacheOptions param1)
        {
            try
            {
                ...
                if (!method)
                {
                    ...
                    PyErr_Clear();
                    method.attach(PyObject_GetAttrString(self.get(), "get_file_async"));
                    if (!method)
                    {
                        throw python_exception();
                    }
        ...
        auto GetFolderAsync(winrt::hstring const& param0, winrt::Windows::Storage::AccessCache::AccessCacheOptions param1)
        {
            try
            {
                ...
                if (!method)
                {
                    ...
                    PyErr_Clear();
                    method.attach(PyObject_GetAttrString(self.get(), "get_folder_async"));
                    if (!method)
                    {
                        throw python_exception();
                    }
        ...
        auto GetItemAsync(winrt::hstring const& param0, winrt::Windows::Storage::AccessCache::AccessCacheOptions param1)
        {
            try
            {
                ...
                if (!method)
                {
                    ...
                    PyErr_Clear();
                    method.attach(PyObject_GetAttrString(self.get(), "get_item_async"));
                    if (!method)
                    {
                        throw python_exception();
                    }
