...
class HandMeshVertex:
    ...
    def __new__(cls, position: windows_foundation_numerics.Vector3 = ..., normal: windows_foundation_numerics.Vector3 = ...) -> HandMeshVertex: ...
...
class JointPose:
    ...
    def __new__(cls, orientation: windows_foundation_numerics.Quaternion = ..., position: windows_foundation_numerics.Vector3 = ..., radius: winrt.system.Single = 0, accuracy: JointPoseAccuracy = ...) -> JointPose: ...
...
class HandPose(winrt.system.Object):
    ...
    def get_relative_joints(self, joints: winrt.system.Array[HandJointKind] | winrt.system.ReadableBuffer, reference_joints: winrt.system.Array[HandJointKind] | winrt.system.ReadableBuffer, joint_poses: winrt.system.Array[JointPose] | winrt.system.WriteableBuffer, /) -> None: ...
    ...
    def try_get_joint(self, coordinate_system: windows_perception_spatial.SpatialCoordinateSystem, joint: HandJointKind, /) -> tuple[bool, JointPose]: ...
    ...
    def try_get_joints(self, coordinate_system: windows_perception_spatial.SpatialCoordinateSystem, joints: winrt.system.Array[HandJointKind] | winrt.system.ReadableBuffer, joint_poses: winrt.system.Array[JointPose] | winrt.system.WriteableBuffer, /) -> bool: ...
