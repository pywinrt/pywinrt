...
class BarcodeScannerFrameReader(winrt.system.Object, windows_foundation.IClosable):
    ...
    def remove_frame_arrived(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class BarcodeScannerProviderConnection(winrt.system.Object, windows_foundation.IClosable):
    ...
    def create_frame_reader_async(self, preferred_format: windows_graphics_imaging.BitmapPixelFormat, preferred_size: windows_graphics_imaging.BitmapSize | tuple[winrt.system.UInt32, winrt.system.UInt32], /) -> windows_foundation.IAsyncOperation[BarcodeScannerFrameReader]: ...
    ...
    def create_frame_reader_with_format_and_size_async(self, preferred_format: windows_graphics_imaging.BitmapPixelFormat, preferred_size: windows_graphics_imaging.BitmapSize | tuple[winrt.system.UInt32, winrt.system.UInt32], /) -> windows_foundation.IAsyncOperation[BarcodeScannerFrameReader]: ...
    # Deprecated alias of create_frame_reader_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.PointOfService.Provider.BarcodeScannerFrameReader> Windows.Devices.PointOfService.Provider.BarcodeScannerProviderConnection::CreateFrameReaderAsync(Windows.Graphics.Imaging.BitmapPixelFormat)
    @deprecated("Use create_frame_reader_async() instead.")
    ...
    def remove_disable_scanner_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_enable_scanner_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_get_barcode_symbology_attributes_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_hide_video_preview_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_set_active_symbologies_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_set_barcode_symbology_attributes_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_start_software_trigger_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_stop_software_trigger_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def supported_symbologies(self) -> _cabc.MutableSequence[winrt.system.UInt32]: ...
...
class BarcodeScannerSetActiveSymbologiesRequest(winrt.system.Object):
    ...
    @_property
    def symbologies(self) -> _cabc.Sequence[winrt.system.UInt32]: ...
