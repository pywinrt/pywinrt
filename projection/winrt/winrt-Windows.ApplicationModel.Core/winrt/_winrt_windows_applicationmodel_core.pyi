...
class CoreApplication_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_unhandled_error_detected(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_exiting(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def views(cls) -> _cabc.Sequence[CoreApplicationView]: ...
...
class CoreApplicationView(winrt.system.Object):
    ...
    def remove_hosted_view_closing(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class CoreApplicationViewTitleBar(winrt.system.Object):
    ...
    def remove_is_visible_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_layout_metrics_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ICoreApplicationUnhandledError(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def remove_unhandled_error_detected(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
