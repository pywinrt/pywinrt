...
namespace py::cpp::Windows::ApplicationModel::UserDataTasks
{
    ...
    static PyObject* UserDataTaskManager_GetDefault(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.ApplicationModel.UserDataTasks.UserDataTaskManager", "GetDefault", nullptr, py::site_is_static};
    ...
    static PyObject* UserDataTaskManager_GetForUser(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.UserDataTasks.UserDataTaskManager", "GetForUser", nullptr, py::site_is_static};
