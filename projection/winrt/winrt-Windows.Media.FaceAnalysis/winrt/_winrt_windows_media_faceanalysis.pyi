...
class FaceDetector_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_supported_bitmap_pixel_formats(cls) -> _cabc.Sequence[windows_graphics_imaging.BitmapPixelFormat]: ...
...
class FaceDetector(winrt.system.Object, metaclass=FaceDetector_Static):
    ...
    def detect_faces_async(self, image: windows_graphics_imaging.SoftwareBitmap, search_area: windows_graphics_imaging.BitmapBounds | tuple[winrt.system.UInt32, winrt.system.UInt32, winrt.system.UInt32, winrt.system.UInt32], /) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[DetectedFace]]: ...
    # Deprecated alias of detect_faces_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVector`1<Windows.Media.FaceAnalysis.DetectedFace>> Windows.Media.FaceAnalysis.FaceDetector::DetectFacesAsync(Windows.Graphics.Imaging.SoftwareBitmap,Windows.Graphics.Imaging.BitmapBounds)
    @deprecated("Use detect_faces_async() instead.")
    def detect_faces_with_search_area_async(self, image: windows_graphics_imaging.SoftwareBitmap, search_area: windows_graphics_imaging.BitmapBounds | tuple[winrt.system.UInt32, winrt.system.UInt32, winrt.system.UInt32, winrt.system.UInt32], /) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[DetectedFace]]: ...
    ...
    def min_detectable_face_size(self, value: windows_graphics_imaging.BitmapSize | tuple[winrt.system.UInt32, winrt.system.UInt32]) -> None: ...
