...
namespace py::cpp::Windows::ApplicationModel::Holographic
{
    ...
    static PyObject* HolographicKeyboard_GetDefault(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.ApplicationModel.Holographic.HolographicKeyboard", "GetDefault", nullptr, py::site_is_static};
