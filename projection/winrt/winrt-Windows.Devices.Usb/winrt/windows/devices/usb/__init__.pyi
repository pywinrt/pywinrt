...
class UsbConfiguration(winrt.system.Object):
    ...
    @_property
    def descriptors(self) -> _cabc.Sequence[UsbDescriptor]: ...
    ...
    @_property
    def usb_interfaces(self) -> _cabc.Sequence[UsbInterface]: ...
...
class UsbConfigurationDescriptor_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_parse(cls, descriptor: UsbDescriptor, /) -> tuple[bool, UsbConfigurationDescriptor]: ...
...
class UsbDeviceClass(winrt.system.Object):
    ...
    def subclass_code(self, value: winrt.system.UInt8 | None) -> None: ...
    # Windows.Foundation.IReference`1<System.Byte> Windows.Devices.Usb.UsbDeviceClass::get_ProtocolCode()
    @_property
    def protocol_code(self) -> winrt.system.UInt8 | None: ...
    ...
    def protocol_code(self, value: winrt.system.UInt8 | None) -> None: ...
...
class UsbEndpointDescriptor_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_parse(cls, descriptor: UsbDescriptor, /) -> tuple[bool, UsbEndpointDescriptor]: ...
...
class UsbInterface(winrt.system.Object):
    ...
    @_property
    def bulk_out_pipes(self) -> _cabc.Sequence[UsbBulkOutPipe]: ...
    ...
    @_property
    def interface_settings(self) -> _cabc.Sequence[UsbInterfaceSetting]: ...
    ...
    @_property
    def interrupt_in_pipes(self) -> _cabc.Sequence[UsbInterruptInPipe]: ...
    ...
    @_property
    def interrupt_out_pipes(self) -> _cabc.Sequence[UsbInterruptOutPipe]: ...
...
class UsbInterfaceDescriptor_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_parse(cls, descriptor: UsbDescriptor, /) -> tuple[bool, UsbInterfaceDescriptor]: ...
...
class UsbInterfaceSetting(winrt.system.Object):
    ...
    @_property
    def bulk_in_endpoints(self) -> _cabc.Sequence[UsbBulkInEndpointDescriptor]: ...
    ...
    @_property
    def bulk_out_endpoints(self) -> _cabc.Sequence[UsbBulkOutEndpointDescriptor]: ...
    ...
    @_property
    def interrupt_in_endpoints(self) -> _cabc.Sequence[UsbInterruptInEndpointDescriptor]: ...
    ...
    @_property
    def interrupt_out_endpoints(self) -> _cabc.Sequence[UsbInterruptOutEndpointDescriptor]: ...
