...
class FileOpenPickerUI(winrt.system.Object):
    ...
    @_property
    def allowed_file_types(self) -> _cabc.Sequence[str]: ...
...
class FileSavePickerUI(winrt.system.Object):
    ...
    def remove_file_name_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_target_file_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
