...
namespace py::cpp::Windows::Devices::Printers::Extensions
{
    ...
    static PyObject* PrintExtensionContext_FromDeviceId(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Printers.Extensions.PrintExtensionContext", "FromDeviceId", nullptr, py::site_is_static};
