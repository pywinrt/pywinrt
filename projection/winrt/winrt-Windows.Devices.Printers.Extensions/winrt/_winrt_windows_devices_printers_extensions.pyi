...
class Print3DWorkflow(winrt.system.Object):
    ...
    def remove_print_requested(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_printer_changed(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PrintTaskConfiguration(winrt.system.Object):
    ...
    def remove_save_requested(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
