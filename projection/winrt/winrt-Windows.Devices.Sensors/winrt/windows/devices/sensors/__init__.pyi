...
class Accelerometer(winrt.system.Object, metaclass=Accelerometer_Static):
    ...
    def remove_shaken(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ActivitySensor_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_system_history_async(cls, from_time: datetime.datetime, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[ActivitySensorReading]]: ...
    @typing.overload
    ...
    def get_system_history_async(cls, from_time: datetime.datetime, duration: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[ActivitySensorReading]]: ...
    ...
    def get_system_history_with_duration_async(cls, from_time: datetime.datetime, duration: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[ActivitySensorReading]]: ...
...
class ActivitySensor(winrt.system.Object, metaclass=ActivitySensor_Static):
    ...
    @_property
    def subscribed_activities(self) -> _cabc.MutableSequence[ActivityType]: ...
    ...
    @_property
    def supported_activities(self) -> _cabc.Sequence[ActivityType]: ...
...
class CompassReading(winrt.system.Object):
    ...
    @_property
    def heading_true_north(self) -> winrt.system.Double | None: ...
...
class HeadPosition(winrt.system.Object):
    ...
    @_property
    def azimuth_in_degrees(self) -> winrt.system.Double | None: ...
...
class HumanPresenceFeatures(winrt.system.Object):
    ...
    @_property
    def supported_wake_or_lock_distances_in_millimeters(self) -> _cabc.Sequence[winrt.system.UInt32]: ...
...
class HumanPresenceSensor(winrt.system.Object, metaclass=HumanPresenceSensor_Static):
    ...
    @_property
    def max_detectable_distance_in_millimeters(self) -> winrt.system.UInt32 | None: ...
    ...
    @_property
    def min_detectable_distance_in_millimeters(self) -> winrt.system.UInt32 | None: ...
    ...
    @_property
    def max_detectable_altitude_in_degrees(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def max_detectable_azimuth_in_degrees(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def min_detectable_altitude_in_degrees(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def min_detectable_azimuth_in_degrees(self) -> winrt.system.Double | None: ...
...
class HumanPresenceSensorReading(winrt.system.Object):
    ...
    @_property
    def detected_persons(self) -> _cabc.Sequence[DetectedPerson]: ...
...
class HumanPresenceSensorReadingUpdate(winrt.system.Object):
    ...
    @_property
    def presence(self) -> HumanPresence | None: ...
    ...
    @presence.setter
    def presence(self, value: HumanPresence | None) -> None: ...
    ...
    @_property
    def engagement(self) -> HumanEngagement | None: ...
    ...
    @engagement.setter
    def engagement(self, value: HumanEngagement | None) -> None: ...
    ...
    def distance_in_millimeters(self, value: winrt.system.UInt32 | None) -> None: ...
    ...
    @_property
    def onlooker_presence(self) -> HumanPresence | None: ...
...
class HumanPresenceSettings_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_supported_lock_on_leave_timeouts(cls) -> _cabc.Sequence[datetime.timedelta]: ...
    ...
    def remove_settings_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class HumanPresenceSettings(winrt.system.Object, metaclass=HumanPresenceSettings_Static):
    ...
    def wake_on_approach_distance_in_millimeters(self, value: winrt.system.UInt32 | None) -> None: ...
    ...
    @_property
    def lock_on_leave_distance_in_millimeters(self) -> winrt.system.UInt32 | None: ...
    ...
    def lock_on_leave_distance_in_millimeters(self, value: winrt.system.UInt32 | None) -> None: ...
...
class LightSensorDataThreshold(winrt.system.Object):
    ...
    @chromaticity.setter
    def chromaticity(self, value: LightSensorChromaticity | tuple[winrt.system.Double, winrt.system.Double]) -> None: ...
...
class Pedometer_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_readings_from_trigger_details(cls, trigger_details: SensorDataThresholdTriggerDetails, /) -> _cabc.Sequence[PedometerReading]: ...
    @typing.overload
    ...
    def get_system_history_async(cls, from_time: datetime.datetime, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[PedometerReading]]: ...
    @typing.overload
    ...
    def get_system_history_async(cls, from_time: datetime.datetime, duration: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[PedometerReading]]: ...
    # Deprecated alias of get_system_history_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Devices.Sensors.PedometerReading>> Windows.Devices.Sensors.Pedometer::GetSystemHistoryAsync(Windows.Foundation.DateTime,Windows.Foundation.TimeSpan)
    @deprecated("Use get_system_history_async() instead.")
    def get_system_history_with_duration_async(cls, from_time: datetime.datetime, duration: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[PedometerReading]]: ...
...
class ProximitySensor_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_readings_from_trigger_details(cls, trigger_details: SensorDataThresholdTriggerDetails, /) -> _cabc.Sequence[ProximitySensorReading]: ...
...
class ProximitySensor(winrt.system.Object, metaclass=ProximitySensor_Static):
    ...
    @_property
    def max_distance_in_millimeters(self) -> winrt.system.UInt32 | None: ...
