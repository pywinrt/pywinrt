...
class BackgroundAudioTrack(winrt.system.Object, metaclass=BackgroundAudioTrack_Static):
    ...
    @_property
    def user_data(self) -> _cabc.MutableMapping[str, str]: ...
...
class MediaClip(winrt.system.Object, metaclass=MediaClip_Static):
    ...
    @_property
    def embedded_audio_tracks(self) -> _cabc.Sequence[EmbeddedAudioTrack]: ...
    ...
    @_property
    def video_effect_definitions(self) -> _cabc.MutableSequence[windows_media_effects.IVideoEffectDefinition]: ...
...
class MediaComposition(winrt.system.Object, metaclass=MediaComposition_Static):
    ...
    def generate_media_stream_source(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, /) -> windows_media_core.MediaStreamSource: ...
    # Deprecated alias of generate_media_stream_source() for pywinrt v3.x compatibility.
    # Windows.Media.Core.MediaStreamSource Windows.Media.Editing.MediaComposition::GenerateMediaStreamSource(Windows.Media.MediaProperties.MediaEncodingProfile)
    @deprecated("Use generate_media_stream_source() instead.")
    ...
    def get_thumbnails_async(self, times_from_start: _cabc.Iterable[datetime.timedelta], scaled_width: winrt.system.Int32, scaled_height: winrt.system.Int32, frame_precision: VideoFramePrecision, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_graphics_imaging.ImageStream]]: ...
    @typing.overload
    ...
    def render_to_file_async(self, destination: windows_storage.IStorageFile, trimming_preference: MediaTrimmingPreference, /) -> windows_foundation.IAsyncOperationWithProgress[windows_media_transcoding.TranscodeFailureReason, winrt.system.Double]: ...
    @typing.overload
    ...
    def render_to_file_async(self, destination: windows_storage.IStorageFile, trimming_preference: MediaTrimmingPreference, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, /) -> windows_foundation.IAsyncOperationWithProgress[windows_media_transcoding.TranscodeFailureReason, winrt.system.Double]: ...
    # Deprecated alias of render_to_file_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperationWithProgress`2<Windows.Media.Transcoding.TranscodeFailureReason,System.Double> Windows.Media.Editing.MediaComposition::RenderToFileAsync(Windows.Storage.IStorageFile,Windows.Media.Editing.MediaTrimmingPreference,Windows.Media.MediaProperties.MediaEncodingProfile)
    @deprecated("Use render_to_file_async() instead.")
    ...
    @_property
    def background_audio_tracks(self) -> _cabc.MutableSequence[BackgroundAudioTrack]: ...
    ...
    @_property
    def clips(self) -> _cabc.MutableSequence[MediaClip]: ...
    ...
    @_property
    def overlay_layers(self) -> _cabc.MutableSequence[MediaOverlayLayer]: ...

@typing.final
class MediaOverlay(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], clip: MediaClip) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], clip: MediaClip, position: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], opacity: winrt.system.Double) -> Self: ...
    ...
    @position.setter
    def position(self, value: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single]) -> None: ...
...
class MediaOverlayLayer(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], compositor_definition: windows_media_effects.IVideoCompositorDefinition) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
    ...
    @_property
    def overlays(self) -> _cabc.MutableSequence[MediaOverlay]: ...
