...
class MediaOverlay(winrt.system.Object):
    @typing.overload
    def __new__(cls, clip: MediaClip) -> typing.Self: ...
    @typing.overload
    def __new__(cls, clip: MediaClip, position: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], opacity: winrt.system.Double) -> typing.Self: ...
...
class MediaOverlayLayer(winrt.system.Object):
    @typing.overload
    def __new__(cls, compositor_definition: windows_media_effects.IVideoCompositorDefinition) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
