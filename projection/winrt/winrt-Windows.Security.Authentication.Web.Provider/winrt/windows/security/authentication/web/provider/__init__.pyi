...
class WebAccountManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def add_web_account_async(cls, web_account_id: str, web_account_user_name: str, props: _cabc.Mapping[str, str], scope: WebAccountScope, /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccount]: ...
    @typing.overload
    # Windows.Foundation.IAsyncOperation`1<Windows.Security.Credentials.WebAccount> Windows.Security.Authentication.Web.Provider.WebAccountManager::AddWebAccountAsync(System.String,System.String,Windows.Foundation.Collections.IMapView`2<System.String,System.String>,Windows.Security.Authentication.Web.Provider.WebAccountScope,System.String)
    def add_web_account_async(cls, web_account_id: str, web_account_user_name: str, props: _cabc.Mapping[str, str], scope: WebAccountScope, per_user_web_account_id: str, /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccount]: ...
    # Deprecated alias of add_web_account_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Security.Credentials.WebAccount> Windows.Security.Authentication.Web.Provider.WebAccountManager::AddWebAccountAsync(System.String,System.String,Windows.Foundation.Collections.IMapView`2<System.String,System.String>,Windows.Security.Authentication.Web.Provider.WebAccountScope,System.String)
    @deprecated("Use add_web_account_async() instead.")
    def add_web_account_with_scope_and_map_async(cls, web_account_id: str, web_account_user_name: str, props: _cabc.Mapping[str, str], scope: WebAccountScope, per_user_web_account_id: str, /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccount]: ...
    # Deprecated alias of add_web_account_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Security.Credentials.WebAccount> Windows.Security.Authentication.Web.Provider.WebAccountManager::AddWebAccountAsync(System.String,System.String,Windows.Foundation.Collections.IMapView`2<System.String,System.String>,Windows.Security.Authentication.Web.Provider.WebAccountScope)
    @deprecated("Use add_web_account_async() instead.")
    def add_web_account_with_scope_async(cls, web_account_id: str, web_account_user_name: str, props: _cabc.Mapping[str, str], scope: WebAccountScope, /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccount]: ...
    @typing.overload
    ...
    def add_web_account_for_user_async(cls, user: windows_system.User, web_account_id: str, web_account_user_name: str, props: _cabc.Mapping[str, str], /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccount]: ...
    @typing.overload
    ...
    def add_web_account_for_user_async(cls, user: windows_system.User, web_account_id: str, web_account_user_name: str, props: _cabc.Mapping[str, str], scope: WebAccountScope, /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccount]: ...
    @typing.overload
    # Windows.Foundation.IAsyncOperation`1<Windows.Security.Credentials.WebAccount> Windows.Security.Authentication.Web.Provider.WebAccountManager::AddWebAccountForUserAsync(Windows.System.User,System.String,System.String,Windows.Foundation.Collections.IMapView`2<System.String,System.String>,Windows.Security.Authentication.Web.Provider.WebAccountScope,System.String)
    def add_web_account_for_user_async(cls, user: windows_system.User, web_account_id: str, web_account_user_name: str, props: _cabc.Mapping[str, str], scope: WebAccountScope, per_user_web_account_id: str, /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccount]: ...
    ...
    def add_web_account_with_scope_and_map_for_user_async(cls, user: windows_system.User, web_account_id: str, web_account_user_name: str, props: _cabc.Mapping[str, str], scope: WebAccountScope, per_user_web_account_id: str, /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccount]: ...
    # Deprecated alias of add_web_account_for_user_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Security.Credentials.WebAccount> Windows.Security.Authentication.Web.Provider.WebAccountManager::AddWebAccountForUserAsync(Windows.System.User,System.String,System.String,Windows.Foundation.Collections.IMapView`2<System.String,System.String>,Windows.Security.Authentication.Web.Provider.WebAccountScope)
    @deprecated("Use add_web_account_for_user_async() instead.")
    def add_web_account_with_scope_for_user_async(cls, user: windows_system.User, web_account_id: str, web_account_user_name: str, props: _cabc.Mapping[str, str], scope: WebAccountScope, /) -> windows_foundation.IAsyncOperation[windows_security_credentials.WebAccount]: ...
    ...
    def find_all_provider_web_accounts_async(cls) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_security_credentials.WebAccount]]: ...
    ...
    def find_all_provider_web_accounts_for_user_async(cls, user: windows_system.User, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_security_credentials.WebAccount]]: ...
    ...
    def get_views_async(cls, web_account: windows_security_credentials.WebAccount, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[WebAccountClientView]]: ...
    ...
    def push_cookies_async(cls, uri: windows_foundation.Uri, cookies: _cabc.Sequence[windows_web_http.HttpCookie], /) -> windows_foundation.IAsyncAction: ...
    ...
    def update_web_account_properties_async(cls, web_account: windows_security_credentials.WebAccount, web_account_user_name: str, additional_properties: _cabc.Mapping[str, str], /) -> windows_foundation.IAsyncAction: ...
...
class WebProviderTokenRequest(winrt.system.Object):
    ...
    @_property
    def web_accounts(self) -> _cabc.Sequence[windows_security_credentials.WebAccount]: ...
