...
namespace py::cpp::Windows::Devices::WiFiDirect
{
    ...
    static PyObject* WiFiDirectAdvertisement_get_SupportedConfigurationMethods(py::wrapper::Windows::Devices::WiFiDirect::WiFiDirectAdvertisement* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::Devices::WiFiDirect::IWiFiDirectAdvertisement2>(self->obj, py::member_kind::property, "Windows.Devices.WiFiDirect.WiFiDirectAdvertisement", "SupportedConfigurationMethods", "Windows.Devices.WiFiDirect.IWiFiDirectAdvertisement2").SupportedConfigurationMethods();
            }());
        }
        catch (...)
        {
    ...
    static PyObject* WiFiDirectConnectionParameters_get_PreferredPairingProcedure(py::wrapper::Windows::Devices::WiFiDirect::WiFiDirectConnectionParameters* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::Devices::WiFiDirect::IWiFiDirectConnectionParameters2>(self->obj, py::member_kind::property, "Windows.Devices.WiFiDirect.WiFiDirectConnectionParameters", "PreferredPairingProcedure", "Windows.Devices.WiFiDirect.IWiFiDirectConnectionParameters2").PreferredPairingProcedure();
            }());
        }
        catch (...)
        {
    ...
    static int WiFiDirectConnectionParameters_put_PreferredPairingProcedure(py::wrapper::Windows::Devices::WiFiDirect::WiFiDirectConnectionParameters* self, PyObject* arg, void* /*unused*/) noexcept
    {
        ...
        try
        {
            ...
            {
                auto _gil = release_gil();
                py::require<winrt::Windows::Devices::WiFiDirect::IWiFiDirectConnectionParameters2>(self->obj, py::member_kind::property, "Windows.Devices.WiFiDirect.WiFiDirectConnectionParameters", "PreferredPairingProcedure", "Windows.Devices.WiFiDirect.IWiFiDirectConnectionParameters2").PreferredPairingProcedure(param0);
            }
    ...
    static PyObject* WiFiDirectConnectionParameters_get_PreferenceOrderedConfigurationMethods(py::wrapper::Windows::Devices::WiFiDirect::WiFiDirectConnectionParameters* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::Devices::WiFiDirect::IWiFiDirectConnectionParameters2>(self->obj, py::member_kind::property, "Windows.Devices.WiFiDirect.WiFiDirectConnectionParameters", "PreferenceOrderedConfigurationMethods", "Windows.Devices.WiFiDirect.IWiFiDirectConnectionParameters2").PreferenceOrderedConfigurationMethods();
            }());
        }
        catch (...)
        {
    ...
    static PyObject* WiFiDirectConnectionRequest_Close(py::wrapper::Windows::Devices::WiFiDirect::WiFiDirectConnectionRequest* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Windows.Devices.WiFiDirect.WiFiDirectConnectionRequest", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
    ...
    static PyObject* WiFiDirectDevice_Close(py::wrapper::Windows::Devices::WiFiDirect::WiFiDirectDevice* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Windows.Devices.WiFiDirect.WiFiDirectDevice", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
