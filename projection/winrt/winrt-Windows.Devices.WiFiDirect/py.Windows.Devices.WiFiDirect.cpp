...
namespace py::cpp::Windows::Devices::WiFiDirect
{
    ...
    static PyObject* WiFiDirectConnectionParameters_GetDevicePairingKinds(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.WiFiDirect.WiFiDirectConnectionParameters", "GetDevicePairingKinds", nullptr, py::site_is_static};
    ...
    static PyObject* WiFiDirectDevice_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.WiFiDirect.WiFiDirectDevice", "FromIdAsync", nullptr, py::site_is_static};
        ...
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Devices.WiFiDirect.WiFiDirectDevice", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* WiFiDirectDevice_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.WiFiDirect.WiFiDirectDevice", "GetDeviceSelector", nullptr, py::site_is_static};
        ...
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.WiFiDirect.WiFiDirectDevice", "GetDeviceSelector", nullptr, py::site_is_static};
    ...
    static PyObject* WiFiDirectInformationElement_CreateFromBuffer(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.WiFiDirect.WiFiDirectInformationElement", "CreateFromBuffer", nullptr, py::site_is_static};
    ...
    static PyObject* WiFiDirectInformationElement_CreateFromDeviceInformation(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.WiFiDirect.WiFiDirectInformationElement", "CreateFromDeviceInformation", nullptr, py::site_is_static};
