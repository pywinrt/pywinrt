...
class WiFiDirectAdvertisement(winrt.system.Object):
    ...
    @_property
    def information_elements(self) -> _cabc.MutableSequence[WiFiDirectInformationElement]: ...
    ...
    def information_elements(self, value: _cabc.MutableSequence[WiFiDirectInformationElement]) -> None: ...
    ...
    @_property
    def supported_configuration_methods(self) -> _cabc.MutableSequence[WiFiDirectConfigurationMethod]: ...
...
class WiFiDirectDevice(winrt.system.Object, windows_foundation.IClosable, metaclass=WiFiDirectDevice_Static):
    ...
    def remove_connection_status_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class WiFiDirectInformationElement_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_from_buffer(cls, buffer: winrt.system.Buffer, /) -> _cabc.MutableSequence[WiFiDirectInformationElement]: ...
    ...
    def create_from_device_information(cls, device_information: windows_devices_enumeration.DeviceInformation, /) -> _cabc.MutableSequence[WiFiDirectInformationElement]: ...
