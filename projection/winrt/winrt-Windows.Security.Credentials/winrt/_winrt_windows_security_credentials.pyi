...
class PasswordCredential(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], resource: str, user_name: str, password: str) -> Self: ...
    @typing.overload
...
class WebAccount(winrt.system.Object, IWebAccount):
    def __new__(cls: type[Self], web_account_provider: WebAccountProvider, user_name: str, state: WebAccountState) -> Self: ...
...
class WebAccountProvider(winrt.system.Object):
    def __new__(cls: type[Self], id: str, display_name: str, icon_uri: windows_foundation.Uri) -> Self: ...
