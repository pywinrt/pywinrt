...
namespace py::cpp::Windows::Security::Credentials
{
    ...
    static PyObject* KeyCredentialManager_DeleteAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Security.Credentials.KeyCredentialManager", "DeleteAsync", nullptr, py::site_is_static};
    ...
    static PyObject* KeyCredentialManager_IsSupportedAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Security.Credentials.KeyCredentialManager", "IsSupportedAsync", nullptr, py::site_is_static};
    ...
    static PyObject* KeyCredentialManager_OpenAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Security.Credentials.KeyCredentialManager", "OpenAsync", nullptr, py::site_is_static};
    ...
    static PyObject* KeyCredentialManager_RenewAttestationAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Security.Credentials.KeyCredentialManager", "RenewAttestationAsync", nullptr, py::site_is_static};
    ...
    static PyObject* KeyCredentialManager_RequestCreateAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Security.Credentials.KeyCredentialManager", "RequestCreateAsync", nullptr, py::site_is_static};
