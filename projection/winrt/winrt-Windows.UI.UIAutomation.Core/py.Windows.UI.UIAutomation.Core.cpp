    ...
    static PyObject* CoreAutomationRemoteOperation_ImportConnectionBoundObject(py::wrapper::Windows::UI::UIAutomation::Core::CoreAutomationRemoteOperation* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            try
            {
                ...
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::UI::UIAutomation::Core::ICoreAutomationRemoteOperation2>(self->obj, py::member_kind::method, "Windows.UI.UIAutomation.Core.CoreAutomationRemoteOperation", "ImportConnectionBoundObject", "Windows.UI.UIAutomation.Core.ICoreAutomationRemoteOperation2", 2).ImportConnectionBoundObject(param0, param1);
                }
