...
class AutomationRemoteOperationResult(winrt.system.Object):
    ...
    def has_operand(self, operand_id: AutomationRemoteOperationOperandId | tuple[winrt.system.Int32], /) -> bool: ...
...
class CoreAutomationRegistrar_Static(winrt._winrt.IInspectable_Static):
    ...
    def unregister_annotation_type(cls, registration: AutomationAnnotationTypeRegistration | tuple[winrt.system.Int32], /) -> None: ...
...
class CoreAutomationRemoteOperation(winrt.system.Object):
    ...
    def execute(self, bytecode_buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> AutomationRemoteOperationResult: ...
    ...
    def import_connection_bound_object(self, operand_id: AutomationRemoteOperationOperandId | tuple[winrt.system.Int32], connection_bound_object: windows_ui_uiautomation.AutomationConnectionBoundObject, /) -> None: ...
    ...
    def import_element(self, operand_id: AutomationRemoteOperationOperandId | tuple[winrt.system.Int32], element: windows_ui_uiautomation.AutomationElement, /) -> None: ...
    ...
    def import_text_range(self, operand_id: AutomationRemoteOperationOperandId | tuple[winrt.system.Int32], text_range: windows_ui_uiautomation.AutomationTextRange, /) -> None: ...
...
class CoreAutomationRemoteOperationContext(winrt.system.Object):
    ...
    def set_operand(self, id: AutomationRemoteOperationOperandId | tuple[winrt.system.Int32], operand: winrt.system.Object, /) -> None: ...
    @typing.overload
    ...
    def set_operand(self, id: AutomationRemoteOperationOperandId | tuple[winrt.system.Int32], operand: winrt.system.Object, operand_interface_id: _uuid.UUID, /) -> None: ...
    # Deprecated alias of set_operand() for pywinrt v3.x compatibility.
    # System.Void Windows.UI.UIAutomation.Core.CoreAutomationRemoteOperationContext::SetOperand(Windows.UI.UIAutomation.Core.AutomationRemoteOperationOperandId,System.Object,System.Guid)
    @deprecated("Use set_operand() instead.")
    def set_operand2(self, id: AutomationRemoteOperationOperandId | tuple[winrt.system.Int32], operand: winrt.system.Object, operand_interface_id: _uuid.UUID, /) -> None: ...
...
class RemoteAutomationClientSession(winrt.system.Object):
    ...
    def remove_connection_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
