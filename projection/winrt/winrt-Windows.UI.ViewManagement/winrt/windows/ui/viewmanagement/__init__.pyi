...
class AccessibilitySettings(winrt.system.Object):
    ...
    def remove_high_contrast_changed(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ApplicationView_Static(winrt._winrt.IInspectable_Static):
    ...
    def preferred_launch_view_size(cls, value: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
...
class ApplicationView(winrt.system.Object, metaclass=ApplicationView_Static):
    ...
    def get_display_regions(self) -> _cabc.Sequence[windows_ui_windowmanagement.DisplayRegion]: ...
    ...
    def set_preferred_min_size(self, min_size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
    ...
    def try_resize_view(self, value: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> bool: ...
    ...
    def remove_consolidated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_visible_bounds_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ApplicationViewTitleBar(winrt.system.Object):
    ...
    def inactive_foreground_color(self, value: windows_ui.Color | None) -> None: ...
    ...
    @_property
    def inactive_background_color(self) -> windows_ui.Color | None: ...
    ...
    def foreground_color(self, value: windows_ui.Color | None) -> None: ...
    ...
    @_property
    def button_pressed_foreground_color(self) -> windows_ui.Color | None: ...
    ...
    def button_pressed_foreground_color(self, value: windows_ui.Color | None) -> None: ...
    ...
    @_property
    def button_pressed_background_color(self) -> windows_ui.Color | None: ...
    ...
    def button_pressed_background_color(self, value: windows_ui.Color | None) -> None: ...
    ...
    @_property
    def button_inactive_foreground_color(self) -> windows_ui.Color | None: ...
    ...
    def button_inactive_foreground_color(self, value: windows_ui.Color | None) -> None: ...
    ...
    @_property
    def button_inactive_background_color(self) -> windows_ui.Color | None: ...
    ...
    def button_inactive_background_color(self, value: windows_ui.Color | None) -> None: ...
    ...
    @_property
    def button_hover_foreground_color(self) -> windows_ui.Color | None: ...
    ...
    def button_hover_foreground_color(self, value: windows_ui.Color | None) -> None: ...
    ...
    @_property
    def button_hover_background_color(self) -> windows_ui.Color | None: ...
    ...
    def button_hover_background_color(self, value: windows_ui.Color | None) -> None: ...
    ...
    @_property
    def button_foreground_color(self) -> windows_ui.Color | None: ...
    ...
    def button_foreground_color(self, value: windows_ui.Color | None) -> None: ...
    ...
    @_property
    def button_background_color(self) -> windows_ui.Color | None: ...
    ...
    def background_color(self, value: windows_ui.Color | None) -> None: ...
...
class InputPane(winrt.system.Object, metaclass=InputPane_Static):
    ...
    def remove_hiding(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_showing(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ProjectionManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def request_start_projecting_async(cls, projection_view_id: winrt.system.Int32, anchor_view_id: winrt.system.Int32, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def request_start_projecting_async(cls, projection_view_id: winrt.system.Int32, anchor_view_id: winrt.system.Int32, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preffered_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def request_start_projecting_with_placement_async(cls, projection_view_id: winrt.system.Int32, anchor_view_id: winrt.system.Int32, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preffered_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def remove_projection_display_available_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class UISettings(winrt.system.Object):
    ...
    def remove_text_scale_factor_changed(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_color_values_changed(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_advanced_effects_enabled_changed(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_auto_hide_scroll_bars_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_animations_enabled_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_message_duration_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class UIViewSettings(winrt.system.Object, metaclass=UIViewSettings_Static):
    ...
    def add_preferred_interaction_mode_changed(self, handler: windows_foundation.TypedEventHandler[UIViewSettings, winrt.system.Object], /) -> windows_foundation.EventRegistrationToken: ...
    # System.Void Windows.UI.ViewManagement.UIViewSettings::remove_PreferredInteractionModeChanged(Windows.Foundation.EventRegistrationToken)
    def remove_preferred_interaction_mode_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ViewModePreferences(winrt.system.Object, metaclass=ViewModePreferences_Static):
    ...
    @custom_size.setter
    def custom_size(self, value: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
