...
class ResourceCollection(winrt.system.Object, windows_web_syndication.ISyndicationNode):
    ...
    @_property
    def accepts(self) -> _cabc.Sequence[str]: ...
    ...
    @_property
    def categories(self) -> _cabc.Sequence[windows_web_syndication.SyndicationCategory]: ...
    ...
    @_property
    def attribute_extensions(self) -> _cabc.MutableSequence[windows_web_syndication.SyndicationAttribute]: ...
...
class ServiceDocument(winrt.system.Object, windows_web_syndication.ISyndicationNode):
    ...
    @_property
    def workspaces(self) -> _cabc.Sequence[Workspace]: ...
...
class Workspace(winrt.system.Object, windows_web_syndication.ISyndicationNode):
    ...
    @_property
    def collections(self) -> _cabc.Sequence[ResourceCollection]: ...
