...
class GpioChangeCount:
    ...
    def __new__(cls, count: winrt.system.UInt64 = 0, relative_time: datetime.timedelta = ...) -> GpioChangeCount: ...
...
class GpioChangeRecord:
    ...
    def __new__(cls, relative_time: datetime.timedelta = ..., edge: GpioPinEdge = ...) -> GpioChangeRecord: ...
...
class GpioChangeCounter(winrt.system.Object, windows_foundation.IClosable):
    ...
    def __new__(cls, pin: GpioPin) -> typing.Self: ...
...
class GpioChangeReader(winrt.system.Object, windows_foundation.IClosable):
    ...
    def __new__(cls, pin: GpioPin) -> typing.Self: ...
    @typing.overload
    def __new__(cls, pin: GpioPin, min_capacity: winrt.system.Int32) -> typing.Self: ...
