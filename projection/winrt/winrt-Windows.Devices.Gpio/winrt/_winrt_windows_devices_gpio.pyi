...
class GpioChangeCount:
    ...
    def unpack(self) -> tuple[winrt.system.UInt64, datetime.timedelta]: ...
...
class GpioChangeReader(winrt.system.Object, windows_foundation.IClosable):
    ...
    def __new__(cls: type[Self], pin: GpioPin) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], pin: GpioPin, min_capacity: winrt.system.Int32) -> Self: ...
    ...
    def get_all_items(self) -> _cabc.MutableSequence[GpioChangeRecord]: ...
...
class GpioController(winrt.system.Object, metaclass=GpioController_Static):
    ...
    def try_open_pin(self, pin_number: winrt.system.Int32, sharing_mode: GpioSharingMode, /) -> tuple[bool, GpioPin, GpioOpenStatus]: ...
