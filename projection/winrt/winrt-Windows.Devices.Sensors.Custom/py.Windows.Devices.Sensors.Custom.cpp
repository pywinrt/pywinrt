...
namespace py::cpp::Windows::Devices::Sensors::Custom
{
    ...
    static PyObject* CustomSensor_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Sensors.Custom.CustomSensor", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* CustomSensor_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Sensors.Custom.CustomSensor", "GetDeviceSelector", nullptr, py::site_is_static};
