...
class CustomSensor(winrt.system.Object, metaclass=CustomSensor_Static):
    ...
    def remove_reading_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class CustomSensorReading(winrt.system.Object):
    ...
    @_property
    def performance_count(self) -> datetime.timedelta | None: ...
