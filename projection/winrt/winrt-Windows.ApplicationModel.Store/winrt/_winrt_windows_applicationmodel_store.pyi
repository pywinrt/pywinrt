...
class CurrentApp_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_unfulfilled_consumables_async(cls) -> windows_foundation.IAsyncOperation[_cabc.Sequence[UnfulfilledConsumable]]: ...
    ...
    def load_listing_information_by_keywords_async(cls, keywords: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[ListingInformation]: ...
    ...
    def load_listing_information_by_product_ids_async(cls, product_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[ListingInformation]: ...
...
class LicenseInformation(winrt.system.Object):
    ...
    def remove_license_changed(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def product_licenses(self) -> _cabc.Mapping[str, ProductLicense]: ...
...
class ListingInformation(winrt.system.Object):
    ...
    @_property
    def product_listings(self) -> _cabc.Mapping[str, ProductListing]: ...
...
class ProductListing(winrt.system.Object):
    ...
    @_property
    def keywords(self) -> _cabc.Iterable[str]: ...
