...
class RemoteDesktopRegistrar_Static(winrt._winrt.IInspectable_Static):
    ...
    # Windows.Foundation.EventRegistrationToken Windows.System.RemoteDesktop.Provider.RemoteDesktopRegistrar::add_ConnectionCenterRequested(Windows.Foundation.EventHandler`1<System.Object>)
    def add_connection_center_requested(cls, handler: windows_foundation.EventHandler[winrt.system.Object], /) -> windows_foundation.EventRegistrationToken: ...
    # System.Void Windows.System.RemoteDesktop.Provider.RemoteDesktopRegistrar::remove_ConnectionCenterRequested(Windows.Foundation.EventRegistrationToken)
    def remove_connection_center_requested(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
