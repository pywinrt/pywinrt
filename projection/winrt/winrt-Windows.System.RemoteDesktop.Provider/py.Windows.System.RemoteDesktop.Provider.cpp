...
namespace py::cpp::Windows::System::RemoteDesktop::Provider
{
    ...
    static PyObject* RemoteDesktopConnectionInfo_GetForLaunchUri(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.System.RemoteDesktop.Provider.RemoteDesktopConnectionInfo", "GetForLaunchUri", nullptr, py::site_is_static};
    ...
    static PyObject* RemoteDesktopConnectionInfo_PerformLocalActionFromRemote(py::wrapper::Windows::System::RemoteDesktop::Provider::RemoteDesktopConnectionInfo* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            try
            {
                ...
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::System::RemoteDesktop::Provider::IRemoteDesktopConnectionInfo2>(self->obj, py::member_kind::method, "Windows.System.RemoteDesktop.Provider.RemoteDesktopConnectionInfo", "PerformLocalActionFromRemote", "Windows.System.RemoteDesktop.Provider.IRemoteDesktopConnectionInfo2", 1).PerformLocalActionFromRemote(param0);
                }
    ...
    static PyObject* RemoteDesktopConnectionRemoteInfo_Close(py::wrapper::Windows::System::RemoteDesktop::Provider::RemoteDesktopConnectionRemoteInfo* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Windows.System.RemoteDesktop.Provider.RemoteDesktopConnectionRemoteInfo", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
    ...
    static PyObject* RemoteDesktopConnectionRemoteInfo_GetForLaunchUri(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.System.RemoteDesktop.Provider.RemoteDesktopConnectionRemoteInfo", "GetForLaunchUri", nullptr, py::site_is_static};
    ...
    static PyObject* RemoteDesktopConnectionRemoteInfo_IsSwitchSupported(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.System.RemoteDesktop.Provider.RemoteDesktopConnectionRemoteInfo", "IsSwitchSupported", nullptr, py::site_is_static};
    ...
    static PyObject* RemoteDesktopRegistrar_IsSwitchToLocalSessionEnabled(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.System.RemoteDesktop.Provider.RemoteDesktopRegistrar", "IsSwitchToLocalSessionEnabled", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.System.RemoteDesktop.Provider.RemoteDesktopRegistrar", "DesktopInfos", nullptr, py::site_is_static};
