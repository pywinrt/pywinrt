...
class BluetoothDevice_Static(winrt._winrt.IInspectable_Static):
    ...
    def from_bluetooth_address_async(cls, address: winrt.system.UInt64, /) -> windows_foundation.IAsyncOperation[BluetoothDevice | None]: ...
...
class BluetoothDevice(winrt.system.Object, windows_foundation.IClosable, metaclass=BluetoothDevice_Static):
    ...
    def remove_sdp_records_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def sdp_records(self) -> _cabc.Sequence[winrt.system.Buffer]: ...
...
class BluetoothLEDevice_Static(winrt._winrt.IInspectable_Static):
    ...
    def from_bluetooth_address_async(cls, bluetooth_address: winrt.system.UInt64, /) -> windows_foundation.IAsyncOperation[BluetoothLEDevice | None]: ...
    @typing.overload
    ...
    def from_bluetooth_address_async(cls, bluetooth_address: winrt.system.UInt64, bluetooth_address_type: BluetoothAddressType, /) -> windows_foundation.IAsyncOperation[BluetoothLEDevice | None]: ...
    ...
    def from_bluetooth_address_with_bluetooth_address_type_async(cls, bluetooth_address: winrt.system.UInt64, bluetooth_address_type: BluetoothAddressType, /) -> windows_foundation.IAsyncOperation[BluetoothLEDevice | None]: ...
...
class BluetoothLEDevice(winrt.system.Object, windows_foundation.IClosable, metaclass=BluetoothLEDevice_Static):
    ...
    def remove_gatt_services_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_connection_parameters_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_connection_phy_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class BluetoothSignalStrengthFilter(winrt.system.Object):
    ...
    def sampling_interval(self, value: datetime.timedelta | None) -> None: ...
    ...
    @_property
    def out_of_range_timeout(self) -> datetime.timedelta | None: ...
    ...
    def out_of_range_timeout(self, value: datetime.timedelta | None) -> None: ...
    ...
    @_property
    def out_of_range_threshold_in_dbm(self) -> winrt.system.Int16 | None: ...
    ...
    def out_of_range_threshold_in_dbm(self, value: winrt.system.Int16 | None) -> None: ...
    ...
    @_property
    def in_range_threshold_in_dbm(self) -> winrt.system.Int16 | None: ...
    ...
    def in_range_threshold_in_dbm(self, value: winrt.system.Int16 | None) -> None: ...
...
class BluetoothUuidHelper_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_get_short_id(cls, uuid: _uuid.UUID, /) -> winrt.system.UInt32 | None: ...
