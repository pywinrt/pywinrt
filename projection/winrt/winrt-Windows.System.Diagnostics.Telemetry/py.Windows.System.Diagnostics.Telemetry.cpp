...
namespace py::cpp::Windows::System::Diagnostics::Telemetry
{
    ...
    static PyObject* PlatformTelemetryClient_Register(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.System.Diagnostics.Telemetry.PlatformTelemetryClient", "Register", nullptr, py::site_is_static};
        ...
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.System.Diagnostics.Telemetry.PlatformTelemetryClient", "Register", nullptr, py::site_is_static};
