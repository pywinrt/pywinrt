...
class EmailAttachment(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], file_name: str, data: windows_storage_streams.IRandomAccessStreamReference, mime_type: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], file_name: str, data: windows_storage_streams.IRandomAccessStreamReference) -> Self: ...
    @typing.overload
...
class EmailConversation(winrt.system.Object):
    ...
    def find_messages_async(self, count: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[EmailMessage]]: ...
    # Deprecated alias of find_messages_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Email.EmailMessage>> Windows.ApplicationModel.Email.EmailConversation::FindMessagesAsync(System.UInt32)
    @deprecated("Use find_messages_async() instead.")
    def find_messages_with_count_async(self, count: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[EmailMessage]]: ...
...
class EmailFolder(winrt.system.Object):
    ...
    def find_child_folders_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[EmailFolder]]: ...
    @typing.overload
    ...
    def try_move_async(self, new_parent_folder: EmailFolder, new_folder_name: str, /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of try_move_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.ApplicationModel.Email.EmailFolder::TryMoveAsync(Windows.ApplicationModel.Email.EmailFolder,System.String)
    @deprecated("Use try_move_async() instead.")
...
class EmailIrmInfo(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], expiration: datetime.datetime, irm_template: EmailIrmTemplate) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
class EmailIrmTemplate(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], id: str, name: str, description: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
class EmailMailbox(winrt.system.Object):
    ...
    def resolve_recipients_async(self, recipients: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[EmailRecipientResolutionResult]]: ...
    ...
    def send_message_async(self, message: EmailMessage, smart_send: bool, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of send_message_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.ApplicationModel.Email.EmailMailbox::SendMessageAsync(Windows.ApplicationModel.Email.EmailMessage,System.Boolean)
    @deprecated("Use send_message_async() instead.")
    ...
    def try_forward_meeting_async(self, meeting: EmailMessage, recipients: _cabc.Iterable[EmailRecipient], subject: str, forward_header_type: EmailMessageBodyKind, forward_header: str, comment: str, /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def try_move_folder_async(self, folder_id: str, new_parent_folder_id: str, new_folder_name: str, /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of try_move_folder_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.ApplicationModel.Email.EmailMailbox::TryMoveFolderAsync(System.String,System.String,System.String)
    @deprecated("Use try_move_folder_async() instead.")
    ...
    def validate_certificates_async(self, certificates: _cabc.Iterable[windows_security_cryptography_certificates.Certificate], /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[EmailCertificateValidationStatus]]: ...
    ...
    def remove_mailbox_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def mail_address_aliases(self) -> _cabc.MutableSequence[str]: ...
...
class EmailMailboxAutoReplySettings(winrt.system.Object):
    ...
    @start_time.setter
    def start_time(self, value: datetime.datetime | None) -> None: ...
    ...
    @end_time.setter
    def end_time(self, value: datetime.datetime | None) -> None: ...
...
class EmailMailboxChange(winrt.system.Object):
    ...
    @_property
    def mailbox_actions(self) -> _cabc.MutableSequence[EmailMailboxAction]: ...
...
class EmailMailboxChangeReader(winrt.system.Object):
    ...
    def read_batch_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[EmailMailboxChange]]: ...
...
class EmailMailboxPolicies(winrt.system.Object):
    ...
    def required_smime_signing_algorithm(self, value: EmailMailboxSmimeSigningAlgorithm | None) -> None: ...
    ...
    @_property
    def required_smime_encryption_algorithm(self) -> EmailMailboxSmimeEncryptionAlgorithm | None: ...
    ...
    def required_smime_encryption_algorithm(self, value: EmailMailboxSmimeEncryptionAlgorithm | None) -> None: ...
...
class EmailMeetingInfo(winrt.system.Object):
    ...
    @_property
    def appointment_original_start_time(self) -> datetime.datetime | None: ...
    ...
    def appointment_original_start_time(self, value: datetime.datetime | None) -> None: ...
    ...
    @_property
    def proposed_duration(self) -> datetime.timedelta | None: ...
    ...
    def proposed_duration(self, value: datetime.timedelta | None) -> None: ...
    ...
    @_property
    def recurrence_start_time(self) -> datetime.datetime | None: ...
    ...
    def recurrence_start_time(self, value: datetime.datetime | None) -> None: ...
    ...
    @_property
    def proposed_start_time(self) -> datetime.datetime | None: ...
    ...
    def proposed_start_time(self, value: datetime.datetime | None) -> None: ...
...
class EmailMessage(winrt.system.Object):
    ...
    @_property
    def bcc(self) -> _cabc.MutableSequence[EmailRecipient]: ...
    ...
    @_property
    def cc(self) -> _cabc.MutableSequence[EmailRecipient]: ...
    ...
    @_property
    def attachments(self) -> _cabc.MutableSequence[EmailAttachment]: ...
    ...
    @_property
    def to(self) -> _cabc.MutableSequence[EmailRecipient]: ...
    ...
    @_property
    def sent_time(self) -> datetime.datetime | None: ...
    ...
    @sent_time.setter
    def sent_time(self, value: datetime.datetime | None) -> None: ...
    ...
    @_property
    def reply_to(self) -> _cabc.MutableSequence[EmailRecipient]: ...
...
class EmailQueryOptions(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: type[Self], text: str, fields: EmailQuerySearchFields) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
    ...
    @_property
    def folder_ids(self) -> _cabc.MutableSequence[str]: ...
...
class EmailRecipient(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], address: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], address: str, name: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
class EmailRecipientResolutionResult(winrt.system.Object):
    ...
    def set_public_keys(self, value: _cabc.Iterable[windows_security_cryptography_certificates.Certificate], /) -> None: ...
    ...
    @_property
    def public_keys(self) -> _cabc.Sequence[windows_security_cryptography_certificates.Certificate]: ...
...
class EmailStore(winrt.system.Object):
    ...
    def create_mailbox_async(self, account_name: str, account_address: str, user_data_account_id: str, /) -> windows_foundation.IAsyncOperation[EmailMailbox]: ...
    # Deprecated alias of create_mailbox_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Email.EmailMailbox> Windows.ApplicationModel.Email.EmailStore::CreateMailboxAsync(System.String,System.String,System.String)
    @deprecated("Use create_mailbox_async() instead.")
    ...
    def find_mailboxes_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[EmailMailbox]]: ...
