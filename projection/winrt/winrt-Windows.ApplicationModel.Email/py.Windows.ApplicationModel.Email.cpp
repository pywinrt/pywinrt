...
namespace py::cpp::Windows::ApplicationModel::Email
{
    ...
    static PyObject* EmailManager_GetForUser(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.Email.EmailManager", "GetForUser", nullptr, py::site_is_static};
    ...
    static PyObject* EmailManager_RequestStoreAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.Email.EmailManager", "RequestStoreAsync", nullptr, py::site_is_static};
    ...
    static PyObject* EmailManager_ShowComposeNewEmailAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.Email.EmailManager", "ShowComposeNewEmailAsync", nullptr, py::site_is_static};
