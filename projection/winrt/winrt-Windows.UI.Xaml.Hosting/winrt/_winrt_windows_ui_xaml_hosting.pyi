...
class DesignerAppManager(winrt.system.Object, windows_foundation.IClosable):
    ...
    def __new__(cls: type[Self], app_user_model_id: str) -> Self: ...
    ...
    def create_new_view_async(self, initial_view_state: DesignerAppViewState, initial_view_size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[DesignerAppView]: ...
    ...
    def remove_designer_app_exited(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class DesignerAppView(winrt.system.Object, windows_foundation.IClosable):
    ...
    def update_view_async(self, view_state: DesignerAppViewState, view_size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncAction: ...
...
class XamlUIPresenter_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_flyout_placement_target_info(cls, placement_target: windows_ui_xaml.FrameworkElement, preferred_placement: windows_ui_xaml_controls_primitives.FlyoutPlacementMode, /) -> tuple[windows_foundation.Rect, windows_ui_xaml_controls_primitives.FlyoutPlacementMode, bool]: ...
