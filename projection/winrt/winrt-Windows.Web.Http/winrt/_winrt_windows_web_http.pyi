...
class HttpProgress:
    ...
    @_property
    def total_bytes_to_send(self) -> winrt.system.UInt64 | None: ...
    @_property
    def bytes_received(self) -> winrt.system.UInt64: ...
    @_property
    def total_bytes_to_receive(self) -> winrt.system.UInt64 | None: ...
    @_property
    def retries(self) -> winrt.system.UInt32: ...
    def __new__(cls, stage: HttpProgressStage = HttpProgressStage(0), bytes_sent: winrt.system.UInt64 = 0, total_bytes_to_send: winrt.system.UInt64 | None = None, bytes_received: winrt.system.UInt64 = 0, total_bytes_to_receive: winrt.system.UInt64 | None = None, retries: winrt.system.UInt32 = 0) -> HttpProgress: ...
    def __replace__(self, /, **changes: typing.Any) -> HttpProgress: ...
    def unpack(self) -> tuple[HttpProgressStage, winrt.system.UInt64, winrt.system.UInt64 | None, winrt.system.UInt64, winrt.system.UInt64 | None, winrt.system.UInt32]: ...
...
class HttpBufferContent(winrt.system.Object, windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable):
    ...
    @typing.overload
    def __new__(cls: type[Self], content: winrt.system.Buffer) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], content: winrt.system.Buffer, offset: winrt.system.UInt32, count: winrt.system.UInt32) -> Self: ...
    ...
    def try_compute_length(self) -> tuple[bool, winrt.system.UInt64]: ...
...
class HttpClient(winrt.system.Object, windows_foundation.IStringable, windows_foundation.IClosable):
    ...
    def __str__(self) -> str: ...
    @typing.overload
    def __new__(cls: type[Self], filter: windows_web_http_filters.IHttpFilter) -> Self: ...
    @typing.overload
    ...
    def get_async(self, uri: windows_foundation.Uri, completion_option: HttpCompletionOption, /) -> windows_foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]: ...
    ...
    def send_request_async(self, request: HttpRequestMessage, completion_option: HttpCompletionOption, /) -> windows_foundation.IAsyncOperationWithProgress[HttpResponseMessage, HttpProgress]: ...
    # Deprecated alias of send_request_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperationWithProgress`2<Windows.Web.Http.HttpResponseMessage,Windows.Web.Http.HttpProgress> Windows.Web.Http.HttpClient::SendRequestAsync(Windows.Web.Http.HttpRequestMessage,Windows.Web.Http.HttpCompletionOption)
    @deprecated("Use send_request_async() instead.")
    ...
    def try_get_async(self, uri: windows_foundation.Uri, completion_option: HttpCompletionOption, /) -> windows_foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]: ...
    # Deprecated alias of try_get_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperationWithProgress`2<Windows.Web.Http.HttpRequestResult,Windows.Web.Http.HttpProgress> Windows.Web.Http.HttpClient::TryGetAsync(Windows.Foundation.Uri,Windows.Web.Http.HttpCompletionOption)
    @deprecated("Use try_get_async() instead.")
    ...
    def try_send_request_async(self, request: HttpRequestMessage, completion_option: HttpCompletionOption, /) -> windows_foundation.IAsyncOperationWithProgress[HttpRequestResult, HttpProgress]: ...
    # Deprecated alias of try_send_request_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperationWithProgress`2<Windows.Web.Http.HttpRequestResult,Windows.Web.Http.HttpProgress> Windows.Web.Http.HttpClient::TrySendRequestAsync(Windows.Web.Http.HttpRequestMessage,Windows.Web.Http.HttpCompletionOption)
    @deprecated("Use try_send_request_async() instead.")
...
class HttpCookie(winrt.system.Object, windows_foundation.IStringable):
    def __str__(self) -> str: ...
    def __new__(cls: type[Self], name: str, domain: str, path: str) -> Self: ...
...
class HttpCookieCollection(winrt.system.Object, winrt._winrt.Sequence[HttpCookie]):
    ...
    def __iter__(self) -> _cabc.Iterator[HttpCookie]: ...
    @typing.overload
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[HttpCookie] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    # System.Boolean Windows.Web.Http.HttpCookieCollection::IndexOf(Windows.Web.Http.HttpCookie,System.UInt32&)
    def index_of(self, value: HttpCookie, /) -> tuple[bool, winrt.system.UInt32]: ...
...
class HttpCookieManager(winrt.system.Object):
    ...
    def set_cookie(self, cookie: HttpCookie, third_party: bool, /) -> bool: ...
    # Deprecated alias of set_cookie() for pywinrt v3.x compatibility.
    # System.Boolean Windows.Web.Http.HttpCookieManager::SetCookie(Windows.Web.Http.HttpCookie,System.Boolean)
...
class HttpFormUrlEncodedContent(winrt.system.Object, windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    def __str__(self) -> str: ...
    def __new__(cls: type[Self], content: _cabc.Mapping[str, str] | _cabc.Iterable[windows_foundation_collections.IKeyValuePair[str, str]]) -> Self: ...
...
class HttpMethod(winrt.system.Object, windows_foundation.IStringable, metaclass=HttpMethod_Static):
    def __str__(self) -> str: ...
    def __new__(cls: type[Self], method: str) -> Self: ...
...
class HttpMultipartContent(winrt.system.Object, windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    def __str__(self) -> str: ...
    def __iter__(self) -> _cabc.Iterator[IHttpContent]: ...
    @typing.overload
    def __new__(cls: type[Self], subtype: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], subtype: str, boundary: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
class HttpMultipartFormDataContent(winrt.system.Object, windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable):
    ...
    def __iter__(self) -> _cabc.Iterator[IHttpContent]: ...
    @typing.overload
    def __new__(cls: type[Self], boundary: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
    @typing.overload
...
class HttpRequestMessage(winrt.system.Object, windows_foundation.IStringable, windows_foundation.IClosable):
    ...
    def __str__(self) -> str: ...
    @typing.overload
    def __new__(cls: type[Self], method: HttpMethod, uri: windows_foundation.Uri) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
class HttpResponseMessage(winrt.system.Object, windows_foundation.IStringable, windows_foundation.IClosable):
    ...
    def __str__(self) -> str: ...
    @typing.overload
    def __new__(cls: type[Self], status_code: HttpStatusCode) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
class HttpStreamContent(winrt.system.Object, windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    def __str__(self) -> str: ...
    def __new__(cls: type[Self], content: windows_storage_streams.IInputStream) -> Self: ...
...
class HttpStringContent(winrt.system.Object, windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable):
    ...
    @typing.overload
    def __new__(cls: type[Self], content: str, encoding: windows_storage_streams.UnicodeEncoding) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], content: str, encoding: windows_storage_streams.UnicodeEncoding, media_type: str) -> Self: ...
