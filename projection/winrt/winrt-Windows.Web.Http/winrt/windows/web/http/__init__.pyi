...
class HttpProgress:
    ...
    def __new__(cls, stage: HttpProgressStage = ..., bytes_sent: winrt.system.UInt64 = 0, total_bytes_to_send: winrt.system.UInt64 | None = None, bytes_received: winrt.system.UInt64 = 0, total_bytes_to_receive: winrt.system.UInt64 | None = None, retries: winrt.system.UInt32 = 0) -> HttpProgress: ...
...
class HttpBufferContent(winrt.system.Object, windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable):
    ...
    @typing.overload
    def __new__(cls, content: winrt.system.Buffer) -> typing.Self: ...
    @typing.overload
    def __new__(cls, content: winrt.system.Buffer, offset: winrt.system.UInt32, count: winrt.system.UInt32) -> typing.Self: ...
...
class HttpClient(winrt.system.Object, windows_foundation.IStringable, windows_foundation.IClosable):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    @typing.overload
    def __new__(cls, filter: windows_web_http_filters.IHttpFilter) -> typing.Self: ...
    @typing.overload
...
class HttpCookie(winrt.system.Object, windows_foundation.IStringable):
    def __new__(cls, name: str, domain: str, path: str) -> typing.Self: ...
...
class HttpFormUrlEncodedContent(winrt.system.Object, windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable):
    def __enter__(self) -> typing.Self: ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    def __new__(cls, content: _cabc.Mapping[str, str] | _cabc.Iterable[windows_foundation_collections.IKeyValuePair[str, str]]) -> typing.Self: ...
...
class HttpMethod(winrt.system.Object, windows_foundation.IStringable, metaclass=HttpMethod_Static):
    def __new__(cls, method: str) -> typing.Self: ...
...
class HttpMultipartContent(winrt.system.Object, windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable):
    ...
    @typing.overload
    def __new__(cls, subtype: str) -> typing.Self: ...
    @typing.overload
    def __new__(cls, subtype: str, boundary: str) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
...
class HttpMultipartFormDataContent(winrt.system.Object, windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable):
    ...
    def __iter__(self) -> _cabc.Iterator[IHttpContent]: ...
    @typing.overload
    def __new__(cls, boundary: str) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
    @typing.overload
...
class HttpRequestMessage(winrt.system.Object, windows_foundation.IStringable, windows_foundation.IClosable):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    @typing.overload
    def __new__(cls, method: HttpMethod, uri: windows_foundation.Uri) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
...
class HttpResponseMessage(winrt.system.Object, windows_foundation.IStringable, windows_foundation.IClosable):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    @typing.overload
    def __new__(cls, status_code: HttpStatusCode) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
...
class HttpStreamContent(winrt.system.Object, windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable):
    def __enter__(self) -> typing.Self: ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    def __new__(cls, content: windows_storage_streams.IInputStream) -> typing.Self: ...
...
class HttpStringContent(winrt.system.Object, windows_foundation.IStringable, IHttpContent, windows_foundation.IClosable):
    ...
    @typing.overload
    def __new__(cls, content: str, encoding: windows_storage_streams.UnicodeEncoding) -> typing.Self: ...
    @typing.overload
    def __new__(cls, content: str, encoding: windows_storage_streams.UnicodeEncoding, media_type: str) -> typing.Self: ...
