...
class PlayReadyContentHeader(winrt.system.Object):
    @typing.overload
    def __new__(cls, dw_flags: winrt.system.UInt32, content_key_ids: winrt.system.Array[_uuid.UUID] | winrt.system.ReadableBuffer, content_key_id_strings: winrt.system.Array[str] | winrt.system.ReadableBuffer, content_encryption_algorithm: PlayReadyEncryptionAlgorithm, license_acquisition_url: windows_foundation.Uri, license_acquisition_user_interface_url: windows_foundation.Uri, custom_attributes: str, domain_service_id: _uuid.UUID) -> typing.Self: ...
    @typing.overload
    def __new__(cls, header_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, license_acquisition_url: windows_foundation.Uri, license_acquisition_user_interface_url: windows_foundation.Uri, custom_attributes: str, domain_service_id: _uuid.UUID) -> typing.Self: ...
    @typing.overload
    def __new__(cls, content_key_id: _uuid.UUID, content_key_id_string: str, content_encryption_algorithm: PlayReadyEncryptionAlgorithm, license_acquisition_url: windows_foundation.Uri, license_acquisition_user_interface_url: windows_foundation.Uri, custom_attributes: str, domain_service_id: _uuid.UUID) -> typing.Self: ...
    @typing.overload
    def __new__(cls, header_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> typing.Self: ...
...
class PlayReadyDomainIterable(winrt.system.Object):
    ...
    def __new__(cls, domain_account_id: _uuid.UUID) -> typing.Self: ...
...
class PlayReadyLicenseIterable(winrt.system.Object):
    ...
    def __new__(cls) -> typing.Self: ...
    @typing.overload
    def __new__(cls, content_header: PlayReadyContentHeader, fully_evaluated: bool) -> typing.Self: ...
...
class PlayReadySecureStopServiceRequest(winrt.system.Object, IPlayReadySecureStopServiceRequest, IPlayReadyServiceRequest, windows_media_protection.IMediaProtectionServiceRequest):
    ...
    def __new__(cls, publisher_cert_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> typing.Self: ...
    @typing.overload
    def __new__(cls, session_id: _uuid.UUID, publisher_cert_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> typing.Self: ...
