...
class NDClient(winrt.system.Object):
    def __new__(cls: type[Self], download_engine: INDDownloadEngine, stream_parser: INDStreamParser, p_messenger: INDMessenger) -> Self: ...
...
class NDCustomData(winrt.system.Object, INDCustomData):
    def __new__(cls: type[Self], custom_data_type_id_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, custom_data_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> Self: ...
...
class NDLicenseFetchDescriptor(winrt.system.Object, INDLicenseFetchDescriptor):
    def __new__(cls: type[Self], content_id_type: NDContentIDType, content_id_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, license_fetch_challenge_custom_data: INDCustomData) -> Self: ...
...
class NDTCPMessenger(winrt.system.Object, INDMessenger):
    def __new__(cls: type[Self], remote_host_name: str, remote_host_port: winrt.system.UInt32) -> Self: ...
...
class PlayReadyContentHeader(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], dw_flags: winrt.system.UInt32, content_key_ids: winrt.system.Array[_uuid.UUID] | winrt.system.ReadableBuffer, content_key_id_strings: winrt.system.Array[str] | winrt.system.ReadableBuffer, content_encryption_algorithm: PlayReadyEncryptionAlgorithm, license_acquisition_url: windows_foundation.Uri, license_acquisition_user_interface_url: windows_foundation.Uri, custom_attributes: str, domain_service_id: _uuid.UUID) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], header_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, license_acquisition_url: windows_foundation.Uri, license_acquisition_user_interface_url: windows_foundation.Uri, custom_attributes: str, domain_service_id: _uuid.UUID) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], content_key_id: _uuid.UUID, content_key_id_string: str, content_encryption_algorithm: PlayReadyEncryptionAlgorithm, license_acquisition_url: windows_foundation.Uri, license_acquisition_user_interface_url: windows_foundation.Uri, custom_attributes: str, domain_service_id: _uuid.UUID) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], header_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> Self: ...
...
class PlayReadyDomainIterable(winrt.system.Object):
    def __iter__(self) -> _cabc.Iterator[IPlayReadyDomain]: ...
    def __new__(cls: type[Self], domain_account_id: _uuid.UUID) -> Self: ...
...
class PlayReadyDomainJoinServiceRequest(winrt.system.Object, IPlayReadyServiceRequest, windows_media_protection.IMediaProtectionServiceRequest):
    ...
    def process_manual_enabling_response(self, response_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> windows_foundation.HResult: ...
...
class PlayReadyLicenseIterable(winrt.system.Object):
    def __iter__(self) -> _cabc.Iterator[IPlayReadyLicense]: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], content_header: PlayReadyContentHeader, fully_evaluated: bool) -> Self: ...
...
class PlayReadyLicenseSession(winrt.system.Object, IPlayReadyLicenseSession2, IPlayReadyLicenseSession):
    def __new__(cls: type[Self], configuration: windows_foundation_collections.IPropertySet) -> Self: ...
...
class PlayReadyMeteringReportServiceRequest(winrt.system.Object, IPlayReadyServiceRequest, windows_media_protection.IMediaProtectionServiceRequest):
    ...
    def metering_certificate(self, value: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> None: ...
...
class PlayReadySecureStopIterable(winrt.system.Object):
    def __iter__(self) -> _cabc.Iterator[IPlayReadySecureStopServiceRequest]: ...
    def __new__(cls: type[Self], publisher_cert_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> Self: ...
...
class PlayReadySecureStopServiceRequest(winrt.system.Object, IPlayReadySecureStopServiceRequest, IPlayReadyServiceRequest, windows_media_protection.IMediaProtectionServiceRequest):
    ...
    def __new__(cls: type[Self], publisher_cert_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], session_id: _uuid.UUID, publisher_cert_bytes: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> Self: ...
...
class PlayReadyStatics_Static(winrt._winrt.IInspectable_Static):
    ...
    @_property
    def hardware_drm_disabled_until_time(cls) -> datetime.datetime | None: ...
    ...
    @_property
    def hardware_drm_disabled_at_time(cls) -> datetime.datetime | None: ...
