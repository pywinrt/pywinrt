...
class RepeatBehavior:
    ...
    def unpack(self) -> tuple[winrt.system.Double, datetime.timedelta, RepeatBehaviorType]: ...
...
class ColorKeyFrame(windows_ui_xaml.DependencyObject, metaclass=ColorKeyFrame_Static):
    ...
    @value.setter
    @typing.final
    def value(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
    ...
    @key_time.setter
    @typing.final
    def key_time(self, value: KeyTime | tuple[datetime.timedelta]) -> None: ...

@typing.final
class ColorKeyFrameCollection(winrt.system.Object, winrt._winrt.MutableSequence[ColorKeyFrame]):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[ColorKeyFrame]: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(self, index: slice, value: _cabc.Iterable[ColorKeyFrame]) -> None: ...
    def __new__(cls: type[Self]) -> Self: ...
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[ColorKeyFrame] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def get_view(self) -> _cabc.Sequence[ColorKeyFrame]: ...
    ...
    def index_of(self, value: ColorKeyFrame, /) -> tuple[bool, winrt.system.UInt32]: ...
    ...
    def replace_all(self, items: winrt.system.Array[ColorKeyFrame] | winrt.system.ReadableBuffer, /) -> None: ...
...
class ConnectedAnimation(winrt.system.Object):
    ...
    def try_start(self, destination: windows_ui_xaml.UIElement, coordinated_elements: _cabc.Iterable[windows_ui_xaml.UIElement], /) -> bool: ...
    # Deprecated alias of try_start() for pywinrt v3.x compatibility.
    # System.Boolean Windows.UI.Xaml.Media.Animation.ConnectedAnimation::TryStart(Windows.UI.Xaml.UIElement,Windows.Foundation.Collections.IIterable`1<Windows.UI.Xaml.UIElement>)
    @deprecated("Use try_start() instead.")
    def try_start_with_coordinated_elements(self, destination: windows_ui_xaml.UIElement, coordinated_elements: _cabc.Iterable[windows_ui_xaml.UIElement], /) -> bool: ...
...
class DoubleKeyFrameCollection(winrt.system.Object, winrt._winrt.MutableSequence[DoubleKeyFrame]):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[DoubleKeyFrame]: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(self, index: slice, value: _cabc.Iterable[DoubleKeyFrame]) -> None: ...
    def __new__(cls: type[Self]) -> Self: ...
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[DoubleKeyFrame] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def get_view(self) -> _cabc.Sequence[DoubleKeyFrame]: ...
    ...
    def index_of(self, value: DoubleKeyFrame, /) -> tuple[bool, winrt.system.UInt32]: ...
    ...
    def replace_all(self, items: winrt.system.Array[DoubleKeyFrame] | winrt.system.ReadableBuffer, /) -> None: ...
...
class KeySpline(windows_ui_xaml.DependencyObject):
    ...
    def control_point2(self, value: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
...
class ObjectKeyFrameCollection(winrt.system.Object, winrt._winrt.MutableSequence[ObjectKeyFrame]):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[ObjectKeyFrame]: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(self, index: slice, value: _cabc.Iterable[ObjectKeyFrame]) -> None: ...
    def __new__(cls: type[Self]) -> Self: ...
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[ObjectKeyFrame] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def get_view(self) -> _cabc.Sequence[ObjectKeyFrame]: ...
    ...
    def index_of(self, value: ObjectKeyFrame, /) -> tuple[bool, winrt.system.UInt32]: ...
    ...
    def replace_all(self, items: winrt.system.Array[ObjectKeyFrame] | winrt.system.ReadableBuffer, /) -> None: ...
...
class PointAnimation(Timeline, metaclass=PointAnimation_Static):
    ...
    @_property
    def to(self) -> windows_foundation.Point | None: ...
    ...
    @from_.setter
    def from_(self, value: windows_foundation.Point | None) -> None: ...
    ...
    @_property
    def by(self) -> windows_foundation.Point | None: ...
    ...
    @by.setter
    def by(self, value: windows_foundation.Point | None) -> None: ...
...
class PointKeyFrame(windows_ui_xaml.DependencyObject, metaclass=PointKeyFrame_Static):
    ...
    @value.setter
    @typing.final
    def value(self, value: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
...
class PointKeyFrameCollection(winrt.system.Object, winrt._winrt.MutableSequence[PointKeyFrame]):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[PointKeyFrame]: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(self, index: slice, value: _cabc.Iterable[PointKeyFrame]) -> None: ...
    def __new__(cls: type[Self]) -> Self: ...
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[PointKeyFrame] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def get_view(self) -> _cabc.Sequence[PointKeyFrame]: ...
    ...
    def index_of(self, value: PointKeyFrame, /) -> tuple[bool, winrt.system.UInt32]: ...
    ...
    def replace_all(self, items: winrt.system.Array[PointKeyFrame] | winrt.system.ReadableBuffer, /) -> None: ...
...
class RepeatBehaviorHelper_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_has_count(cls, target: RepeatBehavior | tuple[winrt.system.Double, datetime.timedelta, RepeatBehaviorType], /) -> bool: ...
    ...
    def get_has_duration(cls, target: RepeatBehavior | tuple[winrt.system.Double, datetime.timedelta, RepeatBehaviorType], /) -> bool: ...
...
class Timeline(windows_ui_xaml.DependencyObject, metaclass=Timeline_Static):
    ...
    @typing.final
    def repeat_behavior(self, value: RepeatBehavior | tuple[winrt.system.Double, datetime.timedelta, RepeatBehaviorType]) -> None: ...
    ...
    @duration.setter
    @typing.final
    def duration(self, value: windows_ui_xaml.Duration | tuple[datetime.timedelta, windows_ui_xaml.DurationType]) -> None: ...
    # Windows.Foundation.IReference`1<Windows.Foundation.TimeSpan> Windows.UI.Xaml.Media.Animation.Timeline::get_BeginTime()
    @_property
    def begin_time(self) -> datetime.timedelta | None: ...
    ...
    @begin_time.setter
    @typing.final
    def begin_time(self, value: datetime.timedelta | None) -> None: ...
...
class TimelineCollection(winrt.system.Object, winrt._winrt.MutableSequence[Timeline]):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[Timeline]: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(self, index: slice, value: _cabc.Iterable[Timeline]) -> None: ...
    def __new__(cls: type[Self]) -> Self: ...
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[Timeline] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def get_view(self) -> _cabc.Sequence[Timeline]: ...
    ...
    def index_of(self, value: Timeline, /) -> tuple[bool, winrt.system.UInt32]: ...
    ...
    def replace_all(self, items: winrt.system.Array[Timeline] | winrt.system.ReadableBuffer, /) -> None: ...
...
class TransitionCollection(winrt.system.Object, winrt._winrt.MutableSequence[Transition]):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[Transition]: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(self, index: slice, value: _cabc.Iterable[Transition]) -> None: ...
    def __new__(cls: type[Self]) -> Self: ...
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[Transition] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def get_view(self) -> _cabc.Sequence[Transition]: ...
    ...
    def index_of(self, value: Transition, /) -> tuple[bool, winrt.system.UInt32]: ...
    ...
    def replace_all(self, items: winrt.system.Array[Transition] | winrt.system.ReadableBuffer, /) -> None: ...
