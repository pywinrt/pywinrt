...
class AppointmentCalendarCreateOrUpdateAppointmentRequest(winrt.system.Object):
    ...
    @_property
    def changed_properties(self) -> _cabc.Sequence[str]: ...
...
class AppointmentCalendarForwardMeetingRequest(winrt.system.Object):
    ...
    @_property
    def invitees(self) -> _cabc.Sequence[windows_applicationmodel_appointments.AppointmentInvitee]: ...
...
class AppointmentDataProviderConnection(winrt.system.Object):
    ...
    def remove_cancel_meeting_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_create_or_update_appointment_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_forward_meeting_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_propose_new_time_for_meeting_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_update_meeting_response_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
