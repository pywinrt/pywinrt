...
class ContentIndexer(winrt.system.Object, metaclass=ContentIndexer_Static):
    ...
    def create_query(self, search_filter: str, properties_to_retrieve: _cabc.Iterable[str], /) -> ContentIndexerQuery: ...
    @typing.overload
    ...
    def create_query(self, search_filter: str, properties_to_retrieve: _cabc.Iterable[str], sort_order: _cabc.Iterable[SortEntry], /) -> ContentIndexerQuery: ...
    @typing.overload
    ...
    def create_query(self, search_filter: str, properties_to_retrieve: _cabc.Iterable[str], sort_order: _cabc.Iterable[SortEntry], search_filter_language: str, /) -> ContentIndexerQuery: ...
    # Deprecated alias of create_query() for pywinrt v3.x compatibility.
    # Windows.Storage.Search.ContentIndexerQuery Windows.Storage.Search.ContentIndexer::CreateQuery(System.String,Windows.Foundation.Collections.IIterable`1<System.String>,Windows.Foundation.Collections.IIterable`1<Windows.Storage.Search.SortEntry>)
    @deprecated("Use create_query() instead.")
    def create_query_with_sort_order(self, search_filter: str, properties_to_retrieve: _cabc.Iterable[str], sort_order: _cabc.Iterable[SortEntry], /) -> ContentIndexerQuery: ...
    # Deprecated alias of create_query() for pywinrt v3.x compatibility.
    # Windows.Storage.Search.ContentIndexerQuery Windows.Storage.Search.ContentIndexer::CreateQuery(System.String,Windows.Foundation.Collections.IIterable`1<System.String>,Windows.Foundation.Collections.IIterable`1<Windows.Storage.Search.SortEntry>,System.String)
    @deprecated("Use create_query() instead.")
    def create_query_with_sort_order_and_language(self, search_filter: str, properties_to_retrieve: _cabc.Iterable[str], sort_order: _cabc.Iterable[SortEntry], search_filter_language: str, /) -> ContentIndexerQuery: ...
    ...
    def delete_multiple_async(self, content_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncAction: ...
    ...
    def retrieve_properties_async(self, content_id: str, properties_to_retrieve: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[_cabc.Mapping[str, winrt.system.Object]]: ...
...
class ContentIndexerQuery(winrt.system.Object):
    ...
    def get_async(self, start_index: winrt.system.UInt32, max_items: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[IIndexableContent]]: ...
    # Deprecated alias of get_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.Search.IIndexableContent>> Windows.Storage.Search.ContentIndexerQuery::GetAsync(System.UInt32,System.UInt32)
    @deprecated("Use get_async() instead.")
    def get_range_async(self, start_index: winrt.system.UInt32, max_items: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[IIndexableContent]]: ...
    ...
    def get_properties_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[_cabc.Mapping[str, winrt.system.Object]]]: ...
    @typing.overload
    ...
    def get_properties_async(self, start_index: winrt.system.UInt32, max_items: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[_cabc.Mapping[str, winrt.system.Object]]]: ...
    # Deprecated alias of get_properties_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Foundation.Collections.IMapView`2<System.String,System.Object>>> Windows.Storage.Search.ContentIndexerQuery::GetPropertiesAsync(System.UInt32,System.UInt32)
    @deprecated("Use get_properties_async() instead.")
    def get_properties_range_async(self, start_index: winrt.system.UInt32, max_items: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[_cabc.Mapping[str, winrt.system.Object]]]: ...
...
class IndexableContent(winrt.system.Object, IIndexableContent):
    ...
    @_property
    def properties(self) -> _cabc.MutableMapping[str, winrt.system.Object]: ...

@typing.final
class QueryOptions(winrt.system.Object):
    @typing.overload
    def __new__(cls, query: CommonFileQuery, file_type_filter: _cabc.Iterable[str]) -> typing.Self: ...
    @typing.overload
    def __new__(cls, query: CommonFolderQuery) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
    ...
    def set_property_prefetch(self, options: windows_storage_fileproperties.PropertyPrefetchOptions, properties_to_retrieve: _cabc.Iterable[str], /) -> None: ...
    ...
    @_property
    def sort_order(self) -> _cabc.MutableSequence[SortEntry]: ...
    # System.Boolean Windows.Storage.Search.QueryOptions::get_IncludeLocalSemanticIndex()
    @_property
    def include_local_semantic_index(self) -> bool: ...
    # System.Void Windows.Storage.Search.QueryOptions::put_IncludeLocalSemanticIndex(System.Boolean)
    @include_local_semantic_index.setter
    def include_local_semantic_index(self, value: bool) -> None: ...
    # System.Boolean Windows.Storage.Search.QueryOptions::get_IncludeCloudProviders()
    @_property
    def include_cloud_providers(self) -> bool: ...
    # System.Void Windows.Storage.Search.QueryOptions::put_IncludeCloudProviders(System.Boolean)
    @include_cloud_providers.setter
    def include_cloud_providers(self, value: bool) -> None: ...
...
class SortEntryVector(winrt.system.Object, winrt._winrt.MutableSequence[SortEntry]):
    ...
    @typing.overload
    def __setitem__(self, index: typing.SupportsIndex, value: SortEntry | tuple[str, bool]) -> None: ...
    @typing.overload
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[SortEntry] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def replace_all(self, items: winrt.system.Array[SortEntry] | winrt.system.ReadableBuffer, /) -> None: ...
    # System.Void Windows.Storage.Search.SortEntryVector::SetAt(System.UInt32,Windows.Storage.Search.SortEntry)
    def set_at(self, index: winrt.system.UInt32, value: SortEntry | tuple[str, bool], /) -> None: ...
...
class StorageFileQueryResult(winrt.system.Object, IStorageQueryResultBase):
    ...
    def get_files_async(self, start_index: winrt.system.UInt32, max_number_of_items: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFile]]: ...
    # Deprecated alias of get_files_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.StorageFile>> Windows.Storage.Search.StorageFileQueryResult::GetFilesAsync()
    @deprecated("Use get_files_async() instead.")
    def get_files_async_default_start_and_count(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFile]]: ...
    ...
    def get_matching_properties_with_ranges(self, file: windows_storage.StorageFile, /) -> _cabc.MutableMapping[str, _cabc.Sequence[windows_data_text.TextSegment]]: ...
    ...
    def remove_contents_changed(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_options_changed(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class StorageFolderQueryResult(winrt.system.Object, IStorageQueryResultBase):
    ...
    def get_folders_async(self, start_index: winrt.system.UInt32, max_number_of_items: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFolder]]: ...
    # Deprecated alias of get_folders_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.StorageFolder>> Windows.Storage.Search.StorageFolderQueryResult::GetFoldersAsync()
    @deprecated("Use get_folders_async() instead.")
    def get_folders_async_default_start_and_count(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFolder]]: ...
...
class StorageItemQueryResult(winrt.system.Object, IStorageQueryResultBase):
    ...
    def get_items_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.IStorageItem]]: ...
    @typing.overload
    ...
    def get_items_async(self, start_index: winrt.system.UInt32, max_number_of_items: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.IStorageItem]]: ...
    # Deprecated alias of get_items_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.IStorageItem>> Windows.Storage.Search.StorageItemQueryResult::GetItemsAsync()
    @deprecated("Use get_items_async() instead.")
    def get_items_async_default_start_and_count(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.IStorageItem]]: ...
...
class IStorageFolderQueryOperations(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def get_files_async(self, query: CommonFileQuery, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFile]]: ...
    @typing.overload
    ...
    @abstractmethod
    def get_files_async(self, query: CommonFileQuery, start_index: winrt.system.UInt32, max_items_to_retrieve: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFile]]: ...
    # Deprecated alias of get_files_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.StorageFile>> Windows.Storage.Search.IStorageFolderQueryOperations::GetFilesAsync(Windows.Storage.Search.CommonFileQuery)
    @deprecated("Use get_files_async() instead.")
    def get_files_async_overload_default_start_and_count(self, query: CommonFileQuery, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFile]]: ...
    @typing.overload
    ...
    @abstractmethod
    def get_folders_async(self, query: CommonFolderQuery, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFolder]]: ...
    @typing.overload
    ...
    @abstractmethod
    def get_folders_async(self, query: CommonFolderQuery, start_index: winrt.system.UInt32, max_items_to_retrieve: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFolder]]: ...
    # Deprecated alias of get_folders_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.StorageFolder>> Windows.Storage.Search.IStorageFolderQueryOperations::GetFoldersAsync(Windows.Storage.Search.CommonFolderQuery)
    @deprecated("Use get_folders_async() instead.")
    def get_folders_async_overload_default_start_and_count(self, query: CommonFolderQuery, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFolder]]: ...
    ...
    @abstractmethod
    def get_items_async(self, start_index: winrt.system.UInt32, max_items_to_retrieve: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.IStorageItem]]: ...
