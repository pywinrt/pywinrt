...
namespace py::cpp::Windows::Devices::WiFiDirect::Services
{
    ...
    static PyObject* WiFiDirectService_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.WiFiDirect.Services.WiFiDirectService", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* WiFiDirectService_GetSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.WiFiDirect.Services.WiFiDirectService", "GetSelector", nullptr, py::site_is_static};
        ...
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Devices.WiFiDirect.Services.WiFiDirectService", "GetSelector", nullptr, py::site_is_static};
