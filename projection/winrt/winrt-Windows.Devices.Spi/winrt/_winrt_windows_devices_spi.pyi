...
class SpiBusInfo(winrt.system.Object):
    ...
    @_property
    def supported_data_bit_lengths(self) -> _cabc.Sequence[winrt.system.Int32]: ...
...
class SpiController_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_controllers_async(cls, provider: windows_devices_spi_provider.ISpiProvider, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[SpiController]]: ...
...
class SpiDevice(winrt.system.Object, windows_foundation.IClosable, metaclass=SpiDevice_Static):
    ...
    def transfer_full_duplex(self, write_buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, read_buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.WriteableBuffer, /) -> None: ...
    # System.Void Windows.Devices.Spi.SpiDevice::TransferSequential(System.Byte[],System.Byte[])
    def transfer_sequential(self, write_buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, read_buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.WriteableBuffer, /) -> None: ...
