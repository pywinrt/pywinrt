...
namespace py::cpp::Windows::Devices::Spi
{
    ...
    static PyObject* SpiController_GetControllersAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Spi.SpiController", "GetControllersAsync", nullptr, py::site_is_static};
    ...
    static PyObject* SpiController_GetDefaultAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Spi.SpiController", "GetDefaultAsync", nullptr, py::site_is_static};
    ...
    static PyObject* SpiDevice_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Devices.Spi.SpiDevice", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* SpiDevice_GetBusInfo(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Spi.SpiDevice", "GetBusInfo", nullptr, py::site_is_static};
    ...
    static PyObject* SpiDevice_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Spi.SpiDevice", "GetDeviceSelector", nullptr, py::site_is_static};
        ...
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Spi.SpiDevice", "GetDeviceSelector", nullptr, py::site_is_static};
