...
namespace py::cpp::Windows::ApplicationModel::Preview::Notes
{
    ...
    static PyObject* NotesWindowManagerPreview_GetForCurrentApp(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.ApplicationModel.Preview.Notes.NotesWindowManagerPreview", "GetForCurrentApp", nullptr, py::site_is_static};
