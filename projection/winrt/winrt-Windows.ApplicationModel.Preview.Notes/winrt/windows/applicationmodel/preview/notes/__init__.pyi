...
class NotesWindowManagerPreview(winrt.system.Object, metaclass=NotesWindowManagerPreview_Static):
    ...
    def try_set_note_size(self, note_view_id: winrt.system.Int32, size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> bool: ...
    ...
    def remove_note_placement_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_note_visibility_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_system_lock_state_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
