...
class LampArray(winrt.system.Object, metaclass=LampArray_Static):
    ...
    def set_colors_for_key(self, desired_color: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8], key: windows_system.VirtualKey, /) -> None: ...
    # System.Void Windows.Devices.Lights.LampArray::SetColorsForKeys(Windows.UI.Color[],Windows.System.VirtualKey[])
    def set_colors_for_keys(self, desired_colors: winrt.system.Array[windows_ui.Color] | winrt.system.ReadableBuffer, keys: winrt.system.Array[windows_system.VirtualKey] | winrt.system.ReadableBuffer, /) -> None: ...
    # System.Void Windows.Devices.Lights.LampArray::SetColorsForPurposes(Windows.UI.Color,Windows.Devices.Lights.LampPurposes)
    def set_colors_for_purposes(self, desired_color: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8], purposes: LampPurposes, /) -> None: ...
...
class LampInfo(winrt.system.Object):
    ...
    @_property
    def fixed_color(self) -> windows_ui.Color | None: ...
