...
namespace py::cpp::Windows::Devices::Lights
{
    ...
    static PyObject* Lamp_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Lights.Lamp", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* Lamp_GetDefaultAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Lights.Lamp", "GetDefaultAsync", nullptr, py::site_is_static};
    ...
    static PyObject* Lamp_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Lights.Lamp", "GetDeviceSelector", nullptr, py::site_is_static};
    ...
    static PyObject* LampArray_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Lights.LampArray", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* LampArray_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Lights.LampArray", "GetDeviceSelector", nullptr, py::site_is_static};
