...
namespace py::cpp::Windows::Gaming::Input::Preview
{
    ...
    static PyObject* GameControllerProviderInfo_GetParentProviderId(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Gaming.Input.Preview.GameControllerProviderInfo", "GetParentProviderId", nullptr, py::site_is_static};
    ...
    static PyObject* GameControllerProviderInfo_GetProviderId(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Gaming.Input.Preview.GameControllerProviderInfo", "GetProviderId", nullptr, py::site_is_static};
    ...
    static PyObject* LegacyGipGameControllerProvider_ClearPairing(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Gaming.Input.Preview.LegacyGipGameControllerProvider", "ClearPairing", nullptr, py::site_is_static};
    ...
    static PyObject* LegacyGipGameControllerProvider_FromGameController(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Gaming.Input.Preview.LegacyGipGameControllerProvider", "FromGameController", nullptr, py::site_is_static};
    ...
    static PyObject* LegacyGipGameControllerProvider_FromGameControllerProvider(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Gaming.Input.Preview.LegacyGipGameControllerProvider", "FromGameControllerProvider", nullptr, py::site_is_static};
    ...
    static PyObject* LegacyGipGameControllerProvider_IsCopilot(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Gaming.Input.Preview.LegacyGipGameControllerProvider", "IsCopilot", nullptr, py::site_is_static};
    ...
    static PyObject* LegacyGipGameControllerProvider_IsPilot(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Gaming.Input.Preview.LegacyGipGameControllerProvider", "IsPilot", nullptr, py::site_is_static};
    ...
    static PyObject* LegacyGipGameControllerProvider_PairPilotToCopilot(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 3)
        {
            static constexpr py::member_site site{py::member_kind::method, 3, "Windows.Gaming.Input.Preview.LegacyGipGameControllerProvider", "PairPilotToCopilot", nullptr, py::site_is_static};
