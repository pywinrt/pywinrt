...
class PackageVersion:
    ...
    def unpack(self) -> tuple[winrt.system.UInt16, winrt.system.UInt16, winrt.system.UInt16, winrt.system.UInt16]: ...
...
class AppInstallerInfo(winrt.system.Object):
    ...
    @_property
    def dependency_package_uris(self) -> _cabc.Sequence[windows_foundation.Uri]: ...
    ...
    @_property
    def repair_uris(self) -> _cabc.Sequence[windows_foundation.Uri]: ...
    ...
    @_property
    def update_uris(self) -> _cabc.Sequence[windows_foundation.Uri]: ...
...
class Package(winrt.system.Object, metaclass=Package_Static):
    ...
    def find_related_packages(self, options: FindRelatedPackagesOptions, /) -> _cabc.MutableSequence[Package]: ...
    ...
    def get_app_list_entries(self) -> _cabc.Sequence[windows_applicationmodel_core.AppListEntry]: ...
    ...
    def get_app_list_entries_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_applicationmodel_core.AppListEntry]]: ...
    ...
    def get_content_groups_async(self) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[PackageContentGroup]]: ...
    ...
    def get_logo_as_random_access_stream_reference(self, size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_storage_streams.RandomAccessStreamReference: ...
    ...
    def stage_content_groups_async(self, names: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[PackageContentGroup]]: ...
    @typing.overload
    ...
    def stage_content_groups_async(self, names: _cabc.Iterable[str], move_to_head_of_queue: bool, /) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[PackageContentGroup]]: ...
    ...
    def stage_content_groups_with_priority_async(self, names: _cabc.Iterable[str], move_to_head_of_queue: bool, /) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[PackageContentGroup]]: ...
    ...
    @_property
    def dependencies(self) -> _cabc.Sequence[Package]: ...
...
class PackageCatalog(winrt.system.Object, metaclass=PackageCatalog_Static):
    ...
    def remove_optional_packages_async(self, optional_package_family_names: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[PackageCatalogRemoveOptionalPackagesResult]: ...
    ...
    def remove_resource_packages_async(self, resource_packages: _cabc.Iterable[Package], /) -> windows_foundation.IAsyncOperation[PackageCatalogRemoveResourcePackagesResult]: ...
    ...
    def remove_package_installing(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_package_staging(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_package_status_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_package_uninstalling(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_package_updating(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_package_content_group_staging(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PackageCatalogRemoveOptionalPackagesResult(winrt.system.Object):
    ...
    @_property
    def packages_removed(self) -> _cabc.Sequence[Package]: ...
...
class StartupTask_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_for_current_package_async(cls) -> windows_foundation.IAsyncOperation[_cabc.Sequence[StartupTask]]: ...
