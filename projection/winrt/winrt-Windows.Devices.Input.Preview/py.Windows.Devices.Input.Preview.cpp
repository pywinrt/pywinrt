...
namespace py::cpp::Windows::Devices::Input::Preview
{
    ...
    static PyObject* GazeInputSourcePreview_CreateWatcher(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Input.Preview.GazeInputSourcePreview", "CreateWatcher", nullptr, py::site_is_static};
    ...
    static PyObject* GazeInputSourcePreview_GetForCurrentView(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Input.Preview.GazeInputSourcePreview", "GetForCurrentView", nullptr, py::site_is_static};
