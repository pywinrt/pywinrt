...
class GazeDevicePreview(winrt.system.Object):
    ...
    def get_numeric_control_descriptions(self, usage_page: winrt.system.UInt16, usage_id: winrt.system.UInt16, /) -> _cabc.Sequence[windows_devices_humaninterfacedevice.HidNumericControlDescription]: ...
...
class GazeInputSourcePreview(winrt.system.Object, metaclass=GazeInputSourcePreview_Static):
    ...
    def remove_gaze_entered(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_gaze_exited(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_gaze_moved(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class GazePointPreview(winrt.system.Object):
    ...
    @_property
    def head_gaze_position(self) -> windows_foundation.Point | None: ...
