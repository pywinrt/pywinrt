...
class PeerFinder_Static(winrt._winrt.IInspectable_Static):
    ...
    def find_all_peers_async(cls) -> windows_foundation.IAsyncOperation[_cabc.Sequence[PeerInformation]]: ...
    @typing.overload
    ...
    def remove_connection_requested(cls, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_triggered_connection_state_changed(cls, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def alternate_identities(cls) -> _cabc.MutableMapping[str, str]: ...
...
class ProximityDevice(winrt.system.Object, metaclass=ProximityDevice_Static):
    ...
    def remove_device_arrived(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_device_departed(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
