...
class MessageDialog(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls, content: str, title: str) -> typing.Self: ...
...
class UICommand(winrt.system.Object, IUICommand):
    ...
    @typing.overload
    def __new__(cls, label: str, action: UICommandInvokedHandler) -> typing.Self: ...
    @typing.overload
    def __new__(cls, label: str, action: UICommandInvokedHandler, command_id: winrt.system.Object) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
