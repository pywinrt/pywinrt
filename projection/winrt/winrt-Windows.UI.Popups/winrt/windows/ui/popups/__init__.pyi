...
class MessageDialog(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: type[Self], content: str, title: str) -> Self: ...
...
class PopupMenu(winrt.system.Object):
    ...
    def show_async(self, invocation_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[IUICommand]: ...
    @typing.overload
    ...
    def show_for_selection_async(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[IUICommand]: ...
    @typing.overload
    ...
    def show_for_selection_async(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: Placement, /) -> windows_foundation.IAsyncOperation[IUICommand]: ...
    ...
    def show_async_with_rect(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[IUICommand]: ...
    # Deprecated alias of show_for_selection_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.UI.Popups.IUICommand> Windows.UI.Popups.PopupMenu::ShowForSelectionAsync(Windows.Foundation.Rect,Windows.UI.Popups.Placement)
    @deprecated("Use show_for_selection_async() instead.")
    def show_async_with_rect_and_placement(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: Placement, /) -> windows_foundation.IAsyncOperation[IUICommand]: ...
...
class UICommand(winrt.system.Object, IUICommand):
    @typing.overload
    def __new__(cls: type[Self], label: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], label: str, action: UICommandInvokedHandler) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], label: str, action: UICommandInvokedHandler, command_id: winrt.system.Object) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
UICommandInvokedHandler: typing.TypeAlias = typing.Callable[[IUICommand], None]
