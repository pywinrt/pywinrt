            ...
            {
                {
                    ...
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Windows.Media.Casting.CastingConnection", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
