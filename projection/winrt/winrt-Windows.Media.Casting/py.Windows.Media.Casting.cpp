...
namespace py::cpp::Windows::Media::Casting
{
    ...
    static PyObject* CastingDevice_DeviceInfoSupportsCastingAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Media.Casting.CastingDevice", "DeviceInfoSupportsCastingAsync", nullptr, py::site_is_static};
    ...
    static PyObject* CastingDevice_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Media.Casting.CastingDevice", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* CastingDevice_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Media.Casting.CastingDevice", "GetDeviceSelector", nullptr, py::site_is_static};
    ...
    static PyObject* CastingDevice_GetDeviceSelectorFromCastingSourceAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Media.Casting.CastingDevice", "GetDeviceSelectorFromCastingSourceAsync", nullptr, py::site_is_static};
