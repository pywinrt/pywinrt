...
class CastingDevicePicker(winrt.system.Object):
    ...
    def remove_casting_device_picker_dismissed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_casting_device_selected(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class CastingDevicePickerFilter(winrt.system.Object):
    ...
    @_property
    def supported_casting_sources(self) -> _cabc.MutableSequence[CastingSource]: ...
