...
class MapRoute(winrt.system.Object):
    ...
    @_property
    def legs(self) -> _cabc.Sequence[MapRouteLeg]: ...
...
class MapRouteDrivingOptions(winrt.system.Object):
    ...
    @_property
    def initial_heading(self) -> winrt.system.Double | None: ...
    ...
    def initial_heading(self, value: winrt.system.Double | None) -> None: ...
    ...
    @_property
    def departure_time(self) -> datetime.datetime | None: ...
...
class MapRouteFinder_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_driving_route_from_enhanced_waypoints_async(cls, waypoints: _cabc.Iterable[EnhancedWaypoint], /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    ...
    def get_driving_route_from_enhanced_waypoints_async(cls, waypoints: _cabc.Iterable[EnhancedWaypoint], options: MapRouteDrivingOptions, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    ...
    def get_driving_route_from_enhanced_waypoints_with_options_async(cls, waypoints: _cabc.Iterable[EnhancedWaypoint], options: MapRouteDrivingOptions, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    ...
    def get_driving_route_from_waypoints_async(cls, way_points: _cabc.Iterable[windows_devices_geolocation.Geopoint], /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    ...
    def get_driving_route_from_waypoints_async(cls, way_points: _cabc.Iterable[windows_devices_geolocation.Geopoint], optimization: MapRouteOptimization, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    ...
    def get_driving_route_from_waypoints_async(cls, way_points: _cabc.Iterable[windows_devices_geolocation.Geopoint], optimization: MapRouteOptimization, restrictions: MapRouteRestrictions, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    @typing.overload
    ...
    def get_driving_route_from_waypoints_async(cls, way_points: _cabc.Iterable[windows_devices_geolocation.Geopoint], optimization: MapRouteOptimization, restrictions: MapRouteRestrictions, heading_in_degrees: winrt.system.Double, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    ...
    def get_driving_route_from_waypoints_and_optimization_async(cls, way_points: _cabc.Iterable[windows_devices_geolocation.Geopoint], optimization: MapRouteOptimization, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    # Deprecated alias of get_driving_route_from_waypoints_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Services.Maps.MapRouteFinderResult> Windows.Services.Maps.MapRouteFinder::GetDrivingRouteFromWaypointsAsync(Windows.Foundation.Collections.IIterable`1<Windows.Devices.Geolocation.Geopoint>,Windows.Services.Maps.MapRouteOptimization,Windows.Services.Maps.MapRouteRestrictions)
    @deprecated("Use get_driving_route_from_waypoints_async() instead.")
    def get_driving_route_from_waypoints_optimization_and_restrictions_async(cls, way_points: _cabc.Iterable[windows_devices_geolocation.Geopoint], optimization: MapRouteOptimization, restrictions: MapRouteRestrictions, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    # Deprecated alias of get_driving_route_from_waypoints_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Services.Maps.MapRouteFinderResult> Windows.Services.Maps.MapRouteFinder::GetDrivingRouteFromWaypointsAsync(Windows.Foundation.Collections.IIterable`1<Windows.Devices.Geolocation.Geopoint>,Windows.Services.Maps.MapRouteOptimization,Windows.Services.Maps.MapRouteRestrictions,System.Double)
    @deprecated("Use get_driving_route_from_waypoints_async() instead.")
    def get_driving_route_from_waypoints_optimization_restrictions_and_heading_async(cls, way_points: _cabc.Iterable[windows_devices_geolocation.Geopoint], optimization: MapRouteOptimization, restrictions: MapRouteRestrictions, heading_in_degrees: winrt.system.Double, /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
    ...
    def get_walking_route_from_waypoints_async(cls, way_points: _cabc.Iterable[windows_devices_geolocation.Geopoint], /) -> windows_foundation.IAsyncOperation[MapRouteFinderResult]: ...
...
class MapRouteFinderResult(winrt.system.Object):
    ...
    @_property
    def alternate_routes(self) -> _cabc.Sequence[MapRoute]: ...
...
class MapRouteLeg(winrt.system.Object):
    ...
    @_property
    def maneuvers(self) -> _cabc.Sequence[MapRouteManeuver]: ...
...
class PlaceInfo(winrt.system.Object, metaclass=PlaceInfo_Static):
    ...
    def show_with_preferred_placement(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> None: ...
