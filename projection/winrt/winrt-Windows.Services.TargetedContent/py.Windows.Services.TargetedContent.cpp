...
namespace py::cpp::Windows::Services::TargetedContent
{
    ...
    static PyObject* TargetedContentContainer_GetAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Services.TargetedContent.TargetedContentContainer", "GetAsync", nullptr, py::site_is_static};
    ...
    static PyObject* TargetedContentSubscription_GetAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Services.TargetedContent.TargetedContentSubscription", "GetAsync", nullptr, py::site_is_static};
    ...
    static PyObject* TargetedContentSubscription_GetOptions(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Services.TargetedContent.TargetedContentSubscription", "GetOptions", nullptr, py::site_is_static};
