...
namespace py::cpp::Windows::Devices::Scanners
{
    ...
    static PyObject* ImageScanner_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Scanners.ImageScanner", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* ImageScanner_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Scanners.ImageScanner", "GetDeviceSelector", nullptr, py::site_is_static};
