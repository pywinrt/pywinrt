...
class RfcommDeviceService(winrt.system.Object, windows_foundation.IClosable, metaclass=RfcommDeviceService_Static):
    ...
    def get_sdp_raw_attributes_async(self) -> windows_foundation.IAsyncOperation[_cabc.Mapping[winrt.system.UInt32, winrt.system.Buffer]]: ...
    @typing.overload
    ...
    def get_sdp_raw_attributes_async(self, cache_mode: windows_devices_bluetooth.BluetoothCacheMode, /) -> windows_foundation.IAsyncOperation[_cabc.Mapping[winrt.system.UInt32, winrt.system.Buffer]]: ...
    ...
    def get_sdp_raw_attributes_with_cache_mode_async(self, cache_mode: windows_devices_bluetooth.BluetoothCacheMode, /) -> windows_foundation.IAsyncOperation[_cabc.Mapping[winrt.system.UInt32, winrt.system.Buffer]]: ...
...
class RfcommServiceProvider(winrt.system.Object, metaclass=RfcommServiceProvider_Static):
    ...
    @_property
    def sdp_raw_attributes(self) -> _cabc.MutableMapping[winrt.system.UInt32, winrt.system.Buffer]: ...
