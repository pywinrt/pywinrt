...
class RichEditTextDocument(winrt.system.Object, ITextDocument):
    ...
    def get_range_from_point(self, point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], options: PointOptions, /) -> ITextRange: ...
...
class RichEditTextRange(winrt.system.Object, ITextRange):
    ...
    def get_rect(self, options: PointOptions, /) -> tuple[windows_foundation.Rect, winrt.system.Int32]: ...
    ...
    def set_point(self, point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], options: PointOptions, extend: bool, /) -> None: ...
...
class ITextCharacterFormat(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def foreground_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
...
class ITextParagraphFormat(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def get_tab(self, index: winrt.system.Int32, /) -> tuple[winrt.system.Single, TabAlignment, TabLeader]: ...
