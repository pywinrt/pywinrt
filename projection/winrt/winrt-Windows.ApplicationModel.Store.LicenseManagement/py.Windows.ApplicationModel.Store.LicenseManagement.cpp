...
namespace py::cpp::Windows::ApplicationModel::Store::LicenseManagement
{
    ...
    static PyObject* LicenseManager_AddLicenseAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.Store.LicenseManagement.LicenseManager", "AddLicenseAsync", nullptr, py::site_is_static};
    ...
    static PyObject* LicenseManager_GetSatisfactionInfosAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.ApplicationModel.Store.LicenseManagement.LicenseManager", "GetSatisfactionInfosAsync", nullptr, py::site_is_static};
    ...
    static PyObject* LicenseManager_RefreshLicensesAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.Store.LicenseManagement.LicenseManager", "RefreshLicensesAsync", nullptr, py::site_is_static};
