...
class AppRecordingManager(winrt.system.Object, metaclass=AppRecordingManager_Static):
    ...
    def save_screenshot_to_files_async(self, folder: windows_storage.StorageFolder, filename_prefix: str, option: AppRecordingSaveScreenshotOption, requested_formats: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[AppRecordingSaveScreenshotResult]: ...
    ...
    @_property
    def supported_screenshot_media_encoding_subtypes(self) -> _cabc.Sequence[str]: ...
...
class AppRecordingSaveScreenshotResult(winrt.system.Object):
    ...
    @_property
    def saved_screenshot_infos(self) -> _cabc.Sequence[AppRecordingSavedScreenshotInfo]: ...
