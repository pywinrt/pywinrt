...
namespace py::cpp::Windows::UI::Input::Preview::Injection
{
    ...
    static PyObject* InputInjector_InitializeGamepadInjection(py::wrapper::Windows::UI::Input::Preview::Injection::InputInjector* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::UI::Input::Preview::Injection::IInputInjector2>(self->obj, py::member_kind::method, "Windows.UI.Input.Preview.Injection.InputInjector", "InitializeGamepadInjection", "Windows.UI.Input.Preview.Injection.IInputInjector2", 0).InitializeGamepadInjection();
                }
    ...
    static PyObject* InputInjector_InjectGamepadInput(py::wrapper::Windows::UI::Input::Preview::Injection::InputInjector* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            try
            {
                ...
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::UI::Input::Preview::Injection::IInputInjector2>(self->obj, py::member_kind::method, "Windows.UI.Input.Preview.Injection.InputInjector", "InjectGamepadInput", "Windows.UI.Input.Preview.Injection.IInputInjector2", 1).InjectGamepadInput(param0);
                }
    ...
    static PyObject* InputInjector_TryCreate(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.UI.Input.Preview.Injection.InputInjector", "TryCreate", nullptr, py::site_is_static};
    ...
    static PyObject* InputInjector_TryCreateForAppBroadcastOnly(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.UI.Input.Preview.Injection.InputInjector", "TryCreateForAppBroadcastOnly", nullptr, py::site_is_static};
    ...
    static PyObject* InputInjector_UninitializeGamepadInjection(py::wrapper::Windows::UI::Input::Preview::Injection::InputInjector* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::UI::Input::Preview::Injection::IInputInjector2>(self->obj, py::member_kind::method, "Windows.UI.Input.Preview.Injection.InputInjector", "UninitializeGamepadInjection", "Windows.UI.Input.Preview.Injection.IInputInjector2", 0).UninitializeGamepadInjection();
                }
