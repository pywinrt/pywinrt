...
class EdgeGesture(winrt.system.Object, metaclass=EdgeGesture_Static):
    ...
    def remove_canceled(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_starting(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PointerPoint_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_intermediate_points(cls, pointer_id: winrt.system.UInt32, /) -> _cabc.MutableSequence[PointerPoint]: ...
    @typing.overload
    ...
    def get_intermediate_points(cls, pointer_id: winrt.system.UInt32, transform: IPointerPointTransform, /) -> _cabc.MutableSequence[PointerPoint]: ...
    # Deprecated alias of get_intermediate_points() for pywinrt v3.x compatibility.
    # Windows.Foundation.Collections.IVector`1<Windows.UI.Input.PointerPoint> Windows.UI.Input.PointerPoint::GetIntermediatePoints(System.UInt32,Windows.UI.Input.IPointerPointTransform)
    @deprecated("Use get_intermediate_points() instead.")
    def get_intermediate_points_transformed(cls, pointer_id: winrt.system.UInt32, transform: IPointerPointTransform, /) -> _cabc.MutableSequence[PointerPoint]: ...
...
class RadialController(winrt.system.Object, metaclass=RadialController_Static):
    ...
    def remove_button_clicked(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_control_acquired(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_control_lost(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_rotation_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_screen_contact_continued(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_screen_contact_ended(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_screen_contact_started(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_button_holding(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_button_pressed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_button_released(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class RadialControllerConfiguration(winrt.system.Object, metaclass=RadialControllerConfiguration_Static):
    ...
    def set_default_menu_items(self, buttons: _cabc.Iterable[RadialControllerSystemMenuItemKind], /) -> None: ...
...
class SystemButtonEventController(AttachableInputObject, metaclass=SystemButtonEventController_Static):
    ...
    def remove_system_function_button_pressed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_system_function_button_released(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_system_function_lock_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_system_function_lock_indicator_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class TouchpadGesturesController(winrt.system.Object, metaclass=TouchpadGesturesController_Static):
    ...
    def remove_global_action_performed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
