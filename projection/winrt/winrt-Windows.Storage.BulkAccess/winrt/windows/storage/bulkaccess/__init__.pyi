...
class FileInformationFactory(winrt.system.Object):
    @typing.overload
    def __new__(cls, query_result: windows_storage_search.IStorageQueryResultBase, mode: windows_storage_fileproperties.ThumbnailMode) -> typing.Self: ...
    @typing.overload
    def __new__(cls, query_result: windows_storage_search.IStorageQueryResultBase, mode: windows_storage_fileproperties.ThumbnailMode, requested_thumbnail_size: winrt.system.UInt32) -> typing.Self: ...
    @typing.overload
    def __new__(cls, query_result: windows_storage_search.IStorageQueryResultBase, mode: windows_storage_fileproperties.ThumbnailMode, requested_thumbnail_size: winrt.system.UInt32, thumbnail_options: windows_storage_fileproperties.ThumbnailOptions) -> typing.Self: ...
    @typing.overload
    def __new__(cls, query_result: windows_storage_search.IStorageQueryResultBase, mode: windows_storage_fileproperties.ThumbnailMode, requested_thumbnail_size: winrt.system.UInt32, thumbnail_options: windows_storage_fileproperties.ThumbnailOptions, delay_load: bool) -> typing.Self: ...
    @typing.overload
