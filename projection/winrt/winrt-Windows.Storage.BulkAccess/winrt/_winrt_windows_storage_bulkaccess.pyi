...
class FileInformation(winrt.system.Object, windows_storage.IStorageFile2, windows_storage.IStorageFilePropertiesWithAvailability, windows_storage.IStorageItemPropertiesWithProvider, windows_storage.IStorageItem2, windows_storage.IStorageItemProperties, windows_storage.IStorageFile, windows_storage_streams.IInputStreamReference, windows_storage_streams.IRandomAccessStreamReference, windows_storage.IStorageItem, IStorageItemInformation):
    ...
    def copy_async(self, destination_folder: windows_storage.IStorageFolder, /) -> windows_foundation.IAsyncOperation[windows_storage.StorageFile]: ...
    @typing.overload
    ...
    def copy_async(self, destination_folder: windows_storage.IStorageFolder, desired_new_name: str, /) -> windows_foundation.IAsyncOperation[windows_storage.StorageFile]: ...
    @typing.overload
    ...
    def copy_async(self, destination_folder: windows_storage.IStorageFolder, desired_new_name: str, option: windows_storage.NameCollisionOption, /) -> windows_foundation.IAsyncOperation[windows_storage.StorageFile]: ...
    ...
    def move_async(self, destination_folder: windows_storage.IStorageFolder, /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    ...
    def move_async(self, destination_folder: windows_storage.IStorageFolder, desired_new_name: str, /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    ...
    def move_async(self, destination_folder: windows_storage.IStorageFolder, desired_new_name: str, option: windows_storage.NameCollisionOption, /) -> windows_foundation.IAsyncAction: ...
    ...
    def remove_properties_updated(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_thumbnail_updated(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class FileInformationFactory(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], query_result: windows_storage_search.IStorageQueryResultBase, mode: windows_storage_fileproperties.ThumbnailMode) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], query_result: windows_storage_search.IStorageQueryResultBase, mode: windows_storage_fileproperties.ThumbnailMode, requested_thumbnail_size: winrt.system.UInt32) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], query_result: windows_storage_search.IStorageQueryResultBase, mode: windows_storage_fileproperties.ThumbnailMode, requested_thumbnail_size: winrt.system.UInt32, thumbnail_options: windows_storage_fileproperties.ThumbnailOptions) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], query_result: windows_storage_search.IStorageQueryResultBase, mode: windows_storage_fileproperties.ThumbnailMode, requested_thumbnail_size: winrt.system.UInt32, thumbnail_options: windows_storage_fileproperties.ThumbnailOptions, delay_load: bool) -> Self: ...
    @typing.overload
    ...
    def get_files_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[FileInformation]]: ...
    @typing.overload
    ...
    def get_files_async(self, start_index: winrt.system.UInt32, max_items_to_retrieve: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[FileInformation]]: ...
    # Deprecated alias of get_files_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.BulkAccess.FileInformation>> Windows.Storage.BulkAccess.FileInformationFactory::GetFilesAsync()
    @deprecated("Use get_files_async() instead.")
    def get_files_async_default_start_and_count(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[FileInformation]]: ...
    @typing.overload
    ...
    def get_folders_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[FolderInformation]]: ...
    @typing.overload
    ...
    def get_folders_async(self, start_index: winrt.system.UInt32, max_items_to_retrieve: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[FolderInformation]]: ...
    # Deprecated alias of get_folders_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.BulkAccess.FolderInformation>> Windows.Storage.BulkAccess.FileInformationFactory::GetFoldersAsync()
    @deprecated("Use get_folders_async() instead.")
    def get_folders_async_default_start_and_count(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[FolderInformation]]: ...
    @typing.overload
    ...
    def get_items_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[IStorageItemInformation]]: ...
    @typing.overload
    ...
    def get_items_async(self, start_index: winrt.system.UInt32, max_items_to_retrieve: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[IStorageItemInformation]]: ...
    # Deprecated alias of get_items_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.BulkAccess.IStorageItemInformation>> Windows.Storage.BulkAccess.FileInformationFactory::GetItemsAsync()
    @deprecated("Use get_items_async() instead.")
    def get_items_async_default_start_and_count(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[IStorageItemInformation]]: ...
...
class FolderInformation(winrt.system.Object, windows_storage.IStorageItemPropertiesWithProvider, windows_storage.IStorageFolder2, windows_storage.IStorageItem2, windows_storage_search.IStorageFolderQueryOperations, windows_storage.IStorageItemProperties, windows_storage.IStorageFolder, windows_storage.IStorageItem, IStorageItemInformation):
    ...
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.StorageFile>> Windows.Storage.BulkAccess.FolderInformation::GetFilesAsync()
    @deprecated("Use get_files_async() instead.")
    def get_files_async_overload_default_options_start_and_count(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFile]]: ...
    # Deprecated alias of get_files_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.StorageFile>> Windows.Storage.BulkAccess.FolderInformation::GetFilesAsync(Windows.Storage.Search.CommonFileQuery)
    @deprecated("Use get_files_async() instead.")
    def get_files_async_overload_default_start_and_count(self, query: windows_storage_search.CommonFileQuery, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFile]]: ...
    ...
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.StorageFolder>> Windows.Storage.BulkAccess.FolderInformation::GetFoldersAsync()
    @deprecated("Use get_folders_async() instead.")
    def get_folders_async_overload_default_options_start_and_count(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFolder]]: ...
    # Deprecated alias of get_folders_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.StorageFolder>> Windows.Storage.BulkAccess.FolderInformation::GetFoldersAsync(Windows.Storage.Search.CommonFolderQuery)
    @deprecated("Use get_folders_async() instead.")
    def get_folders_async_overload_default_start_and_count(self, query: windows_storage_search.CommonFolderQuery, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.StorageFolder]]: ...
    ...
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.IStorageItem>> Windows.Storage.BulkAccess.FolderInformation::GetItemsAsync()
    @deprecated("Use get_items_async() instead.")
    def get_items_async_overload_default_start_and_count(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.IStorageItem]]: ...
    ...
    def try_get_item_async(self, name: str, /) -> windows_foundation.IAsyncOperation[windows_storage.IStorageItem | None]: ...
