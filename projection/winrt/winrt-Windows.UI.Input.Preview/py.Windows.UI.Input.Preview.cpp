...
namespace py::cpp::Windows::UI::Input::Preview
{
    ...
    static PyObject* InputActivationListenerPreview_CreateForApplicationWindow(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.UI.Input.Preview.InputActivationListenerPreview", "CreateForApplicationWindow", nullptr, py::site_is_static};
