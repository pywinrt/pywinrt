            ...
            {
                {
                    ...
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Windows.UI.Input.Inking.Preview.PalmRejectionDelayZonePreview", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
