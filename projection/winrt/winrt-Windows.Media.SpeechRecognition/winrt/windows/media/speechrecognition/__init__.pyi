...
class SpeechContinuousRecognitionSession(winrt.system.Object):
    ...
    def remove_completed(self, value: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_result_generated(self, value: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class SpeechRecognitionGrammarFileConstraint(winrt.system.Object, ISpeechRecognitionConstraint):
    @typing.overload
    def __new__(cls: type[Self], file: windows_storage.StorageFile) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], file: windows_storage.StorageFile, tag: str) -> Self: ...
...
class SpeechRecognitionListConstraint(winrt.system.Object, ISpeechRecognitionConstraint):
    @typing.overload
    def __new__(cls: type[Self], commands: _cabc.Iterable[str]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], commands: _cabc.Iterable[str], tag: str) -> Self: ...
    ...
    @_property
    def commands(self) -> _cabc.MutableSequence[str]: ...
...
class SpeechRecognitionResult(winrt.system.Object):
    ...
    @_property
    def rule_path(self) -> _cabc.Sequence[str]: ...
...
class SpeechRecognitionTopicConstraint(winrt.system.Object, ISpeechRecognitionConstraint):
    @typing.overload
    def __new__(cls: type[Self], scenario: SpeechRecognitionScenario, topic_hint: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], scenario: SpeechRecognitionScenario, topic_hint: str, tag: str) -> Self: ...
...
class SpeechRecognizer_Static(winrt._winrt.IInspectable_Static):
    ...
    @_property
    def supported_grammar_languages(cls) -> _cabc.Sequence[windows_globalization.Language]: ...
    ...
    @_property
    def supported_topic_languages(cls) -> _cabc.Sequence[windows_globalization.Language]: ...
...
class SpeechRecognizer(winrt.system.Object, windows_foundation.IClosable, metaclass=SpeechRecognizer_Static):
    ...
    @typing.overload
    def __new__(cls: type[Self], language: windows_globalization.Language) -> Self: ...
    @typing.overload
    ...
    def remove_recognition_quality_degrading(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_hypothesis_generated(self, value: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def constraints(self) -> _cabc.MutableSequence[ISpeechRecognitionConstraint]: ...
