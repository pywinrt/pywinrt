            ...
            {
                {
                    ...
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Windows.UI.Composition.Core.CompositorController", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
