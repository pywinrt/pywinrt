...
namespace py::cpp::Windows::UI::Composition::Core
{
    ...
    static PyObject* CompositorController_Close(py::wrapper::Windows::UI::Composition::Core::CompositorController* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                ...
                {
                    is_overload_present = winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Composition.Core.CompositorController", L"Close", 0);
                }
    ...
    static PyObject* CompositorController_Commit(py::wrapper::Windows::UI::Composition::Core::CompositorController* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                ...
                if (!is_overload_present.has_value())
                {
                    is_overload_present = winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Composition.Core.CompositorController", L"Commit", 0);
                }
    ...
    static PyObject* CompositorController_EnsurePreviousCommitCompletedAsync(py::wrapper::Windows::UI::Composition::Core::CompositorController* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                ...
                if (!is_overload_present.has_value())
                {
                    is_overload_present = winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Windows.UI.Composition.Core.CompositorController", L"EnsurePreviousCommitCompletedAsync", 0);
                }
    ...
    static PyObject* CompositorController_get_Compositor(py::wrapper::Windows::UI::Composition::Core::CompositorController* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                is_property_present = winrt::Windows::Foundation::Metadata::ApiInformation::IsPropertyPresent(L"Windows.UI.Composition.Core.CompositorController", L"Compositor");
            }
    ...
    static PyObject* CompositorController_add_CommitNeeded(py::wrapper::Windows::UI::Composition::Core::CompositorController* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            {
                is_event_present = winrt::Windows::Foundation::Metadata::ApiInformation::IsEventPresent(L"Windows.UI.Composition.Core.CompositorController", L"CommitNeeded");
            }
