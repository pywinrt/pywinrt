...
class BitmapTypedValue(winrt.system.Object):
    def __new__(cls, value: winrt.system.Object, type: windows_foundation.PropertyType) -> typing.Self: ...
...
class SoftwareBitmap(winrt.system.Object, windows_foundation.IClosable, metaclass=SoftwareBitmap_Static):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    @typing.overload
    def __new__(cls, format: BitmapPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32) -> typing.Self: ...
    @typing.overload
    def __new__(cls, format: BitmapPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32, alpha: BitmapAlphaMode) -> typing.Self: ...
