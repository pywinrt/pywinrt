...
class BitmapCodecInformation(winrt.system.Object):
    ...
    @_property
    def file_extensions(self) -> _cabc.Sequence[str]: ...
...
class BitmapDecoder_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_decoder_information_enumerator(cls) -> _cabc.Sequence[BitmapCodecInformation]: ...
...
class BitmapEncoder_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_async(cls, encoder_id: _uuid.UUID, stream: windows_storage_streams.IRandomAccessStream, encoding_options: _cabc.Mapping[str, BitmapTypedValue] | _cabc.Iterable[windows_foundation_collections.IKeyValuePair[str, BitmapTypedValue]], /) -> windows_foundation.IAsyncOperation[BitmapEncoder]: ...
    # Deprecated alias of create_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Graphics.Imaging.BitmapEncoder> Windows.Graphics.Imaging.BitmapEncoder::CreateAsync(System.Guid,Windows.Storage.Streams.IRandomAccessStream,Windows.Foundation.Collections.IIterable`1<Windows.Foundation.Collections.IKeyValuePair`2<System.String,Windows.Graphics.Imaging.BitmapTypedValue>>)
    @deprecated("Use create_async() instead.")
    def create_with_encoding_options_async(cls, encoder_id: _uuid.UUID, stream: windows_storage_streams.IRandomAccessStream, encoding_options: _cabc.Mapping[str, BitmapTypedValue] | _cabc.Iterable[windows_foundation_collections.IKeyValuePair[str, BitmapTypedValue]], /) -> windows_foundation.IAsyncOperation[BitmapEncoder]: ...
    ...
    def get_encoder_information_enumerator(cls) -> _cabc.Sequence[BitmapCodecInformation]: ...
...
class BitmapEncoder(winrt.system.Object, metaclass=BitmapEncoder_Static):
    ...
    def go_to_next_frame_async(self, encoding_options: _cabc.Mapping[str, BitmapTypedValue] | _cabc.Iterable[windows_foundation_collections.IKeyValuePair[str, BitmapTypedValue]], /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of go_to_next_frame_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Graphics.Imaging.BitmapEncoder::GoToNextFrameAsync(Windows.Foundation.Collections.IIterable`1<Windows.Foundation.Collections.IKeyValuePair`2<System.String,Windows.Graphics.Imaging.BitmapTypedValue>>)
    @deprecated("Use go_to_next_frame_async() instead.")
    def go_to_next_frame_with_encoding_options_async(self, encoding_options: _cabc.Mapping[str, BitmapTypedValue] | _cabc.Iterable[windows_foundation_collections.IKeyValuePair[str, BitmapTypedValue]], /) -> windows_foundation.IAsyncAction: ...
    ...
    def set_pixel_data(self, pixel_format: BitmapPixelFormat, alpha_mode: BitmapAlphaMode, width: winrt.system.UInt32, height: winrt.system.UInt32, dpi_x: winrt.system.Double, dpi_y: winrt.system.Double, pixels: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> None: ...
...
class BitmapPropertySet(winrt.system.Object, winrt._winrt.MutableMapping[str, BitmapTypedValue]):
    ...
    def get_view(self) -> _cabc.Mapping[str, BitmapTypedValue]: ...
...
class BitmapTransform(winrt.system.Object):
    ...
    @bounds.setter
    def bounds(self, value: BitmapBounds | tuple[winrt.system.UInt32, winrt.system.UInt32, winrt.system.UInt32, winrt.system.UInt32]) -> None: ...

@typing.final
class BitmapTypedValue(winrt.system.Object):
    def __new__(cls: type[Self], value: winrt.system.Object, type: windows_foundation.PropertyType) -> Self: ...
...
class SoftwareBitmap(winrt.system.Object, windows_foundation.IClosable, metaclass=SoftwareBitmap_Static):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    @typing.overload
    def __new__(cls: type[Self], format: BitmapPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], format: BitmapPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32, alpha: BitmapAlphaMode) -> Self: ...
