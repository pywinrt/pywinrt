...
namespace py::cpp::Windows::Devices::Adc
{
    ...
    static PyObject* AdcController_GetControllersAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Adc.AdcController", "GetControllersAsync", nullptr, py::site_is_static};
    ...
    static PyObject* AdcController_GetDefaultAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Adc.AdcController", "GetDefaultAsync", nullptr, py::site_is_static};
