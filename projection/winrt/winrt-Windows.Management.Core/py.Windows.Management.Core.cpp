...
namespace py::cpp::Windows::Management::Core
{
    ...
    static PyObject* ApplicationDataManager_CreateForPackageFamily(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Management.Core.ApplicationDataManager", "CreateForPackageFamily", nullptr, py::site_is_static};
