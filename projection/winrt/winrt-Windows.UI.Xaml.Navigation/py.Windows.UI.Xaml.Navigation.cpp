...
namespace py::cpp::Windows::UI::Xaml::Navigation
{
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.UI.Xaml.Navigation.PageStackEntry", "SourcePageTypeProperty", nullptr, py::site_is_static};
