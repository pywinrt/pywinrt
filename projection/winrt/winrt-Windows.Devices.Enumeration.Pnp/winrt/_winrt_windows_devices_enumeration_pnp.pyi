...
class PnpObject_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_watcher(cls, type: PnpObjectType, requested_properties: _cabc.Iterable[str], /) -> PnpObjectWatcher: ...
    @typing.overload
    ...
    def create_watcher(cls, type: PnpObjectType, requested_properties: _cabc.Iterable[str], aqs_filter: str, /) -> PnpObjectWatcher: ...
    # Deprecated alias of create_watcher() for pywinrt v3.x compatibility.
    # Windows.Devices.Enumeration.Pnp.PnpObjectWatcher Windows.Devices.Enumeration.Pnp.PnpObject::CreateWatcher(Windows.Devices.Enumeration.Pnp.PnpObjectType,Windows.Foundation.Collections.IIterable`1<System.String>,System.String)
    @deprecated("Use create_watcher() instead.")
    def create_watcher_aqs_filter(cls, type: PnpObjectType, requested_properties: _cabc.Iterable[str], aqs_filter: str, /) -> PnpObjectWatcher: ...
    @typing.overload
    ...
    def find_all_async(cls, type: PnpObjectType, requested_properties: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[PnpObjectCollection]: ...
    @typing.overload
    ...
    def find_all_async(cls, type: PnpObjectType, requested_properties: _cabc.Iterable[str], aqs_filter: str, /) -> windows_foundation.IAsyncOperation[PnpObjectCollection]: ...
    # Deprecated alias of find_all_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.Enumeration.Pnp.PnpObjectCollection> Windows.Devices.Enumeration.Pnp.PnpObject::FindAllAsync(Windows.Devices.Enumeration.Pnp.PnpObjectType,Windows.Foundation.Collections.IIterable`1<System.String>,System.String)
    @deprecated("Use find_all_async() instead.")
    def find_all_async_aqs_filter(cls, type: PnpObjectType, requested_properties: _cabc.Iterable[str], aqs_filter: str, /) -> windows_foundation.IAsyncOperation[PnpObjectCollection]: ...
...
class PnpObjectCollection(winrt.system.Object, winrt._winrt.Sequence[PnpObject]):
    ...
    def __iter__(self) -> _cabc.Iterator[PnpObject]: ...
    @typing.overload
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[PnpObject] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def index_of(self, value: PnpObject, /) -> tuple[bool, winrt.system.UInt32]: ...
