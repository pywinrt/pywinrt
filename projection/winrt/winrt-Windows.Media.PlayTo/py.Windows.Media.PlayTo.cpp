...
namespace py::cpp::Windows::Media::PlayTo
{
    ...
    static PyObject* PlayToManager_GetForCurrentView(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Media.PlayTo.PlayToManager", "GetForCurrentView", nullptr, py::site_is_static};
    ...
    static PyObject* PlayToManager_ShowPlayToUI(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Media.PlayTo.PlayToManager", "ShowPlayToUI", nullptr, py::site_is_static};
