...
namespace py::cpp::Windows::Media::Ocr
{
    ...
    static PyObject* OcrEngine_IsLanguageSupported(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Media.Ocr.OcrEngine", "IsLanguageSupported", nullptr, py::site_is_static};
    ...
    static PyObject* OcrEngine_TryCreateFromLanguage(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Media.Ocr.OcrEngine", "TryCreateFromLanguage", nullptr, py::site_is_static};
    ...
    static PyObject* OcrEngine_TryCreateFromUserProfileLanguages(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Media.Ocr.OcrEngine", "TryCreateFromUserProfileLanguages", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.Media.Ocr.OcrEngine", "AvailableRecognizerLanguages", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.Media.Ocr.OcrEngine", "MaxImageDimension", nullptr, py::site_is_static};
