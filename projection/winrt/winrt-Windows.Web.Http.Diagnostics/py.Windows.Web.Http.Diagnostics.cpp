...
namespace py::cpp::Windows::Web::Http::Diagnostics
{
    ...
    static PyObject* HttpDiagnosticProvider_CreateFromProcessDiagnosticInfo(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Web.Http.Diagnostics.HttpDiagnosticProvider", "CreateFromProcessDiagnosticInfo", nullptr, py::site_is_static};
