...
class HttpDiagnosticProvider(winrt.system.Object, metaclass=HttpDiagnosticProvider_Static):
    ...
    def remove_request_response_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_request_sent(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_response_received(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class HttpDiagnosticProviderRequestResponseCompletedEventArgs(winrt.system.Object):
    ...
    @_property
    def source_locations(self) -> _cabc.Sequence[HttpDiagnosticSourceLocation]: ...
...
class HttpDiagnosticProviderRequestResponseTimestamps(winrt.system.Object):
    ...
    @_property
    def connection_completed_timestamp(self) -> datetime.datetime | None: ...
    ...
    @_property
    def connection_initiated_timestamp(self) -> datetime.datetime | None: ...
    ...
    @_property
    def name_resolved_timestamp(self) -> datetime.datetime | None: ...
    ...
    @_property
    def request_completed_timestamp(self) -> datetime.datetime | None: ...
    ...
    @_property
    def request_sent_timestamp(self) -> datetime.datetime | None: ...
    ...
    @_property
    def response_completed_timestamp(self) -> datetime.datetime | None: ...
    ...
    @_property
    def response_received_timestamp(self) -> datetime.datetime | None: ...
    ...
    @_property
    def ssl_negotiated_timestamp(self) -> datetime.datetime | None: ...
