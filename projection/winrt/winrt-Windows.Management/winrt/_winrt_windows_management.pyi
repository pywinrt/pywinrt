...
class MdmSession(winrt.system.Object):
    ...
    def start_async(self, alerts: _cabc.Iterable[MdmAlert], /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of start_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Management.MdmSession::StartAsync(Windows.Foundation.Collections.IIterable`1<Windows.Management.MdmAlert>)
    @deprecated("Use start_async() instead.")
    def start_with_alerts_async(self, alerts: _cabc.Iterable[MdmAlert], /) -> windows_foundation.IAsyncAction: ...
    # Windows.Foundation.Collections.IVectorView`1<Windows.Management.MdmAlert> Windows.Management.MdmSession::get_Alerts()
    @_property
    def alerts(self) -> _cabc.Sequence[MdmAlert]: ...
...
class MdmSessionManager_Static(winrt._winrt.IInspectable_Static):
    ...
    @_property
    def session_ids(cls) -> _cabc.Sequence[str]: ...
