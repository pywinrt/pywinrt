...
class CoreDragDropManager(winrt.system.Object, metaclass=CoreDragDropManager_Static):
    ...
    def remove_target_requested(self, value: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class CoreDragOperation(winrt.system.Object):
    ...
    def set_drag_ui_content_from_software_bitmap(self, software_bitmap: windows_graphics_imaging.SoftwareBitmap, anchor_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
    ...
    def set_drag_ui_content_from_software_bitmap_with_anchor_point(self, software_bitmap: windows_graphics_imaging.SoftwareBitmap, anchor_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
