...
namespace py::cpp::Windows::ApplicationModel::DataTransfer::DragDrop::Core
{
    ...
    static PyObject* CoreDragDropManager_GetForCurrentView(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.ApplicationModel.DataTransfer.DragDrop.Core.CoreDragDropManager", "GetForCurrentView", nullptr, py::site_is_static};
