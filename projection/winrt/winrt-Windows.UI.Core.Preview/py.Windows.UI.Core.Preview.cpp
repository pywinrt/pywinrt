...
namespace py::cpp::Windows::UI::Core::Preview
{
    ...
    static PyObject* CoreAppWindowPreview_GetIdFromWindow(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.UI.Core.Preview.CoreAppWindowPreview", "GetIdFromWindow", nullptr, py::site_is_static};
    ...
    static PyObject* SystemNavigationManagerPreview_GetForCurrentView(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.UI.Core.Preview.SystemNavigationManagerPreview", "GetForCurrentView", nullptr, py::site_is_static};
