...
class Buffer_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_memory_buffer_over_ibuffer(cls, input: IBuffer, /) -> windows_foundation.MemoryBuffer: ...
...
class DataWriter(winrt.system.Object, windows_foundation.IClosable, IDataWriter):
    ...
    def write_buffer_range(self, buffer: IBuffer, start: winrt.system.UInt32, count: winrt.system.UInt32, /) -> None: ...
...
class IPropertySetSerializer(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def deserialize(self, property_set: windows_foundation_collections.IPropertySet, buffer: IBuffer, /) -> None: ...
