...
class DataReader(winrt.system.Object, windows_foundation.IClosable, IDataReader, metaclass=DataReader_Static):
    ...
    def __new__(cls: type[Self], input_stream: IInputStream) -> Self: ...
    ...
    def read_bytes(self, value: winrt.system.Array[winrt.system.UInt8] | winrt.system.WriteableBuffer, /) -> None: ...
...
class DataWriter(winrt.system.Object, windows_foundation.IClosable, IDataWriter):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    @typing.overload
    def __new__(cls: type[Self], output_stream: IOutputStream) -> Self: ...
    @typing.overload
    ...
    def write_bytes(self, value: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> None: ...
