...
class ProcessDiagnosticInfo_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_for_processes(cls) -> _cabc.Sequence[ProcessDiagnosticInfo]: ...
    ...
    def try_get_for_process_id(cls, process_id: winrt.system.UInt32, /) -> ProcessDiagnosticInfo | None: ...
