...
namespace py::cpp::Windows::Devices::WiFi
{
    ...
    static PyObject* WiFiAdapter_FindAllAdaptersAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.WiFi.WiFiAdapter", "FindAllAdaptersAsync", nullptr, py::site_is_static};
    ...
    static PyObject* WiFiAdapter_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.WiFi.WiFiAdapter", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* WiFiAdapter_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.WiFi.WiFiAdapter", "GetDeviceSelector", nullptr, py::site_is_static};
    ...
    static PyObject* WiFiAdapter_RequestAccessAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.WiFi.WiFiAdapter", "RequestAccessAsync", nullptr, py::site_is_static};
    ...
    static PyObject* WiFiOnDemandHotspotNetwork_GetOrCreateById(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.WiFi.WiFiOnDemandHotspotNetwork", "GetOrCreateById", nullptr, py::site_is_static};
