...
class WiFiAdapter(winrt.system.Object, metaclass=WiFiAdapter_Static):
    ...
    def remove_available_networks_changed(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class WiFiOnDemandHotspotNetworkProperties(winrt.system.Object):
    ...
    @_property
    def remaining_battery_percent(self) -> winrt.system.UInt32 | None: ...
    ...
    def remaining_battery_percent(self, value: winrt.system.UInt32 | None) -> None: ...
    ...
    @_property
    def cellular_bars(self) -> WiFiOnDemandHotspotCellularBars | None: ...
    ...
    def cellular_bars(self, value: WiFiOnDemandHotspotCellularBars | None) -> None: ...
...
class WiFiWpsConfigurationResult(winrt.system.Object):
    ...
    @_property
    def supported_wps_kinds(self) -> _cabc.Sequence[WiFiWpsKind]: ...
