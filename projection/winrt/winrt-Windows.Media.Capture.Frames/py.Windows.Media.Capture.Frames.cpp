...
namespace py::cpp::Windows::Media::Capture::Frames
{
    ...
    static PyObject* MediaFrameSourceGroup_FindAllAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Media.Capture.Frames.MediaFrameSourceGroup", "FindAllAsync", nullptr, py::site_is_static};
    ...
    static PyObject* MediaFrameSourceGroup_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Media.Capture.Frames.MediaFrameSourceGroup", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* MediaFrameSourceGroup_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Media.Capture.Frames.MediaFrameSourceGroup", "GetDeviceSelector", nullptr, py::site_is_static};
