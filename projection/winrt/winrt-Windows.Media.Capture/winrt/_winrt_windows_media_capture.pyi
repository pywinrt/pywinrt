...
class WhiteBalanceGain:
    ...
    def unpack(self) -> tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double]: ...
...
class AdvancedCapturedPhoto(winrt.system.Object):
    ...
    @_property
    def frame_bounds_relative_to_reference_photo(self) -> windows_foundation.Rect | None: ...
...
class AdvancedPhotoCapture(winrt.system.Object):
    ...
    def capture_async(self, context: winrt.system.Object, /) -> windows_foundation.IAsyncOperation[AdvancedCapturedPhoto]: ...
    # Deprecated alias of capture_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Media.Capture.AdvancedCapturedPhoto> Windows.Media.Capture.AdvancedPhotoCapture::CaptureAsync(System.Object)
    @deprecated("Use capture_async() instead.")
    ...
    def remove_all_photos_captured(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_optional_reference_photo_captured(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AppBroadcastBackgroundService(winrt.system.Object):
    ...
    def remove_heartbeat_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_broadcast_channel_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_broadcast_language_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_broadcast_title_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AppBroadcastBackgroundServiceSignInInfo(winrt.system.Object):
    ...
    def remove_sign_in_state_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_user_name_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AppBroadcastBackgroundServiceStreamInfo(winrt.system.Object):
    ...
    def remove_stream_state_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_video_encoding_bitrate_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_video_encoding_resolution_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AppBroadcastPlugInManager(winrt.system.Object, metaclass=AppBroadcastPlugInManager_Static):
    ...
    @_property
    def plug_in_list(self) -> _cabc.Sequence[AppBroadcastPlugIn]: ...
...
class AppBroadcastPreview(winrt.system.Object):
    ...
    def remove_preview_state_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    # Windows.Foundation.IReference`1<System.UInt32> Windows.Media.Capture.AppBroadcastPreview::get_ErrorCode()
    @_property
    def error_code(self) -> winrt.system.UInt32 | None: ...
...
class AppBroadcastPreviewStreamReader(winrt.system.Object):
    ...
    def remove_video_frame_arrived(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AppBroadcastServices(winrt.system.Object):
    ...
    def start_preview(self, desired_size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> AppBroadcastPreview: ...
...
class AppBroadcastState(winrt.system.Object):
    ...
    def remove_camera_capture_state_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_capture_target_closed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_microphone_capture_state_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_plug_in_state_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_viewer_count_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AppBroadcastStreamReader(winrt.system.Object):
    ...
    def try_get_next_video_frame(self) -> AppBroadcastStreamVideoFrame | None: ...
    ...
    def remove_audio_frame_arrived(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AppCapture(winrt.system.Object, metaclass=AppCapture_Static):
    ...
    def remove_capturing_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AppCaptureMetadataWriter(winrt.system.Object, windows_foundation.IClosable):
    ...
    def remove_metadata_purged(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AppCaptureRecordOperation(winrt.system.Object):
    ...
    def remove_duration_generated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_file_generated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def is_file_truncated(self) -> bool | None: ...
...
class CapturedFrameControlValues(winrt.system.Object):
    ...
    @_property
    def white_balance_gain(self) -> WhiteBalanceGain | None: ...
...
class GameBarServices(winrt.system.Object):
    ...
    def remove_command_received(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class GameBarServicesManager(winrt.system.Object, metaclass=GameBarServicesManager_Static):
    ...
    def remove_game_bar_services_created(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class LowLagPhotoSequenceCapture(winrt.system.Object):
    ...
    def remove_photo_captured(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MediaCapture_Static(winrt._winrt.IInspectable_Static):
    ...
    def find_concurrent_profiles(cls, video_device_id: str, /) -> _cabc.Sequence[MediaCaptureVideoProfile]: ...
    ...
    def find_known_video_profiles(cls, video_device_id: str, name: KnownVideoProfile, /) -> _cabc.Sequence[MediaCaptureVideoProfile]: ...
...
class MediaCapture(winrt.system.Object, windows_foundation.IClosable, metaclass=MediaCapture_Static):
    ...
    def create_frame_reader_async(self, input_source: windows_media_capture_frames.MediaFrameSource, output_subtype: str, /) -> windows_foundation.IAsyncOperation[windows_media_capture_frames.MediaFrameReader]: ...
    @typing.overload
    ...
    def create_frame_reader_async(self, input_source: windows_media_capture_frames.MediaFrameSource, output_subtype: str, output_size: windows_graphics_imaging.BitmapSize | tuple[winrt.system.UInt32, winrt.system.UInt32], /) -> windows_foundation.IAsyncOperation[windows_media_capture_frames.MediaFrameReader]: ...
    ...
    def create_frame_reader_with_subtype_and_size_async(self, input_source: windows_media_capture_frames.MediaFrameSource, output_subtype: str, output_size: windows_graphics_imaging.BitmapSize | tuple[winrt.system.UInt32, winrt.system.UInt32], /) -> windows_foundation.IAsyncOperation[windows_media_capture_frames.MediaFrameReader]: ...
    # Deprecated alias of create_frame_reader_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Media.Capture.Frames.MediaFrameReader> Windows.Media.Capture.MediaCapture::CreateFrameReaderAsync(Windows.Media.Capture.Frames.MediaFrameSource,System.String)
    @deprecated("Use create_frame_reader_async() instead.")
    ...
    def create_multi_source_frame_reader_async(self, input_sources: _cabc.Iterable[windows_media_capture_frames.MediaFrameSource], /) -> windows_foundation.IAsyncOperation[windows_media_capture_frames.MultiSourceMediaFrameReader]: ...
    ...
    def get_preview_frame_async(self, destination: windows_media.VideoFrame, /) -> windows_foundation.IAsyncOperation[windows_media.VideoFrame]: ...
    # Deprecated alias of get_preview_frame_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Media.VideoFrame> Windows.Media.Capture.MediaCapture::GetPreviewFrameAsync(Windows.Media.VideoFrame)
    @deprecated("Use get_preview_frame_async() instead.")
    ...
    def initialize_async(self, media_capture_initialization_settings: MediaCaptureInitializationSettings, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of initialize_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Media.Capture.MediaCapture::InitializeAsync(Windows.Media.Capture.MediaCaptureInitializationSettings)
    ...
    def prepare_low_lag_record_to_custom_sink_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, custom_sink_activation_id: str, custom_sink_settings: windows_foundation_collections.IPropertySet, /) -> windows_foundation.IAsyncOperation[LowLagMediaRecording]: ...
    # Deprecated alias of prepare_low_lag_record_to_custom_sink_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Media.Capture.LowLagMediaRecording> Windows.Media.Capture.MediaCapture::PrepareLowLagRecordToCustomSinkAsync(Windows.Media.MediaProperties.MediaEncodingProfile,System.String,Windows.Foundation.Collections.IPropertySet)
    @deprecated("Use prepare_low_lag_record_to_custom_sink_async() instead.")
    ...
    def start_preview_to_custom_sink_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, custom_sink_activation_id: str, custom_sink_settings: windows_foundation_collections.IPropertySet, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of start_preview_to_custom_sink_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Media.Capture.MediaCapture::StartPreviewToCustomSinkAsync(Windows.Media.MediaProperties.MediaEncodingProfile,System.String,Windows.Foundation.Collections.IPropertySet)
    @deprecated("Use start_preview_to_custom_sink_async() instead.")
    ...
    def start_record_to_custom_sink_async(self, encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, custom_sink_activation_id: str, custom_sink_settings: windows_foundation_collections.IPropertySet, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of start_record_to_custom_sink_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Media.Capture.MediaCapture::StartRecordToCustomSinkAsync(Windows.Media.MediaProperties.MediaEncodingProfile,System.String,Windows.Foundation.Collections.IPropertySet)
    @deprecated("Use start_record_to_custom_sink_async() instead.")
    ...
    def remove_failed(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_record_limitation_exceeded(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_focus_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_photo_confirmation_captured(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_camera_stream_state_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_thermal_status_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_capture_device_exclusive_control_status_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def frame_sources(self) -> _cabc.Mapping[str, windows_media_capture_frames.MediaFrameSource]: ...
...
class MediaCaptureSettings(winrt.system.Object):
    ...
    @_property
    def horizontal35mm_equivalent_focal_length(self) -> winrt.system.UInt32 | None: ...
    ...
    @_property
    def pitch_offset_degrees(self) -> winrt.system.Int32 | None: ...
    ...
    @_property
    def vertical35mm_equivalent_focal_length(self) -> winrt.system.UInt32 | None: ...
...
class MediaCaptureVideoProfile(winrt.system.Object):
    ...
    @_property
    def supported_photo_media_description(self) -> _cabc.Sequence[MediaCaptureVideoProfileMediaDescription]: ...
    ...
    @_property
    def supported_preview_media_description(self) -> _cabc.Sequence[MediaCaptureVideoProfileMediaDescription]: ...
    ...
    @_property
    def supported_record_media_description(self) -> _cabc.Sequence[MediaCaptureVideoProfileMediaDescription]: ...
    ...
    @_property
    def frame_source_infos(self) -> _cabc.Sequence[windows_media_capture_frames.MediaFrameSourceInfo]: ...
