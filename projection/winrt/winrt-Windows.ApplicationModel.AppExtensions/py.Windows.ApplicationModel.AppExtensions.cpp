...
namespace py::cpp::Windows::ApplicationModel::AppExtensions
{
    ...
    static PyObject* AppExtensionCatalog_Open(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.AppExtensions.AppExtensionCatalog", "Open", nullptr, py::site_is_static};
