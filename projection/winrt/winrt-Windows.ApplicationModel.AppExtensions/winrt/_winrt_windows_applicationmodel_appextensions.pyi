...
class AppExtensionCatalog(winrt.system.Object, metaclass=AppExtensionCatalog_Static):
    ...
    def find_all_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppExtension]]: ...
    ...
    def remove_package_installed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_package_updated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AppExtensionPackageInstalledEventArgs(winrt.system.Object):
    ...
    @_property
    def extensions(self) -> _cabc.Sequence[AppExtension]: ...
