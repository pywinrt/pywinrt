...
class AppInstallManager(winrt.system.Object):
    ...
    def search_for_all_updates_async(self, correlation_vector: str, /) -> windows_foundation.IAsyncOperation[typing.Sequence[AppInstallItem]]: ...
    @typing.overload
    ...
    def search_for_all_updates_async(self, correlation_vector: str, client_id: str, update_options: AppUpdateOptions, /) -> windows_foundation.IAsyncOperation[typing.Sequence[AppInstallItem]]: ...
    ...
    def search_for_all_updates_for_user_async(self, user: windows_system.User, correlation_vector: str, client_id: str, update_options: AppUpdateOptions, /) -> windows_foundation.IAsyncOperation[typing.Sequence[AppInstallItem]]: ...
    ...
    def start_product_install_async(self, product_id: str, flight_id: str, client_id: str, correlation_vector: str, install_options: AppInstallOptions, /) -> windows_foundation.IAsyncOperation[typing.Sequence[AppInstallItem]]: ...
    @typing.overload
    ...
    def start_product_install_for_user_async(self, user: windows_system.User, product_id: str, flight_id: str, client_id: str, correlation_vector: str, install_options: AppInstallOptions, /) -> windows_foundation.IAsyncOperation[typing.Sequence[AppInstallItem]]: ...
    @typing.overload
