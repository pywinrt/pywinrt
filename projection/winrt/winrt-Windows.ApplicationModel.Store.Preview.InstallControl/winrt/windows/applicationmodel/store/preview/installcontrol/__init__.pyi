...
class AppInstallItem(winrt.system.Object):
    ...
    # Deprecated alias of cancel() for pywinrt v3.x compatibility.
    # System.Void Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallItem::Cancel(System.String)
    ...
    # Deprecated alias of pause() for pywinrt v3.x compatibility.
    # System.Void Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallItem::Pause(System.String)
    ...
    # Deprecated alias of restart() for pywinrt v3.x compatibility.
    # System.Void Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallItem::Restart(System.String)
    ...
    @_property
    def children(self) -> _cabc.Sequence[AppInstallItem]: ...
...
class AppInstallManager(winrt.system.Object):
    ...
    # Deprecated alias of get_is_app_allowed_to_install_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallManager::GetIsAppAllowedToInstallAsync(System.String,System.String,System.String,System.String)
    @deprecated("Use get_is_app_allowed_to_install_async() instead.")
    ...
    def search_for_all_updates_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    @typing.overload
    ...
    def search_for_all_updates_async(self, correlation_vector: str, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    @typing.overload
    ...
    def search_for_all_updates_async(self, correlation_vector: str, client_id: str, update_options: AppUpdateOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    # Deprecated alias of search_for_all_updates_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallItem>> Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallManager::SearchForAllUpdatesAsync(System.String)
    @deprecated("Use search_for_all_updates_async() instead.")
    def search_for_all_updates_with_telemetry_async(self, correlation_vector: str, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    # Deprecated alias of search_for_all_updates_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallItem>> Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallManager::SearchForAllUpdatesAsync(System.String,System.String,Windows.ApplicationModel.Store.Preview.InstallControl.AppUpdateOptions)
    @deprecated("Use search_for_all_updates_async() instead.")
    def search_for_all_updates_with_update_options_async(self, correlation_vector: str, client_id: str, update_options: AppUpdateOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    @typing.overload
    ...
    def search_for_all_updates_for_user_async(self, user: windows_system.User, correlation_vector: str, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    @typing.overload
    ...
    def search_for_all_updates_for_user_async(self, user: windows_system.User, correlation_vector: str, client_id: str, update_options: AppUpdateOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    # Deprecated alias of search_for_all_updates_for_user_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallItem>> Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallManager::SearchForAllUpdatesForUserAsync(Windows.System.User,System.String,System.String,Windows.ApplicationModel.Store.Preview.InstallControl.AppUpdateOptions)
    @deprecated("Use search_for_all_updates_for_user_async() instead.")
    def search_for_all_updates_with_update_options_for_user_async(self, user: windows_system.User, correlation_vector: str, client_id: str, update_options: AppUpdateOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    @typing.overload
    ...
    def search_for_updates_async(self, product_id: str, sku_id: str, correlation_vector: str, client_id: str, update_options: AppUpdateOptions, /) -> windows_foundation.IAsyncOperation[AppInstallItem]: ...
    # Deprecated alias of search_for_updates_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallItem> Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallManager::SearchForUpdatesAsync(System.String,System.String,System.String,System.String)
    @deprecated("Use search_for_updates_async() instead.")
    ...
    def search_for_updates_for_user_async(self, user: windows_system.User, product_id: str, sku_id: str, correlation_vector: str, client_id: str, update_options: AppUpdateOptions, /) -> windows_foundation.IAsyncOperation[AppInstallItem]: ...
    # Deprecated alias of search_for_updates_for_user_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallItem> Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallManager::SearchForUpdatesForUserAsync(Windows.System.User,System.String,System.String,System.String,System.String,Windows.ApplicationModel.Store.Preview.InstallControl.AppUpdateOptions)
    @deprecated("Use search_for_updates_for_user_async() instead.")
    ...
    # Deprecated alias of start_app_install_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallItem> Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallManager::StartAppInstallAsync(System.String,System.String,System.Boolean,System.Boolean,System.String,System.String,System.String)
    @deprecated("Use start_app_install_async() instead.")
    ...
    def start_product_install_async(self, product_id: str, flight_id: str, client_id: str, correlation_vector: str, install_options: AppInstallOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    @typing.overload
    ...
    def start_product_install_async(self, product_id: str, catalog_id: str, flight_id: str, client_id: str, repair: bool, force_use_of_non_removable_storage: bool, correlation_vector: str, target_volume: windows_management_deployment.PackageVolume, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    # Deprecated alias of start_product_install_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallItem>> Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallManager::StartProductInstallAsync(System.String,System.String,System.String,System.String,Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallOptions)
    @deprecated("Use start_product_install_async() instead.")
    def start_product_install_with_options_async(self, product_id: str, flight_id: str, client_id: str, correlation_vector: str, install_options: AppInstallOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    @typing.overload
    ...
    def start_product_install_for_user_async(self, user: windows_system.User, product_id: str, flight_id: str, client_id: str, correlation_vector: str, install_options: AppInstallOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    @typing.overload
    ...
    def start_product_install_for_user_async(self, user: windows_system.User, product_id: str, catalog_id: str, flight_id: str, client_id: str, repair: bool, force_use_of_non_removable_storage: bool, correlation_vector: str, target_volume: windows_management_deployment.PackageVolume, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    # Deprecated alias of start_product_install_for_user_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallItem>> Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallManager::StartProductInstallForUserAsync(Windows.System.User,System.String,System.String,System.String,System.String,Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallOptions)
    @deprecated("Use start_product_install_for_user_async() instead.")
    def start_product_install_with_options_for_user_async(self, user: windows_system.User, product_id: str, flight_id: str, client_id: str, correlation_vector: str, install_options: AppInstallOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppInstallItem]]: ...
    @typing.overload
    ...
    # Deprecated alias of update_app_by_package_family_name_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallItem> Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallManager::UpdateAppByPackageFamilyNameAsync(System.String,System.String)
    @deprecated("Use update_app_by_package_family_name_async() instead.")
    ...
    def remove_item_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_item_status_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def app_install_items(self) -> _cabc.Sequence[AppInstallItem]: ...
    ...
    @_property
    def app_install_items_with_group_support(self) -> _cabc.Sequence[AppInstallItem]: ...
