...
class GameService_Static(winrt._winrt.IInspectable_Static):
    ...
    def post_result(cls, game_variant: winrt.system.UInt32, score_kind: GameServiceScoreKind, score_value: winrt.system.Int64, game_outcome: GameServiceGameOutcome, buffer: winrt.system.Buffer, /) -> None: ...
