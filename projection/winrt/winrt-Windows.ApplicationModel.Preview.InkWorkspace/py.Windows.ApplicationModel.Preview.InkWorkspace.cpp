...
namespace py::cpp::Windows::ApplicationModel::Preview::InkWorkspace
{
    ...
    static PyObject* InkWorkspaceHostedAppManager_GetForCurrentApp(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.ApplicationModel.Preview.InkWorkspace.InkWorkspaceHostedAppManager", "GetForCurrentApp", nullptr, py::site_is_static};
