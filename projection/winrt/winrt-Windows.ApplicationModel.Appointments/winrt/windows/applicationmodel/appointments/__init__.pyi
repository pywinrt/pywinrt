...
class Appointment(winrt.system.Object):
    ...
    @_property
    def reminder(self) -> datetime.timedelta | None: ...
    ...
    @reminder.setter
    def reminder(self, value: datetime.timedelta | None) -> None: ...
    ...
    @_property
    def invitees(self) -> _cabc.MutableSequence[AppointmentInvitee]: ...
    ...
    @_property
    def reply_time(self) -> datetime.datetime | None: ...
    ...
    @reply_time.setter
    def reply_time(self, value: datetime.datetime | None) -> None: ...
    ...
    @_property
    def original_start_time(self) -> datetime.datetime | None: ...
...
class AppointmentCalendar(winrt.system.Object):
    ...
    def find_all_instances_async(self, master_local_id: str, range_start: datetime.datetime, range_length: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[Appointment]]: ...
    @typing.overload
    ...
    def find_all_instances_async(self, master_local_id: str, range_start: datetime.datetime, range_length: datetime.timedelta, p_options: FindAppointmentsOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[Appointment]]: ...
    # Deprecated alias of find_all_instances_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Appointments.Appointment>> Windows.ApplicationModel.Appointments.AppointmentCalendar::FindAllInstancesAsync(System.String,Windows.Foundation.DateTime,Windows.Foundation.TimeSpan,Windows.ApplicationModel.Appointments.FindAppointmentsOptions)
    @deprecated("Use find_all_instances_async() instead.")
    def find_all_instances_async_with_options(self, master_local_id: str, range_start: datetime.datetime, range_length: datetime.timedelta, p_options: FindAppointmentsOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[Appointment]]: ...
    @typing.overload
    ...
    def find_appointments_async(self, range_start: datetime.datetime, range_length: datetime.timedelta, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[Appointment]]: ...
    @typing.overload
    ...
    def find_appointments_async(self, range_start: datetime.datetime, range_length: datetime.timedelta, options: FindAppointmentsOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[Appointment]]: ...
    # Deprecated alias of find_appointments_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Appointments.Appointment>> Windows.ApplicationModel.Appointments.AppointmentCalendar::FindAppointmentsAsync(Windows.Foundation.DateTime,Windows.Foundation.TimeSpan,Windows.ApplicationModel.Appointments.FindAppointmentsOptions)
    @deprecated("Use find_appointments_async() instead.")
    def find_appointments_async_with_options(self, range_start: datetime.datetime, range_length: datetime.timedelta, options: FindAppointmentsOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[Appointment]]: ...
    ...
    def find_exceptions_from_master_async(self, master_local_id: str, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppointmentException]]: ...
    @typing.overload
    ...
    def find_unexpanded_appointments_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[Appointment]]: ...
    @typing.overload
    ...
    def find_unexpanded_appointments_async(self, options: FindAppointmentsOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[Appointment]]: ...
    # Deprecated alias of find_unexpanded_appointments_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Appointments.Appointment>> Windows.ApplicationModel.Appointments.AppointmentCalendar::FindUnexpandedAppointmentsAsync(Windows.ApplicationModel.Appointments.FindAppointmentsOptions)
    @deprecated("Use find_unexpanded_appointments_async() instead.")
    def find_unexpanded_appointments_async_with_options(self, options: FindAppointmentsOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[Appointment]]: ...
    ...
    def try_forward_meeting_async(self, meeting: Appointment, invitees: _cabc.Iterable[AppointmentInvitee], subject: str, forward_header: str, comment: str, /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def display_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
...
class AppointmentException(winrt.system.Object):
    ...
    @_property
    def exception_properties(self) -> _cabc.Sequence[str]: ...
...
class AppointmentManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def show_add_appointment_async(cls, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    def show_add_appointment_async(cls, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
    # Deprecated alias of show_add_appointment_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.String> Windows.ApplicationModel.Appointments.AppointmentManager::ShowAddAppointmentAsync(Windows.ApplicationModel.Appointments.Appointment,Windows.Foundation.Rect,Windows.UI.Popups.Placement)
    @deprecated("Use show_add_appointment_async() instead.")
    def show_add_appointment_with_placement_async(cls, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    def show_appointment_details_async(cls, appointment_id: str, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of show_appointment_details_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.ApplicationModel.Appointments.AppointmentManager::ShowAppointmentDetailsAsync(System.String,Windows.Foundation.DateTime)
    @deprecated("Use show_appointment_details_async() instead.")
    ...
    def show_remove_appointment_async(cls, appointment_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def show_remove_appointment_async(cls, appointment_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def show_remove_appointment_async(cls, appointment_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of show_remove_appointment_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.ApplicationModel.Appointments.AppointmentManager::ShowRemoveAppointmentAsync(System.String,Windows.Foundation.Rect,Windows.UI.Popups.Placement,Windows.Foundation.DateTime)
    @deprecated("Use show_remove_appointment_async() instead.")
    def show_remove_appointment_with_placement_and_date_async(cls, appointment_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of show_remove_appointment_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.ApplicationModel.Appointments.AppointmentManager::ShowRemoveAppointmentAsync(System.String,Windows.Foundation.Rect,Windows.UI.Popups.Placement)
    @deprecated("Use show_remove_appointment_async() instead.")
    def show_remove_appointment_with_placement_async(cls, appointment_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def show_replace_appointment_async(cls, appointment_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    def show_replace_appointment_async(cls, appointment_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    def show_replace_appointment_async(cls, appointment_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[str]: ...
    # Deprecated alias of show_replace_appointment_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.String> Windows.ApplicationModel.Appointments.AppointmentManager::ShowReplaceAppointmentAsync(System.String,Windows.ApplicationModel.Appointments.Appointment,Windows.Foundation.Rect,Windows.UI.Popups.Placement,Windows.Foundation.DateTime)
    @deprecated("Use show_replace_appointment_async() instead.")
    def show_replace_appointment_with_placement_and_date_async(cls, appointment_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[str]: ...
    # Deprecated alias of show_replace_appointment_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.String> Windows.ApplicationModel.Appointments.AppointmentManager::ShowReplaceAppointmentAsync(System.String,Windows.ApplicationModel.Appointments.Appointment,Windows.Foundation.Rect,Windows.UI.Popups.Placement)
    @deprecated("Use show_replace_appointment_async() instead.")
    def show_replace_appointment_with_placement_async(cls, appointment_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
...
class AppointmentManagerForUser(winrt.system.Object):
    ...
    def show_add_appointment_async(self, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    def show_add_appointment_async(self, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
    # Deprecated alias of show_add_appointment_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.String> Windows.ApplicationModel.Appointments.AppointmentManagerForUser::ShowAddAppointmentAsync(Windows.ApplicationModel.Appointments.Appointment,Windows.Foundation.Rect,Windows.UI.Popups.Placement)
    @deprecated("Use show_add_appointment_async() instead.")
    def show_add_appointment_with_placement_async(self, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    def show_appointment_details_async(self, appointment_id: str, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of show_appointment_details_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.ApplicationModel.Appointments.AppointmentManagerForUser::ShowAppointmentDetailsAsync(System.String,Windows.Foundation.DateTime)
    @deprecated("Use show_appointment_details_async() instead.")
    ...
    def show_remove_appointment_async(self, appointment_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def show_remove_appointment_async(self, appointment_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def show_remove_appointment_async(self, appointment_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of show_remove_appointment_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.ApplicationModel.Appointments.AppointmentManagerForUser::ShowRemoveAppointmentAsync(System.String,Windows.Foundation.Rect,Windows.UI.Popups.Placement,Windows.Foundation.DateTime)
    @deprecated("Use show_remove_appointment_async() instead.")
    def show_remove_appointment_with_placement_and_date_async(self, appointment_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of show_remove_appointment_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.ApplicationModel.Appointments.AppointmentManagerForUser::ShowRemoveAppointmentAsync(System.String,Windows.Foundation.Rect,Windows.UI.Popups.Placement)
    @deprecated("Use show_remove_appointment_async() instead.")
    def show_remove_appointment_with_placement_async(self, appointment_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def show_replace_appointment_async(self, appointment_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    def show_replace_appointment_async(self, appointment_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    def show_replace_appointment_async(self, appointment_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[str]: ...
    # Deprecated alias of show_replace_appointment_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.String> Windows.ApplicationModel.Appointments.AppointmentManagerForUser::ShowReplaceAppointmentAsync(System.String,Windows.ApplicationModel.Appointments.Appointment,Windows.Foundation.Rect,Windows.UI.Popups.Placement,Windows.Foundation.DateTime)
    @deprecated("Use show_replace_appointment_async() instead.")
    def show_replace_appointment_with_placement_and_date_async(self, appointment_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[str]: ...
    # Deprecated alias of show_replace_appointment_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.String> Windows.ApplicationModel.Appointments.AppointmentManagerForUser::ShowReplaceAppointmentAsync(System.String,Windows.ApplicationModel.Appointments.Appointment,Windows.Foundation.Rect,Windows.UI.Popups.Placement)
    @deprecated("Use show_replace_appointment_async() instead.")
    def show_replace_appointment_with_placement_async(self, appointment_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[str]: ...
...
class AppointmentProperties_Static(winrt._winrt.IInspectable_Static):
    ...
    @_property
    def default_properties(cls) -> _cabc.MutableSequence[str]: ...
...
class AppointmentRecurrence(winrt.system.Object):
    ...
    @_property
    def occurrences(self) -> winrt.system.UInt32 | None: ...
    ...
    @occurrences.setter
    def occurrences(self, value: winrt.system.UInt32 | None) -> None: ...
...
class AppointmentStore(winrt.system.Object):
    ...
    def create_appointment_calendar_async(self, name: str, user_data_account_id: str, /) -> windows_foundation.IAsyncOperation[AppointmentCalendar]: ...
    # Deprecated alias of create_appointment_calendar_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Appointments.AppointmentCalendar> Windows.ApplicationModel.Appointments.AppointmentStore::CreateAppointmentCalendarAsync(System.String,System.String)
    @deprecated("Use create_appointment_calendar_async() instead.")
    ...
    def find_appointment_calendars_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppointmentCalendar]]: ...
    @typing.overload
    ...
    def find_appointment_calendars_async(self, options: FindAppointmentCalendarsOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppointmentCalendar]]: ...
    # Deprecated alias of find_appointment_calendars_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Appointments.AppointmentCalendar>> Windows.ApplicationModel.Appointments.AppointmentStore::FindAppointmentCalendarsAsync(Windows.ApplicationModel.Appointments.FindAppointmentCalendarsOptions)
    @deprecated("Use find_appointment_calendars_async() instead.")
    def find_appointment_calendars_async_with_options(self, options: FindAppointmentCalendarsOptions, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppointmentCalendar]]: ...
    @typing.overload
    ...
    def find_conflict_async(self, appointment: Appointment, instance_start_time: datetime.datetime, /) -> windows_foundation.IAsyncOperation[AppointmentConflictResult]: ...
    # Deprecated alias of find_conflict_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Appointments.AppointmentConflictResult> Windows.ApplicationModel.Appointments.AppointmentStore::FindConflictAsync(Windows.ApplicationModel.Appointments.Appointment,Windows.Foundation.DateTime)
    @deprecated("Use find_conflict_async() instead.")
    ...
    def find_local_ids_from_roaming_id_async(self, roaming_id: str, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[str]]: ...
    ...
    def show_appointment_details_async(self, local_id: str, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of show_appointment_details_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.ApplicationModel.Appointments.AppointmentStore::ShowAppointmentDetailsAsync(System.String,Windows.Foundation.DateTime)
    @deprecated("Use show_appointment_details_async() instead.")
    ...
    def show_remove_appointment_async(self, local_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def show_remove_appointment_async(self, local_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of show_remove_appointment_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.ApplicationModel.Appointments.AppointmentStore::ShowRemoveAppointmentAsync(System.String,Windows.Foundation.Rect,Windows.UI.Popups.Placement,Windows.Foundation.DateTime)
    @deprecated("Use show_remove_appointment_async() instead.")
    def show_remove_appointment_with_placement_and_date_async(self, local_id: str, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def show_replace_appointment_async(self, local_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[str]: ...
    @typing.overload
    ...
    def show_replace_appointment_async(self, local_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[str]: ...
    # Deprecated alias of show_replace_appointment_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.String> Windows.ApplicationModel.Appointments.AppointmentStore::ShowReplaceAppointmentAsync(System.String,Windows.ApplicationModel.Appointments.Appointment,Windows.Foundation.Rect,Windows.UI.Popups.Placement,Windows.Foundation.DateTime)
    @deprecated("Use show_replace_appointment_async() instead.")
    def show_replace_appointment_with_placement_and_date_async(self, local_id: str, appointment: Appointment, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, instance_start_date: datetime.datetime, /) -> windows_foundation.IAsyncOperation[str]: ...
    ...
    def remove_store_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AppointmentStoreChangeReader(winrt.system.Object):
    ...
    def read_batch_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[AppointmentStoreChange]]: ...
...
class FindAppointmentsOptions(winrt.system.Object):
    ...
    @_property
    def calendar_ids(self) -> _cabc.MutableSequence[str]: ...
    ...
    @_property
    def fetch_properties(self) -> _cabc.MutableSequence[str]: ...
