...
class AccountsSettingsPane(winrt.system.Object, metaclass=AccountsSettingsPane_Static):
    ...
    def remove_account_commands_requested(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AccountsSettingsPaneCommandsRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def commands(self) -> _cabc.MutableSequence[SettingsCommand]: ...
    ...
    @_property
    def credential_commands(self) -> _cabc.MutableSequence[CredentialCommand]: ...
    ...
    @_property
    def web_account_commands(self) -> _cabc.MutableSequence[WebAccountCommand]: ...
    ...
    @_property
    def web_account_provider_commands(self) -> _cabc.MutableSequence[WebAccountProviderCommand]: ...
