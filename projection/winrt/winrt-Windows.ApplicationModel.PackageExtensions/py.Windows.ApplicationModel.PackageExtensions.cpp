...
namespace py::cpp::Windows::ApplicationModel::PackageExtensions
{
    ...
    static PyObject* PackageExtensionCatalog_Open(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.PackageExtensions.PackageExtensionCatalog", "Open", nullptr, py::site_is_static};
