...
namespace py::cpp::Windows::Perception::Automation::Core
{
    ...
    static PyObject* CorePerceptionAutomation_SetActivationFactoryProvider(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Perception.Automation.Core.CorePerceptionAutomation", "SetActivationFactoryProvider", nullptr, py::site_is_static};
