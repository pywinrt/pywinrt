...
class ProviderI2cTransferResult:
    ...
    def unpack(self) -> tuple[ProviderI2cTransferStatus, winrt.system.UInt32]: ...
...
class II2cDeviceProvider(windows_foundation.IClosable, winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def read_partial(self, buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.WriteableBuffer, /) -> ProviderI2cTransferResult: ...
    ...
    @abstractmethod
    def write_partial(self, buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> ProviderI2cTransferResult: ...
    ...
    @abstractmethod
    def write_read_partial(self, write_buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, read_buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.WriteableBuffer, /) -> ProviderI2cTransferResult: ...
