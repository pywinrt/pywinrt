...
namespace py::cpp::Windows::ApplicationModel::Resources::Core
{
    ...
    static PyObject* ResourceContext_CreateMatchingContext(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.Resources.Core.ResourceContext", "CreateMatchingContext", nullptr, py::site_is_static};
    ...
    static PyObject* ResourceContext_GetForCurrentView(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.ApplicationModel.Resources.Core.ResourceContext", "GetForCurrentView", nullptr, py::site_is_static};
    ...
    static PyObject* ResourceContext_GetForUIContext(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.Resources.Core.ResourceContext", "GetForUIContext", nullptr, py::site_is_static};
    ...
    static PyObject* ResourceContext_GetForViewIndependentUse(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.ApplicationModel.Resources.Core.ResourceContext", "GetForViewIndependentUse", nullptr, py::site_is_static};
    ...
    static PyObject* ResourceContext_ResetGlobalQualifierValues(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.ApplicationModel.Resources.Core.ResourceContext", "ResetGlobalQualifierValues", nullptr, py::site_is_static};
        ...
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.Resources.Core.ResourceContext", "ResetGlobalQualifierValues", nullptr, py::site_is_static};
    ...
    static PyObject* ResourceContext_SetGlobalQualifierValue(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.ApplicationModel.Resources.Core.ResourceContext", "SetGlobalQualifierValue", nullptr, py::site_is_static};
        ...
        {
            static constexpr py::member_site site{py::member_kind::method, 3, "Windows.ApplicationModel.Resources.Core.ResourceContext", "SetGlobalQualifierValue", nullptr, py::site_is_static};
    ...
    static PyObject* ResourceManager_IsResourceReference(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.ApplicationModel.Resources.Core.ResourceManager", "IsResourceReference", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.ApplicationModel.Resources.Core.ResourceManager", "Current", nullptr, py::site_is_static};
