...
class ResourceLayoutInfo:
    ...
    def unpack(self) -> tuple[winrt.system.UInt32, winrt.system.UInt32, winrt.system.UInt32, winrt.system.UInt32, winrt.system.Int32]: ...
...
class NamedResource(winrt.system.Object):
    ...
    def resolve_all(self) -> _cabc.Sequence[ResourceCandidate]: ...
    @typing.overload
    ...
    def resolve_all(self, resource_context: ResourceContext, /) -> _cabc.Sequence[ResourceCandidate]: ...
    # Deprecated alias of resolve_all() for pywinrt v3.x compatibility.
    # Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Resources.Core.ResourceCandidate> Windows.ApplicationModel.Resources.Core.NamedResource::ResolveAll(Windows.ApplicationModel.Resources.Core.ResourceContext)
    @deprecated("Use resolve_all() instead.")
    def resolve_all_for_context(self, resource_context: ResourceContext, /) -> _cabc.Sequence[ResourceCandidate]: ...
    ...
    @_property
    def candidates(self) -> _cabc.Sequence[ResourceCandidate]: ...
...
class ResourceCandidate(winrt.system.Object):
    ...
    @_property
    def qualifiers(self) -> _cabc.Sequence[ResourceQualifier]: ...
...
class ResourceCandidateVectorView(winrt.system.Object, winrt._winrt.Sequence[ResourceCandidate]):
    ...
    def __iter__(self) -> _cabc.Iterator[ResourceCandidate]: ...
    @typing.overload
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[ResourceCandidate] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def index_of(self, value: ResourceCandidate, /) -> tuple[bool, winrt.system.UInt32]: ...
...
class ResourceContext_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_matching_context(cls, result: _cabc.Iterable[ResourceQualifier], /) -> ResourceContext: ...
    ...
    def reset_global_qualifier_values(cls, qualifier_names: _cabc.Iterable[str], /) -> None: ...
    ...
    def reset_global_qualifier_values_for_specified_qualifiers(cls, qualifier_names: _cabc.Iterable[str], /) -> None: ...
    @typing.overload
...
class ResourceContext(winrt.system.Object, metaclass=ResourceContext_Static):
    ...
    def override_to_match(self, result: _cabc.Iterable[ResourceQualifier], /) -> None: ...
    @typing.overload
    ...
    def reset(self, qualifier_names: _cabc.Iterable[str], /) -> None: ...
    # Deprecated alias of reset() for pywinrt v3.x compatibility.
    # System.Void Windows.ApplicationModel.Resources.Core.ResourceContext::Reset(Windows.Foundation.Collections.IIterable`1<System.String>)
    @deprecated("Use reset() instead.")
    def reset_qualifier_values(self, qualifier_names: _cabc.Iterable[str], /) -> None: ...
    ...
    @languages.setter
    def languages(self, value: _cabc.Sequence[str]) -> None: ...
...
class ResourceManager(winrt.system.Object, metaclass=ResourceManager_Static):
    ...
    def get_all_subtrees_for_package(self, package_name: str, resource_layout_info: ResourceLayoutInfo | tuple[winrt.system.UInt32, winrt.system.UInt32, winrt.system.UInt32, winrt.system.UInt32, winrt.system.Int32], /) -> _cabc.Sequence[ResourceMap]: ...
    ...
    def load_pri_files(self, files: _cabc.Iterable[windows_storage.IStorageFile], /) -> None: ...
    ...
    def unload_pri_files(self, files: _cabc.Iterable[windows_storage.IStorageFile], /) -> None: ...
    ...
    @_property
    def all_resource_maps(self) -> _cabc.Mapping[str, ResourceMap]: ...
...
class ResourceMap(winrt.system.Object, winrt._winrt.Mapping[str, NamedResource]):
    ...
    def split(self) -> tuple[_cabc.Mapping[str, NamedResource], _cabc.Mapping[str, NamedResource]]: ...
...
class ResourceMapMapView(winrt.system.Object, winrt._winrt.Mapping[str, ResourceMap]):
    ...
    def split(self) -> tuple[_cabc.Mapping[str, ResourceMap], _cabc.Mapping[str, ResourceMap]]: ...
...
class ResourceQualifierMapView(winrt.system.Object, winrt._winrt.Mapping[str, str]):
    ...
    def split(self) -> tuple[_cabc.Mapping[str, str], _cabc.Mapping[str, str]]: ...
...
class ResourceQualifierVectorView(winrt.system.Object, winrt._winrt.Sequence[ResourceQualifier]):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[ResourceQualifier]: ...
    @typing.overload
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[ResourceQualifier] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def index_of(self, value: ResourceQualifier, /) -> tuple[bool, winrt.system.UInt32]: ...
