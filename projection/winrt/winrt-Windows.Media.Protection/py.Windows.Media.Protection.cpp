...
namespace py::cpp::Windows::Media::Protection
{
    ...
    static PyObject* ComponentRenewal_RenewSystemComponentsAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Media.Protection.ComponentRenewal", "RenewSystemComponentsAsync", nullptr, py::site_is_static};
