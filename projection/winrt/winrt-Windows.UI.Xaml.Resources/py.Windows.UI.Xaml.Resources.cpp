...
namespace py::cpp::Windows::UI::Xaml::Resources
{
        ...
        if (arg_count == 4)
        {
            try
            {
                ...
                return py::convert([&]()
                {
                    ...
                    return py::require<winrt::Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderOverrides>(py::get_inner_or_self(self->obj), py::member_kind::method, "Windows.UI.Xaml.Resources.CustomXamlResourceLoader", "GetResource", "Windows.UI.Xaml.Resources.ICustomXamlResourceLoaderOverrides", 4).GetResource(param0, param1, param2, param3);
                }());
            }
            catch (...)
            {
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.UI.Xaml.Resources.CustomXamlResourceLoader", "Current", nullptr, py::site_is_static};
