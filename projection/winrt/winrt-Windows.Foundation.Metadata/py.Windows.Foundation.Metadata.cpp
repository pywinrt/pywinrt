...
namespace py::cpp::Windows::Foundation::Metadata
{
    ...
    static PyObject* ApiInformation_IsApiContractPresent(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Foundation.Metadata.ApiInformation", "IsApiContractPresent", nullptr, py::site_is_static};
        ...
        {
            static constexpr py::member_site site{py::member_kind::method, 3, "Windows.Foundation.Metadata.ApiInformation", "IsApiContractPresent", nullptr, py::site_is_static};
    ...
    static PyObject* ApiInformation_IsEnumNamedValuePresent(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Foundation.Metadata.ApiInformation", "IsEnumNamedValuePresent", nullptr, py::site_is_static};
    ...
    static PyObject* ApiInformation_IsEventPresent(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Foundation.Metadata.ApiInformation", "IsEventPresent", nullptr, py::site_is_static};
    ...
    static PyObject* ApiInformation_IsMethodPresent(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Foundation.Metadata.ApiInformation", "IsMethodPresent", nullptr, py::site_is_static};
        ...
        {
            static constexpr py::member_site site{py::member_kind::method, 3, "Windows.Foundation.Metadata.ApiInformation", "IsMethodPresent", nullptr, py::site_is_static};
    ...
    static PyObject* ApiInformation_IsPropertyPresent(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Foundation.Metadata.ApiInformation", "IsPropertyPresent", nullptr, py::site_is_static};
    ...
    static PyObject* ApiInformation_IsReadOnlyPropertyPresent(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Foundation.Metadata.ApiInformation", "IsReadOnlyPropertyPresent", nullptr, py::site_is_static};
    ...
    static PyObject* ApiInformation_IsTypePresent(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Foundation.Metadata.ApiInformation", "IsTypePresent", nullptr, py::site_is_static};
    ...
    static PyObject* ApiInformation_IsWriteablePropertyPresent(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Foundation.Metadata.ApiInformation", "IsWriteablePropertyPresent", nullptr, py::site_is_static};
