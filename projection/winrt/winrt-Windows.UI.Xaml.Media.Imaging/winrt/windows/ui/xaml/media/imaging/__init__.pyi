...
class BitmapImage(BitmapSource, metaclass=BitmapImage_Static):
    @typing.overload
    def __new__(cls: type[Self], uri_source: windows_foundation.Uri) -> Self: ...
    @typing.overload
...
class RenderTargetBitmap(windows_ui_xaml_media.ImageSource, metaclass=RenderTargetBitmap_Static):
    ...
    def render_async(self, element: windows_ui_xaml.UIElement, scaled_width: winrt.system.Int32, scaled_height: winrt.system.Int32, /) -> windows_foundation.IAsyncAction: ...
...
class SurfaceImageSource(windows_ui_xaml_media.ImageSource, metaclass=SurfaceImageSource_Static):
    @typing.overload
    def __new__(cls: type[Self], pixel_width: winrt.system.Int32, pixel_height: winrt.system.Int32) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], pixel_width: winrt.system.Int32, pixel_height: winrt.system.Int32, is_opaque: bool) -> Self: ...
