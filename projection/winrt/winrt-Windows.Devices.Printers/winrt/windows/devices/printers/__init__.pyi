...
class IppAttributeValue_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_boolean_array(cls, values: _cabc.Iterable[bool], /) -> IppAttributeValue: ...
    ...
    def create_charset_array(cls, values: _cabc.Iterable[str], /) -> IppAttributeValue: ...
    ...
    def create_collection(cls, member_attributes: _cabc.Mapping[str, IppAttributeValue] | _cabc.Iterable[windows_foundation_collections.IKeyValuePair[str, IppAttributeValue]], /) -> IppAttributeValue: ...
    ...
    def create_collection_array(cls, member_attributes_array: _cabc.Iterable[_cabc.Iterable[windows_foundation_collections.IKeyValuePair[str, IppAttributeValue]]], /) -> IppAttributeValue: ...
    ...
    def create_date_time_array(cls, values: _cabc.Iterable[datetime.datetime], /) -> IppAttributeValue: ...
    ...
    def create_enum_array(cls, values: _cabc.Iterable[winrt.system.Int32], /) -> IppAttributeValue: ...
    ...
    def create_integer_array(cls, values: _cabc.Iterable[winrt.system.Int32], /) -> IppAttributeValue: ...
    ...
    def create_keyword_array(cls, values: _cabc.Iterable[str], /) -> IppAttributeValue: ...
    ...
    def create_mime_media_array(cls, values: _cabc.Iterable[str], /) -> IppAttributeValue: ...
    ...
    def create_name_with_language_array(cls, values: _cabc.Iterable[IppTextWithLanguage], /) -> IppAttributeValue: ...
    ...
    def create_name_without_language_array(cls, values: _cabc.Iterable[str], /) -> IppAttributeValue: ...
    ...
    def create_natural_language_array(cls, values: _cabc.Iterable[str], /) -> IppAttributeValue: ...
    ...
    def create_octet_string_array(cls, values: _cabc.Iterable[winrt.system.Buffer], /) -> IppAttributeValue: ...
    ...
    def create_range_of_integer_array(cls, values: _cabc.Iterable[IppIntegerRange], /) -> IppAttributeValue: ...
    ...
    def create_resolution_array(cls, values: _cabc.Iterable[IppResolution], /) -> IppAttributeValue: ...
    ...
    def create_text_with_language_array(cls, values: _cabc.Iterable[IppTextWithLanguage], /) -> IppAttributeValue: ...
    ...
    def create_text_without_language_array(cls, values: _cabc.Iterable[str], /) -> IppAttributeValue: ...
    ...
    def create_uri_array(cls, values: _cabc.Iterable[windows_foundation.Uri], /) -> IppAttributeValue: ...
    ...
    def create_uri_schema_array(cls, values: _cabc.Iterable[str], /) -> IppAttributeValue: ...
...
class IppAttributeValue(winrt.system.Object, metaclass=IppAttributeValue_Static):
    ...
    def get_charset_array(self) -> _cabc.MutableSequence[str]: ...
    ...
    def get_collection_array(self) -> _cabc.MutableSequence[_cabc.Mapping[str, IppAttributeValue]]: ...
    ...
    def get_name_with_language_array(self) -> _cabc.MutableSequence[IppTextWithLanguage]: ...
    ...
    def get_name_without_language_array(self) -> _cabc.MutableSequence[str]: ...
    ...
    def get_natural_language_array(self) -> _cabc.MutableSequence[str]: ...
    ...
    def get_octet_string_array(self) -> _cabc.MutableSequence[winrt.system.Buffer]: ...
    ...
    def get_range_of_integer_array(self) -> _cabc.MutableSequence[IppIntegerRange]: ...
    ...
    def get_resolution_array(self) -> _cabc.MutableSequence[IppResolution]: ...
    ...
    def get_text_with_language_array(self) -> _cabc.MutableSequence[IppTextWithLanguage]: ...
...
class IppIntegerRange(winrt.system.Object):
    def __new__(cls: type[Self], start: winrt.system.Int32, end: winrt.system.Int32) -> Self: ...
...
class IppPrintDevice(winrt.system.Object, metaclass=IppPrintDevice_Static):
    ...
    def get_printer_attributes(self, attribute_names: _cabc.Iterable[str], /) -> _cabc.MutableMapping[str, IppAttributeValue]: ...
    ...
    def get_printer_attributes_as_buffer(self, attribute_names: _cabc.Iterable[str], /) -> winrt.system.Buffer: ...
...
class IppResolution(winrt.system.Object):
    def __new__(cls: type[Self], width: winrt.system.Int32, height: winrt.system.Int32, unit: IppResolutionUnit) -> Self: ...
...
class IppTextWithLanguage(winrt.system.Object):
    def __new__(cls: type[Self], language: str, text: str) -> Self: ...
...
class VirtualPrinterInstallationParameters(winrt.system.Object):
    ...
    @_property
    def output_file_extensions(self) -> _cabc.MutableSequence[str]: ...
    ...
    @_property
    def supported_input_formats(self) -> _cabc.MutableSequence[VirtualPrinterSupportedFormat]: ...
...
class VirtualPrinterManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def find_all_virtual_printers(cls, app_package_family_name: str, /) -> _cabc.Sequence[str]: ...
    ...
    def find_all_virtual_printers2(cls, app_package_family_name: str, /) -> _cabc.Sequence[str]: ...
    @typing.overload
...
class VirtualPrinterSupportedFormat(winrt.system.Object):
    def __new__(cls: type[Self], content_type: str, max_supported_version: str) -> Self: ...
