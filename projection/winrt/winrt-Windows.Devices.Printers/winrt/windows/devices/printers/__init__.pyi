...
class IppIntegerRange(winrt.system.Object):
    def __new__(cls, start: winrt.system.Int32, end: winrt.system.Int32) -> typing.Self: ...
...
class IppResolution(winrt.system.Object):
    def __new__(cls, width: winrt.system.Int32, height: winrt.system.Int32, unit: IppResolutionUnit) -> typing.Self: ...
...
class IppTextWithLanguage(winrt.system.Object):
    def __new__(cls, language: str, text: str) -> typing.Self: ...
...
class VirtualPrinterSupportedFormat(winrt.system.Object):
    def __new__(cls, content_type: str, max_supported_version: str) -> typing.Self: ...
