...
class DataTemplateKey(winrt.system.Object, metaclass=DataTemplateKey_Static):
    ...
    def __new__(cls: type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], data_type: winrt.system.Object) -> Self: ...
...
class PropertyMetadata(winrt.system.Object, metaclass=PropertyMetadata_Static):
    @typing.overload
    def __new__(cls: type[Self], default_value: winrt.system.Object) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], default_value: winrt.system.Object, property_changed_callback: PropertyChangedCallback) -> Self: ...
...
class PropertyPath(DependencyObject):
    def __new__(cls: type[Self], path: str) -> Self: ...
...
class Setter(SetterBase):
    @typing.overload
    def __new__(cls: type[Self], target_property: DependencyProperty, value: winrt.system.Object) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
class Style(DependencyObject):
    @typing.overload
    def __new__(cls: type[Self], target_type: windows_ui_xaml_interop.TypeName | tuple[str, windows_ui_xaml_interop.TypeKind]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
class TargetPropertyPath(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], target_property: DependencyProperty) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
