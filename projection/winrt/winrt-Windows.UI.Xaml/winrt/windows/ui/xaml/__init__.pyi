...
class CornerRadius:
    ...
    def unpack(self) -> tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]: ...
...
class Duration:
    ...
    def __new__(cls, time_span: datetime.timedelta = ..., type: DurationType = ...) -> Duration: ...
    def __replace__(self, /, **changes: typing.Any) -> Duration: ...
    def unpack(self) -> tuple[datetime.timedelta, DurationType]: ...
...
class GridLength:
    ...
    def __new__(cls, value: winrt.system.Double = 0, grid_unit_type: GridUnitType = ...) -> GridLength: ...
    def __replace__(self, /, **changes: typing.Any) -> GridLength: ...
    def unpack(self) -> tuple[winrt.system.Double, GridUnitType]: ...
...
class Application(winrt.system.Object, metaclass=Application_Static):
    ...
    def remove_resuming(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_suspending(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_unhandled_exception(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_entered_background(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_leaving_background(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class BringIntoViewRequestedEventArgs(RoutedEventArgs):
    ...
    @target_rect.setter
    def target_rect(self, value: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single]) -> None: ...
...
class ColorPaletteResources(ResourceDictionary, metaclass=ColorPaletteResources_Static):
    ...
    @typing.final
    def chrome_medium_low(self, value: windows_ui.Color | None) -> None: ...
    # Windows.Foundation.IReference`1<Windows.UI.Color> Windows.UI.Xaml.ColorPaletteResources::get_ChromeMedium()
    @_property
    def chrome_medium(self) -> windows_ui.Color | None: ...
    ...
    @typing.final
    def chrome_disabled_low(self, value: windows_ui.Color | None) -> None: ...
    # Windows.Foundation.IReference`1<Windows.UI.Color> Windows.UI.Xaml.ColorPaletteResources::get_ChromeDisabledHigh()
    @_property
    def chrome_disabled_high(self) -> windows_ui.Color | None: ...
    ...
    @typing.final
    def chrome_disabled_high(self, value: windows_ui.Color | None) -> None: ...
    # Windows.Foundation.IReference`1<Windows.UI.Color> Windows.UI.Xaml.ColorPaletteResources::get_ChromeBlackMediumLow()
    @_property
    def chrome_black_medium_low(self) -> windows_ui.Color | None: ...
    ...
    @typing.final
    def chrome_black_medium_low(self, value: windows_ui.Color | None) -> None: ...
    # Windows.Foundation.IReference`1<Windows.UI.Color> Windows.UI.Xaml.ColorPaletteResources::get_ChromeBlackMedium()
    @_property
    def chrome_black_medium(self) -> windows_ui.Color | None: ...
    ...
    @typing.final
    def chrome_black_medium(self, value: windows_ui.Color | None) -> None: ...
    # Windows.Foundation.IReference`1<Windows.UI.Color> Windows.UI.Xaml.ColorPaletteResources::get_ChromeBlackLow()
    @_property
    def chrome_black_low(self) -> windows_ui.Color | None: ...
    ...
    @typing.final
    def chrome_black_low(self, value: windows_ui.Color | None) -> None: ...
    # Windows.Foundation.IReference`1<Windows.UI.Color> Windows.UI.Xaml.ColorPaletteResources::get_ChromeBlackHigh()
    @_property
    def chrome_black_high(self) -> windows_ui.Color | None: ...
    ...
    @typing.final
    def chrome_black_high(self, value: windows_ui.Color | None) -> None: ...
    # Windows.Foundation.IReference`1<Windows.UI.Color> Windows.UI.Xaml.ColorPaletteResources::get_ChromeAltLow()
    @_property
    def chrome_alt_low(self) -> windows_ui.Color | None: ...
...
class DataTemplateKey(winrt.system.Object, metaclass=DataTemplateKey_Static):
    ...
    def __new__(cls) -> typing.Self: ...
    @typing.overload
    def __new__(cls, data_type: winrt.system.Object) -> typing.Self: ...
...
class DebugSettings(winrt.system.Object):
    ...
    def remove_binding_failed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class DependencyObjectCollection(DependencyObject, windows_foundation_collections.IObservableVector[DependencyObject], winrt._winrt.MutableSequence[DependencyObject], metaclass=DependencyObjectCollection_Static):
    ...
    def __iter__(self) -> _cabc.Iterator[DependencyObject]: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(self, index: slice, value: _cabc.Iterable[DependencyObject]) -> None: ...
    def __new__(cls) -> typing.Self: ...
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[DependencyObject] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def get_view(self) -> _cabc.Sequence[DependencyObject]: ...
    # System.Boolean Windows.UI.Xaml.DependencyObjectCollection::IndexOf(Windows.UI.Xaml.DependencyObject,System.UInt32&)
    def index_of(self, value: DependencyObject, /) -> tuple[bool, winrt.system.UInt32]: ...
    ...
    def replace_all(self, items: winrt.system.Array[DependencyObject] | winrt.system.ReadableBuffer, /) -> None: ...
...
class DragUI(winrt.system.Object):
    ...
    def set_content_from_bitmap_image(self, bitmap_image: windows_ui_xaml_media_imaging.BitmapImage, anchor_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
    ...
    def set_content_from_bitmap_image_with_anchor_point(self, bitmap_image: windows_ui_xaml_media_imaging.BitmapImage, anchor_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
    ...
    def set_content_from_software_bitmap(self, software_bitmap: windows_graphics_imaging.SoftwareBitmap, anchor_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
    ...
    def set_content_from_software_bitmap_with_anchor_point(self, software_bitmap: windows_graphics_imaging.SoftwareBitmap, anchor_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
...
class DurationHelper_Static(winrt._winrt.IInspectable_Static):
    ...
    def compare(cls, duration1: Duration | tuple[datetime.timedelta, DurationType], duration2: Duration | tuple[datetime.timedelta, DurationType], /) -> winrt.system.Int32: ...
    # System.Boolean Windows.UI.Xaml.DurationHelper::Equals(Windows.UI.Xaml.Duration,Windows.UI.Xaml.Duration)
    def equals(cls, target: Duration | tuple[datetime.timedelta, DurationType], value: Duration | tuple[datetime.timedelta, DurationType], /) -> bool: ...
    ...
    def get_has_time_span(cls, target: Duration | tuple[datetime.timedelta, DurationType], /) -> bool: ...
    # Windows.UI.Xaml.Duration Windows.UI.Xaml.DurationHelper::Subtract(Windows.UI.Xaml.Duration,Windows.UI.Xaml.Duration)
    def subtract(cls, target: Duration | tuple[datetime.timedelta, DurationType], duration: Duration | tuple[datetime.timedelta, DurationType], /) -> Duration: ...
...
class FrameworkElement(UIElement, metaclass=FrameworkElement_Static):
    ...
    def _measure_override(self, available_size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Size: ...
    ...
    def remove_layout_updated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_loaded(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_size_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_unloaded(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_data_context_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_loading(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_actual_theme_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_effective_viewport_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @margin.setter
    @typing.final
    def margin(self, value: Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
    ...
    @typing.final
    def focus_visual_secondary_thickness(self, value: Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
    ...
    @typing.final
    def focus_visual_primary_thickness(self, value: Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
    ...
    @typing.final
    def focus_visual_margin(self, value: Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
...
class GridLengthHelper_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_is_absolute(cls, target: GridLength | tuple[winrt.system.Double, GridUnitType], /) -> bool: ...
    # System.Boolean Windows.UI.Xaml.GridLengthHelper::GetIsAuto(Windows.UI.Xaml.GridLength)
    def get_is_auto(cls, target: GridLength | tuple[winrt.system.Double, GridUnitType], /) -> bool: ...
    # System.Boolean Windows.UI.Xaml.GridLengthHelper::GetIsStar(Windows.UI.Xaml.GridLength)
    def get_is_star(cls, target: GridLength | tuple[winrt.system.Double, GridUnitType], /) -> bool: ...
...
class PropertyMetadata(winrt.system.Object, metaclass=PropertyMetadata_Static):
    @typing.overload
    def __new__(cls, default_value: winrt.system.Object) -> typing.Self: ...
    @typing.overload
    def __new__(cls, default_value: winrt.system.Object, property_changed_callback: PropertyChangedCallback) -> typing.Self: ...
...
class PropertyPath(DependencyObject):
    def __new__(cls, path: str) -> typing.Self: ...
...
class RectHelper_Static(winrt._winrt.IInspectable_Static):
    ...
    def equals(cls, target: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], value: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> bool: ...
    ...
    def from_location_and_size(cls, location: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Rect: ...
    # Windows.Foundation.Rect Windows.UI.Xaml.RectHelper::FromPoints(Windows.Foundation.Point,Windows.Foundation.Point)
    def from_points(cls, point1: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], point2: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Rect: ...
    # System.Single Windows.UI.Xaml.RectHelper::GetBottom(Windows.Foundation.Rect)
    def get_bottom(cls, target: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> winrt.system.Single: ...
    # System.Boolean Windows.UI.Xaml.RectHelper::GetIsEmpty(Windows.Foundation.Rect)
    def get_is_empty(cls, target: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> bool: ...
    # System.Single Windows.UI.Xaml.RectHelper::GetLeft(Windows.Foundation.Rect)
    def get_left(cls, target: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> winrt.system.Single: ...
    # System.Single Windows.UI.Xaml.RectHelper::GetRight(Windows.Foundation.Rect)
    def get_right(cls, target: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> winrt.system.Single: ...
    # System.Single Windows.UI.Xaml.RectHelper::GetTop(Windows.Foundation.Rect)
    def get_top(cls, target: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> winrt.system.Single: ...
    # Windows.Foundation.Rect Windows.UI.Xaml.RectHelper::Intersect(Windows.Foundation.Rect,Windows.Foundation.Rect)
    def intersect(cls, target: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], rect: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Rect: ...
    # Windows.Foundation.Rect Windows.UI.Xaml.RectHelper::Union(Windows.Foundation.Rect,Windows.Foundation.Point)
    def union(cls, target: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Rect: ...
    # Deprecated alias of union() for pywinrt v3.x compatibility.
    # Windows.Foundation.Rect Windows.UI.Xaml.RectHelper::Union(Windows.Foundation.Rect,Windows.Foundation.Point)
    @deprecated("Use union() instead.")
    def union_with_point(cls, target: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Rect: ...
    # Windows.Foundation.Rect Windows.UI.Xaml.RectHelper::Union(Windows.Foundation.Rect,Windows.Foundation.Rect)
    def union_with_rect(cls, target: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], rect: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Rect: ...
...
class ResourceDictionary(DependencyObject, winrt._winrt.MutableMapping[winrt.system.Object, winrt.system.Object], metaclass=ResourceDictionary_Static):
    ...
    def get_view(self) -> _cabc.Mapping[winrt.system.Object, winrt.system.Object]: ...
    ...
    @_property
    @typing.final
    def merged_dictionaries(self) -> _cabc.MutableSequence[ResourceDictionary]: ...
    ...
    @_property
    @typing.final
    def theme_dictionaries(self) -> _cabc.MutableMapping[winrt.system.Object, winrt.system.Object]: ...
...
class SetterBaseCollection(winrt.system.Object, winrt._winrt.MutableSequence[SetterBase]):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[SetterBase]: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(self, index: slice, value: _cabc.Iterable[SetterBase]) -> None: ...
    def __new__(cls) -> typing.Self: ...
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[SetterBase] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    # Windows.Foundation.Collections.IVectorView`1<Windows.UI.Xaml.SetterBase> Windows.UI.Xaml.SetterBaseCollection::GetView()
    def get_view(self) -> _cabc.Sequence[SetterBase]: ...
    # System.Boolean Windows.UI.Xaml.SetterBaseCollection::IndexOf(Windows.UI.Xaml.SetterBase,System.UInt32&)
    def index_of(self, value: SetterBase, /) -> tuple[bool, winrt.system.UInt32]: ...
    ...
    def replace_all(self, items: winrt.system.Array[SetterBase] | winrt.system.ReadableBuffer, /) -> None: ...
...
class SizeHelper_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_is_empty(cls, target: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> bool: ...
...
class Style(DependencyObject):
    @typing.overload
    def __new__(cls, target_type: windows_ui_xaml_interop.TypeName | tuple[str, windows_ui_xaml_interop.TypeKind]) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
...
class TargetPropertyPath(winrt.system.Object):
    @typing.overload
    def __new__(cls, target_property: DependencyProperty) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
...
class TriggerActionCollection(winrt.system.Object, winrt._winrt.MutableSequence[TriggerAction]):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[TriggerAction]: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(self, index: slice, value: _cabc.Iterable[TriggerAction]) -> None: ...
    def __new__(cls) -> typing.Self: ...
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[TriggerAction] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def get_view(self) -> _cabc.Sequence[TriggerAction]: ...
    # System.Boolean Windows.UI.Xaml.TriggerActionCollection::IndexOf(Windows.UI.Xaml.TriggerAction,System.UInt32&)
    def index_of(self, value: TriggerAction, /) -> tuple[bool, winrt.system.UInt32]: ...
    ...
    def replace_all(self, items: winrt.system.Array[TriggerAction] | winrt.system.ReadableBuffer, /) -> None: ...
...
class TriggerCollection(winrt.system.Object, winrt._winrt.MutableSequence[TriggerBase]):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[TriggerBase]: ...
    @typing.overload
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[TriggerBase] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    # Windows.Foundation.Collections.IVectorView`1<Windows.UI.Xaml.TriggerBase> Windows.UI.Xaml.TriggerCollection::GetView()
    def get_view(self) -> _cabc.Sequence[TriggerBase]: ...
    # System.Boolean Windows.UI.Xaml.TriggerCollection::IndexOf(Windows.UI.Xaml.TriggerBase,System.UInt32&)
    def index_of(self, value: TriggerBase, /) -> tuple[bool, winrt.system.UInt32]: ...
    ...
    def replace_all(self, items: winrt.system.Array[TriggerBase] | winrt.system.ReadableBuffer, /) -> None: ...
...
class UIElement(DependencyObject, windows_ui_composition.IVisualElement, windows_ui_composition.IAnimationObject, metaclass=UIElement_Static):
    ...
    def arrange(self, final_rect: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> None: ...
    @typing.final
    ...
    def _find_sub_elements_for_touch_targeting(self, point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], bounding_rect: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> _cabc.Iterable[_cabc.Iterable[windows_foundation.Point]]: ...
    ...
    def _get_children_in_tab_focus_order(self) -> _cabc.Iterable[DependencyObject]: ...
    @typing.final
    ...
    def measure(self, available_size: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
    ...
    def remove_double_tapped(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_drag_enter(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_drag_leave(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_drag_over(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_drop(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_holding(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_key_down(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_key_up(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_manipulation_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_manipulation_delta(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_manipulation_inertia_starting(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_manipulation_started(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_manipulation_starting(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_pointer_canceled(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_pointer_capture_lost(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_pointer_entered(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_pointer_exited(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_pointer_moved(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_pointer_pressed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_pointer_released(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_pointer_wheel_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_right_tapped(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_tapped(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_drag_starting(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_drop_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_context_canceled(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_context_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_getting_focus(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_losing_focus(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_no_focus_candidate_found(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_character_received(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_preview_key_down(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_preview_key_up(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_process_keyboard_accelerators(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_bring_into_view_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @typing.final
    def render_transform_origin(self, value: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
    ...
    @_property
    @typing.final
    def pointer_captures(self) -> _cabc.Sequence[windows_ui_xaml_input.Pointer]: ...
    ...
    @_property
    @typing.final
    def lights(self) -> _cabc.MutableSequence[windows_ui_xaml_media.XamlLight]: ...
    ...
    @_property
    @typing.final
    def keyboard_accelerators(self) -> _cabc.MutableSequence[windows_ui_xaml_input.KeyboardAccelerator]: ...
    ...
    @translation.setter
    @typing.final
    def translation(self, value: windows_foundation_numerics.Vector3 | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single]) -> None: ...
...
class UIElementWeakCollection(winrt.system.Object, winrt._winrt.MutableSequence[UIElement], metaclass=UIElementWeakCollection_Static):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[UIElement]: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(self, index: slice, value: _cabc.Iterable[UIElement]) -> None: ...
    def __new__(cls) -> typing.Self: ...
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[UIElement] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    # Windows.Foundation.Collections.IVectorView`1<Windows.UI.Xaml.UIElement> Windows.UI.Xaml.UIElementWeakCollection::GetView()
    def get_view(self) -> _cabc.Sequence[UIElement]: ...
    # System.Boolean Windows.UI.Xaml.UIElementWeakCollection::IndexOf(Windows.UI.Xaml.UIElement,System.UInt32&)
    def index_of(self, value: UIElement, /) -> tuple[bool, winrt.system.UInt32]: ...
    ...
    def replace_all(self, items: winrt.system.Array[UIElement] | winrt.system.ReadableBuffer, /) -> None: ...
...
class VisualState(DependencyObject):
    ...
    @_property
    def state_triggers(self) -> _cabc.MutableSequence[StateTriggerBase]: ...
...
class VisualStateGroup(DependencyObject):
    ...
    def remove_current_state_changing(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def states(self) -> _cabc.MutableSequence[VisualState]: ...
    ...
    @_property
    def transitions(self) -> _cabc.MutableSequence[VisualTransition]: ...
...
class VisualStateManager_Static(DependencyObject_Static):
    ...
    def get_visual_state_groups(cls, obj: FrameworkElement, /) -> _cabc.MutableSequence[VisualStateGroup]: ...
...
class VisualTransition(DependencyObject, metaclass=VisualTransition_Static):
    ...
    @typing.final
    def generated_duration(self, value: Duration | tuple[datetime.timedelta, DurationType]) -> None: ...
...
ApplicationInitializationCallback: typing.TypeAlias = typing.Callable[[ApplicationInitializationCallbackParams], None]
BindingFailedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, BindingFailedEventArgs], None]
CreateDefaultValueCallback: typing.TypeAlias = typing.Callable[[], winrt.system.Object]
DependencyPropertyChangedCallback: typing.TypeAlias = typing.Callable[[DependencyObject, DependencyProperty], None]
DependencyPropertyChangedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, DependencyPropertyChangedEventArgs], None]
DragEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, DragEventArgs], None]
EnteredBackgroundEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, windows_applicationmodel.EnteredBackgroundEventArgs], None]
ExceptionRoutedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, ExceptionRoutedEventArgs], None]
LeavingBackgroundEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, windows_applicationmodel.LeavingBackgroundEventArgs], None]
PropertyChangedCallback: typing.TypeAlias = typing.Callable[[DependencyObject, DependencyPropertyChangedEventArgs], None]
RoutedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, RoutedEventArgs], None]
SizeChangedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, SizeChangedEventArgs], None]
SuspendingEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, windows_applicationmodel.SuspendingEventArgs], None]
UnhandledExceptionEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, UnhandledExceptionEventArgs], None]
VisualStateChangedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, VisualStateChangedEventArgs], None]
WindowActivatedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, windows_ui_core.WindowActivatedEventArgs], None]
WindowClosedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, windows_ui_core.CoreWindowEventArgs], None]
WindowSizeChangedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, windows_ui_core.WindowSizeChangedEventArgs], None]
WindowVisibilityChangedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, windows_ui_core.VisibilityChangedEventArgs], None]
