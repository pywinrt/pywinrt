...
class SecondaryTile_Static(winrt._winrt.IInspectable_Static):
    ...
    def find_all_async(cls) -> windows_foundation.IAsyncOperation[_cabc.Sequence[SecondaryTile]]: ...
    @typing.overload
    ...
    def find_all_async(cls, application_id: str, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[SecondaryTile]]: ...
    # Deprecated alias of find_all_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.UI.StartScreen.SecondaryTile>> Windows.UI.StartScreen.SecondaryTile::FindAllAsync(System.String)
    @deprecated("Use find_all_async() instead.")
    def find_all_for_application_async(cls, application_id: str, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[SecondaryTile]]: ...
    ...
    def find_all_for_package_async(cls) -> windows_foundation.IAsyncOperation[_cabc.Sequence[SecondaryTile]]: ...

@typing.final
class SecondaryTile(winrt.system.Object, metaclass=SecondaryTile_Static):
    @typing.overload
    def __new__(cls: type[Self], tile_id: str, display_name: str, arguments: str, square150x150_logo: windows_foundation.Uri, desired_size: TileSize) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], tile_id: str, short_name: str, display_name: str, arguments: str, tile_options: TileOptions, logo_reference: windows_foundation.Uri) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], tile_id: str, short_name: str, display_name: str, arguments: str, tile_options: TileOptions, logo_reference: windows_foundation.Uri, wide_logo_reference: windows_foundation.Uri) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], tile_id: str) -> Self: ...
    @typing.overload
    ...
    def request_create_async(self, invocation_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of request_create_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.UI.StartScreen.SecondaryTile::RequestCreateAsync(Windows.Foundation.Point)
    @deprecated("Use request_create_async() instead.")
    def request_create_async_with_point(self, invocation_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def request_create_for_selection_async(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def request_create_for_selection_async(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def request_create_async_with_rect(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of request_create_for_selection_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.UI.StartScreen.SecondaryTile::RequestCreateForSelectionAsync(Windows.Foundation.Rect,Windows.UI.Popups.Placement)
    @deprecated("Use request_create_for_selection_async() instead.")
    def request_create_async_with_rect_and_placement(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def request_delete_async(self, invocation_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of request_delete_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.UI.StartScreen.SecondaryTile::RequestDeleteAsync(Windows.Foundation.Point)
    @deprecated("Use request_delete_async() instead.")
    def request_delete_async_with_point(self, invocation_point: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def request_delete_for_selection_async(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def request_delete_for_selection_async(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def request_delete_async_with_rect(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of request_delete_for_selection_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.UI.StartScreen.SecondaryTile::RequestDeleteForSelectionAsync(Windows.Foundation.Rect,Windows.UI.Popups.Placement)
    @deprecated("Use request_delete_for_selection_async() instead.")
    def request_delete_async_with_rect_and_placement(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], preferred_placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[bool]: ...
...
class TileMixedRealityModel(winrt.system.Object):
    ...
    @_property
    def bounding_box(self) -> windows_perception_spatial.SpatialBoundingBox | None: ...
    ...
    @bounding_box.setter
    def bounding_box(self, value: windows_perception_spatial.SpatialBoundingBox | None) -> None: ...
...
class VisualElementsRequest(winrt.system.Object):
    ...
    @_property
    def alternate_visual_elements(self) -> _cabc.Sequence[SecondaryTileVisualElements]: ...
