...
class AudioDeviceModulesManager(winrt.system.Object):
    ...
    def find_all_by_id(self, module_id: str, /) -> _cabc.Sequence[AudioDeviceModule]: ...
    ...
    def remove_module_notification_received(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class CallControl(winrt.system.Object, metaclass=CallControl_Static):
    ...
    def remove_answer_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_audio_transfer_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_dial_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_hang_up_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_keypad_pressed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_redial_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class DigitalWindowControl(winrt.system.Object):
    ...
    @_property
    def supported_capabilities(self) -> _cabc.Sequence[DigitalWindowCapability]: ...
...
class FocusControl(winrt.system.Object):
    ...
    @_property
    def supported_presets(self) -> _cabc.Sequence[FocusPreset]: ...
    ...
    @_property
    def supported_focus_distances(self) -> _cabc.Sequence[ManualFocusDistance]: ...
    ...
    @_property
    def supported_focus_modes(self) -> _cabc.Sequence[FocusMode]: ...
    ...
    @_property
    def supported_focus_ranges(self) -> _cabc.Sequence[AutoFocusRange]: ...
...
class FocusSettings(winrt.system.Object):
    ...
    @value.setter
    def value(self, value: winrt.system.UInt32 | None) -> None: ...
    ...
    @_property
    def distance(self) -> ManualFocusDistance | None: ...
    ...
    @distance.setter
    def distance(self, value: ManualFocusDistance | None) -> None: ...
...
class HdrVideoControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> _cabc.Sequence[HdrVideoMode]: ...
...
class InfraredTorchControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> _cabc.Sequence[InfraredTorchMode]: ...
...
class MediaDevice_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_default_audio_capture_device_changed(cls, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_default_audio_render_device_changed(cls, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MediaDeviceControl(winrt.system.Object):
    ...
    def try_get_value(self) -> tuple[bool, winrt.system.Double]: ...
...
class OpticalImageStabilizationControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> _cabc.Sequence[OpticalImageStabilizationMode]: ...
...
class RegionsOfInterestControl(winrt.system.Object):
    ...
    def set_regions_async(self, regions: _cabc.Iterable[RegionOfInterest], /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    ...
    def set_regions_async(self, regions: _cabc.Iterable[RegionOfInterest], lock_values: bool, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of set_regions_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Media.Devices.RegionsOfInterestControl::SetRegionsAsync(Windows.Foundation.Collections.IIterable`1<Windows.Media.Devices.RegionOfInterest>,System.Boolean)
    @deprecated("Use set_regions_async() instead.")
    def set_regions_with_lock_async(self, regions: _cabc.Iterable[RegionOfInterest], lock_values: bool, /) -> windows_foundation.IAsyncAction: ...
...
class SceneModeControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> _cabc.Sequence[CaptureSceneMode]: ...
...
class VideoDeviceController(winrt.system.Object, IMediaDeviceController):
    ...
    def get_device_property_by_extended_id(self, extended_property_id: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, max_property_value_size: winrt.system.UInt32 | None, /) -> VideoDeviceControllerGetDevicePropertyResult: ...
    ...
    def get_device_property_by_id(self, property_id: str, max_property_value_size: winrt.system.UInt32 | None, /) -> VideoDeviceControllerGetDevicePropertyResult: ...
    ...
    def set_device_property_by_extended_id(self, extended_property_id: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, property_value: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> VideoDeviceControllerSetDevicePropertyStatus: ...
    ...
    def try_get_powerline_frequency(self) -> tuple[bool, windows_media_capture.PowerlineFrequency]: ...
...
class VideoTemporalDenoisingControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> _cabc.Sequence[VideoTemporalDenoisingMode]: ...
...
class ZoomControl(winrt.system.Object):
    ...
    @_property
    def supported_modes(self) -> _cabc.Sequence[ZoomTransitionMode]: ...
...
CallControlEventHandler: typing.TypeAlias = typing.Callable[[CallControl], None]
DialRequestedEventHandler: typing.TypeAlias = typing.Callable[[CallControl, DialRequestedEventArgs], None]
KeypadPressedEventHandler: typing.TypeAlias = typing.Callable[[CallControl, KeypadPressedEventArgs], None]
RedialRequestedEventHandler: typing.TypeAlias = typing.Callable[[CallControl, RedialRequestedEventArgs], None]
