    ...
    static PyObject* VariablePhotoSequenceCapture_UpdateSettingsAsync(py::wrapper::Windows::Media::Capture::Core::VariablePhotoSequenceCapture* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                ...
                {
                    auto _gil = release_gil();
                    return py::require<winrt::Windows::Media::Capture::Core::IVariablePhotoSequenceCapture2>(self->obj, py::member_kind::method, "Windows.Media.Capture.Core.VariablePhotoSequenceCapture", "UpdateSettingsAsync", "Windows.Media.Capture.Core.IVariablePhotoSequenceCapture2", 0).UpdateSettingsAsync();
                }());
            }
            catch (...)
            {
