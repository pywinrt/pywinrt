...
class ComboBox(windows_ui_xaml_controls_primitives.Selector, metaclass=ComboBox_Static):
    ...
    def remove_drop_down_closed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_drop_down_opened(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
...
class DatePickerFlyout(windows_ui_xaml_controls_primitives.PickerFlyoutBase, metaclass=DatePickerFlyout_Static):
    ...
    def show_at_async(self, target: windows_ui_xaml.FrameworkElement, /) -> windows_foundation.IAsyncOperation[datetime.datetime | None]: ...
    ...
    def remove_date_picked(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class InkToolbarPenButton(InkToolbarToolButton, metaclass=InkToolbarPenButton_Static):
    ...
    @_property
    def palette(self) -> _cabc.MutableSequence[windows_ui_xaml_media.Brush]: ...
    ...
    @palette.setter
    @typing.final
    def palette(self, value: _cabc.MutableSequence[windows_ui_xaml_media.Brush]) -> None: ...
...
class ListBox(windows_ui_xaml_controls_primitives.Selector, metaclass=ListBox_Static):
    ...
    @_property
    @typing.final
    def selected_items(self) -> _cabc.MutableSequence[winrt.system.Object]: ...
...
class ListPickerFlyout(windows_ui_xaml_controls_primitives.PickerFlyoutBase, metaclass=ListPickerFlyout_Static):
    ...
    def show_at_async(self, target: windows_ui_xaml.FrameworkElement, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[winrt.system.Object]]: ...
    ...
    def remove_items_picked(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ListViewBase(windows_ui_xaml_controls_primitives.Selector, ISemanticZoomInformation, metaclass=ListViewBase_Static):
    ...
    def remove_item_click(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_container_content_changing(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_choosing_group_header_container(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_choosing_item_container(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    @_property
    @typing.final
    def selected_ranges(self) -> _cabc.Sequence[windows_ui_xaml_data.ItemIndexRange]: ...
...
class PickerFlyout(windows_ui_xaml_controls_primitives.PickerFlyoutBase, metaclass=PickerFlyout_Static):
    ...
    def remove_confirmed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class TimePickerFlyout(windows_ui_xaml_controls_primitives.PickerFlyoutBase, metaclass=TimePickerFlyout_Static):
    ...
    def show_at_async(self, target: windows_ui_xaml.FrameworkElement, /) -> windows_foundation.IAsyncOperation[datetime.timedelta | None]: ...
    ...
    def remove_time_picked(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class VirtualizingStackPanel(windows_ui_xaml_controls_primitives.OrientedVirtualizingPanel, metaclass=VirtualizingStackPanel_Static):
    ...
    def remove_clean_up_virtualized_item_event(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
