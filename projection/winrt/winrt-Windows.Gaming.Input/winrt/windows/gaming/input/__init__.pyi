...
class ArcadeStickReading:
    ...
    def __new__(cls, timestamp: winrt.system.UInt64 = 0, buttons: ArcadeStickButtons = ...) -> ArcadeStickReading: ...
    def __replace__(self, /, **changes: typing.Any) -> ArcadeStickReading: ...
    def unpack(self) -> tuple[winrt.system.UInt64, ArcadeStickButtons]: ...
...
class FlightStickReading:
    ...
    def __new__(cls, timestamp: winrt.system.UInt64 = 0, buttons: FlightStickButtons = ..., hat_switch: GameControllerSwitchPosition = ..., roll: winrt.system.Double = 0, pitch: winrt.system.Double = 0, yaw: winrt.system.Double = 0, throttle: winrt.system.Double = 0) -> FlightStickReading: ...
    def __replace__(self, /, **changes: typing.Any) -> FlightStickReading: ...
    def unpack(self) -> tuple[winrt.system.UInt64, FlightStickButtons, GameControllerSwitchPosition, winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]: ...
...
class GamepadReading:
    ...
    def unpack(self) -> tuple[winrt.system.UInt64, GamepadButtons, winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]: ...
...
class RacingWheelReading:
    ...
    def __new__(cls, timestamp: winrt.system.UInt64 = 0, buttons: RacingWheelButtons = ..., pattern_shifter_gear: winrt.system.Int32 = 0, wheel: winrt.system.Double = 0, throttle: winrt.system.Double = 0, brake: winrt.system.Double = 0, clutch: winrt.system.Double = 0, handbrake: winrt.system.Double = 0) -> RacingWheelReading: ...
    def __replace__(self, /, **changes: typing.Any) -> RacingWheelReading: ...
    def unpack(self) -> tuple[winrt.system.UInt64, RacingWheelButtons, winrt.system.Int32, winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]: ...
...
class UINavigationReading:
    ...
    def __new__(cls, timestamp: winrt.system.UInt64 = 0, required_buttons: RequiredUINavigationButtons = ..., optional_buttons: OptionalUINavigationButtons = ...) -> UINavigationReading: ...
...
class ArcadeStick_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_arcade_stick_added(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_arcade_stick_removed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ArcadeStick(winrt.system.Object, IGameControllerBatteryInfo, IGameController, metaclass=ArcadeStick_Static):
    ...
    def remove_headset_connected(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_headset_disconnected(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_user_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class FlightStick_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_flight_stick_added(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_flight_stick_removed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class Gamepad_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_gamepad_added(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_gamepad_removed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class RacingWheel_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_racing_wheel_added(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_racing_wheel_removed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class RawGameController_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_raw_game_controller_added(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_raw_game_controller_removed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class RawGameController(winrt.system.Object, IGameControllerBatteryInfo, IGameController, metaclass=RawGameController_Static):
    ...
    def get_current_reading(self, button_array: winrt.system.Array[bool] | winrt.system.WriteableBuffer, switch_array: winrt.system.Array[GameControllerSwitchPosition] | winrt.system.WriteableBuffer, axis_array: winrt.system.Array[winrt.system.Double] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt64: ...
    ...
    @_property
    def force_feedback_motors(self) -> _cabc.Sequence[windows_gaming_input_forcefeedback.ForceFeedbackMotor]: ...
...
class UINavigationController_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_ui_navigation_controller_added(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_ui_navigation_controller_removed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
