...
class MseTimeRange:
    ...
    def __new__(cls, start: datetime.timedelta = ..., end: datetime.timedelta = ...) -> MseTimeRange: ...
...
class TimedTextDouble:
    ...
    def __new__(cls, value: winrt.system.Double = 0, unit: TimedTextUnit = ...) -> TimedTextDouble: ...
    def __replace__(self, /, **changes: typing.Any) -> TimedTextDouble: ...
    def unpack(self) -> tuple[winrt.system.Double, TimedTextUnit]: ...
...
class TimedTextPadding:
    ...
    @_property
    def unit(self) -> TimedTextUnit: ...
    def __new__(cls, before: winrt.system.Double = 0, after: winrt.system.Double = 0, start: winrt.system.Double = 0, end: winrt.system.Double = 0, unit: TimedTextUnit = ...) -> TimedTextPadding: ...
    def __replace__(self, /, **changes: typing.Any) -> TimedTextPadding: ...
    def unpack(self) -> tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double, TimedTextUnit]: ...
...
class TimedTextPoint:
    ...
    @_property
    def unit(self) -> TimedTextUnit: ...
    def __new__(cls, x: winrt.system.Double = 0, y: winrt.system.Double = 0, unit: TimedTextUnit = ...) -> TimedTextPoint: ...
...
class TimedTextSize:
    ...
    @_property
    def unit(self) -> TimedTextUnit: ...
    def __new__(cls, height: winrt.system.Double = 0, width: winrt.system.Double = 0, unit: TimedTextUnit = ...) -> TimedTextSize: ...
...
class AudioStreamDescriptor(winrt.system.Object, IMediaStreamDescriptor2, IMediaStreamDescriptor):
    ...
    @_property
    def trailing_encoder_padding(self) -> winrt.system.UInt32 | None: ...
    ...
    def trailing_encoder_padding(self, value: winrt.system.UInt32 | None) -> None: ...
    # Windows.Foundation.IReference`1<System.UInt32> Windows.Media.Core.AudioStreamDescriptor::get_LeadingEncoderPadding()
    @_property
    def leading_encoder_padding(self) -> winrt.system.UInt32 | None: ...
    ...
    def leading_encoder_padding(self, value: winrt.system.UInt32 | None) -> None: ...
...
class CodecInfo(winrt.system.Object):
    ...
    @_property
    def subtypes(self) -> _cabc.Sequence[str]: ...
...
class FaceDetectionEffect(winrt.system.Object, windows_media.IMediaExtension):
    ...
    def remove_face_detected(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class FaceDetectionEffectFrame(winrt.system.Object, windows_media.IMediaFrame, windows_foundation.IClosable):
    ...
    @_property
    def detected_faces(self) -> _cabc.Sequence[windows_media_faceanalysis.DetectedFace]: ...
...
class ImageCue(winrt.system.Object, IMediaCue):
    ...
    @position.setter
    def position(self, value: TimedTextPoint | tuple[winrt.system.Double, winrt.system.Double, TimedTextUnit]) -> None: ...
    ...
    @extent.setter
    def extent(self, value: TimedTextSize | tuple[winrt.system.Double, winrt.system.Double, TimedTextUnit]) -> None: ...
...
class LowLightFusion_Static(winrt._winrt.IInspectable_Static):
    ...
    @_property
    def supported_bitmap_pixel_formats(cls) -> _cabc.Sequence[windows_graphics_imaging.BitmapPixelFormat]: ...
...
class MediaBinder(winrt.system.Object):
    ...
    def remove_binding(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MediaSource(winrt.system.Object, windows_foundation.IClosable, windows_media_playback.IMediaPlaybackSource, metaclass=MediaSource_Static):
    ...
    def remove_open_operation_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MediaSourceAppServiceConnection(winrt.system.Object):
    def __new__(cls, app_service_connection: windows_applicationmodel_appservice.AppServiceConnection) -> typing.Self: ...
    ...
    def remove_initialize_media_stream_source_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MediaStreamSample(winrt.system.Object, metaclass=MediaStreamSample_Static):
    ...
    def remove_processed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MediaStreamSamplePropertySet(winrt.system.Object, winrt._winrt.MutableMapping[_uuid.UUID, winrt.system.Object]):
    ...
    def get_view(self) -> _cabc.Mapping[_uuid.UUID, winrt.system.Object]: ...
...
class MediaStreamSampleProtectionProperties(winrt.system.Object):
    ...
    def set_initialization_vector(self, value: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> None: ...
    # System.Void Windows.Media.Core.MediaStreamSampleProtectionProperties::SetKeyIdentifier(System.Byte[])
    def set_key_identifier(self, value: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> None: ...
...
class MediaStreamSource(winrt.system.Object, IMediaSource):
    ...
    @typing.overload
    def __new__(cls, descriptor: IMediaStreamDescriptor, descriptor2: IMediaStreamDescriptor) -> typing.Self: ...
    ...
    def add_protection_key(self, stream_descriptor: IMediaStreamDescriptor, key_identifier: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, license_data: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> None: ...
    ...
    def remove_paused(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_sample_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_switch_streams_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_sample_rendered(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def max_supported_playback_rate(self) -> winrt.system.Double | None: ...
    ...
    def max_supported_playback_rate(self, value: winrt.system.Double | None) -> None: ...
...
class MediaStreamSourceStartingRequest(winrt.system.Object):
    ...
    @_property
    def start_position(self) -> datetime.timedelta | None: ...
...
class MseSourceBuffer(winrt.system.Object):
    ...
    def remove(self, start: datetime.timedelta, end: datetime.timedelta | None, /) -> None: ...
    ...
    def remove_aborted(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_update_ended(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_update_starting(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def append_window_end(self) -> datetime.timedelta | None: ...
    ...
    def append_window_end(self, value: datetime.timedelta | None) -> None: ...
    ...
    @_property
    def buffered(self) -> _cabc.Sequence[MseTimeRange]: ...
...
class MseSourceBufferList(winrt.system.Object):
    ...
    def remove_source_buffer_added(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_source_buffer_removed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MseStreamSource(winrt.system.Object, IMediaSource, metaclass=MseStreamSource_Static):
    ...
    @_property
    def live_seekable_range(self) -> MseTimeRange | None: ...
...
class SceneAnalysisEffect(winrt.system.Object, windows_media.IMediaExtension):
    ...
    def remove_scene_analyzed(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class SpeechCue(winrt.system.Object, IMediaCue):
    ...
    @_property
    def start_position_in_input(self) -> winrt.system.Int32 | None: ...
    ...
    def start_position_in_input(self, value: winrt.system.Int32 | None) -> None: ...
    # Windows.Foundation.IReference`1<System.Int32> Windows.Media.Core.SpeechCue::get_EndPositionInInput()
    @_property
    def end_position_in_input(self) -> winrt.system.Int32 | None: ...
...
class TimedMetadataTrack(winrt.system.Object, IMediaTrack):
    ...
    def remove_cue_entered(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_cue_exited(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_track_failed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class TimedTextCue(winrt.system.Object, IMediaCue):
    ...
    @_property
    def lines(self) -> _cabc.MutableSequence[TimedTextLine]: ...
...
class TimedTextLine(winrt.system.Object):
    ...
    @_property
    def subformats(self) -> _cabc.MutableSequence[TimedTextSubformat]: ...
...
class TimedTextRegion(winrt.system.Object):
    ...
    @line_height.setter
    def line_height(self, value: TimedTextDouble | tuple[winrt.system.Double, TimedTextUnit]) -> None: ...
    ...
    @padding.setter
    def padding(self, value: TimedTextPadding | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double, TimedTextUnit]) -> None: ...
    ...
    @background.setter
    def background(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
...
class TimedTextSource(winrt.system.Object, metaclass=TimedTextSource_Static):
    ...
    def remove_resolved(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class TimedTextSourceResolveResultEventArgs(winrt.system.Object):
    ...
    @_property
    def tracks(self) -> _cabc.Sequence[TimedMetadataTrack]: ...
...
class TimedTextStyle(winrt.system.Object):
    ...
    @foreground.setter
    def foreground(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
    ...
    @font_size.setter
    def font_size(self, value: TimedTextDouble | tuple[winrt.system.Double, TimedTextUnit]) -> None: ...
    ...
    def outline_thickness(self, value: TimedTextDouble | tuple[winrt.system.Double, TimedTextUnit]) -> None: ...
    ...
    def outline_radius(self, value: TimedTextDouble | tuple[winrt.system.Double, TimedTextUnit]) -> None: ...
...
class VideoStabilizationEffect(winrt.system.Object, windows_media.IMediaExtension):
    ...
    def remove_enabled_changed(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ITimedMetadataTrackProvider(winrt._winrt.IInspectable):
    ...
    @_property
    @abstractmethod
    def timed_metadata_tracks(self) -> _cabc.Sequence[TimedMetadataTrack]: ...
