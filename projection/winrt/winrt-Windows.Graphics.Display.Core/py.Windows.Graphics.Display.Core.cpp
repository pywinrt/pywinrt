...
namespace py::cpp::Windows::Graphics::Display::Core
{
    ...
    static PyObject* HdmiDisplayInformation_GetForCurrentView(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Graphics.Display.Core.HdmiDisplayInformation", "GetForCurrentView", nullptr, py::site_is_static};
