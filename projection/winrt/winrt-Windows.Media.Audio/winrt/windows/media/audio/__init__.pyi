...
class AudioDeviceInputNode(winrt.system.Object, IAudioInputNode2, IAudioInputNode, IAudioNode, windows_foundation.IClosable):
    ...
    def add_outgoing_connection(self, destination: IAudioNode, gain: winrt.system.Double, /) -> None: ...
    # Deprecated alias of add_outgoing_connection() for pywinrt v3.x compatibility.
    # System.Void Windows.Media.Audio.AudioDeviceInputNode::AddOutgoingConnection(Windows.Media.Audio.IAudioNode,System.Double)
    @deprecated("Use add_outgoing_connection() instead.")
    ...
    @_property
    def outgoing_connections(self) -> _cabc.Sequence[AudioGraphConnection]: ...
    ...
    @_property
    def effect_definitions(self) -> _cabc.MutableSequence[windows_media_effects.IAudioEffectDefinition]: ...
...
class AudioFileInputNode(winrt.system.Object, IAudioInputNode2, IAudioInputNode, IAudioNode, windows_foundation.IClosable):
    ...
    def remove_file_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @start_time.setter
    def start_time(self, value: datetime.timedelta | None) -> None: ...
...
class AudioFrameInputNode(winrt.system.Object, IAudioInputNode2, IAudioInputNode, IAudioNode, windows_foundation.IClosable):
    ...
    def remove_audio_frame_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_quantum_started(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AudioGraph(winrt.system.Object, windows_foundation.IClosable, metaclass=AudioGraph_Static):
    ...
    def create_device_input_node_async(self, category: windows_media_capture.MediaCategory, encoding_properties: windows_media_mediaproperties.AudioEncodingProperties, /) -> windows_foundation.IAsyncOperation[CreateAudioDeviceInputNodeResult]: ...
    @typing.overload
    ...
    def create_device_input_node_async(self, category: windows_media_capture.MediaCategory, encoding_properties: windows_media_mediaproperties.AudioEncodingProperties, device: windows_devices_enumeration.DeviceInformation, /) -> windows_foundation.IAsyncOperation[CreateAudioDeviceInputNodeResult]: ...
    @typing.overload
    ...
    # Deprecated alias of create_device_input_node_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Media.Audio.CreateAudioDeviceInputNodeResult> Windows.Media.Audio.AudioGraph::CreateDeviceInputNodeAsync(Windows.Media.Capture.MediaCategory,Windows.Media.MediaProperties.AudioEncodingProperties,Windows.Devices.Enumeration.DeviceInformation,Windows.Media.Audio.AudioNodeEmitter)
    @deprecated("Use create_device_input_node_async() instead.")
    ...
    def create_file_input_node_async(self, file: windows_storage.IStorageFile, emitter: AudioNodeEmitter, /) -> windows_foundation.IAsyncOperation[CreateAudioFileInputNodeResult]: ...
    # Deprecated alias of create_file_input_node_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Media.Audio.CreateAudioFileInputNodeResult> Windows.Media.Audio.AudioGraph::CreateFileInputNodeAsync(Windows.Storage.IStorageFile,Windows.Media.Audio.AudioNodeEmitter)
    @deprecated("Use create_file_input_node_async() instead.")
    ...
    def create_file_output_node_async(self, file: windows_storage.IStorageFile, file_encoding_profile: windows_media_mediaproperties.MediaEncodingProfile, /) -> windows_foundation.IAsyncOperation[CreateAudioFileOutputNodeResult]: ...
    # Deprecated alias of create_file_output_node_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Media.Audio.CreateAudioFileOutputNodeResult> Windows.Media.Audio.AudioGraph::CreateFileOutputNodeAsync(Windows.Storage.IStorageFile,Windows.Media.MediaProperties.MediaEncodingProfile)
    @deprecated("Use create_file_output_node_async() instead.")
    ...
    def create_frame_input_node(self, encoding_properties: windows_media_mediaproperties.AudioEncodingProperties, /) -> AudioFrameInputNode: ...
    @typing.overload
    ...
    def create_frame_input_node(self, encoding_properties: windows_media_mediaproperties.AudioEncodingProperties, emitter: AudioNodeEmitter, /) -> AudioFrameInputNode: ...
    # Deprecated alias of create_frame_input_node() for pywinrt v3.x compatibility.
    # Windows.Media.Audio.AudioFrameInputNode Windows.Media.Audio.AudioGraph::CreateFrameInputNode(Windows.Media.MediaProperties.AudioEncodingProperties)
    @deprecated("Use create_frame_input_node() instead.")
    ...
    def create_frame_output_node(self, encoding_properties: windows_media_mediaproperties.AudioEncodingProperties, /) -> AudioFrameOutputNode: ...
    # Deprecated alias of create_frame_output_node() for pywinrt v3.x compatibility.
    # Windows.Media.Audio.AudioFrameOutputNode Windows.Media.Audio.AudioGraph::CreateFrameOutputNode(Windows.Media.MediaProperties.AudioEncodingProperties)
    @deprecated("Use create_frame_output_node() instead.")
    ...
    def create_media_source_audio_input_node_async(self, media_source: windows_media_core.MediaSource, emitter: AudioNodeEmitter, /) -> windows_foundation.IAsyncOperation[CreateMediaSourceAudioInputNodeResult]: ...
    # Deprecated alias of create_media_source_audio_input_node_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Media.Audio.CreateMediaSourceAudioInputNodeResult> Windows.Media.Audio.AudioGraph::CreateMediaSourceAudioInputNodeAsync(Windows.Media.Core.MediaSource,Windows.Media.Audio.AudioNodeEmitter)
    @deprecated("Use create_media_source_audio_input_node_async() instead.")
    ...
    def create_submix_node(self, encoding_properties: windows_media_mediaproperties.AudioEncodingProperties, /) -> AudioSubmixNode: ...
    @typing.overload
    ...
    def create_submix_node(self, encoding_properties: windows_media_mediaproperties.AudioEncodingProperties, emitter: AudioNodeEmitter, /) -> AudioSubmixNode: ...
    # Deprecated alias of create_submix_node() for pywinrt v3.x compatibility.
    # Windows.Media.Audio.AudioSubmixNode Windows.Media.Audio.AudioGraph::CreateSubmixNode(Windows.Media.MediaProperties.AudioEncodingProperties)
    @deprecated("Use create_submix_node() instead.")
    ...
    def remove_quantum_processed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_unrecoverable_error_occurred(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AudioGraphSettings(winrt.system.Object):
    def __new__(cls: type[Self], audio_render_category: windows_media_render.AudioRenderCategory) -> Self: ...
...
class AudioNodeEmitter(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], shape: AudioNodeEmitterShape, decay_model: AudioNodeEmitterDecayModel, settings: AudioNodeEmitterSettings) -> Self: ...
    @typing.overload
    ...
    @position.setter
    def position(self, value: windows_foundation_numerics.Vector3 | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single]) -> None: ...
    ...
    def doppler_velocity(self, value: windows_foundation_numerics.Vector3 | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single]) -> None: ...
...
class AudioStateMonitor_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_for_capture_monitoring(cls, category: windows_media_capture.MediaCategory, /) -> AudioStateMonitor: ...
    @typing.overload
    ...
    def create_for_capture_monitoring(cls, category: windows_media_capture.MediaCategory, role: windows_media_devices.AudioDeviceRole, /) -> AudioStateMonitor: ...
    # Deprecated alias of create_for_capture_monitoring() for pywinrt v3.x compatibility.
    # Windows.Media.Audio.AudioStateMonitor Windows.Media.Audio.AudioStateMonitor::CreateForCaptureMonitoring(Windows.Media.Capture.MediaCategory)
    @deprecated("Use create_for_capture_monitoring() instead.")
    ...
    def create_for_render_monitoring(cls, category: windows_media_render.AudioRenderCategory, /) -> AudioStateMonitor: ...
    @typing.overload
    ...
    def create_for_render_monitoring(cls, category: windows_media_render.AudioRenderCategory, role: windows_media_devices.AudioDeviceRole, /) -> AudioStateMonitor: ...
    # Deprecated alias of create_for_render_monitoring() for pywinrt v3.x compatibility.
    # Windows.Media.Audio.AudioStateMonitor Windows.Media.Audio.AudioStateMonitor::CreateForRenderMonitoring(Windows.Media.Render.AudioRenderCategory)
    @deprecated("Use create_for_render_monitoring() instead.")
...
class AudioStateMonitor(winrt.system.Object, metaclass=AudioStateMonitor_Static):
    ...
    def remove_sound_level_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class EchoEffectDefinition(winrt.system.Object, windows_media_effects.IAudioEffectDefinition):
    def __new__(cls: type[Self], audio_graph: AudioGraph) -> Self: ...
...
class EqualizerEffectDefinition(winrt.system.Object, windows_media_effects.IAudioEffectDefinition):
    ...
    @_property
    def bands(self) -> _cabc.Sequence[EqualizerBand]: ...
...
class MediaSourceAudioInputNode(winrt.system.Object, IAudioInputNode2, IAudioInputNode, IAudioNode, windows_foundation.IClosable):
    ...
    def remove_media_source_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class SpatialAudioDeviceConfiguration(winrt.system.Object, metaclass=SpatialAudioDeviceConfiguration_Static):
    ...
    def remove_configuration_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
