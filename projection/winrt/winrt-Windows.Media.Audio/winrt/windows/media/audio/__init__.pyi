...
class AudioGraphSettings(winrt.system.Object):
    def __new__(cls, audio_render_category: windows_media_render.AudioRenderCategory) -> typing.Self: ...
...
class AudioNodeEmitter(winrt.system.Object):
    @typing.overload
    def __new__(cls, shape: AudioNodeEmitterShape, decay_model: AudioNodeEmitterDecayModel, settings: AudioNodeEmitterSettings) -> typing.Self: ...
    @typing.overload
