...
namespace py::cpp::Windows::Devices::Portable
{
    ...
    static PyObject* ServiceDevice_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Portable.ServiceDevice", "GetDeviceSelector", nullptr, py::site_is_static};
    ...
    static PyObject* ServiceDevice_GetDeviceSelectorFromServiceId(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Portable.ServiceDevice", "GetDeviceSelectorFromServiceId", nullptr, py::site_is_static};
    ...
    static PyObject* StorageDevice_FromId(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Portable.StorageDevice", "FromId", nullptr, py::site_is_static};
    ...
    static PyObject* StorageDevice_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.Portable.StorageDevice", "GetDeviceSelector", nullptr, py::site_is_static};
