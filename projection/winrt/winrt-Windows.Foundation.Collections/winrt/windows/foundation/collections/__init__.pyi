...
class IMapView(IIterable[IKeyValuePair[K, V]], winrt._winrt.Mapping[K, V], winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def split(self) -> tuple[_cabc.Mapping[K, V], _cabc.Mapping[K, V]]: ...
...
class IMap(IIterable[IKeyValuePair[K, V]], winrt._winrt.MutableMapping[K, V], winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def get_view(self) -> _cabc.Mapping[K, V]: ...
...
class IVectorView(IIterable[T], winrt._winrt.Sequence[T], winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[T] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    # System.Boolean Windows.Foundation.Collections.IVectorView`1::IndexOf(T,System.UInt32&)
    @abstractmethod
    def index_of(self, value: T, /) -> tuple[bool, winrt.system.UInt32]: ...
...
class IVector(IIterable[T], winrt._winrt.MutableSequence[T], winrt._winrt.IInspectable):
    ...
    @typing.overload
    def __setitem__(self, index: slice, value: _cabc.Iterable[T]) -> None: ...
    ...
    @abstractmethod
    def get_view(self) -> _cabc.Sequence[T]: ...
    ...
    @abstractmethod
    def replace_all(self, items: winrt.system.Array[T] | winrt.system.ReadableBuffer, /) -> None: ...
