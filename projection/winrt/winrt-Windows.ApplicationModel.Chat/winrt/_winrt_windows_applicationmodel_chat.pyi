...
class ChatConversation(winrt.system.Object, IChatItem):
    ...
    def remove_remote_participant_composing_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ChatConversationReader(winrt.system.Object):
    ...
    def read_batch_async(self, count: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[ChatConversation]]: ...
    # Deprecated alias of read_batch_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Chat.ChatConversation>> Windows.ApplicationModel.Chat.ChatConversationReader::ReadBatchAsync(System.Int32)
    @deprecated("Use read_batch_async() instead.")
    def read_batch_with_count_async(self, count: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[ChatConversation]]: ...
...
class ChatMessage(winrt.system.Object, IChatItem):
    ...
    @_property
    def recipient_send_statuses(self) -> _cabc.Mapping[str, ChatMessageStatus]: ...
    # Windows.Foundation.Collections.IVector`1<System.String> Windows.ApplicationModel.Chat.ChatMessage::get_Recipients()
    @_property
    def recipients(self) -> _cabc.MutableSequence[str]: ...
    ...
    @_property
    def attachments(self) -> _cabc.MutableSequence[ChatMessageAttachment]: ...
    ...
    @_property
    def recipients_delivery_infos(self) -> _cabc.MutableSequence[ChatRecipientDeliveryInfo]: ...
...
class ChatMessageChangeReader(winrt.system.Object):
    ...
    def read_batch_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[ChatMessageChange]]: ...
...
class ChatMessageManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_transports_async(cls) -> windows_foundation.IAsyncOperation[_cabc.Sequence[ChatMessageTransport]]: ...
...
class ChatMessageReader(winrt.system.Object):
    ...
    def read_batch_async(self, count: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[ChatMessage]]: ...
    # Deprecated alias of read_batch_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Chat.ChatMessage>> Windows.ApplicationModel.Chat.ChatMessageReader::ReadBatchAsync(System.Int32)
    @deprecated("Use read_batch_async() instead.")
    def read_batch_with_count_async(self, count: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[ChatMessage]]: ...
...
class ChatMessageStore(winrt.system.Object):
    ...
    def forward_message_async(self, local_chat_message_id: str, addresses: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[ChatMessage]: ...
    @typing.overload
    ...
    def get_conversation_async(self, conversation_id: str, transport_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[ChatConversation]: ...
    # Deprecated alias of get_conversation_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Chat.ChatConversation> Windows.ApplicationModel.Chat.ChatMessageStore::GetConversationAsync(System.String,Windows.Foundation.Collections.IIterable`1<System.String>)
    @deprecated("Use get_conversation_async() instead.")
    def get_conversation_for_transports_async(self, conversation_id: str, transport_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[ChatConversation]: ...
    ...
    def get_conversation_reader(self, transport_ids: _cabc.Iterable[str], /) -> ChatConversationReader: ...
    # Deprecated alias of get_conversation_reader() for pywinrt v3.x compatibility.
    # Windows.ApplicationModel.Chat.ChatConversationReader Windows.ApplicationModel.Chat.ChatMessageStore::GetConversationReader(Windows.Foundation.Collections.IIterable`1<System.String>)
    @deprecated("Use get_conversation_reader() instead.")
    def get_conversation_for_transports_reader(self, transport_ids: _cabc.Iterable[str], /) -> ChatConversationReader: ...
    ...
    def get_unseen_count_async(self, transport_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[winrt.system.Int32]: ...
    # Deprecated alias of get_unseen_count_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Int32> Windows.ApplicationModel.Chat.ChatMessageStore::GetUnseenCountAsync(Windows.Foundation.Collections.IIterable`1<System.String>)
    @deprecated("Use get_unseen_count_async() instead.")
    def get_unseen_count_for_transports_reader_async(self, transport_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[winrt.system.Int32]: ...
    @typing.overload
    ...
    def mark_as_seen_async(self, transport_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of mark_as_seen_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.ApplicationModel.Chat.ChatMessageStore::MarkAsSeenAsync(Windows.Foundation.Collections.IIterable`1<System.String>)
    @deprecated("Use mark_as_seen_async() instead.")
    def mark_as_seen_for_transports_async(self, transport_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncAction: ...
    ...
    def remove_message_changed(self, value: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ChatMessageValidationResult(winrt.system.Object):
    ...
    @_property
    def part_count(self) -> winrt.system.UInt32 | None: ...
    ...
    @_property
    def remaining_character_count_in_part(self) -> winrt.system.UInt32 | None: ...
...
class ChatRecipientDeliveryInfo(winrt.system.Object):
    ...
    @_property
    def read_time(self) -> datetime.datetime | None: ...
    ...
    @read_time.setter
    def read_time(self, value: datetime.datetime | None) -> None: ...
    ...
    @_property
    def delivery_time(self) -> datetime.datetime | None: ...
    ...
    def delivery_time(self, value: datetime.datetime | None) -> None: ...
...
class ChatSearchReader(winrt.system.Object):
    ...
    def read_batch_async(self, count: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[IChatItem]]: ...
    # Deprecated alias of read_batch_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.ApplicationModel.Chat.IChatItem>> Windows.ApplicationModel.Chat.ChatSearchReader::ReadBatchAsync(System.Int32)
    @deprecated("Use read_batch_async() instead.")
    def read_batch_with_count_async(self, count: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[IChatItem]]: ...
...
class RcsEndUserMessage(winrt.system.Object):
    ...
    @_property
    def actions(self) -> _cabc.Sequence[RcsEndUserMessageAction]: ...
...
class RcsEndUserMessageManager(winrt.system.Object):
    ...
    def remove_message_available_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class RcsManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_transports_async(cls) -> windows_foundation.IAsyncOperation[_cabc.Sequence[RcsTransport]]: ...
    ...
    def remove_transport_list_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class RcsTransport(winrt.system.Object):
    ...
    def remove_service_kind_supported_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
