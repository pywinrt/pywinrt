...
class AccessKeyManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_is_display_mode_enabled_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ContextRequestedEventArgs(windows_ui_xaml.RoutedEventArgs):
    ...
    def try_get_position(self, relative_to: windows_ui_xaml.UIElement, /) -> tuple[bool, windows_foundation.Point]: ...
...
class FindNextElementOptions(winrt.system.Object):
    ...
    @hint_rect.setter
    def hint_rect(self, value: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single]) -> None: ...
...
class FocusManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def find_next_focusable_element(cls, focus_navigation_direction: FocusNavigationDirection, hint_rect: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_ui_xaml.UIElement: ...
    ...
    def find_next_focusable_element_with_hint(cls, focus_navigation_direction: FocusNavigationDirection, hint_rect: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_ui_xaml.UIElement: ...
    @typing.overload
    ...
    def remove_getting_focus(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_got_focus(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_losing_focus(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_lost_focus(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class InputScope(windows_ui_xaml.DependencyObject):
    ...
    @_property
    def names(self) -> _cabc.MutableSequence[InputScopeName]: ...

@typing.final
class InputScopeName(windows_ui_xaml.DependencyObject):
    @typing.overload
    def __new__(cls: type[Self], name_value: InputScopeNameValue) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
class ManipulationPivot(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], center: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], radius: winrt.system.Double) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self]) -> Self: ...
...
class PointerRoutedEventArgs(windows_ui_xaml.RoutedEventArgs):
    ...
    def get_intermediate_points(self, relative_to: windows_ui_xaml.UIElement, /) -> _cabc.MutableSequence[windows_ui_input.PointerPoint]: ...
...
class StandardUICommand(XamlUICommand, metaclass=StandardUICommand_Static):
    ...
    def __new__(cls: type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], kind: StandardUICommandKind) -> Self: ...
...
class XamlUICommand(windows_ui_xaml.DependencyObject, ICommand, metaclass=XamlUICommand_Static):
    ...
    def remove_can_execute_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_execute_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    @typing.final
    ...
    def remove_can_execute_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    @typing.final
    def keyboard_accelerators(self) -> _cabc.MutableSequence[KeyboardAccelerator]: ...
...
DoubleTappedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, DoubleTappedRoutedEventArgs], None]
HoldingEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, HoldingRoutedEventArgs], None]
KeyEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, KeyRoutedEventArgs], None]
ManipulationCompletedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, ManipulationCompletedRoutedEventArgs], None]
ManipulationDeltaEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, ManipulationDeltaRoutedEventArgs], None]
ManipulationInertiaStartingEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, ManipulationInertiaStartingRoutedEventArgs], None]
ManipulationStartedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, ManipulationStartedRoutedEventArgs], None]
ManipulationStartingEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, ManipulationStartingRoutedEventArgs], None]
PointerEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, PointerRoutedEventArgs], None]
RightTappedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, RightTappedRoutedEventArgs], None]
TappedEventHandler: typing.TypeAlias = typing.Callable[[winrt.system.Object, TappedRoutedEventArgs], None]
