...
class InputScopeName(windows_ui_xaml.DependencyObject):
    @typing.overload
    def __new__(cls, name_value: InputScopeNameValue) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
...
class ManipulationPivot(winrt.system.Object):
    @typing.overload
    def __new__(cls, center: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], radius: winrt.system.Double) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
...
class StandardUICommand(XamlUICommand, metaclass=StandardUICommand_Static):
    ...
    def __new__(cls) -> typing.Self: ...
    @typing.overload
    def __new__(cls, kind: StandardUICommandKind) -> typing.Self: ...
