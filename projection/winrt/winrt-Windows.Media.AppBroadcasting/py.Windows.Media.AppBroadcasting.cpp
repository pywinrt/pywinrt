...
namespace py::cpp::Windows::Media::AppBroadcasting
{
    ...
    static PyObject* AppBroadcastingUI_GetDefault(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Media.AppBroadcasting.AppBroadcastingUI", "GetDefault", nullptr, py::site_is_static};
    ...
    static PyObject* AppBroadcastingUI_GetForUser(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Media.AppBroadcasting.AppBroadcastingUI", "GetForUser", nullptr, py::site_is_static};
