...
class Clipboard_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_history_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_history_enabled_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_roaming_enabled_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_content_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ClipboardContentOptions(winrt.system.Object):
    ...
    @_property
    def history_formats(self) -> _cabc.MutableSequence[str]: ...
    ...
    @_property
    def roaming_formats(self) -> _cabc.MutableSequence[str]: ...
...
class DataPackage(winrt.system.Object):
    ...
    def set_storage_items(self, value: _cabc.Iterable[windows_storage.IStorageItem], /) -> None: ...
    @typing.overload
    ...
    def set_storage_items(self, value: _cabc.Iterable[windows_storage.IStorageItem], read_only: bool, /) -> None: ...
    # Deprecated alias of set_storage_items() for pywinrt v3.x compatibility.
    # System.Void Windows.ApplicationModel.DataTransfer.DataPackage::SetStorageItems(Windows.Foundation.Collections.IIterable`1<Windows.Storage.IStorageItem>)
    @deprecated("Use set_storage_items() instead.")
    def set_storage_items_read_only(self, value: _cabc.Iterable[windows_storage.IStorageItem], /) -> None: ...
    ...
    def remove_operation_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_share_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_share_canceled(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def resource_map(self) -> _cabc.MutableMapping[str, windows_storage_streams.RandomAccessStreamReference]: ...
...
class DataPackagePropertySet(winrt.system.Object, winrt._winrt.MutableMapping[str, winrt.system.Object]):
    ...
    @_property
    def file_types(self) -> _cabc.MutableSequence[str]: ...
    ...
    def logo_background_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
...
class DataPackagePropertySetView(winrt.system.Object, winrt._winrt.Mapping[str, winrt.system.Object]):
    ...
    @_property
    def file_types(self) -> _cabc.Sequence[str]: ...
...
class DataPackageView(winrt.system.Object):
    ...
    def get_resource_map_async(self) -> windows_foundation.IAsyncOperation[_cabc.Mapping[str, windows_storage_streams.RandomAccessStreamReference]]: ...
    ...
    def get_storage_items_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[windows_storage.IStorageItem]]: ...
    @typing.overload
    ...
    def get_text_async(self, format_id: str, /) -> windows_foundation.IAsyncOperation[str]: ...
    # Deprecated alias of get_text_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.String> Windows.ApplicationModel.DataTransfer.DataPackageView::GetTextAsync(System.String)
    @deprecated("Use get_text_async() instead.")
    ...
    def request_access_async(self, enterprise_id: str, /) -> windows_foundation.IAsyncOperation[windows_security_enterprisedata.ProtectionPolicyEvaluationResult]: ...
    ...
    @_property
    def available_formats(self) -> _cabc.Sequence[str]: ...
...
class DataTransferManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def show_share_ui(cls, options: ShareUIOptions, /) -> None: ...
    # Deprecated alias of show_share_ui() for pywinrt v3.x compatibility.
    # System.Void Windows.ApplicationModel.DataTransfer.DataTransferManager::ShowShareUI(Windows.ApplicationModel.DataTransfer.ShareUIOptions)
    @deprecated("Use show_share_ui() instead.")
...
class DataTransferManager(winrt.system.Object, metaclass=DataTransferManager_Static):
    ...
    def remove_data_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_target_application_chosen(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_share_providers_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ShareProvidersRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def providers(self) -> _cabc.MutableSequence[ShareProvider]: ...
