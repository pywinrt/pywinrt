...
class UserActivity_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_parse_from_json_array(cls, json: str, /) -> _cabc.MutableSequence[UserActivity]: ...

@typing.final
class UserActivity(winrt.system.Object, metaclass=UserActivity_Static):
    def __new__(cls: type[Self], activity_id: str) -> Self: ...
...
class UserActivityAttribution(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], icon_uri: windows_foundation.Uri) -> Self: ...
    @typing.overload
...
class UserActivityChannel_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_get_for_web_account(cls, account: windows_security_credentials.WebAccount, /) -> UserActivityChannel | None: ...
...
class UserActivityChannel(winrt.system.Object, metaclass=UserActivityChannel_Static):
    ...
    def get_recent_user_activities_async(self, max_unique_activities: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[UserActivitySessionHistoryItem]]: ...
...
class UserActivityRequestManager(winrt.system.Object, metaclass=UserActivityRequestManager_Static):
    ...
    def remove_user_activity_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
