...
namespace py::cpp::Windows::UI::Composition::Diagnostics
{
    ...
    static PyObject* CompositionDebugSettings_TryGetSettings(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.UI.Composition.Diagnostics.CompositionDebugSettings", "TryGetSettings", nullptr, py::site_is_static};
