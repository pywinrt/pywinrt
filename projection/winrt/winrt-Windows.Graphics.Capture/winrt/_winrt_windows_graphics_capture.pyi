...
class Direct3D11CaptureFramePool(winrt.system.Object, windows_foundation.IClosable, metaclass=Direct3D11CaptureFramePool_Static):
    ...
    def recreate(self, device: windows_graphics_directx_direct3d11.IDirect3DDevice, pixel_format: windows_graphics_directx.DirectXPixelFormat, number_of_buffers: winrt.system.Int32, size: windows_graphics.SizeInt32 | tuple[winrt.system.Int32, winrt.system.Int32], /) -> None: ...
    # Windows.Graphics.Capture.Direct3D11CaptureFrame Windows.Graphics.Capture.Direct3D11CaptureFramePool::TryGetNextFrame()
    def try_get_next_frame(self) -> Direct3D11CaptureFrame | None: ...
...
class GraphicsCaptureItem_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_create_from_display_id(cls, display_id: windows_graphics.DisplayId | tuple[winrt.system.UInt64], /) -> GraphicsCaptureItem | None: ...
    ...
    def try_create_from_window_id(cls, window_id: windows_ui.WindowId | tuple[winrt.system.UInt64], /) -> GraphicsCaptureItem | None: ...
