...
class SpatialGestureRecognizer(winrt.system.Object):
    ...
    def remove_hold_canceled(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_hold_completed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_hold_started(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_manipulation_canceled(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_manipulation_updated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_navigation_canceled(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_navigation_started(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_navigation_updated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_recognition_ended(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_recognition_started(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class SpatialInteractionController(winrt.system.Object):
    ...
    def try_get_renderable_model_async(self) -> windows_foundation.IAsyncOperation[windows_storage_streams.IRandomAccessStreamWithContentType | None]: ...
...
class SpatialInteractionManager(winrt.system.Object, metaclass=SpatialInteractionManager_Static):
    ...
    def remove_interaction_detected(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_source_detected(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_source_lost(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_source_pressed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_source_released(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_source_updated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class SpatialInteractionSource(winrt.system.Object):
    ...
    def try_create_hand_mesh_observer_async(self) -> windows_foundation.IAsyncOperation[windows_perception_people.HandMeshObserver | None]: ...
    ...
    def try_get_state_at_timestamp(self, timestamp: windows_perception.PerceptionTimestamp, /) -> SpatialInteractionSourceState | None: ...
...
class SpatialInteractionSourceLocation(winrt.system.Object):
    ...
    @_property
    def velocity(self) -> windows_foundation_numerics.Vector3 | None: ...
    ...
    @_property
    def orientation(self) -> windows_foundation_numerics.Quaternion | None: ...
    ...
    @_property
    def angular_velocity(self) -> windows_foundation_numerics.Vector3 | None: ...
...
class SpatialInteractionSourceProperties(winrt.system.Object):
    ...
    def try_get_source_loss_mitigation_direction(self, coordinate_system: windows_perception_spatial.SpatialCoordinateSystem, /) -> windows_foundation_numerics.Vector3 | None: ...
