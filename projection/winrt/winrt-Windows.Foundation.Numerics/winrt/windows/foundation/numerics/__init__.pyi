...
class Matrix3x2(metaclass=Matrix3x2_Static):
    ...
    def __iadd__(self, other: Matrix3x2) -> typing.Self: ...
    def __isub__(self, other: Matrix3x2) -> typing.Self: ...
    @typing.overload
    def __imul__(self, other: Matrix3x2) -> typing.Self: ...
    @typing.overload
    def __imul__(self, other: float) -> typing.Self: ...
    def is_identity(self) -> bool: ...
    def determinant(self) -> float: ...
    def translation(self) -> Vector2: ...
    def invert(self) -> Matrix3x2: ...
    def lerp(self, value: Matrix3x2, amount: float) -> Matrix3x2: ...
    def unpack(self) -> tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single]: ...
...
class Matrix4x4(metaclass=Matrix4x4_Static):
    ...
    def __iadd__(self, other: Matrix4x4) -> typing.Self: ...
    def __isub__(self, other: Matrix4x4) -> typing.Self: ...
    @typing.overload
    def __imul__(self, other: Matrix4x4) -> typing.Self: ...
    @typing.overload
    def __imul__(self, other: float) -> typing.Self: ...
    def is_identity(self) -> bool: ...
    def determinant(self) -> float: ...
    ...
    def unpack(self) -> tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single]: ...
...
class Plane(metaclass=Plane_Static):
    ...
    def __new__(cls, normal: Vector3 = ..., d: winrt.system.Single = 0) -> Plane: ...
...
class Quaternion(metaclass=Quaternion_Static):
    ...
    def __iadd__(self, other: Quaternion) -> typing.Self: ...
    def __isub__(self, other: Quaternion) -> typing.Self: ...
    @typing.overload
    def __imul__(self, other: Quaternion) -> typing.Self: ...
    @typing.overload
    def __imul__(self, other: float) -> typing.Self: ...
    def __itruediv__(self, value: Quaternion) -> typing.Self: ...
...
class Vector2(metaclass=Vector2_Static):
    ...
    def __iadd__(self, other: Vector2) -> typing.Self: ...
    def __isub__(self, other: Vector2) -> typing.Self: ...
    @typing.overload
    def __imul__(self, other: Vector2) -> typing.Self: ...
    @typing.overload
    def __imul__(self, other: float) -> typing.Self: ...
    @typing.overload
    def __itruediv__(self, value: Vector2) -> typing.Self: ...
    @typing.overload
...
class Vector3(metaclass=Vector3_Static):
    ...
    def __iadd__(self, other: Vector3) -> typing.Self: ...
    def __isub__(self, other: Vector3) -> typing.Self: ...
    @typing.overload
    def __imul__(self, other: Vector3) -> typing.Self: ...
    @typing.overload
    def __imul__(self, other: float) -> typing.Self: ...
    @typing.overload
    def __itruediv__(self, value: Vector3) -> typing.Self: ...
    @typing.overload
    def __itruediv__(self, value: float) -> typing.Self: ...
    def __abs__(self) -> float: ...
    def length(self) -> float: ...
...
class Vector4(metaclass=Vector4_Static):
    ...
    def __iadd__(self, other: Vector4) -> typing.Self: ...
    def __isub__(self, other: Vector4) -> typing.Self: ...
    @typing.overload
    def __imul__(self, other: Vector4) -> typing.Self: ...
    @typing.overload
    def __imul__(self, other: float) -> typing.Self: ...
    @typing.overload
    def __itruediv__(self, value: Vector4) -> typing.Self: ...
    @typing.overload
    def __itruediv__(self, value: float) -> typing.Self: ...
    def __abs__(self) -> float: ...
    def length(self) -> float: ...
