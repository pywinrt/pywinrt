...
namespace py::cpp::Windows::Security::Authentication::OnlineId
{
    ...
    static PyObject* OnlineIdSystemAuthenticator_GetForUser(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Security.Authentication.OnlineId.OnlineIdSystemAuthenticator", "GetForUser", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.Security.Authentication.OnlineId.OnlineIdSystemAuthenticator", "Default", nullptr, py::site_is_static};
