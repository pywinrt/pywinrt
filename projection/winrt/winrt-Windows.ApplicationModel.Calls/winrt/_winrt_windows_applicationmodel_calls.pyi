...
class LockScreenCallUI(winrt.system.Object):
    ...
    def remove_end_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PhoneCall(winrt.system.Object, metaclass=PhoneCall_Static):
    ...
    def remove_audio_device_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PhoneCallHistoryEntryQueryOptions(winrt.system.Object):
    ...
    @_property
    def source_ids(self) -> _cabc.MutableSequence[str]: ...
...
class PhoneCallHistoryStore(winrt.system.Object):
    ...
    # Deprecated alias of get_entry_reader() for pywinrt v3.x compatibility.
    # Windows.ApplicationModel.Calls.PhoneCallHistoryEntryReader Windows.ApplicationModel.Calls.PhoneCallHistoryStore::GetEntryReader(Windows.ApplicationModel.Calls.PhoneCallHistoryEntryQueryOptions)
    @deprecated("Use get_entry_reader() instead.")
    ...
    def get_sources_unseen_count_async(self, source_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[winrt.system.UInt32]: ...
    ...
    def mark_entries_as_seen_async(self, call_history_entries: _cabc.Iterable[PhoneCallHistoryEntry], /) -> windows_foundation.IAsyncAction: ...
    ...
    def mark_sources_as_seen_async(self, source_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncAction: ...
...
class PhoneCallManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_call_state_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PhoneLine(winrt.system.Object, metaclass=PhoneLine_Static):
    ...
    def remove_line_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PhoneLineTransportDevice(winrt.system.Object, metaclass=PhoneLineTransportDevice_Static):
    ...
    def remove_audio_routing_status_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_in_band_ringing_enabled_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PhoneLineWatcher(winrt.system.Object):
    ...
    def remove_line_added(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_line_removed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_line_updated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class VoipCallCoordinator(winrt.system.Object, metaclass=VoipCallCoordinator_Static):
    ...
    def request_new_incoming_call(self, context: str, contact_name: str, contact_number: str, contact_image: windows_foundation.Uri, service_name: str, branding_image: windows_foundation.Uri, call_details: str, ringtone: windows_foundation.Uri, media: VoipPhoneCallMedia, ring_timeout: datetime.timedelta, contact_remote_id: str, /) -> VoipPhoneCall: ...
    # Deprecated alias of request_new_incoming_call() for pywinrt v3.x compatibility.
    # Windows.ApplicationModel.Calls.VoipPhoneCall Windows.ApplicationModel.Calls.VoipCallCoordinator::RequestNewIncomingCall(System.String,System.String,System.String,Windows.Foundation.Uri,System.String,Windows.Foundation.Uri,System.String,Windows.Foundation.Uri,Windows.ApplicationModel.Calls.VoipPhoneCallMedia,Windows.Foundation.TimeSpan,System.String)
    @deprecated("Use request_new_incoming_call() instead.")
    ...
    # Deprecated alias of reserve_call_resources_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.ApplicationModel.Calls.VoipPhoneCallResourceReservationStatus> Windows.ApplicationModel.Calls.VoipCallCoordinator::ReserveCallResourcesAsync()
    @deprecated("Use reserve_call_resources_async() instead.")
    ...
    def remove_mute_state_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class VoipPhoneCall(winrt.system.Object):
    ...
    def get_associated_call_control_devices(self) -> _cabc.Sequence[str]: ...
    ...
    def notify_call_active(self, associated_device_ids: _cabc.Iterable[str], /) -> None: ...
    # Deprecated alias of notify_call_active() for pywinrt v3.x compatibility.
    # System.Void Windows.ApplicationModel.Calls.VoipPhoneCall::NotifyCallActive(Windows.Foundation.Collections.IIterable`1<System.String>)
    @deprecated("Use notify_call_active() instead.")
    def notify_call_active_on_devices(self, associated_device_ids: _cabc.Iterable[str], /) -> None: ...
    ...
    def set_associated_call_control_devices(self, associated_device_ids: _cabc.Iterable[str], /) -> None: ...
    ...
    def remove_hold_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_reject_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_resume_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
