...
namespace py::cpp::Windows::UI::WindowManagement::Preview
{
    ...
    static PyObject* WindowManagementPreview_SetPreferredMinSize(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.UI.WindowManagement.Preview.WindowManagementPreview", "SetPreferredMinSize", nullptr, py::site_is_static};
