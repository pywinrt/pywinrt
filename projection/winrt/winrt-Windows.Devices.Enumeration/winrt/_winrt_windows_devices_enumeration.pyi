...
class DeviceAccessInformation(winrt.system.Object, metaclass=DeviceAccessInformation_Static):
    ...
    def remove_access_changed(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class DeviceInformation_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_from_id_async(cls, device_id: str, additional_properties: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[DeviceInformation]: ...
    @typing.overload
    ...
    def create_from_id_async(cls, device_id: str, additional_properties: _cabc.Iterable[str], kind: DeviceInformationKind, /) -> windows_foundation.IAsyncOperation[DeviceInformation]: ...
    @typing.overload
    ...
    def create_from_id_async(cls, device_id: str, additional_properties: _cabc.Iterable[str], kind: DeviceInformationKind, settings: IDeviceEnumerationSettings, /) -> windows_foundation.IAsyncOperation[DeviceInformation]: ...
    # Deprecated alias of create_from_id_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.Enumeration.DeviceInformation> Windows.Devices.Enumeration.DeviceInformation::CreateFromIdAsync(System.String,Windows.Foundation.Collections.IIterable`1<System.String>)
    @deprecated("Use create_from_id_async() instead.")
    def create_from_id_async_additional_properties(cls, device_id: str, additional_properties: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[DeviceInformation]: ...
    # Deprecated alias of create_from_id_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.Enumeration.DeviceInformation> Windows.Devices.Enumeration.DeviceInformation::CreateFromIdAsync(System.String,Windows.Foundation.Collections.IIterable`1<System.String>,Windows.Devices.Enumeration.DeviceInformationKind,Windows.Devices.Enumeration.IDeviceEnumerationSettings)
    @deprecated("Use create_from_id_async() instead.")
    def create_from_id_async_with_additional_properties_kind_and_settings(cls, device_id: str, additional_properties: _cabc.Iterable[str], kind: DeviceInformationKind, settings: IDeviceEnumerationSettings, /) -> windows_foundation.IAsyncOperation[DeviceInformation]: ...
    # Deprecated alias of create_from_id_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.Enumeration.DeviceInformation> Windows.Devices.Enumeration.DeviceInformation::CreateFromIdAsync(System.String,Windows.Foundation.Collections.IIterable`1<System.String>,Windows.Devices.Enumeration.DeviceInformationKind)
    @deprecated("Use create_from_id_async() instead.")
    def create_from_id_async_with_kind_and_additional_properties(cls, device_id: str, additional_properties: _cabc.Iterable[str], kind: DeviceInformationKind, /) -> windows_foundation.IAsyncOperation[DeviceInformation]: ...
    @typing.overload
    ...
    def create_watcher(cls, device_class: DeviceClass, /) -> DeviceWatcher: ...
    @typing.overload
    ...
    def create_watcher(cls, aqs_filter: str, additional_properties: _cabc.Iterable[str], /) -> DeviceWatcher: ...
    @typing.overload
    ...
    def create_watcher(cls, aqs_filter: str, additional_properties: _cabc.Iterable[str], kind: DeviceInformationKind, /) -> DeviceWatcher: ...
    @typing.overload
    ...
    def create_watcher(cls, aqs_filter: str, additional_properties: _cabc.Iterable[str], kind: DeviceInformationKind, settings: IDeviceEnumerationSettings, /) -> DeviceWatcher: ...
    # Deprecated alias of create_watcher() for pywinrt v3.x compatibility.
    # Windows.Devices.Enumeration.DeviceWatcher Windows.Devices.Enumeration.DeviceInformation::CreateWatcher(System.String,Windows.Foundation.Collections.IIterable`1<System.String>)
    @deprecated("Use create_watcher() instead.")
    def create_watcher_aqs_filter_and_additional_properties(cls, aqs_filter: str, additional_properties: _cabc.Iterable[str], /) -> DeviceWatcher: ...
    # Deprecated alias of create_watcher() for pywinrt v3.x compatibility.
    # Windows.Devices.Enumeration.DeviceWatcher Windows.Devices.Enumeration.DeviceInformation::CreateWatcher(Windows.Devices.Enumeration.DeviceClass)
    @deprecated("Use create_watcher() instead.")
    ...
    # Windows.Devices.Enumeration.DeviceWatcher Windows.Devices.Enumeration.DeviceInformation::CreateWatcher(System.String,Windows.Foundation.Collections.IIterable`1<System.String>,Windows.Devices.Enumeration.DeviceInformationKind,Windows.Devices.Enumeration.IDeviceEnumerationSettings)
    @deprecated("Use create_watcher() instead.")
    def create_watcher_with_aqs_filter_additional_properties_kind_and_settings(cls, aqs_filter: str, additional_properties: _cabc.Iterable[str], kind: DeviceInformationKind, settings: IDeviceEnumerationSettings, /) -> DeviceWatcher: ...
    # Deprecated alias of create_watcher() for pywinrt v3.x compatibility.
    # Windows.Devices.Enumeration.DeviceWatcher Windows.Devices.Enumeration.DeviceInformation::CreateWatcher(System.String,Windows.Foundation.Collections.IIterable`1<System.String>,Windows.Devices.Enumeration.DeviceInformationKind)
    @deprecated("Use create_watcher() instead.")
    def create_watcher_with_kind_aqs_filter_and_additional_properties(cls, aqs_filter: str, additional_properties: _cabc.Iterable[str], kind: DeviceInformationKind, /) -> DeviceWatcher: ...
    ...
    def find_all_async(cls, aqs_filter: str, additional_properties: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[DeviceInformationCollection]: ...
    @typing.overload
    ...
    def find_all_async(cls, aqs_filter: str, additional_properties: _cabc.Iterable[str], kind: DeviceInformationKind, /) -> windows_foundation.IAsyncOperation[DeviceInformationCollection]: ...
    @typing.overload
    ...
    def find_all_async(cls, aqs_filter: str, additional_properties: _cabc.Iterable[str], kind: DeviceInformationKind, settings: IDeviceEnumerationSettings, /) -> windows_foundation.IAsyncOperation[DeviceInformationCollection]: ...
    # Deprecated alias of find_all_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.Enumeration.DeviceInformationCollection> Windows.Devices.Enumeration.DeviceInformation::FindAllAsync(System.String,Windows.Foundation.Collections.IIterable`1<System.String>)
    @deprecated("Use find_all_async() instead.")
    def find_all_async_aqs_filter_and_additional_properties(cls, aqs_filter: str, additional_properties: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[DeviceInformationCollection]: ...
    # Deprecated alias of find_all_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.Enumeration.DeviceInformationCollection> Windows.Devices.Enumeration.DeviceInformation::FindAllAsync(Windows.Devices.Enumeration.DeviceClass)
    @deprecated("Use find_all_async() instead.")
    ...
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.Enumeration.DeviceInformationCollection> Windows.Devices.Enumeration.DeviceInformation::FindAllAsync(System.String,Windows.Foundation.Collections.IIterable`1<System.String>,Windows.Devices.Enumeration.DeviceInformationKind,Windows.Devices.Enumeration.IDeviceEnumerationSettings)
    @deprecated("Use find_all_async() instead.")
    def find_all_async_with_aqs_filter_additional_properties_kind_and_settings(cls, aqs_filter: str, additional_properties: _cabc.Iterable[str], kind: DeviceInformationKind, settings: IDeviceEnumerationSettings, /) -> windows_foundation.IAsyncOperation[DeviceInformationCollection]: ...
    # Deprecated alias of find_all_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.Enumeration.DeviceInformationCollection> Windows.Devices.Enumeration.DeviceInformation::FindAllAsync(System.String,Windows.Foundation.Collections.IIterable`1<System.String>,Windows.Devices.Enumeration.DeviceInformationKind)
    @deprecated("Use find_all_async() instead.")
    def find_all_async_with_kind_aqs_filter_and_additional_properties(cls, aqs_filter: str, additional_properties: _cabc.Iterable[str], kind: DeviceInformationKind, /) -> windows_foundation.IAsyncOperation[DeviceInformationCollection]: ...
...
class DeviceInformationCollection(winrt.system.Object, winrt._winrt.Sequence[DeviceInformation]):
    ...
    def __iter__(self) -> _cabc.Iterator[DeviceInformation]: ...
    @typing.overload
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[DeviceInformation] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    ...
    def index_of(self, value: DeviceInformation, /) -> tuple[bool, winrt.system.UInt32]: ...
...
class DeviceInformationCustomPairing(winrt.system.Object):
    ...
    def pair_async(self, pairing_kinds_supported: DevicePairingKinds, min_protection_level: DevicePairingProtectionLevel, device_pairing_settings: IDevicePairingSettings, /) -> windows_foundation.IAsyncOperation[DevicePairingResult]: ...
    # Deprecated alias of pair_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.Enumeration.DevicePairingResult> Windows.Devices.Enumeration.DeviceInformationCustomPairing::PairAsync(Windows.Devices.Enumeration.DevicePairingKinds,Windows.Devices.Enumeration.DevicePairingProtectionLevel,Windows.Devices.Enumeration.IDevicePairingSettings)
    @deprecated("Use pair_async() instead.")
    ...
    def remove_pairing_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_pairing_set_members_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class DeviceInformationPairing(winrt.system.Object, metaclass=DeviceInformationPairing_Static):
    ...
    def pair_async(self, min_protection_level: DevicePairingProtectionLevel, device_pairing_settings: IDevicePairingSettings, /) -> windows_foundation.IAsyncOperation[DevicePairingResult]: ...
    # Deprecated alias of pair_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.Enumeration.DevicePairingResult> Windows.Devices.Enumeration.DeviceInformationPairing::PairAsync(Windows.Devices.Enumeration.DevicePairingProtectionLevel,Windows.Devices.Enumeration.IDevicePairingSettings)
    @deprecated("Use pair_async() instead.")
...
class DevicePairingRequestedEventArgs(winrt.system.Object):
    ...
    # Deprecated alias of accept() for pywinrt v3.x compatibility.
    # System.Void Windows.Devices.Enumeration.DevicePairingRequestedEventArgs::Accept(System.String)
...
class DevicePicker(winrt.system.Object):
    ...
    def pick_single_device_async(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> windows_foundation.IAsyncOperation[DeviceInformation]: ...
    @typing.overload
    ...
    def pick_single_device_async(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[DeviceInformation]: ...
    # Deprecated alias of pick_single_device_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.Enumeration.DeviceInformation> Windows.Devices.Enumeration.DevicePicker::PickSingleDeviceAsync(Windows.Foundation.Rect,Windows.UI.Popups.Placement)
    @deprecated("Use pick_single_device_async() instead.")
    def pick_single_device_async_with_placement(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], placement: windows_ui_popups.Placement, /) -> windows_foundation.IAsyncOperation[DeviceInformation]: ...
    ...
    def show(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], placement: windows_ui_popups.Placement, /) -> None: ...
    # Deprecated alias of show() for pywinrt v3.x compatibility.
    # System.Void Windows.Devices.Enumeration.DevicePicker::Show(Windows.Foundation.Rect,Windows.UI.Popups.Placement)
    @deprecated("Use show() instead.")
    def show_with_placement(self, selection: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], placement: windows_ui_popups.Placement, /) -> None: ...
    ...
    def remove_device_picker_dismissed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_device_selected(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def requested_properties(self) -> _cabc.MutableSequence[str]: ...
...
class DevicePickerAppearance(winrt.system.Object):
    ...
    def selected_foreground_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
    ...
    def selected_background_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
    ...
    def selected_accent_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
...
class DevicePickerFilter(winrt.system.Object):
    ...
    @_property
    def supported_device_selectors(self) -> _cabc.MutableSequence[str]: ...
