...
class ESim(winrt.system.Object):
    ...
    def get_profiles(self) -> _cabc.Sequence[ESimProfile]: ...
    ...
    def remove_profile_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    # Windows.Foundation.IReference`1<System.Int32> Windows.Networking.NetworkOperators.ESim::get_AvailableMemoryInBytes()
    @_property
    def available_memory_in_bytes(self) -> winrt.system.Int32 | None: ...
    ...
    @_property
    def slot_index(self) -> winrt.system.Int32 | None: ...
...
class ESimManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_service_info_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class KnownCSimFilePaths_Static(winrt._winrt.IInspectable_Static):
    ...
    @_property
    def gid1(cls) -> _cabc.Sequence[winrt.system.UInt32]: ...
    ...
    @_property
    def gid2(cls) -> _cabc.Sequence[winrt.system.UInt32]: ...
...
class KnownUSimFilePaths_Static(winrt._winrt.IInspectable_Static):
    ...
    @_property
    def e_f_pnn(cls) -> _cabc.Sequence[winrt.system.UInt32]: ...
...
class MobileBroadbandAccount_Static(winrt._winrt.IInspectable_Static):
    ...
    @_property
    def available_network_account_ids(cls) -> _cabc.Sequence[str]: ...
...
class MobileBroadbandAccountWatcher(winrt.system.Object):
    ...
    def remove_account_added(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_account_removed(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_account_updated(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_enumeration_completed(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_stopped(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MobileBroadbandCellCdma(winrt.system.Object):
    ...
    @_property
    def base_station_last_broadcast_gps_time(self) -> datetime.timedelta | None: ...
    ...
    @_property
    def base_station_latitude(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def base_station_longitude(self) -> winrt.system.Double | None: ...
...
class MobileBroadbandCellGsm(winrt.system.Object):
    ...
    @_property
    def channel_number(self) -> winrt.system.Int32 | None: ...
    ...
    @_property
    def location_area_code(self) -> winrt.system.Int32 | None: ...
    ...
    @_property
    def received_signal_strength_in_dbm(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def timing_advance_in_bit_periods(self) -> winrt.system.Int32 | None: ...
...
class MobileBroadbandCellLte(winrt.system.Object):
    ...
    @_property
    def physical_cell_id(self) -> winrt.system.Int32 | None: ...
    ...
    @_property
    def reference_signal_received_power_in_dbm(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def reference_signal_received_quality_in_dbm(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def tracking_area_code(self) -> winrt.system.Int32 | None: ...
...
class MobileBroadbandCellNR(winrt.system.Object):
    ...
    @_property
    def signal_to_noise_ratio_in_db(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def timing_advance_in_nanoseconds(self) -> winrt.system.Int32 | None: ...
...
class MobileBroadbandCellTdscdma(winrt.system.Object):
    ...
    @_property
    def cell_parameter_id(self) -> winrt.system.Int32 | None: ...
    ...
    @_property
    def path_loss_in_db(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def received_signal_code_power_in_dbm(self) -> winrt.system.Double | None: ...
...
class MobileBroadbandCellUmts(winrt.system.Object):
    ...
    @_property
    def primary_scrambling_code(self) -> winrt.system.Int32 | None: ...
...
class MobileBroadbandCellsInfo(winrt.system.Object):
    ...
    @_property
    def neighboring_cells_gsm(self) -> _cabc.Sequence[MobileBroadbandCellGsm]: ...
    ...
    @_property
    def neighboring_cells_lte(self) -> _cabc.Sequence[MobileBroadbandCellLte]: ...
    ...
    @_property
    def neighboring_cells_tdscdma(self) -> _cabc.Sequence[MobileBroadbandCellTdscdma]: ...
    ...
    @_property
    def neighboring_cells_umts(self) -> _cabc.Sequence[MobileBroadbandCellUmts]: ...
    ...
    @_property
    def serving_cells_cdma(self) -> _cabc.Sequence[MobileBroadbandCellCdma]: ...
    ...
    @_property
    def serving_cells_gsm(self) -> _cabc.Sequence[MobileBroadbandCellGsm]: ...
    ...
    @_property
    def serving_cells_lte(self) -> _cabc.Sequence[MobileBroadbandCellLte]: ...
    ...
    @_property
    def serving_cells_tdscdma(self) -> _cabc.Sequence[MobileBroadbandCellTdscdma]: ...
    ...
    @_property
    def serving_cells_umts(self) -> _cabc.Sequence[MobileBroadbandCellUmts]: ...
    ...
    @_property
    def neighboring_cells_n_r(self) -> _cabc.Sequence[MobileBroadbandCellNR]: ...
    ...
    @_property
    def serving_cells_n_r(self) -> _cabc.Sequence[MobileBroadbandCellNR]: ...
...
class MobileBroadbandDeviceInformation(winrt.system.Object):
    ...
    @_property
    def telephone_numbers(self) -> _cabc.Sequence[str]: ...
...
class MobileBroadbandDeviceService(winrt.system.Object):
    ...
    @_property
    def supported_commands(self) -> _cabc.Sequence[winrt.system.UInt32]: ...
...
class MobileBroadbandDeviceServiceDataSession(winrt.system.Object):
    ...
    def remove_data_received(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MobileBroadbandModem(winrt.system.Object, metaclass=MobileBroadbandModem_Static):
    ...
    def try_get_pco_async(self) -> windows_foundation.IAsyncOperation[MobileBroadbandPco | None]: ...
    ...
    def remove_is_in_emergency_call_mode_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def device_services(self) -> _cabc.Sequence[MobileBroadbandDeviceServiceInformation]: ...
...
class MobileBroadbandNetwork(winrt.system.Object):
    ...
    @_property
    def registration_uicc_apps(self) -> _cabc.Sequence[MobileBroadbandUiccApp]: ...
...
class MobileBroadbandPinManager(winrt.system.Object):
    ...
    @_property
    def supported_pins(self) -> _cabc.Sequence[MobileBroadbandPinType]: ...
...
class MobileBroadbandSarManager(winrt.system.Object):
    ...
    def set_configuration_async(self, antennas: _cabc.Iterable[MobileBroadbandAntennaSar], /) -> windows_foundation.IAsyncAction: ...
    ...
    def remove_transmission_state_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def antennas(self) -> _cabc.Sequence[MobileBroadbandAntennaSar]: ...
...
class MobileBroadbandSlotManager(winrt.system.Object):
    ...
    def remove_current_slot_index_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_slot_info_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def slot_infos(self) -> _cabc.Sequence[MobileBroadbandSlotInfo]: ...
...
class MobileBroadbandUiccApp(winrt.system.Object):
    ...
    def read_record_async(self, uicc_file_path: _cabc.Iterable[winrt.system.UInt32], record_index: winrt.system.Int32, /) -> windows_foundation.IAsyncOperation[MobileBroadbandUiccAppReadRecordResult]: ...
...
class MobileBroadbandUiccAppsResult(winrt.system.Object):
    ...
    @_property
    def uicc_apps(self) -> _cabc.Sequence[MobileBroadbandUiccApp]: ...
...
class NetworkOperatorTetheringManager(winrt.system.Object, metaclass=NetworkOperatorTetheringManager_Static):
    ...
    def get_tethering_clients(self) -> _cabc.Sequence[NetworkOperatorTetheringClient]: ...
    @typing.overload
...
class UssdMessage(winrt.system.Object):
    ...
    def set_payload(self, value: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> None: ...
