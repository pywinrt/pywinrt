...
namespace py::cpp::Windows::System::Diagnostics::DevicePortal
{
    ...
    static PyObject* DevicePortalConnection_GetForAppServiceConnection(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.System.Diagnostics.DevicePortal.DevicePortalConnection", "GetForAppServiceConnection", nullptr, py::site_is_static};
