...
namespace py::cpp::Windows::Devices::Custom
{
    ...
    static PyObject* CustomDevice_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 3)
        {
            static constexpr py::member_site site{py::member_kind::method, 3, "Windows.Devices.Custom.CustomDevice", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* CustomDevice_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.Custom.CustomDevice", "GetDeviceSelector", nullptr, py::site_is_static};
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.Devices.Custom.KnownDeviceTypes", "Unknown", nullptr, py::site_is_static};
