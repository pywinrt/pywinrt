...
namespace py::cpp::Windows::UI::Text::Core
{
    ...
    static PyObject* CoreTextEditContext_add_NotifyFocusLeaveCompleted(py::wrapper::Windows::UI::Text::Core::CoreTextEditContext* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::UI::Text::Core::ICoreTextEditContext2>(self->obj, py::member_kind::event, "Windows.UI.Text.Core.CoreTextEditContext", "NotifyFocusLeaveCompleted", "Windows.UI.Text.Core.ICoreTextEditContext2").NotifyFocusLeaveCompleted(param0);
            }());
        }
        catch (...)
        {
    ...
    static PyObject* CoreTextEditContext_remove_NotifyFocusLeaveCompleted(py::wrapper::Windows::UI::Text::Core::CoreTextEditContext* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                py::require<winrt::Windows::UI::Text::Core::ICoreTextEditContext2>(self->obj, py::member_kind::event, "Windows.UI.Text.Core.CoreTextEditContext", "NotifyFocusLeaveCompleted", "Windows.UI.Text.Core.ICoreTextEditContext2").NotifyFocusLeaveCompleted(param0);
            }
    ...
    static PyObject* CoreTextLayoutRequest_get_LayoutBoundsVisualPixels(py::wrapper::Windows::UI::Text::Core::CoreTextLayoutRequest* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::UI::Text::Core::ICoreTextLayoutRequest2>(self->obj, py::member_kind::property, "Windows.UI.Text.Core.CoreTextLayoutRequest", "LayoutBoundsVisualPixels", "Windows.UI.Text.Core.ICoreTextLayoutRequest2").LayoutBoundsVisualPixels();
            }());
        }
        catch (...)
        {
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.UI.Text.Core.CoreTextServicesConstants", "HiddenCharacter", nullptr, py::site_is_static};
    ...
    static PyObject* CoreTextServicesManager_GetForCurrentView(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.UI.Text.Core.CoreTextServicesManager", "GetForCurrentView", nullptr, py::site_is_static};
