...
class LoggingActivity(winrt.system.Object, ILoggingTarget, windows_foundation.IClosable):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    @typing.overload
    def __new__(cls, activity_name: str, logging_channel: ILoggingChannel) -> typing.Self: ...
    @typing.overload
    def __new__(cls, activity_name: str, logging_channel: ILoggingChannel, level: LoggingLevel) -> typing.Self: ...
...
class LoggingChannel(winrt.system.Object, ILoggingTarget, ILoggingChannel, windows_foundation.IClosable):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    @typing.overload
    def __new__(cls, name: str, options: LoggingChannelOptions) -> typing.Self: ...
    @typing.overload
    def __new__(cls, name: str, options: LoggingChannelOptions, id: _uuid.UUID) -> typing.Self: ...
    @typing.overload
    def __new__(cls, name: str) -> typing.Self: ...
...
class LoggingChannelOptions(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls, group: _uuid.UUID) -> typing.Self: ...
...
class LoggingOptions(winrt.system.Object):
    ...
    def __new__(cls) -> typing.Self: ...
    @typing.overload
    def __new__(cls, keywords: winrt.system.Int64) -> typing.Self: ...
