...
class SpatialBoundingBox:
    ...
    def __new__(cls, center: windows_foundation_numerics.Vector3 = ..., extents: windows_foundation_numerics.Vector3 = ...) -> SpatialBoundingBox: ...
...
class SpatialBoundingFrustum:
    ...
    def __new__(cls, near: windows_foundation_numerics.Plane = ..., far: windows_foundation_numerics.Plane = ..., right: windows_foundation_numerics.Plane = ..., left: windows_foundation_numerics.Plane = ..., top: windows_foundation_numerics.Plane = ..., bottom: windows_foundation_numerics.Plane = ...) -> SpatialBoundingFrustum: ...
...
class SpatialBoundingOrientedBox:
    ...
    def __new__(cls, center: windows_foundation_numerics.Vector3 = ..., extents: windows_foundation_numerics.Vector3 = ..., orientation: windows_foundation_numerics.Quaternion = ...) -> SpatialBoundingOrientedBox: ...
...
class SpatialBoundingSphere:
    ...
    def __new__(cls, center: windows_foundation_numerics.Vector3 = ..., radius: winrt.system.Single = 0) -> SpatialBoundingSphere: ...
...
class SpatialRay:
    ...
    def __new__(cls, origin: windows_foundation_numerics.Vector3 = ..., direction: windows_foundation_numerics.Vector3 = ...) -> SpatialRay: ...
...
class SpatialEntity(winrt.system.Object):
    @typing.overload
    def __new__(cls, spatial_anchor: SpatialAnchor) -> typing.Self: ...
    @typing.overload
    def __new__(cls, spatial_anchor: SpatialAnchor, property_set: windows_foundation_collections.ValueSet) -> typing.Self: ...
