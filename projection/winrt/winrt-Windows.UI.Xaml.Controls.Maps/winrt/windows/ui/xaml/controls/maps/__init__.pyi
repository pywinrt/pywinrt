...
class HttpMapTileDataSource(MapTileDataSource, metaclass=HttpMapTileDataSource_Static):
    ...
    def __new__(cls) -> typing.Self: ...
    @typing.overload
    def __new__(cls, uri_format_string: str) -> typing.Self: ...
    @typing.final
...
class MapBillboard(MapElement, metaclass=MapBillboard_Static):
    def __new__(cls, camera: MapCamera) -> typing.Self: ...
...
class MapCamera(windows_ui_xaml.DependencyObject):
    @typing.overload
    def __new__(cls, location: windows_devices_geolocation.Geopoint) -> typing.Self: ...
    @typing.overload
    def __new__(cls, location: windows_devices_geolocation.Geopoint, heading_in_degrees: winrt.system.Double) -> typing.Self: ...
    @typing.overload
    def __new__(cls, location: windows_devices_geolocation.Geopoint, heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double) -> typing.Self: ...
    @typing.overload
    def __new__(cls, location: windows_devices_geolocation.Geopoint, heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double, roll_in_degrees: winrt.system.Double, field_of_view_in_degrees: winrt.system.Double) -> typing.Self: ...
...
class MapControlDataHelper(windows_ui_xaml.DependencyObject, metaclass=MapControlDataHelper_Static):
    def __new__(cls, map: MapControl) -> typing.Self: ...
...
class MapRouteView(windows_ui_xaml.DependencyObject, metaclass=MapRouteView_Static):
    def __new__(cls, route: windows_services_maps.MapRoute) -> typing.Self: ...
...
class MapTileSource(windows_ui_xaml.DependencyObject, metaclass=MapTileSource_Static):
    ...
    def __new__(cls) -> typing.Self: ...
    @typing.overload
    def __new__(cls, data_source: MapTileDataSource) -> typing.Self: ...
    @typing.overload
    def __new__(cls, data_source: MapTileDataSource, zoom_level_range: MapZoomLevelRange | tuple[winrt.system.Double, winrt.system.Double]) -> typing.Self: ...
    @typing.overload
    def __new__(cls, data_source: MapTileDataSource, zoom_level_range: MapZoomLevelRange | tuple[winrt.system.Double, winrt.system.Double], bounds: windows_devices_geolocation.GeoboundingBox) -> typing.Self: ...
    @typing.overload
    def __new__(cls, data_source: MapTileDataSource, zoom_level_range: MapZoomLevelRange | tuple[winrt.system.Double, winrt.system.Double], bounds: windows_devices_geolocation.GeoboundingBox, tile_size_in_pixels: winrt.system.Int32) -> typing.Self: ...
    @typing.final
...
class StreetsideExperience(MapCustomExperience):
    @typing.overload
    def __new__(cls, panorama: StreetsidePanorama) -> typing.Self: ...
    @typing.overload
    def __new__(cls, panorama: StreetsidePanorama, heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double, field_of_view_in_degrees: winrt.system.Double) -> typing.Self: ...
