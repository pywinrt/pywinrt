...
class CustomMapTileDataSource(MapTileDataSource, metaclass=CustomMapTileDataSource_Static):
    ...
    def remove_bitmap_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class HttpMapTileDataSource(MapTileDataSource, metaclass=HttpMapTileDataSource_Static):
    ...
    def __new__(cls: type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], uri_format_string: str) -> Self: ...
    @typing.final
    ...
    def remove_uri_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    @typing.final
    def additional_request_headers(self) -> _cabc.MutableMapping[str, str]: ...
...
class MapBillboard(MapElement, metaclass=MapBillboard_Static):
    def __new__(cls: type[Self], camera: MapCamera) -> Self: ...
    ...
    def normalized_anchor_point(self, value: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
...
class MapCamera(windows_ui_xaml.DependencyObject):
    @typing.overload
    def __new__(cls: type[Self], location: windows_devices_geolocation.Geopoint) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], location: windows_devices_geolocation.Geopoint, heading_in_degrees: winrt.system.Double) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], location: windows_devices_geolocation.Geopoint, heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], location: windows_devices_geolocation.Geopoint, heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double, roll_in_degrees: winrt.system.Double, field_of_view_in_degrees: winrt.system.Double) -> Self: ...
...
class MapContextRequestedEventArgs(winrt.system.Object):
    ...
    @_property
    def map_elements(self) -> _cabc.Sequence[MapElement]: ...
...
class MapControl_Static(windows_ui_xaml_controls.Control_Static):
    ...
    def set_normalized_anchor_point(cls, element: windows_ui_xaml.DependencyObject, value: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> None: ...
...
class MapControl(windows_ui_xaml_controls.Control, metaclass=MapControl_Static):
    ...
    def find_map_elements_at_offset(self, offset: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> _cabc.Sequence[MapElement]: ...
    @typing.overload
    ...
    def find_map_elements_at_offset(self, offset: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], radius: winrt.system.Double, /) -> _cabc.Sequence[MapElement]: ...
    ...
    def find_map_elements_at_offset_with_radius(self, offset: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], radius: winrt.system.Double, /) -> _cabc.Sequence[MapElement]: ...
    @typing.overload
    ...
    def get_location_from_offset(self, offset: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_devices_geolocation.Geopoint: ...
    @typing.overload
    ...
    def get_location_from_offset(self, offset: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], desired_reference_system: windows_devices_geolocation.AltitudeReferenceSystem, /) -> windows_devices_geolocation.Geopoint: ...
    ...
    def get_location_from_offset_with_reference_system(self, offset: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], desired_reference_system: windows_devices_geolocation.AltitudeReferenceSystem, /) -> windows_devices_geolocation.Geopoint: ...
    ...
    def try_get_location_from_offset(self, offset: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> tuple[bool, windows_devices_geolocation.Geopoint]: ...
    @typing.overload
    ...
    def try_get_location_from_offset(self, offset: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], desired_reference_system: windows_devices_geolocation.AltitudeReferenceSystem, /) -> tuple[bool, windows_devices_geolocation.Geopoint]: ...
    ...
    def try_get_location_from_offset_with_reference_system(self, offset: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], desired_reference_system: windows_devices_geolocation.AltitudeReferenceSystem, /) -> tuple[bool, windows_devices_geolocation.Geopoint]: ...
    ...
    def try_set_view_async(self, center: windows_devices_geolocation.Geopoint, zoom_level: winrt.system.Double | None, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def try_set_view_async(self, center: windows_devices_geolocation.Geopoint, zoom_level: winrt.system.Double | None, heading: winrt.system.Double | None, desired_pitch: winrt.system.Double | None, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.UI.Xaml.Controls.Maps.MapControl::TrySetViewAsync(Windows.Devices.Geolocation.Geopoint,Windows.Foundation.IReference`1<System.Double>,Windows.Foundation.IReference`1<System.Double>,Windows.Foundation.IReference`1<System.Double>,Windows.UI.Xaml.Controls.Maps.MapAnimationKind)
    def try_set_view_async(self, center: windows_devices_geolocation.Geopoint, zoom_level: winrt.system.Double | None, heading: winrt.system.Double | None, desired_pitch: winrt.system.Double | None, animation: MapAnimationKind, /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of try_set_view_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.UI.Xaml.Controls.Maps.MapControl::TrySetViewAsync(Windows.Devices.Geolocation.Geopoint,Windows.Foundation.IReference`1<System.Double>)
    @deprecated("Use try_set_view_async() instead.")
    def try_set_view_with_center_and_zoom_async(self, center: windows_devices_geolocation.Geopoint, zoom_level: winrt.system.Double | None, /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of try_set_view_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.UI.Xaml.Controls.Maps.MapControl::TrySetViewAsync(Windows.Devices.Geolocation.Geopoint)
    @deprecated("Use try_set_view_async() instead.")
    ...
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.UI.Xaml.Controls.Maps.MapControl::TrySetViewAsync(Windows.Devices.Geolocation.Geopoint,Windows.Foundation.IReference`1<System.Double>,Windows.Foundation.IReference`1<System.Double>,Windows.Foundation.IReference`1<System.Double>)
    @deprecated("Use try_set_view_async() instead.")
    def try_set_view_with_center_zoom_heading_and_pitch_async(self, center: windows_devices_geolocation.Geopoint, zoom_level: winrt.system.Double | None, heading: winrt.system.Double | None, desired_pitch: winrt.system.Double | None, /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of try_set_view_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.UI.Xaml.Controls.Maps.MapControl::TrySetViewAsync(Windows.Devices.Geolocation.Geopoint,Windows.Foundation.IReference`1<System.Double>,Windows.Foundation.IReference`1<System.Double>,Windows.Foundation.IReference`1<System.Double>,Windows.UI.Xaml.Controls.Maps.MapAnimationKind)
    @deprecated("Use try_set_view_async() instead.")
    def try_set_view_with_center_zoom_heading_pitch_and_animation_async(self, center: windows_devices_geolocation.Geopoint, zoom_level: winrt.system.Double | None, heading: winrt.system.Double | None, desired_pitch: winrt.system.Double | None, animation: MapAnimationKind, /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def try_set_view_bounds_async(self, bounds: windows_devices_geolocation.GeoboundingBox, margin: windows_ui_xaml.Thickness | None, animation: MapAnimationKind, /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def remove_center_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_heading_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_loading_status_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_map_double_tapped(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_map_holding(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_map_tapped(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_pitch_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_transform_origin_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_zoom_level_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_actual_camera_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_actual_camera_changing(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_custom_experience_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_map_element_click(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_map_element_pointer_entered(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_map_element_pointer_exited(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_target_camera_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_map_right_tapped(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_map_context_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def transform_origin(self, value: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
    ...
    @_property
    def children(self) -> _cabc.MutableSequence[windows_ui_xaml.DependencyObject]: ...
    ...
    @_property
    def map_elements(self) -> _cabc.MutableSequence[MapElement]: ...
    ...
    @_property
    def routes(self) -> _cabc.MutableSequence[MapRouteView]: ...
    ...
    @_property
    def tile_sources(self) -> _cabc.MutableSequence[MapTileSource]: ...
    ...
    @view_padding.setter
    def view_padding(self, value: windows_ui_xaml.Thickness | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> None: ...
    ...
    @_property
    def layers(self) -> _cabc.MutableSequence[MapLayer]: ...
    ...
    @layers.setter
    def layers(self, value: _cabc.MutableSequence[MapLayer]) -> None: ...
...
class MapControlBusinessLandmarkClickEventArgs(winrt.system.Object):
    ...
    @_property
    def local_locations(self) -> _cabc.Sequence[windows_services_maps_localsearch.LocalLocation]: ...
...
class MapControlDataHelper(windows_ui_xaml.DependencyObject, metaclass=MapControlDataHelper_Static):
    def __new__(cls: type[Self], map: MapControl) -> Self: ...
    ...
    def remove_business_landmark_click(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_business_landmark_right_tapped(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_transit_feature_click(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_transit_feature_right_tapped(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_business_landmark_pointer_entered(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_business_landmark_pointer_exited(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_transit_feature_pointer_entered(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_transit_feature_pointer_exited(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MapControlTransitFeatureClickEventArgs(winrt.system.Object):
    ...
    @_property
    def transit_properties(self) -> _cabc.Mapping[str, winrt.system.Object]: ...
...
class MapElementsLayer(MapLayer, metaclass=MapElementsLayer_Static):
    ...
    @map_elements.setter
    def map_elements(self, value: _cabc.MutableSequence[MapElement]) -> None: ...
...
class MapItemsControl(windows_ui_xaml.DependencyObject, metaclass=MapItemsControl_Static):
    ...
    @_property
    def items(self) -> _cabc.MutableSequence[windows_ui_xaml.DependencyObject]: ...
...
class MapPolygon(MapElement, metaclass=MapPolygon_Static):
    ...
    @stroke_color.setter
    def stroke_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
    ...
    @fill_color.setter
    def fill_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
    ...
    @_property
    def paths(self) -> _cabc.MutableSequence[windows_devices_geolocation.Geopath]: ...
...
class MapRouteView(windows_ui_xaml.DependencyObject, metaclass=MapRouteView_Static):
    def __new__(cls: type[Self], route: windows_services_maps.MapRoute) -> Self: ...
    ...
    @route_color.setter
    @typing.final
    def route_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
    ...
    @typing.final
    def outline_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
...
class MapScene_Static(windows_ui_xaml.DependencyObject_Static):
    ...
    def create_from_locations(cls, locations: _cabc.Iterable[windows_devices_geolocation.Geopoint], /) -> MapScene: ...
    @typing.overload
    ...
    def create_from_locations(cls, locations: _cabc.Iterable[windows_devices_geolocation.Geopoint], heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double, /) -> MapScene: ...
    # Deprecated alias of create_from_locations() for pywinrt v3.x compatibility.
    # Windows.UI.Xaml.Controls.Maps.MapScene Windows.UI.Xaml.Controls.Maps.MapScene::CreateFromLocations(Windows.Foundation.Collections.IIterable`1<Windows.Devices.Geolocation.Geopoint>,System.Double,System.Double)
    @deprecated("Use create_from_locations() instead.")
    def create_from_locations_with_heading_and_pitch(cls, locations: _cabc.Iterable[windows_devices_geolocation.Geopoint], heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double, /) -> MapScene: ...
...
class MapStyleSheet_Static(windows_ui_xaml.DependencyObject_Static):
    ...
    def combine(cls, style_sheets: _cabc.Iterable[MapStyleSheet], /) -> MapStyleSheet: ...
    ...
    def try_parse_from_json(cls, style_as_json: str, /) -> tuple[bool, MapStyleSheet]: ...
...
class MapTileSource(windows_ui_xaml.DependencyObject, metaclass=MapTileSource_Static):
    ...
    def __new__(cls: type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], data_source: MapTileDataSource) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], data_source: MapTileDataSource, zoom_level_range: MapZoomLevelRange | tuple[winrt.system.Double, winrt.system.Double]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], data_source: MapTileDataSource, zoom_level_range: MapZoomLevelRange | tuple[winrt.system.Double, winrt.system.Double], bounds: windows_devices_geolocation.GeoboundingBox) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], data_source: MapTileDataSource, zoom_level_range: MapZoomLevelRange | tuple[winrt.system.Double, winrt.system.Double], bounds: windows_devices_geolocation.GeoboundingBox, tile_size_in_pixels: winrt.system.Int32) -> Self: ...
    @typing.final
    ...
    @typing.final
    def zoom_level_range(self, value: MapZoomLevelRange | tuple[winrt.system.Double, winrt.system.Double]) -> None: ...
...
class StreetsideExperience(MapCustomExperience):
    @typing.overload
    def __new__(cls: type[Self], panorama: StreetsidePanorama) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], panorama: StreetsidePanorama, heading_in_degrees: winrt.system.Double, pitch_in_degrees: winrt.system.Double, field_of_view_in_degrees: winrt.system.Double) -> Self: ...
