...
class FileExtensionVector(winrt.system.Object, winrt._winrt.MutableSequence[str]):
    ...
    @typing.overload
    def __setitem__(self, index: slice, value: _cabc.Iterable[str]) -> None: ...
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[str] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    # Windows.Foundation.Collections.IVectorView`1<System.String> Windows.Storage.Pickers.FileExtensionVector::GetView()
    def get_view(self) -> _cabc.Sequence[str]: ...
    # System.Boolean Windows.Storage.Pickers.FileExtensionVector::IndexOf(System.String,System.UInt32&)
    def index_of(self, value: str, /) -> tuple[bool, winrt.system.UInt32]: ...
    ...
    def replace_all(self, items: winrt.system.Array[str] | winrt.system.ReadableBuffer, /) -> None: ...
...
@typing.final
class FilePickerFileTypesOrderedMap(winrt.system.Object, winrt._winrt.MutableMapping[str, _cabc.MutableSequence[str]]):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[str]: ...
    def __contains__(self, key: object) -> bool: ...
    def __getitem__(self, key: str) -> _cabc.MutableSequence[str]: ...
    def __setitem__(self, key: str, value: _cabc.MutableSequence[str]) -> None: ...
    ...
    def first(self) -> windows_foundation_collections.IIterator[windows_foundation_collections.IKeyValuePair[str, _cabc.MutableSequence[str]]]: ...
    ...
    def get_view(self) -> _cabc.Mapping[str, _cabc.MutableSequence[str]]: ...
    ...
    def insert(self, key: str, value: _cabc.MutableSequence[str], /) -> bool: ...
    ...
    def lookup(self, key: str, /) -> _cabc.MutableSequence[str]: ...
...
class FilePickerSelectedFilesArray(winrt.system.Object, winrt._winrt.Sequence[windows_storage.StorageFile]):
    def __len__(self) -> int: ...
    def __iter__(self) -> _cabc.Iterator[windows_storage.StorageFile]: ...
    @typing.overload
    ...
    def get_many(self, start_index: winrt.system.UInt32, items: winrt.system.Array[windows_storage.StorageFile] | winrt.system.WriteableBuffer, /) -> winrt.system.UInt32: ...
    # System.Boolean Windows.Storage.Pickers.FilePickerSelectedFilesArray::IndexOf(Windows.Storage.StorageFile,System.UInt32&)
    def index_of(self, value: windows_storage.StorageFile, /) -> tuple[bool, winrt.system.UInt32]: ...
