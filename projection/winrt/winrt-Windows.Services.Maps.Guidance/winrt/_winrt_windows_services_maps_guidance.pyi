...
class GuidanceNavigator(winrt.system.Object, metaclass=GuidanceNavigator_Static):
    ...
    def update_user_location(self, user_location: windows_devices_geolocation.Geocoordinate, position_override: windows_devices_geolocation.BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double], /) -> None: ...
    # Deprecated alias of update_user_location() for pywinrt v3.x compatibility.
    # System.Void Windows.Services.Maps.Guidance.GuidanceNavigator::UpdateUserLocation(Windows.Devices.Geolocation.Geocoordinate,Windows.Devices.Geolocation.BasicGeoposition)
    @deprecated("Use update_user_location() instead.")
    def update_user_location_with_position_override(self, user_location: windows_devices_geolocation.Geocoordinate, position_override: windows_devices_geolocation.BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double], /) -> None: ...
    ...
    def remove_destination_reached(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_guidance_updated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_reroute_failed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_rerouted(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_rerouting(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_user_location_lost(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_user_location_restored(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_audio_notification_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class GuidanceRoadSignpost(winrt.system.Object):
    ...
    @_property
    def exit_directions(self) -> _cabc.Sequence[str]: ...
...
class GuidanceRoute_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_create_from_map_route(cls, map_route: windows_services_maps.MapRoute, /) -> GuidanceRoute | None: ...
...
class GuidanceRoute(winrt.system.Object, metaclass=GuidanceRoute_Static):
    ...
    @_property
    def maneuvers(self) -> _cabc.Sequence[GuidanceManeuver]: ...
...
class GuidanceUpdatedEventArgs(winrt.system.Object):
    ...
    @_property
    def lane_info(self) -> _cabc.Sequence[GuidanceLaneInfo]: ...
