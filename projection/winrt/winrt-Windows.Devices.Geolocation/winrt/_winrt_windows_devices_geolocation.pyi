...
class GeoboundingBox_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_compute(cls, positions: _cabc.Iterable[BasicGeoposition], altitude_ref_system: AltitudeReferenceSystem, /) -> GeoboundingBox: ...
    @typing.overload
    ...
    def try_compute(cls, positions: _cabc.Iterable[BasicGeoposition], altitude_ref_system: AltitudeReferenceSystem, spatial_reference_id: winrt.system.UInt32, /) -> GeoboundingBox: ...
    # Deprecated alias of try_compute() for pywinrt v3.x compatibility.
    # Windows.Devices.Geolocation.GeoboundingBox Windows.Devices.Geolocation.GeoboundingBox::TryCompute(Windows.Foundation.Collections.IIterable`1<Windows.Devices.Geolocation.BasicGeoposition>,Windows.Devices.Geolocation.AltitudeReferenceSystem)
    @deprecated("Use try_compute() instead.")
    def try_compute_with_altitude_reference(cls, positions: _cabc.Iterable[BasicGeoposition], altitude_ref_system: AltitudeReferenceSystem, /) -> GeoboundingBox: ...
    # Deprecated alias of try_compute() for pywinrt v3.x compatibility.
    # Windows.Devices.Geolocation.GeoboundingBox Windows.Devices.Geolocation.GeoboundingBox::TryCompute(Windows.Foundation.Collections.IIterable`1<Windows.Devices.Geolocation.BasicGeoposition>,Windows.Devices.Geolocation.AltitudeReferenceSystem,System.UInt32)
    @deprecated("Use try_compute() instead.")
...
class GeoboundingBox(winrt.system.Object, IGeoshape, metaclass=GeoboundingBox_Static):
    @typing.overload
    def __new__(cls: type[Self], northwest_corner: BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double], southeast_corner: BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], northwest_corner: BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double], southeast_corner: BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double], altitude_reference_system: AltitudeReferenceSystem) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], northwest_corner: BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double], southeast_corner: BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double], altitude_reference_system: AltitudeReferenceSystem, spatial_reference_id: winrt.system.UInt32) -> Self: ...
...
class Geocircle(winrt.system.Object, IGeoshape):
    @typing.overload
    def __new__(cls: type[Self], position: BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double], radius: winrt.system.Double) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], position: BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double], radius: winrt.system.Double, altitude_reference_system: AltitudeReferenceSystem) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], position: BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double], radius: winrt.system.Double, altitude_reference_system: AltitudeReferenceSystem, spatial_reference_id: winrt.system.UInt32) -> Self: ...
...
class Geocoordinate(winrt.system.Object):
    ...
    @_property
    def altitude_accuracy(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def speed(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def position_source_timestamp(self) -> datetime.datetime | None: ...
...
class GeocoordinateSatelliteData(winrt.system.Object):
    ...
    @_property
    def position_dilution_of_precision(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def vertical_dilution_of_precision(self) -> winrt.system.Double | None: ...
    ...
    @_property
    def geometric_dilution_of_precision(self) -> winrt.system.Double | None: ...
...
class Geolocator_Static(winrt._winrt.IInspectable_Static):
    ...
    @_property
    def default_geoposition(cls) -> BasicGeoposition | None: ...
    ...
    def default_geoposition(cls, value: BasicGeoposition | None) -> None: ...
...
class Geolocator(winrt.system.Object, metaclass=Geolocator_Static):
    ...
    @_property
    def desired_accuracy_in_meters(self) -> winrt.system.UInt32 | None: ...
...
class Geopath(winrt.system.Object, IGeoshape):
    @typing.overload
    def __new__(cls: type[Self], positions: _cabc.Iterable[BasicGeoposition]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], positions: _cabc.Iterable[BasicGeoposition], altitude_reference_system: AltitudeReferenceSystem) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], positions: _cabc.Iterable[BasicGeoposition], altitude_reference_system: AltitudeReferenceSystem, spatial_reference_id: winrt.system.UInt32) -> Self: ...
    ...
    @_property
    def positions(self) -> _cabc.Sequence[BasicGeoposition]: ...
...
class Geopoint(winrt.system.Object, IGeoshape):
    @typing.overload
    def __new__(cls: type[Self], position: BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], position: BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double], altitude_reference_system: AltitudeReferenceSystem) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], position: BasicGeoposition | tuple[winrt.system.Double, winrt.system.Double, winrt.system.Double], altitude_reference_system: AltitudeReferenceSystem, spatial_reference_id: winrt.system.UInt32) -> Self: ...
...
class GeovisitMonitor(winrt.system.Object, metaclass=GeovisitMonitor_Static):
    ...
    def remove_visit_state_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
