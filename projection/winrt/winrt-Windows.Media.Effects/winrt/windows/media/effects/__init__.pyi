...
class AudioCaptureEffectsManager(winrt.system.Object):
    ...
    def remove_audio_capture_effects_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class AudioEffectDefinition(winrt.system.Object, IAudioEffectDefinition):
    @typing.overload
    def __new__(cls: type[Self], activatable_class_id: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], activatable_class_id: str, props: windows_foundation_collections.IPropertySet) -> Self: ...
...
class CompositeVideoFrameContext(winrt.system.Object):
    ...
    @_property
    def surfaces_to_overlay(self) -> _cabc.Sequence[windows_graphics_directx_direct3d11.IDirect3DSurface]: ...
...
class VideoTransformEffectDefinition(winrt.system.Object, IVideoEffectDefinition):
    ...
    def padding_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
    ...
    @output_size.setter
    def output_size(self, value: windows_foundation.Size | tuple[winrt.system.Single, winrt.system.Single]) -> None: ...
    ...
    def crop_rectangle(self, value: windows_foundation.Rect | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single]) -> None: ...
...
class IBasicAudioEffect(windows_media.IMediaExtension, winrt._winrt.IInspectable):
    ...
    @_property
    @abstractmethod
    def supported_encoding_properties(self) -> _cabc.Sequence[windows_media_mediaproperties.AudioEncodingProperties]: ...
...
class IBasicVideoEffect(windows_media.IMediaExtension, winrt._winrt.IInspectable):
    ...
    @_property
    @abstractmethod
    def supported_encoding_properties(self) -> _cabc.Sequence[windows_media_mediaproperties.VideoEncodingProperties]: ...
