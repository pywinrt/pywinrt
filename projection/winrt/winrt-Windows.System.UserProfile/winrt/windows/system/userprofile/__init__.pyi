...
class GlobalizationPreferences_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_set_languages(cls, language_tags: _cabc.Iterable[str], /) -> bool: ...
    ...
    @_property
    def calendars(cls) -> _cabc.Sequence[str]: ...
    ...
    @_property
    def clocks(cls) -> _cabc.Sequence[str]: ...
    ...
    @_property
    def currencies(cls) -> _cabc.Sequence[str]: ...
...
class GlobalizationPreferencesForUser(winrt.system.Object):
    ...
    @_property
    def clocks(self) -> _cabc.Sequence[str]: ...
    ...
    @_property
    def currencies(self) -> _cabc.Sequence[str]: ...
