...
class ApplicationData(winrt.system.Object, windows_foundation.IClosable, metaclass=ApplicationData_Static):
    ...
    def remove_data_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ApplicationDataContainer(winrt.system.Object, windows_foundation.IClosable):
    ...
    @_property
    def containers(self) -> _cabc.Mapping[str, ApplicationDataContainer]: ...
...
class FileIO_Static(winrt._winrt.IInspectable_Static):
    ...
    def append_lines_async(cls, file: IStorageFile, lines: _cabc.Iterable[str], encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of append_lines_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Storage.FileIO::AppendLinesAsync(Windows.Storage.IStorageFile,Windows.Foundation.Collections.IIterable`1<System.String>,Windows.Storage.Streams.UnicodeEncoding)
    @deprecated("Use append_lines_async() instead.")
    def append_lines_with_encoding_async(cls, file: IStorageFile, lines: _cabc.Iterable[str], encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    ...
    def read_lines_async(cls, file: IStorageFile, /) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[str]]: ...
    @typing.overload
    ...
    def read_lines_async(cls, file: IStorageFile, encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[str]]: ...
    # Deprecated alias of read_lines_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVector`1<System.String>> Windows.Storage.FileIO::ReadLinesAsync(Windows.Storage.IStorageFile,Windows.Storage.Streams.UnicodeEncoding)
    @deprecated("Use read_lines_async() instead.")
    def read_lines_with_encoding_async(cls, file: IStorageFile, encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[str]]: ...
    @typing.overload
    ...
    def write_bytes_async(cls, file: IStorageFile, buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    ...
    def write_lines_async(cls, file: IStorageFile, lines: _cabc.Iterable[str], /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    ...
    def write_lines_async(cls, file: IStorageFile, lines: _cabc.Iterable[str], encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of write_lines_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Storage.FileIO::WriteLinesAsync(Windows.Storage.IStorageFile,Windows.Foundation.Collections.IIterable`1<System.String>,Windows.Storage.Streams.UnicodeEncoding)
    @deprecated("Use write_lines_async() instead.")
    def write_lines_with_encoding_async(cls, file: IStorageFile, lines: _cabc.Iterable[str], encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
...
class PathIO_Static(winrt._winrt.IInspectable_Static):
    ...
    def append_lines_async(cls, absolute_path: str, lines: _cabc.Iterable[str], encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of append_lines_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Storage.PathIO::AppendLinesAsync(System.String,Windows.Foundation.Collections.IIterable`1<System.String>,Windows.Storage.Streams.UnicodeEncoding)
    @deprecated("Use append_lines_async() instead.")
    def append_lines_with_encoding_async(cls, absolute_path: str, lines: _cabc.Iterable[str], encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    ...
    def read_lines_async(cls, absolute_path: str, /) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[str]]: ...
    @typing.overload
    ...
    def read_lines_async(cls, absolute_path: str, encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[str]]: ...
    # Deprecated alias of read_lines_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVector`1<System.String>> Windows.Storage.PathIO::ReadLinesAsync(System.String,Windows.Storage.Streams.UnicodeEncoding)
    @deprecated("Use read_lines_async() instead.")
    def read_lines_with_encoding_async(cls, absolute_path: str, encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncOperation[_cabc.MutableSequence[str]]: ...
    @typing.overload
    ...
    def write_bytes_async(cls, absolute_path: str, buffer: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer, /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    ...
    def write_lines_async(cls, absolute_path: str, lines: _cabc.Iterable[str], /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
    ...
    def write_lines_async(cls, absolute_path: str, lines: _cabc.Iterable[str], encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of write_lines_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Storage.PathIO::WriteLinesAsync(System.String,Windows.Foundation.Collections.IIterable`1<System.String>,Windows.Storage.Streams.UnicodeEncoding)
    @deprecated("Use write_lines_async() instead.")
    def write_lines_with_encoding_async(cls, absolute_path: str, lines: _cabc.Iterable[str], encoding: windows_storage_streams.UnicodeEncoding, /) -> windows_foundation.IAsyncAction: ...
    @typing.overload
...
class StorageFolder(winrt.system.Object, IStorageItemPropertiesWithProvider, IStorageFolder2, IStorageItem2, IStorageItemProperties2, IStorageItemProperties, windows_storage_search.IStorageFolderQueryOperations, IStorageFolder, IStorageItem, metaclass=StorageFolder_Static):
    ...
    def get_files_async_overload_default_options_start_and_count(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[StorageFile]]: ...
    # Deprecated alias of get_files_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.StorageFile>> Windows.Storage.StorageFolder::GetFilesAsync(Windows.Storage.Search.CommonFileQuery)
    @deprecated("Use get_files_async() instead.")
    def get_files_async_overload_default_start_and_count(self, query: windows_storage_search.CommonFileQuery, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[StorageFile]]: ...
    ...
    def get_folders_async_overload_default_options_start_and_count(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[StorageFolder]]: ...
    # Deprecated alias of get_folders_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.StorageFolder>> Windows.Storage.StorageFolder::GetFoldersAsync(Windows.Storage.Search.CommonFolderQuery)
    @deprecated("Use get_folders_async() instead.")
    def get_folders_async_overload_default_start_and_count(self, query: windows_storage_search.CommonFolderQuery, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[StorageFolder]]: ...
    ...
    def get_items_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[IStorageItem]]: ...
    @typing.overload
    ...
    def get_items_async(self, start_index: winrt.system.UInt32, max_items_to_retrieve: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[IStorageItem]]: ...
    # Deprecated alias of get_items_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Storage.IStorageItem>> Windows.Storage.StorageFolder::GetItemsAsync()
    @deprecated("Use get_items_async() instead.")
    def get_items_async_overload_default_start_and_count(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[IStorageItem]]: ...
    ...
    def try_get_change_tracker(self) -> StorageLibraryChangeTracker | None: ...
...
class StorageLibrary(winrt.system.Object, metaclass=StorageLibrary_Static):
    ...
    def remove_definition_changed(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class StorageLibraryChangeReader(winrt.system.Object):
    ...
    def read_batch_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[StorageLibraryChange]]: ...
