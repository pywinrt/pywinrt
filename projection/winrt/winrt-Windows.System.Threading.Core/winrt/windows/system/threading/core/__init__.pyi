...
class PreallocatedWorkItem(winrt.system.Object):
    @typing.overload
    def __new__(cls, handler: windows_system_threading.WorkItemHandler) -> typing.Self: ...
    @typing.overload
    def __new__(cls, handler: windows_system_threading.WorkItemHandler, priority: windows_system_threading.WorkItemPriority) -> typing.Self: ...
    @typing.overload
    def __new__(cls, handler: windows_system_threading.WorkItemHandler, priority: windows_system_threading.WorkItemPriority, options: windows_system_threading.WorkItemOptions) -> typing.Self: ...
