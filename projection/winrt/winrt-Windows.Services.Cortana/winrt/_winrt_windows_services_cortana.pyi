...
class CortanaPermissionsManager(winrt.system.Object, metaclass=CortanaPermissionsManager_Static):
    ...
    # @deprecated("ICortanaPermissionsManager is deprecated and might not work on all platforms. For more info, see MSDN.")
    def grant_permissions_async(self, permissions: _cabc.Iterable[CortanaPermission], /) -> windows_foundation.IAsyncOperation[CortanaPermissionsChangeResult]: ...
    ...
    # @deprecated("ICortanaPermissionsManager is deprecated and might not work on all platforms. For more info, see MSDN.")
    def revoke_permissions_async(self, permissions: _cabc.Iterable[CortanaPermission], /) -> windows_foundation.IAsyncOperation[CortanaPermissionsChangeResult]: ...
