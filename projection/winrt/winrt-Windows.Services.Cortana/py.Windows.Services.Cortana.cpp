...
namespace py::cpp::Windows::Services::Cortana
{
    ...
    static PyObject* CortanaActionableInsights_GetDefault(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Services.Cortana.CortanaActionableInsights", "GetDefault", nullptr, py::site_is_static};
    ...
    static PyObject* CortanaActionableInsights_GetForUser(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Services.Cortana.CortanaActionableInsights", "GetForUser", nullptr, py::site_is_static};
    ...
    static PyObject* CortanaPermissionsManager_GetDefault(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Services.Cortana.CortanaPermissionsManager", "GetDefault", nullptr, py::site_is_static};
    ...
    static PyObject* CortanaSettings_GetDefault(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Services.Cortana.CortanaSettings", "GetDefault", nullptr, py::site_is_static};
    ...
    static PyObject* CortanaSettings_IsSupported(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Services.Cortana.CortanaSettings", "IsSupported", nullptr, py::site_is_static};
