...
class GattCharacteristic(winrt.system.Object, metaclass=GattCharacteristic_Static):
    ...
    def remove_value_changed(self, value_changed_event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def presentation_formats(self) -> _cabc.Sequence[GattPresentationFormat]: ...
...
class GattDeviceServicesResult(winrt.system.Object):
    ...
    @_property
    def services(self) -> _cabc.Sequence[GattDeviceService]: ...
...
class GattLocalCharacteristic(winrt.system.Object):
    ...
    def notify_value_async(self, value: winrt.system.Buffer, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[GattClientNotificationResult]]: ...
    @typing.overload
    ...
    def remove_read_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_subscribed_clients_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_write_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def descriptors(self) -> _cabc.Sequence[GattLocalDescriptor]: ...
    ...
    @_property
    def subscribed_clients(self) -> _cabc.Sequence[GattSubscribedClient]: ...
...
class GattLocalCharacteristicParameters(winrt.system.Object):
    ...
    @_property
    def presentation_formats(self) -> _cabc.MutableSequence[GattPresentationFormat]: ...
...
class GattLocalService(winrt.system.Object):
    ...
    @_property
    def characteristics(self) -> _cabc.Sequence[GattLocalCharacteristic]: ...
...
class GattSession(winrt.system.Object, windows_foundation.IClosable, metaclass=GattSession_Static):
    ...
    def remove_max_pdu_size_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class GattSubscribedClient(winrt.system.Object):
    ...
    def remove_max_notification_size_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
