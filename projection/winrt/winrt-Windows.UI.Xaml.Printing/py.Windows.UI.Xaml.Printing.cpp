...
namespace py::cpp::Windows::UI::Xaml::Printing
{
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.UI.Xaml.Printing.PrintDocument", "DocumentSourceProperty", nullptr, py::site_is_static};
