...
namespace py::cpp::Windows::UI::Xaml::Printing
{
    ...
    using BasePyWinrtPrintDocument = winrt::Windows::UI::Xaml::Printing::PrintDocumentT<PyWinrtPrintDocument, py::IPywinrtObject>;
    ...
    static PyObject* PrintDocument_AddPage(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            try
            {
                ...
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::UI::Xaml::Printing::IPrintDocument>(self->obj, py::member_kind::method, "Windows.UI.Xaml.Printing.PrintDocument", "AddPage", "Windows.UI.Xaml.Printing.IPrintDocument", 1).AddPage(param0);
                }
    ...
    static PyObject* PrintDocument_AddPagesComplete(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::UI::Xaml::Printing::IPrintDocument>(self->obj, py::member_kind::method, "Windows.UI.Xaml.Printing.PrintDocument", "AddPagesComplete", "Windows.UI.Xaml.Printing.IPrintDocument", 0).AddPagesComplete();
                }
    ...
    static PyObject* PrintDocument_InvalidatePreview(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::UI::Xaml::Printing::IPrintDocument>(self->obj, py::member_kind::method, "Windows.UI.Xaml.Printing.PrintDocument", "InvalidatePreview", "Windows.UI.Xaml.Printing.IPrintDocument", 0).InvalidatePreview();
                }
    ...
    static PyObject* PrintDocument_SetPreviewPage(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            try
            {
                ...
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::UI::Xaml::Printing::IPrintDocument>(self->obj, py::member_kind::method, "Windows.UI.Xaml.Printing.PrintDocument", "SetPreviewPage", "Windows.UI.Xaml.Printing.IPrintDocument", 2).SetPreviewPage(param0, param1);
                }
    ...
    static PyObject* PrintDocument_SetPreviewPageCount(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            try
            {
                ...
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::UI::Xaml::Printing::IPrintDocument>(self->obj, py::member_kind::method, "Windows.UI.Xaml.Printing.PrintDocument", "SetPreviewPageCount", "Windows.UI.Xaml.Printing.IPrintDocument", 2).SetPreviewPageCount(param0, param1);
                }
    ...
    static PyObject* PrintDocument_get_DocumentSource(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::UI::Xaml::Printing::IPrintDocument>(self->obj, py::member_kind::property, "Windows.UI.Xaml.Printing.PrintDocument", "DocumentSource", "Windows.UI.Xaml.Printing.IPrintDocument").DocumentSource();
            }());
        }
        catch (...)
        {
    ...
    static PyObject* PrintDocument_get_DocumentSourceProperty(PyObject* /*unused*/, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return winrt::Windows::UI::Xaml::Printing::PrintDocument::DocumentSourceProperty();
            }());
        }
        catch (...)
        {
    ...
    static PyObject* PrintDocument_add_AddPages(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::UI::Xaml::Printing::IPrintDocument>(self->obj, py::member_kind::event, "Windows.UI.Xaml.Printing.PrintDocument", "AddPages", "Windows.UI.Xaml.Printing.IPrintDocument").AddPages(param0);
            }());
        }
        catch (...)
        {
    ...
    static PyObject* PrintDocument_remove_AddPages(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                py::require<winrt::Windows::UI::Xaml::Printing::IPrintDocument>(self->obj, py::member_kind::event, "Windows.UI.Xaml.Printing.PrintDocument", "AddPages", "Windows.UI.Xaml.Printing.IPrintDocument").AddPages(param0);
            }
    ...
    static PyObject* PrintDocument_add_GetPreviewPage(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::UI::Xaml::Printing::IPrintDocument>(self->obj, py::member_kind::event, "Windows.UI.Xaml.Printing.PrintDocument", "GetPreviewPage", "Windows.UI.Xaml.Printing.IPrintDocument").GetPreviewPage(param0);
            }());
        }
        catch (...)
        {
    ...
    static PyObject* PrintDocument_remove_GetPreviewPage(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                py::require<winrt::Windows::UI::Xaml::Printing::IPrintDocument>(self->obj, py::member_kind::event, "Windows.UI.Xaml.Printing.PrintDocument", "GetPreviewPage", "Windows.UI.Xaml.Printing.IPrintDocument").GetPreviewPage(param0);
            }
    ...
    static PyObject* PrintDocument_add_Paginate(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::UI::Xaml::Printing::IPrintDocument>(self->obj, py::member_kind::event, "Windows.UI.Xaml.Printing.PrintDocument", "Paginate", "Windows.UI.Xaml.Printing.IPrintDocument").Paginate(param0);
            }());
        }
        catch (...)
        {
    ...
    static PyObject* PrintDocument_remove_Paginate(py::winrt_wrapper<winrt::Windows::Foundation::IInspectable>* self, PyObject* arg) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                py::require<winrt::Windows::UI::Xaml::Printing::IPrintDocument>(self->obj, py::member_kind::event, "Windows.UI.Xaml.Printing.PrintDocument", "Paginate", "Windows.UI.Xaml.Printing.IPrintDocument").Paginate(param0);
            }
