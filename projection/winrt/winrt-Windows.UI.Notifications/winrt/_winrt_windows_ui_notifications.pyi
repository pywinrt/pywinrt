...
class BadgeNotification(winrt.system.Object):
    ...
    def expiration_time(self, value: datetime.datetime | None) -> None: ...
...
class NotificationData(winrt.system.Object):
    ...
    @_property
    def values(self) -> _cabc.MutableMapping[str, str]: ...
...
class NotificationVisual(winrt.system.Object):
    ...
    @_property
    def bindings(self) -> _cabc.MutableSequence[NotificationBinding]: ...
...
class ScheduledToastNotification(winrt.system.Object):
    ...
    @_property
    def snooze_interval(self) -> datetime.timedelta | None: ...
...
class TileUpdater(winrt.system.Object):
    ...
    def get_scheduled_tile_notifications(self) -> _cabc.Sequence[ScheduledTileNotification]: ...
    ...
    def start_periodic_update_batch(self, tile_contents: _cabc.Iterable[windows_foundation.Uri], requested_interval: PeriodicUpdateRecurrence, /) -> None: ...
    @typing.overload
    ...
    def start_periodic_update_batch(self, tile_contents: _cabc.Iterable[windows_foundation.Uri], start_time: datetime.datetime, requested_interval: PeriodicUpdateRecurrence, /) -> None: ...
    ...
    def start_periodic_update_batch_at_time(self, tile_contents: _cabc.Iterable[windows_foundation.Uri], start_time: datetime.datetime, requested_interval: PeriodicUpdateRecurrence, /) -> None: ...
...
class ToastNotification(winrt.system.Object):
    ...
    def remove_failed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ToastNotificationHistory(winrt.system.Object):
    ...
    def get_history(self) -> _cabc.Sequence[ToastNotification]: ...
    @typing.overload
    ...
    def get_history(self, application_id: str, /) -> _cabc.Sequence[ToastNotification]: ...
    # Deprecated alias of get_history() for pywinrt v3.x compatibility.
    # Windows.Foundation.Collections.IVectorView`1<Windows.UI.Notifications.ToastNotification> Windows.UI.Notifications.ToastNotificationHistory::GetHistory(System.String)
    @deprecated("Use get_history() instead.")
    def get_history_with_id(self, application_id: str, /) -> _cabc.Sequence[ToastNotification]: ...
    @typing.overload
...
class ToastNotificationManagerForUser(winrt.system.Object):
    ...
    def remove_notification_mode_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class ToastNotifier(winrt.system.Object):
    ...
    def get_scheduled_toast_notifications(self) -> _cabc.Sequence[ScheduledToastNotification]: ...
    ...
    def remove_scheduled_toast_notification_showing(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
