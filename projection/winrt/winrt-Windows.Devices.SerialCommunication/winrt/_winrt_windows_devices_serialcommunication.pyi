...
class SerialDevice(winrt.system.Object, windows_foundation.IClosable, metaclass=SerialDevice_Static):
    ...
    def remove_error_received(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_pin_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
