...
class LearningModelBinding(winrt.system.Object, winrt._winrt.Mapping[str, winrt.system.Object]):
    ...
    def __new__(cls, session: LearningModelSession) -> typing.Self: ...
    @typing.overload
...
class LearningModelDevice(winrt.system.Object, metaclass=LearningModelDevice_Static):
    def __new__(cls, device_kind: LearningModelDeviceKind) -> typing.Self: ...
...
class LearningModelSession(winrt.system.Object, windows_foundation.IClosable):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    @typing.overload
    def __new__(cls, model: LearningModel, device_to_run_on: LearningModelDevice, learning_model_session_options: LearningModelSessionOptions) -> typing.Self: ...
    @typing.overload
    def __new__(cls, model: LearningModel) -> typing.Self: ...
    @typing.overload
    def __new__(cls, model: LearningModel, device_to_run_on: LearningModelDevice) -> typing.Self: ...
