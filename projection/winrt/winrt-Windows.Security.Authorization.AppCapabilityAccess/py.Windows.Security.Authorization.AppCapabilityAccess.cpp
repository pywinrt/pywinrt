...
namespace py::cpp::Windows::Security::Authorization::AppCapabilityAccess
{
    ...
    static PyObject* AppCapability_Create(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Security.Authorization.AppCapabilityAccess.AppCapability", "Create", nullptr, py::site_is_static};
    ...
    static PyObject* AppCapability_CreateWithProcessIdForUser(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 3)
        {
            static constexpr py::member_site site{py::member_kind::method, 3, "Windows.Security.Authorization.AppCapabilityAccess.AppCapability", "CreateWithProcessIdForUser", nullptr, py::site_is_static};
    ...
    static PyObject* AppCapability_RequestAccessForCapabilitiesAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Security.Authorization.AppCapabilityAccess.AppCapability", "RequestAccessForCapabilitiesAsync", nullptr, py::site_is_static};
    ...
    static PyObject* AppCapability_RequestAccessForCapabilitiesForUserAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Security.Authorization.AppCapabilityAccess.AppCapability", "RequestAccessForCapabilitiesForUserAsync", nullptr, py::site_is_static};
    ...
    static PyObject* AppCapability_get_DisplayMessage(py::wrapper::Windows::Security::Authorization::AppCapabilityAccess::AppCapability* self, void* /*unused*/) noexcept
    {
        try
        {
            ...
            {
                auto _gil = release_gil();
                return py::require<winrt::Windows::Security::Authorization::AppCapabilityAccess::IAppCapability2>(self->obj, py::member_kind::property, "Windows.Security.Authorization.AppCapabilityAccess.AppCapability", "DisplayMessage", "Windows.Security.Authorization.AppCapabilityAccess.IAppCapability2").DisplayMessage();
            }());
        }
        catch (...)
        {
    ...
    static int AppCapability_put_DisplayMessage(py::wrapper::Windows::Security::Authorization::AppCapabilityAccess::AppCapability* self, PyObject* arg, void* /*unused*/) noexcept
    {
        ...
        try
        {
            ...
            {
                auto _gil = release_gil();
                py::require<winrt::Windows::Security::Authorization::AppCapabilityAccess::IAppCapability2>(self->obj, py::member_kind::property, "Windows.Security.Authorization.AppCapabilityAccess.AppCapability", "DisplayMessage", "Windows.Security.Authorization.AppCapabilityAccess.IAppCapability2").DisplayMessage(param0);
            }
