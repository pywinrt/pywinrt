...
class PrintWorkflowBackgroundSession(winrt.system.Object):
    ...
    def remove_setup_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_submitted(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PrintWorkflowForegroundSession(winrt.system.Object):
    ...
    def remove_xps_data_available(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PrintWorkflowJobBackgroundSession(winrt.system.Object):
    ...
    def remove_job_starting(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_pdl_modification_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PrintWorkflowJobUISession(winrt.system.Object):
    ...
    def remove_job_notification(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_pdl_data_available(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_virtual_printer_ui_data_available(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PrintWorkflowPdlModificationRequestedEventArgs(winrt.system.Object):
    ...
    def create_job_on_printer_with_attributes(self, job_attributes: _cabc.Mapping[str, windows_devices_printers.IppAttributeValue] | _cabc.Iterable[windows_foundation_collections.IKeyValuePair[str, windows_devices_printers.IppAttributeValue]], target_content_type: str, /) -> PrintWorkflowPdlTargetStream: ...
    @typing.overload
...
class PrintWorkflowPrinterJob(winrt.system.Object):
    ...
    def get_job_attributes(self, attribute_names: _cabc.Iterable[str], /) -> _cabc.MutableMapping[str, windows_devices_printers.IppAttributeValue]: ...
    ...
    def get_job_attributes_as_buffer(self, attribute_names: _cabc.Iterable[str], /) -> winrt.system.Buffer: ...
...
class PrintWorkflowVirtualPrinterSession(winrt.system.Object):
    ...
    def remove_virtual_printer_data_available(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
