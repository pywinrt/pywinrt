...
namespace py::cpp::Windows::Devices::I2c
{
    ...
    static PyObject* I2cController_GetControllersAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.I2c.I2cController", "GetControllersAsync", nullptr, py::site_is_static};
    ...
    static PyObject* I2cController_GetDefaultAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.I2c.I2cController", "GetDefaultAsync", nullptr, py::site_is_static};
    ...
    static PyObject* I2cDevice_Close(py::wrapper::Windows::Devices::I2c::I2cDevice* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            try
            {
                {
                    auto _gil = release_gil();
                    py::require<winrt::Windows::Foundation::IClosable>(self->obj, py::member_kind::method, "Windows.Devices.I2c.I2cDevice", "Close", "Windows.Foundation.IClosable", 0).Close();
                }
    ...
    static PyObject* I2cDevice_FromIdAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 2)
        {
            static constexpr py::member_site site{py::member_kind::method, 2, "Windows.Devices.I2c.I2cDevice", "FromIdAsync", nullptr, py::site_is_static};
    ...
    static PyObject* I2cDevice_GetDeviceSelector(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Devices.I2c.I2cDevice", "GetDeviceSelector", nullptr, py::site_is_static};
        ...
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Devices.I2c.I2cDevice", "GetDeviceSelector", nullptr, py::site_is_static};
