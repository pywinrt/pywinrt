...
class InkDrawingAttributes(winrt.system.Object, metaclass=InkDrawingAttributes_Static):
    ...
    def pen_tip_transform(self, value: windows_foundation_numerics.Matrix3x2 | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single]) -> None: ...
...
class InkManager(winrt.system.Object, IInkRecognizerContainer, IInkStrokeContainer):
    ...
    def get_recognition_results(self) -> _cabc.Sequence[InkRecognitionResult]: ...
    ...
    def move_selected(self, translation: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Rect: ...
    # Windows.Foundation.Rect Windows.UI.Input.Inking.InkManager::PasteFromClipboard(Windows.Foundation.Point)
    def paste_from_clipboard(self, position: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Rect: ...
    ...
    def recognize_async(self, recognition_target: InkRecognitionTarget, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[InkRecognitionResult]]: ...
    @typing.overload
    ...
    def recognize_async(self, stroke_collection: InkStrokeContainer, recognition_target: InkRecognitionTarget, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[InkRecognitionResult]]: ...
    # Deprecated alias of recognize_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.UI.Input.Inking.InkRecognitionResult>> Windows.UI.Input.Inking.InkManager::RecognizeAsync(Windows.UI.Input.Inking.InkRecognitionTarget)
    @deprecated("Use recognize_async() instead.")
    def recognize_async2(self, recognition_target: InkRecognitionTarget, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[InkRecognitionResult]]: ...
    ...
    def select_with_line(self, from_: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], to: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], /) -> windows_foundation.Rect: ...
    ...
    def select_with_poly_line(self, polyline: _cabc.Iterable[windows_foundation.Point], /) -> windows_foundation.Rect: ...
    ...
    def update_recognition_results(self, recognition_results: _cabc.Sequence[InkRecognitionResult], /) -> None: ...
...
class InkPoint(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], position: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], pressure: winrt.system.Single, tilt_x: winrt.system.Single, tilt_y: winrt.system.Single, timestamp: winrt.system.UInt64) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], position: windows_foundation.Point | tuple[winrt.system.Single, winrt.system.Single], pressure: winrt.system.Single) -> Self: ...
...
class InkPresenter(winrt.system.Object):
    ...
    def remove_strokes_collected(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_strokes_erased(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class InkPresenterProtractor(winrt.system.Object, IInkPresenterStencil):
    def __new__(cls: type[Self], ink_presenter: InkPresenter) -> Self: ...
    ...
    @accent_color.setter
    def accent_color(self, value: windows_ui.Color | tuple[winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8, winrt.system.UInt8]) -> None: ...
    ...
    @transform.setter
    def transform(self, value: windows_foundation_numerics.Matrix3x2 | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single]) -> None: ...
...
class InkRecognitionResult(winrt.system.Object):
    ...
    def get_text_candidates(self) -> _cabc.Sequence[str]: ...
...
class InkStroke(winrt.system.Object):
    ...
    def get_ink_points(self) -> _cabc.Sequence[InkPoint]: ...
    ...
    def get_rendering_segments(self) -> _cabc.Sequence[InkStrokeRenderingSegment]: ...
    ...
    def point_transform(self, value: windows_foundation_numerics.Matrix3x2 | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single]) -> None: ...
    # Windows.Foundation.IReference`1<Windows.Foundation.DateTime> Windows.UI.Input.Inking.InkStroke::get_StrokeStartedTime()
    @_property
    def stroke_started_time(self) -> datetime.datetime | None: ...
    ...
    def stroke_duration(self, value: datetime.timedelta | None) -> None: ...
...
class InkStrokeBuilder(winrt.system.Object):
    ...
    def create_stroke(self, points: _cabc.Iterable[windows_foundation.Point], /) -> InkStroke: ...
    @typing.overload
    ...
    def create_stroke_from_ink_points(self, ink_points: _cabc.Iterable[InkPoint], transform: windows_foundation_numerics.Matrix3x2 | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], /) -> InkStroke: ...
    @typing.overload
    ...
    def create_stroke_from_ink_points(self, ink_points: _cabc.Iterable[InkPoint], transform: windows_foundation_numerics.Matrix3x2 | tuple[winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single, winrt.system.Single], stroke_started_time: datetime.datetime | None, stroke_duration: datetime.timedelta | None, /) -> InkStroke: ...
...
class InkStrokeContainer(winrt.system.Object, IInkStrokeContainer):
    ...
    def add_strokes(self, strokes: _cabc.Iterable[InkStroke], /) -> None: ...
...
class InkStrokeInput(winrt.system.Object):
    ...
    def remove_stroke_canceled(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_stroke_continued(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_stroke_ended(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_stroke_started(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class InkUnprocessedInput(winrt.system.Object):
    ...
    def remove_pointer_hovered(self, cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
