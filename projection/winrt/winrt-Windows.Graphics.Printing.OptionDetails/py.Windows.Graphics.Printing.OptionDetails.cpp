...
namespace py::cpp::Windows::Graphics::Printing::OptionDetails
{
    ...
    static PyObject* PrintTaskOptionDetails_GetFromPrintTaskOptions(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Graphics.Printing.OptionDetails.PrintTaskOptionDetails", "GetFromPrintTaskOptions", nullptr, py::site_is_static};
