...
class MediaTimeRange:
    ...
    def __new__(cls, start: datetime.timedelta = ..., end: datetime.timedelta = ...) -> MediaTimeRange: ...
...
class VideoFrame(winrt.system.Object, IMediaFrame, windows_foundation.IClosable, metaclass=VideoFrame_Static):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    @typing.overload
    def __new__(cls, format: windows_graphics_imaging.BitmapPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32) -> typing.Self: ...
    @typing.overload
    def __new__(cls, format: windows_graphics_imaging.BitmapPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32, alpha: windows_graphics_imaging.BitmapAlphaMode) -> typing.Self: ...
