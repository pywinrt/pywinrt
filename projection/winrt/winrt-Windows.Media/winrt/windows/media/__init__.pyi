...
class AudioFrame(winrt.system.Object, IMediaFrame, windows_foundation.IClosable):
    ...
    def system_relative_time(self, value: datetime.timedelta | None) -> None: ...
    # Windows.Foundation.IReference`1<Windows.Foundation.TimeSpan> Windows.Media.AudioFrame::get_RelativeTime()
    @_property
    def relative_time(self) -> datetime.timedelta | None: ...
    ...
    def relative_time(self, value: datetime.timedelta | None) -> None: ...
...
class MediaTimelineController(winrt.system.Object):
    ...
    def remove_position_changed(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_state_changed(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_ended(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class MusicDisplayProperties(winrt.system.Object):
    ...
    @_property
    def genres(self) -> _cabc.MutableSequence[str]: ...
...
class SystemMediaTransportControls(winrt.system.Object, metaclass=SystemMediaTransportControls_Static):
    ...
    def remove_auto_repeat_mode_change_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_playback_position_change_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_playback_rate_change_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_shuffle_enabled_change_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class VideoFrame(winrt.system.Object, IMediaFrame, windows_foundation.IClosable, metaclass=VideoFrame_Static):
    ...
    def __exit__(self, exc_type: type[BaseException] | None, exc_value: BaseException | None, traceback: types.TracebackType | None) -> None: ...
    @typing.overload
    def __new__(cls: type[Self], format: windows_graphics_imaging.BitmapPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], format: windows_graphics_imaging.BitmapPixelFormat, width: winrt.system.Int32, height: winrt.system.Int32, alpha: windows_graphics_imaging.BitmapAlphaMode) -> Self: ...
    ...
    def copy_to_async(self, frame: VideoFrame, source_bounds: windows_graphics_imaging.BitmapBounds | None, destination_bounds: windows_graphics_imaging.BitmapBounds | None, /) -> windows_foundation.IAsyncAction: ...
    # Deprecated alias of copy_to_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncAction Windows.Media.VideoFrame::CopyToAsync(Windows.Media.VideoFrame,Windows.Foundation.IReference`1<Windows.Graphics.Imaging.BitmapBounds>,Windows.Foundation.IReference`1<Windows.Graphics.Imaging.BitmapBounds>)
    @deprecated("Use copy_to_async() instead.")
    def copy_to_with_bounds_async(self, frame: VideoFrame, source_bounds: windows_graphics_imaging.BitmapBounds | None, destination_bounds: windows_graphics_imaging.BitmapBounds | None, /) -> windows_foundation.IAsyncAction: ...
...
class IMediaMarkers(winrt._winrt.IInspectable):
    ...
    @_property
    @abstractmethod
    def markers(self) -> _cabc.Sequence[IMediaMarker]: ...
