...
class PhotoImportProgress:
    ...
    def unpack(self) -> tuple[winrt.system.UInt32, winrt.system.UInt32, winrt.system.UInt64, winrt.system.UInt64, winrt.system.Double]: ...
...
class PhotoImportFindItemsResult(winrt.system.Object):
    ...
    def remove_item_imported(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def found_items(self) -> _cabc.Sequence[PhotoImportItem]: ...
...
class PhotoImportImportItemsResult(winrt.system.Object):
    ...
    @_property
    def imported_items(self) -> _cabc.Sequence[PhotoImportItem]: ...
...
class PhotoImportItem(winrt.system.Object):
    ...
    @_property
    def sidecars(self) -> _cabc.Sequence[PhotoImportSidecar]: ...
    ...
    @_property
    def video_segments(self) -> _cabc.Sequence[PhotoImportVideoSegment]: ...
...
class PhotoImportManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def find_all_sources_async(cls) -> windows_foundation.IAsyncOperation[_cabc.Sequence[PhotoImportSource]]: ...
    ...
    def get_pending_operations(cls) -> _cabc.Sequence[PhotoImportOperation]: ...
...
class PhotoImportSource(winrt.system.Object, metaclass=PhotoImportSource_Static):
    ...
    @_property
    def battery_level_percent(self) -> winrt.system.UInt32 | None: ...
    ...
    @_property
    def date_time(self) -> datetime.datetime | None: ...
    ...
    @_property
    def storage_media(self) -> _cabc.Sequence[PhotoImportStorageMedium]: ...
