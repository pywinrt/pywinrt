...
class StoreContext(winrt.system.Object, metaclass=StoreContext_Static):
    ...
    def download_and_install_store_packages_async(self, store_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]: ...
    ...
    def find_store_product_for_package_async(self, product_kinds: _cabc.Iterable[str], package: windows_applicationmodel.Package, /) -> windows_foundation.IAsyncOperation[StoreProductResult]: ...
    ...
    def get_app_and_optional_store_package_updates_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[StorePackageUpdate]]: ...
    ...
    def get_associated_store_products_async(self, product_kinds: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[StoreProductQueryResult]: ...
    ...
    def get_associated_store_products_by_in_app_offer_token_async(self, in_app_offer_tokens: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[StoreProductQueryResult]: ...
    ...
    def get_associated_store_products_with_paging_async(self, product_kinds: _cabc.Iterable[str], max_items_to_retrieve_per_page: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[StoreProductPagedQueryResult]: ...
    ...
    def get_associated_store_queue_items_async(self) -> windows_foundation.IAsyncOperation[_cabc.Sequence[StoreQueueItem]]: ...
    ...
    def get_store_products_async(self, product_kinds: _cabc.Iterable[str], store_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[StoreProductQueryResult]: ...
    @typing.overload
    ...
    def get_store_products_async(self, product_kinds: _cabc.Iterable[str], store_ids: _cabc.Iterable[str], store_product_options: StoreProductOptions, /) -> windows_foundation.IAsyncOperation[StoreProductQueryResult]: ...
    ...
    def get_store_products_with_options_async(self, product_kinds: _cabc.Iterable[str], store_ids: _cabc.Iterable[str], store_product_options: StoreProductOptions, /) -> windows_foundation.IAsyncOperation[StoreProductQueryResult]: ...
    ...
    def get_store_queue_items_async(self, store_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[StoreQueueItem]]: ...
    ...
    def get_user_collection_async(self, product_kinds: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[StoreProductQueryResult]: ...
    ...
    def get_user_collection_with_paging_async(self, product_kinds: _cabc.Iterable[str], max_items_to_retrieve_per_page: winrt.system.UInt32, /) -> windows_foundation.IAsyncOperation[StoreProductPagedQueryResult]: ...
    ...
    def get_user_purchase_history_async(self, product_kinds: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperation[StoreProductQueryResult]: ...
    ...
    def request_download_and_install_store_package_updates_async(self, store_package_updates: _cabc.Iterable[StorePackageUpdate], /) -> windows_foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]: ...
    @typing.overload
    ...
    def request_download_and_install_store_packages_async(self, store_ids: _cabc.Iterable[str], /) -> windows_foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]: ...
    @typing.overload
    ...
    def request_download_and_install_store_packages_async(self, store_ids: _cabc.Iterable[str], store_package_install_options: StorePackageInstallOptions, /) -> windows_foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]: ...
    ...
    def request_download_and_install_store_packages_with_install_options_async(self, store_ids: _cabc.Iterable[str], store_package_install_options: StorePackageInstallOptions, /) -> windows_foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]: ...
    ...
    def request_download_store_package_updates_async(self, store_package_updates: _cabc.Iterable[StorePackageUpdate], /) -> windows_foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]: ...
    @typing.overload
    ...
    def set_install_order_for_associated_store_queue_items_async(self, items: _cabc.Iterable[StoreQueueItem], /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[StoreQueueItem]]: ...
    ...
    def try_silent_download_and_install_store_package_updates_async(self, store_package_updates: _cabc.Iterable[StorePackageUpdate], /) -> windows_foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]: ...
    ...
    def try_silent_download_store_package_updates_async(self, store_package_updates: _cabc.Iterable[StorePackageUpdate], /) -> windows_foundation.IAsyncOperationWithProgress[StorePackageUpdateResult, StorePackageUpdateStatus]: ...
    ...
    def remove_offline_licenses_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class StorePackageLicense(winrt.system.Object, windows_foundation.IClosable):
    ...
    def remove_license_lost(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class StorePackageUpdateResult(winrt.system.Object):
    ...
    @_property
    def store_package_update_statuses(self) -> _cabc.Sequence[StorePackageUpdateStatus]: ...
    ...
    @_property
    def store_queue_items(self) -> _cabc.Sequence[StoreQueueItem]: ...
...
class StoreProduct(winrt.system.Object):
    ...
    @_property
    def images(self) -> _cabc.Sequence[StoreImage]: ...
    ...
    @_property
    def keywords(self) -> _cabc.Sequence[str]: ...
    ...
    @_property
    def skus(self) -> _cabc.Sequence[StoreSku]: ...
    ...
    @_property
    def videos(self) -> _cabc.Sequence[StoreVideo]: ...
...
class StoreProductOptions(winrt.system.Object):
    ...
    @_property
    def action_filters(self) -> _cabc.MutableSequence[str]: ...
...
class StoreProductPagedQueryResult(winrt.system.Object):
    ...
    @_property
    def products(self) -> _cabc.Mapping[str, StoreProduct]: ...
