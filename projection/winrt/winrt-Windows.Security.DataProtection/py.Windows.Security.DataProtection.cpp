...
namespace py::cpp::Windows::Security::DataProtection
{
    ...
    static PyObject* UserDataProtectionManager_TryGetDefault(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.Security.DataProtection.UserDataProtectionManager", "TryGetDefault", nullptr, py::site_is_static};
    ...
    static PyObject* UserDataProtectionManager_TryGetForUser(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Security.DataProtection.UserDataProtectionManager", "TryGetForUser", nullptr, py::site_is_static};
