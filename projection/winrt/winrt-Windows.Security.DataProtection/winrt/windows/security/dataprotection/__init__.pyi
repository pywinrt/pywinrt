...
class UserDataProtectionManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def try_get_for_user(cls, user: windows_system.User, /) -> UserDataProtectionManager | None: ...
...
class UserDataProtectionManager(winrt.system.Object, metaclass=UserDataProtectionManager_Static):
    ...
    def remove_data_availability_state_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
