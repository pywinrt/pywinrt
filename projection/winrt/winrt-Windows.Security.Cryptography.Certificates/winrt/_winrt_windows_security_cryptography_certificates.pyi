...
class Certificate(winrt.system.Object):
    ...
    def build_chain_async(self, certificates: _cabc.Iterable[Certificate], parameters: ChainBuildingParameters, /) -> windows_foundation.IAsyncOperation[CertificateChain]: ...
    ...
    @_property
    def enhanced_key_usages(self) -> _cabc.Sequence[str]: ...
...
class CertificateExtension(winrt.system.Object):
    ...
    @value.setter
    def value(self, value: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> None: ...
...
class CertificateQuery(winrt.system.Object):
    ...
    @thumbprint.setter
    def thumbprint(self, value: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> None: ...
    ...
    @_property
    def enhanced_key_usages(self) -> _cabc.MutableSequence[str]: ...
...
class CertificateRequestProperties(winrt.system.Object):
    ...
    def curve_parameters(self, value: winrt.system.Array[winrt.system.UInt8] | winrt.system.ReadableBuffer) -> None: ...
    ...
    @_property
    def extensions(self) -> _cabc.MutableSequence[CertificateExtension]: ...
    ...
    @_property
    def suppressed_defaults(self) -> _cabc.MutableSequence[str]: ...
...
class CertificateStores_Static(winrt._winrt.IInspectable_Static):
    ...
    def find_all_async(cls, query: CertificateQuery, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[Certificate]]: ...
    # Deprecated alias of find_all_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Foundation.Collections.IVectorView`1<Windows.Security.Cryptography.Certificates.Certificate>> Windows.Security.Cryptography.Certificates.CertificateStores::FindAllAsync(Windows.Security.Cryptography.Certificates.CertificateQuery)
    @deprecated("Use find_all_async() instead.")
    def find_all_with_query_async(cls, query: CertificateQuery, /) -> windows_foundation.IAsyncOperation[_cabc.Sequence[Certificate]]: ...
...
class ChainBuildingParameters(winrt.system.Object):
    ...
    @_property
    def exclusive_trust_roots(self) -> _cabc.MutableSequence[Certificate]: ...
...
class SubjectAlternativeNameInfo(winrt.system.Object):
    ...
    @_property
    def dns_name(self) -> _cabc.Sequence[str]: ...
    ...
    @_property
    def email_name(self) -> _cabc.Sequence[str]: ...
    ...
    @_property
    def ip_address(self) -> _cabc.Sequence[str]: ...
    ...
    @_property
    def principal_name(self) -> _cabc.Sequence[str]: ...
    ...
    @_property
    def url(self) -> _cabc.Sequence[str]: ...
    ...
    @_property
    def distinguished_names(self) -> _cabc.MutableSequence[str]: ...
    ...
    @_property
    def dns_names(self) -> _cabc.MutableSequence[str]: ...
    ...
    @_property
    def email_names(self) -> _cabc.MutableSequence[str]: ...
    ...
    @_property
    def ip_addresses(self) -> _cabc.MutableSequence[str]: ...
    ...
    @_property
    def principal_names(self) -> _cabc.MutableSequence[str]: ...
    ...
    @_property
    def urls(self) -> _cabc.MutableSequence[str]: ...
