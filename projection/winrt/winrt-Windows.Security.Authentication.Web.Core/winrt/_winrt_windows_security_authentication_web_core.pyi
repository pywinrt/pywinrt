...
class WebAccountMonitor(winrt.system.Object):
    ...
    def remove_default_sign_in_account_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_account_picture_updated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...

@typing.final
class WebAuthenticationAddAccountResponse(winrt.system.Object):
    def __new__(cls: type[Self], web_account: windows_security_credentials.WebAccount) -> Self: ...
    ...
    @_property
    def properties(self) -> _cabc.MutableMapping[str, str]: ...
...
class WebAuthenticationCoreManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def create_web_account_monitor(cls, web_accounts: _cabc.Iterable[windows_security_credentials.WebAccount], /) -> WebAccountMonitor: ...
...
class WebAuthenticationTransferTokenRequest(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], provider: windows_security_credentials.WebAccountProvider, transfer_token: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], provider: windows_security_credentials.WebAccountProvider, transfer_token: str, correlation_id: str) -> Self: ...
...
class WebProviderError(winrt.system.Object):
    def __new__(cls: type[Self], error_code: winrt.system.UInt32, error_message: str) -> Self: ...
...
class WebTokenRequest(winrt.system.Object):
    @typing.overload
    def __new__(cls: type[Self], provider: windows_security_credentials.WebAccountProvider, scope: str, client_id: str) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], provider: windows_security_credentials.WebAccountProvider, scope: str, client_id: str, prompt_type: WebTokenRequestPromptType) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], provider: windows_security_credentials.WebAccountProvider) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], provider: windows_security_credentials.WebAccountProvider, scope: str) -> Self: ...
    ...
    @_property
    def app_properties(self) -> _cabc.MutableMapping[str, str]: ...
...
class WebTokenRequestResult(winrt.system.Object):
    ...
    @_property
    def response_data(self) -> _cabc.Sequence[WebTokenResponse]: ...
...
class WebTokenResponse(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls: type[Self], token: str, web_account: windows_security_credentials.WebAccount) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], token: str, web_account: windows_security_credentials.WebAccount, error: WebProviderError) -> Self: ...
    @typing.overload
