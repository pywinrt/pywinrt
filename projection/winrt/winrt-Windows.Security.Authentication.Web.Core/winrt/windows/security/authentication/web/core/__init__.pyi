...
class WebAuthenticationAddAccountResponse(winrt.system.Object):
    def __new__(cls, web_account: windows_security_credentials.WebAccount) -> typing.Self: ...
...
class WebAuthenticationTransferTokenRequest(winrt.system.Object):
    @typing.overload
    def __new__(cls, provider: windows_security_credentials.WebAccountProvider, transfer_token: str) -> typing.Self: ...
    @typing.overload
    def __new__(cls, provider: windows_security_credentials.WebAccountProvider, transfer_token: str, correlation_id: str) -> typing.Self: ...
...
class WebProviderError(winrt.system.Object):
    def __new__(cls, error_code: winrt.system.UInt32, error_message: str) -> typing.Self: ...
...
class WebTokenRequest(winrt.system.Object):
    @typing.overload
    def __new__(cls, provider: windows_security_credentials.WebAccountProvider, scope: str, client_id: str) -> typing.Self: ...
    @typing.overload
    def __new__(cls, provider: windows_security_credentials.WebAccountProvider, scope: str, client_id: str, prompt_type: WebTokenRequestPromptType) -> typing.Self: ...
    @typing.overload
    def __new__(cls, provider: windows_security_credentials.WebAccountProvider) -> typing.Self: ...
    @typing.overload
    def __new__(cls, provider: windows_security_credentials.WebAccountProvider, scope: str) -> typing.Self: ...
...
class WebTokenResponse(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls, token: str, web_account: windows_security_credentials.WebAccount) -> typing.Self: ...
    @typing.overload
    def __new__(cls, token: str, web_account: windows_security_credentials.WebAccount, error: WebProviderError) -> typing.Self: ...
    @typing.overload
