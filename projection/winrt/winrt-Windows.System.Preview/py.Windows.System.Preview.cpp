...
namespace py::cpp::Windows::System::Preview
{
    ...
    static PyObject* TwoPanelHingedDevicePosturePreview_GetDefaultAsync(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 0)
        {
            static constexpr py::member_site site{py::member_kind::method, 0, "Windows.System.Preview.TwoPanelHingedDevicePosturePreview", "GetDefaultAsync", nullptr, py::site_is_static};
