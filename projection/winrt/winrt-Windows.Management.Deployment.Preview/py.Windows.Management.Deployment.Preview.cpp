...
namespace py::cpp::Windows::Management::Deployment::Preview
{
    ...
    static PyObject* ClassicAppManager_FindInstalledApp(PyObject* /*unused*/, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            static constexpr py::member_site site{py::member_kind::method, 1, "Windows.Management.Deployment.Preview.ClassicAppManager", "FindInstalledApp", nullptr, py::site_is_static};
