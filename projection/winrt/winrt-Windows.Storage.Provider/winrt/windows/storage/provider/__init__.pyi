...
class CachedFileUpdaterUI(winrt.system.Object):
    ...
    def remove_file_update_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_ui_requested(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class StorageProviderKnownFolderSyncInfo(winrt.system.Object):
    ...
    @_property
    def known_folder_entries(self) -> _cabc.MutableSequence[StorageProviderKnownFolderEntry]: ...
...
class StorageProviderQuotaUI(winrt.system.Object):
    ...
    @_property
    def quota_used_color(self) -> windows_ui.Color | None: ...
    ...
    def quota_used_color(self, value: windows_ui.Color | None) -> None: ...
...
class StorageProviderSearchQueryOptions(winrt.system.Object):
    ...
    @_property
    def sort_order(self) -> _cabc.Sequence[windows_storage_search.SortEntry]: ...
...
class StorageProviderStatusUI(winrt.system.Object):
    ...
    @_property
    def provider_secondary_commands(self) -> _cabc.MutableSequence[IStorageProviderUICommand]: ...
    ...
    def provider_secondary_commands(self, value: _cabc.MutableSequence[IStorageProviderUICommand]) -> None: ...
...
class StorageProviderSyncRootInfo(winrt.system.Object):
    ...
    @_property
    def storage_provider_item_property_definitions(self) -> _cabc.MutableSequence[StorageProviderItemPropertyDefinition]: ...
...
class IStorageProviderKnownFolderSyncInfoSource(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def remove_known_folder_sync_info_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class IStorageProviderShareLinkSource(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def get_default_access_control_string_async(self, storage_item_list: _cabc.Sequence[windows_storage.IStorageItem], /) -> windows_foundation.IAsyncOperation[str]: ...
    ...
    @abstractmethod
    def get_state(self, storage_item_list: _cabc.Sequence[windows_storage.IStorageItem], /) -> windows_foundation.IAsyncOperation[StorageProviderShareLinkState]: ...
...
class IStorageProviderStatusUISource(winrt._winrt.IInspectable):
    ...
    @abstractmethod
    def remove_status_ui_changed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
StorageProviderKnownFolderSyncRequestedHandler: typing.TypeAlias = typing.Callable[[StorageProviderKnownFolderSyncRequestArgs], None]
