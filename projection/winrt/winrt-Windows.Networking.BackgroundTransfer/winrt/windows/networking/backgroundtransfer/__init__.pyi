...
class BackgroundDownloadProgress:
    ...
    def __new__(cls, bytes_received: winrt.system.UInt64 = 0, total_bytes_to_receive: winrt.system.UInt64 = 0, status: BackgroundTransferStatus = ..., has_response_changed: bool = False, has_restarted: bool = False) -> BackgroundDownloadProgress: ...
    def __replace__(self, /, **changes: typing.Any) -> BackgroundDownloadProgress: ...
    def unpack(self) -> tuple[winrt.system.UInt64, winrt.system.UInt64, BackgroundTransferStatus, bool, bool]: ...
...
class BackgroundTransferFileRange:
    ...
    def unpack(self) -> tuple[winrt.system.UInt64, winrt.system.UInt64]: ...
...
class BackgroundUploadProgress:
    ...
    @_property
    def has_restarted(self) -> bool: ...
    def __new__(cls, bytes_received: winrt.system.UInt64 = 0, bytes_sent: winrt.system.UInt64 = 0, total_bytes_to_receive: winrt.system.UInt64 = 0, total_bytes_to_send: winrt.system.UInt64 = 0, status: BackgroundTransferStatus = ..., has_response_changed: bool = False, has_restarted: bool = False) -> BackgroundUploadProgress: ...
...
class BackgroundTransferCompletionGroupTriggerDetails(winrt.system.Object):
    ...
    @_property
    def uploads(self) -> _cabc.Sequence[UploadOperation]: ...
...
class BackgroundTransferContentPart(winrt.system.Object):
    ...
    @typing.overload
    def __new__(cls, name: str, file_name: str) -> typing.Self: ...
    @typing.overload
    def __new__(cls) -> typing.Self: ...
...
class BackgroundTransferRangesDownloadedEventArgs(winrt.system.Object):
    ...
    @_property
    def added_ranges(self) -> _cabc.MutableSequence[BackgroundTransferFileRange]: ...
...
class BackgroundUploader(winrt.system.Object, IBackgroundTransferBase, metaclass=BackgroundUploader_Static):
    ...
    def create_upload_async(self, uri: windows_foundation.Uri, parts: _cabc.Iterable[BackgroundTransferContentPart], /) -> windows_foundation.IAsyncOperation[UploadOperation]: ...
    @typing.overload
    # Windows.Foundation.IAsyncOperation`1<Windows.Networking.BackgroundTransfer.UploadOperation> Windows.Networking.BackgroundTransfer.BackgroundUploader::CreateUploadAsync(Windows.Foundation.Uri,Windows.Foundation.Collections.IIterable`1<Windows.Networking.BackgroundTransfer.BackgroundTransferContentPart>,System.String)
    def create_upload_async(self, uri: windows_foundation.Uri, parts: _cabc.Iterable[BackgroundTransferContentPart], sub_type: str, /) -> windows_foundation.IAsyncOperation[UploadOperation]: ...
    @typing.overload
    # Windows.Foundation.IAsyncOperation`1<Windows.Networking.BackgroundTransfer.UploadOperation> Windows.Networking.BackgroundTransfer.BackgroundUploader::CreateUploadAsync(Windows.Foundation.Uri,Windows.Foundation.Collections.IIterable`1<Windows.Networking.BackgroundTransfer.BackgroundTransferContentPart>,System.String,System.String)
    def create_upload_async(self, uri: windows_foundation.Uri, parts: _cabc.Iterable[BackgroundTransferContentPart], sub_type: str, boundary: str, /) -> windows_foundation.IAsyncOperation[UploadOperation]: ...
    # Deprecated alias of create_upload_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Networking.BackgroundTransfer.UploadOperation> Windows.Networking.BackgroundTransfer.BackgroundUploader::CreateUploadAsync(Windows.Foundation.Uri,Windows.Foundation.Collections.IIterable`1<Windows.Networking.BackgroundTransfer.BackgroundTransferContentPart>)
    @deprecated("Use create_upload_async() instead.")
    def create_upload_with_form_data_and_auto_boundary_async(self, uri: windows_foundation.Uri, parts: _cabc.Iterable[BackgroundTransferContentPart], /) -> windows_foundation.IAsyncOperation[UploadOperation]: ...
    # Deprecated alias of create_upload_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Networking.BackgroundTransfer.UploadOperation> Windows.Networking.BackgroundTransfer.BackgroundUploader::CreateUploadAsync(Windows.Foundation.Uri,Windows.Foundation.Collections.IIterable`1<Windows.Networking.BackgroundTransfer.BackgroundTransferContentPart>,System.String,System.String)
    @deprecated("Use create_upload_async() instead.")
    def create_upload_with_sub_type_and_boundary_async(self, uri: windows_foundation.Uri, parts: _cabc.Iterable[BackgroundTransferContentPart], sub_type: str, boundary: str, /) -> windows_foundation.IAsyncOperation[UploadOperation]: ...
    # Deprecated alias of create_upload_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<Windows.Networking.BackgroundTransfer.UploadOperation> Windows.Networking.BackgroundTransfer.BackgroundUploader::CreateUploadAsync(Windows.Foundation.Uri,Windows.Foundation.Collections.IIterable`1<Windows.Networking.BackgroundTransfer.BackgroundTransferContentPart>,System.String)
    @deprecated("Use create_upload_async() instead.")
    def create_upload_with_sub_type_async(self, uri: windows_foundation.Uri, parts: _cabc.Iterable[BackgroundTransferContentPart], sub_type: str, /) -> windows_foundation.IAsyncOperation[UploadOperation]: ...
...
class ContentPrefetcher_Static(winrt._winrt.IInspectable_Static):
    ...
    @_property
    def content_uris(cls) -> _cabc.MutableSequence[windows_foundation.Uri]: ...
    ...
    @_property
    def last_successful_prefetch_time(cls) -> datetime.datetime | None: ...
...
class DownloadOperation(winrt.system.Object, IBackgroundTransferOperationPriority, IBackgroundTransferOperation):
    ...
    def get_downloaded_ranges(self) -> _cabc.MutableSequence[BackgroundTransferFileRange]: ...
    ...
    def remove_ranges_downloaded(self, event_cookie: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    @_property
    def current_web_error_status(self) -> windows_web.WebErrorStatus | None: ...
    ...
    @_property
    def recoverable_web_error_statuses(self) -> _cabc.MutableSequence[windows_web.WebErrorStatus]: ...
...
class ResponseInformation(winrt.system.Object):
    ...
    @_property
    def headers(self) -> _cabc.Mapping[str, str]: ...
