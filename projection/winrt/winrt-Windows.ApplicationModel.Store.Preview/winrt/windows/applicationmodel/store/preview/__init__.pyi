...
class StoreConfiguration_Static(winrt._winrt.IInspectable_Static):
    ...
    def get_purchase_prompting_policy_for_user(cls, user: windows_system.User, /) -> winrt.system.UInt32 | None: ...
    ...
    def set_purchase_prompting_policy_for_user(cls, user: windows_system.User, value: winrt.system.UInt32 | None, /) -> None: ...
    ...
    @_property
    def purchase_prompting_policy(cls) -> winrt.system.UInt32 | None: ...
    ...
    def purchase_prompting_policy(cls, value: winrt.system.UInt32 | None) -> None: ...
...
class StorePreviewProductInfo(winrt.system.Object):
    ...
    @_property
    def sku_info_list(self) -> _cabc.Sequence[StorePreviewSkuInfo]: ...
