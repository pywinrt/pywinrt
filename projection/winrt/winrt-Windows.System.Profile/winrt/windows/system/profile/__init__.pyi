...
class PlatformDiagnosticsAndUsageDataSettings_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_collection_level_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class SmartAppControlPolicy_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class SystemSetupInfo_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_out_of_box_experience_state_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class WindowsIntegrityPolicy_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_policy_changed(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
