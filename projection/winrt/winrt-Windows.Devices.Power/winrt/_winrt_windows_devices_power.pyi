...
class Battery(winrt.system.Object, metaclass=Battery_Static):
    ...
    def remove_report_updated(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PowerGridForecast_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_forecast_updated(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PowerGridForecast(winrt.system.Object, metaclass=PowerGridForecast_Static):
    ...
    @_property
    def forecast(self) -> _cabc.Sequence[PowerGridData]: ...
