...
class PushNotificationChannel(winrt.system.Object):
    ...
    def remove_push_notification_received(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class PushNotificationChannelManager_Static(winrt._winrt.IInspectable_Static):
    ...
    def remove_channels_revoked(cls, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
