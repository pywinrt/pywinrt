...
class SmartCardAppletIdGroup(winrt.system.Object, metaclass=SmartCardAppletIdGroup_Static):
    @typing.overload
    def __new__(cls: type[Self], display_name: str, applet_ids: _cabc.MutableSequence[winrt.system.Buffer], emulation_category: SmartCardEmulationCategory, emulation_type: SmartCardEmulationType) -> Self: ...
    @typing.overload
    ...
    @_property
    def applet_ids(self) -> _cabc.MutableSequence[winrt.system.Buffer]: ...
...
class SmartCardAppletIdGroupRegistration(winrt.system.Object):
    ...
    def set_automatic_response_apdus_async(self, apdus: _cabc.Iterable[SmartCardAutomaticResponseApdu], /) -> windows_foundation.IAsyncAction: ...
...
class SmartCardAutomaticResponseApdu(winrt.system.Object):
    def __new__(cls: type[Self], command_apdu: winrt.system.Buffer, response_apdu: winrt.system.Buffer) -> Self: ...
    ...
    @_property
    def output_state(self) -> winrt.system.UInt32 | None: ...
    ...
    @input_state.setter
    def input_state(self, value: winrt.system.UInt32 | None) -> None: ...
...
class SmartCardCryptogramGenerator(winrt.system.Object, metaclass=SmartCardCryptogramGenerator_Static):
    ...
    def validate_request_apdu_async(self, prompting_behavior: SmartCardUnlockPromptingBehavior, apdu_to_validate: winrt.system.Buffer, cryptogram_placement_steps: _cabc.Iterable[SmartCardCryptogramPlacementStep], /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]: ...
    ...
    @_property
    def supported_cryptogram_algorithms(self) -> _cabc.Sequence[SmartCardCryptogramAlgorithm]: ...
    ...
    @_property
    def supported_cryptogram_material_package_confirmation_response_formats(self) -> _cabc.Sequence[SmartCardCryptogramMaterialPackageConfirmationResponseFormat]: ...
    ...
    @_property
    def supported_cryptogram_material_package_formats(self) -> _cabc.Sequence[SmartCardCryptogramMaterialPackageFormat]: ...
    ...
    @_property
    def supported_cryptogram_material_types(self) -> _cabc.Sequence[SmartCardCryptogramMaterialType]: ...
    ...
    @_property
    def supported_smart_card_cryptogram_storage_key_capabilities(self) -> _cabc.Sequence[SmartCardCryptogramStorageKeyCapabilities]: ...
...
class SmartCardCryptogramGetAllCryptogramMaterialCharacteristicsResult(winrt.system.Object):
    ...
    @_property
    def characteristics(self) -> _cabc.Sequence[SmartCardCryptogramMaterialCharacteristics]: ...
...
class SmartCardCryptogramGetAllCryptogramMaterialPackageCharacteristicsResult(winrt.system.Object):
    ...
    @_property
    def characteristics(self) -> _cabc.Sequence[SmartCardCryptogramMaterialPackageCharacteristics]: ...
...
class SmartCardCryptogramGetAllCryptogramStorageKeyCharacteristicsResult(winrt.system.Object):
    ...
    @_property
    def characteristics(self) -> _cabc.Sequence[SmartCardCryptogramStorageKeyCharacteristics]: ...
...
class SmartCardCryptogramMaterialCharacteristics(winrt.system.Object):
    ...
    @_property
    def allowed_algorithms(self) -> _cabc.Sequence[SmartCardCryptogramAlgorithm]: ...
    ...
    @_property
    def allowed_proof_of_possession_algorithms(self) -> _cabc.Sequence[SmartCardCryptogramMaterialPackageConfirmationResponseFormat]: ...
    ...
    @_property
    def allowed_validations(self) -> _cabc.Sequence[SmartCardCryptogramAlgorithm]: ...
...
class SmartCardEmulator(winrt.system.Object, metaclass=SmartCardEmulator_Static):
    ...
    def remove_apdu_received(self, value: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_connection_deactivated(self, value: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class SmartCardEmulatorApduReceivedEventArgs(winrt.system.Object):
    ...
    def try_respond_async(self, response_apdu: winrt.system.Buffer, next_state: winrt.system.UInt32 | None, /) -> windows_foundation.IAsyncOperation[bool]: ...
    # Deprecated alias of try_respond_async() for pywinrt v3.x compatibility.
    # Windows.Foundation.IAsyncOperation`1<System.Boolean> Windows.Devices.SmartCards.SmartCardEmulatorApduReceivedEventArgs::TryRespondAsync(Windows.Storage.Streams.IBuffer,Windows.Foundation.IReference`1<System.UInt32>)
    @deprecated("Use try_respond_async() instead.")
    def try_respond_with_state_async(self, response_apdu: winrt.system.Buffer, next_state: winrt.system.UInt32 | None, /) -> windows_foundation.IAsyncOperation[bool]: ...
    @typing.overload
    ...
    def try_respond_with_cryptograms_async(self, response_template: winrt.system.Buffer, cryptogram_placement_steps: _cabc.Iterable[SmartCardCryptogramPlacementStep], /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]: ...
    @typing.overload
    # Windows.Foundation.IAsyncOperation`1<Windows.Devices.SmartCards.SmartCardCryptogramGeneratorOperationStatus> Windows.Devices.SmartCards.SmartCardEmulatorApduReceivedEventArgs::TryRespondWithCryptogramsAsync(Windows.Storage.Streams.IBuffer,Windows.Foundation.Collections.IIterable`1<Windows.Devices.SmartCards.SmartCardCryptogramPlacementStep>,Windows.Foundation.IReference`1<System.UInt32>)
    def try_respond_with_cryptograms_async(self, response_template: winrt.system.Buffer, cryptogram_placement_steps: _cabc.Iterable[SmartCardCryptogramPlacementStep], next_state: winrt.system.UInt32 | None, /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]: ...
    ...
    def try_respond_with_cryptograms_and_state_async(self, response_template: winrt.system.Buffer, cryptogram_placement_steps: _cabc.Iterable[SmartCardCryptogramPlacementStep], next_state: winrt.system.UInt32 | None, /) -> windows_foundation.IAsyncOperation[SmartCardCryptogramGeneratorOperationStatus]: ...
...
class SmartCardReader(winrt.system.Object, metaclass=SmartCardReader_Static):
    ...
    def remove_card_added(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
    ...
    def remove_card_removed(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
SmartCardPinResetHandler: typing.TypeAlias = typing.Callable[[SmartCardProvisioning, SmartCardPinResetRequest], None]
