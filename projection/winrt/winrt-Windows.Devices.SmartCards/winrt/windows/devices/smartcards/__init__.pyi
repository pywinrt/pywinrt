...
class SmartCardAppletIdGroup(winrt.system.Object, metaclass=SmartCardAppletIdGroup_Static):
    @typing.overload
    def __new__(cls, display_name: str, applet_ids: _cabc.MutableSequence[winrt.system.Buffer], emulation_category: SmartCardEmulationCategory, emulation_type: SmartCardEmulationType) -> typing.Self: ...
    @typing.overload
...
class SmartCardAutomaticResponseApdu(winrt.system.Object):
    def __new__(cls, command_apdu: winrt.system.Buffer, response_apdu: winrt.system.Buffer) -> typing.Self: ...
