...
class SmartCardAppletIdGroup(winrt.system.Object, metaclass=SmartCardAppletIdGroup_Static):
    @typing.overload
    def __new__(cls: typing.Type[Self], display_name: str, applet_ids: typing.MutableSequence[windows_storage_streams.IBuffer], emulation_category: SmartCardEmulationCategory, emulation_type: SmartCardEmulationType) -> Self: ...
    @typing.overload
...
class SmartCardAutomaticResponseApdu(winrt.system.Object):
    def __new__(cls: typing.Type[Self], command_apdu: windows_storage_streams.IBuffer, response_apdu: windows_storage_streams.IBuffer) -> Self: ...
