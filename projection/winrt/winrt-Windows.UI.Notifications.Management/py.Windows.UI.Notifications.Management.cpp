...
namespace py::cpp::Windows::UI::Notifications::Management
{
    ...
    {
        static constexpr py::member_site site{py::member_kind::property, 0, "Windows.UI.Notifications.Management.UserNotificationListener", "Current", nullptr, py::site_is_static};
