...
class BluetoothLEAdvertisement(winrt.system.Object):
    ...
    def get_manufacturer_data_by_company_id(self, company_id: winrt.system.UInt16, /) -> _cabc.Sequence[BluetoothLEManufacturerData]: ...
    ...
    def get_sections_by_type(self, type: winrt.system.UInt8, /) -> _cabc.Sequence[BluetoothLEAdvertisementDataSection]: ...
    ...
    @_property
    def flags(self) -> BluetoothLEAdvertisementFlags | None: ...
    ...
    @flags.setter
    def flags(self, value: BluetoothLEAdvertisementFlags | None) -> None: ...
    ...
    @_property
    def data_sections(self) -> _cabc.MutableSequence[BluetoothLEAdvertisementDataSection]: ...
    ...
    @_property
    def manufacturer_data(self) -> _cabc.MutableSequence[BluetoothLEManufacturerData]: ...
    ...
    @_property
    def service_uuids(self) -> _cabc.MutableSequence[_uuid.UUID]: ...
...
class BluetoothLEAdvertisementBytePattern(winrt.system.Object):
    ...
    def __new__(cls: type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], data_type: winrt.system.UInt8, offset: winrt.system.Int16, data: winrt.system.Buffer) -> Self: ...
...
class BluetoothLEAdvertisementDataSection(winrt.system.Object):
    ...
    def __new__(cls: type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], data_type: winrt.system.UInt8, data: winrt.system.Buffer) -> Self: ...
...
class BluetoothLEAdvertisementFilter(winrt.system.Object):
    ...
    @_property
    def byte_patterns(self) -> _cabc.MutableSequence[BluetoothLEAdvertisementBytePattern]: ...
...
class BluetoothLEAdvertisementPublisher(winrt.system.Object):
    ...
    def __new__(cls: type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], advertisement: BluetoothLEAdvertisement) -> Self: ...
...
class BluetoothLEAdvertisementPublisherStatusChangedEventArgs(winrt.system.Object):
    ...
    @_property
    def selected_transmit_power_level_in_dbm(self) -> winrt.system.Int16 | None: ...
...
class BluetoothLEAdvertisementReceivedEventArgs(winrt.system.Object):
    ...
    @_property
    def transmit_power_level_in_dbm(self) -> winrt.system.Int16 | None: ...
...
class BluetoothLEAdvertisementWatcher(winrt.system.Object):
    ...
    def __new__(cls: type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], advertisement_filter: BluetoothLEAdvertisementFilter) -> Self: ...
    ...
    def remove_received(self, token: windows_foundation.EventRegistrationToken | tuple[winrt.system.Int64], /) -> None: ...
...
class BluetoothLEManufacturerData(winrt.system.Object):
    ...
    def __new__(cls: type[Self]) -> Self: ...
    @typing.overload
    def __new__(cls: type[Self], company_id: winrt.system.UInt16, data: winrt.system.Buffer) -> Self: ...
