...
PyMODINIT_FUNC PyInit__winrt_windows_devices_adc_provider(void) noexcept
{
    ...
    py::pyobj_handle IAdcControllerProvider_type{py::register_python_type(module.get(), &type_spec_IAdcControllerProvider, object_bases.get(), nullptr)};
    if (!IAdcControllerProvider_type)
    {
        return nullptr;
    }

    py::pyobj_handle IAdcProvider_type{py::register_python_type(module.get(), &type_spec_IAdcProvider, object_bases.get(), nullptr)};
