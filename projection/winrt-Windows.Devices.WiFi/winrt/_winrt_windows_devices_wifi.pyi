...
class WiFiAdapter(winrt.system.Object, metaclass=WiFiAdapter_Static):
    ...
    def connect_with_password_credential_and_ssid_and_connection_method_async(self, available_network: typing.Optional[WiFiAvailableNetwork], reconnection_kind: WiFiReconnectionKind, password_credential: typing.Optional[windows_security_credentials.PasswordCredential], ssid: str, connection_method: WiFiConnectionMethod, /) -> windows_foundation.IAsyncOperation[WiFiConnectionResult]: ...
    def connect_with_password_credential_and_ssid_async(self, available_network: typing.Optional[WiFiAvailableNetwork], reconnection_kind: WiFiReconnectionKind, password_credential: typing.Optional[windows_security_credentials.PasswordCredential], ssid: str, /) -> windows_foundation.IAsyncOperation[WiFiConnectionResult]: ...
    def connect_with_password_credential_async(self, available_network: typing.Optional[WiFiAvailableNetwork], reconnection_kind: WiFiReconnectionKind, password_credential: typing.Optional[windows_security_credentials.PasswordCredential], /) -> windows_foundation.IAsyncOperation[WiFiConnectionResult]: ...
