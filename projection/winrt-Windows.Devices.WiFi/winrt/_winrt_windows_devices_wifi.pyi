...
class WiFiNetworkReport(winrt.system.Object):
    ...
    @_property
    def available_networks(self) -> windows_foundation_collections.IVectorView[WiFiAvailableNetwork]: ...
    @_property
...
class WiFiWpsConfigurationResult(winrt.system.Object):
    ...
    @_property
    def supported_wps_kinds(self) -> windows_foundation_collections.IVectorView[WiFiWpsKind]: ...
