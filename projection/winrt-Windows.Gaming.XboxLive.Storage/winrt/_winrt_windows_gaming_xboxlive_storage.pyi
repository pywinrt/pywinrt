...
class GameSaveBlobGetResult(winrt.system.Object):
    ...
    @_property
    def value(self) -> windows_foundation_collections.IMapView[str, windows_storage_streams.IBuffer]: ...
...
class GameSaveBlobInfoGetResult(winrt.system.Object):
    ...
    def status(self) -> GameSaveErrorStatus: ...
    @_property
    def value(self) -> windows_foundation_collections.IVectorView[GameSaveBlobInfo]: ...
...
class GameSaveContainerInfoGetResult(winrt.system.Object):
    ...
    def status(self) -> GameSaveErrorStatus: ...
    @_property
    def value(self) -> windows_foundation_collections.IVectorView[GameSaveContainerInfo]: ...
...
class GameSaveProvider(winrt.system.Object, metaclass=GameSaveProvider_Static):
    ...
    @_property
    def containers_changed_since_last_sync(self) -> windows_foundation_collections.IVectorView[str]: ...
    @_property
