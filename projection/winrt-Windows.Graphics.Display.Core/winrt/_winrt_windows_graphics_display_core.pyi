...
class HdmiDisplayInformation(winrt.system.Object, metaclass=HdmiDisplayInformation_Static):
    ...
    def get_supported_display_modes(self) -> typing.Optional[windows_foundation_collections.IVectorView[HdmiDisplayMode]]: ...
    def request_set_current_display_mode_async(self, mode: typing.Optional[HdmiDisplayMode], /) -> windows_foundation.IAsyncOperation[bool]: ...
    def request_set_current_display_mode_with_hdr_and_metadata_async(self, mode: typing.Optional[HdmiDisplayMode], hdr_option: HdmiDisplayHdrOption, hdr_metadata: HdmiDisplayHdr2086Metadata, /) -> windows_foundation.IAsyncOperation[bool]: ...
    def request_set_current_display_mode_with_hdr_async(self, mode: typing.Optional[HdmiDisplayMode], hdr_option: HdmiDisplayHdrOption, /) -> windows_foundation.IAsyncOperation[bool]: ...
