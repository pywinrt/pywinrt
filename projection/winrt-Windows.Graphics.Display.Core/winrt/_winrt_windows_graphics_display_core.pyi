...
class HdmiDisplayInformation(winrt.system.Object, metaclass=HdmiDisplayInformation_Static):
    ...
    def request_set_current_display_mode_with_hdr_and_metadata_async(self, mode: HdmiDisplayMode, hdr_option: HdmiDisplayHdrOption, hdr_metadata: HdmiDisplayHdr2086Metadata, /) -> windows_foundation.IAsyncOperation[bool]: ...
    ...
    def remove_display_modes_changed(self, token: windows_foundation.EventRegistrationToken, /) -> None: ...
