...
PyMODINIT_FUNC PyInit__winrt_windows_graphics_display_core(void) noexcept
{
    ...
    if (py::register_python_type(module.get(), &type_spec_HdmiDisplayInformation, nullptr, object_bases.get(), nullptr) == -1)
    #else
    ...
    #if PY_VERSION_HEX < 0x03090000
    if (py::register_python_type(module.get(), &type_spec_HdmiDisplayMode, nullptr, object_bases.get(), nullptr) == -1)
    #else
    ...
    #if PY_VERSION_HEX < 0x03090000
    if (py::register_python_type(module.get(), &type_spec_HdmiDisplayHdr2086Metadata, nullptr, nullptr, nullptr) == -1)
    #else
