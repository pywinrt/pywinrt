...
PyMODINIT_FUNC PyInit__winrt_windows_networking(void) noexcept
{
    ...
    py::pyobj_handle EndpointPair_type{py::register_python_type(module.get(), &type_spec_EndpointPair, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle HostName_type{py::register_python_type(module.get(), &type_spec_HostName, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_HostName_Static.get()))};
    if (!HostName_type)
    {
        return nullptr;
    }
