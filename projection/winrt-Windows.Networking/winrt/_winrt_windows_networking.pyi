...
class EndpointPair(winrt.system.Object):
    ...
    def __new__(cls: typing.Type[EndpointPair], local_host_name: HostName, local_service_name: str, remote_host_name: HostName, remote_service_name: str) -> EndpointPair: ...
    @_property
