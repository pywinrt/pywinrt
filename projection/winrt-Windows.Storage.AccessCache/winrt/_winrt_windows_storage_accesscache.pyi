...
class StorageItemAccessList(winrt.system.Object):
    ...
    def add_or_replace_overload_default_metadata(self, token: str, file: typing.Optional[windows_storage.IStorageItem], /) -> None: ...
    def add_overload_default_metadata(self, file: typing.Optional[windows_storage.IStorageItem], /) -> str: ...
...
class StorageItemMostRecentlyUsedList(winrt.system.Object):
    ...
    def add_or_replace(self, token: str, file: typing.Optional[windows_storage.IStorageItem], metadata: str, /) -> None: ...
    def add_or_replace_overload_default_metadata(self, token: str, file: typing.Optional[windows_storage.IStorageItem], /) -> None: ...
    def add_or_replace_with_metadata_and_visibility(self, token: str, file: typing.Optional[windows_storage.IStorageItem], metadata: str, visibility: RecentStorageItemVisibility, /) -> None: ...
    def add_overload_default_metadata(self, file: typing.Optional[windows_storage.IStorageItem], /) -> str: ...
    def add_with_metadata_and_visibility(self, file: typing.Optional[windows_storage.IStorageItem], metadata: str, visibility: RecentStorageItemVisibility, /) -> str: ...
    def check_access(self, file: typing.Optional[windows_storage.IStorageItem], /) -> bool: ...
    def clear(self) -> None: ...
    def contains_item(self, token: str, /) -> bool: ...
    def get_file_async(self, token: str, /) -> windows_foundation.IAsyncOperation[windows_storage.StorageFile]: ...
