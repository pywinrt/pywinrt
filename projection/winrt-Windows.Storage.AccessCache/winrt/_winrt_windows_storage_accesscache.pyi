...
@typing.final
class StorageItemAccessList(winrt.system.Object, ImplementsIStorageItemAccessList):
...
@typing.final
class StorageItemMostRecentlyUsedList(winrt.system.Object, ImplementsIStorageItemAccessList):
    ...
    def add_or_replace_with_metadata_and_visibility(self, token: str, file: windows_storage.ImplementsIStorageItem, metadata: str, visibility: RecentStorageItemVisibility, /) -> None: ...
    ...
    def add_with_metadata_and_visibility(self, file: windows_storage.ImplementsIStorageItem, metadata: str, visibility: RecentStorageItemVisibility, /) -> str: ...
