...
PyMODINIT_FUNC PyInit__winrt_windows_storage_accesscache(void) noexcept
{
    ...
    py::pyobj_handle AccessListEntryView_type{py::register_python_type(module.get(), &type_spec_AccessListEntryView, object_bases.get(), nullptr)};
    if (!AccessListEntryView_type)
    {
        return nullptr;
    }

    py::pyobj_handle ItemRemovedEventArgs_type{py::register_python_type(module.get(), &type_spec_ItemRemovedEventArgs, object_bases.get(), nullptr)};
    ...
    py::pyobj_handle StorageApplicationPermissions_type{py::register_python_type(module.get(), &type_spec_StorageApplicationPermissions, object_bases.get(), reinterpret_cast<PyTypeObject*>(type_StorageApplicationPermissions_Static.get()))};
    if (!StorageApplicationPermissions_type)
    {
        return nullptr;
    }

    py::pyobj_handle StorageItemAccessList_type{py::register_python_type(module.get(), &type_spec_StorageItemAccessList, object_bases.get(), nullptr)};
    if (!StorageItemAccessList_type)
    {
        return nullptr;
    }

    py::pyobj_handle StorageItemMostRecentlyUsedList_type{py::register_python_type(module.get(), &type_spec_StorageItemMostRecentlyUsedList, object_bases.get(), nullptr)};
    if (!StorageItemMostRecentlyUsedList_type)
    {
        return nullptr;
    }

    py::pyobj_handle IStorageItemAccessList_type{py::register_python_type(module.get(), &type_spec_IStorageItemAccessList, object_bases.get(), nullptr)};
    if (!IStorageItemAccessList_type)
    {
        return nullptr;
    }

    py::pyobj_handle AccessListEntry_type{py::register_python_type(module.get(), &type_spec_AccessListEntry, nullptr, nullptr)};
