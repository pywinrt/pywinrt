...
class PrintCustomItemListOptionDetails(winrt.system.Object):
    ...
    @typing.overload
    def add_item(self, item_id: str, display_name: str, description: str, icon: typing.Optional[windows_storage_streams.IRandomAccessStreamWithContentType], /) -> None: ...
    def try_set_value(self, value: typing.Optional[winrt.system.Object], /) -> bool: ...
    @_property
    def warning_text(self) -> str: ...
    @warning_text.setter
...
class PrintTaskOptionDetails_Static(type):
    def get_from_print_task_options(cls, print_task_options: typing.Optional[windows_graphics_printing.PrintTaskOptions], /) -> typing.Optional[PrintTaskOptionDetails]: ...
...
class PrintTaskOptionDetails(winrt.system.Object, metaclass=PrintTaskOptionDetails_Static):
    ...
    @_property
    def options(self) -> typing.Optional[windows_foundation_collections.IMapView[str, IPrintOptionDetails]]: ...
