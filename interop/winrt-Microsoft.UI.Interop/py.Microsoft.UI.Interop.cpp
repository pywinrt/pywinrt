...
namespace py::cpp::Microsoft::UI::Interop
{
        ...
        PyObject* /*unused*/, PyObject* arg) noexcept
    {
        ...
        try
        {
            auto type = py::get_python_type("winrt.microsoft.ui.WindowId");
            if (!type)
            {
                return nullptr;
            }
        ...
        PyObject* /*unused*/, PyObject* arg) noexcept
    {
        ...
        try
        {
            auto type = py::get_python_type("winrt.microsoft.ui.DisplayId");
            if (!type)
            {
                return nullptr;
            }
        ...
        PyObject* /*unused*/, PyObject* arg) noexcept
    {
        ...
        try
        {
            auto type = py::get_python_type("winrt.microsoft.ui.IconId");
            if (!type)
            {
                return nullptr;
            }
